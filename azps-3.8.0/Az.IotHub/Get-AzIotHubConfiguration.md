...
## DESCRITIVO
Obtenha os detalhes de uma configuração de gerenciamento automático de dispositivos da IoT ou liste as configurações de gerenciamento automático de dispositivos do IoT em um hub IoT.
...
Obtenha os detalhes de uma configuração de gerenciamento automático de dispositivos da IoT.
...
Liste as configurações de gerenciamento automático de dispositivos da IoT em um hub IoT.
