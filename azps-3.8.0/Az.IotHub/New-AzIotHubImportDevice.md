...
## DESCRITIVO
Cria um novo trabalho de dispositivos de importação para o IotHub.
Isso importará todos os dispositivos para o IotHub a partir do contêiner especificado. Consulte o artigo a seguir sobre como gerar o URI da SAS.
...
Cria uma nova solicitação de dispositivo de importação para o IotHub "myiothub".
...
URI do contêiner de blob de entrada para FileUpload
...
O URI no qual a saída será gravada. 
