...
Esse comando Remove uma política de ponto de extremidade de serviço com o nome PolicyDef1
...
### -InputObject
O objeto de definição da política de ponto de extremidade do serviço.
...
### -Nome
O nome da definição de ponto de extremidade do serviço
...
### -ResourceId
A ID da definição de ponto de extremidade do serviço.
