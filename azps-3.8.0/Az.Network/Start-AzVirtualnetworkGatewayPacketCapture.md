...
### -FilterData
Opções de filtro para iniciar captura de pacote no gateway de rede virtual.
...
### -InputObject
O objeto de gateway de rede virtual em que a captura de pacote deve ser iniciada.
...
### -Nome
O nome do gateway de rede virtual em que a captura de pacote deve ser iniciada.
...
### -ResourceId
A ID de recurso do Azure do VirtualNetworkGateway em que a captura de pacote deve ser iniciada.
