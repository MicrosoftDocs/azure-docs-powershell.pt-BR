...
Após a criação do gateway, ele é conectado ao ExpressRouteSite usando o comando New-AzExpressRouteConnection.

Em seguida, ele remove a conexão usando o nome da conexão.
...
Mesmo que o exemplo 1, mas agora ele remove a conexão usando o objeto piped do Get-AzExpressRouteConnection.
