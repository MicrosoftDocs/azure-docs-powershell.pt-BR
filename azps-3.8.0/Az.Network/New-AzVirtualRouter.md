...
### HostedGatewayParameterSet (padrão)
```
...
### -HostedGateway
O gateway em que o roteador virtual precisa ser hospedado.
...
### -HostedGatewayId
A ID do gateway em que o roteador virtual precisa ser hospedado.
