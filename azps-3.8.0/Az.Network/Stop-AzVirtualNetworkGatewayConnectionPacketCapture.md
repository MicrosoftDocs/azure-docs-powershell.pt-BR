...
## DESCRITIVO
Interrompe a operação de captura de pacote em uma conexão de gateway de rede virtual e carregará o resultado em determinado SasUrl contêiner de armazenamento.
...
### -Nome
O nome da conexão de gateway de rede virtual em que a captura de pacotes deve ser iniciada.
...
### -SasUrl
URL SAS para parar captura de pacotes no gateway de rede virtual.
