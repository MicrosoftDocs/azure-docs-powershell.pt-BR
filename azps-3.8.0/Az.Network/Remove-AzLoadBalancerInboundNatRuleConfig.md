...
## DESCRITIVO
O cmdlet **Remove-AzLoadBalancerInboundNatRuleConfig** remove uma configuração de regra NAT (conversão de endereço de rede) de entrada de um balanceador de carga do Azure.

## EXEMPLOS

### 1: excluir uma regra NAT de entrada de um balanceador de carga do Azure
```
...
O primeiro comando carrega um balanceador de carga já existente chamado "mylb" e o armazena na variável de balanceador de $load. O segundo comando Remove a regra NAT de entrada associada a esse balanceador de carga.
...
### -Loadbalancer
Especifica o objeto **Loadbalancer** que contém a configuração de regra NAT de entrada que este cmdlet Remove.
...
### -Nome
Especifica o nome da configuração de regra NAT de entrada que este cmdlet Remove.
