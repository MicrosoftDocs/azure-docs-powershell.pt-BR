...
### -ConnectionBandwidth
A largura de banda que precisa ser manipulada por essa conexão de link em Mbps.
...
### -EnableBgp
Habilitar o BGP para esta conexão de link
...
### -IpSecPolicy
Política IpSec a ser considerada para esta conexão de link.
...
### -SharedKey
A chave compartilhada necessária para definir essa conexão de link.
...
Use o endereço IP do Azure local como IP de origem para esta conexão de link.
...
Use seletores de tráfego baseado em política para esta conexão de link.
...
### -VpnSiteLink
O objeto de link de site VPN ao qual se conectar.
