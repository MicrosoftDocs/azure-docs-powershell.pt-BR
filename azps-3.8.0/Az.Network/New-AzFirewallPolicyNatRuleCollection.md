...
## DESCRITIVO
O cmdlet **New-AzFirewallPolicyNatRuleCollection** cria uma coleção de regras NAT para uma política de firewall do Azure.
...
Este exemplo cria uma coleção de regras NAT com uma regra de rede

## OS

### -ActionType
O tipo da ação da regra
...
### -Nome
O nome da coleção de regras de rede
