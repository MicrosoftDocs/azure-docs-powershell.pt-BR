...
## DESCRITIVO
O cmdlet **Get-AzFirewallPolicy** Obtém um ou mais firewalls em um grupo de recursos
...
Este exemplo obtém uma política de firewall chamada "firewallPolicy" no grupo de recursos "TestRg"
