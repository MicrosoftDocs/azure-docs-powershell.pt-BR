...
Atualize um recurso de log de fluxo.
...
Desconectar a conexão VPN do gateway de rede virtual.

### [Desconectar-AzP2sVpnGatewayVpnConnection](Disconnect-AzP2sVpnGatewayVpnConnection.md)
Desconectar a conexão VPN do gateway VPN do P2s.
