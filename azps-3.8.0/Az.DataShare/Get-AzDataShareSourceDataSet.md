...
## DESCRITIVO
O cmdlet **Get-AzDataShareSourceDataSet** fornece informações sobre os conjuntos de dados de origem na assinatura do compartilhamento. 
...
Obtém conjuntos de fontes disponíveis no compartilhamento de origem
