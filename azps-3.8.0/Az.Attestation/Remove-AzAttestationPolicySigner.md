...
### -Signatário
Especifica o token da Web RFC7519 JSON que contém uma declaração chamada "AAS-policyCertificate" cujo valor é uma chave JSON RFC7517 da Web que contém uma chave de assinatura confiável a ser removida.
