...
## DESCRITIVO
O cmdlet **Remove-AzWcfRelay** remove o WcfRelay do namespace de retransmissão especificado.
...
Remove o WcfRelay `TestWCFRelay1` do namespace `TestNameSpace-Relay1` .
