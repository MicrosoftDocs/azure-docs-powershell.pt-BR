...
3) NotDataActions: o conjunto de operações que devem ser excluídas da dataactions para determinar as ações de dados efetivas para a função personalizada.
