...
## DESCRITIVO
O cmdlet **Update-AzManagementGroup** atualiza **parentID** ou **DisplayName** para um grupo de gerenciamento.
...
### Exemplo 3: atualizar um grupo de gerenciamento por objeto de PSManagementGroup de tubulação
```
...
### Exemplo 4: atualizar o pai de um grupo de gerenciamento usando ParentObject
```
