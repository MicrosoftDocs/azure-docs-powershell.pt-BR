...
## DESCRITIVO
Recuperar artefatos de uma definição de plano. Se uma versão de definição Blueprint não for especificada, a versão de rascunho será recuperada. Caso não haja nenhuma versão de rascunho, a última definição de planta publicada é retornada.
...
### -BlueprintVersion
Versão do plano gráfico da qual obter os artefatos.
