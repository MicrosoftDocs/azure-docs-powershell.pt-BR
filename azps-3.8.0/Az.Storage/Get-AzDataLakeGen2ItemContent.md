...
## DESCRITIVO
O cmdlet **Get-AzDataLakeGen2ItemContent** baixa um arquivo em um sistema de arquivos em uma conta de armazenamento do Azure.
...
### Exemplo 1: baixar um arquivo sem avisar
```
...
Esse comando baixa um arquivo para um arquivo local sem avisar.

### Exemplo 2: obter um arquivo e, em seguida, fazer o pipeline para baixar o arquivo para um arquivo local
```
...
Esse comando primeiro obtém um arquivo e, em seguida, o pipeline para baixar o arquivo para um arquivo local.
...
### -Destino
Caminho do arquivo de destino local.
...
### -Force
Forçar a substituição do arquivo ou BLOB existente
...
### -InputObject
Objeto de item Gen2 do Azure datalake para download.
