...
## DESCRITIVO
O cmdlet **move-AzDataLakeGen2Item** move um arquivo ou diretório para outro arquivo ou diretório na mesma conta de armazenamento.
...
### Exemplo 1: mover uma dobra no mesmo sistema de arquivos
```
...
Este comando move o diretório ' dir1 ' para o diretório ' dir3 ' no mesmo sistema de arquivos.

### Exemplo 2: mover um arquivo por pipeline, para outro sistema de arquivos na mesma conta de armazenamento sem confirmação
```
...
Este comando move o arquivo ' dir1/arquivo1 ' em ' filesystem1 ' para o arquivo ' dir2/arquivo2 ' em ' filesystem2 ' na mesma conta de armazenamento sem aviso.
...
### -DestFileSystem
Nome do sistema de arquivos de destino
...
### -InputObject
Objeto de item Gen2 do Azure datalake para o qual mover.
...
### -Caminho
O caminho no sistema de arquivos especificado que deve ser movido.
