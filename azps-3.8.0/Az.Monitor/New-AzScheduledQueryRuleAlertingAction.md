...
## DESCRITIVO
Cria um objeto do tipo ação de alerta esse objeto deve ser passado para o comando que cria a regra de alerta de log
...
### -ThrottlingInMinutes
A duração em minutos para a qual o alerta deve ser limitado
