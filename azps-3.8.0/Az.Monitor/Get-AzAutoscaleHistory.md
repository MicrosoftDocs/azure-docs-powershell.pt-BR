...
## DESCRITIVO
O cmdlet **Get-AzAutoscaleHistory** Obtém o histórico de eventos relacionados a uma configuração de dimensionamento automático.
...
Esse comando obtém todos os eventos relacionados à autoescala associados à assinatura atual.
...
Esse comando obtém todos os eventos relacionados à autoescala associados a um determinado recurso identificado pela ID do recurso (essencialmente, o ResourceURI).
...
### -ResourceId
Especifica a ID do recurso à qual a configuração de autoescala está associada.
...
Este parâmetro é opcional.
A falha é uma cadeia de caracteres vazia (isto é, sem filtro)
