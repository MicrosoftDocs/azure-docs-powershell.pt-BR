...
## DESCRITIVO
Use **Add-AzServiceFabricNode** para adicionar nós ao tipo de nó específico. Você só precisa especificar o número de nós que deseja adicionar a um tipo de nó.
