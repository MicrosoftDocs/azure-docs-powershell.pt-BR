...
Excluir um serviço de provisionamento de dispositivo Hub IoT do Azure ' myiotdps '.
...
Excluir um serviço de provisionamento de dispositivo Hub IoT do Azure ' myiotdps ' usando o pipeline.
