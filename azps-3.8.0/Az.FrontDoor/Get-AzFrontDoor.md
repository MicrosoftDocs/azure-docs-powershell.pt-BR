...
## DESCRITIVO
O cmdletGet **Get-AzFrontDoor** obtém todas as portas frontais existentes na assinatura atual que corresponde às informações fornecidas.
...
Obtenha todos os FrontDoors na assinatura atual.
...
Obtenha todos os FrontDoors no grupo de recursos "Rg1" na assinatura atual.

### Exemplo 3: obter o FrontDoors no grupo de recursos "Rg1" com nome "frontDoor1" na assinatura atual.
```powershell
...
Obtenha o FrontDoors no grupo de recursos "Rg1" com o nome "frontDoor1" na assinatura atual.
