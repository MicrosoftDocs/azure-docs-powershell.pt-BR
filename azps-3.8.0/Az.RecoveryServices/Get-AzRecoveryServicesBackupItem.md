...
Usar o parâmetro FriendlyName pode resultar em retornar mais de um compartilhamento de arquivos do Azure. Nesse caso, use o parâmetro Name com valor de parâmetro como a propriedade Name retornada na variável $BackupItem.
