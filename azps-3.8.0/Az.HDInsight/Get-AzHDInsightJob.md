...
Obtenha um trabalho específico fornecendo o parâmetro *JobID* .

## EXEMPLOS

### Exemplo 1: obter trabalhos recentes para um cluster do Azure HDInsight especificado
```
PS C:\># Cluster info
...
Esse comando obtém todos os trabalhos recentes do cluster chamado seu-Hadoop-001.
...
### -JobId
Especifica a ID do trabalho a ser obtida.
...
### -NumOfJobs
Especifica o número de trabalhos a serem recuperados.
