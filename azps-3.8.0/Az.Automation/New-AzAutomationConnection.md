...
### Exemplo 1: criar uma conexão para ConnectionName = Azure
```
...
### Exemplo 2: criar uma conexão para ConnectionName = AzureServicePrincipal
```
...
O comando cria uma conexão do Azure chamada Connection13 na conta de automação chamada AutomationAccount01 usando $RunAsAccountConnectionFieldValues e ConnectionName = AzureServicePrincipal.
Esse ConnectionName = AzureServicePrincipal é usado principalmente para a conta Executar como do Azure.

### Exemplo 3: criar uma conexão para ConnectionName = AzureClassicCertificate
```
...
O comando cria uma conexão do Azure chamada Connection14 na conta de automação chamada AutomationAccount01 usando $ClassicRunAsAccountConnectionFieldValues e ConnectionName = AzureClassicCertificate.
Esse ConnectionName = AzureClassicCertificate é usado principalmente para a conta Executar como do Azure Classic.
