...
### -InputObject
Instância do PsApiManagementIdentityProvider. Esse parâmetro é obrigatório.
...
### -PassThru
Indica que esse cmdlet retorna o  **PsApiManagementIdentityProvider** que esse cmdlet modifica.
