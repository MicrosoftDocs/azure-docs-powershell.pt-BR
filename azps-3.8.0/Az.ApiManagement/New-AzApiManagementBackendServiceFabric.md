...
O cmdlet **New-AzApiManagementBackendServiceFabric** cria um objeto de ser usado no `PsApiManagementServiceFabric` cmdlet **New-AzApiManagementBackend** e **Set-AzApiManagementBackend.**
