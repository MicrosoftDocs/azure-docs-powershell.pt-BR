...
## DESCRITIVO
Esse comando permite alterações nos parâmetros ajustáveis de um ponto de extremidade do servidor. Por exemplo, a hierarquização da nuvem e as políticas de hierarquização na nuvem podem ser alteradas a qualquer momento. Vários aspectos de um ponto de extremidade do servidor, como o caminho local, não podem ser alterados após a criação do ponto de extremidade do servidor.
