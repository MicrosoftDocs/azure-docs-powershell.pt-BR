...
## DESCRITIVO
O cmdlet Update-AzAvailabilityGroupListener atualiza um ouvinte de grupo de disponibilidade.
...
Atualiza as máquinas virtuais SQL da lista para o ouvinte do grupo de disponibilidade.
