...
## DESCRITIVO
O cmdlet New-AzSqlVM cria uma máquina virtual do Azure SQL.
...
Cria uma nova máquina virtual do Azure SQL com o nome VM na ResourceGroup01 do grupo de recursos 
...
### -Local
Local da máquina virtual do SQL.
