...
## DESCRITIVO
O cmdlet **Get-AzBatchApplicationPackage** Obtém informações sobre um pacote de aplicativo em uma conta em lotes do Azure.

## EXEMPLOS

### Exemplo 1: obter detalhes de um pacote de aplicativo em uma conta em lotes
```
...
### -AccountName
Especifica o nome da conta em lotes da qual este cmdlet obtém informações.
