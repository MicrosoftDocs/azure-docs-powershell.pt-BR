...
## DESCRITIVO
O cmdlet **set-AzSqlDatabaseGeoBackupPolicy** define a política de backup geográfico registrada em um banco de dados.
...
### -DatabaseName
Especifica o nome do banco de dados para o qual esse cmdlet define a política de backup geográfico.
...
### -Estado
Especifica o estado da política de backup geográfico.
