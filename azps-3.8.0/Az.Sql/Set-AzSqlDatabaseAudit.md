...
## DESCRITIVO
O cmdlet **set-AzSqlDatabaseAudit** altera as configurações de auditoria de um banco de dados SQL do Azure.
...
### Exemplo 3,1: habilitar a política de auditoria de armazenamento de blob de um banco de dados SQL do Azure com filtragem avançada usando um predicado T-SQL
```
...
### Exemplo 3,2: remover a configuração de filtragem avançada da política de auditoria de um banco de dados SQL do Azure
```
...
### Exemplo 4: habilitar a política de auditoria do hub de eventos de um banco de dados SQL do Azure
```
...
### Exemplo 5: desabilitar a política de auditoria do hub de eventos de um banco de dados SQL do Azure
```
...
### Exemplo 6: habilitar a política de auditoria de análise de log de um banco de dados SQL do Azure
```
...
### Exemplo 7: desabilitar a política de auditoria de análise de log de um banco de dados SQL do Azure
```
...
### Exemplo 8: desabilitar, por meio de pipeline, a política de auditoria de análise de logs de um banco de dados SQL do Azure
```
...
### Exemplo 9: desabilitar o envio de registros de auditoria de um banco de dados SQL do Azure para o armazenamento de BLOB e habilitar o envio para a análise de logs.
```
...
### Exemplo 10: habilitar o envio de registros de auditoria de um banco de dados SQL do Azure para o armazenamento de BLOB, o Hub de eventos e a análise de logs.
```
...
Recebi  
REFERE  
A forma geral para definir uma ação a ser auditada é: [ação] em [objeto] por [entidade] Observe que [objeto] no formato acima pode se referir a um objeto, como uma tabela, um modo de exibição ou um procedimento armazenado ou um esquema ou banco de dados inteiro. Para os últimos casos, o banco de dados de formulários:: [dbname] e esquema:: [SchemaName] são usados, respectivamente.
Por exemplo:  
