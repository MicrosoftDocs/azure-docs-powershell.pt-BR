...
### Exemplo 1
### Exemplo 1-desabilitar a segurança de dados avançados do servidor
```powershell
...
### Exemplo 2-desabilitar a segurança de dados avançados do servidor do recurso do servidor
```powershell
