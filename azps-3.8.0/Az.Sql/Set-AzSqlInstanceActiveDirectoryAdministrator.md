...
## DESCRITIVO
O cmdlet **set-AzSqlInstanceActiveDirectoryAdministrator** provisiona um administrador do Azure Active Directory (Azure AD) para AzureSQL instância gerenciada na assinatura atual.
Você pode provisionar apenas um administrador de cada vez.
Os seguintes membros do Azure AD podem ser provisionados como um administrador de instância gerenciada SQL:
- Membros nativos do Azure AD 
- Membros federados do Azure AD 
- Grupos do Azure AD criados como grupos de segurança importados os membros de outros anúncios do Azure não têm suporte como administradores.
...
### Exemplo 2: prover um usuário administrador usando o objeto da instância gerenciada
```
...
Este comando provisiona um usuário do Azure AD como administrador a partir do objeto de instância gerenciado.

### Exemplo 3: prover um administrador usando o identificador de recursos de instância gerenciada
```
...
Este comando provisiona um usuário do Azure AD como administrador usando o identificador de recursos de instância gerenciada.
...
### -DisplayName
Especifica o nome de exibição do usuário ou grupo para o qual conceder permissões.
Este nome para exibição deve existir no Active Directory associado à assinatura atual.
...
### -ObjectId
Especifica a ID de objeto do usuário ou grupo no Azure Active Directory ao qual conceder permissões.
