...
## DESCRITIVO
O cmdlet Remove-AzSqlElasticJobTarget remove um recurso de destino para um grupo de destino
...
### Exemplo 3-remover um destino de pool elástico
```
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Exemplo 4-remover um destino do mapa de fragmentos
```
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Remove um destino (servidor, pool elástico, banco de dados e mapa de fragmentos) de um grupo de destino

## OS

### -AgentName
Nome do agente do banco de dados SQL.
...
### -AgentServerName
Nome do servidor do SQL Database Agent.
...
### -DatabaseName
Nome do destino do banco de dados
...
### -ElasticPoolName
Nome do destino do pool elástico
...
### -ParentResourceId
A ID do recurso do grupo de destino.
...
### -ShardMapName
Nome do destino do mapa de fragmentos
