...
## DESCRITIVO
Os cmdlets **Stop-AzServiceBusMigration** terminam a migração entre o namespace padrão Premium
...
O cmdlet termina a migração entre namespace padrão e namespace Premium fornecido durante a criação da configuração de migração.
...
### -InputObject
Objeto namespace padrão de configuração de migração do barramento do serviço
...
### -ResourceId
ID do recurso namespace padrão de configuração de migração do barramento do serviço
