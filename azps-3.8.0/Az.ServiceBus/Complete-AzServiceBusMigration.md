...
## DESCRITIVO
Os cmdlets **Complete-AzServiceBusMigration** definem a migração do namespace padrão para Premium, já que cadeias de caracteres de conexão completa e de conexão do namespace padrão apontam para namespace Premium
...
Define a migração do namespace ' NamespaceStandardMigration ' como concluída.
...
### -InputObject
Configuração de migração de barramento de serviço-objeto de namespace padrão
...
### -ResourceId
Migração do barramento do serviço-ID do recurso namespace padrão
