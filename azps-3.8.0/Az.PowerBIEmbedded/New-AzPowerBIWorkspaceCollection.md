...
## DESCRITIVO
O cmdlet **New-AzPowerBIWorkspaceCollection** cria um conjunto do espaço de trabalho do Power bi para a sua assinatura do Azure no grupo de recursos e local especificados.
