...
## DESCRITIVO
O cmdlet **New-AzDataBoxEdgeStorageContainer** cria um novo contêiner de armazenamento na conta de armazenamento de borda em um dispositivo de borda de caixa de dados.
