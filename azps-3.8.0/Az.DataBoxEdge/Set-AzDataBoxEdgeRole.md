...
## DESCRITIVO
O cmdlet **set-AzDataBoxEdgeRole** atualiza uma função IOT para um dispositivo de borda de caixa de dados. Os antigos compartilhamentos montados serão substituídos pelos recém fornecidos no parâmetro ShareName.
...
Os nomes de compartilhamento substituirão os compartilhamentos montados antigos pelos novos fornecidos
...
Para desmontar todos os compartilhamentos
...
### -ShareName
Compartilhamento (s) em uma função
