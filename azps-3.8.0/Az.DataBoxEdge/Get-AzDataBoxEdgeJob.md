...
## DESCRITIVO
O cmdlet **Get-AzDataBoxEdgeJob** Obtém os trabalhos ativos em um dispositivo de borda de caixa de dados. Você pode mencionar o parâmetro Name para obter detalhes de um trabalho específico.
