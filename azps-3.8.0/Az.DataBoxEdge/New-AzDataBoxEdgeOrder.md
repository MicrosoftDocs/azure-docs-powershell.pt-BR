...
## DESCRITIVO
O cmdlet **New-AzDataBoxEdgeOrder** cria um novo pedido para um dispositivo de borda de caixa de dados. Um recurso de dispositivo de borda de caixa de dados precisa ser criado primeiro antes de criar um pedido. Você pode especificar detalhes como pessoa de contato, nome da empresa, email, endereço, etc. como parâmetros para criar o pedido.
...
### -Email
Lista de emails para receber atualizações, aceita o máximo de 10 emails
