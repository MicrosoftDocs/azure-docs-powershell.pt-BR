...
## DESCRITIVO
O cmdlet Remove-AzEnvironment remove pontos de extremidade e informações de metadados para se conectar a uma determinada instância do Azure.

## EXEMPLOS

### Exemplo 1: Criando e removendo um ambiente de teste
```
...
Este exemplo mostra como criar um ambiente usando Add-AzEnvironment e, em seguida, como excluir o ambiente usando Remove-AzEnvironment.
