...
## DESCRITIVO
O cmdlet **Remove-AzActionRule** exclui uma regra de ação.
...
Este cmdlet exclui a regra de ação com o nome ActionRuleName no teste do grupo de recursos-RG
