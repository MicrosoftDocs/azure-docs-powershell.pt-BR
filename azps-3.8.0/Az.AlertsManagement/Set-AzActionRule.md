...
Esse cmdlet cria uma regra de ação para supressão.
...
Esse cmdlet cria uma regra de ação para o grupo de ação.
...
Esse cmdlet cria uma regra de ação para configurações de diagnóstico.
...
Formato esperado-{ \< Operation \> : \< lista de valores separados por vírgula \> } para ex.
Contém: smartgroups
