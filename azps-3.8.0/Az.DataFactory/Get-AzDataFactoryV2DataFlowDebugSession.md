...
## Sinopse
Obter todas as sessões de depuração do fluxo de dados ativos pelo Azure data Factory
...
## DESCRITIVO
Liste todas as sessões de depuração de fluxo de dados ativos pelo Azure data Factory com detalhes.
...
Obter todas as sessões de depuração de fluxo de dados ativas no Azure data Factory "WikiADF".
