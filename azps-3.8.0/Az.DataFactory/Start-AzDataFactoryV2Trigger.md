...
## DESCRITIVO
O cmdlet **Start-AzDataFactoryV2Trigger** inicia um gatilho em uma fábrica de dados. Se o gatilho estiver no estado ' parado ', o cmdlet iniciará o gatilho e eventualmente invocará os pipelines com base em sua definição. Se o gatilho já estiver no estado ' iniciado ', esse cmdlet não terá efeito. Se o parâmetro Force for especificado, o cmdlet não avisa antes de iniciar o gatilho.

## EXEMPLOS

### Exemplo 1: iniciar um gatilho
```
...
Inicia um gatilho chamado "ScheduledTrigger" na fábrica de dados "WikiADF".
