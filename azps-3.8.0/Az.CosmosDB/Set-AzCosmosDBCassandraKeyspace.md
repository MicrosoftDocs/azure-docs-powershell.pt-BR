...
## Sinopse
Define o espaço CosmosDB Cassandra.
...
## DESCRITIVO
O cmdlet **set-AzCosmosDBCassandraKeyspace** define o espaço de keyCosmosDB Cassandra.
...
Objeto de recurso contém os valores das propriedades _rid, _ts _etag.
