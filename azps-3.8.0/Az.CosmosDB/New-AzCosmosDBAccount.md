...
Uma nova conta do CosmosDB com o nome databaseAccountName é criada no resourceGroupName do.

## OS

### -ApiKind
O tipo de conta de banco de dados de banco de dados do cosmos a ser criado.
Valores aceitos: GlobalDocumentDB, MongoDB, Gremlin, Table, Cassandra.
Valor padrão: GlobalDocumentDB
...
### -IpRangeFilter
Suporte a firewall.
Especifica o conjunto de endereços IP ou intervalos de endereços IP no formato CIDR a ser incluído como a lista permitida de IPs de cliente para uma determinada conta de banco de dados
...
### -Local
Adicione um local para a conta de banco de dados do cosmos DB.
Matriz de cadeia de caracteres, ordenada pela prioridade de failover.
