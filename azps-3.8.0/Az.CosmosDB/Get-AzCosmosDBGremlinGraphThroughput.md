...
## Sinopse
Obtém a taxa de transferência de um gráfico de Gremlin CosmosDB.
...
## DESCRITIVO
O cmdlet **Get-AzCosmosDBGremlinGraphThroughput** Obtém a taxa de transferência de um gráfico de Gremlin de CosmosDB.
