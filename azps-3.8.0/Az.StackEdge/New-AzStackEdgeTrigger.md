...
## DESCRITIVO
O cmdlet **New-AzStackEdgeTrigger** configura um gatilho no dispositivo de borda de pilha. 
...
### -RoleName
Calcule a função em relação a quais eventos serão gerados.
...
### -Cronograma
Frequência periódica em que o evento do temporizador precisa ser gerado. Especifique um cronograma em qualquer um dos dias (entre 1 e 365), horas (entre 1 e 23) ou minutos (entre 1 e 59).
...
### -StartTime
A hora do dia que resulta em um gatilho válido. A agenda é calculada com referência ao tempo especificado em até segundos. Se o fuso horário não for especificado, o tempo será considerado no fuso horário do dispositivo. O valor sempre será retornado como horário UTC.
