...
### Exemplo 15: criar um tíquete de suporte especificando parâmetros de contato do cliente individuais em vez do objeto CustomerContactDetail. 
```powershell
...
### Exemplo 16: criar um tíquete de suporte com solicitação de resposta 24 x 7 do Azure. 
```powershell
