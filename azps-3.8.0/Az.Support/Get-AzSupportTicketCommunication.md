...
## Sinopse
Obter suporte a comunicações de permissão.
...
## DESCRITIVO
Obtém comunicações para um tíquete de suporte. Ele recuperará todas as comunicações para um tíquete se você não especificar outros parâmetros. Você também pode filtrar as comunicações por CreatedDate ou Communicationtype usando o parâmetro Filter. Aqui estão alguns exemplos de valores de filtro que você pode especificar.


| Situações                                                        | Filtre                                                     |
|-----------------------------------------------------------------|------------------------------------------------------------|
| Obter comunicações da Web                                          | "Communicationtype EQ" Web ""                               |
| Obter comunicações por telefone                                        | "Communicationtype EQ" Phone ""                             |
| Obter comunicações criadas em ou após 20 de dezembro de 2019 | "CreatedDate GE 2019-12-20"                                |
| Obter comunicações criadas após 20 de dezembro de 2019       | "CreatedDate gt 2019-12-20"                                |
| A comunicação da Web é criada após 20 de dezembro de 2019            | "CreatedDate gt 2019-12-20 e Communicationtype EQ ' Web '" |


Esse cmdlet dá suporte à paginação pelos parâmetros First e Skip.

Você também pode recuperar uma única comunicação de tíquete de suporte especificando o nome de comunicação. 
...
### Exemplo 2: recuperar uma única comunicação por ele é o nome de um tíquete de suporte
```powershell
...
### Exemplo 3: recuperar as primeiras 2 comunicações para obter um tíquete de suporte
```powershell
...
### Exemplo 4: recuperar as próximas 2 comunicações após ignorar as 2 primeiras comunicações para um tíquete de suporte
```powershell
...
### Exemplo 6: recuperar todas as comunicações criadas em ou após dez de 20 de dezembro de 2019 para um tíquete de suporte
```powershell
...
### Exemplo 7: recuperar todas as comunicações da Web criadas em ou após dez de 20 de dezembro de 2019 para obter um tíquete de suporte
```powershell
...
### Exemplo 8: recuperar todas as comunicações para um tíquete de suporte por meio do objeto de tíquete de suporte de tubulação
```powershell
