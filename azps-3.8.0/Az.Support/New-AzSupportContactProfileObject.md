...
## DESCRITIVO
Esse é um cmdlet auxiliar que você pode usar para criar um objeto de perfil de contato de suporte ao criar ou atualizar um tíquete de suporte. Você deve especificar os seguintes parâmetros que são obrigatórios para a criação de um tíquete de suporte: 
