...
### Exemplo 3: obter os primeiros 2 tíquetes de suporte filtrados por status
```powershell
...
### Exemplo 3: obter todos os ingressos de suporte que estiverem em estado aberto e criados após dez de 20 de dezembro de 2019
```powershell
