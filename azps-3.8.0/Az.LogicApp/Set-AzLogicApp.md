...
## DESCRITIVO
O cmdlet **set-AzLogicApp** modifica um aplicativo lógico usando o recurso de aplicativos lógicos.
...
Você pode modificar um aplicativo lógico especificando um nome, local, definição de aplicativo lógico, grupo de recursos e plano.
