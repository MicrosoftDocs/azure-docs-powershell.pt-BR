...
## DESCRITIVO
O cmdlet **New-AzIntegrationAccountCertificate** cria um certificado de conta de integração.
Esse cmdlet retorna um objeto que representa o certificado da conta de integração.
Especifique o nome da conta de integração, o nome do grupo de recursos, o nome do certificado, o nome da chave, versão da chave e a ID do cofre de chaves.
