...
## DESCRITIVO
O cmdlet Remove-AzContainerRegistry remove um registro do contêiner.

## EXEMPLOS

### Exemplo 1: remover um registro de contêiner especificado
```powershell
PS C:\>Remove-AzContainerRegistry -ResourceGroupName "MyResourceGroup" -Name "MyRegistry"
```

Esse comando Remove o registro do contêiner especificado.
