...
### Exemplo 1: atualizar um ambiente do insights série tempo do Gen1
```powershell
...
Esse comando atualiza um ambiente do insights série de tempo do Gen1.

### Exemplo 2: atualizar um ambiente do insights série tempo do Gen1
```powershell
...
### -Marca
Pares de valores chave de propriedades adicionais para o ambiente.
