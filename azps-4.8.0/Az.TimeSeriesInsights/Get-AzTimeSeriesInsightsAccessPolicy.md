...
### Exemplo 1: listar todas as políticas de acesso em um ambiente especificado
```powershell
...
Esse comando lista todas as políticas de acesso em um ambiente especificado.

### Exemplo 2: obter uma política de acesso especificada por nome
```powershell
...
Este comando obtém uma política de acesso especificada.

### Exemplo 3: obter uma política de acesso especificada por objeto
```powershell
