...
### Exemplo 1: remover um ambiente do insights série de tempo por nome
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEnvironment -ResourceGroupName testgroup -Name tsill

```

Esse comando Remove um ambiente do insights série de tempo.

### Exemplo 2: remover um ambiente do insights série de tempo por objeto
```powershell
