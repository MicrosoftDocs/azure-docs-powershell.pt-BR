...
### Exemplo 1: criar uma política de acesso para um ambiente especificado
```powershell
...
Esse comando cria uma política de acesso para um ambiente especificado.
...
### -PrincipalObjectId
O objectId do objeto de segurança no Azure Active Directory.
