...
## DESCRITIVO
Registre a configuração de manutenção do recurso.
...
Registre a configuração de manutenção para o host dedicado.
...
O nome da atribuição de configuração deve corresponder ao MaintenanceConfigurationName.
...
### -Local
O local sem espaços para o recurso.
...
A MaintenanceConfiguration totalmente qualificada.
