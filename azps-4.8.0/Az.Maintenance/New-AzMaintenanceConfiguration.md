...
Criar uma configuração de manutenção com o host de escopo
...
### -ExpirationDateTime
O expirationDateTime do cronograma no formato AAAA-MM-DD hh: mm
...
### -StartDatetime
O StartDatetime do cronograma em Format AAAA-MM-DD hh: mm
