...
## DESCRITIVO
O cmdlet **New-AzHpcCacheStorageTarget** adiciona um destino de armazenamento ao cache do Azure HPC.
...
### -CLFS
Atualize o tipo de destino de armazenamento CLFS.
...
### -Force
Indica que o cmdlet não solicita confirmação. Por padrão, esse cmdlet solicita que você confirme que deseja liberar o cache.
...
### -NFS
Atualize o tipo de destino do armazenamento NFS.
...
### -ResourceGroupName
"Nome do grupo de recursos sob o qual você deseja criar o destino de armazenamento para um determinado cache.
