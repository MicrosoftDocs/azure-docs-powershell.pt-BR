...
## DESCRITIVO
O cmdlet **Remove-AzHpcCacheStorageTarget** remove um destino de armazenamento do cache do Azure HPC.
...
### -Force
Indica que o cmdlet não solicita confirmação. Por padrão, esse cmdlet solicita que você confirme se deseja remover o destino de armazenamento.
...
### -ResourceGroupName
Nome do grupo de recursos sob o qual você deseja remover o destino de armazenamento do cache.
