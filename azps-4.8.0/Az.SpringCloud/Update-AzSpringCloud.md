...
### Exemplo 1: Atualize o serviço de nuvem Spring por nome.
```powershell
...
Atualize o serviço de nuvem da mola por nome.

### Exemplo 2: Atualize o serviço de nuvem da mola do pipe.
```powershell
...
Atualize o serviço de nuvem da mola do pipe.
