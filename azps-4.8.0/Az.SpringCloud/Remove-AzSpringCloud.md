...
### Exemplo 1: remover o serviço de nuvem Spring por nome.
```powershell
PS C:\> Remove-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service
```

Remova o serviço de nuvem Spring por nome.

### Exemplo 2: remover o serviço de nuvem Spring do pipe.
```powershell
PS C:\> Get-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service | Remove-AzSpringCloud
```

Remova o serviço de nuvem Spring do pipe.
