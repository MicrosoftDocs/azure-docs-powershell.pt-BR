...
### Exemplo 1: obter o aplicativo de nuvem Spring por nome.
```powershell
...
Obtenha o aplicativo de nuvem Spring por nome.

### Exemplo 2: listar todos o aplicativo em um determinado serviço de nuvem Spring.
```powershell
...
Liste todos os aplicativos em um determinado serviço de nuvem Spring.
...
### -SyncStatus
Indica se o status de sincronização
