...
## DESCRITIVO
O cmdlet **Remove-AzSqlElasticPool** exclui um pool elástico do banco de dados SQL do Azure.

## EXEMPLOS

### Exemplo 1: excluir um pool elástico
```
PS C:\>Remove-AzSqlElasticPool -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

Esse comando exclui um pool elástico chamado ElasticPool01.
...
### -ElasticPoolName
Especifica o nome do pool elástico que este cmdlet exclui.
