...
## DESCRITIVO
O cmdlet **Stop-AzSqlInstanceDatabaseLogReplay** descarta o banco de dados e, por isso, cancela o serviço de reprodução de log.
...
Esse comando cancelará o serviço de reprodução de logs no banco de dados fornecido.
