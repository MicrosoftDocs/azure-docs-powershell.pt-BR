...
Esse comando obtém todos os backups de retenção de longo prazo para todos os bancos de dados (que podem estar ativos ou excluídos) no northeurope, o grupo de recursos só será definido se o servidor estiver ao vivo.

### Exemplo 2: obter todos os backups para um local em um grupo de recursos
```powershell
...
Esse comando obtém todos os backups de retenção de longo prazo para todos os bancos de dados (que podem estar ativos ou excluídos) em um grupo de recursos no northeurope.
