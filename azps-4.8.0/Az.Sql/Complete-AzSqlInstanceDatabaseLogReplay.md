...
## DESCRITIVO
O cmdlet **Complete-AzSqlInstanceDatabaseLogReplay** conclui o serviço de repetição de log em um determinado banco de dados.
...
Este comando concluirá o serviço de repetição de log concluir o último backup será restaurado.
