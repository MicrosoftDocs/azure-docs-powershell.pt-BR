...
## Sinopse
Remove um signatário de política confiável para um locatário no Azure atestado.
...
## DESCRITIVO
O cmdlet Remove-AzAttestationPolicySigner remove um signatário de política confiável para um locatário no Azure atestado.
...
Remova um signatário confiável do provedor de atestado chamado *pshtest*.
...
### -Signatário
Especifica o token da Web RFC7519 JSON que contém uma declaração chamada "Maa-policyCertificate" cujo valor é uma chave da Web JSON RFC7517 que contém uma chave de assinatura confiável a ser removida.
