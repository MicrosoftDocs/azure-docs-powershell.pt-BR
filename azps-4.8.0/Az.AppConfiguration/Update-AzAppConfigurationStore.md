...
### Exemplo 1: habilitar a criptografia de dados da App conifguration Store por identidade gerenciada atribuída pelo sistema
```powershell
...
### Exemplo 2: habilitar a criptografia de dados do App conifguration Store por identidade gerenciada atribuída pelo usuário
```powershell
PS C:\> $key = Add-AzKeyVaultKey -VaultName kv-Name -Name key-Name -Destination 'Software'
...
### Exemplo 3: desabilitar a criptografia de uma loja do aplicativo conifguration.
```powershell
...
Esse comando desabilita a criptografia de uma loja de aplicativos conifguration.

### Exemplo 3: Atualize a SKU e a marca de um app conifguration Store por pipeline.
```powershell
...
Esse comando atualiza a SKU e a marca de um app conifguration Store por pipeline.
