...
## DESCRITIVO
O cmdlet **Get-AzDataShareSynchronizationSetting** fornece informações sobre a sincronização habilitada em um compartilhamento. 
...
Este comando fornece informações sobre a sincronização ShareSynchronization habilitada no compartilhamento AdsShare em WikiAds de conta de compartilhamento de dados.
...
### -Nome
Nome para a configuração de sincronização
...
### -ResourceId
A ID do recurso da configuração de sincronização do compartilhamento de dados do Azure
