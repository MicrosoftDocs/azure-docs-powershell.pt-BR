...
## DESCRITIVO
O cmdlet **Get-AzDataFactoryDataset** Obtém informações sobre conjuntos de dados no Azure data Factory.
...
Como alternativa, atribua a saída do cmdlet **Get-AzDataFactoryDataset** a uma variável e, em seguida, use a notação de ponto para exibir a propriedade Location associada ao objeto DataSet armazenado nessa variável.
