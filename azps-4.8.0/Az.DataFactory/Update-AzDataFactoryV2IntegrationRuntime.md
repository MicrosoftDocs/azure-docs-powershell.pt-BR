...
## DESCRITIVO
O cmdlet **Update-AzDataFactoryV2IntegrationRuntime** atualiza as propriedades do tempo de execução de integração. Atualmente, o cmdlet só dá suporte à atualização de ' AutoUpdate ' e ' AutoUpdateDelayOffset ' para o tempo de execução de integração de hospedagem automática.

## EXEMPLOS

### Exemplo 1: atualiza um tempo de execução de integração
```
...
O cmdlet atualiza o tempo de execução de integração de hospedagem interna chamado ' test-selfhost-IV '.

## OS

### -Atualização automática
Habilite ou desabilite a atualização automática do tempo de execução de integração de hospedagem interna.
...
O tempo em hora do dia da atualização automática do tempo de execução de integração de hospedagem interna.
