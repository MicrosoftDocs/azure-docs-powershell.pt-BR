...
Obter todas as sessões de depuração de fluxo de dados ativas pelo Azure data Factory.
...
Cria um fluxo de dados na fábrica de dados.
...
Inicia uma sessão de depuração do fluxo de dados no Azure data Factory.

### [Parar-AzDataFactoryV2IntegrationRuntime](Stop-AzDataFactoryV2IntegrationRuntime.md)
Interrompe um tempo de execução de integração dedicada gerenciado.

### [Parar-AzDataFactoryV2PipelineRun](Stop-AzDataFactoryV2PipelineRun.md)
Interrompe uma execução de pipeline em uma fábrica de dados.

### [Parar-AzDataFactoryV2Trigger](Stop-AzDataFactoryV2Trigger.md)
...
Interrompe uma sessão de depuração do fluxo de dados no Azure data Factory.
