...
## DESCRITIVO
O cmdlet Remove-AzEventHubAuthorizationRule remove e exclui a regra de autorização especificada do hub de eventos fornecido.
...
Remove a regra de autorização \` MyAuthRuleName \` da MyEventHubName do hub de eventos \` \` .
