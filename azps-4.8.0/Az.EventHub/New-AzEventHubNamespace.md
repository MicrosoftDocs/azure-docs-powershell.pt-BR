...
## DESCRITIVO
O cmdlet New-AzEventHubNamespace cria um novo namespace de hubs de eventos de tipo.
...
### Exemplo 4: namespace habilitado para ZoneRedundant
```powershell
...
### Exemplo 5: criando namespace com gerenciar identidade em um cluster 
```powershell
...
### -ClusterARMId
ID do braço do cluster onde o namespace deve ser criado
...
### -Identidade
habilitar ou desabilitar a identidade do namespace
...
### -ZoneRedundant
Habilitando ou desabilitando a zona redundante para namespace
