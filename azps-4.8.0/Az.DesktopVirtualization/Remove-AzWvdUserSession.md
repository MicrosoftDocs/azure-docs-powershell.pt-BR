...
### Exemplo 1: excluir um usersession de área de trabalho virtual do Windows por nome
```powershell
...
Esse comando exclui uma sessão do userdesktop virtual do Windows em um host de sessão.
...
### -Force
Force o sinalizador a fazer logon no usersession.
