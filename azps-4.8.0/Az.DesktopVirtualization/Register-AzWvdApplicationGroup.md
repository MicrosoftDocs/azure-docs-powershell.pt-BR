...
### Exemplo 1: registrar um grupo de aplicativos de área de trabalho virtual do Windows
```powershell
...
Esse comando registra um grupo de aplicativos de área de trabalho virtual do Windows em um espaço de trabalho.

## OS

### -ApplicationGroupPath
Caminho ApplicationGroupPath
