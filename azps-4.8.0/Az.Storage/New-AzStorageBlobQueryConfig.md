...
### Exemplo 1: criar uma consulta de blob configura e consulta um blob
```powershell
...
Esse comando primeiro cria o objeto de configuração de entrada como CSV e o objeto de configuração de saída como JSON e, em seguida, use as duas configurações para o blob de consulta.

## OS

### -AsCsv
Indicar a criação de uma configuração de consulta de BLOB para CSV.
...
### -Asjson
Indicar a criação de uma configuração de consulta de BLOB para JSON.
...
### -EscapeCharacter
Adicionais.
O caractere usado como um caractere de escape.
...
### -HasHeader
Adicionais.
Indicar que os dados têm cabeçalhos.
...
### -QuotationCharacter
Adicionais.
O caractere usado para citar um campo específico.
...
### -RecordSeparator
Adicionais.
A cadeia de caracteres usada para separar os registros.
