...
## Sinopse
Exclui a vNetPeering do espaço de trabalho.
...
### Exemplo 1: remover um emparelhamento via rede virtual de Bricks por nome
```powershell
PS C:\> Remove-AzDatabricksVNetPeering -WorkspaceName databricks-test01 -ResourceGroupName lucas-manual-test -Name vnetpeering-t01

```

Esse comando Remove um emparelhamento de rede virtual de Bricks por nome

### Exemplo 2: remover um emparelhamento via rede virtual de Bricks por objeto
```powershell
PS C:\> Get-AzDatabricksVNetPeering -ResourceGroupName lucas-manual-test -WorkspaceName databricks-test01 -PeeringName MyPeering-test01 | Remove-AzDatabricksVNetPeering

```

Esse comando Remove um emparelhamento de rede virtual de Bricks por objeto
