...
### UnlimitedBandwidthParameterSet (padrão)
```
...
## DESCRITIVO
O cmdlet **New-AzStackEdgeBandwidthSchedule** cria uma nova programação de largura de banda para um dispositivo de borda de pilha para ajudar a gerenciar o uso de largura de banda.
...
### -UnlimitedBandwidth
Definirá a largura de banda como ilimitada
