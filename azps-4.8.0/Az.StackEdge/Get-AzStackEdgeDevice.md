...
### -ExtendedInfo
Obtém informações adicionais para o dispositivo de gateway Edge/Stack de pilha especificado
...
### -NetworkSetting
Obtém as configurações de rede do dispositivo de gateway de pilha/pilha especificado da pilha
