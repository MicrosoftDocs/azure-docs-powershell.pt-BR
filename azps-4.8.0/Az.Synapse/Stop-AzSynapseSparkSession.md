...
## DESCRITIVO
O cmdlet **Stop-AzSynapseSparkSession** interrompe uma sessão do Spark analítico do Synapse.
...
Esse comando interrompe uma sessão do Spark analítico do Synapse.
...
Esse comando interrompe uma sessão do Spark do Synapse Analytics pelo pipeline.
