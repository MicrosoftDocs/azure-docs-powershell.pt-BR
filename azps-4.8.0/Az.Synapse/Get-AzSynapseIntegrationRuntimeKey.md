...
## DESCRITIVO
O cmdlet **Get-AzSynapseIntegrationRuntimeKey** Obtém chaves para um tempo de execução de integração. As chaves são usadas para registrar um nó do tempo de execução de integração.
