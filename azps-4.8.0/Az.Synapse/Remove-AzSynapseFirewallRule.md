...
## DESCRITIVO
O cmdlet **Remove-AzSynapseFirewallRule** exclui permanentemente uma regra de firewall de análise do Azure Synapse.
...
Esse comando exclui a regra de firewall chamada ContosoFirewallRule em espaço de trabalho ContosoWorkspace com o nome ContosoFirewallRule.
...
Esse comando exclui a regra de firewall chamada ContosoFirewallRule em um espaço de trabalho por meio do pipeline.
