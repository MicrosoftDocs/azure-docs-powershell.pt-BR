...
## DESCRITIVO
O cmdlet **Update-AzSynapseIntegrationRuntime** atualiza as propriedades do tempo de execução de integração. Atualmente, o cmdlet só dá suporte à atualização de ' AutoUpdate ' e ' AutoUpdateDelayOffset ' para o tempo de execução de integração de hospedagem automática.
...
A hora do dia da atualização automática do tempo de execução de integração de hospedagem interna.
