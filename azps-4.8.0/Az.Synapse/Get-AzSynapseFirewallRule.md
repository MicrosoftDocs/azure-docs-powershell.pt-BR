...
## DESCRITIVO
O cmdlet **Get-AzSynapseFirewallRule** Obtém uma regra de firewall de análise do Azure Synapse.
Se você não especificar um nome de regra, este cmdlet obterá todas as regras.
...
Esse comando obtém todas as regras de firewall em um espaço de trabalho.
...
Esse comando obtém a regra de firewall em ContosoWorkspace do espaço de trabalho com o nome ContosoFirewallRule.
...
Esse comando obtém todas as regras de firewall em um espaço de trabalho por meio do pipeline.
