...
## DESCRITIVO
O cmdlet **Remove-AzSynapseSparkSessionTimeout** redefine o tempo limite de uma sessão do Spark analítico do Synapse.
...
Este comando redefine o tempo limite da sessão do Spark da análise Synapse com a ID Livy especificada.
...
Este comando redefine o tempo limite da sessão do Spark da análise Synapse com a ID Livy especificada por meio do pipeline.
