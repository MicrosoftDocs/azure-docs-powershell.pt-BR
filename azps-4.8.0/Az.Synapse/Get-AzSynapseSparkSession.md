...
## DESCRITIVO
O cmdlet **Get-AzSynapseSparkSession** Obtém informações sobre uma sessão do Spark do Azure Synapse Analytics.
...
Esse comando obtém todas as sessões do Spark no pool do Spark especificado.
...
Este comando obtém a sessão do Spark com a ID Livy especificada.
...
Esse comando obtém todas as sessões do Spark no pool do Spark especificado por meio do pipeline.

## OS

### -ApplicationId
O identificador de aplicativo da sessão.
