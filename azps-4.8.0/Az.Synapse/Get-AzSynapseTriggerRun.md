...
## DESCRITIVO
O comando **Get-AzSynapseTriggerRun** retorna informações detalhadas sobre execuções de gatilho para o gatilho especificado no período de tempo especificado.
...
Esse comando mostra informações sobre execuções de ContosoTrigger no espaço de trabalho ContosoWorkspace que começou entre "2018-09-01T21:00" e "2019-09-01T21:00".
...
Esse comando mostra informações sobre execuções de ContosoTrigger no espaço de trabalho ContosoWorkspace que começou entre "2018-09-01T21:00" e "2019-09-01T21:00" por meio do pipeline.
