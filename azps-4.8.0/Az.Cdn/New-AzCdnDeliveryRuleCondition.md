...
### -MatchVariable
Corresponde à variável da condição.
...
### -Seletor
Nome do seletor a ser correspondido
...
### -Transform
Transformação a ser aplicada antes da correspondência.
Os valores possíveis são minúsculas e maiúsculas
