...
## DESCRITIVO
O cmdlet **UNPUBLISH-AzCdnEndpointContent** limpa o conteúdo de um ponto de extremidade da CDN (rede de distribuição de conteúdo) do Azure.
...
### -CdnEndpoint
Especifica o ponto de extremidade que este cmdlet limpa.
...
### -EndpointName
Especifica o nome do ponto de extremidade que este cmdlet limpa.
...
### -PurgeContent
Especifica uma matriz de caminhos relativos para o conteúdo do servidor de origem que este cmdlet limpa.
