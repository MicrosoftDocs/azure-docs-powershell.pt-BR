...
## DESCRITIVO
O cmdlet **Get-AzCdnProfileSupportedOptimizationType** Obtém os tipos de otimização com suporte para o perfil atual. Um usuário pode criar um ponto de extremidade com um tipo de otimização dos valores listados.
...
Obter os tipos de otimização compatíveis para um perfil CDN.
