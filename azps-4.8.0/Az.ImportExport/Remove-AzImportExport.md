...
Somente os trabalhos nos Estados criando ou concluídos podem ser excluídos.
...
### Exemplo 1: remover o trabalho do ImportExport por meio da Resource e do nome do servidor
```powershell
PS C:\> Remove-AzImportExport -Name test-job -ResourceGroupName ImportTestRG
```

Esse cmdlet Remove o trabalho do ImportExport por meio da Resource e do nome do servidor.
