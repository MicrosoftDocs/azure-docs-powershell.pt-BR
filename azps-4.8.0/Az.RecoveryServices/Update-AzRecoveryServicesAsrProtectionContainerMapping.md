...
## DESCRITIVO
O cmdlet **Update-AzRecoveryServicesAsrProtectionContainerMapping** atualiza o mapeamento de contêiner da proteção do Azure site Recovery especificado.
...
### -AutomationAccountId
Especifica a conta de automação usada para a udpate automática.
...
### -AzureToAzure
Especifica o contêiner de proteção do Azure para o Azure.
...
### -DisableAutoUpdate
Parâmetro de opção para desabilitar a atualização automática.
...
### -EnableAutoUpdate
Parâmetro de alternância para habilitar a atualização automática.
