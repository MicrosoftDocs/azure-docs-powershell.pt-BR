...
Esse cmdlet também pode excluir pontos de recuperação existentes para o item de backup, se for executado com o parâmetro RemoveRecoveryPoints.
...
Desabilita a proteção para um item protegido por backup. (gerado automaticamente)
