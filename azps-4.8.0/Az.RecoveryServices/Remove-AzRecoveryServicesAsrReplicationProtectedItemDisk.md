...
## DESCRITIVO
O cmdlet **Remove-AzRecoveryServicesAsrReplicationProtectedItemDisk** remove o disco do item protegido de replicação ASR.
...
Inicie a operação para remover o disco especificado da VM de proteção para disco não gerenciado.
...
Inicia a operação para remover o disco especificado e retorna o trabalho ASR usado para acompanhar a operação remover disco protegido.
...
### -DiskId
Especifica a lista de IDs de disco gerenciados.
...
### -InputObject
O objeto de entrada para o cmdlet: o objeto de item protegido da replicação ASR correspondente ao disco que será removido.
...
### -VhdUri
Especifica a lista de URIs do VHD.
