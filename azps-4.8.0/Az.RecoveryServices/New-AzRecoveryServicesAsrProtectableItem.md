...
## DESCRITIVO
O **New-AzRecoveryServicesAsrProtectableItem** adiciona um novo item de proteção à lista de itens que protegem os itens que protegem em um contêiner de proteção em uma malha ASR (aplicável somente para o tipo de malha do VMware).

## EXEMPLOS

### Exemplo 1

Adicione (descubra) um servidor físico à lista de itens que protegem. (gerado automaticamente)
...
### -FriendlyName
Nome amigável do item de proteção.
...
### -IPAddress
Endereço IP do item de proteção.
...
### -OSType
Tipo de sistema operacional (Windows/Linux) do item de proteção.
...
### -ProtectionContainer
Objeto de contêiner de proteção ASR ao qual o item que pode ser protegido deve ser adicionado.
...
### -Confirme
Solicite confirmação antes de executar o cmdlet.
