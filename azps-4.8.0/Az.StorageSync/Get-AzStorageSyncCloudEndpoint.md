...
## DESCRITIVO
Esse comando lista todos os pontos de extremidade da nuvem em um determinado grupo de sincronização. Ele também pode ser usado para listar os atributos de cada ponto de extremidade da nuvem.
...
Esse comando obtém todos os pontos de extremidade da nuvem contidos no grupo de sincronização especificado. Especifique-CloudEndpointName para retornar um específico.
