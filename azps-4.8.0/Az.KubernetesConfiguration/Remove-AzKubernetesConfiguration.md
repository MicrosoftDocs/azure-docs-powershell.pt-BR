...
## Sinopse
Isso excluirá o arquivo YAML usado para configurar a configuração do controle do código-fonte, por isso interrompendo a sincronização futura do repositório de origem.
...
### Exemplo 1: remover um configuation do cluster kubernetes por nome
```powershell
...
Esse comando Remove um configuation do cluster kubernetes por nome.

### Exemplo 2: remover um configuation do cluster do kubernetes por objeto
```powershell
...
Esse comando Remove um configuation do cluster kubernetes por objeto.
