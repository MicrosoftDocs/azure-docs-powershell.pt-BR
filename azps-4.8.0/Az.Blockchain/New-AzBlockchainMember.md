...
### Exemplo 1: criar um novo membro de blockchain
```powershell
...
Esse comando cria um novo membro blockchain.
...
### -Consortium
Obtém ou define o consórcio para o membro blockchain.
...
Define a senha da conta de gerenciamento do consórcio gerenciado.
...
Obtém o nome de exibição do membro no consórcio.
...
### -ConsortiumRole
Obtém a função do membro no consórcio.
...
### -FirewallRule
Obtém ou define as regras de firewall a serem construídas, consulte a seção observações para FIREWALLRULE Propriedades e criar uma tabela de hash.
...
### -Local
A localização geográfica do serviço blockchain.
...
### -Senha
Define a senha de autenticação básica do membro blockchain.
...
### -Protocolo
Obtém ou define o protocolo blockchain.
...
### -SkuTier
Obtém ou define a camada de SKU
...
Obtém ou define a capacidade dos nós.
...
FIREWALLRULE <IFirewallRule [] >: Obtém ou define regras de firewall
