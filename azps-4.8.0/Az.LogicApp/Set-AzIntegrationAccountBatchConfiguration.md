...
## Sinopse
Modifica uma configuração em lotes da conta de integração.

## SYNTAX

### ByIntegrationAccountAndParameters (padrão)
```
...
## DESCRITIVO
O cmdlet **set-AzIntegrationAccountBatchConfiguration** modifica uma configuração em lotes da conta de integração.

## EXEMPLOS

### Exemplo 1: modificar uma configuração em lotes usando um arquivo local
```powershell
...
Modifique uma configuração em lotes chamada "sampleBatchConfig" usando o arquivo local localizado no caminho do arquivo contido em "$batchConfigurationFilePath".

### Exemplo 2: modificar uma configuração em lotes usando uma cadeia de caracteres JSON
```powershell
...
Modifique uma configuração em lotes chamada "sampleBatchConfig" usando a cadeia de caracteres JSON contida em "$batchConfigurationContent".

### Exemplo 3: modificar uma configuração em lotes usando parâmetros
```powershell
...
Modifique uma configuração em lotes chamada "sampleBatchConfig" fornecendo manualmente todos os parâmetros necessários.

## OS

### -BatchConfigurationDefinition
A definição de configuração em lotes da conta de integração.
...
O caminho do arquivo de configuração em lotes da conta de integração.
...
### -BatchGroupName
O nome do grupo de configuração em lotes da conta de integração.
...
### -BatchSize
O tamanho do lote de configuração em lotes da conta de integração.
...
### -InputObject
Uma configuração em lotes da conta de integração.
...
### -MessageCount
A contagem de mensagens de configuração em lotes da conta de integração.
...
### -Metadados
Metadados de configuração em lotes da conta de integração.
...
### -Nome
O nome de configuração em lotes da conta de integração.
...
### -ResourceId
A ID do recurso de configuração em lotes da conta de integração.
...
### -ScheduleFrequency
A frequência de agendamento da configuração em lotes da conta de integração.
...
### -ScheduleInterval
O intervalo de agendamento de configuração em lotes da conta de integração.
...
### -ScheduleStartTime
A hora de início da agenda de configuração em lotes da conta de integração.
...
### -ScheduleTimeZone
O fuso horário da agenda de configuração em lotes da conta de integração.
