...
Esse comando Remove uma configuração de nome de host de gateway existente e não solicita confirmação pelo usuário.
...
Identificador da configuração de nome do host de gateway existente.
Esse parâmetro é obrigatório.
...
### -InputObject
Instância do PsApiManagementGatewayHostnameConfiguration. Esse parâmetro é obrigatório.
...
### -ResourceId
Resourcebinding do GatewayHostnameConfiguration. Esse parâmetro é obrigatório.
