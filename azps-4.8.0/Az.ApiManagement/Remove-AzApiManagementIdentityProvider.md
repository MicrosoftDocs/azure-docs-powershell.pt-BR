...
### Exemplo 1: remove as configurações do provedor de identidade do Facebook do serviço ApiManagement
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementIdentityProvider -Context $apimContext -Type 'Facebook' -PassThru
```

Exclui a configuração relacionada à configuração do provedor de identidade do Facebook.
...
### -PassThru
Indica que esse cmdlet retorna um valor de $True se a operação for bem-sucedida ou $False caso contrário.
