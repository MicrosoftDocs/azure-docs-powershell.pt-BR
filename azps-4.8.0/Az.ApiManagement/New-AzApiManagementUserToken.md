...
### Exemplo 1: gerar um token de acesso compartilhado para usuário git
```powershell
...
Esse script Obtém o usuário git configurado no serviço ApiManagement e gera um token de acesso compartilhado usando a chave primária válida por 8 horas.
...
### -Vencimento
Vencimento do token.
Se não for especificado, o token será criado para expirar após 8 horas.
...
### -KeyType
Chave de usuário a ser usada ao gerar o token.
Este parâmetro é opcional.
...
### -UserId
Identificador do usuário existente.
Esse parâmetro é obrigatório.
...
### Microsoft. Azure. Commands. ApiManagement. onmanagement. Models. PsApiManagementUserKeyType

### System. Nullable ' 1 [[System. DateTime, mscorlib, Version = 4.0.0.0, Culture = neutral, PublicKeyToken = b77a5c561934e089]]

## EXIBE

### Microsoft. Azure. Commands. ApiManagement. onmanagement. Models. PsApiManagementUserToken
