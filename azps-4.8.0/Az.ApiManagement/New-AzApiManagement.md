...
Esse comando cria um serviço de gerenciamento de API de camada de consumo com certificado de cliente habilitado na Europa Ocidental.
...
### Exemplo 6: criar um serviço de gerenciamento de API e habilitar o protocolo TLS 1,0
```powershell
...
Esse comando cria um serviço de gerenciamento de API de SKU padrão e habilita o TLS 1,0 no cliente de front-end para o gateway ApiManagement e o cliente back-end entre gateway ApiManagement e back-end.
...
### -EnableClientCertificate
Somente sinalizador deve ser usado para o serviço de ApiManagement de SKU de consumo. Isso impõe que um certificado de cliente seja apresentado em cada solicitação ao gateway. Isso também permite a capacidade de autenticar o certificado na política no gateway.
...
Atribua identidades de usuários a este servidor para uso com os serviços de gerenciamento de chaves, como o keyvault do Azure.
