...
## DESCRITIVO
O cmdlet **Add-AzApiManagementApiToGateway** adiciona uma API de gerenciamento de API do Azure a um gateway.
...
Esse comando adiciona a API especificada ao gateway especificado.
...
### -ProvisioningState
Estado de provisionamento (criado).
Este parâmetro é opcional.
...
### System. Nullable ' 1 [[Microsoft. Azure. Commands. ApiManagement. Management. Models. PsApiManagementGatewayApiProvisioningState, Microsoft. Azure. PowerShell. cmdlets. ApiManagement. immanagement, Version = 2.0.1.0, Culture = neutral, PublicKeyToken = null]]
