...
## DESCRITIVO
O cmdlet **Get-AzConsumptionPriceSheet** Obtém planilhas de preço da assinatura.

## EXEMPLOS

### Exemplo 1: obter planilhas de preços
```powershell
...
### Exemplo 3: obter planilhas de preço do BillingPeriodName
```powershell
...
### Exemplo 4: obter os cinco registros principais de planilhas de preços
```powershell
...
### -BillingPeriodName
Nome de um período de cobrança específico para obter as folhas de preço associadas.
...
### -ExpandMeterDetail
Expanda as folhas de preços com base em MeterDetails.
...
### Microsoft. Azure. Commands. consumo. Models. PSPriceSheet
