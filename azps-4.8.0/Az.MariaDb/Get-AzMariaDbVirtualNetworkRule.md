...
### Exemplo 1: listar todas as regras de rede virtual em um MariaDB
```powershell
...
Esse comando lista todas as regras de rede virtual em um MariaDB.

### Exemplo 2: obter regra de rede virtual em um MariaDB
```powershell
...
Esse comando obtém uma regra de rede virtual em um MariaDB.
