...
## DESCRITIVO
O cmdlet Set-AzContext define informações de autenticação para cmdlets que você executa na sessão atual.
...
### -Assinatura
O nome ou a ID da assinatura à qual o contexto deve ser definido. Esse parâmetro tem aliases para-Subscriptionname e-SubscriptionId, portanto, para maior clareza, qualquer um deles pode ser usado em vez de-assinatura ao especificar o nome e a ID, respectivamente.
