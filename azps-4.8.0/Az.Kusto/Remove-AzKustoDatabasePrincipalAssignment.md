...
### Exemplo 1: excluir um banco de dados do Kusto existente PrincipalAssignment por nome
```powershell
...
O comando acima exclui o PrincipalAssignment chamado "kustoprincipal1" no banco de dados do Kusto "mykustodatabase".
