...
### Exemplo 1: listar todos os principalAssignment de cluster Kusto
```powershell
...
O comando acima lista todos os principalAssignment no cluster "testnewkustocluster".

### Exemplo 2: Obtém um Kusto de cluster de principalAssignment por nome
```powershell
...
O comando acima retorna o Kusto de cluster principalAssignment chamado "kustoprincipal1" no cluster "testnewkustocluster".
