...
### Exemplo 1: criar um banco de dados de cluster Kusto principalAssignment
```powershell
...
O comando acima cria um banco de dados de cluster Kusto principalAssignment
...
A ID da entidade de segurança atribuída à entidade do banco de dados.
Pode ser um email do usuário, ID do aplicativo ou nome do grupo de segurança.
...
### -Função
Função de entidade do banco de dados.
...
### -Tenantid
A ID do locatário do principal
