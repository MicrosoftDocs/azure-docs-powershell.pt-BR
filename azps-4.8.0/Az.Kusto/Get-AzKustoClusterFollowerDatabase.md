...
### Exemplo 1: lista todos os bancos de dados seguidos
```powershell
...
O comando acima lista todos os bancos de dados pertencentes a esse cluster e que foram seguidos por outro cluster.
