...
## DESCRITIVO
O cmdlet **Get-AzSearchQueryKey** Obtém a (s) chave (s) de consulta do serviço de pesquisa do Azure.
...
O exemplo obtém todas as chaves de consulta do serviço de pesquisa do Azure.
