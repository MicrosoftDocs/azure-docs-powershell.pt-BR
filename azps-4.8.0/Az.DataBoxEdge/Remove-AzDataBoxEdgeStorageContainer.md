...
## DESCRITIVO
O cmdlet **Remove-AzDataBoxEdgeStorageContainer** remove um contêiner de armazenamento associado da conta de armazenamento de borda em um dispositivo de borda de caixa de dados. Você pode especificar o nome do contêiner de armazenamento a ser removido como um parâmetro.
