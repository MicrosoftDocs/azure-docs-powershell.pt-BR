...
## DESCRITIVO
O cmdlet **New-AzDataBoxEdgeStorageAccountCredential** cria uma nova credencial de conta de armazenamento de borda para um dispositivo de borda de caixa de dados.
...
### -StorageAccountType
Possível tipo de acesso de armazenamento GeneralPurposeStorage, BlockStorage
