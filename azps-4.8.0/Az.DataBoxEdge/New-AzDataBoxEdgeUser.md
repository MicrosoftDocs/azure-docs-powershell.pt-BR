...
## DESCRITIVO
O cmdlet **New-AzDataBoxEdgeUser** cria um novo usuário para o dispositivo de borda da caixa de dados. Só há suporte para a criação de usuários do tipo `Share` .
