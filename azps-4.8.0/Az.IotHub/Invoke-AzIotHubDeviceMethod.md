...
## DESCRITIVO
Invocar um método direto em um dispositivo. Consulte https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods para obter mais informações.
...
### -ConnectionTimeOut
Número de segundos para esperar até que uma conexão seja feita com êxito.
O padrão é 10.
...
### -Nome
O nome do método a ser invocado nesse dispositivo.
...
### -Payload
A carga do método a ser invocado nesse dispositivo.
...
### -ResponseTimeOut
Número de segundos para esperar até que um resultado seja recebido do método direto.
O padrão é 10.
