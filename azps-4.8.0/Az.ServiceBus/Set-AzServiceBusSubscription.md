...
## DESCRITIVO
O cmdlet **set-AzServiceBusSubscription** atualiza a descrição da assinatura para o tópico de barramento de serviço no namespace de barramento de serviço especificado.
...
Atualiza a descrição da assinatura especificada para o tópico fornecido. Este exemplo atualiza a propriedade **DeadLetteringOnMessageExpiration** para **true** e **MaxDeliveryCount** para 9.
...
### -InputObject
Definição da assinatura do ServiceBus.
