...
## Cmdlets AZ. ServiceBus
### [Concluir-AzServiceBusMigration](Complete-AzServiceBusMigration.md)
...
Gera uma tolen SAS para a regra de autorização do Azure serviucebus de namespace/fila/tópico. 
...
### [Parar-AzServiceBusMigration](Stop-AzServiceBusMigration.md)
{{Preencher o resumo}}
