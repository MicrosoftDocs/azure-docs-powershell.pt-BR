...
---
# Módulo AZ. Automation
## Descritivo
Este tópico exibe os tópicos da ajuda para os cmdlets de automação do Azure.

## Cmdlets AZ. Automation
...
Obtém informações de registro para a integração de um nó DSC ou um trabalhador híbrido à automação.
...
Obtém a saída de um trabalho de sincronização do controle de origem de automação do Azure.
...
Registra uma máquina virtual do Azure como um nó DSC para uma conta de automação.
...
Remove um controle de origem da automação do Azure.
...
Modifica uma variável de automação.
...
Inicia um trabalho de sincronização do controle de origem de automação do Azure.

### [Parar-AzAutomationDscNodeConfigurationDeployment](Stop-AzAutomationDscNodeConfigurationDeployment.md)
Interrompe a implantação da configuração do nó DSC na automação. Ele somente interrompe o trabalho de implantação atual, mas não atribui configurações de nó já atribuídas.
