...
## Sinopse
Atualize um HSM exclusivo na assinatura especificada.
...
### Exemplo 1: atualizar a marca de parâmetro do HSM dedicado por nome
```powershell
...
Esse comando atualiza a marca de parâmetro do HSM dedicado por nome
...
Esse comando atualiza a marca de parâmetro do HSM dedicado por objeto
