...
## DESCRITIVO
Remova uma conta do CosmosDB com um nome específico em um determinado nome de Resource.
...
A conta com o nome de conta dbname no nome de conta de Resource é excluída. 
...
### -InputObject
O objeto da conta de banco de dados
