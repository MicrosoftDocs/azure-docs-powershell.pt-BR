...
## Sinopse
Obtém um espaço de CosmosDB Cassandra.
...
## DESCRITIVO
O cmdlet **Get-AzCosmosDBCassandraKeyspace** cria um novo ou atualiza um espaço keyCosmosDB Cassandra existente.
...
Get-AzCosmosDBCassandraKeyspace Obtém as propriedades de um CassandraKeyspace existente. Você pode expandir o recurso para obter as propriedades _etag, _ts _rid.
