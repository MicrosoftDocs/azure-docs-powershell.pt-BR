...
Esse comando cria uma nova implantação no escopo do locatário atual usando um modelo personalizado e um arquivo de modelo no disco, com o parâmetro Tags definidas.
