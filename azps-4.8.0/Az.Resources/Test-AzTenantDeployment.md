...
## DESCRITIVO
O cmdlet **Test-AzTenantDeployment** determina se um modelo de implantação e seus valores de parâmetro são válidos no escopo do locatário atual.
...
Esse comando testa a implantação no escopo do locatário atual usando o arquivo de modelo e o arquivo de parâmetros fornecido.
...
Esse comando testa a implantação no escopo do locatário atual usando uma Hashtable na memória criada a partir do arquivo de modelo específico e um arquivo de parâmetro.
