...
## Sinopse
Cancela um trabalho em andamento do databox se o trabalho estiver em estado cancelável.
...
## DESCRITIVO
O cmdlet **Stop-AzDataBoxJob** é usado para cancelar um trabalho do databox.
...
Cancela o trabalho databox especificado
...
Cancela o trabalho do databox especificado à força sem confirmação
...
### -InputObject
InputObject do tipo PSDataBoxJob
