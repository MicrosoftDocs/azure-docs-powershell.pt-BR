...
Atualize a política de alocação para "geolatência" de um serviço de provisionamento de dispositivo Hub do Azure IoT "myiotdps".
...
Adicionar " @tags " à marca de um serviço de provisionamento de dispositivo Hub IOT do Azure "myiotdps".
...
Excluir marca e adicionar novo " @tags " à marca de um serviço de provisionamento de dispositivo Hub do Azure IOT "myiotdps" usando o pipeline.
...
### -Redefinir
Redefinir as marcas do serviço de provisionamento de dispositivo IoT
...
### -Marca
Coleção de marcas do serviço de provisionamento de dispositivo IoT
