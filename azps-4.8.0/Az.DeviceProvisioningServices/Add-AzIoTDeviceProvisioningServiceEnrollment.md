...
## DESCRITIVO
Crie um registro de dispositivo em um serviço de provisionamento de dispositivo Hub IoT do Azure.
...
Crie um registro com atestado TPM.
...
Crie um registro com o tipo de atestado SymmetricKey e o estado de "bitexto inicial".

## OS

### -AllocationPolicy
Tipo de atribuição do dispositivo atribuído ao Hub.
...
### -Desejado
Propriedades desejadas de a "a) inicial.
...
Use a lista separada por espaços para vários hubs IoT.
...
### -PrimaryCAName
O nome do certificado da CA raiz primária.
Se o atestado com um certificado de CA raiz for necessário, será necessário fornecer um nome de autoridade de certificação raiz.
...
### -PrimaryKey
A chave de acesso compartilhado simétrico principal armazenada no formato base64.
...
### -RegistrationId
ID de registro de inscrição individual.
...
### -ReprovisionPolicy
Dados do dispositivo a serem manuseados no reprovisionamento para um hub IOT diferente.
...
### -RootCertificate
Permite criar X509attestation usando certificados raiz.
...
### -SecondaryCAName
O nome do certificado da autoridade de certificação raiz secundária.
Se o atestado com um certificado de CA raiz for necessário, será necessário fornecer um nome de autoridade de certificação raiz.
...
### -SecondaryKey
A chave de acesso compartilhado simétrico secundário armazenada no formato base64.
...
### -Marca
Rótulos de rótulos de cima iniciais.
