...
## DESCRITIVO
O cmdlet **Update-AzCognitiveServicesAccountNetworkRuleSet** atualiza a propriedade NetworkRule de uma conta de serviços cognitivas
...
### Exemplo 3: limpar regras de NetworkRule de uma conta de serviços cognitiva
```
...
Este comando limpa as regras de NetworkRule de uma conta de serviços cognitiva (outras propriedades não são alteradas).

## OS

### -DefaultAction
Conta de serviços cognitiva NetworkRule DefaultAction. Valor padrão `Deny` .
...
### Microsoft. Azure. Commands. Management. Cognitivaservices. Models. PSNetworkRuleSet
