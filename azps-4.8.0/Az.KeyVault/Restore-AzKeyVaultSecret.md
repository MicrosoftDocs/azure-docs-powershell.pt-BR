...
## DESCRITIVO
O cmdlet **Restore-AzKeyVaultSecret** cria um segredo no cofre de chaves especificado.
...
Esse comando restaura um segredo, incluindo todas as suas versões, do arquivo de backup chamado backup. blob no cofre de chaves chamado contoso.
