...
## DESCRITIVO
O cmdlet **Add-AzKeyVaultCertificate** inicia o processo de registrar um certificado em um cofre de chaves no cofre de chaves do Azure.
...
O primeiro comando usa o cmdlet New-AzKeyVaultCertificatePolicy para criar uma política de certificado e, em seguida, armazena-o na variável $Policy.
O segundo comando usa **Add-AzKeyVaultCertificate** para iniciar o processo de criação de um certificado.
O terceiro comando usa o cmdlet Get-AzKeyVaultCertificateOperation para sondar a operação e verificar se ela está completa.
O comando final usa o cmdlet Get-AzKeyVaultCertificate para obter o certificado.
