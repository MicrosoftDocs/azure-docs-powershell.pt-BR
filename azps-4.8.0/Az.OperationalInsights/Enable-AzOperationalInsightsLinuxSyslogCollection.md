...
## DESCRITIVO
O cmdlet **Enable-AzOperationalInsightsLinuxSyslogCollection** inicia a coleta de dados de syslog de computadores Linux conectados em um espaço de trabalho.
