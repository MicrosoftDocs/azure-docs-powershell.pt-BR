...
## DESCRITIVO
O cmdlet **New-AzOperationalInsightsComputerGroup** cria um grupo de computadores em um grupo de recursos e local.

## EXEMPLOS

### Exemplo 1

Cria um grupo de computadores. (gerado automaticamente)
