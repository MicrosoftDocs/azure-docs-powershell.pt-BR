...
cluster de links para espaço de trabalho
...
### -ResourceId
A ID do recurso que será vinculado ao espaço de trabalho.
...
O cluster deve ter o estado de provisionamento "bem-sucedido" e as propriedades válidas do keyvault.
