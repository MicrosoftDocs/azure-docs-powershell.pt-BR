...
## DESCRITIVO
**Get-AzWebAppSlotMetric** Obtém métricas do aplicativo Web para o slot especificado.
...
Este comando recebe a solicitação do aplicativo Web especificado por minuto (PT1M-Poll time 1 minuto) entre StartTime e EndTime
