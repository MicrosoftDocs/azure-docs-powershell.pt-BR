...
Obtém as configurações de restrição de acesso de um aplicativo Web do Azure.

### [Update-AzWebAppAccessRestrictionConfig](Update-AzWebAppAccessRestrictionConfig.md)
Atualize a configuração de herança de site do SCM para um aplicativo Web do Azure.

### [Add-AzWebAppAccessRestrictionRule](Add-AzWebAppAccessRestrictionRule.md)
Adiciona uma restrição de acesso a um aplicativo Web do Azure.

### [Remove-AzWebAppAccessRestrictionRule](Remove-AzWebAppAccessRestrictionRule.md)
Remove uma restrição de acesso para um aplicativo Web do Azure