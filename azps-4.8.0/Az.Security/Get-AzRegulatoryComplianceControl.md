...
## DESCRITIVO
Obtenha um controle spcific detalhes ou liste todos os controles em padrão de conformidade normativa específica.
...
Obtenha todos os controles sob o padrão normativo específico.
...
Obter detalhes de controle específicos de acordo com a ID de controle.
...
Obter detalhes de controle específicos de acordo com a ID do recurso.
