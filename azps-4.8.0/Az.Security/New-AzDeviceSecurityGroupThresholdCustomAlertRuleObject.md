...
## DESCRITIVO
O cmdlet New-AzDeviceSecurityGroupThresholdCustomAlertRuleObject cria uma nova lista de regras de alerta personalizadas de limite para o grupo de segurança de dispositivos na solução de segurança IoT.
...
Criar nova regra de alerta personalizado de limite do tipo "SomeRuleType" com o status habilitado para valores Ant para o limite mínimo e máximo
