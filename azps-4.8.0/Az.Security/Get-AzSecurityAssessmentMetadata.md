...
## DESCRITIVO
Obtém tipos de avaliações de segurança e metadta em uma assinatura. Os metadados de avaliação de segurança incluem avaliações Built-In e tipos de avaliação personalizados que o usuário pode definir.
