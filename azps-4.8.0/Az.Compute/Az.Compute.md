...
# Módulo AZ. Compute
## Descritivo
Este tópico exibe os tópicos da ajuda para os cmdlets de computação do Azure.
...
Adiciona um disco de dados a um objeto de imagem.
...
Adiciona as chaves públicas do SSH para uma máquina virtual, ao criar apenas a VM.
...
Exportar logs que mostram solicitações de API feitas por essa assinatura na janela de tempo determinada para mostrar as atividades de limitação.
...
Obtém as propriedades de acessos a disco
...
Obter ou lista galerias.

### [Get-AzGalleryImageDefinition](Get-AzGalleryImageDefinition.md)
Obter ou listar definições de imagem da galeria.
...
Mostra o status de criptografia do disco de um conjunto de escala de VM.
...
Concede um acesso a um disco.

### [Grant AzSnapshotAccess](Grant-AzSnapshotAccess.md)
Concede um acesso a um instantâneo.
...
Reimagem de uma máquina virtual do Azure.
...
Excluir recurso de grupo de posicionamento de proximidade.
...
### [Reparar-AzVmssServiceFabricUpdateDomain](Repair-AzVmssServiceFabricUpdateDomain.md)
...
Define as propriedades da chave de criptografia do disco em um objeto de disco.

### [Set-AzDiskImageReference](Set-AzDiskImageReference.md)
Define as propriedades de referência de imagem em um objeto de disco.

### [Set-AzDiskKeyEncryptionKey](Set-AzDiskKeyEncryptionKey.md)
Define as propriedades da chave de criptografia de chave em um objeto de disco.
...
Define as propriedades da chave de criptografia de chave em um objeto de atualização de disco.
...
Define as propriedades da chave de criptografia do disco em um objeto de instantâneo.
...
Define as propriedades da chave de criptografia de chave em um objeto de atualização de instantâneo.
...
Atualiza as propriedades de extensão ou adiciona uma extensão a uma máquina virtual.
...
Inicia uma atualização sem interrupção para mover todas as instâncias do conjunto de escala da máquina virtual para a versão do sistema operacional da plataforma mais recente disponível.
...
### [Parar-AzVmssRollingUpgrade](Stop-AzVmssRollingUpgrade.md)
