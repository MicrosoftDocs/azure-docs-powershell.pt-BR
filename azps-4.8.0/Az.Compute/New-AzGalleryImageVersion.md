...
### -StorageAccountType
Especifica o tipo de conta de armazenamento a ser usado para armazenar a imagem. Esta propriedade não é atualizável. Os valores disponíveis são Standard_LRS, Standard_ZRS e Premium_LRS.
