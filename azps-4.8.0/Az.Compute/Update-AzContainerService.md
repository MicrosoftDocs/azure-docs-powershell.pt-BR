...
## DESCRITIVO
O cmdlet **Update-AzContainerService** atualiza o estado de um serviço de contêiner para corresponder a uma instância local do serviço.
...
Esse comando obtém o serviço de contêiner chamado CSResourceGroup17 usando o cmdlet Get-AzContainerService.
O comando passa esse objeto para o cmdlet Remove-AzContainerServiceAgentPoolProfile usando o operador pipeline.
**Remove-AzContainerServiceAgentPoolProfile** remove o perfil chamado AgentPool01.
O comando passa o resultado para o cmdlet Add-AzContainerServiceAgentPoolProfile.
**Add-AzContainerServiceAgentPoolProfile** adiciona um perfil que tem o nome AgentPool01 e tem as propriedades especificadas.
