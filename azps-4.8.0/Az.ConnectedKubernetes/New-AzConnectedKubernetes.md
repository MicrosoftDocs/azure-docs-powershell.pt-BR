...
## Sinopse
API para registrar um novo cluster K8s e, assim, criar um recurso controlado no ARM
...
### Exemplo 1: criar uma kubernetes conectada
```powershell
...
Esse comando cria um kubernetes conectado.

### Exemplo 1: criar uma kubernetes conectada com parâmetros kubeConfig e kubeContext
```powershell
...
Esse comando cria um kubernetes conectado com parâmetros kubeConfig e kubeContext.
...
### -ResourceGroupName
O nome do grupo de recursos ao qual o cluster kubernetes está registrado.
...
### -SubscriptionId
A ID da assinatura à qual o cluster kubernetes está registrado.
