...
## DESCRITIVO
O cmdlet **Get-AzBatchSupportedImage** é compatível com as imagens da máquina virtual que estão disponíveis em uma conta em lotes do Azure.
Especifique a conta usando o parâmetro *BatchContext* .

## EXEMPLOS

### Exemplo 1: obter todas as imagens compatíveis disponíveis
...
O primeiro comando obtém um contexto de conta em lotes que contém as chaves de acesso para a sua assinatura usando **Get-AzBatchAccountKey**.
O comando armazena o contexto na variável $Context para usar no próximo comando.
O segundo comando obtém todas as imagens com suporte disponíveis para essa conta em lotes.
...
### -Filtro
Especifica uma cláusula de filtro OData para imagens com suporte.
Se você não especificar um filtro, esse cmdlet retornará todas as imagens aceitas pela conta em lotes.
...
### -MaxCount
Especifica o número máximo de imagens com suporte a serem retornadas.
...
### Microsoft.Azure.Commands.Batch. Modelos. PSImageInformation
