...
### Exemplo 1: adicionando um recurso à coleção move.
```powershell
...
Adicionando um recurso à coleção move dentro da assinatura especificada.
...
### -DependsOnOverride
Obtém ou define a substituição das dependências do recurso de movimentação.
Para construir, consulte a seção notas para propriedades DEPENDSONOVERRIDE e crie uma tabela de hash.
...
### -ExistingTargetId
Obtém ou define a ID do braço de destino existente do recurso.
...
### -Nome
O nome do recurso de movimento.
...
### -SourceID
Obtém ou define a ID do braço de origem do recurso.
...
DEPENDSONOVERRIDE <IMoveResourceDependencyOverride [] >: Obtém ou define a substituição das dependências do recurso de movimentação.
  - `[Id <String>]`: Obtém ou define a ID do braço do recurso dependente.
  - `[TargetId <String>]`: Obtém ou define a ID do braço do recurso de MoveResource ou a ID do braço do recurso do recurso dependente.
