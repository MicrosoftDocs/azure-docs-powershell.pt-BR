...
## DESCRITIVO
O cmdlet cria um novo tipo de aplicativo Service Fabric no grupo de recursos e no cluster especificado.
...
Este exemplo criará um novo tipo de aplicativo "testAppType", no grupo de recursos e no cluster especificado.
