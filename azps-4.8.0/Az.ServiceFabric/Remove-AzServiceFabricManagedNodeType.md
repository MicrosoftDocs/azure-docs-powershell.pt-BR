...
## DESCRITIVO
Remova o tipo de nó ou nós específicos dentro do tipo de nó. Se paremter-NodeName for usado, somente nós especificados serão removidos.
...
Remova o tipo de nó, com tubulação.
...
Remova 2 nós do tipo de nó, com tubulação.
...
Use com cuidado, pois isso pode causar perda de dados se cargas de trabalho com estado estiverem em execução nos nós ou se não houver nós de propagação suficientes após o opearion.
