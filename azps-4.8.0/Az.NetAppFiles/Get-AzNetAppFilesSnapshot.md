...
## DESCRITIVO
O cmdlet **Get-AzNetAppFilesSnapshot** Obtém detalhes de um instantâneo do ANF.

## EXEMPLOS

### Exemplo 1: obter um instantâneo ANF
```
...
Esse comando obtém o instantâneo chamado MyAnfSnapshot do volume "MyAnfVolume".
...
### -Volumeobject
O objeto volume que contém o instantâneo a ser retornado
