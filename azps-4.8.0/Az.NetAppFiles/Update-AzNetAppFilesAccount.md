...
## DESCRITIVO
O cmdlet **Update-AzNetAppFilesAccount** modifica uma conta ANF.

## EXEMPLOS

### Exemplo 1: atualiza uma conta do ANF
```
...
Esse comando executa uma atualização na conta determinada modificando as marcas para as fornecidas.

## OS

### -ActiveDirectory
Uma matriz de Hashtable que representa os diretórios ativos
...
### -InputObject
O objeto de conta a ser atualizado
