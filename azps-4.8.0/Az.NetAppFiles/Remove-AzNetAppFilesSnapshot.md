...
## DESCRITIVO
O cmdlet **Remove-AzNetAppFilesSnapshot** exclui um instantâneo ANF.
...
Esse comando exclui o instantâneo ANF "MyAnfSnapshot".
...
### -PassThru
Retornar se o volume especificado foi removido com êxito
...
### -ResourceGroupName
O grupo de recursos do instantâneo ANF
...
### -ResourceId
A ID do recurso do instantâneo ANF
...
### -Volumeobject
O objeto volume que contém o instantâneo a ser removido
