...
## DESCRITIVO
O cmdlet **Remove-AzCustomIpPrefix** remove um CustomIpPrefix.
...
Remove o CustomIpPrefix com o nome $prefixName do grupo de recursos $rgName
