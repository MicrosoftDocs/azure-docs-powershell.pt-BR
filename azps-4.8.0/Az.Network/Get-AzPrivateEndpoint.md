...
## DESCRITIVO
O cmdlet **Get-AzPrivateEndpoint** Obtém um ou mais pontos de extremidade privados.

## EXEMPLOS

### Exemplo 1: recuperar um ponto de extremidade privado
```powershell
...
Esse comando obtém o ponto de extremidade privado chamado MyPrivateEndpoint1 na TestResourceGroup do grupo de recursos

### Exemplo 2: listar todos os pontos de extremidade particulares no MySource
```powershell
...
Esse comando obtém todos os pontos de extremidade particulares na TestResourceGroup do grupo de recursos
