...
Este exemplo é semelhante ao exemplo 1, mas usa uma ID de recurso para fazer referência à rede WAN virtual necessária para criar o Hub virtual.
...
A seguir, você criará um grupo de recursos "testRG", uma WAN virtual e um hub virtual no oeste dos EUA no grupo de recursos do Azure. O Hub virtual terá o espaço de endereço "10.0.1.0/24" e uma tabela de rota anexada.
...
### -VirtualWan
O objeto de WAN virtual ao qual esse Hub está vinculado.
...
### -VirtualWanId
A ID do objeto de WAN virtual ao qual este Hub está vinculado.
