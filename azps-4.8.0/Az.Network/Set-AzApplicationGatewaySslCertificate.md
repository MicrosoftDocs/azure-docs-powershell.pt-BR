...
Atualize um certificado SSL existente para o Application Gateway chamado ApplicationGateway01.

### Exemplo 2: atualizar um certificado SSL existente usando o segredo do keyvault (versão menos secreta) no gateway do aplicativo
```
...
Obtenha o segredo e atualize um certificado SSL existente usando o `Set-AzApplicationGatewaySslCertificate` .

### Exemplo 3: atualizar um certificado SSL existente usando o segredo do keyvault no gateway do aplicativo
```
PS C:\> $secret = Get-AzKeyVaultSecret -VaultName "keyvault01" -Name "sslCert01"
...
### -ApplicationGateway
Especifica o gateway do aplicativo com o qual o certificado SSL (Secure Socket Layer) está associado.
