...
## DESCRITIVO
O cmdlet **New-AzSecurityPartnerProvider** cria um Azure SecurityPartnerProvider
...
### -VirtualHub
A ID do Hub virtual à qual o provedor do parceiro de segurança está associado
