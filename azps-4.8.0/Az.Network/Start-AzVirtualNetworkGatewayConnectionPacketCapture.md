...
```
### Exemplo 3
Exemplo de captura de pacote para capturar todos os pacotes internos e externos
```powershell
...
### -FilterData
Opções de filtro para iniciar captura de pacote na conexão de gateway de rede virtual.
...
### -InputObject
O objeto de conexão de gateway de rede virtual em que a captura de pacote deve ser iniciada.
...
### -Nome
O nome da conexão de gateway de rede virtual em que a captura de pacote deve ser iniciada.
...
### -ResourceId
A ID de recurso do Azure do VirtualNetworkGatewayConnection em que a captura de pacote deve ser iniciada.
