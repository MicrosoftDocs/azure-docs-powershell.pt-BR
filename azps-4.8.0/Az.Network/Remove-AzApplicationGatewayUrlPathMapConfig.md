...
## DESCRITIVO
O cmdlet **Remove-AzApplicationGatewayUrlPathMapConfig** remove mapeamentos de caminho de URL para um pool de servidores back-end.

## EXEMPLOS

### Exemplo 1: remover um mapeamento de caminho de URL de um aplicativo gateway
```
...
O segundo comando Remove o mapeamento de caminho de URL chamado map01 do gateway do aplicativo.
O terceiro comando atualiza o Application Gateway.

## OS

### -ApplicationGateway
Especifica o gateway do aplicativo para o qual esse cmdlet Remove a configuração do mapa de caminho da URL.
...
### -Nome
Especifica o nome do mapa de caminho de URL que este cmdlet Remove do servidor back-end.
