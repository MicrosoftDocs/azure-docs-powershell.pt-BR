...
## Sinopse
Cria um recurso do CustomIpPrefix
...
Esse comando cria um novo recurso CustomIpPrefix com o nome $prefixName no grupo $rgName de recursos com um CIDR de 40.40.40.0/24 na westus
