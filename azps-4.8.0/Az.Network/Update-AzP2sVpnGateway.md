...
## DESCRITIVO
O cmdlet **Update-AzP2sVpnGateway** permite que você atualize um P2SVpnGateway existente em VirtualHub com novos VpnClientAddressPool ou novo VpnServerConfiguration ou alterar VpnGatewayScaleUnit.
...
O cmdlet **Update-AzP2sVpnGateway** permite que você atualize um P2SVpnGateway existente em VirtualHub com novo VpnClientAddressPool. Quando o ponto para o cliente do site se conecta a este P2SVpnGateway, um dos endereços IP desse VpnClientAddressPool é atribuído a esse cliente.

### Exemplo 2

Atualize um P2SVpnGateway existente em VirtualHub para conectividade com o ponto para o site. (gerado automaticamente)
...
Habilitar o sinalizador de segurança da Internet para esta P2SVpnGateway conexões
...
Desabilitar o sinalizador de segurança da Internet para esta P2SVpnGateway conexões
...
### -VpnClientAddressPool
P2S VpnClient AddressPool para este P2SVpnGateway P2SConnectionConfiguration.
...
A ID do objeto de configuração do servidor VPN a qual esta P2SVpnGateway será anexada.
