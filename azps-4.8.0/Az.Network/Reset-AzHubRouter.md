...
## Sinopse
Redefine o RoutingState de um recurso VirtualHub.
...
## DESCRITIVO
Redefine o estado de roteamento de um recurso VirtualHub existente somente se o estado de roteamento do Hub virtual não for provisionado.
...
Redefina o estado de roteamento do Hub virtual usando seu ResourceGroupName e Resource Resource.
...
Redefina o estado de roteamento do Hub virtual usando seu ResourceId.
...
Redefina o estado de roteamento do Hub virtual usando um objeto de entrada. O objeto de entrada é do tipo PSVirtualHub.
...
Um objeto Hub virtual existente pode ser recuperado e, em seguida, passado como objeto de entrada para Reset-AzHubRouter.
