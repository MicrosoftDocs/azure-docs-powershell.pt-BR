...
## Sinopse
Interrompe a operação de captura de pacote em um gateway VPN.
...
## DESCRITIVO
Interrompe a operação de captura de pacote em um gateway VPN e carregará o resultado em determinado SasUrl contêiner de armazenamento.
...
### -InputObject
O objeto de gateway VPN em que a captura de pacote deve ser iniciada.
...
### -Nome
O nome do gateway VPN em que a captura de pacote deve ser iniciada.
...
### -ResourceId
A ID de recurso do Azure do VpnGateway em que a captura de pacote deve ser iniciada.
...
### -SasUrl
Captura de pacote de URL SAS no gateway VPN.
