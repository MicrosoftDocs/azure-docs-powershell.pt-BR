...
## Sinopse
Baixar a carta de autorização do documento para uma porta expressa de rota.
...
## DESCRITIVO
New-AzExpressRoutePortLOA cmdlet baixa um documento da carta de autorização no formato PDF para uma porta expressa de rota.
...
Baixe o documento da carta de autorização para porta de rota expressa ' MyPort ' e armazene-o no arquivo ' loa.pdf '.
...
### -O CustomerName
O nome do cliente ao qual esta porta expressa expressa está atribuída.
...
### -Destino
O FilePath de saída para armazenar a carta de autorização.
