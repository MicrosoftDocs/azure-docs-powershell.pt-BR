...
## DESCRITIVO
Enumera rotas aprendidas por um gateway virtual de rede do Azure de várias fontes. Isso inclui rotas aprendidas pelo BGP, bem como rotas estáticas. 
...
Para o gateway de rede virtual do Azure chamado GATEWAYNAME no grupo de Resource do grupo de recursos, recupera rotas que o gateway do Azure sabe. Nesse caso, o gateway de rede virtual do Azure tem duas rotas estáticas (10.1.0.0/16 e 10.0.0.254/32), bem como uma rota aprendida pelo BGP (10.0.0.0/16).
