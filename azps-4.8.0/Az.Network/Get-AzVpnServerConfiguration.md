...
## DESCRITIVO
O cmdlet **Get-AzVpnServerConfiguration** retorna o VpnServerConfiguration existente do ponto para a conectividade do site.
...
O comando acima receberá o VpnServerConfiguration existente.
