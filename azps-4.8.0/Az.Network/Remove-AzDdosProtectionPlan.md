...
## DESCRITIVO
O cmdlet Remove-AzDdosProtectionPlan remove um plano de proteção contra DDoS.
...
Em seguida, persistemos o novo estado canalizando a variável local para **set-AzVirtualNetwork**. Neste ponto, o plano não está mais associado à rede virtual.
Se este for o último associado ao plano, poderemos remover o plano de proteção contra DDoS usando o comando Remove-AzDdosProtectionPlan.
