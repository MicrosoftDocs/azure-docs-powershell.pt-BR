...
## Sinopse
Inicia a operação de captura de pacote em um gateway VPN.
...
### -FilterData
Opções de filtro para iniciar captura de pacote no gateway VPN.
...
[Parar-AzVpnGatewayPacketCapture](./Stop-AzVpnGatewayPacketCapture.md)