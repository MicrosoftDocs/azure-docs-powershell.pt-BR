...
## DESCRITIVO
O cmdlet **Get-AzP2sVpnGateway** permite que você obtenha um P2SVpnGateway existente em VirtualHub.
...
O cmdlet **Get-AzP2sVpnGateway** permite que você obtenha um P2SVpnGateway existente em VirtualHub que é usado para apontar para a conectividade do site.
