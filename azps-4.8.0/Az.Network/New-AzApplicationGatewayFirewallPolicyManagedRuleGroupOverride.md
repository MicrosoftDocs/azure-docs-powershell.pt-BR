...
## DESCRITIVO
O **New-AzApplicationGatewayFirewallPolicyManagedRuleGroupOverride** cria uma entrada ruleGroupOverride em um managedRuleSet para uma política de firewall.
...
Cria uma entrada RuleGroupOverride com o nome do grupo como $ruleName e regras como $rule 1, $rule 2. Atribui o mesmo $overrideEntry
...
### -RuleGroupName
Especifique o ruleGroupName em uma entrada do meu fio de substituição.
