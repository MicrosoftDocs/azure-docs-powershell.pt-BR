...
## DESCRITIVO
O cmdlet New-AzRouteFilterRuleConfig cria uma regra de filtro de rota para um filtro de rota do Azure.
...
O comando cria uma nova regra de filtro de rota e a armazena em Variable $rule 1.

## OS

### -Acesso
Acesso à regra de filtro de rota.
