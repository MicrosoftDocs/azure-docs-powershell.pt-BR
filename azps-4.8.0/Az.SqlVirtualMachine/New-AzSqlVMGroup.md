...
## DESCRITIVO
O cmdlet New-AzSqlVMGroup cria um grupo de máquina virtual do SQL do Azure.
...
Cria um novo grupo de máquinas virtuais do Azure SQL com VM de grupo de teste na ResourceGroup01 do grupo de recursos.
$profile é um objeto do tipo Microsoft. Azure. Management. SqlVirtualMachine. Models. WsfcDomainProfile
...
Nome usado para a criação de um cluster
...
Nome usado para o cluster operacional
...
Caminho opcional para testemunha do FileShare
...
### -Local
Local do grupo de máquinas virtuais do SQL.
...
### -Oferta
Oferta de grupo de máquina virtual SQL.
...
### -OuPath
Caminho da unidade organizacional em que os nós e o cluster estarão presentes
...
### -SKU
Tipo da edição de grupo da máquina virtual SQL.
...
### -SqlServiceAccount
Nome em que o serviço SQL será executado em todas as máquinas virtuais do SQL no cluster
...
Chave primária da conta de armazenamento de testemunha
...
### -Marca
As marcas a serem associadas ao grupo da máquina virtual do SQL.
