...
## DESCRITIVO
O cmdlet New-AzAvailabilityGroupListener cria um novo ouvinte de grupo de disponibilidade.
...
Cria um novo ouvinte de escuta do grupo de AgListener01 para o AvailabilityGroup01 do grupo de disponibilidade no grupo SqlVmGroup01 do grupo da máquina virtual do SQL.
...
### -Porta
Número da porta do ouvinte AG. O valor padrão é 1433.
...
ID do recurso do endereço IP público
...
### -SqlVirtualMachineId
Lista de IDs de recursos de VM do SQL
