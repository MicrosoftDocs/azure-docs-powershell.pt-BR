...
```
Uma consulta que mostra todas as máquinas virtuais que não usam discos gerenciados e inclui nomes para exibição de assinatura.
...
```
Uma consulta exibindo a contagem de recursos por locatário e nomes para exibição de assinatura.
