...
### Exemplo 1: atualizar plano de hospedagem do aplicativo da função.
```powershell
PS C:\> Update-AzFunctionApp -Name MyUniqueFunctionAppName -ResourceGroupName MyResourceGroupName -PlanName NewPlanName 
```

Este comando atualiza o plano de Hospedagem de aplicativos da função.
...
### Exemplo 3: atualizar as ideias do aplicativo app app.
```powershell
...
Este comando atualiza o function app insights do aplicativo.
...
O tipo ' nenhum ' removerá todas as identidades do aplicativo de função.
Os valores aceitáveis para esse parâmetro são:-SystemAssigned-userassigned-None
