...
### Exemplo 1: remover a regra de firewall do PostgreSql por nome
```powershell
PS C:\> Remove-AzPostgreSqlFirewallRule -Name rule -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Este cmdlet Remove a regra de firewall do PostgreSql por nome.

### Exemplo 2: remover a regra de firewall do PostgreSql por identidade
```powershell
...
Esses cmdlets removem a regra de firewall do PostgreSql por identidade.
