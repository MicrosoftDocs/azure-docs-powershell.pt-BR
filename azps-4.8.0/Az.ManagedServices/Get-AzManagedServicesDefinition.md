...
Obtém todas as definições de registro.
...
Obtém a definição de registro de acordo com sua ID.
...
Obtém a definição de registro de acordo com a ID de recurso totalmente qualificada.
...
### -ID
O identificador de definição de registro (por exemplo, b0c052e5-c437-4771-a476-8b1201158a57).
```yaml
Type: System.String
Parameter Sets: ById
Aliases:
