...
## DESCRITIVO
O cmdlet **New-AzFrontDoor** cria um novo balanceador de carga de porta frontal do Azure no grupo de recursos especificado na assinatura atual

## EXEMPLOS

### Exemplo 1: criar uma porta frontal com base em determinados parâmetros.
```powershell
...
Crie uma porta frontal com base em determinados parâmetros.
...
### -Enabledstate
Enabledstate do balanceador de carga da porta frontal.
