...
## Sinopse
Obtém as propriedades de uma instância de provedor para a assinatura especificada, o grupo de recursos, o nome do SapMonitor e o nome do recurso.
...
### Exemplo 2: obter uma instância do monitor SAP por nome
```powershell
...
Esse comando obtém uma instância do monitor SAP por nome.

### Exemplo 3: obter uma instância do monitor SAP por objeto
```powershell
...
Esse comando obtém uma instância do monitor SAP por objeto.

### Exemplo 4: obter uma instância do monitor SAP por pipeline
```powershell
...
Esse comando obtém uma instância do monitor SAP por pipeline.
