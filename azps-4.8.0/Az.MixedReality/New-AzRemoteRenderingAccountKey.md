...
## Sinopse
Regenerar a chave da conta de renderização remota
...
## DESCRITIVO
Regenerar a chave primária ou a chave secundária da conta de renderização remota.
...
Regenerar a chave secundária da conta de renderização remota "exemplo" no grupo de recursos "Rg1". 
...
Regenerar a chave secundária da conta de renderização remota "exemplo" da assinatura atual e do grupo de recursos "Rg1" com o encanamento.
...
### -Principal
Regenerar a chave primária da conta de renderização remota.
