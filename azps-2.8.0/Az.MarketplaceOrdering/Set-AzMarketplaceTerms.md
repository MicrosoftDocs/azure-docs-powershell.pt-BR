...
### AgreementAcceptParameterSet (padrão)
```
...
## DESCRITIVO
O cmdlet **set-AzMarketplaceTerms** salva o objeto terms para a determinada ID de fornecedor (fornecedor), a ID de oferta (produto) e a tupla de ID de plano (nome).

## EXEMPLOS

### Exemplo 1
Obter o contrato de fornecedor do Marketplace
...
### Exemplo 2
Defina o contrato de fornecedor como ' Aceito '. Obter o valor para o parâmetro "termos" do cmdlet "Get-AzMarketplaceTerms"
...
### -Aceitar
Passe para aceitar os termos legais.
...
### -InputObject
Objeto termos retornado no Get-AzMarketplaceTerms cmdlet. Esse é um parâmetro obrigatório se o parâmetro aceito for verdadeiro.
...
### -Rejeitar
Passe para rejeitar os termos legais.
