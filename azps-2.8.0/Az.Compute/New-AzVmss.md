...
### -Priority
A prioridade do conjunto de escala da máquina virtual.  Somente os valores com suporte são ' regular ' e ' baixo '.
...
O nome ou a ID do recurso do grupo de posicionamento de proximidade para usar com esse conjunto de escala.
