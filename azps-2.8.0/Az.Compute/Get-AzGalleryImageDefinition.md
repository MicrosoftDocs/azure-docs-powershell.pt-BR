...
Obtenha a definição de imagem da galeria que começa com "imagem".
...
Obtenha as definições de imagem da galeria no gallery1.
...
### -ResourceId
A ID do recurso da definição de imagem da Galeria
