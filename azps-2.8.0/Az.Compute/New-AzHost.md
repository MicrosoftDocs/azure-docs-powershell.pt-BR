...
Esse comando cria um host da SKU fornecida no grupo host fornecido e o local indicado.
...
Especifica se o host deve ser substituído automaticamente em caso de falha. O valor padrão é "true" quando não é fornecido.
...
### -HostGroupName
Especifica o nome do grupo host.
...
### -LicenseType
Especifica o tipo de licença de software que será aplicado às VMs implantadas no host. Os valores possíveis são: None, Windows_Server_Hybrid e Windows_Server_Perpetual.  O valor padrão é nenhum.
...
### -PlatformFaultDomain
Especifica o número do domínio de falha da plataforma do host.  Em seguida, o valor mínimo é 0 e o valor máximo é 2.
