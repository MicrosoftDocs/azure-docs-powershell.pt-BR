...
### -AssignIdentity
Especifique a identidade atribuída pelo sistema para a máquina virtual.
...
### -IdentityType
O tipo de identidade usado para a máquina virtual. Os valores válidos são SystemAssigned, userassign, SystemAssignedUserAssigned e None.
