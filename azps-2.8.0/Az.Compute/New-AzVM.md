...
### -EvictionPolicy
A política de remoção para a máquina virtual de baixa prioridade.  Somente o valor com suporte é ' desallocate '.
...
### -Priority
A prioridade da máquina virtual.  Somente os valores com suporte são ' regular ' e ' baixo '.
...
O nome ou a ID do recurso do grupo de posicionamento de proximidade para usar com esta VM.
