...
## DESCRITIVO
O cmdlet Remove-AzEventHub remove e exclui o Hub de eventos especificado do namespace fornecido.
...
Remove o Hub de eventos \` MyEventHubName \` .
...
### Exemplo 3,1-ResourceId-usando cadeia de caracteres:
```
