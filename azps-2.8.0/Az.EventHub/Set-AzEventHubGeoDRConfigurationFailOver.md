...
## DESCRITIVO
O cmdlet **set-AzEventHubGeoDRConfigurationFailOver** invoca o failover de Dr geográfico e reconfigura o alias para apontar para o namespace secundário
...
Invoca o failover por alias "SampleDRConfigName", reconfigura e aponta para o namespace secundário "SampleNamespace_Secondary"
...
### -InputObject
Objeto de configuração GeoDR do Eventhub
