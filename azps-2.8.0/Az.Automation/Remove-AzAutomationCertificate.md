...
Especifica o nome da conta de automação para a qual esse cmdlet Remove um certificado.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos para o qual esse cmdlet Remove um certificado.
