...
### Exemplo 1-atualize um cluster existente por nome
...
O comando acima atualiza a camada do cluster Kusto "mykustocluster" encontrada no grupo de recursos "testrg".

### Exemplo 2-atualize um cluster existente por tubulação
...
O comando acima Obtém o Kusto cluster "mykustocluster" localizado no grupo de recursos "testrg" usando o `Get-AzKustoCluster` cmdlet e, em seguida, canaliza o resultado para `Update-AzKustoCluster` atualizar o nível do cluster para "padrão".

## OS

### -Capacidade
O número de instância da VM.
...
### -Nome
Nome do cluster a ser atualizado.
