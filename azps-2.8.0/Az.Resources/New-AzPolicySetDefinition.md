...
### -PolicyDefinition
As definições de política. Pode ser um caminho para um nome de arquivo que contenha as definições da política ou as definições da política como cadeia de caracteres.
