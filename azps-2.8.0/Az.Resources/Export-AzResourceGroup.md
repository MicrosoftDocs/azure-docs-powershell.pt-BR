...
Esse comando captura o recurso de máquina virtual chamado "TestVirtualMachine" do grupo de recursos "grupo de teste" como modelo e salva-o em um arquivo JSON no diretório atual.
...
Esse comando captura dois recursos do grupo de recursos "grupo de teste" como um modelo e salva-os em um arquivo JSON no diretório atual. O modelo gerado não conterá nenhum parâmetro gerado.
...
### -Recurso
Uma lista de ResourceId para filtrar os resultados por.
...
Pule a parametrização do nome do recurso.
