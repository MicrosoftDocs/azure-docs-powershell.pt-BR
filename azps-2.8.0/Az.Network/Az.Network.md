...
Obter uma conexão de ponto de extremidade particular
...
Obtém a integridade da conexão do cliente VPN de rede virtual para cada conexão de cliente VPN.
...
Cria uma política de seletor de tráfego IPSec.
...
Verifica se um serviço de link privado está visível para uso atual.
