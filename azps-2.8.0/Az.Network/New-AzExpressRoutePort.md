...
## DESCRITIVO
O cmdlet **New-AzExpressRoutePort** cria um Azure ExpressRoutePort
...
### -Identidade
Identidade atribuída pelo usuário para ler a configuração do MacSec
...
### -PeeringLocation
O nome do local de emparelhamento ao qual o ExpressRoutePort está mapeado fisicamente.
