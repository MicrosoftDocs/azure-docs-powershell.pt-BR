...
### 1: criar um ponto de extremidade privado
```
...
Este exemplo cria um ponto de extremidade particular com ID de serviço de link particular específico em uma sub-rede específica em uma rede virtual.
...
A conexão do serviço de link privado.
