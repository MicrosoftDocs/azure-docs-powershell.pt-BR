...
## DESCRITIVO
O cmdlet **set-AzApplicationGatewayAuthenticationCertificate** atualiza um certificado de autenticação para um gateway do aplicativo do Azure.

## EXEMPLOS

### Exemplo 1: atualizar um certificado de autenticação
```
...
O segundo comando atualiza o certificado de autenticação chamado cert01 no gateway do aplicativo.
O terceiro comando atualiza o Application Gateway.

## OS

### -ApplicationGateway
Especifica o nome do gateway do aplicativo para o qual esse cmdlet atualiza um certificado de autenticação.
...
### -CertificateFile
Especifica o caminho do arquivo de certificado de autenticação com o qual esse cmdlet atualiza o certificado.
...
### -Nome
Especifica o nome do certificado de autenticação que este cmdlet atualiza.
