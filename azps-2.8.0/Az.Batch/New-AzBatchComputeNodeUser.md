...
## DESCRITIVO
O cmdlet **New-AzBatchComputeNodeUser** cria uma conta de usuário em um nó de computação em lotes do Azure.
...
Esse comando obtém o nó de computação chamado ComputeNode01 usando o cmdlet **Get-AzBatchComputeNode** .
...
O comando cria uma conta de usuário com o nome de usuário testuser e a senha da senha.
