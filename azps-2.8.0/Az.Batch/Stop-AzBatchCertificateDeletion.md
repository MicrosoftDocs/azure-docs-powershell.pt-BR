...
## DESCRITIVO
O cmdlet **Stop-AzBatchCertificateDeletion** cancela uma falha na exclusão de um certificado no serviço em lotes do Azure.
Você pode parar uma exclusão apenas se o certificado estiver no estado **DeleteFailed** .
Esse cmdlet restaura o certificado para o estado **ativo** .
...
### -Impressão digital
Especifica a impressão digital do certificado que este cmdlet restaura ao estado **ativo** .
