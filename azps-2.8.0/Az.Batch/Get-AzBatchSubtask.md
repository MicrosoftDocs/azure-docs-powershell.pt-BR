...
Em seguida, o segundo comando usa essa referência de objeto e o cmdlet **Get-AzBatchSubtask** para retornar todas as subtarefas de MyTask, uma tarefa que é executada como parte do trabalho do trabalho-01.
...
Essa referência de objeto é criada usando-se o cmdlet Get-AzBatchTask e armazenando o objeto retornado em uma variável.
...
### Microsoft.Azure.Commands.Batch. Modelos. PSSubtaskInformation
