...
## DESCRITIVO
O cmdlet **set-AzBatchJob** atualiza um trabalho em lotes do Azure.
Use o cmdlet Get-AzBatchJob para obter um objeto **PSCloudJob** .
...
O primeiro comando obtém um trabalho usando **Get-AzBatchJob** e, em seguida, armazena-o na variável $Job.
