...
## DESCRITIVO
O cmdlet **Get-AzBatchPoolStatistic** Obtém as estatísticas de tempo de vida de todos os grupos na conta especificada.
...
### Microsoft.Azure.Commands.Batch. Modelos. PSPoolStatistics
