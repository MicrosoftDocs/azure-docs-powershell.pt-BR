...
## DESCRITIVO
O cmdlet **New-AzRelayNamespace** cria um novo namespace de retransmissão. Uma vez criado, o manifesto do recurso namespace é imutável.
...
Cria um novo namespace de retransmissão dentro do grupo de recursos especificado.
...
### -Local
Local do namespace de retransmissão.
