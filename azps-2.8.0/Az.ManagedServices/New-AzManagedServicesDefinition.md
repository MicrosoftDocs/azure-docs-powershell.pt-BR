...
Cria ou atualiza uma definição de registro de acordo com os parâmetros necessários.
...
Cria ou atualiza uma definição de registro com os detalhes do plano.
...
O identificador principal do ManagedBy.
...
### -RoleDefinitionId
O identificador de função do provedor de serviços gerenciado.
