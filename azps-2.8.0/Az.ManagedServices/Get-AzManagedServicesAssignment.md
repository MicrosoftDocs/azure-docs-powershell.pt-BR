...
Obtém uma atribuição de registro sem os detalhes da definição do registro.
...
Obtém a atribuição de registro de acordo com a ID de recurso totalmente qualificada.
