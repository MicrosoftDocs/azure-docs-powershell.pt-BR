...
## DESCRITIVO
O cmdlet Invoke-AzDataMigrationCommand cria uma nova tarefa de comando para ser executada em uma tarefa de migração existente.
...
```
### -ObjectName
O nome do objeto de banco de dados no qual o comando será executado.
