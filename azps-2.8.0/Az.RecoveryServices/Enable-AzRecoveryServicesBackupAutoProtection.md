...
## DESCRITIVO
O cmdlet **Enable-AzRecoveryServicesBackupAutoProtection** define a política de proteção de backup automático do Azure em um item que permite proteção.
...
O segundo cmdlet define a política de proteção de backup para o AzureWorkload usando a política em $Pol.

## OS

### -BackupManagementType
Tipo de gerenciamento de backup do recurso (por exemplo: MAB, DPM, AzureWorkload).
...
### -InputItem
Especifica o objeto de item protector que pode ser passado como uma entrada.
