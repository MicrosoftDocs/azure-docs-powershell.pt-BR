...
## DESCRITIVO
Ativa ou desativa as configurações de provisionamento automático para uma assinatura.
As configurações de provisionamento automático permitem que você decida se deseja que a central de segurança do Azure forneça automaticamente um agente de segurança que será instalado em suas VMs.
...
Ativa a configuração de provisionamento automático para uma assinatura.
...
Desativa a configuração automática de provisionamento para uma assinatura.
