...
## DESCRITIVO
O cmdlet **Get-AzFrontDoorFrontendEndpoint** Obtém todos os pontos de extremidade de frontend existentes no recurso de porta frontal atual que corresponde às informações fornecidas.

## EXEMPLOS

### Exemplo 1: obter todos os pontos de extremidade de front-end na porta frontal "frontdoor1" que faz parte do grupo de recursos "Rg1".
```powershell
...
Obter todos os pontos de extremidade de front-end na porta frontal "frontdoor1" que faz parte do grupo de recursos "Rg1".

### Exemplo 2: obter ponto de extremidade de front-end com nome "frontdoor1-azurefd-net" na porta frontal "frontdoor1", que faz parte do grupo de recursos "Rg1"
```powershell
...
Obtenha um ponto de extremidade de front-end com o nome "frontdoor1-azurefd-net" na porta frontal "frontdoor1", que faz parte do grupo de recursos "Rg1"
...
### -ResourceId
ID do recurso da porta frontal
