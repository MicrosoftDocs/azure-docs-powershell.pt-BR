...
## DESCRITIVO
O cmdlet **Remove-AzFrontDoorWafPolicy** remove uma política WAF sob a assinatura atual
...
Remova a política WAF chamada $policyName em $resourceGroupName.
...
Remover toda a política WAF em $resourceGroupName.
