...
### ByTopologyAndServiceNames (padrão)
```
...
## DESCRITIVO
O cmdlet **New-AzDeploymentManagerServiceUnit** cria um serviço em um serviço em uma topologia de serviço e retorna um objeto que representa essa unidade de serviço.
Especifique a unidade de serviço por nome, nome do serviço, topologia do serviço na qual ele se encontra e o nome do grupo de recursos. 

O cmdlet retorna um objeto onunit. Você pode modificar esse objeto localmente e, em seguida, aplicar as alterações ao serviço usando o cmdlet Set-AzDeploymentManagerService.
...
Esse cmdlet cria uma nova unidade de serviço com o nome ContosoService2Storage na ContosoResourceGroup abaixo da ContosoService2 do serviço no ContosoServiceTopology de topologia, no local central dos EUA. As referências de modelo e parâmetros são fornecidas como URI SAS porque o ResourceId da fonte de artefatos não foi fornecido no ContosoServiceTopology1 de topologia de serviço. Os recursos definidos neste modelo devem ser implantados no grupo de recursos de destino service2ResourceGroup com o modo de implantação definido como concluir.
...
### -Deploymentmode
O modo de implantação a ser usado ao implantar os recursos na unidade de serviço.
...
### -Local
O local do recurso de unidade de serviço.
...
O caminho para o arquivo de parâmetros relativo à origem do artefato.
Requer que o Artefatote seja referenciado no imtopology.
...
### -ParametersUri
O URI da SAS para o arquivo de parâmetros.
Se ArtifactSourceId foi referenciado no imtopology, especifique o caminho relativo usando ParametersArtifactSourceRelativePath.
...
### -ServiceName
O nome do serviço para o qual esta unidade de serviço faz parte.
...
### -Imtopologyname
O nome da topologia de serviço na qual esta unidade de serviço faz parte.
...
### -TargetResourceGroup
Determina o local onde os recursos na unidade de serviço seriam implantados.
...
O caminho para o arquivo de modelo relativo à fonte de artefatos.
Requer que o Artefatote seja referenciado no imtopology.
...
### -TemplateUri
O URI da SAS para o arquivo de modelo.
Se ArtifactSourceId foi referenciado no imtopology, especifique o caminho relativo usando TemplateArtifactSourceRelativePath.
