...
## DESCRITIVO
O cmdlet **New-AzDeploymentManagerService** cria um serviço em uma topologia de serviço e retorna um objeto que representa esse serviço.
Especifique o serviço pelo nome, topologia de serviço em que ele se encontra e o nome do grupo de recursos. 

O cmdlet retorna um objeto de serviço. Você pode modificar esse objeto localmente e, em seguida, aplicar as alterações ao serviço usando o cmdlet Set-AzDeploymentManagerService.
...
Cria um novo serviço com o nome ContosoService1 em ContosoServiceTopology de topologia de serviço no grupo de recursos ContosoResourceGroup, no centro de localização dos EUA. A propriedade TargetLocation indica que o serviço ContosoService1 deve ser implantado na região leste dos EUA na assinatura especificada.
...
### -Imtopologyname
O nome da topologia de serviço a qual esse serviço pertence.
...
### -TargetLocation
Determina o local onde os recursos do serviço seriam implantados.
...
Determina a assinatura na qual os recursos do serviço seriam implantados.
