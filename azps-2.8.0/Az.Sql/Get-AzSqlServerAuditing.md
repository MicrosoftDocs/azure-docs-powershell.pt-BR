...
## Sinopse
**Importante: esse cmdlet é preterido, [Get-AzSqlServerAudit](https://docs.microsoft.com/en-us/powershell/module/az.sql/get-azsqlserveraudit) está substituindo-o.**
...
## DESCRITIVO
O cmdlet **Get-AzSqlServerAuditing** Obtém as configurações de auditoria de um SQL Server do Azure.
Especifique os parâmetros *ResourceGroupName* e *nomedoservidor* para identificar o servidor.
...
### Exemplo 1: obter as configurações de auditoria de armazenamento blob de um SQL Server do Azure
```
...
### Exemplo 2: obter as configurações de auditoria de armazenamento blob de um SQL Server do Azure
```
...
### Exemplo 3: obter, por meio do pipeline, as configurações de auditoria de armazenamento de blob de um SQL Server do Azure
```
...
### Exemplo 4: obter as configurações de auditoria do hub de eventos de um SQL Server do Azure
```
...
### Exemplo 5: obter, por meio do pipeline, as configurações de auditoria do hub de eventos de um SQL Server do Azure
```
...
### Exemplo 6: obter as configurações de auditoria de análise de log de um SQL Server do Azure
```
