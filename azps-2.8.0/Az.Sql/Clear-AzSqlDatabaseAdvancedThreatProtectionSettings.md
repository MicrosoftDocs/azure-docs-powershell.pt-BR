...
## DESCRITIVO
O cmdlet **Clear-AzSqlDatabaseAdvancedThreatProtectionSettings** remove as configurações avançadas de proteção contra ameaças de um banco de dados SQL do AzureAzure.
