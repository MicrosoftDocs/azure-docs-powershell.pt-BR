...
## DESCRITIVO
O cmdlet **Update-AzSqlDatabaseAdvancedThreatProtectionSettings** define as configurações avançadas de proteção contra ameaças em um banco de dados SQL do Azure.
