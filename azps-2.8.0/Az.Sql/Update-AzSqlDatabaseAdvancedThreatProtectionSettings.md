...
## Descrição
O cmdlet **Update-AzSqlDatabaseAdvancedThreatProtectionSettings** define configurações avançadas de proteção contra ameaças em um banco de dados SQL do Azure.
