...
Obtém a política de conexão segura para um banco de dados. A conexão segura será substituída e esse comando será removido em uma versão futura. Use a lâmina do banco de dados SQL no portal do Azure para exibir as cadeias de conexão
