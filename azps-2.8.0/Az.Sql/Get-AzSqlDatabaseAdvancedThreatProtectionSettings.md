...
## Descrição
O cmdlet **Get-AzSqlDatabaseAdvancedThreatProtectionSettings** obtém as configurações avançadas de proteção contra ameaças de um banco de dados SQL do Azure.
