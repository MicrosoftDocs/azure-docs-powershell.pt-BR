...
## DESCRITIVO
O cmdlet **Get-AzSqlDatabaseBackupShortTermRetentionPolicy** Obtém a política de retenção de curto prazo registrada nesse banco de dados.
...
Esse comando obtém a política de retenção de curto prazo para database01.
...
Esse comando obtém a política de retenção de curto prazo para database01 via tubulação em um objeto de banco de dados.

## OS

### -AzureSqlDatabaseObject
O objeto de banco de dados para o qual obter a política.
