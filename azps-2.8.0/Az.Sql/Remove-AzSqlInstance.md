...
### RemoveInstanceFromInputParameters (padrão)
```
...
## DESCRITIVO
O cmdlet **Remove-AzSqlInstance** remove uma instância gerenciada do banco de dados SQL do Azure.

## EXEMPLOS

### Exemplo 1: remover instância
```
PS C:\>Remove-AzSqlInstance -Name "managedInstance1" -ResourceGroupName "ResourceGroup01"
```

Esse comando Remove a instância chamada managedInstance1.
