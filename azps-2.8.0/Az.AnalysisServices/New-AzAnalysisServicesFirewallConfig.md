...
Cria um objeto de configuração de firewall com duas regras ao habilitar também o acesso do serviço do Power BI.
...
Um sinalizador para indicar se o firewall está permitindo acesso do Power BI
