...
## DESCRITIVO
O cmdlet **Remove-AzApiManagementLogger** remove um **agente** de gerenciamento de API do Azure.

## EXEMPLOS

### Exemplo 1: remover um agente de log
```
...
### -Loggerid
Especifica a ID do agente de log a ser removida.
