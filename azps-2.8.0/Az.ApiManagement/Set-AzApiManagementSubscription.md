...
## DESCRITIVO
O cmdlet **set-AzApiManagementSubscription** define os detalhes da assinatura existente.
...
### -InputObject
Instância do PsApiManagementSubscription. Esse parâmetro é obrigatório.
...
### -UserId
O proprietário da assinatura. Este parâmetro é opcional.
