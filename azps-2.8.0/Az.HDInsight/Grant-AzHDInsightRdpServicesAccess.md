...
## DESCRITIVO
O cmdlet **Grant-AzHDInsightRdpServicesAccess** permite que o RDP (protocolo de área de trabalho remota) acesse um cluster HDInsight do Windows baseado no Windows.
