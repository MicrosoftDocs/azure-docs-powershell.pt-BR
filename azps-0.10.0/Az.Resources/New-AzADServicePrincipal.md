...
### -CertValue
O valor do tipo de credencial "assimétrico".
...
O valor de data de término padrão é de um ano a partir de hoje. Para uma credencial de tipo "assimétrica", ela deve ser definida como em ou antes da data em que o certificado X509 é válido.
...
## Notas
Palavras-chave: azure, Az, arm, resource, management, manager, resource, group, template, deployment
