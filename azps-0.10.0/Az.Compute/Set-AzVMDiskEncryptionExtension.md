...
### AADClientSecretParameterSet (padrão)
```
...
## DESCRITIVO
O cmdlet **set-AzVMDiskEncryptionExtension** habilita a criptografia em uma máquina virtual de serviço (IaaS) de infraestrutura em execução no Azure.
...
### Exemplo 1: habilitar a criptografia usando o ID de cliente do Azure AD e o segredo do cliente
```
...
### Exemplo 2: habilitar a criptografia usando a ID de cliente do Azure AD e a impressão digital de certificação do cliente
```
$RGName = "MyResourceGroup"
$VMName = "MyTestVM"
...
### Exemplo 3: habilitar a criptografia usando a identificação de cliente do Azure AD, o segredo do cliente e a chave de criptografia do disco decodificada usando chave de criptografia de chave
```
$RGName = "MyResourceGroup"
$VMName = "MyTestVM"
...
### Exemplo 4: habilitar a criptografia usando a ID de cliente do Azure AD, a impressão digital de certificado de cliente e o encapsulamento de disco EncryptionKey usando chave de criptografia de chave
```
$RGName = "MyResourceGroup"
$VMName = "MyTestVM"
#The KeyVault must have enabledForDiskEncryption property set on it
...
Os valores permitidos para máquinas virtuais Linux são os seguintes: somente dados.
