...
## DESCRITIVO
Isso exporta os números agregados de chamadas de API do Microsoft. Compute separadas por êxito, falha ou limitação exibidos em intervalos de tempo.
Os logs podem ser agrupados por três parâmetros: GroupByOperationName, GroupByThrottlePolicy ou GroupByResourceName.
