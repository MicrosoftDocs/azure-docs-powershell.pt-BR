...
## DESCRITIVO
O cmdlet **Remove-AzDnsRecordConfig** remove um registro de DNS (sistema de nomes de domínio) de um conjunto de registros.
...
Para remover completamente um conjunto de registros, consulte Remove-AzDnsRecordSet.
...
Esta é uma representação offline do conjunto de registros e as atualizações dele não alteram as respostas de DNS até que você execute Set-AzDnsRecordSet.
