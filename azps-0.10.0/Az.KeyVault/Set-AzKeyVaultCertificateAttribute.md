...
## DESCRITIVO
O cmdlet **set-AzKeyVaultCertificateAttribute** modifica os atributos editáveis de um certificado.
...
O comando final exibe o certificado TestCert01 usando o cmdlet Get-AzKeyVaultCertificate para verificar a operação.
