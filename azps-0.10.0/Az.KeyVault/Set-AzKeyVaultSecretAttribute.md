...
## DESCRITIVO
O cmdlet **set-AzKeyVaultSecretAttribute** atualiza atributos editáveis de um segredo em um cofre de chaves.
...
Os primeiros três comandos definem variáveis de cadeia de caracteres para usar para os parâmetros *vaultname* , *Name* e *ContentType* . O quarto comando usa o cmdlet Get-AzKeyVaultKey para obter as chaves especificadas e canaliza as chaves para o cmdlet Set-AzKeyVaultSecretAttribute para definir o tipo de conteúdo como XML.
