...
Esse comando alternará o slot "sourceslot" do slot com "destinationslot" para ContosoWebApp do aplicativo Web associado ao grupo de recursos padrão-Web-Oesteus
