...
## DESCRITIVO
O cmdlet Remove-AzEventHubNamespace remove e exclui o namespace de hubs de eventos especificado.
...
### Exemplo 2,1-InputObject-usando o encanamento:
```
...
### Exemplo 3,2-ResourceId-usando o encanamento:
```
PS C:\> Get-AzResource -ResourceType Microsoft.EventHub/Namespaces | Remove-AzEventHubNamespace
```

### Exemplo 3,3-ResourceId-usando cadeia de caracteres:
```
