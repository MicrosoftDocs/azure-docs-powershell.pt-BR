...
## DESCRITIVO
O cmdlet **Get-AzDataBoxEdgeBandwidthSchedule** Obtém as informações sobre as agendas de largura de banda. Você pode especificar o nome de um cronograma juntamente com o nome do grupo de recursos e o nome do dispositivo para obter as informações sobre um agendamento de largura de banda específico
