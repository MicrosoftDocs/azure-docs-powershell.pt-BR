...
## DESCRITIVO
O cmdlet **Get-AzInvoiceSection** Obtém seções de fatura sob o perfil de cobrança especificado. 
...
Obter todas as seções de fatura sob o perfil de cobrança especificado.
...
Obter a seção de fatura com o nome especificado.
