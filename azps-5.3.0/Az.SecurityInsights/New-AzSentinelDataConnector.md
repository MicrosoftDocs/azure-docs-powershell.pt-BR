...
Você deve especificar um dos parâmetros, por exemplo, AzureActiveDirectory, para especificar o tipo de regra de alerta a ser criado.  Cada tipo tem parâmetros obrigatórios diferentes.
...
Observação: nem todos os conectores de dados disponíveis no portal são avaialble via API.
...
Este exemplo cria uma central de segurança do **DataConnect** para o Azure no espaço de trabalho especificado e armazena-a na variável $DataConnector.
...
Este exemplo cria um **Dataconnecter** para Microsoft Cloud app Security no espaço de trabalho especificado e, em seguida, armazena-o na variável $DataConnector.
...
### -AmazonWebServicesCloudTrail
Trail na nuvem de serviços Web do Amazon conector de dados
...
Active Directory do Azure conector de dados
...
### -AzureAdvancedThreatProtection
Proteção avançada contra ameaças do Azure conector de dados
...
### -AzureSecurityCenter
Central de segurança do Azure conector de dados
...
### -MicrosoftCloudAppSecurity
Conector de dados Microsoft Cloud app Security
...
### -MicrosoftDefenderAdvancedThreatProtection
Conector de dados proteção avançada contra ameaças Microsoft defender
...
### -ThreatIntelligence
Inteligência de ameaças do conector de dados
