...
## DESCRITIVO
O cmdlet **Remove-AzSentinelAlertRuleAction** exclui permanentemente uma resposta automática da regra de alerta em um espaço de trabalho especificado.
Você pode passar um objeto **AlertRuleAction** usando o operador pipeline ou, como alternativa, pode especificar os parâmetros obrigatórios.
...
Esse comando Remove a regra de alerta do espaço de trabalho.
