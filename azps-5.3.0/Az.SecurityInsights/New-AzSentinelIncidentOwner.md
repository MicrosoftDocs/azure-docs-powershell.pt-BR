...
## DESCRITIVO
O cmdlet **New-AzSentinelIncidentOwner** cria um objeto de proprietário de incidente na memória para atualizar um incidente.
...
### -Email
Proprietário do incidente-email
...
### -ObjectId
Proprietário do incidente-ObjectId
...
### -UserPrincipalName
Proprietário do incidente-nome UPN do usuário
