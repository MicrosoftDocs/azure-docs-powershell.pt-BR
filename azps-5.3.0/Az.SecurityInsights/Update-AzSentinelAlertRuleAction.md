...
Você pode passar um objeto **AlertRuleAction** como um parâmetro ou usando o operador pipeline ou, como alternativa, pode especificar os parâmetros *AlertRuleId* e *ActionID* .
...
Este exemplo atualiza um **AlertRuleAction** que substitui uma *ação* existente por novas propriedades.
...
### -LogicAppResourceId
ID do recurso de aplicativo lógica da ação.
...
### -TriggerUri
URI de gatilho do aplicativo lógica da ação.
