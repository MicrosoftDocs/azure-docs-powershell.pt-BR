...
### -Back-end
O conjunto de back-ends para este pool.
...
O nome das configurações de investigação de integridade para este pool de back-end
...
O nome das configurações de balanceamento de carga para este pool de back-end
