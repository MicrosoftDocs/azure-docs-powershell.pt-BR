...
Os valores possíveis incluem: ' RemoteAddr ', ' RequestMethod ', ' QueryString ', ' createargs ', ' RequestUri ', ' RequestHeader ', ' RequestBody ', ' SocketAddr '
...
Os valores possíveis incluem: ' any ', ' IPMatch ', ' geomatch ', ' ' EQUAL ', ' GreaterThanOrEqual ', ' começa ', ' EndsWith ', ' RegEx ', ' ', ' ', ' EndsWith ', ' RegEx '
...
### -Transform
Transformações a serem aplicadas. Os valores possíveis incluem: ' minúscula ', ' maiúscula ', ' arrumar ', ' UrlDecode ', ' UrlEncode ', ' RemoveNulls '.
