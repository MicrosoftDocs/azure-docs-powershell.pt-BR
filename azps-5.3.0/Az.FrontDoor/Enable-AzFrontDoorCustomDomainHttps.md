...
### Exemplo 1: habilitar HTTPS para um domínio personalizado com FrontDoorName e ResourceGroupName usando o certificado gerenciado de front door.
```powershell
...
Habilite o HTTPS para um domínio personalizado "frontendpointname1-Custom-XYZ" que faz parte da porta frontal "frontdoor1" no grupo de recursos "resourcegroup1" usando o certificado gerenciado pela porta frontal.

### Exemplo 2: habilitar HTTPS para um domínio personalizado com FrontDoorName e ResourceGroupName usando o próprio certificado no cofre de chaves.
```powershell
...
### Exemplo 3: habilitar HTTPS para um domínio personalizado com objeto PSFrontendEndpoint usando o certificado gerenciado pela porta frontal.
```powershell
...
Habilite HTTPS para um domínio personalizado com objeto PSFrontendEndpoint usando o certificado gerenciado de front door.

### Exemplo 4: habilitar HTTPS para um domínio personalizado com ID de recurso usando o certificado gerenciado pela porta frontal.
```powershell
...
Habilite o HTTPS para um domínio personalizado "frontendpointname1-Custom-XYZ" com a ID do recurso $resourceId usando o certificado gerenciado de front door.
...
### -MinimumTlsVersion
A versão mínima do TLS necessária dos clientes para estabelecer um handshake SSL com a porta frontal.
...
### -ResourceId
ID do recurso do ponto de extremidade da porta frontal para habilitar https
...
### -Secretname
O nome do segredo do cofre de chaves que representa o PFX de certificado completo
...
### -SecretVersion
A versão do segredo do cofre de chaves que representa o PFX de certificado completo
...
### -Cofreid
A ID do cofre de chaves que contém o certificado SSL
