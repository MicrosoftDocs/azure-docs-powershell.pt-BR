...
## DESCRITIVO
O cmdlet Resume-AzAnalysisServicesServer retoma uma instância do servidor do Analysis Services
...
Esse comando retomará um servidor pausado chamado TestServer no de teste do meu nome do o-botão
