...
Atualiza uma atribuição de registro com um nome e identificador de definição de registro.
...
A ID de recurso totalmente qualificado da definição de registro.
