...
## DESCRITIVO
O cmdlet Set-AzSynapseSqlPoolSensitivityClassification define os tipos de informações e rótulos de sensibilidade de colunas no pool do SQL.

## EXEMPLOS

### Exemplo 1: definir tipo de informação e rótulo de sensibilidade de uma coluna em um pool do SQL do Synapse do Azure.
```powershell
...
### Exemplo 2: definir tipos de informações recomendadas e rótulos de sensibilidade de colunas em um pool do SQL do Synapse do Azure.
```powershell
...
### Exemplo 3: definir tipo de informação e rótulo de sensibilidade de uma coluna em um pool do SQL do Synapse do Azure, usando o encanamento.
```powershell
