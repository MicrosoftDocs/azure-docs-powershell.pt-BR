...
## DESCRITIVO
O cmdlet Enable-AzSynapseSqlPoolSensitivityRecommendation permite recomendações de sensibilidade em colunas no pool do SQL.

## EXEMPLOS

### Exemplo 1: habilitar recomendações de sensibilidade em uma determinada coluna em um pool do SQL do Synapse do Azure.
```powershell
...
### Exemplo 2: habilitar recomendações de sensibilidade em uma determinada coluna do Azure Synapse pool do SQL usando o encanamento.
```powershell
