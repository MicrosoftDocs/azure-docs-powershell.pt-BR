...
### CreateByNameAndEnableAutoScaleParameterSet (padrão)
```
...
## DESCRITIVO
O cmdlet **New-AzSynapseSparkPool** cria um pool Spark do Azure Synapse Analytics.
...
Esse comando cria um pool Spark do Azure Synapse Analytics.
...
Esse comando cria um pool do Spark do Azure Synapse Analytics com escala automática habilitada.
...
Esse comando cria um pool do Spark do Azure Synapse Analytics por meio do pipeline.
...
Esse comando cria um pool Spark do Azure Synapse Analytics com escala automática habilitada por meio do pipeline.
