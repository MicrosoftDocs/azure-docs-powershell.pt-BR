...
## DESCRITIVO
O cmdlet **Reset-AzSynapseSqlPoolAdvancedThreatProtectionSetting** remove as configurações avançadas de proteção contra ameaças de um pool SQL do Azure Synapse Analytics.
...
Esse comando remove as configurações avançadas de proteção contra ameaças de um pool SQL chamado ContosoSqlPool sob o espaço de trabalho chamado ContosoWorkspace.
