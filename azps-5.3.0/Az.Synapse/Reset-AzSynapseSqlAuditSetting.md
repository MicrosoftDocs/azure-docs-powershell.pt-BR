...
Esse comando remove as configurações de auditoria de um espaço de trabalho de análise do Azure Synapse chamado ContosoWorkspace.
...
Esse comando remove as configurações de auditoria de um espaço de trabalho de análise do Azure Synapse chamado ContosoWorkspace pelo pipeline.
