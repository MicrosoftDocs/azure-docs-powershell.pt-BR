...
## DESCRITIVO
O cmdlet **Remove-AzSynapseSparkPool** exclui permanentemente um pool do Spark do Azure Synapse Analytics.
...
Esse comando exclui um pool Spark do Azure Synapse Analytics.
...
Esse comando exclui um pool do Spark do Azure Synapse Analytics pelo pipeline.
...
Esse comando exclui um pool Spark do Azure Synapse Analytics com uma ID do recurso.
