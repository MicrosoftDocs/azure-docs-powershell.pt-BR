...
## DESCRITIVO
[Este recurso está em uma visualização limitada, inicialmente acessível somente para determinadas assinaturas.] O cmdlet **Get-AzSynapseSqlDatabase** Obtém informações sobre um banco de dados SQL do Azure Synapse Analytics.
...
Esse comando obtém todos os bancos de dados SQL em um espaço de trabalho.
...
Esse comando obtém o banco de dados SQL em espaço de trabalho ContosoWorkspace com o nome ContosoSqlDatabase.
...
### -ResourceId
Identificador de recurso do banco de dados SQL do Synapse.
