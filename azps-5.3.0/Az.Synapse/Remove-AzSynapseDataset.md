...
## DESCRITIVO
O cmdlet **Remove-AzSynapseDataset** remove um DataSet do espaço de trabalho.
...
Esse comando Remove o DataSet chamado ContosoDataset do espaço de trabalho chamado ContosoWorkspace.
