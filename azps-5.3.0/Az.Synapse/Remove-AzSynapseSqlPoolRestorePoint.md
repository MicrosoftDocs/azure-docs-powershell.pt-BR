...
## DESCRITIVO
O cmdlet **Remove-AzSynapseSqlPoolRestorePoint** exclui permanentemente um ponto de restauração de pool do SQL do Azure Synapse Analytics.
...
Esse comando exclui um ponto de restauração de pool do SQL do Azure Synapse Analytics.
...
Esse comando exclui um pipeline de restauração do pool do SQL Synapse Analytics do Azure.
...
Esse comando exclui um ponto de restauração de pool do SQL do Azure Synapse Analytics com a ID do recurso especificada.
...
### -InputObject
Objeto de entrada do tempo de criação do pool de SQL, geralmente passado pelo pipeline.
...
Nome da data de criação do ponto de restauração do SQL do Synapse.
