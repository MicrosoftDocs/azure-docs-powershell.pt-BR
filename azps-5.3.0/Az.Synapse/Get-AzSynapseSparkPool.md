...
## DESCRITIVO
O cmdlet **Get-AzSynapseSparkPool** Obtém informações sobre um pool Spark do Azure Synapse Analytics.
...
Esse comando obtém todos os pools do Spark em um espaço de trabalho.
...
Esse comando obtém o pool do Spark em ContosoWorkspace do espaço de trabalho com o nome ContosoSparkPool.
...
Esse comando obtém todos os pools do Spark em um espaço de trabalho por meio do pipeline.
...
Esse comando obtém o pool do Spark com a ID do recurso especificada.
