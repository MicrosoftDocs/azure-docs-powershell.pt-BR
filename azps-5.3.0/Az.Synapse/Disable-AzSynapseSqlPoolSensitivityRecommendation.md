...
## DESCRITIVO
O cmdlet Disable-AzSynapseSqlPoolSensitivityRecommendation desabilita (ignora) as recomendações de sensibilidade em colunas no pool SQL.

## EXEMPLOS

### Exemplo 1: desabilitar recomendações de sensibilidade em uma determinada coluna em um pool do SQL do Synapse do Azure.
```powershell
...
### Exemplo 2: Desabilite as recomendações de sensibilidade em colunas com recomendações de sensibilidade em um pool do SQL Synapse do Azure usando o encanamento.
```powershell
...
### Exemplo 3: Desabilite as recomendações de sensibilidade em uma determinada coluna em um pool do SQL Synapse do Azure usando o encanamento.
```powershell
...
### -InputObject
Um objeto que representa uma classificação de sensibilidade de pool do SQL.
