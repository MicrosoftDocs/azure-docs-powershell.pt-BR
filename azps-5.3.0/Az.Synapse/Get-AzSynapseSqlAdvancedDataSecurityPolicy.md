...
Esse comando obtém a segurança avançada de dados no espaço de trabalho chamado ContosoWorkspace.
...
Esse comando obtém a segurança avançada de dados no espaço de trabalho chamado ContosoWorkspace pelo pipeline.
