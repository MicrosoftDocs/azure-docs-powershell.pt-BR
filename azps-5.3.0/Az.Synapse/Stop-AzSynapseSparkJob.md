...
### StopSparkJobByIdParameterSet (padrão)
```
...
## DESCRITIVO
O cmdlet **Stop-AzSynapseSparkJob** cancela um trabalho de análise do Synapse.
...
Este comando cancela um trabalho de Synapse analítico da análise.
...
Esse comando cancela um trabalho do Spark analítico do Synapse por meio do pipeline.
