...
## DESCRITIVO
O cmdlet **Get-AzSynapseIntegrationRuntimeNode** Obtém as informações detalhadas de um nó de tempo de execução de integração.
...
O cmdlet obtém informações do nó chamado ' Node_1 ' no tempo de execução de integração de hospedagem interna ' test-selfhost-IV ' na ContosoWorkspace do espaço de trabalho.
...
O cmdlet obtém informações do nó chamado ' Node_1 ' no tempo de execução de integração de hospedagem interna ' test-selfhost-IV ' no espaço de trabalho ' test-DF-EU2 ', incluindo o endereço IP.
