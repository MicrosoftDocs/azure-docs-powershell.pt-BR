...
## DESCRITIVO
O cmdlet **set-AzSynapseSqlPoolTransparentDataEncryption** modifica a propriedade de criptografia de dados transparente (TDE) de um pool SQL do Azure Synapse Analytics.
...
Esse comando habilita TDE para o pool SQL chamado ContosoSqlPool no espaço de trabalho chamado ContosoWorkspace.
...
### -Estado
O estado de criptografia de dados transparente do pool do SQL do Azure Synapse Analytics.
