...
## DESCRITIVO
O cmdlet **New-AzSynapseIntegrationRuntimeKey** regenera a chave de tempo de execução de integração com o nome de chave especificado pelo parâmetro ' KeyName '. A chave anterior será inválida.
