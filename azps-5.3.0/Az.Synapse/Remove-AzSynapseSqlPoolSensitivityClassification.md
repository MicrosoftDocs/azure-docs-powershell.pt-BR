...
## DESCRITIVO
O cmdlet Remove-AzSynapseSqlPoolSensitivityClassification remove os tipos de informações e rótulos de sensibilidade de colunas no pool do SQL.

## EXEMPLOS

### Exemplo 1: remover tipo de informação e rótulo de sensibilidade de uma coluna em um pool do SQL do Synapse do Azure.
```powershell
...
### Exemplo 2: remover tipos de informações atuais e rótulos de sensibilidade de colunas em um pool do SQL Synapse do Azure usando o encanamento.
```powershell
...
### Exemplo 3: remover tipo de informação e rótulo de sensibilidade de uma coluna em um pool do SQL Synapse do Azure usando o encanamento.
```powershell
