...
# Módulo AZ. Synapse
## Descritivo
Os tópicos desta seção documentam os cmdlets do PowerShell do Azure para a análise do Azure Synapse.

## Cmdlets AZ. Synapse
### [Add-AzSynapseTriggerSubscription](Add-AzSynapseTriggerSubscription.md)
Assine o gatilho de evento para eventos de serviço externo.
...
Desabilita as recomendações de sensibilidade (ignoradas) nas colunas no pool do SQL.
...
Permite recomendações de sensibilidade em colunas (as recomendações são habilitadas por padrão em todas as colunas) no pool do SQL.
...
Obtém uma regra de firewall de análise do Synapse.
...
Obtém uma definição de função de análise do Synapse.

### [Get-AzSynapseSparkJob](Get-AzSynapseSparkJob.md)
Obtém um trabalho do Spark de análise Synapse.

### [Get-AzSynapseSparkPool](Get-AzSynapseSparkPool.md)
Obtém um pool do Spark da análise Synapse.

### [Get-AzSynapseSparkSession](Get-AzSynapseSparkSession.md)
Obtém uma sessão do Spark Synapse Analytics.

### [Get-AzSynapseSparkStatement](Get-AzSynapseSparkStatement.md)
Obtém uma instrução do Synapse Analytics Analytics.

### [Get-AzSynapseSqlActiveDirectoryAdministrator](Get-AzSynapseSqlActiveDirectoryAdministrator.md)
Obtém informações sobre um administrador do Azure AD para Synapse de trabalho de análise.

### [Get-AzSynapseSqlAdvancedDataSecurityPolicy](Get-AzSynapseSqlAdvancedDataSecurityPolicy.md)
Obtém a política de segurança de dados avançada de um espaço de trabalho.

### [Get-AzSynapseSqlAdvancedThreatProtectionSetting](Get-AzSynapseSqlAdvancedThreatProtectionSetting.md)
Obtém as configurações avançadas de proteção contra ameaças para um espaço de trabalho.

### [Get-AzSynapseSqlAuditSetting](Get-AzSynapseSqlAuditSetting.md)
Obtém as configurações de auditoria de um espaço de trabalho de análise do Azure Synapse.

### [Get-AzSynapseSqlDatabase](Get-AzSynapseSqlDatabase.md)
Este recurso está em uma visualização limitada, inicialmente acessível somente para determinadas assinaturas. Obtém um banco de dados SQL do Synapse Analytics.

### [Get-AzSynapseSqlPool](Get-AzSynapseSqlPool.md)
Obtém um pool do SQL Synapse Analytics.
...
Recupera os pontos de restauração distintos a partir dos quais um pool do SQL Synapse Analytics pode ser restaurado.

### [Get-AzSynapseSqlPoolSensitivityClassification](Get-AzSynapseSqlPoolSensitivityClassification.md)
Obtém os tipos de informações atuais e os rótulos de sensibilidade de colunas no pool do SQL.
...
Obtém o estado TDE de um pool SQL.
...
Obtém as configurações de avaliação de vulnerabilidade de um pool SQL.

### [Get-AzSynapseSqlVulnerabilityAssessmentSetting](Get-AzSynapseSqlVulnerabilityAssessmentSetting.md)
Obtém as configurações de avaliação de vulnerabilidade de um espaço de trabalho.

### [Get-AzSynapseTrigger](Get-AzSynapseTrigger.md)
Obtém informações sobre gatilhos em um espaço de trabalho.
...
Obtém um espaço de trabalho de análise do Synapse.
...
Cria um pool Spark do Synapse Analytics.

### [New-AzSynapseSqlDatabase](New-AzSynapseSqlDatabase.md)
Este recurso está em uma visualização limitada, inicialmente acessível somente para determinadas assinaturas. Cria um banco de dados SQL analítico do Synapse.
...
Cria um espaço de trabalho de análise do Synapse.
...
Remove um conjunto de um conjunto de espaço de trabalho.

### [Remove-AzSynapseFirewallRule](Remove-AzSynapseFirewallRule.md)
Exclui uma regra de firewall de análise do Synapse.
...
Exclui uma atribuição de função de análise do Synapse.

### [Remove-AzSynapseSparkPool](Remove-AzSynapseSparkPool.md)
Exclui um pool Spark do Synapse Analytics.
...
Este recurso está em uma visualização limitada, inicialmente acessível somente para determinadas assinaturas. Exclui um banco de dados SQL do Synapse Analytics.
...
Exclui um ponto de restauração de pool do SQL do Synapse Analytics.

### [Remove-AzSynapseSqlPoolSensitivityClassification](Remove-AzSynapseSqlPoolSensitivityClassification.md)
Remove os tipos de informações e os rótulos de sensibilidade de colunas no pool do SQL.

### [Remove-AzSynapseTrigger](Remove-AzSynapseTrigger.md)
Remove um gatilho de um espaço de trabalho.

### [Remove-AzSynapseTriggerSubscription](Remove-AzSynapseTriggerSubscription.md)
Cancele a assinatura do gatilho de evento para eventos de serviço externo.
...
Redefine o tempo limite de uma sessão do Spark Synapse Analytics.

### [Reset-AzSynapseSqlAdvancedThreatProtectionSetting](Reset-AzSynapseSqlAdvancedThreatProtectionSetting.md)
Remove as configurações avançadas de proteção contra ameaças de um espaço de trabalho.
...
Vincula um repositório de dados ou um serviço na nuvem para o espaço de trabalho.
...
Provisiona um administrador do Azure AD para pool do SQL Synapse Analytics.
...
Define os tipos de informações e rótulos de sensibilidade de colunas no pool do SQL.

### [Set-AzSynapseSqlPoolTransparentDataEncryption](Set-AzSynapseSqlPoolTransparentDataEncryption.md)
Modifica a propriedade TDE de um pool SQL.
...
Cria um gatilho em um espaço de trabalho.
...
Inicia um gatilho em um espaço de trabalho.

### [Parar-AzSynapsePipelineRun](Stop-AzSynapsePipelineRun.md)
Interrompe uma execução de pipeline em um espaço de trabalho.

### [Parar-AzSynapseSparkJob](Stop-AzSynapseSparkJob.md)
Cancela um trabalho do Spark de análise do Synapse.

### [Parar-AzSynapseSparkSession](Stop-AzSynapseSparkSession.md)
Interrompe uma sessão do Spark Synapse Analytics.

### [Parar-AzSynapseSparkStatement](Stop-AzSynapseSparkStatement.md)
Cancela uma declaração de Synapse analítico da análise.

### [Parar-AzSynapseTrigger](Stop-AzSynapseTrigger.md)
Interrompe um gatilho em um espaço de trabalho.

### [Enviar-AzSynapseSparkJob](Submit-AzSynapseSparkJob.md)
Envia um trabalho Spark de análise Synapse.

### [Suspender-AzSynapseSqlPool](Suspend-AzSynapseSqlPool.md)
Suspende um pool SQL do Synapse Analytics.
...
Verifica a existência de um pool Spark do Analytics Synapse.

### [Test-AzSynapseSqlDatabase](Test-AzSynapseSqlDatabase.md)
Este recurso está em uma visualização limitada, inicialmente acessível somente para determinadas assinaturas. Verifica a existência de um banco de dados SQL do Synapse Analytics.

### [Test-AzSynapseSqlPool](Test-AzSynapseSqlPool.md)
Verifica a existência de um pool do SQL Synapse Analytics.

### [Test-AzSynapseWorkspace](Test-AzSynapseWorkspace.md)
Verifica a existência de um espaço de trabalho de análise do Synapse.

### [Update-AzSynapseFirewallRule](Update-AzSynapseFirewallRule.md)
Atualiza uma regra de firewall de análise do Synapse.
...
Atualiza um pool Spark do Synapse Analytics.

### [Update-AzSynapseSqlAdvancedThreatProtectionSetting](Update-AzSynapseSqlAdvancedThreatProtectionSetting.md)
Atualiza as configurações avançadas de proteção contra ameaças em um espaço de trabalho.

### [Update-AzSynapseSqlDatabase](Update-AzSynapseSqlDatabase.md)
Este recurso está em uma visualização limitada, inicialmente acessível somente para determinadas assinaturas. Atualiza um banco de dados do SQL Synapse Analytics.

### [Update-AzSynapseSqlPool](Update-AzSynapseSqlPool.md)
Atualiza um pool do SQL Synapse Analytics.
...
Atualiza as configurações de avaliação de vulnerabilidade de um pool SQL.

### [Update-AzSynapseSqlVulnerabilityAssessmentSetting](Update-AzSynapseSqlVulnerabilityAssessmentSetting.md)
Atualiza as configurações de avaliação de vulnerabilidade de um espaço de trabalho.

### [Update-AzSynapseWorkspace](Update-AzSynapseWorkspace.md)
Atualiza um espaço de trabalho de análise do Synapse.

### [Wait-AzSynapseSparkJob](Wait-AzSynapseSparkJob.md)
Aguarda a conclusão de um trabalho do Spark do Synapse Analytics.
