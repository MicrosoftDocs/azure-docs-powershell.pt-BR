...
## Sinopse
Exclui um banco de dados SQL do Synapse Analytics.
...
## DESCRITIVO
O cmdlet **Remove-AzSynapseSqlPool** exclui permanentemente um banco de dados SQL do Azure Synapse Analytics.
...
Esse comando exclui um banco de dados SQL do Azure Synapse Analytics.
...
Esse comando exclui um banco de dados SQL do Azure Synapse Analytics por meio do pipeline.
...
Esse comando exclui um banco de dados SQL do Azure Synapse Analytics com a ID do recurso especificada.
...
### -InputObject
Objeto de entrada de banco de dados SQL, geralmente passado pelo pipeline.
