...
## DESCRITIVO
O cmdlet **set-AzSynapseSqlActiveDirectoryAdministrator** provisiona um administrador do Azure Active Directory (Azure AD) para o Azure Synapse espaço de trabalho de análise na assinatura atual.
Você pode provisionar apenas um administrador de cada vez.
Os seguintes membros do Azure AD podem ser provisionados como administrador do espaço de trabalho de análise do Synapse:
...
Esse comando provisiona um grupo de administradores do Azure AD chamado DBAs para o espaço de trabalho chamado ContosoWorkspace.
