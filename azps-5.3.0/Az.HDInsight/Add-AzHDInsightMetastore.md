...
## DESCRITIVO
O cmdlet **Add-AzHDInsightMetastore** adiciona um Hive ou Oozie metastore ao objeto de configuração do HDInsight criado pelo cmdlet New-AzHDInsightClusterConfig.
...
### Exemplo 2: adicionar um banco de dados do Ambari personalizado ao objeto de configuração do cluster
```
PS C:\># Primary storage account info
PS C:\> $storageAccountResourceGroupName = "Group"
PS C:\> $storageAccountResourceId = "yourstorageaccountresourceid"
...
Esse comando adiciona um banco de dados do Ambari personalizado ao cluster chamado Your-Hadoop-002.
