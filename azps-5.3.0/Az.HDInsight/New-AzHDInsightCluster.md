...
## DESCRITIVO
O New-AzHDInsightCluster cria um cluster do Azure HDInsight usando os parâmetros especificados ou usando um objeto de configuração que é criado usando o cmdlet New-AzHDInsightClusterConfig.
...
### Exemplo 2: criar cluster com a chave de criptografia de disco gerenciada pelo cliente
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exemplo 3: criar um cluster do Azure HDInsight que permite a criptografia em trânsito
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exemplo 4: criar um cluster do Azure HDInsight com o recurso de link de transmissão de saída e particular
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exemplo 5: criar um cluster do Azure HDInsight que permite a criptografia no host
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exemplo 6: criar um cluster do Azure HDInsight que permite a autoescala.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exemplo 7: criar um cluster do Azure HDInsight com proxy Kafka REST.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exemplo 8: criar um cluster do Azure HDInsight com armazenamento do Azure data Lake Gen2.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exemplo 9: criar um cluster do Azure HDInsight com o pacote de segurança da empresa (ESP) e habilitar o agente de ID do HDInsight.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
Especifica as contas de armazenamento adicionais do Azure para o cluster.
Você também pode usar o cmdlet Add-AzHDInsightStorage.
...
### -ClusterSizeInNodes
Especifica o número de nós de trabalho do cluster.
...
Esse objeto pode ser criado usando o cmdlet New-AzHDInsightClusterConfig.
...
Você também pode usar o cmdlet Add-AzHDInsightConfigValues.
...
### -EnableIDBroker
Habilita o recurso do agente de identidade do HDInsight.
...
### -HiveMetastore
Especifica o banco de dados SQL para armazenar metadados de Hive.
...
### -KafkaClientGroupId
Obtém ou define a ID do grupo do cliente para o acesso ao proxy REST Kafka.
...
Obtém ou define o nome do grupo do cliente para o acesso ao proxy REST Kafka.
...
### -OozieMetastore
Especifica o banco de dados SQL para armazenar metadados de Oozie.
Você também pode usar o cmdlet Add-AzHDInsightMetastore.
...
### -RdpCredential
Especifica as credenciais da área de trabalho remota (RDP) para o cluster.
...
### -ScriptActions
Especifica as ações de script a serem executadas no cluster ao final da criação do cluster.
Você também pode usar Add-AzHDInsightScriptAction.
...
Você também pode usar o cmdlet Add-AzHDInsightSecurityProfile.
...
Isso somente para clusters Linux.
...
### -StorageAccountKey
Obtém ou define a chave de acesso da conta de armazenamento da conta de armazenamento.
...
Obtém ou define a ID do recurso de armazenamento da conta de armazenamento.
...
### -StorageContainer
Obtém ou define o nome do StorageContainer para a conta de armazenamento padrão do Azure
...
### -StorageRootPath
Obtém ou define o caminho para a raiz do cluster na conta padrão do repositório do data Lake.
...
### -SubnetName
Obtém ou define o nome de sub-rede para este cluster HDInsight.
