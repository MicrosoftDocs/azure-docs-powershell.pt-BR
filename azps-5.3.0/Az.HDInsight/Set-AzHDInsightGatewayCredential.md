...
## DESCRITIVO
O cmdlet **set-AzHDInsightGatewayCredential** define a credencial do gateway de um cluster do Azure HDInsight.
...
Este comando define a credencial do gateway do cluster chamado seu-Hadoop-001 por parâmetro de nome definido.
...
Este comando define a credencial do gateway do cluster chamado seu conjunto de parâmetros-Hadoop-001 by ResourceId.
...
Este comando define a credencial do gateway do cluster chamado seu-Hadoop-001 com o parâmetro InputObject definido.
