...
## Sinopse
Cria um objeto para atualizar as propriedades da NIC de um servidor de replicação.
...
Cria um objeto de atualização de NIC.
...
### -TargetNicIP
Especifica o IP na sub-rede de destino a ser usada para a NIC.
