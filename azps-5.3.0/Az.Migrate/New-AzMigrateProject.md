...
Método para criar um novo projeto migrar.
...
### -Propriedade
Especifica as propriedades do projeto.
Para construir, consulte a seção observações para propriedades de propriedades e crie uma tabela de hash.
...
Propriedade <IMigrateProjectProperties> : especifica as propriedades do projeto.
  - `[ProvisioningState <ProvisioningState?>]`: Configuração do estado do projeto de migração.
  - `[RegisteredTool <String[]>]`: Obtém ou define a lista de ferramentas registradas com o projeto de migração.
