...
## DESCRITIVO
O cmdlet **Get-AzKeyVaultManagedHsm** Obtém informações sobre os HSMs gerenciados em uma assinatura. Você pode exibir todas as instâncias de HSMs gerenciadas em uma assinatura ou filtrar os resultados por um grupo de recursos ou HSM gerenciado específico.
Observe que, embora a especificação do grupo de recursos seja opcional para esse cmdlet quando você obtém um único HSM gerenciado, você deve fazê-lo para melhorar o desempenho.
...
Esse comando obtém todos os HSMs gerenciados na sua assinatura atual.
...
Este comando obtém o HSM gerenciado chamado myhsm na sua assinatura atual.
...
### Exemplo 4: obter HSMs gerenciados usando a filtragem
```powershell
PS C:\> Get-AzKeyVaultManagedHsm -Name 'myhsm*'
...
Esse comando obtém todos os HSMs gerenciados na assinatura que começa com "myhsm".
...
### -Marca
Especifica a chave e o valor opcional da marca especificada para filtrar a lista de HSMs gerenciados por.
