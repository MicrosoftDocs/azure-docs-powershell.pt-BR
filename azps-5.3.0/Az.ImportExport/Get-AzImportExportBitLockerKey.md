...
## Sinopse
Retorna as chaves BitLocker para todas as unidades no trabalho especificado.
...
### Exemplo 1: listar todas as chaves do BitLocker no trabalho ImportExport especificado
```powershell
...
Esse cmdlet lista todas as chaves do BitLocker no trabalho ImportExport especificado.
