...
### Exemplo 1: criar um HostPool de área de trabalho virtual do Windows por nome
```powershell
...
Esse comando cria uma HostPool da área de trabalho virtual do Windows em um grupo de recursos.
...
### -DesktopAppGroupName
Nome do grupo do aplicativo da área de trabalho
...
### -MaxSessionLimit
O limite máximo da sessão de HostPool.
...
Tipo de PersonalDesktopAssignment para HostPool.
...
O tipo de tipo de grupo de aplicativos preferencial, padrão para grupo de aplicativos de área de trabalho
...
A cadeia de caracteres codificada em base64 do token de registro.
...
### -Ring
O número de toques de HostPool.
...
### -SsoadfsAuthority
URL para o servidor ADFS do cliente para autenticação de certificados de SSO do WVD.
...
### -SsoClientId
ClientId para a terceira parte confiável usada para emitir certificados de SSO do WVD.
...
Caminho para o cofre de chave do Azure que armazena o segredo usado para comunicação com o ADFS.
...
### -SsoContext
Caminho para o keyvault que contém ssoContext segredo.
...
### -SsoSecretType
O tipo de tipo de segredo de logon único.
...
### -VMTemplate
Modelo de VM para configuração do sessionhosts em hostpool.
