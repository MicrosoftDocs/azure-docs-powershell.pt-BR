...
### Exemplo 1: obter um pacote MSIX por nome
```powershell
...
Esse comando obtém um pacote MSIX em um HostPool.

### Exemplo 2: list MSIX Packages 
```powershell
...
Esse comando lista os pacotes MSIX em um HostPool.
