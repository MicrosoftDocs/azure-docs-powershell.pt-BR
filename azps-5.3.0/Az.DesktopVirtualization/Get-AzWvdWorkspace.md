...
### Exemplo 1: obter um espaço de trabalho da área de trabalho virtual do Windows por nome
```powershell
...
Este comando obtém um espaço de trabalho da área de trabalho virtual do Windows em um grupo de recursos.

### Exemplo 2: listar espaços de trabalho da área de trabalho virtual do Windows
```powershell
...
Esse comando lista um espaço de trabalho de área de trabalho virtual do Windows em um grupo de recursos.
