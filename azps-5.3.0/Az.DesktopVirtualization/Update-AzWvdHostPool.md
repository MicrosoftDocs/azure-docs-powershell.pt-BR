...
### Exemplo 1: atualizar um HostPool de área de trabalho virtual do Windows por nome
```powershell
...
Esse comando atualiza um HostPool de área de trabalho virtual do Windows em um grupo de recursos.
