...
### Exemplo 1: atualizar um espaço de trabalho da área de trabalho virtual do Windows por nome
```powershell
...
Este comando atualiza um espaço de trabalho da área de trabalho virtual do Windows em um grupo de recursos.

## OS

### -ApplicationGroupReference
Lista de links de um aplicativo.
