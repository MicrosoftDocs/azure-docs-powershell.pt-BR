...
### Exemplo 1: atualizar um pacote do MSIX 
```powershell
...
Esse comando atualiza um pacote MSIX em um HostPool.
...
### -DisplayName
Nome para exibição do pacote MSIX.
...
### -IsActive
Defina uma versão do pacote a ser ativada em hostpool.
