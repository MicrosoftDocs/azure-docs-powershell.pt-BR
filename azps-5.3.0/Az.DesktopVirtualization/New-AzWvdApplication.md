...
### Exemplo 1: criar um aplicativo de área de trabalho virtual do Windows
```powershell
...
Esse comando cria um aplicativo de área de trabalho virtual do Windows em um grupo applicaton.

## OS

### -AppAlias
Alias do aplicativo do item do menu iniciar
...
### -CommandLineArgument
Argumentos de linha de comando do aplicativo.
...
### -CommandLineSetting
Especifica se esse aplicativo publicado pode ser iniciado com argumentos de linha de comando fornecidos pelo cliente, argumentos de linha de comando especificados no tempo de publicação ou nenhum argumento de linha de comando.
...
### -FilePath
Especifica um caminho para o arquivo executável do aplicativo.
...
Especifica a ID do aplicativo do pacote para aplicativos MSIX
...
Especifica o nome da família de pacotes para aplicativos do MSIX
...
### -ShowInPortal
Especifica se o programa RemoteApp deve ser mostrado no servidor de acesso à Web da área de trabalho remota.
