...
## Sinopse
Cria uma configuração agendada de atualização do software de automação do Azure.
...
## DESCRITIVO
Cria uma configuração de atualização de software que é executada em um cronograma para atualizar uma lista de computadores. Os computadores incluem máquinas virtuais do Azure ou computadores não AZ.

## EXEMPLOS

### Exemplo 1
Cria uma configuração de atualização de software para instalar atualizações críticas em duas máquinas virtuais do Windows Azure a cada sábado 9PM. A duração da atualização é definida como 2 horas neste exemplo.
...
### -AzureQuery
Consulta do Azure em grupo dinâmico.
...
### -ExcludedKbNumber
KB número de atualizações excluídas.
...
Máscaras de pacotes Linux excluídas.
...
### -IncludedKbNumber
KB número de atualizações incluídas.
...
Classificações de pacotes Linux incluídas.
...
Máscaras de pacotes Linux incluídas.
...
Classificações de atualização do Windows incluídas.
...
### -Linux
Indica que a configuração de atualização de software está direcionada para computadores com sistema operacional Linux.
...
### -NonAzureQuery
Grupo dinâmico não consulta do Azure.
...
### -RebootOnly
Indica que a configuração da atualização de software somente reinicializará as máquinas.
...
### -Cronograma
Agendar objeto usado para configuração de atualização de software.
...
### -Windows
Indica que a configuração de atualização de software está direcionada para máquinas do sistema operacional Windows.
