...
## DESCRITIVO
O cmdlet **Remove-AzAutomationSchedule** exclui um cronograma da automação do Azure.
...
Esse comando exclui o agendamento chamado Schedule01 na conta de automação Contoso17 no ResourceGroup01 do grupo de recursos.

## OS

### -AutomationAccountName
Especifica o nome de uma conta de automação para a qual esse cmdlet Remove um cronograma.
