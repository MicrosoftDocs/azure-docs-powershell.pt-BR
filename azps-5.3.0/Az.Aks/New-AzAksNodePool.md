...
### Criar pool de nós com parâmetros padrão
```powershell
...
### -Clusterobject
Especifique o objeto de cluster no qual criar o pool de nós.
...
### -Force
Crie um pool de nós mesmo se ele já existir
...
### -OsType
OsType a ser usado para especificar o tipo de sistema operacional.
Escolha entre Linux e Windows.
Padrão para Linux.
...
ScaleSetEvictionPolicy a ser usado para especificar a política de remoção para conjunto de escala de máquina virtual de baixa prioridade.
Padrão a ser excluído.
...
### -ScaleSetPriority
ScaleSetPriority a ser usado para especificar a prioridade do conjunto de escala da máquina virtual.
O padrão é normal.
...
### -VmSetType
Representa tipos de um pool de nós.
Os valores possíveis incluem: ' VirtualMachineScaleSets ', ' Availabilityset '
