...
### Alterar a contagem de Minimun para 5 para o pool de nós especificado
```powershell
...
### -Force
Atualizar o pool de nós sem avisar
...
### -ID
ID de um pool de nós no cluster de kubernetes gerenciados
