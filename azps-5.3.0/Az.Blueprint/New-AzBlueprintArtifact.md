...
## DESCRITIVO
Crie um novo artefato. Há duas maneiras de criar um artefato: por meio de um artefato JSON como um arquivo de entrada ou de fornecer parâmetros embutidos para o artefato. Embora o método JSON não exija o tipo do método de parâmetro embutido que deve ser fornecido, o usuário deve fornecer o tipo do parâmetro artefato por tipo.
