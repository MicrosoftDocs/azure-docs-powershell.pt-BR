...
### -PassThru
Quando definido, o cmdlet retornará um objeto que representa a atribuição Blueprint removida. Por padrão, esse cmdlet não gera nenhuma saída.
