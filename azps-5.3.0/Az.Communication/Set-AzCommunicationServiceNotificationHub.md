...
Um hub de notificação vinculado permite que um recurso do ACS envie notificações para certos eventos.
...
Descrição de um hub de notificação do Azure para vincular o serviço de comunicação a ser construído, consulte a seção notas para propriedades LINKNOTIFICATIONHUBPARAMETER e crie uma tabela de hash.
...
LINKNOTIFICATIONHUBPARAMETER <ILinkNotificationHubParameters> : Descrição de um hub de notificação do Azure para vincular ao serviço de comunicação
