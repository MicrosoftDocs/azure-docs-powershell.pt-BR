...
Esse comando atualiza o protocolo de cliente do banco de dados para o cache corporativo Redis chamado myCache.

### Exemplo 2: atualizar o protocolo de cliente e a política de remoção
```powershell
...
Esse comando atualiza o protocolo de cliente e a política de remoção do banco de dados para o cache corporativo Redis nomeado como myCache.
