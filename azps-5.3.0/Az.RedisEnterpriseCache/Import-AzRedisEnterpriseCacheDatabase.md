...
### Exemplo 1: importar banco de dados
```powershell
...
Esse comando importa um arquivo de banco de dados para o banco de dados do cache corporativo Redis nomeado como myCache.

### Exemplo 2: importar banco de dados (usando o arquivo de exemplo)
```powershell
#[SuppressMessage("Microsoft.Security", "CS002:SecretInNextLine", Justification="Invalid SAS token")]
...
### -SasUri
URI da SAS para o qual o blob de destino será importado
