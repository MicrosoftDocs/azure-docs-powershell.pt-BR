...
Esse comando exporta o banco de dados do Redis Enterprise cache nomeado myCache para um arquivo de banco de dados.
...
### -SasUri
URI de SAS para o diretório de destino para o qual exportar
