...
### Exemplo 1: obter as chaves de acesso ao banco de dados
```powershell
...
Esse comando obtém as teclas de acesso secreta usadas para autenticar conexões com o banco de dados do cache corporativo do Redis nomeado como myCache.
