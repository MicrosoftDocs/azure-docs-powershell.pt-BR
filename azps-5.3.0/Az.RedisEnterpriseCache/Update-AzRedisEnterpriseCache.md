...
### Exemplo 1: atualizar o cache corporativo do Redis
```powershell
...
Esse comando atualiza a versão mínima do TLS e adiciona uma marca ao cache corporativo do Redis chamado myCache.
...
### -MinimumTlsVersion
A versão de TLS mínima para o cluster dar suporte, por exemplo, ' 1,2 '
