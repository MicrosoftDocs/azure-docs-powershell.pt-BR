...
## DESCRITIVO
O cmdlet Get-AzContainerRegistryReplication Obtém uma replicação especificada de um registro de contêiner ou todas as replicações de um registro de contêiner.

## EXEMPLOS

### Exemplo 1: Obtém uma replicação especificada de um registro de contêiner
```powershell
...
### Exemplo 2: Obtém todas as replicações de um registro de contêiner
```powershell
...
Obtém todas as replicações de um registro de contêiner
