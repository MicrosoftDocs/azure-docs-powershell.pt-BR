...
### Exemplo 1: obter um banco de dados MySql por nome do recurso
```powershell
...
Este cmdlet obtém o MySql Server por nome do recurso.
...
Esse cmdlet obtém um servidor MySql por identidade.
...
Esse cmdlet lista todos os servidores MySql em um servidor especificado.
