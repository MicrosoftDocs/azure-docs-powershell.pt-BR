...
### Exemplo 1: atualizar um banco de dados de servidor MySql por nome
```powershell
...
Atualizar um banco de dados pelo nome do recurso.

### Exemplo 2: Atualize o banco de dados MySql por parâmetro.
```powershell
