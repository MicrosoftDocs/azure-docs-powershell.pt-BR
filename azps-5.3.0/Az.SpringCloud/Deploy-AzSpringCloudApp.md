...
### Exemplo 1: implantar jar compilado local para serviço por nome.
```powershell
...
Implantar jar compilado local para o serviço por nome.
...
### -JarPath
O caminho do jar precisa ser deploied.
