...
### Exemplo 1: obter o aplicativo de nuvem Spring Deploymeng por nome.
```powershell
...
Obtenha o aplicativo de nuvem Spring Deploymeng por nome.

### Exemplo 2: listar toda a implantação em um determinado aplicativo de nuvem Spring.
```powershell
...
Listar toda a implantação em um determinado aplicativo de nuvem Spring.
