...
### Exemplo 1: atualizar a implantação de nuvem da mola por nome.
```powershell
...
Atualize a implantação de nuvem da mola por nome.

### Exemplo 2: atualizar a implantação de nuvem da mola do pipe.
```powershell
...
Atualize a implantação de nuvem da mola do pipe.
