...
ms.locfileid: "98433547"
---
# <span data-ttu-id="ee683-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="ee683-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="ee683-102">Sinopse</span><span class="sxs-lookup"><span data-stu-id="ee683-102">SYNOPSIS</span></span>
<span data-ttu-id="ee683-103">Obtém informações sobre uma configuração do servidor.</span><span class="sxs-lookup"><span data-stu-id="ee683-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="ee683-104">SYNTAX</span><span class="sxs-lookup"><span data-stu-id="ee683-104">SYNTAX</span></span>

### <span data-ttu-id="ee683-105">Lista (padrão)</span><span class="sxs-lookup"><span data-stu-id="ee683-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="ee683-106">Obter</span><span class="sxs-lookup"><span data-stu-id="ee683-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="ee683-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="ee683-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="ee683-108">DESCRITIVO</span><span class="sxs-lookup"><span data-stu-id="ee683-108">DESCRIPTION</span></span>
<span data-ttu-id="ee683-109">Obtém informações sobre uma configuração do servidor.</span><span class="sxs-lookup"><span data-stu-id="ee683-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="ee683-110">EXEMPLOS</span><span class="sxs-lookup"><span data-stu-id="ee683-110">EXAMPLES</span></span>

### <span data-ttu-id="ee683-111">Exemplo 1: listar todas as configurações em um MariaDB</span><span class="sxs-lookup"><span data-stu-id="ee683-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="ee683-112">Esse comando lista todas as configurações em um MariaDB.</span><span class="sxs-lookup"><span data-stu-id="ee683-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="ee683-113">Exemplo 2: obter uma configuração de MariaDB</span><span class="sxs-lookup"><span data-stu-id="ee683-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="ee683-114">Esse comando obtém uma configuração de MariaDB.</span><span class="sxs-lookup"><span data-stu-id="ee683-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="ee683-115">OS</span><span class="sxs-lookup"><span data-stu-id="ee683-115">PARAMETERS</span></span>

### <span data-ttu-id="ee683-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="ee683-116">-DefaultProfile</span></span>
<span data-ttu-id="ee683-117">As credenciais, a conta, o locatário e a assinatura usados para comunicação com o Azure.</span><span class="sxs-lookup"><span data-stu-id="ee683-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="ee683-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="ee683-118">-InputObject</span></span>
<span data-ttu-id="ee683-119">Parâmetro de identidade para construir, consulte a seção de observações para as propriedades INPUTobject e crie uma tabela de hash.</span><span class="sxs-lookup"><span data-stu-id="ee683-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="ee683-120">-Nome</span><span class="sxs-lookup"><span data-stu-id="ee683-120">-Name</span></span>
<span data-ttu-id="ee683-121">O nome da configuração do servidor.</span><span class="sxs-lookup"><span data-stu-id="ee683-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="ee683-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="ee683-122">-ResourceGroupName</span></span>
<span data-ttu-id="ee683-123">O nome do grupo de recursos que contém o recurso.</span><span class="sxs-lookup"><span data-stu-id="ee683-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="ee683-124">Você pode obter esse valor da API do Azure Resource Manager ou do Portal.</span><span class="sxs-lookup"><span data-stu-id="ee683-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="ee683-125">-Nomedoservidor</span><span class="sxs-lookup"><span data-stu-id="ee683-125">-ServerName</span></span>
<span data-ttu-id="ee683-126">O nome do servidor.</span><span class="sxs-lookup"><span data-stu-id="ee683-126">The name of the server.</span></span>
...
### <span data-ttu-id="ee683-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="ee683-127">-SubscriptionId</span></span>
<span data-ttu-id="ee683-128">A ID da assinatura que identifica uma assinatura do Azure.</span><span class="sxs-lookup"><span data-stu-id="ee683-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="ee683-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="ee683-129">CommonParameters</span></span>
<span data-ttu-id="ee683-130">Esse cmdlet dá suporte a parâmetros comuns:-debug,-ErrorAction,-ErrorVariable,-Informationaction,-InformationVariable,-OutVariable,-OutBuffer,-PipelineVariable,-Verbose-WarningAction e-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="ee683-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="ee683-131">Para obter mais informações, consulte [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="ee683-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="ee683-132">SENSORES</span><span class="sxs-lookup"><span data-stu-id="ee683-132">INPUTS</span></span>

### <span data-ttu-id="ee683-133">Microsoft. Azure. PowerShell. cmdlets. MariaDb. Models. IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="ee683-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="ee683-134">EXIBE</span><span class="sxs-lookup"><span data-stu-id="ee683-134">OUTPUTS</span></span>

### <span data-ttu-id="ee683-135">Microsoft. Azure. PowerShell. cmdlets. MariaDb. Models. Api20180601Preview. IConfiguration</span><span class="sxs-lookup"><span data-stu-id="ee683-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="ee683-136">INFORMA</span><span class="sxs-lookup"><span data-stu-id="ee683-136">NOTES</span></span>

<span data-ttu-id="ee683-137">ALIASES</span><span class="sxs-lookup"><span data-stu-id="ee683-137">ALIASES</span></span>

<span data-ttu-id="ee683-138">PROPRIEDADES DE PARÂMETROS COMPLEXAS</span><span class="sxs-lookup"><span data-stu-id="ee683-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="ee683-139">Para criar os parâmetros descritos abaixo, construa uma tabela de hash contendo as propriedades adequadas.</span><span class="sxs-lookup"><span data-stu-id="ee683-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="ee683-140">Para obter informações sobre tabelas de hash, execute Get-Help about_Hash_Tables.</span><span class="sxs-lookup"><span data-stu-id="ee683-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="ee683-141">INPUTobject <IMariaDbIdentity> : parâmetro de identidade</span><span class="sxs-lookup"><span data-stu-id="ee683-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="ee683-142">`[ConfigurationName <String>]`: O nome da configuração do servidor.</span><span class="sxs-lookup"><span data-stu-id="ee683-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="ee683-143">`[DatabaseName <String>]`: O nome do banco de dados.</span><span class="sxs-lookup"><span data-stu-id="ee683-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="ee683-144">`[FirewallRuleName <String>]`: O nome da regra de firewall do servidor.</span><span class="sxs-lookup"><span data-stu-id="ee683-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="ee683-145">`[Id <String>]`: Caminho de identidade do recurso</span><span class="sxs-lookup"><span data-stu-id="ee683-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="ee683-146">`[LocationName <String>]`: O nome do local.</span><span class="sxs-lookup"><span data-stu-id="ee683-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="ee683-147">`[ResourceGroupName <String>]`: O nome do grupo de recursos que contém o recurso.</span><span class="sxs-lookup"><span data-stu-id="ee683-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="ee683-148">Você pode obter esse valor da API do Azure Resource Manager ou do Portal.</span><span class="sxs-lookup"><span data-stu-id="ee683-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="ee683-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: O nome da política de alerta de segurança.</span><span class="sxs-lookup"><span data-stu-id="ee683-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="ee683-150">`[ServerName <String>]`: O nome do servidor.</span><span class="sxs-lookup"><span data-stu-id="ee683-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="ee683-151">`[SubscriptionId <String>]`: A ID da assinatura que identifica uma assinatura do Azure.</span><span class="sxs-lookup"><span data-stu-id="ee683-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="ee683-152">`[VirtualNetworkRuleName <String>]`: O nome da regra de rede virtual.</span><span class="sxs-lookup"><span data-stu-id="ee683-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="ee683-153">LINKS RELACIONADOS</span><span class="sxs-lookup"><span data-stu-id="ee683-153">RELATED LINKS</span></span>
