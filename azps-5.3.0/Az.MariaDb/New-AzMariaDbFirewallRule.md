...
### Exemplo 1: criar uma regra de firewall em um MariaDB
```powershell
...
Esse comando cria uma regra de firewall em um MariaDB.

### Exemplo 2: criar uma nova regra de firewall MariaDB usando-ClientIPAddress.
```powershell
...
Esses cmdlets criam uma regra de firewall MariaDB usando-ClientIPAddress.

### Exemplo 3: criar uma nova regra de firewall MariaDB para permitir todos os IPs
```powershell
...
Esses cmdlets criam uma nova regra de firewall MariaDB para permitir que todos os IPs.
...
Se não for especificado, o padrão será indefinido.
