...
### Exemplo 1: obter um ambiente de insights série temporal
```powershell
...
Esse comando obtém um ambiente de insights série de tempo.

### Exemplo 2: listar todos os ambientes de insights série de tempo
```powershell
...
Esse comando lista todos os ambientes de insights série de tempo em um grupo de recursos.

### Exemplo 3: obter um ambiente do insights série de tempo por objeto
```powershell
...
### -Expandir
A configuração de $expand = status incluirá o status dos serviços internos do ambiente no serviço insights série de tempo.
