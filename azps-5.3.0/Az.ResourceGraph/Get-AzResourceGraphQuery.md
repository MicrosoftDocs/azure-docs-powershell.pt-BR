...
## Sinopse
Obtenha uma única consulta de gráfico por meio de seu Resource resourcer.
...
### Exemplo 2: obter uma consulta de gráfico de recursos por objecy
```powershell
...
INPUTobject <IResourceGraphIdentity> : parâmetro de identidade
  ...
  - `[ResourceName <String>]`: O nome do recurso de consulta de gráfico.
