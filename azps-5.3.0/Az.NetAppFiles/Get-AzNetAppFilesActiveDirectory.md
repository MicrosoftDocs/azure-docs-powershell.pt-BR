...
## DESCRITIVO
O cmdlet **Get-AzNetAppFilesActiveDirectory** Obtém detalhes de uma configuração de contas do anf do Active Directory.
...
Esse comando obtém a configuração de anúncio chamada MyADConfigName para a conta do Azure NetApp Files (ANF) chamada MyAnfAccount.
...
### -Accountobject
A conta para o novo objeto do Active Directory
...
### -ActiveDirectoryid
O ActiveDirectoryid do Active Directory do ANF
