...
## DESCRITIVO
O cmdlet **Remove-AzNetAppFilesBackupPolicy** exclui uma política de backup do ANF.
...
### -Accountobject
O objeto de conta que contém a política de backup a ser removida
...
### -PassThru
Retornar se a política de backup especificada foi removida com êxito
