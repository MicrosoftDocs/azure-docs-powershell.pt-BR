...
Obtém detalhes de uma configuração do Active Directory para arquivos do Azure NetApp (ANF).
...
Obtém detalhes de uma política de instantâneo do Azure NetApp Files (ANF).

### [Get-AzNetAppFilesVault](Get-AzNetAppFilesVault.md)
Obtém a lista de cofres de backup de contas do Azure NetApp Files (ANF).
...
Cria uma nova política de backup do Azure NetApp Files (ANF) para uma conta do ANF.
...
Exclui uma configuração do Active Directory dos arquivos do Azure NetApp (ANF).

### [Remove-AzNetAppFilesBackup](Remove-AzNetAppFilesBackup.md)
Exclui um backup do Azure NetApp Files (ANF).

### [Remove-AzNetAppFilesBackupPolicy](Remove-AzNetAppFilesBackupPolicy.md)
Exclui uma política de backup do Azure NetApp Files (ANF).
...
Alterar o pool para um volume de arquivos do Azure NetApp (ANF).
...
Atualiza uma configuração do Active Directory dos arquivos do Azure NetApp (ANF) para os modificadores opcionais fornecidos.
...
Atualiza uma política de backup de arquivos do Azure NetApp (ANF) para os modificadores opcionais fornecidos.
