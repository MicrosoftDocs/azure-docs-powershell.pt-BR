...
## DESCRITIVO
O cmdlet **New-AzNetAppFilesPool** cria um pool ANF.

## EXEMPLOS

### Exemplo 1: criar um pool de ANF
```
...
Esse comando cria o novo pool de ANF "MyAnfPool" na conta "MyAnfAccount".
...
### -Accountobject
A conta para o novo objeto de pool
