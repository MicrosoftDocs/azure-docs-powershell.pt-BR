...
## DESCRITIVO
Aprovar a conexão de replicação no volume de origem
...
Esse comando aprova a replicação no MyAnfVolume.

## OS

### -AccountName
O nome da conta ANF do volume de origem de replicação
...
A ID do sistema de arquivos do volume de proteção de dados de destino
...
### -InputObject
O objeto de volume de origem ANF para autorizar o destino de replicação
...
### -Nome
O nome do volume de origem de replicação do ANF
...
### -PassThru
Retornar se a autorização de replicação do volume especificado foi realizada
...
### -PoolName
O nome do pool ANF do volume de origem de replicação
...
### -ResourceGroupName
O grupo de recursos do volume de origem de replicação do ANF
...
### -ResourceId
A ID do recurso do volume de origem de replicação do ANF
