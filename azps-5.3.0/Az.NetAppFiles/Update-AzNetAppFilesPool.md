...
Esse comando altera o pool de ANF "MyAnfPool" para ter o tamanho e o QosType.
...
### -QosType
O tipo de QoS do pool. Os valores possíveis incluem: ' auto ', ' manual '
