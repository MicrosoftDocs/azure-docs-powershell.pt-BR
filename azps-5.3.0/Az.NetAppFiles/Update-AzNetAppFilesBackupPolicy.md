...
## DESCRITIVO
O cmdlet **Update-AzNetAppFilesBackupPolicy** modifica uma política de backup do ANF.
...
Esse comando altera a política de backup do ANF "MyBackupPolicy" para ter o DailyBackupsToKeep especificado.
...
### -Accountobject
O objeto de conta que contém a política de backup a ser atualizada
...
### -DailyBackupsToKeep
Contagem de backups diários a ser mantida
...
### -InputObject
O objeto BackupPolicy para remover
...
Contagem de backups mensais a ser mantida
...
### -WeeklyBackupsToKeep
Contagem semanal de backups a ser mantida
...
### -YearlyBackupsToKeep
Contagem de backups anuais para manter
