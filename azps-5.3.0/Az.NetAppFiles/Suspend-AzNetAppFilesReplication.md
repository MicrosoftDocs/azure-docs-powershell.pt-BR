...
Esse comando suspende a conexão de replicação do ANF no volume "MyDestinationAnfVolume".
...
### -ForceBreak
Se a replicação estiver em transferência de status e você quiser forçar a interrupção da replicação, defina como verdadeiro
...
### -InputObject
O objeto de volume de destino ANF com a replicação a ser interrompida
...
### -Nome
O nome do volume de destino de replicação do ANF
...
### -PassThru
Retorna se a interrupção da replicação do volume especificado foi realizada
...
### -ResourceGroupName
O grupo de recursos do volume de destino de replicação do ANF
...
### -ResourceId
A ID do recurso do volume de destino de replicação do ANF
