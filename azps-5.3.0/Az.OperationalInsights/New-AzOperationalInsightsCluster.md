...
### -IdentityType
o tipo de identidade, value pode ser ' SystemAssigned ', ' none '.
...
### -Local
A região geográfica na qual o cluster será implantado.
...
### -SkuCapacity
Capacidade de SKU, o valor precisa ser múltiplo de 100 e no intervalo de 1000-2000.
...
### -SkuName
O nome do SKU agora pode ser ' CapacityReservation ' apenas
