...
atualizar cluster com propriedades e SKU do cofre de chaves
...
### -KeyVaultUri
O URI do cofre de chaves, "remover proteção" e "exclusão reversível" precisa estar habilitado para este keyvault
