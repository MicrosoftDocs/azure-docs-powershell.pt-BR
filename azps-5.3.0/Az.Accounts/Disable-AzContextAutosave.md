...
### Exemplo 1: desabilitar o salvamento AutoTexto
```powershell
...
Desative a gravação salva de credenciais do Azure nesta sessão do PowerShell. (gerado automaticamente)
