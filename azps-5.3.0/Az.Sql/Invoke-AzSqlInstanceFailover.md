...
## DESCRITIVO
O cmdlet **Invoke-AzSqlInstanceFailover** failoveru uma instância gerenciada SQL do Azure.
...
Esse comando irá failover na réplica primária da instância chamada "ManagedInstance01".
...
Esse comando fará o failover da réplica secundária legível da instância gerenciada "ManagedInstance01".
...
### -Nome
O nome da instância do Azure SQL a ser removida.
...
### -ReadableSecondary
Failover da réplica secundária legível em vez da réplica primária padrão
