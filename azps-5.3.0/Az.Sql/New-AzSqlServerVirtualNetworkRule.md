...
## DESCRITIVO
Cria uma regra de rede virtual do SQL Server do Azure. As regras de rede virtual são usadas para conectar o SQL Server do Azure a uma rede virtual específica a fim de restringir o acesso no SQL Server do Azure apenas para estar disponível na rede virtual. 
...
A ID de sub-rede da rede virtual que especifica os detalhes da Microsoft. Network
