...
## DESCRITIVO
O cmdlet **Enable-AzSqlServerActiveDirectoryOnlyAuthentication** habilita o Azure Active Directory (Azure AD) apenas requisito de autenticação para um servidor AzureSQL na assinatura atual.
...
Esse comando habilita o Azure Active Directory (Azure AD) apenas requisito de autenticação para um servidor AzureSQL chamado Server01 que está associado a um grupo de recursos chamado ResourceGroup01.
