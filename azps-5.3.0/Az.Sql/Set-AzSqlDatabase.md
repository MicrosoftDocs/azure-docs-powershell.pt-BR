...
Esse comando atualiza um banco de dados denominado Database01 para um banco de dados S0 padrão em um servidor chamado Server01.
...
### Exemplo 4: atualizar um banco de dados de finalidade geral existente para a camada de serviço de subescala
```
...
Esse comando atualiza um banco de dados denominado Database01 da camada de serviço de uma finalidade geral para a camada de serviço de hiperescala.
...
### -ComputeModel
Modelo calculado do banco de dados SQL do Azure. Desprovisionada ou com servidor
...
O número de réplicas secundárias ReadOnly associadas ao banco de dados.  Somente para a edição de hiperescalas.
...
### -RequestedServiceObjectiveName
Especifica o nome do objetivo de serviço a ser atribuído ao banco de dados. Para obter informações sobre os objetivos do serviço, consulte [níveis de desempenho e camadas do serviço de banco de dados SQL do Azure](https://docs.microsoft.com/en-us/azure/sql-database/sql-database-dtu-resource-limits-single-databases) na biblioteca do Microsoft Developer Network.
