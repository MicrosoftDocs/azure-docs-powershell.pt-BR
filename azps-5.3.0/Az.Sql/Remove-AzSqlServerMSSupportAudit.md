...
## DESCRITIVO
O cmdlet **Remove-AzSqlServerMSSupportAudit** remove as configurações de auditoria de operações de suporte da Microsoft de um SQL Server do Azure.
Para usar o cmdlet, use os parâmetros *ResourceGroupName* e *ServerName* para identificar o servidor.

## EXEMPLOS

### Exemplo 1: remover as configurações de auditoria de operações de suporte da Microsoft de um SQL Server do Azure
```powershell
PS C:\>Remove-AzSqlServerMSSupportAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01"
```

### Exemplo 2: remover, por meio de pipeline, as configurações de auditoria de suporte da Microsoft de um SQL Server do Azure
```
