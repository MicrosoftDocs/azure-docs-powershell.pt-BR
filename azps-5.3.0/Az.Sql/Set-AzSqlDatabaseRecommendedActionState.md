...
## DESCRITIVO
O cmdlet **set-AzSqlDatabaseRecommendedActionState** atualiza o estado de uma ação recomendada do banco de dados SQL do Azure.
Isso permite que uma ação recomendada seja aplicada, revertida ou descartada com base no novo estado.

## EXEMPLOS

### Exemplo 1: aplicar um estado de ação recomendado para pendente
```
...
Esse comando atualiza o estado da ação recomendada chamada IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 que pertence ao banco de dados chamado WIRunner para pendente.
...
### -DatabaseName
Especifica o nome do banco de dados para o qual esse cmdlet define o estado de ação recomendado.
...
Especifica o nome da ação recomendada para a qual o estado está sendo atualizado.
