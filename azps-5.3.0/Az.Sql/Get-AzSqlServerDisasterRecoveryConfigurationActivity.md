...
## DESCRITIVO
O cmdlet **Get-AzSqlServerDisasterRecoveryConfigurationActivity** Obtém atividade para uma configuração de recuperação do sistema de servidor de banco de dados SQL.
...
Especifica o nome da configuração de recuperação do sistema do servidor.
