...
## DESCRITIVO
O cmdlet **Get-AzSqlSyncMember** retorna informações sobre um ou mais membros de sincronização do banco de dados SQL do Azure.
Especifique o nome de um membro de sincronização para ver informações somente para esse membro de sincronização.

## EXEMPLOS

### Exemplo 1: obter todas as instâncias do Azure SQL Sync member atribuída a um grupo de sincronização
```
...
Esse comando obtém informações sobre todo o membro de sincronização do banco de dados SQL do Azure atribuído à SyncGroup01 do grupo de sincronização.

### Exemplo 2: obter informações sobre um membro de sincronização de banco de dados SQL do Azure
```
...
Esse comando obtém informações sobre o membro de sincronização do banco de dados SQL do Azure com o nome "SyncMember01"

### Exemplo 3: obter todas as instâncias do membro de sincronização do SQL do Azure atribuída a um grupo de sincronização usando a filtragem
```
...
Esse comando obtém informações sobre todos os membros de sincronização do banco de dados SQL do Azure atribuídos ao grupo de sincronização SyncGroup01 que começam com "SyncMember".
