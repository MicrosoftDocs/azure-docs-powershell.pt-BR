...
## DESCRITIVO
O cmdlet Remove-AzSqlElasticJobTargetGroup remove um grupo de destino e seus destinos
...
Remove um grupo de destino e os alvos

### Exemplo 2

Remove o grupo de destino. (gerado automaticamente)
