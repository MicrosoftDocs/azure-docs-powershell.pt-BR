...
## DESCRITIVO
Remove um ou mais bancos de dados do grupo de failover de banco de dados SQL do Azure especificado. Os bancos de dados e os relacionamentos de replicação são mantidos intactos, mas não poderão mais ser acessados por meio dos pontos de extremidade do grupo de failover.
...
Esse comando Remove todos os bancos de dados de um grupo de failover.
...
### -Banco de dados
Um ou mais bancos de dados SQL do Azure no servidor primário do grupo de failover a ser removido do grupo de failover.
