...
## DESCRITIVO
O cmdlet **Get-AzSqlElasticPoolAdvisor** Obtém um ou mais conselheiros de pool elástico do SQL do Azure para um pool elástico do Azure SQL.
...
### Exemplo 5: listar todos os conselheiros do pool elástico especificado usando a filtragem
```
...
O comando obtém lista todos os conselheiros do pool elástico chamado WIRunnerPool que começam com a letra "d".
