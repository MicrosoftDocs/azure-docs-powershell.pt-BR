...
### Exemplo 1-desativar a instância gerenciada segurança de dados avançada
```powershell
...
### Exemplo 2-desabilitar a segurança de dados avançados do servidor do recurso de instância gerenciada
```powershell
