...
## DESCRITIVO
O cmdlet Add-AzSqlElasticJobTarget adiciona um recurso de destino a um grupo de destino
...
### Exemplo 3: adicionar um destino de pool elástico
```powershell
...
### Exemplo 4: adicionar um destino do mapa de fragmentos
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Adiciona um destino (servidor, pool elástico, banco de dados e mapa de fragmentos) a um grupo de destino
