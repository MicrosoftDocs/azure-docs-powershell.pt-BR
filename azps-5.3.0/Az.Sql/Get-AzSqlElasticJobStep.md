...
## DESCRITIVO
O cmdlet Get-AzSqlElasticJobStep Obtém uma ou mais etapas do trabalho a partir de um trabalho

## EXEMPLOS

### Exemplo 1: Obtém uma etapa de trabalho a partir de um trabalho
```powershell
...
Obtém uma etapa de trabalho a partir de um trabalho
