...
### Exemplo 3: habilitar a política de auditoria de armazenamento de blob de um banco de dados SQL do Azure com a filtragem usando um predicado T-SQL
```powershell
...
### Exemplo 4: remover a filtragem da política de auditoria de um banco de dados SQL do Azure
```powershell
