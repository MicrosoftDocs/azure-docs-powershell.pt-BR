...
## DESCRITIVO
O cmdlet **Update-AzSqlSyncGroup** modifica as propriedades de um membro de sincronização do banco de dados SQL do Azure.
...
Esse comando redefine a senha de administrador para o banco de dados membro.
...
Se o link privado deve ser usado ao conectar-se a este membro de sincronização.
