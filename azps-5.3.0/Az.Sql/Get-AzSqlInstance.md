...
## DESCRITIVO
O cmdlet **Get-AzSqlInstance** retorna informações sobre uma ou mais instâncias gerenciadas do SQL do Azure.
Especifique o nome de uma instância para ver informações somente para essa instância.

## EXEMPLOS

### Exemplo 1: obter todas as instâncias atribuídas a um grupo de recursos
```powershell
...
Esse comando obtém informações sobre todas as instâncias atribuídas à ResourceGroup01 do grupo de recursos.

### Exemplo 2: obter informações sobre uma instância
```powershell
...
Esse comando obtém informações sobre a instância chamada managedInstance1.

### Exemplo 3: obter todas as instâncias atribuídas a um grupo de recursos usando a filtragem
```powershell
...
Esse comando obtém informações sobre todas as instâncias atribuídas ao grupo de recursos ResourceGroup01 que começam com "managedInstance".

### Exemplo 4: obter todas as instâncias em um pool de instâncias
```powershell
...
Esse comando obtém informações sobre todas as instâncias dentro do pool de instâncias "instancePool0".

### Exemplo 5: obter todas as instâncias em um pool de instâncias usando o objeto de pool de instâncias
```powershell
...
### Exemplo 6: obter todas as instâncias em um pool de instâncias usando o identificador de recursos do pool de instâncias
```powershell
...
### Exemplo 7: obter uma instância gerenciada usando seu identificador de recursos
```powershell
...
### -ResourceId
O identificador de recursos da instância gerenciada.
