...
## DESCRITIVO
O cmdlet **Get-AzSqlServerActiveDirectoryOnlyAuthentication** obtém somente requisitos de autenticação do Azure Active Directory (Azure AD) para um servidor AzureSQL na assinatura atual.
...
Este comando obtém o Azure Active Directory (Azure AD) apenas requisito de autenticação para um servidor AzureSQL chamado Server01 que está associado a um grupo de recursos chamado ResourceGroup01.
