...
### Exemplo 1: validar o dependecies antes de descartar os recursos.
```powershell
...
Valide o dependecies antes de descartar os recursos.

### Exemplo 2: descarta a movimentação dos recursos usando "MoveResource Name" como entrada
```powershell
...
Descarta a movimentação dos recursos usando "MoveResource Name" como entrada.

### Exemplo 3: descarta a movimentação dos recursos usando "SourceARMID" como entrada
```powershell
...
Descarta a movimentação dos recursos usando "SourceARMID" como entrada.
