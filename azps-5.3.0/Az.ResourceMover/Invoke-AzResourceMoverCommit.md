...
### Exemplo 1: validar o dependecies antes da confirmação dos recursos
```powershell
...
Valide o dependecies antes da confirmação dos recursos.

### Exemplo 2: confirmar o conjunto de recursos na coleção move usando "MoveResource Name" como entrada
```powershell
...
Confirme o conjunto de recursos na coleção move usando "MoveResource Name" como entrada

### Exemplo 3: confirmar o conjunto de recursos na coleção move usando "SourceARMID" como entrada
```powershell
...
Confirme o conjunto de recursos na coleção mover usando "SourceARMID" como entrada
