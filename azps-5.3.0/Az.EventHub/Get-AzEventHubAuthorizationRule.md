...
### Exemplo 3: AuthorizationRule para o EventHub
```powershell
...
### Exemplo 4: AuthorizationRules para o EventHub
```powershell
PS C:\> Get-AzEventHubAuthorizationRule -ResourceGroupName MyResourceGroupName -NamespaceName MyNamespaceName -EventHubName MyEventHubName
```
...
### Exemplo 5: AuthorizationRule para alias (configuração georecuperação)
```powershell
...
### Exemplo 6: AuthorizationRules para alias (configuração de georecuperação)
```powershell
