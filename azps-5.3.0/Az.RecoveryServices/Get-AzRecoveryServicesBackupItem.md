...
O cmdlet **Get-AzRecoveryServicesBackupItem** Obtém a lista de itens protegidos em um contêiner e o status de proteção dos itens.
...
O primeiro comando obtém o contêiner do tipo AzureStorage e, em seguida, armazena-o na variável $Container.
O segundo comando obtém o item de backup cujo FriendlyName corresponde ao valor passado no parâmetro FriendlyName e o armazena na variável $BackupItem.
Usar o parâmetro FriendlyName pode resultar em retornar mais de um compartilhamento de arquivos do Azure. Nesses casos, execute o cmdlet passando o valor do parâmetro-Name como a propriedade Name retornada no conjunto de resultados de $BackupItem.

## OS

### -BackupManagementType

A classe de recursos que estão sendo protegidos. Os valores aceitáveis para esse parâmetro são:
