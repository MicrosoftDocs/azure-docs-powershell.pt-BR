...
1.  Obtenha uma base de SchedulePolicyObject e base de RetentionPolicyObject. Armazene-os em alguma variável.
2.  Defina os diferentes parâmetros de objeto de política de retenção e agendamento de acordo com sua necessidade. Por exemplo, no script de exemplo acima, estamos tentando definir uma política de proteção semanal. Portanto, alteramos a frequência de agendamento para "semanal" e também atualizamos o tempo de execução do cronograma. No objeto da política de retenção, atualizamos a duração da retenção semanal e definimos o sinalizador "cronograma semanal habilitado" correto. Caso você queira definir uma política diária, defina o sinalizador "agenda diária habilitada" como verdadeiro e atribua os valores apropriados para outros parâmetros do objeto.
3.  Obtenha a política de proteção de backup que você deseja modificar e armazene-a em uma variável. No exemplo acima, recuperamos a política de backup com o nome "TestPolicy" que queremos modificar.
4.  Modifique a política de proteção de backup recuperada na etapa 3 usando o objeto de política de agendamento modificado e o objeto da política de retenção.
