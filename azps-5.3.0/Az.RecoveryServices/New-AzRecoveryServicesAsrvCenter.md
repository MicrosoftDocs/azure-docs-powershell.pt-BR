...
## DESCRITIVO
O cmdlet **New-AzRecoveryServicesAsrvCenter** adiciona um servidor vCenter para descobrir itens protegidos. Esse cmdlet registra o servidor do vCenter para descoberta com o servidor de configuração.
...
### -Conta
Conta de credenciais de logon do usuário.
