...
Os dois primeiros cmdlets buscam o cofre de serviços de recuperação vault1 e vault2, respectivamente.
O segundo comando dispara uma movimentação de dados completa de vault1 para vault2. 

### Exemplo 2: copiar dados do vault1 para o vault2 apenas com itens com falha
```powershell
PS C:\> $sourceVault = Get-AzRecoveryServicesVault -ResourceGroupName "rgName1" -Name "vault1"
PS C:\> $targetVault = Get-AzRecoveryServicesVault -ResourceGroupName "rgName2" -Name "vault2"
...
Os dois primeiros cmdlets buscam o cofre de serviços de recuperação vault1 e vault2, respectivamente.
O segundo comando dispara uma movimentação de dados parciais de vault1 para vault2 apenas com os itens que falhavam nas operações de movimentação anteriores.
