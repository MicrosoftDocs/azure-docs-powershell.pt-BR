...
O cmdlet registra uma VM do Azure como um contêiner para a carga de trabalho MSSQL.
...
### -Workloadtype
Tipo de carga de trabalho do recurso. O valor atual com suporte é AzureVM, WindowsServer, AzureFiles, MSSQL
