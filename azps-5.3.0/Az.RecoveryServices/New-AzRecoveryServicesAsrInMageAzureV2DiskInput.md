...
## DESCRITIVO
Cria um objeto de mapeamento de disco que mapeia um disco de máquina virtual do vMWare para a conta de armazenamento do cache e destino o tipo de disco gerenciado (região de recuperação) a ser usado para replicar o disco.
...
Crie um objeto de mapeamento de disco para discos de máquina virtual do vMWare a ser replicado. Usado durante a habilitação da proteção para o vMWare Machine.
...
### -DiskId
Especifique o DiskId do disco ao qual esse mapeamento corresponde.
...
### -Disktype
Especifica o tipo de disco de recuperação.
