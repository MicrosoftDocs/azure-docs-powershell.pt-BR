...
## DESCRITIVO
O cmdlet **New-AzRecoveryServicesAsrReplicationProtectedItem** cria um novo item de replicação protegida.
...
Inicia a operação de criação de itens protegidos de replicação para o item protegido ASR especificado, incluindo discos seletivos e retorna o trabalho ASR usado para acompanhar a operação (cenário do vmWare para o Azure) com discos selecionados.
...
Inicia a operação de criação de itens protegidos de replicação para o VmId especificado e retorna o trabalho ASR usado para acompanhar a operação (cenário do Azure para o Azure). Para ver os detalhes da VM de failover aprovados cmdlet para criptografia serão usados.
...
Inicia a operação de criação de itens protegidos de replicação para uma máquina virtual dentro do grupo de posicionamento de proximidade e retorna o trabalho ASR usado para acompanhar a operação (cenário do Azure para o Azure).
...
### -AzureToAzure
Parâmetro switch especifica a criação do item replicado no cenário do Azure para o Azure.
...
Especifica a configuração de disco para usar VM do cenário de recuperação de desastres do Azure para o Azure.
...
### -AzureVmId
Especifica a ID de VM do Azure para proteção de recuperação de desastre em região de recuperação.
...
Especifica a ID do cofre de criptografia de disco (criptografia de disco do Azure) a ser usada para a VM de recuperação após o failover.
...
### -Disktype
Especifica o tipo de disco gerenciado VM de recuperação.
...
Especifica a entrada de configuração de disco para o ID de disco do vMWare para proteger de um item de proteção especificado.
...
### -KeyEncryptionKeyUrl
Especifica a URL da chave de criptografia de disco com a versão (criptografia de disco do Azure) a ser usada para a VM de recuperação após o failover.
...
Especifique a ID do grupo de posicionamento de proximidade a ser usada pela VM de failover na região de recuperação de destino.
