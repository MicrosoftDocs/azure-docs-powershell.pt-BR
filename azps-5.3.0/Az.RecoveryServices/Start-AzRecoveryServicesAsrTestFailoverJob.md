...
### -AzureVMNetworkId
Especifica a ID de rede da VM do Azure para a VM de recuperação após o failover.
...
### -RecoveryPoint
Especifica um ponto de recuperação personalizado para testar o failover da máquina protegida.
...
### -RecoveryTag
Especifica a marca de recuperação para o qual testar o failover
