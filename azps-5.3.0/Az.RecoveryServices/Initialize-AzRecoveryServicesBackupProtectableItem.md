...
Esse comando dispara a descoberta de itens desprotegidos do tipo de carga de trabalho fornecido no contêiner fornecido. (gerado automaticamente)
...
### -PassThru
Retorna o contêiner em que a descoberta está sendo disparada.
