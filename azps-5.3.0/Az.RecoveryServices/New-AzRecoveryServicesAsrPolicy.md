...
## DESCRITIVO
O cmdlet **New-AzRecoveryServicesAsrPolicy** cria uma política de replicação do Azure site Recovery.
...
### -AzureToAzure
Parâmetro switch especifica o cenário da criação de políticas do Azure para o Azure.
...
### -AzureToVMware
Parâmetro switch especifica o cenário para criação da política do Azure para o vMWare.
