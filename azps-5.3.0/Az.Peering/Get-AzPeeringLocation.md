...
## DESCRITIVO
Obtém os recursos de emparelhamento em que os usuários podem se conectar com o ARM.
...
Uma longa lista de locais. Obtém todos os recursos de emparelhamento direto.
...
Obtém o local de emparelhamento do Exchange para Honolulu. 
...
Obtém o local de emparelhamento do Exchange para a identificação de recursos de emparelhamento 71. 
...
### -Kind
Mostra todos os recursos de emparelhamento por tipo.
