...
### Obter emparelhamento e criar um prefixo cadastrado
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredPrefix -Name $asnName -Asn $asn
```

Obtenha a correspondência que você deseja adicionar um prefixo registrado. Em seguida, passe isso para o commandlet.
