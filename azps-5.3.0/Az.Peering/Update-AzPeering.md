...
### Atualize a chave de autenticação MD5
```powershell
...
Define o sinalizador de uso para serviço de emparelhamento

### Atualize o endereço IPv4 da troca de tráfego do Exchange
```powershell
...
Define o endereço IPv4 para um emparelhamento do Exchange usando ResourceId
...
### -DirectConnection
Crie uma nova conexão direta usando o New-AzDirectPeeringConnectionObject e o pipe para esse comando.
...
### -ExchangeConnection
Crie uma nova conexão do Exchange usando o New-AzExchangePeeringConnectionObject e o pipe para esse comando.
