...
### Exemplo 1: testar a disponibilidade do nome do repositório de configuração do aplicativo
...
Esse comando testa a disponibilidade do nome da loja de configuração do aplicativo.
