...
Atualiza o AppliedScopeType do especificado `Reservation` para Single e InstanceFlexibility para on.
...
Atualiza o AppliedScopeType do especificado `Reservation` para compartilhado e o InstanceFlexibility para off.
...
### -InstanceFlexibility
Se presente, atualiza o valor InstanceFlexibility do `Reservation` . Se não for especificado, o valor existente permanecerá inalterado.
