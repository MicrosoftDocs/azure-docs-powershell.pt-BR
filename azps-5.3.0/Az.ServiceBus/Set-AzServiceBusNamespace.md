...
## DESCRITIVO
O cmdlet **set-AzServiceBusNamespace** atualiza a descrição do namespace de barramento de serviço especificado dentro do grupo de recursos.
...
Atualiza o namespace de barramento do serviço com uma nova descrição.
...
### -Confirme
Atualiza o namespace de barramento do serviço com as informações especificadas.
