...
## Sinopse
Verifica a disponibilidade da determinada fila ou nome do tópico
...
## DESCRITIVO
O cmdlet **Test-AzServiceBusNameAvailability** verifica a disponibilidade do nome fornecido da fila ou tópico
...
Retorna true se o nome $nameQueue fornecido for Availabile ou retornará false se fornecido $nameQueue nome não disponível
...
Retorna true se o nome $nameTopic fornecido for Availabile ou retornará false se fornecido $nameTopic nome não disponível
...
### -Tópico
Para verificar a disponibilidade do nome para o nome do tópico
