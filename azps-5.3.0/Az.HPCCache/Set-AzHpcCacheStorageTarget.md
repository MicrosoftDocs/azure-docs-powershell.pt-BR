...
## DESCRITIVO
O cmdlet **set-AzHpcCacheStorageTarget** atualiza um destino de armazenamento associado ao cache do Azure HPC.
...
### -ResourceGroupName
Nome do grupo de recursos sob o qual você deseja atualizar o destino de armazenamento.
