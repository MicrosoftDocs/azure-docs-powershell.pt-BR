...
## DESCRITIVO
O cmdlet **Stop-AzHpcCache** interrompe um cache do Azure HPC.
...
### -Force
Indica que o cmdlet não solicita confirmação. Por padrão, esse cmdlet solicita que você confirme se deseja parar o cache.
...
### -ResourceGroupName
Nome do grupo de recursos sob o qual você deseja parar o cache.
