...
### [Fechar-AzStorageFileHandle](Close-AzStorageFileHandle.md)
Fecha identificadores de arquivos de um compartilhamento de arquivos, um diretório de arquivos ou um arquivo.
...
Habilita a política de restauração de BLOB em uma conta de armazenamento.
...
Habilite o site estático para a conta de armazenamento do Azure.
...
Obtém os detalhes de um arquivo ou diretório em um sistema de arquivos.
...
Obtém a política de gerenciamento de uma conta de armazenamento do Azure.
...
Aplica uma instrução SQL (linguagem de consulta estruturada) simples no conteúdo de um blob e salva apenas o subconjunto consultado dos dados em um arquivo local.
...
Obtém regras CORS para um tipo de serviço de armazenamento.
...
Obtém as propriedades de serviço dos serviços de arquivo do Azure Storage.
...
### [Mover-AzDataLakeGen2Item](Move-AzDataLakeGen2Item.md)
Mover um arquivo ou diretório para outro arquivo ou diretório na mesma conta de armazenamento.
...
Cria um objeto de regra ManagementPolicy, que pode ser usado em Set-AzStorageAccountManagementPolicy.
...
Cria uma política de acesso armazenado para um contêiner de armazenamento do Azure.
...
Cria uma regra de política de replicação de objetos.
...
Remove ImmutabilityPolicy de um contêiner de blob de armazenamento com uma política desbloqueada
...
Remove a política de replicação de objetos especificada de uma conta de armazenamento.

### [Remove-AzStorageQueue](Remove-AzStorageQueue.md)
Remove uma fila de armazenamento.
...
Exclui um compartilhamento de arquivos.
...
Revogar todas as chaves de delegação de usuário de uma conta de armazenamento.
...
Defina a ACL recursivamente no caminho especificado. 
...
Cria ou atualiza a política de replicação de objetos especificada em uma conta de armazenamento.

### [Set-AzStorageQueueStoredAccessPolicy](Set-AzStorageQueueStoredAccessPolicy.md)
Define uma política de acesso armazenado para uma fila de armazenamento do Azure.
...
Atualiza uma política de acesso armazenado em um compartilhamento de armazenamento.
...
Inicia a cópia de um arquivo de origem.
