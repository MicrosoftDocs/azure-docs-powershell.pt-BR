...
### -CloudBlob
Objeto CloudBlob da biblioteca de cliente de armazenamento do Azure. Você pode criá-lo ou usar Get-AzStorageBlob cmdlet.
...
### -CloudBlobContainer
Objeto CloudBlobContainer da biblioteca de cliente de armazenamento do Azure. Você pode criá-lo ou usar Get-AzStorageContainer cmdlet.
...
### -Contexto
Contexto de armazenamento do Azure de origem. Você pode criá-lo por New-AzStorageContext cmdlet.
...
### -DestContext
Contexto de armazenamento do Azure de destino. Você pode criá-lo por New-AzStorageContext cmdlet.
