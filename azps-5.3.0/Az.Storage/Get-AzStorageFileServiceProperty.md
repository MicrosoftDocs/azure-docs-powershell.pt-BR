...
### Exemplo 1: obter a propriedade de serviços de arquivo do Azure Storage de uma conta de armazenamento especificada
```powershell
...
Esse comando obtém a propriedade serviços de arquivo de uma conta de armazenamento especificada.
