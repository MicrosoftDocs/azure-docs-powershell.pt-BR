...
### Exemplo 4: obter um objeto BLOB e salvá-lo em uma variável e, em seguida, baixar o conteúdo do blob com o objeto BLOB
```
PS C:\>$blob = Get-AzStorageBlob -Container containername -Blob blobname 
PS C:\>Get-AzStorageBlobContent -CloudBlob $blob.ICloudBlob -Destination "C:\test"
```

Primeiro, este exemplo obtém um objeto BLOB e o salva em uma variável e, em seguida, baixa o conteúdo do blob com o objeto BLOB. 
