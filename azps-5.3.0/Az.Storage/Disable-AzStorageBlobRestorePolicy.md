...
## DESCRITIVO
O cmdlet **Disable-AzStorageBlobRestorePolicy** desabilita a política de restauração de BLOB para o serviço de blob de armazenamento do Azure.

## EXEMPLOS

### Exemplo 1: desabilita a política de restauração de BLOB para o serviço de blob de armazenamento do Azure em uma conta de armazenamento
```powershell
PS C:\> Disable-AzStorageBlobRestorePolicy -ResourceGroupName "myresourcegoup" -StorageAccountName "mystorageaccount"
```

Este comando desabilita a política de restauração de BLOB para o serviço de blob de armazenamento do Azure em uma conta de armazenamento.
