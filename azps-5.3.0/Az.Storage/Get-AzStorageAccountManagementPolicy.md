...
## DESCRITIVO
O cmdlet **Get-AzStorageAccountManagementPolicy** Obtém a política de gerenciamento de uma conta de armazenamento do Azure.

## EXEMPLOS

### Exemplo 1: obter a política de gerenciamento de uma conta de armazenamento.
```
...
Esse comando obtém a política de gerenciamento de uma conta de armazenamento.
