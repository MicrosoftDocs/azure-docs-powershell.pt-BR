...
## DESCRITIVO
O cmdlet **Add-AzStorageAccountNetworkRule** adiciona IpRules ou VirtualNetworkRules à propriedade NetworkRule de uma conta de armazenamento
...
### -IPAddressOrRange
A matriz de IpAddressOrRange, adicione IpRules com o IpAddressOrRange de entrada e a ação padrão Allow à propriedade NetworkRule.
...
### -IPRule
A matriz de objetos IpRule para adicionar à propriedade NetworkRule.
...
A matriz de VirtualNetworkResourceId, adicionará VirtualNetworkRule com VirtualNetworkResourceId de entrada e a ação padrão permitir à propriedade NetworkRule.
...
### -VirtualNetworkRule
A matriz de objetos VirtualNetworkRule para adicionar à propriedade NetworkRule.
