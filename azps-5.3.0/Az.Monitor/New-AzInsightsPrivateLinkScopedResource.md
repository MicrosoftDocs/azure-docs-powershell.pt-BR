...
## DESCRITIVO
criar para recurso de escopo de link privado, o recurso em escopo pode ser espaço de trabalho de análise de log ou componente Application insights
...
criar recurso de escopo "scoped_resource_name" vinculado ao componente Application insights "ai_name"
...
### -LinkedResourceId
ID do recurso LA/AI para vincular
