...
Obter ou listar a categoria de configuração de diagnóstico com suporte para o recurso do Azure.
...
Obter recurso de escopo de link privado
...
Obtém recursos de consulta agendada
...
Cria uma regra de alerta de log (tipo de regra de consulta agendada)
...
Cria um objeto do tipo Azns grupo de ação
...
Atualiza uma regra de alerta de log

### [Update-AzInsightsPrivateLinkScope](Update-AzInsightsPrivateLinkScope.md)
Atualização do escopo do link privado
