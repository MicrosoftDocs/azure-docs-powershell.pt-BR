...
## DESCRITIVO
Atualiza uma regra de alerta de log por colocar semântica

## EXEMPLOS

### Exemplo 1: definir pelo nome da regra
```powershell
...
### Exemplo 3: definir por ID do recurso
```powershell
...
### -Ação
A ação de alerta de regra de consulta programada
...
### -Cronograma
A agenda de regras de consulta agendada
...
### -Fonte
A origem da regra de consulta agendada
