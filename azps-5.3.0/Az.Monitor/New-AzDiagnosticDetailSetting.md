...
## DESCRITIVO
Crie o objeto PSMetricSettings ou PSLogSettings. Você pode obter categorias usando `Get-AzDiagnosticSettingCategory` .
...
### -Log
Para criar uma configuração de log
...
### -Métrica
Para criar a configuração métrica
...
### -Timegranular
Timegranular para configuração métrica
