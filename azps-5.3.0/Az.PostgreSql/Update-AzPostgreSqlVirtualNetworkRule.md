...
### Exemplo 1: atualizar a regra de rede virtual PostgreSql por nome
```powershell
...
Este cmdlet atualiza a regra de rede virtual PostgreSql por nome.

### Exemplo 2: atualizar a regra de rede virtual PostgreSql por identidade.
```powershell
...
Esses cmdlets atualizam a regra de rede virtual PostgreSql por identidade.
