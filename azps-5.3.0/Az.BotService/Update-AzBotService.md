...
### Exemplo 1: Atualize o bot por nome e ResourceGroupName
```powershell
...
Atualize o bot por nome e ResourceGroupName

### Exemplo 2: Atualize o bot por InputObject
```powershell
...
Atualize o bot por InputObject
...
A chave do Application insights
...
A chave de API do Application insights
...
A ID do aplicativo insights do aplicativo
...
### -LuisAppId
Coleção de IDs do aplicativo LUIS
...
### -MsaAppId
ID do aplicativo da Microsoft para o bot
...
### -Marca
Contém marcas de recurso definidas como pares de chave/valor.
