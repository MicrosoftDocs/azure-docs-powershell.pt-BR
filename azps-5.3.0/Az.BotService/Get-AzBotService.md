...
### Exemplo 2: obter o BotService por ResourceGroupName e nome
```powershell
...
Obter o BotService por ResourceGroupName e nome
...
Obtenha todos os BotServices por ResourceGroupName
...
INPUTobject <IBotServiceIdentity> : parâmetro de identidade
  - `[ChannelName <ChannelName?>]`: O nome do recurso de canal.
  - `[ConnectionName <String>]`: O nome do recurso de configuração de conexão do serviço bot
  - `[Id <String>]`: Caminho de identidade do recurso
  - `[ResourceGroupName <String>]`: O nome do grupo de recursos de bot na assinatura do usuário.
