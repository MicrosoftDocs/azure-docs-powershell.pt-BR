...
## DESCRITIVO
O cmdlet **Remove-AzCosmosDBSqlContainer** exclui o contêiner SQL CosmosDB correspondente a um determinado ResourceGroupName, AccountName, DatabaseName e ContainerName.
