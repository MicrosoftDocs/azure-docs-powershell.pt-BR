...
## Sinopse
Cria um novo objeto do tipo PSIndexes. Ele pode ser passado como um valor de parâmetro para Set-AzCosmosDBSqlIncludedPath.
...
## DESCRITIVO
Objeto correspondente aos índices do IncludedPath's da API SQL.
