...
## Sinopse
Obtém a taxa de transferência de um banco de dados CosmosDB Gremlin.
...
## DESCRITIVO
O cmdlet **Get-AzCosmosDBGremlinDatabaseThroughput** Obtém a taxa de transferência de um banco de dados do Gremlin do CosmosDB.
