...
Atualiza o valor de produtividade de um espaço de CosmosDB Cassandra.

### [Update-AzCosmosDBCassandraTable](Update-AzCosmosDBCassandraTable.md)
Atualiza a tabela CosmosDB Cassandra. Executa uma operação de patch do lado do cliente lendo a tabela existente.

### [Update-AzCosmosDBCassandraTableThroughput](Update-AzCosmosDBCassandraTableThroughput.md)
Atualiza o valor de produtividade de uma tabela CosmosDB Cassandra.

### [Update-AzCosmosDBGremlinDatabase](Update-AzCosmosDBGremlinDatabase.md)
Atualiza o banco de dados CosmosDB Gremlin. Executa uma operação de patch do lado do cliente lendo o banco de dados existente.

### [Update-AzCosmosDBGremlinDatabaseThroughput](Update-AzCosmosDBGremlinDatabaseThroughput.md)
Atualiza o valor de produtividade de um banco de dados CosmosDB Gremlin.
...
Atualiza o valor de produtividade de um gráfico de Gremlin CosmosDB.

### [Update-AzCosmosDBMongoDBCollection](Update-AzCosmosDBMongoDBCollection.md)
Atualiza a coleção CosmosDB MongoDB. Executa uma operação de patch do lado do cliente lendo a coleção existente.

### [Update-AzCosmosDBMongoDBCollectionThroughput](Update-AzCosmosDBMongoDBCollectionThroughput.md)
Atualiza o valor de produtividade de uma coleção CosmosDB MongoDB.

### [Update-AzCosmosDBMongoDBDatabase](Update-AzCosmosDBMongoDBDatabase.md)
Atualiza o banco de dados do CosmosDB MongoDB. Executa uma operação de patch do lado do cliente lendo o banco de dados existente.

### [Update-AzCosmosDBMongoDBDatabaseThroughput](Update-AzCosmosDBMongoDBDatabaseThroughput.md)
Atualiza o valor de produtividade de um banco de dados CosmosDB MongoDB.
...
Atualiza o valor de produtividade de um contêiner SQL do CosmosDB.
...
Atualiza o valor de produtividade de um banco de dados SQL do CosmosDB.

### [Update-AzCosmosDBSqlStoredProcedure](Update-AzCosmosDBSqlStoredProcedure.md)
Atualiza o StoredProcedure do SQL CosmosDB. Executa uma operação de patch do lado do cliente lendo o StoredProcedure existente.

### [Update-AzCosmosDBSqlTrigger](Update-AzCosmosDBSqlTrigger.md)
Atualiza o gatilho SQL do CosmosDB. Executa uma operação de patch do lado do cliente lendo o gatilho existente.
...
Atualiza o valor de produtividade de uma tabela CosmosDB.