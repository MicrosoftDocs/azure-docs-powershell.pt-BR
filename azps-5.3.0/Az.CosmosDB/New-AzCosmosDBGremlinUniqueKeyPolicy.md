...
## Sinopse
Cria um novo objeto CosmosDB UniqueKeyPolicy.
...
## DESCRITIVO
O cmdlet **New-AzCosmosDBGremlinUniqueKeyPolicy** cria um novo objeto do tipo PSUniqueKeyPolicy.
...
### -UniqueKey
Matriz de objetos do tipo PSUniqueKey.
