...
## Sinopse
Exclui um espaço de CosmosDB Cassandra.
...
## DESCRITIVO
O cmdlet **Remove-AzCosmosDBCassandraKeyspace** exclui um espaço de keyCassandra existente do CosmosDB.
...
O cmdlet retorna um objeto do tipo bool (quando-PassThru é passado) que será true se a exclusão tiver sido bem-sucedida.
