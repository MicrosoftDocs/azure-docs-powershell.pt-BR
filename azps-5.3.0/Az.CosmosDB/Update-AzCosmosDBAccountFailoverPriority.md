...
FailoverPolicies atualizado com region1 como FailoverPriority 1, region2 como FailoverPriority 2 e region3 como FailoverPriority 3.
...
### -FailoverPolicy
Matriz de cadeias de caracteres com nomes de regiões, ordenados pela prioridade de failover.
Por exemplo, eastus, westus
