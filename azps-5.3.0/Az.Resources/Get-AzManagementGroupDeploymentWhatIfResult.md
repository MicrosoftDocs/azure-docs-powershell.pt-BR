...
Esse comando obtém um resultado What-If no escopo do grupo de gerenciamento usando um arquivo de modelo personalizado e um arquivo de parâmetro no disco.
O comando usa o parâmetro *Location* para especificar onde armazenar os dados de implantação.
O comando usa o parâmetro *ManagementGroupId* para especificar o grupo de gerenciamento em que o modelo será implantado.
...
O comando usa o parâmetro *ResultFormat* para definir o resultado What-If para incluir cargas de recursos completas.

### Exemplo 2: obter um resultado de What-If no escopo do grupo de gerenciamento com ResourceIdOnly
```powershell
PS C:\> Get-AzManagementGroupDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
...
O comando usa o parâmetro *TemplateFile* para especificar um arquivo de modelo.
O comando usa o parâmetro *TemplateParameterFile* para especificar um arquivo de parâmetro de modelo.
O comando usa o parâmetro *ResultFormat* para definir o resultado What-If para conter somente as IDs do recurso.
...
### -ExcludeChangeType
Lista separada por vírgula dos tipos de alteração de recurso a serem excluídos dos resultados de What-If.
...
Se não for especificado, o padrão será o nome do arquivo de modelo quando um arquivo de modelo for fornecido; o padrão é a hora atual quando um objeto de modelo é fornecido, por exemplo, "20131223140835".
...
### Microsoft. Azure. Commands. ResourceManager. cmdlets. SdkModels. imdeployments. PSWhatIfOperationResult
