...
# Módulo AZ. Resources
## Descritivo
Este tópico exibe os tópicos da ajuda para os cmdlets do Azure Resource Manager.

## Cmdlets AZ. Resources
### [Add-AzADGroupMember](Add-AzADGroupMember.md)
Adiciona um usuário a um grupo de anúncios existente.
...
Lista os membros de um grupo de anúncios no locatário atual.
...
Obtém um modelo ARM What-If resultado de uma implantação em escopo de assinatura. 
...
Obtém grupo (s) de gerenciamento
...
Obtém um modelo ARM What-If resultado para uma implantação em escopo do grupo de gerenciamento. 
...
Obtém um modelo ARM What-If resultado para uma implantação em escopo de grupo de recursos. 
...
Cria um aplicativo gerenciado do Azure.
...
Remove um usuário de um grupo do AD.
...
Atualiza a definição do aplicativo gerenciado
...
### [Parar-AzDeployment](Stop-AzDeployment.md)
Cancelar uma implantação em execução

### [Parar-AzManagementGroupDeployment](Stop-AzManagementGroupDeployment.md)
...
### [Parar-AzTenantDeployment](Stop-AzTenantDeployment.md)
...
### [Cancelar registro-AzProviderFeature](Unregister-AzProviderFeature.md)
...
Cancela o registro de um provedor de recursos.
