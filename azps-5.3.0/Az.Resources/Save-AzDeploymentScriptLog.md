...
## DESCRITIVO
**Save-AzDeploymentScriptLog** salva o log de uma execução de script de implantação em disco.
...
Salva o log de um script de implantação com o nome e o grupo de recursos fornecidos.
...
Salva as três últimas linhas do log de um script de implantação com o nome e o grupo de recursos fornecidos.
...
Exemplo:/assinaturas/{subId}/resourceGroups/{rgName}/provedores/Microsoft. Resources/deploymentScripts/{deploymentScriptName}
...
### -Force
Força a substituição do arquivo existente.
