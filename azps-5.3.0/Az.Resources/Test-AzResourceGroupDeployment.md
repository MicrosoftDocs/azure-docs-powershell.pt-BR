...
## DESCRITIVO
O cmdlet **Test-AzResourceGroupDeployment** determina se um modelo de implantação do grupo de recursos do Azure e seus valores de parâmetro são válidos.

## EXEMPLOS

### Exemplo 1: implantação de teste com um objeto de modelo personalizado e um arquivo de parâmetro
...
Esse comando testa uma implantação no grupo de recursos específico usando a Hashtable na memória criada a partir do arquivo de modelo específico e um arquivo de parâmetro.

### Exemplo 2: implantação de teste via arquivo de modelo e arquivo de parâmetro
...
Esse comando testa a implantação no grupo de recursos e no recurso fornecido usando o arquivo de modelo fornecido e um arquivo de parâmetro.
