...
## DESCRITIVO
O cmdlet **Remove-AzTenantDeployment** remove uma implantação do Azure no escopo atual do locatário e em todas as operações associadas.
...
Esse comando Remove a implantação "RolesDeployment" no escopo do locatário atual.
...
Esse comando obtém a implantação "RolesDeployment" no escopo do locatário atual e a remove.
