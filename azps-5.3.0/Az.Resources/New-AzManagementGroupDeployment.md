...
Para adicionar uma implantação em um grupo de gerenciamento, especifique o grupo de gerenciamento, local e um modelo.
...
Esse comando cria uma nova implantação no grupo de gerenciamento "myMG" usando um modelo personalizado e um arquivo de modelo no disco, com o parâmetro Tags definidas.
...
### -WhatIfResultFormat
O formato de resultado What-If. Aplicável quando a opção-WhatIf ou-Confirm está definida.
