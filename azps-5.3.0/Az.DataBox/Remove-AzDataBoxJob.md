...
## DESCRITIVO
O cmdlet **Remove-AzDataBoxJob** é usado para excluir um trabalho do databox concluído da lista de trabalhos do databox.
...
Exclui o trabalho databox especificado
...
Exclui o trabalho databox especificado à força sem confirmação
