...
Obtém os systemAssignedIdentity disponíveis no escopo do RP especificado.

### [GetAzWebAppConfig](GetAzWebAppConfig.md)


### [Get-AzWebAppFunctionKey](Get-AzWebAppFunctionKey.md)
Descrição para obter as teclas de função para uma função em um site da Web ou um slot de implantação.
...
Descrição para obter as configurações e o status do aplicativo de referência de configuração de um aplicativo

### [Get-AzWebAppSyncStatus](Get-AzWebAppSyncStatus.md)
Descrição para permitir chamadas via PowerShell e modelo ARM.
...
Descrição da função syncs gatilho Metadata para o banco de dados de gerenciamento
