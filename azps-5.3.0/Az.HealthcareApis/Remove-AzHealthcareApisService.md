...
Exclui o serviço HealthcareApis existente com o nome fornecido dentro de um grupo de recursos fornecido.
...
Exclui o serviço HealthcareApis existente com o ResourceId fornecido.
...
Exclui o objeto de serviço HealthcareApis fornecido.
...
### -InputObject
Objeto de serviço HealthcareApis
...
### -PassThru
Se fornecido, retorna verdadeiro se a operação foi bem-sucedida
...
### -ResourceId
ResourceId do serviço HealthcareApis.
