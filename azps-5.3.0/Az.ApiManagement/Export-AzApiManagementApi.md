...
## DESCRITIVO
O cmdlet **Export-AzApiManagementApi** exporta uma API de gerenciamento de API do Azure para um arquivo em um dos formatos com suporte.
...
### Exemplo 2: exportar uma API no formato de especificação OpenApi 3,0 como documento JSON
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Este comando exporta as definições de API no formato Open API como documento JSON
