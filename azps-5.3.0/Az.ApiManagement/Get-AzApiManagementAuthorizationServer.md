...
## DESCRITIVO
O cmdlet **Get-AzApiManagementAuthorizationServer** Obtém todos os servidores de autorização de gerenciamento de API do Azure ou o servidor de autorização especificado.
O ClientSecret não será incluído nos detalhes do resultado. Para obter o segredo do cliente, use **Get-AzApiManagementAuthorizationServerClientSecret**.
