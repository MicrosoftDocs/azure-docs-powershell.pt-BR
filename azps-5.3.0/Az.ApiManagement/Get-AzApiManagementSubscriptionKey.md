...
## DESCRITIVO
O cmdlet **Get-AzApiManagementSubscriptionKey** Obtém as chaves de uma assinatura especificada.

## EXEMPLOS

### Exemplo 1: obter uma chave de assinatura com uma ID especificada
```
...
### Microsoft. Azure. Commands. ApiManagement. onmanagement. Models. PsApiManagementSubscriptionKey
