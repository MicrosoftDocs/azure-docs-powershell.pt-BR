...
## DESCRITIVO
O cmdlet **Remove-AzApiManagementApiFromGateway** anexa uma API a um gateway.

## EXEMPLOS

### Exemplo 1: remover uma API de um gateway
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementApiFromGateway -Context $ApiMgmtContext -GatewayId "0123456789" -ApiId "0001" -PassThru
```

Esse comando Remove a API especificada de um gateway.

## OS

### -ApiId
Identificador de APIs existentes para remover do gateway.
...
### -Gatewayid
Identificador do gateway existente do qual remover a API.
Esse parâmetro é obrigatório.
