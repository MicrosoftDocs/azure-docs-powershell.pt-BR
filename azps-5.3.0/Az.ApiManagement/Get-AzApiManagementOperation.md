...
## DESCRITIVO
**Get-AzApiManagementOperation** Obtém uma lista ou uma operação de API especificada.
...
### -ApiRevision
Identificador da revisão da API. Este parâmetro é opcional. Se não for especificado, a operação será recuperada da revisão da API ativa no momento.
