...
### Exemplo 1: alterar as marcas no valor nomeado
```powershell
...
O segundo comando modifica o valor nomeado que tem a ID Property11.
O comando atribui as cadeias de caracteres em $Tags como marcas no valor nomeado.

### Exemplo 2: modifique o valor nomeado para ter um valor secreto
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementNamedValue -Context $apimContext -NamedValueId "Property12" -Secret $True -PassThru
```

Esse comando altera o valor nomeado a ser criptografado.
...
### -Nome
Nome do valor nomeado.
O comprimento máximo é de 100 caracteres.
Ele pode conter apenas letras, dígitos, ponto, traço e sublinhado de caracteres.
...
### -NamedValueId
Identificador do valor nomeado a ser atualizado.
Esse parâmetro é obrigatório.
...
### -PassThru
Se especificado, a instância do tipo Microsoft. Azure. Commands. ApiManagement. onmanagement. Models. PsApiManagementProperty que representa a propriedade Modified será gravada para output.
...
### -Segredo
Se o valor nomeado é um segredo e se seu valor deve ser criptografado.
Este parâmetro é opcional.
...
### -Marca
Marcas associadas ao valor nomeado.
Este parâmetro é opcional.
...
### -Valor
Valor do valor nomeado.
Pode conter expressões de política.
O comprimento máximo é de 1000 caracteres.
Ele pode não estar vazio ou consistir somente em espaços em branco.
Este parâmetro é opcional.
