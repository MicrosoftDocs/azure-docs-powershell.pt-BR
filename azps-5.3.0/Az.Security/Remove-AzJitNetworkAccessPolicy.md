...
## DESCRITIVO
Exclui uma política de acesso à rede just in time.
Após essa ação, um usuário não poderá solicitar uma conexão de rede temporária nas VMs que foram configuradas dentro da política excluída.
