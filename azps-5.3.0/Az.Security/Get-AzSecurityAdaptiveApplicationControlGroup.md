...
## Sinopse
Obtém um grupo de VMs/servidor de controle de aplicativo.
...
## DESCRITIVO
Os controles de aplicativos adaptáveis são calculados automaticamente pela central de segurança do Azure, use esse cmdlet para obter um controle de aplicativo/VM/grupo de servidor.
...
### -AscLocation
O local onde o ASC armazena os dados da assinatura. pode ser recuperada de obter locais.
...
### -Nome_do_grupo
Nome de um grupo de VM/servidor de controle de aplicativo.
