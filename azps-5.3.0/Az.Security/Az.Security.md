...
Desabilita a política avançada de proteção contra ameaças para uma conta de armazenamento/cosmosDB.

### [Enable-AzSecurityAdvancedThreatProtection](Enable-AzSecurityAdvancedThreatProtection.md)
Habilita a política avançada de proteção contra ameaças para uma conta de armazenamento/cosmosDB.
...
Obter alerta de agregação de segurança de IoT
...
Obtém os dados de preço dos planos do Azure defender habilitados na central de segurança do Azure para uma assinatura.
...
Criar uma nova regra de alerta personalizada de lista de permissões para o grupo de segurança de dispositivo (segurança IoT)

### [New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject](New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject.md)
Criar uma nova regra de alerta personalizada da lista de negações para o grupo de segurança do dispositivo (segurança de IoT)

### [New-AzDeviceSecurityGroupThresholdCustomAlertRuleObject](New-AzDeviceSecurityGroupThresholdCustomAlertRuleObject.md)
Criar nova regra de alerta personalizado de limite para o grupo de segurança do dispositivo (segurança de IoT)

### [New-AzDeviceSecurityGroupTimeWindowRuleObject](New-AzDeviceSecurityGroupTimeWindowRuleObject.md)
Criar nova regra de janela de horário para o grupo de segurança de dispositivo (segurança IoT)

### [New-AzIotSecuritySolutionRecommendationConfigurationObject](New-AzIotSecuritySolutionRecommendationConfigurationObject.md)
Criar uma nova configuração de recomendação para a solução de segurança IOT

### [New-AzIotSecuritySolutionUserDefinedResourcesObject](New-AzIotSecuritySolutionUserDefinedResourcesObject.md)
Criar novos recursos definidos pelo usuário para a solução de segurança da IOT
...
Excluir a solução de segurança IoT
...
Criar ou atualizar o grupo de segurança de dispositivos

### [Set-AzIotSecuritySolution](Set-AzIotSecuritySolution.md)
Criar ou atualizar a solução de segurança IoT
...
Define os dados de preço dos planos do Azure defender habilitados na central de segurança do Azure para uma assinatura.
...
Atualizar uma ou mais das seguintes propriedades na solução de segurança da IoT: marcas, configuração de recomendação, recursos definidos pelo usuário
...
Obtém as configurações de segurança na central de segurança do Azure

### [Set-AzSecuritySetting](Set-AzSecuritySetting.md)
Define uma configuração de segurança na central de segurança do Azure
