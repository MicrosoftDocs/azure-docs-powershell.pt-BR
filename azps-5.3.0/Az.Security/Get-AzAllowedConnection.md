...
## Sinopse
Usado para exibir o tráfego permitido entre recursos para a assinatura
...
## DESCRITIVO
Obtém a lista de todos os possíveis tráfegos entre recursos para a assinatura e o local, com base no tipo de conexão.
