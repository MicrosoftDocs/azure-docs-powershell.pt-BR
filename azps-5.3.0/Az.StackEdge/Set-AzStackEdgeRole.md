...
## DESCRITIVO
O cmdlet **set-AzStackEdgeRole** atualiza uma função IOT para um dispositivo de borda de pilha. Os antigos compartilhamentos montados serão substituídos pelos recém fornecidos no parâmetro ShareName.
