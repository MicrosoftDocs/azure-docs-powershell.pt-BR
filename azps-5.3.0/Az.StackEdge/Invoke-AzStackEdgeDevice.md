...
## DESCRITIVO
O cmdlet **Invoke-AzStackEdgeDevice** invoca ações para examinar, baixar e instalar as atualizações no dispositivo de borda de pilha. Uma verificação automática é executada no dispositivo diariamente, você pode disparar a digitalização explicitamente executando esse cmdlet.
...
### -FetchUpdate
Baixa as atualizações em um dispositivo de borda/gateway de pilha
...
### -InstallUpdate
Instala as atualizações no dispositivo de borda/gateway de pilha
...
### -ScanForUpdate
Verifica se há atualizações em um dispositivo de borda/gateway de pilha.
