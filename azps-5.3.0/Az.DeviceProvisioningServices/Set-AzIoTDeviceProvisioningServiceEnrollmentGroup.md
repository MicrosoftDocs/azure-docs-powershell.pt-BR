...
## DESCRITIVO
Atualizar um grupo de inscrição em um serviço de provisionamento de dispositivo Hub IoT do Azure.
...
Atualize o Hub e a política de alocação para um grupo de registro.
...
Atualize o estado de atualização inicial do grupo de registros.
