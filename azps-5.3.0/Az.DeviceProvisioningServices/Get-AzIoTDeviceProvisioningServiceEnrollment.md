...
## DESCRITIVO
Obter detalhes de inscrição do dispositivo ou listar registros de dispositivo em um serviço de provisionamento de dispositivo Hub do Azure IoT.
...
Obter detalhes de registro do dispositivo em um serviço de provisionamento de dispositivo Hub IoT do Azure.
...
Listar registros de dispositivo em um serviço de provisionamento de dispositivo Hub IoT do Azure.
