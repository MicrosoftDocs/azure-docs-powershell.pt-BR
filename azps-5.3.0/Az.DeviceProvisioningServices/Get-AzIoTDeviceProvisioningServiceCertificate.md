...
Mostrar detalhes sobre "myCertificate" em um serviço de provisionamento de dispositivo Hub IoT do Azure.
...
Liste todos os certificados em "myiotdps" usando o pipeline.
