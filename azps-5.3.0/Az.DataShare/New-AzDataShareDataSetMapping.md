...
## DESCRITIVO
O cmdlet **New-AzDataShareDataSetMapping** cria um mapeamento de conjuntos de dados entre os conjuntos de dados de origem e a conta de armazenamento do coletor na assinatura do compartilhamento.
...
Esse comando cria um mapeamento de conjunto de dados AdsDataSetMapping para a conta de armazenamento AdsStorage para a assinatura de compartilhamento AdsShareSubscription em WikiAdsAccount de conta de compartilhamento de dados.
...
### -FilePath
Caminho do arquivo de armazenamento do Azure
...
### -FileSystem
Nome do sistema de arquivos Gen2 do ADLS
...
### -Nome
Nome do mapeamento do conjunto de dados do Azure
