...
## DESCRITIVO
Use **Add-AzServiceFabricClientCertificate** para adicionar um nome comum e uma impressão digital do emissor ou impressão digital de certificado ao cluster, para que o cliente possa usá-lo para autenticação.
...
Esse comando adicionará o certificado com a impressão digital ' 5F3660C715EBBDA31DB1FFDCF508302348DE8E7A ' ao cluster, portanto, o cliente poderá usar o certificado como administrador para se comunicar com o cluster.
...
Esse comando adicionará um certificado de cliente somente leitura que é o nome comum é ' Contoso.com ' e a impressão digital do emissor é ' 5F3660C715EBBDA31DB1FFDCF508302348DE8E7A ' para o cluster.
...
Especificar a impressão digital do certificado de cliente que tem apenas permissão de administrador
...
Especificar o nome comum do cliente, a impressão digital do emissor e o tipo de autenticação
...
### -CommonName
Especificar nome comum do certificado do cliente
...
Especificar a impressão digital do certificado de cliente que tem apenas permissão somente leitura
...
### -Impressão digital
Especificar a impressão digital do certificado do cliente
...
### Microsoft. Azure. Commands. imfabric. Models. PSClientCertificateCommonName []
