...
### Exemplo 1: especificar apenas o tamanho do cluster, o nome do requerente do certificado e o sistema operacional para implantar um cluster
...
Especifique o nome do cluster, se não for fornecido como nome do grupo de recursos
