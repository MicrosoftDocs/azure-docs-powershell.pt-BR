...
Atualize a porta de conexão do cliente e o nome DNS para o cluster.
...
Atualize o nome DNS e a porta de conexão do cliente para o cluster, com tubulação.
...
### -CodeVersion
Versão do código do cluster. Use o modo de atualização somente se for manual.
...
### -ResourceId
ID do recurso de cluster gerenciado
...
### -Upgrademode
Modo de atualização de versão do código do cluster. Automática ou manual.
