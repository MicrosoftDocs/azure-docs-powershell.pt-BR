...
## Sinopse
Obter detalhes do serviço do Service Fabric no aplicativo e no cluster especificados. Só oferece suporte a serviços de ARM distribuído.
...
## DESCRITIVO
Esse cmdlet obterá os detalhes do serviço no aplicativo e no cluster especificados.
...
Este exemplo obtém os detalhes do recurso de serviço para o serviço "testApp ~ testService".
...
Este exemplo obtém uma lista dos serviços sob o aplicativo "testApp".
