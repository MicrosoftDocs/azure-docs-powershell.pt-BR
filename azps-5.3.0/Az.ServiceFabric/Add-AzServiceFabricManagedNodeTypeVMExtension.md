...
## DESCRITIVO
Adicionar extensão de VM ao tipo de nó. Isso adicionará a extensão ao recurso do conjunto de escala da máquina virtual underliying.
...
Esse comando adiciona uma extensão ao tipo de nó.
...
Esse comando adiciona uma extensão com configurações e configurações protegidas ao tipo de nó.
...
Esse comando adiciona uma extensão ao tipo de nó, com tubulação.
...
Isso pode usar o cmdlet Get-AzVMImagePublisher para obter o fornecedor.
...
Você pode usar o cmdlet Get-AzVMExtensionImageType para obter o tipo de extensão.
