...
## DESCRITIVO
O cmdlet **Add-AzDataLakeAnalyticsDataSource** adiciona uma fonte de dados a uma conta do Azure data Lake Analytics.
...
Adiciona uma fonte de dados a uma conta do data Lake Analytics. (gerado automaticamente)
