...
## DESCRITIVO
Remove **-AzDataLakeAnalyticsComputePolicy** remove uma política de computação do Azure data Lake Analytics especificada.

## EXEMPLOS

### Exemplo 1: remover uma política de computação
```
PS C:\>Remove-AzDataLakeAnalyticsComputePolicy -Account "contosoadla" -Name myPolicy
```

Este comando Remove a política de computação especificada com o nome ' MyPolicy ' na conta ' contosoadla '.

## OS

### -Conta
Nome da conta da qual remover a política de computação.
...
### -Nome
Nome da política de computação a ser removida.
