...
### ByIntegrationAccountAndFilePath (padrão)
```
...
## DESCRITIVO
O cmdlet **set-AzIntegrationAccountAssembly** modifica um assembly de conta de integração.

## EXEMPLOS

### Exemplo 1: modificar um assembly usando um arquivo local
```powershell
...
Modifica o assembly chamado "sampleAssembly" usando o arquivo local localizado no caminho do arquivo contido em "$localAssemblyFilePath".

### Exemplo 2: modificar um assembly usando dados de bytes
```powershell
...
Modifica o assembly chamado "sampleAssembly" usando a matriz de bytes contida em "$assemblyContent".

### Exemplo 3: modificar um assembly usando um link de conteúdo
```powershell
...
Modifica o assembly chamado "sampleAssembly" usando os dados de bytes localizados na URL "$assemblyUrl". Esse é o método sugerido para a criação de conjuntos de grandes tamanhos.

## OS

### -AssemblyData
A conta de integração assembly dados de bytes.
...
### -AssemblyFilePath
O caminho do arquivo de assembly da conta de integração.
...
### -ContentLink
Um link publicamente acessível para os dados de assembly da conta de integração.
...
### -Metadados
Os metadados de assembly da conta de integração.
...
### -ResourceId
A ID do recurso assembly da conta de integração.
