...
## DESCRITIVO
Esse comando cancela a assinatura do gatilho de evento para os eventos de serviço externo especificados da definição do gatilho.
...
Esse comando cancelará a assinatura do gatilho BlobEnetTrigger1 para os eventos especificados da definição do gatilho.
...
### -PassThru
Se especificado, o cmdlet retornará retornará true na exclusão bem-sucedida.
