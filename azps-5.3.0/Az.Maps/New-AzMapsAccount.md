...
## DESCRITIVO
O cmdlet New-AzMapsAccount cria uma conta do Azure Maps com a SKU especificada.
...
Cria uma nova conta do Azure Maps chamada myaccount no grupo de recursos grupo de recursos com o SKU S0 e uma marca.
