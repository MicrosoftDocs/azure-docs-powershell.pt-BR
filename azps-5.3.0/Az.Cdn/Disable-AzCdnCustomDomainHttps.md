...
## DESCRITIVO
O cmdlet **Disable-AzCdnCustomDomainHttps** desabilita a entrega https segura de um domínio personalizado CDN.
...
Desabilitar a entrega segura do domínio personalizado.
...
### -ResourceId
ResourceId do domínio personalizado
