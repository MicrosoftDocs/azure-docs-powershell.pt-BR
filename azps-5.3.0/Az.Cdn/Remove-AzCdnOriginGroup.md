...
## DESCRITIVO
Remove-AzCdnOriginGroup removerá um grupo de origem CDN do ponto de extremidade especificado. 
...
Esse cmdlet removerá o grupo de origem especificado do ponto de extremidade fornecido. 
...
### -ResourceId
A ID do recurso do grupo de origens da CDN do Azure.
