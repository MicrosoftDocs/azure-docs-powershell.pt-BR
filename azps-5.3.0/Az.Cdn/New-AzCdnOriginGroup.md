...
## Sinopse
Cria um novo grupo de origens CDN
...
## DESCRITIVO
O New-AzCdnOriginGroup criará um novo grupo de origem dentro do ponto de extremidade especificado. Se esse for o primeiro grupo de origem para o ponto de extremidade, a propriedade defaultorigin também deve ser definida.
...
```
Esse cmdlet criará um novo grupo de origem dentro do ponto de extremidade especificado. Ele usará as identificações de origem fornecidas como o conjunto de origens.

## OS

### -CdnOriginGroup
O objeto do grupo de origem CDN.
...
### -OriginGroupName
Nome do grupo de origens da CDN do Azure.
