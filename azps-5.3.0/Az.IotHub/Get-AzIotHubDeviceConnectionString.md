...
## DESCRITIVO
Listar cadeia de conexão de todos os dispositivos ou um dispositivo IoT de destino contido em um hub IoT do Azure.
...
Mostrar cadeia de conexão de todos os dispositivos em um hub IOT.
...
Obter a cadeia de conexão secundária de um dispositivo IoT.
