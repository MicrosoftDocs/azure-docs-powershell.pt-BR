...
Esse comando cria um espaço de trabalho databricks.
...
Esse comando cria um espaço de trabalho databricks com uma rede virtual personalizada em um grupo de recursos.

### Exemplo 3: criar um espaço de trabalho databricks com habilitar criptografia
```powershell
...
Esse comando cria um espaço de trabalho databricks e o define para se preparar para a criptografia.
...
### -PrivateSubnetName
O nome da sub-rede particular dentro da rede virtual.
...
Um booliano que indica se o sistema de arquivos raiz DBFS será habilitado com camada secundária de criptografia com chaves gerenciadas pela plataforma para dados em repouso.
...
### -VirtualNetworkId
A ID de uma rede virtual na qual esse cluster de databricks deve ser criado.
