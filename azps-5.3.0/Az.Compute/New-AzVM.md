...
### -HostGroupId
Especifica o grupo de hosts dedicados no qual a máquina virtual residirá.
...
Os possíveis valores para o Windows Server são:
- Windows_Client
- Windows_Server possíveis valores para o sistema operacional do servidor Linux são: 
- RHEL_BYOS (para RHEL) 
- SLES_BYOS (para SUSE) 
...
Para obter um objeto de máquina virtual, use o cmdlet New-AzVMConfig.
...
### -VmssId
A ID do conjunto de escala de máquina virtual ao qual esta VM será associada
