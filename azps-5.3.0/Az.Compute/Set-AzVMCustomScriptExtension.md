...
### -Nome do arquivo
Especifica o nome do arquivo de script. Se o arquivo estiver armazenado no armazenamento do blob do Azure, o valor do nome do arquivo diferenciará maiúsculas de minúsculas. Os nomes de arquivo dos arquivos armazenados no armazenamento de arquivos do Azure não diferenciam maiúsculas de minúsculas.
...
Para obter a versão, execute o cmdlet Get-AzVMExtensionImage com um valor de Microsoft. COMPUTE para o parâmetro *PublisherName* e CustomScriptExtension para o parâmetro de *tipo* .
