...
### Exemplo 2: obter objeto de VMImage
```
...
Esse comando obtém uma versão específica da VMImage que corresponde aos valores especificados.
...
Esse comando obtém todas as versões de VMImage correspondentes aos valores especificados com filtragem sobre a versão.
...
### -OrderBy
Especifica a ordem dos resultados retornados. Formatada como uma consulta OData.
...
### -Início
Especifica o número máximo de imagens da máquina virtual retornadas. 
