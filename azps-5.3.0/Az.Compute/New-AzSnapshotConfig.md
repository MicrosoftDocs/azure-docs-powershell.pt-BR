...
Cria um objeto de instantâneo configurável. (gerado automaticamente)
...
### -Incremental
Especifica um instantâneo incremental. Instantâneos incrementais no mesmo disco ocupam menos espaço do que os instantâneos completos e podem ser diferenciados.
