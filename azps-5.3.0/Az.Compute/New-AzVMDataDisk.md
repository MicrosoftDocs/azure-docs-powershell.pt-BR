...
### NormalDiskParameterSetName (padrão)
```
...
## DESCRITIVO
O cmdlet **New-AzVMDataDisk** cria um objeto de disco de dados local para uma máquina virtual ou uma VM Vmss.
...
Cria um objeto de disco de dados local para uma máquina virtual ou uma VM Vmss. (gerado automaticamente)
...
### -Cache
O cache do disco de dados da máquina virtual.
...
### -Createoption
A opção de criação do disco de dados da máquina virtual.
...
### -DiskEncryptionSetId
O ID do conjunto de criptografia de disco gerenciado pela máquina virtual.
...
### -DiskSizeInGB
O tamanho do disco dos dados da máquina virtual em GB.
...
### -LUN
O LUN do disco de dados da máquina virtual.
...
### -ManagedDiskId
A ID do disco gerenciado pela máquina virtual.
...
### -Nome
O nome do disco de dados da máquina virtual.
...
### -SourceImageUri
O URI da imagem de origem do disco do so da máquina virtual.
...
### -VhdUri
O URI do VHD do disco de dados da máquina virtual.
