...
A seguir, você criará uma tabela de rota composta por várias rotas e anexada a um novo hub virtual.

Esse é um objeto na memória que pode ser usado para adicionar uma tabela de rota a um novo ou a um VirtualHub existente.
