...
## Sinopse
Obtém a política SSL de um perfil de SSL do gateway do aplicativo.
...
## DESCRITIVO
O cmdlet **Get-AzApplicationGatewaySslProfilePolicy** Obtém a política SSL de um perfil SSL do gateway do aplicativo.
