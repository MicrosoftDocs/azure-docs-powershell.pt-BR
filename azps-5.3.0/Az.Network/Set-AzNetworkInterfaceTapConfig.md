...
## DESCRITIVO
O **set-AzNetworkInterfaceTapConfig** atualiza uma configuração de toque para uma interface de rede.

## EXEMPLOS

### Exemplo 1: definir o TapConfiguration com o nome TapConfig atualizado
```
...
A configuração de o toque de NetworkInterface
