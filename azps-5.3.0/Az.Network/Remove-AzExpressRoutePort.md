...
Remove $PortName recurso ExpressRoutePort em $rg grupo de recursos na sua assinatura.
...
Remove o recurso ExpressRoutePort em InputObject.
...
Remove o recurso ExpressRoutePort com $id ResourceId.
...
### -InputObject
O objeto porta de rota expressa
