...
## Sinopse
Cria uma cadeia de certificados de autoridade de certificação de cliente confiável para um gateway de aplicativo.
...
## DESCRITIVO
O cmdlet New-AzApplicationGatewayTrustedClientCertificate cria uma cadeia de certificados de autoridade de certificação de cliente confiável para um gateway de aplicativo.
...
```
O comando cria um novo objeto de cadeia de certificados de autoridade de certificação de cliente confiável fazendo o caminho do certificado da autoridade de certificação do cliente como entrada.
