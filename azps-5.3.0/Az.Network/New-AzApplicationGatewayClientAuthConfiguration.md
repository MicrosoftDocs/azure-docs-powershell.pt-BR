...
## Sinopse
Cria uma nova configuração de autenticação de cliente para o perfil SSL.
...
## DESCRITIVO
O cmdlet **New-AzApplicationGatewayClientAuthConfiguration** cria uma nova configuração de autenticação de cliente para o perfil SSL.
...
O comando cria uma nova configuração de autenticação de cliente e a armazena em $clientAuthConfig variável para ser usada em um perfil SSL. 
