...
## DESCRITIVO
O cmdlet **Get-AzP2sVpnGatewayVpnProfile** permite gerar e obter uma URL SAS para o cliente baixar o perfil VPN da configuração do site do cliente para o site para que ele tenha o ponto para a conectividade do site com o P2SVpnGateway. A configuração de cliente do site que usa esse perfil VPN pode se conectar a esse P2SVpnGateway específico apenas.
...
O cmdlet **Get-AzP2sVpnGatewayVpnProfile** permite gerar e obter uma URL SAS para o cliente baixar o perfil VPN da configuração do site do cliente para o site para que ele tenha o ponto para a conectividade do site com o P2SVpnGateway. O ProfileUrl mostra a URL da SAS a partir da qual o cliente pode baixar o perfil da VPN para a configuração do cliente do site do Point.
