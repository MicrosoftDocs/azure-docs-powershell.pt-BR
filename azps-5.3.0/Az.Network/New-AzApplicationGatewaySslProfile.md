...
## DESCRITIVO
O cmdlet **New-AzApplicationGatewaySslProfile** cria um perfil SSL para um gateway de aplicativo. O perfil SSL está configurado nos ouvintes HTTPS.
...
```
O primeiro comando cria uma nova política SSL e a armazena na variável $sslPolicy.
O segundo comando cria uma cadeia de certificados de autoridade de certificação de cliente confiável e a armazena na variável $ClientCert 01.
O terceiro comando cria um novo perfil SSL com a cadeia de certificados política SSL e certificado de autoridade de certificação de cliente confiável.
