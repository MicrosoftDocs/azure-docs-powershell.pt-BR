...
## Sinopse
Remove uma política SSL de um perfil SSL do gateway do aplicativo do Azure.
...
## DESCRITIVO
O cmdlet Remove-AzApplicationGatewaySslProfilePolicy remove uma política SSL de um perfil SSL do gateway do aplicativo do Azure.
...
### -SslProfile
O perfil SSL do applicationGateway
