...
### Exemplo 1: definir o objeto da política IPSec de VPN:
```powershell
...
### Exemplo 2: criar um novo gateway de rede virtual com a configuração de política IPSec personalizada VPN:
```powershell
