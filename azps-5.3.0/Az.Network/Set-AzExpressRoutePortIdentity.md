...
## DESCRITIVO
O cmdlet **set-AzExpressRoutePortIdentity** atualiza um objeto ExpressRoutePort do Azure local. Use **set-AzExpressRoutePort** para atribuí-lo ao ExpressRoutePort.
