...
## Sinopse
Cria um item de escopo de ponto de extremidade de monitor de conexão.
...
## DESCRITIVO
O cmdlet New-AzNetworkWatcherConnectionMonitorEndpointScopeItemObject cria um item de escopo de ponto de extremidade.
