...
## DESCRITIVO
Cria uma conexão do ExpressRoute entre um emparelhamento BGP do circuito no local ExpressRoute para o gateway do ExpressRoute dentro de um hub virtual.
...
A seguir, você criará um grupo de recursos, uma WAN virtual, uma rede virtual, um hub virtual, o gateway de rota expressa e um circuito do ExpressRoute com emparelhamento privado no centro-oeste do grupo de recursos "testRG" do Azure. Após a criação do gateway, ele é conectado à troca de circuito do ExpressRoute usando o comando New-AzExpressRouteConnection.
...
### -AuthorizationKey
Uma chave obtida do proprietário do circuito do ExpressRoute para poder criar uma conexão com um gateway em uma assinatura diferente.
...
Habilitar a segurança da Internet para esta conexão de gateway ExpressRoute
...
A ID do recurso do emparelhamento de circuito de rota expressa para a qual essa conexão de gateway de rota expressa deve ser criada.
...
### -RoutingWeight
O peso do roteamento de pacotes que precisa ser atribuído a essa conexão.
