...
## DESCRITIVO
Interrompe a operação de captura de pacote em um gateway de rede virtual e carregará o resultado em determinado SasUrl contêiner de armazenamento.
...
### -SasUrl
Captura de pacote de URL SAS no gateway de rede virtual.
