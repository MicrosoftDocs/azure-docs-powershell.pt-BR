...
## DESCRITIVO
O cmdlet **Remove-AzExpressRoutePortIdentity** remove a identidade de um objeto ExpressRoutePort do Azure local. Use **Remove-AzExpressRoutePort** para removê-lo do ExpressRoutePort.
