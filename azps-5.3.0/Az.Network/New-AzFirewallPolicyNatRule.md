...
Este exemplo cria uma regra NAT com o endereço de origem, o protocolo, o endereço de destino, a porta de destino, o endereço traduzido e a porta traduzida.
...
Este exemplo cria uma regra NAT com o endereço de origem, o protocolo, o endereço de destino, a porta de destino, o FQDN traduzido e a porta traduzida.
...
### -DestinationAddress
Os endereços de destino da regra. Isso deve ser um IP público do firewall.
...
### -TranslatedAddress
O endereço traduzido para esta regra NAT
