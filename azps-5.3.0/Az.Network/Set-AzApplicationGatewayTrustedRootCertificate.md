...
## DESCRITIVO
O cmdlet **set-AzApplicationGatewayTrustedRootCertificate** modifica o certificado raiz confiável existente de um gateway de aplicativo.
...
Os cenários de exemplo acima mostram como atualizar um certificado raiz confiável existente quando um certificado raiz é revertido.
O primeiro comando obtém um gateway de aplicativo e o armazena na variável $gw.
O segundo comando modifica o certificado raiz confiável existente com um novo certificado raiz.
O terceiro comando atualiza o Application Gateway no Azure.
