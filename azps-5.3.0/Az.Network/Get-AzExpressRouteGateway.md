...
A seguir, você criará um grupo de recursos, uma WAN virtual, uma rede virtual, um hub virtual no centro-oeste do grupo de recursos "testRG" no Azure. Um gateway ExpressRoute será criado posteriormente no Hub virtual com duas unidades de escala.

Em seguida, ele obtém o ExpressRouteGateway usando seu resourceGroupName e o nome do gateway.
...
Esse comando terá todos os ExpressRouteGateways que começam com "Test"
