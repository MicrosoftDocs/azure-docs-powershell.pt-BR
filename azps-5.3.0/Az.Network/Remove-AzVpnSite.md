...
Depois que o site for criado, ele será removido imediatamente usando o comando Remove-AzVpnSite.
...
Mesmo que o exemplo 1, mas aqui, a remoção ocorre usando a saída de pipe do Get-AzVpnSite.
...
### -InputObject
O objeto vpnSite a ser excluído.
...
### -ResourceId
A ID de recurso do Azure para o vpnSite a ser excluído.
