...
### ByVpnServerConfigurationName (padrão)
```
...
O comando acima removerá um VpnServerConfiguration existente.
...
### -InputObject
O objeto vpnServerConfiguration a ser excluído.
...
### -ResourceId
A ID de recurso do Azure para o vpnServerConfiguration a ser excluído.
