...
Este exemplo cria um grupo de recursos, uma WAN virtual, um hub virtual, um gateway VPN escalável nos EUA e, em seguida, o exclui imediatamente. Essa exclusão ocorre usando o pipe do PowerShell, que usa o objeto VpnGateway retornado pelo comando Get-AzVpnGateway.
