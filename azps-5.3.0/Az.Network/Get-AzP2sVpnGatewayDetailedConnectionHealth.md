...
## DESCRITIVO
O cmdlet **Get-AzP2sVpnGatewayDetailedConnectionHealth** permite que você obtenha as informações detalhadas do ponto atual para conexões de site do P2SVpnGateway. O cliente precisa passar pela URL SAS, onde poderemos colocar essas informações detalhadas sobre a saúde.
...
O cmdlet **Get-AzP2sVpnGatewayDetailedConnectionHealth** permite que você obtenha as informações detalhadas do ponto atual para conexões de site do P2SVpnGateway. O cliente pode baixar detalhes de integridade do download da URL SAS aprovada. Isso mostrará as informações de cada ponto para conexão do site com nomes de email, bytes em bytes de saída, endereço IP alocado, etc.
...
### -OutputBlobSasUrl
OutputBlob a URL SAS à qual a integridade da conexão VPN do P2s será gravada.
...
### -VpnUserNamesFilter
A lista de nomes de usuários VPN P2S para filtrar.
