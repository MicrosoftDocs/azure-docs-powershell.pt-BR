...
## DESCRITIVO
O cmdlet **set-AzExpressRouteCircuitConnectionConfig** atualiza uma configuração de conexão de circuito criada em emparelhamento privado para um circuito do ExpressRoute. Isso permite o emparelhamento de dois circuitos de rota expressa entre regiões ou assinaturas.
...
### Exemplo 1: atualizar um recurso de conexão de circuito para um circuito ExpressRoute existente
```
...
### Exemplo 2: definir uma configuração de conexão de circuito usando o encanamento para um circuito ExpressRoute existente
```
$circuit_peer = Get-AzExpressRouteCircuit -Name $peeringCircuitName -ResourceGroupName $rg
...
### -AddressPrefix
Um espaço de endereço de cliente mínimo/29 para criar túneis de VxLan entre os circuitos de rota expressa para túneis IPv4.
ou um espaço de endereço de cliente no mínimo/125 para criar túneis de VxLan entre circuitos de rota expressa para túneis IPv6.
...
```
### -AddressPrefixType
Especifica a família de endereços à qual pertence o prefixo de endereço.
