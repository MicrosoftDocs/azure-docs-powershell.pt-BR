...
## Sinopse
Modifica a configuração de autenticação de cliente de um objeto de perfil SSL.
...
## DESCRITIVO
O cmdlet **set-AzApplicationGatewayClientAuthConfiguration** modifica a configuração de autenticação de cliente de um objeto de perfil SSL.
