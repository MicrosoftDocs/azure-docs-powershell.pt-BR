...
## DESCRITIVO
O cmdlet **New-AzExpressRouteCircuit** cria um circuito de rota do Azure Express.
...
### -Inprovidername
O nome do provedor de serviços de circuito. Isso deve corresponder a um nome listado pelo cmdlet Get-AzExpressRouteServiceProvider.
...
### -SkuTier
O nível de serviço para o circuito. Os valores possíveis para esse parâmetro são `Standard` : `Premium` ou `Local` .
