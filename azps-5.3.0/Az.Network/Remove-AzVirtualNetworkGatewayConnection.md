...
O cmdlet **Remove-AzVirtualNetworkGatewayConnection** exclui o objeto da sua conexão com base no nome e no nome do grupo de recursos.

## EXEMPLOS

### Exemplo 1: excluir uma conexão de gateway de rede virtual
```powershell
Remove-AzVirtualNetworkGatewayConnection -Name myTunnel -ResourceGroupName myRG
```

Exclui o objeto da conexão do gateway de rede virtual com o nome "mytunnel" dentro do grupo de recursos "myRG"
...
### -Nome
Especifica o nome da conexão de gateway de rede virtual que este cmdlet Remove.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém a conexão de gateway de rede virtual.
