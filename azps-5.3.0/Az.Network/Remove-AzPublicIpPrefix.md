...
## DESCRITIVO
O cmdlet **Remove-AzPublicIpPrefix** remove um prefixo de IP público do Azure desde que não haja endereços IP públicos atribuídos a ele.
...
Remove o prefixo de IP público com o nome $prefixName do grupo de recursos $rgName
...
### -ResourceId
A ResourceId do recurso a ser removido
