...
O sexto comando cria um balanceador de carga chamado MyLoadBalancer no grupo de recursos chamado MyResource Group.
O sétimo e o último comando recebem o novo balanceador de carga para garantir que ele foi criado com êxito.
Observe que este exemplo mostra apenas como criar um balanceador de carga global. Você também deve configurá-lo usando o cmdlet New-AzLoadBalancerBackendAddressConfig para atribuir IDs de ipconfig de front-end de carga regional ao pool de endereços back-end
