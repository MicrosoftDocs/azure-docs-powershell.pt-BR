...
## DESCRITIVO
O cmdlet **set-AzNetworkSecurityGroup** atualiza um grupo de segurança de rede.

## EXEMPLOS

### Exemplo 1: atualizar um grupo de segurança de rede existente
```
...
Especifica um objeto do grupo de segurança de rede que representa o estado para o qual o grupo de segurança de rede deve ser definido.
