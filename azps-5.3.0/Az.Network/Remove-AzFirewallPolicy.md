...
## DESCRITIVO
O cmdlet **Remove-AzFirewallPolicy** remove uma política de firewall do Azure.
...
Este exemplo remove a política de firewall chamada "firewallpolicy" no TestRg ".
...
Este exemplo remove a política de firewall pela ID.
...
Este exemplo remove a política de firewall $fp
