...
## DESCRITIVO
**O cmdlet New-AzApplicationGatewayRewriteRuleSet** cria um conjunto de regras de regravação para um gateway do aplicativo do Azure.
...
Esse comando cria um conjunto de regras de regravação chamado ruleset1 e armazena o resultado na variável chamada $ruleset.
