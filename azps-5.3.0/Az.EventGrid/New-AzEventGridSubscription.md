...
### -DeliverySchema
O esquema a ser usado durante o envio de eventos para o destino. Os valores possíveis são: eventgridschema, CustomInputSchema ou cloudeventv01schema. O valor padrão é CustomInputSchema.
