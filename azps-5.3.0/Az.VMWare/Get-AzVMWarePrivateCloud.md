...
### Exemplo 1: lista de nuvem privada em assinatura
```powershell
...
Lista de nuvem privada em assinatura

### Exemplo 2: lista de nuvem privada em grupo de recursos
```powershell
...
Lista de nuvem privada em grupo de recursos
