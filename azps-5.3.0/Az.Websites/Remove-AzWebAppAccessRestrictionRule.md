...
## DESCRITIVO
O cmdlet **Remove-AzWebAppAccessRestrictionRule** remove uma regra de restrição de acesso de um aplicativo Web do Azure

## EXEMPLOS

### Exemplo 1: remover uma regra de restrição de acesso do aplicativo Web
```
PS C:\>Remove-AzWebAppAccessRestrictionRule -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite" -Name IpRule
```

Esse comando Remove a regra de restrição de acesso IpRule do Azure Web App chamado ContosoSite que pertence ao grupo de recursos chamado Default-Web-Oesteus.

### Exemplo 2: remover uma regra de restrição de acesso ao aplicativo Web de marca de serviço
```
...
Esse comando Remove a regra de restrição de acesso com ServiceTag igual a AzureFrontDoor. back-end do Azure Web App chamado ContosoSite que pertence ao grupo de recursos chamado Default-Web-Oesteus.
...
### -Nome
Nome da regra de restrição de acesso
...
### -VirtualNetworkName
Nome da rede virtual (deve estar no mesmo grupo de recursos do aplicativo Web).
