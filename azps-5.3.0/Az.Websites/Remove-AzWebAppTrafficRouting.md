...
## DESCRITIVO
O cmdlet **Remove-AzWebAppTrafficRouting** remove uma regra de roteamento de um slot do aplicativo Web do Azure.

## EXEMPLOS

### O exemplo 1 remove a regra de roteamento específica do slot webapp
```powershell
PS C:\> Remove-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite"  -RuleName 'Stg'
```

Esse comando Remove uma regra de roteamento para um determinado slot do webapp.
