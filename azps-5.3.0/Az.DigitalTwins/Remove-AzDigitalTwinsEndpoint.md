...
### Exemplo 1: excluir o azDigitalTwinsEndPoint por EndpointName
```powershell
...
Excluir o azDigitalTwinsEndPoint de EndpointName ResourceGroupName e resourceName

### Exemplo 2: excluir o azDigitalTwinsEndPoint por objeto
```powershell
...
Excluir o azDigitalTwinsEndPoint por objeto
