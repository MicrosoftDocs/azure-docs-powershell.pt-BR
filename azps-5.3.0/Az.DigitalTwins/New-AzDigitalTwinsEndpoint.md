...
### Exemplo 1: criar um AzDigitalTwinsEndpoint para o Eventhub
```powershell
...
Criar um AzDigitalTwinsEndpoint para o Eventhub pela connectionStringPrimaryKey

### Exemplo 2: criar um AzDigitalTwinsEndpoint para EventGrid
```powershell
...
Criar um AzDigitalTwinsEndpoint para o Eventhub pelo TopicEndpoint e pelo accessKey1

### Exemplo 3: criar um AzDigitalTwinsEndpoint para o ServiceBus
```powershell
...
Criar um AzDigitalTwinsEndpoint para ServicBus por PrimaryConnectionString
...
### -DeadLetterSecret
Segredo do armazenamento de carta de inatividade.
Serão ofuscados durante a leitura.
...
Para construir, consulte a seção notas para propriedades ENDPOINTDESCRIPTION e crie uma tabela de hash.
...
### -EndpointType
O tipo de ponto de extremidade Twins digital
...
ENDPOINTDESCRIPTION <IDigitalTwinsEndpointResource> : DigitalTwinsInstance recurso de ponto de extremidade.
  - `EndpointType <EndpointType>`: O tipo de ponto de extremidade Twins digital
  - `[DeadLetterSecret <String>]`: Segredo de armazenamento de letra de inatividade. Serão ofuscados durante a leitura.
