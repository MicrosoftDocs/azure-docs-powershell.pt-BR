...
### Exemplo 1: verificar o nome por local e nome.
```powershell
...
### Exemplo 2: Verifique o nome de DigitalTwinsObject e CheckNameObject.
```powershell
...
Obtenha um DigitalTwinsInstance e crie um objeto requset para testar a disponibilidade do nome.
...
O resultado retornado de um banco de dados verificar solicitação de disponibilidade de nome.
Para construir, consulte a seção notas para propriedades DIGITALTWINSINSTANCECHECKNAME e crie uma tabela de hash.
...
DIGITALTWINSINSTANCECHECKNAME <ICheckNameRequest> : o resultado retornado de um banco de dados verificar solicitação de disponibilidade de nome.
