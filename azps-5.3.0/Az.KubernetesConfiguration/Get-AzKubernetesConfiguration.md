...
## Sinopse
Obtém detalhes da configuração de controle do código-fonte.
...
### Exemplo 1: obter todas as configurações do cluster kubernetes
```powershell
...
Esse comando obtém todas as configurações do cluster kubernetes.

### Exemplo 2: obter uma configuração do kubernetes cluster por nome
```powershell
...
Esse comando obtém uma configuração do cluster kubernetes por nome.

### Exemplo 3: obter uma configuração do cluster kubernetes por objeto
```powershell
...
Esse comando obtém uma configuração do kubernetes cluster por objeto.

### Exemplo 4: obter uma configuração do cluster kubernetes por pipeline
```powershell
...
Esse comando obtém uma configuração de cluster de kubernetes por pipeline.
...
### -ClusterRp
O kubernetes do cluster do RP-Microsoft. ContainerService (para clusters AKS) ou Microsoft. kubernetes (para clusters de K8S onlocal).
...
### -Clustertype
O nome do recurso de cluster kubernetes-managedClusters (para clusters AKS) ou connectedClusters (para clusters de K8S onlocal).
...
### -Nome
Nome da configuração de controle do código-fonte.
...
INPUTobject <IKubernetesConfigurationIdentity> : parâmetro de identidade
  ...
  - `[ClusterResourceName <String>]`: O nome do recurso de cluster kubernetes-managedClusters (para clusters AKS) ou connectedClusters (para clusters de K8S onlocal).
  - `[ClusterRp <String>]`: O kubernetes do cluster do RP-Microsoft. ContainerService (para clusters AKS) ou Microsoft. kubernetes (para clusters do K8S onlocal).
  - `[Id <String>]`: Caminho de identidade do recurso
  - `[ResourceGroupName <String>]`: O nome do grupo de recursos.
  - `[SourceControlConfigurationName <String>]`: Nome da configuração de controle do código-fonte.
