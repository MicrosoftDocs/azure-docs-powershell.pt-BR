...
### Exemplo 1: excluir um AttachedDatabaseConfiguration existente por nome
```powershell
...
O comando acima exclui o banco de dados de acompanhamento definido no AttachedDatabaseConfiguration "myfollowerconfiguration" do cluster "testnewkustoclusterf".
