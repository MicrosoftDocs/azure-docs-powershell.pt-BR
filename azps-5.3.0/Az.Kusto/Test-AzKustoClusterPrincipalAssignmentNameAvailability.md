...
### Exemplo 1: verificar a disponibilidade de um nome de principalassignment de cluster que está em uso
```powershell
...
O comando acima retorna se um PrincipalAssignment chamado "myupn" existe no cluster "testnewkustocluster".

### Exemplo 2: verificar a disponibilidade de um nome de principalassignment de cluster que não está em uso
```powershell
...
O comando acima retorna se um PrincipalAssignment chamado "newprincipal" existe no cluster "testnewkustocluster".
