...
### Exemplo 1: verificar a disponibilidade de um nome de principalassignment de banco de dados que está em uso
```powershell
...
O comando acima retorna se um PrincipalAssignment chamado "myupn" existe no banco de dados "mykustodatabase" do cluster "testnewkustocluster".

### Exemplo 2: verificar a disponibilidade de um nome de principalassignment de banco de dados que não está em uso
```powershell
...
### -Nome
Nome do recurso da atribuição principal.
...
### -Digite
O tipo de recurso, Microsoft. Kusto/clusters/bancos de dados/principalAssignments.
