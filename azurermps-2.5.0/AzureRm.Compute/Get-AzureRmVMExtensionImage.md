...
## DESCRITIVO
O cmdlet **Get-AzureRmVMExtensionImage** obtém todas as versões de uma extensão do Azure.
...
Para obter um tipo de extensão, use o cmdlet Get-AzureRmVMExtensionImageType.
