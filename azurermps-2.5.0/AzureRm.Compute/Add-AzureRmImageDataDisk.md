...
## DESCRITIVO
O cmdlet **Add-AzureRmImageDataDisk** adiciona um disco de dados a um objeto Image.
...
Os próximos três comandos atribuem caminhos de disco do sistema operacional e dois discos de dados para o $osDiskVhdUri, $dataDiskVhdUri 1 e $dataDiskVhdUri 2 variáveis.
...
O comando final cria uma imagem chamada ImageName01 na ResourceGroup01 do grupo de recursos.
