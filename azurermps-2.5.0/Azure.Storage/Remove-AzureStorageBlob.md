...
## DESCRITIVO
O cmdlet **Remove-AzureStorageBlob** remove o blob especificado de uma conta de armazenamento no Azure.
...
Você pode usar o cmdlet Get-AzureStorageContainer para obtê-lo.
