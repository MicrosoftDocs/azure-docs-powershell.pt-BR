...
O cmdlet falhará quando você usar um contexto de armazenamento criado a partir do token SAS porque o cmdlet consultará as permissões de contêiner que exigem permissão de chave da conta de armazenamento.
