...
## DESCRITIVO
O cmdlet **Remove-AzureStorageShare** exclui um compartilhamento de arquivos.

## EXEMPLOS

### Exemplo 1: remover um compartilhamento de arquivos
```
PS C:\>Remove-AzureStorageShare -Name "ContosoShare06"
```

Esse comando Remove o compartilhamento de arquivos chamado ContosoShare06.

### Exemplo 2: remover um compartilhamento de arquivos e todos os seus instantâneos
```
PS C:\>Remove-AzureStorageShare -Name "ContosoShare06" -IncludeAllSnapshot
```

Esse comando Remove o compartilhamento de arquivos chamado ContosoShare06 e todos os seus instantâneos.
...
### -Force
Force a remoção do compartilhamento com todos os seus instantâneos e todo o conteúdo.
...
### -IncludeAllSnapshot
Remover o compartilhamento de arquivos com todos os seus instantâneos
...
Esse cmdlet exclui o compartilhamento de arquivos que esse parâmetro especifica.
...
Esse cmdlet Remove o objeto que esse parâmetro especifica.
