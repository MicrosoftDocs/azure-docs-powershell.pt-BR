...
## DESCRITIVO
O cmdlet **Add-AzureRmVirtualNetworkPeering** cria um emparelhamento entre duas redes virtuais.
...
### String
O parâmetro ' RemoteVirtualNetworkId ' aceita o valor do tipo ' String ' do pipeline
