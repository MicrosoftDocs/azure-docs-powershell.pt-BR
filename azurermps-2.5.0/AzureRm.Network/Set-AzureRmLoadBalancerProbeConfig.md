...
## DESCRITIVO
O cmdlet **set-AzureRmLoadBalancerProbeConfig** define o estado da meta para uma configuração de sondagem.
...
O segundo comando usa o operador pipeline para passar o balanceador de carga em $slb para adicionar-AzureRmLoadBalancerProbeConfig, o que adiciona uma nova configuração de sonda a ele.

O terceiro comando passa o balanceador de carga para **set-AzureRmLoadBalancerProbeConfig** , que define a nova configuração.
