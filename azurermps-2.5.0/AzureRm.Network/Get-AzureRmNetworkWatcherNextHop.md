...
## DESCRITIVO
O cmdlet Get-AzureRmNetworkWatcherNextHop Obtém o próximo salto de uma VM. Próximo nó permite exibir o tipo de recurso do Azure, o endereço IP associado do recurso e a regra da tabela de roteamento que é responsável pela rota.

## EXEMPLOS

### --Exemplo 1: obter o próximo salto ao se comunicar com um IP de Internet--
```
...
Obter o próximo salto para a comunicação de saída da interface de rede principal no Vachine virtual especificado para 204.79.197.200 (www.bing.com)
