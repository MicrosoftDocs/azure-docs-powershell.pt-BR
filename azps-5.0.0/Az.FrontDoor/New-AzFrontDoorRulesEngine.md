...
Use cmdlet "New-AzFrontDoorRulesEngineRule" para construir regras de mecanismo de regras para passar para o parâmetro "-Rules" deste cmdlet.
...
Criar uma nova configuração de mecanismo de regras para a porta frontal especificada.
