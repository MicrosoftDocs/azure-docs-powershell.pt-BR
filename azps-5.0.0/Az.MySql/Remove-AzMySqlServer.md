...
### Exemplo 1: remover o MySql Server por meio da Resource do nome do servidor e do nome do servidor
```powershell
PS C:\> Remove-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Este cmdlet Remove o MySql Server por meio da Resource e do nome do servidor.

### Exemplo 2: remover o servidor MySql por identidade
```powershell
...
Esses cmdlets removem o MySql Server por identidade.
