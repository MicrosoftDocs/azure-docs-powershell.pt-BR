...
### Exemplo 1: atualizar o aplicativo de nuvem Spring por nome.
```powershell
...
Atualize o aplicativo de nuvem da mola por nome.

### Exemplo 2: atualizar o aplicativo de nuvem da mola do pipe.
```powershell
...
Atualize o aplicativo de nuvem da mola do pipe.

## OS

### -ActiveDeploymentName
Nome da implantação ativa do aplicativo
...
### -HttpsOnly
Indique se somente HTTPS é permitido.
...
### -Público
Indica se o aplicativo expõe um ponto de extremidade público
