...
## DESCRITIVO
O cmdlet **Update-AzHpcCache** atualiza um cache do Azure HPC.
...
### -InputObject
O objeto de cache para atualizar.
...
### -ResourceGroupName
Nome do grupo de recursos sob o qual você deseja atualizar o cache.
