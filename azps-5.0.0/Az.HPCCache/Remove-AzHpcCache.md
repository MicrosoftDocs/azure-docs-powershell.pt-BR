...
## DESCRITIVO
O cmdlet **Remove-AzHpcCache** remove um cache do Azure HPC.
...
### -Force
Indica que o cmdlet não solicita confirmação. Por padrão, esse cmdlet solicita que você confirme que deseja remover o cache.
...
### -ResourceGroupName
Nome do grupo de recursos sob o qual você deseja remover o cache.
