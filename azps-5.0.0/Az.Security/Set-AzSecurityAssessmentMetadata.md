...
## DESCRITIVO
Cria ou atualiza metadados de avaliação de segurança, pode ser usado para criar e gerenciar várias propriedades de avaliação.
Depois dessa ação, você poderá relatar resultados de avaliação em qualquer recurso desta assinatura.
...
Criar um novo tipo de avaliação em uma assinatura.
...
### -DisplayName
Título legível pelo homem para este objeto.
...
Cadeia de caracteres detalhada que ajudará os usuários a entender as diferentes maneiras de reduzir ou corrigir o problema de segurança.
...
### -Severidade
Indica a importância do risco de segurança se a avaliação não estiver íntegra.
