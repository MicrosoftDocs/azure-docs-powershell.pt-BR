...
## Sinopse
Obtém uma lista de topologias de segurança em uma assinatura
...
## DESCRITIVO
As topologias de segurança são descobertas automaticamente pela central de segurança do Azure, use esse cmdlet para exibir as topologias de segurança.
...
Exibir todas as topologias de segurança em uma assinatura
...
Obter uma topologia de segurança específica
