...
## DESCRITIVO
O cmdlet New-AzDeviceSecurityGroupTimeWindowRuleObject cria uma nova lista de regras de alerta da janela de tempo para o grupo de segurança de dispositivos na solução de segurança IoT.
...
Criar nova regra de janela de horário do tipo "ActiveConnectionsNotInAllowedRange"
