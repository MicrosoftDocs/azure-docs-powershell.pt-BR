...
## DESCRITIVO
Obtenha um detalhe da avaliação do spcific ou liste todas as avaliações sob controle específico e padrão de conformidade normativa.
...
Obtenha todas as avaliações sob controle específico e padrão.
...
Obtenha uma avaliação específica sob controle específico e padrão de acordo com a ID da avaliação.
...
Obtenha uma avaliação específica sob controle específico e padrão de acordo com a ID do recurso.
