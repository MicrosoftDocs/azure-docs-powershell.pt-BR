...
## DESCRITIVO
O cmdlet Set-AzIotSecuritySolution cria ou atualiza uma solução de segurança IOT específica. A solução de segurança da IoT coleta dados de segurança e eventos de dispositivos IOT e Hub IOT para ajudar a prevenir e a detectar ameaças.
O nome da solução de segurança IOT deve ser idêntico ao nome do Hub IOT.
...
Criar uma nova solução de segurança IOT "MySample" para o Hub IoT com ID de recurso "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MichalResourceGroup/providers/Microsoft.Devices/IotHubs/MySample" (o nome da solução deve ser idêntico ao nome do Hub IoT)
...
Status de log de IP sem máscara.
