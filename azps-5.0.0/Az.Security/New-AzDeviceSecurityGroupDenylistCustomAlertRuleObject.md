...
## DESCRITIVO
O cmdlet New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject cria uma nova lista de regras de alerta personalizadas negadas para o grupo de segurança de dispositivos na solução de segurança IoT.
...
Criar uma nova regra de alerta personalizada da lista de negações com o tipo de Rull "SomeRuleType" e o status definido como desable
