...
## Sinopse
Exclui metadados de avaliação de segurança de uma assinatura.
...
## DESCRITIVO
Exclui metadados de avaliação de segurança de uma assinatura. Esta ação excluirá o tipo de avaliação e todos os resultados de avaliação relevantes da assinatura.
...
Exclui um tipo de avaliação de uma assinatura
