...
## DESCRITIVO
O `Disable-AzSecurityAdvancedThreatProtection` cmdlet desabilita a política de proteção contra ameaças para uma conta de armazenamento/cosmosDB.
...
Esse comando desabilita a política avançada de proteção contra ameaças para a ID do recurso `"/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.Storage/storageAccounts/myStorageAccount/"` .

### Exemplo 2: conta CosmosDB
```powershell
...
Esse comando desabilita a política avançada de proteção contra ameaças para a ID do recurso ` "/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.DocumentDb/databaseAccounts/myCosmosDBAccount/"` .
