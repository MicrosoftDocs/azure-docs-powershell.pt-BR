...
## Sinopse
Obtém uma lista de grupos de servidores/VM de controle do aplicativo para a assinatura.
...
## DESCRITIVO
Os controles de aplicativos adaptáveis são calculados automaticamente pela central de segurança do Azure, use esse cmdlet para obter uma lista de recursos de controles de aplicativos adaptáveis no escopo de uma assinatura.
...
### -Resumo
Retornar a saída em um formato resumido.
