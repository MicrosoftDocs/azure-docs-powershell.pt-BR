...
ms.locfileid: "94125407"
---
# <span data-ttu-id="d2c47-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="d2c47-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="d2c47-102">Sinopse</span><span class="sxs-lookup"><span data-stu-id="d2c47-102">SYNOPSIS</span></span>
<span data-ttu-id="d2c47-103">Obtém alertas de segurança detectados pela central de segurança do Azure</span><span class="sxs-lookup"><span data-stu-id="d2c47-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="d2c47-104">SYNTAX</span><span class="sxs-lookup"><span data-stu-id="d2c47-104">SYNTAX</span></span>

### <span data-ttu-id="d2c47-105">SubscriptionScope (padrão)</span><span class="sxs-lookup"><span data-stu-id="d2c47-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="d2c47-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="d2c47-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="d2c47-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="d2c47-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="d2c47-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="d2c47-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="d2c47-109">Identificação</span><span class="sxs-lookup"><span data-stu-id="d2c47-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="d2c47-110">DESCRITIVO</span><span class="sxs-lookup"><span data-stu-id="d2c47-110">DESCRIPTION</span></span>
<span data-ttu-id="d2c47-111">Obtém alertas de segurança detectados pela central de segurança do Azure</span><span class="sxs-lookup"><span data-stu-id="d2c47-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="d2c47-112">EXEMPLOS</span><span class="sxs-lookup"><span data-stu-id="d2c47-112">EXAMPLES</span></span>

### <span data-ttu-id="d2c47-113">Exemplo 1</span><span class="sxs-lookup"><span data-stu-id="d2c47-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="d2c47-114">Obtém todos os alertas de segurança detectados nos recursos dentro de uma assinatura</span><span class="sxs-lookup"><span data-stu-id="d2c47-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="d2c47-115">Exemplo 2</span><span class="sxs-lookup"><span data-stu-id="d2c47-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="d2c47-116">Obtém todos os alertas de segurança detectados nos recursos dentro do grupo de recursos "myService1"</span><span class="sxs-lookup"><span data-stu-id="d2c47-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="d2c47-117">Exemplo 3</span><span class="sxs-lookup"><span data-stu-id="d2c47-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="d2c47-118">Obtém um alerta de segurança específico detectado em recursos dentro do grupo de recursos "myService1"</span><span class="sxs-lookup"><span data-stu-id="d2c47-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="d2c47-119">OS</span><span class="sxs-lookup"><span data-stu-id="d2c47-119">PARAMETERS</span></span>

### <span data-ttu-id="d2c47-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="d2c47-120">-DefaultProfile</span></span>
<span data-ttu-id="d2c47-121">As credenciais, a conta, o locatário e a assinatura usados para comunicação com o Azure.</span><span class="sxs-lookup"><span data-stu-id="d2c47-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="d2c47-122">-Local</span><span class="sxs-lookup"><span data-stu-id="d2c47-122">-Location</span></span>
<span data-ttu-id="d2c47-123">Ponto.</span><span class="sxs-lookup"><span data-stu-id="d2c47-123">Location.</span></span>
...
### <span data-ttu-id="d2c47-124">-Nome</span><span class="sxs-lookup"><span data-stu-id="d2c47-124">-Name</span></span>
<span data-ttu-id="d2c47-125">Nome do recurso.</span><span class="sxs-lookup"><span data-stu-id="d2c47-125">Resource name.</span></span>
...
### <span data-ttu-id="d2c47-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="d2c47-126">-ResourceGroupName</span></span>
<span data-ttu-id="d2c47-127">Nome do grupo de recursos.</span><span class="sxs-lookup"><span data-stu-id="d2c47-127">Resource group name.</span></span>
...
### <span data-ttu-id="d2c47-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="d2c47-128">-ResourceId</span></span>
<span data-ttu-id="d2c47-129">ID do recurso.</span><span class="sxs-lookup"><span data-stu-id="d2c47-129">Resource ID.</span></span>
...
### <span data-ttu-id="d2c47-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="d2c47-130">CommonParameters</span></span>
<span data-ttu-id="d2c47-131">Esse cmdlet dá suporte a parâmetros comuns:-debug,-ErrorAction,-ErrorVariable,-Informationaction,-InformationVariable,-OutVariable,-OutBuffer,-PipelineVariable,-Verbose-WarningAction e-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="d2c47-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="d2c47-132">Para obter mais informações, consulte [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="d2c47-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="d2c47-133">SENSORES</span><span class="sxs-lookup"><span data-stu-id="d2c47-133">INPUTS</span></span>

### <span data-ttu-id="d2c47-134">System. String</span><span class="sxs-lookup"><span data-stu-id="d2c47-134">System.String</span></span>

## <span data-ttu-id="d2c47-135">EXIBE</span><span class="sxs-lookup"><span data-stu-id="d2c47-135">OUTPUTS</span></span>

### <span data-ttu-id="d2c47-136">Microsoft. Azure. Commands. Security. Models. Alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="d2c47-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="d2c47-137">INFORMA</span><span class="sxs-lookup"><span data-stu-id="d2c47-137">NOTES</span></span>

## <span data-ttu-id="d2c47-138">LINKS RELACIONADOS</span><span class="sxs-lookup"><span data-stu-id="d2c47-138">RELATED LINKS</span></span>
