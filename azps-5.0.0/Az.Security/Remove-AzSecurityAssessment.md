...
## DESCRITIVO
Exclui um resultado de avaliação de segurança de uma assinatura, geralmente usado quando um resoruce é excluído ou quando a avaliação não é relevante para um recurso específico mais
