...
## DESCRITIVO
O cmdlet **Remove-AzVM** remove uma máquina virtual do Azure.
...
Esse comando Remove a máquina virtual nomeada VirtualMachine07 na ResourceGroup11 do grupo de recursos.
