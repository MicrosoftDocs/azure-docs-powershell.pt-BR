...
Esse comando suspende o serviço de reparos automáticos no VMSS "vmss1" no grupo de recursos "RG".
...
Este comando retoma o serviço de reparos automáticos no VMSS "vmss1" no grupo de recursos "RG".

## OS

### -Ação
A ação a ser executada.  Os valores possíveis são: retomar, suspender.
...
### -InputObject
O objeto local do conjunto de escala da máquina virtual.
