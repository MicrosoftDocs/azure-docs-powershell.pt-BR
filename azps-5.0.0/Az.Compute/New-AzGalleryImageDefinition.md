...
### -Descrição
A descrição do recurso de definição de imagem de galeria. 
...
### -EndOfLifeDate
A data de fim da vida útil da definição de imagem da Galeria
...
### -EULA
O contrato de EULA para a definição de imagem da galeria.
...
### -Publisher
O nome do fornecedor da definição de imagem da galeria.
...
### -PurchasePlanProduct
A ID do produto do plano de compra.
...
A ID de fornecedor para o plano de compra.
...
### -SKU
O nome da SKU da definição da imagem da galeria.
