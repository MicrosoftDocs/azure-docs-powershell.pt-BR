...
## DESCRITIVO
O cmdlet **New-AzImageConfig** cria um objeto de imagem configurável.
...
O primeiro comando cria um objeto Image e, em seguida, armazena-o na variável $imageConfig.
Os próximos três comandos atribuem caminhos de disco do sistema operacional e dois discos de dados para o $osDiskVhdUri, $dataDiskVhdUri 1 e $dataDiskVhdUri 2 variáveis. Essa abordagem só tem a legibilidade dos comandos a seguir.
Os próximos três comandos adicionam um disco do sistema operacional e dois discos de dados à imagem armazenada em $imageConfig.
...
### -HyperVGeneration
Especifica o tipo de HyperVGeneration para a máquina virtual criada a partir da imagem.  Os valores permitidos são v1 e v2.
...
### -OsDisk
Especifica o disco do sistema operacional.
...
Especifica a ID da máquina virtual de origem.
