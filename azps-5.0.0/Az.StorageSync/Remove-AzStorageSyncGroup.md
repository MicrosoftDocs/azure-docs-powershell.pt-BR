...
## DESCRITIVO
Esse comando excluirá o grupo de sincronização especificado. Um grupo de sincronização só poderá ser removido quando todos os pontos de extremidade contidos forem excluídos primeiro.
...
Esse comando irá remover o grupo de sincronização.
...
### -InputObject
Objeto de entrada do objeto de sincronização
...
### -ResourceId
ID do recurso do pool de sincronização
