...
## Sinopse
Este comando define o serviço de sincronização de armazenamento em um grupo de recursos.
...
Esse comando irá definir um serviço de sincronização de armazenamento.
