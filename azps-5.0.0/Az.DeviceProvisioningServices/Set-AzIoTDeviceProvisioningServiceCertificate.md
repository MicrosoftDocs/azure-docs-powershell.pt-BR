...
## DESCRITIVO
Verifique um certificado carregando um certificado de verificação contendo o código de verificação obtido ao chamar o código de verificação de geração. Esta é a última etapa no processo de prova de posse.
...
Verifique a propriedade da chave privada "myCertificate" usando o pipeline.
