...
Atualize o Hub IoT vinculado "myiothub.azure-devices.net" em um serviço de provisionamento de dispositivo Hub IoT do Azure.
...
Aplicar a política de alocação ao Hub IoT
