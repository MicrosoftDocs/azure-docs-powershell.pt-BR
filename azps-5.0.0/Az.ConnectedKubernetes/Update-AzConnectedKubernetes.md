...
### Exemplo 1: atualizar uma kubernetes conectada
```powershell
...
Esse comando atualiza um kubernetes conectado.

### Exemplo 2: atualizar uma kubernetes conectada por objeto
```powershell
...
Esse comando atualiza um kubernetes conectado por objeto.
