...
## DESCRITIVO
O cmdlet **Remove-AzStackEdgeStorageContainer** remove um contêiner de armazenamento associado para a conta de armazenamento de borda em um dispositivo de borda de pilha. Você pode especificar o nome do contêiner de armazenamento a ser removido como um parâmetro.
