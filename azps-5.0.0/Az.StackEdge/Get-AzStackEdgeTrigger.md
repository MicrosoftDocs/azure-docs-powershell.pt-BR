...
## DESCRITIVO
O cmdlet **Get-AzStackEdgeTriger** Obtém os gatilhos de um dispositivo. Você pode especificar o nome como um parâmetro no cmdlet para buscar os detalhes de um gatilho específico específico
