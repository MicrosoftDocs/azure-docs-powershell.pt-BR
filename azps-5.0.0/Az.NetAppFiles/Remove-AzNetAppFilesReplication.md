...
Esse comando Remove a conexão de replicação do ANF no volume "MyDestinationAnfVolume".
...
### -InputObject
O volume de destino do ANF com a replicação a ser removida
...
### -PassThru
Retorna se a replicação de ANF especificada foi removida com êxito
