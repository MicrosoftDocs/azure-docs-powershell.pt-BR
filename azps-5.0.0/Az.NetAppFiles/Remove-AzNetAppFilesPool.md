...
## DESCRITIVO
O cmdlet **Remove-AzNetAppFilesPool** exclui um pool ANF.
...
Esse comando exclui o pool de ANF "MyAnfPool".
...
### -Accountobject
O objeto de conta que contém o pool a ser removido
...
### -InputObject
O objeto de pool a ser removido
...
### -PassThru
Retorna se o pool especificado foi removido com êxito
...
### -ResourceGroupName
O grupo de recursos do pool ANF
