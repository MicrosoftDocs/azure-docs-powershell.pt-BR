...
### Exemplo 1: regenerar chaves de API para um nó de transação usando name.
```powershell
...
Esse comando gera chaves de API para um nó de transação usando o nome, o grupo de recursos.
...
Esse comando gera chaves de API para um nó de transação usando idenity.
