...
## DESCRITIVO
Criar novo recurso de tipo de nó para um cluster específico.
...
Crie o tipo de nó principal com 3 nós.
...
Crie o tipo de nó principal com 5 nós e especifique propriedades de posicionamento, capacidades, aplicativos e portas efêmeras.
...
### -Capacidade
As marcas de capacidade são aplicadas aos nós no tipo de nó como pares chave/valor, o Gerenciador de recursos de cluster usa essas marcas para entender a quantidade de recursos que um nó tem.
...
### -PlacementProperty
Marcas de posicionamento aplicadas a nós no tipo de nó como pares chave/valor, que podem ser usados para indicar onde determinados serviços (carga de trabalho) devem ser executados.
Atualizar, isso substituirá os valores atuais.
...
### -Principal
Especifique se o tipo de nó é primário.
Nesse tipo de nó, executará serviços do sistema.
Somente um tipo de nó deve ser marcado como principal.
O tipo de nó primário não pode ser excluído ou alterado para clusters existentes.
...
### -VmImagePublisher
O fornecedor da imagem do Marketplace de máquinas virtuais do Azure.
...
Todas as máquinas virtuais em um pool são do mesmo tamanho.
Padrão: Standard_D2.
