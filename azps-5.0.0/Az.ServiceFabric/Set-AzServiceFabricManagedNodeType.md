...
## DESCRITIVO
Define as propriedades de recurso do tipo de nó ou executar ações de reimagem em NDES específicas do tipo de nó com o parâmetro-reimage. Na operação reimgae, os nós do Service Fabric serão desabilitados antes de fazer a nova geração de imagens das VMs e habilitá-las novamente depois que elas forem retornadas. Se isso for feito nos tipos de nós primários, pode demorar um pouco, pois ele pode não renovar todos os nós ao mesmo tempo. Use-ForceReimage force a operação mesmo que o Service Fabric não consiga desabilitar os nós, mas use com cuidado, pois isso pode causar perda de dados se cargas de trabalho com estado estiverem em execução no nó.
...
Atualize o properites de posicionamento do tipo de nó. Isso substituirá o posicionamento mais antigo properites, se houver.
...
Reimagem do nó 0 e 3 no tipo de nó.
...
### -Capacidade
As marcas de capacidade são aplicadas aos nós no tipo de nó como pares chave/valor, o Gerenciador de recursos de cluster usa essas marcas para entender a quantidade de recursos que um nó tem. Atualizar, isso substituirá os valores atuais.
...
### -ForceReimage
Usar esse sinalizador forçará a remoção mesmo que o Service Fabric não consiga desabilitar os nós.
Use com cuidado, pois isso pode causar perda de dados se cargas de trabalho com estado estiverem em execução no nó.
...
### -PlacementProperty
Marcas de posicionamento aplicadas a nós no tipo de nó como pares chave/valor, que podem ser usados para indicar onde determinados serviços (carga de trabalho) devem ser executados. Atualizar, isso substituirá os valores atuais.
...
### -Nova imagem
Especifique para refazer a imagem dos nós no tipo de nó.
