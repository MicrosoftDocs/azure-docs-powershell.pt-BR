...
## DESCRITIVO
Remova a extensão de VM do tipo de nó por nome. Use [Get-AzServiceFabricManagedNodeType](./Get-AzServiceFabricManagedNodeType.md) e examine a propriedade VmExtensions para ver a extensão atual no tipo de nó.
...
Remova a extensão do tipo de nó por nome.
...
Remova a extensão do tipo de nó por nome, com tubulação.
