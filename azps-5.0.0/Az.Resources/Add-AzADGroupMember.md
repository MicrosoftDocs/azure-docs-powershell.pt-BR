...
Adiciona o usuário com a ID de objeto ' D9076BBC-D62C-4105-9C78-A7F5BC4A3405 ' ao grupo com a ID de objeto ' 85F89C90-780E-4AA6-9F4F-6F268D322EEE '.

### Exemplo 2: adicionar um usuário a um grupo por tubulação

```powershell
PS C:\> Get-AzADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE | Add-AzADGroupMember -MemberObjectId D9076BBC-D62C-4105-9C78-A7F5BC4A3405
```

Obtém o grupo com a ID de objeto ' 85F89C90-780E-4AA6-9F4F-6F268D322EEE ' e a canaliza para o cmdlet Add-AzADGroupMember para adicionar o usuário ao grupo.

### Exemplo 3: adicionar um usuário a um grupo por nome principal
...
O UPN do (s) membro (s) para adicionar ao grupo.
...
O nome de exibição do grupo ao qual adicionar o (s) membro (s).
...
### -TargetGroupObject
A representação de objeto do grupo para o qual adicionar o (s) membro (s).
...
### -TargetGroupObjectId
A ID de objeto do grupo ao qual adicionar o (s) membro (s).
