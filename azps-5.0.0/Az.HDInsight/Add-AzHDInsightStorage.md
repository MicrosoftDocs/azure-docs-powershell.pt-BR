...
## DESCRITIVO
O cmdlet **Add-AzHDInsightStorage** adiciona uma entrada de conta de armazenamento do Azure ao objeto de configuração do Azure HDInsight criado pelo cmdlet New-AzHDInsightClusterConfig.
