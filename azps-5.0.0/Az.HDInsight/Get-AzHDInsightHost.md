...
## DESCRITIVO
O cmdlet **Get-AzHDInsightHost** lista os hosts do cluster HDInsight.
...
Este comando lista os hosts do cluster com nome do cluster.
...
Este comando lista os hosts do cluster com pipeline.
