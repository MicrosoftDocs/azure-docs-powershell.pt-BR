...
## Sinopse
Habilita a recomendação (s) do Azure Advisor.
...
## DESCRITIVO
Este cmdlet habilita uma recomendação que você já eliminou. Você também pode remover todas as supressãos associadas a uma recomendação.
...
Remove todas as supressões para a recomendação fornecida com o nome "recommendation_id".
...
Remove todas as supressões para a (s) recomendação (s) determinada (s) passada (s) da pipeline.
