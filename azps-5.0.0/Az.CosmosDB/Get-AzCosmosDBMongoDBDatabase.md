...
## Sinopse
Obtém o banco de dados do CosmosDB MongoDB
...
## DESCRITIVO
O cmdlet **Get-AzCosmosDBMongoDBDatabase** Obtém o banco de dados do MongoDB do CosmosDB.
...
Objeto de recurso contém propriedades _rid, _ts, _etag.
