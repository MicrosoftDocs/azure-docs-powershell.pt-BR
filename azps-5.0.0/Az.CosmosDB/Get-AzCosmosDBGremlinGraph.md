...
## Sinopse
Obtém o gráfico CosmosDB Gremlin.
...
## DESCRITIVO
O cmdlet **Get-AzCosmosDBGremlinGraph** Obtém as propriedades do gráfico CosmosDB Gremlin.
...
Objeto de recurso contém IndexingPolicy, PartitionKey, DefaultTtl, UniqueKeyPolicy, ConflictResolutionPolicy, _rid, _ts, _etag.
