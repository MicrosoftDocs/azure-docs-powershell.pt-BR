...
## Sinopse
Obtém o valor de produtividade do espaço de Cassandra.
...
## DESCRITIVO
O cmdlet **Get-AzCosmosDBCassandraKeyspaceThroughput** Obtém o objeto de taxa de transferência correspondente a um espaço de espaço disponível.
