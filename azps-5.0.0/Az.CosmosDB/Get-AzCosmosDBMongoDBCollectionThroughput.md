...
## Sinopse
Obtém as propriedades de produtividade CosmosDB da coleção do MongoDB.
...
## DESCRITIVO
O cmdlet **Get-AzCosmosDBMongoDBCollectionThroughput** Obtém as propriedades de produtividade da coleção do MongoDB.
...
### -InputObject
Se fornecido, o cmdlet retornará a coleção com o valor de produtividade correspondente.
