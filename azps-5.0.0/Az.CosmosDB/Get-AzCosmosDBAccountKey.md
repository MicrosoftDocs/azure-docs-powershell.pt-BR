...
## DESCRITIVO
Obter a lista de chaves de conexão.
...
Lista as chaves para a conta do CosmosDB. O tipo de chave pode ser um valor de: ConnectionStrings, Keys e ReadOnlyKeys. Padrão é Keys.
