...
## DESCRITIVO
O cmdlet Update-AzContainerRegistryCredential regenera uma credencial de logon para um registro de contêiner.

## EXEMPLOS

### Exemplo 1: regenerar uma credencial de logon para um registro de contêiner
```powershell
...
Esse comando regenera uma credencial de logon para o registro de contêiner especificado.
O usuário administrador precisa estar habilitado para o meu \` registro do contêiner \` para gerar novamente as credenciais de logon.
...
### -Passwordname
O nome da senha para gerar novamente.
Valores permitidos: password, password2.
