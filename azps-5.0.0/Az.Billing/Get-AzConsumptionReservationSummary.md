...
## DESCRITIVO
O cmdlet **Get-AzConsumptionReservationSummary** tem resumos de reserva para grãos diários ou mensais.

## EXEMPLOS

### Exemplo 1: obter resumos de reserva com ID de ordem de reserva para detalhamento mensal
```powershell
...
### Exemplo 2: obter resumos de reserva com ID de ordem de reserva e ID de reserva para detalhamento mensal
```powershell
...
### Exemplo 3: obter resumos de reserva com a ID do pedido de reserva para o intervalo de datas fornecido do detalhamento diário
```powershell
...
### Exemplo 4: obter resumos de reserva com ID de ordem de reserva e ID de reserva para intervalo de datas fornecido em detalhamento diário
```powershell
...
### -EndDate
Os dados finais (AAAA-MM-DD em UTC) do Resumo de reserva, necessários somente para o detalhamento diário.
...
### -Granular
O intervalo de tempo do resumo da reserva pode ser diária ou mensalmente.
...
### -StartDate
Os dados de início (AAAA-MM-DD em UTC) do Resumo de reserva são necessários somente para o detalhamento diário.
...
### Microsoft. Azure. Commands. consumo. Models. PSReservationSummary
