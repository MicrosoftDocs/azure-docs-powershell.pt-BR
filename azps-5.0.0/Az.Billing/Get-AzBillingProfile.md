...
## DESCRITIVO
O cmdlet **Get-AzBillingProfile** Obtém perfis de cobrança na conta de cobrança especificada. 
...
Obter todos os perfis de cobrança na conta de cobrança especificada.
...
Obter o perfil de cobrança com o nome especificado.
...
Obter todos os perfis de cobrança na conta de cobrança especificada e incluir as seções de fatura no resultado.
...
Obter o perfil de cobrança com o nome especificado e incluir as seções de fatura no resultado.
...
Inclua as seções faturas em perfil de cobrança.
...
### -Nome
Nome de um perfil de cobrança específico.
