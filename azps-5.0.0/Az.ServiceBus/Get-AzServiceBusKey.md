...
## DESCRITIVO
O cmdlet **Get-AzServiceBusKey** retorna as cadeias de conexão primária e secundária para o namespace ou fila ou tópico ou alias (configurações de GeoDR) fornecido.
...
Cadeia de conexão primária e secundária para a fila especificada.
...
Cadeia de conexão primária e secundária para o tópico especificado.
...
Cadeia de conexão primária e secundária para o namespace e o alias especificados.
