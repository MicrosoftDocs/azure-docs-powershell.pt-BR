...
## DESCRITIVO
O cmdlet **Start-AzServiceBusMigration** cria uma nova configuração de migração e inicia a migração de entidades dos namespaces padrão para Premium
...
Cria uma nova configuração de migração para os namespaces "TestingNamespaceStandardMigration" para "TestingNamespacePremiumMigration"
...
### -Pré-migraçãoname
Pós-nome de migração para namespace padrão em migração
