...
## DESCRITIVO
O **Get-AzServiceBusMigration** recupera a configuração de migração para o namespace
...
Obtém as propriedades de configuração de migração de ' TestingNamespaceStandardMigration '
