...
### -MappingName
Nome do mapeamento do contêiner de proteção.
...
Entrada específica do provedor para emparelhamento.
Para construir, consulte a seção notas para propriedades PROVIDERSPECIFICINPUT e crie uma tabela de hash.
...
O nome exclusivo do contêiner de proteção de destino.
...
PROVIDERSPECIFICINPUT <IReplicationProviderSpecificContainerMappingInput> : entrada específica do provedor para emparelhamento.
  - `[InstanceType <String>]`: O tipo de classe.
