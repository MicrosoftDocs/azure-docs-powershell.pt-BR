...
### Exemplo 2: listar tudo no Project por ID.
```powershell
...
### Exemplo 2: listar tudo no Project por nome.
```powershell
...
### -DiscoveredMachineId
Especifica a ID da máquina do servidor descoberto.
...
### -ProjectName
Especifica o projeto de migração do Azure na assinatura atual.
