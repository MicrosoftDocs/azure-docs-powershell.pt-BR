...
### Exemplo 1: criar back-end 123 com um esquema de autorização básico
```powershell
...
### -Protocolo
Protocolo de comunicação back-end.
Esse parâmetro é obrigatório.
Os valores válidos são ' http ' e ' SOAP '.
