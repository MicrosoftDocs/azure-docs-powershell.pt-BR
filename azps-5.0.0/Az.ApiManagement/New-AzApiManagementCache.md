...
## DESCRITIVO
O cmdlet **New-AzApiManagementCache** cria uma nova entidade de cache no serviço de gerenciamento de API.

## EXEMPLOS

### Exemplo 1: criar uma nova entidade de cache
```powershell
...
Os cmdlets criam uma nova entidade de cache no local mestre do serviço de gerenciamento de API.

## OS

### -AzureRedisResourceId
Resourcebinding da instância de cache do Azure Redis. Este parâmetro é opcional.
