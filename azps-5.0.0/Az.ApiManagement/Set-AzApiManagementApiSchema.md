...
### -ResourceId
Resourcebinding do esquema de diagnóstico ou API. Esse parâmetro é obrigatório.
...
ContentType do esquema de API. Este parâmetro é opcional.
