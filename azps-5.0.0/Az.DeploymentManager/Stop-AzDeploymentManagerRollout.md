...
## DESCRITIVO
O cmdlet **Stop-AzDeploymentManagerRollout** interrompe uma distribuição em andamento e retorna um objeto que representa o estado atual da distribuição.
