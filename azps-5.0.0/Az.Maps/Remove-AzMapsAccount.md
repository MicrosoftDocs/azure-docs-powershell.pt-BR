...
## Sinopse
Exclui uma conta do Azure Maps.
...
## DESCRITIVO
O cmdlet Remove-AzMapsAccount exclui a conta do Azure Maps especificada.
...
Exclui a conta myaccount do grupo de recursos grupo de recursos.
...
Exclui a conta do Azure Maps especificada.
...
### -PassThru
Retorne se a conta especificada foi excluída ou não com êxito.
