...
## DESCRITIVO
O cmdlet **New-AzCdnDeliveryPolicy** cria uma política de entrega para criação de ponto de extremidade CDN.
...
Criar uma política de entrega de exemplo
