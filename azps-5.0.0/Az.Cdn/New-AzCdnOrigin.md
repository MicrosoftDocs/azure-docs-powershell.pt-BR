...
## DESCRITIVO
O New-AzCdnOrigin criará uma nova origem CDN no ponto de extremidade especificado.
...
Esse cmdlet criará uma nova origem CDN para o ponto de extremidade especificado. Ele usará o nome do host fornecido como origem. 

## OS

### -CdnOrigin
O objeto de origem CDN.
...
### -HostName
Nome do host da origem da CDN do Azure.
...
### -HttpPort
Porta http da origem CDN do Azure.
...
### -HttpsPort
Porta https da origem da CDN do Azure.
...
### -OriginHostHeader
Cabeçalho do host de origem da CDN do Azure.
...
### -Originname
Nome da origem da CDN do Azure.
