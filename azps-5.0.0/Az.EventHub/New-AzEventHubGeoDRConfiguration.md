...
## DESCRITIVO
O cmdlet **New-AzEventHubGeoDRConfiguration** cria um novo alias (configuração de recuperação de desastres)
...
Cria um alias "SampleDRConfigName" com o namespace principal "SampleNamespace_Primary" com o namespace secundário "SampleNamespace_Secondary"

## OS

### -Alternatename
Alternatename necessário quando o nome de configuração de DR é igual ao principal namespace
...
### -PartnerNamespace
RECUPERAÇÃO de configuração PartnerNamespace
