...
## Sinopse
Cria um novo cluster exclusivo do eventhub
...
## DESCRITIVO
O cmdlet New-AzEventHubCluster cria o cluster do eventhub dedicado no grupo de recursos específico
...
Cria o cluster dedicado "Eventhub-cluster-5557" no grupo de Cluster27651 "RSG-" com o local southcentralus e a capacidade como 1

## OS

### -Capacidade
Capacidade do cluster (RECOR), curerntrly, valor permitido = 1
...
### -Marca
Hashtables que representam marcas de recursos para clusters
