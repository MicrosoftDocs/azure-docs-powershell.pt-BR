...
### Exemplo 1: obter o trabalho do ImportExport com contexto padrão
```powershell
...
Esse cmdlet obtém um trabalho ImportExport com contexto padrão.

### Exemplo 2: obter ImportExport trabalho por grupo de recursos e nome do trabalho
```powershell
...
Esse cmdlet obtém um trabalho do ImportExport por grupo de recursos e nome do trabalho.

### Exemplo 3: lista todos os trabalhos do ImportExport no grupo de recursos especificado
```powershell
...
Esse cmdlet lista todos os trabalhos do ImportExport no grupo de recursos especificado.

### Exemplo 4: obter ImportExport de trabalho por identidade
```powershell
...
Esta lista de cmdlets Obtém o trabalho do ImportExport por identidade.
...
### -Início
Um valor inteiro que especifica o número de trabalhos no máximo deve ser retornado.
