...
## DESCRITIVO
O cmdlet **Get-AzDataShareSynchronization** fornece informações sobre todas as configurações de sincronização presentes em um compartilhamento em uma conta de compartilhamento de dados.
...
Esses comandos fornecem informações sobre todas as configurações de sincronização presentes no share AdsShare no WikiAds de conta de compartilhamento de dados.
