...
## DESCRITIVO
O cmdlet **Remove-AzDataShareDataSetMapping** remove mapeamentos de DataSet.
...
Esses comandos removem o DataSet chamado DSM de sharesubscription WikiAds. 
...
### -InputObject
O objeto de mapeamento do Azure Data Set
