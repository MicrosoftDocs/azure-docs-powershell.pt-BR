...
### Exemplo 1 criar um novo recurso do Application insights
```
...
Adicionar um novo recurso do Application insights chamado "Test" no grupo de recursos "grupo de teste" com o tipo "Java"
...
### -Local
Localização de recursos do Application insights.
...
O tipo de acesso à rede para acessar a inclusão de insights do aplicativo. O valor deve ser ' Enabled ' ou ' disabled '
...
O tipo de acesso à rede para acessar a consulta do Application insights. O valor deve ser ' Enabled ' ou ' disabled '
