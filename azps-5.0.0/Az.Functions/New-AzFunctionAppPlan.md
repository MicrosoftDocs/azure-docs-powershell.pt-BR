...
### Exemplo 1: criar um plano de aplicativo do Windows Premium na Europa Ocidental com capacidade de intermitência out de até 10 instâncias.
```powershell
...
Esse comando cria um plano de aplicativo do Windows Premium na Europa Ocidental com capacidade de intermitência de saída de até 10 instâncias.
...
### -Workertype
O tipo de trabalhador para o plano.
As entradas válidas são: Windows ou Linux.
