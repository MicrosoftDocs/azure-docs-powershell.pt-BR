...
### Exemplo 1: obter um aplicativo de função por nome e interrompê-lo.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Stop-AzFunctionApp -Force
```

Esse comando obtém um aplicativo function por nome e o interrompe.

### Exemplo 2: Pare um aplicativo function por nome.
```powershell
PS C:\> Stop-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName -Force
```

Esse comando interrompe um aplicativo function por nome.
