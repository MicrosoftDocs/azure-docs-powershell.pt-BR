...
### Exemplo 1: remover as configurações do aplicativo em um aplicativo de função.
```powershell
...
### -AppSettingname
Lista de configurações de aplicativo da função a serem removidas do aplicativo da função.
