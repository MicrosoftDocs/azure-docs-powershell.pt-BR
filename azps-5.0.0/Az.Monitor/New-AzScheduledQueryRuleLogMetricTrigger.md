...
A entrada não é validada. Ele será validado primeiro quando New-AzScheduledQueryRule for eventualmente chamado.
...
### -Threshold
O valor de limite métrico: consecutivo, total.
A entrada não é validada. Ele será validado primeiro quando New-AzScheduledQueryRule for eventualmente chamado.
...
### -ThresholdOperator
O limite de métrica Operator: GreaterThan, LessThan, Equals.
A entrada não é validada. Ele será validado primeiro quando New-AzScheduledQueryRule for eventualmente chamado.
