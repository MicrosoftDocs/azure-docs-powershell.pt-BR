...
Remove o tópico de domínio da grade de eventos \` tópico1 \` em Domain \` domain1 \` no grupo de MyResourceGroupName do grupo de recursos \` \` .
...
### -ResourceId
Identificador de recurso que representa o tópico do domínio da grade de eventos.
