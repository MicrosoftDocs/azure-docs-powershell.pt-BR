...
## DESCRITIVO
O cmdlet **New-AzSqlDatabaseCopy** cria uma cópia de um banco de dados SQL do Azure que usa o instantâneo dos dados no momento atual. Use esse cmdlet em vez do cmdlet Start-AzSqlDatabaseCopy para criar uma cópia do banco de dados única. Esse cmdlet retorna o objeto **Database** da cópia.
Observação: Use o cmdlet New-AzSqlDatabaseSecondary para configurar a replicação geográfica para um banco de dados.
...
Cria uma cópia de um banco de dados SQL que usa o instantâneo no momento atual. (gerado automaticamente)
...
### -ComputeGeneration
A geração de computação a ser atribuída à nova cópia.
...
### -CopyDatabaseName
Especifica o nome da cópia do banco de dados SQL.
...
Especifica o nome do grupo de recursos do Azure no qual atribuir a cópia.
...
### -CopyServerName
Especifica o nome do SQL Server que hospeda a cópia.
...
### -DatabaseName
Especifica o nome do banco de dados SQL a ser copiado.
...
### -ElasticPoolName
Especifica o nome do pool elástico no qual atribuir a cópia.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém o banco de dados a ser copiado.
...
### -Nomedoservidor
Especifica o nome do SQL Server que contém o banco de dados a ser copiado.
...
### -Imobjecname
Especifica o nome do objetivo de serviço a ser atribuído à cópia.
...
### -Marcas
Especifica os pares de valor chave na forma de uma tabela de hash para associar a cópia do banco de dados SQL do Azure. Por exemplo: @ {Key0 = "value0"; key1 = $null; Key2 = "value2"}
...
### -VCore
Os números Vcores da cópia do banco de dados SQL do Azure.
