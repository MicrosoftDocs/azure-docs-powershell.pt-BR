...
## DESCRITIVO
O cmdlet Remove-AzSqlElasticJobCredential remove uma credencial de trabalho
...
Remove uma credencial de trabalho
...
### -InputObject
O objeto de credencial do trabalho
...
### -ResourceId
A ID do recurso de credenciais do trabalho
