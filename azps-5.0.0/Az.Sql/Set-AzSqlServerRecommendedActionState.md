...
## DESCRITIVO
O cmdlet **set-AzSqlServerRecommendedActionState** atualiza o estado de uma ação recomendada do Azure SQL Server.
Esse cmdlet aplica, reverte ou descarta a ação recomendada com base no novo estado.

## EXEMPLOS

### Example1: atualiza o estado da ação recomendada especificada para pendente
```
...
Atualiza o estado da ação recomendada do servidor chamada "IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893" para "pendente"

## OS

### -Supervisorname
Especifica o nome do supervisor que contém a ação recomendada.
...
### -Estado
Especifica o novo valor para o qual esse cmdlet atualiza o estado de ação recomendado.
...
### Microsoft. Azure. Commands. Sql. Recomendadoaction. cmdlet. RecommendedActionState
