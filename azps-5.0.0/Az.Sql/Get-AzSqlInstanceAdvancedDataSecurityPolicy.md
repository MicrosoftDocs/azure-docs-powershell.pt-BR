...
## DESCRITIVO
O cmdlet **Get-AzSqlInstanceAdvancedDataSecurityPolicy** recupera a política de segurança de dados avançada de uma instância gerenciada.

## EXEMPLOS

### Exemplo 1: Obtém a instância gerenciada segurança avançada de dados
```powershell
...
### Exemplo 2: Obtém a instância gerenciada segurança avançada de dados do recurso instância gerenciada
```powershell
