...
## DESCRITIVO
O cmdlet Stop-AzSqlElasticJob interrompe um trabalho com uma execução em execução.
Retorna o status atual da execução do trabalho

## EXEMPLOS

### Exemplo 1: interrompe um trabalho com uma execução de trabalho em execução
```powershell
...
Interrompe uma execução de trabalho em execução e retorna o status atual
...
### -ParentObject
O objeto de banco de dados controle de agente
