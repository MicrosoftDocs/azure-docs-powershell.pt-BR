...
## DESCRITIVO
O cmdlet **Get-AzSqlDatabase** Obtém um ou mais bancos de dados SQL do Azure de um servidor de banco de dados SQL do Azure.
...
### Exemplo 3: obter todos os bancos de dados em um servidor usando a filtragem
```
...
Esse comando obtém todos os bancos de dados no servidor chamado Server01 que começam com "banco de dados".
