...
## DESCRITIVO
O cmdlet **Remove-AzSqlSyncMember** remove um membro de sincronização do banco de dados SQL do Azure.

## EXEMPLOS

### Exemplo 1: remover um membro de sincronização
```
...
Esse comando Remove o membro de sincronização do banco de dados SQL do Azure chamado syncMember01.
...
### -PassThru
Define se retornar o membro de sincronização removido
