...
### InstancePoolUsageDefaultParameterSet (padrão)
```
...
## DESCRITIVO
O cmdlet **Get-AzSqlInstancePoolUsage** retorna informações sobre o uso de um pool de instâncias do SQL do Azure.

## EXEMPLOS

### Exemplo 1: Obtém o uso de um pool de instâncias do SQL do Azure
```powershell
...
Obtém o uso do pool de instâncias do SQL do Azure instancepool0.

### Exemplo 2: Obtém o uso de um pool de instâncias do SQL do Azure usando um objeto de pool de instâncias
```powershell
...
Obtém o uso do pool de instâncias do SQL do Azure instancepool0 usando um objeto de pool de instâncias.

### Exemplo 3: Obtém o uso de um pool de instâncias do SQL do Azure usando uma ID de recurso do pool de instâncias
```powershell
...
Obtém o uso do pool de instâncias do SQL do Azure instancepool0 usando um identificador de recurso do pool de instâncias.

### Exemplo 3: Obtém o uso de um pool de instâncias do SQL do Azure com um detalhamento dos usos da instância gerenciada dentro do pool.
```powershell
...
Obtém o uso do pool de instâncias do SQL do Azure instancepool0 juntamente com os usos das instâncias gerenciadas no instancepool0.
...
### -ExpandChildren
Sinalizador que indica se o uso do pool de instâncias deve ser expandido com o uso de seus filhos.
...
### -InstancePool
O objeto de pool de instâncias pai.
...
### -Nome
O nome do pool de instâncias gerenciadas.
