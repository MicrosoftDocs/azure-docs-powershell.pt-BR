...
## DESCRITIVO
O cmdlet **Get-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy** Obtém a política de retenção de longo prazo registrada nesse banco de dados gerenciado.
...
Obtém a versão atual da política de retenção de longo prazo para o banco de dados
