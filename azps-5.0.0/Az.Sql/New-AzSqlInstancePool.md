...
## DESCRITIVO
O cmdlet **New-AzSqlInstancePool** cria um pool de instâncias do SQL do Azure.
...
Esse comando cria um novo pool de instâncias do SQL do Azure.
...
### -ComputeGeneration
A geração de computação do pool de instâncias.
...
### -Edição
A edição do pool de instâncias.
...
### -Local
O local para criar o pool de instâncias.
...
### -Subnetid
A ID de sub-rede a ser usada para criação de pool de instâncias.
