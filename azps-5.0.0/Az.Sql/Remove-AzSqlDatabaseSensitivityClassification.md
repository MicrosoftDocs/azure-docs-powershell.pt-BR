...
## DESCRITIVO
O cmdlet Remove-AzSqlDatabaseSensitivityClassification remove os tipos de informações e rótulos de sensibilidade de colunas no banco de dados.

## EXEMPLOS

### Exemplo 1: remover tipo de informação e rótulo de sensibilidade de uma coluna em um banco de dados SQL do Azure.
```powershell
...
### Exemplo 2: remover tipos de informações atuais e rótulos de sensibilidade de colunas em um banco de dados SQL do Azure usando o encanamento.
```powershell
...
### Exemplo 3: remover tipo de informação e rótulo de sensibilidade de uma coluna em um banco de dados SQL do Azure usando o encanamento.
```powershell
