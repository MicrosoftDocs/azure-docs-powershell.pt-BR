...
### GetVirtualClusterByResourceGroup (padrão)
```
...
## DESCRITIVO
O cmdlet **Get-AzSqlVirtualCluster** retorna informações sobre um ou mais clusters virtuais do Azure SQL.
Especifique o nome de um cluster virtual para ver informações somente para esse cluster.

## EXEMPLOS

### Exemplo 1: obter todos os clusters virtuais atribuídos a um grupo de recursos
```powershell
...
Esse comando obtém informações sobre todos os clusters virtuais atribuídos à ResourceGroup01 do grupo de recursos.

### Exemplo 2: obter informações sobre um cluster virtual específico
```
...
Esse comando obtém informações sobre o cluster virtual VirtualCluster1 na ResourceGroup01 do grupo de recursos.
...
### -ResourceId
A ID do recurso do objeto de instância a ser obtido
