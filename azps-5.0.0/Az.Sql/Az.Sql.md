...
### [<span data-ttu-id="8125d-111">Add-AzSqlInstanceKeyVaultKey</span><span class="sxs-lookup"><span data-stu-id="8125d-111">Add-AzSqlInstanceKeyVaultKey</span></span>](Add-AzSqlInstanceKeyVaultKey.md)
...
### [<span data-ttu-id="8125d-123">Clear-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="8125d-123">Clear-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Clear-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="8125d-135">Concluir-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="8125d-135">Complete-AzSqlInstanceDatabaseLogReplay</span></span>](Complete-AzSqlInstanceDatabaseLogReplay.md)
...
### [<span data-ttu-id="8125d-147">Disable-AzSqlInstanceDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="8125d-147">Disable-AzSqlInstanceDatabaseSensitivityRecommendation</span></span>](Disable-AzSqlInstanceDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="8125d-159">Enable-AzSqlInstanceAdvancedDataSecurity</span><span class="sxs-lookup"><span data-stu-id="8125d-159">Enable-AzSqlInstanceAdvancedDataSecurity</span></span>](Enable-AzSqlInstanceAdvancedDataSecurity.md)
...
### [<span data-ttu-id="8125d-171">Get-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="8125d-171">Get-AzSqlDatabase</span></span>](Get-AzSqlDatabase.md)
...
### [<span data-ttu-id="8125d-185">Get-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="8125d-185">Get-AzSqlDatabaseDataMaskingPolicy</span></span>](Get-AzSqlDatabaseDataMaskingPolicy.md)
...
### [<span data-ttu-id="8125d-199">Get-AzSqlDatabaseIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="8125d-199">Get-AzSqlDatabaseIndexRecommendation</span></span>](Get-AzSqlDatabaseIndexRecommendation.md)
...
### [<span data-ttu-id="8125d-213">Get-AzSqlDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="8125d-213">Get-AzSqlDatabaseSensitivityRecommendation</span></span>](Get-AzSqlDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="8125d-225">Get-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="8125d-225">Get-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Get-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="8125d-239">Get-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="8125d-239">Get-AzSqlElasticJobStep</span></span>](Get-AzSqlElasticJobStep.md)
...
### [<span data-ttu-id="8125d-253">Get-AzSqlElasticPoolDatabase</span><span class="sxs-lookup"><span data-stu-id="8125d-253">Get-AzSqlElasticPoolDatabase</span></span>](Get-AzSqlElasticPoolDatabase.md)
...
### [<span data-ttu-id="8125d-267">Get-AzSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="8125d-267">Get-AzSqlInstanceDatabase</span></span>](Get-AzSqlInstanceDatabase.md)
...
### [<span data-ttu-id="8125d-281">Get-AzSqlInstanceDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="8125d-281">Get-AzSqlInstanceDatabaseSensitivityRecommendation</span></span>](Get-AzSqlInstanceDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="8125d-293">Get-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="8125d-293">Get-AzSqlInstancePool</span></span>](Get-AzSqlInstancePool.md)
...
### [<span data-ttu-id="8125d-305">Get-AzSqlServerActiveDirectoryOnlyAuthentication</span><span class="sxs-lookup"><span data-stu-id="8125d-305">Get-AzSqlServerActiveDirectoryOnlyAuthentication</span></span>](Get-AzSqlServerActiveDirectoryOnlyAuthentication.md)
...
### [<span data-ttu-id="8125d-317">Get-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="8125d-317">Get-AzSqlServerDisasterRecoveryConfiguration</span></span>](Get-AzSqlServerDisasterRecoveryConfiguration.md)
...
### [<span data-ttu-id="8125d-331">Get-AzSqlServerTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="8125d-331">Get-AzSqlServerTransparentDataEncryptionProtector</span></span>](Get-AzSqlServerTransparentDataEncryptionProtector.md)
...
### [<span data-ttu-id="8125d-345">Get-AzSqlSyncGroupLog</span><span class="sxs-lookup"><span data-stu-id="8125d-345">Get-AzSqlSyncGroupLog</span></span>](Get-AzSqlSyncGroupLog.md)
...
### [<span data-ttu-id="8125d-359">New-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="8125d-359">New-AzSqlDatabase</span></span>](New-AzSqlDatabase.md)
...
### [<span data-ttu-id="8125d-373">New-AzSqlDatabaseRestorePoint</span><span class="sxs-lookup"><span data-stu-id="8125d-373">New-AzSqlDatabaseRestorePoint</span></span>](New-AzSqlDatabaseRestorePoint.md)
...
### [<span data-ttu-id="8125d-387">New-AzSqlInstance</span><span class="sxs-lookup"><span data-stu-id="8125d-387">New-AzSqlInstance</span></span>](New-AzSqlInstance.md)
...
### [<span data-ttu-id="8125d-401">New-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="8125d-401">New-AzSqlServerFirewallRule</span></span>](New-AzSqlServerFirewallRule.md)
...
### [<span data-ttu-id="8125d-415">Remove-AzSqlDatabaseAudit</span><span class="sxs-lookup"><span data-stu-id="8125d-415">Remove-AzSqlDatabaseAudit</span></span>](Remove-AzSqlDatabaseAudit.md)
...
### [<span data-ttu-id="8125d-429">Remove-AzSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="8125d-429">Remove-AzSqlDatabaseSecondary</span></span>](Remove-AzSqlDatabaseSecondary.md)
...
### [<span data-ttu-id="8125d-443">Remove-AzSqlElasticJobTargetGroup</span><span class="sxs-lookup"><span data-stu-id="8125d-443">Remove-AzSqlElasticJobTargetGroup</span></span>](Remove-AzSqlElasticJobTargetGroup.md)
...
### [<span data-ttu-id="8125d-457">Remove-AzSqlInstanceKeyVaultKey</span><span class="sxs-lookup"><span data-stu-id="8125d-457">Remove-AzSqlInstanceKeyVaultKey</span></span>](Remove-AzSqlInstanceKeyVaultKey.md)
...
### [<span data-ttu-id="8125d-471">Remove-AzSqlServerDnsAlias</span><span class="sxs-lookup"><span data-stu-id="8125d-471">Remove-AzSqlServerDnsAlias</span></span>](Remove-AzSqlServerDnsAlias.md)
...
### [<span data-ttu-id="8125d-485">Remove-AzSqlVirtualCluster</span><span class="sxs-lookup"><span data-stu-id="8125d-485">Remove-AzSqlVirtualCluster</span></span>](Remove-AzSqlVirtualCluster.md)
...
<span data-ttu-id="8125d-496">Modifica o status de execução automática de um supervisor de banco de dados SQL do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-496">Modifies auto execute status of an Azure SQL Database Advisor.</span></span>

### [<span data-ttu-id="8125d-497">Set-AzSqlDatabaseAudit</span><span class="sxs-lookup"><span data-stu-id="8125d-497">Set-AzSqlDatabaseAudit</span></span>](Set-AzSqlDatabaseAudit.md)
<span data-ttu-id="8125d-498">Altera as configurações de auditoria de um banco de dados SQL do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-498">Changes the auditing settings for an Azure SQL database.</span></span>

### [<span data-ttu-id="8125d-499">Set-AzSqlDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="8125d-499">Set-AzSqlDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="8125d-500">Define uma política de retenção de longo prazo do servidor.</span><span class="sxs-lookup"><span data-stu-id="8125d-500">Sets a server long term retention policy.</span></span>

### [<span data-ttu-id="8125d-501">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="8125d-501">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="8125d-502">Define uma política de retenção de curto prazo de backup.</span><span class="sxs-lookup"><span data-stu-id="8125d-502">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="8125d-503">Set-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="8125d-503">Set-AzSqlDatabaseDataMaskingPolicy</span></span>](Set-AzSqlDatabaseDataMaskingPolicy.md)
<span data-ttu-id="8125d-504">Define o mascaramento de dados para um banco de dados.</span><span class="sxs-lookup"><span data-stu-id="8125d-504">Sets data masking for a database.</span></span>

### [<span data-ttu-id="8125d-505">Set-AzSqlDatabaseDataMaskingRule</span><span class="sxs-lookup"><span data-stu-id="8125d-505">Set-AzSqlDatabaseDataMaskingRule</span></span>](Set-AzSqlDatabaseDataMaskingRule.md)
<span data-ttu-id="8125d-506">Define as propriedades de uma regra de máscara de dados para um banco de dados.</span><span class="sxs-lookup"><span data-stu-id="8125d-506">Sets the properties of a data masking rule for a database.</span></span>

### [<span data-ttu-id="8125d-507">Set-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="8125d-507">Set-AzSqlDatabaseFailoverGroup</span></span>](Set-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="8125d-508">Modifica a configuração de um grupo de failover do banco de dados SQL do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-508">Modifies the configuration of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="8125d-509">Set-AzSqlDatabaseGeoBackupPolicy</span><span class="sxs-lookup"><span data-stu-id="8125d-509">Set-AzSqlDatabaseGeoBackupPolicy</span></span>](Set-AzSqlDatabaseGeoBackupPolicy.md)
<span data-ttu-id="8125d-510">Define uma política de backup geográfico do banco de dados.</span><span class="sxs-lookup"><span data-stu-id="8125d-510">Sets a database geo backup policy.</span></span>

### [<span data-ttu-id="8125d-511">Set-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="8125d-511">Set-AzSqlDatabaseInstanceFailoverGroup</span></span>](Set-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="8125d-512">Modifica a configuração de um grupo de failover de instância.</span><span class="sxs-lookup"><span data-stu-id="8125d-512">Modifies the configuration of an Instance Failover Group.</span></span>

### [<span data-ttu-id="8125d-513">Set-AzSqlDatabaseRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="8125d-513">Set-AzSqlDatabaseRecommendedActionState</span></span>](Set-AzSqlDatabaseRecommendedActionState.md)
<span data-ttu-id="8125d-514">Atualiza o estado de uma ação recomendada do banco de dados SQL do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-514">Updates the state of an Azure SQL Database recommended action.</span></span>

### [<span data-ttu-id="8125d-515">Set-AzSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="8125d-515">Set-AzSqlDatabaseSecondary</span></span>](Set-AzSqlDatabaseSecondary.md)
<span data-ttu-id="8125d-516">Alterna um banco de dados secundário para ser primário a fim de iniciar o failover.</span><span class="sxs-lookup"><span data-stu-id="8125d-516">Switches a secondary database to be primary in order to initiate failover.</span></span>

### [<span data-ttu-id="8125d-517">Set-AzSqlDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="8125d-517">Set-AzSqlDatabaseSensitivityClassification</span></span>](Set-AzSqlDatabaseSensitivityClassification.md)
<span data-ttu-id="8125d-518">Define os tipos de informações e rótulos de sensibilidade de colunas no banco de dados.</span><span class="sxs-lookup"><span data-stu-id="8125d-518">Sets the information types and sensitivity labels of columns in the database.</span></span>

### [<span data-ttu-id="8125d-519">Set-AzSqlDatabaseTransparentDataEncryption</span><span class="sxs-lookup"><span data-stu-id="8125d-519">Set-AzSqlDatabaseTransparentDataEncryption</span></span>](Set-AzSqlDatabaseTransparentDataEncryption.md)
<span data-ttu-id="8125d-520">Modifica a propriedade TDE de um banco de dados.</span><span class="sxs-lookup"><span data-stu-id="8125d-520">Modifies TDE property for a database.</span></span>

### [<span data-ttu-id="8125d-521">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="8125d-521">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="8125d-522">Define a linha de base da regra de avaliação de vulnerabilidade.</span><span class="sxs-lookup"><span data-stu-id="8125d-522">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="8125d-523">Set-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="8125d-523">Set-AzSqlElasticJob</span></span>](Set-AzSqlElasticJob.md)
<span data-ttu-id="8125d-524">Atualiza um trabalho</span><span class="sxs-lookup"><span data-stu-id="8125d-524">Updates a job</span></span>

### [<span data-ttu-id="8125d-525">Set-AzSqlElasticJobAgent</span><span class="sxs-lookup"><span data-stu-id="8125d-525">Set-AzSqlElasticJobAgent</span></span>](Set-AzSqlElasticJobAgent.md)
<span data-ttu-id="8125d-526">Atualiza um agente de trabalho elástico</span><span class="sxs-lookup"><span data-stu-id="8125d-526">Updates an elastic job agent</span></span>

### [<span data-ttu-id="8125d-527">Set-AzSqlElasticJobCredential</span><span class="sxs-lookup"><span data-stu-id="8125d-527">Set-AzSqlElasticJobCredential</span></span>](Set-AzSqlElasticJobCredential.md)
<span data-ttu-id="8125d-528">Atualiza uma credencial de trabalho</span><span class="sxs-lookup"><span data-stu-id="8125d-528">Updates a job credential</span></span>

### [<span data-ttu-id="8125d-529">Set-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="8125d-529">Set-AzSqlElasticJobStep</span></span>](Set-AzSqlElasticJobStep.md)
<span data-ttu-id="8125d-530">Atualiza uma etapa do trabalho</span><span class="sxs-lookup"><span data-stu-id="8125d-530">Updates a job step</span></span>

### [<span data-ttu-id="8125d-531">Set-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="8125d-531">Set-AzSqlElasticPool</span></span>](Set-AzSqlElasticPool.md)
<span data-ttu-id="8125d-532">Modifica as propriedades de um pool de banco de dados elástico no banco de dados SQL do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-532">Modifies properties of an elastic database pool in Azure SQL Database.</span></span>

### [<span data-ttu-id="8125d-533">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="8125d-533">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span></span>](Set-AzSqlElasticPoolAdvisorAutoExecuteStatus.md)
<span data-ttu-id="8125d-534">Atualiza o status de execução automática de um supervisor de pool elástico do Azure SQL.</span><span class="sxs-lookup"><span data-stu-id="8125d-534">Updates auto execute status of an Azure SQL Elastic Pool Advisor.</span></span>

### [<span data-ttu-id="8125d-535">Set-AzSqlElasticPoolRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="8125d-535">Set-AzSqlElasticPoolRecommendedActionState</span></span>](Set-AzSqlElasticPoolRecommendedActionState.md)
<span data-ttu-id="8125d-536">Atualiza o estado de uma ação recomendada do pool elástico do SQL Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-536">Updates the state of an Azure SQL Elastic Pool recommended action.</span></span>

### [<span data-ttu-id="8125d-537">Set-AzSqlInstance</span><span class="sxs-lookup"><span data-stu-id="8125d-537">Set-AzSqlInstance</span></span>](Set-AzSqlInstance.md)
<span data-ttu-id="8125d-538">Define propriedades para uma instância gerenciada de banco de dados SQL do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-538">Sets properties for an Azure SQL Database Managed Instance.</span></span>

### [<span data-ttu-id="8125d-539">Set-AzSqlInstanceActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="8125d-539">Set-AzSqlInstanceActiveDirectoryAdministrator</span></span>](Set-AzSqlInstanceActiveDirectoryAdministrator.md)
<span data-ttu-id="8125d-540">Provisiona uma instância gerenciada do Azure AD Administrator para SQL.</span><span class="sxs-lookup"><span data-stu-id="8125d-540">Provisions an Azure AD administrator for SQL Managed Instance.</span></span>

### [<span data-ttu-id="8125d-541">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="8125d-541">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="8125d-542">O cmdlet **set-AzSqlInstanceDatabaseLongTermRetentionBackup** define a política de retenção de longo prazo do banco de dados gerenciado.</span><span class="sxs-lookup"><span data-stu-id="8125d-542">The **Set-AzSqlInstanceDatabaseLongTermRetentionBackup** cmdlet sets a managed database's long term retention policy.</span></span>

### [<span data-ttu-id="8125d-543">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="8125d-543">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="8125d-544">Define uma política de retenção de curto prazo de backup.</span><span class="sxs-lookup"><span data-stu-id="8125d-544">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="8125d-545">Set-AzSqlInstanceDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="8125d-545">Set-AzSqlInstanceDatabaseSensitivityClassification</span></span>](Set-AzSqlInstanceDatabaseSensitivityClassification.md)
<span data-ttu-id="8125d-546">Define os tipos de informações e rótulos de sensibilidade de colunas no banco de dados de instância gerenciada do Azure SQL.</span><span class="sxs-lookup"><span data-stu-id="8125d-546">Sets the information types and sensitivity labels of columns in the Azure SQL managed instance database.</span></span>

### [<span data-ttu-id="8125d-547">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="8125d-547">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="8125d-548">Define a linha de base da regra de avaliação de vulnerabilidade.</span><span class="sxs-lookup"><span data-stu-id="8125d-548">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="8125d-549">Set-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="8125d-549">Set-AzSqlInstancePool</span></span>](Set-AzSqlInstancePool.md)
<span data-ttu-id="8125d-550">Define as propriedades de um pool de instâncias do SQL do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-550">Sets properties for an Azure SQL Instance pool.</span></span>

### [<span data-ttu-id="8125d-551">Set-AzSqlInstanceTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="8125d-551">Set-AzSqlInstanceTransparentDataEncryptionProtector</span></span>](Set-AzSqlInstanceTransparentDataEncryptionProtector.md)
<span data-ttu-id="8125d-552">Define o protetor de criptografia de dados transparente (TDE) para uma instância gerenciada SQL.</span><span class="sxs-lookup"><span data-stu-id="8125d-552">Sets the Transparent Data Encryption (TDE) protector for a SQL managed instance.</span></span>

### [<span data-ttu-id="8125d-553">Set-AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="8125d-553">Set-AzSqlServer</span></span>](Set-AzSqlServer.md)
<span data-ttu-id="8125d-554">Modifica as propriedades de um servidor de banco de dados SQL.</span><span class="sxs-lookup"><span data-stu-id="8125d-554">Modifies properties of a SQL Database server.</span></span>

### [<span data-ttu-id="8125d-555">Set-AzSqlServerActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="8125d-555">Set-AzSqlServerActiveDirectoryAdministrator</span></span>](Set-AzSqlServerActiveDirectoryAdministrator.md)
<span data-ttu-id="8125d-556">Provisiona um administrador do Azure AD para SQL Server.</span><span class="sxs-lookup"><span data-stu-id="8125d-556">Provisions an Azure AD administrator for SQL Server.</span></span>

### [<span data-ttu-id="8125d-557">Set-AzSqlServerAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="8125d-557">Set-AzSqlServerAdvisorAutoExecuteStatus</span></span>](Set-AzSqlServerAdvisorAutoExecuteStatus.md)
<span data-ttu-id="8125d-558">Atualiza o status de execução automática de um supervisor do SQL Server do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-558">Updates the auto execute status of an Azure SQL Server Advisor.</span></span>

### [<span data-ttu-id="8125d-559">Set-AzSqlServerAudit</span><span class="sxs-lookup"><span data-stu-id="8125d-559">Set-AzSqlServerAudit</span></span>](Set-AzSqlServerAudit.md)
<span data-ttu-id="8125d-560">Altera as configurações de auditoria de um SQL Server do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-560">Changes the auditing settings of an Azure SQL server.</span></span>

### [<span data-ttu-id="8125d-561">Set-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="8125d-561">Set-AzSqlServerDisasterRecoveryConfiguration</span></span>](Set-AzSqlServerDisasterRecoveryConfiguration.md)
<span data-ttu-id="8125d-562">Modifica uma configuração de recuperação do servidor de banco de dados.</span><span class="sxs-lookup"><span data-stu-id="8125d-562">Modifies a database server recovery configuration.</span></span>

### [<span data-ttu-id="8125d-563">Set-AzSqlServerDnsAlias</span><span class="sxs-lookup"><span data-stu-id="8125d-563">Set-AzSqlServerDnsAlias</span></span>](Set-AzSqlServerDnsAlias.md)
<span data-ttu-id="8125d-564">Modifica o servidor para o qual o alias DNS do SQL Server do Azure está apontando</span><span class="sxs-lookup"><span data-stu-id="8125d-564">Modifies the server to which Azure SQL Server DNS Alias is pointing</span></span>

### [<span data-ttu-id="8125d-565">Set-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="8125d-565">Set-AzSqlServerFirewallRule</span></span>](Set-AzSqlServerFirewallRule.md)
<span data-ttu-id="8125d-566">Modifica uma regra de firewall no servidor de banco de dados SQL do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-566">Modifies a firewall rule in Azure SQL Database server.</span></span>

### [<span data-ttu-id="8125d-567">Set-AzSqlServerRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="8125d-567">Set-AzSqlServerRecommendedActionState</span></span>](Set-AzSqlServerRecommendedActionState.md)
<span data-ttu-id="8125d-568">Atualiza o estado de uma ação recomendada do Azure SQL Server.</span><span class="sxs-lookup"><span data-stu-id="8125d-568">Updates the state of an Azure SQL Server recommended action.</span></span>

### [<span data-ttu-id="8125d-569">Set-AzSqlServerTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="8125d-569">Set-AzSqlServerTransparentDataEncryptionProtector</span></span>](Set-AzSqlServerTransparentDataEncryptionProtector.md)
<span data-ttu-id="8125d-570">Define o protetor de criptografia de dados transparente (TDE) para um SQL Server.</span><span class="sxs-lookup"><span data-stu-id="8125d-570">Sets the Transparent Data Encryption (TDE) protector for a SQL server.</span></span>

### [<span data-ttu-id="8125d-571">Set-AzSqlServerVirtualNetworkRule</span><span class="sxs-lookup"><span data-stu-id="8125d-571">Set-AzSqlServerVirtualNetworkRule</span></span>](Set-AzSqlServerVirtualNetworkRule.md)
<span data-ttu-id="8125d-572">Modifica a configuração de uma regra de rede virtual do Azure SQL Server.</span><span class="sxs-lookup"><span data-stu-id="8125d-572">Modifies the configuration of an Azure SQL Server Virtual Network Rule.</span></span>

### [<span data-ttu-id="8125d-573">Start-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="8125d-573">Start-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Start-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="8125d-574">Inicia o fluxo de trabalho que executa uma operação de índice recomendada.</span><span class="sxs-lookup"><span data-stu-id="8125d-574">Starts the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="8125d-575">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="8125d-575">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="8125d-576">Inicia uma análise da avaliação de vulnerabilidade.</span><span class="sxs-lookup"><span data-stu-id="8125d-576">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="8125d-577">Start-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="8125d-577">Start-AzSqlElasticJob</span></span>](Start-AzSqlElasticJob.md)
<span data-ttu-id="8125d-578">Inicia um trabalho, retornando uma ID de execução de trabalho que pode ser sondada para exibir seu status</span><span class="sxs-lookup"><span data-stu-id="8125d-578">Starts a job, returning a job execution id that can be polled to view it's status</span></span>

### [<span data-ttu-id="8125d-579">Start-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="8125d-579">Start-AzSqlInstanceDatabaseLogReplay</span></span>](Start-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="8125d-580">Inicia um serviço de reprodução de log com os parâmetros especificados.</span><span class="sxs-lookup"><span data-stu-id="8125d-580">Starts a Log Replay service with the given parameters.</span></span>

### [<span data-ttu-id="8125d-581">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="8125d-581">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="8125d-582">Inicia uma análise da avaliação de vulnerabilidade.</span><span class="sxs-lookup"><span data-stu-id="8125d-582">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="8125d-583">Start-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="8125d-583">Start-AzSqlSyncGroupSync</span></span>](Start-AzSqlSyncGroupSync.md)
<span data-ttu-id="8125d-584">Inicia uma sincronização de grupo de sincronização.</span><span class="sxs-lookup"><span data-stu-id="8125d-584">Starts a sync group synchronization.</span></span>

### [<span data-ttu-id="8125d-585">Parar-AzSqlDatabaseActivity</span><span class="sxs-lookup"><span data-stu-id="8125d-585">Stop-AzSqlDatabaseActivity</span></span>](Stop-AzSqlDatabaseActivity.md)
<span data-ttu-id="8125d-586">Cancela a operação de atualizações assíncronas no banco de dados.</span><span class="sxs-lookup"><span data-stu-id="8125d-586">Cancels the asynchronous updates operation on the database.</span></span>

### [<span data-ttu-id="8125d-587">Parar-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="8125d-587">Stop-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Stop-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="8125d-588">Interrompe o fluxo de trabalho que executa uma operação de índice recomendada.</span><span class="sxs-lookup"><span data-stu-id="8125d-588">Stops the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="8125d-589">Parar-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="8125d-589">Stop-AzSqlElasticJob</span></span>](Stop-AzSqlElasticJob.md)
<span data-ttu-id="8125d-590">Interrompe um trabalho de acordo com a ID de execução do trabalho</span><span class="sxs-lookup"><span data-stu-id="8125d-590">Stops a job given it's job execution id</span></span>

### [<span data-ttu-id="8125d-591">Parar-AzSqlElasticPoolActivity</span><span class="sxs-lookup"><span data-stu-id="8125d-591">Stop-AzSqlElasticPoolActivity</span></span>](Stop-AzSqlElasticPoolActivity.md)
<span data-ttu-id="8125d-592">Cancela a operação de atualização assíncrona em um pool elástico.</span><span class="sxs-lookup"><span data-stu-id="8125d-592">Cancels the asynchronous update operation on an elastic pool.</span></span>

### [<span data-ttu-id="8125d-593">Parar-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="8125d-593">Stop-AzSqlInstanceDatabaseLogReplay</span></span>](Stop-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="8125d-594">Cancela o serviço de reprodução de log ao descartar o banco de dados.</span><span class="sxs-lookup"><span data-stu-id="8125d-594">Cancels the Log Replay service by dropping the database.</span></span>

### [<span data-ttu-id="8125d-595">Parar-AzSqlInstanceOperation</span><span class="sxs-lookup"><span data-stu-id="8125d-595">Stop-AzSqlInstanceOperation</span></span>](Stop-AzSqlInstanceOperation.md)
<span data-ttu-id="8125d-596">Interrompe as operações de uma instância gerenciada de SQL.</span><span class="sxs-lookup"><span data-stu-id="8125d-596">Stops a SQL managed instance's operations.</span></span>

### [<span data-ttu-id="8125d-597">Parar-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="8125d-597">Stop-AzSqlSyncGroupSync</span></span>](Stop-AzSqlSyncGroupSync.md)
<span data-ttu-id="8125d-598">Interrompe a sincronização de um grupo de sincronização.</span><span class="sxs-lookup"><span data-stu-id="8125d-598">Stops a sync group synchronization.</span></span>

### [<span data-ttu-id="8125d-599">Suspender-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="8125d-599">Suspend-AzSqlDatabase</span></span>](Suspend-AzSqlDatabase.md)
<span data-ttu-id="8125d-600">Suspende um banco de dados de data warehouse do SQL.</span><span class="sxs-lookup"><span data-stu-id="8125d-600">Suspends a SQL Data Warehouse database.</span></span>

### [<span data-ttu-id="8125d-601">Botão de AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="8125d-601">Switch-AzSqlDatabaseFailoverGroup</span></span>](Switch-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="8125d-602">Executa um failover de um grupo de failover do banco de dados SQL do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-602">Executes a failover of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="8125d-603">Botão de AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="8125d-603">Switch-AzSqlDatabaseInstanceFailoverGroup</span></span>](Switch-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="8125d-604">Executa um failover de um grupo de failover de instância.</span><span class="sxs-lookup"><span data-stu-id="8125d-604">Executes a failover of an Instance Failover Group.</span></span>

### [<span data-ttu-id="8125d-605">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="8125d-605">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span></span>](Update-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
<span data-ttu-id="8125d-606">Define as configurações avançadas de proteção contra ameaças em um banco de dados.</span><span class="sxs-lookup"><span data-stu-id="8125d-606">Sets a advanced threat protection settings on a database.</span></span>

### [<span data-ttu-id="8125d-607">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="8125d-607">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="8125d-608">Atualiza as configurações de avaliação de vulnerabilidade de um banco de dados.</span><span class="sxs-lookup"><span data-stu-id="8125d-608">Updates the vulnerability assessment settings of a database.</span></span>

### [<span data-ttu-id="8125d-609">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="8125d-609">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="8125d-610">Atualiza as configurações de avaliação de vulnerabilidade de um banco de dados gerenciado.</span><span class="sxs-lookup"><span data-stu-id="8125d-610">Updates the vulnerability assessment settings of a managed database.</span></span>

### [<span data-ttu-id="8125d-611">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="8125d-611">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceVulnerabilityAssessmentSetting.md)
<span data-ttu-id="8125d-612">Atualiza as configurações de avaliação de vulnerabilidade de uma instância gerenciada.</span><span class="sxs-lookup"><span data-stu-id="8125d-612">Updates the vulnerability assessment settings of a managed instance.</span></span>

### [<span data-ttu-id="8125d-613">Update-AzSqlServerAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="8125d-613">Update-AzSqlServerAdvancedThreatProtectionSetting</span></span>](Update-AzSqlServerAdvancedThreatProtectionSetting.md)
<span data-ttu-id="8125d-614">Define as configurações avançadas de proteção contra ameaças em um servidor.</span><span class="sxs-lookup"><span data-stu-id="8125d-614">Sets a advanced threat protection settings on a server.</span></span>

### [<span data-ttu-id="8125d-615">Update-AzSqlServerVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="8125d-615">Update-AzSqlServerVulnerabilityAssessmentSetting</span></span>](Update-AzSqlServerVulnerabilityAssessmentSetting.md)
<span data-ttu-id="8125d-616">Atualiza as configurações de avaliação de vulnerabilidade de um servidor.</span><span class="sxs-lookup"><span data-stu-id="8125d-616">Updates the vulnerability assessment settings of a server.</span></span>

### [<span data-ttu-id="8125d-617">Update-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="8125d-617">Update-AzSqlSyncGroup</span></span>](Update-AzSqlSyncGroup.md)
<span data-ttu-id="8125d-618">Atualiza um grupo de sincronização do banco de dados SQL do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-618">Updates an Azure SQL Database Sync Group.</span></span>

### [<span data-ttu-id="8125d-619">Update-AzSqlSyncMember</span><span class="sxs-lookup"><span data-stu-id="8125d-619">Update-AzSqlSyncMember</span></span>](Update-AzSqlSyncMember.md)
<span data-ttu-id="8125d-620">Atualiza um membro de sincronização do banco de dados SQL do Azure.</span><span class="sxs-lookup"><span data-stu-id="8125d-620">Updates an Azure SQL Database Sync Member.</span></span>

### [<span data-ttu-id="8125d-621">Update-AzSqlSyncSchema</span><span class="sxs-lookup"><span data-stu-id="8125d-621">Update-AzSqlSyncSchema</span></span>](Update-AzSqlSyncSchema.md)
<span data-ttu-id="8125d-622">Atualize o esquema de sincronização para um banco de dados de membro de sincronização ou um banco de dados Hub de sincronização.</span><span class="sxs-lookup"><span data-stu-id="8125d-622">Update the sync schema for a sync member database or a sync hub database.</span></span>
<span data-ttu-id="8125d-623">Ele receberá o esquema de banco de dados mais recente do banco de dados real e o usará atualizará o esquema armazenado em cache pelo banco de dados de metadados de sincronização.</span><span class="sxs-lookup"><span data-stu-id="8125d-623">It will get the latest database schema from the real database and then use it refresh the schema cached by Sync metadata database.</span></span>
<span data-ttu-id="8125d-624">Se "SyncMemberName" for especificado, o esquema de banco de dados membro será atualizado. caso contrário, o esquema de banco de dados Hub será atualizado.</span><span class="sxs-lookup"><span data-stu-id="8125d-624">If "SyncMemberName" is specified, it will refresh the member database schema; if not, it will refresh the hub database schema.</span></span>
