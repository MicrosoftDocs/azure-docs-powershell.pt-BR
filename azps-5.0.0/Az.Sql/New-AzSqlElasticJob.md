...
## DESCRITIVO
O cmdlet New-AzSqlElasticJob cria um novo trabalho

## EXEMPLOS

### Exemplo 1: cria um novo trabalho
```powershell
...
Cria um novo trabalho. (gerado automaticamente)
...
### -Habilitar
O sinalizador para indicar que o cliente deseja habilitar esse trabalho.
...
### -EndTime
A hora de término do agendamento do trabalho
...
### -IntervalCount
A contagem de intervalos do cronograma recorrente
...
### -IntervalType
O tipo de intervalo do cronograma recorrente-pode ser minuto, hora, dia, semana, mês
...
### -StartTime
A hora de início do agendamento do trabalho
