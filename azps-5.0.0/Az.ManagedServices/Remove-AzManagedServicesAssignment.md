...
Exclui a atribuição de registro por nome no escopo padrão.
...
Exclui a atribuição de registro por nome em um determinado escopo.
...
### -Escopo
O escopo da atribuição de registro.
