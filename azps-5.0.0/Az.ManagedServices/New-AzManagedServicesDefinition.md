...
Cria uma definição de registro pelos valores roleDefinitionId e dirigeid fornecidos diretamente.
...
### -Authorization
Lista de mapeamento de autorização com entidade de segurança-roleDefinitionId.
