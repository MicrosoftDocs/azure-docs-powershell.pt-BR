...
### Exemplo 1: criar um BD de réplica para um MariaDB
```powershell
...
Esse comando cria um BD de réplica para um MariaDB.

### Exemplo 2: criar um BD de réplica para um MariaDB
```powershell
...
### Exemplo 3: criar um BD de réplica para um MariaDB
```powershell
...
Esse comando com o parâmetro InputObject cria um BD de réplica com o parâmetro InputObject para um MariaDB.
...
Mestre <IServer> : o objeto do servidor de origem para o qual restaurar.
