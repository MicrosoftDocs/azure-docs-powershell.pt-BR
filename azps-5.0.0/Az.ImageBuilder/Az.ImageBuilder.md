...
## Descritivo
Microsoft Azure PowerShell: cmdlets do ImageBuilder

## Cmdlets AZ. ImageBuilder
...
Criar artefatos a partir de um modelo de imagem existente

### [Parar-AzImageBuilderTemplate](Stop-AzImageBuilderTemplate.md)
Cancelar a construção da imagem de longa duração com base no modelo de imagem
