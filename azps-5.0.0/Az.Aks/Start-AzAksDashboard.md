...
## DESCRITIVO
Crie um encapsulamento SSH Kubectl para o painel do cluster gerenciado. O túnel SSH é configurado em um trabalho do PowerShell chamado Kubectl-Tunnel e pode ser encontrado em execução `Get-Job` . O encapsulamento deve ser acessível via [http://127.0.0.1:8001](http://127.0.0.1:8001) .
...
### -DisableBrowser
Não abra abrir um navegador após estabelecer o encaminhamento de porta kubectl.
...
### -ListenPort
A porta de escuta do painel. O valor padrão é 8003.
