...
## Sinopse
API para registrar um novo computador e, assim, criar um recurso controlado no ARM
...
### Exemplo 1: embuti o computador em que você está conectado como um computador conectado
```powershell
...
O computador em que você está conectado como um computador conectado.

### Exemplo 2: embuti um computador remoto como um dispositivo conectado
```powershell
...
O integrada a um computador remoto como um dispositivo conectado usando a comunicação remota do PowerShell.
Observação: somente o Windows como destino tem suporte no momento.
...
### -Nome
O nome que será usado para esta máquina.
...
### -PSSession
Quando especificado, o comando que os computadores que se encontram na máquina do Azure para o Azure serão executados em cada PSSession.
...
### -SubscriptionId
A ID da assinatura à qual você deseja adicionar a máquina.
