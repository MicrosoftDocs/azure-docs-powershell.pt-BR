...
### Exemplo 1 gerar novamente a chave primária
```
...
Chave primária regenerada para a política de autorização "testKey" de um hub IOT do Azure.

### Exemplo 2 teclas de permuta
```
...
Chaves de troca da política de autorização "testKey" de um hub IOT do Azure.
