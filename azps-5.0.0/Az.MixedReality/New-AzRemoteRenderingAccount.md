...
## Sinopse
Criar conta de renderização remota
...
Criar uma nova conta de renderização remota "exemplo" na assinatura atual, grupo de recursos "Rg1" e centro dos EUA.
...
### -Local
Local da conta de renderização remota.
