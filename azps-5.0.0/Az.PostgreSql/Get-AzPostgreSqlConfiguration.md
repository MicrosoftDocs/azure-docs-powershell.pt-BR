...
### Exemplo 1: listar todas as configurações no servidor PostgreSql
```powershell
...
Esse cmdlet lista todas as configurações no servidor PostgreSql especificado.

### Exemplo 2: obter a configuração de PostgreSql especificado por nome
```powershell
...
Este cmdlet obtém a configuração PostgreSql especificada por nome.
