...
### Exemplo 1: obter a réplica do servidor PostgreSql por grupo de recursos e nome do servidor
```powershell
...
Esse cmdlet obtém a réplica do servidor PostgreSql por grupo de recursos e nome do servidor.
