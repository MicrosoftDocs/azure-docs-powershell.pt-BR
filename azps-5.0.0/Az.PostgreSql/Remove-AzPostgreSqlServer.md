...
### Exemplo 1: remover o servidor PostgreSql por meio da Resource do nome do servidor e do nome do servidor
```powershell
PS C:\> Remove-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Este cmdlet Remove o servidor PostgreSql pelo nome do servidor e do nome do servidor.

### Exemplo 2: remover o servidor PostgreSql por identidade
```powershell
...
Esses cmdlets removem o servidor PostgreSql por identidade.
