...
## DESCRITIVO
O cmdlet **Edit-AzRecoveryServicesAsrRecoveryPlan** edita um plano do Azure site Recovery.
...
Acrescenta um grupo ao plano existente do Azure site Recovery e retorna o plano de recuperação atualizado na memória. 
...
### -InputObject
O objeto de plano de recuperação ASR a ser editado (na operação de memória. Para atualizar o plano de recuperação execute Update-AzASRRecoveryPlan com o objeto do plano de recuperação editado.)
