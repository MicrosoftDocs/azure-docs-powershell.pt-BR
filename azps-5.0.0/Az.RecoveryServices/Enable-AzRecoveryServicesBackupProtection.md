...
## DESCRITIVO
O cmdlet **Enable-AzRecoveryServicesBackupProtection** permite o backup associando uma política de proteção ao item.
...
Habilita o backup para um item com uma política de proteção de backup especificada. (gerado automaticamente)
...
### -ExclusionDisksList
A lista de LUNs de disco a ser excluída no backup e o restante são automaticamente incluídas.
...
### -InclusionDisksList
Lista de LUNs de disco a serem incluídos no backup e o restante são excluídos automaticamente, exceto o disco do sistema operacional.
...
### -ProtectableItem
Especifica o item a ser protegido com a política fornecida.
