...
## DESCRITIVO
O cmdlet **Stop-AzRecoveryServicesBackupJob** cancela um trabalho de backup do Azure existente.
...
Para obter um objeto **BackupJob** , use Get-AzRecoveryServicesBackupJob.
