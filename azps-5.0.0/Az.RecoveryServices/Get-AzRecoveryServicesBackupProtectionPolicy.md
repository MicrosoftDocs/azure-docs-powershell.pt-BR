...
## DESCRITIVO
O cmdlet **Get-AzRecoveryServicesBackupProtectionPolicy** Obtém as políticas de proteção de backup do Azure para um cofre.
...
A classe de recursos que estão sendo protegidos. Atualmente, os valores com suporte para esse cmdlet são AzureVM, AzureStorage, AzureWorkload
