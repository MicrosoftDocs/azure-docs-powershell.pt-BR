...
### -AccessKey
Tecla de acesso para a conta de armazenamento do Azure
...
### -MountPath
Caminho no contêiner em que o compartilhamento especificado por ShareName será exposto
...
### -Nome
O identificador da propriedade de armazenamento do Azure.
...
### -ShareName
Nome do compartilhamento para montar no contêiner
...
Os contêineres do Windows só dão suporte a arquivos do Azure
