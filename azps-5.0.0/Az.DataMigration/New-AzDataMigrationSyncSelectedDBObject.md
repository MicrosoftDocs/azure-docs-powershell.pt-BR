...
Este exemplo cria um objeto de metadados de banco de dados descrevendo as configurações de migração de $DatabaseName para o banco de dados $DatabaseName.  
...
### -SourceSetting
Configurações de origem para ajustar o comportamento de migração de ponto de extremidade de origem
...
### -TargetSetting
Configurações de destino para ajustar o comportamento de migração de ponto de extremidade de destino
