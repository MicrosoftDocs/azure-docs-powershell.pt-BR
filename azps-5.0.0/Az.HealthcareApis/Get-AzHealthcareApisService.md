...
## DESCRITIVO
Obtém contas de serviço fhir de healthcareApis existentes criadas na assinatura especificada ou em um grupo de recursos.
...
Obtém os metadados de todos os serviços do HealthcareApis no grupo de recursos fornecido.
...
Obtém os metadados de todos os serviços do HealthcareApis na assinatura especificada
...
### -ResourceId
Nome da identificação do recurso.
