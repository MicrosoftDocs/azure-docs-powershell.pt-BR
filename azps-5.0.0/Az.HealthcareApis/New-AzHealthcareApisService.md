...
### -AllowCorsCredential
HealthcareApis Fhir de serviço do AllowCorsCredential.
...
### -CorsOrigin
Lista de serviços Fhir HealthcareApis da origem CORS. Especifique as URLs de sites de origem que podem acessar essa API ou use * para permitir o acesso de qualquer site.
