...
## DESCRITIVO
O cmdlet **New-AzDataBoxEdgeBandwidthSchedule** cria uma nova programação de largura de banda para um dispositivo de borda de caixa de dados para ajudar a gerenciar o uso de largura de banda.
...
### -UnlimitedBandwidth
Definirá largura de banda ilimitada, se definido como false irá definir o valor padrão como 20 Mbps
