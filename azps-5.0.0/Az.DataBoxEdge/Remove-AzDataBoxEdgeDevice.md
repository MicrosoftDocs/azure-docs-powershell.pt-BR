...
## DESCRITIVO
O cmdlet **Remove-AzDataBoxEdgeDevice** remove a configuração de um dispositivo de borda de caixa de dados.
Observe que o dispositivo só pode ser excluído depois que você tiver feito o pedido e antes que o dispositivo seja preparado pela Microsoft para remessa.

Consulte a documentação sobre como excluir o recurso antes de usar este [cmdlet](https://docs.microsoft.com/en-us/azure/databox-online/data-box-edge-return-device#delete-the-resource)
