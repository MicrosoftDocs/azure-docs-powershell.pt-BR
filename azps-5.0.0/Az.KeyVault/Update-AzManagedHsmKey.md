...
## Sinopse
Atualiza os atributos de uma chave em um HSM gerenciado.
...
## DESCRITIVO
O cmdlet **Update-AzManagedHsmKey** atualiza os atributos editáveis de uma chave em um HSM gerenciado.
...
O comando final modifica uma chave chamada testkey001. O comando habilita a chave, define seu tempo de expiração para a hora armazenada em $Expires e define as marcas armazenadas no $Tags.
...
### -Habilitar
O valor de true permite que a chave e um valor false desativassem a chave.
Se não for especificado, o estado Enabled/Disabled existente permanecerá inalterado.
...
Se não for especificado, o atributo nobefore existente da chave permanecerá inalterado.
...
### -Marca
Uma Hashtable representa as marcas de tecla.
Se não for especificado, as marcas existentes da tecla permanecerão inalteradas.
