...
## DESCRITIVO
O cmdlet **Get-AzManagedHsm** Obtém informações sobre os HSMs gerenciados em uma assinatura. Você pode exibir todas as instâncias de HSMs gerenciadas em uma assinatura ou filtrar os resultados por um grupo de recursos ou HSM gerenciado específico.
