...
## Sinopse
Recupera uma chave excluída em um HSM gerenciado em um estado ativo.
...
## DESCRITIVO
O cmdlet **Undo-AzManagedHsmKeyRemoval** recuperará uma chave previamente excluída.
...
Esse comando recuperará a chave ' testkey001 ' que foi excluída anteriormente, em um estado ativo e utilizável.
