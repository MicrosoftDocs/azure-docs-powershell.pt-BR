...
## DESCRITIVO
Crie um objeto que representa as configurações de regra de rede que podem ser usadas ao criar um cofre.
...
Criando um novo cofre e especifica regras de rede para permitir o acesso ao endereço IP especificado da rede virtual identificada por $myNetworkResId.
