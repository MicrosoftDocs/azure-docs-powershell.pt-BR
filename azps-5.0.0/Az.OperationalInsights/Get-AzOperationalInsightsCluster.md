...
## DESCRITIVO
Obter ou listar clusters, listar clusters em grupo de recursos quando "-ClusterName" não foi fornecido, clusters de lista em assinatura quando "-ClusterName" e "ResourceGroupName" não foram fornecidos.
