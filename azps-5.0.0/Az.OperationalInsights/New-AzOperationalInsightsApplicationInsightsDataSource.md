...
## DESCRITIVO
O cmdlet **New-AzOperationalInsightsApplicationInsightsDataSource** permite a coleta de logs de um determinado aplicativo Application-Insights.

## EXEMPLOS

### Exemplo 1: criar uma fonte de dados do Application insights no espaço de trabalho
```
...
Esse comando cria uma fonte de dados Application insights de um determinado aplicativo em um determinado espaço de trabalho de análise de log. Isso habilita a coleta de logs de um determinado aplicativo para o espaço de trabalho análise de logs.

### Exemplo 2: obter objeto do espaço de trabalho e criar fonte de dados do Application insights pela ID do recurso do aplicativo
```
...
Esse comando demonstra obter um objeto de espaço de trabalho de análise de log e, em seguida, passar a saída para criar uma fonte de dados do aplicativo insights associados pela ID do recurso do aplicativo. 

## OS

### -ApplicationName
O nome do aplicativo vinculado.
...
O nome do grupo de recursos do aplicativo vinculado.
...
A ID de recurso do aplicativo vinculado.
...
A ID da assinatura do aplicativo vinculado.
...
### -Espaço de trabalho
O espaço de trabalho que conterá a fonte de dados.
...
### -WorkspaceName
O nome do espaço de trabalho que conterá a fonte de dados.
