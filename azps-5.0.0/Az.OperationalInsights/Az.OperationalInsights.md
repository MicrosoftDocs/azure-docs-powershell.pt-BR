...
Liste os espaços de trabalho excluídos.
...
Obter ou listar o serviço vinculado para o espaço de trabalho
...
Criar conta de armazenamento vinculado para o espaço de trabalho
...
Desvincular serviço para espaço de trabalho

### [Remove-AzOperationalInsightsLinkedStorageAccount](Remove-AzOperationalInsightsLinkedStorageAccount.md)
Excluir conta de armazenamento vinculado do espaço de trabalho
...
serviço de link para espaço de trabalho

### [Set-AzOperationalInsightsLinkedStorageAccount](Set-AzOperationalInsightsLinkedStorageAccount.md)
Definir conta de armazenamento vinculado para o espaço de trabalho
