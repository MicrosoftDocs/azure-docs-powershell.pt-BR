...
### Exemplo 1: atualizar um monitor SAP por nome
```powershell
...
Esses comandos atualizam um monitor SAP por nome.
...
Esses comandos atualizam um monitor SAP por objeto.
