...
## Sinopse
Exclui o provedor de recursos personalizado.
...
### Exemplo 1: remover um provedor personalizado.
```powershell
PS C:\> PS C:\> Remove-AzCustomProvider -ResourceGroupName myRg -Name Namespace.Type
```

Remover um provedor personalizado

### Exemplo 2: remover um provedor personalizado com PassThru
```powershell
...
Remova um provedor personalizado, usando o recurso PassThru para indicar êxito ou falha.
