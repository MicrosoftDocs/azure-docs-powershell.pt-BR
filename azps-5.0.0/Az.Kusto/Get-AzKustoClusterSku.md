...
O comando acima lista os SKUs qualificados.

### Exemplo 2: lista SKUs qualificados para um cluster específico
```powershell
...
O comando acima lista os SKUs qualificados para um cluster específico
