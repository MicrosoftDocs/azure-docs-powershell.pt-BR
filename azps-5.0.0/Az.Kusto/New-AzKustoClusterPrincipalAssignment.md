...
### Exemplo 1: criar um cluster de Kusto de principalAssignment
```powershell
...
O comando acima cria um cluster de Kusto de principalAssignment
...
A ID da entidade de segurança atribuída à entidade de segurança do grupo.
...
### -Função
Função de entidade de segurança de cluster.
