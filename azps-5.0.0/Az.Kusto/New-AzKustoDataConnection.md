...
### Exemplo 2: criar uma nova conexão de dados do EventGrid
```powershell
...
O comando acima cria uma nova conexão de dados IotHub chamada "myiothubdc" para o banco de dados "mykustodatabase" no cluster "testnewkustocluster".
