...
## Sinopse
 Invoca outra instância de uma execução de gatilho.
...
## DESCRITIVO
O comando **Invoke-AzDataFactoryV2TriggerRun** inicia outra instância de um gatilho executado com uma nova ID de execução do disparador.
...
```
Inicia outra instância de um gatilho executado com uma nova ID de execução do disparador, mantendo o mesmo windowStartTime e windowEndTime como o gatilho original é executado.
