...
## DESCRITIVO
O cmdlet Update-AzAutomationSourceControl modifica o valor de um campo em um controle de origem na automação do Azure.
...
Atualiza um controle de origem de automação do Azure. (gerado automaticamente)
