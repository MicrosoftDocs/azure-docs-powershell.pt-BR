...
## DESCRITIVO
O cmdlet **Get-AzAutomationDscOnboardingMetaconfig** cria os arquivos MOF (formato de objeto gerenciado) de metadados de configuração de estado desejado do APS (MOF).
