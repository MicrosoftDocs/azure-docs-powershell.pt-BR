...
## DESCRITIVO
O cmdlet **Wait-AzSynapseSparkJob** aguarda a conclusão de um trabalho de análise do Azure Synapse.
...
Este comando aguarda o trabalho com a ID especificada ser concluída.
...
### -SparkJobObject
Objeto de entrada de trabalho Spark, geralmente passado pelo pipeline.
...
### -TimeoutInSeconds
O período máximo de tempo de espera antes do erro. O valor padrão é para nunca tempo limite.
...
O intervalo de sondagem entre as verificações do status do trabalho, em segundos.
