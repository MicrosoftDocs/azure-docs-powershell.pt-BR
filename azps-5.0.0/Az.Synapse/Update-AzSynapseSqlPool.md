...
## DESCRITIVO
O cmdlet **Update-AzSynapseSqlPool** atualiza um pool SQL do Azure Synapse Analytics.
...
Esse comando atualiza um pool SQL do Azure Synapse Analytics.
...
Esse comando atualiza um pool do SQL do Azure Synapse Analytics por meio do pipeline.
...
Esse comando atualiza um pool SQL do Azure Synapse Analytics com ID do recurso.
