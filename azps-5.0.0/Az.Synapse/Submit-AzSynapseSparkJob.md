...
## DESCRITIVO
O cmdlet **Submit-AzSynapseSparkJob** envia um trabalho do analítico do Synapse.
...
Esse comando envia um trabalho do Spark de análise Synapse.
...
Esse comando envia um trabalho do Synapse analítico Spark .NET.
...
Esse comando envia um trabalho de Synapse analítico PySpark.

## OS

### -CommandLineArgument
Argumentos opcionais para o trabalho. por exemplo, "--iteração 10000--tempo limite 20s"
...
### -Idioma
Idioma do trabalho para enviar.
...
Obrigatório para o serviço Spark e .NET Spark.
