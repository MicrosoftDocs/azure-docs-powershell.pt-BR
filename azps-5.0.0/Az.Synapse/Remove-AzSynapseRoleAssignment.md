...
## DESCRITIVO
O cmdlet **Remove-AzSynapseRoleAssignment** exclui permanentemente uma atribuição de função de análise do Azure Synapse.
...
Esse comando exclui uma atribuição de função de análise do Azure Synapse com uma ID de atribuição de função.
...
Esse comando exclui uma atribuição de função de análise do Azure Synapse com um nome de função e um nome de usuário principal.
...
Esse comando exclui uma atribuição de função de análise do Azure Synapse com uma ID de atribuição de função por meio do pipeline.
