...
## DESCRITIVO
O cmdlet **set-AzSynapseDataFlow** cria um fluxo de dados ou atualiza um fluxo de dados existente no espaço de trabalho.
...
Esse comando cria um fluxo de dados denominado ContosoDataFlow no espaço de trabalho chamado ContosoWorkspace.
O comando baseia o fluxo de dados nas informações na DataFlow.jsem arquivo.
