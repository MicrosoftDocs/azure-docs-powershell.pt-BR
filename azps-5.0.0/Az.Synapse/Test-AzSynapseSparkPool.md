...
## DESCRITIVO
O cmdlet **Test-AzSynapseSparkPool** verifica a existência de um pool Spark do Analytics do Synapse.
...
Esse comando verifica a existência do pool do Spark especificado.
