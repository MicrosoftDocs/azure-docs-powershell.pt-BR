...
## DESCRITIVO
O cmdlet **Update-AzSynapseIntegrationRuntimeNode** atualiza propriedades do nó de tempo de execução de integração de hospedagem interna em um espaço de trabalho. Atualmente só dá suporte à atualização de ' ConcurrentJobsLimit '.
