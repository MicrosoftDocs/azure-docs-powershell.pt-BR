...
## DESCRITIVO
O cmdlet **Test-AzSynapseWorkspace** verifica a existência de um espaço de trabalho analítico do Synapse.
...
Esse comando verifica a existência de um espaço de trabalho de análise do Synapse.
