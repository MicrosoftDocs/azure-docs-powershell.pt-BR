...
### Exemplo 1: remover um HSM dedicado por nome
```powershell
PS C:\> Remove-AzDedicatedHsm -Name hsm-7t2xaf -ResourceGroupName lucas-manual-test

```

Este commnad remove um HSM (módulo de segurança de hardware) por nome.
...
Isso commnad remove um HSM dedicado por objeto.
