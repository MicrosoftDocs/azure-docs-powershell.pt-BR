...
### -Painel
A definição de recurso de painel compartilhado.
Para construir, consulte a seção de notas para propriedades do painel e crie uma tabela de hash.
...
Os modelos de painel podem ser baixados do Portal.
...
PAINEL <IDashboard> : a definição de recurso de painel compartilhado.
