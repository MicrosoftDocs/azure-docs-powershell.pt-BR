...
## DESCRITIVO
O cmdlet **Remove-AzIntegrationAccountBatchConfiguration** remove uma configuração em lotes de uma conta de integração.

## EXEMPLOS

### Exemplo 1: remover uma configuração em lotes por parâmetros
```powershell
...
Remove a configuração em lotes chamada "sampleBatchConfig" localizada na conta de integração "sampleIntegrationAccount".
...
### -PassThru
Retorna se o comando foi bem-sucedido ou não.
