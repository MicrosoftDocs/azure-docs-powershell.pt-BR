...
### Exemplo 1: criar um ponto de extremidade privado

O exemplo a seguir cria um ponto de extremidade particular com uma ID de serviço de link particular específico na sub-rede especificada em uma rede virtual.
...
Use a solicitação manual para estabelecer a conexão.
...
Especifica um local para o ponto de extremidade privado. Use [Get-AzLocation](/powershell/module/az.resources/get-azlocation) para determinar valores válidos para esse parâmetro.
...
Nome do ponto de extremidade privado.
...
A ID do recurso para conectar o ponto de extremidade privado.
...
A sub-rede do ponto de extremidade privado.
