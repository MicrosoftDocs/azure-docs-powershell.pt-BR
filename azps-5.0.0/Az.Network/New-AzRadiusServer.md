...
## DESCRITIVO
O cmdlet New-AzRadiusServer cria uma configuração de servidor RADIUS externo para ser usada no gateway de rede virtual e na configuração do servidor VPN.
...
Criar várias configurações de servidor RADIUS externo a serem usadas para configurar o P2S em um novo gateway de rede virtual.
...
### -RadiusServerAddress
Endereço do servidor RADIUS externo
...
### -RadiusServerScore
Pontuação do servidor RADIUS externo
...
### -RadiusServerSecret
Segredo do servidor RADIUS externo
