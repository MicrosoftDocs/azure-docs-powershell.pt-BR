...
### Exemplo 1: criar uma regra para permitir todo o tráfego HTTPS de 10.0.0.0
```powershell
...
### Exemplo 2: criar uma regra para permitir o WindowsUpdate para a sub-rede 10.0.0.0/24
```powershell
...
O caractere de asterisco ' *', é aceito apenas como o primeiro caractere de um FQDN na lista. Quando usado, o asterisco corresponde a qualquer número de caracteres. (por exemplo, '* MSN.com ' corresponderá MSN.com e todos os seus subdomínios)
