...
Adiciona um erro personalizado a um gateway do aplicativo.
...
Adiciona um erro personalizado a um ouvinte HTTP de um aplicativo gateway.
...
Adiciona um conjunto de regras de regravação a um gateway de aplicativo.
...
Adiciona uma delegação a uma sub-rede.
...
Adiciona um pool de NAT de entrada a um balanceador de carga.
...
Adiciona uma definição de política de ponto de extremidade de serviço a uma política especificada.

### [Add-AzVirtualHubRoute](Add-AzVirtualHubRoute.md)
Cria um objeto VirtualHubRoute que pode ser passado como parâmetro para o comando Add-AzVirtualHubRouteTable. 

### [Add-AzVirtualHubRouteTable](Add-AzVirtualHubRouteTable.md)
Cria um recurso de tabela de rota de Hub virtual que é filho de VirtualHub.
...
### [Aprovar-AzPrivateEndpointConnection](Approve-AzPrivateEndpointConnection.md)
Aprova uma conexão de ponto de extremidade particular.

### [Deny-AzPrivateEndpointConnection](Deny-AzPrivateEndpointConnection.md)
nega uma conexão de ponto de extremidade particular.

### [Desconectar-AzP2SVpnGatewayVpnConnection](Disconnect-AzP2SVpnGatewayVpnConnection.md)
Desconectar conexões de cliente VPN conectadas com determinado gateway VPN P2s

### [Desconectar-AzVirtualNetworkGatewayVpnConnection](Disconnect-AzVirtualNetworkGatewayVpnConnection.md)
...
Obtém o conjunto de regras de regravação de um gateway de aplicativo.
...
Obtém o certificado raiz confiável com um nome específico do gateway do aplicativo.
...
Retornar tipos de ponto de extremidade privados disponíveis no local.
...
Obtém um recurso bastião ou recursos bastiões.
...
Obtém uma configuração de emparelhamento de conexão cruzada do ExpressRoute.

### [Get-AzExpressRouteCrossConnectionRouteTable](Get-AzExpressRouteCrossConnectionRouteTable.md)
Obtém uma tabela de rota de uma conexão cruzada do ExpressRoute.
...
Obtém um recurso ExpressRouteGateway usando ResourceGroupName e GATEWAYNAME ou lista todos os gateways por ResourceGroupName ou SubscriptionId.
...
Obtém uma política de firewall do Azure

### [Get-AzFirewallPolicyRuleCollectionGroup](Get-AzFirewallPolicyRuleCollectionGroup.md)
Obtém um grupo de regras de política de firewall do Azure
...
Obtém uma ou mais configurações de pool de NAT de entrada de um balanceador de carga.
...
Obtém um recurso de log de fluxo ou uma lista de recursos de log de fluxo na assinatura especificada e na região.
...
Obtém um P2SVpnGateway existente em VirtualHub.

### [Get-AzP2sVpnGatewayConnectionHealth](Get-AzP2sVpnGatewayConnectionHealth.md)
Obtém o ponto de aggregared atual para informações de integridade de conexões de site do P2SVpnGateway.
...
Gera e retorna uma URL SAS para o cliente baixar o perfil de VPN da configuração do cliente do site para que ele tenha o ponto para a conectividade do site com o P2SVpnGateway.
...
Obter um SecurityPartnerProvider do Azure

### [Get-AzServiceEndpointPolicy](Get-AzServiceEndpointPolicy.md)
Obtém uma política de ponto de extremidade do serviço.

### [Get-AzServiceEndpointPolicyDefinition](Get-AzServiceEndpointPolicyDefinition.md)
Obtém uma definição de política de ponto de extremidade do serviço.
...
Obtém uma tabela de rota de Hub virtual em um hub virtual ou lista todas as tabelas de rotas em um hub virtual.
...
Permite que os usuários baixem facilmente o pacote de perfil VPN gerado usando o New-AzVpnClientConfiguration commandlet.
...
Obtém um VpnServerConfiguration existente para a conectividade do ponto para o site.
...
Cria uma configuração de AutoEscala para o gateway do aplicativo.

### [New-AzApplicationGatewayBackendAddressPool](New-AzApplicationGatewayBackendAddressPool.md)
Cria um pool de endereços back-end para um gateway de aplicativo.

### [New-AzApplicationGatewayBackendHttpSetting](New-AzApplicationGatewayBackendHttpSetting.md)
Cria uma configuração HTTP back-end para um gateway de aplicativo.
...
Cria uma variável de correspondência para a condição do firewall.

### [New-AzApplicationGatewayFirewallPolicy](New-AzApplicationGatewayFirewallPolicy.md)
Cria uma política de firewall do Application Gateway.
...
Cria uma regra de regravação para um gateway de aplicativo.

### [New-AzApplicationGatewayRewriteRuleActionSet](New-AzApplicationGatewayRewriteRuleActionSet.md)
Cria uma ação de regra de regravação definida para um gateway de aplicativo.
...
Cria uma configuração de URL de regra de regravação para um gateway de aplicativo.
...
Cria uma conexão do ExpressRoute que conecta um gateway do ExpressRoute a um circuito do ExpressRoute no local.

### [New-AzExpressRouteGateway](New-AzExpressRouteGateway.md)
Cria um gateway ExpressRoute escalável.

### [New-AzExpressRoutePort](New-AzExpressRoutePort.md)
Cria um ExpressRoutePort do Azure.

### [New-AzExpressRoutePortIdentity](New-AzExpressRoutePortIdentity.md)
Cria um ExpressRoutePortIdentity do Azure.
...
Endereços IP assoicated ao firewall no virtual Hub

### [New-AzFirewallHubPublicIpAddress](New-AzFirewallHubPublicIpAddress.md)
Assoicated de IP público para o firewall no virtual Hub
...
Criar uma nova regra de aplicativo da política de firewall do Azure
...
Criar uma nova coleção de regras de NAT da política de firewall do Azure

### [New-AzFirewallPolicyNetworkRule](New-AzFirewallPolicyNetworkRule.md)
Criar uma nova regra de rede de política de firewall do Azure

### [New-AzFirewallPolicyNetworkRule](New-AzFirewallPolicyNatRule.md)
Criar uma nova regra de NAT da política de firewall do Azure

### [New-AzFirewallPolicyRuleCollectionGroup](New-AzFirewallPolicyRuleCollectionGroup.md)
Criar um novo grupo de coleção de regras de firewall do Azure
...
Criar uma nova lista branca de inteligência de ameaças para o Firewall do Azure
...
Cria um novo IpconfigurationBgpPeeringAddressObject
...
Cria uma configuração de pool NAT de entrada para um balanceador de carga.
...
Cria um recurso de monitor de conexão.
...
Criar uma configuração de teste de monitor de conexão.
...
Crie um novo P2SVpnGateway em VirtualHub para obter a conectividade do site.
...
Cria uma configuração de servidor RADIUS externo
...
Cria um SecurityPartnerProvider do Azure.

### [New-AzServiceEndpointPolicy](New-AzServiceEndpointPolicy.md)
Cria uma política de ponto de extremidade do serviço.

### [New-AzServiceEndpointPolicyDefinition](New-AzServiceEndpointPolicyDefinition.md)
Cria uma definição de política de ponto de extremidade do serviço.
...
O cmdlet New-AzVirtualHubVnetConnection cria um recurso HubVirtualNetworkConnection que peer uma rede virtual para o Hub virtual do Azure.
...
Cria um recurso VirtualNetworkTap.

### [New-AzVirtualRouter](New-AzVirtualRouter.md)
Cria um VirtualRouter do Azure.
...
Cria um objeto VpnSiteLink do Azure.

### [New-AzVpnSiteLinkConnection](New-AzVpnSiteLinkConnection.md)
Cria um objeto VpnSiteLinkConnection do Azure.
...
Remove a configuração de autoescala de um aplicativo gateway.
...
Remove um erro personalizado de um gateway de aplicativo.

### [Remove-AzApplicationGatewayFirewallPolicy](Remove-AzApplicationGatewayFirewallPolicy.md)
Remove uma política de firewall do Application Gateway.
...
Remove um erro personalizado de um ouvinte HTTP de um gateway de aplicativo.
...
Remove um conjunto de regras de regravação de um Application Gateway.
...
Remove um ExpressRouteConnection.

### [Remove-AzExpressRouteCrossConnectionPeering](Remove-AzExpressRouteCrossConnectionPeering.md)
Remove uma configuração de emparelhamento de conexão cruzada do ExpressRoute.

### [Remove-AzExpressRouteGateway](Remove-AzExpressRouteGateway.md)
O cmdlet Remove-AzExpressRouteGateway remove um gateway do Azure ExpressRoute. Esse é um gateway específico para a conectividade definida pelo software da WAN virtual WAN.
...
Remove uma identidade de um ExpressRoutePort.

### [Remove-AzFirewall](Remove-AzFirewall.md)
Remover um firewall.

### [Remove-AzFirewallPolicy](Remove-AzFirewallPolicy.md)
Remove uma política de firewall do Azure
...
Exclui um IpAllocation do Azure.

### [Remove-AzIpGroup](Remove-AzIpGroup.md)
Exclui um IpGroup do Azure.
...
Remove uma configuração de pool NAT de entrada de um balanceador de carga.
...
Remova o recurso de gateway NAT.
...
Remove uma política de ponto de extremidade do serviço.

### [Remove-AzServiceEndpointPolicyDefinition](Remove-AzServiceEndpointPolicyDefinition.md)
Remove uma definição de política de ponto de extremidade do serviço.
...
O cmdlet Remove-AzVirtualHubVnetConnection remove uma conexão de rede virtual do Azure que seja uma VNET remota para a VNET do Hub.
...
Remove um toque de rede virtual.
...
O cmdlet Remove-AzVpnGateway remove um gateway de VPN do Azure. Esse é um gateway específico para a conectividade definida pelo software da WAN virtual WAN.

### [Remove-AzVpnServerConfiguration](Remove-AzVpnServerConfiguration.md)
Remove um VpnServerConfiguration existente.
...
Atualiza a configuração de autoescala de um gateway de aplicativo.
...
Atualiza uma política de firewall do Application Gateway.
...
Modifica um conjunto de regras de regravação para um gateway de aplicativo.
...
Atualiza um certificado raiz confiável de um gateway de aplicativo.
...
Atualiza uma configuração de conexão de circuito criada em pares privados para um circuito de rota expressa. 
...
Atualiza uma conexão de rota expressa criada entre um gateway de rota expressa e o emparelhamento de circuito de rota expressa no local.

### [Set-AzExpressRouteCrossConnection](Set-AzExpressRouteCrossConnection.md)
Modifica uma conexão cruzada do ExpressRoute.

### [Set-AzExpressRouteGateway](Set-AzExpressRouteGateway.md)
Atualiza um gateway ExpressRoute dimensionável.
...
salva um grupo da coleção de regras de firewall do Azure modificada

### [Set-AzIpAllocation](Set-AzIpAllocation.md)
Salva uma IpAllocation modificada.

### [Set-AzIpGroup](Set-AzIpGroup.md)
Salva um firewall modificado.

### [Set-AzLoadBalancer](Set-AzLoadBalancer.md)
Atualiza um balanceador de carga.
...
Define uma configuração de pool NAT de entrada para um balanceador de carga.
...
Atualize o recurso de gateway NAT com endereço IP público, prefixo de IP público e IdleTimeoutInMinutes.

### [Set-AzNetworkInterface](Set-AzNetworkInterface.md)
Atualiza uma interface de rede.

### [Set-AzNetworkInterfaceIpConfig](Set-AzNetworkInterfaceIpConfig.md)
Atualiza uma configuração de IP para uma interface de rede.

### [Set-AzNetworkInterfaceTapConfig](Set-AzNetworkInterfaceTapConfig.md)
Atualiza uma configuração de toque para uma interface de rede.
...
Atualiza um grupo de segurança de rede.
...
Atualiza um estado de conexão de ponto de extremidade privado no serviço de link particular.
...
Modifica a regra de filtro de rota de um filtro de rota.
...
Atualiza uma definição de política de ponto de extremidade do serviço.

### [Set-AzVirtualHub](Set-AzVirtualHub.md)
Modifica um hub virtual para adicionar uma tabela de roteiros do HUb virtual a ele.
...
Atualiza uma rede virtual, toque em.
...
Inicia a operação de captura de pacote em uma conexão de gateway de rede virtual.

### [Start-AzVirtualnetworkGatewayPacketCapture](Start-AzVirtualnetworkGatewayPacketCapture.md)
Inicia a operação de captura de pacote em um gateway de rede virtual.

### [Parar-AzApplicationGateway](Stop-AzApplicationGateway.md)
...
### [Parar-AzVirtualNetworkGatewayConnectionPacketCapture](Stop-AzVirtualNetworkGatewayConnectionPacketCapture.md)
Interrompe a operação de captura de pacote em uma conexão de gateway de rede virtual

### [Parar-AzVirtualNetworkGatewayPacketCapture](Stop-AzVirtualNetworkGatewayPacketCapture.md)
Interrompe a operação de captura de pacote em um gateway de rede virtual.
...
Atualize um P2SVpnGateway existente em VirtualHub para conectividade com o ponto para o site.
...
Atualizar um par em um VirtualRouter do Azure
