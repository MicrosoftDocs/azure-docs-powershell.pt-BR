...
A seguir, você criará um grupo de recursos, uma WAN virtual e uma VpnSite com 1 VpnSiteLinks nos EUA no grupo de recursos "testRG" do Azure.

### Exemplo 2

Cria um objeto VpnSiteLink do Azure. (gerado automaticamente)
...
### -BGPAsn
A ASN do BGP para este VpnSiteLink.
...
### -BGPPeeringAddress
O endereço de emparelhamento BGP para este VpnSiteLink.
