...
## DESCRITIVO
O cmdlet **Remove-AzApplicationGatewayTrustedRootCertificate** remove um certificado raiz confiável de um Application Gateway existente.
...
O segundo comando Remove o certificado raiz confiável chamado myRootCA do gateway do aplicativo armazenado em $gw.
