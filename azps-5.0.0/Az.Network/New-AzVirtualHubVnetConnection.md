...
O cmdlet New-AzVirtualHubVnetConnection cria um recurso HubVirtualNetworkConnection que peer uma rede virtual para o Hub virtual do Azure. (gerado automaticamente)
...
```
A seguir, você criará uma nova configuração de roteamento e criará rotas estáticas na configuração de roteamento com o próximo nó como um endereço IP especificado. Essa configuração de roteamento pode então ser passada para o comando New-AzVirtualHubVnetConnection como o parâmetro-RoutingConfiguration.
...
A rede virtual remota à qual a conexão de rede virtual do Hub está conectada.
