...
## DESCRITIVO
O cmdlet **Remove-AzPrivateDnsZoneGroup** remove um grupo de zonas DNS. 
...
Exemplo acima remove um Grup de zona DNS chamado dnsgroup1 do Endpoint Test-PR-Endpoint.
