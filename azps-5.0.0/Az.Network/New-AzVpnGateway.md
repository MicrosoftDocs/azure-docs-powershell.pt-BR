...
New-AzVpnGateway cria um gateway VPN escalável. Esta é uma conectividade definida por software para conexões de site para site dentro do VirtualHub. 

Esse gateway é redimensionado e dimensionado com base na unidade de escala especificada neste cmdlet Set-AzVpnGateway. 

Uma conexão é configurada a partir de uma ramificação/site conhecida como VPNSite ao gateway expansível. Cada conexão é composta por 2 Active-Active túneis.

O VpnGateway estará no mesmo local do VirtualHub referenciado.
...
### -VpnConnection
A lista de VpnConnections que esse VpnGateway precisa ter.
