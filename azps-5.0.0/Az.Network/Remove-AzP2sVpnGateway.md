...
## DESCRITIVO
O cmdlet **Remove-AzP2sVpnGateway** permite remover um P2SVpnGateway existente em VirtualHub. Todo o ponto para a conectividade dos clientes do site falhará depois que o P2SVpnGateway for removido.
...
O cmdlet **Remove-AzP2sVpnGateway** permite remover um P2SVpnGateway existente em VirtualHub.
...
### -ResourceId
A ID de recurso do Azure para o p2sVpnGateway a ser excluído.
