...
## DESCRITIVO
O cmdlet **set-AzPrivateEndpointConnection** atualiza um estado de conexão de ponto de extremidade privado em um serviço de link privado
...
Este exemplo atualiza um estado de conexão de ponto de extremidade particular para aprovado.
