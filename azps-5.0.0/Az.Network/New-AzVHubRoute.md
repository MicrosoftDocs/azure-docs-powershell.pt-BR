...
## Sinopse
Cria um objeto VHubRoute que pode ser passado como parâmetro para o comando New-AzVHubRouteTable.
...
O comando acima criará um objeto VHubRoute com nextHop como o firewall especificado que pode ser adicionado a um recurso do VHubRouteTable.
...
O comando acima criará um objeto VHubRoute com nextHop como o hubVnetConnection especificado que pode então ser adicionado a um recurso VHubRouteTable.
...
```
Os comandos acima receberão a RoutingConfiguration de um AzVHubRoute já existente e, em seguida, adicionarão uma rota estática na conexão. Como alternativa, se você espera criar uma nova conexão com a rota estática dentro dela, consulte o exemplo 1 [aqui.](New-AzRoutingConfiguration.md)
## OS
