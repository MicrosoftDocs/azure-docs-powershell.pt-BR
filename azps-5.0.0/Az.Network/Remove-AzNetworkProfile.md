...
## DESCRITIVO
O cmdlet **Remove-AzNetworkProfile** remove um perfil de rede se não for criada nenhuma interface de rede de contêiner (conforme o contraste com uma **configuração** de interface de rede de contêiner).
...
Isso remove o perfil de rede com o nome NP1 da Rg1 do grupo de recursos.
...
### -ResourceId
A ID do recurso do Gerenciador de recursos do Azure do perfil de rede.
