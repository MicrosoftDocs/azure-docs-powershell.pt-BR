...
## DESCRITIVO
O cmdlet **Update-AzCustomIpPrefix** permite que o usuário use a Comissão ou a descomissionação de seu CustomIpPrefix ou edite as marcas do recurso.

## EXEMPLOS

### Exemplo 1: Commission a CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Commission
```

O comando acima iniciará o processo de comissões do CustomIpPrefix.

### Exemplo 2: encerrar o CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Decommission
```

O comando acima iniciará o processo de descomissionamento do CustomIpPrefix.

### Exemplo 3: atualizar marcas para o CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Tag $tags
```

O comando acima atualizará as marcas para o CustomIpPrefix.
...
### -InputObject
O CustomIpPrefix a ser definido.
