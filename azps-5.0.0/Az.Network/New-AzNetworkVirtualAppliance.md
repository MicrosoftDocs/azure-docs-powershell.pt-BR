...
A URL do blob de configuração de inicialização.
...
A configuração Cloudinit como texto sem formatação.
...
A URL de armazenamento de blob de configuração do Cloudinit.
