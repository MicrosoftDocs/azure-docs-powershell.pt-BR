...
## Sinopse
Cria um pool de endereços back-end em um loadbalancer. 
...
## DESCRITIVO
Cria um pool de endereços back-end em um loadbalancer. Permite que o specifiying seja uma matriz de PSLoadBalancerBackendAddress. 
## EXEMPLOS
