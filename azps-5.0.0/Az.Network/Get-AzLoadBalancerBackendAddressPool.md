...
## Sinopse
Get-AzLoadBalancerBackendAddressPool recupera um ou mais pools de endereços back-end associados a um balanceador de carga. 
...
### -Loadbalancer
{{Filler descrição do loadbalador}}
...
### -Nome
O nome do pool de endereços back-end.
