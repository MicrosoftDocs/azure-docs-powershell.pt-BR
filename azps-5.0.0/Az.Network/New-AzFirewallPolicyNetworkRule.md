...
## DESCRITIVO
O cmdlet **New-AzFirewallPolicyNetworkRule** cria uma regra de rede para uma política de firewall do Azure.
...
Este exemplo cria uma regra de rede com o endereço de origem, o protocolo, o endereço de destino e a porta de destino
...
### -DestinationIpGroup
O ipgroups de destino da regra
