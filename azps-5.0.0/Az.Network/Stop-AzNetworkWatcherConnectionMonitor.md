...
## DESCRITIVO
O cmdlet Stop-AzNetworkWatcherConnectionMonitor interrompe o monitor de conexão especificado.
...
Parar um monitor de conexão. (gerado automaticamente)
