...
## DESCRITIVO
O cmdlet **Remove-AzRouteConfig** remove uma rota de uma tabela de rota do Azure.
...
O cmdlet atual remove a rota chamada Route02 e passa o resultado para o cmdlet **set-AzRouteTable** , que atualiza a tabela para refletir suas alterações.
