...
## DESCRITIVO
O cmdlet **New-AzLoadBalancerRuleConfig** cria uma configuração de regra para um balanceador de carga do Azure.

## EXEMPLOS

### Exemplo 1: criando uma configuração de regra para um balanceador de carga do Azure
```powershell
...
Os primeiros três comandos configuram um IP público, um front-end e um teste para a configuração de regra no comando por diante. O comando avançar cria uma nova regra chamada MyLBrule com determinadas especificações.

## OS

### -BackendAddressPool
Especifica um objeto **BackendAddressPool** para associar a uma configuração de regra de balanceador de carga.
...
### -BackendPort
Especifica a porta back-end para o tráfego correspondente a essa configuração de regra de balanceador de carga.
...
### -Nome
Especifica o nome da regra de balanceamento de carga que este cmdlet cria.
...
### -Protocolo
Especifica o protocolo que corresponde a uma configuração de regra de balanceador de carga.
