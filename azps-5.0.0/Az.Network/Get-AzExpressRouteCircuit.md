...
## DESCRITIVO
O cmdlet **Get-AzExpressRouteCircuit** é usado para recuperar um objeto de circuito do ExpressRoute da sua assinatura. O objeto de circuito retornado pode ser usado como entrada para outros cmdlets que operam em circuitos do ExpressRoute.

## EXEMPLOS

### Exemplo 1: obter o circuito do ExpressRoute
```
...
Obter um circuito do ExpressRoute específico com o nome "testrg" e ResourceGroupName "teste"

### Exemplo 2: listar os circuitos do ExpressRoute usando a filtragem
```
...
Obter todos os circuitos do ExpressRoute cujo nome começa com "Test".
...
### -Nome
O nome do circuito do ExpressRoute.
