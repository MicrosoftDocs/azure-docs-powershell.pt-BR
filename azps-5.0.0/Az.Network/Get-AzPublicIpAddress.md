...
### Exemplo 1: obter um recurso de IP público
```powershell
...
Esse comando obtém um recurso de endereço IP público com o nome myPublicIp na myRg do grupo de recursos.

### Exemplo 2: obter recursos de IP público usando a filtragem
```powershell
...
Esse comando obtém todos os recursos de endereço IP público cujo nome começa com myPublicIp.
...
### -IpConfigurationName
Nome de configuração de IP da interface de rede.
...
### -Nome
Especifica o nome do endereço IP público que esse cmdlet obtém.
