...
#### <a name="azurermdatalakestore"></a><span data-ttu-id="cd7f6-114">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="cd7f6-114">AzureRM.DataLakeStore</span></span>
...
#### <a name="azurermcognitiveservices"></a><span data-ttu-id="cd7f6-131">AzureRM.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="cd7f6-131">AzureRM.CognitiveServices</span></span>
...
#### <a name="azurermrediscache"></a><span data-ttu-id="cd7f6-151">AzureRM.RedisCache</span><span class="sxs-lookup"><span data-stu-id="cd7f6-151">AzureRM.RedisCache</span></span>
...
## <a name="690---september-2018"></a><span data-ttu-id="cd7f6-165">6.9.0 - setembro de 2018</span><span class="sxs-lookup"><span data-stu-id="cd7f6-165">6.9.0 - September 2018</span></span>
...
#### <a name="azurermdns"></a><span data-ttu-id="cd7f6-183">AzureRM.Dns</span><span class="sxs-lookup"><span data-stu-id="cd7f6-183">AzureRM.Dns</span></span>
...
* <span data-ttu-id="cd7f6-204">Novos cmdlets adicionados para o recurso: Firewall do Azure via ARM</span><span class="sxs-lookup"><span data-stu-id="cd7f6-204">Added new cmdlets for feature: Azure Firewall via ARM</span></span>
...
* <span data-ttu-id="cd7f6-215">Suporte adicionado para o certificado de Raiz Confiável e a configuração de Dimensionamento automático no Gateway de Aplicativo</span><span class="sxs-lookup"><span data-stu-id="cd7f6-215">Added support for Trusted Root certificate and Autoscale configuration in Application Gateway</span></span>
  ...
  - <span data-ttu-id="cd7f6-226">Cmdlets atualizados com o parâmetro opcional -TrustedRootCertificate</span><span class="sxs-lookup"><span data-stu-id="cd7f6-226">Cmdlets updated with optonal parameter -TrustedRootCertificate</span></span>
      ...
      - <span data-ttu-id="cd7f6-228">Set-AzureRmApplicationGateway</span><span class="sxs-lookup"><span data-stu-id="cd7f6-228">Set-AzureRmApplicationGateway</span></span>
...
* <span data-ttu-id="cd7f6-256">Adicionando cmdlets para delegação da sub-rede.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-256">Adding cmdlets for subnet delegation.</span></span>
  - <span data-ttu-id="cd7f6-257">New-AzureRmDelegation: cria uma nova delegação que pode ser adicionada a uma sub-rede</span><span class="sxs-lookup"><span data-stu-id="cd7f6-257">New-AzureRmDelegation: Creates a new delegation, which can be added to a subnet</span></span>
...
#### <a name="azurermsignalr"></a><span data-ttu-id="cd7f6-274">AzureRM.SignalR</span><span class="sxs-lookup"><span data-stu-id="cd7f6-274">AzureRM.SignalR</span></span>
...
## <a name="681---august-2018"></a><span data-ttu-id="cd7f6-294">6.8.1 - Agosto de 2018</span><span class="sxs-lookup"><span data-stu-id="cd7f6-294">6.8.1 - August 2018</span></span>
...
* <span data-ttu-id="cd7f6-326">Suporte adicionado para o método de roteamento de sub-rede</span><span class="sxs-lookup"><span data-stu-id="cd7f6-326">Added Support for the Subnet routing method</span></span>
    - <span data-ttu-id="cd7f6-327">Suporte para intervalos de endereços IP (sub-redes) em pontos de extremidade</span><span class="sxs-lookup"><span data-stu-id="cd7f6-327">Support for IP address ranges (subnets) in endpoints</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="cd7f6-342">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="cd7f6-342">AzureRM.Network</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="cd7f6-358">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="cd7f6-358">AzureRM.Websites</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="cd7f6-373">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="cd7f6-373">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermcognitiveservices"></a><span data-ttu-id="cd7f6-387">AzureRM.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="cd7f6-387">AzureRM.CognitiveServices</span></span>
...
#### <a name="azurermdatafactories"></a><span data-ttu-id="cd7f6-401">AzureRM.DataFactories</span><span class="sxs-lookup"><span data-stu-id="cd7f6-401">AzureRM.DataFactories</span></span>
...
#### <a name="azurermeventgrid"></a><span data-ttu-id="cd7f6-416">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="cd7f6-416">AzureRM.EventGrid</span></span>
...
#### <a name="azurermmachinelearningcompute"></a><span data-ttu-id="cd7f6-432">AzureRM.MachineLearningCompute</span><span class="sxs-lookup"><span data-stu-id="cd7f6-432">AzureRM.MachineLearningCompute</span></span>
...
#### <a name="azurermnotificationhubs"></a><span data-ttu-id="cd7f6-447">AzureRM.NotificationHubs</span><span class="sxs-lookup"><span data-stu-id="cd7f6-447">AzureRM.NotificationHubs</span></span>
...
#### <a name="azurermscheduler"></a><span data-ttu-id="cd7f6-484">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="cd7f6-484">AzureRM.Scheduler</span></span>
...
#### <a name="azurermservicebus"></a><span data-ttu-id="cd7f6-486">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="cd7f6-486">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="cd7f6-487">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-487">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="cd7f6-488">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="cd7f6-488">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="cd7f6-489">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-489">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="cd7f6-490">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="cd7f6-490">AzureRM.Sql</span></span>
* <span data-ttu-id="cd7f6-491">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-491">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermstorage"></a><span data-ttu-id="cd7f6-492">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="cd7f6-492">AzureRM.Storage</span></span>
* <span data-ttu-id="cd7f6-493">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-493">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermstreamanalytics"></a><span data-ttu-id="cd7f6-494">AzureRM.StreamAnalytics</span><span class="sxs-lookup"><span data-stu-id="cd7f6-494">AzureRM.StreamAnalytics</span></span>
* <span data-ttu-id="cd7f6-495">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-495">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermtags"></a><span data-ttu-id="cd7f6-496">AzureRM.Tags</span><span class="sxs-lookup"><span data-stu-id="cd7f6-496">AzureRM.Tags</span></span>
* <span data-ttu-id="cd7f6-497">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-497">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="cd7f6-498">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="cd7f6-498">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="cd7f6-499">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-499">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermusageaggregates"></a><span data-ttu-id="cd7f6-500">AzureRM.UsageAggregates</span><span class="sxs-lookup"><span data-stu-id="cd7f6-500">AzureRM.UsageAggregates</span></span>
* <span data-ttu-id="cd7f6-501">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-501">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="cd7f6-502">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="cd7f6-502">AzureRM.Websites</span></span>
* <span data-ttu-id="cd7f6-503">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-503">Updated to the latest version of the Azure ClientRuntime.</span></span>

## <a name="660---july-2018"></a><span data-ttu-id="cd7f6-504">6.6.0 – Julho de 2018</span><span class="sxs-lookup"><span data-stu-id="cd7f6-504">6.6.0 - July 2018</span></span>
#### <a name="general"></a><span data-ttu-id="cd7f6-505">Geral</span><span class="sxs-lookup"><span data-stu-id="cd7f6-505">General</span></span>
* <span data-ttu-id="cd7f6-506">Todos os arquivos de ajuda atualizados para incluir tipos corretos de entrada/saída e tipos de parâmetro completos.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-506">Updated all help files to include full parameter types and correct input/output types.</span></span>

#### <a name="azurermprofile"></a><span data-ttu-id="cd7f6-507">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="cd7f6-507">AzureRM.Profile</span></span>
* <span data-ttu-id="cd7f6-508">Biblioteca Common.Strategy atualizada para poder validar se a configuração atual de um recurso é compatível com o recurso de destino.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-508">Updated Common.Strategy library to be able to validate that the current config for a resource is compatible with the target resource.</span></span>
* <span data-ttu-id="cd7f6-509">Tipos de ps1xml adicionados a Common.Storage</span><span class="sxs-lookup"><span data-stu-id="cd7f6-509">Added ps1xml types to Common.Storage</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="cd7f6-510">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="cd7f6-510">Azure.Storage</span></span>
* <span data-ttu-id="cd7f6-511">Suporte adicionado para obter o Contexto de Armazenamento em DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="cd7f6-511">Added support for getting Storage Context from DefaultProfile</span></span>
* <span data-ttu-id="cd7f6-512">Ps1XmlAttribute adicionado às propriedades dos tipos de saída dos cmdlets.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-512">Added Ps1XmlAttribute to cmdlets output types properties.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="cd7f6-513">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="cd7f6-513">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="cd7f6-514">Problema corrigido https://github.com/Azure/azure-powershell/issues/6370</span><span class="sxs-lookup"><span data-stu-id="cd7f6-514">Fixed issue https://github.com/Azure/azure-powershell/issues/6370</span></span>
    - <span data-ttu-id="cd7f6-515">Corrigido o bug no Automapper para traduzir PsApiManagementApi em ApiContract</span><span class="sxs-lookup"><span data-stu-id="cd7f6-515">Fixed bug in Automapper to translate PsApiManagementApi to ApiContract</span></span>
* <span data-ttu-id="cd7f6-516">Problema corrigido https://github.com/Azure/azure-powershell/issues/6515</span><span class="sxs-lookup"><span data-stu-id="cd7f6-516">Fixed issue https://github.com/Azure/azure-powershell/issues/6515</span></span>
    - <span data-ttu-id="cd7f6-517">Corrigido o bug File.Save para não ficar sobrecarregado com o tipo de codificação</span><span class="sxs-lookup"><span data-stu-id="cd7f6-517">Fixed bug in File.Save to not overload with Encoding Type</span></span>
* <span data-ttu-id="cd7f6-518">Problema corrigido https://github.com/Azure/azure-powershell/issues/6560</span><span class="sxs-lookup"><span data-stu-id="cd7f6-518">Fixed issue https://github.com/Azure/azure-powershell/issues/6560</span></span>
    - <span data-ttu-id="cd7f6-519">Atualizado para a versão 4.0.3 NuGet que corrige a exceção de padrão em apiId</span><span class="sxs-lookup"><span data-stu-id="cd7f6-519">Upgraded to 4.0.3 Nuget version which fixes the pattern exception on apiId</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="cd7f6-520">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="cd7f6-520">AzureRM.Compute</span></span>
* <span data-ttu-id="cd7f6-521">Corrigido o problema com a criação de uma VM usando DiskFileParameterSet em New-AzureRmVm com falha devido à renomeação do tipo de conta de armazenamento PremiumLRS.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-521">Fix issue with creating a vm using DiskFileParameterSet in New-AzureRmVm failing because of PremiumLRS storage account type renaming.</span></span>
* <span data-ttu-id="cd7f6-522">Corrigir o cmdlet Invoke-AzureRmVMRunCommand</span><span class="sxs-lookup"><span data-stu-id="cd7f6-522">Fix Invoke-AzureRmVMRunCommand cmdlet</span></span>
* <span data-ttu-id="cd7f6-523">Atualizar Get-AzureRmAvailabilitySet para habilitar a lista de todos os conjuntos de disponibilidade em uma assinatura.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-523">Update Get-AzureRmAvailabilitySet to enable list all availability sets in a subscription.</span></span>  <span data-ttu-id="cd7f6-524">(O parâmetro ResouceGroupName agora é opcional.)</span><span class="sxs-lookup"><span data-stu-id="cd7f6-524">(ResouceGroupName parameter is now optional.)</span></span>
* <span data-ttu-id="cd7f6-525">Atualizar SimpleParameterSet de 'New-AzureRmVm' para habilitar rede acelerada em VMs qualificadas.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-525">Update SimpleParameterSet of 'New-AzureRmVm' to enable Accelerated Network on qualifying vms.</span></span>
* <span data-ttu-id="cd7f6-526">Atualizar o parâmetro simples New-AzureRmVmss configurado para falhar na criação de vmss quando o balanceador de carga especificado pelo usuário já existir.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-526">Update New-AzureRmVmss simple parameter set to fail creating the vmss when a user specified LB already exists.</span></span>
* <span data-ttu-id="cd7f6-527">Atualizar exemplo de New-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="cd7f6-527">Update example for New-AzureRmDisk</span></span>
* <span data-ttu-id="cd7f6-528">Adicionar exemplo de 'New-AzureRmVM'</span><span class="sxs-lookup"><span data-stu-id="cd7f6-528">Add example for 'New-AzureRmVM'</span></span>
* <span data-ttu-id="cd7f6-529">Atualizar descrição de Set-AzureRmVMOSDisk</span><span class="sxs-lookup"><span data-stu-id="cd7f6-529">Update description for Set-AzureRmVMOSDisk</span></span>
* <span data-ttu-id="cd7f6-530">Atualizar exemplo 1 de Set-AzureRmVMBginfoExtension para corrigir a ortografia e o prefixo.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-530">Update Example 1 for Set-AzureRmVMBginfoExtension to correct spelling and prefix.</span></span> 

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="cd7f6-531">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="cd7f6-531">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="cd7f6-532">Atualizado a versão do SDK do .NET do ADF para 1.1.0.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-532">Updated the ADF .Net SDK version to 1.1.0.</span></span>
* <span data-ttu-id="cd7f6-533">Suporte ao compartilhamento de tempo de execução da integração auto-hospedada entre as fábricas de dados.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-533">Support self-hosted integration runtime sharing across data factories.</span></span>
     - <span data-ttu-id="cd7f6-534">Adicionar novo parâmetro -SharedIntegrationRuntimeResourceId ao cmdlet Set-AzureRmDataFactoryV2IntegrationRuntime.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-534">Add new parameter -SharedIntegrationRuntimeResourceId to Set-AzureRmDataFactoryV2IntegrationRuntime cmdlet.</span></span>
     - <span data-ttu-id="cd7f6-535">Adicionar novo parâmetro opcional -LinkedDataFactoryName ao cmdlet Remove-AzureRmDataFactoryV2IntegrationRuntime.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-535">Add new optional parameter -LinkedDataFactoryName to Remove-AzureRmDataFactoryV2IntegrationRuntime cmdlet.</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="cd7f6-536">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="cd7f6-536">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="cd7f6-537">Atualizada a versão do SDK do DataPlane (Microsoft.Azure.DataLake.Store) para 1.1.9</span><span class="sxs-lookup"><span data-stu-id="cd7f6-537">Updated the DataPlane SDK (Microsoft.Azure.DataLake.Store) version to 1.1.9</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="cd7f6-538">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="cd7f6-538">AzureRM.EventHub</span></span>
* <span data-ttu-id="cd7f6-539">Tubulação atualizada para InputObject e ResourceId em Remover cmdlets</span><span class="sxs-lookup"><span data-stu-id="cd7f6-539">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>

#### <a name="azurerminsights"></a><span data-ttu-id="cd7f6-540">AzureRM.Insights</span><span class="sxs-lookup"><span data-stu-id="cd7f6-540">AzureRM.Insights</span></span>
* <span data-ttu-id="cd7f6-541">Formatação corrigida do OutputType nos arquivos de ajuda</span><span class="sxs-lookup"><span data-stu-id="cd7f6-541">Fixed formatting of OutputType in help files</span></span>
* <span data-ttu-id="cd7f6-542">Usando o SDK Microsoft.Azure.Management.Monitor 0.19.1-preview</span><span class="sxs-lookup"><span data-stu-id="cd7f6-542">Using Microsoft.Azure.Management.Monitor SDK 0.19.1-preview</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="cd7f6-543">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="cd7f6-543">AzureRM.KeyVault</span></span>
* <span data-ttu-id="cd7f6-544">Corrigir o problema de tubulação em Set-AzureRmKeyVaultAccessPolicy</span><span class="sxs-lookup"><span data-stu-id="cd7f6-544">Fix piping issue in Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="cd7f6-545">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="cd7f6-545">AzureRM.Network</span></span>
* <span data-ttu-id="cd7f6-546">Exemplos adicionados para cmdlets LoadBalancerInboundNatPoolConfig.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-546">Added examples for LoadBalancerInboundNatPoolConfig cmdlets.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="cd7f6-547">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="cd7f6-547">AzureRM.Resources</span></span>
* <span data-ttu-id="cd7f6-548">Corrigir problema ao fornecer nome e valor da marca para 'Get-AzureRmResource'</span><span class="sxs-lookup"><span data-stu-id="cd7f6-548">Fix issue when providing both tag name and value for 'Get-AzureRmResource'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6765
* <span data-ttu-id="cd7f6-549">Corrigir o cenário de tubulação com 'Set-AzureRmResource'</span><span class="sxs-lookup"><span data-stu-id="cd7f6-549">Fix piping scenario with 'Set-AzureRmResource'</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="cd7f6-550">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="cd7f6-550">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="cd7f6-551">Tubulação atualizada para InputObject e ResourceId em Remover cmdlets</span><span class="sxs-lookup"><span data-stu-id="cd7f6-551">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>
* <span data-ttu-id="cd7f6-552">alguns problemas corrigidos</span><span class="sxs-lookup"><span data-stu-id="cd7f6-552">fixed few issues</span></span>
    - https://github.com/Azure/azure-powershell/issues/3780
    - https://github.com/Azure/azure-powershell/issues/4340

#### <a name="azurermsql"></a><span data-ttu-id="cd7f6-553">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="cd7f6-553">AzureRM.Sql</span></span>
* <span data-ttu-id="cd7f6-554">Adicionando suporte à Proteção Avançada contra Ameaças do Server com os seguintes cmdlets:</span><span class="sxs-lookup"><span data-stu-id="cd7f6-554">Adding Server Advanced Threat Protection support with the following cmdlets:</span></span>
    - <span data-ttu-id="cd7f6-555">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span><span class="sxs-lookup"><span data-stu-id="cd7f6-555">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span></span>
* <span data-ttu-id="cd7f6-556">Adicionando suporte à Avaliação de Vulnerabilidade com os seguintes cmdlets:</span><span class="sxs-lookup"><span data-stu-id="cd7f6-556">Adding Vulnerability Assessment support with the following cmdlets:</span></span>
    - <span data-ttu-id="cd7f6-557">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span><span class="sxs-lookup"><span data-stu-id="cd7f6-557">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span></span>
    - <span data-ttu-id="cd7f6-558">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="cd7f6-558">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>
    - <span data-ttu-id="cd7f6-559">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="cd7f6-559">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span></span>
* <span data-ttu-id="cd7f6-560">Corrigido o exemplo em Remove-AzureRmSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="cd7f6-560">Fixed example in Remove-AzureRmSqlServerFirewallRule</span></span>
* <span data-ttu-id="cd7f6-561">Corrigir tratamento de data e hora incorreto para cultura de base não EUA em Get-AzureSqlSyncGroupLog</span><span class="sxs-lookup"><span data-stu-id="cd7f6-561">Fix datetime handling incorrectly for non-us base culture in Get-AzureSqlSyncGroupLog</span></span>

#### <a name="azurermstorage"></a><span data-ttu-id="cd7f6-562">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="cd7f6-562">AzureRM.Storage</span></span>
* <span data-ttu-id="cd7f6-563">Adicionar Ps1XmlAttribute às propriedades de tipos de saída de cmdlets</span><span class="sxs-lookup"><span data-stu-id="cd7f6-563">Add Ps1XmlAttribute to cmdlets output types properties</span></span>
* <span data-ttu-id="cd7f6-564">Mostrar a saída do cmdlet StorageAccount no modo de exibição de tabela</span><span class="sxs-lookup"><span data-stu-id="cd7f6-564">Show StorageAccount cmdlet output in table view</span></span>
    - <span data-ttu-id="cd7f6-565">Get-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="cd7f6-565">Get-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="cd7f6-566">New-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="cd7f6-566">New-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="cd7f6-567">Set-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="cd7f6-567">Set-AzureRmStorageAccount</span></span>

#### <a name="azurermtags"></a><span data-ttu-id="cd7f6-568">AzureRM.Tags</span><span class="sxs-lookup"><span data-stu-id="cd7f6-568">AzureRM.Tags</span></span>
* <span data-ttu-id="cd7f6-569">Remover instrução incorreta de ajuda de cmdlet de marca</span><span class="sxs-lookup"><span data-stu-id="cd7f6-569">Remove incorrect statement from Tag cmdlet help</span></span>
    - https://github.com/Azure/azure-powershell/issues/3878

## <a name="650---july-2018"></a><span data-ttu-id="cd7f6-570">6.5.0 - julho de 2018</span><span class="sxs-lookup"><span data-stu-id="cd7f6-570">6.5.0 - July 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="cd7f6-571">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="cd7f6-571">AzureRM.Profile</span></span>
* <span data-ttu-id="cd7f6-572">Ajuda atualizada para 'Get-AzureRmContextAutosaveSetting'</span><span class="sxs-lookup"><span data-stu-id="cd7f6-572">Updated help for 'Get-AzureRmContextAutosaveSetting'</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="cd7f6-573">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="cd7f6-573">Azure.Storage</span></span>
* <span data-ttu-id="cd7f6-574">Suporte ao carregar o blob ou o arquivo com o token de Sas somente gravação</span><span class="sxs-lookup"><span data-stu-id="cd7f6-574">Support Upload Blob or File with write only Sas token</span></span>
- <span data-ttu-id="cd7f6-575">Set-AzureStorageBlobContent</span><span class="sxs-lookup"><span data-stu-id="cd7f6-575">Set-AzureStorageBlobContent</span></span>
- <span data-ttu-id="cd7f6-576">Set-AzureStorageFileContent</span><span class="sxs-lookup"><span data-stu-id="cd7f6-576">Set-AzureStorageFileContent</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="cd7f6-577">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="cd7f6-577">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="cd7f6-578">Adicione a propriedade necessária ResourceGroupName ao AS.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-578">Add required property ResourceGroupName to AS.</span></span>

#### <a name="azurermautomation"></a><span data-ttu-id="cd7f6-579">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="cd7f6-579">AzureRM.Automation</span></span>
* <span data-ttu-id="cd7f6-580">Atualizar a ajuda e adicionar exemplo do 'New-AzureRMAutomationSchedule'</span><span class="sxs-lookup"><span data-stu-id="cd7f6-580">Update help and add example for 'New-AzureRMAutomationSchedule'</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="cd7f6-581">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="cd7f6-581">AzureRM.Compute</span></span>
* <span data-ttu-id="cd7f6-582">Adicionar parâmetro -Tag ao New/Update-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="cd7f6-582">Add -Tag parameter to Update/New-AzureRmAvailabilitySet</span></span>
* <span data-ttu-id="cd7f6-583">Adicionar exemplo do 'Add-AzureRmVmssExtension'</span><span class="sxs-lookup"><span data-stu-id="cd7f6-583">Add example for 'Add-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="cd7f6-584">Adicionar exemplos do 'Remove-AzureRmVmssExtension'</span><span class="sxs-lookup"><span data-stu-id="cd7f6-584">Add examples for 'Remove-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="cd7f6-585">Atualizar ajuda do 'Set-AzureRmVMAccessExtension'</span><span class="sxs-lookup"><span data-stu-id="cd7f6-585">Update help for 'Set-AzureRmVMAccessExtension'</span></span>
* <span data-ttu-id="cd7f6-586">Atualize SimpleParameterSet do New-AzureRmVmss para definir SinglePlacementGroup como false por padrão e adicionar o parâmetro de opção 'SinglePlacementGroup', que permite ao usuário criar VMSS em um único grupo de posicionamento.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-586">Update SimpleParameterSet for New-AzureRmVmss to set SinglePlacementGroup to false by default and add switch parameter 'SinglePlacementGroup' that enables the user to create the VMSS in a single placement group.</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="cd7f6-587">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="cd7f6-587">AzureRM.EventHub</span></span>
* <span data-ttu-id="cd7f6-588">Adicionada uma propriedade readonly 'PendingReplicationOperationsCount' à classe PSEventHubDRConfigurationAttributes, que fornece a contagem de operações pendentes de replicação durante a replicação em andamento</span><span class="sxs-lookup"><span data-stu-id="cd7f6-588">Added a readonly property 'PendingReplicationOperationsCount' to PSEventHubDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="cd7f6-589">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="cd7f6-589">AzureRM.KeyVault</span></span>
* <span data-ttu-id="cd7f6-590">Mensagem de erro de atualização para Set-AzureRmKeyVaultAccessPolicy</span><span class="sxs-lookup"><span data-stu-id="cd7f6-590">Update error message for Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermlogicapp"></a><span data-ttu-id="cd7f6-591">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="cd7f6-591">AzureRM.LogicApp</span></span>
* <span data-ttu-id="cd7f6-592">Corrigido o erro de "conjunto de parâmetros não pôde ser resolvido" no New-AzureRmLogicApp</span><span class="sxs-lookup"><span data-stu-id="cd7f6-592">Fixed "parameter set could not be resolved" error in New-AzureRmLogicApp</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="cd7f6-593">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="cd7f6-593">AzureRM.Network</span></span>
* <span data-ttu-id="cd7f6-594">Habilitar o emparelhamento entre redes virtuais em vários locatários para o Add/Set-AzureRmVirtualNetworkPeering</span><span class="sxs-lookup"><span data-stu-id="cd7f6-594">Enable peering across Virtual Networks in multiple Tenants for Set/Add-AzureRmVirtualNetworkPeering</span></span>
* <span data-ttu-id="cd7f6-595">Atualizados os cmdlets abaixo para o Gateway de Aplicativo</span><span class="sxs-lookup"><span data-stu-id="cd7f6-595">Updated below cmdlets for Application Gateway</span></span>
    - <span data-ttu-id="cd7f6-596">New-AzureRmApplicationGateway: Adicionado o sinalizador EnableFIPS e suporte a Zonas</span><span class="sxs-lookup"><span data-stu-id="cd7f6-596">New-AzureRmApplicationGateway : Added EnableFIPS flag and Zones support</span></span>
    - <span data-ttu-id="cd7f6-597">New-AzureRmApplicationGatewaySku: Adicionados novos skus Standard_v2 e WAF_v2</span><span class="sxs-lookup"><span data-stu-id="cd7f6-597">New-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
    - <span data-ttu-id="cd7f6-598">Set-AzureRmApplicationGatewaySku: Adicionados novos skus Standard_v2 e WAF_v2</span><span class="sxs-lookup"><span data-stu-id="cd7f6-598">Set-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
* <span data-ttu-id="cd7f6-599">Cmdlets de RouteTable regenerados com a versão mais recente do gerador</span><span class="sxs-lookup"><span data-stu-id="cd7f6-599">Regenerated RouteTable cmdlets with the latest generator version</span></span>

#### <a name="azurermrelay"></a><span data-ttu-id="cd7f6-600">AzureRM.Relay</span><span class="sxs-lookup"><span data-stu-id="cd7f6-600">AzureRM.Relay</span></span>
* <span data-ttu-id="cd7f6-601">Arquivos markdown atualizados, correção para o problema de nome de parâmetro no exemplo</span><span class="sxs-lookup"><span data-stu-id="cd7f6-601">Updated markdown files, fix for the parameter name issue in example</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="cd7f6-602">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="cd7f6-602">AzureRM.Resources</span></span>
* <span data-ttu-id="cd7f6-603">Atualize os cmdlets Roleassignment e roledefinition:</span><span class="sxs-lookup"><span data-stu-id="cd7f6-603">Update Roleassignment and roledefinition cmdlets:</span></span>
    - <span data-ttu-id="cd7f6-604">Remova chamadas extras roledefinition feitas como parte da paginação.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-604">Remove extra roledefinition calls done as part of paging.</span></span>
* <span data-ttu-id="cd7f6-605">Corrigir cmdlet Get-AzureRmRoleAssignment</span><span class="sxs-lookup"><span data-stu-id="cd7f6-605">Fix Get-AzureRmRoleAssignment cmdlet</span></span>
    - <span data-ttu-id="cd7f6-606">Corrigir funcionalidade de parâmetro de comando -ExpandPrincipalGroups</span><span class="sxs-lookup"><span data-stu-id="cd7f6-606">Fix -ExpandPrincipalGroups command parameter functionality</span></span>
* <span data-ttu-id="cd7f6-607">Corrigir problema com 'Get-AzureRmResource', no qual o parâmetro '-ResourceType' diferencia maiúsculas de minúsculas</span><span class="sxs-lookup"><span data-stu-id="cd7f6-607">Fix issue with 'Get-AzureRmResource' where '-ResourceType' parameter was case sensitive</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="cd7f6-608">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="cd7f6-608">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="cd7f6-609">Adicionado o parâmetro top e skip aos cmdlets de lista</span><span class="sxs-lookup"><span data-stu-id="cd7f6-609">Added top and skip parameter to list cmdlets</span></span>
* <span data-ttu-id="cd7f6-610">Adicionados os cmdlets de migração de NameSpace Standard a Premium:</span><span class="sxs-lookup"><span data-stu-id="cd7f6-610">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    - <span data-ttu-id="cd7f6-611">Start-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="cd7f6-611">Start-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="cd7f6-612">Get-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="cd7f6-612">Get-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="cd7f6-613">Complete-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="cd7f6-613">Complete-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="cd7f6-614">Stop-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="cd7f6-614">Stop-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="cd7f6-615">Remove-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="cd7f6-615">Remove-AzureRmServiceBusMigration</span></span>
* <span data-ttu-id="cd7f6-616">Adicionada uma propriedade readonly 'PendingReplicationOperationsCount' à classe PSServiceBusDRConfigurationAttributes, que fornece a contagem de operações pendentes de replicação durante a replicação em andamento</span><span class="sxs-lookup"><span data-stu-id="cd7f6-616">Added a readonly property 'PendingReplicationOperationsCount' to PSServiceBusDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="cd7f6-617">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="cd7f6-617">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="cd7f6-618">Exemplo de atualização para 'New-AzureRmServiceFabricCluster'</span><span class="sxs-lookup"><span data-stu-id="cd7f6-618">Update example for 'New-AzureRmServiceFabricCluster'</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="cd7f6-619">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="cd7f6-619">AzureRM.Sql</span></span>
* <span data-ttu-id="cd7f6-620">Adicionar novos Cmdlets ao Management.Sql para permitir que os clientes adicionem o certificado TDE à instância do SQL Server ou uma Instância Gerenciada</span><span class="sxs-lookup"><span data-stu-id="cd7f6-620">Adding new Cmdlets for Management.Sql to allow customers to add TDE Certificate to Sql Server instance or a Managed Instance</span></span>
    - <span data-ttu-id="cd7f6-621">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="cd7f6-621">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span></span>
    - <span data-ttu-id="cd7f6-622">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="cd7f6-622">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="cd7f6-623">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="cd7f6-623">AzureRM.Websites</span></span>
* <span data-ttu-id="cd7f6-624">`Set-AzureRmWebApp -AssignIdentity` e `Set-AzureRmWebAppSlot -AssignIdentity` quando definidos como false agora também removerão a propriedade de identidade da marca de visualização object.Removing do site.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-624">`Set-AzureRmWebApp -AssignIdentity` and  `Set-AzureRmWebAppSlot -AssignIdentity` when set to false will now remove the Identity property from the site object.Removing preview tag as well.</span></span>
* <span data-ttu-id="cd7f6-625">Exemplos `Get-AzureRmWebAppMetrics` e `Get-AzureRmAppServicePlanMetrics` atualizados</span><span class="sxs-lookup"><span data-stu-id="cd7f6-625">`Get-AzureRmWebAppMetrics`,`Get-AzureRmAppServicePlanMetrics` example updated</span></span>
* <span data-ttu-id="cd7f6-626">`Set-AzureRmWebApp -PhpVersion` dá suporte como uma versão do PHP válida</span><span class="sxs-lookup"><span data-stu-id="cd7f6-626">`Set-AzureRmWebApp -PhpVersion` supports off as a valid php version</span></span>

## <a name="640---july-2018"></a><span data-ttu-id="cd7f6-627">6.4.0 - julho de 2018</span><span class="sxs-lookup"><span data-stu-id="cd7f6-627">6.4.0 - July 2018</span></span>
#### <a name="general"></a><span data-ttu-id="cd7f6-628">Geral</span><span class="sxs-lookup"><span data-stu-id="cd7f6-628">General</span></span>
* <span data-ttu-id="cd7f6-629">Formatação corrigida do OutputType nos arquivos de ajuda para a maioria dos módulos</span><span class="sxs-lookup"><span data-stu-id="cd7f6-629">Fixed formatting of OutputType in help files for most modules</span></span>

#### <a name="azurermprofile"></a><span data-ttu-id="cd7f6-630">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="cd7f6-630">AzureRM.Profile</span></span>
* <span data-ttu-id="cd7f6-631">Atributo Ps1Xml adicionado aos tipos de saída básicos</span><span class="sxs-lookup"><span data-stu-id="cd7f6-631">Ps1Xml attribute added to the basic output types</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="cd7f6-632">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="cd7f6-632">AzureRM.Compute</span></span>
* <span data-ttu-id="cd7f6-633">Recurso de Marca do IP para VMSS</span><span class="sxs-lookup"><span data-stu-id="cd7f6-633">IP Tag feature for VMSS</span></span>
    - <span data-ttu-id="cd7f6-634">O cmdlet “New-AzureRmVmssIpTagConfig” foi adicionado</span><span class="sxs-lookup"><span data-stu-id="cd7f6-634">'New-AzureRmVmssIpTagConfig' cmdlet is added</span></span>
    - <span data-ttu-id="cd7f6-635">O parâmetro IpTag foi adicionado a New-AzureRmVmssIpConfig</span><span class="sxs-lookup"><span data-stu-id="cd7f6-635">IpTag parameter is added to New-AzureRmVmssIpConfig</span></span>
* <span data-ttu-id="cd7f6-636">Recurso de Reversão Automática do SO para VMSS</span><span class="sxs-lookup"><span data-stu-id="cd7f6-636">Auto OS Rollback feature for VMSS</span></span>
    - <span data-ttu-id="cd7f6-637">Os parâmetros DisableAutoRollback são adicionados a New-AzureRmVmssConfig e Update-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="cd7f6-637">DisableAutoRollback parameters are added to New-AzureRmVmssConfig and Update-AzureRmVmss</span></span>
* <span data-ttu-id="cd7f6-638">Recurso do Histórico de Atualizações do SO para Vmss</span><span class="sxs-lookup"><span data-stu-id="cd7f6-638">OS Upgrade History feature for Vmss</span></span>
    - <span data-ttu-id="cd7f6-639">O parâmetro com argumento OSUpgradeHistory foi adicionado ao Get-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="cd7f6-639">OSUpgradeHistory switch parameter is added to Get-AzureRmVmss</span></span>

#### <a name="azurermdatalakeanalytics"></a><span data-ttu-id="cd7f6-640">AzureRM.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="cd7f6-640">AzureRM.DataLakeAnalytics</span></span>
* <span data-ttu-id="cd7f6-641">Adicione suporte para as ACLs de Catálogo com os comandos a seguir:</span><span class="sxs-lookup"><span data-stu-id="cd7f6-641">Add support for Catalog ACLs through the following commands:</span></span>
    - <span data-ttu-id="cd7f6-642">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="cd7f6-642">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="cd7f6-643">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="cd7f6-643">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="cd7f6-644">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="cd7f6-644">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="cd7f6-645">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="cd7f6-645">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="cd7f6-646">Adicionar suporte a cancelamento e acompanhamento do progresso para Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span><span class="sxs-lookup"><span data-stu-id="cd7f6-646">Add cancellation support and progress tracking for Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span></span>
* <span data-ttu-id="cd7f6-647">Adicionar suporte a cancelamento para Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="cd7f6-647">Add cancellation support for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="cd7f6-648">Corrigir liberação das mensagens de depuração para cmdlets que fazem operações recursivas</span><span class="sxs-lookup"><span data-stu-id="cd7f6-648">Fix flushing of debug messages for cmdlets that does recursive operations</span></span>
* <span data-ttu-id="cd7f6-649">Corrigir local de teste dos cmdlets DataLake</span><span class="sxs-lookup"><span data-stu-id="cd7f6-649">Fix location of test of DataLake cmdlets</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="cd7f6-650">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="cd7f6-650">AzureRM.EventHub</span></span>
* <span data-ttu-id="cd7f6-651">Parâmetro MaxCount Opcional adicionado aos cmdlets da Lista de Operações Get-AzureRmEventHub e Get-AzureRmEventHubConsumerGroup</span><span class="sxs-lookup"><span data-stu-id="cd7f6-651">Added Optional MaxCount parameter to List Operations cmdlet Get-AzureRmEventHub and Get-AzureRmEventHubConsumerGroup</span></span>
* <span data-ttu-id="cd7f6-652">Problema corrigido no cmdlet New-AzureRmEventHub onde pelo menos um parâmetro é necessário durante a criação do Novo EventHub.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-652">Fixed issue in New-AzureRmEventHub cmdlet where at least one parameter needed while creating New EventHub.</span></span> <span data-ttu-id="cd7f6-653">Conjunto de Parâmetros Padrão fornecido.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-653">Provided Default Parameter set.</span></span>
* <span data-ttu-id="cd7f6-654">Parâmetro opcional -KeyValue adicionado ao cmdlet New-AzureRmEventHubKey, que permite ao usuário fornecer o KeyValue.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-654">Added optional Parameter -KeyValue to New-AzureRmEventHubKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="cd7f6-655">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="cd7f6-655">AzureRM.KeyVault</span></span>
* <span data-ttu-id="cd7f6-656">Problema corrigido onde todos os recursos foram retornados por Get-AzureRmKeyVault-Tag</span><span class="sxs-lookup"><span data-stu-id="cd7f6-656">Fix issue where all resources were being returned by Get-AzureRmKeyVault -Tag</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="cd7f6-657">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="cd7f6-657">AzureRM.Network</span></span>
* <span data-ttu-id="cd7f6-658">Expor novas Skus para VirtualNetworkGateways com Redundância de Zona</span><span class="sxs-lookup"><span data-stu-id="cd7f6-658">Expose new Skus for Zone-Redundant VirtualNetworkGateways</span></span>
* <span data-ttu-id="cd7f6-659">Novos comandos adicionados do recurso: APIs de Parceiro do ExpressRoute via ARM</span><span class="sxs-lookup"><span data-stu-id="cd7f6-659">Added new commands for feature: ExpressRoute Partner APIs via ARM</span></span>
    - <span data-ttu-id="cd7f6-660">Get-AzureRmExpressRouteCrossConnection adicionado</span><span class="sxs-lookup"><span data-stu-id="cd7f6-660">Added Get-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="cd7f6-661">Set-AzureRmExpressRouteCrossConnection adicionado</span><span class="sxs-lookup"><span data-stu-id="cd7f6-661">Added Set-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="cd7f6-662">Add-AzureRmExpressRouteCrossConnectionPeering adicionado</span><span class="sxs-lookup"><span data-stu-id="cd7f6-662">Added Add-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="cd7f6-663">Get-AzureRmExpressRouteCrossConnectionPeering adicionado</span><span class="sxs-lookup"><span data-stu-id="cd7f6-663">Added Get-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="cd7f6-664">Remove-AzureRmExpressRouteCrossConnectionPeering adicionado</span><span class="sxs-lookup"><span data-stu-id="cd7f6-664">Added Remove-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="cd7f6-665">Get-AzureRMExpressRouteCrossConnectionArpTable adicionado</span><span class="sxs-lookup"><span data-stu-id="cd7f6-665">Added Get-AzureRMExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="cd7f6-666">Get-AzureRMExpressRouteCrossConnectionRouteTable adicionado</span><span class="sxs-lookup"><span data-stu-id="cd7f6-666">Added Get-AzureRMExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="cd7f6-667">Get-AzureRMExpressRouteCrossConnectionRouteTableSummary adicionado</span><span class="sxs-lookup"><span data-stu-id="cd7f6-667">Added Get-AzureRMExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="cd7f6-668">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="cd7f6-668">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="cd7f6-669">Cmdlet Get-AzureRmRecoveryServicesBackupStatus adicionado.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-669">Added Get-AzureRmRecoveryServicesBackupStatus cmdlet.</span></span> <span data-ttu-id="cd7f6-670">Esse cmdlet usa uma ID de VM e verifica se a VM está protegida por algum cofre na assinatura.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-670">This cmdlet takes a VM ID and checks if the VM is protected by some vault in the subscription.</span></span> <span data-ttu-id="cd7f6-671">Se houver tal cofre, o cmdlet produzirá detalhes dele.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-671">If there exists such a vault, the cmdlet outputs the vault details.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="cd7f6-672">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="cd7f6-672">AzureRM.Resources</span></span>
* <span data-ttu-id="cd7f6-673">Atualize os cmdlets Get-AzureRmPolicyAssignment:</span><span class="sxs-lookup"><span data-stu-id="cd7f6-673">Update Get-AzureRmPolicyAssignment cmdlets:</span></span>
    - <span data-ttu-id="cd7f6-674">Adicionar suporte para listar valores -Scope no nível do grupo de gerenciamento</span><span class="sxs-lookup"><span data-stu-id="cd7f6-674">Add support for listing -Scope values at management group level</span></span>
    - <span data-ttu-id="cd7f6-675">Adicionar suporte para recuperar as atribuições individuais com valores -Scope no nível do grupo de gerenciamento</span><span class="sxs-lookup"><span data-stu-id="cd7f6-675">Add support for retrieving individual assignments with -Scope values at management group level</span></span>
    - <span data-ttu-id="cd7f6-676">Adicionar argumentos -Effective e -All para controlar  parâmetro</span><span class="sxs-lookup"><span data-stu-id="cd7f6-676">Add -Effective and -All switches to control  parameter</span></span>
* <span data-ttu-id="cd7f6-677">Atualizar cmdlets Get/New/Remove/Set-AzureRmPolicyDefinition</span><span class="sxs-lookup"><span data-stu-id="cd7f6-677">Update Get/New/Remove/Set-AzureRmPolicyDefinition cmdlets</span></span>
    - <span data-ttu-id="cd7f6-678">Adicionar parâmetro -ManagementGroupName para aplicar as operações a um determinado grupo de gerenciamento</span><span class="sxs-lookup"><span data-stu-id="cd7f6-678">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="cd7f6-679">Adicionar parâmetro -SubscriptionId para aplicar as operações a uma determinada assinatura</span><span class="sxs-lookup"><span data-stu-id="cd7f6-679">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="cd7f6-680">Atualizar cmdlets Get/New/Remove/Set-AzureRmPolicySetDefinition</span><span class="sxs-lookup"><span data-stu-id="cd7f6-680">Update Get/New/Remove/Set-AzureRmPolicySetDefinition cmdlets</span></span>
    - <span data-ttu-id="cd7f6-681">Adicionar parâmetro -ManagementGroupName para aplicar as operações a um determinado grupo de gerenciamento</span><span class="sxs-lookup"><span data-stu-id="cd7f6-681">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="cd7f6-682">Adicionar parâmetro -SubscriptionId para aplicar as operações a uma determinada assinatura</span><span class="sxs-lookup"><span data-stu-id="cd7f6-682">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="cd7f6-683">Adicionar suporte de referência do segredo KeyVault nos parâmetros ao usar “TemplateParameterObject” em “New-AzureRmResourceGroupDeployment”</span><span class="sxs-lookup"><span data-stu-id="cd7f6-683">Add KeyVault secret reference support in parameters when using 'TemplateParameterObject' in 'New-AzureRmResourceGroupDeployment'</span></span>
* <span data-ttu-id="cd7f6-684">Corrigir problema onde o parâmetro “-EndDate” foi ignorado para “New-AzureRmADAppCredential”</span><span class="sxs-lookup"><span data-stu-id="cd7f6-684">Fix issue where '-EndDate' parameter was ignored for 'New-AzureRmADAppCredential'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6505
* <span data-ttu-id="cd7f6-685">Corrigir problema onde “Add-AzureRmADGroupMember” usou a URL incorreta para fazer a solicitação</span><span class="sxs-lookup"><span data-stu-id="cd7f6-685">Fix issue where 'Add-AzureRmADGroupMember' used incorrect URL to make request</span></span>
    - https://github.com/Azure/azure-powershell/issues/6485

#### <a name="azurermservicebus"></a><span data-ttu-id="cd7f6-686">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="cd7f6-686">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="cd7f6-687">Parâmetro opcional -KeyValue adicionado ao cmdlet New-AzureRmServiceBusKey, que permite ao usuário fornecer o KeyValue.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-687">Added optional Parameter -KeyValue to New-AzureRmServiceBusKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="cd7f6-688">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="cd7f6-688">AzureRM.Sql</span></span>
* <span data-ttu-id="cd7f6-689">Pontos de Restauração Definidos pelo Usuário e Esclarecidos para SQLDW na ajuda do New-AzureRmSqlDatabaseRestorePoint</span><span class="sxs-lookup"><span data-stu-id="cd7f6-689">Clarified User-Defined Restore Points for SQLDW in New-AzureRmSqlDatabaseRestorePoint help</span></span>
* <span data-ttu-id="cd7f6-690">Documentação atualizada do parâmetro -ComputeGeneration em vários cmdlets</span><span class="sxs-lookup"><span data-stu-id="cd7f6-690">Updated documentation of -ComputeGeneration parameter in several cmdlets</span></span>

## <a name="630---june-2018"></a><span data-ttu-id="cd7f6-691">6.3.0 - junho de 2018</span><span class="sxs-lookup"><span data-stu-id="cd7f6-691">6.3.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="cd7f6-692">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="cd7f6-692">AzureRM.Profile</span></span>
* <span data-ttu-id="cd7f6-693">Mensagens de erro atualizadas para Enable-AzureRmContextAutoSave</span><span class="sxs-lookup"><span data-stu-id="cd7f6-693">Updated error messages for Enable-AzureRmContextAutoSave</span></span>
* <span data-ttu-id="cd7f6-694">Criar contexto para cada assinatura ao executar “Connect-AzureRmAccount” sem contexto anterior</span><span class="sxs-lookup"><span data-stu-id="cd7f6-694">Create a context for each subscription when running 'Connect-AzureRmAccount' with no previous context</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="cd7f6-695">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="cd7f6-695">Azure.Storage</span></span>
* <span data-ttu-id="cd7f6-696">Outras informações adicionadas sobre o parâmetro -Permissions nos arquivos de ajuda.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-696">Added additional information about -Permissions parameter in help files.</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="cd7f6-697">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="cd7f6-697">AzureRM.Compute</span></span>
* <span data-ttu-id="cd7f6-698">“Get-AzureRmVmDiskEncryptionStatus” corrige um problema observado por VMs sem discos de dados</span><span class="sxs-lookup"><span data-stu-id="cd7f6-698">'Get-AzureRmVmDiskEncryptionStatus' fixes an issue observed for VMs with no data disks</span></span> 
* <span data-ttu-id="cd7f6-699">Atualizar versão da Biblioteca do cliente de computação para corrigir os cmdlets a seguir</span><span class="sxs-lookup"><span data-stu-id="cd7f6-699">Update Compute client library version to fix following cmdlets</span></span>
    - <span data-ttu-id="cd7f6-700">Grant-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="cd7f6-700">Grant-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="cd7f6-701">Grant-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="cd7f6-701">Grant-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="cd7f6-702">Save-AzureRmVMImage</span><span class="sxs-lookup"><span data-stu-id="cd7f6-702">Save-AzureRmVMImage</span></span>
* <span data-ttu-id="cd7f6-703">Cmdlets corrigidos a seguir para mostrar corretamente a "ID da operação" e o "status da operação":</span><span class="sxs-lookup"><span data-stu-id="cd7f6-703">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    - <span data-ttu-id="cd7f6-704">Start-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="cd7f6-704">Start-AzureRmVM</span></span>
    - <span data-ttu-id="cd7f6-705">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="cd7f6-705">Stop-AzureRmVM</span></span>
    - <span data-ttu-id="cd7f6-706">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="cd7f6-706">Restart-AzureRmVM</span></span>
    - <span data-ttu-id="cd7f6-707">Set-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="cd7f6-707">Set-AzureRmVM</span></span>
    - <span data-ttu-id="cd7f6-708">Remove-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="cd7f6-708">Remove-AzuerRmVM</span></span>
    - <span data-ttu-id="cd7f6-709">Set-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="cd7f6-709">Set-AzureRmVmss</span></span>
    - <span data-ttu-id="cd7f6-710">Start-AzureRmVmssRollingOSUpgrade</span><span class="sxs-lookup"><span data-stu-id="cd7f6-710">Start-AzureRmVmssRollingOSUpgrade</span></span>
    - <span data-ttu-id="cd7f6-711">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="cd7f6-711">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="cd7f6-712">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="cd7f6-712">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="cd7f6-713">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="cd7f6-713">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="cd7f6-714">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="cd7f6-714">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="cd7f6-715">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="cd7f6-715">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="cd7f6-716">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="cd7f6-716">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="cd7f6-717">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="cd7f6-717">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="cd7f6-718">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="cd7f6-718">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="cd7f6-719">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="cd7f6-719">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="cd7f6-720">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="cd7f6-720">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="cd7f6-721">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="cd7f6-721">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="cd7f6-722">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="cd7f6-722">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="cd7f6-723">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="cd7f6-723">AzureRM.EventGrid</span></span>
* <span data-ttu-id="cd7f6-724">Remova as condições de validação ValidateNotNullOrEmpty para SubjectBeginsWith/SubjectEndsWith no cmdlet Update-AzureRmEventGridSubscription e permita a mudança desses parâmetros para uma cadeia de caracteres vazia, se for necessário.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-724">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="cd7f6-725">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="cd7f6-725">AzureRM.KeyVault</span></span>
* <span data-ttu-id="cd7f6-726">Corrigir problema onde nenhuma marca retorna ao executar Get-AzureRmKeyVault -Tag</span><span class="sxs-lookup"><span data-stu-id="cd7f6-726">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="cd7f6-727">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="cd7f6-727">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="cd7f6-728">Versão pública dos cmdlets de Informações sobre a Política</span><span class="sxs-lookup"><span data-stu-id="cd7f6-728">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="cd7f6-729">Usar versão da API 2018-04-04</span><span class="sxs-lookup"><span data-stu-id="cd7f6-729">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="cd7f6-730">Adicionar PolicyDefinitionReferenceId aos resultados de Get-AzureRmPolicyStateSummary</span><span class="sxs-lookup"><span data-stu-id="cd7f6-730">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="cd7f6-731">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="cd7f6-731">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="cd7f6-732">Parâmetro -Vault adicionado aos cmdlets RecoveryServices.Backup.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-732">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="cd7f6-733">Quando passado, substituirá o cmdlet Set-AzureRmRecoveryServicesContext.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-733">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="cd7f6-734">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="cd7f6-734">AzureRM.Sql</span></span>
* <span data-ttu-id="cd7f6-735">Exemplo atualizado no arquivo de ajuda para Get-AzureRmSqlDatabaseExpanded</span><span class="sxs-lookup"><span data-stu-id="cd7f6-735">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="cd7f6-736">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="cd7f6-736">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="cd7f6-737">Arquivo de ajuda atualizado para Add-AzureRmTrafficManagerEndpointConfig</span><span class="sxs-lookup"><span data-stu-id="cd7f6-737">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="cd7f6-738">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="cd7f6-738">AzureRM.Websites</span></span>
* <span data-ttu-id="cd7f6-739">"Set-AzureRmWebApp" foi atualizado para não substituir AppSettings ao usar -AssignIdentity</span><span class="sxs-lookup"><span data-stu-id="cd7f6-739">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="cd7f6-740">"New-AzureRmWebAppSlot" foi atualizado para aceitar AppServicePlan como um parâmetro opcional</span><span class="sxs-lookup"><span data-stu-id="cd7f6-740">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="cd7f6-741">6.2.1 - junho de 2018</span><span class="sxs-lookup"><span data-stu-id="cd7f6-741">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="cd7f6-742">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="cd7f6-742">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="cd7f6-743">Modelo PSWorkspace atualizado para permitir que a Rede use o tipo como um parâmetro</span><span class="sxs-lookup"><span data-stu-id="cd7f6-743">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="cd7f6-744">6.2.0 - Junho de 2018</span><span class="sxs-lookup"><span data-stu-id="cd7f6-744">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="cd7f6-745">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="cd7f6-745">AzureRM.Profile</span></span>
* <span data-ttu-id="cd7f6-746">Corrija o problema em que a versão 10.0.3 do Newtonsoft.Json não estava sendo carregado na importação do módulo</span><span class="sxs-lookup"><span data-stu-id="cd7f6-746">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="cd7f6-747">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="cd7f6-747">AzureRM.Compute</span></span>
* <span data-ttu-id="cd7f6-748">Recurso de atualização de VM VMSS</span><span class="sxs-lookup"><span data-stu-id="cd7f6-748">VMSS VM Update feature</span></span>
    - <span data-ttu-id="cd7f6-749">Os cmdlets 'Update-AzureRmVmssVM' e 'New-AzureRmVMDataDisk' foram adicionados</span><span class="sxs-lookup"><span data-stu-id="cd7f6-749">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="cd7f6-750">Adicione o parâmetro VirtualMachineScaleSetVM ao cmdlet 'Add-AzureRmVMDataDisk' para dar suporte à adição de um disco de dados para a VM Vmss.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-750">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="cd7f6-751">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="cd7f6-751">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="cd7f6-752">A versão do SDK do .Net ADF foi atualizada para a versão prévia 0.8.0 que contém as seguintes alterações:</span><span class="sxs-lookup"><span data-stu-id="cd7f6-752">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="cd7f6-753">A operação para Configurar o repositório de fábrica foi adicionada</span><span class="sxs-lookup"><span data-stu-id="cd7f6-753">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="cd7f6-754">O LinkedService QuickBooks foi atualizado para expor as propriedades consumerKey e consumerSecret</span><span class="sxs-lookup"><span data-stu-id="cd7f6-754">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="cd7f6-755">Vários tipos de modelo atualizados de SecretBase para Object</span><span class="sxs-lookup"><span data-stu-id="cd7f6-755">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="cd7f6-756">Foram adicionados gatilho de eventos de blob</span><span class="sxs-lookup"><span data-stu-id="cd7f6-756">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="cd7f6-757">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="cd7f6-757">AzureRM.KeyVault</span></span>
* <span data-ttu-id="cd7f6-758">Atualizar documentação com a saída de exemplo</span><span class="sxs-lookup"><span data-stu-id="cd7f6-758">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="cd7f6-759">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="cd7f6-759">AzureRM.Network</span></span>
* <span data-ttu-id="cd7f6-760">Habilitar parâmetros de Análise de Tráfego nos cmdlets do Observador de Rede</span><span class="sxs-lookup"><span data-stu-id="cd7f6-760">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="cd7f6-761">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="cd7f6-761">AzureRM.Resources</span></span>
* <span data-ttu-id="cd7f6-762">Corrigir o problema com a propriedade 'Properties' dos objetos 'PSResource' retornados de 'Get-AzureRmResource'</span><span class="sxs-lookup"><span data-stu-id="cd7f6-762">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="cd7f6-763">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="cd7f6-763">AzureRM.Scheduler</span></span>
* <span data-ttu-id="cd7f6-764">Corrigir o problema com a atualização de ServiceBusQueueJob não definindo novos valores de Autenticação</span><span class="sxs-lookup"><span data-stu-id="cd7f6-764">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="cd7f6-765">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="cd7f6-765">AzureRM.Sql</span></span>
* <span data-ttu-id="cd7f6-766">Os seguintes cmdlets foram atualizados com o parâmetro LicenseType opcional</span><span class="sxs-lookup"><span data-stu-id="cd7f6-766">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="cd7f6-767">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="cd7f6-767">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="cd7f6-768">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="cd7f6-768">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="cd7f6-769">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="cd7f6-769">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="cd7f6-770">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="cd7f6-770">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="cd7f6-771">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="cd7f6-771">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="cd7f6-772">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="cd7f6-772">AzureRM.Websites</span></span>
* <span data-ttu-id="cd7f6-773">'New-AzureRMWebApp' será atualizado para usar os algoritmos comuns da biblioteca de Estratégia.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-773">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="cd7f6-774">6.1.0 - maio de 2018</span><span class="sxs-lookup"><span data-stu-id="cd7f6-774">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="cd7f6-775">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="cd7f6-775">AzureRM.Profile</span></span>
* <span data-ttu-id="cd7f6-776">Corrija o problema onde executar “Clear-AzureRmContext” manteria um contexto vazio com o nome do contexto padrão anterior, o que impediu o usuário de criar um novo contexto com o antigo nome</span><span class="sxs-lookup"><span data-stu-id="cd7f6-776">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="cd7f6-777">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="cd7f6-777">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="cd7f6-778">Habilite as operações de associação/desassociação do Gateway no sistema autônomo.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-778">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="cd7f6-779">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="cd7f6-779">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="cd7f6-780">Suporte adicionado para ApiVersions, ApiReleases e ApiRevisions</span><span class="sxs-lookup"><span data-stu-id="cd7f6-780">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="cd7f6-781">Suporte adicionado para Back-end do ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="cd7f6-781">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="cd7f6-782">Suporte adicionado para Agente do Application Insights</span><span class="sxs-lookup"><span data-stu-id="cd7f6-782">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="cd7f6-783">Suporte adicionado para reconhecer a sku “Básica” como uma sku válida do serviço de Gerenciamento da Api</span><span class="sxs-lookup"><span data-stu-id="cd7f6-783">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="cd7f6-784">Suporte adicionado para instalar os Certificados emitidos pela autoridade de certificação privada como Raiz ou CA</span><span class="sxs-lookup"><span data-stu-id="cd7f6-784">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="cd7f6-785">Suporte adicionado para aceitar certificados SSL Personalizados via KeyVault e vários nomes de host do proxy</span><span class="sxs-lookup"><span data-stu-id="cd7f6-785">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="cd7f6-786">Suporte adicionado para a identidade MSI</span><span class="sxs-lookup"><span data-stu-id="cd7f6-786">Added support for MSI identity</span></span>
* <span data-ttu-id="cd7f6-787">Suporte adicionado para aceitar Políticas via Url OBSERVAÇÃO: os cmdlets a seguir serão preteridos na futura versão</span><span class="sxs-lookup"><span data-stu-id="cd7f6-787">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="cd7f6-788">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="cd7f6-788">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="cd7f6-789">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="cd7f6-789">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="cd7f6-790">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="cd7f6-790">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="cd7f6-791">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="cd7f6-791">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="cd7f6-792">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="cd7f6-792">AzureRM.Batch</span></span>
* <span data-ttu-id="cd7f6-793">Versão do novo cmdlet Get-AzureBatchPoolNodeCounts</span><span class="sxs-lookup"><span data-stu-id="cd7f6-793">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="cd7f6-794">Versão novo cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span><span class="sxs-lookup"><span data-stu-id="cd7f6-794">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="cd7f6-795">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="cd7f6-795">AzureRM.Consumption</span></span>
* <span data-ttu-id="cd7f6-796">Adicionar os novos parâmetros Expand, ResourceGroup, InstanceName, InstanceId, Tags e Top no cmdlet Get-AzureRmConsumptionUsageDetail</span><span class="sxs-lookup"><span data-stu-id="cd7f6-796">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="cd7f6-797">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="cd7f6-797">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="cd7f6-798">Corrigir exemplo para Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="cd7f6-798">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="cd7f6-799">Corrigir exceção do parâmetro nulo para Recurse, caso esteja em Set-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="cd7f6-799">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="cd7f6-800">Corrigir arquivos de ajuda para Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="cd7f6-800">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="cd7f6-801">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="cd7f6-801">AzureRM.Network</span></span>
* <span data-ttu-id="cd7f6-802">Aumentar a versão do SDK de Rede de 18.0.0-preview para 19.0.0-preview</span><span class="sxs-lookup"><span data-stu-id="cd7f6-802">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="cd7f6-803">Cmdlet adicionado para criar a configuração de protocolo</span><span class="sxs-lookup"><span data-stu-id="cd7f6-803">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="cd7f6-804">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="cd7f6-804">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="cd7f6-805">Cmdlet adicionado para acrescentar uma nova conexão de circuito a um circuito de rota expressa existente.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-805">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="cd7f6-806">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="cd7f6-806">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="cd7f6-807">Cmdlet adicionado para remover uma conexão de circuito de um circuito de rota expressa existente.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-807">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="cd7f6-808">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="cd7f6-808">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="cd7f6-809">Cmdlet adicionado para recuperar uma conexão de circuito</span><span class="sxs-lookup"><span data-stu-id="cd7f6-809">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="cd7f6-810">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="cd7f6-810">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="cd7f6-811">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="cd7f6-811">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="cd7f6-812">Uso da autenticação do servidor corrigido com certificados gerados (problema 5998)</span><span class="sxs-lookup"><span data-stu-id="cd7f6-812">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="cd7f6-813">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="cd7f6-813">AzureRM.Sql</span></span>
* <span data-ttu-id="cd7f6-814">Cmdlets de auditoria atualizados para permitir a remoção de AuditActions ou AuditActionGroups</span><span class="sxs-lookup"><span data-stu-id="cd7f6-814">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="cd7f6-815">Problema corrigido com Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy ao definir uma nova política de retenção flexível onde o comando falharia com “Configurar política de retenção de longo prazo com o cofre de serviços de recuperação do azure e não há mais suporte para a política.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-815">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="cd7f6-816">Envie a solicitação com a nova política de retenção flexível”.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-816">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="cd7f6-817">Atualizar todos os cmdlets relacionados ao Banco de Dados Sql do Azure/Criação do ElasticPool/Atualização para usar a nova API do Banco de Dados, que suporta a propriedade Sku para o dimensionamento e as propriedades relacionadas à camada.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-817">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="cd7f6-818">Os cmdlets atualizados, incluindo:</span><span class="sxs-lookup"><span data-stu-id="cd7f6-818">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="cd7f6-819">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="cd7f6-819">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="cd7f6-820">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="cd7f6-820">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="cd7f6-821">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="cd7f6-821">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="cd7f6-822">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="cd7f6-822">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="cd7f6-823">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="cd7f6-823">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="cd7f6-824">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="cd7f6-824">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="cd7f6-825">Atualize os parâmetros para “Get-AzureRmTrafficManagerProfile” para que o parâmetro -ResourceGroupName seja requerido ao usar o parâmetro -Name.</span><span class="sxs-lookup"><span data-stu-id="cd7f6-825">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
