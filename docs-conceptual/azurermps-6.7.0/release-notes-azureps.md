...
#### <a name="azurestorage"></a><span data-ttu-id="9665e-111">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="9665e-111">Azure.Storage</span></span>
...
#### <a name="azurermbatch"></a><span data-ttu-id="9665e-126">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="9665e-126">AzureRM.Batch</span></span>
...
#### <a name="azurermcontainerinstance"></a><span data-ttu-id="9665e-142">AzureRM.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="9665e-142">AzureRM.ContainerInstance</span></span>
...
#### <a name="azurermdevtestlabs"></a><span data-ttu-id="9665e-157">AzureRM.DevTestLabs</span><span class="sxs-lookup"><span data-stu-id="9665e-157">AzureRM.DevTestLabs</span></span>
...
#### <a name="azurermlogicapp"></a><span data-ttu-id="9665e-173">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="9665e-173">AzureRM.LogicApp</span></span>
...
* <span data-ttu-id="9665e-206">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="9665e-206">Updated to the latest version of the Azure ClientRuntime.</span></span>
...
* <span data-ttu-id="9665e-228">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="9665e-228">Updated to the latest version of the Azure ClientRuntime.</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="9665e-243">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="9665e-243">AzureRM.TrafficManager</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="9665e-258">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="9665e-258">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="9665e-276">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="9665e-276">AzureRM.DataFactoryV2</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="9665e-290">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="9665e-290">AzureRM.Network</span></span>
...
* <span data-ttu-id="9665e-306">Corrigir tratamento de data e hora incorreto para cultura de base não EUA em Get-AzureSqlSyncGroupLog</span><span class="sxs-lookup"><span data-stu-id="9665e-306">Fix datetime handling incorrectly for non-us base culture in Get-AzureSqlSyncGroupLog</span></span>
...
#### <a name="azurermautomation"></a><span data-ttu-id="9665e-324">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="9665e-324">AzureRM.Automation</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="9665e-338">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="9665e-338">AzureRM.Network</span></span>
...
* <span data-ttu-id="9665e-355">Adicionados os cmdlets de migração de NameSpace Standard a Premium:</span><span class="sxs-lookup"><span data-stu-id="9665e-355">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    ...
    - <span data-ttu-id="9665e-358">Complete-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="9665e-358">Complete-AzureRmServiceBusMigration</span></span>
...
#### <a name="azurermprofile"></a><span data-ttu-id="9665e-375">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="9665e-375">AzureRM.Profile</span></span>
...
#### <a name="azurermeventhub"></a><span data-ttu-id="9665e-395">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="9665e-395">AzureRM.EventHub</span></span>
...
#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="9665e-413">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="9665e-413">AzureRM.RecoveryServices.Backup</span></span>
...
#### <a name="azurermservicebus"></a><span data-ttu-id="9665e-431">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="9665e-431">AzureRM.ServiceBus</span></span>
...
* <span data-ttu-id="9665e-448">Cmdlets corrigidos a seguir para mostrar corretamente a "ID da operação" e o "status da operação":</span><span class="sxs-lookup"><span data-stu-id="9665e-448">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    ...
    - <span data-ttu-id="9665e-451">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="9665e-451">Restart-AzureRmVM</span></span>
...
#### <a name="azurermpolicyinsights"></a><span data-ttu-id="9665e-472">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="9665e-472">AzureRM.PolicyInsights</span></span>
...
### <a name="azurermoperationalinsights"></a><span data-ttu-id="9665e-487">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="9665e-487">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="9665e-488">Modelo PSWorkspace atualizado para permitir que a Rede use o tipo como um parâmetro</span><span class="sxs-lookup"><span data-stu-id="9665e-488">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="9665e-489">6.2.0 - Junho de 2018</span><span class="sxs-lookup"><span data-stu-id="9665e-489">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="9665e-490">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="9665e-490">AzureRM.Profile</span></span>
* <span data-ttu-id="9665e-491">Corrija o problema em que a versão 10.0.3 do Newtonsoft.Json não estava sendo carregado na importação do módulo</span><span class="sxs-lookup"><span data-stu-id="9665e-491">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="9665e-492">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="9665e-492">AzureRM.Compute</span></span>
* <span data-ttu-id="9665e-493">Recurso de atualização de VM VMSS</span><span class="sxs-lookup"><span data-stu-id="9665e-493">VMSS VM Update feature</span></span>
    - <span data-ttu-id="9665e-494">Os cmdlets 'Update-AzureRmVmssVM' e 'New-AzureRmVMDataDisk' foram adicionados</span><span class="sxs-lookup"><span data-stu-id="9665e-494">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="9665e-495">Adicione o parâmetro VirtualMachineScaleSetVM ao cmdlet 'Add-AzureRmVMDataDisk' para dar suporte à adição de um disco de dados para a VM Vmss.</span><span class="sxs-lookup"><span data-stu-id="9665e-495">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="9665e-496">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="9665e-496">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="9665e-497">A versão do SDK do .Net ADF foi atualizada para a versão prévia 0.8.0 que contém as seguintes alterações:</span><span class="sxs-lookup"><span data-stu-id="9665e-497">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="9665e-498">A operação para Configurar o repositório de fábrica foi adicionada</span><span class="sxs-lookup"><span data-stu-id="9665e-498">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="9665e-499">O LinkedService QuickBooks foi atualizado para expor as propriedades consumerKey e consumerSecret</span><span class="sxs-lookup"><span data-stu-id="9665e-499">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="9665e-500">Vários tipos de modelo atualizados de SecretBase para Object</span><span class="sxs-lookup"><span data-stu-id="9665e-500">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="9665e-501">Foram adicionados gatilho de eventos de blob</span><span class="sxs-lookup"><span data-stu-id="9665e-501">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="9665e-502">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="9665e-502">AzureRM.KeyVault</span></span>
* <span data-ttu-id="9665e-503">Atualizar documentação com a saída de exemplo</span><span class="sxs-lookup"><span data-stu-id="9665e-503">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="9665e-504">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="9665e-504">AzureRM.Network</span></span>
* <span data-ttu-id="9665e-505">Habilitar parâmetros de Análise de Tráfego nos cmdlets do Observador de Rede</span><span class="sxs-lookup"><span data-stu-id="9665e-505">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="9665e-506">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="9665e-506">AzureRM.Resources</span></span>
* <span data-ttu-id="9665e-507">Corrigir o problema com a propriedade 'Properties' dos objetos 'PSResource' retornados de 'Get-AzureRmResource'</span><span class="sxs-lookup"><span data-stu-id="9665e-507">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="9665e-508">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="9665e-508">AzureRM.Scheduler</span></span>
* <span data-ttu-id="9665e-509">Corrigir o problema com a atualização de ServiceBusQueueJob não definindo novos valores de Autenticação</span><span class="sxs-lookup"><span data-stu-id="9665e-509">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="9665e-510">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="9665e-510">AzureRM.Sql</span></span>
* <span data-ttu-id="9665e-511">Os seguintes cmdlets foram atualizados com o parâmetro LicenseType opcional</span><span class="sxs-lookup"><span data-stu-id="9665e-511">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="9665e-512">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="9665e-512">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="9665e-513">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="9665e-513">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="9665e-514">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="9665e-514">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="9665e-515">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="9665e-515">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="9665e-516">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="9665e-516">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="9665e-517">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="9665e-517">AzureRM.Websites</span></span>
* <span data-ttu-id="9665e-518">'New-AzureRMWebApp' será atualizado para usar os algoritmos comuns da biblioteca de Estratégia.</span><span class="sxs-lookup"><span data-stu-id="9665e-518">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="9665e-519">6.1.0 - maio de 2018</span><span class="sxs-lookup"><span data-stu-id="9665e-519">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="9665e-520">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="9665e-520">AzureRM.Profile</span></span>
* <span data-ttu-id="9665e-521">Corrija o problema onde executar “Clear-AzureRmContext” manteria um contexto vazio com o nome do contexto padrão anterior, o que impediu o usuário de criar um novo contexto com o antigo nome</span><span class="sxs-lookup"><span data-stu-id="9665e-521">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="9665e-522">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="9665e-522">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="9665e-523">Habilite as operações de associação/desassociação do Gateway no sistema autônomo.</span><span class="sxs-lookup"><span data-stu-id="9665e-523">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="9665e-524">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="9665e-524">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="9665e-525">Suporte adicionado para ApiVersions, ApiReleases e ApiRevisions</span><span class="sxs-lookup"><span data-stu-id="9665e-525">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="9665e-526">Suporte adicionado para Back-end do ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="9665e-526">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="9665e-527">Suporte adicionado para Agente do Application Insights</span><span class="sxs-lookup"><span data-stu-id="9665e-527">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="9665e-528">Suporte adicionado para reconhecer a sku “Básica” como uma sku válida do serviço de Gerenciamento da Api</span><span class="sxs-lookup"><span data-stu-id="9665e-528">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="9665e-529">Suporte adicionado para instalar os Certificados emitidos pela autoridade de certificação privada como Raiz ou CA</span><span class="sxs-lookup"><span data-stu-id="9665e-529">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="9665e-530">Suporte adicionado para aceitar certificados SSL Personalizados via KeyVault e vários nomes de host do proxy</span><span class="sxs-lookup"><span data-stu-id="9665e-530">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="9665e-531">Suporte adicionado para a identidade MSI</span><span class="sxs-lookup"><span data-stu-id="9665e-531">Added support for MSI identity</span></span>
* <span data-ttu-id="9665e-532">Suporte adicionado para aceitar Políticas via Url OBSERVAÇÃO: os cmdlets a seguir serão preteridos na futura versão</span><span class="sxs-lookup"><span data-stu-id="9665e-532">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="9665e-533">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="9665e-533">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="9665e-534">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="9665e-534">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="9665e-535">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="9665e-535">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="9665e-536">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="9665e-536">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="9665e-537">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="9665e-537">AzureRM.Batch</span></span>
* <span data-ttu-id="9665e-538">Versão do novo cmdlet Get-AzureBatchPoolNodeCounts</span><span class="sxs-lookup"><span data-stu-id="9665e-538">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="9665e-539">Versão novo cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span><span class="sxs-lookup"><span data-stu-id="9665e-539">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="9665e-540">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="9665e-540">AzureRM.Consumption</span></span>
* <span data-ttu-id="9665e-541">Adicionar os novos parâmetros Expand, ResourceGroup, InstanceName, InstanceId, Tags e Top no cmdlet Get-AzureRmConsumptionUsageDetail</span><span class="sxs-lookup"><span data-stu-id="9665e-541">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="9665e-542">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="9665e-542">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="9665e-543">Corrigir exemplo para Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="9665e-543">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="9665e-544">Corrigir exceção do parâmetro nulo para Recurse, caso esteja em Set-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="9665e-544">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="9665e-545">Corrigir arquivos de ajuda para Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="9665e-545">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="9665e-546">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="9665e-546">AzureRM.Network</span></span>
* <span data-ttu-id="9665e-547">Aumentar a versão do SDK de Rede de 18.0.0-preview para 19.0.0-preview</span><span class="sxs-lookup"><span data-stu-id="9665e-547">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="9665e-548">Cmdlet adicionado para criar a configuração de protocolo</span><span class="sxs-lookup"><span data-stu-id="9665e-548">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="9665e-549">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="9665e-549">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="9665e-550">Cmdlet adicionado para acrescentar uma nova conexão de circuito a um circuito de rota expressa existente.</span><span class="sxs-lookup"><span data-stu-id="9665e-550">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="9665e-551">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="9665e-551">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="9665e-552">Cmdlet adicionado para remover uma conexão de circuito de um circuito de rota expressa existente.</span><span class="sxs-lookup"><span data-stu-id="9665e-552">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="9665e-553">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="9665e-553">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="9665e-554">Cmdlet adicionado para recuperar uma conexão de circuito</span><span class="sxs-lookup"><span data-stu-id="9665e-554">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="9665e-555">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="9665e-555">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="9665e-556">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="9665e-556">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="9665e-557">Uso da autenticação do servidor corrigido com certificados gerados (problema 5998)</span><span class="sxs-lookup"><span data-stu-id="9665e-557">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="9665e-558">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="9665e-558">AzureRM.Sql</span></span>
* <span data-ttu-id="9665e-559">Cmdlets de auditoria atualizados para permitir a remoção de AuditActions ou AuditActionGroups</span><span class="sxs-lookup"><span data-stu-id="9665e-559">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="9665e-560">Problema corrigido com Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy ao definir uma nova política de retenção flexível onde o comando falharia com “Configurar política de retenção de longo prazo com o cofre de serviços de recuperação do azure e não há mais suporte para a política.</span><span class="sxs-lookup"><span data-stu-id="9665e-560">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="9665e-561">Envie a solicitação com a nova política de retenção flexível”.</span><span class="sxs-lookup"><span data-stu-id="9665e-561">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="9665e-562">Atualizar todos os cmdlets relacionados ao Banco de Dados Sql do Azure/Criação do ElasticPool/Atualização para usar a nova API do Banco de Dados, que suporta a propriedade Sku para o dimensionamento e as propriedades relacionadas à camada.</span><span class="sxs-lookup"><span data-stu-id="9665e-562">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="9665e-563">Os cmdlets atualizados, incluindo:</span><span class="sxs-lookup"><span data-stu-id="9665e-563">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="9665e-564">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="9665e-564">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="9665e-565">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="9665e-565">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="9665e-566">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="9665e-566">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="9665e-567">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="9665e-567">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="9665e-568">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="9665e-568">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="9665e-569">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="9665e-569">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="9665e-570">Atualize os parâmetros para “Get-AzureRmTrafficManagerProfile” para que o parâmetro -ResourceGroupName seja requerido ao usar o parâmetro -Name.</span><span class="sxs-lookup"><span data-stu-id="9665e-570">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
