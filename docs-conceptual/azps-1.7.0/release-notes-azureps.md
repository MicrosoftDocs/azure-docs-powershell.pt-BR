...
* Corrigir problema ao redirecionar o resultado de `Get-AzResource` para `Set-AzResource`
    - Mais informações podem ser obtidas aqui: https://github.com/Azure/azure-powershell/issues/8240
* Corrigir problema com a alteração no tipo de dados JSON ao executar `Set-AzResource`
...
### <a name="azresources"></a>Az.Resources
* Atualizar documentação de ajuda para os parâmetros relacionados à identidade de recurso em `New-AzureRmPolicyAssignment` e `Set-AzureRmPolicyAssignment`
