...
#### <a name="azcdn"></a><span data-ttu-id="ea9a3-114">Az.Cdn</span><span class="sxs-lookup"><span data-stu-id="ea9a3-114">Az.Cdn</span></span>
...
#### <a name="azeventhub"></a><span data-ttu-id="ea9a3-128">Az.EventHub</span><span class="sxs-lookup"><span data-stu-id="ea9a3-128">Az.EventHub</span></span>
...
#### <a name="aznetwork"></a><span data-ttu-id="ea9a3-149">Az.Network</span><span class="sxs-lookup"><span data-stu-id="ea9a3-149">Az.Network</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="ea9a3-165">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ea9a3-165">Az.Resources</span></span>
...
#### <a name="azcontainerinstance"></a><span data-ttu-id="ea9a3-201">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="ea9a3-201">Az.ContainerInstance</span></span>
...
* <span data-ttu-id="ea9a3-218">Propriedades do Serviço de Blob de Gerenciamento de Suporte de uma conta de armazenamento especificada com a API do plano de gerenciamento</span><span class="sxs-lookup"><span data-stu-id="ea9a3-218">Support Manage Blob Service Properties of a specified Storage account with Management plane API</span></span>
    - <span data-ttu-id="ea9a3-219">Update-AzStorageBlobServiceProperty</span><span class="sxs-lookup"><span data-stu-id="ea9a3-219">Update-AzStorageBlobServiceProperty</span></span>
...
#### <a name="azautomation"></a><span data-ttu-id="ea9a3-237">Az.Automation</span><span class="sxs-lookup"><span data-stu-id="ea9a3-237">Az.Automation</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="ea9a3-253">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ea9a3-253">Az.Resources</span></span>
...
#### <a name="azautomation"></a><span data-ttu-id="ea9a3-272">Az.Automation</span><span class="sxs-lookup"><span data-stu-id="ea9a3-272">Az.Automation</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="ea9a3-291">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ea9a3-291">Az.Resources</span></span>
...
#### <a name="azcognitiveservices"></a><span data-ttu-id="ea9a3-310">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="ea9a3-310">Az.CognitiveServices</span></span>
...
* <span data-ttu-id="ea9a3-326">Novos cmdlets para assemblies de conta de integração</span><span class="sxs-lookup"><span data-stu-id="ea9a3-326">New cmdlets for Integration Account Assemblies</span></span>
    ...
    - <span data-ttu-id="ea9a3-329">Remove-AzIntegrationAccountAssembly</span><span class="sxs-lookup"><span data-stu-id="ea9a3-329">Remove-AzIntegrationAccountAssembly</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="ea9a3-366">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ea9a3-366">Az.Resources</span></span>
...
## <a name="120---january-2019"></a><span data-ttu-id="ea9a3-382">1.2.0 – Janeiro de 2019</span><span class="sxs-lookup"><span data-stu-id="ea9a3-382">1.2.0 - January 2019</span></span>
...
#### <a name="azdatafactory"></a><span data-ttu-id="ea9a3-400">Az.DataFactory</span><span class="sxs-lookup"><span data-stu-id="ea9a3-400">Az.DataFactory</span></span>
...
#### <a name="azservicefabric"></a><span data-ttu-id="ea9a3-420">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="ea9a3-420">Az.ServiceFabric</span></span>
...
#### <a name="aztrafficmanager"></a><span data-ttu-id="ea9a3-437">Az.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="ea9a3-437">Az.TrafficManager</span></span>
...
#### <a name="azeventgrid"></a><span data-ttu-id="ea9a3-453">Az.EventGrid</span><span class="sxs-lookup"><span data-stu-id="ea9a3-453">Az.EventGrid</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="ea9a3-470">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ea9a3-470">Az.Resources</span></span>
...
#### <a name="azwebsites"></a><span data-ttu-id="ea9a3-486">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="ea9a3-486">Az.Websites</span></span>
...
- <span data-ttu-id="ea9a3-493">Para obter mais detalhes e um roteiro, confira a [página de Comunicado do Az](https://aka.ms/azps-announce)</span><span class="sxs-lookup"><span data-stu-id="ea9a3-493">For more details and a roadmap, see the [Az Announcement page](https://aka.ms/azps-announce)</span></span>
- <span data-ttu-id="ea9a3-494">Confira o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter informações sobre como migrar do AzureRM</span><span class="sxs-lookup"><span data-stu-id="ea9a3-494">See the [Migration Guide](https://aka.ms/azps-migration-guide) for information on migrating from AzureRM</span></span>

### <a name="azaccounts"></a><span data-ttu-id="ea9a3-495">Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="ea9a3-495">Az.Accounts</span></span>
- <span data-ttu-id="ea9a3-496">Alterado de Az.Profile</span><span class="sxs-lookup"><span data-stu-id="ea9a3-496">Changed from Az.Profile</span></span>
- <span data-ttu-id="ea9a3-497">Corrigidos os formatos de tabela para tipos de perfil e contexto</span><span class="sxs-lookup"><span data-stu-id="ea9a3-497">Fixed table formats for profile and context types</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="ea9a3-498">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="ea9a3-498">Az.ApiManagement</span></span>
- <span data-ttu-id="ea9a3-499">Correções para #7002</span><span class="sxs-lookup"><span data-stu-id="ea9a3-499">Fixes for #7002</span></span>
- <span data-ttu-id="ea9a3-500">Alterações de falha pequenas. Confira o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-500">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azbatch"></a><span data-ttu-id="ea9a3-501">Az.Batch</span><span class="sxs-lookup"><span data-stu-id="ea9a3-501">Az.Batch</span></span>
- <span data-ttu-id="ea9a3-502">Adicionada a capacidade de ver qual versão do agente de nó do Lote do Azure está em execução em cada uma das VMs em um pool, através da nova propriedade `NodeAgentInformation` em `PSComputeNode`.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-502">Added the ability to see what version of the Azure Batch Node Agent is running on each of the VMs in a pool, via the new `NodeAgentInformation` property on `PSComputeNode`.</span></span>
- <span data-ttu-id="ea9a3-503">O padrão `Caching` para `PSDataDisk` agora é `ReadWrite` em vez de `None`.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-503">The `Caching` default for `PSDataDisk` is now `ReadWrite` instead of `None`.</span></span>
- <span data-ttu-id="ea9a3-504">Alterações de falha pequenas. Confira o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-504">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azbilling"></a><span data-ttu-id="ea9a3-505">Az.Billing</span><span class="sxs-lookup"><span data-stu-id="ea9a3-505">Az.Billing</span></span>
- <span data-ttu-id="ea9a3-506">Combina os cmdlets Billing, Consumption e UsageAggregates. Consulte o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-506">Combines Billing, Consumption, and UsageAggregates cmdlets, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azcognitivservices"></a><span data-ttu-id="ea9a3-507">Az.CognitivServices</span><span class="sxs-lookup"><span data-stu-id="ea9a3-507">Az.CognitivServices</span></span>
- <span data-ttu-id="ea9a3-508">Adiciona complementos para SkuName e Typem disponíveis na operação New-AzureRmCognitiveServicesAccount</span><span class="sxs-lookup"><span data-stu-id="ea9a3-508">Add completers for SkuName and Typem available on New-AzureRmCognitiveServicesAccount operation</span></span>
- <span data-ttu-id="ea9a3-509">Removido o conjunto de parâmetros GetSkusWithAccountParamSetName de Get-AzCognitiveServicesAccountSkus</span><span class="sxs-lookup"><span data-stu-id="ea9a3-509">Removed GetSkusWithAccountParamSetName parameter set from Get-AzCognitiveServicesAccountSkus</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="ea9a3-510">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="ea9a3-510">Az.ContainerInstance</span></span>
- <span data-ttu-id="ea9a3-511">Adicionado suporte para ManagedIdentity</span><span class="sxs-lookup"><span data-stu-id="ea9a3-511">Added ManagedIdentity support</span></span>

### <a name="azdatalakeanalytics"></a><span data-ttu-id="ea9a3-512">Az.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="ea9a3-512">Az.DataLakeAnalytics</span></span>
- <span data-ttu-id="ea9a3-513">Alterações de falha pequenas. Confira o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-513">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="ea9a3-514">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="ea9a3-514">Az.DataLakeStore</span></span>
- <span data-ttu-id="ea9a3-515">Alterações de falha pequenas. Confira o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-515">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azmonitor"></a><span data-ttu-id="ea9a3-516">Az.Monitor</span><span class="sxs-lookup"><span data-stu-id="ea9a3-516">Az.Monitor</span></span>
- <span data-ttu-id="ea9a3-517">Az.Insights renomeado para Az.Monitor e outras pequenas alterações. Consulte o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-517">Renamed Az.Insights to Az.Monitor and other minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azkeyvault"></a><span data-ttu-id="ea9a3-518">Az.KeyVault</span><span class="sxs-lookup"><span data-stu-id="ea9a3-518">Az.KeyVault</span></span>
- <span data-ttu-id="ea9a3-519">Removida a propriedade “PurgeDisabled” preterida dos tipos de saída</span><span class="sxs-lookup"><span data-stu-id="ea9a3-519">Removed the deprecated 'PurgeDisabled' property from output types</span></span>

### <a name="azmachinelearning"></a><span data-ttu-id="ea9a3-520">Az.MachineLearning</span><span class="sxs-lookup"><span data-stu-id="ea9a3-520">Az.MachineLearning</span></span>
- <span data-ttu-id="ea9a3-521">Incluídos os cmdlets do módulo Az.MachineLearningCompute</span><span class="sxs-lookup"><span data-stu-id="ea9a3-521">Included cmdlets from Az.MachineLearningCompute module</span></span>

### <a name="azmedia"></a><span data-ttu-id="ea9a3-522">Az.Media</span><span class="sxs-lookup"><span data-stu-id="ea9a3-522">Az.Media</span></span>
- <span data-ttu-id="ea9a3-523">Removido o alias -Tags de New-AzMediaService</span><span class="sxs-lookup"><span data-stu-id="ea9a3-523">Remove deprecated -Tags alias from New-AzMediaService</span></span>

### <a name="aznetwork"></a><span data-ttu-id="ea9a3-524">Az.Network</span><span class="sxs-lookup"><span data-stu-id="ea9a3-524">Az.Network</span></span>
<span data-ttu-id="ea9a3-525">Adicionado suporte para a configuração de RewriteRuleSets no Gateway de Aplicativo</span><span class="sxs-lookup"><span data-stu-id="ea9a3-525">Added support for the configuring RewriteRuleSets in the Application Gateway</span></span>
    - <span data-ttu-id="ea9a3-526">Novos cmdlets adicionados:</span><span class="sxs-lookup"><span data-stu-id="ea9a3-526">New cmdlets added:</span></span>
        - <span data-ttu-id="ea9a3-527">Add-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="ea9a3-527">Add-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="ea9a3-528">Get-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="ea9a3-528">Get-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="ea9a3-529">New-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="ea9a3-529">New-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="ea9a3-530">Remove-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="ea9a3-530">Remove-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="ea9a3-531">Set-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="ea9a3-531">Set-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="ea9a3-532">New-AzureRmApplicationGatewayRewriteRule</span><span class="sxs-lookup"><span data-stu-id="ea9a3-532">New-AzureRmApplicationGatewayRewriteRule</span></span>
        - <span data-ttu-id="ea9a3-533">New-AzureRmApplicationGatewayRewriteRuleActionSet</span><span class="sxs-lookup"><span data-stu-id="ea9a3-533">New-AzureRmApplicationGatewayRewriteRuleActionSet</span></span>
        - <span data-ttu-id="ea9a3-534">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span><span class="sxs-lookup"><span data-stu-id="ea9a3-534">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span></span>
    - <span data-ttu-id="ea9a3-535">Cmdlets atualizados com o parâmetro opcional -RewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="ea9a3-535">Cmdlets updated with optional parameter -RewriteRuleSet</span></span>
        - <span data-ttu-id="ea9a3-536">New-AzureRmApplicationGateway</span><span class="sxs-lookup"><span data-stu-id="ea9a3-536">New-AzureRmApplicationGateway</span></span>
        - <span data-ttu-id="ea9a3-537">New-AzureRmApplicationGatewayRequestRoutingRule</span><span class="sxs-lookup"><span data-stu-id="ea9a3-537">New-AzureRmApplicationGatewayRequestRoutingRule</span></span>
        - <span data-ttu-id="ea9a3-538">Add-AzureRmApplicationGatewayRequestRoutingRule</span><span class="sxs-lookup"><span data-stu-id="ea9a3-538">Add-AzureRmApplicationGatewayRequestRoutingRule</span></span>
        - <span data-ttu-id="ea9a3-539">New-AzureRmApplicationGatewayPathRuleConfig</span><span class="sxs-lookup"><span data-stu-id="ea9a3-539">New-AzureRmApplicationGatewayPathRuleConfig</span></span>
        - <span data-ttu-id="ea9a3-540">Add-AzureRmApplicationGatewayUrlPathMapConfig</span><span class="sxs-lookup"><span data-stu-id="ea9a3-540">Add-AzureRmApplicationGatewayUrlPathMapConfig</span></span>
        - <span data-ttu-id="ea9a3-541">New-AzureRmApplicationGatewayUrlPathMapConfig Adicionado suporte para KeyVault para o Gateway de Aplicativo usando Identity.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-541">New-AzureRmApplicationGatewayUrlPathMapConfig Added KeyVault Support to Application Gateway using Identity.</span></span>
    - <span data-ttu-id="ea9a3-542">Cmdlets atualizados com o parâmetro opcional KeyVaultSecretId-, - KeyVaultSecret</span><span class="sxs-lookup"><span data-stu-id="ea9a3-542">Cmdlets updated with optonal parameter -KeyVaultSecretId, -KeyVaultSecret</span></span>
        - <span data-ttu-id="ea9a3-543">Add-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="ea9a3-543">Add-AzApplicationGatewaySslCertificate</span></span>
        - <span data-ttu-id="ea9a3-544">New-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="ea9a3-544">New-AzApplicationGatewaySslCertificate</span></span>
        - <span data-ttu-id="ea9a3-545">Set-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="ea9a3-545">Set-AzApplicationGatewaySslCertificate</span></span>
    - <span data-ttu-id="ea9a3-546">Cmdlet New-AzApplicationGateway atualizado com o parâmetro opcional -UserAssignedIdentity</span><span class="sxs-lookup"><span data-stu-id="ea9a3-546">New-AzApplicationGateway cmdlet updated with optional parameter -UserAssignedIdentity</span></span>
- <span data-ttu-id="ea9a3-547">Alterações de falha pequenas. Confira o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-547">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azoperationalinsights"></a><span data-ttu-id="ea9a3-548">Az.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="ea9a3-548">Az.OperationalInsights</span></span>
- <span data-ttu-id="ea9a3-549">Alterações de falha pequenas. Confira o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-549">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azprofile"></a><span data-ttu-id="ea9a3-550">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="ea9a3-550">Az.Profile</span></span>
- <span data-ttu-id="ea9a3-551">Nome do módulo alterado para Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="ea9a3-551">Changed module name to Az.Accounts</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="ea9a3-552">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="ea9a3-552">Az.RecoveryServices</span></span>
- <span data-ttu-id="ea9a3-553">Alterações de falha pequenas. Confira o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-553">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azresources"></a><span data-ttu-id="ea9a3-554">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ea9a3-554">Az.Resources</span></span>
- <span data-ttu-id="ea9a3-555">Alterações de falha pequenas. Confira o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-555">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="ea9a3-556">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="ea9a3-556">Az.ServiceFabric</span></span>
- <span data-ttu-id="ea9a3-557">Suporte para especificação de certificado pelo nome comum e impressão digital</span><span class="sxs-lookup"><span data-stu-id="ea9a3-557">Support specfying certificate by common name and thumbprint</span></span>
- <span data-ttu-id="ea9a3-558">Alterações de falha pequenas. Consulte o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-558">Mnor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azsignalr"></a><span data-ttu-id="ea9a3-559">Az.SIgnalR</span><span class="sxs-lookup"><span data-stu-id="ea9a3-559">Az.SIgnalR</span></span>
- <span data-ttu-id="ea9a3-560">Disponibilidade Geral de cmdlets do PowerShell para o SIgnalR</span><span class="sxs-lookup"><span data-stu-id="ea9a3-560">General Availability for PowerShell cmdlets for SIgnalR</span></span>

### <a name="azsql"></a><span data-ttu-id="ea9a3-561">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="ea9a3-561">Az.Sql</span></span>
- <span data-ttu-id="ea9a3-562">Adicionado novos tipos de detecção Data_Exfiltration e Unsafe_Action aos cmdlets da detecção de ameaças</span><span class="sxs-lookup"><span data-stu-id="ea9a3-562">Added new Data_Exfiltration and Unsafe_Action detection types to Threat Detection's cmdlets</span></span>
- <span data-ttu-id="ea9a3-563">Exemplos de documentação atualizados para cmdlets de auditoria do SQL</span><span class="sxs-lookup"><span data-stu-id="ea9a3-563">Updated documentation examples for Sql Auditing cmdlets</span></span>
- <span data-ttu-id="ea9a3-564">Alterações de falha pequenas. Confira o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-564">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azstorage"></a><span data-ttu-id="ea9a3-565">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="ea9a3-565">Az.Storage</span></span>
- <span data-ttu-id="ea9a3-566">Alterações de falha pequenas. Confira o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-566">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azwebsites"></a><span data-ttu-id="ea9a3-567">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="ea9a3-567">Az.Websites</span></span>
- <span data-ttu-id="ea9a3-568">Alterações de falha pequenas. Confira o [Guia de Migração](https://aka.ms/azps-migration-guide) para obter detalhes</span><span class="sxs-lookup"><span data-stu-id="ea9a3-568">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

## <a name="070---december-2018"></a><span data-ttu-id="ea9a3-569">0.7.0 - Dezembro de 2018</span><span class="sxs-lookup"><span data-stu-id="ea9a3-569">0.7.0 - December 2018</span></span>

### <a name="general"></a><span data-ttu-id="ea9a3-570">Geral</span><span class="sxs-lookup"><span data-stu-id="ea9a3-570">General</span></span>

* <span data-ttu-id="ea9a3-571">Pequenas alterações para a futura transição de AzureRM para Az</span><span class="sxs-lookup"><span data-stu-id="ea9a3-571">Minor changes for upcoming AzureRM to Az transition</span></span>

### <a name="azcompute"></a><span data-ttu-id="ea9a3-572">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="ea9a3-572">Az.Compute</span></span>

* <span data-ttu-id="ea9a3-573">Adicionado suporte para UltraSSD e imagens da Galeria nos conjuntos de parâmetro simples para cmdlets `New-AzVm(ss)`.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-573">Add support for UltraSSD and Gallery Images in the simple param sets for `New-AzVm(ss)` cmdlets.</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="ea9a3-574">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="ea9a3-574">Az.DataLakeStore</span></span>

* <span data-ttu-id="ea9a3-575">Corrigida a barra à direita do domínio da conta do ADLS</span><span class="sxs-lookup"><span data-stu-id="ea9a3-575">Fix the trailing slash of the domain of adls account</span></span>

### <a name="azfrontdoor"></a><span data-ttu-id="ea9a3-576">Az.FrontDoor</span><span class="sxs-lookup"><span data-stu-id="ea9a3-576">Az.FrontDoor</span></span>

* <span data-ttu-id="ea9a3-577">Corrigidos alguns links desfeitos</span><span class="sxs-lookup"><span data-stu-id="ea9a3-577">Fixed some broken links</span></span>
    - <span data-ttu-id="ea9a3-578">Nos artigos New-AzureRmFrontDoor e Set-AzureRmFrontDoor, foi corrigido o link para o artigo do cmdlet New-AzureRmFrontDoorHealthProbeSettingObject.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-578">In the New-AzureRmFrontDoor and Set-AzureRmFrontDoor articles, fixed the link to the New-AzureRmFrontDoorHealthProbeSettingObject cmdlet article.</span></span>
    - <span data-ttu-id="ea9a3-579">No artigo New-AzureRmFrontDoorManagedRuleObject, foi corrigido o link para o artigo do cmdlet New-AzureRmFrontDoorRuleGroupOverrideObject.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-579">In the New-AzureRmFrontDoorManagedRuleObject article, fixed the link to the New-AzureRmFrontDoorRuleGroupOverrideObject cmdlet article.</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="ea9a3-580">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="ea9a3-580">Az.RecoveryServices</span></span>

* <span data-ttu-id="ea9a3-581">Adicionadas validações do lado do cliente para operações de restauração do Compartilhamento de Arquivos.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-581">Added client side validations for Azure File Share restore operations.</span></span>
* <span data-ttu-id="ea9a3-582">Agora storageAccountName e storageAccountResourceGroupName são opcionais para restauração do AFS.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-582">Made storageAccountName and storageAccountResourceGroupName optional for afs restore.</span></span>

### <a name="azresources"></a><span data-ttu-id="ea9a3-583">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ea9a3-583">Az.Resources</span></span>

* <span data-ttu-id="ea9a3-584">Correção para https://github.com/Azure/azure-powershell/issues/7679</span><span class="sxs-lookup"><span data-stu-id="ea9a3-584">Fix for https://github.com/Azure/azure-powershell/issues/7679</span></span>
    - <span data-ttu-id="ea9a3-585">Atualizado Get-AzureRmRoleAssignment para usar o escopo de assinatura, se ele for fornecido ao solicitar aos administradores clássicos.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-585">Update Get-AzureRmRoleAssignment to use the subscription scope if it is provided when requesting classic administrators.</span></span>

### <a name="azsql"></a><span data-ttu-id="ea9a3-586">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="ea9a3-586">Az.Sql</span></span>

* <span data-ttu-id="ea9a3-587">Pequenas alterações para a futura transição de AzureRM para Az</span><span class="sxs-lookup"><span data-stu-id="ea9a3-587">Minor changes for upcoming AzureRM to Az transition</span></span>
* <span data-ttu-id="ea9a3-588">Corrigido o problema com o uso de Get-AzureRmSqlDatabaseVulnerabilityAssessment com núcleo DotNet</span><span class="sxs-lookup"><span data-stu-id="ea9a3-588">Fixed issue with using Get-AzureRmSqlDatabaseVulnerabilityAssessment with DotNet core</span></span>
* <span data-ttu-id="ea9a3-589">Documentação modificada de mensagens de Ajuda relacionadas aos cmdlets de Auditoria do SQL.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-589">Modified documentation of help messages related to SQL Auditing cmdlets.</span></span>

### <a name="azstorage"></a><span data-ttu-id="ea9a3-590">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="ea9a3-590">Az.Storage</span></span>

* <span data-ttu-id="ea9a3-591">Adicionado -EnableHierarchicalNamespace a New-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="ea9a3-591">Add -EnableHierarchicalNamespace to New-AzureRmStorageAccount</span></span>
* <span data-ttu-id="ea9a3-592">Corrigido o problema em que o cmdlet Copy File não podia reutilizar o contexto de origem no destino quando a entrada não era -DestContext</span><span class="sxs-lookup"><span data-stu-id="ea9a3-592">Fix issue that Copy File cmdlet can't reuse source context in destination when not input -DestContext</span></span>
    - <span data-ttu-id="ea9a3-593">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="ea9a3-593">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="ea9a3-594">Suporte para a Configuração do Site Estático</span><span class="sxs-lookup"><span data-stu-id="ea9a3-594">Support Static Website configuration</span></span>
    - <span data-ttu-id="ea9a3-595">Enable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="ea9a3-595">Enable-AzureStorageStaticWebsite</span></span>
    - <span data-ttu-id="ea9a3-596">Disable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="ea9a3-596">Disable-AzureStorageStaticWebsite</span></span>

### <a name="azwebsites"></a><span data-ttu-id="ea9a3-597">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="ea9a3-597">Az.Websites</span></span>

* <span data-ttu-id="ea9a3-598">Set-AzureRmWebApp e Set-AzureRmWebAppSlot</span><span class="sxs-lookup"><span data-stu-id="ea9a3-598">Set-AzureRmWebApp and Set-AzureRmWebAppSlot</span></span> 
    - <span data-ttu-id="ea9a3-599">Novo parâmetro (-AzureStoragePath) adicionado para especificar caminhos do Armazenamento do Azure que serão montados em aplicativos de contêiner do Windows e Linux.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-599">New parameter (-AzureStoragePath) added to specify Azure Storage paths to be mounted in Windows and Linux container apps.</span></span> <span data-ttu-id="ea9a3-600">Use a saída do novo cmdlet New-AzureRmWebAppAzureStoragePath como um parâmetro para definir os caminhos do Armazenamento do Azure.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-600">Use the output of the new cmdlet New-AzureRmWebAppAzureStoragePath as a parameter to set the Azure Storage paths.</span></span>

## <a name="061---november-2018"></a><span data-ttu-id="ea9a3-601">0.6.1 - Novembro de 2018</span><span class="sxs-lookup"><span data-stu-id="ea9a3-601">0.6.1 - November 2018</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="ea9a3-602">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="ea9a3-602">Az.ApiManagement</span></span>
* <span data-ttu-id="ea9a3-603">Atualizar as dependências para o problema de mapeamento do tipo</span><span class="sxs-lookup"><span data-stu-id="ea9a3-603">Update dependencies for type mapping issue</span></span>

### <a name="azautomation"></a><span data-ttu-id="ea9a3-604">Az.Automation</span><span class="sxs-lookup"><span data-stu-id="ea9a3-604">Az.Automation</span></span>
* <span data-ttu-id="ea9a3-605">Cmdlets de Automação do Azure baseados no Swagger</span><span class="sxs-lookup"><span data-stu-id="ea9a3-605">Swagger based Azure Automation cmdlets</span></span>
* <span data-ttu-id="ea9a3-606">Cmdlets de Gerenciamento de Atualizações Adicionados</span><span class="sxs-lookup"><span data-stu-id="ea9a3-606">Added Update Management cmdlets</span></span>
* <span data-ttu-id="ea9a3-607">Cmdlets de Controle do Código-fonte adicionados</span><span class="sxs-lookup"><span data-stu-id="ea9a3-607">Added Source Control cmdlets</span></span>
* <span data-ttu-id="ea9a3-608">Cmdlet Remove-AzureRmAutomationHybridWorkerGroup adicionado</span><span class="sxs-lookup"><span data-stu-id="ea9a3-608">Added Remove-AzureRmAutomationHybridWorkerGroup cmdlet</span></span>
* <span data-ttu-id="ea9a3-609">Corrigido o comando de Nó do Registro de DSC</span><span class="sxs-lookup"><span data-stu-id="ea9a3-609">Fixed the DSC Register Node command</span></span>

### <a name="azcompute"></a><span data-ttu-id="ea9a3-610">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="ea9a3-610">Az.Compute</span></span>
* <span data-ttu-id="ea9a3-611">Problema de identidade corrigido para a identidade SystemAssigned</span><span class="sxs-lookup"><span data-stu-id="ea9a3-611">Fixed identity issue for SystemAssigned identity</span></span>
* <span data-ttu-id="ea9a3-612">Atualizar as dependências para o problema de mapeamento do tipo</span><span class="sxs-lookup"><span data-stu-id="ea9a3-612">Update dependencies for type mapping issue</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="ea9a3-613">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="ea9a3-613">Az.ContainerInstance</span></span>
* <span data-ttu-id="ea9a3-614">Atualizar as dependências para o problema de mapeamento do tipo</span><span class="sxs-lookup"><span data-stu-id="ea9a3-614">Update dependencies for type mapping issue</span></span>

### <a name="azmarketplaceordering"></a><span data-ttu-id="ea9a3-615">Az.MarketplaceOrdering</span><span class="sxs-lookup"><span data-stu-id="ea9a3-615">Az.MarketplaceOrdering</span></span>
* <span data-ttu-id="ea9a3-616">atualizar a descrição de exemplos dos cmdlets do marketplace</span><span class="sxs-lookup"><span data-stu-id="ea9a3-616">update the examples description for marketplace cmdlets</span></span>

### <a name="aznetwork"></a><span data-ttu-id="ea9a3-617">Az.Network</span><span class="sxs-lookup"><span data-stu-id="ea9a3-617">Az.Network</span></span>
* <span data-ttu-id="ea9a3-618">Cmdlets New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError adicionados</span><span class="sxs-lookup"><span data-stu-id="ea9a3-618">Added cmdlet New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError</span></span>
* <span data-ttu-id="ea9a3-619">ICMP adicionado aos Protocolos de Rede do AzureFirewall com suporte</span><span class="sxs-lookup"><span data-stu-id="ea9a3-619">Added ICMP back to supported AzureFirewall Network Protocols</span></span>
* <span data-ttu-id="ea9a3-620">Atualizar cmdlet Test-AzureRmNetworkWatcherConnectivity, adicionar validação no id de destino, endereço e porta.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-620">Update cmdlet Test-AzureRmNetworkWatcherConnectivity, add validation on destination id, address and port.</span></span> 
* <span data-ttu-id="ea9a3-621">Corrigir problemas com o uso da memória no mapa VirtualNetwork</span><span class="sxs-lookup"><span data-stu-id="ea9a3-621">Fix issues with memory usage in VirtualNetwork map</span></span>

### <a name="azrecoveryservicesbackup"></a><span data-ttu-id="ea9a3-622">Az.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="ea9a3-622">Az.RecoveryServices.Backup</span></span>
* <span data-ttu-id="ea9a3-623">Corrigir para modificar a política para um compartilhamento de arquivos protegido.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-623">Fix for modifying policy for a protected file share.</span></span>
* <span data-ttu-id="ea9a3-624">Fuso horário da política convertido em letras maiúsculas.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-624">Converted policy timezone to uppercase.</span></span>

### <a name="azrecoveryservicessiterecovery"></a><span data-ttu-id="ea9a3-625">Az.RecoveryServices.SiteRecovery</span><span class="sxs-lookup"><span data-stu-id="ea9a3-625">Az.RecoveryServices.SiteRecovery</span></span>
* <span data-ttu-id="ea9a3-626">Exemplo corrigido em New-AzureRmRecoveryServicesAsrProtectableItem</span><span class="sxs-lookup"><span data-stu-id="ea9a3-626">Corrected example in New-AzureRmRecoveryServicesAsrProtectableItem</span></span>
* <span data-ttu-id="ea9a3-627">Atualizar as dependências para o problema de mapeamento do tipo</span><span class="sxs-lookup"><span data-stu-id="ea9a3-627">Update dependencies for type mapping issue</span></span>

### <a name="azrelay"></a><span data-ttu-id="ea9a3-628">Az.Relay</span><span class="sxs-lookup"><span data-stu-id="ea9a3-628">Az.Relay</span></span>
* <span data-ttu-id="ea9a3-629">Parâmetro opcional -KeyValue adicionado ao cmdlet New-AzureRmRelayKey, que permite ao usuário fornecer o KeyValue.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-629">Added optional Parameter -KeyValue to New-AzureRmRelayKey cmdlet, which enables user to provide KeyValue.</span></span>

### <a name="azresources"></a><span data-ttu-id="ea9a3-630">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ea9a3-630">Az.Resources</span></span>
* <span data-ttu-id="ea9a3-631">Atualizar documentação de ajuda para a identidade do recurso relacionada aos parâmetros em `New-AzureRmPolicyAssignment` e `Set-AzureRmPolicyAssignment`</span><span class="sxs-lookup"><span data-stu-id="ea9a3-631">Update help documentation for resource identity related parameters in `New-AzureRmPolicyAssignment` and `Set-AzureRmPolicyAssignment`</span></span>
* <span data-ttu-id="ea9a3-632">Adicionar um exemplo para New-AzureRmPolicyDefinition que usa -Metadata</span><span class="sxs-lookup"><span data-stu-id="ea9a3-632">Add an example for New-AzureRmPolicyDefinition that uses -Metadata</span></span>
* <span data-ttu-id="ea9a3-633">Corrigir para permitir a preservação das letras maiúsculas e minúsculas nas chaves de Marca em NetStandard: #7678 #7703</span><span class="sxs-lookup"><span data-stu-id="ea9a3-633">Fix to allow case preservation in Tag keys in NetStandard: #7678 #7703</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="ea9a3-634">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="ea9a3-634">Az.ServiceFabric</span></span>
* <span data-ttu-id="ea9a3-635">Adicionar mensagens preteridas para futuras alterações da falha</span><span class="sxs-lookup"><span data-stu-id="ea9a3-635">Add deprecation messages for upcoming breaking changes</span></span>

### <a name="azsql"></a><span data-ttu-id="ea9a3-636">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="ea9a3-636">Az.Sql</span></span>
* <span data-ttu-id="ea9a3-637">Novos cmdlets adicionados para operações CRUD na Instância Gerenciada do Banco de Dados SQL do Azure e no Banco de Dados SQL do Azure Gerenciado</span><span class="sxs-lookup"><span data-stu-id="ea9a3-637">Added new cmdlets for CRUD operations on Azure Sql Database Managed Instance and Azure Sql Managed Database</span></span>
    - <span data-ttu-id="ea9a3-638">Get-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="ea9a3-638">Get-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="ea9a3-639">New-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="ea9a3-639">New-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="ea9a3-640">Set-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="ea9a3-640">Set-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="ea9a3-641">Remove-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="ea9a3-641">Remove-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="ea9a3-642">Get-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="ea9a3-642">Get-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="ea9a3-643">New-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="ea9a3-643">New-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="ea9a3-644">Restore-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="ea9a3-644">Restore-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="ea9a3-645">Remove-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="ea9a3-645">Remove-AzureRmSqlInstanceDatabase</span></span>
* <span data-ttu-id="ea9a3-646">Gerenciamento da Política de Auditoria Estendida Habilitado em um servidor ou banco de dados.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-646">Enabled Extended Auditing Policy management on a server or a database.</span></span>
    - <span data-ttu-id="ea9a3-647">Um novo parâmetro (PredicateExpression) foi adicionado para habilitar a filtragem dos logs de auditoria.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-647">New parameter (PredicateExpression) was added to enable filtering of audit logs.</span></span>
    - <span data-ttu-id="ea9a3-648">Os cmdlets foram modificadas para usar os clientes SQL, em vez dos clientes herdados.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-648">Cmdlets were modified to use SQL clients instead of Legacy clients.</span></span>
    - <span data-ttu-id="ea9a3-649">Set-AzureRmSqlServerAuditing.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-649">Set-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="ea9a3-650">Get-AzureRmSqlServerAuditing.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-650">Get-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="ea9a3-651">Set-AzureRmSqlDatabaseAuditing.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-651">Set-AzureRmSqlDatabaseAuditing.</span></span>
    - <span data-ttu-id="ea9a3-652">Get-AzureRmSqlDatabaseAuditing.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-652">Get-AzureRmSqlDatabaseAuditing.</span></span>
* <span data-ttu-id="ea9a3-653">Problema corrigido ao usar Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings com o conjunto de parâmetros de nome da conta de armazenamento</span><span class="sxs-lookup"><span data-stu-id="ea9a3-653">Fixed issue with using Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings with storage account name parameter set</span></span>

## <a name="050---november-2018"></a><span data-ttu-id="ea9a3-654">0.5.0 - Novembro de 2018</span><span class="sxs-lookup"><span data-stu-id="ea9a3-654">0.5.0 - November 2018</span></span>
#### <a name="general"></a><span data-ttu-id="ea9a3-655">Geral</span><span class="sxs-lookup"><span data-stu-id="ea9a3-655">General</span></span>
* <span data-ttu-id="ea9a3-656">Adicionados Complementos de Recursos para vários cmdlets principais - eles permitem alternar entre as abas dos nomes dos recursos existentes ao invocar os cmdlets interativamente</span><span class="sxs-lookup"><span data-stu-id="ea9a3-656">Added Resource Completers to many core cmdlets - these alloow you to tab through existing resource names when invoking cmdlets interactively</span></span>

#### <a name="azprofile"></a><span data-ttu-id="ea9a3-657">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="ea9a3-657">Az.Profile</span></span>
* <span data-ttu-id="ea9a3-658">Atualizar código comum para usar a versão mais recente do ClientRuntime</span><span class="sxs-lookup"><span data-stu-id="ea9a3-658">Update common code to use latest version of ClientRuntime</span></span>
* <span data-ttu-id="ea9a3-659">Renomear o parâmetro TenantId no cmdlet Connect-AzAccount para Tenant e adicionar um alias para TenantId</span><span class="sxs-lookup"><span data-stu-id="ea9a3-659">Rename param TenantId in cmdlet Connect-AzAccount to Tenant and add an alias for TenantId</span></span>
* <span data-ttu-id="ea9a3-660">Atualizada a descrição de TenantId atualizada para Connect-AzAccount</span><span class="sxs-lookup"><span data-stu-id="ea9a3-660">Updated TenantId description for Connect-AzAccount</span></span>
* <span data-ttu-id="ea9a3-661">Corrigir a mensagem de erro de logon com falha ao fornecer o domínio de locatário</span><span class="sxs-lookup"><span data-stu-id="ea9a3-661">Fix error message for failed login when providing tenant domain</span></span>
    - https://github.com/Azure/azure-powershell/issues/6936
* <span data-ttu-id="ea9a3-662">Corrigir o problema com o conflitos de nome do contexto para contas sem assinaturas no locatário</span><span class="sxs-lookup"><span data-stu-id="ea9a3-662">Fix issue with context name clashing for accounts with no subscriptions in tenant</span></span>
    - https://github.com/Azure/azure-powershell/issues/7453
* <span data-ttu-id="ea9a3-663">Corrigir o problema com pontos de extremidade DataLake ao usar o MSI</span><span class="sxs-lookup"><span data-stu-id="ea9a3-663">Fix issue with DataLake endpoints when using MSI</span></span>
    - https://github.com/Azure/azure-powershell/issues/7462
* <span data-ttu-id="ea9a3-664">Corrigir o problema em que “Disconnect-AzAccount” seria lançado quando não conectado</span><span class="sxs-lookup"><span data-stu-id="ea9a3-664">Fix issue where 'Disconnect-AzAccount' would throw if not connected</span></span>
    - https://github.com/Azure/azure-powershell/issues/7167

#### <a name="azcognitiveservices"></a><span data-ttu-id="ea9a3-665">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="ea9a3-665">Az.CognitiveServices</span></span>
* <span data-ttu-id="ea9a3-666">Adicionada a operação Get-AzCognitiveServicesAccountSkus.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-666">Add Get-AzCognitiveServicesAccountSkus operation.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="ea9a3-667">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="ea9a3-667">Az.Compute</span></span>
* <span data-ttu-id="ea9a3-668">Adicionar cmdlets Add-AzVmssVMDataDisk e Remove-AzVmssVMDataDisk</span><span class="sxs-lookup"><span data-stu-id="ea9a3-668">Add Add-AzVmssVMDataDisk and Remove-AzVmssVMDataDisk cmdlets</span></span>
* <span data-ttu-id="ea9a3-669">Get-AzVMImage mostra AutomaticOSUpgradeProperties</span><span class="sxs-lookup"><span data-stu-id="ea9a3-669">Get-AzVMImage shows AutomaticOSUpgradeProperties</span></span>
* <span data-ttu-id="ea9a3-670">Os valores de opção -BootstrapOptions e -JsonAttribute do SetAzVMChefExtension corrigidos não estão de acordo com a configuração no formato json.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-670">Fixed SetAzVMChefExtension -BootstrapOptions and -JsonAttribute option values are not setting in json format.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="ea9a3-671">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="ea9a3-671">Az.DataLakeStore</span></span>
* <span data-ttu-id="ea9a3-672">Atualizar o pacote de DataLake para 1.1.10.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-672">Update the DataLake package to 1.1.10.</span></span>
* <span data-ttu-id="ea9a3-673">Adicionar o padrão de Simultaneidade às operações multi-threaded.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-673">Add default Concurrency to multithreaded operations.</span></span>

#### <a name="azinsights"></a><span data-ttu-id="ea9a3-674">Az.Insights</span><span class="sxs-lookup"><span data-stu-id="ea9a3-674">Az.Insights</span></span>
* <span data-ttu-id="ea9a3-675">Correção do problema #7267 (área de dimensionamento automático)</span><span class="sxs-lookup"><span data-stu-id="ea9a3-675">Fixed issue #7267 (Autoscale area)</span></span>
    - <span data-ttu-id="ea9a3-676">Problemas ao criar uma nova regra de dimensionamento automático não definindo corretamente os parâmetros enumerados (sempre os defina para o valor padrão).</span><span class="sxs-lookup"><span data-stu-id="ea9a3-676">Issues with creating a new autoscale rule not properly setting enumerated parameters (would always set them to the default value).</span></span>
* <span data-ttu-id="ea9a3-677">Corrigido o problema #7513 [Insights] em que Set-AzDiagnosticSetting requer a especificação explícita das categorias durante a criação da configuração</span><span class="sxs-lookup"><span data-stu-id="ea9a3-677">Fixed issue #7513 [Insights] Set-AzDiagnosticSetting requires explicit specification of categories during creation of setting</span></span>
    - <span data-ttu-id="ea9a3-678">Agora o cmdlet não requer uma indicação explícita das categorias para habilitar durante a criação, ou seja, ele funciona conforme está documentado</span><span class="sxs-lookup"><span data-stu-id="ea9a3-678">Now the cmdlet does not require explicit indication of the categories to enable during creation, i.e. it works as it is documented</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="ea9a3-679">Az.Network</span><span class="sxs-lookup"><span data-stu-id="ea9a3-679">Az.Network</span></span>
* <span data-ttu-id="ea9a3-680">Alterado o PeeringType para ser um parâmetro obrigatório para os seguintes cmdlets:-</span><span class="sxs-lookup"><span data-stu-id="ea9a3-680">Changed PeeringType to be a mandatory parameter for the following cmdlets:-</span></span>
    - <span data-ttu-id="ea9a3-681">Get-AzExpressRouteCircuitRouteTable</span><span class="sxs-lookup"><span data-stu-id="ea9a3-681">Get-AzExpressRouteCircuitRouteTable</span></span>
    - <span data-ttu-id="ea9a3-682">Get-AzExpressRouteCircuitARPTable</span><span class="sxs-lookup"><span data-stu-id="ea9a3-682">Get-AzExpressRouteCircuitARPTable</span></span>
    - <span data-ttu-id="ea9a3-683">Get-AzExpressRouteCircuitRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="ea9a3-683">Get-AzExpressRouteCircuitRouteTableSummary</span></span>
    - <span data-ttu-id="ea9a3-684">Get-AzExpressRouteCrossConnectionArpTable</span><span class="sxs-lookup"><span data-stu-id="ea9a3-684">Get-AzExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="ea9a3-685">Get-AzExpressRouteCrossConnectionRouteTable</span><span class="sxs-lookup"><span data-stu-id="ea9a3-685">Get-AzExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="ea9a3-686">Get-AzExpressRouteCrossConnectionRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="ea9a3-686">Get-AzExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azpolicyinsights"></a><span data-ttu-id="ea9a3-687">Az.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="ea9a3-687">Az.PolicyInsights</span></span>
* <span data-ttu-id="ea9a3-688">Adicionados cmdlets de correção de política</span><span class="sxs-lookup"><span data-stu-id="ea9a3-688">Added policy remediation cmdlets</span></span>

#### <a name="azresources"></a><span data-ttu-id="ea9a3-689">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ea9a3-689">Az.Resources</span></span>
* <span data-ttu-id="ea9a3-690">Correção para https://github.com/Azure/azure-powershell/issues/7402</span><span class="sxs-lookup"><span data-stu-id="ea9a3-690">Fix for https://github.com/Azure/azure-powershell/issues/7402</span></span>
    - <span data-ttu-id="ea9a3-691">Permitir a listagem de recursos usando o parâmetro “-ResourceId” para “Get-AzResource”</span><span class="sxs-lookup"><span data-stu-id="ea9a3-691">Allow listing resources using the '-ResourceId' parameter for 'Get-AzResource'</span></span>

#### <a name="azservicebus"></a><span data-ttu-id="ea9a3-692">Az.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="ea9a3-692">Az.ServiceBus</span></span>
* <span data-ttu-id="ea9a3-693">Adicionada propriedade somente leitura de MigrationState para PSServiceBusMigrationConfigurationAttributes, o que ajudará a conhecer o estado de Migração.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-693">Added MigrationState read-only property to PSServiceBusMigrationConfigurationAttributes which will help to know the Migration state.</span></span>

#### <a name="azservicefabric"></a><span data-ttu-id="ea9a3-694">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="ea9a3-694">Az.ServiceFabric</span></span>
* <span data-ttu-id="ea9a3-695">Correção do certificado de adição para Vmss do Linux.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-695">Fix add certificate to Linux Vmss.</span></span>
* <span data-ttu-id="ea9a3-696">Corrigido “Add-AzServiceFabricClusterCertificate”</span><span class="sxs-lookup"><span data-stu-id="ea9a3-696">Fix 'Add-AzServiceFabricClusterCertificate'</span></span>
    - <span data-ttu-id="ea9a3-697">Usando a impressão digital correta do novo certificado (Azure/service-fabric-issues#932).</span><span class="sxs-lookup"><span data-stu-id="ea9a3-697">Using correct thumbprint from new certificate (Azure/service-fabric-issues#932).</span></span>
    - <span data-ttu-id="ea9a3-698">Exibir exceções corretamente (Azure/service-fabric-issues#1054).</span><span class="sxs-lookup"><span data-stu-id="ea9a3-698">Display exception correctly (Azure/service-fabric-issues#1054).</span></span>
* <span data-ttu-id="ea9a3-699">Corrigido “Update-AzServiceFabricDurability” para atualizar a configuração do cluster antes de iniciar a operação CreateOrUpdate do Vmss.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-699">Fix 'Update-AzServiceFabricDurability' to update cluster configuration before starting Vmss CreateOrUpdate operation.</span></span>

## <a name="040---october-2018"></a><span data-ttu-id="ea9a3-700">0.4.0 - Outubro de 2018</span><span class="sxs-lookup"><span data-stu-id="ea9a3-700">0.4.0 - October 2018</span></span>
#### <a name="azprofile"></a><span data-ttu-id="ea9a3-701">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="ea9a3-701">Az.Profile</span></span>
* <span data-ttu-id="ea9a3-702">Corrigido o problema com Get-AzSubscription no CloudShell</span><span class="sxs-lookup"><span data-stu-id="ea9a3-702">Fix issue with Get-AzSubscription in CloudShell</span></span>
* <span data-ttu-id="ea9a3-703">Atualizar código comum para usar a versão mais recente do ClientRuntime</span><span class="sxs-lookup"><span data-stu-id="ea9a3-703">Update common code to use latest version of ClientRuntime</span></span>

#### <a name="azcompute"></a><span data-ttu-id="ea9a3-704">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="ea9a3-704">Az.Compute</span></span>
* <span data-ttu-id="ea9a3-705">Adicionados novos tamanhos à lista de permissões de tamanhos de VM para o qual a aceleração de rede será ativada ao usar o conjunto de parâmetros simples para “New-AzVm”</span><span class="sxs-lookup"><span data-stu-id="ea9a3-705">Added new sizes to the whitelist of VM sizes for which accelerated networking will be turned on when using the simple param set for 'New-AzVm'</span></span>
* <span data-ttu-id="ea9a3-706">Adicionado o finalizador do argumento ResourceName para todos os cmdlets.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-706">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="ea9a3-707">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="ea9a3-707">Az.DataLakeStore</span></span>
* <span data-ttu-id="ea9a3-708">Adicionar suporte às Regras da Rede Virtual</span><span class="sxs-lookup"><span data-stu-id="ea9a3-708">Adding support for Virtual Network Rules</span></span>
    - <span data-ttu-id="ea9a3-709">Get-AzDataLakeStoreVirtualNetworkRule: Obtém ou lista a regra da rede virtual do Azure Data Lake Store.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-709">Get-AzDataLakeStoreVirtualNetworkRule: Gets or Lists Azure Data Lake Store virtual network rule.</span></span>
    - <span data-ttu-id="ea9a3-710">Add-AzDataLakeStoreVirtualNetworkRule: Adiciona uma regra da rede virtual à conta do Data Lake Store especificada.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-710">Add-AzDataLakeStoreVirtualNetworkRule: Adds a virtual network rule to the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="ea9a3-711">Set-AzDataLakeStoreVirtualNetworkRule: Modifica a regra da rede virtual especificada na conta do Data Lake Store especificada.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-711">Set-AzDataLakeStoreVirtualNetworkRule: Modifies the specified virtual network rule in the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="ea9a3-712">Remove-AzDataLakeStoreVirtualNetworkRule: Exclui uma regra da rede virtual do Azure Data Lake Store.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-712">Remove-AzDataLakeStoreVirtualNetworkRule: Deletes an Azure Data Lake Store virtual network rule.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="ea9a3-713">Az.Network</span><span class="sxs-lookup"><span data-stu-id="ea9a3-713">Az.Network</span></span>
* <span data-ttu-id="ea9a3-714">Atualizar o cmdlet Test-AzNetworkWatcherConnectivity, passar o valor de protocolo para o back-end.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-714">Update cmdlet Test-AzNetworkWatcherConnectivity, pass the protocol value to backend.</span></span>
* <span data-ttu-id="ea9a3-715">Adicionado o finalizador do argumento ResourceName para todos os cmdlets.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-715">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azresources"></a><span data-ttu-id="ea9a3-716">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ea9a3-716">Az.Resources</span></span>
* <span data-ttu-id="ea9a3-717">Corrigido o problema em que Get-AzRoleDefinition gera uma exceção ininteligível (quando o perfil padrão não tem nenhuma assinatura nele e nenhum escopo for especificado) com a adição de uma exceção significativa no cenário.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-717">Fix isssue where Get-AzRoleDefinition throws an unintelligible exception (when the default profile has no subscription in it and no scope is specified) by adding a meaningful exception in the scenario.</span></span> <span data-ttu-id="ea9a3-718">Também defina o conjunto de parâmetros padrão como 'RoleDefinitionNameParameterSet'.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-718">Also set the default param set to 'RoleDefinitionNameParameterSet'.</span></span>

## <a name="030---october-2018"></a><span data-ttu-id="ea9a3-719">0.3.0 - Outubro de 2018</span><span class="sxs-lookup"><span data-stu-id="ea9a3-719">0.3.0 - October 2018</span></span>
#### <a name="azurestorage"></a><span data-ttu-id="ea9a3-720">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="ea9a3-720">Azure.Storage</span></span>
* <span data-ttu-id="ea9a3-721">Correção de Copiar Blob/O arquivo não copiará os metadados quando o destino tiver problemas de metadados</span><span class="sxs-lookup"><span data-stu-id="ea9a3-721">Fix Copy Blob/File won't copy metadata when destination has metadata issue</span></span>
    - <span data-ttu-id="ea9a3-722">Start-AzureStorageBlobCopy</span><span class="sxs-lookup"><span data-stu-id="ea9a3-722">Start-AzureStorageBlobCopy</span></span>
    - <span data-ttu-id="ea9a3-723">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="ea9a3-723">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="ea9a3-724">O suporte para obter o uso dos recursos de armazenamento de um local específico e adicionar mensagem de aviso para obter o uso dos recursos de armazenamento global é obsoleto.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-724">Support get the Storage resource usage of a specific location, and add warning message for get global Storage resource usage is obsolete.</span></span>
    - <span data-ttu-id="ea9a3-725">Get-AzStorageUsage</span><span class="sxs-lookup"><span data-stu-id="ea9a3-725">Get-AzStorageUsage</span></span>
    
#### <a name="azcognitiveservices"></a><span data-ttu-id="ea9a3-726">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="ea9a3-726">Az.CognitiveServices</span></span>
* <span data-ttu-id="ea9a3-727">Suporte para Get-AzCognitiveServicesAccountSkus sem uma conta existente.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-727">Support Get-AzCognitiveServicesAccountSkus without an existing account.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="ea9a3-728">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="ea9a3-728">Az.Compute</span></span>
* <span data-ttu-id="ea9a3-729">Corrigido Get-AzVM -ResourceGroupName <rg> para retornar mais de 50 resultados se necessário</span><span class="sxs-lookup"><span data-stu-id="ea9a3-729">Fix Get-AzVM -ResourceGroupName <rg> to return more than 50 results if needed</span></span>
* <span data-ttu-id="ea9a3-730">Adicionado um exemplo de “SimpleParameterSet” para a ajuda do cmdlet New-AzVmss.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-730">Added an example of the 'SimpleParameterSet' to New-AzVmss cmdlet help.</span></span>
* <span data-ttu-id="ea9a3-731">Corrigido um erro de digitação na mensagem de progresso do Azure Disk Encryption</span><span class="sxs-lookup"><span data-stu-id="ea9a3-731">Fixed a typo in the Azure Disk Encryption progress message</span></span>

#### <a name="azdatafactoryv2"></a><span data-ttu-id="ea9a3-732">Az.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="ea9a3-732">Az.DataFactoryV2</span></span>
* <span data-ttu-id="ea9a3-733">Atualizada a versão do SDK do ADF .NET para 2.3.0.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-733">Updated the ADF .Net SDK version to 2.3.0.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="ea9a3-734">Az.Network</span><span class="sxs-lookup"><span data-stu-id="ea9a3-734">Az.Network</span></span>
* <span data-ttu-id="ea9a3-735">Adicionada a funcionalidade NetworkProfile.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-735">Added NetworkProfile functionality.</span></span> <span data-ttu-id="ea9a3-736">Novos cmdlets adicionados</span><span class="sxs-lookup"><span data-stu-id="ea9a3-736">new cmdlets added</span></span>
    - <span data-ttu-id="ea9a3-737">Get-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="ea9a3-737">Get-AzNetworkProfile</span></span>
    - <span data-ttu-id="ea9a3-738">New-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="ea9a3-738">New-AzNetworkProfile</span></span>
    - <span data-ttu-id="ea9a3-739">Remove-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="ea9a3-739">Remove-AzNetworkProfile</span></span>
    - <span data-ttu-id="ea9a3-740">Set-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="ea9a3-740">Set-AzNetworkProfile</span></span>
    - <span data-ttu-id="ea9a3-741">New-AzContainerNicConfig</span><span class="sxs-lookup"><span data-stu-id="ea9a3-741">New-AzContainerNicConfig</span></span>
    - <span data-ttu-id="ea9a3-742">New-AzContainerNicConfigIpConfig</span><span class="sxs-lookup"><span data-stu-id="ea9a3-742">New-AzContainerNicConfigIpConfig</span></span>
* <span data-ttu-id="ea9a3-743">Link de associação de serviço adicionado no modelo de sub-rede</span><span class="sxs-lookup"><span data-stu-id="ea9a3-743">Added service association link on Subnet Model</span></span>
* <span data-ttu-id="ea9a3-744">Adicionados os cmdlets New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap, Remove-AzVirtualNetworkTap</span><span class="sxs-lookup"><span data-stu-id="ea9a3-744">Added cmdlet New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap, Remove-AzVirtualNetworkTap</span></span>
* <span data-ttu-id="ea9a3-745">Adicionados os cmdlets Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig, Remove-AzNEtworkInterfaceTapConfig</span><span class="sxs-lookup"><span data-stu-id="ea9a3-745">Added cmdlet Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig, Remove-AzNEtworkInterfaceTapConfig</span></span>

#### <a name="azrediscache"></a><span data-ttu-id="ea9a3-746">Az.RedisCache</span><span class="sxs-lookup"><span data-stu-id="ea9a3-746">Az.RedisCache</span></span>
* <span data-ttu-id="ea9a3-747">Permissão de qualquer cadeia de caracteres como parâmetro Size de agora em diante.</span><span class="sxs-lookup"><span data-stu-id="ea9a3-747">Allow any string as Size parameter going forward.</span></span> <span data-ttu-id="ea9a3-748">Adição do P5 na pop-up PSArgumentCompleter</span><span class="sxs-lookup"><span data-stu-id="ea9a3-748">Add P5 in PSArgumentCompleter popup</span></span>

#### <a name="azresources"></a><span data-ttu-id="ea9a3-749">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ea9a3-749">Az.Resources</span></span>
* <span data-ttu-id="ea9a3-750">Adicionado o parâmetro -Mode ausente a Set-AzPolicyDefinition</span><span class="sxs-lookup"><span data-stu-id="ea9a3-750">Add missing -Mode parameter to Set-AzPolicyDefinition</span></span>
* <span data-ttu-id="ea9a3-751">Corrigido o bug do cmdlet Get-AzProviderOperation para operações com a Origem que contém o Usuário</span><span class="sxs-lookup"><span data-stu-id="ea9a3-751">Fix Get-AzProviderOperation commandlet bug for operations with Origin containing User</span></span>

#### <a name="azsql"></a><span data-ttu-id="ea9a3-752">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="ea9a3-752">Az.Sql</span></span>
* <span data-ttu-id="ea9a3-753">Corrigido o problema no qual alguns cmdlets de backup não reconheciam a assinatura atual do Azure</span><span class="sxs-lookup"><span data-stu-id="ea9a3-753">Fixed issue where some backup cmdlets would not recognize the current azure subscription</span></span>

#### <a name="azwebsites"></a><span data-ttu-id="ea9a3-754">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="ea9a3-754">Az.Websites</span></span>
* <span data-ttu-id="ea9a3-755">Novo cmdlet Get-AzWebAppContainerContinuousDeploymentUrl: obtém a URL do Webhook de Implantação Contínua do Contêiner</span><span class="sxs-lookup"><span data-stu-id="ea9a3-755">New Cmdlet Get-AzWebAppContainerContinuousDeploymentUrl - Gets the Container Continuous Deployment Webhook URL</span></span>
* <span data-ttu-id="ea9a3-756">Novos cmdlets New-AzWebAppContainerPSSession e Enter-WebAppContainerPSSession: iniciam a sessão remota do PowerShell em um aplicativo contêiner do Windows</span><span class="sxs-lookup"><span data-stu-id="ea9a3-756">New Cmdlets New-AzWebAppContainerPSSession and Enter-WebAppContainerPSSession  - Initiates a PowerShell remote session into a windows container app</span></span>

## <a name="020---september-2018"></a><span data-ttu-id="ea9a3-757">0.2.0 - Setembro de 2018</span><span class="sxs-lookup"><span data-stu-id="ea9a3-757">0.2.0 - September 2018</span></span>
 <span data-ttu-id="ea9a3-758">Versão Inicial</span><span class="sxs-lookup"><span data-stu-id="ea9a3-758">Initial Release</span></span>