...
O Azure PowerShell funciona com o PowerShell 5.x no Windows 7 ou o PowerShell 6.x em qualquer plataforma.
...
Se você estiver usando o PowerShell 5.x no Windows, também precisará do .NET Framework 4.7.2 instalado. Para obter instruções sobre como atualizar ou instalar uma nova versão do .NET Framework, confira o [guia de instalação do .NET Framework](/dotnet/framework/install).
