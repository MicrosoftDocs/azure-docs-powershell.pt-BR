...
Use o cmdlet `Get-AzVM` para consultar uma lista de máquinas virtuais em sua conta.
...
Se a propriedade que você deseja estiver aninhada na saída JSON, será necessário fornecer o caminho completo para a propriedade. O exemplo a seguir mostra como selecionar o nome da VM e o tipo do SO do cmdlet `Get-AzVM`.
