...
#### <a name="azurestorage"></a><span data-ttu-id="3e0b2-112">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="3e0b2-112">Azure.Storage</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="3e0b2-131">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="3e0b2-131">AzureRM.Network</span></span>
...
* <span data-ttu-id="3e0b2-155">Suporte adicionado para o certificado de Raiz Confiável e a configuração de Dimensionamento automático no Gateway de Aplicativo</span><span class="sxs-lookup"><span data-stu-id="3e0b2-155">Added support for Trusted Root certificate and Autoscale configuration in Application Gateway</span></span>
  - <span data-ttu-id="3e0b2-156">Novos Cmdlets adicionados:</span><span class="sxs-lookup"><span data-stu-id="3e0b2-156">New Cmdlets added:</span></span>
...
* <span data-ttu-id="3e0b2-175">Suporte adicionado para vários prefixos de endereço em uma sub-rede.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-175">Added support for multiple address prefixes in a subnet.</span></span> <span data-ttu-id="3e0b2-176">Cmdlets atualizados:</span><span class="sxs-lookup"><span data-stu-id="3e0b2-176">Updated cmdlets:</span></span>
  ...
  - <span data-ttu-id="3e0b2-181">Add-AzureRmApplicationGatewayAuthenticationCertificate</span><span class="sxs-lookup"><span data-stu-id="3e0b2-181">Add-AzureRmApplicationGatewayAuthenticationCertificate</span></span>
...
#### <a name="azurermrediscache"></a><span data-ttu-id="3e0b2-204">AzureRM.RedisCache</span><span class="sxs-lookup"><span data-stu-id="3e0b2-204">AzureRM.RedisCache</span></span>
...
* <span data-ttu-id="3e0b2-218">Suporte à Política de Imutabilidade no AzureRm.Storage</span><span class="sxs-lookup"><span data-stu-id="3e0b2-218">Support Immutability Policy in AzureRm.Storage</span></span> 
    ...
    - <span data-ttu-id="3e0b2-226">Set-AzureRmStorageContainerImmutabilityPolicy</span><span class="sxs-lookup"><span data-stu-id="3e0b2-226">Set-AzureRmStorageContainerImmutabilityPolicy</span></span>
...
* <span data-ttu-id="3e0b2-242">Problema corrigido https://github.com/Azure/azure-powershell/issues/6879</span><span class="sxs-lookup"><span data-stu-id="3e0b2-242">Fixed issue https://github.com/Azure/azure-powershell/issues/6879</span></span>
    - <span data-ttu-id="3e0b2-243">O CertificateInformation é uma propriedade configurável, permitindo que o cmdlet Set-AzureRmApiManagement funcione corretamente.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-243">The CertificateInformation is a settable property allowing for Set-AzureRmApiManagement cmdlet to work property.</span></span> <span data-ttu-id="3e0b2-244">Corrigida pela atualização para o nuget 4.0.4-nuget de prévia</span><span class="sxs-lookup"><span data-stu-id="3e0b2-244">Fixed by upgrading to 4.0.4-preview nuget</span></span>
...
#### <a name="azurermprofile"></a><span data-ttu-id="3e0b2-274">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="3e0b2-274">AzureRM.Profile</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="3e0b2-290">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="3e0b2-290">AzureRM.TrafficManager</span></span>
...
#### <a name="azurestorage"></a><span data-ttu-id="3e0b2-306">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="3e0b2-306">Azure.Storage</span></span>
...
#### <a name="azurermbatch"></a><span data-ttu-id="3e0b2-321">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="3e0b2-321">AzureRM.Batch</span></span>
...
#### <a name="azurermcontainerinstance"></a><span data-ttu-id="3e0b2-337">AzureRM.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="3e0b2-337">AzureRM.ContainerInstance</span></span>
...
#### <a name="azurermdevtestlabs"></a><span data-ttu-id="3e0b2-352">AzureRM.DevTestLabs</span><span class="sxs-lookup"><span data-stu-id="3e0b2-352">AzureRM.DevTestLabs</span></span>
...
#### <a name="azurermlogicapp"></a><span data-ttu-id="3e0b2-368">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="3e0b2-368">AzureRM.LogicApp</span></span>
...
* <span data-ttu-id="3e0b2-401">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-401">Updated to the latest version of the Azure ClientRuntime.</span></span>
...
* <span data-ttu-id="3e0b2-423">Atualização para a versão mais recente do Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-423">Updated to the latest version of the Azure ClientRuntime.</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="3e0b2-438">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="3e0b2-438">AzureRM.TrafficManager</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="3e0b2-453">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="3e0b2-453">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="3e0b2-471">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="3e0b2-471">AzureRM.DataFactoryV2</span></span>
...
* <span data-ttu-id="3e0b2-479">Tubulação atualizada para InputObject e ResourceId em Remover cmdlets</span><span class="sxs-lookup"><span data-stu-id="3e0b2-479">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>

#### <a name="azurerminsights"></a><span data-ttu-id="3e0b2-480">AzureRM.Insights</span><span class="sxs-lookup"><span data-stu-id="3e0b2-480">AzureRM.Insights</span></span>
* <span data-ttu-id="3e0b2-481">Formatação corrigida do OutputType nos arquivos de ajuda</span><span class="sxs-lookup"><span data-stu-id="3e0b2-481">Fixed formatting of OutputType in help files</span></span>
* <span data-ttu-id="3e0b2-482">Usando o SDK Microsoft.Azure.Management.Monitor 0.19.1-preview</span><span class="sxs-lookup"><span data-stu-id="3e0b2-482">Using Microsoft.Azure.Management.Monitor SDK 0.19.1-preview</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="3e0b2-483">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="3e0b2-483">AzureRM.KeyVault</span></span>
* <span data-ttu-id="3e0b2-484">Corrigir o problema de tubulação em Set-AzureRmKeyVaultAccessPolicy</span><span class="sxs-lookup"><span data-stu-id="3e0b2-484">Fix piping issue in Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="3e0b2-485">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="3e0b2-485">AzureRM.Network</span></span>
* <span data-ttu-id="3e0b2-486">Exemplos adicionados para cmdlets LoadBalancerInboundNatPoolConfig.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-486">Added examples for LoadBalancerInboundNatPoolConfig cmdlets.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="3e0b2-487">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="3e0b2-487">AzureRM.Resources</span></span>
* <span data-ttu-id="3e0b2-488">Corrigir problema ao fornecer nome e valor da marca para 'Get-AzureRmResource'</span><span class="sxs-lookup"><span data-stu-id="3e0b2-488">Fix issue when providing both tag name and value for 'Get-AzureRmResource'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6765
* <span data-ttu-id="3e0b2-489">Corrigir o cenário de tubulação com 'Set-AzureRmResource'</span><span class="sxs-lookup"><span data-stu-id="3e0b2-489">Fix piping scenario with 'Set-AzureRmResource'</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="3e0b2-490">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="3e0b2-490">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="3e0b2-491">Tubulação atualizada para InputObject e ResourceId em Remover cmdlets</span><span class="sxs-lookup"><span data-stu-id="3e0b2-491">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>
* <span data-ttu-id="3e0b2-492">alguns problemas corrigidos</span><span class="sxs-lookup"><span data-stu-id="3e0b2-492">fixed few issues</span></span>
    - https://github.com/Azure/azure-powershell/issues/3780
    - https://github.com/Azure/azure-powershell/issues/4340

#### <a name="azurermsql"></a><span data-ttu-id="3e0b2-493">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="3e0b2-493">AzureRM.Sql</span></span>
* <span data-ttu-id="3e0b2-494">Adicionando suporte à Proteção Avançada contra Ameaças do Server com os seguintes cmdlets:</span><span class="sxs-lookup"><span data-stu-id="3e0b2-494">Adding Server Advanced Threat Protection support with the following cmdlets:</span></span>
    - <span data-ttu-id="3e0b2-495">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span><span class="sxs-lookup"><span data-stu-id="3e0b2-495">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span></span>
* <span data-ttu-id="3e0b2-496">Adicionando suporte à Avaliação de Vulnerabilidade com os seguintes cmdlets:</span><span class="sxs-lookup"><span data-stu-id="3e0b2-496">Adding Vulnerability Assessment support with the following cmdlets:</span></span>
    - <span data-ttu-id="3e0b2-497">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span><span class="sxs-lookup"><span data-stu-id="3e0b2-497">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span></span>
    - <span data-ttu-id="3e0b2-498">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="3e0b2-498">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>
    - <span data-ttu-id="3e0b2-499">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="3e0b2-499">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span></span>
* <span data-ttu-id="3e0b2-500">Corrigido o exemplo em Remove-AzureRmSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="3e0b2-500">Fixed example in Remove-AzureRmSqlServerFirewallRule</span></span>
* <span data-ttu-id="3e0b2-501">Corrigir tratamento de data e hora incorreto para cultura de base não EUA em Get-AzureSqlSyncGroupLog</span><span class="sxs-lookup"><span data-stu-id="3e0b2-501">Fix datetime handling incorrectly for non-us base culture in Get-AzureSqlSyncGroupLog</span></span>

#### <a name="azurermstorage"></a><span data-ttu-id="3e0b2-502">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="3e0b2-502">AzureRM.Storage</span></span>
* <span data-ttu-id="3e0b2-503">Adicionar Ps1XmlAttribute às propriedades de tipos de saída de cmdlets</span><span class="sxs-lookup"><span data-stu-id="3e0b2-503">Add Ps1XmlAttribute to cmdlets output types properties</span></span>
* <span data-ttu-id="3e0b2-504">Mostrar a saída do cmdlet StorageAccount no modo de exibição de tabela</span><span class="sxs-lookup"><span data-stu-id="3e0b2-504">Show StorageAccount cmdlet output in table view</span></span>
    - <span data-ttu-id="3e0b2-505">Get-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="3e0b2-505">Get-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="3e0b2-506">New-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="3e0b2-506">New-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="3e0b2-507">Set-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="3e0b2-507">Set-AzureRmStorageAccount</span></span>

#### <a name="azurermtags"></a><span data-ttu-id="3e0b2-508">AzureRM.Tags</span><span class="sxs-lookup"><span data-stu-id="3e0b2-508">AzureRM.Tags</span></span>
* <span data-ttu-id="3e0b2-509">Remover instrução incorreta de ajuda de cmdlet de marca</span><span class="sxs-lookup"><span data-stu-id="3e0b2-509">Remove incorrect statement from Tag cmdlet help</span></span>
    - https://github.com/Azure/azure-powershell/issues/3878

## <a name="650---july-2018"></a><span data-ttu-id="3e0b2-510">6.5.0 - julho de 2018</span><span class="sxs-lookup"><span data-stu-id="3e0b2-510">6.5.0 - July 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="3e0b2-511">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="3e0b2-511">AzureRM.Profile</span></span>
* <span data-ttu-id="3e0b2-512">Ajuda atualizada para 'Get-AzureRmContextAutosaveSetting'</span><span class="sxs-lookup"><span data-stu-id="3e0b2-512">Updated help for 'Get-AzureRmContextAutosaveSetting'</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="3e0b2-513">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="3e0b2-513">Azure.Storage</span></span>
* <span data-ttu-id="3e0b2-514">Suporte ao carregar o blob ou o arquivo com o token de Sas somente gravação</span><span class="sxs-lookup"><span data-stu-id="3e0b2-514">Support Upload Blob or File with write only Sas token</span></span>
- <span data-ttu-id="3e0b2-515">Set-AzureStorageBlobContent</span><span class="sxs-lookup"><span data-stu-id="3e0b2-515">Set-AzureStorageBlobContent</span></span>
- <span data-ttu-id="3e0b2-516">Set-AzureStorageFileContent</span><span class="sxs-lookup"><span data-stu-id="3e0b2-516">Set-AzureStorageFileContent</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="3e0b2-517">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="3e0b2-517">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="3e0b2-518">Adicione a propriedade necessária ResourceGroupName ao AS.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-518">Add required property ResourceGroupName to AS.</span></span>

#### <a name="azurermautomation"></a><span data-ttu-id="3e0b2-519">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="3e0b2-519">AzureRM.Automation</span></span>
* <span data-ttu-id="3e0b2-520">Atualizar a ajuda e adicionar exemplo do 'New-AzureRMAutomationSchedule'</span><span class="sxs-lookup"><span data-stu-id="3e0b2-520">Update help and add example for 'New-AzureRMAutomationSchedule'</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="3e0b2-521">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="3e0b2-521">AzureRM.Compute</span></span>
* <span data-ttu-id="3e0b2-522">Adicionar parâmetro -Tag ao New/Update-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="3e0b2-522">Add -Tag parameter to Update/New-AzureRmAvailabilitySet</span></span>
* <span data-ttu-id="3e0b2-523">Adicionar exemplo do 'Add-AzureRmVmssExtension'</span><span class="sxs-lookup"><span data-stu-id="3e0b2-523">Add example for 'Add-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="3e0b2-524">Adicionar exemplos do 'Remove-AzureRmVmssExtension'</span><span class="sxs-lookup"><span data-stu-id="3e0b2-524">Add examples for 'Remove-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="3e0b2-525">Atualizar ajuda do 'Set-AzureRmVMAccessExtension'</span><span class="sxs-lookup"><span data-stu-id="3e0b2-525">Update help for 'Set-AzureRmVMAccessExtension'</span></span>
* <span data-ttu-id="3e0b2-526">Atualize SimpleParameterSet do New-AzureRmVmss para definir SinglePlacementGroup como false por padrão e adicionar o parâmetro de opção 'SinglePlacementGroup', que permite ao usuário criar VMSS em um único grupo de posicionamento.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-526">Update SimpleParameterSet for New-AzureRmVmss to set SinglePlacementGroup to false by default and add switch parameter 'SinglePlacementGroup' that enables the user to create the VMSS in a single placement group.</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="3e0b2-527">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="3e0b2-527">AzureRM.EventHub</span></span>
* <span data-ttu-id="3e0b2-528">Adicionada uma propriedade readonly 'PendingReplicationOperationsCount' à classe PSEventHubDRConfigurationAttributes, que fornece a contagem de operações pendentes de replicação durante a replicação em andamento</span><span class="sxs-lookup"><span data-stu-id="3e0b2-528">Added a readonly property 'PendingReplicationOperationsCount' to PSEventHubDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="3e0b2-529">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="3e0b2-529">AzureRM.KeyVault</span></span>
* <span data-ttu-id="3e0b2-530">Mensagem de erro de atualização para Set-AzureRmKeyVaultAccessPolicy</span><span class="sxs-lookup"><span data-stu-id="3e0b2-530">Update error message for Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermlogicapp"></a><span data-ttu-id="3e0b2-531">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="3e0b2-531">AzureRM.LogicApp</span></span>
* <span data-ttu-id="3e0b2-532">Corrigido o erro de "conjunto de parâmetros não pôde ser resolvido" no New-AzureRmLogicApp</span><span class="sxs-lookup"><span data-stu-id="3e0b2-532">Fixed "parameter set could not be resolved" error in New-AzureRmLogicApp</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="3e0b2-533">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="3e0b2-533">AzureRM.Network</span></span>
* <span data-ttu-id="3e0b2-534">Habilitar o emparelhamento entre redes virtuais em vários locatários para o Add/Set-AzureRmVirtualNetworkPeering</span><span class="sxs-lookup"><span data-stu-id="3e0b2-534">Enable peering across Virtual Networks in multiple Tenants for Set/Add-AzureRmVirtualNetworkPeering</span></span>
* <span data-ttu-id="3e0b2-535">Atualizados os cmdlets abaixo para o Gateway de Aplicativo</span><span class="sxs-lookup"><span data-stu-id="3e0b2-535">Updated below cmdlets for Application Gateway</span></span>
    - <span data-ttu-id="3e0b2-536">New-AzureRmApplicationGateway: Adicionado o sinalizador EnableFIPS e suporte a Zonas</span><span class="sxs-lookup"><span data-stu-id="3e0b2-536">New-AzureRmApplicationGateway : Added EnableFIPS flag and Zones support</span></span>
    - <span data-ttu-id="3e0b2-537">New-AzureRmApplicationGatewaySku: Adicionados novos skus Standard_v2 e WAF_v2</span><span class="sxs-lookup"><span data-stu-id="3e0b2-537">New-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
    - <span data-ttu-id="3e0b2-538">Set-AzureRmApplicationGatewaySku: Adicionados novos skus Standard_v2 e WAF_v2</span><span class="sxs-lookup"><span data-stu-id="3e0b2-538">Set-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
* <span data-ttu-id="3e0b2-539">Cmdlets de RouteTable regenerados com a versão mais recente do gerador</span><span class="sxs-lookup"><span data-stu-id="3e0b2-539">Regenerated RouteTable cmdlets with the latest generator version</span></span>

#### <a name="azurermrelay"></a><span data-ttu-id="3e0b2-540">AzureRM.Relay</span><span class="sxs-lookup"><span data-stu-id="3e0b2-540">AzureRM.Relay</span></span>
* <span data-ttu-id="3e0b2-541">Arquivos markdown atualizados, correção para o problema de nome de parâmetro no exemplo</span><span class="sxs-lookup"><span data-stu-id="3e0b2-541">Updated markdown files, fix for the parameter name issue in example</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="3e0b2-542">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="3e0b2-542">AzureRM.Resources</span></span>
* <span data-ttu-id="3e0b2-543">Atualize os cmdlets Roleassignment e roledefinition:</span><span class="sxs-lookup"><span data-stu-id="3e0b2-543">Update Roleassignment and roledefinition cmdlets:</span></span>
    - <span data-ttu-id="3e0b2-544">Remova chamadas extras roledefinition feitas como parte da paginação.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-544">Remove extra roledefinition calls done as part of paging.</span></span>
* <span data-ttu-id="3e0b2-545">Corrigir cmdlet Get-AzureRmRoleAssignment</span><span class="sxs-lookup"><span data-stu-id="3e0b2-545">Fix Get-AzureRmRoleAssignment cmdlet</span></span>
    - <span data-ttu-id="3e0b2-546">Corrigir funcionalidade de parâmetro de comando -ExpandPrincipalGroups</span><span class="sxs-lookup"><span data-stu-id="3e0b2-546">Fix -ExpandPrincipalGroups command parameter functionality</span></span>
* <span data-ttu-id="3e0b2-547">Corrigir problema com 'Get-AzureRmResource', no qual o parâmetro '-ResourceType' diferencia maiúsculas de minúsculas</span><span class="sxs-lookup"><span data-stu-id="3e0b2-547">Fix issue with 'Get-AzureRmResource' where '-ResourceType' parameter was case sensitive</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="3e0b2-548">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="3e0b2-548">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="3e0b2-549">Adicionado o parâmetro top e skip aos cmdlets de lista</span><span class="sxs-lookup"><span data-stu-id="3e0b2-549">Added top and skip parameter to list cmdlets</span></span>
* <span data-ttu-id="3e0b2-550">Adicionados os cmdlets de migração de NameSpace Standard a Premium:</span><span class="sxs-lookup"><span data-stu-id="3e0b2-550">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    - <span data-ttu-id="3e0b2-551">Start-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="3e0b2-551">Start-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="3e0b2-552">Get-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="3e0b2-552">Get-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="3e0b2-553">Complete-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="3e0b2-553">Complete-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="3e0b2-554">Stop-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="3e0b2-554">Stop-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="3e0b2-555">Remove-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="3e0b2-555">Remove-AzureRmServiceBusMigration</span></span>
* <span data-ttu-id="3e0b2-556">Adicionada uma propriedade readonly 'PendingReplicationOperationsCount' à classe PSServiceBusDRConfigurationAttributes, que fornece a contagem de operações pendentes de replicação durante a replicação em andamento</span><span class="sxs-lookup"><span data-stu-id="3e0b2-556">Added a readonly property 'PendingReplicationOperationsCount' to PSServiceBusDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="3e0b2-557">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="3e0b2-557">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="3e0b2-558">Exemplo de atualização para 'New-AzureRmServiceFabricCluster'</span><span class="sxs-lookup"><span data-stu-id="3e0b2-558">Update example for 'New-AzureRmServiceFabricCluster'</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="3e0b2-559">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="3e0b2-559">AzureRM.Sql</span></span>
* <span data-ttu-id="3e0b2-560">Adicionar novos Cmdlets ao Management.Sql para permitir que os clientes adicionem o certificado TDE à instância do SQL Server ou uma Instância Gerenciada</span><span class="sxs-lookup"><span data-stu-id="3e0b2-560">Adding new Cmdlets for Management.Sql to allow customers to add TDE Certificate to Sql Server instance or a Managed Instance</span></span>
    - <span data-ttu-id="3e0b2-561">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="3e0b2-561">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span></span>
    - <span data-ttu-id="3e0b2-562">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="3e0b2-562">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="3e0b2-563">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="3e0b2-563">AzureRM.Websites</span></span>
* <span data-ttu-id="3e0b2-564">`Set-AzureRmWebApp -AssignIdentity` e `Set-AzureRmWebAppSlot -AssignIdentity` quando definidos como false agora também removerão a propriedade de identidade da marca de visualização object.Removing do site.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-564">`Set-AzureRmWebApp -AssignIdentity` and  `Set-AzureRmWebAppSlot -AssignIdentity` when set to false will now remove the Identity property from the site object.Removing preview tag as well.</span></span>
* <span data-ttu-id="3e0b2-565">Exemplos `Get-AzureRmWebAppMetrics` e `Get-AzureRmAppServicePlanMetrics` atualizados</span><span class="sxs-lookup"><span data-stu-id="3e0b2-565">`Get-AzureRmWebAppMetrics`,`Get-AzureRmAppServicePlanMetrics` example updated</span></span>
* <span data-ttu-id="3e0b2-566">`Set-AzureRmWebApp -PhpVersion` dá suporte como uma versão do PHP válida</span><span class="sxs-lookup"><span data-stu-id="3e0b2-566">`Set-AzureRmWebApp -PhpVersion` supports off as a valid php version</span></span>

## <a name="640---july-2018"></a><span data-ttu-id="3e0b2-567">6.4.0 - julho de 2018</span><span class="sxs-lookup"><span data-stu-id="3e0b2-567">6.4.0 - July 2018</span></span>
#### <a name="general"></a><span data-ttu-id="3e0b2-568">Geral</span><span class="sxs-lookup"><span data-stu-id="3e0b2-568">General</span></span>
* <span data-ttu-id="3e0b2-569">Formatação corrigida do OutputType nos arquivos de ajuda para a maioria dos módulos</span><span class="sxs-lookup"><span data-stu-id="3e0b2-569">Fixed formatting of OutputType in help files for most modules</span></span>

#### <a name="azurermprofile"></a><span data-ttu-id="3e0b2-570">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="3e0b2-570">AzureRM.Profile</span></span>
* <span data-ttu-id="3e0b2-571">Atributo Ps1Xml adicionado aos tipos de saída básicos</span><span class="sxs-lookup"><span data-stu-id="3e0b2-571">Ps1Xml attribute added to the basic output types</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="3e0b2-572">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="3e0b2-572">AzureRM.Compute</span></span>
* <span data-ttu-id="3e0b2-573">Recurso de Marca do IP para VMSS</span><span class="sxs-lookup"><span data-stu-id="3e0b2-573">IP Tag feature for VMSS</span></span>
    - <span data-ttu-id="3e0b2-574">O cmdlet “New-AzureRmVmssIpTagConfig” foi adicionado</span><span class="sxs-lookup"><span data-stu-id="3e0b2-574">'New-AzureRmVmssIpTagConfig' cmdlet is added</span></span>
    - <span data-ttu-id="3e0b2-575">O parâmetro IpTag foi adicionado a New-AzureRmVmssIpConfig</span><span class="sxs-lookup"><span data-stu-id="3e0b2-575">IpTag parameter is added to New-AzureRmVmssIpConfig</span></span>
* <span data-ttu-id="3e0b2-576">Recurso de Reversão Automática do SO para VMSS</span><span class="sxs-lookup"><span data-stu-id="3e0b2-576">Auto OS Rollback feature for VMSS</span></span>
    - <span data-ttu-id="3e0b2-577">Os parâmetros DisableAutoRollback são adicionados a New-AzureRmVmssConfig e Update-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="3e0b2-577">DisableAutoRollback parameters are added to New-AzureRmVmssConfig and Update-AzureRmVmss</span></span>
* <span data-ttu-id="3e0b2-578">Recurso do Histórico de Atualizações do SO para Vmss</span><span class="sxs-lookup"><span data-stu-id="3e0b2-578">OS Upgrade History feature for Vmss</span></span>
    - <span data-ttu-id="3e0b2-579">O parâmetro com argumento OSUpgradeHistory foi adicionado ao Get-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="3e0b2-579">OSUpgradeHistory switch parameter is added to Get-AzureRmVmss</span></span>

#### <a name="azurermdatalakeanalytics"></a><span data-ttu-id="3e0b2-580">AzureRM.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="3e0b2-580">AzureRM.DataLakeAnalytics</span></span>
* <span data-ttu-id="3e0b2-581">Adicione suporte para as ACLs de Catálogo com os comandos a seguir:</span><span class="sxs-lookup"><span data-stu-id="3e0b2-581">Add support for Catalog ACLs through the following commands:</span></span>
    - <span data-ttu-id="3e0b2-582">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="3e0b2-582">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="3e0b2-583">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="3e0b2-583">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="3e0b2-584">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="3e0b2-584">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="3e0b2-585">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="3e0b2-585">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="3e0b2-586">Adicionar suporte a cancelamento e acompanhamento do progresso para Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span><span class="sxs-lookup"><span data-stu-id="3e0b2-586">Add cancellation support and progress tracking for Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span></span>
* <span data-ttu-id="3e0b2-587">Adicionar suporte a cancelamento para Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="3e0b2-587">Add cancellation support for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="3e0b2-588">Corrigir liberação das mensagens de depuração para cmdlets que fazem operações recursivas</span><span class="sxs-lookup"><span data-stu-id="3e0b2-588">Fix flushing of debug messages for cmdlets that does recursive operations</span></span>
* <span data-ttu-id="3e0b2-589">Corrigir local de teste dos cmdlets DataLake</span><span class="sxs-lookup"><span data-stu-id="3e0b2-589">Fix location of test of DataLake cmdlets</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="3e0b2-590">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="3e0b2-590">AzureRM.EventHub</span></span>
* <span data-ttu-id="3e0b2-591">Parâmetro MaxCount Opcional adicionado aos cmdlets da Lista de Operações Get-AzureRmEventHub e Get-AzureRmEventHubConsumerGroup</span><span class="sxs-lookup"><span data-stu-id="3e0b2-591">Added Optional MaxCount parameter to List Operations cmdlet Get-AzureRmEventHub and Get-AzureRmEventHubConsumerGroup</span></span>
* <span data-ttu-id="3e0b2-592">Problema corrigido no cmdlet New-AzureRmEventHub onde pelo menos um parâmetro é necessário durante a criação do Novo EventHub.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-592">Fixed issue in New-AzureRmEventHub cmdlet where at least one parameter needed while creating New EventHub.</span></span> <span data-ttu-id="3e0b2-593">Conjunto de Parâmetros Padrão fornecido.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-593">Provided Default Parameter set.</span></span>
* <span data-ttu-id="3e0b2-594">Parâmetro opcional -KeyValue adicionado ao cmdlet New-AzureRmEventHubKey, que permite ao usuário fornecer o KeyValue.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-594">Added optional Parameter -KeyValue to New-AzureRmEventHubKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="3e0b2-595">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="3e0b2-595">AzureRM.KeyVault</span></span>
* <span data-ttu-id="3e0b2-596">Problema corrigido onde todos os recursos foram retornados por Get-AzureRmKeyVault-Tag</span><span class="sxs-lookup"><span data-stu-id="3e0b2-596">Fix issue where all resources were being returned by Get-AzureRmKeyVault -Tag</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="3e0b2-597">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="3e0b2-597">AzureRM.Network</span></span>
* <span data-ttu-id="3e0b2-598">Expor novas Skus para Zone-Redundant VirtualNetworkGateways</span><span class="sxs-lookup"><span data-stu-id="3e0b2-598">Expose new Skus for Zone-Redundant VirtualNetworkGateways</span></span>
* <span data-ttu-id="3e0b2-599">Novos comandos adicionados do recurso: APIs de Parceiro do ExpressRoute via ARM</span><span class="sxs-lookup"><span data-stu-id="3e0b2-599">Added new commands for feature: ExpressRoute Partner APIs via ARM</span></span>
    - <span data-ttu-id="3e0b2-600">Get-AzureRmExpressRouteCrossConnection adicionado</span><span class="sxs-lookup"><span data-stu-id="3e0b2-600">Added Get-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="3e0b2-601">Set-AzureRmExpressRouteCrossConnection adicionado</span><span class="sxs-lookup"><span data-stu-id="3e0b2-601">Added Set-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="3e0b2-602">Add-AzureRmExpressRouteCrossConnectionPeering adicionado</span><span class="sxs-lookup"><span data-stu-id="3e0b2-602">Added Add-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="3e0b2-603">Get-AzureRmExpressRouteCrossConnectionPeering adicionado</span><span class="sxs-lookup"><span data-stu-id="3e0b2-603">Added Get-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="3e0b2-604">Remove-AzureRmExpressRouteCrossConnectionPeering adicionado</span><span class="sxs-lookup"><span data-stu-id="3e0b2-604">Added Remove-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="3e0b2-605">Get-AzureRMExpressRouteCrossConnectionArpTable adicionado</span><span class="sxs-lookup"><span data-stu-id="3e0b2-605">Added Get-AzureRMExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="3e0b2-606">Get-AzureRMExpressRouteCrossConnectionRouteTable adicionado</span><span class="sxs-lookup"><span data-stu-id="3e0b2-606">Added Get-AzureRMExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="3e0b2-607">Get-AzureRMExpressRouteCrossConnectionRouteTableSummary adicionado</span><span class="sxs-lookup"><span data-stu-id="3e0b2-607">Added Get-AzureRMExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="3e0b2-608">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="3e0b2-608">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="3e0b2-609">Cmdlet Get-AzureRmRecoveryServicesBackupStatus adicionado.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-609">Added Get-AzureRmRecoveryServicesBackupStatus cmdlet.</span></span> <span data-ttu-id="3e0b2-610">Esse cmdlet usa uma ID de VM e verifica se a VM está protegida por algum cofre na assinatura.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-610">This cmdlet takes a VM ID and checks if the VM is protected by some vault in the subscription.</span></span> <span data-ttu-id="3e0b2-611">Se houver tal cofre, o cmdlet produzirá detalhes dele.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-611">If there exists such a vault, the cmdlet outputs the vault details.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="3e0b2-612">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="3e0b2-612">AzureRM.Resources</span></span>
* <span data-ttu-id="3e0b2-613">Atualize os cmdlets Get-AzureRmPolicyAssignment:</span><span class="sxs-lookup"><span data-stu-id="3e0b2-613">Update Get-AzureRmPolicyAssignment cmdlets:</span></span>
    - <span data-ttu-id="3e0b2-614">Adicionar suporte para listar valores -Scope no nível do grupo de gerenciamento</span><span class="sxs-lookup"><span data-stu-id="3e0b2-614">Add support for listing -Scope values at management group level</span></span>
    - <span data-ttu-id="3e0b2-615">Adicionar suporte para recuperar as atribuições individuais com valores -Scope no nível do grupo de gerenciamento</span><span class="sxs-lookup"><span data-stu-id="3e0b2-615">Add support for retrieving individual assignments with -Scope values at management group level</span></span>
    - <span data-ttu-id="3e0b2-616">Adicionar argumentos -Effective e -All para controlar  parâmetro</span><span class="sxs-lookup"><span data-stu-id="3e0b2-616">Add -Effective and -All switches to control  parameter</span></span>
* <span data-ttu-id="3e0b2-617">Atualizar cmdlets Get/New/Remove/Set-AzureRmPolicyDefinition</span><span class="sxs-lookup"><span data-stu-id="3e0b2-617">Update Get/New/Remove/Set-AzureRmPolicyDefinition cmdlets</span></span>
    - <span data-ttu-id="3e0b2-618">Adicionar parâmetro -ManagementGroupName para aplicar as operações a um determinado grupo de gerenciamento</span><span class="sxs-lookup"><span data-stu-id="3e0b2-618">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="3e0b2-619">Adicionar parâmetro -SubscriptionId para aplicar as operações a uma determinada assinatura</span><span class="sxs-lookup"><span data-stu-id="3e0b2-619">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="3e0b2-620">Atualizar cmdlets Get/New/Remove/Set-AzureRmPolicySetDefinition</span><span class="sxs-lookup"><span data-stu-id="3e0b2-620">Update Get/New/Remove/Set-AzureRmPolicySetDefinition cmdlets</span></span>
    - <span data-ttu-id="3e0b2-621">Adicionar parâmetro -ManagementGroupName para aplicar as operações a um determinado grupo de gerenciamento</span><span class="sxs-lookup"><span data-stu-id="3e0b2-621">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="3e0b2-622">Adicionar parâmetro -SubscriptionId para aplicar as operações a uma determinada assinatura</span><span class="sxs-lookup"><span data-stu-id="3e0b2-622">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="3e0b2-623">Adicionar suporte de referência do segredo KeyVault nos parâmetros ao usar “TemplateParameterObject” em “New-AzureRmResourceGroupDeployment”</span><span class="sxs-lookup"><span data-stu-id="3e0b2-623">Add KeyVault secret reference support in parameters when using 'TemplateParameterObject' in 'New-AzureRmResourceGroupDeployment'</span></span>
* <span data-ttu-id="3e0b2-624">Corrigir problema onde o parâmetro “-EndDate” foi ignorado para “New-AzureRmADAppCredential”</span><span class="sxs-lookup"><span data-stu-id="3e0b2-624">Fix issue where '-EndDate' parameter was ignored for 'New-AzureRmADAppCredential'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6505
* <span data-ttu-id="3e0b2-625">Corrigir problema onde “Add-AzureRmADGroupMember” usou a URL incorreta para fazer a solicitação</span><span class="sxs-lookup"><span data-stu-id="3e0b2-625">Fix issue where 'Add-AzureRmADGroupMember' used incorrect URL to make request</span></span>
    - https://github.com/Azure/azure-powershell/issues/6485

#### <a name="azurermservicebus"></a><span data-ttu-id="3e0b2-626">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="3e0b2-626">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="3e0b2-627">Parâmetro opcional -KeyValue adicionado ao cmdlet New-AzureRmServiceBusKey, que permite ao usuário fornecer o KeyValue.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-627">Added optional Parameter -KeyValue to New-AzureRmServiceBusKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="3e0b2-628">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="3e0b2-628">AzureRM.Sql</span></span>
* <span data-ttu-id="3e0b2-629">Pontos de Restauração Definidos pelo Usuário e Esclarecidos para SQLDW na ajuda do New-AzureRmSqlDatabaseRestorePoint</span><span class="sxs-lookup"><span data-stu-id="3e0b2-629">Clarified User-Defined Restore Points for SQLDW in New-AzureRmSqlDatabaseRestorePoint help</span></span>
* <span data-ttu-id="3e0b2-630">Documentação atualizada do parâmetro -ComputeGeneration em vários cmdlets</span><span class="sxs-lookup"><span data-stu-id="3e0b2-630">Updated documentation of -ComputeGeneration parameter in several cmdlets</span></span>

## <a name="630---june-2018"></a><span data-ttu-id="3e0b2-631">6.3.0 - junho de 2018</span><span class="sxs-lookup"><span data-stu-id="3e0b2-631">6.3.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="3e0b2-632">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="3e0b2-632">AzureRM.Profile</span></span>
* <span data-ttu-id="3e0b2-633">Mensagens de erro atualizadas para Enable-AzureRmContextAutoSave</span><span class="sxs-lookup"><span data-stu-id="3e0b2-633">Updated error messages for Enable-AzureRmContextAutoSave</span></span>
* <span data-ttu-id="3e0b2-634">Criar contexto para cada assinatura ao executar “Connect-AzureRmAccount” sem contexto anterior</span><span class="sxs-lookup"><span data-stu-id="3e0b2-634">Create a context for each subscription when running 'Connect-AzureRmAccount' with no previous context</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="3e0b2-635">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="3e0b2-635">Azure.Storage</span></span>
* <span data-ttu-id="3e0b2-636">Outras informações adicionadas sobre o parâmetro -Permissions nos arquivos de ajuda.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-636">Added additional information about -Permissions parameter in help files.</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="3e0b2-637">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="3e0b2-637">AzureRM.Compute</span></span>
* <span data-ttu-id="3e0b2-638">“Get-AzureRmVmDiskEncryptionStatus” corrige um problema observado por VMs sem discos de dados</span><span class="sxs-lookup"><span data-stu-id="3e0b2-638">'Get-AzureRmVmDiskEncryptionStatus' fixes an issue observed for VMs with no data disks</span></span> 
* <span data-ttu-id="3e0b2-639">Atualizar versão da Biblioteca do cliente de computação para corrigir os cmdlets a seguir</span><span class="sxs-lookup"><span data-stu-id="3e0b2-639">Update Compute client library version to fix following cmdlets</span></span>
    - <span data-ttu-id="3e0b2-640">Grant-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="3e0b2-640">Grant-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="3e0b2-641">Grant-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="3e0b2-641">Grant-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="3e0b2-642">Save-AzureRmVMImage</span><span class="sxs-lookup"><span data-stu-id="3e0b2-642">Save-AzureRmVMImage</span></span>
* <span data-ttu-id="3e0b2-643">Cmdlets corrigidos a seguir para mostrar corretamente a "ID da operação" e o "status da operação":</span><span class="sxs-lookup"><span data-stu-id="3e0b2-643">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    - <span data-ttu-id="3e0b2-644">Start-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="3e0b2-644">Start-AzureRmVM</span></span>
    - <span data-ttu-id="3e0b2-645">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="3e0b2-645">Stop-AzureRmVM</span></span>
    - <span data-ttu-id="3e0b2-646">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="3e0b2-646">Restart-AzureRmVM</span></span>
    - <span data-ttu-id="3e0b2-647">Set-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="3e0b2-647">Set-AzureRmVM</span></span>
    - <span data-ttu-id="3e0b2-648">Remove-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="3e0b2-648">Remove-AzuerRmVM</span></span>
    - <span data-ttu-id="3e0b2-649">Set-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="3e0b2-649">Set-AzureRmVmss</span></span>
    - <span data-ttu-id="3e0b2-650">Start-AzureRmVmssRollingOSUpgrade</span><span class="sxs-lookup"><span data-stu-id="3e0b2-650">Start-AzureRmVmssRollingOSUpgrade</span></span>
    - <span data-ttu-id="3e0b2-651">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="3e0b2-651">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="3e0b2-652">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="3e0b2-652">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="3e0b2-653">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="3e0b2-653">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="3e0b2-654">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="3e0b2-654">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="3e0b2-655">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="3e0b2-655">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="3e0b2-656">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="3e0b2-656">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="3e0b2-657">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="3e0b2-657">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="3e0b2-658">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="3e0b2-658">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="3e0b2-659">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="3e0b2-659">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="3e0b2-660">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="3e0b2-660">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="3e0b2-661">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="3e0b2-661">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="3e0b2-662">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="3e0b2-662">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="3e0b2-663">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="3e0b2-663">AzureRM.EventGrid</span></span>
* <span data-ttu-id="3e0b2-664">Remova as condições de validação ValidateNotNullOrEmpty para SubjectBeginsWith/SubjectEndsWith no cmdlet Update-AzureRmEventGridSubscription e permita a mudança desses parâmetros para uma cadeia de caracteres vazia, se for necessário.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-664">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="3e0b2-665">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="3e0b2-665">AzureRM.KeyVault</span></span>
* <span data-ttu-id="3e0b2-666">Corrigir problema onde nenhuma marca retorna ao executar Get-AzureRmKeyVault -Tag</span><span class="sxs-lookup"><span data-stu-id="3e0b2-666">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="3e0b2-667">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="3e0b2-667">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="3e0b2-668">Versão pública dos cmdlets de Informações sobre a Política</span><span class="sxs-lookup"><span data-stu-id="3e0b2-668">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="3e0b2-669">Usar versão da API 2018-04-04</span><span class="sxs-lookup"><span data-stu-id="3e0b2-669">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="3e0b2-670">Adicionar PolicyDefinitionReferenceId aos resultados de Get-AzureRmPolicyStateSummary</span><span class="sxs-lookup"><span data-stu-id="3e0b2-670">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="3e0b2-671">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="3e0b2-671">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="3e0b2-672">Parâmetro -Vault adicionado aos cmdlets RecoveryServices.Backup.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-672">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="3e0b2-673">Quando passado, substituirá o cmdlet Set-AzureRmRecoveryServicesContext.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-673">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="3e0b2-674">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="3e0b2-674">AzureRM.Sql</span></span>
* <span data-ttu-id="3e0b2-675">Exemplo atualizado no arquivo de ajuda para Get-AzureRmSqlDatabaseExpanded</span><span class="sxs-lookup"><span data-stu-id="3e0b2-675">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="3e0b2-676">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="3e0b2-676">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="3e0b2-677">Arquivo de ajuda atualizado para Add-AzureRmTrafficManagerEndpointConfig</span><span class="sxs-lookup"><span data-stu-id="3e0b2-677">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="3e0b2-678">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="3e0b2-678">AzureRM.Websites</span></span>
* <span data-ttu-id="3e0b2-679">"Set-AzureRmWebApp" foi atualizado para não substituir AppSettings ao usar -AssignIdentity</span><span class="sxs-lookup"><span data-stu-id="3e0b2-679">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="3e0b2-680">"New-AzureRmWebAppSlot" foi atualizado para aceitar AppServicePlan como um parâmetro opcional</span><span class="sxs-lookup"><span data-stu-id="3e0b2-680">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="3e0b2-681">6.2.1 - junho de 2018</span><span class="sxs-lookup"><span data-stu-id="3e0b2-681">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="3e0b2-682">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="3e0b2-682">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="3e0b2-683">Modelo PSWorkspace atualizado para permitir que a Rede use o tipo como um parâmetro</span><span class="sxs-lookup"><span data-stu-id="3e0b2-683">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="3e0b2-684">6.2.0 - Junho de 2018</span><span class="sxs-lookup"><span data-stu-id="3e0b2-684">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="3e0b2-685">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="3e0b2-685">AzureRM.Profile</span></span>
* <span data-ttu-id="3e0b2-686">Corrija o problema em que a versão 10.0.3 do Newtonsoft.Json não estava sendo carregado na importação do módulo</span><span class="sxs-lookup"><span data-stu-id="3e0b2-686">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="3e0b2-687">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="3e0b2-687">AzureRM.Compute</span></span>
* <span data-ttu-id="3e0b2-688">Recurso de atualização de VM VMSS</span><span class="sxs-lookup"><span data-stu-id="3e0b2-688">VMSS VM Update feature</span></span>
    - <span data-ttu-id="3e0b2-689">Os cmdlets 'Update-AzureRmVmssVM' e 'New-AzureRmVMDataDisk' foram adicionados</span><span class="sxs-lookup"><span data-stu-id="3e0b2-689">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="3e0b2-690">Adicione o parâmetro VirtualMachineScaleSetVM ao cmdlet 'Add-AzureRmVMDataDisk' para dar suporte à adição de um disco de dados para a VM Vmss.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-690">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="3e0b2-691">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="3e0b2-691">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="3e0b2-692">A versão do SDK do .Net ADF foi atualizada para a versão prévia 0.8.0 que contém as seguintes alterações:</span><span class="sxs-lookup"><span data-stu-id="3e0b2-692">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="3e0b2-693">A operação para Configurar o repositório de fábrica foi adicionada</span><span class="sxs-lookup"><span data-stu-id="3e0b2-693">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="3e0b2-694">O LinkedService QuickBooks foi atualizado para expor as propriedades consumerKey e consumerSecret</span><span class="sxs-lookup"><span data-stu-id="3e0b2-694">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="3e0b2-695">Vários tipos de modelo atualizados de SecretBase para Object</span><span class="sxs-lookup"><span data-stu-id="3e0b2-695">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="3e0b2-696">Foram adicionados gatilho de eventos de blob</span><span class="sxs-lookup"><span data-stu-id="3e0b2-696">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="3e0b2-697">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="3e0b2-697">AzureRM.KeyVault</span></span>
* <span data-ttu-id="3e0b2-698">Atualizar documentação com a saída de exemplo</span><span class="sxs-lookup"><span data-stu-id="3e0b2-698">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="3e0b2-699">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="3e0b2-699">AzureRM.Network</span></span>
* <span data-ttu-id="3e0b2-700">Habilitar parâmetros de Análise de Tráfego nos cmdlets do Observador de Rede</span><span class="sxs-lookup"><span data-stu-id="3e0b2-700">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="3e0b2-701">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="3e0b2-701">AzureRM.Resources</span></span>
* <span data-ttu-id="3e0b2-702">Corrigir o problema com a propriedade 'Properties' dos objetos 'PSResource' retornados de 'Get-AzureRmResource'</span><span class="sxs-lookup"><span data-stu-id="3e0b2-702">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="3e0b2-703">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="3e0b2-703">AzureRM.Scheduler</span></span>
* <span data-ttu-id="3e0b2-704">Corrigir o problema com a atualização de ServiceBusQueueJob não definindo novos valores de Autenticação</span><span class="sxs-lookup"><span data-stu-id="3e0b2-704">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="3e0b2-705">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="3e0b2-705">AzureRM.Sql</span></span>
* <span data-ttu-id="3e0b2-706">Os seguintes cmdlets foram atualizados com o parâmetro LicenseType opcional</span><span class="sxs-lookup"><span data-stu-id="3e0b2-706">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="3e0b2-707">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="3e0b2-707">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="3e0b2-708">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="3e0b2-708">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="3e0b2-709">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="3e0b2-709">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="3e0b2-710">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="3e0b2-710">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="3e0b2-711">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="3e0b2-711">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="3e0b2-712">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="3e0b2-712">AzureRM.Websites</span></span>
* <span data-ttu-id="3e0b2-713">'New-AzureRMWebApp' será atualizado para usar os algoritmos comuns da biblioteca de Estratégia.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-713">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="3e0b2-714">6.1.0 - maio de 2018</span><span class="sxs-lookup"><span data-stu-id="3e0b2-714">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="3e0b2-715">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="3e0b2-715">AzureRM.Profile</span></span>
* <span data-ttu-id="3e0b2-716">Corrija o problema onde executar “Clear-AzureRmContext” manteria um contexto vazio com o nome do contexto padrão anterior, o que impediu o usuário de criar um novo contexto com o antigo nome</span><span class="sxs-lookup"><span data-stu-id="3e0b2-716">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="3e0b2-717">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="3e0b2-717">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="3e0b2-718">Habilite as operações de associação/desassociação do Gateway no sistema autônomo.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-718">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="3e0b2-719">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="3e0b2-719">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="3e0b2-720">Suporte adicionado para ApiVersions, ApiReleases e ApiRevisions</span><span class="sxs-lookup"><span data-stu-id="3e0b2-720">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="3e0b2-721">Suporte adicionado para Back-end do ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="3e0b2-721">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="3e0b2-722">Suporte adicionado para Agente do Application Insights</span><span class="sxs-lookup"><span data-stu-id="3e0b2-722">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="3e0b2-723">Suporte adicionado para reconhecer a sku “Básica” como uma sku válida do serviço de Gerenciamento da Api</span><span class="sxs-lookup"><span data-stu-id="3e0b2-723">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="3e0b2-724">Suporte adicionado para instalar os Certificados emitidos pela autoridade de certificação privada como Raiz ou CA</span><span class="sxs-lookup"><span data-stu-id="3e0b2-724">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="3e0b2-725">Suporte adicionado para aceitar certificados SSL Personalizados via KeyVault e vários nomes de host do proxy</span><span class="sxs-lookup"><span data-stu-id="3e0b2-725">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="3e0b2-726">Suporte adicionado para a identidade MSI</span><span class="sxs-lookup"><span data-stu-id="3e0b2-726">Added support for MSI identity</span></span>
* <span data-ttu-id="3e0b2-727">Suporte adicionado para aceitar Políticas via Url OBSERVAÇÃO: os cmdlets a seguir serão preteridos na futura versão</span><span class="sxs-lookup"><span data-stu-id="3e0b2-727">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="3e0b2-728">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="3e0b2-728">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="3e0b2-729">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="3e0b2-729">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="3e0b2-730">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="3e0b2-730">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="3e0b2-731">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="3e0b2-731">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="3e0b2-732">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="3e0b2-732">AzureRM.Batch</span></span>
* <span data-ttu-id="3e0b2-733">Versão do novo cmdlet Get-AzureBatchPoolNodeCounts</span><span class="sxs-lookup"><span data-stu-id="3e0b2-733">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="3e0b2-734">Versão novo cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span><span class="sxs-lookup"><span data-stu-id="3e0b2-734">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="3e0b2-735">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="3e0b2-735">AzureRM.Consumption</span></span>
* <span data-ttu-id="3e0b2-736">Adicionar os novos parâmetros Expand, ResourceGroup, InstanceName, InstanceId, Tags e Top no cmdlet Get-AzureRmConsumptionUsageDetail</span><span class="sxs-lookup"><span data-stu-id="3e0b2-736">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="3e0b2-737">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="3e0b2-737">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="3e0b2-738">Corrigir exemplo para Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="3e0b2-738">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="3e0b2-739">Corrigir exceção do parâmetro nulo para Recurse, caso esteja em Set-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="3e0b2-739">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="3e0b2-740">Corrigir arquivos de ajuda para Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="3e0b2-740">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="3e0b2-741">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="3e0b2-741">AzureRM.Network</span></span>
* <span data-ttu-id="3e0b2-742">Aumentar a versão do SDK de Rede de 18.0.0-preview para 19.0.0-preview</span><span class="sxs-lookup"><span data-stu-id="3e0b2-742">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="3e0b2-743">Cmdlet adicionado para criar a configuração de protocolo</span><span class="sxs-lookup"><span data-stu-id="3e0b2-743">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="3e0b2-744">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="3e0b2-744">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="3e0b2-745">Cmdlet adicionado para acrescentar uma nova conexão de circuito a um circuito de rota expressa existente.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-745">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="3e0b2-746">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="3e0b2-746">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="3e0b2-747">Cmdlet adicionado para remover uma conexão de circuito de um circuito de rota expressa existente.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-747">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="3e0b2-748">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="3e0b2-748">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="3e0b2-749">Cmdlet adicionado para recuperar uma conexão de circuito</span><span class="sxs-lookup"><span data-stu-id="3e0b2-749">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="3e0b2-750">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="3e0b2-750">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="3e0b2-751">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="3e0b2-751">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="3e0b2-752">Uso da autenticação do servidor corrigido com certificados gerados (problema 5998)</span><span class="sxs-lookup"><span data-stu-id="3e0b2-752">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="3e0b2-753">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="3e0b2-753">AzureRM.Sql</span></span>
* <span data-ttu-id="3e0b2-754">Cmdlets de auditoria atualizados para permitir a remoção de AuditActions ou AuditActionGroups</span><span class="sxs-lookup"><span data-stu-id="3e0b2-754">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="3e0b2-755">Problema corrigido com Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy ao definir uma nova política de retenção flexível onde o comando falharia com “Configurar política de retenção de longo prazo com o cofre de serviços de recuperação do azure e não há mais suporte para a política.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-755">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="3e0b2-756">Envie a solicitação com a nova política de retenção flexível”.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-756">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="3e0b2-757">Atualizar todos os cmdlets relacionados ao Banco de Dados Sql do Azure/Criação do ElasticPool/Atualização para usar a nova API do Banco de Dados, que suporta a propriedade Sku para o dimensionamento e as propriedades relacionadas à camada.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-757">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="3e0b2-758">Os cmdlets atualizados, incluindo:</span><span class="sxs-lookup"><span data-stu-id="3e0b2-758">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="3e0b2-759">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="3e0b2-759">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="3e0b2-760">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="3e0b2-760">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="3e0b2-761">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="3e0b2-761">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="3e0b2-762">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="3e0b2-762">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="3e0b2-763">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="3e0b2-763">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="3e0b2-764">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="3e0b2-764">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="3e0b2-765">Atualize os parâmetros para “Get-AzureRmTrafficManagerProfile” para que o parâmetro -ResourceGroupName seja requerido ao usar o parâmetro -Name.</span><span class="sxs-lookup"><span data-stu-id="3e0b2-765">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
