...
Os itens mostrados na saída a seguir não serão atualizados automaticamente sem primeiro corrigir manualmente os problemas. Os problemas conhecidos que não podem ser atualizados automaticamente incluem comandos que usam nivelamento.
