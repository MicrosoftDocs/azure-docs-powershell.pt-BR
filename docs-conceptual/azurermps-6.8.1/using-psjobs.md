...
Como os PSJobs são executados como processos separados, a sua conexão do Azure deve ser compartilhada com eles. Após entrar na sua conta do Azure com `Connect-AzureRmAccount`, passe o contexto para um trabalho.
