...
O alias `Get-AzSqlDatabaseIndexRecommendations` é removido. Use `Get-AzSqlDatabaseIndexRecommendation` em seu lugar.

### `Get-AzSqlDatabaseRestorePoints`
O alias `Get-AzSqlDatabaseRestorePoints` é removido. Use `Get-AzSqlDatabaseRestorePoint` em seu lugar.
