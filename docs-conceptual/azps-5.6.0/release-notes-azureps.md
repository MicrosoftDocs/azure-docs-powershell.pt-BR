...
## <a name="560---march-2021"></a>5.6.0 – Março de 2021
#### <a name="azaccounts"></a>Az.Accounts
* Atualize o Azure.Identity para corrigir o problema em que Connect-AzAccount falha quando a credencial do ADFS é usada [#13560]

#### <a name="azautomation"></a>Az.Automation
* Correção do problema em que a cadeia de caracteres não pode ser serializada corretamente. [#14215]
* Inclusão de suporte para o tipo de runbook Python3

#### <a name="azcompute"></a>Az.Compute
* Inclusão do parâmetro '-EnableHotpatching' no cmdlet 'Set-AzVMOperatingSystem' para computadores Windows. 
* Inclusão do parâmetro '-PatchMode' aos conjuntos de parâmetros do Linux no cmdlet 'Set-AzVMOperatingSystem'. 
* [Alteração interruptiva] Alterações interruptivas para os usuários na versão prévia pública do recurso de aplicação de patch de convidado de VM.
    - Remoção da propriedade 'RebootStatus' do objeto 'Microsoft.Azure.Management.Compute.Models.LastPatchInstallationSummary'. 
    - Remoção da propriedade 'StartedBy' do objeto 'Microsoft.Azure.Management.Compute.Models.LastPatchInstallationSummary'.
    - Alteração de nome da propriedade 'Kbid' para 'KbId' no objeto 'Microsoft.Azure.Management.Compute.Models.VirtualMachineSoftwarePatchProperties'. 
    - Alteração de nome da propriedade 'patches' para 'availablePatches' no objeto 'Microsoft.Azure.Management.Compute.Models.VirtualMachineAssessPatchesResult'. 
    - Alteração de nome do objeto 'Microsoft.Azure.Management.Compute.Models.SoftwareUpdateRebootBehavior' para 'Microsoft.Azure.Management.Compute.Models.VMGuestPatchRebootBehavior'.
    - Alteração de nome do objeto 'Microsoft.Azure.Management.Compute.Models.InGuestPatchMode' para 'Microsoft.Azure.Management.Compute.Models.WindowsVMGuestPatchMode'.
* [Alteração interruptiva] Remoção de todos os cmdlets 'ContainerService'. A API do Serviço de Contêiner foi preterida em janeiro de 2020. 
...
* Correção da autenticação de `Connect-AzContainerRegistry`

#### <a name="azcosmosdb"></a>Az.CosmosDB
* Introdução de NetworkAclBypass e NetworkAclBypassResourceIds para os cmdlets de Conta de Banco de Dados.
* Introdução do parâmetro ServerVersion para Update-AzCosmosDBAccount.
* Introdução de BackupInterval e BackupRetention para os cmdlets de Conta de Banco de Dados

#### <a name="azdatafactory"></a>Az.DataFactory
* Atualização do SDK do .Net do ADF para a versão 4.14.0

#### <a name="azmigrate"></a>Az.Migrate
* Az.Migrate em disponibilidade geral
* Incorporação de Initialize-AzMigrateReplicationInfrastructure como cmdlet no módulo Az.Migrate, do script externo que é executado hoje.
* Alguns parâmetros de New-AzMigrateServerReplication, New-AzMigrateDiskMapping agora não diferenciam maiúsculas de minúsculas.
* Inclusão de suporte para dimensionar a alteração do dispositivo para lidar com novas chaves V3.

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Inclusão de verificação nula para a conta de armazenamento de destino na restauração de FileShare.

#### <a name="azresources"></a>Az.Resources
* Inclusão de suporte para a implantação de recursos do Azure na linguagem Bicep
* Correção de problemas com as implantações TemplateSpec em 'New-AzTenantDeployment' e 'New-AzManagementGroupDeployment'
* Inclusão de suporte ao parâmetro '-QueryString' nos cmdlets 'Test-Az*Deployments'
* Correção do problema com os parâmetros dinâmicos quando 'New-Az*Deployments' é usado com '-QueryString'
* Inclusão de suporte ao parâmetro '-TemplateParameterObject' quando o parâmetro '-TemplateSpecId' é usado em cmdlets 'New-Az*Deployments'
* Correção da mensagem de erro incorreta recebida ao tentar implantar uma especificação de modelo não existente

#### <a name="azstorage"></a>Az.Storage
* Atualização para o Microsoft.Azure.Management.Storage 19.0.0 para oferecer suporte à nova versão da API 2021-01-01.
* Regra de acesso a recursos com suporte no NetworkRuleSet
    - 'Update-AzStorageAccountNetworkRuleSet'
    - 'Add-AzStorageAccountNetworkRule'
    - 'Remove-AzStorageAccountNetworkRule'
* Versão de blob com suporte e tipo de blob de acréscimo na política de gerenciamento
    - 'Add-AzStorageAccountManagementPolicyAction'
    - 'New-AzStorageAccountManagementPolicyFilter'
    - 'Set-AzStorageAccountManagementPolicy'
* Conta de criação/atualização com suporte com AllowSharedKeyAccess
    - 'New-AzStorageAccount'
    - 'Set-AzStorageAccount'
* Criação de escopo de criptografia com suporte com RequireInfrastructureEncryption
    - 'New-AzStorageEncryptionScope'
* Cópia de blob de blocos com suporte síncrono, com escopo de criptografia
    - 'Copy-AzStorageBlob'
* Correção do problema em que Get-AzStorageBlobContent usa o caractere separador de diretório incorreto no Linux e no MacOS [#14234]

#### <a name="azwebsites"></a>Az.Websites
* Introdução de uma opção para fornecer um tempo limite personalizado a 'Publish-AzWebApp' 
* Inclusão de suporte para o Ambiente do Serviço de Aplicativo
...
* @alunmj, Pouca ortografia, alterações de formatação (#14155)
* @chakra146, Atualização de Add-AzLoadBalancerInboundNatPoolConfig.md (#14231)
* Martin Ehrnst (@ehrnst), correção de um erro de ortografia no cmdlet (#14112)
* Jan David Narkiewicz (@jdnark)
  * Os exemplos usaram o New-AzAks, que é o cmdlet herdado, e o alias para New-AzAksCluster. Alteração dos exemplos para usar New-AzAksCluster, que é o cmdlet que esta página de documentação aborda. (#14088)
  * Tipo Fox: alteração de SshKeyVaule para SshKeyValue (#14087)
* Ivan Kulezic (@kukislav), inclusão de exemplos de configuração de manutenção de Mi do SQL (#14216)
* @webguynj, Atualização de Set-AzNetworkSecurityRuleConfig.md (#14176)
* Yannick Dils (@yannickdils), inclusão de um cmdline adicional ao exemplo que aplica as alterações ao balanceador de carga (#14185)

## <a name="550---february-2021"></a>5.5.0 – fevereiro de 2021
#### <a name="azaccounts"></a>Az.Accounts
* Código CloudError rastreado na exceção
* Evento 'ContextCleared' criado durante a execução de 'Clear-AzContext'

#### <a name="azaks"></a>Az.Aks
* Mensagens de erro refinadas da falha no cmdlet.
* Tratamento de exceções atualizado para usar exceções relacionadas ao Azure PowerShell.
* Correção de um problema em que o usuário não podia usar a entidade de serviço fornecida para criar um cluster do Kubernetes. [#13938]

#### <a name="azautomation"></a>Az.Automation
* Correção de um problema de processamento de 'PSCustomObject' e 'Array'.

#### <a name="azcompute"></a>Az.Compute
* Parâmetro '-EnableAutomaticUpgrade' adicionado ao 'Set-AzVmExtension' e ao 'Add-AzVmssExtension'.
* Parâmetro FilterExpression removido da documentação do cmdlet 'Get-AzVMImage'. 
* Mensagem de substituição adicionada aos cmdlets de ContainerService:
    ...
    - 'Remove-AzContainerServiceAgentPoolProfile'
    - 'Update-AzContainerService'
* Parâmetro '-BurstingEnabled' adicionado ao 'New-AzDiskConfig' e ao 'New-AzDiskUpdateConfig'
* Parâmetros '-GroupByApplicationId' e '-GroupByUserAgent' adicionados aos cmdlets 'Export-AzLogAnalyticThrottledRequest' e 'Export-AzLogAnalyticRequestRateByInterval'.
* Conjunto de parâmetros 'VMParameterSet' adicionado ao cmdlet 'Get-AzVMExtension'. Novo parâmetro '-VM' adicionado a esse conjunto de parâmetros. 

#### <a name="azcontainerregistry"></a>Az.ContainerRegistry
* Cmdlets adicionados a operações com suporte de repositório, manifesto e marcação:
...
Com suporte – Usar EnableNoPublicIP ao criar um workspace do Databricks

#### <a name="azfrontdoor"></a>Az.FrontDoor
* Adição de FrontDoorId às propriedades
* Exclusões JSON e suporte RequestBodyCheck adicionados às regras gerenciadas

#### <a name="azhdinsight"></a>Az.HDInsight
* Novos parâmetros '-EnableComputeIsolation' e '-ComputeIsolationHostSku' adicionados ao cmdlet 'New-AzHDInsightCluster' para dar suporte ao recurso de isolamento de computação
* Propriedades 'ComputeIsolationProperties' e ' 'ConnectivityEndpoints' adicionadas à classe AzureHDInsightCluster.

#### <a name="azkeyvault"></a>Az.KeyVault
* Especificação do tipo de chave e do nome da curva compatível com a importação de chaves por meio de um arquivo BYOK

#### <a name="aznetwork"></a>Az.Network
* Novos cmdlets adicionados para substituir 'virtual router', o nome anterior do produto, pelo nome 'route server' no futuro.
    - 'New-AzRouteServer'
    - 'Get-AzRouteServer'
    ...
    - Aviso de substituição de atributo adicionado aos cmdlets anteriores.
* Correção de bug no MacSecConfig do ExpressRouteLink. Nova propriedade 'SciState' adicionada ao 'PSExpressRouteLinkMacSecConfig'
* Atualização da lista de formatos e de modos de exibição de tabelas de formatos para Get-AzVirtualNetworkGatewayConnectionIkeSa

#### <a name="azpolicyinsights"></a>Az.PolicyInsights
* Cancelamento de alterações feitas no PowerShell que aumentaram o limite de linhas de solicitação. Instrução incorreta removida da paginação de suporte

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* limites de validação de política modificados de acordo com o serviço de backup.
* Redundância de Zona adicionada aos Cofres do Serviço de Recuperação. 
* Suporte do Azure Site Recovery para um grupo de posicionamento por proximidade para VMware no Azure e no Hyper-V para provedores do Azure.
* Suporte do Azure Site Recovery para uma zona de disponibilidade para VMware no Azure e no Hyper-V para provedores do Azure.
* Suporte do Azure Site Recovery para UseManagedDisk para Hyper-V no provedor do Azure

#### <a name="azresources"></a>Az.Resources
* Remoção do tipo de entidade de segurança em New-AzRoleAssignment e Set-AzRoleAssignment porque o mapeamento atual estava interrompendo determinados cenários

#### <a name="azsql"></a>Az.Sql
* Adição de MaintenanceConfigurationId a 'New-AzSqlDatabase', 'Set-AzSqlDatabase', 'New-AzSqlElasticPool' e 'Set-AzSqlElasticPool'
* Correção de regressão em 'Set-AzSqlServerAudit' durante o fornecimento do argumento PredicateExpression

#### <a name="azstorage"></a>Az.Storage
* Configurações de RoutingPreference compatíveis com a opção criar/atualizar conta de armazenamento
    - 'New-AzStorageAccount'
    - 'Set-AzStorageAccount'
* Atualização de Azure.Storage.Blobs para 12.8.0
* Atualização de Azure.Storage.Files.Shares para 12.6.0
* Atualização de Azure.Storage.Files.DataLake para 12.6.0

#### <a name="azwebsites"></a>Az.Websites
* Adição de suporte para a Importação de um certificado do cofre de chaves no WebApp.

### <a name="thanks-to-our-community-contributors"></a>Agradecimentos aos colaboradores da comunidade
* @atul-ram: atualização do Set-AzEventHub.md (nº 13921)
* Christoph Bergmeister [MVP] (@bergmeister): Set-AzDataLakeGen2AclRecursive.md – Correção de erro de digitação (directiry -> directory) (nº 14082)
* Alexander Schmidt (@devdeer-alex): correção de link desfeito para acessar diretrizes de contribuição (nº 14009)
* @JiangYuchun: atualização do Get-AzApplicationGatewayAuthenticationCertificate.md (nº 13972)
* Sebastián Olsen (@Spacebjorn): comando de exemplo corrigido (nº 13901)

## <a name="540---january-2021"></a>5.4.0 – janeiro de 2021
#### <a name="azaccounts"></a>Az.Accounts
* ID de solicitação do cliente correta mostrada na mensagem de depuração [nº 13745]
* Tipo de exceção comum do Azure PowerShell adicionado
* API 2019-06-01 de armazenamento com suporte

#### <a name="azautomation"></a>Az.Automation
* O problema em que a descrição não era populada para agendamentos de gerenciamento de atualizações foi corrigido

#### <a name="azcosmosdb"></a>Az.CosmosDB
* Disponibilidade geral do módulo 'Az.CosmosDB'
* Restrição do cmdlet New-AzCosmosDBAccount para fazer chamadas de atualização para Contas de Banco de Dados existentes.
* Introdução do AnalyticalStorageTTL em SqlContainer.

#### <a name="aziothub"></a>Az.IotHub
* Regressão relativa à geração de token SAS corrigida

#### <a name="azkeyvault"></a>Az.KeyVault
* Problema no módulo Gerenciamento de Segredos corrigido

#### <a name="azlogicapp"></a>Az.LogicApp
* Problema em que 'Get-AzLogicAppTriggerHistory' e 'Get-AzLogicAppRunAction' só recuperavam a primeira página de resultados corrigido [Nº 9141]

#### <a name="azmonitor"></a>Az.Monitor
* Cmdlets adicionados para regras de coleta de dados: 
    - 'Get-AzDataCollectionRule'
    - 'New-AzDataCollectionRule'
    - 'Set-AzDataCollectionRule'
    - 'Update-AzDataCollectionRule'
    - 'Remove-AzDataCollectionRule'
* Cmdlets adicionados para associações de regras de coleta de dados
    - 'Get-AzDataCollectionRuleAssociation'
    - 'New-AzDataCollectionRuleAssociation'
    - 'Remove-AzDataCollectionRuleAssociation'

#### <a name="aznetwork"></a>Az.Network
* Novos cmdlets adicionados para CRUD de VpnGatewayNATRule.
    - 'New-AzVpnGatewayNatRule'
    - 'Update-AzVpnGatewayNatRule'
    - 'Get-AzVpnGatewayNatRule'
    - 'Remove-AzVpnGatewayNatRule'  
* Cmdlets atualizados para definir NATRule no recurso VpnGateway e associá-lo ao recurso VpnSiteLinkConnection.
    - 'New-AzVpnGateway'
    - 'Update-AzVpnGateway' 
    - 'New-AzVpnSiteLinkConnection'
* Cmdlets atualizados para habilitar a configuração de ConnectionMode em Conexões de Gateway de Rede Virtual.
    - 'New-AzVirtualNetworkGatewayConnection'
    - 'Set-AzVirtualNetworkGatewayConnection'
* Cmdlet 'New-AzFirewallPolicyApplicationRule' atualizado:
    - Parâmetro TargetUrl adicionado
    - Parâmetro TerminateTLS adicionado
* Novos cmdlets adicionados para recursos Premium do Firewall do Azure
    - 'New-AzFirewallPolicyIntrusionDetection'
    - 'New-AzFirewallPolicyIntrusionDetectionBypassTraffic'
    - 'New-AzFirewallPolicyIntrusionDetectionSignatureOverride'
* Cmdlet New-AzFirewallPolicy atualizado:
    - Parâmetro -SkuTier adicionado
    - Parâmetro -Identity adicionado
    - Parâmetro -UserAssignedIdentityId adicionado
    - Parâmetro -IntrusionDetection adicionado
    - Parâmetro -TransportSecurityName adicionado
    - Parâmetro -TransportSecurityKeyVaultSecretId adicionado
* Novo cmdlet para buscar Associações de Segurança IKE para Conexões de Gateway de Rede Virtual adicionado.
    - 'Get-AzVirtualNetworkGatewayConnectionIkeSa'
* Suporte a várias autenticações para p2sVpnGateway adicionado
    - New-AzVpnServerConfiguration e Update-AzVpnServerConfiguration adicionados para permitir que vários parâmetros de autenticação sejam definidos.
* Cmdlet 'New-AzVpnGateway' e 'New-AzP2sVpnGateway' atualizado:
    - Parâmetro EnableRoutingPreferenceInternetFlag adicionado

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Recurso Restauração entre Regiões adicionado.  
* Obtenção de configuração de carga de trabalho bloqueada quando o item de destino é um grupo de disponibilidade.

#### <a name="azresources"></a>Az.Resources
* Suporte adicionado para o parâmetro -QueryString em cmdlets New-AZ*Deployments

#### <a name="azsql"></a>Az.Sql
* Cmdlet 'Start-AzSqlInstanceDatabaseLogReplay' tornado síncrono, sinalizador -AsJob adicionado

#### <a name="azstorage"></a>Az.Storage
* ContinuationToken corrigido para nunca nulo na listagem de blobs com -IncludeVersion
    - 'Get-AzStorageBlob'

#### <a name="azwebsites"></a>Az.Websites
* Suporte adicionado para certificados Gerenciados do Serviço de Aplicativo
    - 'New-AzWebAppCertificate'
    - 'Remove-AzWebAppCertificate'
* Problema que fazia com que a Senha do Docker fosse removida de appSettings em 'Set-AzWebApp' e 'Set-AzWebAppSlot' corrigido

### <a name="thanks-to-our-community-contributors"></a>Agradecimentos aos colaboradores da comunidade
* Ivan Akcheurov (@ivanakcheurov), por atualizar Set-AzSecurityWorkspaceSetting.md (Nº 13877)
* @javiermarasco, atualização de exemplo (Nº 13837)
* @jhaprakash26, Atualização de Set-AzVirtualNetwork.md (Nº 13857)
* Michael Holmes (@MichaelHolmesWP), por atualizar New-AzStorageTableStoredAccessPolicy.md (#13871)
* Michael James (@mikejwhat), por permitir que Get-AzLogicAppTriggerHistory e Get-AzLogicAppRunAction retornem mais de 30 resultados (Nº 13846)
* @Willem-J-an, correção de bug que fazia a senha do Docker ser removida de appsettings em Set-AzWebApp(Slot) (Nº 13866)

## <a name="530---december-2020"></a>5.3.0 – Dezembro de 2020
#### <a name="azaccounts"></a>Az.Accounts
* Foi corrigido o problema em que o proxy http não é respeitado no Windows PowerShell [n. 13647]
* Foi aprimorado o log de depuração de operações de execução prolongada em módulos gerados

#### <a name="azautomation"></a>Az.Automation
* Foi corrigido o problema em que os parâmetros de 'Start-AzAutomationRunbook' não podem converter a cadeia de caracteres encapsulada de PSObject em cadeia de caracteres JSON [#13240]
* Foi corrigido o preenchedor de localização para o cmdlet New-AzAutomationUpdateManagementAzureQuery

#### <a name="azcompute"></a>Az.Compute
* Novo parâmetro 'VM' no novo conjunto de parâmetros 'VMParameterSet' adicionado aos cmdlets 'Get-AzVMDscExtensionStatus' e 'Get-AzVMDscExtension'. 

#### <a name="azdatabricks"></a>Az.Databricks
* Foi corrigido um problema que fazia com que 'New-AzDatabricksVNetPeering' fosse retornado antes de ser totalmente provisionado (https://github.com/Azure/autorest.powershell/issues/610) )

#### <a name="azdatafactory"></a>Az.DataFactory
* Foi corrigido o problema do comando ' Invoke-AzDataFactoryV2Pipeline' para SupportsShouldProcess

#### <a name="azdesktopvirtualization"></a>Az.DesktopVirtualization
* Foi adicionada a propriedade StartVMOnConnect ao pool de host.

#### <a name="azhdinsight"></a>Az.HDInsight
* Propriedades adicionadas: FQDN e EffectiveDiskEncryptionKeyUrl na classe AzureHDInsightHostInfo.

#### <a name="azkeyvault"></a>Az.KeyVault
* Foi adicionado um novo parâmetro '-AsPlainText' a 'Get-AzKeyVaultSecret' para retornar diretamente o segredo em texto sem formatação [n. 13630]
* Foi adicionado suporte à restauração seletiva de uma chave de um backup completo de HSM gerenciado [n. 13526]
* Foram corrigidos alguns problemas secundários [n. 13583] [n. 13584]
* Foram adicionados objetos de retorno ausentes de 'Get-Secret' no módulo SecretManagement
* Foi corrigido um problema que pode fazer com que o cofre seja criado sem a política de acesso padrão [n. 13687]

#### <a name="azkusto"></a>Az.Kusto
* Versão da API atualizada para a versão de 18/09/2020.

#### <a name="aznetwork"></a>Az.Network
* Foi corrigido problema no cmdlet de remoção e emparelhamento e conexão para o cenário ExpressRouteCircuit
    - 'Remove-AzExpressRouteCircuitPeeringConfig' e 'Remove-AzExpressRouteCircuitConnectionConfig'

#### <a name="azpolicyinsights"></a>Az.PolicyInsights
* Foi adicionado suporte para retorno de resultados paginados para Get-AzPolicyState

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Foi habilitado o recurso de exclusão temporária para SQL.
* Foi corrigida a restauração do SQL AG e removida a verificação do nome do contêiner.
* Foi alterado o formato de nome de contêiner para o item de backup de Arquivos do Azure.
* Foi adicionado suporte de recurso CMK para ações do cofre dos Serviços de Recuperação.

#### <a name="azresources"></a>Az.Resources
* Foi corrigido um problema de exceção de NullRef em 'New-AzureManagedApplication' e 'Set-AzureManagedApplication'.
* Foi atualizado o SDK do Azure Resource Manager para uso da versão mais recente em GA da API do DeploymentScripts: 01/10/2020.

#### <a name="azservicefabric"></a>Az.ServiceFabric
* Correção do 'Add-AzServiceFabricNodeType'. Foi adicionado um tipo de nó ao cluster do Service Fabric antes da criação de um conjunto de dimensionamento de máquinas virtuais.

#### <a name="azsql"></a>Az.Sql
* Foi corrigida a descrição do parâmetro fixo para o comando 'InstanceFailoverGroup'.
* Foi atualizada a lógica em que schemaName, tableName e columnName estão sendo extraídos da ID dos comandos da Classificação de Dados SQL.
* Foram corrigidos os campos Status e StatusMessage em 'Get-AzSqlDatabaseImportExportStatus' para estar em conformidade com a documentação
* Foram adicionados cmdlets de auditoria do DevOps (operações de suporte da Microsoft): Get-AzSqlServerMSSupportAudit, Set-AzSqlServerMSSupportAudit, Remove-AzSqlServerMSSupportAudit

#### <a name="azstorage"></a>Az.Storage
* Foi adicionado suporte à criação/atualização/obtenção/listagem de EncryptionScope de uma conta de armazenamento
    - 'New-AzStorageEncryptionScope'
    - 'Update-AzStorageEncryptionScope'
    - 'Get-AzStorageEncryptionScope'
* Foi adicionado suporte para a criação de contêineres e o upload de blobs com a configuração Escopo de Criptografia
    - 'New-AzRmStorageContainer'
    - 'New-AzStorageContainer'
    - 'Set-AzStorageBlobContent'

### <a name="thanks-to-our-community-contributors"></a>Agradecimentos aos colaboradores da comunidade
* Andreas Wolter (@AndreasWolter), idioma de marketing removido, melhor filtro de exemplo (n. 13671)
* Tidjani Belmansour (@BelRarr), Get-AzBillingInvoice.md atualizado (n. 13634)
* David Klempfner (@DavidKlempfner)
  * Foi corrigido um erro de ortografia (n. 13677)
  * Atualização do PSMetricNoDetails.cs (#13676)
* @kilobyte97, correção de bug para a exclusão da configuração pelo cmdlet remove (n. 13655)
* @kongou-ae, atualização do Set-AzFirewall.md (n. 13727)
* @MasterKuat, correção da troca entre título e código na documentação (n. 13666)
* NickT (@nukeulis), atualização do Set-AzContext.md (n. 13702)
* @PaulHCode, atualização do Start-AzJitNetworkAccessPolicy.md – correção do exemplo para exibir o cmdlet adequado que está sendo demonstrado (n. 13713)
* Ryan Borstelmann (@ryanborMSFT), ID da assinatura removida (n. 13715)
* Shashikant Shakya (@shshakya), atualização do Set-AzSqlDatabase.md (n. 13674)
* Sebastian Olsen (@Spacebjorn), atualização do Get-AzRecoveryServicesBackupItem.md (n. 13719)

## <a name="520---december-2020"></a>5.2.0 – Dezembro de 2020
#### <a name="azaccounts"></a>Az.Accounts
* Gerenciado para analisar o tempo de ExpiresOn do token bruto se não for possível obter da biblioteca subjacente
* Mensagem de aviso aprimorada se a autenticação interativa não estiver disponível

#### <a name="azapimanagement"></a>Az.ApiManagement
* [Alteração da falha] 'New-AzApiManagementProduct', por padrão, não tem limite de assinatura.

#### <a name="azcompute"></a>Az.Compute
* Get-AzVm editado para filtrar por '-Name' antes de verificar a limitação devido a muitos recursos. 
* Novo cmdlet 'Start-AzVmssRollingExtensionUpgrade'.

#### <a name="azcontainerregistry"></a>Az.ContainerRegistry
* Parâmetro 'Name' com suporte e valor da entrada de pipeline para 'Get-AzContainerRegistryUsage' [nº 13605]
* Exceções refinadas para 'Connect-AzContainerRegistry'

#### <a name="azdatafactory"></a>Az.DataFactory
* SDK do .NET do ADF atualizado para a versão 4.13.0

#### <a name="azhealthcareapis"></a>Az.HealthcareApis
* Suporte adicionado para chaves gerenciadas pelo cliente

#### <a name="aziothub"></a>Az.IotHub
* Problema de token SAS corrigido.

#### <a name="azkeyvault"></a>Az.KeyVault
* 'Todos' com suporte como uma opção quando são definidas políticas de acesso do cofre de chaves
* Nova versão com suporte do módulo do SecretManagement [nº 13366]
* ByteArray, String, PSCredential e Hashtable com suporte para 'SecretValue' em SecretManagementModule [nº 12190]
* [Alteração da falha] Superfície de API de cmdlets recriada com relação ao HSM gerenciado.

#### <a name="azmonitor"></a>Az.Monitor
* Parâmetro 'Rule' de 'New-AzAutoscaleProfile' alterado para aceitar lista vazia. [Nº 12903]
* Adição de novos cmdlets para dar suporte à criação de configurações de diagnóstico mais flexíveis:
    * 'Get-AzDiagnosticSettingCategory'
    * 'New-AzDiagnosticSetting'
    * 'New-AzDiagnosticDetailSetting'

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* O texto de ajuda e o nome do conjunto de parâmetros foram alterados para o cmdlet 'Restore-AzRecoveryServicesBackupItem'.

#### <a name="azresources"></a>Az.Resources
* Suporte ao parâmetro '-Tag' adicionado para 'Set-AzTemplateSpec' e 'New-AzTemplateSpec'
* Suporte à exibição de marcas adicionado para o formatador padrão para Especificações de Modelo 

#### <a name="azservicefabric"></a>Az.ServiceFabric
* Exemplo adicionado para 'Set-AzServiceFabricSetting' com o parâmetro SettingsSectionDescription
* Cmdlets relacionados a aplicativos atualizados para alertar que o suporte é apenas para recursos implantados do ARM
* Cmdlets de certificado de cluster de 'Add-AzureRmServiceFabricClusterCertificate' e 'Remove-AzureRmServiceFabricClusterCertificate' marcados para substituição

#### <a name="azsql"></a>Az.Sql
* SecondaryType adicionado ao seguinte: 
    - 'New-AzSqlDatabase'
    - 'Set-AzSqlDatabase'
    - 'New-AzSqlDatabaseSecondary'
* HighAvailabilityReplicaCount adicionado ao seguinte: 
    - 'New-AzSqlDatabase'
    - 'Set-AzSqlDatabase'
* ReadReplicaCount tornado um alias de HighAvailabilityReplicaCount no seguinte: 
    - 'New-AzSqlDatabase'
    - 'Set-AzSqlDatabase'

#### <a name="azstorage"></a>Az.Storage
* Upload de arquivos do Azure de até 4 TiB com suporte
    - 'Set-AzStorageFileContent'
* Azure.Storage.Blobs atualizado para 12.7.0
* Azure.Storage.Files.Shares atualizado para 12.5.0
* Azure.Storage.Files.DataLake atualizado para 12.5.0

#### <a name="azstoragesync"></a>Az.StorageSync
* Recurso de política de camadas de sincronização adicionado com política de download e modo de cache local

#### <a name="azwebsites"></a>Az.Websites
* Impedir regras de restrição de acesso duplicadas

### <a name="thanks-to-our-community-contributors"></a>Agradecimentos aos colaboradores da comunidade
* Andrew Dawson (@dawsonar802), por atualizar Get-AzKeyVaultCertificate.md – obter certificado e salvá-lo como seção pfx para trabalhar com o PowerShell Core (nº 13557)
* @iviark, por atualizações de APIs de saúde BYOK do Powershell (nº 13518)
* John Duckmanton (@johnduckmanton), por corrigir a ortografia de TagPatchOperation (nº 13508)
* Michael James (@mikejwhat)
  * Ajuda organizada do Get-AzLogicAppRunHistory (nº 13513)
* Richard de Zwart (@mountain65)
  * Atualizar Update-AzAppConfigurationStore.md (nº 13485)
  * Atualizar New-AzCosmosDBAccount.md (nº 13490)
* @SteppingRazor, New-AzApiManagementProduct: alterar o valor padrão do parâmetro SubscriptionsLimit para nenhum (nº 13457)
* Steve Burkett (@SteveBurkettNZ), por corrigir erros de digitação para o parâmetro WorkspaceResourceId no exemplo (nº 13589)

## <a name="510---november-2020"></a>5.1.0 – Novembro de 2020
#### <a name="azaccounts"></a>Az.Accounts
* Correção de um problema em que a TenantId podia não ser respeitada se 'Connect-AzAccount -DeviceCode' [nº 13477] fosse usado
* Adição do novo cmdlet 'Get-AzAccessToken'
* Correção de um problema que ocorria quando o caminho do perfil do usuário estava inacessível
* Correção de um problema que causava o erro Write-Object durante Connect-AzAccount [nº 13419]
* Adição do parâmetro 'ContainerRegistryEndpointSuffix' a: 'Add-AzEnvironment', 'Set-AzEnvironment' 
* Suporte à interrupção de logon com o clique em <kbd>CTRL</kbd>+<kbd>C</kbd>
* Correção de um problema que fazia com que 'Connect-AzAccount -KeyVaultAccessToken' não funcionasse [nº 13127]
* Correção da referência nula e da não diferenciação de maiúsculas e minúsculas no método em 'Invoke-AzRestMethod'

#### <a name="azaks"></a>Az.Aks
* Correção do problema em que o usuário não podia usar a entidade de serviço para criar um cluster do Kubernetes. [nº 13012]

#### <a name="azappconfiguration"></a>Az.AppConfiguration
* Disponibilidade geral do módulo 'Az.AppConfiguration'

#### <a name="azdatafactory"></a>Az.DataFactory
* Aprimoramento da mensagem de erro do comando 'New-AzDataFactoryV2LinkedServiceEncryptedCredential'

#### <a name="azdatalakestore"></a>Az.DataLakeStore
* Atualização do SDK do plano de dados do ADLS para 1.2.4-alpha. Alterações: https://github.com/Azure/azure-data-lake-store-net/blob/preview-alpha/CHANGELOG.md#version-124-alpha

#### <a name="azdesktopvirtualization"></a>Az.DesktopVirtualization
* Adição de novos cmdlets do Pacote MSIX e atualização de cmdlets de Aplicativos.

#### <a name="azeventhub"></a>Az.EventHub
* Correção de comandos do cluster EventHub sem marcas
* Atualização do texto da Ajuda de PartnerNamespace dos comandos AzEventHubGeoDRConfiguration 

#### <a name="azhdinsight"></a>Az.HDInsight
* Adição dos parâmetros 'ResourceProviderConnection' e 'PrivateLink' ao cmdlet 'New-AzHDInsightCluster' para dar suporte ao recurso de link privado e saída de retransmissão
* Adição do parâmetro 'AmbariDatabase' ao cmdlet 'New-AzHDInsightCluster' para dar suporte ao recurso de banco de dados personalizado do Ambari
* Adição do valor de aceitação de 'AmbariDatabase' ao parâmetro 'MetastoreType' do cmdlet 'Add-AzHDInsightMetastore'

#### <a name="aziothub"></a>Az.IotHub
* Permissão de marcas no cmdlet create do Hub IoT.

#### <a name="azkeyvault"></a>Az.KeyVault
* Suporte à atualização de marcas do cofre de chaves

#### <a name="azlogicapp"></a>Az.LogicApp
* Correção de Get-AzLogicAppRunHistory, que só recuperava a primeira página de resultados

#### <a name="aznetwork"></a>Az.Network
* Atualização do cmdlet indicado abaixo 
    - 'New-AzLoadBalancerFrontendIpConfigCommand', 'Set-AzLoadBalancerFrontendIpConfigCommand', 'Add-AzLoadBalancerFrontendIpConfigCommand':
        - Adição da propriedade PublicIpAddressPrefix
        - Adição da propriedade PublicIpAddressPrefixId
* Adição de novas propriedades aos cmdlets a seguir para permitir o balanceamento de carga global
    - 'New-AzLoadBalancer':
        - adição da propriedade de Nível de SKU
    - 'New-AzPuplicIpAddress':
        - adição da propriedade de Nível de SKU
    - 'New-AzPublicIpPrefix':
        - adição da propriedade de Nível de SKU
    - 'New-AzLoadBalancerBackendAddressConfig':
        - Adição da propriedade LoadBalancerFrontendIPConfigurationId
* Atualização do planejamento para preterir os avisos dos seguintes cmdlets: –'New-AzVirtualHubRoute'   –'New-AzVirtualHubRouteTable'   –'Add-AzVirtualHubRoute'   –'Add-AzVirtualHubRouteTable'   –'Get-AzVirtualHubRouteTable'   –'Remove-AzVirtualHubRouteTable'
* Adição do planejamento para preterir os avisos no argumento 'RouteTable' nos seguintes cmdlets: –'New-AzVirtualHub'   –'Set-AzVirtualHub'   –'Update-AzVirtualHub'
* Os argumentos '-MinScaleUnits' e '-MaxScaleUnits' passaram a ser opcionais em 'Set-AzExpressRouteGateway'
* Adição de novos cmdlets para dar suporte à autenticação mútua e aos perfis SSL no Gateway de Aplicativo
...
#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* A especificação do BackupTime da política está em UTC.
* Modificação do aviso de alteração da falha no cmdlet Get-AzRecoveryServicesBackupJobDetails.
* Atualização do texto da Ajuda do script de exemplo para o cmdlet Set-AzRecoveryServicesBackupProtectionPolicy.
...
* Atualização de 'Export-AzResourceGroup' para uso do SDK.
* Adição de informações de cultura aos métodos de análise

#### <a name="azsql"></a>Az.Sql
* Correção de problemas em que Set-AzSqlDatabaseAudit não dava suporte ao banco de dados de Hiperescala e em que não era possível determinar a edição do banco de dados
* Adição de MaintenanceConfigurationId a 'New-AzSqlInstance' e 'Set-AzSqlInstance'
* Correção de um bug em GetAzureSqlDatabaseReplicationLink.cs, em que o parâmetro PartnerServerName era verificado por valor em vez de chave

#### <a name="azwebsites"></a>Az.Websites
* Adição de suporte para novos recursos de restrição de acesso: ServiceTag, multi-ip e http-headers

### <a name="thanks-to-our-community-contributors"></a>Agradecimentos aos colaboradores da comunidade
* John Q. Martin (@johnmart82) – Adição de informações de pré-requisitos do firewall (nº 13385)
* Manikandan Duraisamy (@madurais-msft) – Correção do argumento PublicSubnetName (nº 13417)
* @mahortas – Atualização dos valores do parâmetro -HostNames (nº 13349)
* @MariachiForHire – Adição de valores compatíveis com TrafficAnalyticsInterval (nº 13304)
* Michael James (@mikejwhat) – permissão para que Get-AzLogicAppRunHistory retorne mais de 30 entradas (nº 13393)
* Shashikant Shakya (@shshakya) – Atualização de Restore-AzSqlInstanceDatabase.md (nº 13404)
...
#### <a name="azaks"></a>Az.Aks
* O uso da [API AccessProfile](/rest/api/aks/managedclusters/getaccessprofile) antiga foi substituído por chamadas para as APIs [ListClusterAdmin](/rest/api/aks/managedclusters/listclusteradmincredentials) e [ListClusterUser](/rest/api/aks/managedclusters/listclusterusercredentials)
...
* Os módulos Az já estão disponíveis no Azure Stack Hub em versão prévia. Isso permite a compatibilidade entre plataformas com o Linux e o macOs. O Azure Stack Hub agora é compatível com o PowerShell Core com os módulos Az. Mais informações podem ser encontradas [aqui](/azure-stack/operator/powershell-install-az-module)
...
* O link atualizado para a documentação do PowerShell para o Azure Stack Hub pode ser encontrado [aqui](/azure-stack/operator/powershell-install-az-module)
