...
ms.locfileid: "37091566"
---
## <a name="run-azure-powershell-in-a-docker-container"></a>Executar o Azure PowerShell em um contêiner do Docker

Há um conjunto de imagens do Docker pré-configuradas com o Azure PowerShell. Há dois tipos de contêineres disponíveis: os que estão executando o PowerShell tradicional no Windows, e um contêiner executando o PowerShell Core no Windows ou no Linux.
...
Os contêineres do PowerShell Core vêm com o PowerShell Core v6 e o módulo `AzureRM.NetCore` pré-instalados. Execute o cmdlet [Import-Module](/powershell/module/microsoft.powershell.core/import-module) e, em seguida, entre com sua conta do Azure:
...
O contêiner do Windows tem o módulo `AzureRM` pré-instalado. Execute o cmdlet [Import-Module](/powershell/module/microsoft.powershell.core/import-module) e, em seguida, entre com sua conta do Azure:
