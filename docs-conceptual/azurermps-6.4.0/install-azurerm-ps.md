...
A partir da versão 6.0, o Azure PowerShell requer a versão 5.0 ou superior do PowerShell em execução no Windows. Para verificar a versão do PowerShell em execução no computador, execute o seguinte comando:
