...
#### <a name="azurermiothub"></a><span data-ttu-id="7ead6-114">AzureRM.IotHub</span><span class="sxs-lookup"><span data-stu-id="7ead6-114">AzureRM.IotHub</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="7ead6-132">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="7ead6-132">AzureRM.Websites</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="7ead6-147">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="7ead6-147">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermcognitiveservices"></a><span data-ttu-id="7ead6-161">AzureRM.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="7ead6-161">AzureRM.CognitiveServices</span></span>
...
#### <a name="azurermdatafactories"></a><span data-ttu-id="7ead6-175">AzureRM.DataFactories</span><span class="sxs-lookup"><span data-stu-id="7ead6-175">AzureRM.DataFactories</span></span>
...
#### <a name="azurermeventgrid"></a><span data-ttu-id="7ead6-190">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="7ead6-190">AzureRM.EventGrid</span></span>
...
#### <a name="azurermmachinelearningcompute"></a><span data-ttu-id="7ead6-206">AzureRM.MachineLearningCompute</span><span class="sxs-lookup"><span data-stu-id="7ead6-206">AzureRM.MachineLearningCompute</span></span>
...
#### <a name="azurermnotificationhubs"></a><span data-ttu-id="7ead6-221">AzureRM.NotificationHubs</span><span class="sxs-lookup"><span data-stu-id="7ead6-221">AzureRM.NotificationHubs</span></span>
...
#### <a name="azurermscheduler"></a><span data-ttu-id="7ead6-258">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="7ead6-258">AzureRM.Scheduler</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="7ead6-272">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="7ead6-272">AzureRM.TrafficManager</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="7ead6-287">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="7ead6-287">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="7ead6-305">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="7ead6-305">AzureRM.DataFactoryV2</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="7ead6-319">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="7ead6-319">AzureRM.Network</span></span>
...
* <span data-ttu-id="7ead6-335">Corrigir tratamento de data e hora incorreto para cultura de base não EUA em Get-AzureSqlSyncGroupLog</span><span class="sxs-lookup"><span data-stu-id="7ead6-335">Fix datetime handling incorrectly for non-us base culture in Get-AzureSqlSyncGroupLog</span></span>
...
#### <a name="azurermautomation"></a><span data-ttu-id="7ead6-353">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="7ead6-353">AzureRM.Automation</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="7ead6-367">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="7ead6-367">AzureRM.Network</span></span>
...
* <span data-ttu-id="7ead6-384">Adicionados os cmdlets de migração de NameSpace Standard a Premium:</span><span class="sxs-lookup"><span data-stu-id="7ead6-384">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    ...
    - <span data-ttu-id="7ead6-387">Complete-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="7ead6-387">Complete-AzureRmServiceBusMigration</span></span>
...
#### <a name="azurermprofile"></a><span data-ttu-id="7ead6-404">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="7ead6-404">AzureRM.Profile</span></span>
...
#### <a name="azurermeventhub"></a><span data-ttu-id="7ead6-424">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="7ead6-424">AzureRM.EventHub</span></span>
...
#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="7ead6-442">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="7ead6-442">AzureRM.RecoveryServices.Backup</span></span>
...
#### <a name="azurermservicebus"></a><span data-ttu-id="7ead6-460">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="7ead6-460">AzureRM.ServiceBus</span></span>
...
* <span data-ttu-id="7ead6-473">Atualizar versão da Biblioteca do cliente de computação para corrigir os cmdlets a seguir</span><span class="sxs-lookup"><span data-stu-id="7ead6-473">Update Compute client library version to fix following cmdlets</span></span>
    - <span data-ttu-id="7ead6-474">Grant-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="7ead6-474">Grant-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="7ead6-475">Grant-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="7ead6-475">Grant-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="7ead6-476">Save-AzureRmVMImage</span><span class="sxs-lookup"><span data-stu-id="7ead6-476">Save-AzureRmVMImage</span></span>
* <span data-ttu-id="7ead6-477">Cmdlets corrigidos a seguir para mostrar corretamente a "ID da operação" e o "status da operação":</span><span class="sxs-lookup"><span data-stu-id="7ead6-477">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    - <span data-ttu-id="7ead6-478">Start-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="7ead6-478">Start-AzureRmVM</span></span>
    - <span data-ttu-id="7ead6-479">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="7ead6-479">Stop-AzureRmVM</span></span>
    - <span data-ttu-id="7ead6-480">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="7ead6-480">Restart-AzureRmVM</span></span>
    - <span data-ttu-id="7ead6-481">Set-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="7ead6-481">Set-AzureRmVM</span></span>
    - <span data-ttu-id="7ead6-482">Remove-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="7ead6-482">Remove-AzuerRmVM</span></span>
    - <span data-ttu-id="7ead6-483">Set-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="7ead6-483">Set-AzureRmVmss</span></span>
    - <span data-ttu-id="7ead6-484">Start-AzureRmVmssRollingOSUpgrade</span><span class="sxs-lookup"><span data-stu-id="7ead6-484">Start-AzureRmVmssRollingOSUpgrade</span></span>
    - <span data-ttu-id="7ead6-485">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="7ead6-485">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="7ead6-486">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="7ead6-486">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="7ead6-487">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="7ead6-487">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="7ead6-488">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="7ead6-488">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="7ead6-489">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="7ead6-489">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="7ead6-490">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="7ead6-490">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="7ead6-491">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="7ead6-491">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="7ead6-492">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="7ead6-492">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="7ead6-493">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="7ead6-493">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="7ead6-494">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="7ead6-494">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="7ead6-495">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="7ead6-495">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="7ead6-496">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="7ead6-496">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="7ead6-497">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="7ead6-497">AzureRM.EventGrid</span></span>
* <span data-ttu-id="7ead6-498">Remova as condições de validação ValidateNotNullOrEmpty para SubjectBeginsWith/SubjectEndsWith no cmdlet Update-AzureRmEventGridSubscription e permita a mudança desses parâmetros para uma cadeia de caracteres vazia, se for necessário.</span><span class="sxs-lookup"><span data-stu-id="7ead6-498">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="7ead6-499">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="7ead6-499">AzureRM.KeyVault</span></span>
* <span data-ttu-id="7ead6-500">Corrigir problema onde nenhuma marca retorna ao executar Get-AzureRmKeyVault -Tag</span><span class="sxs-lookup"><span data-stu-id="7ead6-500">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="7ead6-501">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="7ead6-501">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="7ead6-502">Versão pública dos cmdlets de Informações sobre a Política</span><span class="sxs-lookup"><span data-stu-id="7ead6-502">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="7ead6-503">Usar versão da API 2018-04-04</span><span class="sxs-lookup"><span data-stu-id="7ead6-503">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="7ead6-504">Adicionar PolicyDefinitionReferenceId aos resultados de Get-AzureRmPolicyStateSummary</span><span class="sxs-lookup"><span data-stu-id="7ead6-504">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="7ead6-505">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="7ead6-505">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="7ead6-506">Parâmetro -Vault adicionado aos cmdlets RecoveryServices.Backup.</span><span class="sxs-lookup"><span data-stu-id="7ead6-506">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="7ead6-507">Quando passado, substituirá o cmdlet Set-AzureRmRecoveryServicesContext.</span><span class="sxs-lookup"><span data-stu-id="7ead6-507">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="7ead6-508">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="7ead6-508">AzureRM.Sql</span></span>
* <span data-ttu-id="7ead6-509">Exemplo atualizado no arquivo de ajuda para Get-AzureRmSqlDatabaseExpanded</span><span class="sxs-lookup"><span data-stu-id="7ead6-509">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="7ead6-510">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="7ead6-510">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="7ead6-511">Arquivo de ajuda atualizado para Add-AzureRmTrafficManagerEndpointConfig</span><span class="sxs-lookup"><span data-stu-id="7ead6-511">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="7ead6-512">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="7ead6-512">AzureRM.Websites</span></span>
* <span data-ttu-id="7ead6-513">"Set-AzureRmWebApp" foi atualizado para não substituir AppSettings ao usar -AssignIdentity</span><span class="sxs-lookup"><span data-stu-id="7ead6-513">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="7ead6-514">"New-AzureRmWebAppSlot" foi atualizado para aceitar AppServicePlan como um parâmetro opcional</span><span class="sxs-lookup"><span data-stu-id="7ead6-514">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="7ead6-515">6.2.1 - junho de 2018</span><span class="sxs-lookup"><span data-stu-id="7ead6-515">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="7ead6-516">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="7ead6-516">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="7ead6-517">Modelo PSWorkspace atualizado para permitir que a Rede use o tipo como um parâmetro</span><span class="sxs-lookup"><span data-stu-id="7ead6-517">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="7ead6-518">6.2.0 - Junho de 2018</span><span class="sxs-lookup"><span data-stu-id="7ead6-518">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="7ead6-519">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="7ead6-519">AzureRM.Profile</span></span>
* <span data-ttu-id="7ead6-520">Corrija o problema em que a versão 10.0.3 do Newtonsoft.Json não estava sendo carregado na importação do módulo</span><span class="sxs-lookup"><span data-stu-id="7ead6-520">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="7ead6-521">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="7ead6-521">AzureRM.Compute</span></span>
* <span data-ttu-id="7ead6-522">Recurso de atualização de VM VMSS</span><span class="sxs-lookup"><span data-stu-id="7ead6-522">VMSS VM Update feature</span></span>
    - <span data-ttu-id="7ead6-523">Os cmdlets 'Update-AzureRmVmssVM' e 'New-AzureRmVMDataDisk' foram adicionados</span><span class="sxs-lookup"><span data-stu-id="7ead6-523">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="7ead6-524">Adicione o parâmetro VirtualMachineScaleSetVM ao cmdlet 'Add-AzureRmVMDataDisk' para dar suporte à adição de um disco de dados para a VM Vmss.</span><span class="sxs-lookup"><span data-stu-id="7ead6-524">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="7ead6-525">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="7ead6-525">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="7ead6-526">A versão do SDK do .Net ADF foi atualizada para a versão prévia 0.8.0 que contém as seguintes alterações:</span><span class="sxs-lookup"><span data-stu-id="7ead6-526">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="7ead6-527">A operação para Configurar o repositório de fábrica foi adicionada</span><span class="sxs-lookup"><span data-stu-id="7ead6-527">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="7ead6-528">O LinkedService QuickBooks foi atualizado para expor as propriedades consumerKey e consumerSecret</span><span class="sxs-lookup"><span data-stu-id="7ead6-528">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="7ead6-529">Vários tipos de modelo atualizados de SecretBase para Object</span><span class="sxs-lookup"><span data-stu-id="7ead6-529">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="7ead6-530">Foram adicionados gatilho de eventos de blob</span><span class="sxs-lookup"><span data-stu-id="7ead6-530">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="7ead6-531">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="7ead6-531">AzureRM.KeyVault</span></span>
* <span data-ttu-id="7ead6-532">Atualizar documentação com a saída de exemplo</span><span class="sxs-lookup"><span data-stu-id="7ead6-532">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="7ead6-533">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="7ead6-533">AzureRM.Network</span></span>
* <span data-ttu-id="7ead6-534">Habilitar parâmetros de Análise de Tráfego nos cmdlets do Observador de Rede</span><span class="sxs-lookup"><span data-stu-id="7ead6-534">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="7ead6-535">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="7ead6-535">AzureRM.Resources</span></span>
* <span data-ttu-id="7ead6-536">Corrigir o problema com a propriedade 'Properties' dos objetos 'PSResource' retornados de 'Get-AzureRmResource'</span><span class="sxs-lookup"><span data-stu-id="7ead6-536">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="7ead6-537">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="7ead6-537">AzureRM.Scheduler</span></span>
* <span data-ttu-id="7ead6-538">Corrigir o problema com a atualização de ServiceBusQueueJob não definindo novos valores de Autenticação</span><span class="sxs-lookup"><span data-stu-id="7ead6-538">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="7ead6-539">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="7ead6-539">AzureRM.Sql</span></span>
* <span data-ttu-id="7ead6-540">Os seguintes cmdlets foram atualizados com o parâmetro LicenseType opcional</span><span class="sxs-lookup"><span data-stu-id="7ead6-540">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="7ead6-541">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="7ead6-541">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="7ead6-542">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="7ead6-542">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="7ead6-543">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="7ead6-543">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="7ead6-544">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="7ead6-544">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="7ead6-545">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="7ead6-545">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="7ead6-546">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="7ead6-546">AzureRM.Websites</span></span>
* <span data-ttu-id="7ead6-547">'New-AzureRMWebApp' será atualizado para usar os algoritmos comuns da biblioteca de Estratégia.</span><span class="sxs-lookup"><span data-stu-id="7ead6-547">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="7ead6-548">6.1.0 - maio de 2018</span><span class="sxs-lookup"><span data-stu-id="7ead6-548">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="7ead6-549">AzureRM.profile</span><span class="sxs-lookup"><span data-stu-id="7ead6-549">AzureRM.Profile</span></span>
* <span data-ttu-id="7ead6-550">Corrija o problema onde executar “Clear-AzureRmContext” manteria um contexto vazio com o nome do contexto padrão anterior, o que impediu o usuário de criar um novo contexto com o antigo nome</span><span class="sxs-lookup"><span data-stu-id="7ead6-550">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="7ead6-551">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="7ead6-551">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="7ead6-552">Habilite as operações de associação/desassociação do Gateway no sistema autônomo.</span><span class="sxs-lookup"><span data-stu-id="7ead6-552">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="7ead6-553">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="7ead6-553">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="7ead6-554">Suporte adicionado para ApiVersions, ApiReleases e ApiRevisions</span><span class="sxs-lookup"><span data-stu-id="7ead6-554">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="7ead6-555">Suporte adicionado para Back-end do ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="7ead6-555">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="7ead6-556">Suporte adicionado para Agente do Application Insights</span><span class="sxs-lookup"><span data-stu-id="7ead6-556">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="7ead6-557">Suporte adicionado para reconhecer a sku “Básica” como uma sku válida do serviço de Gerenciamento da Api</span><span class="sxs-lookup"><span data-stu-id="7ead6-557">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="7ead6-558">Suporte adicionado para instalar os Certificados emitidos pela autoridade de certificação privada como Raiz ou CA</span><span class="sxs-lookup"><span data-stu-id="7ead6-558">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="7ead6-559">Suporte adicionado para aceitar certificados SSL Personalizados via KeyVault e vários nomes de host do proxy</span><span class="sxs-lookup"><span data-stu-id="7ead6-559">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="7ead6-560">Suporte adicionado para a identidade MSI</span><span class="sxs-lookup"><span data-stu-id="7ead6-560">Added support for MSI identity</span></span>
* <span data-ttu-id="7ead6-561">Suporte adicionado para aceitar Políticas via Url OBSERVAÇÃO: os cmdlets a seguir serão preteridos na futura versão</span><span class="sxs-lookup"><span data-stu-id="7ead6-561">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="7ead6-562">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="7ead6-562">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="7ead6-563">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="7ead6-563">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="7ead6-564">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="7ead6-564">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="7ead6-565">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="7ead6-565">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="7ead6-566">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="7ead6-566">AzureRM.Batch</span></span>
* <span data-ttu-id="7ead6-567">Versão do novo cmdlet Get-AzureBatchPoolNodeCounts</span><span class="sxs-lookup"><span data-stu-id="7ead6-567">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="7ead6-568">Versão novo cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span><span class="sxs-lookup"><span data-stu-id="7ead6-568">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="7ead6-569">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="7ead6-569">AzureRM.Consumption</span></span>
* <span data-ttu-id="7ead6-570">Adicionar os novos parâmetros Expand, ResourceGroup, InstanceName, InstanceId, Tags e Top no cmdlet Get-AzureRmConsumptionUsageDetail</span><span class="sxs-lookup"><span data-stu-id="7ead6-570">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="7ead6-571">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="7ead6-571">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="7ead6-572">Corrigir exemplo para Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="7ead6-572">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="7ead6-573">Corrigir exceção do parâmetro nulo para Recurse, caso esteja em Set-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="7ead6-573">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="7ead6-574">Corrigir arquivos de ajuda para Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="7ead6-574">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="7ead6-575">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="7ead6-575">AzureRM.Network</span></span>
* <span data-ttu-id="7ead6-576">Aumentar a versão do SDK de Rede de 18.0.0-preview para 19.0.0-preview</span><span class="sxs-lookup"><span data-stu-id="7ead6-576">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="7ead6-577">Cmdlet adicionado para criar a configuração de protocolo</span><span class="sxs-lookup"><span data-stu-id="7ead6-577">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="7ead6-578">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="7ead6-578">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="7ead6-579">Cmdlet adicionado para acrescentar uma nova conexão de circuito a um circuito de rota expressa existente.</span><span class="sxs-lookup"><span data-stu-id="7ead6-579">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="7ead6-580">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="7ead6-580">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="7ead6-581">Cmdlet adicionado para remover uma conexão de circuito de um circuito de rota expressa existente.</span><span class="sxs-lookup"><span data-stu-id="7ead6-581">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="7ead6-582">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="7ead6-582">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="7ead6-583">Cmdlet adicionado para recuperar uma conexão de circuito</span><span class="sxs-lookup"><span data-stu-id="7ead6-583">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="7ead6-584">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="7ead6-584">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="7ead6-585">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="7ead6-585">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="7ead6-586">Uso da autenticação do servidor corrigido com certificados gerados (problema 5998)</span><span class="sxs-lookup"><span data-stu-id="7ead6-586">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="7ead6-587">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="7ead6-587">AzureRM.Sql</span></span>
* <span data-ttu-id="7ead6-588">Cmdlets de auditoria atualizados para permitir a remoção de AuditActions ou AuditActionGroups</span><span class="sxs-lookup"><span data-stu-id="7ead6-588">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="7ead6-589">Problema corrigido com Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy ao definir uma nova política de retenção flexível onde o comando falharia com “Configurar política de retenção de longo prazo com o cofre de serviços de recuperação do azure e não há mais suporte para a política.</span><span class="sxs-lookup"><span data-stu-id="7ead6-589">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="7ead6-590">Envie a solicitação com a nova política de retenção flexível”.</span><span class="sxs-lookup"><span data-stu-id="7ead6-590">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="7ead6-591">Atualizar todos os cmdlets relacionados ao Banco de Dados Sql do Azure/Criação do ElasticPool/Atualização para usar a nova API do Banco de Dados, que suporta a propriedade Sku para o dimensionamento e as propriedades relacionadas à camada.</span><span class="sxs-lookup"><span data-stu-id="7ead6-591">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="7ead6-592">Os cmdlets atualizados, incluindo:</span><span class="sxs-lookup"><span data-stu-id="7ead6-592">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="7ead6-593">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="7ead6-593">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="7ead6-594">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="7ead6-594">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="7ead6-595">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="7ead6-595">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="7ead6-596">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="7ead6-596">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="7ead6-597">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="7ead6-597">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="7ead6-598">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="7ead6-598">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="7ead6-599">Atualize os parâmetros para “Get-AzureRmTrafficManagerProfile” para que o parâmetro -ResourceGroupName seja requerido ao usar o parâmetro -Name.</span><span class="sxs-lookup"><span data-stu-id="7ead6-599">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
