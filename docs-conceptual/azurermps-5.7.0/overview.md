...
- [Máquinas Virtuais do Linux](/azure/virtual-machines/linux/powershell-samples?toc=/powershell/azure/toc.json)
- [Máquinas Virtuais do Windows](/azure/virtual-machines/windows/powershell-samples?toc=/powershell/azure/toc.json)
