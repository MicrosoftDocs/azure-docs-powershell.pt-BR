...
O Azure PowerShell para Windows é instalado usando o arquivo MSI disponível no [GitHub](https://github.com/Azure/azure-powershell/releases/tag/v3.5.0-February2020). Se você tiver instalado versões anteriores dos módulos do Azure como um MSI, o instalador as removerá automaticamente. O pacote de MSI instala os módulos em `${env:ProgramFiles}\WindowsPowerShell\Modules`.
