...
## DESCRITIVO
O cmdlet New-AzureRmConsumptionBudget cria um orçamento em uma assinatura ou em um grupo de recursos.

## EXEMPLOS

### Exemplo 1: criar um orçamento de custo com um nome de orçamento no nível de assinatura
```powershell
...
### Exemplo 2: criar um orçamento de custo com um nome de orçamento em nível de grupo de recursos
```powershell
