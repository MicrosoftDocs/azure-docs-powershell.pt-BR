...
## DESCRITIVO
Esse cmdlet deve ser usado em cenários de recuperação de desastres para validar a presença de um número de controle de troca recebido e opcionalmente para remover essa entidade com Remove-AzureRmIntegrationAccountReceivedIcn.
...
Esse comando obtém a conta de integração do X12 de um número de controle de intercâmbio recebido pelo nome do contrato e pelo valor do número do controle.
...
Esse comando obtém a conta de integração do EDIFACT de um número de controle de intercâmbio recebido pelo nome do contrato e pelo valor do número do controle.
