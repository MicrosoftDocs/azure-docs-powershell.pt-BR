...
## DESCRITIVO
O cmdlet **Get-AzureRmIntegrationAccountPartner** Obtém parceiros de conta de integração a partir de um grupo de recursos.
...
### Exemplo 1: obter um parceiro de conta de integração
```
...
Esse comando obtém o parceiro da conta de integração chamado IntegrationAccountPartner22.

### Exemplo 2: obter um parceiro de conta de integração usando um nome de conta de integração
```
...
Esse comando obtém os parceiros da conta de integração da conta de integração chamada IntegrationAccount31.
