...
## DESCRITIVO
O cmdlet Set-AzureRmDataLakeAnalyticsCatalogCredential modifica uma senha de credencial associada a um catálogo do Azure data Lake Analytics.
...
Este comando define a senha da credencial como a senha especificada em NewPassword.
...
### -Credential
Especifica o nome e a senha atual da credencial a ser modificada.
...
### -CredentialName
Especifica o nome da credencial a ser modificada
...
### -DatabaseName
Especifica o nome do banco de dados na conta data Lake Analytics que mantém a credencial.
