...
## DESCRITIVO
O cmdlet **Remove-AzureRmDataLakeAnalyticsAccount** exclui permanentemente uma conta do Azure data Lake Analytics.
...
Este comando Remove a conta do data Lake Analytics especificada.
