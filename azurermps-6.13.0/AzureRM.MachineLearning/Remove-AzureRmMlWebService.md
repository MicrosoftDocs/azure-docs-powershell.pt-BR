...
## DESCRITIVO
Exclui um serviço Web do Azure Machine Learning referenciado pelo nome e grupo de recursos.
...
### -Nome
O nome do serviço Web a ser removido.
...
Parâmetros: MlWebService (ByValue)
