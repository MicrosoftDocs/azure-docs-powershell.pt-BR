...
## DESCRITIVO
O cmdlet **Remove-AzureRmAutomationConnection** remove uma conexão da automação do Azure.
...
Esse comando Remove um certificado denominado ContosoConnection na conta de automação chamada Contoso17.

## OS

### -AutomationAccountName
Especifica o nome da conta de automação para a qual esse cmdlet Remove uma conexão.
...
### -Nome
Especifica o nome da conexão que este cmdlet Remove.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos para o qual esse cmdlet Remove uma conexão.
