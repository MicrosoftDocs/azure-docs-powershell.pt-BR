...
## DESCRITIVO
O cmdlet **Get-AzureRmAutomationSchedule** Obtém um cronograma de automação do Azure.
...
Este comando obtém o cronograma chamado DailySchedule08.

## OS

### -AutomationAccountName
Especifica o nome de uma conta de automação para a qual esse cmdlet tem um cronograma.
...
### -Nome
Especifica o nome de uma agenda obtida por esse cmdlet.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos para o qual esse cmdlet recebe um cronograma.
