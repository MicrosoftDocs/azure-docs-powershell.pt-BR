...
## DESCRITIVO
O cmdlet Start-AzureRmAutomationSourceControlSyncJob inicia um trabalho de sincronização de controle de recurso de automação do Azure para o nome do controle do código-fonte fornecido.
