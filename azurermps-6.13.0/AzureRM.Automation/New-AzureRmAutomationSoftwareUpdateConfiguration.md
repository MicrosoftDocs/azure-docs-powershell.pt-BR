...
## DESCRITIVO
Cria uma configuração de atualização de software que é executada em um cronograma para atualizar uma lista de computadores. Os computadores incluem máquinas virtuais do Azure ou computadores não pertencentes ao Azure.
