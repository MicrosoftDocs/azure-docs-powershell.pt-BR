...
## DESCRITIVO
O cmdlet New-AzureRmAutomationSourceControl cria uma configuração para vincular minha conta de automação do Azure com meu VSTS TFVC, VSTS git ou GitHub.
