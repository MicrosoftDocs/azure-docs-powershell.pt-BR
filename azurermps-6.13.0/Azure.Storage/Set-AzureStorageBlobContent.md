...
Para usar um contexto de armazenamento criado a partir de um token SAS sem permissão de leitura, é necessário o parâmetro Add-Force para ignorar a verificação de BLOB.
