...
Defina o plano de preços como "básico", defina o limite de volume de dados diários para 400 GB por dia e pare enviar notificação quando a tampa do recurso for "teste" no grupo de recursos "grupo de teste"
