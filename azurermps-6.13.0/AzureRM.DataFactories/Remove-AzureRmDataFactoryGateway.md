...
## DESCRITIVO
O cmdlet **Remove-AzureRmDataFactoryGateway** remove o gateway especificado do Azure data Factory.

## EXEMPLOS

### Exemplo 1: remover um gateway
```
...
Esse comando Remove o gateway chamado ContosoGateway da fábrica de dados chamado WikiADF.

## OS

### -Datafactory
Especifica um objeto **PSDataFactory** .
Esse cmdlet Remove um gateway da fábrica de dados que esse parâmetro especifica.
...
### -Force
Indica que esse cmdlet Remove um gateway sem solicitar confirmação.
...
### -Nome
Especifica o nome do gateway a ser removido.
...
Esse cmdlet Remove um gateway que pertence ao grupo que esse parâmetro especifica.
