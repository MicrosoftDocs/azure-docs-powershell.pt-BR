...
## DESCRITIVO
O cmdlet **set-AzureRmServiceBusSubscription** atualiza a descrição da assinatura para o tópico de barramento de serviço no namespace de barramento de serviço especificado.
