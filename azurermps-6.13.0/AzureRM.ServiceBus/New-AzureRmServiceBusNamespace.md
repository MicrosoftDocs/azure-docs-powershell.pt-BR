...
## DESCRITIVO
O cmdlet **New-AzureRmServiceBusNamespace** cria um novo namespace de barramento de serviço. Uma vez criado, o manifesto do recurso namespace é imutável. Esta operação é idempotente.
