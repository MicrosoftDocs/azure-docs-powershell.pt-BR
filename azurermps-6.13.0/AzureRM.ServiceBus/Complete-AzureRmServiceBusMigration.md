...
## DESCRITIVO
Os cmdlets **Complete-AzureRmServiceBusMigration** definem a migração do namespace padrão para Premium, já que cadeias de caracteres de conexão completa e de conexão do namespace padrão apontam para namespace Premium
...
Define a migração do namespace ' NamespaceStandardMirgation ' como concluída.
...
### -ResourceId
Barramento do serviço Migratio-ID do recurso de namespace padrão
