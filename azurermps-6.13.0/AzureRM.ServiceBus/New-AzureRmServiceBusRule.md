...
## DESCRITIVO
O cmdlet **New-AzureRmServiceBusRule** cria uma nova regra para a assinatura determinada.
...
O cmdlet New-AzureRmServiceBusRule cria uma nova regra para a assinatura especificada.
...
O cmdlet New-AzureRmServiceBusRule cria uma nova regra para a assinatura especificada com o ActionFilter.

## OS

### -ActionSqlExpression
Expressão SqlFillter de ação
