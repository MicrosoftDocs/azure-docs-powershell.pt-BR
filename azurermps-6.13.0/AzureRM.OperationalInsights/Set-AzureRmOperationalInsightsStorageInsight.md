...
## DESCRITIVO
O cmdlet **set-AzureRmOperationalInsightsStorageInsight** altera a configuração de uma percepção do armazenamento.

## EXEMPLOS

### Exemplo 1: modificar uma visão do armazenamento por nome
```
...
Esse comando modifica as tabelas das quais a percepção do armazenamento chamada MyStorageInsight lê.

### Exemplo 2: modificar uma visão do armazenamento usando um objeto do espaço de trabalho
```
...
O segundo comando modifica os contêineres dos quais a percepção do armazenamento chamada MyStorageInsight lê.

## OS

### -Contêineres
Especifica a lista de contêineres que fornecem os dados.
...
### -Nome
Especifica o nome de uma informação sobre o armazenamento.
...
### -Tabelas
Especifica a lista de tabelas que contêm os dados.
...
### -WorkspaceName
Especifica o nome de um espaço de trabalho.
