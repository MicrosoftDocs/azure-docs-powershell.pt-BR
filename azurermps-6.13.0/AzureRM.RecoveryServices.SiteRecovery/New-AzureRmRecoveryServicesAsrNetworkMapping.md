...
## DESCRITIVO
O cmdlet **New-AzureRmRecoveryServicesAsrNetworkMapping** inicia a operação de criação de um mapeamento de rede ASR entre duas redes e retorna o objeto de trabalho ASR para o trabalho ASR usado para acompanhar a operação.
...
Inicia a operação de criação de mapeamento de rede usando o nome, as redes primárias e de recuperação especificadas e retorna um trabalho ASR para acompanhar a operação.
...
Inicia o mapeamento de rede para a operação de criação usando o nome especificado, redes primárias e de recuperação e retorna um trabalho ASR para acompanhar a operação (cenário do Azure para o Azure).

## OS

### -AzureToAzure
Parâmetro de alternância especificando que o mapeamento de rede que está sendo criado será usado para replicar máquinas virtuais do Azure entre duas regiões do Azure.
...
Especifica a ID de rede virtual do Azure da rede principal para o mapeamento.
...
### -PrimaryFabric
Especifica a malha ASR na qual o mapeamento deve ser criado.
...
### -RecoveryFabric
O objeto de malha do Azure site Recovery correspondente à região de recuperação do Azure.
