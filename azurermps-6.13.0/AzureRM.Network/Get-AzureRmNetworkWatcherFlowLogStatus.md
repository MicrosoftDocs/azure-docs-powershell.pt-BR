...
Neste exemplo, obtemos o status de registro de fluxo e de análise de tráfego para um grupo de segurança de rede. O NSG especificado tem o log de fluxo e a análise de tráfego habilitados e nenhuma política de retenção definida.
