...
## DESCRITIVO
O cmdlet **set-AzureRmLoadBalancerOutboundRuleConfig** define uma configuração de regra de saída para um balanceador de carga do Azure.
...
O segundo comando usa o operador pipeline para passar o balanceador de carga em $slb para adicionar-AzureRmLoadBalancerOutboundRuleConfig, o que adiciona uma configuração de regra de saída a ele.
O terceiro comando passa o balanceador de carga para **set-AzureRmLoadBalancerOutboundRuleConfig** , que salva e atualiza a configuração da regra de saída.
