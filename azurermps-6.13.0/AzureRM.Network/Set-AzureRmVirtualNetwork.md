...
## DESCRITIVO
O cmdlet **set-AzureRmVirtualNetwork** define o estado da meta para uma rede virtual do Azure.
...
Este exemplo cria uma rede virtual chamada TestResourceGroup com duas sub-redes: frontendSubnet e backendSubnet. Em seguida, ele remove a sub-rede backendSubnet da representação na memória da rede virtual. O cmdlet Set-AzureRmVirtualNetwork é usado para gravar o estado da rede virtual modificada no lado do serviço. Quando o cmdlet Set-AzureRmVirtualNetwork for executado, o backendSubnet será removido.
