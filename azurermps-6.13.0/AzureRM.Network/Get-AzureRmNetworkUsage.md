...
## DESCRITIVO
O cmdlet Get-AzureRmNetworkUsage Obtém limites e uso atual para recursos de rede.
...
Obtém dados de uso de recursos na região westcentralus
...
### -Local
O local em que o uso do recurso é consultado.
