...
Este exemplo cria uma WAN virtual em um grupo de recursos e, em seguida, a exclui imediatamente. Essa exclusão ocorre usando o objeto de WAN virtual retornado por New-AzureRmVirtualWan.
...
Este exemplo cria uma WAN virtual em um grupo de recursos e, em seguida, a exclui imediatamente. Essa exclusão ocorre usando a ID do recurso de WAN virtual retornada por New-AzureRmVirtualWan.
Para suprimir o prompt ao excluir a rede de longa distância virtual, use o sinalizador-Force.
