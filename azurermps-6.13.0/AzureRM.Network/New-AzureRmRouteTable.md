...
## DESCRITIVO
O cmdlet **New-AzureRmRouteTable** cria uma tabela de rota do Azure.
...
O primeiro comando cria uma rota chamada Route07 usando o cmdlet New-AzureRmRouteConfig e a armazena na variável $Route. Essa rota encaminha pacotes para a rede virtual local.
...
Desabilitar a propagação automática de rota BGP.
