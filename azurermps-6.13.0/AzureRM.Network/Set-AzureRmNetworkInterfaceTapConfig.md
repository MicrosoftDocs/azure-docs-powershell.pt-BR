...
## Sinopse
Define o estado da meta de uma configuração de toque
...
## DESCRITIVO
O **set-AzureRmNetworkInterfaceTapConfig** define o estado da meta para uma interface de rede do Azure.
...
A NetworkInterface, toque em configurtion
