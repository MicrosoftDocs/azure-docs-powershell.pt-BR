...
### Exemplo 2: configurar o log de fluxo e a análise de tráfego para um NSG especificado
```
PS C:\> $NW = Get-AzurermNetworkWatcher -ResourceGroupName NetworkWatcherRg -Name NetworkWatcher_westcentralus
PS C:\> $nsg = Get-AzureRmNetworkSecurityGroup -ResourceGroupName NSGRG -Name appNSG
PS C:\> $storageId = "/subscriptions/bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb/resourceGroups/NSGRG/providers/Microsoft.Storage/storageAccounts/contosostorageacct123"
...
Neste exemplo, configuramos o status do log de fluxo e a análise de tráfego para um grupo de segurança de rede. Na resposta, vemos que o NSG especificado tem o log de fluxo e a análise de tráfego habilitados e nenhuma política de retenção definida.
