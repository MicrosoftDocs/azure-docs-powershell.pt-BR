...
Após a criação do gateway, ele é conectado ao VpnSite usando o comando New-AzureRmVpnConnection.

A conexão é atualizada para ter um novo IpSecPolicy usando o comando Set-AzureRmVpnConnection.
