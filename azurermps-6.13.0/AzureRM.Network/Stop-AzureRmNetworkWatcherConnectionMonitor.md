...
## DESCRITIVO
O cmdlet Stop-AzureRmNetworkWatcherConnectionMonitor interrompe o monitor de conexão especificado.

## EXEMPLOS

### Exemplo 1: parar um monitor de conexão
```
PS C:\> Stop-AzureRmNetworkWatcherConnectionMonitor -NetworkWatcher $nw -Name cm
```

Neste exemplo, interrompemos o monitor de conexão especificado pelo nome e Inspetor de rede
