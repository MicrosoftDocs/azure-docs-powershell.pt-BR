...
## DESCRITIVO
O cmdlet **set-AzureRmVirtualNetworkSubnetConfig** configura o estado da meta para uma configuração de sub-rede em uma rede virtual do Azure.
...
Este exemplo cria uma rede virtual com uma sub-rede. Em seguida, chama-se Set-AzureRmVirtualNetworkSubnetConfig de modificar o AddressPrefix da sub-rede. Isso afeta apenas a representação na memória da rede virtual. Set-AzureRmVirtualNetwork, em seguida, é chamado para modificar a rede virtual no Azure.
