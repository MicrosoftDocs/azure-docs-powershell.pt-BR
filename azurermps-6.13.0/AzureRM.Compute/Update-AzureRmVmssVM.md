...
### Exemplo 1: adicionar um disco de dados gerenciado a uma VM do Vmss usando New-AzureRmVMDataDisk
```
...
### Exemplo 2: adicionar um disco de dados gerenciado a uma VM do Vmss usando Add-AzureRmVMDataDisk
```
PS C:\> $disk = Get-AzureRmDisk -ResourceGroupName $rgname -DiskName $diskname0
PS C:\> $VmssVM = Get-AzureRmVmssVM -ResourceGroupName "myrg" -VMScaleSetName "myvmss" -InstanceId 0
