...
### Exemplo 3: criar um novo cluster usando um modelo personalizado. Especificar um nome de grupo de recursos diferente para o cofre de chaves e fazer com que o sistema carregue um novo certificado
```
$pass="Password#1234" | ConvertTo-SecureString -AsPlainText -Force
$RGname="test20"
...
Esse comando cria um novo cluster usando um modelo personalizado. Especificar um nome de grupo de recursos diferente para o cofre de chaves e fazer com que o sistema carregue um novo certificado
...
### System. String
Parâmetros: CertificateFile (ByValue), CertificateOutputFolder (ByValue), CertificateSubjectName (ByValue), keyvaultname (ByValue), KeyVaultResouceGroupName (ByValue), Location (ByValue), Name (ByValue), Parameterfile (ByValue), SecondaryCertificateFile (ByValue), SecretIdentifier (ByValue), TemplateFile (ByValue), VmUserName (ByValue)

### System. Security. SecureString
Parâmetros: CertificatePassword (ByValue), SecondaryCertificatePassword (ByValue)

### System. Int32
Parâmetros: ClusterSize (ByValue)

### Microsoft. Azure. Commands. imfabric. Models. OperatingSystem
