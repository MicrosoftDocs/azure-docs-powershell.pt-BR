...
## DESCRITIVO
Use **Remove-AzureRmServiceFabricNode** para remover nós de um tipo de nó específico de um cluster. A remoção continuará somente se atender as métricas de integridade do cluster.
...
Esse comando removerá 2 nós do NodeType ' NT1 '.
...
### System. Int32
Parâmetros: NumberOfNodesToRemove (ByValue)
