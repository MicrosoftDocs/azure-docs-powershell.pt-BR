...
## DESCRITIVO
Use **Add-AzureRmServiceFabricClientCertificate** para adicionar um nome comum e uma impressão digital do emissor ou impressão digital de certificado ao cluster, para que o cliente possa usá-lo para autenticação.
...
Parâmetros: administrador (ByValue)

### System. String
Parâmetros: CommonName (ByValue), IssuerThumbprint (ByValue), Thumbprint (ByValue)

### System. String []
Parâmetros: AdminClientThumbprint (ByValue), ReadonlyClientThumbprint (ByValue)

### Microsoft. Azure. Commands. imfabric. Models. PSClientCertificateCommonName []
Parâmetros: ClientCertificateCommonName (ByValue)
