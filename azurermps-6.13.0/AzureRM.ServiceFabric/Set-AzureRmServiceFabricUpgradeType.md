...
## DESCRITIVO
Use **set-AzureRmServiceFabricUpgradeType** para definir o tipo de atualização para automático ou manual com uma versão específica do código de malha de serviço.
...
Esse comando definirá o modo de atualização do cluster como automático.
...
### System. String
Parâmetros: Version (ByValue)

### Microsoft. Azure. Commands. imfabric. Models. ClusterUpgradeMode
Parâmetros: Upgrademode (ByValue)
