...
Esse comando adicionará um novo NodeType ' N2 ' com capacidade de 5, e o nome do administrador da VM será ' adminname '.
...
### -VmUserName
O nome de usuário para logon na VM.
...
### System. String
Parâmetros: NodeType (ByValue), camada (ByValue), VmSku (ByValue), VmUserName (ByValue)

### System. Int32
Parâmetros: Capacity (ByValue)

### System. Security. SecureString
Parâmetros: VmPassword (ByValue)

### Microsoft. Azure. Commands. imfabric. Models. DurabilityLevel
Parâmetros: DurabilityLevel (ByValue)
