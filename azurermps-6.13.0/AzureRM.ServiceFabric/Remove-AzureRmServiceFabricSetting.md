...
## DESCRITIVO
Use **Remove-AzureRmServiceFabricSetting** para remover as configurações do Service Fabric do cluster.
...
Este comando removerá as configurações ' MaxCursors ' na seção ' EseStore '.
...
### System. String
Parâmetros: Parameter (ByValue), seção (ByValue)

### Microsoft. Azure. Commands. imfabric. Models. PSSettingsSectionDescription []
Parâmetros: SettingsSectionDescription (ByValue)
