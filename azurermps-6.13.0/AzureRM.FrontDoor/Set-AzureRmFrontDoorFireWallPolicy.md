...
## DESCRITIVO
O cmdlet **set-AzureRmFrontDoor** atualiza uma política WAF existente. Se os parâmetros de entrada não forem fornecidos, os parâmetros antigos da política WAF existente serão usados.

## EXEMPLOS

### Exemplo 1: atualizar uma política de WAF existente
```powershell
...
### Exemplo 3: atualizar uma política de WAF existente
```powershell
...
### Exemplo 4: atualizar todas as políticas do WAF no $resourceGroup
```powershell
...
atualizar todas as políticas do WAF no $resourceGroup
