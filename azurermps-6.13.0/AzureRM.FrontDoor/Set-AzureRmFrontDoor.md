...
## DESCRITIVO
O cmdlet **set-AzureRmFrontDoor** atualiza um balanceador de carga de porta frontal. Se os parâmetros de entrada não forem fornecidos, os parâmetros antigos da porta frontal existente serão usados.
