...
## DESCRITIVO
O cmdlet **Get-AzureBatchCertificate** Obtém os certificados na conta em lotes do Azure que o parâmetro *BatchContext* especifica.
Para obter um certificado específico, especifique os parâmetros de *ThumbprintAlgorithm* e *impressão digital* .
Especifique o parâmetro *Filter* para obter os certificados correspondentes a um filtro do Open Data Protocol (OData).
...
Esse comando obtém um único certificado que tem a impressão digital especificada.
O algoritmo de impressão digital do certificado é SHA1.
...
Esse comando obtém todos os certificados no estado ativo da conta em lotes.
O parâmetro *Filter* especifica o estado.
...
Se você especificar esse parâmetro, esse cmdlet obterá os certificados que correspondem ao filtro.
...
### -MaxCount
Especifica o número máximo de certificados a serem retornados.
...
### Microsoft.Azure.Commands.Batch. Modelos. PSCertificate
