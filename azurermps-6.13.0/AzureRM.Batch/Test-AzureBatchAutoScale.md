...
## DESCRITIVO
O cmdlet **Test-AzureBatchAutoScale** Obtém o resultado de uma fórmula de dimensionamento automático no pool especificado.

## EXEMPLOS

### Exemplo 1: avaliar uma fórmula de autoescala em um pool
```
...
O primeiro comando armazena uma fórmula na variável $Formula para uso no exemplo.
O segundo comando avalia a fórmula de autoescala no pool que tem a ID ContosoPool.
O comando final exibe os **resultados** usando a sintaxe ponto padrão.
...
### -ID
Especifica a ID de objeto do pool para o qual testar o dimensionamento automático.
...
### Microsoft.Azure.Commands.Batch. Modelos. PSAutoScaleRun
