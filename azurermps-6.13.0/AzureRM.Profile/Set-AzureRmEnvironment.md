...
## DESCRITIVO
O cmdlet Set-AzureRMEnvironment define pontos de extremidade e metadados para se conectar a uma instância do Azure.
...
Sufixo DNS dos pontos de extremidade do serviço do Azure Analysis Services
...
### -Nome
Especifica o nome do ambiente a ser modificado.
