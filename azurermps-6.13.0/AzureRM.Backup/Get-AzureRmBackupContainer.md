...
- Uma máquina virtual de infraestrutura como serviço do Azure (IaaS) antes de o backup pode fazer backup de uma fonte de dados ou item, você deve registrar o contêiner que o mantém com o serviço de backup do Azure.
