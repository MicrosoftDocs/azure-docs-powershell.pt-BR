...
- Mensal 
- Mensal 
- Crie anualmente uma política de retenção para cada tipo de retenção que você planeja usar.
...
- Às 
- Sábado 
- Domingo Especifique esse parâmetro se você especificar os parâmetros *WeeklyRetention* , *MonthlyRetentionInWeeklyFormat* e *YearlyRetentionInWeeklyFormat* .
