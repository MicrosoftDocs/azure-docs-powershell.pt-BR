...
### ConsumergroupPropertiesSet (padrão)
```
...
## DESCRITIVO
O cmdlet Remove-AzureRmEventHubConsumerGroup remove e exclui o grupo consumidor especificado do hub de eventos fornecido.
...
Exclui o \` MyConsumerGroupName do grupo \` do consumidor do MyEventHubName do hub de eventos \` \` , escopo do \` namespace mynamespacename \` .
...
### -InputObject
Objeto do objeto do consumidor
...
### -ResourceId
ID do recurso de usuário do usuário
