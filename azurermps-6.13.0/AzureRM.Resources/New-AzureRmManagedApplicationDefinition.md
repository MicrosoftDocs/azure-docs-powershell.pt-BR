...
## DESCRITIVO
O cmdlet **New-AzureRmManagedApplicationDefinition** cria uma definição de aplicativo gerenciado.
...
### -CreateUiDefinition
A definição de aplicativo gerenciado criar definição da interface do usuário
...
### -LockLevel
O nível do bloqueio para a definição do aplicativo gerenciado.
...
### -MainTemplate
O modelo principal de definição do aplicativo gerenciado
