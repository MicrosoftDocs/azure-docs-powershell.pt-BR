...
## DESCRITIVO
O cmdlet **set-AzureRmPolicyDefinition** modifica uma definição de política.
...
Esse comando atualiza a definição de política chamada VMPolicyDefinition usando o cmdlet Set-AzureRmPolicyDefinition para definir a propriedade Mode como ' all'.
