...
Obtém uma implantação no escopo da assinatura.

### [Get-AzureRmDeploymentOperation](Get-AzureRmDeploymentOperation.md)
Obtém as operações de implantação para uma implantação em escopo de assinatura.
...
Cria uma nova implantação em escopo de assinatura.
...
Remove uma implantação no escopo da assinatura.
...
Obtém o modelo para uma implantação em escopo de assinatura.
...
### [Parar-AzureRmDeployment](Stop-AzureRmDeployment.md)
Cancela uma implantação em execução no escopo da assinatura.
...
Valida um modelo de implantação e parâmetros no escopo da assinatura.
