...
### Exemplo 1-remover um usuário de um grupo por ID de objeto
...
Remove o usuário com a ID de objeto "D9076BBC-D62C-4105-9C78-A7F5BC4A3405" do grupo com a ID de objeto "85F89C90-780E-4AA6-9F4F-6F268D322EEE".

### Exemplo 2-remover um usuário de um grupo por tubulação
...
Obtém o grupo com a ID de objeto ' 85F89C90-780E-4AA6-9F4F-6F268D322EEE ' e a canaliza para o cmdlet Remove-AzureRmADGroupMember para remover o usuário desse grupo.
...
### -GroupDisplayName
O nome de exibição do grupo do qual você deseja remover o (s) membro (s).
...
### -Groupobject
A representação de objeto do grupo do qual você deseja remover o membro.
...
### -GroupObjectId
A ID de objeto do grupo do qual você deseja remover o membro.
...
Parâmetros: Groupobject (ByValue)
