...
### Exemplo 1-remover um grupo por ID de objeto

```
PS C:\> Remove-AzureRmADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE
```

Remove o grupo com a ID de objeto "85F89C90-780E-4AA6-9F4F-6F268D322EEE" do locatário.

### Exemplo 2-remover um grupo por tubulação

```
PS C:\> Get-AzureRmADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE | Remove-AzureRmADGroup
```

Obtém o grupo com a ID de objeto ' 85F89C90-780E-4AA6-9F4F-6F268D322EEE ' e canaliza-se para Remove-AzureRmADGroup para remover o grupo do locatário.
...
### -DisplayName
O nome de exibição do grupo a ser removido.
...
### -Force
Se especificado, não pede confirmação para excluir o grupo.
...
### -InputObject
A representação de objeto do grupo a ser removido.
...
### -ObjectId
A ID de objeto do grupo a ser removido.
