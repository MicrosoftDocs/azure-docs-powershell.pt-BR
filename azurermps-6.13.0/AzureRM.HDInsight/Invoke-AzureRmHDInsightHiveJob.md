...
## DESCRITIVO
O cmdlet **Invoke-AzureRmHDInsightHiveJob** envia uma consulta Hive para um cluster do Azure HDInsight e recupera resultados de consulta em uma operação.
Use o cmdlet Use-AzureRmHDInsightCluster antes de chamar **Invoke-AzureRmHDInsightHiveJob** para especificar qual cluster será usado para a consulta.
