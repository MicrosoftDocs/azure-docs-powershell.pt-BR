...
## DESCRITIVO
O cmdlet **New-AzureRmHDInsightSqoopJobDefinition** define um objeto de trabalho Sqoop para uso com um cluster do Azure HDInsight.
...
Esse comando cria uma definição de trabalho Sqoop.
...
### -LibDir
Especifica o diretório de bibliotecas para o trabalho do Sqoop.
