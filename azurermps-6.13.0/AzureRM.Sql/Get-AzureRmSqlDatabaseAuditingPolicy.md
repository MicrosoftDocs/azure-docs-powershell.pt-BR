...
## DESCRITIVO
O cmdlet **Get-AzureRmSqlDatabaseAuditingPolicy** Obtém a política de auditoria de um banco de dados SQL do Azure.
Para usar o cmdlet, use os parâmetros *ResourceGroupName* , *ServerName* e *DatabaseName* para identificar o banco de dados.

## EXEMPLOS

### Exemplo 1: obter a política de auditoria de um banco de dados SQL do Azure com a auditoria de tabela definida
```
...
### Exemplo 2: obter a política de auditoria de um banco de dados SQL do Azure com auditoria de blob definida
```
PS C:\>Get-AzureRmSqlDatabaseAuditingPolicy -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
DatabaseName           : database01
AuditAction            : {}
