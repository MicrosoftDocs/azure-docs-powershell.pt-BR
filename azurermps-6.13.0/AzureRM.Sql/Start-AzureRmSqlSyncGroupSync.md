...
## DESCRITIVO
O cmdlet **Start-AzureRmSqlSyncGroupSync** inicia uma sincronização de grupo de sincronização.
...
Esse comando inicia uma arredondamento de sincronização para o grupo de sincronização mysg.
...
### -PassThru
Define se retornar o grupo de sincronização
