...
## DESCRITIVO
O cmdlet **Stop-AzureRmSqlSyncGroupSync** interrompe uma sincronização de grupo de sincronização.
...
Esse comando interrompe a sincronização que está em andamento para o grupo de sincronização mysg.
