...
## DESCRITIVO
O cmdlet **Remove-AzureRmSqlDatabaseLongTermRetentionBackup** exclui o backup especificado.

## EXEMPLOS

### Exemplo 1: excluir um único backup
```powershell
...
### Exemplo 2: excluir todos os backups de um local
```powershell
