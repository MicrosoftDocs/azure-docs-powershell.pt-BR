...
## DESCRITIVO
O cmdlet **Get-AzureRmSqlServerRecommendedAction** Obtém uma ou mais ações recomendadas para um SQL Server Advisor do Azure.

## EXEMPLOS

### Exemplo 1: obter uma lista de todas as ações recomendadas para um consultor específico
```
...
Esse comando obtém uma lista de todas as ações recomendadas do para o SQL Server Advisor chamado CreateIndex disponível para o servidor chamado Wi-Runner-Austrália-leste.

### Exemplo 2: obter uma única ação recomendada para um conselheiro
```
...
Esse comando obtém uma ação recomendada chamada IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 do supervisor chamado CreateIndex.

## OS

### -Supervisorname
Especifica o nome do supervisor para o qual este cmdlet solicita ações.
...
Especifica o nome da ação recomendada que este cmdlet obtém.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos do servidor que contém esse servidor.
...
### -Nomedoservidor
Especifica o nome do servidor ao qual o supervisor pertence.
...
### Microsoft. Azure. Commands. Sql. Recomendadoaction. Model. AzureSqlServerRecommendedActionModel

## INFORMA
* Palavras-chave: Azure, azurerm, ARM, Resource, Management, Manager, SQL, Server, MSSQL, Advisor, recommendedaction
