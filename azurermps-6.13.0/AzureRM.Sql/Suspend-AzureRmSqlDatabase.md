...
## DESCRITIVO
O cmdlet **Suspend-AzureRmSqlDatabase** suspende um banco de dados de SQL data warehouse do Azure.
...
## INFORMA
* O cmdlet **Suspend-AzureRmSqlDatabase** funciona apenas em bancos de dados de data warehouse do SQL do Azure. Não há suporte para essa operação nas edições Basic, Standard e Premium do banco de dados SQL do Azure.
