...
## DESCRITIVO
O cmdlet **Get-AzureRmSqlSyncGroupLog** retorna os logs de um grupo de sincronização de banco de dados SQL do Azure.

## EXEMPLOS

### Exemplo 1: obter os logs de um grupo de sincronização do Azure SQL
```
...
Esse comando obtém os logs de um grupo Azure SQL Sync.
...
### -EndTime
A hora de término dos logs para consulta.
...
### -LogLevel
O tipo dos logs a serem consultados.
Os valores válidos são: ' error ', ' Warning ', ' Success ' e ' all'.
...
### -StartTime
A hora de início do log para consulta.
