...
## DESCRITIVO
O cmdlet **set-AzureRmSqlElasticPool** define propriedades para um pool elástico no banco de dados SQL do Azure. Esse cmdlet pode modificar o eDTUs por pool ( *DTU* ), o tamanho máximo de armazenamento por pool ( *StorageMB* ), o máximo eDTUs por banco de dados ( *DatabaseDtuMax* ) e o mínimo de EDTUs por banco de dados ( *DatqabaseDtuMin* ).
...
### Exemplo 1: modificar as propriedades de um pool elástico
```
...
Esse comando modifica as propriedades de um pool elástico chamado elasticpool01. O comando define o número de DTUs para o pool elástico para 1000 e define as DTUs mínima e máxima.
...
Esse comando modifica as propriedades de um pool elástico chamado elasticpool01. O comando define o armazenamento máximo para um pool elástico para 2 TB.
...
### -DatabaseDtuMax
Especifica o número máximo de DTUs que qualquer único banco de dados no pool pode consumir.
...
### -Edição
Especifica a edição do banco de dados SQL do Azure para o pool elástico. Não é possível alterar a edição. Os valores aceitáveis para esse parâmetro são:
- Nenhuma
- Basic
- Oficial
- Gratifica
...
### -StorageMB
Especifica o limite de armazenamento, em megabytes, para o pool elástico. Para obter mais informações, consulte o cmdlet New-AzureRmSqlElasticPool.
...
### -Marcas
Especifica um dicionário de pares de chave-valor que esse cmdlet associa ao pool elástico na forma de uma tabela de hash. Por exemplo: `@{key0="value0";"key 1"=$null;key2="value2"}`
...
### -VCore
O número total de partilhas de VCORE do pool elástico do SQL Azure.
