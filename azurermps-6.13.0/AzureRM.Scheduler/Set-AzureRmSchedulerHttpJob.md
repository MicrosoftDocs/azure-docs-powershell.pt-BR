...
## DESCRITIVO
O cmdlet **set-AzureRmSchedulerHttpJob** modifica um trabalho http no Agendador do Azure.
...
### -Frequency
Especifica a frequência máxima do trabalho.
Os valores aceitáveis para esse parâmetro são:
- Minuto 
- Ampulheta 
- Contas 
...
### -Método
Especifica o método para os tipos de ação para esse trabalho.
Os valores aceitáveis para esse parâmetro são:
- Obter 
- SUSPENDE 
- Postar 
