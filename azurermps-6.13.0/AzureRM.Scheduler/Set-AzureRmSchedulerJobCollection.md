...
## DESCRITIVO
O cmdlet **set-AzureRmSchedulerJobCollection** modifica uma coleção de trabalhos no Agendador do Azure.
...
### -Local
Especifica a região do Azure na qual existe a coleção de trabalhos.
