...
## DESCRITIVO
O cmdlet **Restore-AzureKeyVaultManagedStorageAccount** cria uma conta de armazenamento gerenciado no cofre de chaves especificado a partir de um arquivo de backup.
