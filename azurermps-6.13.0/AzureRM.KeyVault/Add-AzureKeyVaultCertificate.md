...
## DESCRITIVO
O cmdlet **Add-AzureKeyVaultCertificate** inicia o processo de registrar um certificado em um cofre de chaves no cofre de chaves do Azure.

## EXEMPLOS

### Exemplo 1: adicionar um certificado
```powershell
...
O primeiro comando usa o cmdlet New-AzureKeyVaultCertificatePolicy para criar uma política de certificado e, em seguida, armazena-o na variável $Policy.
O segundo comando usa **Add-AzureKeyVaultCertificate** para iniciar o processo de criação de um certificado.
O terceiro comando usa o cmdlet Get-AzureKeyVaultCertificateOperation para sondar a operação e verificar se ela está completa.
O comando final usa o cmdlet Get-AzureKeyVaultCertificate para obter o certificado.

## OS

### -CertificatePolicy
Especifica um objeto **KeyVaultCertificatePolicy** .
...
### -Nome
Especifica o nome do certificado a ser adicionado.
...
Parâmetros: CertificatePolicy (ByValue)
