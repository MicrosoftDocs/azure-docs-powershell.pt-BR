...
### -TargetFolder
A pasta na qual o compartilhamento de arquivos precisa ser restaurado dentro do targetFileShareName. deixe a variável vazia para restaurar na pasta raiz.
...
### System. String
Parâmetros: Vaultid (ByValue), VaultLocation (ByValue)
