...
## DESCRIPTION
O Get-AzContext cmdlet obtém os metadados atuais usados para autenticar solicitações do Gerenciador de Recursos do Azure.
Este cmdlet obtém a conta do Active Directory, o locatário do Active Directory, a assinatura do Azure e o ambiente do Azure direcionado.
