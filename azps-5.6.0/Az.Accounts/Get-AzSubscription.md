...
## DESCRIPTION
O Get-AzSubscription cmdlet obtém a ID da assinatura, o nome da assinatura e o locatário de residência para assinaturas que a conta atual pode acessar.
...
Listar todas as assinaturas no locatário determinado que estão autorizadas para a conta atual.
...
Esse comando obtém a assinatura especificada e define o contexto atual para usá-la. Todos os cmdlets subsequentes nesta sessão usam a nova assinatura (Assinatura contoso 1) por padrão.
...
### -SubscriptionId
Especifica a ID da assinatura a ser obter.
...
### -SubscriptionName
Especifica o nome da assinatura a ser obter.
...
### -TenantId
Especifica a ID do locatário que contém assinaturas a obter.
