...
## DESCRIPTION
O cmdlet Add-AzEnvironment adiciona pontos de extremidade e metadados para permitir que os cmdlets do Gerenciador de Recursos do Azure se conectem a uma nova instância do Gerenciador de Recursos do Azure.
Os ambientes integrados do AzureCloud e do AzureChinaCloud visam instâncias públicas existentes do Gerenciador de Recursos do Azure.
...
Especifica a audiência para tokens que autenticam solicitações para pontos de extremidade do Gerenciador de Recursos do Azure ou gerenciamento de serviço (RDFE).
...
Descobre ambientes por meio do ponto de extremidade padrão ou configurado.
...
O identificador de recursos do recurso serviços de análise do Azure.
...
### -AzureDataLakeStoreFileSystemEndpointSuffix
Sufixo dns do Arquivo do Azure Data Lake Store. Exemplo: azuredatalake.net
...
### -AzureKeyVaultDnsSuffix
Sufixo dns do serviço do Azure Key Vault. Exemplo é vault-int.azure-int.net
...
### -BatchEndpointResourceId
O identificador de recurso do serviço batch do Azure que é o destinatário do token solicitado
...
Sufixo do Registro de Contêineres do Azure.
...
### -DataLakeAudience
A audiência para tokens autenticando com o Ponto de Extremidade dos serviços do AD Data Lake.
...
### -GalleryEndpoint
Especifica o ponto de extremidade para a galeria do Gerenciador de Recursos do Azure de modelos de implantação.
...
Especifica a URL para solicitações do Gerenciador de Recursos do Azure.
...
### -SqlDatabaseDnsSuffix
Especifica o sufixo de nome de domínio para servidores de banco de dados SQL Azure.
...
### -StorageEndpoint
Especifica o ponto de extremidade para o acesso de armazenamento (blob, tabela, fila e arquivo).
...
### -Uri
Especifica o URI do recurso internet para buscar ambientes.
