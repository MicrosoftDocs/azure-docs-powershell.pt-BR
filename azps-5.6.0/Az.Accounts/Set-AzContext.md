...
### -Force
Sobrescreva o contexto existente com o mesmo nome, se for o caso.
...
### -Subscription
O nome ou a id da assinatura à qual o contexto deve ser definido. Esse parâmetro tem aliases para -SubscriptionName e -SubscriptionId, portanto, para esclarecer, um deles pode ser usado em vez de -Subscription ao especificar nome e id, respectivamente.
