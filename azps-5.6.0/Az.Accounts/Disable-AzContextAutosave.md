...
### Exemplo 1: Desabilitar a autosaving do contexto
```powershell
PS C:\> Disable-AzContextAutosave
```

Desabilitar o autosave para o usuário atual.

### Exemplo 2

Desativar a autosaving credenciais do Azure nesta sessão do powershell. (gerado automaticamente)
