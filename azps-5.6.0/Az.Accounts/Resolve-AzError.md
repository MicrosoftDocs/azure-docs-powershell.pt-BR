...
## DESCRIPTION
Resolve e exibe informações detalhadas sobre erros na sessão atual do PowerShell, incluindo onde ocorreu o erro no script, rastreamento de pilha e todas as exceções internas e agregadas. Para erros do Azure PowerShell, fornece detalhes adicionais sobre problemas de serviço de depuração, incluindo detalhes completos sobre a solicitação e a resposta do servidor que causaram o erro.
...
### -Error
Um ou mais registros de erro a resolver.  Se nenhum parâmetro for especificado, todos os erros na sessão serão resolvidos.
