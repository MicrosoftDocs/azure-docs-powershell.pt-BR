...
## DESCRIPTION
Remove uma assinatura de evento grade de eventos do Azure para um tópico grade de eventos do Azure, um recurso, uma assinatura do Azure ou um grupo de recursos.
...
Remove a assinatura do evento EventSubscription1 para um tópico da Grade de Eventos do Azure1 no grupo de recursos \` \` \` \` \` MyResourceGroupName \` .
...
Remove a assinatura de evento \` EventSubscription1 \` para um grupo de recursos \` MyResourceGroupName \` .
...
Remove a assinatura de evento \` EventSubscription1 \` para um namespace do Hub de Eventos.
...
Remove a assinatura do \` evento EventSubscription1 \` para um Tópico de Grade de Eventos.
...
### -PassThru
Retorna o status da operação Remover. Por padrão, esse cmdlet não gera nenhuma saída.
