...
Remove o Tópico de Domínio da Grade de Eventos1 em Domínio de Domínio1 no grupo de recursos \` \` \` \` \` MyResourceGroupName \` .
...
### -ResourceId
Identificador de Recurso que representa o Tópico de Domínio da Grade de Eventos.
