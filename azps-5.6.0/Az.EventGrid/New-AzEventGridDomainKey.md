...
Regenerar a chave correspondente à chave chave1'\ do domínio de Grade de Eventos1 no grupo de recursos \' \` \` \` MyResourceGroupName \` .
...
Regenerar a chave correspondente à chave chave2'\ do domínio de Grade de Eventos1 no grupo de recursos \' \` \` \` MyResourceGroupName usando sua ID de recurso \` completa.
