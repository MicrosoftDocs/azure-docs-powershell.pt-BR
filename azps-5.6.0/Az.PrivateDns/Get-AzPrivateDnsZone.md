...
## DESCRIPTION
O cmdlet **Get-AzPrivateDnsZone** obtém uma zona DNS do grupo de recursos especificado.
...
Você pode usar o **objeto PrivateDnsZone** para atualizar a zona, por exemplo, você pode adicionar **objetos RecordSet** a ela.
...
Este exemplo obtém todas as zonas DNS privadas no grupo de recursos especificado e armazena-as na variável $Zones privada.
...
### -Name
Especifica o nome da zona DNS privada a ser obter.
Se você não especificar um valor para o parâmetro *Name,* esse cmdlet obtém todas as zonas DNS privadas no grupo de recursos especificado.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém a zona DNS privada a ser obter.
