...
## DESCRIPTION
O cmdlet **New-AzPrivateDnsZone** cria uma nova zona DNS (Sistema de Nomes de Domínio) privada no grupo de recursos especificado. Você deve especificar um nome de zona DNS particular exclusivo para o parâmetro *Name* ou o cmdlet retornará um erro. Depois que a zona for criada, use o cmdlet New-AzPrivateDnsRecordSet para criar conjuntos de registros na zona.
