...
As marcas são representadas como uma hashtable em linha.

### Exemplo 2: Atualizar marcas do Painel usando o pipeline
```powershell
...
Atualize as Marcas em um Painel que foi recuperada usando Get-AzPortalDashboard.
Isso pode ser usado para atualizar as marcas em um único painel ou vários dashboardfs.
