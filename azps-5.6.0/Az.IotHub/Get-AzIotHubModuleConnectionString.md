...
## SYNOPSIS
Obter a cadeia de conexão de um módulo de dispositivo IoT de destino em um Hub de Iot.
...
## DESCRIPTION
Listar cadeia de conexão de todos os módulos ou um módulo especificado de um dispositivo de IoT de destino contido em um Hub do Azure IoT.
...
Mostrar todas as cadeias de conexão de módulos de um dispositivo IoT de destino em um Hub de Iot.
...
Obter a cadeia de conexão de módulo secundário de um dispositivo IoT de destino em um Hub de Iot.
...
### -KeyType
Tipo de chave de política de acesso compartilhado para auth.
