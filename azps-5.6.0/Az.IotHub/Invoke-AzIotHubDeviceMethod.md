...
## DESCRIPTION
Invocar um método direto em um dispositivo. Confira https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods mais informações.
...
### -Name
O nome do método a ser invocado neste dispositivo.
...
### -Carga
A carga do método a ser invocado neste dispositivo.
