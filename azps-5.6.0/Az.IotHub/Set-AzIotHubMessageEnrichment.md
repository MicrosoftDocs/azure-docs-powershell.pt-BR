...
## SYNOPSIS
Atualize um enriquecimento de mensagens em seu hub de IoT.
...
Atualiza o valor do enriquecimento como "updatedValue" para a chave "newKey".
Para uma explicação detalhada dos enriquecimentos de mensagens no Hub do Azure IoT, consulte https://docs.microsoft.com/azure/iot-hub/iot-hub-message-enrichments-overview
...
Atualiza o ponto de extremidade do enriquecimento para "endpoint1, endpoint2, endpoint3" para a chave "newKey".
Para uma explicação detalhada dos enriquecimentos de mensagens no Hub do Azure IoT, consulte https://docs.microsoft.com/azure/iot-hub/iot-hub-message-enrichments-overview
