...
Isso exportará todos os dispositivos para o contêiner especificado. Consulte o artigo a seguir sobre como gerar o URI do SAS.
https://docs.microsoft.com/azure/iot-hub/iot-hub-bulk-identity-mgmt#get-the-container-sas-uri .

## EXEMPLOS

### Exemplo 1 Emitir uma solicitação de dispositivo de exportação.
```
...
### -ExcludeKeys
Permite exportar dispositivos sem chaves.
...
O Uri para o que exportar o blob. 
