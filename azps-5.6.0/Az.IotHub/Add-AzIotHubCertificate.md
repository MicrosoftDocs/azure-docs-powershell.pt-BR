...
## SYNOPSIS
Criar/atualizar um certificado do Hub IoT do Azure.
...
Carrega um arquivo CER de certificado da CA em um hub de IoT. 
...
Atualiza um certificado ca em um hub IoT carregando um novo arquivo CER. 
