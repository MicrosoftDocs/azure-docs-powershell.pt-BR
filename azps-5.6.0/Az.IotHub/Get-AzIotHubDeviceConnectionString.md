...
## SYNOPSIS
Obter a cadeia de conexão de um dispositivo de IoT de destino em um Hub de Iot.
...
Mostrar todas as cadeias de conexão de dispositivos em um Hub de Iot.
...
Obter a cadeia de caracteres de conexão secundária de um dispositivo IoT.
