...
## SYNOPSIS
Lista todos os dispositivos ou um dispositivo específico contido em um Hub IoT do Azure. 
...
## DESCRIPTION
Obter os detalhes de um dispositivo de Hub de Iot ou listar todos os dispositivos em um Hub de Iot.
...
Mostrar todos os dispositivos em um Hub de Iot.
...
Obter os detalhes de um dispositivo IoT Hub.
