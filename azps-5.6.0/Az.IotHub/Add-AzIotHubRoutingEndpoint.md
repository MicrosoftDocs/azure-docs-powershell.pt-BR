...
## DESCRIPTION
Adicione um novo ponto de extremidade em seu Hub de IoT. Para saber mais sobre os pontos de extremidade com suporte, consulte https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-endpoints
...
Adicione um novo ponto de extremidade "E2" do tipo EventHub a um Hub de IoT "myiothub".
...
Adicione um novo ponto de extremidade "S1" do tipo AzureStorageContainer a um Hub de IoT "myiothub".
...
Grupo de recursos do recurso Endpoint
...
SubscriptionId do recurso Endpoint
