...
Obter todos os pontos de extremidade do Hub de IoT "myiothub".
...
Obter todos os pontos de extremidade do tipo EventHub do Hub de IoT "myiothub". 
...
Obter informações de ponto de extremidade do Hub de IoT "myiothub".
