...
## SYNOPSIS
Consultar um Hub de IoT usando um idioma SQL de uso eficiente.
...
## DESCRIPTION
Consultar um Hub de IoT usando um idioma SQL de usuário poderoso para recuperar informações sobre os modelos de dispositivo e módulo, trabalhos e roteamento de mensagens.
Confira https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language mais informações.
...
Consultar todos os dados duplos do dispositivo em um Hub do Azure IoT.
...
Consultar dados duplos do módulo 2 principais em um dispositivo de destino.
