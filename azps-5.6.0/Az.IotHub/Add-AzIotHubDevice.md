...
## DESCRIPTION
Crie um dispositivo com tipo de autorização diferente em um Hub de IoT.
...
Crie um dispositivo IoT com autorização de AC raiz com status e motivo desabilitados.
