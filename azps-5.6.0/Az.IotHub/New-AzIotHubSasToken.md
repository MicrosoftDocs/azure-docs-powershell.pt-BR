...
## DESCRIPTION
Para tokens SAS de dispositivo, o parâmetro de política é usado apenas para acessar o registro do dispositivo. Portanto, a política deve ter acesso de leitura ao Registro.
Para tokens de Hub de IoT, a política faz parte do SAS.
