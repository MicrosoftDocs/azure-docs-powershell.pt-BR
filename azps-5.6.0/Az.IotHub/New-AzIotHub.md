...
Cria um novo IotHub chamado "myiothub" do sku "S1", capacidade 1 e local "northeurope" incluído com Marcas.

### Exemplo 2 Criar um novo IotHub com MaxDeliveryCount da Fila CloudToDevice definida como 20
```
PS C:\> New-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -SkuName "S1" -Units 1 -Location "northeurope" -Properties $properties
```

Cria um novo IotHub chamado "myiothub" do sku "S1", capacidade 1 e local "northeurope" com propriedades de entrada avançadas representadas por $properties.
...
### -Tag
Marcas de instância do hub IoT. Bolsa de propriedades em pares de valores-chave na forma de uma tabela de hash.
