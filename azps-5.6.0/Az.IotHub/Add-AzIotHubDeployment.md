...
## SYNOPSIS
Adicione uma implantação de Borda de IoT em um Hub de IoT de destino.
...
Crie uma implantação de Borda com uma prioridade 3 que se aplica na condição quando um dispositivo é marcado no edifício 9 e o ambiente é 'test'.
...
### -ModulesContent
Conteúdo de implantação de módulos para dispositivos de Borda de IoT.
