...
## SYNOPSIS
Gere uma chave do Hub do Azure IoT.
...
### Exemplo 1 Regenerar chave primária
```
...
Chave primária regenerada para a política de autorização "testKey" de um hub de iot do azure.

### Exemplo 2 Teclas de troca
```
...
Trocar chaves pela política de autorização "testKey" de um hub de iot do azure.
