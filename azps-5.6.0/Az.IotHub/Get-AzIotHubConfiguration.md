...
## SYNOPSIS
Lista toda ou uma configuração específica de gerenciamento automático de dispositivoSoT.
...
## DESCRIPTION
Obter os detalhes de uma configuração de gerenciamento automático de dispositivo IoT ou listar configurações de gerenciamento automático de dispositivo IoT em um Hub de IoT.
...
Obter os detalhes de uma configuração de gerenciamento automático de dispositivoSoT.
...
Listar configurações de gerenciamento automático de dispositivoSoT em um Hub de IoT.
