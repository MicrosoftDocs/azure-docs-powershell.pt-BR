...
## DESCRIPTION
Adicione até 10 enriquecimentos de mensagens por Hub de IoT. Elas são adicionadas como propriedades de aplicativo a mensagens enviadas para os pontos de extremidade escolhidos.
Para saber mais, confira https://docs.microsoft.com/azure/iot-hub/iot-hub-message-enrichments-overview
...
Adicione um novo enriquecimento com a chave "newKey" e o valor "newValue". Esse novo enriquecimento é aplicado aos pontos de extremidade "endpoint1" e "endpoint2".
