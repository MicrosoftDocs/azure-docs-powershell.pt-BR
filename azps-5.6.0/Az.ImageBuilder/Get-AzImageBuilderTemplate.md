...
Este comando lista todos os modelos em uma assinatura.
...
Este comando lista todos os modelos em um grupo de recursos.
...
Este comando obtém um modelo em um grupo de recursos.
