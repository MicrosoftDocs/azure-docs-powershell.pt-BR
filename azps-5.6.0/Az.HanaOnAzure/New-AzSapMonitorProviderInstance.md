...
Este comando cria uma instância do monitor SAP por cadeia de caracteres para HANA.

### Exemplo 2: Criar uma instância do monitor SAP por cofre de chaves para HANA
```powershell
...
Este comando cria uma instância do monitor SAP por cofre de chaves para HANA.

### Exemplo 3: Criar uma instância do monitor SAP por dicionário para PrometheusHaCluster
```powershell
...
Este comando cria uma instância do monitor SAP por dicionário para PrometheusHaCluster.

### Exemplo 4: Criar uma instância do monitor SAP por dicionário para PrometheusOS
```powershell
...
Este comando cria uma instância do monitor SAP por dicionário para PrometheusOS.

### Exemplo 5: Criar uma instância do monitor SAP por dicionário para MsSqlServer
```powershell
...
Este comando cria uma instância do monitor SAP por dicionário para MsSqlServer.

### Exemplo 6: Criar uma instância do monitor SAP por dicionário para SapHana
```powershell
...
Este comando cria uma instância do monitor SAP por dicionário para SapHana.
...
### -HanaDatabaseName
O nome do banco de dados da instância SAP HANA.
...
A senha do banco de dados da instância SAP HANA.
...
ID de recurso do Cofre de Chaves que contém as credenciais HANA.
...
Identificador secreto do segredo do Cofre de Chaves que contém as credenciais HANA.
...
### -HanaDatabaseSqlPort
A SQL do banco de dados da instância DO SAP HANA.
...
O nome de usuário do banco de dados da instância SAP HANA.
...
### -InstanceProperty
A propriedade da instância HANA.
...
Os valores suportados são: "SapHana".
