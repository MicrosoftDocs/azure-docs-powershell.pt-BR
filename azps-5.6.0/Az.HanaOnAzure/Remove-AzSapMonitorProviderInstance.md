...
### Exemplo 1: Remover instância do monitor SAP pelo nome
```powershell
PS C:\> Remove-AzSapMonitorProviderInstance -ResourceGroupName nancyc-hn1 -SapMonitorName ps-spamonitor-t01 -Name ps-sapmonitorins-t02

```

Este comando remove a instância do monitor SAP pelo nome.
...
Este comando remove a instância do monitor SAP por objeto.
