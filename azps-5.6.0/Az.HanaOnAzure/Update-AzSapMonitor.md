...
## SYNOPSIS
Remenda o campo Marcas de um monitor SAP para a assinatura especificada, o grupo de recursos e o nome do monitor.
...
### Exemplo 1: Atualizar um monitor SAP pelo nome
```powershell
...
Esse comandos atualiza um monitor SAP pelo nome.

### Exemplo 2: atualizar um monitor SAP por objeto
```powershell
...
Esse comandos atualiza um monitor SAP por objeto.
