...
## DESCRIPTION
O cmdlet **New-AzPowerBIWorkspaceCollection** cria uma coleção de espaços de trabalho do Power BI para sua assinatura do Azure no grupo de recursos especificado e no local.

## EXEMPLOS

### Exemplo 1: Criar uma coleção de espaços de trabalho
```
...
Este comando cria uma coleção de espaços de trabalho chamada WCN11 no grupo de recursos especificado no local especificado.
...
### -Location
Especifica o local do Azure no qual este cmdlet cria uma coleção de espaços de trabalho.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos no qual esse cmdlet cria uma coleção de espaços de trabalho.
