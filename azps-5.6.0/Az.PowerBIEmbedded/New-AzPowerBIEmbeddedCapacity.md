...
## DESCRIPTION
O New-AzPowerBIEmbeddedCapacity cmdlet cria uma nova Capacidade Incorporada do PowerBI
...
Cria uma capacidade denominada testcapacity na região centro-oeste dos EUA do Azure e no testRG do grupo de recursos. O nível sku da capacidade será A1.
