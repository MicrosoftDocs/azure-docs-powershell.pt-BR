...
## DESCRIPTION
O cmdlet **Remove-AzPowerBIWorkspaceCollection** remove uma coleção de espaços de trabalho do Power BI da sua assinatura do Azure e do grupo de recursos.

## EXEMPLOS

### Exemplo 1: Remover uma coleção de espaços de trabalho
```
PS C:\>Remove-AzPowerBIWorkspaceCollection -ResourceGroupName "ResourceGroup17" -WorkspaceCollectionName "WCN11"
```

Este comando remove a coleção de espaços de trabalho chamada WCN11 no grupo de recursos especificado.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos do qual este cmdlet remove uma coleção de espaços de trabalho.
...
Especifica o nome da coleção de espaços de trabalho power BI que este cmdlet remove.
