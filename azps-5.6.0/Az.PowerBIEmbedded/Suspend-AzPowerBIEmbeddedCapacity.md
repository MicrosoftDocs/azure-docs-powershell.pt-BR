...
## DESCRIPTION
O cmdlet Suspend-AzPowerBIEmbeddedCapacity suspende uma instância da Capacidade Incorporada do PowerBI
...
Este comando suspenderá uma capacidade ativa chamada testcapacity no grupo de recursos testgroup
