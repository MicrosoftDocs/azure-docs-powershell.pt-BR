...
## DESCRIPTION
O cmdlet **Get-AzPowerBIWorkspaceCollectionAccessKey** obtém as chaves de acesso atuais associadas a uma coleção de espaços de trabalho do Power BI.

## EXEMPLOS

### Exemplo 1: Obter chaves de acesso
```
PS C:\>Get-AzPowerBIWorkspaceCollectionAccessKey -ResourceGroupName "ResourceGroup17" -WorkspaceCollectionName "WCN11"
```

Este comando obtém chaves de acesso para a coleção de espaços de trabalho chamada WCN11 no grupo de recursos especificado.
