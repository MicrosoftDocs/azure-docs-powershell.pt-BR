...
### Exemplo 1: Remover um Cache da Empresa Redis e retornar o resultado
```powershell
PS C:\> Remove-AzRedisEnterpriseCache -Name "MyCache" -ResourceGroupName "MyGroup" -PassThru
True
```

Este comando remove um Cache da Empresa Redis e exibe se a operação foi bem-sucedida.

### Exemplo 2: Remover um Cache da Empresa Redis e não exibir o resultado
```powershell
PS C:\> Remove-AzRedisEnterpriseCache -Name "MyCache" -ResourceGroupName "MyGroup"
```

Este comando remove um Cache da Empresa Redis.
