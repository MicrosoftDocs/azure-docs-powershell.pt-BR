...
Este comando importa um arquivo de banco de dados para o banco de dados do Cache da Empresa Redis chamado MyCache.

### Exemplo 2: Importar banco de dados (usando nome de arquivo de exemplo)
```powershell
#[SuppressMessage("Microsoft.Security", "CS002:SecretInNextLine", Justification="Invalid SAS token")]
