...
Este comando exporta o banco de dados do Cache corporativo Redis chamado MyCache para um arquivo de banco de dados.
...
### -SasUri
SAS Uri para o diretório de destino a ser exportado para
