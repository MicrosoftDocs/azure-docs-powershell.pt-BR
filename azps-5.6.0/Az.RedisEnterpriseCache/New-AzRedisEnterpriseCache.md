...
### Exemplo 1: Criar um Cache da Empresa Redis
```powershell
...
Este comando cria um Cache da Empresa Redis chamado MyCache.
...
Este comando cria um Cache Corporativo Redis chamado MyCache usando alguns parâmetros opcionais.
...
O padrão é 2 ou 3, dependendo do SKU.
