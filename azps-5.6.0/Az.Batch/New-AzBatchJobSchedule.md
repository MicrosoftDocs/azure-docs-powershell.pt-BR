...
## SYNOPSIS
Cria um cronograma de trabalho no serviço Batch.
...
## DESCRIPTION
O cmdlet **New-AzBatchJobSchedule** cria um cronograma de trabalho no serviço Lote do Azure.
O *parâmetro BatchAccountContext* especifica a conta na qual esse cmdlet cria a agenda.
...
Os comandos armazenam esses objetos nas $Schedule e $JobSpecification variáveis.
...
### -JobSpecification
Especifica os detalhes dos trabalhos que esse cmdlet inclui na agenda do trabalho.
