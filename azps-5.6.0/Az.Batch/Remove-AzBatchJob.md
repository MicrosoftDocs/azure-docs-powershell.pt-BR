...
## DESCRIPTION
O cmdlet **Remove-AzBatchJob** exclui um trabalho do Lote do Azure.
Este cmdlet solicita a confirmação antes de remover um trabalho, a menos que você especifique o *parâmetro Force.*
...
Este comando exclui o trabalho que tem a ID Job-000001.
...
Este comando obtém o trabalho que tem a ID Job-000002 usando o cmdlet Get-AzBatchJob.
...
### -Id
Especifica a ID do trabalho que esse cmdlet exclui.
