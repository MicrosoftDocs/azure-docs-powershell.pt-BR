...
## DESCRIPTION
O cmdlet **Set-AzBatchJob** atualiza um trabalho do Lote do Azure.
...
O primeiro comando obtém um trabalho usando **Get-AzBatchJob** e o armazena na variável $Job.
O segundo comando modifica a especificação de prioridade no objeto $Job.
O comando final atualiza o serviço Batch para corresponder ao objeto local no $Job.
...
### -Job
Especifica um **PSCloudJob** ao qual este cmdlet atualiza o serviço Batch.
