...
## DESCRIPTION
O cmdlet **Remove-AzBatchTask** exclui uma tarefa do Lote do Azure.
Este cmdlet solicita a confirmação, a menos que você especifique o *parâmetro Force.*
...
Este comando exclui uma tarefa que tem a ID Task23 no trabalho que tem a ID Job-000001.
...
Este comando obtém a tarefa Batch que tem a ID Task26 no trabalho que tem a ID Job-000001 usando o cmdlet **Get-AzBatchTask.**
...
### -Id
Especifica a ID da tarefa que esse cmdlet exclui.
...
### -InputObject
Especifica a tarefa que esse cmdlet exclui.
