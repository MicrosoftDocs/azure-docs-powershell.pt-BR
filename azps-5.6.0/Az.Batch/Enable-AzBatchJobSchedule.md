...
## DESCRIPTION
O cmdlet **Enable-AzBatchJobSchedule** habilita um cronograma de trabalho do Lote do Azure.
...
Esse comando habilita o cronograma de trabalho que tem a ID JobSchedule17.
