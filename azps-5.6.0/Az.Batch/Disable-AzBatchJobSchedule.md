...
## SYNOPSIS
Desabilita um cronograma de trabalho em lotes.
...
## DESCRIPTION
O cmdlet **Disable-AzBatchJobSchedule** desabilita um cronograma de trabalho do Lote do Azure.
Se você desabilitar um cronograma, os trabalhos não serão criados de acordo com esse cronograma.
Você pode habilitar uma agenda desabilitada posteriormente.

## EXEMPLOS

### Exemplo 1: Desabilitar um agendamento de trabalho
```
PS C:\>Disable-AzBatchJobSchedule -Id "JobSchedule17" -BatchContext $Context
```

Este comando desabilita o agendamento de trabalho que tem a ID JobSchedule17.
...
### -Id
Especifica a ID do cronograma de trabalho que esse cmdlet desabilita.
