...
## DESCRIPTION
O cmdlet **Set-AzBatchPool** atualiza as propriedades de um pool no serviço batch do Azure.
...
O primeiro comando obtém um pool usando **Get-AzBatchPool** e o armazena na variável $Pool.
Os três comandos a seguir modificam a especificação da tarefa inicial no $Pool objeto.
O comando final atualiza o serviço Batch para corresponder ao objeto local $Pool.
...
### -Pool
Especifica o **PSCloudPool** ao qual este cmdlet atualiza o serviço Batch.
