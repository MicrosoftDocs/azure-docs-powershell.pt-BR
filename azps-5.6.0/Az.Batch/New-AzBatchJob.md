...
O comando final cria um trabalho que tem a ID ContosoJob35.
...
A chave é o nome da variável do ambiente.
...
### -JobManagerTask
Especifica a tarefa do Gerenciador de Trabalho.
O serviço Batch executa a tarefa Gerenciador de Trabalho quando o trabalho é iniciado.
...
O serviço Batch executa a tarefa Preparação do Trabalho em um nó de computação antes de iniciar qualquer tarefa desse trabalho nesse nó de computação.
...
### -JobReleaseTask
Especifica a tarefa Liberação de Trabalho.
O serviço Batch executa a tarefa Liberação de Trabalho quando o trabalho termina.
O serviço Batch executa a tarefa Liberar Trabalho em cada nó de computação onde ele executa qualquer tarefa do trabalho.
...
### -OnAllTasksComplete
Especifica uma ação que o serviço Batch realizará se todas as tarefas do trabalho estão no estado concluído.
...
### -OnTaskFailure
Especifica uma ação que o serviço Batch assume se qualquer tarefa no trabalho falhar.
...
### -PoolInformation
Especifica os detalhes do pool no qual o serviço Batch executa as tarefas do trabalho.
