...
## DESCRIPTION
O cmdlet **Get-AzBatchApplication** obtém informações sobre um aplicativo em uma conta do Lote do Azure.

## EXEMPLOS

### Exemplo 1: Exibir os aplicativos em uma conta batch
```
...
Este comando exibe todos os aplicativos na conta ContosoBatch.

## PARÂMETROS

### -AccountName
Especifica o nome da conta Batch que contém o aplicativo.
