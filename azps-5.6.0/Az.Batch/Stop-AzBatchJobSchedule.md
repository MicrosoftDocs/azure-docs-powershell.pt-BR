...
## DESCRIPTION
O cmdlet **Stop-AzBatchJobSchedule** interrompe um cronograma de trabalho do Lote do Azure.

## EXEMPLOS

### Exemplo 1: Interromper um agendamento de trabalho
```
PS C:\>Stop-AzBatchJobSchedule -Id "JobSchedule17" -BatchContext $Context
```

Este comando interrompe o cronograma de trabalho que tem a ID JobSchedule17.
...
### -Id
Especifica a ID do cronograma de trabalho que este cmdlet interrompe.
