...
## DESCRIPTION
O cmdlet **New-AzBatchComputeNodeUser** cria uma conta de usuário em um nó de computação do Lote do Azure.
...
Este comando cria uma conta de usuário no nó de computação que tem a ID ComputeNode01.
...
Este comando obtém o nó de computação chamado ComputeNode01 usando o cmdlet **Get-AzBatchComputeNode.**
...
O comando cria uma conta de usuário que tem o nome de usuário TestUser e a senha Password.
