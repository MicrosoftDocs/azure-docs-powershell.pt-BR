...
## SYNOPSIS
Obtém imagens com suporte em lote para uma conta Batch.
...
## DESCRIPTION
O cmdlet **Get-AzBatchSupportedImage** obtém imagens de máquina virtual com suporte que estão disponíveis em uma conta do Lote do Azure.
...
O primeiro comando obtém um contexto de conta batch que contém chaves de acesso para sua assinatura usando **Get-AzBatchAccountKey**.
O comando armazena o contexto na variável $Context a ser usada no próximo comando.
O segundo comando obtém todas as imagens com suporte disponíveis para essa conta batch.
...
Se você não especificar um filtro, este cmdlet retornará todas as imagens com as quais a conta Batch oferece suporte.
