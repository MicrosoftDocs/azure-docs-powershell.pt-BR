...
## DESCRIPTION
O cmdlet **New-AzBatchAccount** cria uma conta do Lote do Azure para o grupo de recursos especificado e o local.
...
Este comando cria uma conta Batch chamada pfuller usando o grupo de recursos ResourceGroup03 no local do Oeste dos EUA.

### Exemplo 2

Cria uma conta Batch. (gerado automaticamente)
...
### -AccountName
Especifica o nome da conta Batch que este cmdlet cria.
Os nomes de contas em lotes devem ter entre 3 e 24 caracteres e conter apenas números e letras minúsculas.
...
Especifica a ID de recurso da conta de armazenamento a ser usada para armazenamento automático.
...
### -KeyVaultUrl
A URL do cofre de chaves do Azure associada à conta Batch.
...
### -Location
Especifica a região onde esse cmdlet cria a conta.
...
### -PoolAllocationMode
O modo de alocação para criar pools na conta Batch.
...
### -PublicNetworkAccess
O tipo de acesso de rede pública
