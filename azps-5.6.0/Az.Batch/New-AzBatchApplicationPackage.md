...
## SYNOPSIS
Cria um pacote de aplicativos em uma conta Batch.
...
## DESCRIPTION
O cmdlet **New-AzBatchApplicationPackage** cria um pacote de aplicativos em uma conta do Lote do Azure.

## EXEMPLOS

### Exemplo 1: Instalar um pacote de aplicativos em uma conta batch
```
...
Este comando cria e ativa a versão 1.0 do aplicativo Litware e carrega o conteúdo do litware.1.0.zip como o conteúdo do pacote de aplicativos.

## PARÂMETROS

### -AccountName
Especifica o nome da conta Batch à qual este cmdlet adiciona um pacote de aplicativos.
