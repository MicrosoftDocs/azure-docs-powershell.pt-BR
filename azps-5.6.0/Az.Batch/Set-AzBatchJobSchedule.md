...
## DESCRIPTION
O cmdlet **Set-AzBatchJobSchedule** define um cronograma de trabalho no serviço batch do Azure.
...
O primeiro comando obtém um trabalho usando **Get-AzBatchJobSchedule** e o armazena na variável $JobSchedule.
O segundo comando modifica o intervalo de recorrência no `$JobSchedule.Schedule` objeto.
O comando final atualiza o serviço Batch para corresponder ao objeto local no $JobSchedule.
