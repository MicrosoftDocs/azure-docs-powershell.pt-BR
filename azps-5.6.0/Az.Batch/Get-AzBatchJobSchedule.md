...
## DESCRIPTION
O cmdlet **Get-AzBatchJobSchedule** obtém agendamentos de trabalho do Lote do Azure para a conta Batch especificada pelo parâmetro *BatchContext.*
Especifique uma ID para obter um único cronograma de trabalho.
*Especifique o parâmetro Filter* para obter os agendamentos de trabalho que corresponderem a um filtro OData (Protocolo de Dados Abertos).

## EXEMPLOS

### Exemplo 1: Obter um cronograma de trabalho especificando uma ID
```
...
Este comando obtém o cronograma de trabalho que tem a ID JobSchedule23.
Use o cmdlet Get-AzBatchAccountKey para atribuir um contexto à variável $Context.

### Exemplo 2: Obter agendamentos de trabalho usando um filtro
```
...
Esse comando obtém todos os agendamentos de trabalho com IDs que começam com Job especificando o *parâmetro Filter.*
...
Este cmdlet retorna cronogramas de trabalho que corresponderem ao filtro especificado por esse parâmetro.
Se você não especificar um filtro, este cmdlet retornará todos os agendamentos de trabalho para o contexto Batch.
...
### -Id
Especifica a ID do cronograma de trabalho que este cmdlet obtém.
...
### -MaxCount
Especifica o número máximo de agendamentos de trabalho a retornar.
