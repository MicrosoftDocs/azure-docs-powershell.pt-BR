...
## DESCRIPTION
O cmdlet **Remove-AzBatchPool** exclui o pool especificado do Lote do Azure.
...
Este comando exclui o pool com a ID MyPool.
O usuário é solicitado a confirmar antes da operação de exclusão.

### Exemplo 2: Excluir todos os pools em lotes à força
```
PS C:\>Get-AzBatchPool -BatchContext $Context | Remove-AzBatchPool -Force -BatchContext $Context
```

Este comando exclui todos os pools batch.
