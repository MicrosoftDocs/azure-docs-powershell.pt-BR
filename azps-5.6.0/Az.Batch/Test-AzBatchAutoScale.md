...
## DESCRIPTION
O cmdlet **Test-AzBatchAutoScale** obtém o resultado de uma fórmula de dimensionamento automática no pool especificado.

## EXEMPLOS

### Exemplo 1: Avaliar uma fórmula de escala automática em um pool
```
...
O segundo comando avalia a fórmula de escala automática no pool que tem a ID ContosoPool.
O comando final exibe os **Resultados usando** a sintaxe de ponto padrão.
...
### -Id
Especifica a ID do objeto do pool para o qual testar o dimensionamento automático.
