...
Este comando reimaima o nó de computação com a ID "tvm-3257026573_2-20150813t200938z" no pool chamado MyPool.
...
Esse comando reimaja cada nó de computação no pool chamado MyPool.
...
### -ComputeNode
Especifica o **objeto PSComputeNode** que representa o nó de computação para reimage.
...
### -Id
Especifica a ID do nó de computação a ser reimage.
