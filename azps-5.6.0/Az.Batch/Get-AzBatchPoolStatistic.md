...
## SYNOPSIS
Obtém estatísticas de resumo de pool para uma conta batch.
...
## DESCRIPTION
O cmdlet **Get-AzBatchPoolStatistic** obtém as estatísticas de vida útil de todos os pools na conta especificada.
As estatísticas são agregadas em todos os pools que já existiram na conta, desde a criação da conta até a última atualização das estatísticas.
