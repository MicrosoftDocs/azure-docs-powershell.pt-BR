...
## SYNOPSIS
Obtém os certificados em uma conta Batch.
...
## DESCRIPTION
O cmdlet **Get-AzBatchCertificate** obtém os certificados na conta batch do Azure que o parâmetro *BatchContext* especifica.
Para obter um certificado específico, especifique os *parâmetros ThumbprintAlgorithm* e *Thumbprint.*
*Especifique o parâmetro Filter* para obter os certificados que corresponderem a um filtro OData (Protocolo de Dados Abertos).
...
Este comando obtém um único certificado que tem a impressão digital especificada.
...
Este comando obtém todos os certificados no estado ativo da conta Batch.
...
Se você especificar esse parâmetro, esse cmdlet obtém os certificados que corresponderem ao filtro.
...
### -MaxCount
Especifica o número máximo de certificados a ser retornado.
