...
Você pode usar o *parâmetro Filter* para obter os trabalhos que corresponderem a um filtro OData (Protocolo de Dados Abertos).
Se você fornecer uma ID de agendamento de trabalho ou uma instância **PSCloudJobSchedule,** este cmdlet retornará apenas os trabalhos desse cronograma de trabalho.
...
Este comando obtém o trabalho que tem a ID Job01.
...
Este comando obtém os trabalhos ativos para o cronograma de trabalho que tem a ID JobSchedule27.

### Exemplo 3: obtém todos os trabalhos em um cronograma de trabalho usando o pipeline
```
...
Este comando obtém o cronograma de trabalho que tem a ID JobSchedule27 usando o cmdlet Get-AzBatchJobSchedule ID.
...
Se você não especificar um filtro, este cmdlet retornará todos os trabalhos para a conta batch ou agenda de trabalho.
