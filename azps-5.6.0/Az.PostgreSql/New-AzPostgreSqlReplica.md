...
### Exemplo 1: Criar uma nova réplica de servidor PostgreSql
```powershell
...
Este cmdlet cria uma nova réplica de servidor PostgreSql.

### Exemplo 2: Criar uma nova réplica de servidor PostgreSql
```powershell
...
### -Master
O objeto do servidor de origem do que criar réplica.
...
MASTER <IServer> : O objeto do servidor de origem para criar réplica.
