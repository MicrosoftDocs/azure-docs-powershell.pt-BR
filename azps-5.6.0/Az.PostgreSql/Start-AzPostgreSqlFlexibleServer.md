...
### Exemplo 1: Iniciar o servidor pelo nome do recurso
```powershell
PS C:\> Start-AzPostgreSqlFlexibleServer -ResourceGroupName PowershellPostgreSqlTest -Name postgresql-test
```

Iniciar o servidor pelo nome

### Exemplo 2: Iniciar o servidor por identidade
```powershell
...
Iniciar o servidor por identidade
