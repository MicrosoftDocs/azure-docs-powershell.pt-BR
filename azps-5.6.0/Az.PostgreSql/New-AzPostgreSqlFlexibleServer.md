...
Este cmdlet cria servidor flexível PostgreSql com valores de parâmetro padrão e provisiona o servidor dentro de uma nova rede virtual e tem uma sub-rede delegada ao servidor.
Os valores padrão de localização são West US 2, Sku é Standard_D2s_v3, camada Sku é GeneralPurpose e tamanho de armazenamento é 128GiB.
...
Este cmdlet cria servidor flexível PostgreSql com id de vnet ou nome de vnet fornecido por um usuário.
Se a rede virtual não existir, o cmdlet criará uma.

### Exemplo 4: Criar um novo servidor flexível PostgreSql com rede virtual e nome de sub-rede
```powershell
...
Este cmdlet cria servidor flexível PostgreSql com nome de vnet, nome de sub-rede, prefixo de vnet e prefixo de sub-rede.
...
Este cmdlet cria o servidor flexível PostgreSql aberto para todos os endereços IP.
...
Este cmdlet cria o servidor flexível PostgreSql aberto para endereços IP especificados.
