...
### Exemplo 1: Obter cadeia de conexão de servidor PostgreSql por grupo de recursos e nome do servidor
```powershell
...
Este cmdlet obtém cadeia de conexão de servidor PostgreSql por grupo de recursos e nome do servidor.
