...
### Exemplo 1: Atualizar a configuração postgreSql pelo nome
```powershell
...
Este cmdlet atualiza a configuração postgreSql pelo nome.

### Exemplo 2: Atualizar a configuração postgreSql por identidade.
```powershell
