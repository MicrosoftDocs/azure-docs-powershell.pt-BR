...
### Exemplo 1: Obter réplica de servidor PostgreSql por grupo de recursos e nome do servidor
```powershell
...
Este cmdlet obtém réplica de servidor PostgreSql por grupo de recursos e nome do servidor.
