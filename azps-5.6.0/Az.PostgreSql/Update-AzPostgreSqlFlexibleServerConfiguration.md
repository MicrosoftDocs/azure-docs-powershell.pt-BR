...
### Exemplo 1: Configuração de PostgreSql especificada por nome
```powershell
...
Este cmdlet atualiza a configuração de PostgreSql especificada pelo nome.

### Exemplo 1: Configuração de PostgreSql especificada por identidade
```powershell
...
Este cmdlet atualiza a configuração de PostgreSql especificada por identidade.
