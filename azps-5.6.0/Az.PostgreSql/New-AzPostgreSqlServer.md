...
### Exemplo 1: Criar um novo servidor PostgreSql
```powershell
...
Esses cmdlets criam um novo servidor PostgreSql.
...
Depois de definido, não é possível alterá-lo.
...
### -GeoRedundantBackup
Habilitar Geo-redundante ou não para backup do servidor.
