...
### Exemplo 1: Remover Regra de Rede Virtual do servidor PostgreSql pelo nome
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Este cmdlet remove a Regra de Rede Virtual do servidor PostgreSql pelo nome.

### Exemplo 2: Remover Regra de Rede Virtual do servidor PostgreSql por identidade
```powershell
