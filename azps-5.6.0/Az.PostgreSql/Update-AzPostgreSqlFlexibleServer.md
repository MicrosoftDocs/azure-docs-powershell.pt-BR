...
Use Update-AzPostSqlFlexibleServerConfiguration se quiser atualizar parâmetros de servidor, como wait_timeout ou net_retry_count.
...
### Exemplo 1: Atualizar servidor PostgreSql por grupo de recursos e nome do servidor
```powershell
...
### Exemplo 2: Atualizar servidor PostgreSql por identidade.
```powershell
...
### -Sku
O nome do sku, por exemplo, Burstable_B1ms, Standard_D2ds_v4
