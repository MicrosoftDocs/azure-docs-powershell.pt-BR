...
## SYNOPSIS
Crie ou atualize os metadados de um DigitalTwinsInstance.
O padrão comum para modificar uma propriedade é recuperar os metadados digitalTwinsInstance e segurança e combiná-los com os valores modificados em um novo corpo para atualizar o DigitalTwinsInstance.
...
### Exemplo 2: Criar um objeto AzDigitalTwinsInstance pelo objeto AzDigitalTwins.
```powershell
...
Criar um objeto AzDigitalTwinsInstance by AzDigitalTwins
...
Para construir, consulte a seção NOTES para propriedades DIGITALTWINSCREATE e crie uma tabela de hash.
...
DIGITALTWINSCREATE <IDigitalTwinsDescription> : A descrição do serviço DigitalTwins.
  ...
  - `[Tag <IDigitalTwinsResourceTags>]`: As marcas de recurso.
