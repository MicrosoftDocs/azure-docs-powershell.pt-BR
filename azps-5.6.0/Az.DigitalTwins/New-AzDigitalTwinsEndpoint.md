...
### Exemplo 1: Criar um AzDigitalTwinsEndpoint para Eventhub
```powershell
...
Criar um AzDigitalTwinsEndpoint para Eventhub por connectionStringPrimaryKey
...
Criar um AzDigitalTwinsEndpoint para Eventhub por TopicEndpoint e accessKey1

### Exemplo 3: Criar um AzDigitalTwinsEndpoint para ServiceBus
```powershell
...
### -DeadLetterSecret
Segredo de armazenamento de carta morta.
Será ofuscado durante a leitura.
...
Para construir, consulte a seção NOTES para propriedades ENDPOINTDESCRIPTION e crie uma tabela de hash.
...
### -EndpointType
O tipo de ponto de extremidade de Digital Twins
...
ENDPOINTDESCRIPTION : Recurso de ponto de extremidade <IDigitalTwinsEndpointResource> DigitalTwinsInstance.
  - `EndpointType <EndpointType>`: O tipo de ponto de extremidade do Digital Twins
  - `[DeadLetterSecret <String>]`: Segredo de armazenamento de carta morta. Será ofuscado durante a leitura.
