...
### Exemplo 1: Verifique o nome por local e nome.
```powershell
...
Verifique a disponibilidade do nome por local e nome.

### Exemplo 2: Verifique o nome por DigitalTwinsObject e CheckNameObject.
```powershell
...
Obter Um DigitalTwinsInstance e criar um Objeto Requset para testar a disponibilidade do nome.
...
Para construir, consulte a seção NOTES para propriedades DIGITALTWINSINSTANCECHECKNAME e crie uma tabela de hash.
...
DIGITALTWINSINSTANCECHECKNAME : o resultado retornado de uma solicitação de disponibilidade de nome de verificação <ICheckNameRequest> de banco de dados.
