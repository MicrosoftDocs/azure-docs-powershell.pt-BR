...
### Exemplo 1: Remover uma solução de análise de log de monitoramento pelo nome
```powershell
PS C:\> Remove-AzMonitorLogAnalyticsSolution  -ResourceGroupName azureps-manual-test -Name 'Containers(monitoringworkspace-2vob7n)'

```

Este comando remove uma solução de análise de log de monitoramento pelo nome.

### Exemplo 2: Remover uma solução de análise de log de monitoramento por objeto
```powershell
...
Este comando remove uma solução de análise de log de monitoramento por objeto.

### Exemplo 3: Remover uma solução de análise de log de monitoramento por pipeline
```powershell
PS C:\> $monitor = Get-AzMonitorLogAnalyticsSolution -ResourceGroupName azureps-manual-test -Name 'Containers(monitoringworkspace-asdehu)' | Remove-AzMonitorLogAnalyticsSolution

```

Este comando remove uma solução de análise de log de monitoramento por pipeline.
