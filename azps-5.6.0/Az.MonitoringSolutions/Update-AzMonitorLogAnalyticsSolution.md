...
### Exemplo 1: Atualizar uma solução de análise de log de monitoramento pelo nome
```powershell
...
Este comando atualiza uma solução de análise de log de monitoramento pelo nome.

### Exemplo 2: atualizar uma solução de análise de log de monitoramento por objeto
```powershell
...
Este comando atualiza uma solução de análise de log de monitoramento por objeto.
