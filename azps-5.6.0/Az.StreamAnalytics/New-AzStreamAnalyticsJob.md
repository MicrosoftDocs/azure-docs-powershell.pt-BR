...
Este comando cria um trabalho a partir da definição em JobDefinition.json.
...
Esse comando substitui a definição de trabalho para StreamingJob sem confirmação.
