...
## DESCRIPTION
O cmdlet **Remove-AzStreamAnalyticsInput** exclui de forma assíncrona uma entrada de um trabalho do Stream Analytics no Azure.
...
Este comando remove a entrada EventStream do StreamingJob.
...
### -Name
Especifica o nome da entrada do Azure Stream Analytics a ser removido.
