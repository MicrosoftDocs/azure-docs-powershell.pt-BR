...
## DESCRIPTION
O cmdlet **Get-AzCosmosDBSqlContainer** obtém a lista de todos os Contêineres Sql do CosmosDB existentes para um determinado ResourceGroupName, AccountName e DatabaseName e obtém um único Contêiner Sql do CosmosDB para um determinado ResourceGroupName, AccountName, DatabaseName e ContainerName.
