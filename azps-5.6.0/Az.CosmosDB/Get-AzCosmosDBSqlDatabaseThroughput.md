...
## SYNOPSIS
Obtém as configurações de transferência correspondentes a um Banco de Dados Sql do CosmosDB.
...
## DESCRIPTION
O cmdlet **Get-AzCosmosDBSqlDatabaseThroughput** obtém as configurações de transferência correspondentes a um Banco de Dados Sql do CosmosDB.
