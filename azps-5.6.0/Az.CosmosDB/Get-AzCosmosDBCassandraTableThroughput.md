...
## SYNOPSIS
Obtém o valor de produtividade da Tabela de Cassandra.
...
## DESCRIPTION
O cmdlet **Get-AzCosmosDBCassandraTableThroughput** obtém o objeto de transferência correspondente a um determinado Keyspace.
