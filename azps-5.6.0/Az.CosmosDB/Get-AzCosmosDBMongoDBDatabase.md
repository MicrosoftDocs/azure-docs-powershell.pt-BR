...
## SYNOPSIS
Obtém o banco de dados MongoDB do CosmosDB
...
## DESCRIPTION
O cmdlet **Get-AzCosmosDBMongoDBDatabase** obtém o Banco de Dados MongoDB do CosmosDB.
...
Objeto Resource contém _rid, _ts, _etag propriedades.
