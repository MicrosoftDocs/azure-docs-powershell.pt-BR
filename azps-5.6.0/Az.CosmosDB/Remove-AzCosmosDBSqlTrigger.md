...
## SYNOPSIS
Exclui o Gatilho Sql do CosmosDB.
...
## DESCRIPTION
O cmdlet **Remove-AzCosmosDBSqlTrigger** exclui o Gatilho Sql do CosmosDB correspondente ao ResourceGroupName, AccountName e DatabaseName.
