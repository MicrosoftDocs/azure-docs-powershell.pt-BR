...
## SYNOPSIS
Obtém as configurações de transferência correspondentes a um Contêiner Sql do CosmosDB.
...
## DESCRIPTION
O cmdlet **Get-AzCosmosDBSqlContainerThroughput** obtém as configurações de transferência correspondentes a um Contêiner Sql do CosmosDB. 
