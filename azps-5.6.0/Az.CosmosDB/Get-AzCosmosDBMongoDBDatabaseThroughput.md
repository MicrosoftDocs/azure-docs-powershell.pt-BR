...
## SYNOPSIS
Obtém as propriedades de transferência do CosmosDB do Banco de Dados MongoDB.
...
## DESCRIPTION
O cmdlet **Get-AzCosmosDBMongoDBDatabaseThroughput** obtém as propriedades de transferência do Banco de Dados MongoDB.
