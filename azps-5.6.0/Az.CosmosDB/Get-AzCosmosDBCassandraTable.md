...
## SYNOPSIS
Obtém uma Tabela de Cassandra do CosmosDB.
...
## DESCRIPTION
O cmdlet **Get-AzCosmosDBCassandraTable** cria um novo ou atualiza um Espaço-Chave existente do CosmosDB.
...
{{ Get-AzCosmosDBCassandraTable obtém as propriedades de uma CassandraKeyspace existente. Você pode expandir o Recurso para obter as propriedades DefaultTtl, Schema, _etag, _ts, _rid.}}
