...
## SYNOPSIS
Exclui o Sql StoredProcedure do CosmosDB.
...
## DESCRIPTION
O cmdlet **Remove-AzCosmosDBSqlStoredProcedure** exclui o CosmosDB Sql StoredProcedure correspondente ao ResourceGroupName, AccountName e DatabaseName determinado.
