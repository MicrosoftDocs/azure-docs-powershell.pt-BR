...
## SYNOPSIS
Atualiza o banco de dados MongoDB do CosmosDB. Executa uma operação de patch do lado do cliente lendo o Banco de Dados existente.
...
### -Throughput
A produtividade do banco de dados Mongo (RU/s).
