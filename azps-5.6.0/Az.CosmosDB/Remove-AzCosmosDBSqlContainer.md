...
## SYNOPSIS
Exclui o Contêiner Sql do CosmosDB.
...
## DESCRIPTION
O cmdlet **Remove-AzCosmosDBSqlContainer** exclui o Contêiner Sql do CosmosDB correspondente ao ResourceGroupName, AccountName, DatabaseName e ContainerName.
