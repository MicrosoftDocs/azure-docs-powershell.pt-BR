...
## SYNOPSIS
Obtém a produtividade de um Gráfico de Gremlin do CosmosDB.
...
## DESCRIPTION
O cmdlet **Get-AzCosmosDBGremlinGraphThroughput** obtém a produtividade de um Gráfico de Gremlin do CosmosDB.
