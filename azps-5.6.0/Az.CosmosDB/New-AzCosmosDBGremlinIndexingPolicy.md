...
## SYNOPSIS
Cria um novo objeto IndexingPolicy do CosmosDB.
...
## DESCRIPTION
O cmdlet **New-AzCosmosDBGremlinIndexingPolicy** cria um novo objeto do tipo PSIndexingPolicy.
...
### -CompositePath
Matriz de matriz de objetos do tipo Microsoft.Azure.Commands.CosmosDB.PSCompositePath
...
### -ExcludedPath
Matriz de cadeias de caracteres contendo excludedPath(Especifica um caminho dentro de um documento JSON a ser excluído no serviço db do Azure Cosmos.)  elementos.
...
### -IncludedPath
Matriz de cadeias de caracteres que contêm includedPath (Especifica um caminho dentro de um documento JSON a ser incluído nos elementos do serviço DB do Azure Cosmos.)
...
Os valores possíveis incluem: 'Consistente', 'Lazy', 'None'
