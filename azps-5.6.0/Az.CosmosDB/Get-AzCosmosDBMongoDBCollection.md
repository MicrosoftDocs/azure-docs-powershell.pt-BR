...
## SYNOPSIS
Obtém a coleção MongoDB do CosmosDB.
...
## DESCRIPTION
O cmdlet **Get-AzCosmosDBMongoDBCollection** obtém a Coleção MongoDB do CosmosDB.
...
Objeto Resource contém mongoIndexes, _rid, _ts, _etag propriedades.
