...
## SYNOPSIS
Obter Chaves{"ConnectionKeys", "PrimaryReadOnly" ou "Keys"} para a conta determinada do CosmosDB. 
...
Lista as chaves da Conta do CosmosDB. O Tipo de Chave pode ser o valor de : ConnectionStrings, Keys e ReadOnlyKeys. O padrão é Keys.
