...
## SYNOPSIS
Atualizar atributos de conta do CosmosDB.
...
## DESCRIPTION
Atualize as propriedades de uma conta do CosmosDB. Não é possível atualizar as Regiões de Conta de forma simulada com outras propriedades.
...
Atualizado DefaultConsistencyLevel para "Strong", Enabled AutomaticFailover, Enabled MultipleWriteLocations e Enabled VirtualNetwork for CosmosDB Account with name accountName. 
