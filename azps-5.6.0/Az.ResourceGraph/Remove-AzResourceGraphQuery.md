...
### Exemplo 1: Remover uma consulta de gráfico de recursos pelo nome
```powershell
PS C:\> Remove-AzResourceGraphQuery -ResourceGroupName azure-rg-test -Name query-t03

```

Este comando remove uma consulta de gráfico de recursos pelo nome.
...
Este comando remove uma consulta de gráfico de recursos por objeto.
...
### -Name
O nome do recurso Consulta do Graph.
...
INPUTOBJECT <IResourceGraphIdentity> : Parâmetro Identity
  - `[Id <String>]`: Caminho da identidade do recurso
  - `[ResourceGroupName <String>]`: O nome do grupo de recursos.
  - `[ResourceName <String>]`: O nome do recurso Consulta do Graph.
  - `[SubscriptionId <String>]`: A ID da assinatura do Azure.
