...
## SYNOPSIS
Crie uma nova consulta gráfica.
...
Este comando cria uma consulta de gráfico de recursos pelo parâmetro de consulta.

### Exemplo 2: Criar uma consulta de gráfico de recursos pelo parâmetro file
```powershell
...
Este comando cria uma consulta de gráfico de recursos pelo parâmetro file.
