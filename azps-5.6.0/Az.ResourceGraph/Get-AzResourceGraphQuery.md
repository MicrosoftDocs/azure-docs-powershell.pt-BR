...
## SYNOPSIS
Obter uma única consulta de gráfico pelo resourceName.
...
### Exemplo 1: Obter todas as consultas de gráfico de recursos em um grupo de recursos
```powershell
...
### Exemplo 2: Obter uma consulta de gráfico de recursos pelo nome
```powershell
...
Este comando obtém uma consulta de gráfico de recursos pelo nome.

### Exemplo 2: Obter uma consulta de gráfico de recursos por objeto
```powershell
...
Este comando obtém uma consulta de gráfico de recursos por objeto.
