...
## SYNOPSIS
Atualiza uma consulta gráfica que já foi adicionada.
...
### Exemplo 1: Atualizar a consulta de parâmetro e a marca por nome
```powershell
...
Este comando atualiza a consulta de parâmetro e marca por nome.
...
Este comando atualiza a consulta de parâmetro e a marca por objeto.
...
### -Description
A descrição de uma consulta gráfica.
