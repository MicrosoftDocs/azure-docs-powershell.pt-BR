...
## DESCRIPTION
O cmdlet **New-AzUserAssignedIdentity** cria uma nova Identidade Atribuída pelo Usuário. Quando usado com uma identidade já existente, atualizou a identidade.
Para adicionar marcas do Gerenciador de Recursos do Azure à identidade, use Set-AzResource cmdlet.

## EXEMPLOS

### Exemplo 1
Este cmdlet de exemplo cria uma nova Identidade atribuída ao Usuário com **iD1** de nome no grupo de recursos **PSRG** no local do ResourceGroup.
...
### Exemplo 2
Este cmdlet de exemplo cria uma nova Identidade atribuída ao usuário com **iD1** de nome no grupo de recursos **PSRG** na região do oeste.
