...
## DESCRIPTION
**Get-AzUserAssignedIdentity** obtém identidades atribuídas pelo usuário existentes.

## EXEMPLOS

### Exemplo 1
Este cmdlet de exemplo obtém a Identidade atribuída ao Usuário com **iD1** de nome no grupo de recursos **PSRG**
...
### Exemplo 3
Este cmdlet de exemplo obtém todas as Identidades Atribuídas pelo Usuário na assinatura.
