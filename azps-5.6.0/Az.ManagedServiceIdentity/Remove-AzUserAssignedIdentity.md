...
## DESCRIPTION
O **Remove-AzUserAssignedIdentity** exclui a Identidade Atribuída pelo Usuário especificada.
...
Este cmdlet de exemplo exclui a **ID1** de identidade no grupo de recursos **PSRG**.
True
