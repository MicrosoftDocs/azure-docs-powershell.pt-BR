...
## DESCRIPTION
O cmdlet **Get-AzConsumptionMarketplace** obtém marketplaces da assinatura.

## EXEMPLOS

### Exemplo 1: Obter uso de marketplaces
```powershell
...
### Exemplo 2: Obter uso do marketplace com intervalo de datas
```powershell
...
### Exemplo 4: Obter uso do marketplace com filtro InstanceName
```powershell
...
### -EndDate
A data de término (em UTC) dos marketplaces a ser filtrado.
...
### -InstanceId
A id de instância dos marketplaces a ser filtrado.
...
### -InstanceName
O nome da instância dos marketplaces a ser filtrado.
...
### -ResourceGroup
O grupo de recursos dos marketplaces a ser filtrado.
...
### -StartDate
A data de início (em UTC) dos marketplaces a ser filtrado.
