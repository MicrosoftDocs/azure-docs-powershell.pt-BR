...
## DESCRIPTION
O Get-AzConsumptionBudget cmdlet obtém uma lista de orçamentos em uma assinatura ou em um grupo de recursos.

## EXEMPLOS

### Exemplo 1: Obter uma lista de orçamentos no nível da assinatura
```powershell
...
### Exemplo 2: Obter uma lista de orçamentos no nível do grupo de recursos
```powershell
...
### Exemplo 3: obter um orçamento com o nome do orçamento no nível da assinatura
```powershell
...
### Exemplo 4: obter um orçamento com o nome do orçamento no nível do grupo de recursos
```powershell
