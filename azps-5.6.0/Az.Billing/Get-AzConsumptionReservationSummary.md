...
## DESCRIPTION
O cmdlet **Get-AzConsumptionReservationSummary** obtém resumos de reserva para o grain diário ou mensal.

## EXEMPLOS

### Exemplo 1: Obter resumos de reserva com ID do pedido de reserva para o grain mensal
```powershell
...
### Exemplo 2: Obter resumos de reserva com ID do pedido de reserva e ID de reserva para o grain mensal
```powershell
...
### -EndDate
Os dados de término (YYYY-MM-DD em UTC) do resumo da reserva, necessários apenas para o grain diário.
...
### -StartDate
Os dados de início (YYYY-MM-DD em UTC) do resumo da reserva, necessários apenas para o grain diário.
