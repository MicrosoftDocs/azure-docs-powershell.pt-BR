...
### Exemplo 1: Obter detalhes de uso com expansão de MeterDetails
```powershell
...
### Exemplo 2: Obter detalhes de uso com intervalo de datas
```powershell
...
### Exemplo 3: Obter detalhes de uso de BillingPeriodName com filtro InstanceName
```powershell
...
### -EndDate
A data de término (em UTC) dos usos a ser filtrados.
...
### -InstanceId
A id da instância dos usos a ser filtrado.
...
### -InstanceName
O nome da instância dos usos a ser filtrado.
...
### -StartDate
A data de início (em UTC) dos usos a ser filtrados.
