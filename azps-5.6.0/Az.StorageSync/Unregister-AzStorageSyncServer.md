...
## DESCRIPTION
Esse comando desacreva um servidor do serviço de sincronização de armazenamento. Aviso: o não registro de um servidor resultará em exclusões em cascata de todos os pontos de extremidade do servidor neste servidor. Ele só deve ser chamado quando você estiver certo de que nenhum caminho neste servidor deve ser sincronizado mais.
...
Esse comando desatará o registro do servidor, causando exclusões em cascata de todos os pontos de extremidade do servidor neste servidor.
...
### -InputObject
Objeto de Entrada RegisteredServer, normalmente passado pelo pipeline.
