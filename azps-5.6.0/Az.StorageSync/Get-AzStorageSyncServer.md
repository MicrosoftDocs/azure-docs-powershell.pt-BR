...
## DESCRIPTION
Este comando lista todos os servidores registrados em um determinado serviço de sincronização de armazenamento. Ele também pode ser usado para listar os atributos de cada servidor registrado.
...
Esse comando obtém todos os servidores registrados em um serviço de sincronização de armazenamento específico.
