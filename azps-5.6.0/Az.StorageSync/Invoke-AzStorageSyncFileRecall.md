...
## DESCRIPTION
Quando a camada de nuvem está habilitada em um ponto de extremidade do servidor (um local específico em um servidor registrado), esse comando pode ser usado para chamar todos os arquivos hierárquiquios para o disco local. É altamente recomendável desabilitar a camada de nuvem neste ponto de extremidade do servidor antes de iniciar o recall. Se a camada ainda estiver em, o recall pode levar a outros arquivos que estão sendo hierárquidos, o que erra para atingir o objetivo desejado de todo o conteúdo que reside no disco local.
...
Esse comando recursivamente recorda todos os arquivos hierárcarados localizados no caminho raiz do ponto de extremidade do servidor especificado.
...
### -RecallPath
Caminho de recall que precisa ser chamado.
