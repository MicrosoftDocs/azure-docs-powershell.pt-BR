...
## DESCRIPTION
O cmdlet **Remove-AzStackEdgeStorageContainer** remove um contêiner de armazenamento associado para a conta de Armazenamento de Borda em um dispositivo de Borda de Pilha. Você pode especificar o nome do contêiner de armazenamento a ser removido como parâmetro.
