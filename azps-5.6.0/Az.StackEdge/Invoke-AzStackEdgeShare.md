...
## DESCRIPTION
O cmdlet **Invoke-AzStackEdgeShare** invoca a ação para atualizar dados em um compartilhamento em um dispositivo de Borda de Pilha.
...
### -RefreshData
Atualizar Metadados do Compartilhamento com os dados da nuvem
