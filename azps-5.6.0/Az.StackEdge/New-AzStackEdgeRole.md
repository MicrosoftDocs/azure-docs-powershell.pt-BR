...
### -ConnectionString
Para fornecer cadeias de caracteres de conexão
...
Forneça cadeia de conexão do dispositivo IOT
...
Chave de acesso do dispositivo de Borda de Iot
...
Forneça cadeia de conexão do Dispositivo de Borda
...
### -IotEdgeDeviceId
ID do Dispositivo de Borda de Iot
...
### -Platform
Forneça a Plataforma, para ex: Linux
...
### -RoleStatus
Fornecer o status enable/disable
