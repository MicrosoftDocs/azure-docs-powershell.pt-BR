...
## DESCRIPTION
O cmdlet **New-AzStackEdgeStorageAccount** cria uma nova conta de Armazenamento de Borda em um dispositivo de Borda de Pilha. Para um dispositivo, uma conta de Armazenamento de Borda pode ser mapeada no máximo para apenas uma conta de Armazenamento na Nuvem.
...
2 EdgeStorageAccounts no dispositivo não pode compartilhar mais de 1 conta de armazenamento na nuvem
...
### -Cloud
Usará um CloudStorageAccount para camadas
