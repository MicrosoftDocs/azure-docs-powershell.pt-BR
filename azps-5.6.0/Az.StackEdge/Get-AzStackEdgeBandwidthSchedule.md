...
## DESCRIPTION
O cmdlet **Get-AzStackEdgeBandwidthSchedule** obtém as informações sobre os Cronogramas de Largura de Banda. Você pode especificar o Nome de um Cronograma juntamente com o nome do Grupo de Recursos e o nome do dispositivo para obter as informações sobre um cronograma de largura de banda específico
