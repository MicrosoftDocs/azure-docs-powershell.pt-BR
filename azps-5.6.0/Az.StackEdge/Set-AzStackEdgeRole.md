...
## DESCRIPTION
O cmdlet **Set-AzStackEdgeRole** atualiza uma função de IoT para um dispositivo de Borda de Pilha. Os compartilhamentos montados antigos serão substituídos por os recém-fornecidos no parâmetro ShareName.
