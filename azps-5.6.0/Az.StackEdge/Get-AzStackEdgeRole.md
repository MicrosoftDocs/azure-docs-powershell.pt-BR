...
## DESCRIPTION
O cmdlet **Get-AzStackEdgeRole** busca as funções de IoT disponíveis para um dispositivo de Borda de Pilha. Você pode mencionar o parâmetro Name para obter os detalhes de uma função IoT específica.
