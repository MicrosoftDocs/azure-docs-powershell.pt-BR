...
## DESCRIPTION
O cmdlet **New-AzStackEdgeBandwidthSchedule** cria um novo Cronograma de Largura de Banda para um dispositivo de Borda de Pilha para ajudar a gerenciar o uso da largura de banda.
