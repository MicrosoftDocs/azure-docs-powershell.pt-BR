...
## SYNOPSIS
Modifica a regra de firewall especificada no Data Lake Store especificado.
...
## DESCRIPTION
O cmdlet **Set-AzDataLakeStoreFirewallRule** modifica a regra de firewall especificada no Repositório de Data Lake especificado.

## EXEMPLOS

### Exemplo 1: atualizar o intervalo ip inicial e final para uma regra de firewall
```
...
### -Account
A conta do Data Lake Store para atualizar a regra de firewall em
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém a conta para atualizar a regra de firewall.
