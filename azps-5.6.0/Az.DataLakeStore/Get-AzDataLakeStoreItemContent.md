...
## DESCRIPTION
O cmdlet **Get-AzDataLakeStoreItemContent** obtém o conteúdo de um arquivo no Data Lake Store.
...
Este comando obtém as duas primeiras linhas separadas de linha no arquivo MyFile.txt na conta ContosoADL.
...
### -Head
O número de linhas (nova linha delimitada) do início do arquivo para a visualização. Se nenhuma nova linha for encontrada nos primeiros 4 mb de dados, somente esses dados serão retornados.
...
### -Path
Especifica o caminho do Data Lake Store de um arquivo, começando com o diretório raiz (/).
