...
## DESCRIPTION
O cmdlet **Get-AzDataLakeStoreItemAclEntry** obtém uma entrada (ACE) na lista de controle de acesso (ACL) de um arquivo ou pasta no Data Lake Store.
...
Este comando obtém a ACL para o diretório raiz da conta do Data Lake Store especificada
...
### -Path
Especifica o caminho do Data Lake Store do item para o qual este cmdlet obtém um ACE, começando com o diretório raiz (/).
