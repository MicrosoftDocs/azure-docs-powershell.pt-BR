...
## SYNOPSIS
Remove a regra de firewall especificada no Data Lake Store especificado.
...
## DESCRIPTION
O cmdlet **Remove-AzDataLakeStoreFirewallRule** remove a regra de firewall especificada no Repositório de Data Lake especificado.
...
### -Name
O nome da regra de firewall a ser excluído.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém a conta para remover a regra de firewall.
