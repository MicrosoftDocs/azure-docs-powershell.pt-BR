...
## DESCRIPTION
O cmdlet **Set-AzDataLakeStoreTrustedIdProvider** modifica o provedor de identidade confiável especificado no Repositório de Data Lake especificado.
...
### -ProviderEndpoint
O ponto de extremidade de provedor confiável válido no formato: https://sts.windows.net/\<provider identity\>
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém a conta para a atualização do provedor de identidade confiável.
