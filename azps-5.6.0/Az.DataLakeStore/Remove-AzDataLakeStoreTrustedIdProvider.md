...
## SYNOPSIS
Remove o provedor de identidade confiável especificado no Data Lake Store especificado.
...
## DESCRIPTION
O cmdlet **Remove-AzDataLakeStoreTrustedIdProvider** remove o provedor de identidade confiável especificado no Repositório de Data Lake especificado.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém a conta para remover o provedor de identidade confiável.
