...
## SYNOPSIS
Limpa a ACL de um arquivo ou pasta no Data Lake Store.
...
## DESCRIPTION
O cmdlet **Remove-AzDataLakeStoreItemAcl** limpa a lista de controles de acesso (ACL) de um arquivo ou pasta no Data Lake Store.
...
Este comando remove a ACL do diretório raiz da conta ContosoADL.
...
### -Path
Especifica o caminho do Data Lake Store do item, começando com o diretório raiz (/).
