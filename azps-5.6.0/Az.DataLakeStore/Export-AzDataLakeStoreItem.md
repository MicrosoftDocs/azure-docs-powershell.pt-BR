...
### Exemplo 1: Baixar um item do Data Lake Store
```
PS C:\>Export-AzDataLakeStoreItem -AccountName "ContosoADL" -Path /myFiles/TestSource.csv -Destination "C:\Test.csv" -Concurrency 4
```

Este comando baixa o arquivo TestSource.csv do Data Lake Store para C:\Test.csv com uma concurreência de 4.
...
### -Concurrency
Indica o número de arquivos ou partes a baixar em paralelo. O padrão será calculado como um melhor esforço com base nas especificações do sistema.
...
### -Path
Especifica o caminho do item a ser baixado do Data Lake Store, começando pelo diretório raiz (/).
