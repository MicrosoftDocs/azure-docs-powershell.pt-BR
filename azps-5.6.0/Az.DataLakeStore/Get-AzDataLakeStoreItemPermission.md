...
## SYNOPSIS
Obtém o octal de permissão de um arquivo ou pasta no Data Lake Store.
...
## DESCRIPTION
O cmdlet **Get-AzDataLakeStoreItemPermission obtém** o octal de permissão de um arquivo ou pasta no Data Lake Store.

## EXEMPLOS

### Exemplo 1: definir o octal de permissão para um arquivo
```
PS C:\>Get-AzDataLakeStoreItemPermission -AccountName "ContosoADL" -Path "/file.txt"
```

Este comando obtém a octal de permissão para um arquivo.
