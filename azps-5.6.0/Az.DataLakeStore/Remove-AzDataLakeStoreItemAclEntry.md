...
## DESCRIPTION
O cmdlet **Remove-AzDataLakeStoreItemAclEntry** remove uma entrada (ACE) da lista de controles de acesso (ACL) de um arquivo ou pasta no Data Lake Store.
...
Este comando remove o ACE do usuário para Patti Fuller da conta ContosoADL.
...
### Exemplo 3: Remover permissões para um ace recursivamente usando o objeto Acl
```
...
Este comando remove o ACE do usuário para Patti Fuller da raiz e recursivamente de todos os subdiretivos e arquivos da conta ContosoADL.
...
### -Id
Especifica a ID do objeto do usuário, grupo ou entidade de serviço do AzureActive Directory para o qual remover um ACE.
...
### -Recurse
Indica a ACL a ser removida recursivamente para os subdiretivos e arquivos filho
...
### -ShowProgress
Se aprovado, o status de progresso será mostrado. Aplicável somente quando a recursiva remoção de Acl é feita.
