...
Este comando adiciona a marca especificada à conta do Data Lake Store chamada ContosoADL.
...
### -DefaultGroup
Especifica a ID de um grupo do Diretório AzureActive.
Esse grupo é o grupo padrão para arquivos e pastas que você cria.
...
### -KeyVersion
Se o tipo de criptografia for atribuído ao usuário, o usuário poderá girar sua versão de chave com esse parâmetro.
...
Opcionalmente, habilita ou desabilita os provedores de ID confiáveis existentes.
