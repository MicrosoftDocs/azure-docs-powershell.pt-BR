...
Esse comando modifica recursivamente o ACE para Patti Fuller ter todas as permissões para raiz e todos os subdiretivos e arquivos.
...
### -Recurse
Indica a ACL a ser modificada recursivamente para os subdiretivos e arquivos filho
...
### -ShowProgress
Se aprovado, o status de progresso será mostrado. Aplicável somente quando a modificação recursiva do Acl é feita.
