...
## DESCRIPTION
O cmdlet **Set-AzDataLakeStoreItemAcl** modifica a lista de controles de acesso (ACL) de um arquivo ou pasta no Data Lake Store.
...
O segundo comando define a ACL para o arquivo Test.txt como aquele em $ACL.
...
O primeiro comando obtém o ACL para o diretório Folder1 da conta ContosoADL e, em seguida, armazena-o na variável $ACL de diretório.
O segundo comando define a ACL recursivamente como Folder2 e seus sub-diretórios e arquivos como aquele em $ACL.
...
### -Recurse
Indica a ACL a ser definida recursivamente para os subdiretivos filho e arquivos
...
### -ShowProgress
Se aprovado, o status de progresso será mostrado. Aplicável somente quando o conjunto Acl recursivo é feito.
