...
### Exemplo 1: Adicionar uma nova regra de firewall a uma conta do Data Lake Store
```
...
### -Account
A conta do Data Lake Store para adicionar a regra de firewall
...
### -Name
O nome da regra de firewall a ser acrescentada.
...
### -ResourceGroupName
Nome do grupo de recursos no qual a conta para adicionar a regra de firewall é.
