...
### Exemplo 1: Obter todo o HealthBot
```powershell
...
### Exemplo 2: Obter todo o HealthBot por ResourceGroupName
```powershell
...
Obter HealthBot por ResourceGroupName e Name
...
Obter HealthBot por InputObject
