...
Este comando obtém os valores métricos do site3 com um tempo de 1 minuto.
...
### -DetailedOutput
Indica que esse cmdlet exibe saída detalhada.
...
### -MetricFilter
Especifica o filtro de dimensão métrica para o qual as métricas de consulta são consultadas.
...
### -MetricNamespace
Especifica o namespace métrico para o qual consultar métricas.
...
### -TimeGrain
Especifica o grain de tempo da métrica como um **objeto TimeSpan** no formato hh:mm:ss.
...
Mais informações sobre as métricas suportadas podem ser encontradas em: https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported
