...
## SYNOPSIS
Crie o objeto PSServiceDiagnosticSettings.
...
Crie o objeto PSServiceDiagnosticSettings. E crie a configuração de diagnóstico para o recurso de destino.

## PARÂMETROS

### -DedicatedLogAnalyticsDestinationType
O valor que indica se deve exportar (para ODS) para recursos específicos (se presente) ou para a AzureDiagnostics (padrão, não presente)
