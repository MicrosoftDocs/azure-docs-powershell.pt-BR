...
## DESCRIPTION
Adiciona ou atualiza uma regra de alerta baseada em **métrica V2 (não clássica).** A regra adicionada é associada a um grupo de recursos e tem um nome. Este cmdlet implementa o padrão ShouldProcess, ou seja, ele pode solicitar confirmação do usuário antes de realmente criar, modificar ou remover o recurso.
...
Este comando cria uma regra de alerta métrica para todas as máquinas virtuais na assinatura que estão no eastus

### Exemplo 3: Desabilitar uma regra de alerta métrica
```powershell
...
Este comando desabilita uma regra de alerta métrica. Aqui, estamos canalização da saída [de Get-AzMetricAlertRuleV2](https://docs.microsoft.com/powershell/module/az.monitor/get-azmetricalertrulev2) para [Add-AzMetricAlertRuleV2](https://docs.microsoft.com/powershell/module/az.monitor/add-azmetricalertrulev2) 
...
Para criar uma regra de alerta métrica mais complexa, como as que envolvem a seleção de valores de dimensão ou têm vários critérios, você pode usar os cmdlets auxiliares [New-AzMetricAlertRuleV2DimensionSelection](https://docs.microsoft.com/powershell/module/az.monitor/new-azmetricalertrulev2dimensionselection) e [New-AzMetricAlertRuleV2Criteria](https://docs.microsoft.com/powershell/module/az.monitor/new-azmetricalertrulev2criteria).
...
### -ActionGroupId
A ID do Grupo de Ações para a regra
...
### -Description
A descrição da regra de alerta métrica
...
### -Name
O nome da regra de alerta métrica
...
### -Severity
A gravidade da regra de alerta métrica
...
### -TargetResourceRegion
A região de recurso de destino para regra
...
### -TargetResourceScope
O escopo de recurso de destino para a regra
