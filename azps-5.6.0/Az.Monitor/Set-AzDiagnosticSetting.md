...
Este comando desabilita todas as métricas e logs disponíveis para o recurso Resource01.
...
Este comando desabilita as categorias de métricas chamadas Category1 e Category2.
...
Este comando habilita Category1 e Category2.
Todas as outras categorias de métricas e logs permanecem as mesmas.

### Exemplo 5: Habilitar um grain de tempo e várias categorias
```powershell
PS C:\>Set-AzDiagnosticSetting -ResourceId "Resource01" -Enabled $True -Category Category1,Category2 -Timegrain PT1M
```

Este comando habilita apenas Category1, Category2 e time grain PT1M.
Todas as outras categorias e grãos de tempo não são alterados.

### Exemplo 6: Usando pipeline
```powershell
...
Se nenhuma categoria for especificada, esse comando operará em todas as categorias suportadas. 
...
### -Enabled
Indica se é possível habilitar diagnósticos.
...
Sinalizador indicando que a exportação para LA deve ser feita para uma tabela específica do recurso, a.k.a. tabela de esquema dedicada ou fixa, em vez da **tabela** de esquema dinâmica padrão chamada **AzureDiagnostics**.
...
### -MetricCategory
A lista de categorias métricas. Se nenhuma categoria for especificada, esse comando operará em todas as categorias suportadas. 
...
### -StorageAccountId
Especifica a ID da conta de armazenamento na qual os dados serão salvo.
...
### -Timegrain
Especifica os grãos de tempo para habilitar ou desabilitar métricas, de acordo com o valor *de Enabled*.
Se você não especificar um grain de hora, este comando operará em todos os grãos de tempo disponíveis.
...
### -WorkspaceId
A ID de recurso do espaço de trabalho do Log Analytics para enviar logs/métricas para
