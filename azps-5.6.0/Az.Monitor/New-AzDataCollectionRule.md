...
A saída de um DCR serializado com o cmdlet ConvertTo-Json também é suportada (consulte Example #2).

## EXEMPLOS

### Exemplo 1: Criar regra de coleta de dados, JSON da API Rest
```powershell
...
Este comando cria uma regra de coleta de dados para a assinatura atual.

### Exemplo 2: Criar regra de coleta de dados, JSON de PSDataCollectionRuleResource
```powershell
PS C:\>New-AzDataCollectionRule -Location 'East US 2 EUAP' -ResourceGroupName 'testdcr'
