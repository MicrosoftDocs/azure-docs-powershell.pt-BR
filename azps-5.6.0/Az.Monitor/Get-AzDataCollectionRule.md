...
## DESCRIPTION
O cmdlet **Get-AzDataCollectionRule** obtém uma ou mais regras de coleta de dados.
...
### Exemplo 1: Obter regras de coleta de dados por ID de assinatura
```
...
Este comando lista todas as regras de coleta de dados da assinatura atual.

### Exemplo 2: Obter regras de coleta de dados para o grupo de recursos determinado
```
...
Este comando lista as regras de coleta de dados para o determinado grupo de recursos.
...
Este comando lista uma regra de coleta de dados (uma lista com um único elemento).

### Exemplo 4: Obter uma regra de coleta de dados por ID de regra
```
