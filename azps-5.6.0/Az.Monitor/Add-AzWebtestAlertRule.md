...
## DESCRIPTION
O cmdlet **Add-AzWebtestAlertRule** adiciona ou atualiza uma regra de alerta do tipo métrica, evento ou webtest.
...
### Exemplo 1: Adicionar uma regra de alerta de teste da Web
```
...
Este comando adiciona ou atualiza uma regra de alerta de webtest.
...
### -MetricNamespace
Especifica o namespace métrico para regra.
...
### -TargetResourceUri
Especifica a ID de recurso do webtest.
