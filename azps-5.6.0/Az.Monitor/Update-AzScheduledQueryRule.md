...
## DESCRIPTION
Atualiza uma regra de Alerta de Log, atualizando apenas a propriedade "Enabled" é suportada por este comando.
Para atualizar outras propriedades, consulte [o comando Set-AzScheduledQueryRule.](https://docs.microsoft.com/powershell/module/az.monitor/set-azscheduledqueryrule)

## EXEMPLOS

### Exemplo 1: Atualização por nome de regra
```powershell
...
### Exemplo 2: Atualização por objeto de entrada
```powershell
...
### Exemplo 3: Atualização por ID de recurso
```powershell
