...
## SYNOPSIS
Cria um objeto criteria local que pode ser usado para criar um novo alerta métrico
...
## DESCRIPTION
O cmdlet **New-AzMetricAlertRuleV2Criteria** cria um objeto de critérios métricos local a ser usado como um cmdlet [Add-AzMetricAlertRuleV2](https://docs.microsoft.com/powershell/module/az.monitor/add-azmetricalertrulev2) de entrada que cria uma nova regra de alerta métrica.

## EXEMPLOS

### Exemplo 1: Criar um critério de alerta métrico simples
...
Este comando cria um critério de alerta métrico simples que pode ser usado em uma regra de alerta métrica

### Exemplo 2: Criar um critério dinâmico de alerta métrico
...
Este comando cria um critério de alerta métrico dinâmico que pode ser usado em uma regra de alerta métrica
...
Esse conjunto de comandos cria um critério de alerta métrico mais complexo que inclui seleção de dimensão

### Exemplo 4: Criar um critério de disponibilidade de teste na Web
...
Este comando cria um critério de disponibilidade do webtest que pode ser usado em uma regra de alerta métrica

## PARÂMETROS

### -ApplicationInsightsId
A ID do recurso Application Insights.
...
### -DynamicThreshold
Parâmetro Switch para usar o Tipo de Limite Dinâmico
...
### -FailedLocationCount
O número mínimo de locais com falha para levantar um alerta.
...
### -Operator
O operador de condição de regra
...
Permite criar uma regra de alerta em uma métrica personalizada que ainda não foi emitida, fazendo com que a validação métrica seja ignorada
...
### -Threshold
O limite para a condição de regra
...
A sensibilidade para a condição de regra
...
### -TimeAggregation
A operação de agregação usada para rolar vários valores métricos no intervalo da janela
...
### -ViolationCount
O número mínimo de violações necessárias na janela de tempo de retorno selecionado necessária para levantar um alerta
...
### -WebTest
Parâmetro Switch para usar o tipo de critérios de disponibilidade
...
### -WebTestId
A ID de teste web do Application Insights.
