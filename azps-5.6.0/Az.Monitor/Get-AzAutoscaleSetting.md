...
## SYNOPSIS
Obtém configurações de escala automática.
...
## DESCRIPTION
O cmdlet **Get-AzAutoscaleSetting** obtém todas as configurações de Escala Automática associadas a um grupo de recursos ou a uma configuração de Escala Automática especificada.

## EXEMPLOS

### Exemplo 1: Obter configurações de escala automática
```
...
Este comando obtém as configurações de escala automática atribuídas ao grupo de recursos Default-Web-EastUS.

### Exemplo 2: Obter uma configuração de escala automática pelo nome
```
...
Este comando obtém a configuração De escala automática chamada DefaultServerFarm-Default-Web-EastUS.
...
### -Name
Especifica o nome da configuração a ser obter.
