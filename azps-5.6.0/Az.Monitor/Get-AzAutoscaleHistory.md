...
Este comando obtém todos os eventos relacionados à escala automática associados à assinatura atual.

### Exemplo 2: GetAutoscaleHistory para um recurso específico
```
