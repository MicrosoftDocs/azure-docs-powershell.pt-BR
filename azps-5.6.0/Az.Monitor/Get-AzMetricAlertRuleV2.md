...
## SYNOPSIS
Obtém regras de alerta métricaS V2 (não clássicas)
...
## DESCRIPTION
O cmdlet **Get-AzMetricAlertRuleV2** obtém uma regra de alerta métrica por seu nome ou URI, ou todas as regras de alerta métricas de um grupo de recursos ou assinatura especificado.

## EXEMPLOS

### Exemplo 1: Obter todas as regras de alerta métricas na assinatura atual
```powershell
...
Esse comando obtém todas as regras de alerta métricas na assinatura atual.

### Exemplo 2: Obter todas as regras de alerta métricas em um grupo de recursos
...
Este comando obtém todas as regras de alerta métricas no grupo de recursos chamado metricAlertsRG.

### Exemplo 3: Obter uma regra de alerta métrica pelo nome
...
Este comando obtém a regra de alerta métrica chamada PS3182019 no grupo de recursos chamado metricAlertsRG.

### Exemplo 4: Obter uma regra de alerta métrica por ruleID
...
Esse comando obtém a regra de alerta métrica com a ID de recurso determinada.
...
### -Name
A regra nome da regra de alerta métrica
...
### -ResourceId
A ID da regra de alerta métrica
