...
## SYNOPSIS
Cria um objeto do tipo Grupo de Ações do Azns
...
### -ActionGroup
A lista de grupos de ações a ser enviado para notificação
...
A carga de webhook personalizada
...
### -EmailSubject
O assunto do email de notificação de alerta
