...
## SYNOPSIS
Obtém o histórico de regras de alerta clássicas.
...
## DESCRIPTION
O cmdlet **Get-AzAlertHistory** obtém o histórico de regras de alerta clássicas à medida que elas são habilitadas, desabilitadas, disparadas, resolvidas e assim por diante.
...
Este comando obtém o histórico de alertas do período especificado para a assinatura atual.

### Exemplo 2: Obter histórico de alerta para um recurso especificado
```
...
Este comando obtém os eventos relacionados à regra de alerta para um recurso especificado.
