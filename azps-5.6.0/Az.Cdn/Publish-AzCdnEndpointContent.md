...
## SYNOPSIS
Carrega conteúdo para um ponto de extremidade.
...
## DESCRIPTION
O cmdlet **Publish-AzCdnEndpointContent** carrega conteúdo de um servidor de origem para o ponto de extremidade cdn (Rede de Distribuição de Conteúdo) do Azure.
...
### -LoadContent
Especifica uma matriz de caminhos relativos para o conteúdo no servidor de origem que este cmdlet publica.
