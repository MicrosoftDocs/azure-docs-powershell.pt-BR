...
## SYNOPSIS
Cria um novo grupo de origem da CDN
...
## DESCRIPTION
O New-AzCdnOriginGroup criará um novo grupo de origem dentro do ponto de extremidade especificado. Se esse for o primeiro grupo de origem do ponto de extremidade, a propriedade DefaultOriginGroup também deverá ser definida.
...
```
Este cmdlet criará um novo grupo de origem dentro do ponto de extremidade especificado. Ele utilizará as IDs de origem determinadas como o conjunto de origens.
