...
## SYNOPSIS
Obtém um grupo de origem da CDN
...
## DESCRIPTION
O Get-AzCdnOriginGroup cmdlet recupera um grupo de origem da CDN.
...
Este comando obterá o grupo de origem dentro do ponto de extremidade especificado.
