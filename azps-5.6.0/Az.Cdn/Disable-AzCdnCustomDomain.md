...
## SYNOPSIS
Desabilita HTTPS de domínio personalizado (preterido).
...
## DESCRIPTION
O cmdlet **Disable-AzCdnCustomDomain** desabilita a entrega HTTPS segura de um domínio personalizado da CDN.
...
Desabilitar a entrega https do domínio personalizado.

## PARÂMETROS

### -CustomDomainName
Nome de exibição de domínio personalizado do Azure CDN.
