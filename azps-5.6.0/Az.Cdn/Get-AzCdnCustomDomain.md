...
## DESCRIPTION
O cmdlet **Get-AzCdnCustomDomain** obtém um domínio personalizado da Rede de Entrega de Conteúdo (CDN) do Azure e suas configurações relacionadas.
...
O nome do domínio personalizado difere do nome do host do domínio personalizado.
