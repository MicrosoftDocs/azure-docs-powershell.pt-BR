...
## DESCRIPTION
O New-AzCdnOrigin criará uma nova origem de CDN no ponto de extremidade especificado.
...
Este cmdlet criará uma nova origem de CDN para o ponto de extremidade especificado. Ele usará o nome do host fornecido como a origem. 
