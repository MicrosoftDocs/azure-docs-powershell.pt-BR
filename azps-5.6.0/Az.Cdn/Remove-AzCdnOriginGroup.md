...
## DESCRIPTION
Remove-AzCdnOriginGroup removerá um grupo de origem da CDN do ponto de extremidade especificado. 
...
Este cmdlet removerá o grupo de origem especificado do ponto de extremidade determinado. 
...
### -ResourceId
A id de recurso do grupo de origem cdn do Azure.
