...
## DESCRIPTION
Set-AzCdnOriginGroup atualizará o grupo de origem especificado dentro do ponto de extremidade determinado. 
...
```
Este cmdlet atualizará a propriedade ProbeIntervalInSeconds no grupo de origem. 
