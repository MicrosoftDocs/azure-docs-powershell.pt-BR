...
## DESCRIPTION
O cmdlet **Start-AzCdnEndpoint** inicia um ponto de extremidade cdn (Rede de Distribuição de Conteúdo) do Azure.
...
### -CdnEndpoint
Especifica o ponto de extremidade que este cmdlet inicia.
...
### -EndpointName
Especifica o nome do ponto de extremidade que este cmdlet inicia.
