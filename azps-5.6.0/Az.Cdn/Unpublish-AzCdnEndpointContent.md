...
## DESCRIPTION
O cmdlet **Unpublish-AzCdnEndpointContent** limpa o conteúdo de um ponto de extremidade cdn (Rede de Distribuição de Conteúdo) do Azure.
...
### -CdnEndpoint
Especifica o ponto de extremidade que esse cmdlet limpa.
