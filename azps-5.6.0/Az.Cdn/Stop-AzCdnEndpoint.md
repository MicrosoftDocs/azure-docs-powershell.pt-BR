...
## DESCRIPTION
O cmdlet **Stop-AzCdnEndpoint** interrompe o ponto de extremidade cdn (Rede de Distribuição de Conteúdo) do Azure.
...
### -CdnEndpoint
Especifica o objeto de ponto de extremidade que esse cmdlet interrompe.
