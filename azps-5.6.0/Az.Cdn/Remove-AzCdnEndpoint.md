...
## DESCRIPTION
O cmdlet **Remove-AzCdnEndpoint** remove um ponto de extremidade cdn (Rede de Distribuição de Conteúdo) do Azure.
...
### -CdnEndpoint
Especifica o ponto de extremidade que esse cmdlet remove.
