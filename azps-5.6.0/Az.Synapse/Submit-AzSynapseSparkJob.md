...
## SYNOPSIS
Envia um trabalho de Spark de Análise de Synapse.
...
## DESCRIPTION
O cmdlet **Submit-AzSynapseSparkJob** envia um trabalho de Spark de Análise de Synapse.
...
Este comando envia um trabalho de Spark de Análise de Synapse.
...
### -Configuration
Propriedades de configuração spark.
...
### -ExecutorCount
Número de executores a serem alocados no pool de Spark especificado para o trabalho.
...
### -ExecutorSize
Número de núcleo e memória a serem usados para executores alocados no pool de Spark especificado para o trabalho.
...
### -Language
Idioma do trabalho a ser envio.
...
Obrigatório para o trabalho spark e .NET Spark.
