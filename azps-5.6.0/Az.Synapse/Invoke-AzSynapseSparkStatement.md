...
Esses comandos iniciam uma sessão Spark e invocam uma instrução Spark em linha por meio do pipeline.
...
Esses comandos iniciam uma sessão Spark e invocam uma instrução Spark em linha.
...
Esses comandos iniciam uma sessão Spark e invocam instruções Spark em um arquivo.
