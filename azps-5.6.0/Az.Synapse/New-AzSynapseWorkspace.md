...
## SYNOPSIS
Cria um espaço de trabalho do Synapse Analytics.
...
## DESCRIPTION
O cmdlet **New-AzSynapseWorkspace** cria um espaço de trabalho do Azure Synapse Analytics.
...
Este comando cria um espaço de trabalho do Synapse Analytics chamado ContosoWorkspace que usa o Armazenamento de Dados ContosoAdlGenStorage, no grupo de recursos chamado ContosoResourceGroup.
...
O nome da conta de armazenamento padrão do ADLS Gen2.
...
O sistema de arquivos padrão do ADLS Gen2.
...
### -Location
Região do Azure onde o recurso deve ser criado.
...
Nome de uma rede virtual gerenciada pelo Synapse dedicada ao espaço de trabalho do Azure Synapse.
...
SQL credenciais de administrador.
