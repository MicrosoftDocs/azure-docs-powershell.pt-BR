...
## DESCRIPTION
O cmdlet **Invoke-AzSynapseIntegrationRuntimeUpgrade** atualiza o tempo de execução de integração auto-hospedado se a nova versão estiver disponível.
...
O cmdlet atualiza o tempo de execução de integração auto-hospedado chamado "test-selfhost-ir" no espaço de trabalho ContosoWorkspace.
