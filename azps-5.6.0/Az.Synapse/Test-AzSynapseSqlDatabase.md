...
## SYNOPSIS
Verifica a existência de um banco de dados do Synapse Analytics SQL.
...
## DESCRIPTION
O cmdlet **Test-AzSynapseSqlDatabase** verifica a existência de um banco de dados do Synapse Analytics SQL.
...
Este comando verifica a existência do banco de dados SQL especificado.
