...
## SYNOPSIS
Obtém um trabalho de Spark de Análise de Synapse.
...
## DESCRIPTION
O cmdlet **Get-AzSynapseSparkJob** obtém um trabalho de Spark de Análise do Azure Synapse.
...
Esse comando obtém o trabalho com a ID de aplicativo especificada.
...
Este comando obtém todos os trabalhos em um pool de Spark por meio de pipeline.
