...
## SYNOPSIS
Atualiza um pool de Spark de Análise de Synapse.
...
## DESCRIPTION
O cmdlet **Update-AzSynapseSparkPool** atualiza um pool de Spark do Azure Synapse Analytics.
...
Este comando atualiza um pool de Spark do Azure Synapse Analytics.
...
Este comando atualiza um pool de Spark de Análise do Azure Synapse por meio de pipeline.
...
Este comando atualiza um pool de Spark de Análise do Azure Synapse com iD de recurso.
...
Esse comando habilita a escala automática para um pool de Spark do Azure Synapse Analytics.
...
Este comando desabilita a escala automática para um pool de Spark de Análise do Azure Synapse.
...
Este comando habilita a pausa automática para um pool de Spark do Azure Synapse Analytics.
...
Este comando desabilita a pausa automática para um pool de Spark do Azure Synapse Analytics.
...
Esse parâmetro deve ser especificado quando a escala automática estiver habilitada.
...
Número mínimo de nós a serem alocados no pool de Spark especificado.
Esse parâmetro deve ser especificado quando a escala automática estiver habilitada.
...
Esse parâmetro deve ser especificado quando a escala automática estiver desabilitada
