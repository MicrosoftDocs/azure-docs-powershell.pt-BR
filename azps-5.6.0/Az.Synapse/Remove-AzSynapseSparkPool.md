...
## SYNOPSIS
Exclui um pool de Spark de Análise de Sinapse.
...
## DESCRIPTION
O cmdlet **Remove-AzSynapseSparkPool** exclui permanentemente um pool de Spark do Azure Synapse Analytics.
...
Este comando exclui um pool de Spark de Análise do Azure Synapse.
...
Este comando exclui um pool de Spark de Análise de Synapse do Azure por meio de pipeline.
...
Este comando exclui um pool de Spark de Análise do Azure Synapse com uma ID de recurso.
