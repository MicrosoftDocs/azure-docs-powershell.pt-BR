...
## SYNOPSIS
Cancela um trabalho de Spark de Análise de Synapse.
...
## DESCRIPTION
O cmdlet **Stop-AzSynapseSparkJob** cancela um trabalho de Spark de Análise de Synapse.
...
Este comando cancela um trabalho de Spark de Análise de Synapse.
...
Este comando cancela um trabalho de Spark de Análise de Synapse por meio do pipeline.
