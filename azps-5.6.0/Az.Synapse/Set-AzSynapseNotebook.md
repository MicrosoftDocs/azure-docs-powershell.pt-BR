...
Este comando cria ou atualiza um bloco de anotações do bloco de anotações notebook.ipynb no espaço de trabalho chamado ContosoWorkspace.
...
Este comando cria ou atualiza um bloco de anotações do bloco de anotações notebook.ipynb no espaço de trabalho chamado ContosoWorkspace por pipeline.
...
Este comando cria ou atualiza um bloco de anotações do bloco de anotações notebook.ipynb que é anexado à ContosoSparkPool e usa dois executores no espaço de trabalho chamado ContosoWorkspace.
