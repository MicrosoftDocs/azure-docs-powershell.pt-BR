...
## DESCRIPTION
O cmdlet **Get-AzSynapseSparkStatement** obtém informações sobre uma instrução Spark do Azure Synapse Analytics.
...
Este comando obtém todas as instruções Spark em uma sessão Spark.
...
Este comando obtém a instrução Spark com a ID de viol especificada.
...
Este comando obtém todas as instruções Spark em uma sessão Spark por meio do pipeline.
