...
## SYNOPSIS
Obtém chaves para um tempo de execução de integração auto-hospedado.
...
## DESCRIPTION
O cmdlet **Get-AzSynapseIntegrationRuntimeKey** obtém chaves para um tempo de execução de integração. As chaves são usadas para registrar um nó de tempo de execução de integração.
...
O cmdlet recupera chaves para um tempo de execução de integração chamado 'test-selfhost-ir'.
