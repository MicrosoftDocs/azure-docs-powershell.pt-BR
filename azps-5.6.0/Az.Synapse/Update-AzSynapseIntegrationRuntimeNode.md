...
## DESCRIPTION
O cmdlet **Update-AzSynapseIntegrationRuntimeNode** atualiza as propriedades do nó de tempo de execução de integração auto-hospedado em um espaço de trabalho. Atualmente, só dá suporte à atualização de 'ConcurrentJobsLimit'.
