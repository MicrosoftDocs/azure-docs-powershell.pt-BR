...
## DESCRIPTION
O cmdlet **Set-AzSynapseTrigger** cria um gatilho em um espaço de trabalho. Os gatilhos são criados no estado 'Parado', o que significa que eles não começam imediatamente a invocar pipelines que fazem referência.
...
Crie um novo gatilho chamado ContosoTrigger no espaço de trabalho ContosoWorkspace. O gatilho é criado no estado 'Parado', o que significa que ele não inicia imediatamente. Um gatilho pode ser iniciado usando `Start-AzDataFactoryV2Trigger` o cmdlet.
...
Crie um novo gatilho chamado ContosoTrigger no espaço de trabalho ContosoWorkspace por meio de pipeline. O gatilho é criado no estado 'Parado', o que significa que ele não inicia imediatamente. Um gatilho pode ser iniciado usando `Start-AzDataFactoryV2Trigger` o cmdlet.
