...
Este comando cria um fluxo de dados chamado ContosoDataFlow no espaço de trabalho chamado ContosoWorkspace.
O comando baseia o fluxo de dados em informações no arquivo DataFlow.json.
