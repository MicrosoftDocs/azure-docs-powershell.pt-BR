...
## SYNOPSIS
Cria um pool de análise SQL Synapse.
...
## DESCRIPTION
O cmdlet **New-AzSynapseSqlPool** cria um pool do Azure Synapse Analytics SQL pool.
...
Este comando cria um pool do Azure Synapse Analytics SQL.
