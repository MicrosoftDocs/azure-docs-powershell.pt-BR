...
## SYNOPSIS
Altera as configurações de auditoria de um Espaço de Trabalho do Azure Synapse Analytics.
...
Habilita a política de auditoria de armazenamento de blob de um Espaço de Trabalho de Análise do Azure Synapse chamado ContosoWorkspace.
...
Habilita a política de auditoria de armazenamento de blob de um Espaço de Trabalho de Análise do Azure Synapse chamado ContosoWorkspace com filtragem avançada usando um predicado T-SQL.
...
Desabilite a política de auditoria de armazenamento de blob de um Espaço de Trabalho de Análise do Azure Synapse chamado ContosoWorkspace por meio de pipeline.
...
Essa combinação acima também é o conjunto configurado por padrão.
Esses grupos abrangem todas as SQL e procedimentos armazenados executados no banco de dados e não devem ser usados em combinação com outros grupos, pois isso resultará em logs de auditoria duplicados.
