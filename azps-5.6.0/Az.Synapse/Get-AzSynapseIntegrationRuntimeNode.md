...
O cmdlet obtém informações do nó chamado "Node_1" no tempo de execução de integração auto-hospedado 'test-selfhost-ir' no espaço de trabalho ContosoWorkspace.
...
O cmdlet obtém informações do nó chamado 'Node_1' no tempo de execução de integração auto-hospedado 'test-selfhost-ir' no espaço de trabalho 'test-df-eu2', incluindo o endereço IP.
