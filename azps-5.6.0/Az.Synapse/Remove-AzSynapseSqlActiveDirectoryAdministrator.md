...
## SYNOPSIS
Remove um administrador do Azure AD para o Espaço de Trabalho do Synapse Analytics.
...
## DESCRIPTION
O cmdlet **Remove-AzSynapseSqlActiveDirectoryAdministrator** remove um administrador do Azure Active Directory (Azure AD) para o Espaço de Trabalho de Análise do Azure Synapse.
...
Este comando remove o administrador do Azure AD para o espaço de trabalho chamado ContosoWorkspace.
