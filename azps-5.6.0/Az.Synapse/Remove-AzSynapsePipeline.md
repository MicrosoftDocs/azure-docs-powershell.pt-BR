...
Este cmdlet remove o pipeline chamado ContosoPipeline do espaço de trabalho chamado ContosoWorkspace.
...
Este cmdlet remove o pipeline chamado ContosoPipeline do espaço de trabalho chamado ContosoWorkspace por pipeline.
