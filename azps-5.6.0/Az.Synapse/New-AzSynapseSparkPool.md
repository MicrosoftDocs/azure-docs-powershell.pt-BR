...
## SYNOPSIS
Cria um pool de spark de análise synapse.
...
## DESCRIPTION
O cmdlet **New-AzSynapseSparkPool** cria um pool de Spark de Análise do Azure Synapse.
...
Este comando cria um pool de Spark de Análise de Synapse do Azure.
...
Este comando cria um pool de Spark de Análise do Azure Synapse com escala automática habilitada.
...
Este comando cria um pool de Spark de Análise do Azure Synapse por meio de pipeline.
...
Este comando cria um pool de Spark de Análise do Azure Synapse com escala automática habilitada por meio do pipeline.
