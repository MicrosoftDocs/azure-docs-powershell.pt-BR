...
## SYNOPSIS
Inicia uma sessão do Spark de Análise de Sinapse.
...
## DESCRIPTION
O cmdlet **Start-AzSynapseSparkSession** inicia uma sessão de Spark de Análise de Synapse.
...
Este comando inicia uma sessão do Azure Synapse Analytics Spark.
...
Este comando inicia uma sessão do Azure Synapse Analytics Spark por meio do pipeline.
