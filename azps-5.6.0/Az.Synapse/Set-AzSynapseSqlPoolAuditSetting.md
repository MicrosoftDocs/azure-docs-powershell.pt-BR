...
## SYNOPSIS
Altera as configurações de auditoria para um pool do Azure Synapse Analytics SQL pool.
...
## DESCRIPTION
O cmdlet **Set-AzSynapseSqlPoolAuditSetting** altera as configurações de auditoria de um pool do Azure Synapse Analytics SQL.
...
Habilita a política de auditoria de armazenamento de blob de um pool do Azure Synapse Analytics SQL chamado ContosoSqlPool.
...
Desabilite a política de auditoria de armazenamento de blob de um pool do Azure Synapse Analytics SQL chamado ContosoSqlPool.
...
Habilita a política de auditoria de armazenamento de blob de um pool do Azure Synapse Analytics SQL chamado ContosoSqlPool com filtragem avançada usando um predicado T-SQL.
...
Remova a configuração de filtragem avançada da política de auditoria de um pool do Azure Synapse Analytics SQL chamado ContosoSqlPool.
...
Desabilite a política de auditoria de armazenamento de blob de um pool do Azure Synapse Analytics SQL chamado ContosoSqlPool por pipeline.
...
Observe que o objeto no formato acima pode se referir a um objeto como uma tabela, exibição ou procedimento armazenado ou um banco de dados \[ \] ou esquema inteiro.
Para os últimos casos, os formulários DATABASE:: dbname e \[ \] SCHEMA:: \[ schemaname \] são usados, respectivamente.
