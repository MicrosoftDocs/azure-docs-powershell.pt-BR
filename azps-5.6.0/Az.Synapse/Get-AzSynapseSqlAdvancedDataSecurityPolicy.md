...
## SYNOPSIS
Obtém a política avançada de Segurança de Dados de um espaço de trabalho.
...
Este comando obtém a Segurança Avançada de Dados no espaço de trabalho chamado ContosoWorkspace.
...
Este comando obtém a Segurança Avançada de Dados no espaço de trabalho chamado ContosoWorkspace por pipeline.
