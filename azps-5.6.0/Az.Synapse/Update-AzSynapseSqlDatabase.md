...
## SYNOPSIS
Atualiza um banco de dados do Synapse Analytics SQL.
...
## DESCRIPTION
O cmdlet **Update-AzSynapseSqlDatabase** atualiza um banco de dados do Azure Synapse Analytics SQL.
...
Este comando atualiza um banco de dados do Azure Synapse Analytics SQL.
...
### -InputObject
SQL objeto de entrada Banco de Dados, geralmente passado pelo pipeline.
