...
## DESCRIPTION
O cmdlet **New-AzSynapseFirewallRule** cria uma Regra de Firewall do Azure Synapse Analytics.
...
Este comando cria uma regra de firewall chamada ContosoFirewallRule no espaço de trabalho ContosoWorkspace com o nome ContosoFirewallRule.
...
Este comando cria uma regra de firewall chamada ContosoFirewallRule em um espaço de trabalho por meio de pipeline.
...
Este comando cria uma regra de firewall que permite todos os ips do azure em um espaço de trabalho.
