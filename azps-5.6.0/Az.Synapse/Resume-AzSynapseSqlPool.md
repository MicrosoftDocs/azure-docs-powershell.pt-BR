...
## SYNOPSIS
Retoma um pool do Synapse Analytics SQL.
...
## DESCRIPTION
O cmdlet **Resume-AzSynapseSqlPool** retoma um pool do Azure Synapse Analytics SQL pool.
...
Este comando retoma um pool suspenso do Azure Synapse Analytics SQL pool.
