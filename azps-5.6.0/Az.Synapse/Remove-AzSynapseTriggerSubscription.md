...
## DESCRIPTION
O cmdlet **Remove-AzSynapseTriggerSubscription** cancela a assinatura do gatilho de eventos para os eventos de serviço externo especificados a partir da definição do gatilho.
...
Este comando cancelará a assinatura do gatilho chamado ContosoTrigger para os eventos especificados da definição do gatilho.
...
Este comando cancelará a assinatura do gatilho chamado ContosoTrigger para os eventos especificados a partir da definição do gatilho pelo pipeline.
