...
## SYNOPSIS
Remove as configurações avançadas de proteção contra ameaças de um SQL pool.
...
## DESCRIPTION
O cmdlet **Reset-AzSynapseSqlPoolAdvancedThreatProtectionSetting** remove as configurações avançadas de proteção contra ameaças de um pool do Azure Synapse Analytics SQL.
...
Este comando remove as configurações avançadas de proteção contra ameaças de um pool SQL chamado ContosoSqlPool no espaço de trabalho chamado ContosoWorkspace.
