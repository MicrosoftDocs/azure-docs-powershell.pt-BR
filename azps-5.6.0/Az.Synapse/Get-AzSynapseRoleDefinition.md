...
Se você não especificar um nome de função ou uma ID de função, este cmdlet obtém todas as definições de função.
...
Este comando obtém todas as definições de função em um espaço de trabalho.
...
Este comando obtém a definição de função no espaço de trabalho ContosoWorkspace com o nome ContosoRole.
