...
## SYNOPSIS
Exclui um banco de dados do Synapse Analytics SQL.
...
## DESCRIPTION
O cmdlet **Remove-AzSynapseSqlPool** exclui permanentemente um banco de dados do Azure Synapse Analytics SQL.
...
Este comando exclui um banco de dados do Azure Synapse Analytics SQL.
...
Este comando exclui um banco de dados do Azure Synapse Analytics SQL pipeline.
...
Este comando exclui um banco de dados do Azure Synapse Analytics SQL com a ID de recurso especificada.
