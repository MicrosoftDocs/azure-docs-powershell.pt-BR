...
## SYNOPSIS
Remove as configurações de auditoria de um pool do Azure Synapse Analytics SQL pool.
...
## DESCRIPTION
O cmdlet **Reset-AzSynapseSqlPoolAuditSetting** remove as configurações de auditoria de um pool do Azure Synapse Analytics SQL.
...
Este comando remove as configurações de auditoria de um pool SQL chamado ContosoSqlPool no espaço de trabalho ContosoWorkspace.
...
Este comando remove as configurações de auditoria de um pool SQL chamado ContosoSqlPool no espaço de trabalho ContosoWorkspace por meio de pipeline.
