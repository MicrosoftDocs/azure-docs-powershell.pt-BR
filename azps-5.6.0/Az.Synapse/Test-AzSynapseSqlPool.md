...
## SYNOPSIS
Verifica a existência de um pool do Synapse Analytics SQL.
...
## DESCRIPTION
O cmdlet **Test-AzSynapseSqlPool** verifica a existência de um pool de SQL Synapse Analytics.
...
Este comando verifica a existência do pool de SQL especificado.
