...
## SYNOPSIS
Atualiza um espaço de trabalho do Synapse Analytics.
...
## DESCRIPTION
O cmdlet **Update-AzSynapseWorkspace** atualiza um espaço de trabalho do Azure Synapse Analytics.
...
Esse comandos atualiza marcas para o espaço de trabalho especificado do Azure Synapse Analytics.
...
Este comandos atualiza marcas para o espaço de trabalho do Azure Synapse Analytics especificado por meio do pipeline.
...
Esse comandos atualiza marcas para o espaço de trabalho do Azure Synapse Analytics especificado por meio de pipeline com iD de recurso.
...
A nova SQL de administrador para o espaço de trabalho.
