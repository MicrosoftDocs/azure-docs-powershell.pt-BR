...
## SYNOPSIS
Interrompe uma sessão do Spark de Análise de Sinapse.
...
## DESCRIPTION
O cmdlet **Stop-AzSynapseSparkSession** interrompe uma sessão synapse Analytics Spark.
...
Este comando interrompe uma sessão de Spark de Análise de Synapse.
...
Este comando interrompe uma sessão de Spark de Análise de Synapse por meio do pipeline.
