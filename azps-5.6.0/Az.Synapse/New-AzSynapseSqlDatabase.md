...
## SYNOPSIS
Cria um banco de dados do Synapse Analytics SQL.
...
## DESCRIPTION
O cmdlet **Get-AzSynapseSqlDatabase** obtém informações sobre um banco de dados do Azure Synapse Analytics SQL.
...
Este comando cria um banco de dados do Azure Synapse Analytics SQL.
...
### -Collation
O collation define as regras que classificar e comparar dados e não pode ser alterado após a criação SQL pool.
O collation padrão é SQL_Latin1_General_CP1_CI_AS.
...
### -Tag
Uma cadeia de caracteres, um dicionário de cadeias de caracteres de marcas associadas ao recurso.
