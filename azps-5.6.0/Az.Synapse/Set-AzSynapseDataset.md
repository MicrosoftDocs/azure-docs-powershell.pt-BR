...
Este comando cria um grupo de dados chamado ContosoDataset no espaço de trabalho chamado ContosoWorkspace.
O comando baseia o conjuntos de dados em informações no arquivo Dataset.json.
