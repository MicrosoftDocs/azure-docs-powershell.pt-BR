...
## SYNOPSIS
Suspende um pool do Synapse Analytics SQL.
...
## DESCRIPTION
O cmdlet **Suspend-AzSynapseSqlPool** suspende um pool do Azure Synapse Analytics SQL pool.
...
Este comando suspende um pool ativo do Azure Synapse Analytics SQL pool.
