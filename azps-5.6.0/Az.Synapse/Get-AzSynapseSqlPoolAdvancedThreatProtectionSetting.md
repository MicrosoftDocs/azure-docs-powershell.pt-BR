...
## SYNOPSIS
Obtém as configurações avançadas de proteção contra ameaças para SQL pool.
...
## DESCRIPTION
O cmdlet **Get-AzSynapseSqlPoolAdvancedThreatProtectionSetting** obtém as configurações avançadas de proteção contra ameaças de um pool do Azure Synapse Analytics SQL.
...
Este comando obtém as configurações avançadas de proteção contra ameaças para um pool SQL chamado ContosoSqlPool no espaço de trabalho chamado ContosoWorkspace.
