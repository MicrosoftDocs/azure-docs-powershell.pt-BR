...
## SYNOPSIS
Assine o gatilho do evento para eventos de serviço externos.
...
## DESCRIPTION
O cmdlet **Add-AzSynapseTriggerSubscription** assina o gatilho de eventos para os eventos de serviço externo especificados a partir da definição do gatilho.
...
Este comando assinará o gatilho chamado ContosoTrigger para os eventos especificados na definição do gatilho.
...
Este comando assinará o gatilho chamado ContosoTrigger para os eventos especificados a partir da definição do gatilho por pipeline.
