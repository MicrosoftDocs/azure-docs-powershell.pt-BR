...
## SYNOPSIS
Obtém os tipos de informações recomendados e os rótulos de sensibilidade das colunas no pool SQL de dados.
...
## DESCRIPTION
O Get-AzSynapseSqlPoolSensitivityRecommendation cmdlet retorna os tipos de informações recomendados e os rótulos de sensibilidade das colunas no pool SQL.

## EXEMPLOS

### Exemplo 1: Obter tipos de informações recomendados e rótulos de sensibilidade de um pool do Azure Synapse SQL pool.
```powershell
...
### Exemplo 2: Obter tipos de informações recomendados e rótulos de sensibilidade de um pool SQL Azure Synapse usando Piping.
```powershell
