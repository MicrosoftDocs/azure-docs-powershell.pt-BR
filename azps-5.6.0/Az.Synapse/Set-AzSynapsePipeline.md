...
Este comando cria um pipeline chamado ContosoPipeline no espaço de trabalho chamado ContosoWorkspace.
O comando baseia o pipeline em informações no arquivo pipeline.json.
...
Este comando cria um pipeline chamado ContosoPipeline no espaço de trabalho chamado ContosoWorkspace por pipeline.
O comando baseia o pipeline em informações no arquivo pipeline.json.
Esse arquivo inclui informações sobre atividades.
