...
## SYNOPSIS
Obtém um pool de análise SQL Synapse.
...
## DESCRIPTION
O cmdlet **Get-AzSynapseSqlPool** obtém informações sobre um pool do Azure Synapse Analytics SQL pool.
...
Esse comando obtém todos os SQL pools em um espaço de trabalho.
...
Este comando obtém o pool SQL no espaço de trabalho ContosoWorkspace com o nome ContosoSqlPool.
...
Esse comando obtém o pool SQL com a ID de recurso especificada.
...
### -Version
[Esse recurso está em uma visualização limitada, inicialmente acessível apenas a determinadas assinaturas.] Versão do pool SQL Synapse. Por exemplo, 2 ou 3.
