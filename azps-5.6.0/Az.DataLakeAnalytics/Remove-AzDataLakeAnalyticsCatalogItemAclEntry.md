...
## SYNOPSIS
Exclui uma entrada da ACL de um item de catálogo ou catálogo no Data Lake Analytics.
...
## DESCRIPTION
O cmdlet **Remove-AzDataLakeAnalyticsCatalogItemAclEntry** remove uma entrada (ACE) da lista de controle de acesso (ACL) de um item de catálogo ou catálogo no Data Lake Analytics.
...
Este comando remove o catálogo ACL para Patti Fuller da conta contosoadla.
...
Este comando remove o banco de dados ACL de Patti Fuller da conta contosoadla.
