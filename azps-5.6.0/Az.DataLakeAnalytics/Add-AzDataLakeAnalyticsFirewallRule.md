...
Este comando adiciona a regra de firewall chamada "minha regra de firewall" da conta "ContosoAdlAcct" com o intervalo de IP: 127.0.0.1 - 127.0.10

## PARÂMETROS

### -Account
A conta do Data Lake Analytics para adicionar a regra de firewall
