...
## SYNOPSIS
Modifica uma entrada na ACL de um item de catálogo ou catálogo no Data Lake Analytics.
...
## DESCRIPTION
O cmdlet **Set-AzDataLakeAnalyticsCatalogItemAclEntry** adiciona ou modifica uma entrada (ACE) na lista de controles de acesso (ACL) de um item de catálogo ou catálogo no Data Lake Analytics.
...
Este comando modifica o ACE do catálogo para Patti Fuller ter permissões de leitura.
...
Este comando modifica o ACE do banco de dados para Patti Fuller ter permissões de leitura.
...
Este comando modifica o ACE do catálogo para que outros tenham permissões de leitura.

### Exemplo 4: Modificar outras permissões para um banco de dados
```powershell
...
### Exemplo 5: Modificar permissões de proprietário do usuário para um catálogo
```powershell
...
Este comando define a permissão do proprietário da conta como Read.

### Exemplo 6: Modificar permissões do proprietário do usuário para um banco de dados
```powershell
...
Este comando define a permissão do proprietário do banco de dados como Leitura.
...
### -Group
Definir a entrada ACL do catálogo para o grupo.
...
### -GroupOwner
Definir a entrada ACL do catálogo para o proprietário do grupo.
...
### -Other
Definir a entrada ACL do catálogo para outro.
...
### -UserOwner
Definir a entrada ACL do catálogo para o proprietário do usuário.
...
[O U-SQL agora oferece controle de acesso de nível de banco de dados](https://github.com/Azure/AzureDataLake/blob/master/docs/Release_Notes/2016/2016_08_01/USQL_Release_Notes_2016_08_01.md#u-sql-now-offers-database-level-access-control)
