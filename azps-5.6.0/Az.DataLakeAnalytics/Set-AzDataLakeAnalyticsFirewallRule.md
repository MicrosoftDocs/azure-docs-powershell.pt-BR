...
## DESCRIPTION
O cmdlet **Set-AzDataLakeAnalyticsFirewallRule** atualiza uma regra de firewall em uma conta do Azure Data Lake Analytics.

## EXEMPLOS

### Exemplo 1: atualizar uma regra de firewall
```
...
Este comando atualiza a regra de firewall chamada "minha regra de firewall" na conta "ContosoAdlAcct" para ter o novo intervalo de IP: 127.0.0.1 - 127.0.0.10

## PARÂMETROS

### -Account
A conta do Data Lake Analytics para atualizar a regra de firewall em
...
### -EndIpAddress
O final do intervalo ip válido para a regra de firewall
...
### -StartIpAddress
O início do intervalo ip válido para a regra de firewall
