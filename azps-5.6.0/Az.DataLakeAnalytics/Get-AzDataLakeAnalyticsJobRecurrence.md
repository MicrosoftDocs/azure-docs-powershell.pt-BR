...
## SYNOPSIS
Obtém um Trabalho de Análise do Data Lake recorrências ou recorrências.
...
## DESCRIPTION
**Get-AzDataLakeAnalyticsJobRecurrence** obtém uma recorrência especificada do Trabalho de Análise do Azure Data Lake ou uma lista de recorrência.
...
Este comando obtém a recorrência de trabalho especificada com a id '83cb7ad2-3523-4b82-b909-d478b0d8aea3' na conta 'contosoadla'.
...
Este comando obtém uma lista de todas as recorrências na conta "contosoadla"
...
### -RecurrenceId
ID da recorrência de trabalho específica para retornar informações.
