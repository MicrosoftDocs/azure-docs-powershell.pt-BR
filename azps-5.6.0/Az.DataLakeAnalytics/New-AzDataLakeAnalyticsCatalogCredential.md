...
Este comando cria a credencial especificada para a conta, banco de dados, host e porta especificada usando o protocolo https.

### Exemplo 2: Criar uma credencial para um catálogo especificando URI completo
```
PS C:\> New-AzDataLakeAnalyticsCatalogCredential -AccountName "ContosoAdlAccount" `
                  -DatabaseName "databaseName" `
                  -CredentialName "exampleDbCred" `
...
Este comando cria a credencial especificada para a conta especificada, banco de dados e URI de fonte de dados externos.
