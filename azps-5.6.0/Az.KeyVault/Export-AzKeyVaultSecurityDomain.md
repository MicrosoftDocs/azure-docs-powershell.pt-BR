...
Este comando recupera o HSM gerenciado chamado testmhsm e salva um backup desse domínio de segurança HSM gerenciado no arquivo de saída especificado.

## PARÂMETROS

### -Certificates
Caminhos para os certificados usados para criptografar os dados de domínio de segurança.
...
### -OutputPath
Especifique o caminho para o qual os dados de domínio de segurança serão baixados.
