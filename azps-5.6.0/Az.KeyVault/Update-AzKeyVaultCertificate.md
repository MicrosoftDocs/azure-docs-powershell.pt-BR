...
O primeiro comando atribui uma matriz de pares de chave/valor à $Tags variável.
O segundo comando define o valor de marcas do certificado chamado TestCert01 como $Tags.
...
### -Enable
Se presente, habilita um certificado se o valor for verdadeiro.
Desabilite um certificado se o valor for false.
...
Se essa opção for especificada, retorne o objeto certificate.
...
### -Tag
Uma hashtable que representa marcas de certificado.
...
O cmdlet constrói o FQDN de um certificado a partir do nome do cofre, do ambiente selecionado no momento, do nome do certificado e da versão do certificado.
