...
## SYNOPSIS
Regenera a chave especificada da Conta de Armazenamento gerenciada do Azure Vault.
...
## DESCRIPTION
Regenera a chave especificada da Conta de Armazenamento gerenciada do Azure Vault e define a chave como a chave ativa. O Key Vault proxies the call to Azure Resource Manager to regenerate the key. O chamador deve possuir permissões para regenerar chaves em determinada Conta de Armazenamento do Azure.
...
Regenera 'key1' da conta 'mystorageaccount' e define 'key1' como o ativo da Conta de Armazenamento gerenciada do Azure Key Vault.
...
### -KeyName
Nome da chave da conta de armazenamento para se regenerar e tornar ativo.
