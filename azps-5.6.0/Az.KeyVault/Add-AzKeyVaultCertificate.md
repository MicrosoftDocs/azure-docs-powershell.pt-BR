...
## DESCRIPTION
O cmdlet **Add-AzKeyVaultCertificate** inicia o processo de inscrição para um certificado em um cofre de chaves no Azure Key Vault.
...
O primeiro comando usa o cmdlet New-AzKeyVaultCertificatePolicy para criar uma política de certificado e a armazena na variável $Policy.
O segundo comando usa **Add-AzKeyVaultCertificate** para iniciar o processo para criar um certificado.
O terceiro comando usa o cmdlet Get-AzKeyVaultCertificateOperation para sondar a operação para verificar se ela está concluída.
