...
## DESCRIPTION
O cmdlet **Get-AzKeyVaultCertificateIssuer** obtém um emissor de certificado especificado ou todos os emissores de certificado para um cofre de chaves no Azure Key Vault.
...
Este comando obtém o emissor de certificado chamado TestIssuer01.
...
Este comando obtém os emissores de certificado que começam com "test".
...
### -Name
Especifica o nome do emissor do certificado a ser obter.
