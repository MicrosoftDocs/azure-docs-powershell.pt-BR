...
## SYNOPSIS
Faça backup total de um HSM gerenciado.
...
## DESCRIPTION
Faça backup total de um HSM gerenciado em uma conta de armazenamento.
...
O cmdlet criará uma pasta (normalmente chamada ) no contêiner de armazenamento, armazenará o backup nessa pasta e gerará o `mhsm-{name}-{timestamp}` URI da pasta.
