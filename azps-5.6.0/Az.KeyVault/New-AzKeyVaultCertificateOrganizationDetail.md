...
O primeiro comando cria um objeto de detalhes do administrador de certificados e o armazena na variável $AdminDetails certificado.
O segundo comando cria um objeto de detalhes da organização do certificado e o armazena na variável $OrgDetails certificado.
