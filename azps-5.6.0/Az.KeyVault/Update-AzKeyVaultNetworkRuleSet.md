...
## SYNOPSIS
Atualiza a regra de rede definida em um cofre de chaves.
...
## DESCRIPTION
O **comando Update-AzKeyVaultNetworkRuleSet** atualiza as regras de rede em vigor no cofre de chaves especificado. 
...
Este comando atualiza o ruleset de rede no cofre chamado 'myVault' para o intervalo DE IP especificado e a rede virtual, permitindo ignorar a regra de rede para serviços do Azure.

### Exemplo 2

Atualiza a regra de rede definida em um cofre de chaves. (gerado automaticamente)
