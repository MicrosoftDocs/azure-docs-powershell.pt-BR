...
## SYNOPSIS
Recupera uma conta de armazenamento gerenciada por KeyVault excluída anteriormente.
...
## DESCRIPTION
O comando **Undo-AzKeyVaultManagedStorageAccountRemoval** recupera uma conta de armazenamento gerenciado excluída anteriormente, desde que a exclusão suave seja habilitada para esse cofre e que a tentativa de recuperação ocorra durante o intervalo de recuperação.
...
### -InputObject
Objeto Conta de Armazenamento Gerenciado Excluído
...
### -Name
Nome da conta de armazenamento gerenciado KeyVault.
O cmdlet constrói o FQDN do destino a partir do nome do cofre, do ambiente selecionado no momento e do nome da conta de armazenamento gerenciado.
