...
## SYNOPSIS
Recupera um certificado excluído em um cofre de chaves em um estado ativo.
...
Este comando recuperará o certificado 'MyCertificate' que foi excluído anteriormente, em um estado ativo e acessível.
