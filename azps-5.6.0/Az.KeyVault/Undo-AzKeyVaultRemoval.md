...
## SYNOPSIS
Recupera um cofre de chaves excluído em um estado ativo.
...
## DESCRIPTION
O cmdlet **Undo-AzKeyVaultRemoval** recuperará um cofre de chaves excluído anteriormente. O cofre recuperado estará ativo após a recuperação
...
Este comando recuperará o cofre de chaves 'MyKeyVault' que foi excluído anteriormente da região eastus2 e do grupo de recursos 'MyResourceGroup', em um estado ativo e usável. Ele também substitui as marcas por uma nova marca.
