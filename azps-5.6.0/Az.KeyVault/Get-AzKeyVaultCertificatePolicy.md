...
## SYNOPSIS
Obtém a política de um certificado em um cofre de chaves.
...
## DESCRIPTION
O cmdlet **Get-AzKeyVaultCertificatePolicy** obtém a política de um certificado em um cofre de chaves no Azure Key Vault.
...
Este comando obtém a política de certificado para o certificado TestCert01 no cofre de chaves ContosoKV01.
