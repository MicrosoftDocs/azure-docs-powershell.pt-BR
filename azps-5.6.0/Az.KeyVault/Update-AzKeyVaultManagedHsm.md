...
Atualiza marcas para o Hsm gerenciado nomeado `$hsmName` no grupo de recursos `$resourceGroupName` .

### Exemplo 2: atualizar um Hsm gerenciado usando a canalização
```powershell
...
Atualiza marcas para o Hsm gerenciado usando a sintaxe de canalização.
...
### -ResourceId
ID de recurso do HSM gerenciado.
