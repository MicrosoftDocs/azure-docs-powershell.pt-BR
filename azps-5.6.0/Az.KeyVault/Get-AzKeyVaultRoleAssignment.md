...
## SYNOPSIS
Obter ou listar atribuições de função de um HSM gerenciado. Use os parâmetros respectivos para listar atribuições para um usuário específico ou uma definição de função.
...
Este exemplo lista todas as atribuições de função de "myHsm" no escopo "/keys" e filtra o resultado pelo nome de login do usuário.
