...
Habilita a proteção de limpeza usando a sintaxe de canalização.
...
Habilita a Autorização do RBAC usando a sintaxe de canalização.
...
Habilita a funcionalidade de proteção de limpeza para esse cofre de chaves.
Depois de habilitado, não é possível desabilitá-lo.
Ele exige que a exclusão suave seja 100% 10.
...
Habilitar ou desabilitar esse cofre de chaves para autorizar ações de dados pelo Controle de Acesso Baseado em Função (RBAC).
