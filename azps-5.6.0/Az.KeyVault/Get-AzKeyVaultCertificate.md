...
## DESCRIPTION
O cmdlet **Get-AzKeyVaultCertificate** obtém o certificado especificado ou as versões de um certificado de um cofre de chaves no Azure Key Vault.
...
### Exemplo 2: Obter certificado e salvá-lo como pfx
Este comando obtém o certificado chamado TestCert01 do cofre de chaves chamado ContosoKV01. Para baixar o certificado como arquivo pfx, execute o seguinte comando. Esses comandos acessam SecretId e salvam o conteúdo como um arquivo pfx.
...
### Exemplo 3: Obter todos os certificados que foram excluídos, mas não limpos para este cofre de chaves.
```powershell
...
Este comando obtém todos os certificados que foram excluídos anteriormente, mas não limpos, no cofre de chaves chamado Contoso.

### Exemplo 4: Obtém o certificado MyCert que foi excluído, mas não limpo para esse cofre de chaves.
```powershell
...
Este comando obtém o certificado chamado 'MyCert' que foi excluído anteriormente, mas não limpo, no cofre de chaves chamado Contoso.
Este comando retornará metadados, como a data de exclusão e a data de exclusão agendada deste certificado excluído.

### Exemplo 5: Listar certificados usando filtragem
```powershell
...
### -IncludePending
Especifica se deve incluir certificados pendentes na saída
...
### -InRemovedState
Especifica se deve incluir certificados excluídos anteriormente na saída
