...
## SYNOPSIS
Obtém definições de SAS de armazenamento gerenciado do Cofre de Chaves.
...
## DESCRIPTION
Obtém uma Definição SAS de Armazenamento gerenciado do Cofre de Chaves se o nome da definição for especificado. Se o nome da definição não for especificado, todas as definições SAS associadas à Conta de Armazenamento gerenciada do Cofre de Chaves especificada no cofre serão listadas.
...
Lista todas as definições do SAS associadas à conta de armazenamento gerenciada do Cofre de Chaves 'mystorageaccount' gerenciada pelo cofre 'myvault'

### Exemplo 2: Obter uma conta de armazenamento gerenciada do Cofre de Chaves
```powershell
...
Obtém os detalhes de 'accountsas' de definição do SAS associados à conta de armazenamento gerenciada do Cofre de Chaves 'mystorageaccount' gerenciada pelo cofre 'myvault'.

### Exemplo 3: Listar todas as definições de SAS de armazenamento gerenciado do Cofre de Chaves usando filtragem
```powershell
...
Lista todas as definições SAS associadas à conta de armazenamento gerenciada do Cofre de Chaves 'mystorageaccount' gerenciada pelo cofre 'myvault' que começam com "conta".
...
### -InRemovedState
Especifica se as definições de sas de armazenamento excluídas anteriormente serão especificadas na saída.
