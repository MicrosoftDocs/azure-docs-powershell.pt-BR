...
## DESCRIPTION
O cmdlet **Get-AzKeyVault** obtém informações sobre os cofres de chaves em uma assinatura. Você pode exibir todas as instâncias de cofres-chave em uma assinatura ou filtrar seus resultados por um grupo de recursos ou um cofre de chaves específico.
Observe que, embora a especificação do grupo de recursos seja opcional para este cmdlet quando você obter um único cofre de chaves, você deve fazer isso para melhorar o desempenho.

## EXEMPLOS

### Exemplo 1: Obter todos os cofres de chaves em sua assinatura atual
```powershell
PS C:\> Get-AzKeyVault
...
Este comando obtém o cofre de chaves chamado myvault em sua assinatura atual.
...
Este comando obtém todos os cofres de chave no grupo de recursos chamado ContosoPayRollResourceGroup.

### Exemplo 4: Obter todos os cofres de chaves excluídos em sua assinatura atual
```powershell
...
Este comando obtém todos os cofres de chave excluídos na assinatura atual.
...
### Exemplo 6: Obter cofres de chaves usando filtragem
```powershell
PS C:\> Get-AzKeyVault -VaultName 'myvault*'
...
Este comando obtém todos os cofres de chave na assinatura que começam com "myvault".
...
### -InRemovedState
Especifica se os cofres excluídos anteriormente serão indicados na saída.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos associado ao cofre de chaves ou aos cofres chave que estão sendo consultados.
