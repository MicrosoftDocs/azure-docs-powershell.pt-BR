...
## DESCRIPTION
O cmdlet **Stop-AzKeyVaultCertificateOperation** cancela uma operação de certificado no serviço do Azure Key Vault.
...
Este comando cancela a operação de certificado TestCert02.
