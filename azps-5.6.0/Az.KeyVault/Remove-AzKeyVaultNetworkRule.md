...
Este comando remove uma regra de rede do cofre especificado, desde que uma regra seja encontrada correspondendo ao endereço IP especificado e ao identificador de recurso de rede virtual.
