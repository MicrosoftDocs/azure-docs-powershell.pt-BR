...
Essa chave é uma réplica da chave de backup no arquivo de entrada e tem o mesmo nome que a chave original.
Se o cofre de chaves já tiver uma chave com o mesmo nome, esse cmdlet falhará em vez de sobrescrever a chave original.
Se o backup contiver várias versões de uma chave, todas as versões serão restauradas.
O cofre de chaves em que você restaura a chave pode ser diferente do cofre de chaves do que você fez backup da chave.
...
Consulte o Centro de Confiança do Microsoft Azure ( https://azure.microsoft.com/support/trust-center/) para o mapeamento de regiões do Azure para geografias.
...
Este comando restaura uma chave, incluindo todas as suas versões, do arquivo de backup chamado Backup.blob para o cofre de chaves chamado MyKeyVault.
...
### -VaultName
Especifica o nome do cofre de chaves no qual restaurar a chave.
