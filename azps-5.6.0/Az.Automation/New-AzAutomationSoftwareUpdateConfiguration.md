...
## DESCRIPTION
Cria uma configuração de atualização de software que é executado em um cronograma para atualizar uma lista de computadores. Os computadores incluem máquinas virtuais do azure ou computadores que não são do az.

## EXEMPLOS

### Exemplo 1
Cria uma configuração de atualização de software para instalar atualizações críticas em duas máquinas virtuais do Windows azure uma vez a cada sábado às 21h. A duração da atualização é definida como 2 horas neste exemplo.
...
### -AzureQuery
Consulta dinâmica do azure do grupo.
...
Incluídas máscaras de pacote linux.
...
Incluídas as classificações do Windows Update.
...
### -Linux
Indica que a configuração de atualização de software visando computadores do sistema operacional Linux.
...
### -NonAzureQuery
Consulta de grupo dinâmico não Azure.
...
### -RebootOnly
Indica que a configuração de atualização de software reiniciará somente os máquinas.
...
### -Schedule
Objeto Schedule usado para configuração de atualização de software.
...
### -Windows
Indica que a configuração de atualização de software destinado a computadores do sistema operacional windows.
