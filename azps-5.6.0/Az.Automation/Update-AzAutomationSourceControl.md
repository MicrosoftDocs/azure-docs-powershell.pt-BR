...
ms.locfileid: "101891411"
---
# Update-AzAutomationSourceControl

## SYNOPSIS
Atualiza um controle de origem da Automação do Azure.
...
## DESCRIPTION
O Update-AzAutomationSourceControl cmdlet modifica o valor de um campo em um controle de origem no Azure Automation.

## EXEMPLOS

### Exemplo 1
Este comandos define o campo PublishRunbook como false para o controle de origem da Automação do Azure chamado VSTSNative na conta chamada devAccount.
...
Atualiza um controle de origem da Automação do Azure. (gerado automaticamente)
...
### -Branch
O branch de controle de origem.
