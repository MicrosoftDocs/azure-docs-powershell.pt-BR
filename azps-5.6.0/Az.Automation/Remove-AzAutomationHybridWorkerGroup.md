...
## SYNOPSIS
Remove o grupo de trabalho híbrido da Automação.
...
## DESCRIPTION
O Remove-AzAutomationHybridWorkerGroup cmdlet remove um grupo de trabalho híbrido da Automação.

## EXEMPLOS

### Exemplo 1
Este comando remove um trabalhador híbrido pelo nome.
...
### -Name
O nome do grupo de trabalho híbrido.
