...
Este comando remove um webhook chamado Webhook11 na conta de automação chamada AutomationAccount01.
...
Especifica o nome de uma conta de automação da qual este cmdlet remove um webhook.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos para o qual este cmdlet remove um webhook.
