...
## DESCRIPTION
O cmdlet **New-AzAutomationCertificate** cria um certificado no Azure Automation.
Forneça o caminho para um arquivo de certificado a ser carregado.
...
O primeiro comando converte uma senha de texto simples para ser uma cadeia de caracteres segura usando o cmdlet ConvertTo-SecureString de texto.
...
Especifica o nome da conta automação para a qual esse cmdlet armazena o certificado.
...
### -Description
Especifica uma descrição do certificado.
...
### -Path
Especifica o caminho para um arquivo de script que esse cmdlet carrega.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos para o qual este cmdlet cria um certificado.
