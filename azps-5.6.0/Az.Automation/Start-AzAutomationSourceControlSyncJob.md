...
## SYNOPSIS
Inicia um trabalho de sincronização de controle de origem da Automação do Azure.
...
## DESCRIPTION
O Start-AzAutomationSourceControlSyncJob cmdlet inicia um trabalho de sincronização de controle de origem da Automação do Azure para o nome de controle de origem determinado.
