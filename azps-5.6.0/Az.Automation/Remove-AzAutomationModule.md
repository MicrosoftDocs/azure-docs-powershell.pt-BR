...
## DESCRIPTION
O cmdlet **Remove-AzAutomationModule** remove um módulo de uma conta de automação no Azure Automation.
...
Este comando remove um módulo chamado ContosoModule da conta de automação chamada Contoso17.

## PARÂMETROS

### -AutomationAccountName
Especifica o nome da conta de automação da qual este cmdlet remove um módulo.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos no qual este cmdlet remove um módulo.
