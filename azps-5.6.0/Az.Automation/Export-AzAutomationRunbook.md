...
## DESCRIPTION
O cmdlet **Export-AzAutomationRunbook** exporta um runbook de Automação do Azure para um arquivo de script do wps_2 (.ps1 ), para runbooks de fluxo de trabalho wps_2 ou wps_2 ou para um arquivo de runbook gráfico (.graphrunbook) para runbooks gráficos.
...
### -Name
Especifica o nome do runbook que esse cmdlet exporta.
