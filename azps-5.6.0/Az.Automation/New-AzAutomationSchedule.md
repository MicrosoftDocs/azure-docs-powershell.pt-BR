...
## DESCRIPTION
O cmdlet **New-AzAutomationSchedule** cria uma agenda no Azure Automation.

## EXEMPLOS

### Exemplo 1: Criar um agendamento único em horário local
```
...
O primeiro comando obtém a ID do fuso horário do sistema e armazena-a na variável $TimeZone de tempo.
...
O primeiro comando cria um objeto date usando o cmdlet **Get-Date** e armazena o objeto na variável $StartDate.
Especifique uma hora que seja pelo menos cinco minutos no futuro.
O segundo comando cria um objeto date usando o cmdlet **Get-Date** e armazena o objeto na variável $EndDate.
O comando especifica uma hora futura.
O comando final cria uma agenda diária chamada Agenda02 para começar no momento armazenado no $StartDate e expirar no momento armazenado no $EndDate.

### Exemplo 3: Criar uma agenda recorrente semanal
```
...
O comando final cria uma agenda diária chamada Agenda03 que será executado de segunda a sexta-feira a cada semana às 13:00. O cronograma nunca expirará.
...
### -DayInterval
Especifica um intervalo, em dias, para o agendamento.
...
### -ExpiryTime
Especifica o tempo de expiração de um agendamento como **um objeto DateTimeOffset.**
...
### -StartTime
Especifica a hora de início de um agendamento como **um objeto DateTimeOffset.**
Você pode especificar uma cadeia de caracteres que pode ser convertida em **um DateTimeOffset válido.**
...
### -TimeZone
Especifica o fuso horário do agendamento.
