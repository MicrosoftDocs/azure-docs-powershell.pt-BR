...
## DESCRIPTION
O cmdlet **Export-AzAutomationDscNodeReportContent** exporta o conteúdo bruto de um relatório de Configuração de Estado Desejado (DSC) do APS.
...
Este cmdlet exporta conteúdo de relatório para um nó DSC que pertence à conta de Automação especificada por esse parâmetro.
...
Este cmdlet exporta o conteúdo de um relatório para o nó DSC que pertence ao grupo de recursos especificado pelo cmdlet.
