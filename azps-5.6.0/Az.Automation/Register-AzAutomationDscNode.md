...
### -ActionAfterReboot
Especifica a ação que a máquina virtual toma após a reinicialização.
...
Especifica se as novas configurações que esse nó DSC baixa do servidor pull do Azure Automation DSC substituem os módulos existentes já no nó de destino.
...
### -AzureVMName
O nome da máquina virtual do Azure a ser registrado para gerenciamento com o Azure Automation DSC.
...
### -ConfigurationMode
Especifica o modo de configuração do DSC.
Os valores válidos são: 
- ApplyAndMonitor 
- ApplyAndAutocorrect 
- ApplyOnly
...
Especifica o nome da configuração do nó que esse cmdlet configura a máquina virtual a ser puxada do Azure Automation DSC.
...
Especifica a frequência, em minutos, na qual o Gerenciador de Configurações local contata o servidor pull do Azure Automation DSC para baixar a configuração de nó mais recente.
