...
Este comando remove o runbook chamado Runbook03 na conta de Automação do Azure chamada Contoso17.

## PARÂMETROS

### -AutomationAccountName
Especifica o nome da conta de automação na qual este cmdlet remove um runbook.
