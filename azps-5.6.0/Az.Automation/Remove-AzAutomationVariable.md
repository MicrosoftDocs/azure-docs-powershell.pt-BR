...
## SYNOPSIS
Remove uma variável automation.
...
Este comando remove uma variável chamada StringVariable22 na conta de automação chamada Contoso17.
...
Especifica o nome da conta de automação que contém a variável que esse cmdlet exclui.
...
### -Name
Especifica o nome da variável que esse cmdlet exclui.
