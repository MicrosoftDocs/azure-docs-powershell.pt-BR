...
Este comando obtém toda a saída do trabalho que tem a ID especificada.

## PARÂMETROS

### -AutomationAccountName
Especifica o nome de uma conta de automação para a qual este cmdlet obtém saída de trabalho.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos para o qual este cmdlet obtém saída de trabalho.
...
O cmdlet recupera a saída criada após esse tempo.
