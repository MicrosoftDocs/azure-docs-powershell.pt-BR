...
Este comando desabilita um webhook chamado Webhook01 na conta de automação chamada AutomationAccount01.
...
Este comando define o valor de executar no webhook e força o runbook a ser executado em um grupo de Trabalhadores Híbridos chamado Windows.
...
Esse comando atualiza o valor de executar no webhook e força o runbook a ser executado em um trabalhador de runbook do Azure. 
...
### -ResourceGroupName
Especifica o nome do grupo de recursos para o qual este cmdlet modifica um webhook.
