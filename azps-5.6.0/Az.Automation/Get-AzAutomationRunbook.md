...
Este comando obtém todos os runbooks na conta de Automação do Azure chamada Contoso17.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos para o qual este cmdlet obtém runbooks.
