...
## DESCRIPTION
O cmdlet **Remove-AzAutomationConnection** remove uma conexão do Azure Automation.
...
Este comando remove um certificado chamado ContosoConnection na conta de automação chamada Contoso17.
