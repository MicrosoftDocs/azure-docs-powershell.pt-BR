...
## SYNOPSIS
Remove as configurações do DSC da Automação.
...
## DESCRIPTION
O cmdlet **Remove-AzAutomationDscConfiguration** remove as configurações do APS Desired State Configuration (DSC) da Automação do Azure.

## EXEMPLOS

### Exemplo 1

Remove as configurações do DSC da Automação. (gerado automaticamente)
...
Especifica o nome da conta de automação que contém configurações DSC que este cmdlet remove.
