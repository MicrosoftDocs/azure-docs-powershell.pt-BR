...
O primeiro comando obtém uma variável automation chamada Variable06 na conta chamada Contoso17.
O comando armazena esse objeto na variável $Variable.
O segundo comando usa notação de ponto padrão para se referir à **propriedade value** de $Variable.
O comando armazena o valor na variável $value.

## PARÂMETROS

### -AutomationAccountName
Especifica o nome da conta de automação que contém as variáveis que esse cmdlet obtém.
...
### -Name
Especifica o nome de uma variável que esse cmdlet obtém.
