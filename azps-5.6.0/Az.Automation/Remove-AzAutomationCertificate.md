...
Este comando remove um certificado chamado Cert01 na conta de automação chamada Contoso17.

## PARÂMETROS

### -AutomationAccountName
Especifica o nome da conta de automação para a qual este cmdlet remove um certificado.
