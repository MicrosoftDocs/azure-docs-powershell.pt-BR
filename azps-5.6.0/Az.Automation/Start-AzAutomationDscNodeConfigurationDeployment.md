...
## DESCRIPTION
O cmdlet **Start-AzAutomationDscNodeConfigurationDeployment** implanta uma configuração de nó DSC (Configuração de Estado Desejado) no Azure Automation.
...
O comando acima implanta a configuração de nó DSC chamada "Config01.Node1" à matriz bidimensional de Nomes de Nó. A implantação acontece em estágios.

### Exemplo 2: Agendar uma implantação de configuração de nó do Azure DSC na Automação
```
...
O comando acima agenda uma implantação de uma configuração de nó DSC chamada "Config01.Node1" para a determinada matriz bidimensional de Nomes de Nó. A implantação acontece em estágios e será executada com base na agenda.
