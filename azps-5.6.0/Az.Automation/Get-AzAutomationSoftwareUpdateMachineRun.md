...
## SYNOPSIS
Obtém uma lista de máquinas de configuração de atualização de software de automação do azure executados.
...
## DESCRIPTION
Este cmdlet retorna uma lista de executações de máquina. Cada execução de atualização de software disparará uma máquina em execução para cada um dos dispositivos de destino de configuração de atualização de software. Para executar uma máquina específica, passe o parâmetro Id. Você pode listar todas as executações do computador, todas as executados para um computador específico, todas são executados com status específico passando os parâmetros correspondentes.

## EXEMPLOS

### Exemplo 1
Este exemplo retorna todas as executações de máquina com falha para a máquina virtual do azure especificada.
...
### -Id
Id do computador de atualização de software executado.
...
### -SoftwareUpdateRunId
Id da atualização de software executado.
...
### -Status
Status do computador executado.
...
### -TargetComputer
computador de destino para a operação do computador.
