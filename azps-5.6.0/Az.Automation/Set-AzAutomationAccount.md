...
### Exemplo 1: definir as marcas de uma conta de automação
```
...
Este comando altera o plano para Basic para a conta de automação chamada AutomationAccount01.
...
### -Name
Especifica o nome da conta de automação que este cmdlet modifica.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos que contém a conta de automação que este cmdlet modifica.
