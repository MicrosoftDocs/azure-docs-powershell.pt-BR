...
### Obter todos os serviços SignalR na assinatura
```
PS C:\> Get-AzSignalR
...
### Obter todos os serviços signalr em um grupo de recursos
```
...
### Obter um serviço SignalR específico
```
...
### Obter um serviço SignalR específico do grupo de recursos padrão
```
