...
## DESCRIPTION
O Update-AzSqlVM atualiza uma máquina virtual sql.
...
### -LicenseType
SQL tipo de licença de máquina virtual.
...
### -ResourceId
SQL id de recurso de máquina virtual.
...
### -Sku
SQL tipo de edição de máquina virtual.
...
### -SqlManagementType
SQL tipo de gerenciamento de máquina virtual.
...
### -Tag
As marcas a associar à máquina SQL virtual
