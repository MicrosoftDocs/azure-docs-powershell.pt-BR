...
Exclui o Ouvinte do Grupo de Disponibilidade AgListener01 no Grupo de Disponibilidade AvailabilityGroup01.
...
### -PassThru
Especifica se o recurso excluído deve ser produzido no final da execução do cmdlet.
