...
## DESCRIPTION
O New-AzSqlVM cmdlet cria uma máquina virtual do Azure SQL virtual.
...
Cria uma nova máquina SQL virtual do Azure com nome vm no grupo de recursos ResourceGroup01 
