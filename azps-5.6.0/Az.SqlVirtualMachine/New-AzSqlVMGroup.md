...
## DESCRIPTION
O cmdlet New-AzSqlVMGroup cria um grupo de máquinas SQL virtual do Azure.
...
Cria um novo grupo de máquinas virtuais do Azure SQL com vm de grupo de teste no grupo de recursos ResourceGroup01.
...
### -Location
SQL local do grupo de máquinas virtuais.
...
### -Offer
SQL de grupo de máquinas virtuais.
...
### -Sku
SQL tipo de edição do grupo de máquinas virtuais.
