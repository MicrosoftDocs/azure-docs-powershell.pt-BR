...
Este comando cria o parceiro de conta de integração chamado IntegrationAccountPartner22 no grupo de recursos especificado.
...
### -PartnerName
Especifica um nome para o parceiro de conta de integração.
