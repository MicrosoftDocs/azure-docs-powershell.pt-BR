...
## DESCRIPTION
O cmdlet **Start-AzLogicApp** executa um aplicativo lógico usando o recurso Aplicativos Lógicos.
Especifique um nome, grupo de recursos e gatilho.
...
Este comando executa o aplicativo lógico no grupo de recursos chamado ResourceGroup11.
