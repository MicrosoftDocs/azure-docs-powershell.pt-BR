...
Este cmdlet retorna um objeto que representa o mapa da conta de integração.
...
Este comando modifica o mapa da conta de integração no grupo de recursos especificado.
...
Este cmdlet dá suporte a Xslt como um tipo de mapa.
