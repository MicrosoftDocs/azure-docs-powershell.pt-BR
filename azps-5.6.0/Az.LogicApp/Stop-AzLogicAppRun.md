...
## DESCRIPTION
O cmdlet **Stop-AzLogicAppRun** cancela uma executar um aplicativo lógico.
...
### -Name
Especifica o nome de um aplicativo lógico para o qual esse cmdlet cancela uma executar.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos no qual esse cmdlet cancela uma executar.
