...
## SYNOPSIS
Obtém esquemas de conta de integração.
...
## DESCRIPTION
O cmdlet **Get-AzIntegrationAccountSchema** obtém esquemas de conta de integração.
...
Este comando obtém o esquema de conta de integração chamado IntegrationAccountSchema43.

### Exemplo 2: obter esquemas de conta de integração para um grupo de recursos
```
...
Este comando obtém os esquemas de conta de integração do grupo de recursos chamado ResourceGroup11.
