...
## DESCRIPTION
O cmdlet **Set-AzLogicApp** modifica um aplicativo lógico usando o recurso Aplicativos Lógicos.
...
Você pode modificar um aplicativo lógico especificando um nome, local, definição do Aplicativo Lógico, grupo de recursos e plano.
...
Este comando modifica um aplicativo lógico.
