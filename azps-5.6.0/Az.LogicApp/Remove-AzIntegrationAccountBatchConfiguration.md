...
## SYNOPSIS
Remove uma configuração de lote de conta de integração.
...
### Exemplo 1: Remover uma configuração em lote por parâmetros
```powershell
...
Remove a configuração em lote denominada "sampleBatchConfig" localizada na conta de integração "sampleIntegrationAccount".
