...
## SYNOPSIS
Este cmdlet recupera um número de controle de intercâmbio recebido específico por contrato e valor de número de controle.
...
## DESCRIPTION
Esse cmdlet deve ser usado em cenários de recuperação de desastres para validar a presença de um número de controle de intercâmbio recebido e, opcionalmente, remover essa entidade com Remove-AzIntegrationAccountReceivedIcn.
...
Este comando obtém a conta de integração X12 recebida número de controle de intercâmbio pelo nome do contrato e o valor do número de controle.
...
Este comando obtém a conta de integração Edifact recebida número de controle de intercâmbio pelo nome do contrato e o valor do número de controle.
