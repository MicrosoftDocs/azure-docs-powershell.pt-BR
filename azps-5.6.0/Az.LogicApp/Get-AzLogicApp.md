...
Este comando obtém um aplicativo lógico do grupo de recursos chamado ResourceGroup11.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos no qual esse cmdlet obtém um aplicativo lógico.
