...
Este comando modifica o parceiro de conta de integração chamado IntegrationAccountPartner22 no grupo de recursos especificado.
...
Este parâmetro dá suporte ao tipo B2B.
