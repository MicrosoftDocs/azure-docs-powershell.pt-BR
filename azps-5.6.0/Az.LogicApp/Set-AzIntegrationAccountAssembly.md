...
## SYNOPSIS
Modifica um assembly de conta de integração.
...
### Exemplo 1: Modificar um assembly usando o arquivo local
```powershell
...
### Exemplo 2: Modificar um assembly usando dados de byte
```powershell
...
Modifica o assembly chamado "sampleAssembly" usando a matriz de byte contida em "$assemblyContent".
...
Modifica o assembly chamado "sampleAssembly" usando os dados de um byte localizados na URL "$assemblyUrl". Este é o método sugerido para criar assemblies de grande porte.

## PARÂMETROS

### -AssemblyData
Os dados de byte de assembly da conta de integração.
