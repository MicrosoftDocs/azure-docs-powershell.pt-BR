...
### Exemplo 1: Criar novo assembly usando arquivo local
```powershell
...
### Exemplo 2: Criar novo assembly usando dados de byte
```powershell
...
Cria um novo assembly usando a matriz de byte contida em "$assemblyContent".

### Exemplo 3: Criar novo assembly usando um link de conteúdo
```powershell
...
Cria um novo assembly usando os dados de um byte localizados na URL "$assemblyUrl". Este é o método sugerido para criar assemblies de grande porte.
