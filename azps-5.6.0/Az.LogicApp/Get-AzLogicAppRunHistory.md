...
Obtém o histórico de executar um aplicativo lógico.
...
O cmdlet **Get-AzLogicAppRunHistory** obtém o histórico de executar de um aplicativo lógico.
Este cmdlet retorna uma coleção de **objetos WorkflowRun.**
...
### Exemplo 1: Obter o histórico de executar um aplicativo lógico
...
Este comando obtém o histórico de executar um aplicativo lógico chamado LogicApp03.
...
Este comando obtém todo o histórico de executar um aplicativo lógico chamado LogicApp03 seguindo o NextPageLink.
...
Este comando obtém as duas primeiras páginas do histórico de executar um aplicativo lógico chamado LogicApp03 seguindo o NextPageLink e limitando o tamanho do resultado a duas páginas.
...
Especifica o nome do aplicativo lógico para o qual esse cmdlet obtém histórico de executar.
...
Este cmdlet obtém o fluxo de trabalho executado que este cmdlet especifica.
