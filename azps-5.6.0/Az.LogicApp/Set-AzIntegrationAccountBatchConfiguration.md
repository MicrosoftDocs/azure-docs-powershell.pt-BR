...
### Exemplo 1: Modificar uma configuração em lote usando o arquivo local
```powershell
...
Modifique uma configuração em lote chamada "sampleBatchConfig" usando o arquivo local localizado no caminho do arquivo contido em "$batchConfigurationFilePath".

### Exemplo 2: Modificar uma configuração em lote usando uma cadeia de caracteres JSON
```powershell
...
Modifique uma configuração em lote chamada "sampleBatchConfig" usando a cadeia de caracteres JSON contida em "$batchConfigurationContent".

### Exemplo 3: Modificar uma configuração em lote usando parâmetros
```powershell
...
Modifique uma configuração em lote chamada "sampleBatchConfig" fornecendo manualmente todos os parâmetros necessários.
