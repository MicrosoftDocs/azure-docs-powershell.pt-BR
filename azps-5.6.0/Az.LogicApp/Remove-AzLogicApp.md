...
## DESCRIPTION
O cmdlet **Remove-AzLogicApp** remove um aplicativo lógico de um grupo de recursos usando o recurso Aplicativos Lógicos.
...
Este comando remove um aplicativo lógico de um grupo de recursos.
O comando inclui o parâmetro *Force,* que impede que o comando solicitar confirmação.
