...
Este cmdlet retorna um objeto que representa a conta de integração.
...
Este comando modifica uma conta de integração chamada IntegrationAccount31 no grupo de recursos especificado.
