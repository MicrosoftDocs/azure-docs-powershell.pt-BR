...
Este cmdlet retorna um objeto que representa o contrato de conta de integração.
...
### -AgreementContent
Especifica o conteúdo do contrato, no formato JSON (Notação de Objeto JavaScript), para o contrato.
...
### -AgreementType
Especifica o tipo de contrato de conta de integração.
...
Especifica um qualificador de identidade comercial de nome para o parceiro host.
...
### -HostPartner
Especifica o nome do parceiro host.
