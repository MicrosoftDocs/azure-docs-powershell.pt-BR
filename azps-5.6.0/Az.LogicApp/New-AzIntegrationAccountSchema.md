...
## DESCRIPTION
O cmdlet **New-AzIntegrationAccountSchema** cria um esquema de conta de integração.
Este cmdlet retorna um objeto que representa o esquema de conta de integração.
Especifique o nome da conta de integração, o nome do grupo de recursos, o nome do esquema e a definição do esquema.
...
### Exemplo 1: Criar o esquema de conta de integração
```
...
Este comando cria o esquema de conta de integração chamado IntegrationAccountSchema1 no grupo de recursos especificado.
...
Especifique esse parâmetro ou o *parâmetro SchemaFilePath.*
...
Especifique esse parâmetro ou o *parâmetro SchemaDefinition.*
...
### -SchemaName
Especifica um nome para o esquema de conta de integração.
