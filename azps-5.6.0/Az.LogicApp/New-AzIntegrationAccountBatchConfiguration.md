...
## SYNOPSIS
Cria uma configuração de lote de conta de integração.
...
### Exemplo 1: Criar nova configuração em lote usando o arquivo local
```powershell
...
Cria uma nova configuração em lote usando o arquivo local localizado no caminho do arquivo contido em "$batchConfigurationFilePath".

### Exemplo 2: Criar nova configuração em lote usando uma cadeia de caracteres JSON
```powershell
...
Cria uma nova configuração em lote usando a cadeia de caracteres JSON contida em "$batchConfigurationContent".

### Exemplo 3: Criar nova configuração em lote usando parâmetros
```powershell
...
A definição de configuração de lote da conta de integração.
...
O caminho do arquivo de configuração de lote da conta de integração.
...
### -BatchGroupName
O nome do grupo de configuração de lote da conta de integração.
...
### -BatchSize
O tamanho do lote de configuração de lote da conta de integração.
...
### -MessageCount
A contagem de mensagens de configuração de lote de conta de integração.
...
### -Metadados
Os metadados de configuração de lote da conta de integração.
...
### -ParentResourceId
A ID do recurso de configuração de lote da conta de integração.
...
### -ScheduleFrequency
A frequência de agendamento de configuração de lote da conta de integração.
...
### -ScheduleInterval
O intervalo de agendamento de configuração de lote da conta de integração.
...
### -ScheduleStartTime
A hora de início do cronograma de configuração do lote da conta de integração.
...
### -ScheduleTimeZone
O fuso horário de configuração do lote da conta de integração.
