...
Este cmdlet retorna um **objeto WorkflowTriggerCallbackUrl** que representa a URL de retorno de chamada.
...
Este comando obtém uma URL de retorno de chamada de gatilho do Aplicativo Lógico.
