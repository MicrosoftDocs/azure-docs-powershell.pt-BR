...
## DESCRIPTION
O cmdlet **Get-AzIntegrationAccountAgreement** obtém um contrato de conta de integração de um grupo de recursos do Azure.
...
### Exemplo 1: Obter um contrato de conta de integração
```
...
Este comando obtém um contrato de conta de integração chamado IntegrationAccountAgreement06.

### Exemplo 2: Obter contratos de conta de integração pelo nome do grupo de recursos
```
...
Este comando obtém os contratos de conta de integração pelo nome do grupo de recursos.

## PARÂMETROS

### -AgreementName
Especifica o nome de um contrato de conta de integração.
