...
## SYNOPSIS
Adiciona um Certificado de Criptografia de Dados Transparente para a instância SQL Server determinada
...
## DESCRIPTION
O Add-AzSqlManagedInstanceTransparentDataEncryptionCertificate adiciona um Certificado de Criptografia de Dados Transparente para a instância SQL Server determinada
...
Adicionar certificado TDE a um servidor sql usando o nome do grupo de recursos e SQL Server nome
...
### -PassThru
Em Execução bem-sucedida, retorna o objeto certificate que foi adicionado.
...
### -Password
A senha para certificado de criptografia de dados transparentes
