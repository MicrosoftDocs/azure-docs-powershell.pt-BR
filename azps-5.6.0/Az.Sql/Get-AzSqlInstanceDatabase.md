...
## SYNOPSIS
Retorna informações sobre o banco de dados SQL Instância Gerenciada do Azure.
...
## DESCRIPTION
O cmdlet **Get-AzSqlInstanceDatabase** obtém um ou mais bancos de dados do Azure SQL de uma Instância Gerenciada de Banco de Dados do Azure SQL.
...
### Exemplo 2: Obter um banco de dados pelo nome em uma instância gerenciada
```
...
Esse comando obtém todos os bancos de dados na instância denominada managedInstance1 que começam com "managedDatabase".
...
### -InstanceObject
O objeto instance a ser usado para obter o banco de dados de instância
...
### -Name
O nome do Banco de Dados de Instância do Azure SQL a ser recuperado.
