...
## SYNOPSIS
Atualiza um membro de sincronização de SQL banco de dados do Azure.
...
## DESCRIPTION
O cmdlet **Update-AzSqlSyncGroup** modifica propriedades de um membro de sincronização de banco de dados do Azure SQL.
...
Esse comando redefine a senha do administrador para o banco de dados de membros.
...
Se deve usar o link privado ao se conectar a esse membro de sincronização.
