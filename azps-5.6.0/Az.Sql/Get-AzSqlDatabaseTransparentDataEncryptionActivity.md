...
## DESCRIPTION
O cmdlet **Get-AzSqlDatabaseTransparentDataEncryptionActivity** obtém o progresso de uma verificação TDE (Criptografia de Dados Transparentes) de um banco de dados do Azure SQL.
Se nenhum intervalo de criptografia estiver sendo executado, esse cmdlet retornará uma lista vazia.
