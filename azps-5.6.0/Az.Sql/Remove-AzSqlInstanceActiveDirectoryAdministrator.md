...
## SYNOPSIS
Remove um administrador do Azure AD para SQL Instância Gerenciada.
...
Este comando remove o administrador do Azure AD para a instância gerenciada chamada ManagedInstanceName01 associada ao grupo de recursos ResourceGroup01.
...
Este comando remove o administrador do Azure AD do objeto de instância gerenciada.
...
Este comando remove o administrador do Azure AD usando o identificador de recurso de instância gerenciada.
