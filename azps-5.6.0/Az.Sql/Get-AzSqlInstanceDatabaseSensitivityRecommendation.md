...
## DESCRIPTION
O Get-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet retorna os tipos de informações recomendados e os rótulos de sensibilidade das colunas no banco de dados de instância gerenciada do Azure SQL.

## EXEMPLOS

### Exemplo 1: Obter tipos de informações recomendados e rótulos de sensibilidade de um banco de dados de instância SQL instância gerenciada do Azure.
```powershell
...
### Exemplo 2: Obter tipos de informações recomendados e rótulos de sensibilidade de um banco de dados de instância gerenciada do Azure SQL usando Piping.
```powershell
