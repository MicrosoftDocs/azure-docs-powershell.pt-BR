...
## SYNOPSIS
Remove um Cluster Virtual do Azure SQL Virtual.
...
## DESCRIPTION
O cmdlet **Remove-AzSqlVirtualCluster** remove um Cluster Virtual do Azure SQL Virtual.
...
Este comando remove o cluster virtual chamado VirtualCluster1 atribuído ao grupo de recursos ResourceGroup01.
...
### -InputObject
O objeto instance a ser removido
