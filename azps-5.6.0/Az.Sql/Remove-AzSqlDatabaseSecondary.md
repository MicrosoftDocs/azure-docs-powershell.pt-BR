...
## SYNOPSIS
Encerra a replicação de dados entre um banco de dados SQL e o banco de dados secundário especificado.
...
## DESCRIPTION
O cmdlet **Remove-AzSqlDatabaseSecondary** força o término de um link de replicação geográfica.
Este cmdlet substitui o Stop-AzSqlDatabaseCopy cmdlet.
Não há sincronização de replicação antes do término.
...
### -DatabaseName
Especifica o nome do banco de dados primário do Azure SQL que tem o link de replicação que este cmdlet remove.
...
### -PartnerServerName
Especifica o nome do parceiro SQL Server.
...
### -ServerName
Especifica o nome da SQL Server que tem o link de replicação a ser removido.
