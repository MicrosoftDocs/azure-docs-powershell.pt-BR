...
## DESCRIPTION
O cmdlet **Set-AzSqlServerRecommendedActionState** atualiza o estado de uma ação SQL Server Azure.
Este cmdlet aplica, reverta ou descarta a ação recomendada com base no novo estado.
