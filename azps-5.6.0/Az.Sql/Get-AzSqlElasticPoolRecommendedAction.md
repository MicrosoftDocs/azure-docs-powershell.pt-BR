...
## SYNOPSIS
Obtém uma ou mais ações recomendadas para um Azure SQL Pool Elastic.
...
## DESCRIPTION
O cmdlet **Get-AzSqlElasticPoolRecommendedAction** obtém uma ou mais ações recomendadas para um Azure SQL Elastic Pool Advisor.

## EXEMPLOS

### Exemplo 1: Listar todas as ações recomendadas para um Consultor
```
...
Este comando obtém uma lista de todas as ações recomendadas do Consultor chamado CreateIndex disponíveis para o pool elástica chamado WIRunnerPool.

### Exemplo 2: Obter uma única ação recomendada para um Consultor
```
...
Este comando obtém a ação recomendada chamada IR_ \[ test_schema \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893 do \] Advisor chamado CreateIndex.

## PARÂMETROS

### -AdvisorName
Especifica o nome do consultor para o qual este cmdlet solicita ações recomendadas.
...
### -ElasticPoolName
Especifica o nome do pool elástica para o qual este cmdlet solicita ações recomendadas.
