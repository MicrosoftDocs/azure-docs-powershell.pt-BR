...
## SYNOPSIS
Atualiza o estado de uma ação recomendada SQL Banco de Dados do Azure.
...
## DESCRIPTION
O cmdlet **Set-AzSqlDatabaseRecommendedActionState** atualiza o estado de uma ação recomendada SQL banco de dados do Azure.
Isso permite que uma ação recomendada seja aplicada, revertida ou descartada com base no novo estado.

## EXEMPLOS

### Exemplo 1: Aplicar um estado de ação recomendado a pendentes
```
...
Este comando atualiza o estado da ação recomendada chamada IR_ \[ test_schema \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893 que pertence ao banco de dados chamado WIRunner para \] Pendente.

## PARÂMETROS

### -AdvisorName
Especifica o nome do consultor ao qual essa ação recomendada pertence.
