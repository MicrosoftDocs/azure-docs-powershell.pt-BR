...
## SYNOPSIS
Modifica a propriedade TDE para um banco de dados.
...
## DESCRIPTION
O cmdlet **Set-AzSqlDatabaseTransparentDataEncryption** modifica a propriedade TDE (Criptografia de Dados Transparentes) de um banco de dados do Azure SQL.
