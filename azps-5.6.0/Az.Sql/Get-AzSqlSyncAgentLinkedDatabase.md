...
## SYNOPSIS
Retorna informações sobre SQL Server bancos de dados vinculados por um agente de sincronização.
...
## DESCRIPTION
O cmdlet **Get-AzSqlSyncAgentLinkedDatabase** retorna informações sobre SQL Server bancos de dados vinculados por um agente de sincronização.

## EXEMPLOS

### Exemplo 1: obter os bancos de dados SQL Server vinculados para um agente de sincronização do Azure SQL sincronização.

O exemplo a seguir retorna os bancos SQL Server vinculados por um agente de sincronização do Azure SQL sincronização.
