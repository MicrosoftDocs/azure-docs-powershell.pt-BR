...
## DESCRIPTION
O cmdlet **Remove-AzSqlServerActiveDirectoryAdministrator** remove um administrador do Azure Active Directory (Azure AD) para o AzureSQL Server na assinatura atual.
...
Este comando remove o administrador do Azure AD para o servidor chamado Server01 associado ao grupo de recursos ResourceGroup01.
...
### -ServerName
Especifica o nome do SQL Server para o qual este cmdlet remove um administrador.
