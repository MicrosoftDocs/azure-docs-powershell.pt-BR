...
## SYNOPSIS
Remove um grupo de sincronização SQL banco de dados do Azure.
...
## DESCRIPTION
O cmdlet **Remove-AzSqlSyncGroup** remove um Grupo de Sincronização de Banco de Dados do Azure SQL Banco de Dados.
...
Este comando remove o Grupo de Sincronização de Banco de Dados do Azure SQL chamado syncGroup01.
