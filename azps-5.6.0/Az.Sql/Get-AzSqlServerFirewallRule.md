...
## SYNOPSIS
Obtém regras de firewall para um servidor SQL Banco de Dados.
...
## DESCRIPTION
O cmdlet **Get-AzSqlServerFirewallRule** obtém regras de firewall para um servidor de banco de dados do Azure SQL Database.
...
Este comando obtém todas as regras de firewall para o servidor chamado Server01.

### Exemplo 2: Obter todas as regras para um servidor usando filtragem
```
...
Esse comando obtém todas as regras de firewall do servidor chamado Server01 que começam com "Rule".
...
### -ServerName
Especifica o nome da SQL Server.
