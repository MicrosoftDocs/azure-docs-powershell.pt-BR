...
## DESCRIPTION
O Set-AzSqlElasticJobStep cmdlet atualiza uma etapa de trabalho
...
Os segundos iniciais de intervalo de repetir
...
O intervalo máximo de repetir segundos
...
### -RemoveOutput
O sinalizador para indicar se deve remover a saída
...
O multiplicador de backoff de intervalo de tentativa
