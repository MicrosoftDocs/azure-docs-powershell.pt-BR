...
## SYNOPSIS
Desabilita a autenticação somente do Azure AD para um SQL Server.
...
## DESCRIPTION
O cmdlet **Disable-AzSqlServerActiveDirectoryOnlyAuthentication** desabilita o requisito de autenticação somente do Azure Active Directory (Azure AD) para um Servidor do AzureSQL na assinatura atual.
...
Este comando desabilita o requisito de autenticação somente do Azure Active Directory (Azure AD) para um servidor do AzureSQL chamado Server01 associado a um grupo de recursos chamado ResourceGroup01.
