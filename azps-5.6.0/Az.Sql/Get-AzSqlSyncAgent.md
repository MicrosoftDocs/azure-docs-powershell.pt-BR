...
## SYNOPSIS
Retorna informações sobre o Azure SQL Agentes de Sincronização.
...
## DESCRIPTION
O cmdlet **Get-AzSqlSyncAgent** retorna informações sobre um ou mais agentes de sincronização do Azure SQL Sync.
Especifique o nome de um agente de sincronização para ver informações apenas para esse agente de sincronização.

## EXEMPLOS

### Exemplo 1: Obter todas as instâncias do Azure SQL Agente de Sincronização atribuídos a um SQL Server
```
...
Este comando obtém informações sobre todos os agentes de sincronização do Azure SQL atribuídos a um SQL Server do Azure.

### Exemplo 2: obter informações sobre um agente de sincronização do Azure SQL Sincronização
```
...
Este comando obtém informações sobre o Agente de Sincronização de Banco de Dados do Azure SQL com o nome "SyncAgent01"

### Exemplo 3: Obter todas as instâncias do Azure SQL Agente de Sincronização atribuído a um SQL Server do Azure usando filtragem
```
...
Este comando obtém informações sobre todos os agentes de sincronização do Azure SQL atribuídos a um SQL Server do Azure que começam com "SyncAgent".
