...
Este comando fará failover no pool elástica chamado "ElasticPool01" no servidor chamado "Server01".  Isso significa que o failover ocorrerá em todos os bancos de dados no pool elástica chamado "ElasticPool01".
...
### -ElasticPoolName
O nome do Pool SQL Elastic do Azure a ser removido.
...
### -ServerName
O nome do Azure SQL Server pool elástica está.
