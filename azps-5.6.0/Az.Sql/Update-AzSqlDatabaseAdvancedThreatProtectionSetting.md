...
## DESCRIPTION
O cmdlet **Update-AzSqlDatabaseAdvancedThreatProtectionSetting** define uma configuração avançada de proteção contra ameaças em um banco de dados do Azure SQL.
Para habilitar a proteção avançada contra ameaças em um banco de dados, as configurações de auditoria devem ser habilitadas nesse banco de dados.
...
Este comando define as configurações avançadas de proteção contra ameaças para um banco de dados chamado Database01 no servidor chamado Server01.
