...
## SYNOPSIS
Interrompe as SQL de uma instância gerenciada.
...
## DESCRIPTION
O Stop-AzSqlInstanceOperation de cmdlet interrompe a operação com o nome de operação fornecido em uma SQL gerenciada.
...
Este comando interrompe a operação com o nome 'd0f5bef5-e2b1-4ef8-bb42-2e54073874f9' em uma instância SQL gerenciada.
...
Este comando interrompe a operação com a id de recurso $managedInstanceOperation.Id.
...
Este comando interrompe a operação com o objeto $managedInstanceOperation.
...
### -ResourceId
A ID do recurso do objeto operation a ser parada
