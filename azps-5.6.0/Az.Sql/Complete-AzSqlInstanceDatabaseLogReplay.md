...
## SYNOPSIS
Conclui o serviço de Repetição de Log para o banco de dados determinado.
...
## DESCRIPTION
O cmdlet **Complete-AzSqlInstanceDatabaseLogReplay** conclui o serviço de Repetição de Log no banco de dados determinado.
...
Este comando concluirá o serviço de Repetição de Log para o banco de dados determinado após a restauração do último backup.
