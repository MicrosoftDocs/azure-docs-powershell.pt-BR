...
## DESCRIPTION
O Get-AzSqlDatabaseSensitivityRecommendation cmdlet retorna os tipos de informações recomendados e os rótulos de sensibilidade das colunas no banco de dados.

## EXEMPLOS

### Exemplo 1: Obter tipos de informações recomendados e rótulos de sensibilidade de um banco de dados SQL Azure.
```powershell
...
### Exemplo 2: Obter tipos de informações recomendados e rótulos de sensibilidade de um banco de dados SQL Azure usando Piping.
```powershell
