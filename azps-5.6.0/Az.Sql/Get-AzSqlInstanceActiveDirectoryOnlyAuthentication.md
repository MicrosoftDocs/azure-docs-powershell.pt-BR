...
## SYNOPSIS
Obtém a autenticação somente do Azure AD para uma instância SQL Gerenciada específica.
...
## DESCRIPTION
O cmdlet **Get-AzSqlInstanceActiveDirectoryOnlyAuthentication** obtém o requisito de autenticação somente do Azure Active Directory (Azure AD) para uma Instância Gerenciada do AzureSQL na assinatura atual.
...
Esse comando obtém o Azure Active Directory (Azure AD) apenas requisito de autenticação para uma Instância Gerenciada do AzureSQL chamada ManagedInstance01 associada a um grupo de recursos chamado ResourceGroup01.
