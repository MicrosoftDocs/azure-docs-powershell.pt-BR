...
## DESCRIPTION
O cmdlet **Set-AzSqlServerAdvisorAutoExecuteStatus** define a propriedade de execução automática para um Azure SQL Server Advisor.
...
### -AutoExecuteStatus
Especifica o valor ao qual esse cmdlet atualiza o status de execução automática.
