...
## SYNOPSIS
Define os tipos de informações e os rótulos de sensibilidade das colunas no banco de dados.
...
## DESCRIPTION
O Set-AzSqlDatabaseSensitivityClassification cmdlet define os tipos de informações e os rótulos de sensibilidade das colunas no banco de dados.

## EXEMPLOS

### Exemplo 1: Definir o tipo de informação e o rótulo de sensibilidade de uma coluna em um banco de dados do Azure SQL.
```powershell
...
### Exemplo 2: Definir tipos de informações recomendados e rótulos de sensibilidade de colunas em um banco de dados do Azure SQL.
```powershell
...
### Exemplo 3: Definir o tipo de informação e o rótulo de sensibilidade de uma coluna em um banco de dados do Azure SQL, usando a canalização.
```powershell
