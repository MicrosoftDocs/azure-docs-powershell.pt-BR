...
## SYNOPSIS
Obtém objetivos de serviço para um servidor de banco de dados SQL Azure.
...
## DESCRIPTION
O cmdlet **Get-AzSqlServerServiceObjective** obtém os objetivos de serviço disponíveis para um servidor de banco de dados do Azure SQL Database.
...
Este comando obtém os objetivos de serviço para o servidor chamado Server01.
...
Este comando obtém os objetivos de serviço do servidor chamado Server01 que começam com "System".

### Exemplo 3: Obter objetivos de serviço para um local
```
...
Este comando obtém os objetivos de serviço de uma região do Azure especificada.
...
### -ServerName
Especifica o nome de um servidor SQL Banco de Dados SQL Banco de Dados.
...
Especifica o nome de um objetivo de serviço para um servidor de banco de dados do Azure SQL Banco de Dados.
Os valores aceitáveis para este parâmetro são: Basic, S0, S1, S2, P1, P2 e P3.
