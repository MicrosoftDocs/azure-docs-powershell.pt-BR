...
## SYNOPSIS
Define propriedades para um pool de instâncias do Azure SQL Instância.
...
## DESCRIPTION
O cmdlet **Set-AzSqlInstancePool** modifica propriedades de um pool de instâncias do Azure SQL.
...
Este comando define o tipo de licença e/ou marcas para um pool de instâncias chamado instancePool0.
...
Este comando define o tipo de licença e/ou marcas para um pool de instâncias usando um objeto de pool de instâncias.
