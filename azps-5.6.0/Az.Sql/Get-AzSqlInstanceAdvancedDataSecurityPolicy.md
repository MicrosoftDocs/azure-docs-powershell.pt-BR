...
### Exemplo 1: obtém instância gerenciada Segurança avançada de dados
```powershell
...
### Exemplo 2: obtém instância gerenciada Segurança avançada de dados do recurso de instância gerenciada
```powershell
