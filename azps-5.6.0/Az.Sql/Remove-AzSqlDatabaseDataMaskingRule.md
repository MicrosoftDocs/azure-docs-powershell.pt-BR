...
## SYNOPSIS
Remove uma regra de mascaramento de dados de um banco de dados.
...
## DESCRIPTION
O cmdlet **Remove-AzSqlDatabaseDataMaskingRule** remove uma regra específica de mascaramento de dados de um banco de dados do Azure SQL.
Você pode remover uma regra de mascaramento de dados usando os parâmetros *ResourceGroupName,* *ServerName,* *DatabaseName* e *RuleId* para identificar a regra que esse cmdlet remove.
Esse cmdlet também é suportado pelo serviço SQL Server Banco de Dados de Extensão no Azure.

## EXEMPLOS

### Exemplo 1: Remover uma regra de mascaramento de dados de banco de dados
```
...
Este comando remove o nome de regra Rule01 definido para o banco de dados Database01.
O banco de dados está localizado no Server01 e atribuído ao grupo de recursos ResourceGroup01.
...
### -TableName
Especifica o nome de uma tabela SQL Azure.
