...
## SYNOPSIS
Modifica o servidor para o qual o Azure SQL Server DNS Alias está apontando
...
Este comando está atualizando o alias que estava apontando anteriormente para o oldServer para apontar para o servidor newServer
...
### -SourceServerName
O nome do Azure Sql Server para o qual o alias está apontando no momento.
...
A id de assinatura do servidor de origem
...
### -TargetServerName
O nome do Azure Sql Server para o qual o alias deve apontar.
