...
## SYNOPSIS
Cria um grupo de sincronização SQL banco de dados do Azure.
...
## DESCRIPTION
O cmdlet **New-AzSqlSyncGroup** cria um Grupo de Sincronização de Banco de Dados do Azure SQL.

## EXEMPLOS

### Exemplo 1: Criar um grupo de sincronização para um banco de dados do Azure SQL.
```
...
### -DatabaseCredential
A SQL de autenticação do banco de dados de hub.
...
Use uma conexão de link privado ao se conectar ao hub deste grupo de sincronização.
