...
## SYNOPSIS
Desabilita (descarta) recomendações de sensibilidade em colunas no banco de dados de instância gerenciada do Azure SQL.
...
## DESCRIPTION
O Disable-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet desabilita (descarta) recomendações de sensibilidade em colunas no banco de dados de instâncias gerenciadas do Azure SQL.

## EXEMPLOS

### Exemplo 1: Desabilitar recomendações de sensibilidade em uma determinada coluna em um banco de dados de instância gerenciada do Azure SQL.
```powershell
...
### Exemplo 2: Desabilite as recomendações de sensibilidade em colunas que tenham recomendações de sensibilidade em um banco de dados de instância gerenciada do Azure SQL com Piping.
```powershell
...
### Exemplo 3: Desabilitar recomendações de sensibilidade em uma determinada coluna em um banco de dados de instância gerenciada do Azure SQL com Piping.
```powershell
...
### -DatabaseObject
O objeto de banco de dados SQL instância gerenciada do Azure.
...
### -InputObject
Um objeto que representa SQL Classificação de Sensibilidade de Banco de Dados de Instância Gerenciada.
...
### -InstanceName
O Azure SQL nome da instância gerenciada.
...
### -PassThru
Especifica se o modelo de classificação de sensibilidade deve ser produzido no final da execução do cmdlet
...
[Saiba mais sobre a descoberta e classificação de dados SQL banco de dados do Azure](https://docs.microsoft.com/azure/sql-database/sql-database-data-discovery-and-classification)