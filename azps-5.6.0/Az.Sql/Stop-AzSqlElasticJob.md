...
## SYNOPSIS
Interrompe um trabalho, uma vez que sua id de execução de trabalho
...
Interrompe uma execução de trabalho e retorna seu status atual
...
### -ParentObject
O objeto de banco de dados de controle do agente
