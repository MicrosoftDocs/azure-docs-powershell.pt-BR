...
Isso define a política de retenção de longo prazo do database01 para salvar o primeiro backup completo de cada mês por cinco anos
...
Remove a política do database01 para que ela não salve mais os backups de retenção de longo prazo.
Isso não afetará backups que já foram feitos
...
Essa é outra maneira de remover a política para database01 para que ela não salve mais backups de retenção de longo prazo.
Isso não afetará backups que já foram feitos

## PARÂMETROS

### -DatabaseName
O nome do banco de dados do Azure SQL a ser usado.
...
### -ServerName
O nome do Azure SQL Server o banco de dados está.
