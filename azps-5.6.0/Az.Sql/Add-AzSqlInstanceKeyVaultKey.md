...
## SYNOPSIS
Adiciona uma chave de cofre à Instância Gerenciada fornecida. 
...
## DESCRIPTION
O Add-AzSqlInstanceKeyVaultKey cmdlet adiciona uma chave de cofre à Instância Gerenciada fornecida. A instância gerenciada deve ter permissões 'get, wrapKey, unwrapKey' para o cofre, use o script a seguir para conceder permissão à instância gerenciada.
...
Este comando adiciona a chave key vault com Id ' ' à instância gerenciada SQL https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 chamada 'ContosoManagedInstanceName' no grupo de recursos 'ContosoResourceGroup'. 
