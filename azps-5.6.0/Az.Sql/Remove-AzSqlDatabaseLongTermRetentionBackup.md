...
### Exemplo 1: Excluir um único backup com grupo de recursos
```powershell
...
Exclui o backup com o nome 601061b7-d10b-46e0-bf77-a2bfb16a6add;1316556665500000000

### Exemplo 2: excluir um único backup sem grupo de recursos
```powershell
...
Este comando exclui todos os backups de retenção de longo prazo para o local northeurope.
...
### -InputObject
O objeto Backup de Retenção de Longo Prazo do Banco de Dados a ser removido.
...
### -ResourceId
A ID de Recurso do Backup de Retenção de Longo Prazo do Banco de Dados a ser removido.
...
### -ServerName
O nome do Azure SQL Server em que o backup está.
