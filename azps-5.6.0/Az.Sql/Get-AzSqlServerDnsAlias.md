...
## SYNOPSIS
Obtém ou lista o Azure SQL Server DNS Alias.
...
## DESCRIPTION
Obter o Alias DNS específico do Azure SQL Server lista todos os Aliases DNS do Servidor para o servidor
...
Obtém Alias DNS do servidor especificado pelo nome de servidor e alias
...
Lista todos os Aliases DNS do Servidor para o servidor específico que começa com "dnsaliasname".
