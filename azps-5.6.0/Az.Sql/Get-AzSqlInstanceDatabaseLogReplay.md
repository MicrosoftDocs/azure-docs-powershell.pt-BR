...
## DESCRIPTION
O cmdlet **Get-AzSqlInstanceDatabaseLogReplay** obtém o status do serviço de Repetição de Log no banco de dados determinado.
...
Este comando receberá o status do serviço de repetição de log no banco de dados determinado.
