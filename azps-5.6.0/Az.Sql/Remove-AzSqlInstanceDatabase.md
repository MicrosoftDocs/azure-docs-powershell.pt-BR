...
## SYNOPSIS
Remove um banco de dados de instância gerenciada do Azure SQL.
...
Este comando remove o banco de dados chamado Database01 da instância managedInstance1.
...
### -InputObject
O objeto Instance Database a ser removido
...
### -Name
O nome do Banco de Dados de Instância SQL Azure a ser removido.
...
### -ResourceId
A id de recurso do objeto Banco de Dados de Instância a ser removido
