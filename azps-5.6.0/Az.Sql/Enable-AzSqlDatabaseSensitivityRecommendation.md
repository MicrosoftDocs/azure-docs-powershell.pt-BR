...
## SYNOPSIS
Habilita recomendações de sensibilidade em colunas (as recomendações são habilitadas por padrão em todas as colunas) no banco de dados.
...
## DESCRIPTION
O Enable-AzSqlDatabaseSensitivityRecommendation cmdlet permite recomendações de sensibilidade em colunas no banco de dados.

## EXEMPLOS

### Exemplo 1: Habilitar recomendações de sensibilidade em uma determinada coluna em um banco de dados do Azure SQL.
```powershell
...
### Exemplo 2: Habilitar recomendações de sensibilidade em uma determinada coluna do Azure SQL banco de dados usando Piping.
```powershell
