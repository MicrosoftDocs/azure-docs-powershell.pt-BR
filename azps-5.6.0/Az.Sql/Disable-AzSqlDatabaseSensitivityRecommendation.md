...
## SYNOPSIS
Desabilita (descarta) recomendações de sensibilidade em colunas no banco de dados.
...
## DESCRIPTION
O Disable-AzSqlDatabaseSensitivityRecommendation cmdlet desabilita (descarta) recomendações de sensibilidade em colunas no banco de dados.

## EXEMPLOS

### Exemplo 1: Desabilitar recomendações de sensibilidade em uma determinada coluna em um banco de dados do Azure SQL.
```powershell
...
### Exemplo 2: Desabilitar recomendações de sensibilidade em colunas que tenham recomendações de sensibilidade em um banco de dados do Azure SQL usando Piping.
```powershell
...
### Exemplo 3: Desabilitar recomendações de sensibilidade em uma determinada coluna em um banco de dados do Azure SQL usando Piping.
```powershell
...
### -DatabaseName
O nome do banco de dados SQL Azure.
...
### -InputObject
Um objeto que representa uma classificação SQL de Sensibilidade do Banco de Dados.
