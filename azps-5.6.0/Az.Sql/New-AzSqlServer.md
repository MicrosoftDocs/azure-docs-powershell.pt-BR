...
## SYNOPSIS
Cria um servidor SQL banco de dados.
...
## DESCRIPTION
O cmdlet **New-AzSqlServer** cria um servidor de banco de dados do Azure SQL.

## EXEMPLOS

### Exemplo 1: Criar um novo servidor de banco de dados do Azure SQL Banco de Dados
```
...
Este comando cria um servidor de banco de dados do Azure SQL versão 12.
...
### -Location
Especifica o local do data center onde esse cmdlet cria o servidor.
...
Especifique 2.0 para criar um servidor versão 11 ou 12.0 para criar um servidor versão 12.
...
Especifica as credenciais SQL administrador do servidor de banco de dados do novo servidor. Para obter um **objeto PSCredential,** use Get-Credential cmdlet. Para obter mais informações, digite `Get-Help
Get-Credential` .
