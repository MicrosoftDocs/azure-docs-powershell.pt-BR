...
## SYNOPSIS
Retorna informações sobre o Azure SQL Cluster Virtual.
...
## DESCRIPTION
O cmdlet **Get-AzSqlVirtualCluster** retorna informações sobre um ou mais clusters virtuais do Azure SQL Virtual.
Especifique o nome de um cluster virtual para ver informações apenas para esse cluster.
...
Este comando obtém informações sobre todos os Clusters Virtuais atribuídos ao grupo de recursos ResourceGroup01.

### Exemplo 2: obter informações sobre cluster virtual específico
```
...
Este comando obtém informações sobre o cluster virtual VirtualCluster1 no grupo de recursos ResourceGroup01.
...
### -ResourceId
A id de recurso do objeto instance a ser obter
