...
## SYNOPSIS
Obtém o protetor TDE (Criptografia de Dados Transparentes) para uma SQL gerenciada.
...
## DESCRIPTION
O Get-AzSqlInstanceTransparentDataEncryptionProtector cmdlet obtém o protetor TDE para a instância SQL gerenciada especificada.
...
Este comando obtém o protetor TDE para a instância gerenciada chamada ContosoManagedInstanceName no grupo de recursos chamado ContosoResourceGroup.
