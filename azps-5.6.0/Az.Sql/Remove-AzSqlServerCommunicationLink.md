...
## SYNOPSIS
Exclui um link de comunicação para transações de banco de dados elásticas entre dois servidores.
...
## DESCRIPTION
O cmdlet **Remove-AzSqlServerCommunicationLink** exclui um link de comunicação de servidor para servidor para transações de banco de dados elásticas no Banco de Dados do Azure SQL.
...
Este comando exclui um link de comunicação de servidor para servidor chamado Link01 em ContosoServer17.
...
### -LinkName
Especifica o nome do link de comunicação do servidor que esse cmdlet exclui.
...
Este servidor contém o link de comunicação que esse cmdlet exclui.
