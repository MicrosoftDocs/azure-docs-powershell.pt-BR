...
## SYNOPSIS
Obtém a autenticação somente do Azure AD para um SQL Server.
...
## DESCRIPTION
O cmdlet **Get-AzSqlServerActiveDirectoryOnlyAuthentication** obtém o requisito de autenticação somente do Azure Active Directory (Azure AD) para um Servidor do AzureSQL na assinatura atual.
...
Este comando obtém o Azure Active Directory (Azure AD) apenas requisito de autenticação para um servidor do AzureSQL chamado Server01 associado a um grupo de recursos chamado ResourceGroup01.
