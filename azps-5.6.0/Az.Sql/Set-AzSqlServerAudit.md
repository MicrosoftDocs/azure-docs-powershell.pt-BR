...
## SYNOPSIS
Altera as configurações de auditoria de um servidor SQL Azure.
...
## DESCRIPTION
O cmdlet **Set-AzSqlServerAudit** altera as configurações de auditoria de um servidor SQL Azure.
...
### Exemplo 1: Habilitar a política de auditoria de armazenamento de blob de um servidor SQL Azure
```powershell
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -BlobStorageTargetState Enabled -StorageAccountResourceId "/subscriptions/7fe3301d-31d3-4668-af5e-211a890ba6e3/resourceGroups/resourcegroup01/providers/Microsoft.Storage/storageAccounts/mystorage"
```

### Exemplo 2: Desabilitar a política de auditoria de armazenamento de blob de um servidor SQL Azure
```powershell
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -BlobStorageTargetState Disabled
```

### Exemplo 3: Habilitar a política de auditoria de armazenamento de blob de um servidor do Azure SQL com filtragem avançada usando um predicado T-SQL
```powershell
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -BlobStorageTargetState Enabled -StorageAccountResourceId "/subscriptions/7fe3301d-31d3-4668-af5e-211a890ba6e3/resourceGroups/resourcegroup01/providers/Microsoft.Storage/storageAccounts/mystorage" -PredicateExpression "statement <> 'select 1'"
```

### Exemplo 4: Remover a configuração de filtragem avançada da política de auditoria de um servidor SQL Azure
```powershell
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -PredicateExpression ""
```

### Exemplo 5: Habilitar a política de auditoria do hub de eventos de um servidor SQL Azure
```powershell
...
### Exemplo 6: desabilitar a política de auditoria do hub de eventos de um servidor SQL Azure
```powershell
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -EventHubTargetState Disabled
```

### Exemplo 7: Habilitar a política de auditoria de análise de log de um servidor SQL Azure
```powershell
...
### Exemplo 8: desabilitar a política de auditoria de análise de log de um servidor SQL Azure
```powershell
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -LogAnalyticsTargetState Disabled
```

### Exemplo 9: Desabilitar, por meio de pipeline, a política de auditoria de análise de log de um servidor do Azure SQL servidor
```powershell
...
### Exemplo 10: desabilitar o envio de registros de auditoria de um servidor do Azure SQL blob storage e permitir enviá-los para análise de log.
```powershell
...
### Exemplo 11: Habilitar o envio de registros de auditoria de um servidor do Azure SQL blob storage, event hub e log analytics.
```powershell
