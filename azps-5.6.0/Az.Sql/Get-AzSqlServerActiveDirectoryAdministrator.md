...
## DESCRIPTION
O cmdlet **Get-AzSqlServerActiveDirectoryAdministrator** obtém informações sobre um administrador do Azure Active Directory (Azure AD) para um Servidor do AzureSQL na assinatura atual.
...
Este comando obtém informações sobre um administrador do Azure AD para um servidor chamado Server01 associado a um grupo de recursos chamado ResourceGroup01.
