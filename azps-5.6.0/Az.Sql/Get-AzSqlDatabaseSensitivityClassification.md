...
## SYNOPSIS
Obtém os tipos de informações atuais e rótulos de sensibilidade de colunas no banco de dados.
...
## DESCRIPTION
O Get-AzSqlDatabaseSensitivityClassification cmdlet retorna os tipos de informações atuais e os rótulos de sensibilidade das colunas no banco de dados do Azure SQL.

## EXEMPLOS

### Exemplo 1: Obter tipos de informações atuais e rótulos de sensibilidade de um banco de dados do Azure SQL.
```powershell
...
### Exemplo 2: Obter tipos de informações atuais e rótulos de sensibilidade de um banco de dados do Azure SQL com piping.
```powershell
...
### Exemplo 3: obter o tipo de informação atual e o rótulo de sensibilidade de uma coluna específica de um banco de dados do Azure SQL.
```powershell
...
### Exemplo 4: obter o tipo de informação atual e o rótulo de sensibilidade de uma coluna específica de um banco de dados do Azure SQL usando Piping.
```powershell
