...
## SYNOPSIS
Remove um ou mais bancos de dados de um Grupo SQL Failover de Banco de Dados do Azure.
...
## DESCRIPTION
Remove um ou mais bancos de dados do Grupo de Failover de Banco de Dados SQL Azure especificado. Os bancos de dados e as relações de replicação são deixados intactos, mas eles não estarão mais acessíveis por meio dos pontos de extremidade do Grupo de Failover.
...
Este comando remove um banco de dados de um Grupo de Failover canalização.
...
Este comando remove todos os bancos de dados em um Pool Elastic de um Grupo de Failover.

## PARÂMETROS

### -Database
Um ou mais bancos de dados do Azure SQL no servidor principal do Grupo de Failover a ser removido do Grupo de Failover.
