...
## SYNOPSIS
Restaura um banco de dados de instância gerenciada do Azure SQL.
...
## DESCRIPTION
O cmdlet **Restore-AzSqlInstanceDatabase** restaura um banco de dados de instância de um backup geo-redundante, um ponto no tempo em um banco de dados ao vivo ou um backup de retenção de longo prazo.
...
O primeiro comando obtém o backup geo-redundante para o banco de dados chamado Database01 e o armazena na variável $GeoBackup.
...
O primeiro comando obtém os bancos de dados de instância excluídos denominados 'DB1' na Instância 'managedInstance1'.
...
O primeiro comando obtém os bancos de dados de instância excluídos denominados 'DB1' na Instância 'managedInstance1'.
O segundo comando restaura o banco de dados buscado, do backup point-in-time especificado para o banco de dados de instância chamado Database01_restored usando o objeto de entrada.
...
Restaura o backup ltr com a ID de recurso determinada (que pode ser encontrada executando Get-AzSqlInstanceDatabaseLongTermRetentionBackup).
...
### -FromGeoBackup
Restaure a partir de um backup geo.
...
### -InputObject
O objeto Banco de Dados de Instância a ser restaurado
...
### -ResourceId
A id de recurso do objeto Banco de Dados de Instância a ser restaurado
...
O nome do banco de dados de instância de destino a ser restaurado.
...
Se não for especificada, a instância de destino será igual à instância de origem.
...
O nome do grupo de recursos de destino a ser restaurado.
