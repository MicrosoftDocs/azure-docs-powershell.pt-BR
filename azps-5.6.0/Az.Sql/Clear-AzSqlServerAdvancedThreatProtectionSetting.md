...
## DESCRIPTION
O Clear-AzSqlServerAdvancedThreatProtectionSetting cmdlet remove as configurações avançadas de proteção contra ameaças de um servidor SQL Azure.
...
Este comando remove as configurações avançadas de proteção contra ameaças de um servidor chamado Server01.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos ao que o servidor é atribuído.
