...
## DESCRIPTION
O cmdlet **Remove-AzSqlElasticPool** exclui um pool elástica do banco de dados do Azure SQL.
...
Este comando exclui um pool elástica chamado ElasticPool01.
...
### -ElasticPoolName
Especifica o nome do pool elástica que esse cmdlet exclui.
