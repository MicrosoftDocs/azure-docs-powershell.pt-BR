...
## SYNOPSIS
Obtém uma ou mais ações recomendadas para um Azure SQL Server Advisor.
...
## DESCRIPTION
O cmdlet **Get-AzSqlServerRecommendedAction** obtém uma ou mais ações recomendadas para um Azure SQL Server Advisor.
...
Este comando obtém uma lista de todas as ações recomendadas do SQL Server Advisor chamado CreateIndex disponível para o servidor chamado wi-runner-australia-east.
...
Este comando obtém uma ação recomendada chamada IR_ \[ test_schema \] _ \[ test_table_0.0361551 \] _6C7AE8CC9C87E7FD5893 do Advisor chamado CreateIndex.
...
### -ServerName
Especifica o nome do servidor ao que o Advisor pertence.
