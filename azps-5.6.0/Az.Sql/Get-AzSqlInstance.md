...
## SYNOPSIS
Retorna informações sobre a instância de banco de dados gerenciada do Azure SQL.
...
Este comando obtém informações sobre todas as instâncias atribuídas ao grupo de recursos ResourceGroup01.
...
Este comando obtém informações sobre a instância chamada managedInstance1.
...
Este comando obtém informações sobre todas as instâncias atribuídas ao grupo de recursos ResourceGroup01 que começam com "managedInstance".
...
Este comando obtém informações sobre todas as instâncias no pool de instâncias "instancePool0".
...
### Exemplo 6: Obter todas as instâncias em um pool de instâncias usando o identificador de recurso do pool de instâncias
```powershell
