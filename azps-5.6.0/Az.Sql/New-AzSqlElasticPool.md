...
## SYNOPSIS
Cria um pool de banco de dados elástica para um banco de dados SQL Banco de Dados.
...
## DESCRIPTION
O cmdlet **New-AzSqlElasticPool** cria um pool de banco de dados elástica para um banco de dados do Azure SQL Database.
...
### Exemplo 1: Criar um pool elástica de DTU
...
Este comando cria um pool elástica na camada de serviço Standard chamada ElasticPool01. O servidor chamado server01, atribuído a um grupo de recursos do Azure chamado ResourceGroup01, hospeda o pool elástica. O comando especifica valores de propriedade DTU para o pool e os bancos de dados no pool.

### Exemplo 2: Criar um pool elástica vCore
...
Este comando cria um pool elástica na camada de serviço GengeralPurpose chamada ElasticPool01. O servidor chamado server01, atribuído a um grupo de recursos do Azure chamado ResourceGroup01, hospeda o pool elástica. O comando especifica os valores da propriedade vCore para o pool e os bancos de dados no pool.

### Exemplo 3

Cria um pool de banco de dados elástica para um banco de dados SQL Banco de Dados. (gerado automaticamente)
...
Os valores padrão para as diferentes edições são os seguinte:
- Básico. 5 DTUs
- Padrão. 100 DTUs
- Premium. 125 DTUs Para obter detalhes sobre quais valores são válidos, consulte a tabela para o pool de tamanho específico em [pools elásticas](https://docs.microsoft.com/azure/sql-database/sql-database-elastic-pool)
...
### -Edition
Especifica a edição do banco de dados do Azure SQL usado para o pool elástica.
...
Consulte [eDTU e limites de armazenamento para](/azure/sql-database/sql-database-elastic-pool#edtu-and-storage-limits-for-elastic-pools) ver os valores possíveis.
...
### -Tags
Especifica um dicionário de pares de valores-chave na forma de uma tabela de hash que esse cmdlet associa ao pool elástica. Por exemplo: @{key0="value0";key1=$null;key2="value2"}
