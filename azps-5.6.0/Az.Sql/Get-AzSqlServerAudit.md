...
## SYNOPSIS
Obtém as configurações de auditoria de um servidor SQL Azure.
...
## DESCRIPTION
O cmdlet **Get-AzSqlServerAudit** obtém as configurações de auditoria de um servidor SQL Azure.
*Especifique os parâmetros ResourceGroupName* *e ServerName* para identificar o servidor.

## EXEMPLOS

### Exemplo 1: Obter as configurações de auditoria de um servidor SQL Azure
```
...
### Exemplo 2: Obter, por meio do pipeline, as configurações de auditoria de um servidor SQL Azure
```
...
### Exemplo 3: Obter as configurações de auditoria de um servidor SQL Azure
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
