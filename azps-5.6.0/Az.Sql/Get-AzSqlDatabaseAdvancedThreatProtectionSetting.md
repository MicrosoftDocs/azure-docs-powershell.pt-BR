...
## DESCRIPTION
O cmdlet **Get-AzSqlDatabaseAdvancedThreatProtectionSetting** obtém as configurações avançadas de proteção contra ameaças de um banco de dados do Azure SQL.
...
Este comando obtém as configurações avançadas de proteção contra ameaças para um banco de dados chamado Database01.
