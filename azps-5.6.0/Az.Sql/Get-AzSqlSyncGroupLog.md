...
## SYNOPSIS
Retorna os logs de um grupo de sincronização SQL banco de dados do Azure.
...
## DESCRIPTION
O cmdlet **Get-AzSqlSyncGroupLog** retorna os logs de um Grupo de Sincronização de Banco de Dados do Azure SQL Banco de Dados.

## EXEMPLOS

### Exemplo 1: Obter os logs de um grupo de sincronização do Azure SQL Sincronização
```
...
Este comando obtém os logs de um grupo de sincronização do Azure SQL Sincronização.
...
### -EndTime
A hora de término dos logs a ser consultado.
...
### -LogLevel
O tipo de logs a ser consultado.
...
### -StartTime
A hora de início dos logs para consulta.
