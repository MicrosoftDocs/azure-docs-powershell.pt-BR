...
## SYNOPSIS
Cria um pool de instâncias SQL Azure.
...
## DESCRIPTION
O cmdlet **New-AzSqlInstancePool** cria um pool de instâncias SQL Azure.
...
Este comando cria um novo pool de instâncias SQL Azure.
...
### -ComputeGeneration
A geração de computação para o pool de instâncias.
...
### -SubnetId
A id da sub-rede a ser usada para criação de pool de instâncias.
