...
## SYNOPSIS
Remove os tipos de informações e os rótulos de sensibilidade das colunas no banco de dados de instância gerenciada do Azure SQL.
...
## DESCRIPTION
O Remove-AzSqlInstanceDatabaseSensitivityClassification cmdlet remove os tipos de informações e os rótulos de sensibilidade das colunas no banco de dados de instância gerenciada do Azure SQL.

## EXEMPLOS

### Exemplo 1: Remover o tipo de informação e o rótulo de sensibilidade de uma coluna em um banco de dados SQL instância gerenciada do Azure.
```powershell
...
### Exemplo 2: Remover tipos de informações atuais e rótulos de sensibilidade de colunas em um banco de dados de instância gerenciada do Azure SQL com Piping.
```powershell
...
### Exemplo 3: Remover o tipo de informação e o rótulo de sensibilidade de uma coluna em um banco de dados de instância gerenciada do Azure SQL com Piping.
```powershell
