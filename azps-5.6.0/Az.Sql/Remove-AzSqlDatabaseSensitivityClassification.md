...
## SYNOPSIS
Remove os tipos de informações e os rótulos de sensibilidade das colunas no banco de dados.
...
## DESCRIPTION
O Remove-AzSqlDatabaseSensitivityClassification cmdlet remove os tipos de informações e os rótulos de sensibilidade das colunas no banco de dados.

## EXEMPLOS

### Exemplo 1: Remover o tipo de informação e o rótulo de sensibilidade de uma coluna em um banco de dados do Azure SQL.
```powershell
...
### Exemplo 2: Remover tipos de informações atuais e rótulos de sensibilidade de colunas em um banco de dados do Azure SQL usando Piping.
```powershell
...
### Exemplo 3: Remover o tipo de informação e o rótulo de sensibilidade de uma coluna em um banco de dados do Azure SQL usando Piping.
```powershell
