...
## SYNOPSIS
Cancela o serviço de Repetição de Log soltando o banco de dados.
...
## DESCRIPTION
O cmdlet **Stop-AzSqlInstanceDatabaseLogReplay** solta o banco de dados e, portanto, cancela o serviço de Repetição de Log.
...
Esse comando cancelará o serviço de repetição de log no banco de dados determinado.
