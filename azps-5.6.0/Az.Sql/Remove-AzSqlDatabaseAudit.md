...
## SYNOPSIS
Remove as configurações de auditoria de um banco de dados SQL Azure.
...
## DESCRIPTION
O cmdlet **Remove-AzSqlDatabaseAudit** remove as configurações de auditoria de um banco de dados do Azure SQL.
Para usar o cmdlet, use os *parâmetros ResourceGroupName,* *ServerName* e *DatabaseName* para identificar o banco de dados.

## EXEMPLOS

### Exemplo 1: Remover as configurações de auditoria de um banco de dados SQL Azure
```
PS C:\>Remove-AzSqlDatabaseAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

### Exemplo 2: Remover, por pipeline, as configurações de auditoria de um banco de dados SQL Azure
```
