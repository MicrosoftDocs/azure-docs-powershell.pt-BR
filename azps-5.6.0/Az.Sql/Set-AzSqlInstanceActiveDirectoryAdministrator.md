...
## SYNOPSIS
Provisiona um administrador do Azure AD para SQL Instância Gerenciada.
...
## DESCRIPTION
O cmdlet **Set-AzSqlInstanceActiveDirectoryAdministrator** provisiona um administrador do Azure Active Directory (Azure AD) para Instância Gerenciada do AzureSQL na assinatura atual.
Você pode provisioná-lo apenas um administrador por vez.
Os seguintes membros do Azure AD podem ser provisionados como SQL administrador de Instância Gerenciada:
...
Contas da Microsoft, como aquelas nos domínios Outlook.com, Hotmail.com ou Live.com, não são suportadas como administradores.
...
### Exemplo 2: Provisionar um usuário de administrador usando o objeto de instância gerenciada
```
