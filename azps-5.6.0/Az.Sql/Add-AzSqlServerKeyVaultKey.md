...
## SYNOPSIS
Adiciona uma chave do Cofre de Chaves a um SQL servidor.
...
## DESCRIPTION
O Add-AzSqlServerKeyVaultKey cmdlet adiciona uma chave do Cofre de Chaves ao servidor SQL fornecido.
...
Este comando adiciona a chave do Cofre de Chaves com Id ' ' ao servidor SQL chamado 'ContosoServer' no grupo de recursos https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 'ContosoResourceGroup'.
