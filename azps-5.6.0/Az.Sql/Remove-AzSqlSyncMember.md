...
## SYNOPSIS
Remove um membro de sincronização de SQL banco de dados do Azure.
...
## DESCRIPTION
O cmdlet **Remove-AzSqlSyncMember** remove um membro de sincronização de banco de dados do Azure SQL.
...
Este comando remove o Membro de Sincronização de Banco de Dados do Azure SQL chamado syncMember01.
...
### -PassThru
Define se retorna o membro de sincronização removido
