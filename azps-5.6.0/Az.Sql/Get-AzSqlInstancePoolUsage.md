...
## SYNOPSIS
Retorna informações sobre o uso de um pool SQL instância do Azure.
...
## DESCRIPTION
O cmdlet **Get-AzSqlInstancePoolUsage** retorna informações sobre o uso do pool de instâncias do Azure SQL.

## EXEMPLOS

### Exemplo 1 : Obtém o uso de um pool de instâncias SQL Azure
```powershell
...
Obtém o uso para o pool de instâncias SQL Instância do Azure0.

### Exemplo 2: Obtém o uso de um pool de instâncias do Azure SQL usando um objeto de pool de instâncias
```powershell
...
Obtém o uso para o pool de instâncias do Azure SQL Instance0 usando um objeto de pool de instâncias.

### Exemplo 3: obtém o uso de um pool de instâncias do Azure SQL usando uma id de recurso de pool de instâncias
```powershell
...
Obtém o uso para o pool de instâncias SQL instância do Azure usando um identificador de recurso do pool de instâncias.

### Exemplo 3: Obtém o uso de um pool de instâncias do Azure SQL com uma divisão dos usos da instância gerenciada no pool.
```powershell
...
Obtém o uso do pool de instâncias do Azure SQL Instance0, juntamente com os usos das instâncias gerenciadas em instancepool0.
...
### -ExpandChildren
Sinalizador indicando se o uso desse pool de instâncias deve ser expandido com o uso de seus filhos.
...
### -InstancePool
O objeto pool de instância pai.
