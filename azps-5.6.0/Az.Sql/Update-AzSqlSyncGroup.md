...
## SYNOPSIS
Atualiza um grupo de sincronização SQL banco de dados do Azure.
...
## DESCRIPTION
O cmdlet **Update-AzSqlSyncGroup** modifica propriedades de um Grupo de Sincronização de Banco de Dados do Azure SQL.

## EXEMPLOS

### Exemplo 1: atualizar um grupo de sincronização para um banco de dados do Azure SQL.
```
...
Se deve usar uma conexão de link privado ao se conectar ao hub deste grupo de sincronização.
