...
## SYNOPSIS
Cria uma regra de firewall para um servidor SQL Banco de Dados.
...
## DESCRIPTION
O cmdlet **New-AzSqlServerFirewallRule** cria uma regra de firewall para o servidor de banco de dados SQL Azure especificado.
...
A regra inclui os endereços IP inicial e final especificados.
...
Não será possível usar esse parâmetro se você pretende usar os *parâmetros FirewallRuleName,* *StartIpAddress* e *EndIpAddress.*
Se você quiser permitir que os IPs do Azure acessem o servidor, esse parâmetro deve ser usado em uma chamada de cmdlet separada que não use os parâmetros *FirewallRuleName,* *StartIpAddress* e *EndIpAddress.*
...
### -EndIpAddress
Especifica o valor final do intervalo de endereços IP para essa regra.
