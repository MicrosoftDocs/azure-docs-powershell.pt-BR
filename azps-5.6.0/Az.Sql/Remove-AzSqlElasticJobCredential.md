...
## SYNOPSIS
Remove a credencial de trabalho elástica
...
## DESCRIPTION
O Remove-AzSqlElasticJobCredential cmdlet remove uma credencial de trabalho
...
### -ResourceId
A ID do recurso de credencial de trabalho
