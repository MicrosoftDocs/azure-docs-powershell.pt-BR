...
## SYNOPSIS
Atualiza o status de execução automática de um Azure SQL Pool Elastic.
...
Este comando define o status de execução automática de um consultor chamado CreateIndex como habilitado.
...
### -AutoExecuteStatus
Especifica um novo valor ao qual esse cmdlet atualiza o status de execução automática.
