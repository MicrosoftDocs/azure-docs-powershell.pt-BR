...
## SYNOPSIS
Define o protetor TDE (Criptografia de Dados Transparentes) para uma SQL gerenciada.
...
## DESCRIPTION
O Set-AzSqlInstanceTransparentDataEncryptionProtector cmdlet define o protetor TDE para uma SQL gerenciada. Alterar o tipo de protetor TDE girará o protetor.

## EXEMPLOS

### Exemplo 1: definir o tipo de protetor TDE (Criptografia de Dados Transparente) como ServiceManaged
```powershell
...
### Exemplo 2: definir o tipo de protetor de Criptografia de Dados Transparente como Cofre de Chaves do Azure
```powershell
...
Este comando atualiza a instância gerenciada especificada para usar a Chave de Cofre de Chaves de instância gerenciada com Id https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ' ' como o protetor TDE.

### Exemplo 3: definir o tipo de protetor de Criptografia de Dados Transparente como Cofre de Chaves do Azure usando o objeto de instância gerenciada
```powershell
...
### Exemplo 4: definir o tipo de protetor de Criptografia de Dados Transparentes como Cofre de Chaves do Azure usando a ID do recurso
```powershell
PS C:\> $managedInstance = Get-AzSqlInstance -Name 'ContosoManagedInstanceName' -ResourceGroupName 'ContosoResourceGroup'
...
### Exemplo 5: definir o tipo de protetor de Criptografia de Dados Transparente como Cofre de Chaves do Azure usando a canalização
```powershell
PS C:\> $managedInstance = Get-AzSqlInstance -Name 'ContosoManagedInstanceName' -ResourceGroupName 'ContosoResourceGroup'
...
### -Type
O tipo protetor de criptografia de dados transparente do banco de dados do Azure Sql.
