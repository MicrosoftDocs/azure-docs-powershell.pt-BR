...
## SYNOPSIS
Obtém uma ou mais ações recomendadas para um Azure SQL Database Advisor.
...
## DESCRIPTION
O cmdlet **Get-AzSqlDatabaseRecommendedAction** obtém uma ou mais ações recomendadas para um Consultor de Banco de Dados do Azure SQL.
...
Este comando obtém uma lista de todas as ações recomendadas do Consultor chamado CreateIndex disponíveis para o banco de dados chamado wi-runner-australia-east.
...
Este comando obtém a ação recomendada chamada IR_ \[ test_schema \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893 para o Consultor chamado \] CreateIndex.

## PARÂMETROS

### -AdvisorName
Especifica o nome do Advisor para o qual este cmdlet solicita ações recomendadas.
