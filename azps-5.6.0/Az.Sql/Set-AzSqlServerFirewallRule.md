...
## SYNOPSIS
Modifica uma regra de firewall no servidor de banco de dados do Azure SQL.
...
## DESCRIPTION
O cmdlet **Set-AzSqlServerFirewallRule** modifica uma regra de firewall em um servidor de banco de dados do Azure SQL.
...
Este comando modifica uma regra de firewall chamada Rule01 no servidor chamado Server01.
O comando modifica os endereços IP inicial e final.
