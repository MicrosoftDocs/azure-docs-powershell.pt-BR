...
## DESCRIPTION
O cmdlet **New-AzSqlDatabaseRestorePoint** cria um novo ponto de restauração do SQL Data Warehouse do Azure.
Atualmente, esse cmdlet tem suporte para o Azure SQL Data Warehouse.
...
Este comando cria um ponto de restauração para o Azure SQL Data Warehouse e retorna os detalhes do ponto de restauração.
