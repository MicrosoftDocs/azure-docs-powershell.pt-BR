...
## SYNOPSIS
Define o protetor TDE (Criptografia de Dados Transparentes) para um SQL servidor.
...
## DESCRIPTION
O Set-AzSqlServerTransparentDataEncryptionProtector cmdlet define o protetor TDE para um SQL servidor.
Alterar o tipo de protetor TDE girará o protetor.
...
Este comando atualiza o tipo de protetor TDE de um servidor para Service Managed.
...
Este comando atualiza um servidor para usar a Chave do Cofre de Chaves do Servidor com Id ' https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ' como o protetor TDE.
ResourceGroupName ServerName Type ServerKeyVaultKeyName
----------------- ----------                   ---- ---------------------
...
### -Type
O tipo de protetor TDE do Banco de Dados sql do Azure.
