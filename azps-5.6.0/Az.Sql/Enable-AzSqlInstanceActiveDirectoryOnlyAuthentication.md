...
## SYNOPSIS
Habilita a autenticação somente do Azure AD para uma instância SQL Gerenciada específica.
...
## DESCRIPTION
O cmdlet **Enable-AzSqlInstanceActiveDirectoryOnlyAuthentication** permite que o Azure Active Directory (Azure AD) só seja requisito de autenticação para uma Instância Gerenciada do AzureSQL na assinatura atual.
...
Esse comando habilita o Azure Active Directory (Azure AD) somente requisito de autenticação para uma Instância Gerenciada do AzureSQL chamada ManagedInstance01 associada a um grupo de recursos chamado ResourceGroup01.
