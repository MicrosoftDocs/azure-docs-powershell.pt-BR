...
## SYNOPSIS
Obtém uma política de backup geo do banco de dados.
...
## DESCRIPTION
O cmdlet **Get-AzSqlDatabaseGeoBackupPolicy** obtém a política de backup geográfica registrada neste banco de dados.
...
Obtém uma política de backup geo do banco de dados. (gerado automaticamente)
...
### -DatabaseName
Especifica o nome do banco de dados para o qual este cmdlet obtém a política de backup geo.
