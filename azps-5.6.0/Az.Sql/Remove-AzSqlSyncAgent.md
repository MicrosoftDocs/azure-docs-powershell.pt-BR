...
## SYNOPSIS
Remove um Agente de Sincronização do Azure SQL.
...
## DESCRIPTION
O cmdlet **Remove-AzSqlSyncAgent** remove um Agente SQL Sync do Azure.
...
Este comando remove o Agente de Sincronização do Azure SQL chamado syncAgent01.
...
### -PassThru
Define se o agente de sincronização removido deve retornar
