...
## SYNOPSIS
Remove uma instância de banco de dados gerenciada do Azure SQL.
...
## DESCRIPTION
O cmdlet **Remove-AzSqlInstance** remove uma instância gerenciada do banco de dados do Azure SQL.
...
Este comando remove a instância chamada managedInstance1.
...
### -ResourceId
A ID do recurso do objeto instance a ser removido
