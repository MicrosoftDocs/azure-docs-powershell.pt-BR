...
## DESCRIPTION
O cmdlet **Get-AzSentinelAlertRule** obtém um Analytic (Regra de Alerta) do espaço de trabalho especificado.
...
Você pode usar o **objeto AlertRule** para atualizar o AlertRule, por exemplo, você pode desabilitar **AlertRule**.
...
Este exemplo obtém todos os **AlertRules** no espaço de trabalho especificado e o armazena na variável $AlertRules.
...
Este exemplo obtém **um AlertRule** no espaço de trabalho especificado e o armazena na variável $AlertRule.
