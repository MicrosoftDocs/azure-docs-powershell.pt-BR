...
## DESCRIPTION
O cmdlet **New-AzSentinelIncidentOwner** cria um objeto Incident Owner na memória para atualizar um incidente.
...
### -AssignedTo
Proprietário de Incidentes - Atribuído a
...
### -UserPrincipalName
Proprietário do Incidente - Nome principal do usuário
