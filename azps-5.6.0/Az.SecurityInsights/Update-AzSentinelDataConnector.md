...
Você pode passar um **objeto DataConnector** como um parâmetro ou usando o operador de pipeline ou, como alternativa, pode especificar os parâmetros necessários.
...
O comando obtém o Conector de Dados *por DataConnectorId* e define o estado *Alertas* como *Desabilitado*.  Todas as outras propriedades permanecem as mesmas.
