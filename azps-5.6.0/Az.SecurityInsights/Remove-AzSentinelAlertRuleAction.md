...
Você pode passar um **objeto AlertRuleAction** usando o operador de pipeline ou, como alternativa, pode especificar os parâmetros necessários.
...
Este comando remove a Regra de Alerta do espaço de trabalho.
