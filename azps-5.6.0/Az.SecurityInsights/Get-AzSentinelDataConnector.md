...
Este exemplo obtém todos os **DataConnectors** no espaço de trabalho especificado e o armazena na variável $DataConnectors.
...
Este exemplo obtém **um DataConnector** no espaço de trabalho especificado e o armazena na variável $DataConnector.
