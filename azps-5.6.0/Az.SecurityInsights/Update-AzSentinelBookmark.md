...
Você pode passar um **objeto Bookmark** como um parâmetro ou usando o operador de pipeline ou, como alternativa, pode especificar os parâmetros *BookmarkId* necessários.
...
O comando atualiza o Indicador definindo a *propriedade Notes.*  Todas as outras propriedades permanecem as mesmas.
...
O segundo comando atualiza a propriedade Notes.   Todas as outras propriedades permanecem as mesmas.
...
### -DisplayName
Nome de exibição da regra do indicador.
...
### -IncidentInfo
Informações sobre incidentes do indicador.
