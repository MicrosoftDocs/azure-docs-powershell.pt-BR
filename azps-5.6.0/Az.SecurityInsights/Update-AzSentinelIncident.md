...
Você pode passar um **objeto Incident** como um parâmetro ou usando o operador de pipeline ou, como alternativa, pode especificar os parâmetros necessários.
...
O comando obtém o Incidente por *IncidentId* e define a propriedade *Severity* como *High*.  Todas as outras propriedades permanecem as mesmas.
...
Motivo de Classificaiton de Incidentes.
