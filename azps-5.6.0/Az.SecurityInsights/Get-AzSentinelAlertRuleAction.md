...
Se você não especificar o parâmetro *ActionId,* uma matriz contendo todas as Ações da Regra de Alerta específica no espaço de trabalho especificado será retornada.
Você pode usar o **objeto Action** para atualizar a Ação, por exemplo, você pode alterar a **Ação** de uma Regra de Alerta.
...
Este exemplo obtém **um AlertRuleAction** para a Regra de Alerta especificada no espaço de trabalho especificado e a armazena na variável $AlertRuleAction.
