...
## DESCRIPTION
O cmdlet **Get-AzRelayKey** retorna as cadeias de caracteres de conexão primárias e secundárias para as entidades Relay determinadas (Namespace/WcfRelay/HybridConnection).
...
Cadeia de conexão primária e secundária para as entidades relay especificadas (Namespace/WcfRelay/HybridConnection).
