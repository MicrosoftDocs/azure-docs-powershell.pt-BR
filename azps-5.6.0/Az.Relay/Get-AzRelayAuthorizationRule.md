...
## DESCRIPTION
O cmdlet **Get-AzRelayAuthorizationRule** obtém a descrição da regra de autorização especificada nas entidades Relay determinadas (Namespace/WcfRelay/HybridConnection).
