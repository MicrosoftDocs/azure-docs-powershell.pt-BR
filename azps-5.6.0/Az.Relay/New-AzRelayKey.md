...
## DESCRIPTION
O cmdlet **New-AzRelayKey** gera as cadeias de conexão primárias e secundárias para as entidades relay determinadas (Namespace/WcfRelay/HybridConnection).
...
gera as cadeias de caracteres de conexão primárias ou secundárias para a entidade Relay-Namespace com Valor de Chave Fornecido
...
### Exemplo 2.1 - WcfRelay KeyValue fornecido
```
...
gera as cadeias de caracteres de conexão primárias ou secundárias para a entidade Relay-WcfRelay com Valor de Chave Fornecido
...
### Exemplo 3.1 - HybridConnection KeyValue fornecido
```
...
gera as cadeias de caracteres de conexão primárias ou secundárias para a entidade Relay-HybridConnection com Valor de Chave Fornecido
