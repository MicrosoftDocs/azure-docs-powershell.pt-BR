...
## DESCRIPTION
O cmdlet **Set-AzRelayAuthorizationRule** atualiza a descrição da regra de autorização especificada das entidades Relay determinadas (Namespace/WcfRelay/HybridConnection).
...
### Exemplo 1.2 - Namespace com parâmetro Rights
```
...
Adiciona **Enviar** aos direitos de acesso da regra de `AuthoRule1` autorização do HybridConnection `TestHybridConnection` .
