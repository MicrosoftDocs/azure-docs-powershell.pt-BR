...
## DESCRIPTION
O cmdlet **Remove-AzRelayAuthorizationRule** remove a regra de autorização das entidades Relay determinadas (Namespace/WcfRelay/HybridConnection).
...
Remove a regra de `AuthoRule1` autorização do namespace `TestNameSpace-Relay1` .
...
Remove a regra de `AuthoRule1` autorização do WcfRelay `TestWcfRelay` do namespace `TestNameSpace-Relay1` .
...
Remove a regra de `AuthoRule1` autorização do HybridConnection `TestHybridConnection` do namespace `TestNameSpace-Relay1` .
