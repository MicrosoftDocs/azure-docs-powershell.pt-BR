...
## DESCRIPTION
O cmdlet **New-AzRelayNamespace** cria um novo namespace Relay. Depois de criado, o manifesto do recurso namespace é imutável.
...
Cria um novo namespace Relay dentro do grupo de recursos especificado.
