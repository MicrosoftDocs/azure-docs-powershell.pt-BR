...
## DESCRIPTION
O cmdlet **Get-AzRelayNamespace** obtém uma descrição do namespace Relay especificado no grupo de recursos.
...
Retorna uma descrição do namespace Relay especificado.
