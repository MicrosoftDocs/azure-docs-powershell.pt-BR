...
## SYNOPSIS
Remover malha de serviço um tipo de aplicativo do cluster. Isso removerá todas as versões de tipo sob esse recurso. Oferece suporte ARM tipos de aplicativo implantados.
...
## DESCRIPTION
Este cmdlet remove um tipo de aplicativo do cluster e removerá toda a versão do tipo sob esse recurso, mas todos os aplicativos sob ele devem ser removidos antes de executar esse comando.
