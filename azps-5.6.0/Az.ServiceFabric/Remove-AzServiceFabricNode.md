...
## DESCRIPTION
Use **Remove-AzServiceFabricNode** para remover nós de um tipo de nó específico de um cluster. A remoção só prosseguirá se atender às métricas de saúde do cluster.
...
Este comando removerá 2 nós do NodeType 'nt1'.
