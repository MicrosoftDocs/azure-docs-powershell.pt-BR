...
## DESCRIPTION
Use **Remove-AzServiceFabricClientCertificate** para remover um(s) certificado(s) ou (s) nome(s) de certificado (s) de ser usado para autenticação do cliente para o cluster.
...
Este comando removerá o certificado do cliente com a impressão digital '5F3660C715EBBDA31DB1FFDCF508302348DE8E7A' do cluster.
