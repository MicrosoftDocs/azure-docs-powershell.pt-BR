...
## DESCRIPTION
Remova o tipo de nó ou nós específicos dentro do tipo de nó. Se a marcação -NodeName for usada, somente nós especificados serão removidos.
...
Remover tipo de nó, com canalização.
...
Remova 2 nós do tipo de nó, com canalização.
...
Use com cautela, pois isso pode causar perda de dados se cargas de trabalho de estado estão sendo executados nos nós ou pode derrubar o cluster se não houver nós de semente suficientes após o opearion.
