...
Atualize o nome dns e a porta de conexão do cliente para o cluster, com canalização.
...
Porta usada para conexões do cliente com o cluster. Padrão: 19000.
...
### -ResourceId
ID de recurso de Cluster Gerenciado
