...
## DESCRIPTION
Remova a extensão vm do tipo de nó por nome. Use [Get-AzServiceFabricManagedNodeType](./Get-AzServiceFabricManagedNodeType.md) e veja a propriedade VmExtensions para ver a extensão atual no tipo de nó.
...
Remova a extensão do tipo de nó por nome, com canalização.
