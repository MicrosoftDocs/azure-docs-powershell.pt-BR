...
## SYNOPSIS
Obter detalhes da versão do tipo de aplicativo do Service Fabric. Só dá suporte ARM versões de tipo de aplicativo implantadas.
...
## DESCRIPTION
Use este cmdlet para obter os detalhes da versão do tipo de aplicativo no grupo de recursos especificado e no cluster.
...
Este exemplo obtém uma lista das versões de tipo de aplicativo definidas sob o cluster especificado e o tipo.
