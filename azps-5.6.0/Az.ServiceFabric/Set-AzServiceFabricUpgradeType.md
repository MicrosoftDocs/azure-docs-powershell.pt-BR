...
## DESCRIPTION
Use **Set-AzServiceFabricUpgradeType** para definir o tipo de atualização como automático ou manual com a versão de código do Service Fabric específica.
...
Este comando definirá o modo de atualização de cluster como automático.
