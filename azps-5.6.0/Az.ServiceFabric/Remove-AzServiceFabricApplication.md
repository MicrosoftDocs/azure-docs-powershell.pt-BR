...
## SYNOPSIS
Remova um aplicativo do cluster. Isso removerá todos os serviços no aplicativo. Só dá suporte ARM aplicativos implantados.
...
## DESCRIPTION
Este cmdlet remove um formulário de aplicativo do cluster. Isso removerá todos os serviços, se for o caso, no recurso application.
