...
## DESCRIPTION
Adicione extensão vm ao tipo de nó. Isso adicionará a extensão ao recurso Conjunto de Escala de Máquina Virtual subliying.
...
Este comando adiciona uma extensão ao tipo de nó.
...
Este comando adiciona uma extensão com configurações e configurações protegidas ao tipo de nó.
...
Este comando adiciona uma extensão ao tipo de nó, com canalização.
...
Isso pode usar o cmdlet Get-AzVMImagePublisher para obter o editor.
