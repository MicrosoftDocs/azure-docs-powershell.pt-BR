...
## DESCRIPTION
Use **Add-AzServiceFabricClientCertificate** para adicionar um nome comum e impressão digital de emissor ou impressão digital de certificado ao cluster, para que o cliente possa usá-la para autenticação.
...
Este comando adicionará um certificado de cliente somente leitura que tem o nome comum 'Contoso.com' e a impressão digital do emissor é '5F3660C715EBBDA31DB1FFDCF508302348DE8E7A' no cluster.
...
Especificar a impressão digital do certificado do cliente que só tem permissão de administrador
...
Especificar o nome comum do cliente, impressão digital do emissor e tipo de autenticação
...
### -CommonName
Especificar o nome comum do certificado do cliente
...
### -IssuerThumbprint
Especificar impressão digital do emissor do certificado do cliente
...
Especifique a impressão digital do certificado do cliente que tem somente permissão de leitura
...
### -Thumbprint
Especificar impressão digital do certificado do cliente
