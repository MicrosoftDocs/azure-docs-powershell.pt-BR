...
## SYNOPSIS
Remover o service fabric uma versão do tipo de aplicativo do cluster. Só dá suporte ARM versões de tipo de aplicativo implantadas.
...
## DESCRIPTION
Este cmdlet removerá a malha de serviço de uma versão de tipo de aplicativo do cluster. Todos os aplicativos sob esse recurso devem ser removidos antes de executar este comando.
...
Este exemplo removerá a versão "v1" no tipo "testAppType". Se houver aplicativos sob esse recurso, o comando lançará uma exceção.
