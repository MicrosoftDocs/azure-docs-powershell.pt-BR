...
## SYNOPSIS
Obter detalhes do serviço de Malha de Serviço no aplicativo e cluster especificados. Só dá suporte ARM serviços implantados.
...
Este exemplo obtém uma lista dos serviços no aplicativo "testApp".
