...
## DESCRIPTION
Define propriedades de recurso de tipo de nó ou executar ações de reimage em ndes específicos do tipo de nó com o parâmetro -Reimage. Na operação reimgae, os nós de malha de serviço serão desabilitados antes de reimaginar as vms e habilita-las novamente assim que retornarem. Se isso for feito em tipos de nó primários, pode demorar um pouco, pois pode não reimage todos os nós ao mesmo tempo. Use -ForceReimage force a operação, mesmo que a malha de serviço não consiga desabilitar os nós, mas use com cautela, pois isso pode causar perda de dados se cargas de trabalho de estado estão sendo executados no nó.
...
Nó Reimage 0 e 3 no tipo de nó.
...
Atualize a contagem de instâncias do tipo de nó, com canalização.
...
### -Capacity
Marcas de capacidade aplicadas aos nós no tipo de nó como pares de chave/valor, o gerenciador de recursos de cluster usa essas marcas para entender quanto recurso um nó tem. Atualizar isso substituirá os valores atuais.
...
### -ForceReimage
O uso desse sinalizador força a remoção mesmo que a malha de serviço não consiga desabilitar os nós.
Use com cuidado, pois isso pode causar perda de dados se cargas de trabalho de estado estão sendo executados no nó.
...
### -NodeName
Lista de nomes de nós para a operação.
...
### -PlacementProperty
Marcas de posicionamento aplicadas aos nós no tipo de nó como pares de chave/valor, que podem ser usadas para indicar onde determinados serviços (carga de trabalho) devem ser executados. Atualizar isso substituirá os valores atuais.
...
### -Reimage
Especifique para reimagear nós no tipo de nó.
