...
### Exemplo 1: Listar todos os dispositivos conectados em uma assinatura
```powershell
...
Lista todos os dispositivos conectados em uma assinatura.
Se a assinatura não for especificada, ela usará a assinatura do contexto atual do Azure PowerShell.

### Exemplo 2: Listar todos os dispositivos conectados em um grupo de recursos
```powershell
...
Listar todos os dispositivos conectados em um grupo de recursos.

### Exemplo 3: Obter uma máquina conectada em um grupo de recursos pelo nome
```powershell
...
Obter uma máquina conectada em um grupo de recursos pelo nome.
...
### -Expand
A expressão expandir a ser aplicada à operação.
