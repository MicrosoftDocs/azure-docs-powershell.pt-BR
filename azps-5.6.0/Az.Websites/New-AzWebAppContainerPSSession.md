...
## SYNOPSIS
New-AzWebAppContainerPSSession criará nova Sessão remota do PowerShell no contêiner do Windows especificado em um determinado site ou slot e determinado grupo de recursos
...
Isso criará uma nova Sessão remota do PowerShell no aplicativo de contêiner do Windows ContosoASP e mostrará os processos que estão sendo executados no contêiner ContosoASP
