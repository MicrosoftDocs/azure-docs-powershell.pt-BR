...
## DESCRIPTION
O cmdlet **Get-AzWebAppSlotPublishingProfile** obtém o perfil de publicação do Web App para o slot especificado.
...
Este comando obtém o perfil de publicação no formato Ftp para slot Slot001 pertencente ao Web App ContosoWebApp associado ao grupo de recursos Default-Web-WestUS e o armazena no arquivo de saída especificado.
...
Incluir os pontos de extremidade de recuperação de desastres se for verdadeiro
