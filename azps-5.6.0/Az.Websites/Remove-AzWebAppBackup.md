...
## DESCRIPTION
O cmdlet **Remove-AzWebAppBackup** remove o backup especificado de um Aplicativo Web do Azure.
...
Este comando remove o backup com backup com a ID de "12345" do Aplicativo Web chamado WebAppStandard que pertence ao grupo de recursos Default-Web-WestUS.
