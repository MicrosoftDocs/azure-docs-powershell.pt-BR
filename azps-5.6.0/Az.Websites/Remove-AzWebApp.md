...
## DESCRIPTION
O cmdlet **Remove-AzWebApp** remove um Aplicativo Web do Azure fornecido pelo grupo de recursos e pelo nome do Aplicativo Web.
...
Este comando remove o Aplicativo Web do Azure chamado ContosoSite que pertence ao grupo de recursos chamado Default-Web-WestUS.
