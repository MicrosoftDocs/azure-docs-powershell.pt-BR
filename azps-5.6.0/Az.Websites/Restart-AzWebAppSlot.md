...
## DESCRIPTION
O cmdlet **Restart-AzWebAppSlot** para e inicia um Slot do Aplicativo Web do Azure.
Se o Slot do Aplicativo Web estiver em um estado interrompido, use o cmdlet Start-AzWebAppSlot web.
...
Este comando reinicia o slot Slot001 para o aplicativo Web ContosoWebApp associado ao grupo de recursos Default-Web-WestUS
