...
Obtém o instantâneo mais recente de um aplicativo Web chamado "ContosoApp" com um slot chamado "Preparação" no grupo de recursos "Default-Web-WestUS". Restaura o instantâneo para o slot "Restaurar" do aplicativo Web.
