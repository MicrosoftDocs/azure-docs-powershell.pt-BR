...
## DESCRIPTION
O cmdlet **Remove-AzWebAppTrafficRouting** remove uma regra de roteamento de um Slot de Aplicativo Web do Azure.
...
Este comando remove uma regra de roteamento para um determinado slot de webapp.
