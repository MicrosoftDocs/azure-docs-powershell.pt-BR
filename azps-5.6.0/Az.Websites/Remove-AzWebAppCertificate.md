...
## SYNOPSIS
Remove um certificado gerenciado do serviço de aplicativo para um Aplicativo Web do Azure. 
...
## DESCRIPTION
O cmdlet **Remove-AzWebAppCertificate** Removes an Azure App Service Managed Certificate
...
Este comando remove o certificado Gerenciado do Serviço de Aplicativo para o determinado aplicativo Web.
