...
## DESCRIPTION
O cmdlet **Get-AzWebAppSlot** obtém informações sobre um Slot do Aplicativo Web do Azure.
...
Este comando obtém o slot chamado Slot001 do Aplicativo Web chamado WebAppStandard que pertence ao grupo de recursos Default-Web-WestUS.
