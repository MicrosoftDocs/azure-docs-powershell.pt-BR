...
Este comando alterna o slot "sourceslot" com "destinationslot" do Web App ContosoWebApp associado ao grupo de recursos Default-Web-WestUS
...
Troca com ação de visualização
