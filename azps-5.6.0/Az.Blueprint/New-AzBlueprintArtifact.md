...
Crie um novo artefato por meio de um arquivo ARM modelo.
...
### -DependsOn
Lista dos nomes de artefatos que precisam ser criados antes que o artefato atual seja criado.
...
Hashtable de parâmetros para passar para o artefato de definição de política.
...
### -ResourceGroupName
Nome do grupo de recursos em que o artefato estará.
...
### -TemplateFile
Local do arquivo ARM de modelo no disco.
...
Local do arquivo de parâmetro ARM modelo no disco.
