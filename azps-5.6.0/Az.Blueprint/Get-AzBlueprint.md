...
## DESCRIPTION
Obter uma ou mais definições de projeto. As definições de projeto existem no grupo de gerenciamento ou no escopo de assinatura.
...
Obter as definições de projeto dentro da assinatura atual e a hierarquia de grupo de gerenciamento da assinatura.
...
Obter as definições de projeto dentro do grupo de gerenciamento especificado.
...
Obter as definições de projeto dentro da assinatura especificada e a hierarquia de grupo de gerenciamento da assinatura.
...
Obter a definição de projeto com o nome determinado dentro da assinatura especificada.
...
Obter a definição de projeto com o nome e a versão especificados no grupo de gerenciamento especificado.
...
Obter a definição de projeto publicado mais recente com o nome indicado no grupo de gerenciamento especificado.
...
### -LatestPublished
O sinalizador de definição de projeto publicado mais recente.
Quando definido, a execução retorna a versão publicada mais recente da definição do modelo.
O padrão é false.
...
### -ManagementGroupId
ID do Grupo de Gerenciamento onde a definição de projeto é salva.
...
### -SubscriptionId
ID da assinatura onde a definição de projeto é salva.
