...
## DESCRIPTION
Remova um projeto que tenha sido atribuído a uma assinatura.
...
Remova a atribuição de projeto especificada pelo nome da assinatura especificada. O cmdlet solicitará confirmação antes de executar o comando.
