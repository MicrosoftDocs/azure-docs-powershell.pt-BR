...
## DESCRIPTION
Crie um túnel SSH Kubectl no painel do cluster gerenciado. O túnel SSH é configurado em um trabalho do PowerShell chamado Kubectl-Tunnel e pode ser encontrado executando `Get-Job` . O túnel deve estar acessível por [http://127.0.0.1:8001](http://127.0.0.1:8001) meio de .

## EXEMPLOS

### Inicie um túnel SSH e abra um navegador para o painel kubernetes
```
...
### -DisableBrowser
Não abra um navegador depois de estabelecer o kubectl port-forward.
...
### -Id
ID de um cluster kubernetes gerenciado
...
### -PassThru
O cmdlet retorna o KubeTunnelJob se for passado.
