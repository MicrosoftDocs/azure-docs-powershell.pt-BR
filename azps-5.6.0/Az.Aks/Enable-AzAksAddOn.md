...
Habilita os `HttpApplicationRouting` complementos `Monitoring` , , e para `AzurePolicy` `VirtualNode` `KubeDashboard` aks.
...
### -SubnetName
Nome da sub-rede de VirtualNode.
...
### -WorkspaceResourceId
ID de recurso do espaço de trabalho do Monitoramento.
