...
## DESCRIPTION
O New-AzContainerRegistryReplication cmdlet cria uma nova replicação de registro de contêiner.
...
Crie uma nova replicação de registro de contêiner.
...
### -Tag
Marcas de Registro de Contêiner.
