...
## DESCRIPTION
O Get-AzContainerRegistryWebhook cmdlet obtém um webhook especificado do registro de contêiner ou todos os webhooks de um registro de contêiner.
...
Obter as informações de configuração para um webhook.
