...
O usuário administrador precisa estar habilitado para que o Registro de contêiner \` MyRegistry \` regenere credenciais de logon.
...
### -PasswordName
O nome da senha a ser regenerada.
