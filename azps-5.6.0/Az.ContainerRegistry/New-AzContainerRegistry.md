...
## DESCRIPTION
O New-AzContainerRegistry cmdlet cria um registro de contêiner.
...
Este comando cria um registro de contêiner com uma nova conta de armazenamento no grupo de recursos \` MyResourceGroup \` .

### Exemplo 2: Criar um registro de contêiner com o usuário de administrador habilitado.
```powershell
...
Este comando cria um registro de contêiner com o usuário de administrador habilitado.
...
### -EnableAdminUser
Habilitar o usuário de administrador para o registro de contêiner.
...
### -Sku
SKU do Registro de Contêiner.
Valores permitidos: Básico.
...
### -Tag
Container Registry Tags.Key-value pairs na forma de uma tabela de hash.
