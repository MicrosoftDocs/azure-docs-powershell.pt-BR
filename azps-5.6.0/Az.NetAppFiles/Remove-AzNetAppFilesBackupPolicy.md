...
## SYNOPSIS
Exclui uma política de backup arquivos do Azure NetApp (ANF).
...
## DESCRIPTION
O cmdlet **Remove-AzNetAppFilesBackupPolicy** exclui uma política de backup ANF.
...
Este comando exclui a nova política de backup ANF com o nome "MyBackupPolicy" para a conta "MyAccount".
...
### -AccountObject
O objeto Account que contém a Política de Backup a ser removido
