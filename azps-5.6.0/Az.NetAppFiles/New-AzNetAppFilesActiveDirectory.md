...
## SYNOPSIS
Cria uma nova configuração do Active Directory Azure NetApp Files (ANF).
...
Esse comando obtém a senha do AD de promt em uma secreta a nova configuração do Active Directory para a conta ANF "MyAnfAccount".
