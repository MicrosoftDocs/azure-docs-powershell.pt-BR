...
## SYNOPSIS
Obtém detalhes de um volume Azure NetApp Files (ANF).
...
Este comando obtém o volume chamado MyAnfVolume do pool "MyAnfPool". 
...
### -PoolObject
O objeto pool que contém o volume a ser retornado
