...
## SYNOPSIS
Atualiza uma política de backup arquivos do Azure NetApp (ANF) para os modificadores opcionais fornecidos.
...
## DESCRIPTION
O cmdlet **Update-AzNetAppFilesBackupPolicy** modifica uma política de backup ANF.
...
Este comando altera a política de backup da ANF "MyBackupPolicy" para ter o DailyBackupsToKeep determinado.
...
### -AccountObject
O objeto Account que contém a Política de Backup a ser atualizada
...
### -DailyBackupsToKeep
Contagem de backups diários a ser manter
...
### -InputObject
O objeto BackupPolicy a ser removido
...
Contagem mensal de backups a ser manter
...
### -Name
O nome da política de backup da ANF
...
### -ResourceId
A id de recurso da Política de Backup da ANF
...
### -WeeklyBackupsToKeep
Contagem de backups semanais para manter
...
### -YearlyBackupsToKeep
Contagem anual de backups a ser manter
