...
## SYNOPSIS
Exclui uma configuração do Active Directory do Azure NetApp Files (ANF).
...
Este comando exclui a nova configuração do active directory ANF com o nome "MyADName".
