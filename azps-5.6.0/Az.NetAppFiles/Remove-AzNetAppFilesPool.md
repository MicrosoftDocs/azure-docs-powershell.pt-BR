...
Este comando exclui o pool ANF "MyAnfPool".
...
### -AccountObject
O objeto account que contém o pool a ser removido
...
### -PassThru
Retornar se o pool especificado foi removido com êxito
