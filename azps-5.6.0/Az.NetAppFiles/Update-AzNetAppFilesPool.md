...
### Exemplo 1: Modificar um pool ANF
```
...
Este comando altera o pool de ANF "MyAnfPool" para ter o tamanho determinado e QosType.
...
### -InputObject
O objeto pool a ser atualizado
...
### -QosType
O tipo qos do pool. Os valores possíveis incluem: 'Auto', 'Manual'
...
### -ResourceId
A id de recurso do pool de ANF
