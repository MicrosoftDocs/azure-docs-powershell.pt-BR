...
### Exemplo 1 : atualiza uma conta ANF
```
...
Este comando executa uma atualização na conta fornecida modificando as marcas para as fornecidas.
...
### -InputObject
O objeto account a ser atualizado
