...
## SYNOPSIS
Cria uma nova política de backup arquivos do Azure NetApp (ANF) para uma conta ANF.
...
## DESCRIPTION
O cmdlet **New-AzNetAppFilesActiveDirectory** cria uma nova política de backup para uma conta ANF.
...
Este comando cria a nova política de backup ANF para a conta ANF denominada "MyAccount".
...
### -AccountObject
O objeto Account da nova Política de Backup
