...
## SYNOPSIS
Atualiza uma conta do Azure NetApp Files (ANF) com o novo conjunto de dados. Útil para excluir diretórios ativos associados.
...
Este comando executa uma atualização na conta determinada. A ausência do active directory significa que ele será removido da conta.

## PARÂMETROS

### -ActiveDirectory
Uma matriz hashtable que representa os diretórios ativos
