...
Este comando altera a política de backup da ANF "MySnapshotPolicy" para ter o hourlySchedule determinado.
...
### -DailySchedule
Uma matriz hashtable que representa o agendamento diário
...
### -HourlySchedule
Uma matriz hashtable que representa o agendamento por hora
...
### -MonthlySchedule
Uma matriz hashtable que representa o agendamento montly
...
### -ResourceId
A id de recurso da Política de Instantâneo ANF
