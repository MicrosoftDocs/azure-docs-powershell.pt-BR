...
## DESCRIPTION
O cmdlet **Update-AzNetAppFilesBackup** modifica um backup ANF.
...
Este comando executa uma atualização no backup fornecido modificando o nome de usuário para o fornecido.
