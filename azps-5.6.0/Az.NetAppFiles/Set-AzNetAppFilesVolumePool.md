...
## SYNOPSIS
Alterar pool para um volume Azure NetApp Files (ANF).
...
### -InputObject
O objeto volume a ser movimentado
...
### -NewPoolResourceId
ResourceId do pool de capacidade para o que se mover.
...
### -PoolObject
O objeto pool que contém o volume
