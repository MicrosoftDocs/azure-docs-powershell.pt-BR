...
Este comando exclui o novo backup ANF com o nome "MyBackup" para volume "MyVolume".
...
### -VolumeObject
O objeto volume que contém o backup a ser retornado
