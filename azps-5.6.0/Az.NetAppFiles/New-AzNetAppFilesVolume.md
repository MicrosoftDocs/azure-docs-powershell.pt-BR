...
## SYNOPSIS
Cria um novo volume Azure NetApp Files (ANF).
...
Este comando cria o novo volume ANF "MyAnfVolume" dentro do pool "MyAnfPool".
...
### -ReplicationObject
Uma matriz hashtable que representa o objeto de replicação
...
### -Instantâneo
Uma matriz hashtable que representa o objeto instantâneo
...
Se habilitado (true), o volume conterá um diretório .instantâneo somente leitura que fornece acesso a cada um dos instantâneos do volume (padrão true)
...
### -ThroughputMibps
Produtividade máxima em Mibps que pode ser atingida por esse volume
