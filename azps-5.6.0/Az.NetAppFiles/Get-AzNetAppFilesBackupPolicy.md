...
Este comando obtém a política de backup chamada "MyBackupPolicy" para a conta "MyAnfAccount".
...
### -AccountObject
O objeto Account que contém a Política de Backup a ser retornada
