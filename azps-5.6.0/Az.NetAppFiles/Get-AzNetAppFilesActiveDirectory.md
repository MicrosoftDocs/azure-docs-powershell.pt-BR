...
## DESCRIPTION
O cmdlet **Get-AzNetAppFilesActiveDirectory** obtém detalhes de uma configuração de contas ANF do Active Directory.
...
Este comando obtém a configuração do AD chamada MyADConfigName para a conta arquivos do Azure NetApp (ANF) chamada MyAnfAccount.
...
### -AccountObject
A Conta do novo objeto Active Directory
...
### -ActiveDirectoryId
ActiveDirectoryId do ANF Active Directory
