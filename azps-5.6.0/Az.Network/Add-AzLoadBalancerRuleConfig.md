...
O segundo comando usa o operador de pipeline para passar o balanceador de carga no $slb para **Add-AzLoadBalancerRuleConfig**, que adiciona a configuração de regra chamada NewRule.
O terceiro comando atualizará o balanceador de carga no azure com a nova Configuração de Regra do Balanceador de Carga.
...
### -BackendPort
Especifica a porta de back-end para tráfego que é corresponder a uma configuração de regra de balanceador de carga.
...
Especifica o período de tempo, em minutos, que o estado das conversas é mantido no balanceador de carga.
...
Este cmdlet adiciona uma configuração de regra ao balanceador de carga especificado por esse parâmetro.
...
### -Name
Especifica o nome da configuração da regra do balanceador de carga.
