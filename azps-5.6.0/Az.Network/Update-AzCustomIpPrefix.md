...
## DESCRIPTION
O cmdlet **Update-AzCustomIpPrefix** permite que o usuário comissione ou desative seu CustomIpPrefix ou edite as marcas do recurso.

## EXEMPLOS

### Exemplo 1 : Comissionar o CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Commission
```

O comando acima iniciará o processo de comissionamento do CustomIpPrefix.

### Exemplo 2 : Descompactar o CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Decommission
```

O comando acima iniciará o processo de desmissionamento do CustomIpPrefix.
...
O comando acima atualizará as marcas do CustomIpPrefix.
