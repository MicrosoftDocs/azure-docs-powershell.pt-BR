...
## SYNOPSIS
Obtém um recurso ExpressRouteGateway usando ResourceGroupName e GatewayName OR lista todos os gateways por ResourceGroupName ou SubscriptionId.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual no Centro Oeste dos EUA no grupo de recursos "testRG" no Azure. Um gateway ExpressRoute será criado posteriormente no Hub Virtual com duas unidades de escala.

Em seguida, obtém o ExpressRouteGateway usando seu resourceGroupName e o nome do gateway.
...
Este comando obterá todos os ExpressRouteGateways que começam com "test"
