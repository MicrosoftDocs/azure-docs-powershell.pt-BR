...
## SYNOPSIS
O Remove-AzExpressRouteGateway cmdlet remove um gateway do Azure ExpressRoute. Esse é um gateway específico para a conectividade definida do software wan virtual do Azure.
...
Este exemplo cria um grupo de Recursos, WAN Virtual, Hub Virtual, gateway ExpressRoute escalonável na Central dos EUA e o exclui imediatamente. Para suprimir o prompt ao excluir o Gateway Virtual, use o sinalizador -Force.
...
Este exemplo cria um grupo de Recursos, WAN Virtual, Hub Virtual, gateway ExpressRoute escalonável no Centro Oeste dos EUA e o exclui imediatamente. Essa exclusão acontece usando a canalização do powershell, que usa o objeto ExpressRouteGateway retornado pelo Get-AzExpressRouteGateway comando.
