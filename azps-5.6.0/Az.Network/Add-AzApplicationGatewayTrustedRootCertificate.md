...
O segundo comando adiciona um novo certificado raiz confiável ao Gateway de Aplicativo que está tomando o caminho do certificado raiz como entrada.
O terceiro comando cria uma nova configuração http de back-end usando certificado raiz confiável para validar o certificado do servidor back-end.
