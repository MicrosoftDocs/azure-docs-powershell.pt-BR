...
O primeiro comando obtém um gateway de aplicativo e o armazena na $AppGw variável.
O segundo comando remove a regra de roteamento de solicitação chamada Rule02 do gateway de aplicativo armazenado em $AppGw.
