...
### -GatewayVip
O vip do gateway para redefinir uma instância de gateway específica (por exemplo, no caso de Active-Active gateways habilitados para recursos).) Por padrão, a instância primária do gateway será redefinida se nenhum valor for passado.
