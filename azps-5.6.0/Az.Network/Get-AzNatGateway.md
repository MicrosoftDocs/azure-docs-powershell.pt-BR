...
## SYNOPSIS
Obtém um recurso Nat Gateway em um grupo de recursos pelo nome ou ID do NatGateway ou todos os recursos do Nat Gateway em um grupo de recursos.
...
## DESCRIPTION
Obtém um recurso Nat Gateway em um grupo de recursos pelo nome OU ID do NatGateway OU todos os recursos nat gateway em um grupo de recursos.
