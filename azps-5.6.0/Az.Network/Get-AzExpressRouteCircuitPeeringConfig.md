...
## SYNOPSIS
Obtém uma configuração de paração de circuitos ExpressRoute.
...
## DESCRIPTION
O cmdlet **Get-AzExpressRouteCircuitPeeringConfig** recupera a configuração de uma relação de paridade para um circuito ExpressRoute.

## EXEMPLOS

### Exemplo 1: Exibir a configuração de peering para um circuito ExpressRoute
```
...
### -ExpressRouteCircuit
O objeto de circuito ExpressRoute que contém a configuração de peering.
