...
Os três primeiros comandos configuram um IP público, um front-end e uma sonda para a configuração de regra no comando forth. O comando forth cria uma nova regra chamada MyLBrule com determinadas especificações.

## PARÂMETROS

### -BackendAddressPool
Especifica um **objeto BackendAddressPool** a ser associado a uma configuração de regra de balanceador de carga.
...
### -BackendPort
Especifica a porta de back-end para tráfego que é corresponder a essa configuração de regra de balanceador de carga.
...
### -Probe
Especifica uma sonda a ser associada a uma configuração de regra de balanceador de carga.
...
### -ProbeId
Especifica a ID da sonda a ser associada a uma configuração de regra de balanceador de carga.
...
### -Protocol
Especifica o protocolo que é correspondente por uma configuração de regra de balanceador de carga.
