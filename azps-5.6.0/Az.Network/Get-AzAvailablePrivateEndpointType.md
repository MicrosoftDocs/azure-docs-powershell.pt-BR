...
## SYNOPSIS
Retorne os tipos de ponto de extremidade particular disponíveis no local.
...
## DESCRIPTION
O cmdlet **Get-AzAvailablePrivateEndpointType** retorna todos os tipos de ponto de extremidade particular disponíveis no local.
...
Este exemplo retorna todos os tipos de ponto de extremidade particular disponíveis no local.
