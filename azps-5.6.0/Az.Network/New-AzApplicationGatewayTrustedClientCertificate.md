...
## SYNOPSIS
Cria uma cadeia de certificados de AC de cliente confiável para um gateway de aplicativo.
...
## DESCRIPTION
O New-AzApplicationGatewayTrustedClientCertificate cmdlet cria uma cadeia de certificados ca de cliente confiável para um gateway de aplicativo.
...
```
O comando cria um novo objeto de cadeia de certificados de CA de cliente confiável que está tomando o caminho do certificado ca do cliente como entrada.
