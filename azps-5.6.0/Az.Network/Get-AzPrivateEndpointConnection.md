...
## SYNOPSIS
Obtém um recurso de conexão de ponto de extremidade privado.
...
## DESCRIPTION
O cmdlet **Get-AzPrivateEndpointConnection** recupera um recurso de conexão de ponto de extremidade privado.
...
Este exemplo retorna uma lista de todas as conexões de ponto de extremidade privadas que pertencem ao sql server chamado Mysql.
...
Este exemplo obter uma conexão de ponto de extremidade privada chamada MyPrivateEndpointConnection1 pertence a um serviço de link privado chamado MyPrivateLinkService
...
A ID do gerenciador de recursos do Azure do recurso de link privado que a conexão de ponto de extremidade privada pertence.
