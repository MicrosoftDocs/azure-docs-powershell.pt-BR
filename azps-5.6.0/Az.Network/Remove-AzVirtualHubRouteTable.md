...
## SYNOPSIS
Exclua um recurso de tabela de rota de hub virtual associado a um hub virtual.
...
Este comando exclui o routeTable1 do hub virtual westushub.
...
### -ResourceId
A id de recurso do recurso virtualhubroutetable a ser removido.
