...
### -ApplicationGateway
Especifica o gateway de aplicativo da política SSL que este cmdlet modifica.
...
### -CipherSuite
Pacote de codificação Ssl a ser habilitado na ordem especificada para gateway de aplicativo
