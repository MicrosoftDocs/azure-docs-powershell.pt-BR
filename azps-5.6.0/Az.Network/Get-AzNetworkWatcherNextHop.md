...
## DESCRIPTION
O Get-AzNetworkWatcherNextHop cmdlet obtém o próximo salto de uma VM. O próximo salto permite que você veja o tipo de recurso do Azure, o endereço IP associado desse recurso e a regra de tabela de roteamento responsável pela rota.
