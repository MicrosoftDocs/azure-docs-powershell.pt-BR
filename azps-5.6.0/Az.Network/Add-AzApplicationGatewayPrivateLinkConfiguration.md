...
## SYNOPSIS
Adiciona uma configuração de link privado a um gateway de aplicativo.
...
O terceiro comando adiciona a configuração de link privado chamada privateLinkConfig01, para o gateway no $AppGw
