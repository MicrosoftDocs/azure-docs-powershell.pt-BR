...
O primeiro comando obtém o balanceador de carga chamado MyLoadBalancer e o armazena na variável $loadbalancer de carga.
O segundo comando remove a configuração de regra chamada MyLBruleName do balanceador de carga no $loadbalancer.
...
### -Name
Especifica o nome da configuração de regra do balanceador de carga que este cmdlet remove.
