...
## SYNOPSIS
Listar rotas que estão sendo anunciadas por pares de roteador virtual específicos
...
## DESCRIPTION
Dado um par de roteador virtual por nome ou por objeto, enumerar rotas que estão sendo anunciadas para esse par por um roteador virtual específico.
...
### -InputObject
O objeto de entrada par do roteador virtual.
...
### -ResourceGroupName
Nome do grupo de recursos do par de roteador virtual
