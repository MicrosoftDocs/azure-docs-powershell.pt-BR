...
Primeiro, criamos um objeto Rota de Hub Virtual e o usamos para criar um recurso de Tabela de Rota de Hub Virtual. Em seguida, definimos esse recurso de tabela de rota para o hub virtual usando o Set-AzVirtualHub comando.
