...
## SYNOPSIS
Cria uma nova configuração de autenticação de cliente para perfil SSL.
...
O comando cria uma nova configuração de auth do cliente e a armazena $clientAuthConfig variável a ser usada em um perfil SSL. 
