...
## SYNOPSIS
Cria uma regra NAT em uma VpnGateway que pode ser associada a VpnSiteLinkConnection.
...
## DESCRIPTION
Cria uma regra NAT em uma VpnGateway que pode ser associada a VpnGateway.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual. Em seguida, criaremos VpnGateway sob esse Hub Virtual. Em seguida, usando este comando: New-AzVpnGatewayNatRule, a regra NAT pode ser criada e associada ao VpnGateway criado.
...
### -ParentResourceId
A id de recurso do VpnGateway pai para esta Regra NAT.
