...
O primeiro comando obtém uma tabela de rota chamada RouteTable01 usando o cmdlet Get-AzRouteTable de rota.
...
Este comando obtém a tabela de rota chamada RouteTable01 usando **Get-AzRouteTable**.
...
### -Name
Especifica um nome da rota a ser acrescentada à tabela de rota.
