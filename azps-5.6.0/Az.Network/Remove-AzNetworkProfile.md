...
## DESCRIPTION
O cmdlet **Remove-AzNetworkProfile** removerá um perfil de rede se nenhuma interface de rede de contêiner (como contrastada com uma configuração de **interface** de rede de contêiner ) tiver sido criada.
...
Isso remove o perfil de rede com o nome np1 do grupo de recursos rg1.
