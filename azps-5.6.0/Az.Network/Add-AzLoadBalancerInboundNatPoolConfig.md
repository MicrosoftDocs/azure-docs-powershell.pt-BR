...
## SYNOPSIS
Adiciona um pool NAT de entrada a um balanceador de carga.
...
## DESCRIPTION
O cmdlet **Add-AzLoadBalancerInboundNatPoolConfig** adiciona um pool NAT de entrada a um balanceador de carga.
