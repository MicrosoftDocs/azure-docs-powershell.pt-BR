...
## DESCRIPTION
O New-AzTrafficSelectorPolicy cmdlet cria uma proposta de política de seletor de tráfego a ser usada em uma conexão de gateway de rede virtual.
...
Cria uma instância de uma política de seletor de tráfego e a adiciona como parâmetro ao criar uma conexão de gateway de rede virtual com um protocolo IKEv2.
