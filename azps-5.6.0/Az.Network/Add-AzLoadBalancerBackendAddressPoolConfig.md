...
Esse comando obtém o balanceador de carga chamado MyLoadBalancer, adiciona o pool de endereços back-end chamado BackendAddressPool02 ao MyLoadBalancer e usa o cmdlet **Set-AzLoadBalancer** para atualizar MyLoadBalancer.
...
### -Name
Especifica o nome da configuração do pool de endereços back-end a ser acrescentado.
