...
## SYNOPSIS
Adiciona uma configuração de conexão de circuito ao Private Peering de um Circuito de Rota Expressa. 
...
### Exemplo 2: Adicionar uma configuração de conexão de circuito usando a canalização a um Circuito ExpressRoute existente
```
$circuit_peer = Get-AzExpressRouteCircuit -Name $peeringCircuitName -ResourceGroupName $rg
$addressSpace = '60.0.0.0/29'
...
```
### -AddressPrefixType
Isso especifica a Família de Endereços à que o prefixo de endereço pertence.
