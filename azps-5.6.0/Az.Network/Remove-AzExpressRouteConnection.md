...
Depois que o gateway for criado, ele será conectado ao ExpressRouteSite usando o comando New-AzExpressRouteConnection.
...
O mesmo que o exemplo 1, mas agora remove a conexão usando o objeto canal do Get-AzExpressRouteConnection.
...
### -ResourceId
A id de recurso do objeto ExpressRouteConnection a ser excluído.
