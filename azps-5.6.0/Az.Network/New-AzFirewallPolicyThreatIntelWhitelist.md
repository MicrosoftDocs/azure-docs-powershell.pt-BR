...
## SYNOPSIS
Criar uma nova lista branca de inteligência contra ameaças para a Política de Firewall do Azure
...
Este exemplo cria uma lista branca de intel de ameaça que contém uma lista branca FQDN de uma entrada e uma lista branca de endereço Ip de duas entradas
