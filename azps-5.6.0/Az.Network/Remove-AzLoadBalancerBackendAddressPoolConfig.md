...
Este comando obtém o balanceador de carga chamado MyLoadBalancer e o passa para **Remove-AzLoadBalancerBackendAddressPoolConfig**, que remove a configuração BackendAddressPool02 do MyLoadBalancer.
Finalmente, o cmdlet Set-AzLoadBalancer atualiza MyLoadBalancer.
Observe que uma configuração de pool de endereços back-end deve existir antes de poder excluí-la.
