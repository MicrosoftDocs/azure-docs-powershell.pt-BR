...
## DESCRIPTION
O cmdlet **Set-AzApplicationGatewaySku** modifica a unidade de manutenção de estoque (SKU) de um gateway de aplicativo.

## EXEMPLOS

### Exemplo 1: atualizar o SKU do gateway de aplicativos
```
...
O segundo comando atualiza a SKU do gateway de aplicativo.

## PARÂMETROS

### -ApplicationGateway
Especifica o objeto gateway de aplicativo com o qual esse cmdlet associa a SKU.
...
### -Capacity
Especifica a contagem de instâncias do gateway de aplicativo.
...
### -Tier
Especifica a camada do gateway de aplicativo.
Os valores aceitáveis para este parâmetro são:
- Standard
- WAF
