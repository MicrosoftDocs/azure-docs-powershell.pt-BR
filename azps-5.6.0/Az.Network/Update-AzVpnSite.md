...
O acima criará um grupo de recursos, a WAN Virtual no Oeste dos EUA, no grupo de recursos "testRG" no Azure. 

Em seguida, ele cria um VpnSite para representar uma filial de cliente e o vincula à WAN Virtual.

Depois que o site é criado, ele atualiza o IpAddress do site usando o Set-AzVpnSite comando.

## PARÂMETROS

### -AddressSpace
Os prefixos de endereço da rede virtual.
Use isso ou AddressSpaceObject, mas não ambos.
