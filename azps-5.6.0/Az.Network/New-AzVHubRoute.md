...
## SYNOPSIS
Cria um objeto VHubRoute que pode ser passado como parâmetro para o New-AzVHubRouteTable comando.
...
O comando acima criará um objeto VHubRoute com nextHop como o hubVnetConnection especificado que pode ser adicionado a um recurso VHubRouteTable.
...
```
Os comandos acima obterão RoutingConfiguration de um AzVHubRoute já existente e adicionarão uma rota estática na conexão. Como alternativa, se você espera criar uma nova conexão com a rota estática dentro dela, consulte o Exemplo 1 [aqui.](New-AzRoutingConfiguration.md)
## PARÂMETROS
