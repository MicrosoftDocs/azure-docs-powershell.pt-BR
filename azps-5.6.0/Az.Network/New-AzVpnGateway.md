...
## SYNOPSIS
Cria um Gateway VPN escalonável.
...
## DESCRIPTION
New-AzVpnGateway cria um Gateway VPN escalonável.
Essa é a conectividade definida pelo software para conexões de site para site dentro do VirtualHub.

Esse gateway resize e dimensiona com base na unidade de escala especificada neste ou Set-AzVpnGateway cmdlet.

Uma conexão é configurada de um branch/Site conhecido como VPNSite para o gateway escalonável.
Cada conexão é composta por 2 Active-Active túnel.
...
Sinalizador para habilitar a Internet de Preferência de Roteamento nesta VpnGateway.
