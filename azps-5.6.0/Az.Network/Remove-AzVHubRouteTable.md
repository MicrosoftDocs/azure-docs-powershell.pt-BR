...
## SYNOPSIS
Exclua um recurso de tabela de rota de hub associado a um VirtualHub.
...
## DESCRIPTION
Exclui a tabela de rota de hub especificada associada ao hub virtual especificado.
...
### -InputObject
O recurso vhubroutetable a ser removido.
...
### -ResourceId
A id de recurso do recurso vhubroutetable a ser removido.
