...
### Exemplo 1: atualizar a configuração de firewall do aplicativo web gateway de aplicativo
```
...
O segundo comando habilita a configuração de firewall para o gateway de aplicativo armazenado no $AppGw e define o modo de firewall como "Detecção", RuleSetType como "OWASP" e RuleSetVersion como "3.0".

## PARÂMETROS

### -ApplicationGateway
Especifica um objeto gateway de aplicativo.
Você pode usar o cmdlet Get-AzApplicationGateway para obter um objeto gateway de aplicativo.
