...
## SYNOPSIS
Crie novo recurso Nat Gateway com propriedades Endereço Ip Público/Prefixo ip público, IdleTimeoutInMinutes e Sku.
...
## DESCRIPTION
O cmdlet **New-AzNatGateway** cria um Recurso nat gateway. Um natgateway exige o seguinte: 
...
O primeiro comando cria endereço IP público padrão.
O segundo comando cria o Gateway NAT com Endereço IP Público na Zona de Disponibilidade 1.
...
### -Zone
Uma lista de zonas de disponibilidade que denotam a zona na qual Nat Gateway deve ser implantado.
