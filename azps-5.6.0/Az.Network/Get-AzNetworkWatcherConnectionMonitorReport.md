...
## SYNOPSIS
Consultar um instantâneo dos estados de conexão mais recentes.
...
## DESCRIPTION
O Get-AzNetworkWatcherConnectionMonitorReport cmdlet retorna o relatório sobre os estados de conexão mais recentes.

## EXEMPLOS

### Exemplo 1: Obter o instantâneo de conexão mais recente do monitor de conexão pelo nome no local especificado
```
...
Neste exemplo, consultamos os estados de conexão mais recentes do monitor de conexão especificado.
...
### -ResourceId
ID do recurso do monitor de conexão.
...
## NOTES
Palavras-chave: azure, azurerm, arm, resource, connectivity, management, manager, network, networking, network watcher, connection monitor
