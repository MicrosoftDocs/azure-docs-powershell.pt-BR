...
## SYNOPSIS
Remove uma política de ponto de extremidade de serviço.
...
Este comando remove uma política de ponto de extremidade de serviço com o nome Policy1 que pertence ao grupo de recursos com o nome "resourcegroup1"

### Exemplo 2: Remover uma política de ponto de extremidade de serviço usando o objeto de entrada
```
Remove-AzServiceEndpointPolicy -InputObject $Policy1 -ResourceGroup "resourcegroup1"
```

Este comando remove um objeto policy de ponto de extremidade de serviço Policy1 que pertence ao grupo de recursos com o nome "resourcegroup1"
...
### -InputObject
O objeto de política de ponto de extremidade do serviço.
