...
## SYNOPSIS
Crie um novo P2SVpnGateway em VirtualHub para apontar para a conectividade do site.
...
## DESCRIPTION
O New-AzP2sVpnGateway cmdlet permite que você crie um novo P2SVpnGateway em VirtualHub para conectividade ponto a site de clientes ponto a site para a Azure VirtualWan.
...
O New-AzP2sVpnGateway cmdlet permite que você crie um novo P2SVpnGateway em VirtualHub para conectividade ponto a site.
...
### -VirtualHub
O VirtualHub ao que o P2SVpnGateway precisa estar associado.
...
### -VirtualHubId
A ID do VirtualHub a que o P2SVpnGateway precisa ser associado.
...
Sinalizador para habilitar a Internet de Preferência de Roteamento neste P2SVpnGateway.
