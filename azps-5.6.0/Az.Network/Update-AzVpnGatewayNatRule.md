...
## SYNOPSIS
Atualiza uma regra NAT associada a VpnGateway.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual. Em seguida, criaremos VpnGateway sob esse Hub Virtual. Em seguida, crie uma nova regra NAT associada ao VpnGateway criado.
...
### -ExternalMapping
A lista de mapeamentos externos de sub-rede de endereço IP privados para NAT
...
### -InternalMapping
A lista de mapeamentos internos de sub-rede de endereço IP privados para NAT
...
### -ResourceId
A id de recurso do objeto VpnGatewayNatRule a ser excluído.
