...
### Exemplo 1: adiciona erro personalizado ao nível do gateway de aplicativo
```powershell
...
Este comando adiciona um erro personalizado do código de status http 502 ao gateway de aplicativo $appgw e retorna o gateway atualizado.

### Exemplo 2: adiciona erro personalizado ao nível de ouvinte do gateway de aplicativo
```powershell
...
Este comando adiciona um erro personalizado do código de status http 502 ao gateway de aplicativo $appgw no nível do ouvinte e retorna o gateway atualizado.
