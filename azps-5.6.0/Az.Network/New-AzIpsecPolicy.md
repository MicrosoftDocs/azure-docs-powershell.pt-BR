...
### -IkeEncryption
O algoritmo de criptografia IKE (Fase 1 do IKE)
...
### -IkeIntegrity
O algoritmo de integridade IKE (Fase 1 do IKE)
...
### -IpsecEncryption
O algoritmo de criptografia IPSec (Fase 2 do IKE)
...
### -IpsecIntegrity
O algoritmo de integridade IPSec (Fase 2 do IKE)
...
### -PfsGroup
Os Grupos de DH usados na Fase 2 do IKE para o NOVO SA filho
...
### -SADataSizeKilobytes
O tamanho da carga da Associação de Segurança IPSec (também chamada de Modo Rápido ou Fase 2 SA) no KB
...
### -SALifeTimeSeconds
A vida útil da Associação de Segurança IPSec (também chamada de Modo Rápido ou Fase 2 SA) em segundos
