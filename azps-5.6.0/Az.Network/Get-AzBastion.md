...
## SYNOPSIS
Obtém um recurso Bastion ou recursos de Bastion.
...
## DESCRIPTION
O cmdlet **Get-Bastion** obtém um ou mais bastions em um grupo de recursos ou subscritption.
...
### -ResourceId
A ID de recurso do Azure bastion
