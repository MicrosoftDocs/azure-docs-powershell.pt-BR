...
## DESCRIPTION
O cmdlet **Get-AzVirtualWanVpnServerConfiguration** retornará a lista de todos os VpnServerConfigurations associados a este VirtualWan. ou seja, todas as VpnServerConfigurations que estão anexadas a qualquer P2SVpnGateways em VirutalHubs deste VirtualWan.
