...
## SYNOPSIS
Remove um recurso do Azure VirtualHub.
...
Em seguida, exclui o hub virtual usando resourceGroupName e ResourceName.
...
Em seguida, exclui o hub virtual usando um objeto de entrada. O objeto de entrada é do tipo PSVirtualHub.
...
Em seguida, exclui o hub virtual usando a canalização do powershell usando a saída de Get-AzVirtualHub.
