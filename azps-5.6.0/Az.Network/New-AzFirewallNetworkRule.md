...
Este exemplo cria uma regra para todo o tráfego TCP. O usuário impõe se o tráfego será permitido ou negado para uma regra com base na coleção de regras à que ele está associado.
...
Este exemplo cria uma regra para todo o tráfego TCP de 10.0.0.0 a 60.1.5.0:4040. O usuário impõe se o tráfego será permitido ou negado para uma regra com base na coleção de regras à que ele está associado.
...
Este exemplo cria uma regra para todo o tráfego TCP de qualquer fonte para 10.0.0.0/16. O usuário impõe se o tráfego será permitido ou negado para uma regra com base na coleção de regras à que ele está associado.
...
### -Name
Especifica o nome dessa regra de rede. O nome deve ser exclusivo dentro de uma coleção de regras.
