...
## SYNOPSIS
O Remove-AzVpnGateway cmdlet remove um gateway VPN do Azure. Esse é um gateway específico para a conectividade definida do software wan virtual do Azure.
...
Este exemplo cria um grupo de Recursos, WAN Virtual, Hub Virtual, gateway VPN escalonável na Central dos EUA e o exclui imediatamente. Para suprimir o prompt ao excluir o Gateway Virtual, use o sinalizador -Force.
...
Este exemplo cria um grupo de Recursos, WAN Virtual, Hub Virtual, gateway VPN escalonável na Central dos EUA e o exclui imediatamente. Essa exclusão acontece usando a canalização do powershell, que usa o objeto VpnGateway retornado pelo comando Get-AzVpnGateway.
