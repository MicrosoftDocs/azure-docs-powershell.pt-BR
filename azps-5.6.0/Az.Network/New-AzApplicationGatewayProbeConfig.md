...
## DESCRIPTION
O New-AzApplicationGatewayProbeConfig cmdlet cria uma sonda de saúde.

## EXEMPLOS

### Exemplo 1: Exemplo1: Criar uma sonda de saúde
```powershell
PS C:\>New-AzApplicationGatewayProbeConfig -Name "Probe03" -Protocol Http -HostName "contoso.com" -Path "/path/custompath.htm" -Interval 30 -Timeout 120 -UnhealthyThreshold 8
```

Este comando cria uma sonda de saúde chamada Probe03, com protocolo HTTP, um intervalo de 30 segundos, tempo limite de 120 segundos e um limite não alal de 8 novas.

### Exemplo 2

Cria uma sonda de saúde. (gerado automaticamente)
...
### -HostName
Especifica o nome do host que este cmdlet envia a sonda.
