...
## DESCRIPTION
O cmdlet **Get-AzFirewallPolicyRuleCollectionGroup** obtém o RuleCollectionGroup mencionado em uma Política de Firewall
...
Este exemplo obter o conjunto de regrasGroup na política de firewall $fp
