...
O comando acima criará um objeto RoutingConfiguration que pode ser adicionado a um recurso de conexão. Rotas estáticas só são permitidas com um objeto HubVirtualNetworkConnection. 
...
### -Id
A lista de IDs de recursos de todas as tabelas de rota de hub para anunciar as rotas para a propriedade PropagatedRouteTables.
