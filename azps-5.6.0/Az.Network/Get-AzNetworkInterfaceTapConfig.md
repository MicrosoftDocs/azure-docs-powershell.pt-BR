...
## SYNOPSIS
Obtém um recurso de configuração tocar.
...
## DESCRIPTION
O cmdlet **Get-AzNetworkInterfaceTapConfig** obtém uma Configuração de Toque do Azure para um determinado grupo de recursos, interface de rede e nome de configuração de toque ou lista de configurações de toque em um grupo de recursos e interface de rede.
...
Esse comando obtém configurações de toque adicionadas para a interface de rede determinada.

### Exemplo 2: Obter uma configuração de toque determinada
```
PS C:\> Get-AzNetworkInterface -ResourceGroupName "ResourceGroup1" -NetworkInterface "sourceNicName" -Name "tapconfigName"
```

Este comando obtém configuração de toque específica adicionada para a interface de rede determinada.

### Exemplo 3: Obter uma configuração de toque determinada
```
PS C:\> Get-AzNetworkInterface -ResourceGroupName "ResourceGroup1" -NetworkInterface "sourceNicName" -Name "tapconfig*"
```

Este comando obtém configurações de toque adicionadas para a interface de rede determinada com o nome começando com "tapconfig".
