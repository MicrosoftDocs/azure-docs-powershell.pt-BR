...
Este comando cria um ouvinte HTTP que usa a carga SSL e fornece o certificado SSL na variável $SSLCert 01.
...
Este comando cria um ouvinte HTTP que usa a carga SSL e fornece o certificado SSL na variável $SSLCert 01 juntamente com dois HostNames.
O comando armazena o resultado na variável chamada $Listener.
...
Especifica a ID da configuração de IP front-end para o ouvinte HTTP.
...
### -FrontendPort
Especifica a porta front-end do ouvinte HTTP.
