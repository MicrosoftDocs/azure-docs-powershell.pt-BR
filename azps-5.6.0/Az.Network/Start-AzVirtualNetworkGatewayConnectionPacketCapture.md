...
## SYNOPSIS
Inicia a operação de captura de pacotes em uma conexão de gateway de rede virtual.
...
### -FilterData
Opções de filtro para iniciar a captura de pacotes na conexão de gateway de rede virtual.
...
### -Name
O nome da conexão do gateway de rede virtual no qual a captura de pacotes deve ser iniciada.
