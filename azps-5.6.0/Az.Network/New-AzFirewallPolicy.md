...
Este exemplo cria uma política de firewall do azure com um modo intel de ameaça

### Exemplo 3: 3. Criar uma política vazia com ThreatIntel Whitelist
```powershell
...
Este exemplo cria uma política de firewall do azure com uma lista de ameaças intel

### Exemplo 4: 4. Criar política com detecção de intrusão, identidade e segurança de transporte
```powershell
...
Este exemplo cria uma política de firewall do azure com uma detecção de intrusão em alerta de modo, identidade atribuída pelo usuário e segurança de transporte
...
### -Identity
Identidade da Política de Firewall a ser atribuída à Política de Firewall.
...
### -IntrusionDetection
A configuração de detecção de intrusão
...
### -SkuTier
Camada sku da política de firewall
...
ID secreta do objeto 'Secret' ou 'Certificate' (pfx codificado na base 64) armazenado em KeyVault
...
Nome da segurança de transporte
