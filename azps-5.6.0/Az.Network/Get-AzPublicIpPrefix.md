...
Este comando obtém um recurso de prefixo IP público com myPublicIpPrefix1 no grupo de recursos myRg
...
Este comando obtém todos os recursos de prefixo IP públicos que começam com myPublicIpPrefix.
