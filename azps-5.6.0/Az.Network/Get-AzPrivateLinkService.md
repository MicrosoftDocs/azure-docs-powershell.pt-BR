...
## DESCRIPTION
O cmdlet **Get-AzPrivateLinkService** obtém um ou mais serviços de link privado.
...
Esse commandlet obtém um serviço de link privado no grupo de recursos.
