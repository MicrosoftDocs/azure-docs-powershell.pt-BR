...
Este comando exclui um balanceador de carga chamado MyLoadBalancer no grupo de recursos chamado MyResourceGroup.
...
### -Force
Indica que esse cmdlet remove o balanceador de carga, independentemente de os recursos a ele atribuídos.
