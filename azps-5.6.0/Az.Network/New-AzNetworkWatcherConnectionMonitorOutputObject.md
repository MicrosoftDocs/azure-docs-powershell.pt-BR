...
Tipo : "workspace" WorkspaceSettings : { "WorkspaceResourceId": "MyWSResourceId" }
...
### -OutputType
Tipo de destino de saída do monitor de conexão. Atualmente, apenas \" o Workspace \" é suportado.
...
### -WorkspaceResourceId
ID do recurso do espaço de trabalho de análise de log.
