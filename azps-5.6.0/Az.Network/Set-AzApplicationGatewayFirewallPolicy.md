...
## SYNOPSIS
Atualiza uma política de firewall de gateway de aplicativo.
...
## DESCRIPTION
O cmdlet **Set-AzApplicationGatewayFirewallPolicy** atualiza uma política de firewall de gateway de aplicativo do Azure.
...
Esse comando atualiza a política de firewall do gateway de aplicativo com configurações na variável $AppGwFirewallPolicy e armazena o gateway atualizado na variável $UpdatedAppGwFirewallPolicy de aplicativos.
