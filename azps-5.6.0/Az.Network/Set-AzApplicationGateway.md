...
## DESCRIPTION
O cmdlet **Set-AzApplicationGateway** atualiza um gateway de aplicativo do Azure.
...
Esses comandos atualizam o gateway de aplicativo com configurações na variável $AppGw e armazenam o gateway atualizado na variável $UpdatedAppGw.

## PARÂMETROS

### -ApplicationGateway
Especifica um objeto gateway de aplicativo que representa o estado para o qual o gateway de aplicativo deve ser definido.
