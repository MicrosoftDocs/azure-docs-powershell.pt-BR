...
O primeiro cmdlet cria uma delegação que pode ser adicionada a uma sub-rede e a armazena na $delegation variável. O segundo e o terceiro cmdlets recuperam a sub-rede a ser delegada. O quarto cmdlet adiciona a delegação criada à sub-rede de interesse, e o cmdlet final envia a configuração atualizada para o servidor.
