...
O cmdlet **Get-AzLocalNetworkGateway** retorna o objeto que representa seu gateway local com base em Nome e Nome do Grupo de Recursos.
...
Retorna o objeto do Gateway de Rede Local com o nome "myLocalGW1" dentro do grupo de recursos "myRG"

### Exemplo 2: Obter gateways de rede locais usando filtragem
```powershell
...
Retorna o objeto do Gateway de Rede Local com nome começando com "myLocalGW" dentro do grupo de recursos "myRG"
