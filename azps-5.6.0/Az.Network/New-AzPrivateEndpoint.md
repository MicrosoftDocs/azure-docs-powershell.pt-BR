...
## SYNOPSIS
Cria um ponto de extremidade privado.
...
O cmdlet **New-AzPrivateEndpoint** cria um ponto de extremidade privado.

## EXEMPLOS

### Exemplo 1: Criar um ponto de extremidade privado

O exemplo a seguir cria um ponto de extremidade privado com uma ID de serviço de link particular específica na sub-rede especificada em uma rede virtual.
...
Especifica um local para o ponto de extremidade privado. Use [Get-AzLocation](/powershell/module/az.resources/get-azlocation) para determinar valores válidos para este parâmetro.
