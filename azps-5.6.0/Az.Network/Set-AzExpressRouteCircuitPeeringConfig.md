...
## SYNOPSIS
Salva uma configuração de paração ExpressRoute modificada.
...
## DESCRIPTION
Os cmdlets **Set-AzExpressRouteCircuitPeeringConfig** salvam uma configuração de paração ExpressRoute modificada de volta para o Azure.

## EXEMPLOS

### Exemplo 1: Alterar uma configuração de peering existente
```powershell
...
Salva uma configuração de paração ExpressRoute modificada. (gerado automaticamente)
...
### -ExpressRouteCircuit
O objeto de circuito ExpressRoute que contém a configuração de paração a ser modificada.
...
### -Name
O nome da configuração de paração a ser modificada.
