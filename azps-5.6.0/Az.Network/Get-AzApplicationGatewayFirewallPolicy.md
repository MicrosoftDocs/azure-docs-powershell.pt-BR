...
## SYNOPSIS
Obtém uma política de firewall de gateway de aplicativo.
...
## DESCRIPTION
O cmdlet **Get-AzApplicationGatewayFirewallPolicy** obtém uma política de firewall de gateway de aplicativo..
