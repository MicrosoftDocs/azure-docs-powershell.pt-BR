...
## SYNOPSIS
Cria uma conexão ExpressRoute que conecta um gateway ExpressRoute a um circuito expressRoute local
...
## DESCRIPTION
Cria uma conexão ExpressRoute entre um BGP do circuito ExpressRoute local e o gateway ExpressRoute dentro de um hub virtual.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual, gateway de Rota Expressa e um circuito ExpressRoute com peering privado no grupo de recursos "testRG" do West Central US no Azure. Depois que o gateway for criado, ele será conectado ao Peering de Circuitos ExpressRoute usando o comando New-AzExpressRouteConnection.
...
### -AuthorizationKey
Uma chave obtida do proprietário do circuito ExpressRoute para poder criar uma conexão com um gateway em uma assinatura diferente.
...
Habilitar a segurança da Internet para essa conexão do Gateway ExpressRoute
...
A id de recurso do Peering do Circuito de Rota Expressa ao qual essa conexão de gateway de Rota Expressa deve ser criada.
