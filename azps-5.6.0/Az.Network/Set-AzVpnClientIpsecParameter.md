...
## SYNOPSIS
Define os parâmetros ipsec vpn para gateway de rede virtual existente.
...
## DESCRIPTION
O cmdlet **Set-AzVpnClientIpsecParameter** define os parâmetros ipsec vpn para gateway de rede virtual existente.
Quando o gateway de rede virtual é criado, ele define o conjunto de políticas ipsec de vpn padrão no Gateway. Caso o usuário aponte para o site queira usar determinada política ipsec personalizada para se conectar ao Gateway VPN, o usuário precisa definir essa política ipsec primeiro no VPN Gateway. **Set-AzVpnClientIpsecParameter** fornece uma maneira de fazer isso.

## EXEMPLOS

### Exemplo 1: define uma política ipsec de vpn personalizada como gateway de rede virtual existente.
```powershell
PS C:\>$vpnclientipsecparams = New-AzVpnClientIpsecParameter -IpsecEncryption AES256 -IpsecIntegrity SHA256 -SALifeTime 86473 -SADataSize 429498 -IkeEncryption AES256 -IkeIntegrity SHA384 -DhGroup DHGroup2 -PfsGroup PFS2
PS C:\> $setvpnIpsecParams = Set-AzVpnClientIpsecParameter -VirtualNetworkGatewayName "ContosoLocalGateway" -ResourceGroupName "ContosoResourceGroup" -VpnClientIPsecParameter $vpnclientipsecparams
```

Este exemplo define a política de ipsec vpn personalizada como gateway de rede virtual existente chamado ContosoVirtualGateway do grupo resource chamado ContosoResourceGroup.
...
### -InputObject
O objeto gateway de rede virtual
...
Parâmetros ipsec de cliente vpn. Esse valor de parâmetro pode ser construído usando o comando PS let:New-AzVpnClientIpsecParameter
