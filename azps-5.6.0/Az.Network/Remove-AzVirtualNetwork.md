...
Este exemplo cria uma rede virtual em um grupo de recursos e a exclui imediatamente. Para suprimir o prompt ao excluir a rede virtual, use o sinalizador -Force.
...
### -Name
Especifica o nome da rede virtual que esse cmdlet remove.
