...
## DESCRIPTION
O cmdlet **Remove-AzP2sVpnGateway** permite remover um P2SVpnGateway existente em VirtualHub. Toda a conectividade de clientes de site falhará após a remoção do P2SVpnGateway.
