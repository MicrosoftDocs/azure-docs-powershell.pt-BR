...
>[!NOTE]
>Se você criar uma referência à captura de pacote diretamente New-AzNetworkWatcherPacketCapture comando New-AzNetworkWatcherPacketCapture, ela não terá todas as propriedades. Você pode obter todas as propriedades da captura do pacote fazendo uma chamada para o comando Get-AzNetworkWatcherPacketCapture.
...
Este cmdlet retorna todos os PacketCaptures que começam com "PacketCapture" no nw1 Network Watcher.
