...
## SYNOPSIS
Cria um objeto Tabela de Rota de Hub Virtual do Azure.
...
O acima criará uma tabela de rota composta por várias rotas e anexada a um novo hub virtual.

Este é um objeto na memória que pode ser usado para adicionar uma tabela Route a um novo ou um VirtualHub existente.
