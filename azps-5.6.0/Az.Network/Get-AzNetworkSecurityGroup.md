...
### Exemplo 1: Recuperar um grupo de segurança de rede existente
```powershell
...
Este comando retorna o conteúdo do grupo de segurança de rede do Azure "nsg1" no grupo de recursos "rg1"

### Exemplo 2: Listar grupos de segurança de rede existentes usando filtragem
```powershell
...
Este comando retorna o conteúdo dos grupos de segurança de rede do Azure que começam com "nsg"
...
### -ResourceGroupName
Especifica o nome do grupo de recursos ao que o grupo de segurança de rede pertence.
