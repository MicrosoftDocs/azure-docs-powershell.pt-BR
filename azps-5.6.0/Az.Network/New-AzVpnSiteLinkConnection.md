...
## SYNOPSIS
Cria um objeto Azure VpnSiteLinkConnection.
...
### -EgressNatRule
A lista de regras NAT de saída associadas a este link Connection.
...
### -EnableBgp
Habilitar BGP para essa conexão de link
...
### -IngressNatRule
A lista de regras NAT de entrada associadas a este link Connection.
...
### -IpSecPolicy
Política IpSec a ser considerada para essa conexão de link.
...
### -SharedKey
A chave compartilhada necessária para configurar essa conexão de link.
...
Use o endereço ip local do azure como IP de origem para esta conexão de link.
...
Use seletores de tráfego baseados em política para essa conexão de link.
...
### -VpnSiteLink
O objeto de link de site vpn ao que se conectar.
