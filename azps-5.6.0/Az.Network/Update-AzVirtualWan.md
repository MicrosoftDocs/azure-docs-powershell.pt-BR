...
O acima criará um grupo de recursos "testRG" na região "Oeste dos EUA" e uma WAN Virtual do Azure nesse grupo de recursos no Azure. VirtualWan é atualizado com novas propriedades.

## PARÂMETROS

### -AllowBranchToBranchTraffic
Permitir ramificação para o tráfego de filial para VirtualWan.
...
Permitir vnet para tráfego de vnet para VirtualWan.
...
### -InputObject
O objeto wan virtual a ser modificado
