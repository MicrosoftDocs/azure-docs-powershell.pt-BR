...
## DESCRIPTION
O **New-AzApplicationGatewayFirewallPolicyManagedRuleSet** cria uma regra gerenciada para uma política de firewall.
...
### -RuleGroupOverride
Substituições de grupo de regras.
...
### -RuleSetType
Especificar RuleSetType em um managedRuleSet
...
### -RuleSetVersion
Especificar RuleSetVersion em um managedRuleSet
