...
O cmdlet **Get-AzVirtualNetworkGateway** retorna o objeto do gateway no Azure com base em Nome e Nome do Grupo de Recursos.
...
Exclui o objeto do Gateway de Rede Virtual com o nome "myGateway" dentro do grupo de recursos "myRG" Observação: primeiro, exclua todas as conexões com o Gateway de Rede Virtual usando o cmdlet **Remove-AzVirtualNetworkGatewayConnection.**
...
### -Name
Especifica o nome do gateway de rede virtual que esse cmdlet remove.
