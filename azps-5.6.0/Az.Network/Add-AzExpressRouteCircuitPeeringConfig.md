...
## SYNOPSIS
Adiciona uma configuração de peering a um circuito ExpressRoute.
...
## DESCRIPTION
O cmdlet **Add-AzExpressRouteCircuitPeeringConfig** adiciona uma configuração de peering a um circuito ExpressRoute. Os circuitos ExpressRoute conectam sua rede local à nuvem da Microsoft usando um provedor de conectividade em vez da Internet pública. Observe que, após executar **Add-AzExpressRouteCircuitPeeringConfig,** você deve chamar o cmdlet Set-AzExpressRouteCircuit para ativar a configuração.

## EXEMPLOS

### Exemplo 1: Adicionar um par a um circuito ExpressRoute existente
```
