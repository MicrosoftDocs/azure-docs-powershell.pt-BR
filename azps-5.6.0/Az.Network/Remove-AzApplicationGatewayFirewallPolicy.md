...
## SYNOPSIS
Remove uma política de firewall de gateway de aplicativo.
...
## DESCRIPTION
O cmdlet **Remove-AzApplicationGatewayFirewallPolicy** remove uma política de firewall de gateway de aplicativo.
...
Este comando remove a política de firewall do gateway de aplicativo chamada ApplicationGatewayFirewallPolicy01 no grupo de recursos chamado ResourceGroup01.
