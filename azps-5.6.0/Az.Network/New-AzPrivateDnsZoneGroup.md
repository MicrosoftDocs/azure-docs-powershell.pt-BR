...
## SYNOPSIS
Cria um grupo de zonas DNS privada no ponto de extremidade privado especificado.
...
## DESCRIPTION
O cmdlet **New-AzPrivateDnsZoneGroup** permite que você crie um novo grupo de zonas DNS privada.
...
Depois que o ponto de extremidade privado é criado, o exemplo acima cria um `test-pr-endpoint` grupo de zonas DNS sob esse ponto de extremidade privado.
...
Uma coleção de configurações de zona dns privadas do grupo de zonas dns privadas.
