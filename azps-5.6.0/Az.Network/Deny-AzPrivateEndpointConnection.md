...
## SYNOPSIS
nega uma conexão de ponto de extremidade privada.
...
## DESCRIPTION
O cmdlet **Deny-AzPrivateEndpointConnection** nega uma conexão de ponto de extremidade privada.
...
Este exemplo nega uma conexão de ponto de extremidade privada.
