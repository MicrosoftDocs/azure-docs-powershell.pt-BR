...
Este comando cria um novo recurso de prefixo IP público. 
...
Este comando cria um novo recurso de prefixo IP público global. 
...
### -CustomIpPrefix
O CustomIpPrefix ao que este PublicIpPrefix será associado
...
### -Sku
O nome Sku de prefixo IP público.
...
### -Tier
A camada Sku de Prefixo IP público.
