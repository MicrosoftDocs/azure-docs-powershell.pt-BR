...
Se houver configurações de toque fazendo referência a ela, todo o tráfego de origem não será espelhado para a nova atualização pós-atualização de configuração ip de destino.
