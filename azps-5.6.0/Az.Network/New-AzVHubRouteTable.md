...
## DESCRIPTION
Cria a tabela de rota especificada associada ao hub virtual especificado com as rotas fornecidas e os rótulos.
...
Este comando cria uma tabela de rota de hub do hub virtual.
...
### -ParentObject
O objeto hub virtual pai desse recurso.
...
### -ParentResourceId
A id de recurso do recurso de hub virtual.
...
### -Route
A lista de rotas para esta tabela de rota.
