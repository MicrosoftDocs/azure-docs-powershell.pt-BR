...
## DESCRIPTION
O cmdlet **Get-AzVirtualNetworkUsageList** obtém o uso por sub-rede da rede virtual especificada.
...
Obtém por sub-rede valores atuais de uso para a rede virtual mais testada.
