...
## SYNOPSIS
Cria um conjunto de ações de regra de regra de reescrita para um gateway de aplicativo.
...
## DESCRIPTION
O cmdlet **New-AzApplicationGatewayRewriteRuleActionSet** cria um conjunto de ações de regra de regra de reescrita para um gateway de aplicativo do Azure.
...
Este comando cria um conjunto de ações de regra de regra de reescrita e armazena o resultado na variável chamada $action.
...
Lista de configurações de header de solicitação
...
Lista de configurações de header de resposta
