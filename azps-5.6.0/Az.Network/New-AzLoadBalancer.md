...
O nono e último comando obtém o novo balanceador de carga para garantir que ele foi criado com êxito.
Observe que este exemplo mostra apenas como criar um balanceador de carga. Você também deve configurá-lo usando o cmdlet Add-AzNetworkInterfaceIpConfig para atribuir os NICs a máquinas virtuais diferentes.
...
O sétimo e último comando obtém o novo balanceador de carga para garantir que ele foi criado com êxito.
Observe que este exemplo mostra apenas como criar um balanceador de carga global. Você também deve configurá-lo usando o cmdlet New-AzLoadBalancerBackendAddressConfig para atribuir ids ipconfig de frontend de balanceador de carga regionais ao seu pool de endereços back-end
...
### -BackendAddressPool
Especifica um pool de endereços back-end a ser associado a um balanceador de carga.
...
### -InboundNatRule
Especifica uma lista de regras nat (conversão de endereço de rede de entrada) para associar a um balanceador de carga.
...
### -LoadBalancingRule
Especifica uma lista de regras de balanceamento de carga a ser associada a um balanceador de carga.
...
### -Probe
Especifica uma lista de sondas a ser associada a um balanceador de carga.
