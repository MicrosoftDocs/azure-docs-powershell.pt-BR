...
O primeiro comando obtém um filtro de rota chamado routefilter01 usando o cmdlet Get-AzRouteFilter de rota.
...
### -Name
Especifica um nome da regra de filtro de rota a ser adicionar ao filtro de rota.
