...
## SYNOPSIS
Obtém a tabela ARP de um circuito ExpressRoute.
...
## DESCRIPTION
O cmdlet **Get-AzExpressRouteCircuitARPTable** recupera a tabela ARP de ambas as interfaces de um circuito ExpressRoute. A tabela ARP fornece um mapeamento do endereço IPv4 para endereço MAC para um ponto específico. Você pode usar a tabela ARP para validar a configuração e a conectividade da camada 2.
