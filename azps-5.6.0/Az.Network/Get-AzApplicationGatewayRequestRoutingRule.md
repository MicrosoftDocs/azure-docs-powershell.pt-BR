...
O segundo comando obtém a regra de roteamento de solicitação chamada Rule01 do Gateway de Aplicativo armazenado na variável denominada $AppGW.
...
O primeiro comando obtém o Gateway de Aplicativo chamado ApplicationGateway01 e armazena o resultado na variável chamada $AppGW.
O segundo comando obtém uma lista de regras de roteamento de solicitação do Gateway de Aplicativo armazenado na variável chamada $AppGW.

## PARÂMETROS

### -ApplicationGateway
Especifica o objeto gateway de aplicativo que contém a regra de roteamento de solicitação.
