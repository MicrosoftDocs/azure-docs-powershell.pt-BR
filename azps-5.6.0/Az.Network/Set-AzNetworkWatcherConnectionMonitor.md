...
## SYNOPSIS
Atualiza o recurso de monitoramento de conexão.
...
## DESCRIPTION
O cmdlet Set-AzNetworkWatcherConnectionMonitor atualiza o recurso de monitor de conexão.

## EXEMPLOS

### Exemplo 1: atualizar um monitor de conexão
```
...
Neste exemplo, atualizamos o monitor de conexão existente alterando destinationAddress e adicionando marcas.
...
### -ConfigureOnly
Configure o monitor de conexão, mas não o inicie
...
### -DestinationAddress
Endereço do destino do monitor de conexão (IP ou nome de domínio).
...
### -DestinationPort
A porta de destino usada pelo monitor de conexão.
...
A ID do recurso usado como destino pelo monitor de conexão.
...
Intervalo de monitoramento em segundos. O valor padrão é 60 segundos.
...
### -Observação
Observações associadas ao monitor de conexão.
...
### -Output
Descreve destinos de saída do monitor de conexão.
...
### -ResourceId
ID do recurso ConnectionMonitor.
...
### -SourcePort
A porta de origem usada pelo monitor de conexão.
...
### -SourceResourceId
A ID do recurso usado como a origem pelo monitor de conexão.
