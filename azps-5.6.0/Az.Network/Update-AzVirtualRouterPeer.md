...
## SYNOPSIS
Atualizar um Par em um Azure VirtualRouter
...
## DESCRIPTION
O cmdlet **Update-AzVirtualRouterPeer** atualiza um Par virtualRouter para um Azure VirtualRouter
...
### -PeerName
O nome do roteador virtual Peer.
...
### -VirtualRouterName
O roteador virtual onde o par existe.
