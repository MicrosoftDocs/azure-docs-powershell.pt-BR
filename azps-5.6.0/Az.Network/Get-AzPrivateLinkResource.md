...
## DESCRIPTION
O cmdlet **Get-AzPrivateLinkResource** recupera todos os recursos de link pertence a PrivateLinkResource.
...
Este exemplo lista todos os recursos de link privado nbelong to sql server named mySql.
...
A ID do gerenciador de recursos do Azure do recurso de link privado.
