...
## SYNOPSIS
Obtém o conjunto de regras de regra de um gateway de aplicativo.
...
### Exemplo 1 : Obter um conjunto de regras de regra de regra de reescrita específico
```
...
O segundo comando obtém o conjunto de regras de regra de reescrita denominado RuleSet01 do Gateway de Aplicativo armazenado na variável denominada $AppGW.
