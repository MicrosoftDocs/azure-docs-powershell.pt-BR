...
## DESCRIPTION
O cmdlet **Get-AzP2sVpnGateway** permite que você receba um P2SVpnGateway existente em VirtualHub.
...
O cmdlet **Get-AzP2sVpnGateway** permite que você receba um P2SVpnGateway existente em VirtualHub usado para conectividade ponto a site.
