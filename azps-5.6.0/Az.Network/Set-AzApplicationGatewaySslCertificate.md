...
### Exemplo 2: atualizar um certificado SSL existente usando KeyVault Secret (secretId sem versão) no Gateway de Aplicativos
```
...
Obter o segredo e atualizar um Certificado SSL existente usando `Set-AzApplicationGatewaySslCertificate` .

### Exemplo 3: atualizar um certificado SSL existente usando KeyVault Secret no Application Gateway
```
PS C:\> $secret = Get-AzKeyVaultSecret -VaultName "keyvault01" -Name "sslCert01"
