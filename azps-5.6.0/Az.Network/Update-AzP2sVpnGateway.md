...
## SYNOPSIS
Atualize um P2SVpnGateway existente em VirtualHub para apontar para a conectividade do site.

## SINTAXE

### ByP2SVpnGatewayNameNoVpnServerConfigurationUpdate (Padrão)
```
...
## DESCRIPTION
O cmdlet **Update-AzP2sVpnGateway** permite que você atualize um P2SVpnGateway existente em VirtualHub com o novo VpnClientAddressPool ou o novo VpnServerConfiguration ou a alteração de VpnGatewayScaleUnit.
...
O cmdlet **Update-AzP2sVpnGateway** permite que você atualize um P2SVpnGateway existente em VirtualHub com o novo VpnClientAddressPool. Quando o cliente Point to site se conecta a esse P2SVpnGateway, um dos endereços ip dessa VpnClientAddressPool é alocado a esse cliente.

### Exemplo 2

Atualize um P2SVpnGateway existente em VirtualHub para apontar para a conectividade do site. (gerado automaticamente)
...
### -CustomDnsServer
A lista de Servidores Dns Personalizados.
...
Habilitar o sinalizador de segurança da Internet para essas conexões P2SVpnGateway
...
Desabilitar o sinalizador de segurança da Internet para essas conexões P2SVpnGateway
...
### -RoutingConfiguration
Configuração de roteamento para essa conexão
...
### -VpnClientAddressPool
AddressPool P2S VpnClient para este P2SVpnGateway P2SConnectionConfiguration.
...
### -VpnGatewayScaleUnit
A unidade de escala para este P2SVpnGateway.
...
O VpnServerConfiguration a ser anexado a este P2SVpnGateway.
...
A id do objeto de configuração do servidor Vpn ao que o P2SVpnGateway será anexado.
