...
## SYNOPSIS
Crie um novo VpnServerConfiguration para a conectividade ponto a site.
...
## DESCRIPTION
O cmdlet **New-AzVpnServerConfiguration** permite que você crie um novo VpnServerConfiguration com vpnProtocols diferentes, VpnAuthenticationTypes, IpsecPolicies e definir parâmetros relacionados ao tipo de autenticação vpn selecionado de acordo com o requisito do cliente para conectividade ponto a site.
...
Crie um novo VpnServerConfiguration para a conectividade ponto a site. (gerado automaticamente)
...
### -AadAudience
Audiência do AAD para autenticação AAD P2S.
...
### -AadIssuer
Emissor AAD para autenticação AAD P2S.
...
### -AadTenant
Locatário AAD para autenticação AAD P2S.
...
Uma lista de caminhos dos arquivos RadiusClientRootCertificate
...
### -RadiusServerList
Servidores de vários raios externos P2S.
...
Uma lista de VpnClientCertificates a serem revogados caminhos dos arquivos
...
Uma lista de VpnClientRootCertificates a serem adicionados caminhos dos arquivos
