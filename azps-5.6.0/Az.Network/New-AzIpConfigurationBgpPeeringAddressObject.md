...
```
## DESCRIPTION
O **Objeto New-AzIpConfigurationBgpPeeringAddressObject** cria um objeto IpConfigurationBgpPeeringAddressObject que representa a propriedade BgpPeeringAddresses no gateway de rede virtual bgpsettings.
...
### -CustomAddress
O gateway de rede virtual CustomAddress List para BgpPeeringAddresses.
