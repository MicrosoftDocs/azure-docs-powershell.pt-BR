...
## SYNOPSIS
Invocar sessão de diagnóstico de configuração de rede para perfis de rede especificados no recurso de destino.
...
## DESCRIPTION
O Invoke-AzNetworkWatcherNetworkConfigurationDiagnostic cmdlet invoca a sessão de diagnóstico de configuração de rede para perfis de rede especificados no recurso de destino.
