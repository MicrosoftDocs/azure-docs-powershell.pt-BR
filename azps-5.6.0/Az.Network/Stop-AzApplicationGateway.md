...
### Exemplo 1: Parar um gateway de aplicativo
```
PS C:\>Stop-AzApplicationGateway -ApplicationGateway $AppGw
```

Esse comando interrompe o gateway de aplicativo armazenado na variável $AppGw de aplicativo.

## PARÂMETROS

### -ApplicationGateway
Especifica o gateway de aplicativo que esse cmdlet interrompe.
