...
## SYNOPSIS
Modifica um circuito ExpressRoute.
...
## DESCRIPTION
O cmdlet **Set-AzExpressRouteCircuit** salva o circuito ExpressRoute modificado no Azure.

## EXEMPLOS

### Exemplo 1: Alterar a ServiceKey de um circuito ExpressRoute
```
...
### -ExpressRouteCircuit
Especifica o **objeto ExpressRouteCircuit** que este cmdlet modifica.
