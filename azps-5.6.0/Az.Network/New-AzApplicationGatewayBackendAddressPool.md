...
Este comando cria um pool de endereços back-end chamado Pool01 usando os FQDNs de servidores back-end e o armazena na variável $Pool back-end.
...
Este comando cria um pool de endereços back-end chamado Pool02 usando os endereços IP de servidores back-end e armazena-o na variável $Pool.
