...
## SYNOPSIS
Cria uma política de firewall de gateway de aplicativo.
...
## DESCRIPTION
O cmdlet **New-AzApplicationGatewayFirewallPolicy** cria uma política de firewall de gateway de aplicativo.
...
Este comando cria uma nova política de firewall de gateway de aplicativo do Azure chamada "wafResource1" no grupo de recursos "rg1" no local "westus" com regras personalizadas definidas na variável $customRule
