...
## DESCRIPTION
O cmdlet **Set-AzApplicationGatewayRequestRoutingRule** modifica uma regra de roteamento de solicitação.

## EXEMPLOS

### Exemplo 1: atualizar uma regra de roteamento de solicitação
```
...
O primeiro comando obtém o gateway de aplicativo chamado ApplicationGateway01 e o armazena na variável $AppGw de aplicativos.
O segundo comando modifica a regra de roteamento de solicitação para o gateway de aplicativo usar configurações HTTP back-end especificadas na variável $Setting, um ouvinte HTTP especificado na variável $Listener e um pool de endereços back-end especificado na variável $Pool.

## PARÂMETROS

### -ApplicationGateway
Especifica o objeto gateway de aplicativo com o qual esse cmdlet associa uma regra de roteamento de solicitação.
...
### -BackendAddressPool
Especifica o pool de endereços back-end do gateway de aplicativo.
...
Especifica a ID do pool de endereços back-end do gateway do aplicativo.
...
### -BackendHttpSettings
Especifica as configurações HTTP de back-end do gateway de aplicativo.
...
Especifica a ID de configurações HTTP back-end do gateway de aplicativo.
...
### -HttpListener
Especifica o ouvinte HTTP do gateway de aplicativo.
...
### -Name
Especifica o nome da regra de roteamento de solicitação que este cmdlet modifica.
