...
## DESCRIPTION
O **Get-AzAutoApprovedPrivateLinkService** obtém uma matriz de id de serviço de link privado que pode ser vinculada a um ponto de extremidade privado com aprovação automática.
