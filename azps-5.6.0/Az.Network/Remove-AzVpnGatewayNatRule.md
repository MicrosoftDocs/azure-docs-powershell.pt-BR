...
## SYNOPSIS
Remove uma regra NAT associada a VpnGateway.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual, VpnGateway e regra NAT associada a essa VpnGateway.
Em seguida, ela remove a regra NAT usando o nome da regra NAT.
...
### -Force
Não peça confirmação se você deseja excluir um recurso
