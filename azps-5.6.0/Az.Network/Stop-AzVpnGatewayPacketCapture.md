...
## SYNOPSIS
Interrompe a operação de captura de pacotes em um Gateway Vpn.
...
## DESCRIPTION
Interrompe a Operação de Captura de Pacotes em um Gateway Vpn e carregará o resultado em determinado SasUrl do contêiner de armazenamento.
...
### -InputObject
O objeto Gateway vpn no qual a captura de pacotes deve ser iniciada.
...
### -Name
O nome do Gateway Vpn no qual a captura de pacote deve ser iniciada.
...
### -SasUrl
Captura de pacote de URL do SAS no Gateway vpn.
