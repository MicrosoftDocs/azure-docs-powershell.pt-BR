...
O segundo comando define o ouvinte HTTP do gateway para usar a configuração front-end armazenada em $FIP 01 com o protocolo HTTP na porta 80.

### Exemplo 2: Adicionar um ouvinte HTTPS com SSL e HostNames
```
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
O segundo comando adiciona o ouvinte, que usa o protocolo HTTPS, com Certificados SSL e HostNames, ao gateway do aplicativo.

## PARÂMETROS

### -ApplicationGateway
Especifica o gateway de aplicativo com o qual esse cmdlet associa o ouvinte HTTP.
...
Especifica o endereço IP front-end do gateway de aplicativo.
...
Especifica a ID do endereço IP front-end do gateway de aplicativo.
...
### -HostName
Especifica o nome do host para o que este cmdlet envia o ouvinte HTTP.
...
Os valores aceitáveis para este parâmetro são: true ou false.
...
### -SslCertificateId
Especifica a ID de certificado SSL do ouvinte HTTP.
