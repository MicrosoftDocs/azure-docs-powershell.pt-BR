...
Este exemplo cria uma regra que permitirá o tráfego para atualizações do Windows para domínio 10.0.0.0/24.
...
### -FqdnTag
Especifica uma lista de marcas FQDN para essa regra. As marcas disponíveis podem ser recuperadas usando o cmdlet [Get-AzFirewallFqdnTag.](./Get-AzFirewallFqdnTag.md)
