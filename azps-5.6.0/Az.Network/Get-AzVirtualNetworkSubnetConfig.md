...
### -Name
Especifica o nome da configuração de sub-rede que este cmdlet obtém.
...
### -VirtualNetwork
Especifica o **objeto VirtualNetwork** que contém a configuração de sub-rede que esse cmdlet obtém.
