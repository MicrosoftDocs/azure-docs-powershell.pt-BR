...
## SYNOPSIS
Cria um novo recurso do Network Watcher.
...
Este exemplo cria um novo Watcher de Rede dentro de um Grupo de Recursos recém-criado. Observe que apenas um Watcher de Rede pode ser criado por região por assinatura.
