...
## SYNOPSIS
Remove uma configuração de peering de conexão cruzada expressRoute.
...
## DESCRIPTION
O cmdlet **Remove-AzExpressRouteCrossConnectionPeering** remove uma configuração de peering de conexão cruzada expressRoute.

## EXEMPLOS

### Exemplo 1: Remover uma configuração de peering de uma conexão cruzada expressRoute
```
...
A conexão cruzada ExpressRoute que contém a configuração de paração a ser removida.
...
### -Name
O nome da configuração de paração a ser removida.
