...
Este exemplo cria um grupo de segurança de aplicativos sem associações. Depois de criada, as configurações IP na interface de rede podem ser incluídas no grupo. As regras de segurança também podem se referir ao grupo como suas fontes ou destinos.
