...
## SYNOPSIS
Aprova uma conexão de ponto de extremidade privada.
...
## DESCRIPTION
O cmdlet **Approve-AzPrivateEndpointConnection** aprova uma conexão de ponto de extremidade privada.
...
Este exemplo aprova uma conexão de ponto de extremidade privada.
