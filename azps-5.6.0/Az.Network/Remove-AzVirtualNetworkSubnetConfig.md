...
Este exemplo cria um grupo de recursos e uma rede virtual com duas sub-redes. Em seguida, ele usa o Remove-AzVirtualNetworkSubnetConfig para remover a sub-rede back-end da representação na memória da rede virtual. Set-AzVirtualNetwork então é chamado para modificar a rede virtual no lado do servidor.
