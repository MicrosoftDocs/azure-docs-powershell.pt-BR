...
### Exemplo 1: atualizar o ASN de um gateway de rede virtual
```
PS C:\>$Gateway = Get-AzVirtualNetworkGateway -ResourceGroupName "ResourceGroup001" -Name "Gateway001"
PS C:\> Set-AzVirtualNetworkGateway -VirtualNetworkGateway $Gateway -Asn 1337
```

O primeiro comando obtém um gateway de rede virtual chamado Gateway01 que pertence ao grupo de recursos ResourceGroup001 e o armazena na variável denominada $Gateway O segundo comando atualiza o gateway de rede virtual armazenado em variável $Gateway.
...
O primeiro comando obtém um gateway de rede virtual chamado Gateway01 que pertence ao grupo de recursos ResourceGroup001 e o armazena para a variável denominada $Gateway O segundo comando cria o objeto de política ipsec vpn de acordo com os parâmetros ipsec especificados.
O terceiro comando atualiza o gateway de rede virtual armazenado em variáveis $Gateway.
...
O primeiro comando obtém um gateway de rede virtual chamado Gateway01 que pertence ao grupo de recursos ResourceGroup001 e o armazena na variável denominada $Gateway O segundo comando atualiza o gateway de rede virtual Gateway01 com as marcas @{ testtagKey="SomeTagKey"; testtagValue="SomeKeyValue" }.
...
O terceiro comando remove a configuração de autenticação AAD do VpnClient do gateway de rede virtual.
...
O primeiro comando obtém um gateway de rede virtual chamado Gateway01 que pertence ao grupo de recursos ResourceGroup001 e o armazena à variável denominada $Gateway O segundo comando atribui o valor do gateway de rede virtual Gateway01 IpConfiguration Id à variável ipconfigurationId1.
...
O quinto comando definiu esse novo PSIpConfigurationBgpPeeringAddress como IpConfigurationBgpPeeringAddresses e atualize o gateway.
...
### -Asn
O ASN do gateway de rede virtual, usado para configurar sessões BGP dentro de tuneis IPsec
...
Sinalizador para desabilitar o recurso Active Active no gateway de rede virtual
...
### -GatewayDefaultSite
O site padrão a ser usado para o tunelamento de força.
...
### -GatewaySku
SKU do gateway de rede virtual
...
Sinalizador para remover a autenticação AAD para cliente P2S do gateway de rede virtual.
...
O objeto gateway de rede virtual para basear modificações.
...
### -VpnClientAddressPool
O espaço de endereço para alocar endereços IP do cliente VPN.
Isso não deve se sobrepor a rede virtual ou intervalos locais.
...
### -VpnClientProtocol
Uma lista de protocolos de túnel de cliente VPN P2S
...
Um cliente VPN que apresenta um certificado que corresponde a um desses será informado a desaparecer.
...
### -VpnClientRootCertificates
Uma lista de certificados raiz do cliente VPN a usar para autenticação de cliente VPN.
