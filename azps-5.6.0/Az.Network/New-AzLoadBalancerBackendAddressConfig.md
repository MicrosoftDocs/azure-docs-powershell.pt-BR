...
### Exemplo 1: Nova configuração de endereço do loadbalancer com referência de rede virtual
```powershell
PS C:\> $virtualNetwork = Get-AzVirtualNetwork -Name $vnetName -ResourceGroupName $resourceGroup
New-AzLoadBalancerBackendAddressConfig -IpAddress "10.0.0.5" -Name "TestVNetRef" -VirtualNetworkId $virtualNetwork.Id
```

### Exemplo 2: Nova configuração de endereço do loadbalancer com referência de configuração ip frontend do loadbalancer
```powershell
...
### -IpAddress
O IPAddress a ser adicionar ao pool de back-end
...
A configuração de ip frontend do balanceador de carga associada à configuração de endereço back-end
...
### -Name
O nome da configuração endereço back-end
...
### -VirtualNetworkId
A rede virtual associada à configuração endereço back-end
