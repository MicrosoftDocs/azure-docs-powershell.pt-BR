...
## DESCRIPTION
O Remove-AzVirtualApplianceSite o comando remove um site de Dispositivo Virtual de um recurso de Dispositivo Virtual de Rede.
...
Exclua um recurso de site do Dispositivo Virtual. 
...
O objeto de site do dispositivo virtual.
