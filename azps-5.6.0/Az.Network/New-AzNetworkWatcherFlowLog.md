...
### -Enabled
Sinalizador para habilitar/desabilitar o log de fluxo.
...
### -EnableRetention
Sinalizador para habilitar/desabilitar a retenção.
...
Sinalizador para habilitar/desabilitar TrafficAnalytics
...
### -FormatType
O tipo de arquivo de log de fluxo.
...
ID de recurso do espaço de trabalho anexado.
