...
## DESCRIPTION
O cmdlet **Set-AzPublicIpPrefix** define as Marcas para um prefixo IP público.
...
O primeiro comando obtém um Prefixo IP público existente, o segundo comando define a Propriedade Tags e o terceiro comando atualiza o objeto existente.
