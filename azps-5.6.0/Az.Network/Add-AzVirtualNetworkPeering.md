...
## SYNOPSIS
Cria um par entre duas redes virtuais.
...
## DESCRIPTION
O cmdlet **Add-AzVirtualNetworkPeering** cria um par entre duas redes virtuais.

## EXEMPLOS

### Exemplo 1: Criar um paring entre duas redes virtuais na mesma região
```
...
Observe que um link de peering deve ser criado do vnet1 para o vnet2 e vice-versa para que o peering funcione.

### Exemplo 2: Criar um par entre duas redes virtuais em regiões diferentes
```
# Variables for common values used throughout the script.
$rgName='myResourceGroup'
...
Aqui 'myVnet1' na Central Ocidental dos EUA é semelhante a 'myVnet2' no Centro do Canadá.
...
### -AllowGatewayTransit
Sinalizador para permitir que gatewayLinks sejam usados no link da rede virtual remota para essa rede virtual
...
### -Name
Especifica o nome do paring de rede virtual.
