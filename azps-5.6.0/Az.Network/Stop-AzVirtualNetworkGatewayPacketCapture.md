...
## SYNOPSIS
Interrompe a operação de captura de pacotes em um Gateway de Rede Virtual.
...
## DESCRIPTION
Interrompe a Operação de Captura de Pacotes em um Gateway de Rede Virtual e carregará o resultado em determinado SasUrl do contêiner de armazenamento.
...
### -InputObject
O objeto gateway de rede virtual no qual a captura de pacote deve ser iniciada.
...
### -Name
O nome do gateway de rede virtual no qual a captura de pacote deve ser iniciada.
...
### -ResourceId
A ID de recurso do Azure do VirtualNetworkGateway onde a captura de pacotes deve ser iniciada.
...
### -SasUrl
Captura de pacote de URL do SAS no gateway de rede virtual.
