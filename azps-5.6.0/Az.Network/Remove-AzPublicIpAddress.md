...
Este comando remove o recurso de endereço IP público chamado $publicIpName no grupo de recursos $rgName.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém o endereço IP público que esse cmdlet remove.
