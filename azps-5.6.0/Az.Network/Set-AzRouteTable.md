...
Este comando obtém a tabela de rota chamada RouteTable01 usando Get-AzRouteTable cmdlet.
O comando passa essa tabela para o cmdlet Add-AzRouteConfig usando o operador de pipeline.
**Add-AzRouteConfig** adiciona a rota chamada Route07 e passa o resultado para o cmdlet atual, que atualiza a tabela para refletir suas alterações.
...
O primeiro comando obtém a tabela de rota chamada rtName e a armazena na variável $rt de rota.
O segundo comando exibe o valor disableBgpRoutePropagation.
...
O sexto comando exibe o valor disableBgpRoutePropagation.
...
### -RouteTable
Especifica um objeto de tabela de rota que representa o estado para o qual a tabela de rota deve ser definida.
