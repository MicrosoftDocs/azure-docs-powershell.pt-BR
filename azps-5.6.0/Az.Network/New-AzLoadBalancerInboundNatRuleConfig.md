...
O terceiro comando cria uma configuração de regra NAT de entrada chamada MyInboundNatRule usando o objeto front-end em $frontend.
O protocolo TCP é especificado e a porta front-end é 3389, o mesmo que a porta back-end nesse caso.
