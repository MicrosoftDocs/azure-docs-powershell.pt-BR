...
### Exemplo 2: crie um certificado SSL usando KeyVault Secret (secretId sem versão) e adicione a um gateway de aplicativo.
```
...
Obter o segredo e criar um Certificado SSL usando `New-AzApplicationGatewaySslCertificate` .
...
### Exemplo 3: Crie um certificado SSL usando Segredo keyVault e adicione a um Gateway de Aplicativo.
```
PS C:\> $secret = Get-AzKeyVaultSecret -VaultName "keyvault01" -Name "sslCert01"
...
### -CertificateFile
Especifica o caminho do arquivo .pfx do certificado SSL que este cmdlet cria.
...
### -Name
Especifica o nome do certificado SSL que este cmdlet cria.
