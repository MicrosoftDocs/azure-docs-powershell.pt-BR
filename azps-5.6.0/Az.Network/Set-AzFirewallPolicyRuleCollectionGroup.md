...
## SYNOPSIS
salva um grupo de conjunto de regras de política de firewall modificado do Azure
...
salva um grupo de conjunto de regras de política de firewall modificado do Azure. (gerado automaticamente)
