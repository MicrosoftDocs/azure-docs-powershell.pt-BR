...
## SYNOPSIS
Cria um objeto identity para um gateway de aplicativo. Isso manterá referência à identidade atribuída pelo usuário.
...
Neste exemplo, criamos uma identidade atribuída ao usuário e a referenciamos no objeto identity usado com o Application Gateway.
