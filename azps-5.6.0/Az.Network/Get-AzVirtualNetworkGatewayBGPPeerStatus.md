...
## DESCRIPTION
Este comando enumera os pares BGP com os que um gateway de rede virtual do Azure está configurado para fazer par. O status de cada par também é dado.
...
Recupera pares BGP para o gateway de rede virtual do Azure chamado gatewayName no resourceGroup do grupo de recursos.
Esta saída de exemplo mostra um par BGP conectado, com um IP de 10.0.0.254.
...
### -Peer
IP do par para recuperar o status
