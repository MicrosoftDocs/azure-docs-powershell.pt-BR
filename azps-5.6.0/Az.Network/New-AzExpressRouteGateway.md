...
## SYNOPSIS
Cria um Gateway ExpressRoute Escalonável.
...
New-AzExpressRouteGateway cria um Gateway ExpressRoute escalonável. Essa é a conectividade definida pelo software para o Azure local dentro do VirtualHub. 

Esse gateway pode ser dimensionado com base na unidade de escala especificada neste ou Set-AzExpressRouteGateway cmdlet. 

Uma conexão é configurada de um circuito ExpressRoute local para o gateway escalonável.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual no Oeste dos EUA no grupo de recursos "testRG" no Azure. Um gateway ExpressRoute será criado posteriormente no Hub Virtual com duas unidades de escala.
...
### -VirtualHub
O VirtualHub ao que o VpnGateway precisa ser associado.
...
### -VirtualHubId
A ID do VirtualHub a que o VpnGateway precisa ser associado.
