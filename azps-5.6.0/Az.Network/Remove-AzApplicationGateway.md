...
Este comando remove o gateway de aplicativo chamado ApplicationGateway01 no grupo de recursos chamado ResourceGroup01.
...
### -Force
Indica que o cmdlet força a exclusão do gateway de aplicativo, independentemente de os recursos a ele ser atribuídos.
