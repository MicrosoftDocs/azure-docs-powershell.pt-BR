...
## SYNOPSIS
Atualiza um estado de conexão de ponto de extremidade privado no serviço de link privado.
...
Este exemplo atualiza um estado de conexão de ponto de extremidade privado para Aprovado.
...
Aprovado ou rejeitado pelo recurso.
