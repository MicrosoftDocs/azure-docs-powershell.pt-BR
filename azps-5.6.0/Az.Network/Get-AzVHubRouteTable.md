...
Este comando obtém a tabela de rota de hub do hub virtual.
...
Este comando lista todas as tabelas de rota de hub no VirtualHub especificado.
...
### -ResourceId
A id de recurso do recurso vhubroutetable para Obter.
