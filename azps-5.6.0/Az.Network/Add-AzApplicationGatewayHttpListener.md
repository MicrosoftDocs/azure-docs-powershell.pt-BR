...
O primeiro comando obtém o gateway do aplicativo e o armazena na variável $AppGw de aplicativos. O segundo comando adiciona o ouvinte HTTP ao gateway do aplicativo.
...
### -ApplicationGateway
Especifica o gateway de aplicativo ao qual este cmdlet adiciona um ouvinte HTTP.
...
Especifica a ID ip front-end do gateway de aplicativo.
...
### -FrontendPort
Especifica o objeto porta front-end do gateway de aplicativo.
...
### -Name
Especifica o nome da porta front-end que este comando adiciona.
