...
## SYNOPSIS
Obtém uma Tabela de Rota de Hub Virtual em um hub virtual ou lista todas as tabelas de rota em um hub virtual.
...
Este cmdlet lista todas as tabelas de rota presentes em um hub virtual usando o nome do grupo de recursos e o nome do hub.
