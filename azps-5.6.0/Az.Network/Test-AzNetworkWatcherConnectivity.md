...
## DESCRIPTION
O Test-AzNetworkWatcherConnectivity cmdlet retorna informações de conectividade para uma VM de origem especificada e um destino. Se a conectividade entre a origem e o destino não puder ser estabelecida, o cmdlet retornará detalhes sobre o problema.

## EXEMPLOS

### Exemplo 1: Testar Conectividade do Watcher de Rede de uma VM para um site
```powershell
...
Retorna informações de conectividade para uma VM de origem especificada e um destino. (gerado automaticamente)
