...
## SYNOPSIS
Inicia a Operação de Captura de Pacotes em um Gateway de Rede Virtual.
...
```
### Exemplo 3
Exemplo de Captura de Pacotes para capturar todos os pacotes internos e externos
```powershell
...
### -FilterData
Opções de filtro para iniciar a captura de pacotes no gateway de rede virtual.
...
### -Name
O nome do gateway de rede virtual onde a captura de pacotes deve ser iniciada.
