...
A conexão VPN cria uma conexão IPsec que conecta um gateway VPN a uma filial de cliente remota representada no Azure como um site VPN.
...
Em seguida, a conexão é atualizada para ter um novo IpSecPolicy usando o comando Set-AzVpnConnection.
...
Em seguida, a conexão é atualizada para ter uma nova chave compartilhada usando a construção de cadeia de caracteres segura.
...
### -ResourceId
A id de recurso do objeto VpnConnection a ser excluído.
...
A lista de VpnSiteLinkConnections que essa VpnConnection precisa ter.
