...
## SYNOPSIS
Cria um Azure ExpressRoutePort.
...
### -Encapsulamento
Método encapsulamento em portas físicas.
...
### -Identity
Identidade atribuída pelo usuário para leitura da configuração do MacSec
...
### -PeeringLocation
O nome do local de paração para o que o ExpressRoutePort é mapeado fisicamente.
