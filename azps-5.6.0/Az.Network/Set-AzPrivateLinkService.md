...
## SYNOPSIS
Atualiza um serviço de link privado.
...
## DESCRIPTION
O cmdlet **Set-AzPrivateLinkService** atualiza um serviço de link privado.

## EXEMPLOS

### 1: cria um serviço de link privado e atualiza seu
```
...
Este exemplo cria um serviço de link privado chamado mypls. Em seguida, ele substitui seus ipConfigurations do objeto ipConfiguratiuon na memória. O Set-AzPrivateLinkService cmdlet é usado para gravar o estado do serviço de link privado modificado no lado do serviço. 
...
### -PrivateLinkService
Especifica um objeto de serviço de link privado que representa o estado ao qual o serviço de link privado deve ser definido.
