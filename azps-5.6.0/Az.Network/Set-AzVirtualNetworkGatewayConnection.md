...
### -EnableBgp
Se deve usar uma sessão BGP em um túnel VPN S2S
...
Uma lista de políticas de Seletor de Tráfego.
...
Se deve usar PrivateIP para uma conexão S2S
...
Se deve usar seletores de tráfego baseados em política para uma conexão S2S
