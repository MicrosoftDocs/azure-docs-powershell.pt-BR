...
```
Este comando cria uma condição em uma regra de reescrita e armazena o resultado na variável chamada $condition.
...
### -IgnoreCase
Definir esse sinalizador para ignorar o caso no padrão
...
### -Negate
Definir esse sinalizador para negar a validação da condição
...
### -Variable
Nome do Header para definir a condição nele
