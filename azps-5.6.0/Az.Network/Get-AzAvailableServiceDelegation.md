...
## SYNOPSIS
Obter delegações de serviço disponíveis na região.
...
## DESCRIPTION
O cmdlet **Get-AzAvailableServiceDelegation** permite recuperar todas as delegações de serviço disponíveis para uma sub-rede no local fornecido. Este cmdlet não *descreve* quais delegações podem existir em uma única sub-rede.

## EXEMPLOS

### 1: Obter todas as delegações de serviço disponíveis
```powershell
