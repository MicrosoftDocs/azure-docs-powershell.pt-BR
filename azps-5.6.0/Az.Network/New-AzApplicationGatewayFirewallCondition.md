...
## SYNOPSIS
Cria uma condição de match para regra personalizada
...
## DESCRIPTION
O **New-AzApplicationGatewayFirewallCondition** cria uma condição de match para a regra personalizada do firewall.
...
O comando cria uma nova condição de match usando a variável match definida no $variable, o operador é Contains e a condição de negação é false, Transfroms incluindo minúsculas e corte, o valor de match é abc e cde. A nova condição de match é salva $condition.
