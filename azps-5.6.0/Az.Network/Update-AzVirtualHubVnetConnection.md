...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual no Central US nesse grupo de recursos no Azure. Uma Conexão de Rede Virtual também é criada, que é igual a Rede Virtual ao Hub Virtual. Essa Conexão de Rede Virtual é atualizada para habilitar a segurança da Internet.
