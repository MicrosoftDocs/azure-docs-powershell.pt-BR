...
Define o sinalizador Usar para o Serviço de Paração

### Atualizar Endereço IPv4 para Peering do Exchange
```powershell
...
### -DirectConnection
Crie uma nova conexão Direta usando o New-AzDirectPeeringConnectionObject e canal para esse comando.
...
### -ExchangeConnection
Crie uma nova conexão do Exchange usando o New-AzExchangePeeringConnectionObject e canal para este comando.
