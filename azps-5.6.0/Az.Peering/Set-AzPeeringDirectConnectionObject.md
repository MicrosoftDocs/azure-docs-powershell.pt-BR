...
## DESCRIPTION
Usada em conjunto com Update-AzPeering, esta é uma operação na memória e só persistirá com `Update-AzPeering` . 
...
Atualiza a largura de banda da primeira conexão no objeto Peering na memória. 
...
Atualiza o Endereço de Peering para a primeira conexão no objeto Peering na memória. 

### Atualizar Uso para o serviço de par
```powershell
