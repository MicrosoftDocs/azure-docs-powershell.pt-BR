...
Cria um objeto de serviço de paração com o provedor e o local de paração. Usar em conjução com `Get-AzPeeringServiceProvider` e `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
A localização física diferente da região do Azure. Use Get-AzPeeringServiceLocation [-Country <country> ]
