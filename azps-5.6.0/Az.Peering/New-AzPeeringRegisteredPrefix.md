...
### Obter peering e criar um prefixo registrado
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredPrefix -Name $asnName -Asn $asn
```

Obter o paring que você deseja adicionar um prefixo registrado. Em seguida, passe isso para o commandlet.

### Usar resourceId de peering para criar uma asn registrada
```powershell
