...
## DESCRIPTION
Obtém serviços de paring para uma assinatura
...
Obtém um serviço de peering para um grupo de recursos
...
Obtém um serviço de peering para um grupo de recursos e nome
...
Obtém um serviço de paração por id de recurso
