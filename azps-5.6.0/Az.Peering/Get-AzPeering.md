...
## DESCRIPTION
Obtém os Peerings de uma assinatura, grupo de recursos ou pelo nome.
...
Obtém o peering do Exchange nomeado `myExchangePeering1`
...
Obtém o peering do Exchange `myExchangePeering1` nomeado com base na id do recurso.
