...
Criar conexão de paração direta com o uso para o serviço de paração habilitado e endereços IP fornecidos pela Microsoft
...
Criar conexão de paração direta com o uso para o serviço de peering habilitado e endereços IP fornecidos por pares
...
Crie conexão de paração direta sem endereços IP de sessão bgp. O par terá que definir os endereços IP antes que a sessão bgp possa ser configurada.
...
### -PeeringDBFacilityId
A ID do recurso de paração encontrada em https://peeringdb.com
...
Habilitar para uso com o Microsoft Peering Service (MPS).
