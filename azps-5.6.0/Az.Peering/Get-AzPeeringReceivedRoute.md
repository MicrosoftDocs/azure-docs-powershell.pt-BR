...
## DESCRIPTION
Lista as rotas recebidas de um Peering

## EXEMPLOS

### Listar as 100 principais rotas recebidas para um par
```powershell
PS C:\> Get-AzPeeringReceivedRoute -ResourceGroupName $resourceGroupName -Name $peeringName
```

Lista todas as rotas recebidas para um paring
...
Lista todas as rotas recebidas para um paring com um filtro em AS 
...
Lista todas as rotas recebidas para um paring com um filtro em RPKIValidationState
...
Lista todas as rotas recebidas para um paring com um filtro em OriginAsValidationState
...
Filtrar por origem estado de validação as.
...
### -RPKIValidationState
Filtrar pelo estado de validação RPKI.
