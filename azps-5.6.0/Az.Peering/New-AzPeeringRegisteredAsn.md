...
## DESCRIPTION
Criar ASNs registradas para objetos de peering.

## EXEMPLOS

### Obter peering e criar um ASN registrado
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredAsn -Name $asnName -Asn $asn
```

Obter o par que você deseja adicionar um ASN registrado. Em seguida, passe isso para o commandlet.
