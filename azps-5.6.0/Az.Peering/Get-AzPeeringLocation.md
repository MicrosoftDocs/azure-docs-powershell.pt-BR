...
## DESCRIPTION
Obtém as Instalações de Paração onde os usuários podem se conectar com ARM.
...
É uma longa lista de locais. Obtém todas as Instalações de Parimento Direto.
...
Obtém o local de paração do exchange para Honolulu. 
...
Obtém o local de paração do exchange para a ID 71 do recurso de paração. 
...
### -Kind
Mostra todo o recurso Peering por Tipo.
...
### -PeeringDbFacilityId
A PeeringDB.com ID de instalação do PeeringDB.com
