...
## SYNOPSIS
Listar todos ou mostrar detalhes dos serviços de provisionamento de dispositivos do Azure IoT Hub.
...
Listar todos os serviços de provisionamento de dispositivo do Azure IoT Hub em uma assinatura.
...
Listar todos os serviços de provisionamento de dispositivo do Azure IoT Hub no grupo de recursos "myresourcegroup".
...
Mostrar detalhes de um serviço de provisionamento de dispositivo do Azure IoT Hub 'myiotdps'.
