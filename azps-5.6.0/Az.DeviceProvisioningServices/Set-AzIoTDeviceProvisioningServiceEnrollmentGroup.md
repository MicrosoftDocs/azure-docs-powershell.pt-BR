...
## DESCRIPTION
Atualize um grupo de registro em um Serviço de Provisionamento de Dispositivo de Hub do Azure IoT.
...
Atualize a política de alocação e os hubs para um grupo de registro.
...
Atualize o estado duplo inicial de um grupo de registro.
...
Atualizar as chaves primárias e secundárias de um grupo de registro de chave simétrica
...
### -Desired
Propriedades iniciais desejadas para o irmão duplo.
...
Use a lista separada por espaço para vários Hubs de IoT.
...
### -PrimaryCAName
O nome do certificado ca raiz principal.
Se o atestado com um certificado ca raiz for desejado, um nome de ca raiz deve ser fornecido.
...
### -ReprovisionPolicy
Dados do dispositivo a serem tratados na re provisionamento para hub de Iot diferente.
...
### -SecondaryCAName
O nome do certificado ca raiz secundário.
Se o atestado com um certificado ca raiz for desejado, um nome de ca raiz deve ser fornecido.
...
### -WebhookUrl
A URL de webhook usada para solicitações de alocação personalizadas.
