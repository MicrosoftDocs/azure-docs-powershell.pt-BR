...
## SYNOPSIS
Atualize um hub de IoT vinculado em um serviço de provisionamento de dispositivo do Azure IoT Hub.
...
Atualize o hub de IoT vinculado "myiothub.azure-devices.net" em um serviço de provisionamento de dispositivoS do Azure IoT Hub.
