...
## DESCRIPTION
Atualize um registro de dispositivo em um Serviço de Provisionamento de Dispositivo de Hub do Azure IoT.
...
Atualize o estado duplo inicial de um registro.
...
Atualizar certificados primários e secundários de um registro de chave simétrica
...
### -RootCertificate
Alternar para atualizar x509attestation usando certificados raiz.
