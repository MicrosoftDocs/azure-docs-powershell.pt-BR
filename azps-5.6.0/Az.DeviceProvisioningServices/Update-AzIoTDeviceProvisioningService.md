...
## SYNOPSIS
Atualize um serviço de provisionamento de dispositivo do Azure IoT Hub.
...
Atualize a Política de Alocação para "GeoLatency" de um serviço de provisionamento de dispositivo do Azure IoT Hub "myiotdps".
...
Adicione marcas a um serviço de provisionamento de dispositivo do Azure IoT Hub "myiotdps".
...
Excluir Marca e adicionar novas marcas a um serviço de provisionamento de dispositivo do Azure IoT Hub "myiotdps" usando pipeline.

## PARÂMETROS

### -AllocationPolicy
Política de Alocação de Serviço de Provisionamento de Dispositivos IoT
...
### -Reset
Redefinir as marcas de serviço de provisionamento de dispositivo IoT
...
### -Tag
Coleção IoT Device Provisioning Service Tag
