...
## SYNOPSIS
Lista todos os certificados ou um certificado específico contido em um Serviço de Provisionamento de Dispositivo de Hub IoT do Azure.
...
Mostrar detalhes sobre "mycertificate" em um serviço de provisionamento de dispositivo do Azure IoT Hub.
...
Listar todos os certificados em "myiotdps" usando pipeline.
