...
## SYNOPSIS
Exclua um certificado do Serviço de Provisionamento de Dispositivo de Hub do Azure IoT.
...
Exclua "mycertificate" em um serviço de provisionamento de dispositivo do Azure IoT Hub.
