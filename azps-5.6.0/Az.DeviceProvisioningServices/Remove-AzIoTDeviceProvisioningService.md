...
## SYNOPSIS
Exclua um serviço de provisionamento de dispositivo do Azure IoT Hub.
...
Exclua um serviço de provisionamento de dispositivo do Azure IoT Hub 'myiotdps'.
...
Exclua um serviço de provisionamento de dispositivo do Azure IoT Hub 'myiotdps' usando pipeline.
