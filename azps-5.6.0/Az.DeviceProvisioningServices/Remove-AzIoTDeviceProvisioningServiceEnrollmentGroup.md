...
## DESCRIPTION
Exclua um grupo de registro em um Serviço de Provisionamento de Dispositivo de Hub do Azure IoT.
...
Exclua um grupo de registro especificado.
...
Exclua todos os grupos de registro.
