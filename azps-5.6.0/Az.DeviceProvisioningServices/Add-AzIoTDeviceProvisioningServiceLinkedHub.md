...
## SYNOPSIS
Hub IoT vinculado a um serviço de provisionamento de dispositivo do Azure IoT Hub.
...
Hub IoT vinculado a um serviço de provisionamento de dispositivo do Azure IoT Hub com AllocationWeight e ApplyAllocationPolicy.
...
### -ApplyAllocationPolicy
Um booleano indicando se a política de alocação deve ser aplicada ao Hub de IoT
...
Cadeia de conexão do recurso hub de Iot.
