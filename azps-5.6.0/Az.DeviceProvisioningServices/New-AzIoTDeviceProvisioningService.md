...
## SYNOPSIS
Crie um serviço de provisionamento de dispositivo do Azure IoT Hub.
...
Crie um serviço de provisionamento de dispositivo do Azure IoT Hub com a faixa de preços padrão S1 e marcas, na região do grupo de recursos.
...
Crie um serviço de provisionamento de dispositivo do Azure IoT Hub com a camada de preços padrão S1, na região 'eastus'.
...
### -Tag
Marcas de instância do Serviço de Provisionamento de Dispositivo IoT. Bolsa de propriedades em pares de valores-chave na forma de uma tabela de hash.
