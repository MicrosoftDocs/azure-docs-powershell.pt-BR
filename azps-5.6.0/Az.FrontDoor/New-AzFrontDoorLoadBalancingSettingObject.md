...
A latência adicional em milissegundos para que as sondas caiam no bucket de latência mais baixo. O valor padrão é 0
...
### -SampleSize
O número de exemplos a considerar para decisões de balanceamento de carga.
O valor padrão é 4
...
O número de amostras dentro do período de exemplo que deve ser bem-sucedido Valor padrão é 2
