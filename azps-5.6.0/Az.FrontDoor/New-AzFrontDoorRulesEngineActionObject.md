...
Crie uma ação do mecanismo de regras e mostre como exibir as propriedades da ação do mecanismo de regras criada.

## PARÂMETROS

### -BackendPoolName
O nome do BackendPool para o qual essa regra se encaminha
...
O primeiro?
e & serão adicionados automaticamente para que não as incluam na frente, mas separem várias cadeias de caracteres de consulta com &.
...
### -DynamicCompression
Se a compactação dinâmica será habilitada para conteúdo armazenado em cache.
...
### -EnableCaching
Se é possível habilitar o cache para essa rota.
...
### -RequestHeaderAction
Uma lista de ações de header a aplicar da solicitação do AFD à origem.
...
Uma lista de ações de header a aplicar a partir da resposta do AFD ao cliente.
