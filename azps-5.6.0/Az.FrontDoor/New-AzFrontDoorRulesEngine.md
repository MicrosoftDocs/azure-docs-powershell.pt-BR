...
Use o cmdlet "New-AzFrontDoorRulesEngineRule" para construir regras de mecanismo de regras para passar para o parâmetro "-Rules" deste cmdlet.
...
Crie uma nova configuração do mecanismo de regras para a porta frontal especificada.
...
### -Rule
Uma lista de regras que definem uma configuração específica do Mecanismo de Regras.
