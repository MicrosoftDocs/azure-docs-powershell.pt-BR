...
Se deve impor a verificação de nome de certificado em solicitações HTTPS a todos os pools de back-end.
...
Enviar e receber tempo de espera na solicitação de encaminhamento para o back-end. Quando o tempo final é atingido, a solicitação falha e retorna.
