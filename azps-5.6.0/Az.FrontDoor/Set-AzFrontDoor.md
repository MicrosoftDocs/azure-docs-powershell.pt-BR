...
## DESCRIPTION
O cmdlet **Set-AzFrontDoor** atualiza um balanceador de carga da Porta Da Frente. Se os parâmetros de entrada não são fornecidos, parâmetros antigos da Porta Frontal existente serão usados.

## EXEMPLOS

### Exemplo 1: atualize um Front Door existente com FrontDoorName e ResourceGroupName.
```powershell
...
### Exemplo 2: atualizar um Front Door existente com objeto PSFrontDoor.
```powershell
...
### Exemplo 4: atualizar a propriedade BackendPoolSetting EnforceCertificateNameCheck de um parâmetro de opção -DisableCertificateNameCheck existente com a porta frontal com -DisableCertificateNameCheck
A Porta Da Frente a ser atualizada pode ser identificada usando FrontoorName e ResourceGroupName, objeto PSFrontDoor ou ResourceId. (Veja acima 3 exemplos por exemplo) O exemplo a seguir usa o objeto PSFrontDoor.
...
### -EnabledState
Status operacional do balanceador de carga da Porta Da Frente.
...
### -ResourceId
ID de recurso da Porta da Frente a ser atualizada
