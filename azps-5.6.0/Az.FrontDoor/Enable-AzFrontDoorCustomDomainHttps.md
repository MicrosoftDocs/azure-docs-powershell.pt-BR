...
## DESCRIPTION
**Enable-AzFrontDoorCustomDomainHttps** habilita HTTPS para um domínio personalizado.

## EXEMPLOS

### Exemplo 1: Habilitar HTTPS para um domínio personalizado com FrontDoorName e ResourceGroupName usando o certificado gerenciado porta da frente.
```powershell
...
Habilitar HTTPS para um domínio personalizado "frontendpointname1-custom-xyz" que faz parte do "frontdoor1" da Porta da Frente no grupo de recursos "resourcegroup1" usando o certificado gerenciado porta da frente.

### Exemplo 2: Habilitar HTTPS para um domínio personalizado com FrontDoorName e ResourceGroupName usando o próprio certificado no Key Vault.
```powershell
...
### Exemplo 3: Habilitar HTTPS para um domínio personalizado com o objeto PSFrontendEndpoint usando o certificado gerenciado porta da frente.
```powershell
...
Habilitar HTTPS para um domínio personalizado com o objeto PSFrontendEndpoint usando o certificado gerenciado porta da frente.

### Exemplo 4: Habilitar HTTPS para um domínio personalizado com id de recurso usando o certificado gerenciado porta da frente.
```powershell
...
Habilitar HTTPS para um domínio personalizado "frontendpointname1-custom-xyz" com id de recurso $resourceId usando o certificado gerenciado porta da frente.
...
### -ResourceId
ID do recurso do ponto de extremidade da Porta da Frente para habilitar https
