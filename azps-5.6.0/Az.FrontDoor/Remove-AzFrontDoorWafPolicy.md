...
## DESCRIPTION
O cmdlet **Remove-AzFrontDoorWafPolicy** remove uma política WAF na assinatura atual
...
Remova toda a política WAF no $resourceGroupName.
...
### -ResourceId
ID de recurso da política WAF a ser excluído
