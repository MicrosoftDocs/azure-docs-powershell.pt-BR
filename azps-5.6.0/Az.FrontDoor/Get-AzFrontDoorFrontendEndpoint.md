...
## DESCRIPTION
O cmdlet **Get-AzFrontDoorFrontendEndpoint** obtém todos os pontos de extremidade front-end existentes no recurso atual da Porta da Frente que corresponde às informações fornecidas.

## EXEMPLOS

### Exemplo 1: Obter todos os pontos de extremidade front-end no Front Door "frontdoor1" que faz parte do grupo de recursos "rg1".
```powershell
...
Obter todos os pontos de extremidade front-end no Front Door "frontdoor1" que faz parte do grupo de recursos "rg1".

### Exemplo 2: Obter ponto de extremidade front-end com o nome "frontdoor1-azurefd-net" na Porta da Frente "frontdoor1" que faz parte do grupo de recursos "rg1"
```powershell
...
Obter ponto de extremidade front-end com o nome "frontdoor1-azurefd-net" no Front Door "frontdoor1" que faz parte do grupo de recursos "rg1"
...
### -ResourceId
ID de recurso da Porta da Frente
