...
## DESCRIPTION
O cmdlet **Get-AzFrontDoorRulesEngine** obtém uma configuração específica do mecanismo de regras ou obtém todas as configurações do mecanismo de regras associadas a uma Porta Da Frente. 
...
Saída esperada ao obter um mecanismo de regras inexistente. 
