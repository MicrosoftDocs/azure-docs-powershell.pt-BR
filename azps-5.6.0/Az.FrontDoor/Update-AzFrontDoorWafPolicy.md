...
## DESCRIPTION
O cmdlet **Update-AzFrontDoorWafPolicy** atualiza uma política WAF existente. Se os parâmetros de entrada não são fornecidos, parâmetros antigos da política WAF existente serão usados.
...
Atualize um código de status personalizado de política WAF existente.
...
Atualize um modo de política WAF existente.
...
Atualize um estado e modo de política WAF existentes.
...
Atualizar todas as políticas waf no $resourceGroupName

## PARÂMETROS

### -CustomBlockResponseBody
Corpo da Resposta Personalizado
...
Código de Status da Resposta Personalizado
...
Os valores possíveis incluem:'Prevention', 'Detection'
...
### -RequestBodyCheck
Define se o corpo deve ser inspecionado por regras gerenciadas. Os valores possíveis incluem: 'Habilitado', 'Desabilitado'
...
### -ResourceId
ID de recurso do FireWallPolicy a ser atualizado
