...
### -BackendHostHeader
O valor a ser usado como o header do host enviado para o back-end. O valor padrão é o endereço back-end.
...
### -EnabledState
Se deve habilitar o uso desse back-end. O valor padrão é Habilitado
...
### -PrivateLinkAlias
Alias do recurso Private Link. Preencher esse campo opcional indica que esse back-end é 'Private'
...
### -PrivateLinkLocation
O local do recurso Private Link. O local é necessário quando PrivateLinkResourceId é definido
...
A ID de Recurso do Link Particular. Preencher esse campo opcional indica que esse back-end é 'Private'
