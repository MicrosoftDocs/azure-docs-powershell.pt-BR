...
### -MatchValue
Corresponder valores a corresponder.
O operador se aplicará a cada valor aqui com semântica OR.
...
### -NegateCondition
Descreve se essa condição é negada ou não
...
### -Operator
Descreve o operador a ser aplicado à condição de match.
...
### -Transform
Lista de quais transformação são aplicadas antes da correspondência. Os valores de transformação individuais possíveis são Lowercase, Uppercase, Trim, UrlDecode, UrlEncode, RemoveNulls.
