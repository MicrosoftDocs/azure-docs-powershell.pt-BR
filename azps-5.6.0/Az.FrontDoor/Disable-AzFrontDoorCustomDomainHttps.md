...
### Exemplo 2: Desabilitar HTTPS para um domínio personalizado com o objeto PSFrontendEndpoint.
```powershell
...
Desabilite HTTPS para um domínio personalizado com o objeto PSFrontendEndpoint.
...
### -ResourceId
ID de recurso do ponto de extremidade da Porta da Frente para desabilitar https
