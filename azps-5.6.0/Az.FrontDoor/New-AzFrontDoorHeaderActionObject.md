...
### -HeaderActionType
Qual tipo de manipulação aplicar ao header.
...
### -HeaderName
O nome do header ao que essa ação se aplicará.
...
### -Value
O valor para atualizar o nome do header determinado com.
Esse valor não será usado se actionType for Delete.
