...
ms.locfileid: "101887720"
---
# <span data-ttu-id="c8410-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="c8410-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="c8410-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="c8410-102">SYNOPSIS</span></span>
<span data-ttu-id="c8410-103">Obtém informações sobre uma configuração do servidor.</span><span class="sxs-lookup"><span data-stu-id="c8410-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="c8410-104">SINTAXE</span><span class="sxs-lookup"><span data-stu-id="c8410-104">SYNTAX</span></span>

### <span data-ttu-id="c8410-105">Lista (Padrão)</span><span class="sxs-lookup"><span data-stu-id="c8410-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="c8410-106">Obter</span><span class="sxs-lookup"><span data-stu-id="c8410-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="c8410-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="c8410-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="c8410-108">DESCRIPTION</span><span class="sxs-lookup"><span data-stu-id="c8410-108">DESCRIPTION</span></span>
<span data-ttu-id="c8410-109">Obtém informações sobre uma configuração do servidor.</span><span class="sxs-lookup"><span data-stu-id="c8410-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="c8410-110">EXEMPLOS</span><span class="sxs-lookup"><span data-stu-id="c8410-110">EXAMPLES</span></span>

### <span data-ttu-id="c8410-111">Exemplo 1: Listar todas as configurações em um MariaDB</span><span class="sxs-lookup"><span data-stu-id="c8410-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="c8410-112">Este comando lista todas as configurações em um MariaDB.</span><span class="sxs-lookup"><span data-stu-id="c8410-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="c8410-113">Exemplo 2: Obter uma configuração de MariaDB</span><span class="sxs-lookup"><span data-stu-id="c8410-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="c8410-114">Este comando obtém uma configuração de MariaDB.</span><span class="sxs-lookup"><span data-stu-id="c8410-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="c8410-115">PARÂMETROS</span><span class="sxs-lookup"><span data-stu-id="c8410-115">PARAMETERS</span></span>

### <span data-ttu-id="c8410-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="c8410-116">-DefaultProfile</span></span>
<span data-ttu-id="c8410-117">As credenciais, conta, locatário e assinatura usadas para comunicação com o Azure.</span><span class="sxs-lookup"><span data-stu-id="c8410-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="c8410-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="c8410-118">-InputObject</span></span>
<span data-ttu-id="c8410-119">Parâmetro Identity Para construir, consulte a seção NOTES para propriedades INPUTOBJECT e crie uma tabela de hash.</span><span class="sxs-lookup"><span data-stu-id="c8410-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="c8410-120">-Name</span><span class="sxs-lookup"><span data-stu-id="c8410-120">-Name</span></span>
<span data-ttu-id="c8410-121">O nome da configuração do servidor.</span><span class="sxs-lookup"><span data-stu-id="c8410-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="c8410-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="c8410-122">-ResourceGroupName</span></span>
<span data-ttu-id="c8410-123">O nome do grupo de recursos que contém o recurso.</span><span class="sxs-lookup"><span data-stu-id="c8410-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="c8410-124">Você pode obter esse valor da API do Gerenciador de Recursos do Azure ou do portal.</span><span class="sxs-lookup"><span data-stu-id="c8410-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="c8410-125">-ServerName</span><span class="sxs-lookup"><span data-stu-id="c8410-125">-ServerName</span></span>
<span data-ttu-id="c8410-126">O nome do servidor.</span><span class="sxs-lookup"><span data-stu-id="c8410-126">The name of the server.</span></span>
...
### <span data-ttu-id="c8410-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="c8410-127">-SubscriptionId</span></span>
<span data-ttu-id="c8410-128">A ID da assinatura que identifica uma assinatura do Azure.</span><span class="sxs-lookup"><span data-stu-id="c8410-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="c8410-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="c8410-129">CommonParameters</span></span>
<span data-ttu-id="c8410-130">Este cmdlet dá suporte aos parâmetros comuns: -Depurar, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction e -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="c8410-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="c8410-131">Para obter mais informações, [consulte about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="c8410-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="c8410-132">INPUTS</span><span class="sxs-lookup"><span data-stu-id="c8410-132">INPUTS</span></span>

### <span data-ttu-id="c8410-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="c8410-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="c8410-134">SAÍDAS</span><span class="sxs-lookup"><span data-stu-id="c8410-134">OUTPUTS</span></span>

### <span data-ttu-id="c8410-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span><span class="sxs-lookup"><span data-stu-id="c8410-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="c8410-136">NOTES</span><span class="sxs-lookup"><span data-stu-id="c8410-136">NOTES</span></span>

<span data-ttu-id="c8410-137">ALIASES</span><span class="sxs-lookup"><span data-stu-id="c8410-137">ALIASES</span></span>

<span data-ttu-id="c8410-138">PROPRIEDADES DE PARÂMETRO COMPLEXO</span><span class="sxs-lookup"><span data-stu-id="c8410-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="c8410-139">Para criar os parâmetros descritos abaixo, construa uma tabela de hash contendo as propriedades apropriadas.</span><span class="sxs-lookup"><span data-stu-id="c8410-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="c8410-140">Para obter informações sobre tabelas de hash, execute Get-Help about_Hash_Tables.</span><span class="sxs-lookup"><span data-stu-id="c8410-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="c8410-141">INPUTOBJECT <IMariaDbIdentity> : Parâmetro Identity</span><span class="sxs-lookup"><span data-stu-id="c8410-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="c8410-142">`[ConfigurationName <String>]`: O nome da configuração do servidor.</span><span class="sxs-lookup"><span data-stu-id="c8410-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="c8410-143">`[DatabaseName <String>]`: O nome do banco de dados.</span><span class="sxs-lookup"><span data-stu-id="c8410-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="c8410-144">`[FirewallRuleName <String>]`: O nome da regra de firewall do servidor.</span><span class="sxs-lookup"><span data-stu-id="c8410-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="c8410-145">`[Id <String>]`: Caminho da identidade do recurso</span><span class="sxs-lookup"><span data-stu-id="c8410-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="c8410-146">`[LocationName <String>]`: O nome do local.</span><span class="sxs-lookup"><span data-stu-id="c8410-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="c8410-147">`[ResourceGroupName <String>]`: O nome do grupo de recursos que contém o recurso.</span><span class="sxs-lookup"><span data-stu-id="c8410-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="c8410-148">Você pode obter esse valor da API do Gerenciador de Recursos do Azure ou do portal.</span><span class="sxs-lookup"><span data-stu-id="c8410-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="c8410-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: O nome da política de alerta de segurança.</span><span class="sxs-lookup"><span data-stu-id="c8410-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="c8410-150">`[ServerName <String>]`: O nome do servidor.</span><span class="sxs-lookup"><span data-stu-id="c8410-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="c8410-151">`[SubscriptionId <String>]`: A ID da assinatura que identifica uma assinatura do Azure.</span><span class="sxs-lookup"><span data-stu-id="c8410-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="c8410-152">`[VirtualNetworkRuleName <String>]`: O nome da regra de rede virtual.</span><span class="sxs-lookup"><span data-stu-id="c8410-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="c8410-153">LINKS RELACIONADOS</span><span class="sxs-lookup"><span data-stu-id="c8410-153">RELATED LINKS</span></span>
