...
### Exemplo 1: Listar todas as configurações em um MariaDB
```powershell
...
Este comando lista todas as configurações em um MariaDB.

### Exemplo 2: Obter uma configuração de MariaDB
```powershell
...
Este comando obtém uma configuração de MariaDB.
