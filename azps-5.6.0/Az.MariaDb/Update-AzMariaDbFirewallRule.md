...
### Exemplo 1: atualizar a regra de firewall do MariaDB
```powershell
...
Este comando atualiza uma regra de firewall MariaDB.

### Exemplo 2: Atualizar Regra de Firewall MariaDB por identidade.
```powershell
...
O cmdlet atualiza a Regra de Firewall MariaDB por identidade.

### Exemplo 3: Atualizar a Regra de Firewall de MariaDB por -ClientIPAddress.
```powershell
PS C:\> $ID = "/subscriptions/<SubscriptionId>/resourceGroups/mariadb-test-qu5ov0/providers/Microsoft.DBforMariaDB/servers/mariadb-test-4rmtig/firewallRules/fr-cfgl3y"
...
O cmdlet atualiza a Regra de Firewall de MariaDB por -ClientIPAddress.
...
INPUTOBJECT <IMariaDbIdentity> : Parâmetro Identity
