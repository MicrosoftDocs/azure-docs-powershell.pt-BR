...
Este comando cria uma regra de firewall em um MariaDB.
...
Este cmdlets criam uma Regra de Firewall MariaDB usando -ClientIPAddress.

### Exemplo 3: Criar uma nova Regra de Firewall do MariaDB para permitir todos os IPs
```powershell
...
Esses cmdlets criam uma nova Regra de Firewall MariaDB para permitir todos os IPs.
