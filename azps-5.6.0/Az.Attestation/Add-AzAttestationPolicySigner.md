...
## SYNOPSIS
Adiciona um signatário de política confiável para um locatário no Atestado do Azure.
...
Adicione um signante confiável para o Provedor de Atteestation chamado *pshtest*.
...
### -Signer
Especifica o Token Web JSON JSON RFC7519 contendo uma declaração chamada "maa-policyCertificate" cujo valor é uma Chave Web JSON JSON RFC7517 que contém uma nova chave de assinatura confiável para adicionar.
