...
Obtém os signatários de política confiáveis para o *pshtest* do Provedor de Atestados em Resource Group *psh-test-rg*.  Observe que não há signatários confiáveis para este Provedor de Atestados.
...
Obtém os signatários de política confiáveis para o *pshtest2* do Provedor de Atestados no Grupo de Recursos *psh-test-rg*.  Observe que há um signante confiável para este Provedor de Atestados.
...
Obtém os signatários de política confiáveis para o Provedor Padrão de Atestado no Local *Central dos EUA*.  Observe que não há signatários confiáveis para o Provedor Padrão de Atestado.
