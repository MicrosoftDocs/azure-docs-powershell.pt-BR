...
## DESCRIPTION
O New-AzAttestation cmdlet cria um atestado no grupo de recursos especificado.
...
Crie uma nova instância de um Provedor de Atestados chamado *pshtest4* com algumas marcas e usando a confiança do AAD para masterizar a política DOE.
...
Crie uma nova instância de um Provedor de Atestados chamado *pshtest3*' que usa a confiança isolada para masterizar a política TEE por meio da especificação de um conjunto de chaves de assinatura confiáveis por meio de um arquivo PEM.
...
### -Location
Especifica a região do Azure na qual criar o provedor de atestados. Use o comando Get-AzResourceProvider com o parâmetro ProviderNamespace para ver suas escolhas.
