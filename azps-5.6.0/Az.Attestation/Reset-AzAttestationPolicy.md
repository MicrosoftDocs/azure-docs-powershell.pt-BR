...
## DESCRIPTION
O Reset-AzAttestationPolicy cmdlet redefine a política de atestado definida pelo usuário de um locatário no Azure Attestation.
...
Redefina a política para o padrão para o *pshtest* do Provedor de Atestados para O tipo de Tee *SgxEnclave*.
...
Se o *pshtest* provedor de atestado estiver configurado para usar o modelo de confiança isolado, redefina a política como padrão para O tipo de Tee *SgxEnclave* incluindo uma política assinada.
...
Este cmdlet redefine a política de atestado para o locatário especificado por esse parâmetro.
...
### -Policy
Especifica o Token Web JSON que descreve o documento de política a ser redefinido.
...
Suportamos quatro tipos de ambiente: SgxEnclave, OpenEnclave, CyResComponent e VBSEnclave.
