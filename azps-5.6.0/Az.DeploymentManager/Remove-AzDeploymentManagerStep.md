...
Especifique a etapa pelo nome e o nome do grupo de recursos. Como alternativa, você pode fornecer o objeto Step ou ResourceId.
...
Este comando exclui uma etapa chamada ContosoService1WaitStep em ContosoResourceGroup.

### Exemplo 2: Remover uma etapa usando o identificador de recurso
```powershell
...
```
 ...
 Este comando exclui uma etapa cujo nome e ResourceGroup corresponderem às propriedades Name e ResourceGroupName do $stepObject, respectivamente.
