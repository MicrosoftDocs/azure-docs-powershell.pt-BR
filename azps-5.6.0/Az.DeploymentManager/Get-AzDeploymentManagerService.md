...
Você pode modificar esse objeto localmente e aplicar alterações ao serviço usando o cmdlet Set-AzDeploymentManagerService.
...
Este comando obtém um serviço chamado ContosoService1 em uma topologia de serviço chamada ContosoServiceTopology no ContosoResourceGroup.
...
Este comando obtém um serviço cujo nome, nome da topologia de serviço e ResourceGroup corresponderem às propriedades Name, ServiceTopologyName e ResourceGroupName do $serviceObject, respectivamente.
