...
Você pode modificar o objeto retornado localmente e aplicar as alterações à etapa usando o cmdlet Set-AzDeploymentManagerStep.
...
Cria uma etapa no ContosoResourceGroup com o nome ContosoService1WaitStep com a Central US como o local do recurso. A propriedade Duration fornece a duração que a entrega aguardará antes de executar a próxima etapa.
...
### -Duration
A duração de espera no formato ISO 8601.
...
O caminho para o arquivo em que as propriedades de verificação de saúde são definidas.
