...
Este comando atualiza uma unidade de serviço cujo nome, nome do serviço, nome da topologia de serviço e ResourceGroup corresponderão às propriedades Name, ServiceName, ServiceTopologyName e ResourceGroupName do $serviceUnitObject, respectivamente.
...
### -InputObject
O objeto da unidade de serviço.
