...
Este comando exclui uma unidade de serviço chamada ContosoService1Storage em um serviço ContosoService1 em uma topologia de serviço chamada ContosoServiceTopology no ContosoResourceGroup.
...
Este comando exclui uma unidade de serviço cujo nome, nome do serviço, nome da topologia de serviço e ResourceGroup corresponderão às propriedades Name, ServiceName, ServiceTopologyName e ResourceGroupName do $serviceUnitObject, respectivamente.
