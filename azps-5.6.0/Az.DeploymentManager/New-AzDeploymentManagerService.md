...
Especifique o serviço pelo nome, topologia de serviço em que ele está e o nome do grupo de recursos. 

O cmdlet retorna um objeto Service. Você pode modificar esse objeto localmente e aplicar alterações ao serviço usando o cmdlet Set-AzDeploymentManagerService.
...
Cria um novo serviço com o nome ContosoService1 em topologia de serviço ContosoServiceTopology no Grupo de Recursos ContosoResourceGroup, no local Central DOS EUA. A propriedade TargetLocation indica que o serviço ContosoService1 deve ser implantado na região leste dos EUA na assinatura especificada.
...
### -ServiceTopologyName
O nome da topologia de serviço a que esse serviço pertence.
...
### -TargetLocation
Determina o local para o qual os recursos sob o serviço seriam implantados.
...
Determina a assinatura para a qual recursos no serviço seriam implantados.
