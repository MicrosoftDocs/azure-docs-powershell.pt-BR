...
## SYNOPSIS
Lista a chave de acesso para o armazenamento de configuração especificado.
...
### Exemplo 1: listar todas as chaves de armazenamento de um armazenamento de configuração de aplicativo
```powershell
...
Este comando lista todas as chaves de armazenamento de um armazenamento de configuração de aplicativo.
