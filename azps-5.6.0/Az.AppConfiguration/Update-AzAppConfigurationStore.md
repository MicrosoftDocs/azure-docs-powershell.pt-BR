...
## SYNOPSIS
Atualiza um armazenamento de configuração com os parâmetros especificados.
...
### Exemplo 1: Habilitar a criptografia de dados do armazenamento de configuração do aplicativo por identidade gerenciada atribuída pelo sistema
```powershell
...
Esse comando habilita a criptografia de dados por uma chave armazenada no Azure Key Vault usando uma identidade gerenciada atribuída pelo sistema.
O cofre deve ter habilitado a exclusão suave e a proteção contra limpeza, e a identidade gerenciada deve ter essas permissões principais: get, wrapKey, unwrapKey.

### Exemplo 2: Habilitar a criptografia de dados do armazenamento de configuração do aplicativo por identidade gerenciada atribuída pelo usuário
```powershell
PS C:\> $key = Add-AzKeyVaultKey -VaultName kv-Name -Name key-Name -Destination 'Software'
...
Esse comando habilita a criptografia de dados por uma chave armazenada no Azure Key Vault usando uma identidade gerenciada atribuída pelo usuário.
A identidade atribuída pelo usuário deve ter sido definida com `-UserAssignedIdentity` .
O cofre deve ter habilitado a exclusão suave e a proteção contra limpeza, e a identidade gerenciada deve ter essas permissões principais: get, wrapKey, unwrapKey.

### Exemplo 3: Desabilitar a criptografia de um armazenamento de configuração de aplicativo.
```powershell
...
Esse comando desabilita a criptografia de um armazenamento de configuração de aplicativo.

### Exemplo 3: Atualizar sku e marca de um armazenamento de configuração de aplicativo por pipeline.
```powershell
...
Este comando atualiza sku e marca de um armazenamento de configuração de aplicativo por pipeline.
...
O URI da chave de cofre de chaves usada para criptografar dados.
