...
## SYNOPSIS
Exclui um armazenamento de configuração.
...
### Exemplo 1: Remover um armazenamento de configuração de aplicativo
```powershell
PS C:\> Remove-AzAppConfigurationStore -Name appconfig-test03 -ResourceGroupName lucas-manual-test

```

Este comando remove um armazenamento de configuração de aplicativo.

### Exemplo 2: Remover um armazenamento de configuração de aplicativo
```powershell
