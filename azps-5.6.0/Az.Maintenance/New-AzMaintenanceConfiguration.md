...
Criar uma configuração de manutenção com Host de escopo
...
### -ExpirationDateTime
O expirationDateTime da agenda no formato YYYY-MM-DD hh:mm
...
### -ExtensionProperty
As propriedades Extension por recurso.
...
### -StartDateTime
StartDateTime da agenda no formato YYYY-MM-DD hh:mm
