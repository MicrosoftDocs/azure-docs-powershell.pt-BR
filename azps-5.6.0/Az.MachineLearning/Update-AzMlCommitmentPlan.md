...
## DESCRIPTION
Atualiza um recurso de plano de compromisso existente. Observe que a maioria das propriedades do plano de compromisso é imutável e não pode ser modificada. As propriedades que podem ser modificadas incluem Sku (permitindo que você migre o plano de compromisso de um SKU para outro) e Tags.
...
### -SkuCapacity
A capacidade do SKU a ser usado ao atualizar o plano de compromisso do Azure ML.
...
### -SkuName
O nome do SKU a ser usado ao atualizar o plano de compromisso do Azure ML.
...
### -SkuTier
A camada do SKU a ser usado ao atualizar o plano de compromisso do Azure ML.
