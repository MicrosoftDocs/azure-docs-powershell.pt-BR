...
## DESCRIPTION
Exclui um plano de compromisso do Azure Machine Learning. Observe que os planos de compromisso que têm associações de compromisso não podem ser excluídos. Associações de compromisso só podem ser excluídas pelo recurso de destino. Por exemplo, se você excluir um serviço Web do Azure Machine Learning, a associação de compromisso que associa o serviço Web a um plano de compromisso também será excluída.
...
### -MlCommitmentPlan
O objeto de serviço Web de aprendizado de máquina.
