...
## SYNOPSIS
Exporta o objeto de definição do serviço Web como uma cadeia de caracteres formatada JSON.
...
## DESCRIPTION
Exporta o objeto de definição para o serviço Web especificado como uma cadeia de caracteres formatada JSON.
...
### -WebService
O objeto de definição do serviço Web a ser exportado.
