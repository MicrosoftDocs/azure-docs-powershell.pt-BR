...
## SYNOPSIS
Inicia a migração de teste para o servidor de réplica.
...
### -InputObject
Especifica o servidor de réplica para o qual a migração de teste precisa ser iniciada.
...
INPUTOBJECT : Especifica o servidor de réplica para o qual a migração de teste <IMigrationItem> precisa ser iniciada. O objeto server pode ser recuperado usando o cmdlet Get-AzMigrateServerReplication servidor.
