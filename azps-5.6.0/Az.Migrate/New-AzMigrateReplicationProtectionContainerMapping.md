...
Para construir, consulte a seção NOTES para propriedades PROVIDERSPECIFICINPUT e crie uma tabela de hash.
...
O nome do contêiner de proteção exclusivo de destino.
