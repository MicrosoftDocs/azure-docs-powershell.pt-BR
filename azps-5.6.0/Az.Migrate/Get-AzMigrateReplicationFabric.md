...
### Exemplo 1: Obter todos os malhas por grupo de recursos e nome do cofre
```powershell
...
Obter todos os malhas no grupo de recursos e no cofre

### Exemplo 2: Obter malha por grupo de recursos, nome do cofre e nome de malha
```powershell
