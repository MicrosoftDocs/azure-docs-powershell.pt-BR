...
## DESCRIPTION
O Export-AzAnalysisServicesInstance de cmdlet exporta log de uma instância do servidor do Azure Analysis Services para o arquivo
...
Este comando exportará o log do servidor 'testserver' no ambiente especificado no comando Add-AzAnalysisServicesAccount e o salvará no arquivo especificado em OutputPath 'C:\path\to\log\testserver.log'
...
### -OutputPath
Caminho de saída para o arquivo para exportar log
