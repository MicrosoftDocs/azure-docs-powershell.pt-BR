...
## DESCRIPTION
O cmdlet Suspend-AzAnalysisServicesServer suspende uma instância do servidor do Analysis Services
...
Este comando suspenderá um servidor ativo chamado testserver no grupo de recursos testgroup
...
### -PassThru
Retornará os detalhes do servidor excluídos se a operação for concluída com êxito
