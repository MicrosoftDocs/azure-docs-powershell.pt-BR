...
## DESCRIPTION
O cmdlet **Update-AzSmartGroupState** atualiza o estado do grupo inteligente.
...
Este cmdlet atualiza o estado do grupo inteligente para Acknowleged.
...
### -State
Estado do grupo Smart atualizado
