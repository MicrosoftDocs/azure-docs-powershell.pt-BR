...
## SYNOPSIS
Obtém histórico de grupo inteligente
...
## DESCRIPTION
O cmdlet **Get-AzSmartGroupHistory** obtém o histórico de grupo inteligente.
...
### -SmartGroupId
Identificador exclusivo do SmartGroup/ResourceId de alerta.
