...
### Exemplo 1: atualizar um ambiente de insights da série de tempo Gen1
```powershell
...
Este comando atualiza um ambiente de insights da série de tempo Gen1.

### Exemplo 2: atualizar um ambiente de insights da série de tempo Gen1
```powershell
