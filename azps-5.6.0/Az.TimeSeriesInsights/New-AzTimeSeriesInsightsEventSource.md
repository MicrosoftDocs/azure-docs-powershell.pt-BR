...
### Exemplo 1: Criar uma fonte de eventos eventhub no ambiente especificado
```powershell
...
Esse comando cria uma fonte de eventos eventhub no ambiente especificado.
...
Este comando cria uma fonte de eventos iothub no ambiente especificado.

## PARÂMETROS

### -ConsumerGroupName
O nome do grupo de consumidores do hub de eventos/iot que contém as partições das quais os eventos serão lidos.
...
A id de recurso da fonte de eventos no Gerenciador de Recursos do Azure.
...
### -KeyName
O nome da chave SAS que concede ao serviço Insights de Série de Tempo acesso ao hub de eventos/iot.
...
### -ServiceBusNameSpace
O nome do barramento de serviço que contém o hub de eventos.
...
### -SharedAccessKey
O valor da chave de acesso compartilhado que concede ao serviço insights de série de tempo acesso de leitura ao hub de eventos/iot.
...
A propriedade event que será usada como o timestamp da fonte de eventos.
