...
### Exemplo 1: Atualizar uma fonte de eventos especificada pelo nome
```powershell
...
Este comando atualiza uma fonte de eventos específica.

### Exemplo 3: atualizar uma fonte de eventos especificada por objeto
```powershell
...
### -Tag
Pares de valores-chave de propriedades adicionais para a fonte de eventos.
