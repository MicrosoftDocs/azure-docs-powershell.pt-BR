...
Este comando adiciona um conjuntos de dados chamado AdsDataSet do contêiner de blob de tipo ao compartilhamento de dados do azure AdsShare.
...
### -AdlsGen1FolderPath
Caminho de pasta do ADLS gen1 de armazenamento do Azure
