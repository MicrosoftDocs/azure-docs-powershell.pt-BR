...
## DESCRIPTION
O cmdlet **Get-AzDataShareSynchronizationDetail** fornece detalhes da sincronização iniciada para um compartilhamento.
...
Este comando fornece informações sobre os detalhes de sincronização de todos os conjuntos de dados correspondentes à id de sincronização fornecida.
...
### -ResourceId
ID de recurso de compartilhamento de dados do Azure
...
### -SynchronizationId
ID de sincronização da sincronização de compartilhamento
