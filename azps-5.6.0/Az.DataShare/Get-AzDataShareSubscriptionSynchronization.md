...
## DESCRIPTION
O cmdlet **Get-AzDataShareSubscriptionSynchronization** fornece informações sobre todas as sincronizações executados em uma assinatura de compartilhamento em uma conta de compartilhamento de dados no consumidor.
...
Este comando fornece informações sobre todas as executações de sincronização para uma assinatura de compartilhamento AdsShareSubscription em conta de compartilhamento de dados WikiAds.
...
### -ResourceId
ID do recurso de assinatura de compartilhamento de dados do Azure
