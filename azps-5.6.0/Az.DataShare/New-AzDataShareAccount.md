...
## DESCRIPTION
O cmdlet **New-AzDataShareAccount** cria uma conta datashare no grupo de recursos especificado do Azure.
...
Cria uma conta chamada "WikiADS" no grupo de recursos "ADS"
...
### -ResourceGroupName
O nome do grupo de recursos da conta de compartilhamento de dados do azure será criado em.
...
### -Tag
As marcas a associar à conta de compartilhamento de dados do azure.
