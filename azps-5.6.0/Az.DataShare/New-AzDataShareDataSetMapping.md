...
## DESCRIPTION
O cmdlet **New-AzDataShareDataSetMapping** cria um mapeamento de conjunto de dados entre os conjuntos de dados de origem e a conta de armazenamento de pia na assinatura de compartilhamento.
...
Este comando cria um conjunto de dados mapeando AdsDataSetMapping para conta de armazenamento AdsStorage para assinatura de compartilhamento AdsShareSubscription na conta de compartilhamento de dados WikiAdsAccount.
