...
## DESCRIPTION
O cmdlet **Remove-AzDataShareDataSetMapping** remove um mapeamentos de conjuntos de dados.
...
Esses comandos removem o conjuntos de dados chamado DSM do WikiAds de compartilhamento. 
...
### -InputObject
O objeto de mapeamento do conjunto de dados do azure
