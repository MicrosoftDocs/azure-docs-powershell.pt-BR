...
Se você não especificar um nome, este cmdlet obterá informações sobre todos os compartilhamentos de dados em uma conta de compartilhamento de dados do Azure.
...
Este comando exibe informações sobre compartilhamento de dados AdsShare na conta de compartilhamento de dados do Azure WikiAdsAccount e ADS do grupo de recursos.
