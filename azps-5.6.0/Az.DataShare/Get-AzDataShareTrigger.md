...
## DESCRIPTION
O cmdlet **Get-AzDataShareTrigger** obtém informações sobre o gatilho para compartilhamento de assinatura em conta de compartilhamento de dados.
...
Este comando obtém informações sobre disparar AdsTrigger para compartilhar assinatura AdsShareSubscription em conta de compartilhamento de dados WikiAds.
