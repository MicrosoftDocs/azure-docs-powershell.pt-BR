...
## DESCRIPTION
O cmdlet **Get-AzDataShareAccount** obtém informações sobre contas daiáculas em um grupo de assinatura/recurso do Azure.
Se você especificar o nome de uma conta, esse cmdlet obterá informações sobre essa conta de datshare.
Se você não especificar um nome, este cmdlet obterá informações sobre todas as contas de datashare em um grupo de assinatura/recurso do Azure.
...
Este comando exibe informações sobre todas as contas de datashare na assinatura do Azure.
...
### -ResourceId
A id de recurso da conta de compartilhamento de dados do azure.
