...
Este comando fornece informações sobre sincronização ShareSynchronization habilitada no compartilhamento AdsShare em conta de compartilhamento de dados WikiAds.
...
### -ResourceId
A id de recurso da configuração de sincronização de compartilhamento de dados do azure
