...
## DESCRIPTION
O cmdlet **Remove-AzDataShareDataSet** remove um conjuntos de dados.
...
Esses comandos removem o conjuntos de dados chamado DS do compartilhamento wikiAds. 
...
### -InputObject
O objeto conjunto de dados do azure.
