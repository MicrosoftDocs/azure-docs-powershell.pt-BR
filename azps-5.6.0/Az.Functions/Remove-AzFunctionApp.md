...
### Exemplo 1: obter um aplicativo de função pelo nome e excluí-lo.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Remove-AzFunctionApp -Force
```

Este comando obtém um aplicativo de função pelo nome e o exclui.

### Exemplo 2: Excluir um aplicativo de função pelo nome.
```powershell
PS C:\> Remove-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName -Force
```

Este comando exclui um aplicativo de função por nome.
