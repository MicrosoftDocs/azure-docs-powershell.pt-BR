...
## SYNOPSIS
Obtém o local onde um aplicativo de função para o sistema operacional determinado e o tipo de plano está disponível.
...
Este comando obtém os locais onde Premium está disponível para Windows.
