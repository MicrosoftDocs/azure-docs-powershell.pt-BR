...
Este comando adiciona uma nova configuração de aplicativo em um aplicativo de função.

## PARÂMETROS

### -AppSetting
Hashtable com chaves e valores descrevem as configurações do aplicativo a serem adicionadas ou atualizadas no aplicativo de função.
