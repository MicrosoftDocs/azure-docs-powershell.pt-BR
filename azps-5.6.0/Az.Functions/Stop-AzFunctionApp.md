...
### Exemplo 1: Obter um aplicativo de função pelo nome e pará-lo.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Stop-AzFunctionApp -Force
```

Esse comando obtém um aplicativo de função pelo nome e o interrompe.

### Exemplo 2: Pare um aplicativo de função pelo nome.
```powershell
PS C:\> Stop-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName -Force
```

Este comando interrompe um aplicativo de função por nome.
...
### -Force
Força o cmdlet a interromper o aplicativo de função sem solicitar confirmação.
