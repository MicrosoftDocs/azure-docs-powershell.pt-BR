...
### Exemplo 1: Criar uma associação de provedor personalizada
```powershell
...
Criar uma associação de provedor personalizada, o provioder de destino associado deve ser configurado corretamente com uma rota para "associações"
