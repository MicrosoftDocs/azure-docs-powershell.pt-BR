...
### Exemplo 1: Remover uma associação de provedor personalizada.
```powershell
PS C:\> PS C:\> Remove-AzCustomProviderAssociation -Scope $id -Name Namespace.Type
```

Remova uma associação de provedor personalizada.

### Exemplo 2: Remover uma associação de provedor personalizada com o Piping
```powershell
...
Remova uma associação de provedor personalizada, usando a canalização e o recurso PassThru para indicar sucesso ou falha.
