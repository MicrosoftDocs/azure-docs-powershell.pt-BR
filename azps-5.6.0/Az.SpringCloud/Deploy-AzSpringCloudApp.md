...
### Exemplo 1: Implantar um jar compilado local para o serviço por nome.
```powershell
...
Implantar um jar compilado local para o serviço por nome.
...
### -JarPath
O caminho do jar precisa ser deplorável.
