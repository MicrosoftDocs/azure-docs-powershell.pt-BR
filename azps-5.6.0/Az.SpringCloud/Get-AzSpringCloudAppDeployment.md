...
### Exemplo 1: Obter Spring Cloud App Deploymeng pelo nome.
```powershell
...
Obter Spring Cloud App Deploymeng pelo nome.

### Exemplo 2: listar toda a implantação em um determinado aplicativo de nuvem de mola.
```powershell
...
Listar toda a implantação em um determinado aplicativo de nuvem de primavera.
