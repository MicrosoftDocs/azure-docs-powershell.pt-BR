...
### Exemplo 1: Atualizar a Implantação da Nuvem de Primavera pelo nome.
```powershell
...
Atualizar a Implantação da Nuvem de Primavera pelo nome.

### Exemplo 2: Atualizar a Implantação de Nuvem de Primavera a partir do pipe.
```powershell
...
Atualizar a Implantação de Nuvem de Primavera do pipe.
...
### -SourceArtifactSelector
Seletor para o artefato a ser usado para a implantação para projetos de vários módulos.
