...
### Exemplo 1: Iniciar o Serviço de Nuvem de Primavera pelo nome.
```powershell
PS C:\> Start-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default
```

Inicie o Serviço de Nuvem de Primavera pelo nome.

### Exemplo 2: Iniciar o Serviço de Nuvem de Mola a partir do pipe.
```powershell
PS C:\> Get-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default | Start-AzSpringCloud
```

Inicie o Serviço de Nuvem de Mola a partir do pipe.
