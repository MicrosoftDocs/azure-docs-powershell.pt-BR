...
### Exemplo 1: Remover a Implantação de Nuvem de Mola pelo nome.
```powershell
PS C:\> Remove-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default
```

Remova a Implantação da Nuvem de Primavera pelo nome.

### Exemplo 2: Remover a Implantação de Nuvem de Mola do pipe.
```powershell
PS C:\> Get-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default | Remove-AzSpringCloudAppDeployment
```

Remover a Implantação de Nuvem de Mola do pipe.
