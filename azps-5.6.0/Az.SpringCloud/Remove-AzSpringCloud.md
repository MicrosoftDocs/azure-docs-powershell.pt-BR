...
### Exemplo 1: Remover o Serviço de Nuvem de Mola pelo nome.
```powershell
PS C:\> Remove-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service
```

Remova o Spring Cloud Service pelo nome.

### Exemplo 2: Remover o Serviço de Nuvem de Mola do pipe.
```powershell
PS C:\> Get-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service | Remove-AzSpringCloud
```

Remover o Serviço de Nuvem de Mola do pipe.
