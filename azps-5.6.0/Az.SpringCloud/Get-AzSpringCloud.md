...
### Exemplo 1: obter o nome do Serviço de Nuvem da Primavera
```powershell
...
Obter o nome do Serviço de Nuvem de Primavera

### Exemplo 2: listar todo o serviço de nuvem de mola no grupo de recursos.
```powershell
...
Listar todo o serviço de nuvem de primavera no grupo de recursos.
