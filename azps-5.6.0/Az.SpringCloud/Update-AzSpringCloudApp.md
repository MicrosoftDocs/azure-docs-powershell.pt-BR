...
### Exemplo 1: Atualizar o Spring Cloud App pelo nome.
```powershell
...
Atualizar o Spring Cloud App pelo nome.

### Exemplo 2: Atualizar o Aplicativo de Nuvem de Primavera a partir do pipe.
```powershell
...
Atualize o Aplicativo de Nuvem de Primavera do pipe.
...
### -Location
O local GEO do aplicativo, sempre o mesmo com seu recurso pai
