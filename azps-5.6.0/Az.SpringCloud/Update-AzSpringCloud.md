...
### Exemplo 1: Atualizar o Serviço de Nuvem de Primavera pelo nome.
```powershell
...
Atualizar o Serviço de Nuvem de Primavera pelo nome.

### Exemplo 2: Atualizar o Serviço de Nuvem de Mola do pipe.
```powershell
...
Atualizar o Serviço de Nuvem de Mola do pipe.
...
### -TraceAppInsightInstrumentationKey
Chave de instrumentação de visão do aplicativo de destino
...
### -TraceEnabled
Indica se habilitar a funcionalidade de rastreamento
