...
Este comando testa uma implantação no escopo de assinatura atual usando o arquivo de modelo determinado e o arquivo de parâmetros.
...
Este comando testa uma implantação no escopo de assinatura atual usando uma hashtable na memória criada a partir do arquivo de modelo determinado e de um arquivo de parâmetro.
