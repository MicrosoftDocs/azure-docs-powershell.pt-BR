...
## DESCRIPTION
Atualiza um usuário existente do Active Directory (conta de trabalho/escola também popularmente conhecida como org-id).
...
Obtém o usuário com a id do objeto '155a5c10-93a9-4941-a0df-96d83ab5ab24' e canaliza isso para o cmdlet Update-AzADUser para atualizar o nome de exibição desse usuário para 'MyNewDisplayName'.
...
### -EnableAccount
true para habilenciar a conta; caso contrário, false.
