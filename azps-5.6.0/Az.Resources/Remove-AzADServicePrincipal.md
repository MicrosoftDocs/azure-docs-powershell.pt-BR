...
### Exemplo 4 - Remover uma entidade de serviço canalização

```
PS C:\> Get-AzADServicePrincipal -ObjectId 61b5d8ea-fdc6-40a2-8d5b-ad447c678d45 | Remove-AzADServicePrincipal
```

Obtém a entidade de serviço com a id do objeto '61b5d8ea-fdc6-40a2-8d5b-ad447c678d45' e canalização para o cmdlet Remove-AzADServicePrincipal para remover essa entidade de serviço.

### Exemplo 5 - Remover uma entidade de serviço canalização de um aplicativo

```
PS C:\> Get-AzApplication -ApplicationId 9263469e-d328-4321-8646-3e3e75d20e76 | Remove-AzADServicePrincipal
```

Obtém o aplicativo com a id do aplicativo '9263469e-d328-4321-8646-3e3e75d20e76' e canalizará isso para o cmdlet Remove-AzADServicePrincipal para remover a entidade de serviço associada a esse aplicativo.
...
### -ApplicationObject
O objeto application cuja entidade de serviço está sendo removida.
