...
## DESCRIPTION
Use o Get-AzRoleDefinition com um nome de função específico para exibir seus detalhes.
Para inspecionar operações individuais às que uma função concede acesso, examine as propriedades Actions e NotActions da função.
...
Obter a definição de função Leitor
...
Por exemplo, Leitor, Colaborador, Colaborador de Máquina Virtual.
