...
## DESCRIPTION
O New-AzADSpCredential cmdlet pode ser usado para adicionar uma nova credencial ou rolar credenciais para uma entidade de serviço.
A entidade de serviço é identificada fornecendo o ID do objeto ou o nome principal do serviço.
...
Obtém a entidade de serviço com a id do objeto '1f99cf81-0146-4f4e-beae-2007d0668476' e canalizará isso para o New-AzADSpCredential para criar uma nova credencial de entidade de serviço para essa entidade de serviço com uma senha gerada.
...
Para uma credencial de tipo "assimétrica", ela deve ser definida como em ou após a data da qual o certificado X509 é válido.
