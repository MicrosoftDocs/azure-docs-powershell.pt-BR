...
## DESCRIPTION
Use o New-AzRoleAssignment para modificar uma atribuição existente.  
Descrições podem ser qualquer cadeia de caracteres válida, use-a para diferentar umas das outras.  
se Condição for definida A Versão da Condição também deve ser definida, mas se você estiver atualizando uma Condição que não é necessária.
A versão de condição pode ser atualizada de 1,0 para 2.0, mas não pode ser rebaixada novamente. Seja cauteloso, pois 2.0 não é retrocompatível com 1.0.
