...
## SYNOPSIS
Cria uma marca predefinida do Azure ou adiciona valores a uma marca | Cria ou atualiza todo o conjunto de marcas em um recurso ou assinatura.
...
Você também pode usá-lo para adicionar valores adicionais a marcas predefinida existentes.
...
Este cmdlet retorna um objeto que representa a marca nova ou modificada com seus valores e o número de recursos aos quais foi aplicado.
...
Para pesquisar grupos de recursos com um nome ou nome de marca especificado e um valor, use o parâmetro *Tag* do cmdlet Get-AzResourceGroup.
Cada marca tem um nome.
Os valores são opcionais.
Uma marca predefinida do Azure pode ter vários valores, mas quando você aplica a marca a um grupo de recursos ou recursos, você aplica o nome da marca e apenas um de seus valores.
...
Quando você aplica a marca Department a um recurso, você aplica apenas um valor predefinido, como Finanças.
...
Este comando cria uma marca predefinida chamada FY2015.
Essa marca não tem valores.
Você pode aplicar uma marca sem valores a um grupo de recursos ou recursos ou usar **New-AzTag** para adicionar valores à marca.
...
Este comando cria uma marca predefinida chamada Department com um valor de Finanças.
...
Se o nome da marca existir, **New-AzTag** adiciona o valor à marca existente em vez de criar um novo.
...
Este comando cria ou atualiza todo o conjunto de marcas na assinatura com {subId}.
...
Este comando cria ou atualiza todo o conjunto de marcas no recurso com {resourceId}.
...
Se uma marca predefinida existente tiver o nome especificado, **New-AzTag** adiciona o valor especificado, se for o caso, à marca com esse nome em vez de criar uma nova marca.
...
### -Tag
As marcas a ser colocadas no recurso.
