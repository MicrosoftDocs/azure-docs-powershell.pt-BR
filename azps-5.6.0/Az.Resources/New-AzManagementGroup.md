...
Criação de um novo grupo com `DisplayName` e `ParentId` definido como `null` . O `DisplayName` será igual ao e o pai do grupo será o `GroupName` locatário.  

### Exemplo 2: Criar um Grupo de Gerenciamento com um nome de exibição
```
...
Nesse caso, o pai do grupo será o locatário e o `DisplayName` será definido como o valor dado.

### Exemplo 3: Criar um Grupo de Gerenciamento com um pai e um nome de exibição
```
