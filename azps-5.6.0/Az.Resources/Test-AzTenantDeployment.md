...
## DESCRIPTION
O cmdlet **Test-AzTenantDeployment** determina se um modelo de implantação e seus valores de parâmetro são válidos no escopo de locatário atual.
...
Este comando testa uma implantação no escopo de locatário atual usando o arquivo de modelo determinado e o arquivo de parâmetros.
...
Este comando testa uma implantação no escopo de locatário atual usando uma hashtable na memória criada a partir do arquivo de modelo determinado e de um arquivo de parâmetro.
