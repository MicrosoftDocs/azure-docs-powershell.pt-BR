...
Este comando cancela uma implantação em execução "deployment01" no grupo de gerenciamento "myMG".
...
Este comando obtém a implantação "deployment01" no grupo de gerenciamento "myMG" e o cancela. 
