...
## DESCRIPTION
O cmdlet **Set-AzResource** modifica um recurso do Azure existente.
...
O primeiro comando obtém o recurso chamado ContosoSite usando o cmdlet Get-AzResource e o armazena na variável $Resource.
...
O primeiro comando obtém os recursos no grupo de recursos testrg e os armazena na variável $Resource.
...
### -Properties
Especifica propriedades de recurso para o recurso.
...
### -UsePatchSemantics
Indica que esse cmdlet usa um PATCH HTTP para atualizar o objeto, em vez de um PUT HTTP.
