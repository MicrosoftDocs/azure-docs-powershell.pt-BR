...
## DESCRIPTION
O cmdlet **New-AzResource** cria um recurso do Azure, como um site, um servidor de banco de dados do Azure SQL ou o banco de dados do Azure SQL, em um grupo de recursos.
...
Este comando cria um recurso que é um site no ResourceGroup11.
...
### -ApiVersion
Especifica a versão da API do provedor de recursos a ser usada. Se você não especificar uma versão, este cmdlet usará a versão mais recente disponível.
...
### -IsFullObject
Indica que o objeto especificado pelo *parâmetro Properties* é o objeto completo.
...
Especifique o local do data center, como o Centro dos EUA ou o Sudeste Asiático.
...
### -ODataQuery
Especifica um filtro de estilo OData (Protocolo de Dados Abertos). Este cmdlet anexa esse valor à solicitação, além de quaisquer outros filtros.
...
### -Plan
Uma tabela de hash que representa propriedades do plano de recursos.
...
### -Properties
Especifica propriedades de recurso para o recurso. Use este parâmetro para especificar os valores das propriedades específicas de um tipo de recurso.
...
### -Sku
Uma tabela de hash que representa propriedades sku.
