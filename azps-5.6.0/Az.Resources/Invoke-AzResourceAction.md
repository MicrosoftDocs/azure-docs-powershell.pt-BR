...
Para obter uma lista de ações com suporte, use a ferramenta Explorador de Recursos do Azure.

## EXEMPLOS

### Exemplo 1: Invocar iniciando uma VM com ResourceId
...
Este comando inicia a Máquina Virtual com {ResourceId}.

### Exemplo 2: Invocar o poweroffing de uma VM com ResourceName
...
Este comando interrompe a Máquina Virtual com {ResourceId}.
...
### -Parameters
Especifica parâmetros, como uma tabela de hash, para a ação que esse cmdlet invoca.
...
### -ResourceId
Especifica a ID de recurso totalmente qualificada do recurso no qual esse cmdlet invoca uma ação.
