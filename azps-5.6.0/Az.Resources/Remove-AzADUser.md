...
## DESCRIPTION
Exclui um usuário do Active Directory (conta de trabalho/escola também popularmente conhecida como org-id).
...
Remove o usuário com o nome principal do usuário " foo@domain.com " do locatário.
...
### Exemplo 3: Remover um usuário canalização

```powershell
PS C:\> Get-AzADUser -ObjectId 7a9582cf-88c4-4319-842b-7a5d60967a69 | Remove-AzADUser
```

Obtém o usuário com a id do objeto '7a9582cf-88c4-4319-842b-7a5d60967a69' e canalização para o cmdlet Remove-AzADUser para remover o usuário do locatário.
