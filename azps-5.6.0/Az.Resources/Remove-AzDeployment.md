...
## DESCRIPTION
O cmdlet **Remove-AzDeployment** remove uma implantação do Azure no escopo da assinatura e em qualquer operação associada.
...
Este comando remove a implantação "RolesDeployment" no escopo de assinatura atual.
...
Este comando obtém a implantação "RolesDeployment" no escopo de assinatura atual e o remove.
