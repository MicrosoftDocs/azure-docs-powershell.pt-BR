...
### Exemplo 3: Atualizar um Grupo de Gerenciamento canalização do objeto PSManagementGroup
```
...
### Exemplo 4: atualizar o pai de um grupo de gerenciamento usando o Objeto ParentObject
```
