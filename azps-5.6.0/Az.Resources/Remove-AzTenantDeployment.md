...
## DESCRIPTION
O cmdlet **Remove-AzTenantDeployment** remove uma implantação do Azure no escopo do locatário atual e em qualquer operação associada.
...
Este comando remove a implantação "RolesDeployment" no escopo de locatário atual.
...
Este comando obtém a implantação "RolesDeployment" no escopo de locatário atual e o remove.
