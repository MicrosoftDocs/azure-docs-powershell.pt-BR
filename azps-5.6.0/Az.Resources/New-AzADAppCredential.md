...
## DESCRIPTION
O New-AzADAppCredential cmdlet pode ser usado para adicionar uma nova credencial ou rolar credenciais para um aplicativo.
O aplicativo é identificado fornecendo a ID do objeto de aplicativo ou a ID do aplicativo.
...
O certificado X509 público codificado em base64 fornecido ("myapp.cer") é adicionado ao aplicativo existente com id de aplicativo '4589cd6b-3d79-4bb4-93b8-a0b99f3bfc58'.
...
Obtém o aplicativo com a id do objeto '1f89cf81-0146-4f4e-beae-2007d0668416' e canalizará isso para o New-AzADAppCredential para criar uma nova credencial de aplicativo para esse aplicativo com a senha determinada.
...
### -ApplicationObject
O objeto application para adicionar as credenciais.
...
### -CertValue
O valor do tipo de credencial "assimétrico". Ele representa o certificado codificado base 64.
...
### -EndDate
A data de término efetiva do uso da credencial. O valor de data de término padrão é de um ano a partir de hoje.  Para uma credencial de tipo "assimétrica", ela deve ser definida como em ou antes da data em que o certificado X509 é válido.
