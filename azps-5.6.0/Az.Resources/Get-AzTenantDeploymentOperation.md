...
## DESCRIPTION
O cmdlet **Get-AzTenantDeploymentOperation** lista todas as operações que foram parte da implantação no escopo de locatário atual para ajudá-lo a identificar e dar mais informações sobre as operações exatas que falharam em uma implantação específica.
...
Obtém operações de implantação com o nome "Deploy01" no escopo de locatário atual.
...
Este comando obtém a implantação "Deploy01" no escopo de locatário atual e obtém suas operações de implantação.
