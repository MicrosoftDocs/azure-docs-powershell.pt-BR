...
## DESCRIPTION
O cmdlet **New-AzDeployment** adiciona uma implantação no escopo de assinatura atual.
...
Este comando cria uma nova implantação no escopo de assinatura atual usando um modelo personalizado e um arquivo de modelo em disco, com parâmetro de marcas definidas.
...
Este comando cria uma nova implantação no escopo de assinatura atual usando um modelo personalizado e um arquivo de modelo em disco que foi convertido em uma hashtable na memória.
