...
O cmdlet solicita a confirmação e não retorna nenhuma saída.
...
Este comando usa o cmdlet Get-AzResourceGroup para obter o grupo de recursos ContosoRG01 e, em seguida, passa-o para **Remove-AzResourceGroup** usando o operador de pipeline. O *parâmetro Force* suprime o prompt de confirmação.
...
Este comando usa o cmdlet **Get-AzResourceGroup** para obter todos os grupos de recursos e, em seguida, os passa para **Remove-AzResourceGroup** usando o operador de pipeline.
...
### -Name
Especifica os nomes dos grupos de recursos a ser removidos.
Caracteres curinga não são permitidos.
