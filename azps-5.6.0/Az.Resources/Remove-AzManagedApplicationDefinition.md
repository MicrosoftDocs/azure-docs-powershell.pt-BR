...
O primeiro comando obtém uma definição de aplicativo gerenciado chamada myAppDef usando Get-AzManagedApplicationDefinition cmdlet.
O comando armazena-o na variável $ApplicationDefinition.
