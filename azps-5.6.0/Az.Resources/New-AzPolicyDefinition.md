...
Este comando cria uma definição de política chamada LocationDefinition que contém a regra de política especificada em C:\LocationPolicy.json. O conteúdo de exemplo para o arquivo LocationPolicy.json é fornecido acima.
...
Este comando cria uma definição de política chamada TagsPolicyDefinition com o modo "Indexado" indicando que a política deve ser avaliada apenas para tipos de recursos que suportam marcas e localização.
