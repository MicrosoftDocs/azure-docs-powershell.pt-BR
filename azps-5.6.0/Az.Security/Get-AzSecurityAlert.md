...
ms.locfileid: "101888804"
---
# <span data-ttu-id="1ffc5-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="1ffc5-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="1ffc5-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="1ffc5-102">SYNOPSIS</span></span>
<span data-ttu-id="1ffc5-103">Obtém alertas de segurança detectados pelo Centro de Segurança do Azure</span><span class="sxs-lookup"><span data-stu-id="1ffc5-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="1ffc5-104">SINTAXE</span><span class="sxs-lookup"><span data-stu-id="1ffc5-104">SYNTAX</span></span>

### <span data-ttu-id="1ffc5-105">SubscriptionScope (Padrão)</span><span class="sxs-lookup"><span data-stu-id="1ffc5-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="1ffc5-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="1ffc5-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="1ffc5-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="1ffc5-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="1ffc5-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="1ffc5-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="1ffc5-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="1ffc5-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="1ffc5-110">DESCRIPTION</span><span class="sxs-lookup"><span data-stu-id="1ffc5-110">DESCRIPTION</span></span>
<span data-ttu-id="1ffc5-111">Obtém alertas de segurança detectados pelo Centro de Segurança do Azure</span><span class="sxs-lookup"><span data-stu-id="1ffc5-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="1ffc5-112">EXEMPLOS</span><span class="sxs-lookup"><span data-stu-id="1ffc5-112">EXAMPLES</span></span>

### <span data-ttu-id="1ffc5-113">Exemplo 1</span><span class="sxs-lookup"><span data-stu-id="1ffc5-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="1ffc5-114">Obtém todos os alertas de segurança detectados em recursos dentro de uma assinatura</span><span class="sxs-lookup"><span data-stu-id="1ffc5-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="1ffc5-115">Exemplo 2</span><span class="sxs-lookup"><span data-stu-id="1ffc5-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="1ffc5-116">Obtém todos os alertas de segurança detectados em recursos dentro do grupo de recursos "myService1"</span><span class="sxs-lookup"><span data-stu-id="1ffc5-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="1ffc5-117">Exemplo 3</span><span class="sxs-lookup"><span data-stu-id="1ffc5-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="1ffc5-118">Obtém um alerta de segurança específico que foi detectado em recursos dentro do grupo de recursos "myService1"</span><span class="sxs-lookup"><span data-stu-id="1ffc5-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="1ffc5-119">PARÂMETROS</span><span class="sxs-lookup"><span data-stu-id="1ffc5-119">PARAMETERS</span></span>

### <span data-ttu-id="1ffc5-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="1ffc5-120">-DefaultProfile</span></span>
<span data-ttu-id="1ffc5-121">As credenciais, conta, locatário e assinatura usadas para comunicação com o Azure.</span><span class="sxs-lookup"><span data-stu-id="1ffc5-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="1ffc5-122">-Location</span><span class="sxs-lookup"><span data-stu-id="1ffc5-122">-Location</span></span>
<span data-ttu-id="1ffc5-123">Local.</span><span class="sxs-lookup"><span data-stu-id="1ffc5-123">Location.</span></span>
...
### <span data-ttu-id="1ffc5-124">-Name</span><span class="sxs-lookup"><span data-stu-id="1ffc5-124">-Name</span></span>
<span data-ttu-id="1ffc5-125">Nome do recurso.</span><span class="sxs-lookup"><span data-stu-id="1ffc5-125">Resource name.</span></span>
...
### <span data-ttu-id="1ffc5-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="1ffc5-126">-ResourceGroupName</span></span>
<span data-ttu-id="1ffc5-127">Nome do grupo de recursos.</span><span class="sxs-lookup"><span data-stu-id="1ffc5-127">Resource group name.</span></span>
...
### <span data-ttu-id="1ffc5-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="1ffc5-128">-ResourceId</span></span>
<span data-ttu-id="1ffc5-129">ID do recurso.</span><span class="sxs-lookup"><span data-stu-id="1ffc5-129">Resource ID.</span></span>
...
### <span data-ttu-id="1ffc5-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="1ffc5-130">CommonParameters</span></span>
<span data-ttu-id="1ffc5-131">Este cmdlet dá suporte aos parâmetros comuns: -Depurar, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction e -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="1ffc5-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="1ffc5-132">Para obter mais informações, [consulte about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="1ffc5-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="1ffc5-133">INPUTS</span><span class="sxs-lookup"><span data-stu-id="1ffc5-133">INPUTS</span></span>

### <span data-ttu-id="1ffc5-134">System.String</span><span class="sxs-lookup"><span data-stu-id="1ffc5-134">System.String</span></span>

## <span data-ttu-id="1ffc5-135">SAÍDAS</span><span class="sxs-lookup"><span data-stu-id="1ffc5-135">OUTPUTS</span></span>

### <span data-ttu-id="1ffc5-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="1ffc5-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="1ffc5-137">NOTES</span><span class="sxs-lookup"><span data-stu-id="1ffc5-137">NOTES</span></span>

## <span data-ttu-id="1ffc5-138">LINKS RELACIONADOS</span><span class="sxs-lookup"><span data-stu-id="1ffc5-138">RELATED LINKS</span></span>
