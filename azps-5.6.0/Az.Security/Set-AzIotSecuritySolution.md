...
## SYNOPSIS
Criar ou atualizar a solução de segurança da IoT
...
## DESCRIPTION
O Set-AzIotSecuritySolution cmdlet cria ou atualiza uma solução de segurança iot específica. A solução de segurança da IoT coleta dados e eventos de segurança de dispositivos iot e hub iot para ajudar a evitar e detectar ameaças.
O nome da solução de segurança iot deve ser idêntico ao nome do hub de iot.
...
Criar nova solução de segurança iot "MySample" para hub IoT com id de recurso "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MichalResourceGroup/providers/Microsoft.Devices/IotHubs/MySample" (o nome da solução deve ser idêntico ao nome do hub IoT)
...
Status de registro em log ip não máscarado.
