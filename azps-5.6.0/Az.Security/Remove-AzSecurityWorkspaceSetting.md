...
## SYNOPSIS
Exclui a configuração de espaço de trabalho de segurança para essa assinatura.
...
## DESCRIPTION
Exclui a configuração de espaço de trabalho de segurança para essa assinatura.
Essa ação fará com que os agentes de segurança recém-instalados reportem ao espaço de trabalho padrão dessa assinatura.
