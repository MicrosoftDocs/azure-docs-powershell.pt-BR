...
## DESCRIPTION
O Get-AzIotSecuritySolution cmdlet retorna uma ou mais soluções de segurança iot. A solução de segurança da IoT coleta dados e eventos de segurança de dispositivos iot e hub iot para ajudar a evitar e detectar ameaças.
...
Obter lista de todas as soluções de segurança no grupo de recursos "MyResourceGroup"
