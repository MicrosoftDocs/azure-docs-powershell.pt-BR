...
Este comando desabilita a política avançada de proteção contra ameaças para id de `"/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.Storage/storageAccounts/myStorageAccount/"` recurso.

### Exemplo 2 : Conta do CosmosDB
```powershell
...
Este comando desabilita a política avançada de proteção contra ameaças para id de ` "/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.DocumentDb/databaseAccounts/myCosmosDBAccount/"` recurso.
