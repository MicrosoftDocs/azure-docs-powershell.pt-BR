...
## DESCRIPTION
O Set-AzDeviceSecurityGroup cmdlet cria ou atualiza um grupo de segurança de dispositivo definido na solução de segurança iot.
...
Atualizar o grupo de segurança de dispositivo existente do Hub IoT "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub" com o tipo de regra "ActiveConnectionsNotInAllowedRange"
