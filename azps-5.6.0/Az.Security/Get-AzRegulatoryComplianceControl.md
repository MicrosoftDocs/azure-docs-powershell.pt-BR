...
## DESCRIPTION
Obter detalhes de controle spcific ou listar todos os controles sob o padrão de conformidade regulamentar específico.
...
Obter todos os controles sob um padrão regulatório específico.
