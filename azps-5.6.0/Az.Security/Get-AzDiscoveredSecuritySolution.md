...
## SYNOPSIS
Obtém soluções de segurança descobertas pelo Centro de Segurança do Azure
...
## DESCRIPTION
Soluções de segurança são descobertas automaticamente pelo Centro de Segurança do Azure, use este cmdlet para exibir as soluções de segurança descobertas
