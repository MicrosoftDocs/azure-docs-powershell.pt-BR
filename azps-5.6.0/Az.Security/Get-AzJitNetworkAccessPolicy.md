...
## DESCRIPTION
As políticas de acesso à rede Just In Time (JIT) permitem definir uma política que permitirá que usuários simples criem uma conexão de rede temporária com uma VM.
...
Obter todas as polícias de acesso à rede JIT em uma assinatura
...
Obter todas as polícias de acesso à rede JIT no grupo de recursos "myService1"
...
Obtém uma política de acesso de rede JIT específica
...
### -ResourceId
A id de recurso do recurso jit Network Access Policy.
