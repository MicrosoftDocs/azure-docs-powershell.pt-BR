...
## DESCRIPTION
Exclui metadados de avaliação de segurança de uma assinatura. Essa ação excluirá o tipo de avaliação e todos os resultados de avaliação relevantes da assinatura.
