...
## SYNOPSIS
Define a política de proteção de informações SQL locatário efetivo.

## SINTAXE

### SQL Política de Proteção de Informações (Padrão)
```
Set-AzSqlInformationProtectionPolicy -Policy <String> [-AsJob] [-DefaultProfile <IAzureContextContainer>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SQL caminho do arquivo de política de proteção de informações
```
...
### -FilePath
Especifica um caminho de um arquivo .json que contém SQL de Política de Proteção de Informações.
...
### -Policy
Especifica uma definição SQL política de proteção de informações. Você pode especificar um caminho de um arquivo .json ou uma cadeia de caracteres de formato JSON que define a política.
