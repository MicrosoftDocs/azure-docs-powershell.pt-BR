...
Este cmdlet cria autorização `azps-test-auth` em nuvem privada `azps-test-cloud`
...
### -Name
Nome da Autorização de Circuito Expresso na nuvem privada
