...
### -AcceptEULA
Aceitar a EULA do AVS, o termo legal será pop-up sem esse parâmetro fornecido
...
Certifique-se de que o formato CIDR está conformed com (A.B.C.D/X) onde A,B,C,D estão entre 0 e 255 e X está entre 0 e 22
...
### -VcenterPassword
Opcionalmente, de definir a senha de administrador do vCenter quando a nuvem privada for criada
