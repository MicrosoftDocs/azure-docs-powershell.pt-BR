...
### Exemplo 1 Obter Chaves de Api para um recurso de insights de aplicativo
```
...
Obter chaves de api de insights de aplicativo para o recurso "test" no grupo de recursos "testGroup".

### Exemplo 2 Obter chave de API específica para um recurso de insights de aplicativo
```
...
Obter uma chave de api de insights de aplicativo específica que id é "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" para o recurso "test" no grupo de recursos "testGroup".

## PARÂMETROS

### -ApiKeyId
Id da Chave da Api do Application Insights.
