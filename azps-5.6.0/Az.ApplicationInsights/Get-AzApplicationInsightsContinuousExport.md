...
### Exemplo 1 Obter exportação contínua para um recurso de insights de aplicativo
```
...
Obter configurações de exportação contínuas de insights do aplicativo para o recurso chamado "test" no grupo de recursos "testgroup"
...
Obter informações do aplicativo configuração de exportação contínua com id de exportação "ZJrfffySPdtG3ESn3iRxVIEFuNY=" para o recurso chamado "test" no grupo de recursos "testgroup"
