...
### Exemplo 1 Criar um novo recurso de insights de aplicativo
```
...
Adicionar um novo recurso de insights de aplicativo chamado "test" no grupo de recursos "testgroup" com o tipo "java"
...
### -Location
Local do recurso Application Insights.
...
O tipo de acesso à rede para acessar a ingestão do Application Insights. O valor deve ser 'Habilitado' ou 'Desabilitado'
...
O tipo de acesso à rede para acessar a consulta Application Insights. O valor deve ser 'Habilitado' ou 'Desabilitado'
