...
## DESCRIPTION
Obter recursos de insights de aplicativos em um grupo de recursos ou recurso específico

## EXEMPLOS

### Exemplo 1 Obter recurso de insights de aplicativo
```
...
Obter recurso de insights de aplicativo chamado "test" no grupo de recursos "testgroup"

### Exemplo 2 Obter recurso de insights de aplicativo com informações do plano de preços
```
...
Obter o recurso de insights do aplicativo e incluir informações do plano de preços para o recurso chamado "test" no grupo de recursos "testgroup"
...
### -Full
Se especificado, ele receberá de volta o plano de preços/limite diário e o status do componente de percepções do aplicativo.
