...
## DESCRIPTION
O cmdlet **Update-AzDataLakeGen2AclRecursive** atualiza a ACL recursivamente no caminho especificado. A ACL de entrada mescla a entrada ACL original: se a entrada ACL com o mesmo AccessControlType/EntityId/DefaultScope existir, atualize a permissão; adicione uma nova entrada ACL.

## EXEMPLOS

### Exemplo 1: atualizar a ACL recursivamente em uma directiria raiz do sistema de arquivos
```
...
Este comando primeiro cria um objeto ACL com 3 entradas acl e atualiza recursivamente a ACL em um diretório raiz de um sistema de arquivos.

### Exemplo 2: atualizar a ACL recursivamente em um diretório e retomar da falha com ContinuationToken
```
...
Este comando primeiro atualiza a ACL recursivamente para um diretório e falha e, em seguida, retoma com ContinuationToken após o usuário corrigir o arquivo com falha.

### Exemplo 3: Atualizar a ACL recursivamente, parte por parte
```
...
Este script atualizará a ACL rescursivamente em parte de diretório por parte, com tamanho de parte como BatchSize * MaxBatchCount. O tamanho da parte é 5000 neste script.

### Exemplo 4: atualizar a ACL recursivamente em um diretório e ContinuarOnFailure e, em seguida, retomar de falhas uma a uma
```
...
Este comando primeiro atualiza a ACL recursivamente para um diretório com ContinueOnFailure e alguns itens falharam e, em seguida, retomam os itens com falha um por um.
