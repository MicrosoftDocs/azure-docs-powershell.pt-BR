...
Este comando modifica os metadados de um contêiner de blob de armazenamento e o acesso público com o nome da conta de armazenamento e o nome do contêiner.

### Exemplo 2: Desabilitar o acesso público em um contêiner de blob de armazenamento com o objeto de conta de armazenamento e o nome do contêiner
```
...
Este comando desabilita o acesso público em um contêiner de blob de armazenamento com o objeto de conta de armazenamento e o nome do contêiner.
...
Este comando definiu o acesso público como Blob para todos os contêineres de blob de armazenamento em uma conta de armazenamento com pipeline.
