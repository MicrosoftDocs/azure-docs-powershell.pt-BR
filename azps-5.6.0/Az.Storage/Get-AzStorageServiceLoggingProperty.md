...
## SYNOPSIS
Obtém propriedades de registro em log para serviços de Armazenamento do Azure.
...
## DESCRIPTION
O cmdlet **Get-AzStorageServiceLoggingProperty** obtém propriedades de registro em log para os serviços de Armazenamento do Azure.

## EXEMPLOS

### Exemplo 1: obter propriedades de registro em log para o serviço Blob
```
C:\PS>Get-AzStorageServiceLoggingProperty -ServiceType Blob
```

Este comando obtém propriedades de registro em log para armazenamento de blob.
