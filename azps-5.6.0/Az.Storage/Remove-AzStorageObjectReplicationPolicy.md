...
Este comando remove uma política de replicação de objeto com policyId específica de uma conta de armazenamento.
...
### -InputObject
Objeto Política de Replicação de Objeto a ser excluído.
