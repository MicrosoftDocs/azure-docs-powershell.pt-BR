...
Este comando gera um token SAS com permissões completas para a tabela chamada ContosoResources.
...
Este comando gera e token SAS com permissões completas para a tabela chamada ContosoResources.
O comando limita o token ao intervalo especificado pelos *parâmetros StartPartitionKey* e *EndPartitionKey.*
...
### -EndPartitionKey
Especifica a chave de partição do final do intervalo para o token que este cmdlet cria.
...
### -EndRowKey
Especifica a chave de linha para o final do intervalo para o token que este cmdlet cria.
...
### -FullUri
Indica que esse cmdlet retorna o URI de fila completa com o token SAS.
...
Este cmdlet cria um token SAS para a tabela especificada por esse parâmetro.
...
### -Policy
Especifica uma política de acesso armazenada, que inclui as permissões para esse token SAS.
...
### -StartPartitionKey
Especifica a chave de partição do início do intervalo para o token que este cmdlet cria.
