...
### Exemplo 1: Baixar um arquivo sem prompt
```
...
Este comando baixa um arquivo para um arquivo local sem prompt.
...
### -InputObject
Objeto de item do Azure Datalake Gen2 a ser baixado.
