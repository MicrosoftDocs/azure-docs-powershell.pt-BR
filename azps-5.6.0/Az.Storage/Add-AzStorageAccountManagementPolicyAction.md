...
## SYNOPSIS
Adiciona uma ação ao objeto ManagementPolicy Action Group de entrada ou cria um objeto ManagementPolicy Action Group com a ação. O objeto pode ser usado em New-AzStorageAccountManagementPolicyRule.
...
## DESCRIPTION
O cmdlet **Add-AzStorageAccountManagementPolicyAction** adiciona uma ação ao objeto ManagementPolicy Action Group de entrada ou cria um objeto ManagementPolicy Action Group com a ação.

## EXEMPLOS

### Exemplo 1: cria um objeto ManagementPolicy Action Group com 4 ações, adicione-o a uma regra de política de gerenciamento e desmarcar uma conta de armazenamento
```
...
O primeiro comando cria um objeto ManagementPolicy Action Group, os três comandos a seguir adicionam 3 ações ao objeto. Em seguida, adicione-a a uma regra de política de gerenciamento e desmarcar uma conta de Armazenamento.

### Exemplo 2: cria um objeto ManagementPolicy Action Group com 6 ações na versão de instantâneo e blob, em seguida, adicione-a a uma regra de política de gerenciamento e desmarcar uma conta de armazenamento
```
...
O primeiro comando cria um objeto ManagementPolicy Action Group, os 5 comandos a seguir adicionam 5 ações em instantâneo e versão de blob ao objeto. Em seguida, adicione-a a uma regra de política de gerenciamento e desmarcar uma conta de Armazenamento.

## PARÂMETROS

### -BaseBlobAction
A ação de política de gerenciamento para baseblob.
...
### -BlobVersionAction
A ação de política de gerenciamento para a versão de blob.
...
### -InputObject
Se o objeto ManagementPolicy Action for de entrada, definirá a ação como o objeto de ação de entrada.
Se não for a entrada, criará um novo objeto de ação.
