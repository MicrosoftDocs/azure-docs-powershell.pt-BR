...
### Exemplo 4: Obter contas de armazenamento com seu status de restauração de blob
```
...
Este comando obtém uma conta de Armazenamento com seu status de restauração de blob e mostra o status de restauração de blob.
