...
### Exemplo 1: criar uma política de acesso armazenado em um contêiner de armazenamento
```
PS C:\>New-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy01"
```

Este comando cria uma política de acesso chamada Policy01 no contêiner de armazenamento chamado MyContainer.
...
### -Permission
Especifica permissões na política de acesso armazenado para acessar o contêiner.
