...
## SYNOPSIS
Remove uma política de acesso armazenada de um compartilhamento de armazenamento.
...
## DESCRIPTION
O cmdlet **Remove-AzStorageShareStoredAccessPolicy** remove uma política de acesso armazenada de um compartilhamento de Armazenamento do Azure.
...
Este comando remove uma política de acesso armazenada chamada GeneralPolicy da ContosoShare.
...
### -ShareName
Especifica o nome de compartilhamento de armazenamento para o qual este cmdlet remove uma política.
