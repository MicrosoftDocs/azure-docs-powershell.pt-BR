...
Este comando cria um objeto de regra ManagementPolicy, com um objeto de grupo de ação ManagementPolicy contém 4 ações, um objeto de filtro de regra ManagementPolicy e, em seguida, desarmá-lo como uma Conta de Armazenamento.

## PARÂMETROS

### -Action
Um objeto que define o conjunto de ações.
Obter o objeto com cmdlet Add-AzureStorageAccountManagementPolicyAction
...
### -Disabled
A regra será desabilitada se defini-la.
...
Obter o objeto com cmdlet New-AzureStorageAccountManagementPolicyFilter
...
### -Name
Um nome de regra pode conter qualquer combinação de caracteres numéricos alfa.
O nome da regra é sensível a minúsculas.
Ele deve ser exclusivo em uma política.
