...
Este exemplo usa um caractere curinga com o parâmetro *Name* para obter todas as tabelas que corresponderem à tabela de padrão e, em seguida, passa o resultado no pipeline para remover as tabelas.
