...
## SYNOPSIS
Inicie uma operação de cópia incremental de um instantâneo de blob page para o blob de página de destino especificado.
...
## DESCRIPTION
Inicie uma operação de cópia incremental de um instantâneo de blob page para o blob de página de destino especificado.
Confira mais detalhes do recurso em https://docs.microsoft.com/rest/api/storageservices/fileservices/incremental-copy-blob .

## EXEMPLOS

### Exemplo 1: Iniciar a Operação de Cópia Incremental por nome de blob e tempo de instantâneo
```
...
Este comando inicia a Operação de Cópia Incremental por nome de blob e tempo de instantâneo

### Exemplo 2: Iniciar a operação de cópia incremental usando uri de origem
```
...
Este comando inicia a Operação de Cópia Incremental usando uri de origem

### Exemplo 3: Iniciar a operação de cópia incremental usando o pipeline de contêiner a partir de GetAzureStorageContainer
```
...
### Exemplo 4: iniciar a operação de cópia incremental do objeto CloudPageBlob para o blob de destino com nome de blob
```
...
Este comando inicia a Operação de Cópia Incremental do objeto CloudPageBlob para o blob de destino com nome de blob

## PARÂMETROS

### -AbsoluteUri
Uri absoluto à origem. A credencial deve ser fornecida no Uri, se a fonte exigir alguma.
...
### -CloudBlob
Objeto CloudBlob da biblioteca do Cliente de Armazenamento do Azure. Você pode criar ou usar Get-AzStorageBlob cmdlet.
...
### -CloudBlobContainer
Objeto CloudBlobContainer da biblioteca do Cliente de Armazenamento do Azure. Você pode criar ou usar Get-AzStorageContainer cmdlet.
...
### -Context
Contexto de armazenamento do Azure De origem. Você pode criar por meio New-AzStorageContext cmdlet.
...
### -DestContext
Contexto de armazenamento do Azure de destino. Você pode criar por meio New-AzStorageContext cmdlet.
...
### -SrcBlob
Nome de blob da página de origem.
...
### -SrcBlobSnapshotTime
Hora do instantâneo blob da página de origem.
