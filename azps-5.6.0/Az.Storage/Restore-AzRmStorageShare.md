...
## SYNOPSIS
Restaura um compartilhamento de arquivo excluído.
...
## DESCRIPTION
O cmdlet **Restore-AzRmStorageShare** restaura um compartilhamento de arquivo excluído em um dia de retenção válido se a exclusão de compartilhamento está habilitada.
...
Esse comando primeiro exclui um compartilhamento de arquivo e lista compartilhamentos e, em seguida, vê a versão de compartilhamento excluída, finalmente restaure-a de volta para um compartilhamento normal. Precisa de exclusão de compartilhamento habilitada com Update-AzStorageFileServiceProperty, antes de excluir o compartilhamento.
...
### -DeletedShareVersion
Versão do Compartilhamento Excluída, que será restaurada a partir de.
...
### -Name
Nome do Compartilhamento Excluído, que será restaurado.
