...
Este cmdlet retorna um **objeto CloudFileDirectory.**
...
Este comando cria uma pasta chamada ContosoWorkingFolder no compartilhamento de arquivos chamado ContosoShare06.
...
Este comando usa o cmdlet **Get-AzStorageShare** para obter o compartilhamento de arquivos chamado ContosoShare06 e, em seguida, passa-o para o cmdlet atual usando o operador de pipeline.
...
Este cmdlet cria a pasta no local especificado por esse parâmetro.
...
Este cmdlet cria uma pasta para o caminho especificado pelo cmdlet.
...
Este cmdlet cria uma pasta no compartilhamento de arquivos que este parâmetro especifica.
