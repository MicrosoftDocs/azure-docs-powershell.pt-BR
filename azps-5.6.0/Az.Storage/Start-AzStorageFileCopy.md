...
## SYNOPSIS
Começa a copiar um arquivo de origem.
...
## DESCRIPTION
O cmdlet **Start-AzStorageFileCopy** começa a copiar um arquivo de origem para um arquivo de destino.

## EXEMPLOS

### Exemplo 1: Iniciar a operação de cópia de arquivo para arquivo usando o nome do compartilhamento e o nome do arquivo
```
...
Este comando inicia uma operação de cópia de arquivo para arquivo.
O comando especifica o nome do compartilhamento e o nome do arquivo

### Exemplo 2: Iniciar a operação de cópia de blob para arquivo usando o nome do contêiner e o nome do blob
```
...
Este comando inicia uma operação de cópia de blob para arquivo.
...
### -DestFilePath
Especifica o caminho do arquivo de destino em relação ao compartilhamento de destino.
...
Você pode criar um blob de nuvem ou obter um usando o cmdlet Get-AzStorageBlob de nuvem.
...
Você pode criar um objeto contêiner de blob na nuvem ou usar o cmdlet Get-AzStorageContainer nuvem.
...
### -SrcFilePath
Especifica o caminho do arquivo de origem em relação ao diretório de origem ou ao compartilhamento de origem.
...
### -SrcShare
Especifica um objeto de compartilhamento de arquivos na nuvem.
Você pode criar um compartilhamento de arquivos na nuvem ou obter um usando o cmdlet Get-AzStorageShare de nuvem.
