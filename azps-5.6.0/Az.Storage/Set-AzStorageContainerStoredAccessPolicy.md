...
## SYNOPSIS
Define uma política de acesso armazenada para um contêiner de armazenamento do Azure.
...
## DESCRIPTION
O cmdlet **Set-AzStorageContainerStoredAccessPolicy** define uma política de acesso armazenada para um contêiner de armazenamento do Azure.

## EXEMPLOS

### Exemplo 1: definir uma política de acesso armazenado em um contêiner de armazenamento com permissão total
```
PS C:\>Set-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy06" -Permission rwdl
```

Este comando define uma política de acesso chamada Policy06 para contêiner de armazenamento chamado MyContainer.
...
### -Permission
Especifica permissões na política de acesso armazenado para acessar o contêiner de armazenamento.
...
### -StartTime
Especifica o momento em que a política de acesso armazenado se torna válida.
