...
Este comando cria um diretório com Permissões especificadas, Umask, propriedades e metadados

### Exemplo 2: Criar(carregar) um arquivo de lago de dados de um arquivo de origem local e o cmdlet é executado em segundo plano
```
...
Este comando cria(carregar) um arquivo de lago de dados de um arquivo de origem local e o cmdlet é executado em segundo plano.
...
### -Force
Se aprovado, o novo item será criado sem qualquer prompt
...
### -Property
Especifica propriedades para o diretório ou arquivo criado. As propriedades suportadas para o arquivo são: CacheControl, ContentDisposition, ContentEncoding, ContentLanguage, ContentMD5, ContentType.
...
### -Umask
Ao criar Novo Item e o diretório pai não tiver uma ACL padrão, a umask restringe as permissões do arquivo ou diretório a ser criado.
A permissão resultante é dada por p & ^u, onde p é a permissão e você é a umask.
Simbólico (rwxrw-rw-) é suportado.
