...
Este comando remove o compartilhamento de arquivos chamado ContosoShare06.

### Exemplo 2: Remover um compartilhamento de arquivos e todos os instantâneos
```
PS C:\>Remove-AzStorageShare -Name "ContosoShare06" -IncludeAllSnapshot
```

Este comando remove o compartilhamento de arquivos chamado ContosoShare06 e todos os instantâneos.
...
### -Force
Force a remover o compartilhamento com todos os instantâneos e todo o conteúdo.
...
### -IncludeAllSnapshot
Remover Compartilhamento de Arquivos com todos os instantâneos
...
Este cmdlet exclui o compartilhamento de arquivos especificado por esse parâmetro.
...
Este cmdlet remove o objeto especificado por esse parâmetro.
