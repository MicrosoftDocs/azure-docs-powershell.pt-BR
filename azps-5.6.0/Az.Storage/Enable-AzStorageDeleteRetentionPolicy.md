...
## DESCRIPTION
O cmdlet **Enable-AzStorageDeleteRetentionPolicy** permite excluir política de retenção para o serviço blob de armazenamento do Azure.
...
Esse comando permite excluir a política de retenção para o serviço Blob e definir os dias de retenção de blob excluídos como 3.
