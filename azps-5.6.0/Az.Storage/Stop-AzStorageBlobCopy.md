...
Este comando interrompe a operação de cópia por nome.
...
Este comando interrompe a operação de cópia passando o contêiner no pipeline de **Get-AzStorageContainer**.
