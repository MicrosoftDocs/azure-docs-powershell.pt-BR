...
Este comando obtém uma política de replicação de objeto com id de política específica e mostra suas regras.

### Exemplo 2:Listar política de replicação de objeto de uma conta de armazenamento
```
...
Este comando lista a política de replicação de objeto de uma conta de armazenamento.
