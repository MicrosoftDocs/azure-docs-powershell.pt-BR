...
## DESCRIPTION
O cmdlet **Enable-AzOperationalInsightsLinuxPerformanceCollection** inicia a coleção de contadores de desempenho de computadores Linux conectados em um espaço de trabalho.
