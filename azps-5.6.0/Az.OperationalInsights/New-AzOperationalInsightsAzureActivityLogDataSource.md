...
## SYNOPSIS
Coletar log atividade do Azure de determinada assinatura.
...
## DESCRIPTION
A New-AzOperationalInsightsAzureActivityLogDataSource permitir que o Log Analytics colete o log de atividades do Azure de determinada assinatura.
...
### -BackfillStartTime
Você pode optar por fazer logs de backfill de uma semana atrás.
