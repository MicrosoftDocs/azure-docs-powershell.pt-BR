...
## SYNOPSIS
Inicia a coleção de dados de syslog de computadores Linux.
...
## DESCRIPTION
O cmdlet **Enable-AzOperationalInsightsLinuxSyslogCollection** inicia a coleção de dados de syslog de computadores Linux conectados em um espaço de trabalho.
