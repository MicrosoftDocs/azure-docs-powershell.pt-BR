...
## SYNOPSIS
Define uma política de coleção de log personalizada.
...
## DESCRIPTION
O cmdlet **New-AzOperationalInsightsCustomLogDataSource** define uma política de coleção de log personalizada.
...
### -CustomLogRawJson
Especifica a política de coleção personalizada como uma cadeia de caracteres JSON (Notação de Objeto JavaScript) bruta.
...
### -Workspace
Especifica um espaço de trabalho no qual este cmdlet opera.
...
### -WorkspaceName
Especifica o nome de um espaço de trabalho no qual este cmdlet opera.
