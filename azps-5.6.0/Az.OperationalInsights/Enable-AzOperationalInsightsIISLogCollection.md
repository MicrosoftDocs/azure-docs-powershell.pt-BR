...
## SYNOPSIS
Inicia a coleção de logs do IIS de computadores em um espaço de trabalho.
...
## DESCRIPTION
O cmdlet **Enable-AzOperationalInsightsIISLogCollection** inicia a coleção de logs do Serviços de Informações da Internet (IIS) de computadores conectados em um espaço de trabalho.
