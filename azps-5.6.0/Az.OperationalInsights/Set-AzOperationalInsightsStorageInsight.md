...
## DESCRIPTION
O cmdlet **Set-AzOperationalInsightsStorageInsight** altera a configuração de um Storage Insight.

## EXEMPLOS

### Exemplo 1: Modificar um Insight de Armazenamento pelo nome
```
...
Este comando modifica as tabelas das quais o Storage Insight chamado MyStorageInsight lê.

### Exemplo 2: Modificar uma Visão de Armazenamento usando um objeto workspace
```
...
O segundo comando modifica os contêineres dos quais o Storage Insight chamado MyStorageInsight lê.
...
### -Name
Especifica o nome de um Storage Insight.
