...
## SYNOPSIS
Interrompe a coleção de logs do IIS de computadores.
...
## DESCRIPTION
O cmdlet **Disable-AzOperationalInsightsIISLogCollection** interrompe a coleção de logs do Serviços de Informações da Internet (IIS) de computadores conectados em um espaço de trabalho.
