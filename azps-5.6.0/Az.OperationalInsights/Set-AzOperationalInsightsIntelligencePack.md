...
## SYNOPSIS
Habilita ou desabilita o Intelligence Pack especificado.
...
## DESCRIPTION
O cmdlet **Set-AzOperationalInsightsIntelligencePack** habilita o  Pacote de Inteligência especificado se Habilitado estiver definido como $True e o desabilitará se *Habilitado* estiver definido como $False.

## EXEMPLOS

### Exemplo 1: Definir Pacotes de Inteligência
```
PS C:\>Set-AzOperationalInsightsIntelligencePack -ResourceGroupName "ContosoResourceGroup" -WorkspaceName "ContosoWorkspace" -IntelligencePackName "ContosoWorkspace" -Enabled $True
```

Este comando habilita o Intelligence Pack especificado.
