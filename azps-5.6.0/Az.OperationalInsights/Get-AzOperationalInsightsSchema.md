...
## DESCRIPTION
O cmdlet **Get-AzOperationalInsightsSchema** retorna o esquema associado ao espaço de trabalho especificado nesse grupo de recursos.

## EXEMPLOS

### Exemplo 1: Obter os esquemas para um espaço de trabalho
```
PS C:\>Get-AzOperationalInsightsSchema -ResourceGroupName "ContosoResourceGroup" -WorkspaceName "ContosoWorkspace"
```

Este comando obtém os esquemas associados a um espaço de trabalho.
