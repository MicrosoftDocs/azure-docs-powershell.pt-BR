...
## DESCRIPTION
Obter ou listar clusters, listar clusters em grupo de recursos quando "-ClusterName" não foi fornecido, listar clusters sob assinatura quando "-ClusterName" e "ResourceGroupName" não foram fornecidos.
