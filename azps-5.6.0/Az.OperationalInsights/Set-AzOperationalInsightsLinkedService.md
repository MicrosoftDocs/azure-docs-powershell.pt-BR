...
cluster de link para espaço de trabalho
...
### -ResourceId
A id de recurso do recurso que será vinculado ao espaço de trabalho.
...
A id de recurso do recurso que será vinculado ao espaço de trabalho.
Isso deve ser usado para vincular recursos que exigem acesso à gravação.
O cluster deve ter propriedades de estado de provisionamento "Bem-sucedidos" e keyvault válidos.
