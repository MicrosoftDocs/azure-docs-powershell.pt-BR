...
## SYNOPSIS
Inicia a coleção de logs personalizados de computadores Linux.
...
## DESCRIPTION
O cmdlet **Enable-AzOperationalInsightsLinuxCustomLogCollection** inicia a coleção de logs personalizados de computadores Linux conectados em um espaço de trabalho.
