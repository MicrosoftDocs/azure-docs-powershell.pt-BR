...
## SYNOPSIS
Coletar logs de determinado Application-Insights aplicativo.
...
## DESCRIPTION
O cmdlet **New-AzOperationalInsightsApplicationInsightsDataSource** habilita a coleção de logs de um determinado aplicativo Application-Insights.

## EXEMPLOS

### Exemplo 1: Criar fonte de dados de insights de aplicativo no espaço de trabalho
```
...
Este comando cria uma fonte de dados de insights de aplicativo de um determinado aplicativo em um determinado espaço de trabalho de análise de log. Isso habilita a coleção de logs de determinado aplicativo para o espaço de trabalho de análise de log.

### Exemplo 2: Obter objeto workspace e criar fonte de dados de insights de aplicativo pela id de recurso do aplicativo
```
...
Este comando demonstra obter um objeto de espaço de trabalho de análise de log e, em seguida, passar a saída para criar uma fonte de dados de percepções de aplicativo associada pela id de recurso do aplicativo. 
...
A id de assinatura do aplicativo vinculado.
