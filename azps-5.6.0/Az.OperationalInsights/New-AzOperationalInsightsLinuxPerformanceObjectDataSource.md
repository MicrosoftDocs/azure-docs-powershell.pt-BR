...
## DESCRIPTION
O cmdlet **New-AzOperationalInsightsLinuxPerformanceObjectDataSource** adiciona contadores de desempenho dos quais o Insights Operacionais do Azure coleta dados para todos os computadores Linux em um espaço de trabalho.
