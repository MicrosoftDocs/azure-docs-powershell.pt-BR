...
## DESCRIPTION
O cmdlet **New-AzOperationalInsightsLinuxSyslogDataSource** adiciona uma fonte de dados de syslog a computadores Linux conectados em um espaço de trabalho.
O Insights Operacionais do Azure pode coletar dados de syslog.

## EXEMPLOS

### Exemplo 1: Criar fontes de dados de syslog
```
$FacilityNames       = @()
$FacilityNames      += 'auth'
...
### -CollectAlert
Indica que o Insights Operacionais coleta mensagens de alerta.
...
### -CollectCritical
Indica que o Insights Operacionais coleta mensagens críticas.
...
### -CollectDebug
Indica que o Insights Operacionais coleta mensagens de depuração.
...
### -CollectEmergency
Indica que o Insights Operacionais coleta mensagens de emergência.
...
### -CollectError
Indica que o Insights Operacionais coleta mensagens de erro.
...
### -CollectInformational
Indica que o Insights Operacionais coleta mensagens informativas.
...
### -CollectNotice
Indica que o Insights Operacionais coleta mensagens de aviso.
