...
### Exemplo 1: Modificar um espaço de trabalho pelo nome
```
PS C:\>Set-AzOperationalInsightsWorkspace -ResourceGroupName "ContosoResourceGroup" -Name "MyWorkspace" -Sku Standard -Tags @{ "Department" = "IT" }
```

Este comando modifica a SKU e as marcas do espaço de trabalho chamado MyWorkspace no grupo de recursos chamado ContosoResourceGroup.
...
Este comando usa o cmdlet Get-AzOperationalInsightsWorkspace para obter o espaço de trabalho chamado MyWorkSpace e, em seguida, passa-o para o cmdlet **Set-AzOperationalInsightsWorkspace** usando o operador de pipeline para definir o SKU como Premium.
