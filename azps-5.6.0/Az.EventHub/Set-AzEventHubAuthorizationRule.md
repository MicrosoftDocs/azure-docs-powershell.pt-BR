...
Atualiza a regra de autorização MyAuthRuleName para conceder direitos de Gerenciar para o Hub de \` Eventos MyEventHubName , com escopo pelo \` \` \` namespace \` MyNamespaceName \` .
