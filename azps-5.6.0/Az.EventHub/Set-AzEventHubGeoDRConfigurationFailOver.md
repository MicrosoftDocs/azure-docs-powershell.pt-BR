...
## DESCRIPTION
O cmdlet **Set-AzEventHubGeoDRConfigurationFailOver** invoca o failover de DR GEO e reconfigura o alias para apontar para o namespace secundário
...
### -InputObject
Objeto de configuração geográfica eventhub
