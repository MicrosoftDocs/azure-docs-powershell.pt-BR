...
## DESCRIPTION
O cmdlet **Set-AzEventHubGeoDRConfigurationBreakPair** desabilita a Recuperação de Desastre e interrompe a réplica de alterações de namespaces primários para secundários
