...
## DESCRIPTION
O New-AzEventHubNamespace cmdlet cria um novo namespace do tipo Hubs de Eventos.
...
Cria um namespace De hubs de eventos MyNamespaceName na localização geográfica especificada MyLocation , no grupo de recursos \` \` \` \` \` MyResourceGroupName \` .
...
Cria um namespace de Hubs de Eventos MyNamespaceName na localização geográfica especificada MyLocation , no grupo de recursos \` \` \` \` \` MyResourceGroupName e AutoInflate está habilitado com \` MaximumThroughputUnits 10.
...
Cria um namespace de Hubs de Eventos MyNamespaceName na localização geográfica especificada MyLocation , no grupo de recursos \` \` \` \` \` MyResourceGroupName com \` Kafka e AutoInflate habilitados.
...
### -ClusterARMId
ARM ID do Cluster onde o namespace deve ser criado
