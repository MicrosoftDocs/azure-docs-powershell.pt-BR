...
### Exemplo 1
Para atualizar Eventhub com propriedades de descrição de Captura, siga as etapas a seguir. 
...
Atualiza o Hub de Eventos \` MyEventHubName representado pelo \` objeto \` MyCreatedEventHub, definindo as \` propriedades CaptureDescription
...
Atualiza o Hub de Eventos \` MyEventHubName representado pelo \` objeto \` MyCreatedEventHub, definindo o período de retenção de mensagens como 4 dias e o número de partições \` como 2.
