...
## DESCRIPTION
O cmdlet Set-AzEventHubConsumerGroup atualiza o grupo de consumidores de Hubs de Eventos especificado.
...
Define os metadados do usuário do grupo de consumidores \` MyConsumerGroupName \` como "Testing".
