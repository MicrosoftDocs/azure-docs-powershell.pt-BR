...
Cria o grupo de consumidores MyConsumerGroupName no Hub de Eventos MyEventHubName , com escopo para o namespace MyNamespaceName , com o grupo de recursos \` \` \` \` \` \` \` MyResourceGroupName \` .
