...
## DESCRIPTION
O cmdlet **Start-AzHpcCache** inicia um Cache HPC do Azure.
...
### -Force
Indica que o cmdlet não solicita a confirmação. Por padrão, este cmdlet solicita que você confirme se deseja iniciar o cache.
...
### -ResourceGroupName
Nome do grupo de recursos no qual você deseja iniciar o cache.
