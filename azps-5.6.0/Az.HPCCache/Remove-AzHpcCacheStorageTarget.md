...
## DESCRIPTION
O cmdlet **Remove-AzHpcCacheStorageTarget** remove um Destino de Armazenamento do Cache HPC do Azure.
...
### -Force
Indica que o cmdlet não solicita a confirmação. Por padrão, este cmdlet solicita que você confirme se deseja remover o destino de armazenamento.
...
### -ResourceGroupName
Nome do grupo de recursos no qual você deseja remover o destino de armazenamento do cache.
