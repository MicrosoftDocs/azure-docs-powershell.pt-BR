...
### -Force
Indica que o cmdlet não solicita a confirmação. Por padrão, este cmdlet solicita que você confirme se deseja liberar o cache.
...
### -NFS
Atualizar tipo de destino de armazenamento NFS.
...
### -ResourceGroupName
"Nome do grupo de recursos no qual você deseja criar destino de armazenamento para determinado cache.
