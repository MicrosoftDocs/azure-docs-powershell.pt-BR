...
### -Force
Indica que o cmdlet não solicita a confirmação. Por padrão, este cmdlet solicita que você confirme se deseja atualizar o cache.
...
### -InputObject
O objeto cache a ser atualizado.
