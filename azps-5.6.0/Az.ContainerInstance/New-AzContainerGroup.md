...
Esse comandos cria um grupo de contêineres usando a imagem nginx mais recente e solicita um endereço IP público com a porta 8000 de abertura.
...
Esse comandos cria um grupo de contêineres e executa um script personalizado dentro do contêiner.

### Exemplo 3: cria um grupo de contêineres de execução para conclusão.
```
...
Esse comandos cria um grupo de contêineres que imprime "hello" e para.
...
Esse comandos cria um grupo de contêineres usando uma imagem nginx no Registro de Contêineres do Azure.
...
Esse comandos cria um grupo de contêineres usando uma imagem personalizada de um registro de imagem de contêiner personalizado.
...
Esse comandos cria um grupo de contêineres que monta o compartilhamento de arquivo do Azure fornecido para `/mnt/azfile` .
...
Esse comandos cria um grupo de contêineres com identidade atribuída ao sistema usando a imagem nginx mais recente e solicita um endereço IP público com a porta 8000 de abertura.
...
Esse comandos cria um grupo de contêineres com identidade atribuída ao sistema e atribuída ao usuário usando a imagem nginx mais recente e solicita um endereço IP público com a porta de abertura 8000.
...
A credencial da conta de armazenamento do compartilhamento do Arquivo do Azure para montar onde o nome de usuário é o nome da conta de armazenamento e a chave é a chave da conta de armazenamento.
...
O nome do compartilhamento de arquivo do Azure a ser montado.
...
### -Port
As portas a ser abertas. Padrão: [80]
...
### -RegistryCredential
A credencial de registro de contêiner personalizada.
