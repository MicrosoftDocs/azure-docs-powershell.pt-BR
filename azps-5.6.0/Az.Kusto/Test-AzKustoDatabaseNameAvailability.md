...
O comando acima retorna se existe ou não um banco de dados Kusto chamado "mykustodatabase" no cluster "testnewkustocluster".

### Exemplo 2: Verifique a disponibilidade de um nome de banco de dados Kusto que não está em uso
```powershell
...
O comando acima retorna se existe ou não um banco de dados Kusto chamado "mykustodatabase2" no cluster "testnewkustocluster".
