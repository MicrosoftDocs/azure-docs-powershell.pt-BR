...
### Exemplo 1: Excluir um cluster Kusto existente PrincipalAssignment pelo nome
```powershell
...
O comando acima exclui o PrincipalAssignment chamado "kustoprincipal1" no cluster kusto "testnewkustocluster".
