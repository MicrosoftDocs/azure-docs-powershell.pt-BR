...
O comando acima retorna se existe ou não um cluster Kusto chamado "testnewkustocluster" na região "East US".
...
O comando acima retorna se existe ou não um cluster Kusto chamado "availablekustocluster" na região "East US".
