...
### Exemplo 1: Criar um novo banco de dados Kusto pelo nome
```powershell
...
O comando acima cria um novo banco de dados Kusto chamado "mykustodatabase" no cluster existente "testnewkustocluster" encontrado no grupo de recursos "testrg".
