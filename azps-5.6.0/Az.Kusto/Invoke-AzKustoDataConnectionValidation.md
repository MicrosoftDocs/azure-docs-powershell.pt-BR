...
### Exemplo 1: Validar parâmetros de conexão de dados EventHub
```powershell
...
O comando acima valida a conexão de dados EventHub chamada "myeventhubdc" para o banco de dados "mykustodatabase" no cluster "testnewkustocluster".

### Exemplo 2: Validar parâmetros de conexão de dados EventGrid
```powershell
...
O comando acima valida a conexão de dados EventGrid chamada "myeventgriddc" para o banco de dados "mykustodatabase" no cluster "testnewkustocluster".

### Exemplo 3: Validar parâmetros de conexão de dados IotHub
```powershell
...
O comando acima valida a conexão de dados IotHub chamada "myiothubdc" para o banco de dados "mykustodatabase" no cluster "testnewkustocluster".

### Exemplo 4: Validar parâmetros de conexão de dados EventHub via identidade
```powershell
...
### Exemplo 5: Validar parâmetros de conexão de dados EventGrid por meio da identidade
```powershell
PS C:\> $database = Get-AzKustoDatabase -ResourceGroupName "testrg" -ClusterName "testnewkustocluster" -DatabaseName "mykustodatabase"
...
### Exemplo 6: Validar parâmetros de conexão de dados IotHub por meio de identidade
```powershell
PS C:\> $database = Get-AzKustoDatabase -ResourceGroupName "testrg" -ClusterName "testnewkustocluster" -DatabaseName "mykustodatabase" 
