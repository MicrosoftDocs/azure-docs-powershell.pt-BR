...
### Exemplo 1: atualizar uma conexão de dados EventHub existente
```powershell
...
O comando acima atualiza a conexão de dados EventHub existente chamada "myeventhubdc" para o banco de dados "mykustodatabase" no cluster "testnewkustocluster".
...
### Exemplo 3: atualizar uma conexão de dados IotHub existente
```powershell
...
### Exemplo 4: atualizar uma conexão de dados EventHub existente por meio da identidade
```powershell
...
### Exemplo 6: atualizar uma conexão de dados IotHub existente por meio da identidade
```powershell
...
O nome do tipo de evento de armazenamento de blob a ser processda.
...
### -EventSystemProperty
Propriedades do sistema do hub event/iot.
...
### -IotHubResourceId
A ID de recurso do hub de Iot a ser usado para criar uma conexão de dados.
...
O nome da política de acesso ao compartilhamento.
