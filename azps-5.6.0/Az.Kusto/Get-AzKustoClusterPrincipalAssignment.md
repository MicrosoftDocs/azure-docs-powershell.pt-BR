...
### Exemplo 1: Listar todas as entidades de cluster KustoAssignment
```powershell
...
O comando acima lista todas as principaisAssignment no cluster "testnewkustocluster".

### Exemplo 2: Obtém uma entidade de cluster KustoAssignment pelo nome
```powershell
...
O comando acima retorna a entidade de cluster KustoAssignment chamada "kustoprincipal1" no cluster "testnewkustocluster".
