...
### Exemplo 1: Criar uma entidade de cluster KustoAssignment
```powershell
...
O comando acima cria uma entidade de cluster KustoAssignment
...
### -PrincipalId
A ID principal atribuída à entidade de cluster.
Pode ser um email de usuário, ID do aplicativo ou nome do grupo de segurança.
...
### -TenantId
A id de locatário da entidade principal
