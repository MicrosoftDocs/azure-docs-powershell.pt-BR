...
### Exemplo 1: Atualizar um banco de dados existente pelo nome
```powershell
...
O comando acima atualiza o período de exclusão suave e o período de hot cache do banco de dados kusto "mykustodatabase" no cluster "testnewkustocluster" encontrado no grupo de recursos "testrg".

### Exemplo 2: atualizar um banco de dados existente por meio da identidade
```powershell
...
### Exemplo 3: Atualizar um banco de dados ReadOnly existente pelo nome
```powershell
PS C:\> $2ds = New-TimeSpan -Days 2
...
O comando acima atualiza o período de hot cache do banco de dados kusto "mykustodatabase" no cluster "myfollowercluster" encontrado no grupo de recursos "testrg".

### Exemplo 4: atualizar um banco de dados ReadOnly existente por meio de identidade
```powershell
...
### -SoftDeletePeriod
O tempo em que os dados devem ser mantidos antes que eles param de ser acessíveis a consultas no TimeSpan.
