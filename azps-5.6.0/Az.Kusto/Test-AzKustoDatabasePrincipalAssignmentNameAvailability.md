...
### Exemplo 1: Verificar a disponibilidade de um nome de entidade de banco de dados que está em uso
```powershell
...
### Exemplo 2: Verifique a disponibilidade de um nome de entidade de banco de dados que não está em uso
```powershell
