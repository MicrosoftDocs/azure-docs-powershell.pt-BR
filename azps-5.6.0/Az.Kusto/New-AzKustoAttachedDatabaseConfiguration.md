...
### Exemplo 1: Criar um novo AttachedDatabaseConfiguration
```powershell
...
O comando acima cria um banco de dados readOnly "mykustodatabase" no cluster "testnewkustoclusterf".
Ele segue o banco de dados "mykustodatabase" do cluster "testnewkustocluster"
...
### -ClusterResourceId
A id de recurso do cluster onde os bancos de dados que você gostaria de anexar residem.
...
O tipo de modificação de entidades principais padrão
