...
### Exemplo 1: Listar todos os AttachedDatabaseConfigurations em um cluster
```powershell
...
O comando acima lista todos os AttachedDatabaseConfigurations no cluster "testnewkustoclusterf".
