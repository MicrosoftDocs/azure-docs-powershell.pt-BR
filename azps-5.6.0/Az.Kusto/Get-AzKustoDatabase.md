...
### Exemplo 1: Listar todos os bancos de dados kusto em um cluster pelo nome
```powershell
...
O comando acima retorna todos os bancos de dados kusto no cluster "testnewkustocluster" encontrado no grupo de recursos "testrg".

### Exemplo 2: Obter um banco de dados Kusto específico pelo nome
```powershell
