...
### Exemplo 1: Listar todos os PrincipaisAssignment em um banco de dados pelo nome
```powershell
...
O comando acima retorna todos os PrincipaisAssignment no banco de dados "mykustodatabase" encontrado no cluster "testnewkustocluster".

### Exemplo 2: Obter um PrincipalAssignment específico em um banco de dados pelo nome
```powershell
...
O comando acima retorna todos os PrincipaisAssignment denominados "kustoprincipal1" no banco de dados "mykustodatabase" encontrado no cluster "testnewkustocluster".
...
O nome da entidade KustoAssignment.
