...
### Exemplo 1: Excluir um banco de dados Kusto existente PrincipalAssignment pelo nome
```powershell
...
O comando acima exclui o PrincipalAssignment chamado "kustoprincipal1" no banco de dados kusto "mykustodatabase".
