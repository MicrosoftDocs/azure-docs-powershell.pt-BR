...
## DESCRIPTION
O cmdlet **Get-AzCognitiveServicesAccountKey** obtém as chaves da API de uma conta provisionada dos Serviços Cognitivos.
Uma conta dos Serviços Cognitivos tem duas chaves de API: Key1 e Key2.
As teclas habilitam a interação com o ponto de extremidade da conta dos Serviços Cognitivos.
