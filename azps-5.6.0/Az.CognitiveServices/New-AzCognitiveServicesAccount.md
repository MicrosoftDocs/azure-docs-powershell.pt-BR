...
## DESCRIPTION
O cmdlet **New-AzCognitiveServicesAccount** cria uma conta dos Serviços Cognitivos com o tipo especificado e o SKU.
...
- S2
- S3
- S4 Para obter mais informações, consulte [APIs do Serviço Cognitivo](https://www.microsoft.com/cognitive-services/en-us/apis).
...
### -Type
Especifica o tipo de conta a ser criado. Use `Get-AzCognitiveServicesAccountType` cmdlet para obter valores aceitáveis atuais.
