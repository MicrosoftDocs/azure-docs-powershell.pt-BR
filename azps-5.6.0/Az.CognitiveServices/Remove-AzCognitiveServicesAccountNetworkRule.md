...
## DESCRIPTION
O cmdlet **Remove-AzCognitiveServicesAccountNetworkRule** remove IpRules ou VirtualNetworkRules da propriedade NetWorkRule de uma conta dos Serviços Cognitivos
