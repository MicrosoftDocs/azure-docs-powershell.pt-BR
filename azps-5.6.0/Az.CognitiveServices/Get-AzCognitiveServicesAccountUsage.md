...
## DESCRIPTION
O cmdlet **Get-AzCognitiveServicesAccountUsage** obtém usos atuais para uma conta dos Serviços Cognitivos.
...
### -InputObject
Objeto de conta dos Serviços Cognitivos.
...
### -ResourceId
ID do Recurso de Conta de Serviços Cognitivos.
