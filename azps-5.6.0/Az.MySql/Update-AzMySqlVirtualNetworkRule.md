...
### Exemplo 1: Atualizar a Regra de Rede Virtual mySql pelo nome
```powershell
...
Este cmdlet atualiza a Regra de Rede Virtual mySql pelo nome.

### Exemplo 2: Atualizar a Regra de Rede Virtual mySql por identidade.
```powershell
...
Esses cmdlets atualizam a Regra de Rede Virtual mySql por identidade.
