...
### Exemplo 2: Obter configuração MySql especificada pelo nome
```powershell
...
Este cmdlet obtém configuração MySql especificada pelo nome.

### Exemplo 3: Listar configuração por identidade
```powershell
...
Este cmdlet obtém configuração MySql especificada por identidade.
