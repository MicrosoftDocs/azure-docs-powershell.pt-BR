...
### Exemplo 1: Reiniciar o servidor pelo nome do recurso
```powershell
PS C:\> Restart-AzMySqlFlexibleServer -ResourceGroupName PowershellMySqlTest -Name mysql-test
```

Reiniciar o servidor pelo nome

### Exemplo 2: Reiniciar o servidor por identidade
```powershell
...
Reiniciar o servidor por identidade
