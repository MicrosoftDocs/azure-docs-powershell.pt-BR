...
### Exemplo 1: Remover Regra de Firewall MySql pelo nome
```powershell
PS C:\> Remove-AzMySqlFirewallRule -Name rule -ResourceGroupName PowershellMySqlTest -ServerName mysql-test

```

Este cmdlet remove a Regra de Firewall MySql pelo nome.

### Exemplo 2: Remover a Regra de Firewall mySql por identidade
```powershell
...
Esses cmdlets removem a Regra de Firewall MySql por identidade.
