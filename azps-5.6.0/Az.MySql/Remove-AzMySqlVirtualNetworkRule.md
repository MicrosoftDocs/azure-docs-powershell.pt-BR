...
### Exemplo 1: Remover Regra de Rede Virtual do servidor MySql pelo nome
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

Este cmdlet remove a Regra de Rede Virtual do servidor MySql pelo nome.

### Exemplo 2: Remover a Regra de Rede Virtual do servidor MySql por identidade
```powershell
...
Esses cmdlets removem a Regra de Rede Virtual do servidor MySql por identidade.
