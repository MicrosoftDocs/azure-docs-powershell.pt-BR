...
### Exemplo 1: Atualizar a configuração do MySql pelo nome
```powershell
...
Este cmdlet atualiza a configuração do MySql pelo nome.

### Exemplo 2: atualizar a configuração do MySql por identidade.
```powershell
