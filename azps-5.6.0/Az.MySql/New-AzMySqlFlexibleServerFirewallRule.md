...
Este cmdlets criam uma Regra de Firewall do servidor MySql.

### Exemplo 2: Criar uma nova Regra de Firewall MySql usando -ClientIPAddress.
```powershell
...
Este cmdlets criam uma Regra de Firewall MySql usando -ClientIPAddress.
