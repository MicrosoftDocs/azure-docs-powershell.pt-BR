...
Este cmdlet obtém servidor MySql com contexto padrão.

### Exemplo 2: Obter servidor MySql por grupo de recursos e nome de servidor
```powershell
...
Este cmdlet obtém servidor MySql por grupo de recursos e nome do servidor.
...
Este cmdlet lists obtém o servidor MySql por identidade.
