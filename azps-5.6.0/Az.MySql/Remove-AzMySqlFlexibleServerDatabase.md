...
### Exemplo 1: Remover banco de dados MySql pelo nome
```powershell
PS C:\> Remove-AzMySqlFlexibleServerDatabase -Name databasetest -ResourceGroupName PowershellMySqlTest -ServerName mysql-test
```

Este cmdlet remove o banco de dados MySql pelo nome.

### Exemplo 2: Remover banco de dados MySql por identidade
```powershell
