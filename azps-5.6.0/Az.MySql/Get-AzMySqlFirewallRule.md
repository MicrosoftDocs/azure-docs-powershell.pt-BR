...
Este cmdlet lista toda a Regra de Firewall no servidor MySql especificado.

### Exemplo 2: Obter Regra de Firewall pelo nome
```powershell
...
Este cmdlet obtém Regra de Firewall pelo nome.
...
Este cmdlet obtém Regra de Firewall por identidade.
