...
## SYNOPSIS
Crie ou atualize os metadados de um Serviço de Dispositivo IoT do Windows.
...
### Exemplo 1: Criar um novo serviço de IoT do Windows
```powershell
...
Este comando cria um novo serviço de IoT do Windows.
