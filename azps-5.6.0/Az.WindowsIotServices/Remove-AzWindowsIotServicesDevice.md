...
## SYNOPSIS
Exclua um Serviço de Dispositivo windows IoT.
...
### Exemplo 1: Remover um serviço de IoT do Windows pelo nome
```powershell
PS C:\> Remove-AzWindowsIotServicesDevice -Name wsi-t03 -ResourceGroupName azure-rg-test

```

Este comando remove um serviço de IoT do Windows pelo nome.

### Exemplo 2: Remover um serviço de IoT do Windows por pipeline
```powershell
...
Este comando remove um serviço de IoT do Windows por pipeline.
