...
## DESCRIPTION
O New-AzMapsAccountKey cmdlet regenera uma chave de API para uma conta do Azure Maps.
...
Regenera a Chave principal da API da conta MyAccount no grupo de recursos MyResourceGroup.
...
Regenera a Chave de API Secundária para a Conta de Mapas do Azure especificada.
