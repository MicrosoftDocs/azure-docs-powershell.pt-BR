...
## DESCRIPTION
Regenerar chave primária ou chave secundária da Conta de Âncoras Espaciais.
...
Regenerar a chave secundária da Conta de Âncoras Espaciais "example" no Grupo de Recursos "rg1". 
...
Regenerar a chave secundária da Conta de Âncoras Espaciais "example" da assinatura atual e grupo de recursos "rg1" com canalização.
