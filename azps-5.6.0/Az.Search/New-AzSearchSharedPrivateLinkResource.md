...
## SYNOPSIS
Cria um recurso de link privado compartilhado para o serviço de Pesquisa Cognitiva do Azure.
...
## DESCRIPTION
O **New-AzSearchSharedPrivateLinkResource** cria um recurso de link privado compartilhado para o serviço de Pesquisa Cognitiva do Azure.
...
Este exemplo cria um recurso de link privado compartilhado para o serviço blob de uma conta de armazenamento para o serviço de Pesquisa Cognitiva do Azure.
...
### -GroupId
ID do grupo de recursos de link privado compartilhado
...
ID de recurso de destino de link privado compartilhado
...
### -ResourceRegion
(Opcional) Região de recurso de link privado compartilhado
