...
## SYNOPSIS
Atualize um serviço de Pesquisa Cognitiva do Azure.
...
O exemplo altera a contagem de partições e a contagem de réplicas do serviço de Pesquisa Cognitiva do Azure para 2.
...
### -PartitionCount
Contagem de partições do Serviço de Pesquisa.
...
### -ReplicaCount
Contagem de réplicas do Serviço de Pesquisa.
