...
## SYNOPSIS
Remova o recurso de link privado compartilhado do serviço de Pesquisa Cognitiva do Azure.
...
## DESCRIPTION
O cmdlet **Remove-AzSearchSharedPrivateLinkResource** remove o recurso de link privado compartilhado do serviço de Pesquisa Cognitiva do Azure.
...
Este exemplo exclui um recurso de link privado compartilhado pelo nome do serviço de Pesquisa Cognitiva do Azure.
