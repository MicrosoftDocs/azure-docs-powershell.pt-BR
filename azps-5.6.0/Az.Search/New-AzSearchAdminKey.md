...
## SYNOPSIS
Regenera uma chave de administrador do serviço de Pesquisa Cognitiva do Azure.
...
## DESCRIPTION
O cmdlet **New-AzSearchAdminKey** regenera uma chave de administrador do serviço de Pesquisa Cognitiva do Azure.
...
O exemplo regenera a chave primária do serviço de Pesquisa Cognitiva do Azure.
...
### -KeyKind
Tipo de chave de administrador do Serviço de Pesquisa Cognitiva do Azure (Primário/Secundário).
