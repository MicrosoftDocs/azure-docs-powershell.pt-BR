...
## SYNOPSIS
Remova um serviço de Pesquisa Cognitiva do Azure.
...
## DESCRIPTION
O cmdlet **Remove-AzSearchService** remove um serviço de Pesquisa Cognitiva do Azure com parâmetros especificados.
...
O exemplo remove um serviço de Pesquisa Cognitiva do Azure.
