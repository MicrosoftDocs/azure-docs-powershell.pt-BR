...
## DESCRIPTION
O cmdlet **Remove-AzDataBoxJob** é usado para excluir um trabalho de caixa de dados concluído da lista de trabalhos da caixa de dados.
...
Exclui o trabalho de caixa de dados especificada
...
Exclui o trabalho de caixa de dados especificado com força sem confirmação
