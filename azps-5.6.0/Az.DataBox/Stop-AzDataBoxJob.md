...
## SYNOPSIS
Cancela um trabalho de caixa de dados em andamento se o trabalho estiver em estado cancelável.
...
## DESCRIPTION
O cmdlet **Stop-AzDataBoxJob** é usado para cancelar um trabalho de caixa de dados.
...
Cancela o trabalho de caixa de dados especificada
...
Cancela o trabalho de caixa de dados especificado com força sem confirmação
...
### -ResourceId
ID do Recurso de Caixa de Dados
