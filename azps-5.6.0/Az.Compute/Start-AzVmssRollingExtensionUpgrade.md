...
## SYNOPSIS
Este cmdlet inicia uma atualização de rolagem para todas as extensões no conjunto de escala de máquina virtual determinado para a versão mais recente disponível. 
...
## DESCRIPTION
Inicia uma atualização de rolagem para mover todas as extensões nesta escala de máquina virtual definida para a versão mais recente disponível.
As extensões que já estão executando a versão mais recente disponível não são afetadas.
...
Este exemplo obtém o conjunto de escala de VM existente "MyVmssName" e adiciona uma extensão a ele. O comando final executa o processo de atualização de rolagem de extensão. 
