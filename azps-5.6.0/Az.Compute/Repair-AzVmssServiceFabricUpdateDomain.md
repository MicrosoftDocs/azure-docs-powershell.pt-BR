...
## DESCRIPTION
Force o domínio de atualização manual da plataforma para atualizar máquinas virtuais em um conjunto de escala de máquina virtual de malha de serviço.
...
Este comando força a atualização de malha de serviço a andar na UD 0 para o conjunto de escala de máquina virtual especificado pelo nome do grupo de recursos e o nome do conjunto de escala.
...
Este comando força a atualização de malha de serviço a andar na UD 1 para o conjunto de escala de máquina virtual especificado pelo objeto de conjunto de escala de VM.
...
Este comando força a atualização de malha de serviço a andar na UD 2 para o conjunto de escala de máquina virtual especificado pela id de recurso.
