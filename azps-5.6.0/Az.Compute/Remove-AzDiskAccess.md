...
Este comando remove o acesso ao disco chamado "DiskAccess01" no grupo de recursos "ResourceGroup01"
...
Este comando remove o acesso ao disco pela ID do Recurso

### Exemplo 3: remover o acesso ao disco usando o objeto Input
```
PS C:\> $myDiskAccess = Get-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01"
...
### Exemplo 4: remover o acesso ao disco canalização do objeto input
```
PS C:\> Get-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01" | Remove-AzDiskAccess 
```

Este comando remove o acesso ao disco canalização do InputObject
...
### -InputObject
Objeto De Acesso ao Disco do PowerShell
