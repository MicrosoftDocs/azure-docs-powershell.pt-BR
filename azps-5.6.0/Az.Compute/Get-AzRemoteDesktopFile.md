...
## DESCRIPTION
O cmdlet **Get-AzRemoteDesktopFile** obtém um arquivo Remote Desktop Protocol (.rdp).
...
Este comando obtém o arquivo de Área de Trabalho Remota para a máquina virtual chamada VirtualMachine07.
...
### -Launch
Indica que esse cmdlet inicia a Área de Trabalho Remota depois que obtém o arquivo .rdp.
