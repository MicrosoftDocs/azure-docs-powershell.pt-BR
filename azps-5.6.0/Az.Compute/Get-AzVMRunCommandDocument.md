...
Obtém um documento de comando de executar específico para 'RunPowerShellScript' em 'westus'.
...
Lista todos os comandos de executar disponíveis em 'westus'.
...
### -Location
O local no qual os comandos de executar são consultados.
