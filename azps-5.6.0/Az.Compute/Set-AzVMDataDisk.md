...
## DESCRIPTION
O cmdlet **Set-AzVMDataDisk** modifica propriedades de um disco de dados de máquina virtual.
...
O segundo comando modifica o modo de cache do disco de dados chamado DataDisk01 na máquina virtual $VM.
...
### -Lun
Especifica o número da unidade lógica (LUN) do disco de dados que este cmdlet modifica.
