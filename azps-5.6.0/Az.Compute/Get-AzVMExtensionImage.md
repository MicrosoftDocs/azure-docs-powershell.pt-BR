...
Este comando obtém todas as versões da imagem de extensão para o local, o editor e o tipo especificados.

### Exemplo 2: Obter as versões de uma imagem de extensão com filtro sobre versão
```
...
Este comando obtém todas as versões da imagem de extensão para o local, o editor, o tipo e a versão especificados a partir de 12.
...
Este comando obtém todas as versões da imagem de extensão para o local, o editor, o tipo e a versão especificados.
