...
Os três comandos a seguir atribuem caminhos do disco do sistema operacional e dois discos de dados às variáveis $osDiskVhdUri, $dataDiskVhdUri 1 e $dataDiskVhdUri 2. Essa abordagem é apenas para a capacidade de leitura dos seguintes comandos.
