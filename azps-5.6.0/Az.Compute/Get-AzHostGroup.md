...
Este cmdlet também lista todos os grupos de host em um grupo de recursos se um nome de grupo de host não for dado.
Esse cmdlet também lista todos os grupos de host em uma assinatura se nem o nome do grupo de host nem o nome do grupo de recursos for dado.
...
Este comando retorna um grupo de host.
...
Este comando retorna todos os grupos de host no grupo de recursos determinado.
...
Este comando retorna todos os grupos de host na assinatura.
...
### -InstanceView
Expanda o objeto retornado para também listar os exibições de instância do host. 
