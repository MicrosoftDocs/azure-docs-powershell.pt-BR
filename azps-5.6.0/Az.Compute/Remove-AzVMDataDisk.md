...
O segundo comando remove o disco de dados chamado Disk3 da máquina virtual armazenada $VirtualMachine.
O comando final atualiza o estado da máquina virtual armazenada em $VirtualMachine em ResourceGroup11.

## PARÂMETROS

### -DataDiskNames
Especifica os nomes de um ou mais discos de dados que esse cmdlet remove.
