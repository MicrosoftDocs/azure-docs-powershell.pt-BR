...
## DESCRIPTION
O cmdlet **Add-AzVmssDiagnosticsExtension** adiciona uma extensão de diagnóstico à instância do Conjunto de Escala de Máquina Virtual (VMSS).
...
Este comando adiciona uma extensão de diagnóstico ao VMSS.
...
Para obter a versão, execute o cmdlet [Get-AzVMExtensionImage](./Get-AzVMExtensionImage.md) com um valor Microsoft.Azure.Diagnostics para o parâmetro *PublisherName* e IaaSDiagnosticstics para o *parâmetro Type.*
