...
## DESCRIPTION
O cmdlet **Add-AzVmssExtension** adiciona uma extensão ao Conjunto de Escala de Máquina Virtual (VMSS).
...
Este comando adiciona uma extensão ao VMSS com um script de exemplo de bash em um armazenamento de blob, especifique a url de armazenamento de blob e comando executável em configurações e acesso de segurança em configurações protegidas. 
