...
### -ProtectFromScaleIn
Indica que o conjunto de escala de máquina virtual VM não deve ser considerado para exclusão durante uma operação de dimensionamento.
...
Indica que as atualizações ou ações do modelo (incluindo o dimensionar) iniciadas no VMSS não devem ser aplicadas à VMSS VMSS.
