...
Cria um conjunto de criptografia de disco usando a chave ativa determinada no cofre de chaves.
...
### -EncryptionType
Use isso para definir o tipo de criptografia do conjunto de criptografia de disco. Os valores disponíveis são: 'EncryptionAtRestWithPlatformKey', 'EncryptionAtRestWithCustomerKey'.
...
### -IdentityType
O tipo de Identidade Gerenciada usada pelo DiskEncryptionSet. Somente SystemAssigned é suportado.
