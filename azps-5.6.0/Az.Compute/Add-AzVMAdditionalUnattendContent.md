...
## DESCRIPTION
O cmdlet **Add-AzVMAdditionalUnattendContent** adiciona informações ao arquivo de resposta de instalação autônoma do Windows.
Especifique informações adicionais codificadas .xml codificadas com base 64 que este cmdlet adiciona ao arquivo unattend.xml.
...
O quinto comando atribui conteúdo à $AucContent variável.
...
### -Content
Especifica o conteúdo xml codificado base 64.
Este cmdlet adiciona o conteúdo ao arquivo unattend.xml arquivo.
O conteúdo XML deve ter menos de 4 KB e deve incluir o elemento raiz para a configuração ou recurso que este cmdlet insere.
