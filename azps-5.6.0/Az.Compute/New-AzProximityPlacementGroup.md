...
## DESCRIPTION
Este cmdlet criará o recurso Grupo de Posicionamento de Proximidade.
...
Este comando cria um grupo de locais de proximidade no local determinado.

### Exemplo 2

Criar recurso Grupo de Posicionamento de Proximidade. (gerado automaticamente)
