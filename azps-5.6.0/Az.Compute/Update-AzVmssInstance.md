...
## DESCRIPTION
O Update-AzVmssInstance cmdlet inicia uma atualização manual da instância do Conjunto de Escala de Máquina Virtual (VMSS) especificada.
Isso é usado quando a política de atualização no Conjunto de Escala VMSS é definida como manual.
...
Este comando inicia uma atualização do VMSS chamado VMScaleSet001 que tem a ID da instância de 0.
...
### -InstanceId
Especifica, como uma matriz de cadeia de caracteres, as IDs ou IDs da instância a ser atualizada.
