...
Este comando suspende o serviço reparos automáticos no VMSS "vmss1" no grupo de recursos "rg".
...
Este comando retoma o serviço reparos automáticos no VMSS "vmss1" no grupo de recursos "rg".

## PARÂMETROS

### -Action
A ação a ser executada.  Os valores possíveis são: Resume, Suspend.
...
### -InputObject
O objeto local do conjunto de escala de máquina virtual.
