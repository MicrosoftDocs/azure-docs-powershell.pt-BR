...
## DESCRIPTION
O cmdlet **Remove-AzVmss** remove o Conjunto de Escala de Máquina Virtual (VMSS) do Azure.
...
Este comando remove o VMSS chamado VMScaleSet001 que pertence ao grupo de recursos chamado Group001.
...
Este comando remove a máquina virtual com a ID da instância 3 do VMSS chamado VMScaleSet002 que pertence ao grupo de recursos chamado Group002.
...
### -VMScaleSetName
Especiem o nome do VMSS que este cmdlet remove.
