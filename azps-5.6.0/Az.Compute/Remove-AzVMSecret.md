...
## DESCRIPTION
O Remove-AzVMSecret cmdlet remove (a) segredo(s) de um objeto de máquina virtual.
...
### -SourceVaultId
Especifica uma matriz de IDs do cofre de origem que esse cmdlet remove.
...
### -VM
Especifica a máquina virtual da qual esse cmdlet remove (a) segredo(s).
