...
Essa extensão permite que sua máquina virtual participe de um domínio.
...
### -JoinOption
Especifica a opção de junção. Para ver opções de [junção, consulte fJoinOptions](https://docs.microsoft.com/windows/desktop/api/lmjoin/nf-lmjoin-netjoindomain)
...
### -OUPath
Especifica uma unidade organizacional (UO) para a conta de domínio.
Insira o nome diferenciado completo da UO entre aspas.
...
Geralmente, uma reinicialização é necessária para tornar a alteração efetiva.
