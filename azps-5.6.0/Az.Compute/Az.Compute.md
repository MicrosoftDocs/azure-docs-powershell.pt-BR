...
ms.locfileid: "101887568"
---
# Módulo Az.Compute
## Descrição
Este tópico exibe os tópicos de ajuda para os Cmdlets do Azure Compute.

## Az.Compute Cmdlets
### [Add-AzContainerServiceAgentPoolProfile](Add-AzContainerServiceAgentPoolProfile.md)
Adiciona um perfil de pool de agente de serviço de contêiner.

### [Add-AzImageDataDisk](Add-AzImageDataDisk.md)
Adiciona um disco de dados a um objeto image.

### [Add-AzVhd](Add-AzVhd.md)
Carrega um disco rígido virtual de uma máquina virtual local para um blob em uma conta de armazenamento em nuvem no Azure.
...
Exportar logs que mostram o total de solicitações de Api aceleradas para essa assinatura na janela de tempo determinado.
...
Listar todos os Skus de recurso de computação
...
Obtém as propriedades de Acessos de Disco
...
Obter ou listar galerias.

### [Get-AzGalleryImageDefinition](Get-AzGalleryImageDefinition.md)
Obter ou listar definições de imagem de galeria.

### [Get-AzGalleryImageVersion](Get-AzGalleryImageVersion.md)
Obter ou listar versões de imagem da galeria.
...
Obtém as configurações da extensão DSC em uma máquina virtual específica.
...
Obtém todas as versões de uma extensão do Azure.
...
Obtém os editores VMImage.

### [Get-AzVMImageSku](Get-AzVMImageSku.md)
Obtém SKUs VMImage.

### [Get-AzVMRunCommandDocument](Get-AzVMRunCommandDocument.md)
Obter um documento de comando de executar.

### [Get-AzVMSize](Get-AzVMSize.md)
Obtém tamanhos de máquina virtual disponíveis.

### [Get-AzVMSqlServerExtension](Get-AzVMSqlServerExtension.md)
Obtém as configurações de uma SQL Server em uma máquina virtual.

### [Get-AzVmss](Get-AzVmss.md)
Obtém as propriedades de um VMSS.

### [Get-AzVmssDiskEncryption](Get-AzVmssDiskEncryption.md)
Mostra o status de criptografia de disco de um conjunto de escala de VM.

### [Get-AzVmssRollingUpgrade](Get-AzVmssRollingUpgrade.md)
Mostra o status da atualização de rolagem do conjunto de escalas de máquina virtual mais recente.
...
Obtém o uso da contagem principal da máquina virtual para um local.
...
Avalie o estado de patch de uma máquina virtual.

### [Invoke-AzVMReimage](Invoke-AzVMReimage.md)
Reimage uma máquina virtual do Azure.
...
Cria um recurso de Acesso ao Disco
...
Cria um conjunto de criptografia de disco.
...
Criar uma definição de imagem de galeria.
...
Cria um objeto de atualização de instantâneo configurável.
...
Cria um objeto de disco de dados local para uma máquina virtual ou uma VM Vmss.

### [New-AzVMSqlServerAutoBackupConfig](New-AzVMSqlServerAutoBackupConfig.md)
Cria um objeto de configuração para SQL Server backup automático.
...
Cria um objeto de configuração para SQL do cofre de chaves do servidor em uma máquina virtual.
...
Cria um objeto IP Tag para uma interface de rede de um VMSS.
...
Remove a extensão do AEM de uma máquina virtual.

### [Remove-AzVMBackup](Remove-AzVMBackup.md)
Remove o backup de uma máquina virtual.

### [Remove-AzVMChefExtension](Remove-AzVMChefExtension.md)
Remove a extensão do Chefe de uma máquina virtual.
...
Remove um disco de dados de uma máquina virtual.
...
Remove uma extensão de uma máquina virtual.

### [Remove-AzVMNetworkInterface](Remove-AzVMNetworkInterface.md)
Remove uma interface de rede de uma máquina virtual.

### [Remove-AzVMSecret](Remove-AzVMSecret.md)
Remove (a) secret(s) de um objeto de máquina virtual

### [Remove-AzVMSqlServerExtension](Remove-AzVMSqlServerExtension.md)
Remove uma SQL Server de uma máquina virtual.
...
Remove um disco de dados de uma VM de conjunto de escala de máquina virtual
...
Define as propriedades da chave de criptografia de disco em um objeto de disco.

### [Set-AzDiskImageReference](Set-AzDiskImageReference.md)
Define as propriedades de referência da imagem em um objeto de disco.

### [Set-AzDiskKeyEncryptionKey](Set-AzDiskKeyEncryptionKey.md)
Define as propriedades principais da chave de criptografia em um objeto de disco.

### [Set-AzDiskUpdateDiskEncryptionKey](Set-AzDiskUpdateDiskEncryptionKey.md)
Define as propriedades da chave de criptografia de disco em um objeto de atualização de disco.

### [Set-AzDiskUpdateKeyEncryptionKey](Set-AzDiskUpdateKeyEncryptionKey.md)
Define as propriedades principais da chave de criptografia em um objeto de atualização de disco.
...
Define as propriedades da chave de criptografia de disco em um objeto instantâneo.

### [Set-AzSnapshotImageReference](Set-AzSnapshotImageReference.md)
Define as propriedades de referência da imagem em um objeto instantâneo.

### [Set-AzSnapshotKeyEncryptionKey](Set-AzSnapshotKeyEncryptionKey.md)
Define as propriedades principais da chave de criptografia em um objeto instantâneo.
...
Define as propriedades principais da chave de criptografia em um objeto de atualização de instantâneo.
...
Define as propriedades de extensão de backup em uma máquina virtual.

### [Set-AzVMBginfoExtension](Set-AzVMBginfoExtension.md)
Adiciona a extensão BGInfo a uma máquina virtual.
...
Adiciona uma extensão do Chefe a uma máquina virtual.
...
Atualiza propriedades de extensão ou adiciona uma extensão a uma máquina virtual.
...
Define o perfil de diagnóstico de inicialização do conjunto de escalas da máquina virtual.
...
Define o estado do serviço de orquestração para o VMSS.
...
Inicia o VMSS ou um conjunto de máquinas virtuais no VMSS.

### [Start-AzVmssRollingOSUpgrade](Start-AzVmssRollingOSUpgrade.md)
Inicia uma atualização de rolagem para mover todas as instâncias de conjunto de escala de máquina virtual para a versão mais recente disponível do sistema operacional de imagem da plataforma.
...
Cancela a atualização atual do conjunto de escala da máquina virtual.

### [Test-AzVMAEMExtension](Test-AzVMAEMExtension.md)
Verifica a configuração da extensão do AEM.

### [Update-AzAvailabilitySet](Update-AzAvailabilitySet.md)
Atualiza um conjunto de disponibilidade.
