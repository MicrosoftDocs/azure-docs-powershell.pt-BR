...
## DESCRIPTION
O cmdlet **Set-AzVMCustomScriptExtension** adiciona uma Extensão de Máquina Virtual de script personalizada a uma máquina virtual.
...
Este comando adiciona um script personalizado à máquina virtual chamada VirtualMachine07.
...
### -ContainerName
Especifica o nome do contêiner de armazenamento do Azure onde esse cmdlet armazena o script.
...
### -FileName
Especifica o nome do arquivo de script. Se o arquivo for armazenado no armazenamento do Blob do Azure, o valor do nome do arquivo será sensível a minúsculas. Os nomes de arquivos armazenados no armazenamento do Arquivo do Azure não são sensíveis a minúsculas.
...
### -SecureExecution
Indica que esse cmdlet garante que o valor do parâmetro *Run* não seja registrado no servidor ou retornado ao usuário usando a API de extensão GET.
O valor de *Run pode* conter segredos ou senhas a serem passadas para o arquivo de script com segurança.
...
Para obter a versão, execute o cmdlet Get-AzVMExtensionImage com um valor Microsoft.Compute para o parâmetro *PublisherName* e CustomScriptExtension para o *parâmetro Type.*
