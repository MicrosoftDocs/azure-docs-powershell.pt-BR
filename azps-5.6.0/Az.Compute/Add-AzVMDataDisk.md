...
O primeiro comando cria um objeto de máquina virtual e o armazena na $VirtualMachine variável.
O comando atribui um nome e tamanho à máquina virtual.
Os dois comandos a seguir atribuem caminhos para a imagem de dados e discos de dados para as $DataImageUri e $DataDiskUri variáveis respectivamente.
...
O primeiro comando cria um objeto de máquina virtual e o armazena na $VirtualMachine variável.
O comando atribui um nome e tamanho à máquina virtual.
Os comandos a seguir atribuem caminhos do disco de dados à $DataDiskUri variável.
Essa abordagem é usada para melhorar a capacidade de leitura dos comandos a seguir.
...
### -VhdUri
Especifica o URI (Uniform Resource Identifier) para o arquivo de disco rígido virtual (VHD) a ser criado quando uma imagem de plataforma ou imagem de usuário é usada.
Este cmdlet copia o objeto binário de imagem grande (blob) para esse local.
Este é o local para iniciar a máquina virtual.
