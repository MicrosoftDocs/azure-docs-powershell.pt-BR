...
## DESCRIPTION
O cmdlet **Remove-AzVmssDiagnosticsExtension** remove uma extensão de diagnóstico do Conjunto de Escala de Máquina Virtual (VMSS).
...
Este comando remove a extensão de diagnóstico do VMSS.
