...
Este comando obtém as propriedades de exibição de modelo e de exibição de instância da máquina virtual chamada VirtualMachine07.
...
Este comando especifica o *parâmetro Status.*
...
Este comando obtém propriedades para todas as máquinas virtuais no grupo de recursos chamado ResourceGroup11.
...
Este comando obtém todas as máquinas virtuais na região dos EUA Ocidental.
...
Esse comando obtém todas as máquinas virtuais em sua assinatura que começam com "test".
...
### -DisplayHint
Determina como o objeto da máquina virtual é exibido.
Os valores válidos são: -- Compacto: exibe somente propriedades de nível superior -- Expand: exibe todas as propriedades em todos os níveis
