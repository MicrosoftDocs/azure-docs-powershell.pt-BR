...
Este comando remove a extensão Diagnóstico de uma máquina virtual chamada ContosoVM22.
O comando passa o resultado para o cmdlet Update-AzVM usando o operador de pipeline.
