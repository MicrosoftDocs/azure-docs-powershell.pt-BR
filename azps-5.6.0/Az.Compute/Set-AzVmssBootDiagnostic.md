...
### Exemplo 1: definir a propriedade de perfil de diagnóstico de inicialização para um VMSS
```
...
Este comando define a propriedade de perfil de diagnóstico de inicialização para a VMSS chamada ContosoVMSS.
