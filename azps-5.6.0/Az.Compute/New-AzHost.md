...
Este comando cria um host do Sku determinado no determinado grupo de host e no local determinado.
...
Especifica se o host deve ser substituído automaticamente em caso de falha. O valor é padrão para "true" quando não fornecido.
...
### -LicenseType
Especifica o tipo de licença de software que será aplicado às VMs implantadas no host. Os valores possíveis são: None, Windows_Server_Hybrid e Windows_Server_Perpetual.  O valor padrão é None.
