...
## DESCRIPTION
O cmdlet **Set-AzSnapshotDiskEncryptionKey** define as propriedades da chave de criptografia de disco em um objeto instantâneo.
...
### -Instantâneo
Especifica um objeto instantâneo local.
