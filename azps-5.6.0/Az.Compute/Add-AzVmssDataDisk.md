...
## DESCRIPTION
O cmdlet **Add-AzVmssDataDisk** adiciona um disco de dados à instância do Conjunto de Escala de Máquina Virtual (VMSS).
...
### -DiskIOPSReadWrite
Especifica o Read-Write IOPS do disco gerenciado. Deve ser usado somente quando StorageAccountType for UltraSSD_LRS. Se não for especificado, um valor padrão seria atribuído com base no diskSizeGB.
...
### -DiskMBpsReadWrite
Especifica a largura de banda em MB por segundo para o disco gerenciado. Deve ser usado somente quando StorageAccountType for UltraSSD_LRS. Se não for especificado, um valor padrão seria atribuído com base no diskSizeGB.
