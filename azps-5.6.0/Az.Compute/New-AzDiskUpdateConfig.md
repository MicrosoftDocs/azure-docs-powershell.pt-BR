...
O primeiro comando cria um objeto de atualização de disco vazio local com tamanho de 10 GB Premium_LRS tipo de conta de armazenamento. Ele também define o tipo de sistema operacional do Windows e habilita as configurações de criptografia. O segundo e o terceiro comandos definirão as configurações de chave de criptografia de disco e chave de criptografia para o objeto de atualização de disco.
...
Este comando atualiza um disco existente com o nome 'Disk01' no grupo de recursos 'ResourceGroup01' para o tamanho do disco de 10 GB.
...
### -DiskMBpsReadOnly
A produtividade total (MBps) que será permitida em todas as VMs que montam o disco compartilhado como ReadOnly. MBps significa milhões de bytes por segundo - MB aqui usa a notação ISO, de potências de 10.
