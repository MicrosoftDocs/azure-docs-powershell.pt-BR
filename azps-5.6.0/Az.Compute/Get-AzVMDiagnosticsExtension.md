...
Este comando obtém a extensão de diagnóstico aplicada à máquina virtual chamada ContosoVM22.
...
### -Name
Especifica o nome da extensão Diagnostics para a qual este cmdlet obtém configurações.
