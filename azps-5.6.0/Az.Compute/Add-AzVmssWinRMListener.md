...
## DESCRIPTION
O cmdlet **Add-AzVmssWinRMListener** adiciona um ouvinte do Windows Remote Management (WinRM) no Conjunto de Escala de Máquina Virtual (VMSS).

## EXEMPLOS

### Exemplo 1: Adicionar um ouvinte WinRM ao VMSS
```
...
Este exemplo adiciona um ouvinte WinRM ao VMSS.
...
O segundo comando adiciona um ouvinte WinRM de protocolo HTTP com o certificado na URL especificada ao VMSS.

## PARÂMETROS

### -CertificateUrl
Especifica um link, como URL, do certificado com o qual novas máquinas virtuais são provisionadas.
