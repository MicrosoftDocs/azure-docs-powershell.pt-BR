...
Quando uma configuração é aplicada, esse cmdlet produz uma saída consistente com o cmdlet Start-DscConfiguration.
...
O Set-AzVMDscExtension cmdlet define esse nome como Microsoft.Powershell.DSC, que é o mesmo valor usado por **Get-AzVMDscExtensionStatus**.
Especifique esse parâmetro somente se você alterou o nome padrão no cmdlet Set ou usou um nome de recurso diferente em um modelo do Gerenciador de Recursos.
...
### -VMName
Especifica o nome de uma máquina virtual para a qual este cmdlet obtém o status de extensão do DSC.
