...
## DESCRIPTION
O cmdlet **New-AzVMSqlServerAutoBackupConfig** cria um objeto de configuração para SQL Server backup automático.

## EXEMPLOS

### Exemplo 1: criar uma configuração de backup automática usando URI de armazenamento e chave de conta
```
...
Este comando cria um objeto de configuração de backup automático especificando URI de armazenamento e chave de conta.
...
### Exemplo 3: criar uma configuração de backup automática usando o contexto de armazenamento com criptografia e senha
```
...
Este comando cria e armazena um objeto de configuração de backup automático.
...
A senha foi armazenada anteriormente como uma cadeia de caracteres segura na $CertificatePassword variável.
...
### -CertificatePassword
Especifica uma senha para criptografar o certificado usado para executar SQL Server backups criptografados.
...
### -Enable
Indica que o backup automatizado para a SQL Server virtual está habilitado.
...
Isso atualiza suas configurações de Backup Gerenciado para seguir esse cronograma.
...
### -FullBackupFrequency
Frequência de Backup Completo do Sql Server, diariamente ou semanalmente
...
### -FullBackupStartHour
Hora do dia (0-23) em que o Backup Completo do Sql Server deve começar
...
Frequência de Backup de Log do Sql Server, uma vez a cada 1-60 minutos
...
O padrão é a conta de armazenamento associada à máquina SQL Server virtual.
