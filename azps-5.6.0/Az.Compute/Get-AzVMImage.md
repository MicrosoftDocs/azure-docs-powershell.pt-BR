...
Este comando obtém todas as versões do VMImage que corresponderem aos valores especificados.
...
Este comando obtém uma versão específica do VMImage que corresponde aos valores especificados.
...
Este comando obtém todas as versões do VMImage que corresponderem aos valores especificados com a filtragem sobre a versão.
...
### -Location
Especifica o local de um VMImage.
...
Para obter um editor de imagens, use o Get-AzVMImagePublisher cmdlet.
...
Para obter um SKU, use o Get-AzVMImageSku cmdlet.
