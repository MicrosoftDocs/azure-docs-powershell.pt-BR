...
### -CreateOption
A opção criar disco de dados da máquina virtual.
...
### -DiskEncryptionSetId
A ID do conjunto de criptografia de disco gerenciado da máquina virtual.
...
### -DiskSizeInGB
O tamanho do disco de dados da máquina virtual em GB.
...
### -Lun
Lun do disco de dados da máquina virtual.
...
### -SourceImageUri
Uri da imagem de origem do disco do sistema operacional da máquina virtual.
...
### -VhdUri
O disco de dados da máquina virtual vhd Uri.
