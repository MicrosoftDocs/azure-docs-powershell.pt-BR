...
## DESCRIPTION
O cmdlet **Stop-AzVM** interrompe uma máquina virtual do Azure.
...
Este comando interrompe a máquina virtual chamada VirtualMachine07 em ResourceGroup11.
...
### -SkipShutdown
Para solicitar o desligamento de VM não-graciosa ao manter a VM provisionada.
...
### -StayProvisioned
O cmdlet interrompe todas as máquinas virtuais dentro do VMSS, mas não as negocia. A conta é cobrada pelas máquinas virtuais paradas.
