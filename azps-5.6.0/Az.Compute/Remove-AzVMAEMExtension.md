...
Este comando remove a extensão do AEM para a máquina virtual chamada contoso-server.
...
### -Name
Especifica o nome da máquina virtual da qual este cmdlet remove a extensão do AEM.
...
Este cmdlet remove a extensão do AEM dessa máquina virtual.
...
Este cmdlet remove a extensão do AEM para a máquina virtual especificada por esse parâmetro.
