...
Este comando obtém as propriedades de um recurso de Acesso ao Disco chamado 'DiskAccess01' no grupo de recursos 'ResourceGroup01'.
...
Este comando obtém as propriedades de todos os acessos de disco no grupo de recursos 'ResourceGroup01'.


### Exemplo 3: Obter todo o Acesso ao Disco
```
...
Este comando obtém as propriedades de todos os acessos de disco sob a assinatura.

### Exemplo 4: Obter todo o Acesso ao Disco usando Caractere Curinga
```
...
Este comando obtém as propriedades de todos os acessos em disco sob o nome da assinatura, começando com 'DiskAccessMicrosoft'.

### Exemplo 5: Obter Acesso ao Disco usando ResourceId.
```
...
Este comando obtém as propriedades de um Acesso de Disco com o ResourceId determinado.
...
### -ResourceId
ID do recurso para o acesso ao disco.
