...
## SYNOPSIS
Inicia a operação de limpeza de failover de teste.
...
## DESCRIPTION
O cmdlet **Start-AzRecoveryServicesAsrTestFailoverCleanupJob** inicia a operação de limpeza de failover de teste em um item ou plano de recuperação protegido por replicação no qual um failover de teste foi executado.

## EXEMPLOS

### Exemplo 1

Trabalho para rastrear a limpeza de failover de teste de uma recuperação de recuperação de site do AzurePlan.
...
Inicia a operação de limpeza de failover de teste. (gerado automaticamente)
...
### -ResourceId
ID de recurso do item protegido de replicação /plano de recuperação para failover de teste de limpeza.
