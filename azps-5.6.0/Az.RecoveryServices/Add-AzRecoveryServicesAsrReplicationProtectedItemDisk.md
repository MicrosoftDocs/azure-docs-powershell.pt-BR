...
Inicie a operação para adicionar a configuração de disco especificada para proteção. Canalização de item protegido de replicação de entrada.

## PARÂMETROS

### -AzureToAzureDiskReplicationConfiguration
Especifica a configuração de disco a ser usada para proteção de disco do Azure para o cenário de recuperação de desastres do Azure.
