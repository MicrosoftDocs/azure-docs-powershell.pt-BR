...
## DESCRIPTION
O cmdlet **Get-AzRecoveryServicesAsrNetwork** obtém informações sobre as redes de Recuperação de Site do Azure para o cofre atual de Recuperação de Site do Azure.
...
Obtém todas as redes conhecidas no tecido especificado.
