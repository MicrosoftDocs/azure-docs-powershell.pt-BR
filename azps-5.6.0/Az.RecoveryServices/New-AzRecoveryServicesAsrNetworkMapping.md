...
## DESCRIPTION
O cmdlet **New-AzRecoveryServicesAsrNetworkMapping** inicia a operação de criação de um mapeamento de rede ASR entre duas redes e retorna o objeto de trabalho ASR para o trabalho ASR usado para rastrear a operação.
...
Inicia a operação de criação de mapeamento de rede usando o nome especificado, as redes primárias e de recuperação e retorna um trabalho ASR para rastrear a operação.
...
Inicia o mapeamento de rede para a operação de criação usando o nome especificado, as redes primárias e de recuperação e retorna um trabalho ASR para controlar a operação(cenário do Azure para o Azure).

## PARÂMETROS

### -AzureToAzure
Sinalizador para criar cenário do AzureToAzure.
...
### -PrimaryFabric
Especifica o tecido ASR onde o mapeamento deve ser criado.
...
### -RecoveryFabric
O objeto de malha recuperação de site do Azure correspondente à região de recuperação do Azure.
