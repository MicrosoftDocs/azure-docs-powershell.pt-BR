...
Esse comando obtém a política de proteção chamada DefaultPolicy e a armazena na variável $Pol de segurança.

## PARÂMETROS

### -BackupManagementType
A classe de recursos que está sendo protegida. Atualmente, os valores suportados para este cmdlet são AzureVM, AzureStorage, AzureWorkload
...
### -WorkloadType
Tipo de carga de trabalho do recurso. Os valores atuais suportados são AzureVM, AzureFiles, MSSQL
