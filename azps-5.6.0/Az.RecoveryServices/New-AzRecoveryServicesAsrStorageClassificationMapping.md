...
## DESCRIPTION
O cmdlet **New-AzRecoveryServicesAsrStorageClassificationMapping** cria uma classificação de armazenamento que mapeia o cofre dos Serviços de Recuperação.
...
Inicia a operação de criação de mapeamento de classificação de armazenamento com os parâmetros especificados e retorna o trabalho ASR usado para rastrear a operação.
