...
## DESCRIPTION
O Disable-AzRecoveryServicesBackupRPMountScript cmdlet desmonta os arquivos do ponto de recuperação que foram montados anteriormente usando o cmdlet Get-AzRecoveryServicesBackupRPMountScript.

## EXEMPLOS

### Exemplo 1: desmonte um ponto de recuperação
```powershell
