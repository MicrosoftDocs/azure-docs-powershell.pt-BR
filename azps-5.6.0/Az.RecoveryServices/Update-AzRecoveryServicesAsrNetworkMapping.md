...
## SYNOPSIS
Atualiza o mapeamento de rede de recuperação de site do azure especificado.
...
## DESCRIPTION
O cmdlet **Update-AzRecoveryServicesAsrNetworkMapping** atualiza o mapeamento de rede de Recuperação de Site especificado do Azure.
...
Inicia a operação de mapeamento de rede de atualização usando os parâmetros especificados e retorna o trabalho ASR usado para rastrear a operação.
...
### -InputObject
Objeto Input: especifica o objeto de mapeamento de rede ASR correspondente ao mapeamento de rede ASR a ser atualizado.
