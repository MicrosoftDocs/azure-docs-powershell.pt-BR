...
## SYNOPSIS
Cria um Contêiner de Proteção de Recuperação de Site do Azure dentro do tecido especificado.
...
## DESCRIPTION
O New-AzRecoveryServicesAsrProtectionContainer cmdlet cria um Contêiner de Proteção no Azure Site Recovery Fabric especificado.
...
Inicia a criação do contêiner de proteção com os parâmetros especificados e retorna o trabalho ASR usado para rastrear a operação.
