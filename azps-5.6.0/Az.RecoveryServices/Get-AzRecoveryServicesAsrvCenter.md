...
## DESCRIPTION
O cmdlet **Get-AzRecoveryServicesAsrvCenter** obtém detalhes dos servidores vCenter registrados para descoberta no servidor de Configuração especificado pelo fabrico ASR.
...
Obter vCenter de recuperação de site do azure pelo nome de malha e nome do vCenter.
...
Obter a lista vCenter de recuperação de site do azure por nome de malha.
