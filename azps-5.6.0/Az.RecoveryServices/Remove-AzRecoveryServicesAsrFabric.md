...
## SYNOPSIS
Exclui o Azure Site Recovery Fabric especificado do cofre dos Serviços de Recuperação.
...
## DESCRIPTION
O cmdlet **Remove-AzRecoveryServicesAsrFabric** remove o tecido especificado de Recuperação de Site do Azure do cofre de serviços de recuperação.
...
Inicia a exclusão de malha especificada e retorna o trabalho ASR usado para rastrear a operação.
...
### -InputObject
O objeto de entrada para o cmdlet: o objeto de malha ASR correspondente ao tecido a ser excluído.
