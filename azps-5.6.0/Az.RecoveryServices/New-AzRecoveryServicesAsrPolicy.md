...
Inicia a operação de criação de política de replicação usando os parâmetros especificados e retorna o trabalho ASR usado para rastrear a operação.
...
### -AzureToAzure
O parâmetro Switch especifica o cenário para a criação de política do azure para o azure.
...
### -AzureToVMware
O parâmetro Switch especifica o cenário para a criação de política do azure para vMWare.
...
### -HyperVToAzure
Parâmetro Switch para especificar a política deve ser usado para replicar máquinas virtuais hyper-V para o Azure
...
Mantenha os pontos de recuperação para determinado tempo em horas.
...
### -VmmToVmm
O parâmetro Switch para especificar a política deve ser usado para replicar entre sites do Hyper-V gerenciados por um servidor VMM.
...
### -VMwareToAzure
Parâmetro switch especificando que a política de replicação que está sendo criada será usada para replicar máquinas virtuais VMware e/ou servidores físicos para o Azure.
