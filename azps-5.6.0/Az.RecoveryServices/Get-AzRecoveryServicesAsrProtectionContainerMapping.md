...
## SYNOPSIS
Obtém mapeamentos do Contêiner de Proteção de Recuperação de Site do Azure.
...
## DESCRIPTION
O cmdlet **Get-AzRecoveryServicesAsrProtectionContainerMapping** obtém informações sobre o contêiner de proteção para mapeamentos(associação) de políticas de replicação no cofre para o contêiner de proteção ASR especificado.
...
Lista de mapeamentos de contêineres de proteção para contêiner.
...
### -Name
Especifica o nome do mapeamento do contêiner de proteção a ser encontrado.
...
### -ProtectionContainer
Obter mapeamentos de contêiner de proteção correspondentes ao objeto de contêiner de proteção ASR especificado.
