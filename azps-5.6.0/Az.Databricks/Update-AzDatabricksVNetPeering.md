...
### Exemplo 1: Atualizar AllowForwardedTraffic do paring vnet
```powershell
...
Este comando atualiza AllowForwardedTraffic do paring vnet.

### Exemplo 2: Atualizar AllowForwardedTraffic de paração de vnet por objeto
```powershell
...
Este comando atualiza AllowForwardedTraffic de paração de vnet por objeto.
...
[System.Management.Automation.SwitchParameter] Se as VMs no espaço de rede virtual local poderão acessar as VMs no espaço de rede virtual remota.
...
### -UseRemoteGateway
[System.Management.Automation.SwitchParameter] Se os gateways remotos puderem ser usados nessa rede virtual.
Se o sinalizador for definido como true, e allowGatewayTransit no peering remoto também for verdadeiro, a rede virtual usará gateways de rede virtual remota para transporte.
Somente um paring pode ter esse sinalizador definido como true.
