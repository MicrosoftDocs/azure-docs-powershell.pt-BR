...
### Exemplo 1: Criar um espaço de trabalho Databricks
```powershell
...
Este comando cria um espaço de trabalho Databricks.

### Exemplo 2: Criar um espaço de trabalho Databricks com uma rede virtual personalizada
```powershell
...
Este comando cria um espaço de trabalho Databricks com rede virtual personalizada em um grupo de recursos.

### Exemplo 3: Criar um espaço de trabalho Databricks com criptografia habilitada
```powershell
...
Este comando cria um espaço de trabalho Databricks e o define para se preparar para criptografia.
Consulte os exemplos de Update-AzDatabricksWorkspace para obter mais configurações de criptografia.
...
### -EnableNoPublicIP
O valor que deve ser usado para este campo.
...
Habilita a Identidade Gerenciada para conta de armazenamento gerenciado.
...
Um booleano indicando se o sistema de arquivos raiz DBFS será ou não habilitado com camada secundária de criptografia com chaves gerenciadas da plataforma para dados em repouso.
...
### -VirtualNetworkId
A ID de uma Rede Virtual onde esse Cluster databricks deve ser criado.
