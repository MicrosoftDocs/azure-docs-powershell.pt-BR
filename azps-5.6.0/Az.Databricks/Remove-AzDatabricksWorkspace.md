...
### Exemplo 1: Remover um espaço de trabalho Databricks
```powershell
PS C:\> Remove-AzDatabricksWorkspace -ResourceGroupName testgroup -Name databricks-test
```

Este comando remove um espaço de trabalho Databricks de um grupo de recursos.

### Exemplo 2: Remover um espaço de trabalho Databricks por objeto
```powershell
...
INPUTOBJECT <IDatabricksIdentity> : Parâmetro Identity
  - `[Id <String>]`: Caminho da identidade do recurso
  - `[PeeringName <String>]`: O nome do paring vNet do espaço de trabalho.
