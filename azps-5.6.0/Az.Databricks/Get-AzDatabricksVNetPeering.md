...
Este comando lista todos os pares de vnet em um databricks.
...
Este comando obtém um par de vnet.

### Exemplo 3: Obter um par de vnet por objeto
```powershell
...
Este comando obtém um ponto de vnet por objeto.
