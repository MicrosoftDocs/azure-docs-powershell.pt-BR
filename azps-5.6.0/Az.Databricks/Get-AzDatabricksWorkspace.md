...
Este comando lista todos os espaços de trabalho Databricks em uma assinatura.

### Exemplo 3: Listar todos os espaços de trabalho Databricks em um grupo de recursos
```powershell
...
Este comando lista todos os espaços de trabalho Databricks em um grupo de recursos.
