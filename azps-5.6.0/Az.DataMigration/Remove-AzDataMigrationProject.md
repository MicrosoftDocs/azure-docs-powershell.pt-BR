...
## DESCRIPTION
O Remove-AzDataMigrationProject cmdlet remove um projeto do Serviço de Migração de Banco de Dados do Azure do Azure. O fornecimento do parâmetro DeleteRunningTask remove todas as tarefas do Serviço de Migração de Banco de Dados do Azure associadas ao projeto que está sendo removido. 
...
O exemplo acima remove o projeto do Serviço de Migração de Banco de Dados do Azure com base no objeto PSProject como parâmetro de entrada.
