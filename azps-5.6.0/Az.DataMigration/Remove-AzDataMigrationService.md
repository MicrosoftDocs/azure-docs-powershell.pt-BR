...
O exemplo acima remove uma instância do Serviço de Migração de Banco de Dados do Azure chamado TestService que está contido em um Grupo de Recursos do Azure chamado MyResourceGroup.
