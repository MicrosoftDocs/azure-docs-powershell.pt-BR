...
## DESCRIPTION
O Get-AzDataMigrationService cmdlet recupera as propriedades associadas a uma instância do Serviço de Migração de Banco de Dados do Azure com base no nome do serviço e no nome do Grupo de Recursos do Azure como parâmetros de entrada. 
...
O exemplo acima recupera as propriedades da instância do Serviço de Migração de Banco de Dados do Azure chamada testService. 
