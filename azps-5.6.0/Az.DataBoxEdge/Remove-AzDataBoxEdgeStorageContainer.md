...
## DESCRIPTION
O cmdlet **Remove-AzDataBoxEdgeStorageContainer** remove um contêiner de armazenamento associado para a conta de Armazenamento de Borda em um dispositivo de Borda da Caixa de Dados. Você pode especificar o nome do contêiner de armazenamento a ser removido como parâmetro.
