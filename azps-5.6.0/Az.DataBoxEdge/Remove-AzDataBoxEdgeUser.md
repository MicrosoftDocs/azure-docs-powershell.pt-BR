...
## DESCRIPTION
O cmdlet **Remove-AzDataBoxEdgeUser** remove um usuário no dispositivo de Borda da Caixa de Dados. Há suporte para a criação de apenas usuários `Share` do tipo.
