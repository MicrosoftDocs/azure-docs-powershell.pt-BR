...
## DESCRIPTION
O cmdlet **Get-AzDataBoxEdgeJob** obtém os trabalhos ativos em um dispositivo de Borda da Caixa de Dados. Você pode mencionar o parâmetro Name para obter detalhes de um trabalho específico.
