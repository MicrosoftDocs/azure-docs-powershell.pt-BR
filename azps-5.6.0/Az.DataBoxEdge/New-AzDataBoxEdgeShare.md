...
### -ContainerName
Nome do contêiner (Com base no formato de dados especificado, isso representa o nome dos arquivos do Azure/pageblob/blob de bloqueio)
...
### -DataFormat
Definir Formato de Dados ex: PageBlob, BlobBlob
...
### -NFS
AccessProtocol no caso de criar o Share
