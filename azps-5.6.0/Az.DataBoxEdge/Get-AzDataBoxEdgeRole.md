...
## DESCRIPTION
O cmdlet **Get-AzDataBoxEdgeRole** busca as funções de IoT disponíveis para um dispositivo de Borda de Caixa de Dados. Você pode mencionar o parâmetro Name para obter os detalhes de uma função IoT específica.
