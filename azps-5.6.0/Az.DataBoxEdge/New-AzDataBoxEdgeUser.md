...
## DESCRIPTION
O cmdlet **New-AzDataBoxEdgeUser** cria um novo usuário para o dispositivo de Borda da Caixa de Dados. Há suporte para a criação de apenas usuários `Share` do tipo.
