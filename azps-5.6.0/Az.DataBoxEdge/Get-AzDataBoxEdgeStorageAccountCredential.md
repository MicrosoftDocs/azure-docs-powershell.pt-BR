...
## DESCRIPTION
O cmdlet **Get-AzDataBoxEdgeStorageAccountCredential** obtém as credenciais da conta de armazenamento para a conta de armazenamento correspondente no dispositivo de Borda da Caixa de Dados. Você pode especificar parâmetros Name, Resource Group Name e Device Name para obter informações sobre uma credencial de conta de armazenamento específica.
