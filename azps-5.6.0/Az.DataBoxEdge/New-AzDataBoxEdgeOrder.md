...
## DESCRIPTION
O cmdlet **New-AzDataBoxEdgeOrder** cria uma nova ordem para um dispositivo de Borda de Caixa de Dados. Um recurso de dispositivo de Borda da Caixa de Dados precisa ser criado primeiro antes de criar uma ordem. Você pode especificar detalhes como pessoa de contato, nome da empresa, email, endereço etc. como parâmetros para a criação do pedido.
...
### -Email
Lista de emails para receber atualizações, Aceita no máximo 10 emails
