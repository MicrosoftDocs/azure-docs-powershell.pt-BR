...
## DESCRIPTION
O cmdlet **New-AzDataBoxEdgeBandwidthSchedule** cria um novo Cronograma de Largura de Banda para um dispositivo de Borda de Caixa de Dados para ajudar a gerenciar o uso da largura de banda.
...
### -UnlimitedBandwidth
Definirá Largura de Banda Ilimitada, se definido como false definirá o valor padrão como 20 Mbps
