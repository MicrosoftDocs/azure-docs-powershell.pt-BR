...
Você pode obter um perfil usando o Get-AzTrafficManagerProfile cmdlet.
...
Para remover um ponto de extremidade e fazer alterações em uma única operação, use o cmdlet Remove-AzTrafficManagerEndpoint.
