...
## DESCRIPTION
O cmdlet **Remove-AzTrafficManagerIpAddressRange** remove um intervalo de endereços IP de um objeto de ponto de extremidade local do Gerenciador de Tráfego do Azure.
...
O segundo comando remove um intervalo de endereços IP do ponto de extremidade armazenado $TrafficManagerEndpoint.
...
### -First
Especifica o primeiro endereço IP no intervalo a ser removido.
