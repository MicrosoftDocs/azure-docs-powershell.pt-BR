...
## DESCRIPTION
O cmdlet **Remove-AzTrafficManagerCustomHeaderFromProfile** remove informações de header personalizadas de um objeto de perfil local do Gerenciador de Tráfego do Azure.
...
### Exemplo 1: Remover informações de header personalizadas de um perfil
```
...
O segundo comando remove informações de header personalizadas do perfil armazenado em $TrafficManagerProfile.
...
### -Name
Especifica o nome das informações de header personalizadas a serem removidas.
