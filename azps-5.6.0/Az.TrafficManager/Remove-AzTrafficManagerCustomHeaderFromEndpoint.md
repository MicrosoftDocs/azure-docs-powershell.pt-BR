...
## DESCRIPTION
O cmdlet **Remove-AzTrafficManagerCustomHeaderFromEndpoint** remove informações de header personalizadas de um objeto de ponto de extremidade local do Gerenciador de Tráfego do Azure.
...
O primeiro comando obtém o ponto de extremidade do Azure chamado contoso do perfil chamado ContosoProfile no grupo de recursos chamado ResourceGroup11 e armazena esse objeto na variável $TrafficManagerEndpoint.
O segundo comando remove informações de header personalizadas do ponto de extremidade armazenado em $TrafficManagerEndpoint.
