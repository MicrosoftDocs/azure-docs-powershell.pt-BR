...
## DESCRIPTION
O cmdlet **Add-AzTrafficManagerIpAddressRange** adiciona um intervalo de endereços IP a um objeto de ponto de extremidade local do Gerenciador de Tráfego do Azure.
Você pode obter um ponto de extremidade usando o New-AzTrafficManagerEndpoint ou Get-AzTrafficManagerEndpoint cmdlets.
...
O terceiro comando adiciona o intervalo de endereços IP 9.10.11.0 a 9.10.11.255 ao ponto de extremidade armazenado em $TrafficManagerEndpoint.
O quarto comando verifica se o escopo corresponde ao tamanho do intervalo e adiciona o intervalo de endereços IP 12.13.14.0 a 12.13.14.31 ao ponto de extremidade armazenado em $TrafficManagerEndpoint.
O quinto comando adiciona o intervalo de endereços IP 15.16.17.18 a 15.16.17.18 ao ponto de extremidade armazenado em $TrafficManagerEndpoint.
