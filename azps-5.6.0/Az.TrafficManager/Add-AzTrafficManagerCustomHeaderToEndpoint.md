...
## DESCRIPTION
O cmdlet **Add-AzTrafficManagerCustomHeaderToEndpoint** adiciona informações de header personalizadas a um objeto de ponto de extremidade local do Gerenciador de Tráfego do Azure.
...
### Exemplo 1: Adicionar informações de header personalizadas a um ponto de extremidade
```
...
O segundo comando adiciona informações de header personalizadas ao ponto de extremidade armazenado $TrafficManagerEndpoint.
...
### -Name
Especifica o nome das informações de header personalizadas a serem adicionadas.
...
### -Value
Especifica o valor das informações de header personalizadas a serem adicionadas.
