...
### Exemplo 1: Instâncias de função reimage do serviço de nuvem
```powershell
...
Este comando reimaima 2 instâncias de função ContosoFrontEnd_IN_0 e ContosoBackEnd_IN_1 de serviço de nuvem chamado ContosoCS que pertence ao grupo de recursos chamado ContosOrg.
...
Este comando reimaja todas as instâncias de função do serviço de nuvem chamada ContosoCS que pertencem ao grupo de recursos chamado ContosOrg.
