...
O comando Acima invoca a operação vipswap no serviço cloud com o nome 'BService' e executará a operação assim que o usuário confirmar a ação no prompt de confirmação.
'BService' com ser trocado com seu serviço de nuvem permutável.
