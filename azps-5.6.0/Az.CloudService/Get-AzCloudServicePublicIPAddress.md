...
### Exemplo 1: Obter endereços IP públicos de nível de instância para um determinado nome de serviço de nuvem.
```powershell
...
Obtém o nível de instância de endereços IP públicos para um determinado nome de serviço de nuvem.

### Exemplo 2: Obter endereços IP públicos de nível de instância para um determinado objeto de serviço de nuvem.
```powershell
...
Obtém os endereços IP públicos de nível de instância para um determinado objeto de serviço de nuvem.
