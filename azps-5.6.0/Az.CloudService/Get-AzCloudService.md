...
Este comando obtém todos os serviços de nuvem no grupo de recursos chamado ContosOrg
...
Este comando obtém um serviço de nuvem chamado ContosoCS que pertence ao grupo de recursos chamado ContosOrg.
