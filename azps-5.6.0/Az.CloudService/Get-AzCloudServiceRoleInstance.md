...
Este comando obtém as propriedades de todas as instâncias de função do serviço de nuvem chamada ContosoCS que pertence ao grupo de recursos chamado ContosOrg.

### Exemplo 2: Obter propriedades para instância de função única
```powershell
...
Este comando obtém as propriedades da instância de função chamada ContosoFrontEnd_IN_0 do serviço de nuvem chamado ContosoCS que pertence ao grupo de recursos chamado ContosOrg.
