...
### Exemplo 1: Recriar instância de função de um serviço de nuvem
```powershell
...
Este comando reimaja a instância de função chamada ContosoFrontEnd_IN_0 de serviço de nuvem chamado ContosoCS que pertence ao grupo de recursos chamado ContosOrg.
