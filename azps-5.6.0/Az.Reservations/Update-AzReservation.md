...
Atualiza o AppliedScopeType do especificado `Reservation` para Single e InstanceFlexibility como On.
...
Atualiza o AppliedScopeType do especificado `Reservation` para Shared e InstanceFlexibility como Desligado.
