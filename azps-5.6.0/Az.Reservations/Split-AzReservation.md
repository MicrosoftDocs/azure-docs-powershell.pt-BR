...
Divida o especificado `Reservation` em dois s com as quantidades `Reservation` correspondentes
...
### -Quantity
Inteiros separados por vírgulas para o campo de quantidade dos dois `Reservation` s
...
### -ReservationId
ID do `Reservation` para dividir
