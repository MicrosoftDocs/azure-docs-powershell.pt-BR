...
### Exemplo 1: Remover um membro do bloco de dados
```powershell
PS C:\> Remove-AzBlockchainMember -Name dolauli001 -ResourceGroupName testgroup

```

Este comando remove um membro do bloco de dados.

### Exemplo 2: Remover um membro do bloco de dados
```powershell
...
### -Name
Nome de membro do Bloco de Trabalho
