...
### Exemplo 1: lista os membros do consorciado para um membro do bloco de dados.
```powershell
...
Este comando lista os membros do consorciado para um membro do bloco de dados.
