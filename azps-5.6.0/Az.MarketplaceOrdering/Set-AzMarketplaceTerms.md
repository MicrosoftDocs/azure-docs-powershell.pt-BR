...
## DESCRIPTION
O cmdlet **Set-AzMarketplaceTerms** salva o objeto terms para determinado id(Publisher), id(Product) de oferta e planejar a tupla id(Name).
...
### Exemplo 2
De definir o contrato de editor como "Aceitar". Obter o valor do parâmetro 'Terms' do cmdlet 'Get-AzMarketplaceTerms'
...
### -InputObject
Objeto Terms retornado no Get-AzMarketplaceTerms cmdlet. Este é um parâmetro obrigatório se o parâmetro Accepted for verdadeiro.
...
### -Name
Planejar a cadeia de caracteres de identificador da imagem que está sendo implantada.
...
### -Product
Oferecer cadeia de caracteres de identificador de imagem sendo implantada.
...
### -Publisher
Cadeia de caracteres de identificador do publisher da imagem que está sendo implantada.
