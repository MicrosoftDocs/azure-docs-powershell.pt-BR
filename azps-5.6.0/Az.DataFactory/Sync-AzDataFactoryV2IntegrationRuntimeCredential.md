...
## SYNOPSIS
Sincroniza credenciais entre nós de tempo de execução de integração.
...
## DESCRIPTION
O cmdlet **Sync-AzDataFactoryV2IntegrationRuntimeCredential** sincroniza credenciais locais entre nós de tempo de execução de integração, o que força as credenciais a serem idênticas em todos os nós.

## EXEMPLOS

### Exemplo 1: sincronizar uma credencial de tempo de execução de integração

Sincroniza credenciais entre nós de tempo de execução de integração. (gerado automaticamente)
