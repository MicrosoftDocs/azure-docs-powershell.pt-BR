...
## DESCRIPTION
Este comando obtém o status da assinatura do gatilho de evento para os eventos de serviço externo especificados. O gatilho não pode ser iniciado até que o status retornado seja "Habilitado".
...
Este comando obterá o status da subscrição para o gatilho BlobEnetTrigger1 para os eventos de serviço externos.
