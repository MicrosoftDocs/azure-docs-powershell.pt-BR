...
## SYNOPSIS
Remove um gatilho de um fábrica de dados.
...
## DESCRIPTION
O cmdlet **Remove-AzDataFactoryV2Trigger** remove um gatilho de um fábrica de dados. Se o _parâmetro Force_ for especificado, o cmdlet não solicitará antes de remover o gatilho.
