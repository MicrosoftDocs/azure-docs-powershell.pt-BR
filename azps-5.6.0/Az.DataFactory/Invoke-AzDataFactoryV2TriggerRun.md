...
## DESCRIPTION
O **comando Invoke-AzDataFactoryV2TriggerRun** inicia outra instância de um gatilho executado com uma nova id de executar gatilho.
...
```
Inicia outra instância de um gatilho executado com uma nova id de execução de gatilho, mantendo a mesma windowStartTime e windowEndTime que o gatilho original é executado.
