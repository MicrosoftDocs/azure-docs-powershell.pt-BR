...
## DESCRIPTION
O cmdlet **Set-AzDataFactoryV2** cria um fábrica de dados com o nome e o local do grupo de recursos especificados.
Execute essas operações na seguinte ordem: -- Criar um fábrica de dados.
...
### Exemplo 1: Criar um fábrica de dados
```
...
### Exemplo 2: Criar um fábrica de dados com detalhes de configuração de repo usando um objeto de fábrica existente.
```
...
Este comando cria um fábrica de dados chamado WikiADF no grupo de recursos chamado ADF no local do EastUS com a configuração de controle de origem do Azure DevOps.

### Exemplo 3: Criar um fábrica de dados com detalhes de configuração de repositório do GitHub usando um novo objeto de fábrica.
```
...
Este comando cria um fábrica de dados chamado WikiADF no grupo de recursos chamado ADF no local do EastUS com a configuração de controle de origem do GitHub..

## PARÂMETROS

### -AccountName
O nome da conta para a configuração de repo.
...
### -CollaborationBranch
O branch de colaboração para configuração de repo.
...
O dicionário que contém os parâmetros globais do fábrica de dados.
...
### -HostName
O nome do host para a configuração de repositório do GitHub.
...
### -LastCommitId
A última id de confirmação para configuração de repo.
...
### -ProjectName
O nome do projeto Azure DevOps para configuração de repo.
...
### -RepositoryName
O nome do repositório para configuração de repositório.
...
### -ResourceId
A ID de recurso do Azure do fábrica de dados V2.
...
### -RootFolder
A pasta raiz para configuração de repo.
...
### -TenantId
A id do locatário para a configuração de repo do Azure DevOps.
