...
## SYNOPSIS
Vincula um armazenamento de dados ou um serviço de nuvem à Fábrica de Dados.
...
## DESCRIPTION
O Set-AzDataFactoryV2LinkedService de dados vincula um armazenamento de dados ou um serviço de nuvem ao Azure Data Factory.
