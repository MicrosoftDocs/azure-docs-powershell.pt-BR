...
## DESCRIPTION
O cmdlet **Get-AzDataFactoryV2ActivityRun** obtém informações sobre as executações no Azure Data Factory para a duração do pipeline especificada que aconteceu no determinado período de tempo. Além disso, você pode especificar filtros para nome da atividade, nome de serviço vinculado que executou a execução e o status da execução.
...
Este comando obtém detalhes sobre todas as atividades executados no pipeline executado com a ID "f288712d-fb08-4cb8-96ef-82d3b9b30621" que aconteceu entre "2017-09-01" e "2017-09-30".
...
### -RunStartedAfter
O momento em que a execução do pipeline começou a ser executada.
