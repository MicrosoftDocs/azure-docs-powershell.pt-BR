...
## SYNOPSIS
Obtém informações sobre janelas de atividade associadas a um fábrica de dados.
...
## DESCRIPTION
O cmdlet **Get-AzDataFactoryActivityWindow** obtém informações sobre as janelas de atividade associadas a um fábrica de dados.

## EXEMPLOS

### Exemplo 1: Obter janelas de atividade associadas a um fábrica de dados
```
...
Este comando obtém informações sobre todas as janelas de atividade associadas ao fábrica de dados chamado WikiADF.

## PARÂMETROS

### -ActivityName
Especifica o nome da atividade.
Este cmdlet obtém janelas de atividade para a atividade especificada por esse parâmetro.
...
Este cmdlet obtém janelas de atividade que pertencem ao fábrica de dados especificado por esse parâmetro.
...
Este cmdlet obtém janelas de atividade que pertencem ao conjuntos de dados especificados por esse parâmetro.
...
### -Filter
Especifica a janela de atividade expressa usando a gramática de filtro de Pesquisa do Azure.
...
A lista de janelas de atividade é filtrada pela cadeia de caracteres de pesquisa especificada por esse parâmetro.
...
### -OrderBy
Especifica a ordem da resposta por um dos parâmetros da lista de janelas de atividade.
Esta é uma lista de propriedades separadas por vírgulas.
Por exemplo: WindowStart, PercentComplete.
Por padrão, a ordem é ordem crescente (ASC).
Especifique DESC se você deseja ordenar a lista em ordem decrescente.
...
### -RunEnd
Especifica a hora de término da janela de atividade em executar.
Este cmdlet obtém janelas de atividade cujas horas de executar se enquadram entre tempos *de RunStart* e *RunEnd.*
...
### -RunStart
Especifica a hora de início da janela de atividade em executar.
Este cmdlet obtém janelas de atividade cujas horas de executar se enquadram entre tempos *de RunStart* e *RunEnd.*
...
### -Top
Especifica o número máximo de janelas de atividade retornadas por esse cmdlet.
...
### -WindowEnd
Especifica a janela de término da atividade.
Este cmdlet obtém janelas de atividade cujas horas se *enquadram entre* tempos windowStart e *WindowEnd.*
...
### -WindowStart
Especifica o horário de início da janela de atividade.
Este cmdlet obtém janelas de atividade cujas horas se *enquadram entre* tempos windowStart e *WindowEnd.*
