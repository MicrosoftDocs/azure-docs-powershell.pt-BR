...
## SYNOPSIS
Atualiza o tempo de execução de integração auto-hospedado.
...
## DESCRIPTION
O cmdlet **Invoke-AzDataFactoryV2IntegrationRuntimeUpgrade** atualiza o tempo de execução de integração auto-hospedado se a nova versão estiver disponível.
