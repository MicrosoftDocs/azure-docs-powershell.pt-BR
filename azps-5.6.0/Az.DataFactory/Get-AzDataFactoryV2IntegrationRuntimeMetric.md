...
## DESCRIPTION
O Get-AzDataFactoryV2IntegrationRuntimeMetric cmdlet obtém dados métricos sobre o tempo de execução de integração em um fábrica de dados.
...
Este comando exibe dados métricos sobre o tempo de execução de integração chamado 'test-selfhost-ir' na assinatura do grupo de recursos chamado 'rg-test-dfv2' e no data factory denominado 'test-df-eu2'.
