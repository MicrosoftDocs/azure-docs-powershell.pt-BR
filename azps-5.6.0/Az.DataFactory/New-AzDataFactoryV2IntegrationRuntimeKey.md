...
## DESCRIPTION
O cmdlet **New-AzDataFactoryV2IntegrationRuntimeKey** regenera a chave de tempo de execução de integração com o nome da chave especificado pelo parâmetro 'KeyName'. A chave anterior será inválida.
