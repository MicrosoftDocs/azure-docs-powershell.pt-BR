...
## SYNOPSIS
Interrompe um gatilho executado em um fábrica de dados.
...
## DESCRIPTION
O cmdlet **Stop-AzDataFactoryV2TriggerRun** interrompe um gatilho executado em um fábrica de dados especificado com o nome do gatilho e a ID de executar gatilho.
Atualmente, só há suporte para WindWindowTriggers no estado WaitingOnDependency.
...
Este comando interrompe o gatilho executado com a id '08586002468005888497807248799CU16' na fábrica WikiADF.
...
### -InputObject
As informações sobre a operação do gatilho.
...
### -PassThru
Se especificado, o cmdlet gravará true caso a operação seja bem-sucedida.
