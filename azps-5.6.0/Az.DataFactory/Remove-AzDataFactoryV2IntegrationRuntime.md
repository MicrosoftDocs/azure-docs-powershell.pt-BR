...
## DESCRIPTION
O Remove-AzDataFactoryV2IntegrationRuntime cmdlet remove um tempo de execução de integração.
...
Este comando remove o tempo de execução de integração chamado 'test-reserved-ir' do fábrica de dados chamado 'test-df'.
...
O nome da fábrica de dados vinculados.
