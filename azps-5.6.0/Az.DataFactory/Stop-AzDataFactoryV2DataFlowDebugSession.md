...
## SYNOPSIS
Interrompe uma sessão de depuração de fluxo de dados no Azure Data Factory
...
## DESCRIPTION
Esse comando interrompe a sessão de depuração, caso não seja então que a sessão será automaticamente desligada de acordo com a configuração Tempo para a live da sessão de depuração.
...
```
Interrompe uma sessão de depuração de fluxo de dados "fd76cd0d-8b37-4dc0-a370-3f9d43ac686d" no fábrica de dados "WikiADF"
