...
Este comando cria um gateway chamado ContosoGateway no fábrica de dados chamado WikiADF no grupo de recursos chamado ADF.

## PARÂMETROS

### -DataFactory
Especifica um **objeto PSDataFactory.**
Este cmdlet cria um gateway para o fábrica de dados especificado por esse parâmetro.
...
Este cmdlet cria um gateway que pertence ao grupo especificado por esse parâmetro.
