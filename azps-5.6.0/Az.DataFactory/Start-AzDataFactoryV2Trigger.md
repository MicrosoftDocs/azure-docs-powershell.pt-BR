...
## SYNOPSIS
Inicia um gatilho em um fábrica de dados.
...
## DESCRIPTION
O cmdlet **Start-AzDataFactoryV2Trigger** inicia um gatilho em um fábrica de dados. Se o gatilho estiver no estado 'Parado', o cmdlet iniciará o gatilho e, eventualmente, invocará pipelines com base em sua definição. Se o gatilho já estiver no estado 'Iniciado', esse cmdlet não terá efeito. Se o parâmetro Force for especificado, o cmdlet não solicitará antes de iniciar o gatilho.
...
Inicia um gatilho chamado "ScheduledTrigger" no fábrica de dados "WikiADF".
