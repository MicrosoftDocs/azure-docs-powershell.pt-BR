...
Este comando cria um fluxo de dados chamado TaxiDemo1 no fábrica de dados chamado WikiADF.
O comando baseia o fluxo de dados em informações no arquivo TaxiDemo1.json.
