...
## SYNOPSIS
Invocar a ação de depuração na sessão de depuração do fluxo de dados.
...
## DESCRIPTION
Este comando executa visualização de dados/visualização de estatísticas/visualização de expressão para um fluxo diferente de fluxo de dados na sessão de depuração.
A sequência de comandos do PowerShell para fluxo de trabalho de depuração de fluxo de dados deve ser:
1. Start-AzDataFactoryV2DataFlowDebugSession
1. Add-AzDataFactoryV2DataFlowDebugSessionPackage
1. Invoke-AzDataFactoryV2DataFlowDebugSessionCommand (repita esta etapa para diferentes comandos/destinos ou repita a etapa 2-3 para alterar o arquivo do pacote)
...
Este exemplo invoca o comando de visualização de dados para a sessão de depuração "fd76cd0d-8b37-4dc0-a370-3f9d43ac686d" no fábrica de dados "WiKiADF" e converta a saída JSON em cadeia de caracteres aceitável.
...
### -Columns
A lista de colunas para visualização de estatísticas de fluxo de dados.
...
### -Expression
A expressão para visualização de expressão de fluxo de dados.
...
### -RowLimits
O limite de linha para visualização de dados de fluxo de dados.
...
### -StreamName
O nome do fluxo de dados para depuração.
...
## NOTES
Palavras-chave: azure, azurerm, arm, resource, management, manager, data, factoriesKeywords: azure, azurerm, arm, resource, management, manager, data, factories
