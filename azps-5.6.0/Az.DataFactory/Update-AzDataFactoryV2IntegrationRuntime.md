...
## DESCRIPTION
O cmdlet **Update-AzDataFactoryV2IntegrationRuntime** atualiza as propriedades de tempo de execução de integração. Atualmente, o cmdlet só dá suporte à atualização de 'AutoUpdate' e 'AutoUpdateDelayOffset' para tempo de execução de integração auto-hospedado.
...
O cmdlet atualiza o tempo de execução de integração auto-hospedado chamado 'test-selfhost-ir'.

## PARÂMETROS

### -AutoUpdate
Habilitar ou desabilitar a atualização automática do tempo de execução de integração auto-hospedada.
...
A hora em hora do dia para a atualização automática do tempo de execução de integração auto-hospedada.
