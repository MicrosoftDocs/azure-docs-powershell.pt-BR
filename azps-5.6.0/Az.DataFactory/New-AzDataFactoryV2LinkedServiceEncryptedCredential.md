...
## SYNOPSIS
Criptografe a credencial no serviço vinculado com o tempo de execução de integração especificado.
...
## DESCRIPTION
O New-AzDataFactoryV2LinkedServiceEncryptedCredential de criptografia de cmdlet no serviço vinculado com tempo de execução de integração especificado.
...
Este comando criptografa a credencial no arquivo C:\samples\WikiSample\TaxiDemo1.jscom o tempo de execução de integração chamado test-selfhost-ir.
