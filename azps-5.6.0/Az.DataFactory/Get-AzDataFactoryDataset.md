...
Este comando obtém informações sobre todos os conjuntos de dados no fábrica de dados chamado WikiADF.

### Exemplo 2: obter informações sobre um conjuntos de dados específico
```
...
Este comando obtém informações sobre o conjuntos de dados chamado DAWikipediaClickEvents no fábrica de dados chamado WikiADF.

### Exemplo 3: Obter o local para um conjuntos de dados específico
```
...
Este comando obtém informações para o grupo de dados chamado DAWikipediaClickEvents no fábrica de dados chamado WikiADF e usa a notação de ponto padrão para exibir o **Local** associado a esse conjuntos de dados.
Como alternativa, atribua a saída do cmdlet **Get-AzDataFactoryDataset** a uma variável e use a notação de ponto para exibir a propriedade Location associada ao objeto dataset armazenado nessa variável.
