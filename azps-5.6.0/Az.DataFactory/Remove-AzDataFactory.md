...
## DESCRIPTION
O cmdlet **Remove-AzDataFactory** remove um fábrica de dados.

## EXEMPLOS

### Exemplo 1: Remover um fábrica de dados
```
...
Este comando remove o fábrica de dados chamado WikiADF do grupo de recursos chamado ADF.
...
### -Force
Indica que esse cmdlet remove um fábrica de dados sem solicitar confirmação.
...
### -Name
Especifica o nome do fábrica de dados a ser removido.
...
Este cmdlet remove um fábrica de dados do grupo especificado por esse parâmetro.
