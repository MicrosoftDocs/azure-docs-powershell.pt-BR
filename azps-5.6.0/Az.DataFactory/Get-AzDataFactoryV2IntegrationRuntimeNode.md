...
O cmdlet obtém informações do nó chamado 'Node_1' no tempo de execução de integração auto-hospedado 'test-selfhost-ir' no data factory 'test-df-eu2'.
...
O cmdlet obtém informações do nó chamado 'Node_1' no tempo de execução de integração auto-hospedado 'test-selfhost-ir' no data factory 'test-df-eu2', incluindo o endereço IP.
...
### -IpAddress
O endereço IP do nó tempo de execução de integração.
