...
- Criar um pipeline.
Se um pipeline com o mesmo nome já existir no fábrica de dados, este cmdlet solicitará que você confirme se deve substituir o pipeline existente com o novo pipeline.
...
Este comando cria um pipeline chamado DPWikisample no fábrica de dados chamado ADF.
O comando baseia o pipeline em informações no arquivo DPWikisample.json.
Este arquivo inclui informações sobre atividades como Copiar Atividade e Atividade HDInsight no pipeline.

## PARÂMETROS

### -DataFactory
Especifica um **objeto PSDataFactory.**
Este cmdlet cria um pipeline para o fábrica de dados especificado por esse parâmetro.
