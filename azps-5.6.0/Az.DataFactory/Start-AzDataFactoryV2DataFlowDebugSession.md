...
## SYNOPSIS
Inicia uma sessão de depuração de fluxo de dados no Azure Data Factory
...
## DESCRIPTION
Esse comando em execução longa inicia uma sessão de depuração de fluxo de dados para os comandos de depuração futuros. Esse comando pode ser anexado com uma definição de tempo de execução de integração para configurar o tamanho/tipo de cluster de sessão de depuração.
