...
## SYNOPSIS
Cria um certificado de Gerenciamento de API a ser usado durante Autenticação com Backend.
...
Cria um certificado de Gerenciamento de API a ser usado durante Autenticação com Backend. (gerado automaticamente)
