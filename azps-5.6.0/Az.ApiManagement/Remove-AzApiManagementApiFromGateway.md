...
Este comando remove a API especificada de um gateway.

## PARÂMETROS

### -ApiId
Identificador de APIs existentes a ser removido do Gateway.
...
### -GatewayId
Identificador do Gateway existente para remover a API.
Esse parâmetro é necessário.
