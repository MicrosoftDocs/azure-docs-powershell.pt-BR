...
Se especificado, tentará encontrar cache pelo identificador.
...
### -ResourceId
Arm Resource Identifier de um cache. Se especificado, tentará encontrar cache pelo identificador. Esse parâmetro é necessário.
