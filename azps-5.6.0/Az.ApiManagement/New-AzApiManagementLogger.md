...
## DESCRIPTION
O cmdlet **New-AzApiManagementLogger** cria um Azure API Management **Logger**.

## EXEMPLOS

### Exemplo 1: Criar um madeireiro
```powershell
...
Este comando cria um madeireiro chamado ContosoSdkEventHub usando a cadeia de caracteres de conexão especificada.

### Exemplo 2

Cria um Api Management Logger. (gerado automaticamente)
...
### -ConnectionString
Especifica uma cadeia de conexão hubs de eventos do Azure que começa com o seguinte: `Endpoint=endpoint and key from Azure classic portal`
A chave com direitos de envio na cadeia de caracteres de conexão deve ser configurada.
...
### -IsBuffered
Especifica se os registros no madeireiro são armazenados em buffer antes da publicação.
...
### -LoggerId
Especifica uma ID do madeireiro.
