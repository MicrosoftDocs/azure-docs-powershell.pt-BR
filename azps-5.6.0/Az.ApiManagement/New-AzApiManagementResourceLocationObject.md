...
## SYNOPSIS
Crie um novo contrato de local de recurso (usado em Gateways).
...
## DESCRIPTION
O cmdlet **New-AzApiManagementResourceLocationObject** cria um novo contrato de local de recurso (usado em Gateways).

## EXEMPLOS

### Exemplo 1: Criar um contrato de localização de recurso
```powershell
