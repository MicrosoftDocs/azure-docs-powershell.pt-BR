...
## SYNOPSIS
Obtém uma lista ou um valor nomeado específico.
...
O valor não será incluído em detalhes do resultado se o valor nomeado marcado como um segredo. Para obter valor secreto, use **Get-AzApiManagementNamedValueSecretValue**.

## EXEMPLOS

### Exemplo 1: Obter Valor Nomeado pelo nome
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementNamedValue -Context $apimContext -Name "sql-connectionstring"
```

Este comando obtém os detalhes de valor nomeados com o nome do valor nomeado.
...
### -Name
Localiza valores nomeados com nomes que contêm a cadeia de caracteres Name.
...
Se especificado, tentará encontrar o valor nomeado pelo identificador.
Esse parâmetro é opcional.
