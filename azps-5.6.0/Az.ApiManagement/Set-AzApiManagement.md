...
Este exemplo obtém uma instância de Gerenciamento de Api, dimensiona-a para cinco unidades premium e adiciona mais três unidades à região premium.
...
Este comando atualiza uma implantação existente de Gerenciamento de API e ins junta-se a um *VpnType externo.*
...
### Exemplo 4: Atualizar Email do Publisher, NotificationSender Email e Nome da Organização
```powershell
...
### -PassThru
Envia PsApiManagement atualizado para pipeline se a operação for bem-sucedida.
