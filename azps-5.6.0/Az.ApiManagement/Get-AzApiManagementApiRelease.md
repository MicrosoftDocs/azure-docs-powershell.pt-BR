...
Este comando obtém todas as versões da `echo-api` API para o contexto especificado.
...
Este comando obtém as informações de versão de uma API específica com o releaseId especificado.
...
### -ResourceId
Arm Resource Identifier of a Api Release. Se especificado, tentará encontrar a versão da api pelo identificador. Esse parâmetro é necessário.
