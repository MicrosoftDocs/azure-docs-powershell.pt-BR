...
## SYNOPSIS
Obter os detalhes dos conjuntos de versão da API
...
### Exemplo 2: Obter todos os conjuntos de versão da API
```powershell
...
Este comando obtém todos os conjuntos de Versão da API para o contexto especificado.

### Exemplo 3: Obter um conjunto de versão da API por ID
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Este comando obtém o Conjunto de Versão da API com a ID especificada.

## PARÂMETROS

### -ApiVersionSetId
Identificador de API a ser pesquisado.
Se especificado, tentará obter a API pela Id.
...
### -ResourceId
Identificador de Recurso arm do ApiVersionSet. Se especificado, tentará encontrar apiVersionSet pelo identificador. Esse parâmetro é necessário.
