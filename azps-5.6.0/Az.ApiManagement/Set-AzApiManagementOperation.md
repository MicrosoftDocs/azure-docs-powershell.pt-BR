...
Este comando define os detalhes da operação para gerenciamento de API.
...
### -ApiRevision
Identificador da Revisão da API. Esse parâmetro é opcional. Se não for especificada, a operação será atualizada na revisão da api ativa no momento.
