...
Este comando remove uma configuração de nome de host de gateway existente e não solicita confirmação ao usuário.
...
Identificador da configuração de nome de host do gateway existente.
Esse parâmetro é necessário.
...
### -ResourceId
Arm ResourceId do GatewayHostnameConfiguration. Esse parâmetro é necessário.
