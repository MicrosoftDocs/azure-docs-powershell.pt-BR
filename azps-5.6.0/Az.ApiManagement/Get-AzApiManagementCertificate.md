...
## SYNOPSIS
Obtém certificados de Gerenciamento de API configurados para Autenticação Mútua com Backend no serviço.
...
## DESCRIPTION
O cmdlet **Get-AzApiManagementCertificate** obtém todos os certificados ou certificados de Gerenciamento de API do Azure especificados.
...
Este comando obtém todos os certificados de Gerenciamento de API.
...
### -ResourceId
Identificador de Recurso arm do Certificado. Se especificado, tentará encontrar o certificado pelo identificador. Esse parâmetro é necessário.
