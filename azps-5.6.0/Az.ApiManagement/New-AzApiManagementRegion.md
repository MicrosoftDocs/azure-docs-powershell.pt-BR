...
### -Capacity
Capacidade Sku do serviço de Gerenciamento de API do Azure região adicional.
O valor padrão é 1.
...
### -VirtualNetwork
Configuração de Rede Virtual da região de implantação do Gerenciamento de API do Azure.
