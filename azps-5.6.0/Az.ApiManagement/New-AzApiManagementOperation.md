...
Este comando cria uma operação de gerenciamento de API.
...
### -ApiRevision
Identificador da Revisão da API. Esse parâmetro é opcional. Se não for especificada, a operação será anexada à revisão da api ativa no momento.
...
Se você não especificar esse parâmetro, um valor padrão será gerado com base na *UrlTemplate*.
