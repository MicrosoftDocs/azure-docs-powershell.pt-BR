...
## DESCRIPTION
O cmdlet **New-AzApiManagementNamedValue** cria um Gerenciamento de API do Azure **denominado Valor**.
...
O segundo comando cria um valor nomeado e atribui as cadeias de caracteres $Tags como marcas na propriedade.
...
Este comando cria um **Valor Nomeado** que tem um valor criptografado.
