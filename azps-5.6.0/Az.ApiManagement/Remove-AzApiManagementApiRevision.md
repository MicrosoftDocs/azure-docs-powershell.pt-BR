...
## SYNOPSIS
Removida uma revisão de API específica
...
Este comando remove a revisão `2` da API do serviço de Gerenciamento de `echo-api` API.

### Exemplo 2

Este comando remove a revisão 2 da api de eco da API do serviço de Gerenciamento de API. (gerado automaticamente)
