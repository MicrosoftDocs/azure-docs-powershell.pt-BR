...
ClientSecret não será incluído nos detalhes do resultado. Para obter o segredo do cliente, use **Get-AzApiManagementOpenIdConnectProviderClientSecret**.
...
Este comando obtém o provedor que tem a ID OICProvider01.
...
Este comando obtém o provedor chamado Contoso OpenID Connect Provider.
...
Se você especificar um nome, esse cmdlet obtém esse provedor.
