...
## DESCRIPTION
Cria um novo Objeto Proxy de Back-end que pode ser canalado ao criar uma nova entidade Backend.

## EXEMPLOS

### Exemplo 1: Criar um objeto In-Memory proxy de back-end
```powershell
...
### -ProxyCredential
Credenciais usadas para se conectar ao Proxy back-end. Esse parâmetro é opcional.
