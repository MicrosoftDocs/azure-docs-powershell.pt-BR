...
O script removerá o Esquema `2` da Api se não for `echo-api` referenciado.

### Exemplo 2

O script remove o Esquema 2 da api de eco da Api se ele não for referenciado. (gerado automaticamente)
...
### -ResourceId
Arm ResourceId de ApiSchema. Esse parâmetro é necessário.
