...
## DESCRIPTION
O cmdlet **Set-AzApiManagementDiagnostic** atualiza o diagnóstico configurado no Escopo Global ou api.
...
Este comando modifica a Porcentagem de Amostragem de Diagnóstico especificada de 100 a 50%
...
### -InputObject
Instância de PsApiManagementDiagnostic.
Esse parâmetro é necessário.
...
### -PassThru
Se especificado, a instância do Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementDiagnostic tipo representando o conjunto Diagnostic.
...
### -ResourceId
Arm ResourceId de Diagnóstico ou Diagnóstico de Api. Esse parâmetro é necessário.
