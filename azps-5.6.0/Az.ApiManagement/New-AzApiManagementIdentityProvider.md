...
Este comando configura a Identidade do Facebook como um Provedor de Identidade aceito no Portal do Desenvolvedor do serviço ApiManagement.
Isso leva como entrada ClientId e ClientSecret do aplicativo do Facebook.
...
Se especificado, tentará encontrar a configuração do provedor de identidade pelo identificador.
