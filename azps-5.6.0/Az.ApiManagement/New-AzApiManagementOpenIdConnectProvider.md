...
## SYNOPSIS
Cria um provedor OpenID Connect.
...
Este comando cria um Provedor de **Conexão** OpenID chamado Contoso OpenID Connect Provider

### Exemplo 2

Cria um provedor OpenID Connect. (gerado automaticamente)
