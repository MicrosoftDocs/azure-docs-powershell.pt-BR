...
Os cmdlets criam uma nova entidade de cache na localização mestra do serviço de Gerenciamento de Api.

## PARÂMETROS

### -AzureRedisResourceId
Arm ResourceId da instância cache do Azure Redis. Esse parâmetro é opcional.
