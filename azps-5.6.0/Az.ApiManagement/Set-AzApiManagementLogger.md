...
## SYNOPSIS
Modifica um Api Management Logger.
...
## DESCRIPTION
O cmdlet **Set-AzApiManagementLogger** modifica as configurações de um Azure API Management **Logger**.

## EXEMPLOS

### Exemplo 1: Modificar ogger EventHub
```powershell
...
Este comando modifica um madeireiro que tem o ID Logger123.

### Exemplo 2

Modifica um Api Management Logger. (gerado automaticamente)
...
### -ConnectionString
Especifica uma cadeia de conexão hubs de eventos do Azure que inclui direitos de política de envio.
...
### -IsBuffered
Especifica que os registros no madeireiro são armazenados em buffer antes da publicação.
...
### -LoggerId
Especifica a ID do madeireiro a ser atualizado.
...
### -PassThru
Indica que este cmdlet retorna  **o PsApiManagementLogger** que este cmdlet modifica.
