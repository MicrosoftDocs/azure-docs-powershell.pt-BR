...
Este comando remove o serviço de Gerenciamento de API chamado ContosoApi.
...
### -PassThru
Indica que esse cmdlet retornará um valor de $True se a operação for bem-sucedida.
