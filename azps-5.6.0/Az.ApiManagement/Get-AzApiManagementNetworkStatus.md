...
## SYNOPSIS
Obtém o Status de Conectividade para os recursos externos nos quais o serviço de Gerenciamento de Api depende de dentro do Serviço de Nuvem. Isso também retorna os Servidores DNS como visíveis para o CloudService.
...
## DESCRIPTION
Obtém o status de rede de seu serviço de Gerenciamento de Api
...
### -Location
Local do Serviço de Gerenciamento de API.
...
### -ResourceGroupName
Nome do grupo de recursos no qual existe o Gerenciamento de API.
