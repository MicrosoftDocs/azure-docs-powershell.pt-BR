...
## SYNOPSIS
Cria uma configuração de nome de host para o Gateway existente.
...
## DESCRIPTION
O cmdlet **New-AzApiManagementGatewayHostnameConfiguration** cria uma configuração de nome de host para o Gateway existente.
...
Este comando cria uma configuração de nome de host "h01" para um gateway "g01".

## PARÂMETROS

### -CertificateResourceId
Um identificador de recurso para a id de certificado existente. Esse parâmetro é necessário.
...
Identificador da nova configuração de nome de host do gateway.
