...
### Exemplo 1: Criar um produto que não exige uma assinatura
```
...
Este comando cria um produto de Gerenciamento de API.
...
Este comando cria um produto.
Uma assinatura e aprovação são necessárias.
Este comando define o período de notificação como 10 dias.
...
psdx_paramvalues
- NotPublished
- Publicado O valor padrão é NotPublished.
