...
Este comando atualiza os detalhes do produto de Gerenciamento de API, exige uma assinatura e, em seguida, não publica.
...
O valor padrão para esse parâmetro é None.
