...
### -ManagementEndpoint
Pontos de extremidade de gerenciamento do Cluster de Malha de Serviço.
Esse parâmetro é necessário.
...
Número máximo de recuperações ao resolver uma partição do Service Fabric.
...
### -ServerX509Name
Coleção Nomes de Certificado x509 do Servidor.
