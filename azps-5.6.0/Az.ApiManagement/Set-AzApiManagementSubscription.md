...
## DESCRIPTION
O cmdlet **Set-AzApiManagementSubscription** define detalhes de assinatura existentes.

## EXEMPLOS

### Exemplo 1: definir o estado e chaves primárias e secundárias para uma assinatura
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementSubscription -Context $apimContext -SubscriptionId -0123456789 -PrimaryKey "80450f7d0b6d481382113073f67822c1" -SecondaryKey "97d6112c3a8f48d5bf0266b7a09a761c" -State "Active"
```

Este comando define as chaves primárias e secundárias para uma assinatura e a ativa.
...
### -ExpiresOn
Especifica uma data de expiração de assinatura.
...
Esse parâmetro deve ter de 1 a 300 caracteres.
...
### -StateComment
Especifica o comentário de estado da assinatura.
O valor padrão desse parâmetro é $Null.
...
### -UserId
O proprietário da assinatura. Esse parâmetro é opcional.
