...
## DESCRIPTION
O cmdlet **Remove-AzApiManagementNamedValue** remove um gerenciamento de API do Azure **chamado Valor**.
...
Este comando remove o valor nomeado que tem a propriedade ID11.
