...
### -ClientId
ID do cliente do Aplicativo no Provedor de Identidade externo.
É iD do aplicativo para logon do Facebook, ID do cliente para logon do Google, ID do aplicativo para Microsoft.
...
### -ClientSecret
Segredo do cliente do Aplicativo no Provedor de Identidade externo, usado para autenticar a solicitação de logon.
Por exemplo, é o App Secret para logon do Facebook, CHAVE da API para logon do Google, Chave Pública para Microsoft.
...
### -InputObject
Instância de PsApiManagementIdentityProvider. Esse parâmetro é necessário.
...
### -PassThru
Indica que esse cmdlet retorna  **o PsApiManagementIdentityProvider** que este cmdlet modifica.
...
Nome da Política de Redefinição de Senha. Aplica-se apenas ao Provedor de Identidade do AAD B2C. Esse parâmetro é opcional.
...
Nome da Política de Edição de Perfil. Aplica-se apenas ao Provedor de Identidade do AAD B2C. Esse parâmetro é opcional.
...
### -SigninPolicyName
Nome da política de assinatura. Aplica-se apenas ao Provedor de Identidade do AAD B2C. Esse parâmetro é opcional.
...
### -SigninTenant
Locatário de signin para substituir no AAD B2C em vez do `common` Locatário
...
### -Type
Identificador de um Provedor de Identidade existente.
Esse parâmetro é necessário.
