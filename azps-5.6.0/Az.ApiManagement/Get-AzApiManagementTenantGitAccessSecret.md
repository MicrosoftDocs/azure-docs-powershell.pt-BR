...
## SYNOPSIS
Obtém as chaves de configuração de acesso do Git para um locatário.
...
Este comando obtém as chaves de configuração de acesso do Git para o contexto especificado.
