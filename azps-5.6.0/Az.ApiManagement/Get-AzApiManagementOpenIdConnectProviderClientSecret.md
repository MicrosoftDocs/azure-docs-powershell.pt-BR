...
## SYNOPSIS
Obtém o segredo do cliente do provedor do OpenID Connect.
...
### Exemplo 1: Obter um segredo do cliente do provedor usando uma ID
```
...
Este comando obtém um segredo do cliente do provedor que tem a ID OICProvider01.
