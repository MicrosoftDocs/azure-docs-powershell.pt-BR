...
### Exemplo 2: obter detalhes de recursos específicos em uma coleção Move usando o nome do recurso move .
```powershell
...
Obter detalhes de recursos específicos em uma coleção Move usando o nome do recurso move.

### Exemplo 3:Obter detalhes de um recurso específico em uma coleção Move usando filtros como : SourceResourceName, SourceId, MoveState, IsResolveRequired, ProvisioningState
```powershell
...
Obter detalhes de um recurso específico em uma coleção Move usando filtro como armid ,moveStatusMoveState(verify) etc.
...
### -Name
O Nome do Recurso de Movimentação.
