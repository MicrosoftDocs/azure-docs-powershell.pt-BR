...
## DESCRIPTION
O cmdlet **New-AzServiceBusNamespace** cria um novo namespace de Barramento de Serviço. Depois de criado, o manifesto do recurso namespace é imutável. Esta operação é idempotente.
...
### -Location
O local do namespace do Barramento de Serviço.
...
### -SkuCapacity
As unidades de transferência de namespace premium do Barramento de Serviço, valores permitidos 1 ou 2 ou 4
...
### -SkuName
O nome SKU do namespace do Barramento de Serviço.
