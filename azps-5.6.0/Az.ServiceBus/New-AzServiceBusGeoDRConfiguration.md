...
## DESCRIPTION
O cmdlet **New-AzServiceBusGeoDRConfiguration** cria um novo Alias(Configuração de Recuperação de Desastre)
...
### -PartnerNamespace
Dr Configuration PartnerNamespace (ARM ID do PartnerNamespace [namespace secundário])
