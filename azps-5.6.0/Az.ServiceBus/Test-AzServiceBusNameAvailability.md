...
## SYNOPSIS
Verifica a disponibilidade do nome da fila ou tópico determinado
...
Retorna True se o nome $nameQueue for Availabile ou retornar False se for fornecido $nameQueue nome em não disponível
...
Retorna True se o nome $nameTopic for Availabile ou retornar False se o nome $nameTopic fornecido não estiver disponível
...
### -Name
Nome da Fila para verificar a Disponibilidade de Nome
...
### -Queue
Para verificar a disponibilidade de nome para o nome da fila
...
### -Topic
Para verificar a disponibilidade de nome para o nome do tópico
