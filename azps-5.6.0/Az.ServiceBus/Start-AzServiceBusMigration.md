...
## SYNOPSIS
Cria uma nova configuração de Migração e inicia a migração de entidades de namespaces Standard para Premium
...
## DESCRIPTION
O cmdlet **Start-AzServiceBusMigration** cria uma nova configuração de Migração e inicia a migração de entidades de namespaces Standard para Premium
...
Cria uma nova configuração de migração para 'TestingNamespaceStandardMigration' para namespace 'TestingNamespacePremiumMigration' namespaces
