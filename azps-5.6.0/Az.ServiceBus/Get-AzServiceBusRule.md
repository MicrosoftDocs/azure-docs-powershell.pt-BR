...
Retorna a descrição de regra especificada para uma assinatura especificada.
...
Retorna a lista de descrições de regra para uma assinatura especificada.  Por padrão, a regra 100 será retornada, se mais de 100 regra for retornada, use -MaxCount Parameter.
...
Retorna a lista das primeiras 150 descrições de regras para uma assinatura especificada.
