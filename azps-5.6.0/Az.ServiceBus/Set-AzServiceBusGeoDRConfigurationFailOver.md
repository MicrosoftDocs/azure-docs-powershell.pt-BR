...
## DESCRIPTION
O cmdlet **Set-AzServiceBusGeoDRConfigurationFailOver** invoca o failover de DR GEO e reconfigura o alias para apontar para o namespace secundário
...
Invoca o Failover sobre o alias "SampleDRConfigName", reconfigura e aponta para namespace secundário "SampleNamespace_Secondary"
...
### -Name
Nome da configuração do DR - Alias
...
### -Namespace
Namespace Name - Namespace secundário
