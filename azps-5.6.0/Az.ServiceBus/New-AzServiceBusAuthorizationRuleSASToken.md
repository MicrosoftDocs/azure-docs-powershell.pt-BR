...
## SYNOPSIS
Gera um tolen SAS para a regra de autorização do servicebus do Azure do namespace/queue/topic. 
...
## DESCRIPTION
O cmdlet New-AzServiceBusAuthorizationRuleSASToken gera um token SAS (Assinatura de Acesso Compartilhado) para um Azure Eventhub Namesapce ou Azure Eventhub
...
Gere token SAS para a regra de autorixação determinada para Namespace com o tempo de início e expiração..
...
Gere token SAS para a regra de autorixação determinada para Namespace com tempo de expiração.
