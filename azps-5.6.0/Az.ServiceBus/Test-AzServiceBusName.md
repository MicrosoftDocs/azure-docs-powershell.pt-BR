...
## DESCRIPTION
O **cmdlet Test-AzServiceBusName** Check Availability of the NameSpace Name or Alias (DR Configuration Name)
...
Retorna o status sobre a disponibilidade do nome do namespace 'MyNameSapceName' como True
