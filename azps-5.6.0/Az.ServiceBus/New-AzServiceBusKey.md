...
## SYNOPSIS
Regenera as cadeias de caracteres de conexão primárias ou secundárias para o namespace de Barra de Serviço ou fila ou tópico.
...
## DESCRIPTION
O cmdlet **New-AzServiceBusKey** gera novas cadeias de conexão primárias ou secundárias para o namespace especificado ou fila ou tópico e regra de autorização.
...
Regenera as cadeias de caracteres de conexão primárias ou secundárias para o namespace.
...
Regenera as cadeias de conexão primárias ou secundárias com o valor Key fornecido para o namespace.
...
Regenera as cadeias de conexão primárias ou secundárias da fila.
...
Regenera as cadeias de conexão primárias ou secundárias com o valor key fornecido para a fila.
...
Regenera as cadeias de caracteres de conexão primárias ou secundárias do tópico.
...
Regenera as cadeias de conexão primárias ou secundárias com o valor Key fornecido para o tópico.
...
### -RegenerateKey
Chaves regeneradas - 'PrimaryKey'/'SecondaryKey'.
