...
## SYNOPSIS
Remove a regra de autorização de um namespace de Barra de Serviço ou fila ou tópico do grupo de recursos especificado.
...
## DESCRIPTION
O cmdlet **Remove-AzServiceBusAuthorizationRule** remove a regra de autorização de um namespace de Barra de Serviço ou fila ou tópico para o grupo de recursos especificado.
...
Remove a regra de autorização `SBAuthoRule1` da fila do grupo de recursos `SBQueue` especificado.
