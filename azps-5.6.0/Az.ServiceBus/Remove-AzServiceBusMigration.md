...
## SYNOPSIS
Cmdlet exclui a configuração de migração para namespaces Standard para Premium
...
## DESCRIPTION
O cmdlet **Remove-AzServiceBusMigration** exclui a configuração de migração para namespaces Standard para Premium
...
### -InputObject
Objeto Namespace Padrão de Migração de Barramento de Serviço
...
### -ResourceId
ID de recurso namespace padrão de migração de barramento de serviço
