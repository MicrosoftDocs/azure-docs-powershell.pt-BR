...
## DESCRIPTION
O cmdlet **Get-AzServiceBusSubscription** retorna uma descrição de assinatura para o tópico Barramento de Serviço especificado.
...
Retorna uma descrição de assinatura para o tópico Barramento de Serviço especificado.
...
Retorna a lista de assinaturas para o tópico barramento de serviço especificado. Por padrão, 100 assinaturas serão retornadas, para o número de assinaturas, use -MaxCount Parameter
...
Retorna a lista das primeiras 150 assinaturas para o tópico Barramento de Serviço especificado.
...
### -MaxCount
Determine o número máximo de Assinaturas a ser retornada.
