...
## SYNOPSIS
Atualiza a descrição da regra de autorização especificada para o namespace ou fila ou tópico do Barramento de Serviço especificado.
...
## DESCRIPTION
O cmdlet **Set-AzServiceBusAuthorizationRule** atualiza a descrição da regra de autorização especificada no namespace ou fila ou tópico do Barramento de Serviço especificado.
...
Remove Gerenciar **dos** direitos de acesso da regra de autorização `AuthoRule1` no namespace `SB-Example1` .
...
Remove Gerenciar **dos** direitos de acesso da regra de autorização `AuthoRule1` na fila `SBQueue` .
...
Remove **Gerenciar dos** direitos de acesso da regra de autorização `AuthoRule1` no tópico `SBTopic` .
...
### -Rights
Direitos, por exemplo, @("Listen","Send","Manage")
