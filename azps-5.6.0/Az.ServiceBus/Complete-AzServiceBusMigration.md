...
## SYNOPSIS
Os cmdlets definiram a Migração do namespace Standard para o premium como cadeias de caracteres completas e de conexão do namespace padrão agora apontam para o namespace Premium
...
## DESCRIPTION
Os cmdlets **Complete-AzServiceBusMigration** definirão o namespace Migration from Standard para premium como cadeias de caracteres completas e de conexão do namespace padrão agora apontam para namespace Premium
...
### -ResourceId
Migração de Barramento de Serviço - ID de Recurso de Namespace Padrão
