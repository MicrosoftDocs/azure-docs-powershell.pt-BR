...
## DESCRIPTION
Atualize o NetwrokruleSet do namespace determinado na assinatura atual do Azure.
...
Atualizar o NetworkRuleSet usando -InputObject
...
Atualize o NetworkRuleSet usando -ResourceId do outro namespace.
