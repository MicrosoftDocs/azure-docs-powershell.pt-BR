...
## SYNOPSIS
Remove a fila do namespace de Barramento de Serviço especificado.
...
Remove a fila de Barramento de `SB-Queue_exampl1` Serviço do namespace `SB-Example1` .
...
Remove a fila de Barramento de Serviço fornecida no parâmetro $inputobject -InputObject
...
Remove a fila de Barramento de Serviço fornecida no ARM id em $resourceid/cadeia de caracteres para o parâmetro -ResourceId
...
### -ResourceId
ID do Recurso de Fila de Barramento de Serviço
