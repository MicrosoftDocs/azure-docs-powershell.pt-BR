...
## SYNOPSIS
Obtém as cadeias de caracteres de conexão primárias e secundárias para o Namespace ou Fila ou Tópico ou Alias (Configurações GeoDR).
...
## DESCRIPTION
O cmdlet **Get-AzServiceBusKey** retorna as cadeias de caracteres de conexão primárias e secundárias para o namespace ou fila ou tópico ou alias (configurações geodr).
...
Cadeia de caracteres de conexão primária e secundária para o namespace especificado.
...
Cadeia de conexão primária e secundária com o tópico especificado.
...
Cadeia de caracteres de conexão primária e secundária para o namespace e alias especificados.
