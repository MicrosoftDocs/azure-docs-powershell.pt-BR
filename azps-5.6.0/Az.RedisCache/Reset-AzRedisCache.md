...
## DESCRIPTION
O cmdlet **Reset-AzRedisCache** reinicia os nós de uma instância do Cache do Azure Redis.
...
Este comando reinicia os dois nós para o cache chamado RedisCache06.
...
### -RebootType
Especifica qual nó ou nós reiniciar.
...
### -ShardId
Especifica a ID do fragmento que este cmdlet reinicia para um cache premium com clustering habilitado.
