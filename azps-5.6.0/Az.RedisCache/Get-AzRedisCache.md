...
## DESCRIPTION
O cmdlet **Get-AzRedisCache** obtém o Cache redis do Azure especificado.
Se você especificar nenhum parâmetro, essa operação obtém cada Cache Redis para a assinatura atual.

## EXEMPLOS

### Exemplo 1: Obter um Cache Redis pelo nome
```
...
Esse comando obtém cada Cache Redis no grupo de recursos especificado.
...
Este comando obtém cada Cache Redis na assinatura atual.
...
### -Name
Especifica o nome do Cache Redis a ser encontrado.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém o Cache Redis a ser encontrado.
Se você especificar apenas o *parâmetro ResourceGroupName,* essa operação obtém cada Cache Redis no grupo de recursos especificado.
