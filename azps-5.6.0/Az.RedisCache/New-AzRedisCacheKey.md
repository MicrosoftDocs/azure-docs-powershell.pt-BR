...
## DESCRIPTION
O cmdlet **New-AzRedisCacheKey** regenera a chave de acesso de um Cache do Azure Redis.
...
Este comando regenera a chave primária de um Cache Redis.
...
Este comando regenera a chave secundária de um Cache Redis.
...
### -KeyType
Especifica se a chave de acesso primária ou secundária deve ser regenerada.
Os valores válidos são: Primário, Secundário.
