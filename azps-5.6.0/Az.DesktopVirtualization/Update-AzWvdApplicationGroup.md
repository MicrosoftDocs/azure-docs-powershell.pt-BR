...
### Exemplo 1: Criar um Grupo de Aplicativos de Área de Trabalho Virtual do Windows pelo nome
```powershell
...
Este comando cria um Windows Virtual Desktop ApplicationGroup em um Grupo de Recursos.
