...
### Exemplo 1: Obter um HostPool da Área de Trabalho Virtual do Windows pelo nome
```powershell
...
Este comando obtém um HostPool da Área de Trabalho Virtual do Windows em um Grupo de Recursos.
...
Este comando lista um HostPools da Área de Trabalho Virtual do Windows em um Grupo de Recursos.
