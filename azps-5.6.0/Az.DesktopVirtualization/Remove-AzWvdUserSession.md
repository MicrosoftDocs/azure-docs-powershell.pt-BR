...
### Exemplo 1: Excluir uma UserSession da Área de Trabalho Virtual do Windows pelo nome
```powershell
...
Este comando exclui uma UserSession da Área de Trabalho Virtual do Windows em um Host de Sessão.
...
### -Force
Forçar o sinalizador a fazer logon de userSession.
