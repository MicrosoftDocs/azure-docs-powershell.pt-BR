...
### Exemplo 1: Não registro em um Grupo de Aplicativos de Área de Trabalho Virtual do Windows
```powershell
...
Esse comando não registrou um Grupo de Aplicativos de Área de Trabalho Virtual do Windows em um Espaço de Trabalho.
