...
### Exemplo 1: Excluir um SessionHost da Área de Trabalho Virtual do Windows pelo nome
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Este comando exclui um Windows Virtual Desktop SessionHost em um Pool de Host.
...
### -Force
Forçar o sinalizador para forçar a exclusão sessionHost mesmo quando a userSession existir.
