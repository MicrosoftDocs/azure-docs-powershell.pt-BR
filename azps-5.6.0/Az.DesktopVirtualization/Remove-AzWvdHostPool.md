...
### Exemplo 1: Excluir um HostPool da Área de Trabalho Virtual do Windows pelo nome
```powershell
PS C:\> Remove-AzWvdHostPool -ResourceGroupName ResourceGroupName -Name HostPoolName
```

Este comando exclui um HostPool da Área de Trabalho Virtual do Windows em um Grupo de Recursos.
