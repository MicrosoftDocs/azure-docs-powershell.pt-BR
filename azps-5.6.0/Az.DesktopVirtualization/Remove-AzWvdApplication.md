...
### Exemplo 1: excluir um aplicativo de área de trabalho virtual do Windows pelo nome
```powershell
PS C:\> Remove-AzWvdApplication -ResourceGroupName ResourceGroupName -ApplicationGroupName ApplicationGroupName -Name ApplicationName
```

Este comando exclui um Aplicativo de Área de Trabalho Virtual do Windows em um grupo de aplicações.
