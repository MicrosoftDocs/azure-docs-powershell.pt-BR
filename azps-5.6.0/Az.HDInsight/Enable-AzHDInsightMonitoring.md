...
## DESCRIPTION
O cmdlet **Enable-AzHDInsightMonitoring** permite o monitoramento em um cluster HDInsight do Azure.
...
O monitoramento será habilitado no cluster HDInsight e os logs relevantes serão enviados para o espaço de trabalho de monitoramento com a id 1d364e89-bb71-4503-aa3d-a23535aea7bd
...
### -PrimaryKey
A chave primária do espaço de trabalho de monitoramento.
