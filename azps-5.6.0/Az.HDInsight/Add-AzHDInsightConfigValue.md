...
## DESCRIPTION
O cmdlet **Add-AzHDInsightConfigValue** adiciona uma personalização de valor de configuração Hadoop, como core-site.xml ou hive-site.xml e/ou uma personalização de biblioteca compartilhada de Hive ao objeto de configuração HDInsight criado pelo cmdlet New-AzHDInsightClusterConfig.

## EXEMPLOS

### Exemplo 1: Adicionar um valor de configuração personalizado ao objeto de configuração de cluster
```
...
Este comando adiciona um valor de configuração Hadoop ao cluster chamado your-hadoop-001.
...
### -Hdfs
Especifica as configurações HDFS deste cluster HDInsight.
...
### -HiveEnv
Especifica as configurações do Hive Env deste cluster HDInsight.
...
### -HiveSite
Especifica as configurações do Site da Hive deste cluster HDInsight.
...
### -OozieEnv
Especifica as configurações Oozie Env deste cluster HDInsight.
...
### -RServer
Especifica as configurações do RServer. Válido somente para clusters RServer.
...
### -Spark2ThriftConf
Especifica as configurações sparkconf spark2 do sparkconf deste cluster HDInsight.
...
### -SparkThriftConf
Especifica as configurações sparkconf de centelha deste cluster HDInsight.
...
### -Tez
Especifica as configurações de Site de Tez deste cluster HDInsight.
...
### -Yarn
Especifica as configurações DO SITE DO FIO deste cluster HDInsight.
