...
Essa operação também exclui todos os dados armazenados no Sistema de Arquivos Distribuídos Hadoop (HDFS) no cluster.
Os dados armazenados na conta de Armazenamento do Azure associada não são excluídos.
Os dados armazenados em metadadores externos não são excluídos.
...
Este comando remove o cluster chamado your-hadoop-001.
...
### -PassThru
Se PassThru estiver presente, resulte no resultado
