...
## DESCRIPTION
O cmdlet **Wait-AzHDInsightJob** aguarda a conclusão ou falha de um trabalho HDInsight do Azure.

## EXEMPLOS

### Exemplo 1: Aguarde a conclusão ou falha de um trabalho
```
PS C:\># Cluster info
...
Este comando aguarda a conclusão ou falha de um trabalho.
...
### -JobId
Especifica a ID de trabalho do trabalho.
