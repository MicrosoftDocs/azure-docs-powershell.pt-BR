...
## DESCRIPTION
Gire a chave de criptografia de disco do cluster HDInsight especificado. Para essa operação, o cluster deve ter acesso à chave atual e à nova chave pretendido, caso contrário, a operação de tecla de rotação falhará.
...
[Criptografia de disco de chave gerenciada pelo cliente](https://docs.microsoft.com/azure/hdinsight/disk-encryption)
