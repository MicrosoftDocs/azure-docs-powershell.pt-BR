...
Use *PersistOnSuccess* para executar a ação de script sempre que o cluster for dimensionado, desde que a ação de script seja inicialmente bem-sucedida.
...
### -PersistOnSuccess
Indica que a ação de script deve ser executado sempre que o cluster for ampliado.
Esse parâmetro switch será ignorado se a ação de script falhar inicialmente.
