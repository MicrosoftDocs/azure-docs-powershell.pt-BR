...
## DESCRIPTION
O cmdlet **New-AzHDInsightHiveJobDefinition** define um objeto de trabalho hive para uso com um cluster HDInsight do Azure.

## EXEMPLOS

### Exemplo 1: Criar uma definição de trabalho hive
```
PS C:\># Cluster info
...
Este comando cria uma definição de trabalho hive.
...
### -Define
Especifica valores de configuração hadoop a ser definidos para quando o trabalho for executado.
