...
## DESCRIPTION
O cmdlet **New-AzHDInsightMapReduceJobDefinition** define um novo trabalho MapReduce para uso com um cluster HDInsight do Azure.
...
Este comando cria uma definição de trabalho MapReduce.
...
### -LibJars
Especifica o JARS de lib para o trabalho.
