...
## DESCRIPTION
Este cmdlet **Set-AzHDInsightClusterAutoscaleConfiguration** define a configuração de escala automática de um cluster HDInsight do Azure.

## EXEMPLOS

### Exemplo 1: definir a configuração de escala automática baseada em carga do cluster HDInsight
```powershell
...
Este comando define a configuração de escala automática baseada em carga de um cluster HDInsight do Azure.
...
Este comando define a configuração de escala automática baseada em Agenda do cluster HDInsight.

### Exemplo 3: definir a configuração de escala automática do cluster HDInsight com base em outro cluster que tenha definido a configuração de escala automática
```powershell
...
Este comando define a configuração de escala automática do cluster HDInsight com base em outro cluster.
...
### -Condition
Obtém ou define a condição de escala automática baseada em agendamento.
...
### -MaxWorkerNodeCount
Obtém ou define a contagem máxima de workernode da escala automática baseada em carga.
...
### -MinWorkerNodeCount
Obtém ou define a contagem mínima de workernode da escala automática baseada em carga.
...
### -TimeZone
Obtém ou define o fuso horário da escala automática baseada em agendamento.
