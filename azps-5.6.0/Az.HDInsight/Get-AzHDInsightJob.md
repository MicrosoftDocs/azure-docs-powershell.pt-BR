...
## DESCRIPTION
O cmdlet **Get-AzHDInsightJob** obtém trabalhos recentes para um cluster HDInsight do Azure especificado em ordem cronológica inversa, com o trabalho mais recente na parte superior da lista.
Obter um trabalho específico fornecendo o *parâmetro JobId.*
...
Este comando obtém todos os trabalhos recentes para o cluster chamado your-hadoop-001.
...
### -JobId
Especifica a ID de trabalho do trabalho a ser feito.
