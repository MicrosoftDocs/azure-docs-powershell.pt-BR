...
Este comando cria um cluster na assinatura atual.
...
### Exemplo 4: Criar um cluster HDInsight do Azure com recurso de conexão privada e de saída de retransmissão
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exemplo 7: Criar um cluster HDInsight do Azure com Proxy de Repouso kafka.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exemplo 8: Criar um cluster HDInsight do Azure com o armazenamento gen2 do Azure Data Lake.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exemplo 9: Criar um cluster HDInsight do Azure com o Enterprise Security Package(ESP) e Habilitar o Agente de ID HDInsight.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
Você pode usar o cmdlet Add-AzHDInsightStorage.
...
Obtém ou define o sku de host dedicado para isolamento de computação.
...
### -Config
Especifica o objeto cluster a ser usado para criar o cluster.
...
### -Configurations
Especifica as configurações desse cluster HDInsight.
Você pode usar o cmdlet Add-AzHDInsightConfigValues.
...
### -KafkaClientGroupId
Obtém ou define a id do grupo de clientes para acesso a Proxy de Repouso de Kafka.
...
Obtém ou define o nome do grupo de clientes para acesso a Proxy de Repouso de Kafka.
...
Obtém ou define o tamanho do Nó de Gerenciamento de Kafka.
...
### -OSType
Especifica o sistema operacional para o cluster.
...
### -RdpCredential
Especifica as credenciais de Área de Trabalho Remota (RDP) para o cluster.
Isso é apenas para clusters do Windows.
...
### -ScriptActions
Especifica as ações de script a ser executados no cluster no final da criação de cluster.
...
Você pode usar o cmdlet Add-AzHDInsightSecurityProfile.
...
Isso é apenas para clusters Linux.
...
### -StorageContainer
Obtém ou define o nome StorageContainer para a conta de armazenamento padrão do Azure
