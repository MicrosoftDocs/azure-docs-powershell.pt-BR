...
### Exemplo 2: obter um BLOB usando o pipeline
```
PS C:\>Get-AzureStorageContainer -Name container* | Get-AzureStorageBlob
```

Esse comando usa o pipeline para obter um blob.

### Exemplo 3: obter um blob por prefixo de nome
```
PS C:\>Get-AzureStorageBlob -Container "ContainerName" -Prefix "blob"
```

Esse comando usa um prefixo Name para obter um blob.
