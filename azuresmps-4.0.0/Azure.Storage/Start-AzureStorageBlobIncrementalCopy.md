...
### -AbsoluteUri
URI absoluto para a fonte.
Lembre-se de que a credencial deve ser fornecida no URI, se a origem exigir algum.
...
### -CloudBlob
Objeto CloudBlob da biblioteca de cliente de armazenamento do Azure.
Você pode criá-lo ou usar Get-AzureStorageBlob cmdlet.
...
### -CloudBlobContainer
Objeto CloudBlobContainer da biblioteca de cliente de armazenamento do Azure.
Você pode criá-lo ou usar Get-AzureStorageContainer cmdlet.
...
### -Contexto
Contexto de armazenamento do Azure de origem.
...
### -DestContext
Contexto de armazenamento do Azure de destino.
Você pode criá-lo por New-AzureStorageContext cmdlet.
