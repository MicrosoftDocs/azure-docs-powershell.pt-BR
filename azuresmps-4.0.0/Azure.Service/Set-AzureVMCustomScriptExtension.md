...
## Sinopse
Define informações para uma extensão de script personalizado da máquina virtual do Azure.
...
## DESCRITIVO
O cmdlet **set-AzureVMCustomScriptExtension** define informações para uma extensão de script personalizado da máquina virtual do Azure.

## EXEMPLOS

### Exemplo 1: definir informações para uma extensão de script personalizado da máquina virtual
```
...
Este comando define informações para uma extensão de script personalizado da máquina virtual.
...
Este comando define informações para uma extensão de script personalizado da máquina virtual usando várias URLs de arquivo.

## OS

### -Argumento
Especifica uma cadeia de caracteres que fornece um argumento que este cmdlet executa na máquina virtual.
...
### -Nome do arquivo
Especifica uma matriz de cadeia de caracteres que contém os nomes dos arquivos blob no contêiner especificado.
...
### -FileUri
Especifica uma matriz de cadeia de caracteres que contém as URLs dos arquivos BLOB.
...
Esse parâmetro é uma cadeia de caracteres definida pelo usuário que pode ser usada para fazer referência a uma extensão.
...
### -Executar
Especifica o comando que esse cmdlet executa pela extensão na máquina virtual.
Só há suporte para "powershell.exe".
