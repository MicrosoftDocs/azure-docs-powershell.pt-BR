...
## Sinopse
Obtém dispositivos anexados ao recurso.
...
## DESCRITIVO
O cmdlet **Get-AzureStorSimpleDevice** Obtém uma lista de dispositivos StorSimple anexados ao recurso.
Você pode especificar a ID do dispositivo, o nome, a ID do modelo e o tipo.
Use a propriedade **DeviceID** obtida usando esse cmdlet para especificar dispositivos para outros cmdlets do StorSimple.

## EXEMPLOS

### Exemplo 1: obter dispositivos disponíveis em um recurso
```
...
Esse comando obtém todos os dispositivos disponíveis em um recurso.
Neste exemplo, apenas um dispositivo está disponível.

### Exemplo 2: obter dispositivos disponíveis específicos em um recurso
```
...
Esse comando obtém todos os dispositivos disponíveis em um recurso que tem o nome, tipo e ID do modelo especificados.

### Exemplo 3: obter detalhes de um dispositivo
```
...
Esse comando obtém todos os dispositivos disponíveis em um recurso que tem o nome e o tipo especificados.
Esse comando especifica o parâmetro *detalhado* .
O comando fornece detalhes adicionais sobre os dispositivos que ele retorna.

## OS

### -Detalhado
Indica que esse cmdlet retorna detalhes do dispositivo para os dispositivos que ele obtém.
...
### -DeviceID
Especifica a ID da instância do dispositivo a obter.
...
### -DeviceName
Especifica o nome do dispositivo StorSimple a ser obtido.
...
### -ModelId
Especifica a ID do modelo de dispositivos StorSimple a serem obtidos.
...
### -Digite
Especifica o tipo de um dispositivo StorSimple.
Os valores válidos são: Appliance e VirtualAppliance.
...
Esse cmdlet retorna um objeto de **lista \<DeviceDetails\>** se você especificar o parâmetro *detalhado* .
Se você não especificar esse parâmetro, ele retornará um objeto **IEnumerable \<DeviceInfo\>** .
