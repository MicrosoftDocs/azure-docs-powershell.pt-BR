...
## DESCRITIVO
O cmdlet **Get-AzureSiteRecoveryVaultSettingsFile** Obtém o arquivo de configurações para um cofre do Azure site Recovery.

## EXEMPLOS

### Exemplo 1: obter o arquivo de configurações para um cofre
```
...
O primeiro comando obtém o cofre do Azure site Recovery ativo chamado ContosoVault usando o cmdlet **Get-AzureSiteRecoveryVault** .
O comando armazena esse cofre na variável $Vault.

O segundo comando obtém o arquivo de configurações para o cofre armazenado em $Vault.

## OS

### -Local
Especifica a localização geográfica à qual o cofre pertence.
...
Para armazenar esse arquivo localmente, baixe-o no portal de cofre do site Recovery após concluir a execução do comando.
...
### -Site
Especifica um site para o qual obter um arquivo de configurações.
Para obter um objeto de **site** , use o cmdlet **Get-AzureSiteRecoverySite** .
...
### -Cofre
Especifica o cofre para o site.
