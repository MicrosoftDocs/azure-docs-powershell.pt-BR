...
## Sinopse
Remove a extensão BGInfo aplicada a uma máquina virtual.
...
## DESCRITIVO
O cmdlet **Remove-AzureVMBGInfoExtension** remove a extensão BGInfo aplicada a uma máquina virtual.

## EXEMPLOS

### Exemplo 1: remover a extensão do BGInfo em uma máquina virtual
```
PS C:\> Remove-AzureVMBGInfoExtension -VM $VM;
```

Esse comando Remove a extensão BGInfo aplicada a uma máquina virtual.
