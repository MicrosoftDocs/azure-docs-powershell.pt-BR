...
## Sinopse
Remove uma extensão DSC do Azure de uma máquina virtual.
...
## DESCRITIVO
O cmdlet **Remove-AzureVMDscExtension** remove uma extensão DSC do Azure de uma máquina virtual.
A saída desse cmdlet precisa ser canalizada para o cmdlet **Update-AzureVM** .

## EXEMPLOS

### Exemplo 1: remover uma extensão DSC de uma máquina virtual
```
PS C:\> Remove-AzureVMDscExtension -VM $VM | Update-AzureVM
```

Esse comando Remove uma extensão DSC do Azure de uma máquina virtual.
