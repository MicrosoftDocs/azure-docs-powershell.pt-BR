...
Esse comando carrega C:\RemoteAppImages\ContosoApps.vhd para criar uma imagem de modelo chamada ContosoApps no centro de dados da Europa norte.
...
### -Retomar
Indica que esse cmdlet retomará se o upload de uma imagem de modelo for interrompido.
