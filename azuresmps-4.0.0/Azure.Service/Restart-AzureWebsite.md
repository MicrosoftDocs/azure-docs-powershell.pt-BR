...
## Sinopse
Para e reinicia o site especificado.
...
O cmdlet **Restart-AzureWebsite** interrompe e, em seguida, reinicia o site especificado.

## EXEMPLOS

### Exemplo 1: reiniciar um site
```
PS C:\> Restart-AzureWebsite -Name MyWebsite
```

Este exemplo reinicia um site denominado mywebsite.

## OS

### -Nome
Especifica o nome do site do Azure a ser reiniciado.
