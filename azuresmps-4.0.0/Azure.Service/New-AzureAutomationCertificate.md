...
Cria um certificado de automação do Azure.
...
O cmdlet **New-AzureAutomationCertificate** cria um certificado na automação do Microsoft Azure.
Você fornece o caminho para um arquivo de certificado para carregar.
...
Esses comandos criam um certificado na automação do Azure chamado meu certificado.
O primeiro comando cria a senha para o arquivo de certificado que é usado no segundo comando que cria o certificado.

## OS

### -AutomationAccountName
Especifica o nome da conta de automação na qual o certificado será armazenado.
...
### -Nome
Especifica um nome para o certificado.
