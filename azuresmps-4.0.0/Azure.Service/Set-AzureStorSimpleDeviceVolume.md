...
## DESCRITIVO
O cmdlet **set-AzureStorSimpleDeviceVolume** atualiza as propriedades de um volume existente.
Este cmdlet associa um volume a um ou mais registros de controle de acesso.
Para obter objetos **AccessControlRecord** , use o cmdlet **Get-AzureStorSimpleAccessControlRecord** .
Atualize o tamanho ou o tipo do volume.
Atualize também se deseja criar o volume online.

## EXEMPLOS

### Exemplo 1: atualizar o valor online para um volume
```
...
Esse comando atualiza o volume denominado Volume18 para ter um valor online de $False.
Esse comando inicia a tarefa e, em seguida, retorna um objeto **TaskResponse** .
...
Esse comando atualiza o volume chamado Volume18.
Ele modifica o tipo e altera o valor do parâmetro *online* para $true.
...
### -DeviceName
Especifica o nome do dispositivo StorSimple no qual o volume deve ser atualizado.
...
### -VolumeAppType
Especifica se o volume deve ser atualizado para ser um volume principal ou de arquivamento.
...
### Programação\<AccessControlRecord\>
Esse cmdlet aceita uma lista de objetos **AccessControlRecord** para associar a um volume.
