...
O primeiro comando obtém todos os contêineres protegidos para o cofre do Azure site Recovery atual usando o cmdlet **Get-AzureSiteRecoveryProtectionContainer** e, em seguida, armazena os resultados na variável $container.
...
O comando final inicia o trabalho de failover para os objetos protegidos armazenados em $Protected.
...
### -RecoveryPlan
Especifica um objeto de plano de recuperação para o qual iniciar o trabalho.
