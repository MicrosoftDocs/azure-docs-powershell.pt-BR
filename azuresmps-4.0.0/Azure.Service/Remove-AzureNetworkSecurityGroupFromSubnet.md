...
## Sinopse
Dissocia um grupo de segurança de rede de uma sub-rede.
...
## DESCRITIVO
O cmdlet **Remove-AzureNetworkSecurityGroupFromSubnet** dissocia um grupo de segurança de rede do Azure de uma sub-rede.
...
### -Nome
Especifica o nome do grupo de segurança de rede que esse cmdlet dissocia de uma sub-rede.
...
### -SubnetName
Especifica o nome de uma sub-rede na qual esse cmdlet dissocia um grupo de segurança de rede.
...
Esse cmdlet Desassocia um grupo de segurança de rede de uma sub-rede na rede virtual que esse parâmetro especifica.
