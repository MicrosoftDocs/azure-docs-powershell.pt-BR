...
## Sinopse
Obtém a chave para um gateway de rede virtual do Azure.
...
## DESCRITIVO
O cmdlet **Get-AzureVirtualNetworkGatewayKey** Obtém a chave para um gateway de rede virtual do Azure.
