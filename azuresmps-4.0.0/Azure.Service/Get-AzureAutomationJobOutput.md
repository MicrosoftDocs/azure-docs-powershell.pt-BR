...
Obtém a saída de um trabalho de automação do Azure.
...
O cmdlet **Get-AzureAutomationJobOutput** Obtém a saída de um trabalho de automação do Microsoft Azure.

## EXEMPLOS

### Exemplo 1: obter a saída de um trabalho de automação do Azure
```
