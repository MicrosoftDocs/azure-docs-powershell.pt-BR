...
## Sinopse
Atualiza um trabalho do Agendador com uma ação HTTP.
...
O cmdlet **set-AzureSchedulerHttpJob** atualiza um trabalho do Agendador com uma ação http.

## EXEMPLOS

### Exemplo 1: alterar o estado de um trabalho para desabilitado
```
...
Esse comando altera o estado do trabalho denominado Job01 para desabilitado.
Esse trabalho faz parte da coleção de trabalhos chamada JobColleciton01 para o local especificado.
...
Esse comando atualiza o URI do trabalho chamado Job01 http://www.contoso.com .
...
### -EndTime
Especifica uma hora, como um objeto **DateTime** , para que o Agendador pare de iniciar trabalhos.
...
### -ErrorActionHeaders
Especifica os cabeçalhos como uma Hashtable.
