...
O cmdlet **Get-AzureAutomationCredential** Obtém uma ou mais credenciais de automação do Microsoft Azure.
Por padrão, todas as credenciais são retornadas.
Para obter uma credencial específica, especifique o nome dela.
