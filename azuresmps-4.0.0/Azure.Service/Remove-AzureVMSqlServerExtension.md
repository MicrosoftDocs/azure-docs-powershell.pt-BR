...
## Sinopse
Remove uma extensão do SQL Server do Azure Virtual Machine de um objeto de máquina virtual.
...
## DESCRITIVO
O cmdlet **Remove-AzureVMSqlServerExtension** remove uma extensão do SQL Server do Azure Virtual Machine de um objeto de máquina virtual.
...
### -VM
Especifica o objeto da máquina virtual persistente do qual esse cmdlet Remove a extensão.
