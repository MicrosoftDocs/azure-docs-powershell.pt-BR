...
## Sinopse
Interrompe o serviço hospedado atual.
...
O cmdlet **Stop-AzureService** interrompe o serviço hospedado atual no slot especificado no Windows Azure.
Se nenhum slot for especificado, o cmdlet para o serviço no slot de produção.
...
### -ServiceName
Especifica o nome do serviço hospedado para parar.
Se nenhum nome for especificado, o cmdlet para o serviço hospedado atual.
...
### -Slot
Especifica o slot em que o serviço está hospedado, em preparação ou em produção.
Se nenhum slot for especificado, a produção será presumida.
