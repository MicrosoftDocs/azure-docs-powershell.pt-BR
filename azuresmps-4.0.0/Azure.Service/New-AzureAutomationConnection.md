...
O cmdlet **New-AzureAutomationConnection** cria uma conexão na automação do Microsoft Azure.
...
Especifica o nome da conta de automação na qual a conexão será armazenada.
...
As chaves representam os campos de conexão no tipo de conexão especificado.
Os valores representam os valores específicos para armazenar para cada campo de conexão para a instância de conexão.
