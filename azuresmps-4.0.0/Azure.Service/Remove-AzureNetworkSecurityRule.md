...
## DESCRITIVO
O cmdlet **Remove-AzureNetworkSecurityRule** remove uma regra de segurança de rede do Azure de um grupo de segurança de rede.
...
### -Nome
Especifica o nome da regra de segurança de rede que este cmdlet Remove.
