...
## Sinopse
Cria os arquivos e a configuração necessários para um novo serviço.
...
O cmdlet **New-AzureServiceProject** cria os arquivos e a configuração necessários para um novo serviço do Azure no diretório atual.

## EXEMPLOS

### Exemplo 1: criar scaffolding para um serviço
```
PS C:\> New-AzureServiceProject MyService1
```

Este exemplo cria scaffolding para um novo serviço do Azure chamado MyService1 no diretório atual.
...
Ele determina a primeira seção do nome do host do serviço (por exemplo, name.cloudapp.net) e o diretório que conterá o serviço.
O nome pode conter apenas letras, dígitos e o caractere traço (-).
