...
## Sinopse
Migra um endereço IP reservado para a pilha do Gerenciador de recursos do Azure.
...
## DESCRITIVO
O cmdlet **move-AzureReservedIP** migra um endereço IP reservado para um grupo de recursos na pilha do Azure Resource Manager.
...
### -Abort
Indica que esse cmdlet cancela a migração de endereço IP reservado.
...
### -Confirmar
Indica que esse cmdlet inicia a migração de endereço IP reservado.
...
### -Prepare
Indica que esse cmdlet prepara o endereço IP reservado para migração.
...
### -ReservedIPName
Especifica o nome do endereço IP reservado que este cmdlet migra.
...
### -Validar
Especifica que esse cmdlet valide o endereço IP reservado para migração.
