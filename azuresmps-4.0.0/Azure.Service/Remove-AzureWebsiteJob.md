...
## Sinopse
Remove um trabalho da Web existente para um site.
...
### Exemplo 1: remover um trabalho da Web existente para um site
```
PS C:\> Remove-AzureWebsiteJob -Name MyWebsite -JobName MyWebJob -JobType Continuous
```

Remove um trabalho da Web chamado MyWebJob para mywebsite.

## OS

### -Force
Indica que esse cmdlet Remove o trabalho da Web sem solicitar confirmação.
