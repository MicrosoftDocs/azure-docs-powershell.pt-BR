...
## Sinopse
Remove uma instância de complemento existente.
...
Remove uma instância de complemento existente da assinatura atual.
...
Este exemplo remove um complemento chamado myaddon da assinatura atual.

## OS

### -Nome
Especifica o nome da instância do complemento a ser removida.
