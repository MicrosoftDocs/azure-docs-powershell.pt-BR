...
## Sinopse
Define o número de nós de dados para um cluster HDInsight.

## SYNTAX

### Defina o tamanho do cluster em nós com nome.
```
Set-AzureHDInsightClusterSize -ClusterSizeInNodes <Int32> -Name <String> [-Force] [-Profile <AzureSMProfile>]
 [<CommonParameters>]
```

### Defina o tamanho do cluster em nós com cluster do pipeline.
```
...
O cmdlet **set-AzureHDInsightClusterSize** define o número de nós de dados de um cluster do Azure HDInsight.
...
### -Cluster
Especifica o cluster a ser redimensionado.
...
### -Nome
Especifica o nome do cluster HDInsight a ser redimensionado.
...
Esse cmdlet define o tamanho do cluster para a assinatura que esse parâmetro especifica.
