...
## Sinopse
Habilita a extensão do diagnóstico do Azure em funções especificadas ou todas as funções em um serviço implantado ou na implantação.
...
## DESCRITIVO
O cmdlet **set-AzureServiceDiagnosticsExtension** habilita a extensão do diagnóstico do Azure em funções especificadas ou todas as funções em um serviço implantado ou na implantação.

## EXEMPLOS

### Exemplo 1: habilitar a extensão do diagnóstico do Azure
```
...
Esse comando habilita a extensão do diagnóstico do Azure para todas as funções.

### Exemplo 2: habilitar a extensão do diagnóstico do Azure para uma função especificada
```
...
Esse comando habilita a extensão do diagnóstico do Azure para uma função especificada.
...
Especifica uma matriz de configuração para o diagnóstico do Azure.
...
Especifica a configuração do diagnóstico do Azure.
Você pode baixar o esquema usando o seguinte comando: 
...
### -Função
Especifica uma matriz opcional de funções para as quais especificar a configuração do Azure Diagnostics.
Se você não especificar esse parâmetro, a configuração de diagnóstico será aplicada como a configuração padrão para todas as funções.
...
Especifica um ponto de extremidade da conta de armazenamento.
...
### -StorageAccountKey
Especifica uma chave de conta de armazenamento.
...
### -X509Certificate
Especifica um certificado X. 509 que, quando especificado, é carregado automaticamente para o serviço de nuvem e usado para criptografar a configuração privada de extensão.
