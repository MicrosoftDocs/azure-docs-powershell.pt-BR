...
Esse comando importa uma versão atualizada de um módulo existente chamado ContosoModule para a conta de automação do Azure chamada Contoso17.
...
### -Marcas
Especifica as marcas do módulo.
