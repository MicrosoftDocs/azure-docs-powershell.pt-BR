...
### SetDiagnosticsExtension (padrão)
```
...
## DESCRITIVO
O cmdlet **set-AzureVMDiagnosticsExtension** configura a extensão de diagnóstico do Microsoft Azure em uma máquina virtual.

## EXEMPLOS

### Exemplo 1: criar uma máquina virtual com a extensão de diagnóstico do Azure aplicada
```
...
Esses comandos habilitam a extensão do diagnóstico do Azure em uma máquina virtual.

### Exemplo 2: habilitar uma extensão de diagnóstico do Azure em uma máquina virtual existente
```
...
O primeiro comando usa o cmdlet **Get-AzureVM** para obter uma máquina virtual.

O segundo comando usa o cmdlet **set-AzureVMDiagnosticsExtension** para atualizar a configuração da máquina virtual para incluir a extensão do diagnóstico do Azure.

O comando final aplica a configuração atualizada à máquina virtual.

## OS

### -DiagnosticsConfigurationPath
Especifica um caminho para a configuração de diagnóstico.
...
### -Disable
Indica que esse cmdlet desabilita a extensão do diagnóstico na máquina virtual.
...
### -Referencename
Especifica o nome de referência para a extensão do diagnóstico.
...
### -Versão
Especifica a versão de extensão como uma cadeia de caracteres.
