...
## Sinopse
Obtém armazenamentos de recuperação de site para um cofre.
...
## DESCRITIVO
O cmdlet **Get-AzureSiteRecoveryStorage** Obtém armazenamentos do Azure site Recovery para o cofre do Azure site Recovery atual.

## EXEMPLOS

### Exemplo 1: obter armazenamento de recuperação de site
```
...
O segundo comando obtém o armazenamento de recuperação de site para o primeiro servidor na matriz de $Servers.
...
### -Servidor
Especifica um servidor para armazenamento de recuperação de site do Azure.
Para obter um objeto **ASRServer** , use o cmdlet **Get-AzureSiteRecoveryServer** .
