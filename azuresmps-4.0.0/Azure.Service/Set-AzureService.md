...
## Sinopse
Define ou atualiza o rótulo e a descrição do serviço do Microsoft Azure especificado.
...
## DESCRITIVO
O cmdlet **set-AzureService** atribui um rótulo e uma descrição a um serviço na assinatura atual.

## EXEMPLOS

### Exemplo 1: atualizar o rótulo e a descrição de um serviço
```
PS C:\> C:\PS>Set-AzureService -ServiceName "MySvc1" -Label "MyTestSvc1" -Description "My service for testing out new configurations"
```

Esse comando define o rótulo como "MyTestSvc1" e a descrição para "meu serviço para testar novas configurações" para o serviço MyTestSvc1.

## OS

### -Descrição
Especifica uma descrição para o serviço do Azure.
...
### -Rótulo
Especifica um rótulo para o serviço do Azure.
...
### -ServiceName
Especifica o nome do serviço do Azure a ser atualizado.
