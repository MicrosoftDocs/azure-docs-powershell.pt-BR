...
## Sinopse
Migra uma rede virtual para a pilha do Gerenciador de recursos do Azure.
...
## DESCRITIVO
O cmdlet **move-AzureVirtualNetwork** migra uma rede virtual para um grupo de recursos na pilha do Azure Resource Manager.

## EXEMPLOS

### Exemplo 1: preparar a migração de rede virtual
```
PS C:\> Move-AzureVirtualNetwork -Prepare -VirtualNetworkName "ContosoVNET"
```

Esse comando prepara a rede virtual chamada ContosoVNET para migração para a pilha do Azure Resource Manager.

### Exemplo 2: iniciar a migração de rede virtual
```
PS C:\> Move-AzureVirtualNetwork -Commit -VirtualNetworkName "ContosoVNET"
```

Esse comando inicia a migração da rede virtual chamada ContosoVNET para a pilha do Gerenciador de recursos do Azure.

### Exemplo 3: validar a migração de rede virtual
```
PS C:\> Move-AzureVirtualNetwork -Validate -VirtualNetworkName "ContosoVNET"
```

Esse comando valida a migração para a rede virtual chamada ContosoVNET para a pilha do Gerenciador de recursos do Azure.

## OS

### -Abort
Indica que esse cmdlet cancela a migração de rede virtual.
...
### -Confirmar
Indica que esse cmdlet inicia a migração de rede virtual.
...
### -Prepare
Indica que esse cmdlet prepara a rede virtual para migração.
...
### -Validar
Especifica que esse cmdlet valida a rede virtual para migração.
...
### -VirtualNetworkName
Nome da rede virtual a ser migrada
