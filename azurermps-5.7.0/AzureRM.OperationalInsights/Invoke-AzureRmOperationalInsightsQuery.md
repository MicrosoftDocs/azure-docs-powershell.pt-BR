...
Se canalizado, a ID do espaço de trabalho será extraída da PSWorkspace. Caso contrário, você pode usar o parâmetro workspaceid para especificar manualmente a ID do espaço de trabalho.

## EXIBE

### Microsoft. Azure. Commands. OperationalInsights. Models. PSQueryResponse
O ***PSQueryResponse*** contém os resultados, renderizar as estatísticas & da consulta.
