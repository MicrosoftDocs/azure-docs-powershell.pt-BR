...
## DESCRITIVO
O cmdlet Get-AzureRmRecoveryServicesBackupRPMountScript baixa um script que monta os volumes do ponto de recuperação no computador em que ele é executado.
