...
## DESCRITIVO
O cmdlet **Reset-AzureRmServerManagementGatewayProfile** redefine o perfil para um gateway de gerenciamento do servidor do Azure.

Você precisará usar o cmdlet Save-AzureRmServerManagementGatewayProfile para baixar o perfil e, em seguida, o cmdlet Install-AzureRmServerManagementGatewayProfile para salvá-lo depois de redefinir o perfil.
...
### -Gateway
Especifica o gateway para o qual o cmdlet redefine o perfil.

Pode ser especificado em vez de ResourceGoupName e GATEWAYNAME
...
### -GATEWAYNAME
Especifica o nome do gateway para o qual o cmdlet redefine o perfil.
