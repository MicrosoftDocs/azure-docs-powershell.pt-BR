...
## DESCRITIVO
O cmdlet **Get-AzureRmServerManagementSession** Obtém uma única sessão de gerenciamento do servidor do Azure.
...
### -Nó
Especifica um objeto de **nó** existente que é usado para obter os parâmetros *ResourceGroupName* e *node NodeName* .
Você também deve especificar um valor para o parâmetro *SessionName* .
...
### -NodeName
Especifica o nome do nó no qual a sessão está localizada.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos para o qual esse cmdlet obtém a sessão de recuperação.
...
### -Sessão
Especifica um objeto **Session** existente que é usado para obter o *ResourceGroupName* , *NodeName* e os parâmetros *SessionName* .
...
### -SESSIONNAME
Especifica o nome da sessão na qual esse cmdlet se obtém.
