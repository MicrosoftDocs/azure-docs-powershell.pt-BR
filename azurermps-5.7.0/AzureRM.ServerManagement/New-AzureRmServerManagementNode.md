...
## DESCRITIVO
O cmdlet **New-AzureRmServerManagementNode** cria um nó de gerenciamento do servidor do Azure.
...
### -ComputerName
Especifica o nome do computador que está sendo gerenciado.
...
### -Credential
Especifica um objeto **PSCredential** para a conexão com o nó Gerenciamento do servidor.
...
### -Gateway
Especifica o gateway que gerencia o nó.

Esse parâmetro pode ser usado em vez dos parâmetros *ResourceGroupName* , *GATEWAYNAME* e *Location* .
...
### -GATEWAYNAME
Especifica o nome do gateway que acessa o nó.
...
### -Local
Especifica o local em que esse cmdlet cria o nó.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos no qual esse cmdlet cria o nó.
...
### -Marca
Pares de chave/valor associados ao objeto.
