...
## DESCRITIVO
O cmdlet **Remove-AzureRmServerManagementNode** remove um nó de gerenciamento do servidor do Azure.
...
### -Nó
Especifica o nó para o qual esse cmdlet Remove.
...
### -NodeName
Especifica o nome do nó para o qual esse cmdlet Remove.
