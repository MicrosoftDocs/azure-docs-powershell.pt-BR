...
## DESCRITIVO
O cmdlet **New-AzureRmServerManagementSession** cria uma sessão de gerenciamento do servidor do Azure.
...
### -Credential
Especifica um objeto **PSCredential** para a conexão com a sessão de gerenciamento do servidor.
...
### -Nó
Especifica o nó para o qual esse cmdlet cria a sessão.

Esse parâmetro pode ser usado em vez dos parâmetros *ResourceGroupName* e *NodeName* .
...
### -NodeName
Especifica o nome do nó para o qual esse cmdlet cria uma sessão.
...
### -ResourceGroupName
Especifica o grupo de recursos do nó para o qual esse cmdlet cria uma sessão.
...
### -SESSIONNAME
Especifica o nome a ser usado para a sessão.
