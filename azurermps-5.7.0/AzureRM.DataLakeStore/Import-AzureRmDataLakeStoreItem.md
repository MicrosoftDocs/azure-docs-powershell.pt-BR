...
### -ConcurrentFileCount
Indica o número máximo de arquivos a serem carregados em paralelo para um carregamento de pasta.  O padrão será calculado como um melhor esforço com base na pasta e no tamanho do arquivo
...
### -PerFileThreadCount
Indica o número máximo de threads a serem usados por arquivo.  O padrão será calculado como um melhor esforço com base na pasta e no tamanho do arquivo
