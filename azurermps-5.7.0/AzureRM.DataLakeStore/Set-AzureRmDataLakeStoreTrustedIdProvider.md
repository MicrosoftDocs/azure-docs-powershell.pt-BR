...
## DESCRITIVO
O cmdlet **set-AzureRmDataLakeStoreTrustedIdProvider** modifica o provedor de identidade confiável especificado no repositório data Lake especificado.
...
Isso atualiza o provedor endpoing para a regra de firewall "MyProvider" na conta "ContosoADL" para " https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150 "

## OS

### -Conta
A conta do data Lake Store para adicionar o provedor de identidade confiável
...
### -ProviderEndpoint
O ponto de extremidade do provedor confiável válido no formato: https://sts.windows.net/\<provider identity\>
...
O provedor de identidade confiável atualizado.
