...
A conta específica do data Lake Store solicitada.

### Programação<PSDataLakeStoreAccountBasic>
Uma lista de contas do data Lake Store no grupo de recursos ou na assinatura especificada.
