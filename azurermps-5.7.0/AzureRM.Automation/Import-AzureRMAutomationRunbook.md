...
## DESCRITIVO
O cmdlet **Import-AzureRmAutomationRunbook** importa um runbook de automação do Azure. Especifique o caminho para um arquivo de script wps_2 (. ps1) a ser importado para os runbooks de fluxo de trabalho wps_2 e wps_2, o arquivo (. graphrunbook) para runbooks gráficos ou o arquivo (. py) dos runbooks do Python 2. Para wps_2 runbooks de fluxo de trabalho, o script deve conter uma única definição de fluxo de trabalho wps_2 que corresponda ao nome do arquivo.
...
O segundo comando importa um runbook gráfico chamado GraphicalRunbook06 para a conta de automação chamada AutomationAccount01.
O comando também atribui as marcas armazenadas em $Tags.
...
### -Descrição
Especifica uma descrição do runbook importado.
...
### -Nome
Especifica o nome do runbook importado por esse cmdlet.
