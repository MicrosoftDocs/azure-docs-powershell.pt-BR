...
## DESCRITIVO
O cmdlet **New-AzureRmAutomationVariable** cria uma variável na automação do Azure.
...
O primeiro comando obtém uma máquina virtual usando o cmdlet Get-AzureVM.
