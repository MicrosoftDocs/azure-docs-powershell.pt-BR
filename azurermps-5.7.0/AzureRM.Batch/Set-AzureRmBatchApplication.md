...
## DESCRITIVO
O cmdlet **set-AzureRmBatchApplication** modifica as configurações do aplicativo em lotes do Azure especificado.

## EXEMPLOS

### Exemplo 1: atualizar um aplicativo em uma conta em lotes
```
...
Esse comando altera se o aplicativo Llitware na conta ContosoBatch permite atualizações.
O comando não altera a versão padrão ou o nome de exibição do aplicativo.

## OS

### -AccountName
Especifica o nome da conta em lotes para a qual esse cmdlet modifica um aplicativo.
