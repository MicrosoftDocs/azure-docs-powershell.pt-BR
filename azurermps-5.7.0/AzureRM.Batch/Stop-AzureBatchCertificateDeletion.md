...
## DESCRITIVO
O cmdlet **Stop-AzureBatchCertificateDeletion** cancela uma falha na exclusão de um certificado no serviço em lotes do Azure.
Você pode parar uma exclusão apenas se o certificado estiver no estado **DeleteFailed** .
Isso cmldet restaura o certificado ao estado **ativo** .
