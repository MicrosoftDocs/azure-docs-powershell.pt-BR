...
## DESCRITIVO
O cmdlet **set-AzureBatchComputeNodeUser** modifica as propriedades de uma conta de usuário em um nó de computação em lotes do Azure.
...
Esse comando modifica a conta de usuário chamada PFuller no nó de computação que tem o ID especificado no pool chamado ContosoPool.
...
### -ComputeNodeId
Especifica a ID do nó de computação em que esse cmdlet Opera.
...
### -Nome
Especifica o nome da conta de usuário que esse cmdlet modifica.
...
### -Poolid
Especifica a ID do pool que contém o nó de computação em que esse cmdlet Opera.
