...
## DESCRITIVO
O cmdlet **Remove-AzureRmIntegrationAccountMap** remove um mapa de conta de integração de um grupo de recursos.
...
Esse comando Remove o mapa da conta de integração chamado IntegrationAccountMap47.
