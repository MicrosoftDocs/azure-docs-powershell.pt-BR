...
## DESCRITIVO
O cmdlet **Get-AzureRmIntegrationAccount** Obtém contas de integração de um grupo de recursos. Especifique o nome da conta de integração e o nome do grupo de recursos.
