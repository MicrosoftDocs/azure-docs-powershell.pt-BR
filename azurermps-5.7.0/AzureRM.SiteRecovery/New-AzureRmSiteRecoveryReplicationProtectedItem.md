...
## DESCRITIVO
O cmdlet **New-AzureRmSiteRecoveryReplicationProtectedItem** cria um novo item de replicação protegida.
Use esse cmdlet para habilitar a replicação para um item que permite proteção.
...
### -Nome
Especifica o nome do item protegido de replicação do Azure site Recovery.
...
### -ProtectableItem
Especifica o item que protege o Azure site Recovery.
...
Especifica o objeto de mapeamento de contêiner de proteção do Azure site Recovery a ser usado para replicação.
...
Especifica a ID da conta de armazenamento do Azure à qual esse cmdlet se replica.
...
### -WaitForCompletion
Indica que o cmdlet aguarda a conclusão.
