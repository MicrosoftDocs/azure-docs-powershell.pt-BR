...
## DESCRITIVO
O cmdlet Start-AzureRmNetworkWatcherConnectionMonitor inicia o monitor de conexão especificado.
...
Neste exemplo, começamos o monitor de conexão especificado por nome e Inspetor de rede
