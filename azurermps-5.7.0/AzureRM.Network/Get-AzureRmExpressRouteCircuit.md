...
## DESCRITIVO
O cmdlet **Get-AzureRmExpressRouteCircuit** é usado para recuperar um objeto de circuito do ExpressRoute da sua assinatura. O objeto de circuito retornado pode ser usado como entrada para outros cmdlets que operam em circuitos do ExpressRoute.

## EXEMPLOS

### Exemplo 1: baixar o circuito do ExpressRoute para ser excluído
```
