...
{{Insira Add-AzureRmLoadBalancerInboundNatPoolConfig Descrição manualmente aqui}}
...
{{Insira Get-AzureRmBgpServiceCommunity Descrição manualmente aqui}}
...
{{Insira Get-AzureRmLoadBalancerInboundNatPoolConfig Descrição manualmente aqui}}
...
Obtém um monitor de conexão

### [Get-AzureRmNetworkWatcherConnectionMonitorReport](Get-AzureRmNetworkWatcherConnectionMonitorReport.md)
Obtém um instantâneo dos Estados de conexão mais recentes
...
{{Insira Get-AzureRmVirtualNetworkGatewayConnectionSharedKey Descrição manualmente aqui}}
...
{{Insira New-AzureRmLoadBalancerInboundNatPoolConfig Descrição manualmente aqui}}
...
Cria um novo recurso monitor de conexão.
...
{{Insira New-AzureRmVirtualNetworkGatewayConnection Descrição manualmente aqui}}
...
{{Insira Remove-AzureRmLoadBalancerInboundNatPoolConfig Descrição manualmente aqui}}
...
{{Insira Remove-AzureRmVirtualNetworkGatewayIpConfig Descrição manualmente aqui}}

### [Remove-AzureRmVirtualNetworkPeering](Remove-AzureRmVirtualNetworkPeering.md)
{{Insira Remove-AzureRmVirtualNetworkPeering Descrição manualmente aqui}}
...
{{Insira Reset-AzureRmVirtualNetworkGateway Descrição manualmente aqui}}

### [Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey](Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey.md)
{{Insira Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey Descrição manualmente aqui}}
...
{{Insira Set-AzureRmLoadBalancerInboundNatPoolConfig Descrição manualmente aqui}}
...
Modifica um monitor de conexão.
...
Interrompe um monitor de conexão em execução
...
{{Insira Test-AzureRmDnsAvailability Descrição manualmente aqui}}
