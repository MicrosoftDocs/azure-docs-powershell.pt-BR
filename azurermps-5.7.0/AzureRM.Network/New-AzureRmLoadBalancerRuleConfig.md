...
## DESCRITIVO
O cmdlet **New-AzureRmLoadBalancerRuleConfig** cria uma configuração de regra para um balanceador de carga do Azure.

## EXEMPLOS

### 1: criando uma configuração de regra para um balanceador de carga do Azure
```
