...
## DESCRITIVO
O cmdlet **Remove-AzureRmNetworkSecurityGroup** remove um grupo de segurança de rede do Azure.
...
Esse comando Remove o grupo de segurança chamado NSG-FrontEnd no grupo de recursos chamado TestRG.
...
### -Nome
Especifica o nome do grupo de segurança de rede que este cmdlet Remove.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos do qual este cmdlet Remove um grupo de segurança de rede.
