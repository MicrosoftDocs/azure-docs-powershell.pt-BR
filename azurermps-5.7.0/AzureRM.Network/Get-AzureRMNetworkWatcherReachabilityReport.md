...
## DESCRITIVO
O Get-AzureRmNetworkWatcherReachabilityReport Obtém a pontuação de latência relativa dos provedores de serviço de Internet de um local especificado para regiões do Azure.
...
### -EndTime
A hora de término do relatório de acessibilidade do Azure.
...
### -StartTime
A hora de início do relatório de acessibilidade do Azure.
