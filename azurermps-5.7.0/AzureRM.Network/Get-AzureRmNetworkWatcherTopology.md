...
## DESCRITIVO
O cmdlet Get-AzureRmNetworkWatcherTopology uma exibição em nível de rede de recursos e suas relações em um grupo de recursos. Observação: se os recursos de várias regiões estiverem no grupo de recursos, somente os recursos na mesma região do Inspetor de rede serão incluídos na saída JSON.
...
Neste exemplo, executamos o cmdlet Get-AzureRmNetworkWatcherTopology em um grupo de recursos que contém uma VM, NIC, NSG e IP público.
...
## INFORMA
Palavras-chave: Azure, azurerm, ARM, recurso, gerenciamento, gerente, rede, rede, Inspetor de rede, topologia, exibição 
