...
## DESCRITIVO
O cmdlet **Remove-AzureRmExpressRouteCircuitPeeringConfig** remove uma configuração de emparelhamento de circuito do ExpressRoute.

## EXEMPLOS

### Exemplo 1: remover uma configuração de emparelhamento de um circuito do ExpressRoute
```
