...
## DESCRITIVO
O cmdlet New-AzureRmNetworkWatcherConnectionMonitor rcreates um monitor de conexão para uma origem e um destino especificados.

## EXEMPLOS

### Exemplo 1: criar um monitor de conexão para uma VM e um destino da Internet
```
...
O cmdlet New-AzureRmNetworkWatcherConnectionMonitor cria um monitor de conexão para uma origem e um destino especificados.
...
### -DestinationAddress
O endereço IP do destino do monitor de conexão.
...
A ID do destino do monitor de conexão.
...
### -SourceResourceId
A ID da fonte do monitor de conexão.
...
[Parar-AzureRmNetworkWatcherPacketCapture]()
...
[Parar-AzureRmNetworkWatcherConnectionMonitor]()
