...
O comando final atribui a política em $Policy no nível de um grupo de recursos usando o arquivo de parâmetro de política AllowedLocations.jsno diretório de trabalho local.
A propriedade **ResourceId** de $ResourceGroup identifica o grupo de recursos.
...
### -SKU
Uma tabela de hash que representa as propriedades de SKU. Padrões para SKU grátis: Name = a0, Tier = fre
