...
## DESCRITIVO
O cmdlet **New-AzureRmSchedulerHttpJob** cria um trabalho http no Agendador do Azure.

Esse cmdlet dá suporte a parâmetros dinâmicos com base nos parâmetros *ErrorActionType* e *HttpAuthenticationType* .
...
### -Frequency
Especifica uma frequência máxima para o trabalho.
Os valores aceitáveis para esse parâmetro são:
...
Especifica o tipo de autenticação HTTP.
Os valores aceitáveis para esse parâmetro são:
...
### -JobName
Especifica um nome para o trabalho.
...
### -Método
Especifica o método para os tipos de ação do trabalho.
Os valores aceitáveis para esse parâmetro são:
...
### -RequestBody
Especifica o valor do corpo para colocar e postar ações de trabalho.
...
### -URI
Especifica um URI para a ação do trabalho.
