...
## DESCRITIVO
O cmdlet **Get-AzureRmSchedulerJobCollection** Obtém as coleções de trabalhos no Agendador do Azure.
...
### -ResourceGroupName
Especifica o grupo de recursos a partir do qual esse cmdlet obtém as coletas de trabalho.
