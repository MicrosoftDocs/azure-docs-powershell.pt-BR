...
## DESCRITIVO
O cmdlet **set-AzureRmDataLakeAnalyticsFirewallRule** atualiza uma regra de firewall em uma conta do Azure data Lake Analytics.
...
Esse comando atualiza a regra de firewall chamada "minha regra de firewall" na conta "ContosoAdlAcct" para ter o novo intervalo de IP: 127.0.0.1-127.0.0.10
