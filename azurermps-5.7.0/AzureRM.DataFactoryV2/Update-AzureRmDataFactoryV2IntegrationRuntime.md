...
## DESCRITIVO
O cmdlet **Update-AzureRmDataFactoryV2IntegrationRuntime** atualiza as propriedades do tempo de execução de integração. Atualmente, o cmdlet só dá suporte à atualização de ' AutoUpdate ' e ' AutoUpdateDelayOffset ' para o tempo de execução de integração de hospedagem automática.
