...
Para obter uma lista atualizada dos locais do Azure, execute o seguinte comando:
...
-Tags @ {Name = "CalendarYear"; Valor = "2016"}

Para adicionar várias marcas no mesmo comando, separe as marcas individuais usando vírgulas:

-Tag @ {Name = "CalendarYear"; Valor = "2016"}, @ {Name = "FiscalYear"; Valor = "2017"}
