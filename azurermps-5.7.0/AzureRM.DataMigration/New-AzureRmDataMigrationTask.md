...
## DESCRITIVO
O cmdlet New-AzureRmDataMigrationTask cria uma tarefa de migração de dados. Esse cmdlet tem parâmetros para o enumerador de tipo de tarefa, o grupo de recursos do Azure, o nome do serviço de migração de dados do Azure associado e o projeto como entrada. 
