...
## DESCRITIVO
O cmdlet **set-AzureKeyVaultCertificateAttribute** modifica os atributos editáveis de um certificado.

## EXEMPLOS

### Exemplo 1: modificar as marcas associadas a um certificado
```
...
O primeiro comando atribui uma matriz de pares de chave/valor à variável $Tags.

O segundo comando define o valor de marcas do certificado chamado TestCert01 para ser $Tags.

O comando final exibe o certificado TestCert01 usando o cmdlet Get-AzureKeyVaultCertificate para verificar a operação.
...
### -Habilitar
Indica se um certificado deve ser habilitado ou desabilitado.
...
### -Nome
Especifica o nome do certificado a ser modificado. Esse cmdlet constrói o FQDN de um certificado com base no nome do cofre de chaves, no ambiente selecionado atualmente, no nome do certificado e na versão do certificado.
...
### -Cofrename
Especifica o nome do cofre de chaves no qual esse cmdlet modifica um certificado.
Esse cmdlet constrói o FQDN de um cofre de chaves com base no nome e no ambiente selecionado no momento.
...
Esse cmdlet constrói o FQDN de um certificado com base no nome do cofre de chaves, no ambiente selecionado atualmente, no nome do certificado e na versão do certificado.
