...
Os detalhes do grupo configurado no serviço de gerenciamento de API.

### IList<Microsoft. Azure. Commands. ApiManagement. onmanagement. Models. PsApiManagementGroup>
A lista de grupos configurados no serviço de gerenciamento de API.
