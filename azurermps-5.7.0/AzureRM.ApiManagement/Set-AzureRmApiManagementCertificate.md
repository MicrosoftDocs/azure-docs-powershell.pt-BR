...
## DESCRITIVO
O cmdlet **set-AzureRmApiManagementCertificate** modifica um certificado de gerenciamento de API do Azure.
...
Esse comando modifica o certificado de gerenciamento de API especificado.
