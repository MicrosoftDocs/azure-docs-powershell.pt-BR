...
## DESCRITIVO
O cmdlet **New-AzureRmSqlDatabaseRestorePoint** cria um novo ponto de restauração do qual um banco de dados SQL do Azure pode ser restaurado.
...
Esse comando cria um ponto de restauração para o banco de dados SQL do Azure e retorna os detalhes do ponto de restauração.
