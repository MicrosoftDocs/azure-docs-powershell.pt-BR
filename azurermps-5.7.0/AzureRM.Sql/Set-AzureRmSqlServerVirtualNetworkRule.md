...
## DESCRITIVO
Esse comando modifica a configuração de uma regra de rede virtual do Azure SQL Server.


Para controlar o conjunto de regras de rede virtual no servidor, use "Add-AzureRmSqlServerVirtualNetworkRule" e "Remove-AzureRmSqlServerVirtualNetworkRule" em vez disso.
...
Modifica uma regra de rede virtual existente com a nova ID de sub-rede de rede virtual que contém informações sobre a nova rede virtual
...
O nome da regra de rede virtual do Azure SQL Server.
...
A ID de sub-rede da rede virtual para a regra.
