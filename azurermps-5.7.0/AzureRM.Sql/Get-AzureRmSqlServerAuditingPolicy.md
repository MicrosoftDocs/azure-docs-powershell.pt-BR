...
## DESCRITIVO
O cmdlet **Get-AzureRmSqlServerAuditingPolicy** Obtém a política de auditoria de um SQL Server do Azure.
Especifique os parâmetros *ResourceGroupName* , *nome_do_servidor* e *DatabaseName* para identificar o banco de dados.
Esse cmdlet retorna uma política que é usada pelos bancos de dados SQL do Azure que são definidos no SQL Server do Azure especificado e usam sua política de auditoria.

## EXEMPLOS

### Exemplo 1: obter a política de auditoria de um SQL Server do Azure com auditoria de tabela definida
```
...
### Exemplo 2: obter a política de auditoria de um SQL Server do Azure com auditoria de blob definida
```
PS C:\>Get-AzureRmSqlServerAuditingPolicy -ResourceGroupName "resourcegroup01" -ServerName "server01"
...
### -Nomedoservidor
Especifica o nome do Azure SQL Server para o qual esse cmdlet obtém a política de auditoria.
