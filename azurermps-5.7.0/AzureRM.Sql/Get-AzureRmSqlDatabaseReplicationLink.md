...
###  
Esse cmdlet aceita instâncias do **ReplicationLink** ou do objeto de **banco de dados** para o banco de dados primário ou secundário.

## EXIBE

###  
Esse cmdlet retorna um objeto **ReplicationLink** .
