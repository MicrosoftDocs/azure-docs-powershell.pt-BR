...
### -Marcas
Especifica um dicionário de marcas que este cmdlet associa ao servidor. Pares de valores chave na forma de uma tabela de hash definidas como marcas no servidor. Por exemplo:
