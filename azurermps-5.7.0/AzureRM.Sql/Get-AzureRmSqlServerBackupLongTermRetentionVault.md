...
## DESCRITIVO
O cmdlet **Get-AzureRmSqlServerBackupLongTermRetentionVault** Obtém o cofre de retenção de longo prazo registrado neste servidor.
...
### -Nomedoservidor
Especifica o servidor para o qual esse cmdlet obtém um cofre.
