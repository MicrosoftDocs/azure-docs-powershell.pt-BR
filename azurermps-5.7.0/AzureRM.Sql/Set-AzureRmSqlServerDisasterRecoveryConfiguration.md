...
## DESCRITIVO
O cmdlet **set-AzureRmSqlServerDisasterRecoveryConfiguration** modifica uma configuração de recuperação do servidor de banco de dados SQL.
...
### -AllowDataLoss
Indica que a operação de failover permite perda de dados.
...
### -Nomedoservidor
Especifica o nome de um servidor de banco de dados SQL.
...
### -VirtualEndpointName
Especifica o nome de um ponto de extremidade virtual.
