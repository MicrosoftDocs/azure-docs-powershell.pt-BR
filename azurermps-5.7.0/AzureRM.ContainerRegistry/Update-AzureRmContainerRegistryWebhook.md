...
## DESCRITIVO
O cmdlet Update-AzureRmContainerRegistryWebhook atualiza um webhook do registro do contêiner.

## EXEMPLOS

### Exemplo 1: atualizar um webhook existente do registro do contêiner.
```powershell
...
Atualizar um webhook existente do registro do contêiner.
...
### -Header
Cabeçalhos personalizados separados por espaço no formato ' chave \[ = valor \] ' que serão adicionados às notificações do webhook.
...
### -Marca
Marcas separadas por espaço no formato ' chave \[ = valor \] '.
...
### -Webhook
Objeto webhook do registro contêiner.
