...
## DESCRITIVO
O New-AzureHDInsightCluster cria um cluster do Azure HDInsight usando os parâmetros especificados ou usando um objeto de configuração que é criado usando o cmdlet New-AzureRmHDInsightClusterConfig.
...
Você também pode usar o cmdlet Add-AzureRmHDInsightStorage.
...
Opções são: Hadoop, HBase, Storm, Spark
...
Esse objeto pode ser criado usando o cmdlet New-AzureRmHDInsightClusterConfig.
...
Você também pode usar o cmdlet Add-AzureRmHDInsightConfigValues.
...
Você também pode usar o cmdlet Set-AzureRmHDInsightDefaultStorage.
...
Você também pode usar Add-AzureRmHDInsightScriptAction.
...
Você também pode usar o cmdlet Add-AzureRmHDInsightSecurityProfile.
