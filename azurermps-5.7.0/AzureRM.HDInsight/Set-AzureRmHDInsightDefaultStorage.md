...
## DESCRITIVO
O cmdlet **set-AzureRmHDInsightDefaultStorage** define a configuração padrão da conta de armazenamento no objeto de configuração do cluster do Azure HDInsight criado pelo cmdlet New-AzureRmHDInsightClusterConfig.
