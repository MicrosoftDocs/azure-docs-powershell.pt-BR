...
## DESCRITIVO
O cmdlet **Get-AzureRmHDInsightJobOutput** Obtém a saída de log para um trabalho da conta de armazenamento associada a um cluster do Azure HDInsight.

## EXEMPLOS

### Exemplo 1: obter a saída do log para um trabalho
```
PS C:\># Cluster info
...
Esse comando obtém a saída do log do cluster chamado seu-Hadoop-001.
...
Especifica a chave da conta de armazenamento padrão.
