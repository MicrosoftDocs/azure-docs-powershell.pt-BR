...
Adiciona um novo nome de consumidor chamado "myconsumero" ao eventhub para eventos de telemetria no iothub chamado "myiothub"

### Exemplo 2: adicionar um grupo de consumidores às operações que monitoram o eventhub
```
...
Adiciona um novo nome de consumidor chamado "myconsumero" ao eventhub para eventos de monitoramento de operações no iothub chamado "myiothub"
...
Nome do meu consumidor do EventHub que você deseja adicionar.
...
Nome do ponto de extremidade do EventHub.
