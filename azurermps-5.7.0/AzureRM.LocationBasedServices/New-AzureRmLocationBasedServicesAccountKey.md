...
## DESCRITIVO
O cmdlet **New-AzureRmLocationBasedServicesAccountKey** regenera uma chave de API para uma conta de serviços com base em local.
...
Regenera a chave de API secundária para a conta de serviços com base em local especificada.
...
### -KeyName
Chave da conta de serviços baseados em local.
