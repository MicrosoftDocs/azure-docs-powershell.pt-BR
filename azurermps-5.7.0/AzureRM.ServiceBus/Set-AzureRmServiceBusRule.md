...
## DESCRITIVO
O cmdlet **set-AzureRmServiceBusRule** atualiza a descrição da regra especificada da assinatura determinada.
...
atualiza a **MySQL = ' Condition '** da regra `SBEule` da assinatura `SBSubscription` no tópico `SBTopic`
