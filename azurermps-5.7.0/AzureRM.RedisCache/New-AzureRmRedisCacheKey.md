...
## DESCRITIVO
O cmdlet **New-AzureRmRedisCacheKey** regenera a tecla de acesso de um cache do Azure Redis.
...
Esse comando regenera a chave primária de um cache Redis.
...
Esse comando regenera a chave secundária de um cache Redis.
...
### -KeyType
Especifica se a chave de acesso primária ou secundária deve ser regerada.
...
### -Nome
Especifica o nome do cache Redis.
...
Esse cmdlet retorna a chave de acesso principal e secundária de um cache do Redis.
