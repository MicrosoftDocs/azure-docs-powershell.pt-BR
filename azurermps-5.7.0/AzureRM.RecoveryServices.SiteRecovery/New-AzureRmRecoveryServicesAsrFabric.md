...
## DESCRITIVO
O cmdlet **New-AzureRmRecoveryServicesAsrFabric** cria uma malha de recuperação de site do Azure do tipo especificado.
...
### -Azure
Parâmetro de opção indica a criação da malha do Azure.
