...
O cmdlet retorna um objeto artefato que tem um ResourceId que pode ser referenciado no cmdlet New-AzDeloymentManagerServiceTopology para que os artefatos necessários para um recurso de recurso, o modelo e os arquivos de parâmetros, possam ser referenciados neste local.
