...
## DESCRITIVO
O cmdlet **Get-AzBatchTask** Obtém tarefas em lotes do Azure para um trabalho em lotes.
Especifique um trabalho pelo parâmetro *JobID* ou por meio do parâmetro *Job* .
Para obter uma única tarefa, especifique o parâmetro *ID* .
Você pode especificar o parâmetro *Filter* para obter as tarefas correspondentes a um filtro do Open Data Protocol (OData).

## EXEMPLOS

### Exemplo 1: obter uma tarefa por ID
```
...
Este comando obtém a tarefa com a ID Task03 no Job Job01.
Use o cmdlet Get-AzBatchAccountKeys para atribuir um contexto para a variável $Context.

### Exemplo 2: obter todas as tarefas concluídas de um trabalho especificado
```
...
Esse comando obtém as tarefas concluídas a partir do trabalho que tem a ID Job02.
...
### -Expandir
Especifica uma cláusula de expansão OData.
Especifique um valor para esse parâmetro para obter entidades associadas da entidade principal para obter.
...
### -Filtro
Especifica uma cláusula de filtro OData para tarefas.
Se você não especificar um filtro, esse cmdlet retornará todas as tarefas para a conta ou o trabalho em lotes.
...
### -ID
Especifica a ID da tarefa obtida por esse cmdlet.
...
### -JobId
Especifica a ID do trabalho que contém as tarefas obtidas por esse cmdlet.
...
### -MaxCount
Especifica o número máximo de tarefas a serem retornadas.
