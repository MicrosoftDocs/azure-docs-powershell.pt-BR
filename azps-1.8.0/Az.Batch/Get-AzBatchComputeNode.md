...
## DESCRITIVO
O cmdlet **Get-AzBatchComputeNode** Obtém os nós de computação em lotes do Azure a partir de um pool.
...
Esse comando obtém o pool com a ID Pool07 usando o cmdlet Get-AzBatchPool.
...
Para obter um objeto **PSCloudPool** , use o cmdlet Get-AzBatchPool.
