...
## DESCRITIVO
O cmdlet **New-AzBatchApplication** adiciona um aplicativo à conta em lotes do Azure especificada.
...
### -AccountName
Especifica o nome da conta em lotes para a qual esse cmdlet adiciona um aplicativo.
