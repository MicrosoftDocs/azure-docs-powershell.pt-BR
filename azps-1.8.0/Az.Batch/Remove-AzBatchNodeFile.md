...
## DESCRITIVO
O cmdlet **Remove-AzBatchNodeFile** exclui um arquivo de nó de lote do Azure para uma tarefa ou um nó de computação.
...
Esse comando obtém o arquivo de nó usando **Get-AzBatchNodeFile**.
Esse arquivo está associado à tarefa que tem a ID Task26 sob o job job-000001.
...
Para obter um **PSNodeFile** , use o cmdlet Get-AzBatchNodeFile.
...
### -Caminho
O caminho do arquivo do nó a ser excluído.
