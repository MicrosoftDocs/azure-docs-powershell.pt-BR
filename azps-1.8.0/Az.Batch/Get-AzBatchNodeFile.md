...
## DESCRITIVO
O cmdlet **Get-AzBatchNodeFile** Obtém as propriedades dos arquivos de nó de lote do Azure de uma tarefa ou um nó de computação.
...
### -Caminho
Especifica o caminho do arquivo de nó para o qual esse cmdlet recupera propriedades.
...
Para obter um objeto Task, use o cmdlet Get-AzBatchTask.
