...
## DESCRITIVO
Esse comando cria um ponto de extremidade de nuvem do Azure File Sync. Um ponto de extremidade de nuvem é uma referência a um compartilhamento de arquivos existente do Azure. Ele representa o compartilhamento de arquivos e define a participação na sincronização de todos os arquivos que fazem parte do grupo de sincronização no qual o ponto de extremidade da nuvem foi criado.
...
Um ponto de extremidade de nuvem é um membro integrante de um grupo de sincronização, este é um exemplo de como criar um grupo de sincronização existente chamado "mySyncGroupName".
...
### -Nome
Nome do ponto de extremidade da nuvem. Quando criado por meio do portal do Azure, o nome é definido como o nome do compartilhamento de arquivos do Azure ao qual ele faz referência.
...
### -ParentObject
Objeto de objeto de sincronização, normalmente passado pelo parâmetro.
...
### -ParentResourceId
ID do recurso pai do pool de sincronização
...
### -AzureFileShareName
Nome de compartilhamento de conta de armazenamento (nome de compartilhamento de arquivos do Azure)
...
ID de locatário da conta de armazenamento (ID do diretório da empresa)
