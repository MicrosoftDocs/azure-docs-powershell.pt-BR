...
## DESCRITIVO
O cmdlet **Remove-AzManagedApplicationDefinition** remove uma definição de aplicativo gerenciado

## EXEMPLOS

### Exemplo 1: remover a definição do aplicativo gerenciado por ID do recurso
```
...
O primeiro comando obtém uma definição de aplicativo gerenciado chamada myAppDef usando o cmdlet Get-AzManagedApplicationDefinition.
O comando o armazena na variável $ApplicationDefinition.
O segundo comando Remove a definição do aplicativo gerenciado identificada pela propriedade **ResourceId** de $ApplicationDefinition.
