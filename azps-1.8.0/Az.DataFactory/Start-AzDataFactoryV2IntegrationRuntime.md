...
## DESCRITIVO
O cmdlet **Start-AzDataFactoryV2IntegrationRuntime** inicia um tempo de execução de integração dedicada gerenciado. O recurso é provisionado e após a operação em que o estado é ' iniciado '.
...
[Parar-AzDataFactoryV2IntegrationRuntime]()
