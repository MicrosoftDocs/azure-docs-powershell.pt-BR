...
## DESCRITIVO
O cmdlet **Stop-AzDataFactoryV2IntegrationRuntime** interrompe um tempo de execução de integração dedicada gerenciado no estado ' iniciado ', que foi iniciado pelo cmdlet Start-AzDataFactoryV2IntegrationRuntime. Os recursos são liberados e o estado é transferido para ' parado '.

## EXEMPLOS

### Exemplo 1: parar um tempo de execução de integração gerenciada que está no estado ' iniciado '.
```
...
O tempo de execução de integração gerenciada ' test-reserlved-IV ' está no estado ' iniciado '. Após a execução do cmdlet Stop-AzDataFactoryV2IntegrationRuntime, os recursos são liberados e o estado é transferido para ' parado '.
