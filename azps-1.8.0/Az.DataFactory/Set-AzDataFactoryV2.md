...
### Exemplo 2: criar uma fábrica de dados com detalhes do repoconfiguration usando um objeto de fábrica existente.
```
...
### -HostName
O nome do host para a configuração do repositório.
...
### -ProjectName
O nome do projeto para a configuração do repositório.
...
### -Tenantid
A ID do locatário para a configuração do repositório.
