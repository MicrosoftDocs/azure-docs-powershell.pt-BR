...
### Exemplo 1 criar uma nova chave de API para um recurso do Application insights
```
...
Crie uma descrição da chave da API do Application insights como "testapiKey" com permissões "ReadTelemetry", "WriteAnnotations" para o recurso "teste" no grupo de recursos "Test Group".
...
### -Permissões
Permissões que a chave de API permite que os aplicativos façam.
