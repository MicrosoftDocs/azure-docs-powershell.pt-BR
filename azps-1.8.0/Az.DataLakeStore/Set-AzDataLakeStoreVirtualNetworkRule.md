...
## Sinopse
Modifica a regra de rede virtual especificada no repositório data Lake especificado.
...
## DESCRITIVO
O cmdlet **set-AzDataLakeStoreVirtualNetworkRule** modifica a regra de rede virtual especificada no repositório data Lake especificado.
...
Atualiza a identificação de sub-rede da regra de rede virtual "myVNET" na conta "DLS" para "updatedid"
...
### -Subnetid
O início do intervalo de IP válido para a regra de rede virtual
