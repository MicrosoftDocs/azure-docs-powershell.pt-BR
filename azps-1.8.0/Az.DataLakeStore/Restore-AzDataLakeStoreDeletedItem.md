...
## DESCRITIVO
O cmdlet **Restore-AzDataLakeStoreDeletedItem** restaura um arquivo ou uma pasta excluída no repositório data Lake. Requer o caminho do item excluído no Trash retunred por Get-AzDataLakeStoreDeletedItem.
