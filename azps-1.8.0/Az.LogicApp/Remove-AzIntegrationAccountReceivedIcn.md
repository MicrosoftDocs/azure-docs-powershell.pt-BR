...
## DESCRITIVO
Este cmdlet se destina a ser usado em cenários de recuperação de desastres para remover um número de controle de intercâmbio recebido da conta de integração para que o conector B2B possa processar novamente a mensagem quando a detecção de número duplicado estiver habilitada.
Em raras ocasiões, o número de controle de intercâmbio recebido pode ser reservado logo antes de um desastre e antes de o conector B2B rejeitar o intercâmbio como errado.
Em tais ocasiões, a operação pode querer habilitar o site de recuperação para processar novamente o mesmo intercâmbio após a correção da carga.
...
Confirma que o número de controle de intercâmbio recebido X12 foi removido tentando recuperá-lo.
...
Tenta obter um número de controle de troca EDIFACT recebido que o conteúdo não está em um formato válido.
Remove o número de controle de troca EDIFACT recebido.
Confirma que o número de controle de intercâmbio recebido EDIFACT foi removido tentando recuperá-lo.
