...
## DESCRITIVO
O cmdlet **Export-AzAutomationDscConfiguration** exporta uma configuração de estado desejado do APS (DSC) da automação do Azure para um arquivo local.
...
- Provisório
- Publicado o valor padrão é publicado.
