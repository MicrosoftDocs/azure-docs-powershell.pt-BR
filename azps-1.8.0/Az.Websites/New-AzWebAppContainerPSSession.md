...
Isso criará uma nova sessão remota do PowerShell na ContosoASP do aplicativo de contêiner do Windows e mostrará os processos em execução no contêiner ContosoASP
...
### -Force
Crie a sessão do PowerShell sem solicitar confirmação.
