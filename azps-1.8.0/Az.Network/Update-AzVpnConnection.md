...
O banda que precisa ser manipulado por essa conexão em Mbps.
...
### -InputObject
O objeto VpnConenction a ser atualizado.
...
### -ResourceId
A ID do recurso do objeto VpnConenction a ser excluído.
