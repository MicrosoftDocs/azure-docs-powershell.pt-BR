...
## DESCRITIVO
O cmdlet New-AzDdosProtectionPlan cria um plano de proteção contra DDoS.
...
Primeiro, criamos um novo plano de proteção contra DDoS com o comando **New-AzDdosProtectionPlan** .
Em seguida, criamos uma nova rede virtual com **New-AzvirtualNetwork** e especificamos a ID do plano recém-criado no parâmetro **DdosProtectionPlanId**. Nesse caso, como estamos associando a rede virtual a um plano, também podemos especificar o parâmetro **EnableDdoSProtection**.
...
Por fim, persistemos o novo estado canalizando a variável local para **set-AzVirtualNetwork**.
