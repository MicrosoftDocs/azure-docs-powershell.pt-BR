...
## Sinopse
Remove a configuração de drenamento de conexão de um objeto de configurações HTTP de back-end.
...
## Descrição
O cmdlet **Remove-AzApplicationGatewayConnectionDraining** remove a configuração de drenamento de conexão de um objeto de configurações HTTP de back-end.
...
O último comando remove a configuração de esgotamento de conexão das configurações HTTP de back-end armazenadas no $Settings.
