...
## DESCRITIVO
O cmdlet **Remove-AzApplicationGatewayRewriteRuleSet** remove um conjunto de regras de regravação de um aplicativo de gateway do Azure.
...
O segundo comando Remove o conjunto de regras Rewrite chamado RuleSet02 do gateway do aplicativo armazenado em $AppGw.
...
### -Nome
O nome do aplicativo do gateway de RewriteRuleSet
