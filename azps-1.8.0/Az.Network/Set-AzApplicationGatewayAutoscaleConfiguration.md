...
O segundo comando atualiza a configuração de autoescala do gateway applicationg.
...
### -MaxCapacity
Capcity máximo para o gateway do aplicativo.
...
### -MinCapacity
Capcity mínima para o gateway do aplicativo.
