...
## DESCRITIVO
O cmdlet **set-AzVpnClientIpsecParameter** define os parâmetros de VPN IPsec do gateway de rede virtual existente.
Quando o gateway de rede virtual é criado, ele define o conjunto de diretivas IPSec de VPN padrão no gateway. Em caso afirmativo, o usuário do site quer usar determinada política IPSec personalizada para se conectar ao gateway VPN, o usuário tem que definir essa política IPSec em um gateway VPN primeiro. **Set-AzVpnClientIpsecParameter** fornece uma maneira de fazer isso.
...
New-AzVpnClientIpsecParameter cmdlet é usado para criar o objeto de parâmetros de IPSec VPN do uso dos valores passados um ou todos os parâmetros que o usuário pode definir para qualquer gateway de rede virtual existente no grupo de Resource.
...
Parâmetros de IPsec do cliente VPN. Esse valor de parâmetro pode ser construído usando o comando PS Let: New-AzVpnClientIpsecParameter
