...
## Descrição
O Get-AzNetworkWatcherNextHop cmdlet recebe o próximo salto de um VM.
O próximo salto permite exibir o tipo de recurso do Azure, o endereço IP associado desse recurso e a regra de tabela de roteamento que é responsável pela rota.
...
Obter o Próximo Salto para comunicação de saída da Interface de Rede principal na Vachine Virtual especificada para 204.79.197.200 (www.bing.com)
