...
Obtém todas as variáveis de servidor disponíveis, cabeçalhos de solicitação e resposta.
...
Cria uma ação de regra de regravação para um gateway de aplicativo.
...
Cria um novo objeto de perfil de diagnóstico de configuração de rede. Esse objeto é usado para restringir a Confiuration de rede durante uma sessão de diagnóstico usando os critérios especificados.
