...
## DESCRITIVO
O cmdlet **set-AzLoadBalancer** atualiza um balanceador de carga.
...
### -Loadbalancer
Especifica um objeto de balanceador de carga que representa o estado para o qual o balanceador de carga deve ser definido.
