...
## DESCRITIVO
O cmdlet **set-AzServiceBusGeoDRConfigurationFailOver** envokes o failover de Dr geográfico e reconfigure o alias para apontar para o namespace secundário
