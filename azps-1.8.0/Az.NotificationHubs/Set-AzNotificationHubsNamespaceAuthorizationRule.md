...
Um arquivo JSON é um arquivo de texto que usa uma sintaxe semelhante a esta: {  
    ...
    "Direitos": \[  
        ...
        Envio  
    \]  
} Quando usado em conjunto com o cmdlet **set-AzNotificationHubsNamespaceAuthorizationRule** , o exemplo JSON anterior modifica uma regra de autorização chamada ContosoAuthorizationRule para conceder aos usuários a permissão de escuta e envio para o namespace.
