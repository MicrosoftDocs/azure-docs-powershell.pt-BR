...
## DESCRITIVO
O cmdlet **Get-AzSqlSyncAgent** retorna informações sobre um ou mais agentes de sincronização do SQL do Azure.
Especifique o nome de um agente de sincronização para ver informações somente para esse agente de sincronização.

## EXEMPLOS

### Exemplo 1: obter todas as instâncias do Azure SQL Sync Agent atribuídas a um SQL Server do Azure
```
...
Esse comando obtém informações sobre todos os agentes do Azure SQL Sync atribuídos a um SQL Server do Azure.

### Exemplo 2: obter informações sobre um agente de sincronização do SQL do Azure
```
...
Esse comando obtém informações sobre o agente de sincronização do banco de dados SQL do Azure com o nome "SyncAgent01"

### Exemplo 3: obter todas as instâncias do agente de sincronização do SQL do Azure atribuídas a um SQL Server do Azure usando a filtragem
```
...
Esse comando obtém informações sobre todos os agentes do Azure SQL Sync atribuídos a um SQL Server do Azure que começam com "SyncAgent".
