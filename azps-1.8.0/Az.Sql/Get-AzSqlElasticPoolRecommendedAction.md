...
## DESCRITIVO
O cmdlet **Get-AzSqlElasticPoolRecommendedAction** Obtém uma ou mais ações recomendadas para um conselheiro de pool elástico do SQL Azure.

## EXEMPLOS

### Exemplo 1: listar todas as ações recomendadas para um conselheiro
```
...
Esse comando obtém uma lista de todas as ações recomendadas do supervisor chamada CreateIndex disponível para o pool elástico chamado WIRunnerPool.
...
Esse comando obtém a ação recomendada chamada IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 do conselheiro chamado CreateIndex.

## OS

### -Supervisorname
Especifica o nome do supervisor para o qual este cmdlet solicita ações recomendadas.
...
### -ElasticPoolName
Especifica o nome do pool elástico para o qual este cmdlet solicita ações recomendadas.
...
### Microsoft. Azure. Commands. Sql. Recomendadoaction. Model. AzureSqlElasticPoolRecommendedActionModel
