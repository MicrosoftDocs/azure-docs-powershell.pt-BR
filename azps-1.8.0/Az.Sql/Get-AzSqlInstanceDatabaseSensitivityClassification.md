...
## DESCRITIVO
O cmdlet Get-AzSqlInstanceDatabaseSensitivityClassification retorna os tipos de informações atuais e rótulos de sensibilidade de colunas no banco de dados instância gerenciada do Azure SQL.

## EXEMPLOS

### Exemplo 1: obter tipos de informações atuais e rótulos de sensibilidade de um banco de dados de instância gerenciada do Azure SQL.
```powershell
...
### Exemplo 2: obter tipos de informações atuais e rótulos de sensibilidade de um banco de dados de instância gerenciada do Azure SQL com encanamento.
```powershell
...
### Exemplo 3: obter tipo de informação atual e rótulo de sensibilidade de uma coluna específica de um banco de dados de instância gerenciada do Azure SQL.
```powershell
...
### Exemplo 4: obter tipo de informação atual e rótulo de sensibilidade de uma coluna específica de um banco de dados de instância gerenciada do Azure SQL usando o encanamento.
```powershell
