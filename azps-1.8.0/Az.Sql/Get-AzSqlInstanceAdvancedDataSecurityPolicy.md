...
## DESCRITIVO
O cmdlet **Get-AzSqlInstanceAdvancedDataSecurityPolicy** Retrives a política de segurança de dados avançada de uma instância gerenciada.

## EXEMPLOS

### Exemplo 1-Obtém a instância gerenciada segurança de dados avançada
```powershell
...
### Exemplo 2-Obtém a instância gerenciada segurança de dados avançada do recurso instância gerenciada
```powershell
