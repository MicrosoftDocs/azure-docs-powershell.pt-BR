...
### Exemplo 1 remover o meu consumidor do eventhub do eventhub de telemetria
```
...
Remove o nome de cliente do IotHub chamado "myiothub"
...
Nome do o seu consumidor do EventHub.
