...
## DESCRITIVO
Obtém as informações sobre um trabalho do IotHub.
Um trabalho do IotHub é criado quando uma operação de importação ou exportação é initialted usando os comandos New-AzIotHubExportDevices ou New-AzIotHubImportDevices.
