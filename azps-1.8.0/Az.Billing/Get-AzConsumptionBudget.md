...
## DESCRITIVO
O cmdlet Get-AzConsumptionBudget Obtém uma lista de orçamentos em uma assinatura ou em um grupo de recursos.

## EXEMPLOS

### Exemplo 1: obter uma lista de orçamentos no nível de assinatura
```powershell
...
### Exemplo 2: obter uma lista de orçamentos em nível de grupo de recursos
```powershell
...
### Exemplo 3: obter um orçamento com o nome do orçamento no nível de assinatura
```powershell
...
### Exemplo 4: obter um orçamento com o nome do orçamento em nível de grupo de recursos
```powershell
