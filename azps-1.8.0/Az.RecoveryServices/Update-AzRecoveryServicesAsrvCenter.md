...
## DESCRITIVO
O cmdlet **Update-AzRecoveryServicesAsrvCenter** é atualizado para obter detalhes de descoberta de um vCenter registrado.
...
### -InputObject
O objeto do servidor do vCenter para o qual atualizar os detalhes da descoberta.
