...
Habilita o backup automático para um item que pode ser protegido com uma política de proteção de backup especificada.
...
Obter itens protegidos de um contêiner.
...
Obter intervalos de tempo para um item de backup.
...
Obter plano de recuperação para um item de backup de backup.
...
Consultas para novos bancos de trabalho na carga de trabalho.
...
Registra um contêiner de proteção.
