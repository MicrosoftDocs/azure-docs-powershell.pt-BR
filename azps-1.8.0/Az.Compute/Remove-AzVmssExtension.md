...
## DESCRITIVO
O cmdlet **Remove-AzVmssExtension** remove uma extensão do VMSS (conjunto de dimensionamento de máquina virtual).

## EXEMPLOS

### Exemplo 1: remover uma extensão VMSS
```
...
Esse comando Remove a extensão de um VMSS e atualiza o VMSS após a modificação.

### Exemplo 2: remover uma instância de dentro de um VMSS
```
PS C:\> $vmss = Get-AzVmss -ResourceGroupName $RGName -VMScaleSetName $vmssName 
PS C:\> Remove-AzVmssExtension -ResourceGroupName "Group002" -VirtualMachineScaleSet $vmss -Id $extensionId
```

Esse comando Remove a ID de extensão de nome da VMSS que pertence ao grupo de recursos chamado Group002.
