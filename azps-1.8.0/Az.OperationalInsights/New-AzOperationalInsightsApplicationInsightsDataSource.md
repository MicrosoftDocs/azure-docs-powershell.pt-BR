...
Esse comando cria uma fonte de dados Application insights de um determinado aplicativo em uma determinada análise de registro workpsace. Isso habilita a coleta de logs de um determinado aplicativo para a análise de logs workpsace.
