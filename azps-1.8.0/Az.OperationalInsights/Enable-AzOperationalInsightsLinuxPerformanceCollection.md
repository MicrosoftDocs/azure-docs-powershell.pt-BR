...
## DESCRITIVO
O cmdlet **Enable-AzOperationalInsightsLinuxPerformanceCollection** inicia a coleta de contadores de desempenho de computadores Linux conectados em um espaço de trabalho.
