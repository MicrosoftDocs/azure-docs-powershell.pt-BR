...
Adiciona a sub-rede e IgnoreMissingVnetServiceEndpoint (VirtualNetworkRule) determinada ao NetworkRuleSet para o namespace especificado
...
Adiciona o $virtualruleset 1 a NetworkRuleSet para o namespace fornecido
...
Objeto de configuração VirtualNetworkRule
