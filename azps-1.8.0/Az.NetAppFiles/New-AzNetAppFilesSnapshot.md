...
## DESCRITIVO
O cmdlet **New-AzNetAppFilesSnapshot** cria um instantâneo ANF.
...
Esse comando cria o novo instantâneo ANF "MyAnfSnapshot" dentro do volume "MyAnfVolume".
...
### -Volumeobject
O volume do novo objeto de instantâneo
