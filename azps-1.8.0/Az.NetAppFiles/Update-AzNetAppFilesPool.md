...
## Sinopse
Atualiza um pool de arquivos do Azure NetApp (ANF) com o novo conjunto de dados.
...
## DESCRITIVO
O cmdlet **Update-AzNetAppFilesPool** modifica um pool de ANF.

## EXEMPLOS

### Exemplo 1: modificar um pool de ANF
```
...
Esse comando altera o pool de ANF "MyAnfPool" para ter o tamanho e o nível de um determinado.
...
### -Accountobject
O objeto de conta que contém o pool a ser atualizado
...
### -InputObject
O objeto de pool a ser atualizado
...
### -Nível de
O nível de serviço do pool ANF
