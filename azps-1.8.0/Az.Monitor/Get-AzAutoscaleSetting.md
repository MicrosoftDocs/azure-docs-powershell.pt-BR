...
## DESCRITIVO
O cmdlet **Get-AzAutoscaleSetting** obtém todas as configurações de autoescala associadas a um grupo de recursos ou uma configuração de autoescala especificada.
