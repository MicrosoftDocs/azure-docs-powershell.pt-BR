...
## DESCRITIVO
O cmdlet **New-AzFrontDoorFireWallPolicy** cria uma nova política do Azure WAF no grupo de recursos especificado na assinatura atual

## EXEMPLOS

### Exemplo 1: criar uma política WAF
```powershell
...
### -Nome
Nome do WebApplicationFireWallPolicy.
