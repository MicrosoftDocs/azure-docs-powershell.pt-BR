...
## DESCRITIVO
O cmdlet **Update-AzFrontDoorFireWallPolicy** atualiza uma política WAF existente. Se os parâmetros de entrada não forem fornecidos, os parâmetros antigos da política WAF existente serão usados.
