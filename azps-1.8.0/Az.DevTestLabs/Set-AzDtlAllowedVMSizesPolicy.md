...
## DESCRITIVO
O cmdlet **set-AzDtlAllowedVMSizesPolicy** define a política de tamanhos de máquinas virtuais permitidos, que especifica uma lista de tamanhos de máquinas virtuais permitidos em um laboratório.
...
### -LabName
Especifica o nome do laboratório para o qual esse cmdlet define a política de tamanhos de máquina virtual.
...
### -VmSizes
Especifica, como uma matriz de cadeia de caracteres, a lista de tamanhos de máquinas virtuais permitidos no laboratório.
