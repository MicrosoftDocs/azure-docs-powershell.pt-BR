...
## DESCRITIVO
O cmdlet **set-AzDataLakeAnalyticsCatalogItemAclEntry** adiciona ou modifica uma entrada (ACE) na lista de controle de acesso (ACL) de um item de catálogo ou catálogo na análise do data Lake.
