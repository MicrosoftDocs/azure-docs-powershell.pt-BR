...
## Sinopse
Cria ou atualiza uma cota de computação com os parâmetros de cota fornecidos.
...
### Exemplo 1: criar uma cota de computação com parâmetros padrão
```powershell
...
Todos os parâmetros que não forem especificados serão definidos como o parâmetro padrão, mostrado acima.

### Exemplo 2: criar uma cota de computação com parâmetros personalizados
```powershell
...
Personalize a cota com parâmetros. Qualquer parâmetro não especificado terá o valor padrão.
...
### -CoresCount
Número máximo de núcleos permitido.
...
### -NewQuota
Armazena informações de cota de computação usadas para controlar a alocação de recursos.
...
Número máximo de discos gerenciados e instantâneos do tipo Premium permitidos.
...
Número máximo de discos gerenciados e instantâneos do tipo padrão permitidos.
...
### -VMScaleSetCount
Número máximo de conjuntos de escala permitidos.
...
NEWQUOTA <IQuota> : armazena informações de cota de computação usadas para controlar a alocação de recursos.
