...
Use um link acessível publicamente para fornecer o local da extensão ou o URI para um blob do Azure usando o SasUri.
...
### -Extensão
Parâmetros usados para criar uma nova imagem de extensão de máquina virtual.
Para construir, consulte a seção observações para propriedades de extensão e crie uma tabela de hash.
...
### -IsSystemExtension
Indica se a extensão é para o sistema.
...
### -PropertiesPublisher
O fornecedor da extensão da VM
...
### -ProvisioningState
Configuração do estado de extensão.
...
### -SourceBlob
URL para blob do Azure ou do AzureStack.
...
Verdadeiro se der suporte a várias extensões.
...
### -VmOsType
Destino do tipo de sistema operacional da máquina virtual necessária para implantar o manipulador de extensão.
...
### -VMScaleSetEnabled
Valor que indica se a extensão está habilitada para suporte ao conjunto de escala de máquina virtual.
...
EXTENSÃO <IVMExtensionParameters> : parâmetros usados para criar uma nova imagem de extensão de máquina virtual.
  - `[ComputeRole <String>]`: Calcular função
  - `[IsSystemExtension <Boolean?>]`: Indica se a extensão é para o sistema.
  - `[ProvisioningState <ProvisioningState?>]`: Configurando o estado da extensão.
  - `[Publisher <String>]`: O fornecedor da extensão da VM
  - `[SourceBlobUri <String>]`: URI para blob do Azure ou AzureStack.
  - `[SupportMultipleExtension <Boolean?>]`: Verdadeiro se der suporte a várias extensões.
  - `[VMScaleSetEnabled <Boolean?>]`: Valor que indica se a extensão está habilitada para suporte ao conjunto de escala de máquina virtual.
  - `[VmosType <OSType?>]`: Destino do tipo de sistema operacional da máquina virtual necessária para implantar o manipulador de extensão.
