...
## DESCRITIVO
O cmdlet **New-AzPrivateDnsZone** cria uma nova zona de sistema de nome de domínio (DNS) privada no grupo de recursos especificado. Você deve especificar um nome de zona DNS particular exclusivo para o parâmetro *Name* , ou o cmdlet retornará um erro. Após a criação da zona, use o cmdlet New-AzPrivateDnsRecordSet para criar conjuntos de registros na zona.
...
### Exemplo 1: criar uma zona DNS privada
```
