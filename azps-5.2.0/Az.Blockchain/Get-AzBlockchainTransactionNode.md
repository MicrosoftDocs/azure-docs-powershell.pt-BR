...
### Exemplo 1: listar nós de transação para um membro de blockchain
```powershell
...
Esse comando lista os nós de transação para um membro de blockchain.
...
Esse comando obtém um nó de transação.
