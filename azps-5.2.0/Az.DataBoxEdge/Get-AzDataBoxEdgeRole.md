...
## DESCRITIVO
O cmdlet **Get-AzDataBoxEdgeRole** busca as funções IOT disponíveis para um dispositivo de borda de caixa de dados. Você pode mencionar o parâmetro Name para obter os detalhes de uma função IoT específica.
