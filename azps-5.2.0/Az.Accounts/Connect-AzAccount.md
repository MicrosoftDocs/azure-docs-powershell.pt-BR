...
Obsoleta. Para usar o ponto de extremidade MSI personalizado, defina a variável de ambiente MSI_ENDPOINT, por exemplo, " http://localhost:50342/oauth2/token ". Nome do host para o serviço gerenciado.
...
Obsoleta. Para usar o ponto de extremidade MSI personalizado, defina a variável de ambiente MSI_ENDPOINT, por exemplo, " http://localhost:50342/oauth2/token ". Número da porta do serviço gerenciado.
...
Obsoleta. Para usar o segredo MSI personalizado, defina a variável de ambiente MSI_SECRET. Token para o logon de serviço gerenciado.
...
Número máximo de assinatura para preencher contextos após o logon. O padrão é 25. Para preencher todas as assinaturas para contextos, defina como-1.
