...
## DESCRITIVO
O cmdlet Import-AzContext carrega informações de autenticação de um arquivo para definir o contexto e o ambiente do Azure.
...
Este exemplo seleciona um contexto de um arquivo JSON que é passado pelo cmdlet. Esse arquivo JSON pode ser criado a partir de Save-AzContext.

## OS

### -AzureContext
{{Fill AzureContext descrição}}
...
### -Caminho
Especifica o caminho para as informações de contexto salvas usando Save-AzContext.
