...
O objeto de servidor pode ser recuperado usando o cmdlet Get-AzMigrateServerReplication para construir, consulte a seção de anotações para obter as propriedades INPUTobject e criar uma tabela de hash.
...
INPUTobject <IMigrationItem> : especifica o servidor de replicação para o qual a limpeza de migração de teste precisa ser iniciada. O objeto do servidor pode ser recuperado usando o cmdlet Get-AzMigrateServerReplication
