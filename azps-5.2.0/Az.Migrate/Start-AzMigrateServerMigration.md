...
### -InputObject
Especifica o servidor de replicação para o qual a migração precisa ser iniciada.
...
### -TargetObjectID
Especifica o servidor replcating para o qual a migração precisa ser iniciada.
...
### -TurnOffSourceServer
Especifica se o servidor de origem deve ser desativado após a migração.
...
INPUTobject <IMigrationItem> : especifica o servidor de replicação para o qual a migração precisa ser iniciada. O objeto do servidor pode ser recuperado usando o cmdlet Get-AzMigrateServerReplication.
