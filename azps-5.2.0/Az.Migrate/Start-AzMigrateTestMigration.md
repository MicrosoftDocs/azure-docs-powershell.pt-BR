...
## Sinopse
Inicia a migração de teste para o servidor de replicação.
...
### -InputObject
Especifica o servidor de replicação para o qual a migração de teste precisa ser iniciada.
...
### -TestNetworkID
Atualiza a ID de rede virtual na assinatura de destino do Azure para ser usada para a migração de teste.
...
INPUTobject <IMigrationItem> : especifica o servidor de replicação para o qual a migração de teste precisa ser iniciada. O objeto do servidor pode ser recuperado usando o cmdlet Get-AzMigrateServerReplication.
