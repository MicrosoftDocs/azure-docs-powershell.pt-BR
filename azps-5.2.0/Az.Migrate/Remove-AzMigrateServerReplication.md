...
## Sinopse
Interrompe a replicação para o servidor migrado.
...
Ressincronize por ID.

### Exemplo 2: remover por objeto de entrada
```powershell
...
### -ForceRemove
Especifica se a replicação precisa ser reforçada.
...
### -TargetObjectID
Especifica o servidor replcating para o qual o Replicatio precisa ser desabilitado.
