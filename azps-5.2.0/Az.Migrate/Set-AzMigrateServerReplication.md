...
## Sinopse
Atualiza as propriedades de destino para o servidor de replicação.
...
### -InputObject
Especifica o servidor de replicação para o qual as propriedades precisam ser atualizadas.
O objeto do servidor pode ser recuperado usando o cmdlet Get-AzMigrateServerReplication.
...
### -NicToUpdate
Atualiza a NIC da máquina virtual do Azure a ser criada.
Para construir, consulte a seção notas para propriedades NICTOUPDATE e crie uma tabela de hash.
...
Especifica o conjunto de disponibilidade a ser usado para a criação de VM.
...
### -TargetNetworkId
Atualiza a ID de rede virtual na assinatura de destino do Azure à qual o servidor precisa ser migrado.
...
### -TargetObjectID
Especifica o servidor replcating para o qual as propriedades precisam ser atualizadas.
A ID deve ser recuperada usando o cmdlet Get-AzMigrateServerReplication.
...
Atualiza a ID do grupo de recursos na assinatura de destino do Azure à qual o servidor precisa ser migrado.
...
INPUTobject <IMigrationItem> : especifica o servidor de replicação para o qual as propriedades precisam ser atualizadas. O objeto do servidor pode ser recuperado usando o cmdlet Get-AzMigrateServerReplication.
  - `[Location <String>]`: Local do recurso
  - `[CurrentJobId <String>]`: A ID do braço do trabalho que está sendo executado.
...
NICTOUPDATE <IVMwareCbtNicInput [] >: atualiza a NIC da máquina virtual do Azure a ser criada.
  - `IsPrimaryNic <String>`: Um valor que indica se esta é a NIC primária.
