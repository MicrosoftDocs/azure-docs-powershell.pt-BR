...
## DESCRITIVO
O cmdlet **New-AzBatchAccount** cria uma conta em lotes do Azure para o grupo de recursos e a localização especificados.
...
Cria uma conta em lotes. (gerado automaticamente)
...
### -IdentityType
A identidade associada ao BatchAccount
...
### -Keyvaultid
A ID do recurso do cofre de chaves do Azure associado à conta em lotes.
...
### -KeyVaultUrl
A URL do cofre de chaves do Azure associado à conta em lotes.
...
### -PoolAllocationMode
O modo de alocação para a criação de grupos na conta em lotes.
