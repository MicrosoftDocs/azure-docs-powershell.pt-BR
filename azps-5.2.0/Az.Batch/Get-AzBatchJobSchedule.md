...
## DESCRITIVO
O cmdlet **Get-AzBatchJobSchedule** Obtém cronogramas do trabalho em lotes do Azure para a conta em lotes especificada pelo parâmetro *BatchContext* .
Especifique uma ID para obter um único cronograma de trabalho.
Especifique o parâmetro *Filter* para obter as agendas de trabalho correspondentes a um filtro do Open Data Protocol (OData).

## EXEMPLOS

### Exemplo 1: obter um plano de trabalho especificando uma ID
```
...
Esse comando obtém o plano de trabalho que tem a ID JobSchedule23.
Use o cmdlet Get-AzBatchAccountKey para atribuir um contexto para a variável $Context.

### Exemplo 2: obter cronogramas de trabalho usando um filtro
```
...
Esse comando obtém todas as agendas de trabalho que têm IDs que começam com o trabalho especificando o parâmetro *Filter* .
...
Esse cmdlet retorna as agendas de trabalho que correspondem ao filtro especificado por esse parâmetro.
Se você não especificar um filtro, esse cmdlet retornará todas as agendas de trabalho do contexto em lotes.
...
### -ID
Especifica a ID do agendamento de trabalho que este cmdlet obtém.
...
### -MaxCount
Especifica o número máximo de cronogramas de trabalho a serem retornados.
