...
## DESCRITIVO
O cmdlet **Update-AzSynapseSparkPool** atualiza um pool Spark do Azure Synapse Analytics.
...
Esse comando atualiza um pool do Spark da análise do Azure Synapse.
...
Esse comando atualiza um pool do Spark do Azure Synapse Analytics pelo pipeline.
...
Esse comando atualiza um pool Spark do Azure Synapse Analytics com ID do recurso.
...
Esse comando habilita a escala automática para um pool Spark do Azure Synapse Analytics.
...
Esse comando desabilita a escala automática de um pool Spark do Azure Synapse Analytics.
...
Esse comando habilita a pausa automática para um pool Spark do Azure Synapse Analytics.
...
Esse comando desabilita a pausa automática para um pool Spark do Azure Synapse Analytics.
...
Número de minutos ociosos. Esse parâmetro deve ser especificado quando a pausa automática está habilitada.
...
Número máximo de nós a serem alocados no pool do Spark especificado.
Esse parâmetro deve ser especificado quando a dimensionamento automático está habilitada.
...
Número mínimo de nós a serem alocados no pool do Spark especificado.
Esse parâmetro deve ser especificado quando a dimensionamento automático está habilitada.
...
### -EnableAutoScale
Indica se a dimensionamento automático deve ser habilitada
...
Arquivo de configuração de ambiente (saída de "PIP Freeze").
...
### -Nós
Número de núcleo e memória a serem usados para nós atribuídos no pool do Spark especificado.
Esse parâmetro deve ser especificado quando a dimensionamento automático está desabilitada
...
### -ResourceId
Identificador de recurso do pool do Spark Synapse.
