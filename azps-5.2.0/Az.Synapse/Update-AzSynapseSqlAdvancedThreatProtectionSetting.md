...
## DESCRITIVO
O cmdlet **Update-AzSynapseSqlAdvancedThreatProtectionSetting** atualiza as configurações avançadas de proteção contra ameaças em um espaço de trabalho de análise do Azure Synapse. Para habilitar a proteção avançada contra ameaças em um espaço de trabalho, as configurações de auditoria devem estar habilitadas nesse espaço de trabalho.
...
Esse comando atualiza as configurações avançadas de proteção contra ameaças para um espaço de trabalho chamado ContosoWorkspace.
