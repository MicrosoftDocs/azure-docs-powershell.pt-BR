...
## DESCRITIVO
O cmdlet **Add-AzSynapseTriggerSubscription** assina o gatilho de evento para os eventos do serviço externo especificado da definição do gatilho.
...
Esse comando inscreverá o gatilho chamado ContosoTrigger para os eventos especificados da definição do gatilho.
...
Esse comando inscreverá o gatilho chamado ContosoTrigger para os eventos especificados da definição do disparador por meio do pipeline.
