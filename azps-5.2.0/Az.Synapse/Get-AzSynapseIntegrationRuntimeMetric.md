...
## DESCRITIVO
O cmdlet **Get-AzSynapseIntegrationRuntimeMetric** obtém dados métricos sobre o tempo de execução de integração em um espaço de trabalho.
...
Esse comando exibe dados métricos sobre o tempo de execução de integração chamado "Test-selfhost-IV" no espaço de trabalho chamado ContosoWorkspace.
