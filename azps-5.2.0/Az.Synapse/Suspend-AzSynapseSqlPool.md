...
### SuspendByNameParameterSet (padrão)
```
...
## DESCRITIVO
O cmdlet **Suspend-AzSynapseSqlPool** suspende um pool SQL do Azure Synapse Analytics.
...
Esse comando suspende um pool SQL do Azure Synapse Analytics ativo.
