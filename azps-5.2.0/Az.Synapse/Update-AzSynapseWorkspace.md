...
## DESCRITIVO
O cmdlet **Update-AzSynapseWorkspace** atualiza um espaço de trabalho de análise do Azure Synapse.
...
Esses comandos atualizam as marcas do espaço de trabalho de análise do Azure Synapse specififed.
...
Esses comandos atualizam as marcas do espaço de trabalho de análise do Azure Synapse do specififed por meio do pipeline.
...
Esses comandos atualizam as marcas do espaço de trabalho de análise do Azure Synapse do specififed por meio do pipeline com a ID do recurso.
...
A nova senha de administrador do SQL para o espaço de trabalho.
