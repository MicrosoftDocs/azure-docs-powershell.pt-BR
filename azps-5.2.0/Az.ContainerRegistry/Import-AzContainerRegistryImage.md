...
Importar busybox para ACR. Anota 
* "library/" precisa ser adicionado antes da imagem de origem. "busybox: mais recente" => "library/busybox: latest"
* Credenciais necessárias se o registro de origem não estiver disponível publicamente
...
Importar busybox do ACR de origem para o ACR de destino. Anota 
* Credenciais necessárias se o usuário administrador do registro de origem foi desabilitado.
...
### -Mode
Quando forçar, qualquer marca de destino existente será substituída.
Quando noforce, todas as marcas de destino existentes falham na operação antes de começar a copiar.
...
Isso vai usar a marca ' mais recente '.

Especifique uma imagem por marca (' Olá-mundo: mais recente ').
...
O identificador de recurso do registro de contêiner de origem do Azure.
...
### -TargetTag
Lista de cadeias de caracteres da marca repositório de formulários \[ : \] .
Quando a marca for omitida, a origem será usada (ou ' Latest ' se a marca de fonte também estiver omitida).
...
Lista de cadeias de caracteres de nomes de repositório para fazer um manifesto copiar apenas.
...
### -Username
O nome de usuário para autenticar com o registro de origem.
