...
### Exemplo 1: listar todas as MariaDB em assinaturas
```powershell
...
Esse comando lista todas as MariaDB em uma assinatura.

### Exemplo 2: listar todas as MariaDB em um grupo de recursos
```powershell
...
Esse comando lista todas as MariaDB em um grupo de recursos.

### Exemplo 3: obter um MariaDB
```powershell
