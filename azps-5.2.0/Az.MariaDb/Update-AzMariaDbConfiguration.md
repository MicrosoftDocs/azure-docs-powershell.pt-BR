...
Use Update-AzMariaDbServer em vez disso, se quiser atualizar AdministratorLoginPassword, SKU, etc.
...
### Exemplo 1: atualizar a configuração do MariaDB
```powershell
...
Esse comando atualiza uma configuração do MariaDB.
