...
### Exemplo 1: criar um novo MariaDB
```powershell
...
Esse comando cria um novo MariaDB.

## OS

### -AdministratorLoginPassword
A senha do administrador deve ser SecureString.
...
### -GeoRedundantBackup
Habilite a redundância geográfica ou não para o backup do servidor.
