...
Adicionar uma configuração de gerenciamento automático de dispositivo IoT em um hub IoT de destino.
...
Lista todas ou uma configuração específica de gerenciamento automático de dispositivos da IoT.
...
Lista todas ou uma implantação de borda IoT específica.
...
Imprimir uma lista separada por vírgulas de dispositivos filho atribuídos.

### [Get-AzIotHubDeviceConnectionString](Get-AzIotHubDeviceConnectionString.md)
Obter a cadeia de conexão de um dispositivo IoT de destino em um hub IOT.
...
Obtém um dispositivo.

### [Get-AzIotHubDistributedTracing](Get-AzIotHubDistributedTracing.md)
Obter as configurações de rastreamento distribuído para um dispositivo.
...
Obtenha os detalhes de um módulo de dispositivo IoT ou módulos de lista localizados em um dispositivo IoT em um hub IoT.
...
Chame uma consulta métrica de configuração de dispositivo IoT.

### [Invoke-AzIotHubDeploymentMetricsQuery](Invoke-AzIotHubDeploymentMetricsQuery.md)
Invocar uma consulta métrica de implantação de borda IoT.
...
Gerar um token SAS para um hub IoT, dispositivo ou módulo de destino.
...
Excluir uma implantação de borda IoT.

### [Remove-AzIotHubDevice](Remove-AzIotHubDevice.md)
Excluir um dispositivo Hub IoT.

### [Remove-AzIotHubDeviceChildren](Remove-AzIotHubDeviceChildren.md)
Remover dispositivos fora da borda como filhos do dispositivo de borda especificado.
...
Atualize os campos mutáveis do registro de configuração.

### [Set-AzIotHubDeployment](Set-AzIotHubDeployment.md)
Atualize os campos mutáveis da implantação do IoT Edge.
...
Definir o dispositivo pai do dispositivo especificado.

### [Set-AzIotHubDistributedTracing](Set-AzIotHubDistributedTracing.md)
Atualizar as opções de rastreamento distribuído para um dispositivo.

### [Set-AzIotHubEdgeModule](Set-AzIotHubEdgeModule.md)
Defina os módulos de borda em um único dispositivo de borda.
...
Atualize um módulo em um dispositivo IoT de destino em um hub IoT.
...
Atualiza as marcas e as propriedades desejadas de um dispositivo.

### [Update-AzIotHubModuleTwin](Update-AzIotHubModuleTwin.md)
Atualiza as marcas e as propriedades desejadas de um módulo de dispositivo IoT.
