...
Cria um novo IotHub chamado "myiothub" do SKU "S1", a capacidade 1 e o local "northeurope" incluídos nas marcas.
...
### -Marca
Marcas de instância de Hub IoT. Recipiente de propriedades em pares de chave-valor na forma de uma tabela de hash.
