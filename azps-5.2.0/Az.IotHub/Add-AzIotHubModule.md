...
## DESCRITIVO
Crie um módulo em um dispositivo IoT de destino com um tipo de autorização diferente em um hub IoT.
...
Crie um módulo em um dispositivo IoT de destino com autorização padrão (chave privada compartilhada).
