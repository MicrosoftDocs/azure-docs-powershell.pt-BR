...
## DESCRITIVO
O cmdlet **Remove-AzRelayHybridConnection** remove o HybridConnection do namespace de retransmissão especificado.
...
Remove o HybridConnection `TestHybridConnection` do namespace `TestNameSpace-Relay1` .
