...
ms.locfileid: "98258688"
---
# <span data-ttu-id="0d98a-101">Get-AzRelayOperation</span><span class="sxs-lookup"><span data-stu-id="0d98a-101">Get-AzRelayOperation</span></span>

## <span data-ttu-id="0d98a-102">Sinopse</span><span class="sxs-lookup"><span data-stu-id="0d98a-102">SYNOPSIS</span></span>
<span data-ttu-id="0d98a-103">Lista de operações de retransmissão aceitas</span><span class="sxs-lookup"><span data-stu-id="0d98a-103">List supported Relay Operations</span></span>

## <span data-ttu-id="0d98a-104">SYNTAX</span><span class="sxs-lookup"><span data-stu-id="0d98a-104">SYNTAX</span></span>

```
Get-AzRelayOperation [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="0d98a-105">DESCRITIVO</span><span class="sxs-lookup"><span data-stu-id="0d98a-105">DESCRIPTION</span></span>
<span data-ttu-id="0d98a-106">O cmdlet **Get-AzRelayOperation** lista as operações com suporte para retransmissão.</span><span class="sxs-lookup"><span data-stu-id="0d98a-106">The **Get-AzRelayOperation** cmdlet Lists the Relay supported Operations.</span></span>

## <span data-ttu-id="0d98a-107">EXEMPLOS</span><span class="sxs-lookup"><span data-stu-id="0d98a-107">EXAMPLES</span></span>

### <span data-ttu-id="0d98a-108">Exemplo 1</span><span class="sxs-lookup"><span data-stu-id="0d98a-108">Example 1</span></span>
```
...
<span data-ttu-id="0d98a-109">Lista as operações aceitas de retransmissão</span><span class="sxs-lookup"><span data-stu-id="0d98a-109">Lists Relay supported operations</span></span>

## <span data-ttu-id="0d98a-110">OS</span><span class="sxs-lookup"><span data-stu-id="0d98a-110">PARAMETERS</span></span>

### <span data-ttu-id="0d98a-111">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="0d98a-111">-DefaultProfile</span></span>
<span data-ttu-id="0d98a-112">As credenciais, a conta, o locatário e a assinatura usados para comunicação com o Azure.</span><span class="sxs-lookup"><span data-stu-id="0d98a-112">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="0d98a-113">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="0d98a-113">CommonParameters</span></span>
<span data-ttu-id="0d98a-114">Esse cmdlet dá suporte a parâmetros comuns:-debug,-ErrorAction,-ErrorVariable,-Informationaction,-InformationVariable,-OutVariable,-OutBuffer,-PipelineVariable,-Verbose-WarningAction e-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="0d98a-114">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="0d98a-115">Para obter mais informações, consulte about_CommonParameters ( http://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="0d98a-115">For more information, see about_CommonParameters (http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="0d98a-116">SENSORES</span><span class="sxs-lookup"><span data-stu-id="0d98a-116">INPUTS</span></span>

### <span data-ttu-id="0d98a-117">Nenhuma</span><span class="sxs-lookup"><span data-stu-id="0d98a-117">None</span></span>

## <span data-ttu-id="0d98a-118">EXIBE</span><span class="sxs-lookup"><span data-stu-id="0d98a-118">OUTPUTS</span></span>

### <span data-ttu-id="0d98a-119">Microsoft. Azure. Commands. Relay. Models. PSOperationAttributes</span><span class="sxs-lookup"><span data-stu-id="0d98a-119">Microsoft.Azure.Commands.Relay.Models.PSOperationAttributes</span></span>

## <span data-ttu-id="0d98a-120">INFORMA</span><span class="sxs-lookup"><span data-stu-id="0d98a-120">NOTES</span></span>

## <span data-ttu-id="0d98a-121">LINKS RELACIONADOS</span><span class="sxs-lookup"><span data-stu-id="0d98a-121">RELATED LINKS</span></span>
