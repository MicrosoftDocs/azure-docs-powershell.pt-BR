...
## DESCRITIVO
Cria um serviço de emparelhamento.
...
Cria um objeto de serviço de emparelhamento com o provedor e o local de emparelhamento. Use no conjuction com `Get-AzPeeringServiceProvider` e `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
A localização física é diferente da região do Azure. Usar Get-AzPeeringServiceLocation [-Country <country> ]
...
O nome do provedor de serviço de emparelhamento.
Usar o cmdlet Get-AzPeeringServiceProvider para uma lista
...
### -Marca
As marcas a serem associadas ao serviço Microsoft InputObject.
