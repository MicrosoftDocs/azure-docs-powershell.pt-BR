...
## DESCRITIVO
O comando é usado para exibir recursos de emparelhamento herdados que você deseja converter em recursos de gerenciamento de recursos do Azure (ARM).
...
Obtém o emparelhamento herdado para Seattle
