...
## Sinopse
Cria um novo objeto do tipo PSIncludedPath. Ele pode ser passado como um valor de parâmetro para Set-AzCosmosDBGremlinGraph.
...
## DESCRITIVO
Objeto correspondente ao IncludedPath da API Gremlin.
