...
### Exemplo 1: obter um token de registro da área de trabalho virtual do Windows
```powershell
...
Este comando obtém um token de registro da área de trabalho virtual do Windows em um pool de hosts.
