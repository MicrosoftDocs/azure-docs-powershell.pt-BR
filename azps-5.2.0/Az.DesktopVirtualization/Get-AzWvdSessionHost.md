...
### Exemplo 1: obter um SessionHost de área de trabalho virtual do Windows por nome
```powershell
...
Este comando obtém um SessionHost da área de trabalho virtual do Windows em um pool de hosts.

### Exemplo 2: lista SessionHosts da área de trabalho virtual do Windows
```powershell
...
Esse comando lista um SessionHosts de área de trabalho virtual do Windows em um pool de hosts.
