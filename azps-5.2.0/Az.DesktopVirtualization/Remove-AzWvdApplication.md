...
### Exemplo 1: excluir um aplicativo de área de trabalho virtual do Windows por nome
```powershell
PS C:\> Remove-AzWvdApplication -ResourceGroupName ResourceGroupName -ApplicationGroupName ApplicationGroupName -Name ApplicationName
```

Esse comando exclui um aplicativo de área de trabalho virtual do Windows em um grupo do applicaton.
