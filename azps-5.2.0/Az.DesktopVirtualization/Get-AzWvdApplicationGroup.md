...
### Exemplo 1: obter um aplicativo de área de trabalho virtual do Windows por nome
```powershell
...
Este comando obtém um grupo de aplicativos área de trabalho virtual do Windows em um grupo de recursos.

### Exemplo 2: lista ApplicationGroups da área de trabalho virtual do Windows
```powershell
...
Esse comando lista um ApplicationGroups da área de trabalho virtual do Windows em um grupo de recursos.
