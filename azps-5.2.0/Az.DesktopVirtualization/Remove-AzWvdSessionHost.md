...
### Exemplo 1: excluir um SessionHost da área de trabalho virtual do Windows por nome
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Esse comando exclui uma SessionHost da área de trabalho virtual do Windows em um pool de hosts.
...
### -Force
Force o sinalizador para forçar a exclusão do sessionHost mesmo quando o usersession existe.
