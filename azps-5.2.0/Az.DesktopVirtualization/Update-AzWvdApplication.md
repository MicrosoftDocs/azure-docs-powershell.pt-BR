...
### Exemplo 1: atualizar um aplicativo de área de trabalho virtual do Windows
```powershell
...
Esse comando atualiza um aplicativo de área de trabalho virtual do Windows em um grupo do applicaton.
