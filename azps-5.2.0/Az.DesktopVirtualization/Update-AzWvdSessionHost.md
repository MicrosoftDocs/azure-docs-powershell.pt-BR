...
### Exemplo 1: atualizar um SessionHost de área de trabalho virtual do Windows por nome
```powershell
...
Esse comando atualiza um SessionHost de área de trabalho virtual do Windows em um pool de hosts.
