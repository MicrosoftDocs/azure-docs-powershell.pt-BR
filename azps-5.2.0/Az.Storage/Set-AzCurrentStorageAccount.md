...
## DESCRITIVO
O cmdlet **set-AzCurrentStorageAccount** modifica a conta de armazenamento atual do Azure da assinatura do Azure especificada no PowerShell do Azure.
...
Para obter um objeto de contexto de armazenamento, use o cmdlet New-AzStorageContext.
