...
## DESCRITIVO
O cmdlet **set-AzDataLakeGen2AclRecursive define a** ACL recursivamente no caminho especificado. A ACL de entrada substituirá a ACL original completamente.

## EXEMPLOS

### Exemplo 1: definir ACL recursivamente em um directiry
```
...
Esse comando primeiro cria um objeto ACL com 3 entradas ACL e, em seguida, define a ACL recursivamente em um diretório.

### Exemplo 2: definir ACL recursivamente em um directiry de raiz do sistema de arquivos
```
...
Esse comando define a ACL recursivamente para um diretório raiz e, em seguida, retomar com ContinuationToken após o usuário corrigir o arquivo com falha.

### Exemplo 3: definir ACL recursivamente o bloco por parte
```
$token = $null
...
Esse script define a ACL rescursively no bloco de diretório por parte, com tamanho de parte como BatchSize * MaxBatchCount. O tamanho da parte é 200 neste script.

### Exemplo 4: definir ACL recursivamente em um diretório e ContinueOnFailure e retomar a partir das falhas um por vez
```
...
Esse comando define a ACL recursivamente para um diretório com ContinueOnFailure e alguns itens falharam e retomará um por um.
