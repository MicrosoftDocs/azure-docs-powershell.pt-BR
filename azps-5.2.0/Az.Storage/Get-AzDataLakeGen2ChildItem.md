...
Esse comando lista os subitens diretos de um sistema de arquivos

### Exemplo 2: lista recursivamente de um diretório e busca Propriedades/ACL
```
...
### -Fetchproperty
Busque as propriedades e a ACL do item datalake.
...
### -MaxCount
A contagem máx dos BLOBs que podem retornar.
...
Se speicify esse parâmetro, os valores de identidade do usuário retornados nos campos Owner e Group de cada entrada de lista serão transformados de IDs de objeto do Azure Active Directory para nomes de usuário principal. Se não speicify esse parâmetro, os valores serão retornados como IDs de objeto do Azure Active Directory. Observe que as IDs de objeto de grupo e aplicativo não são traduzidas porque elas não têm nomes amigáveis exclusivos.
...
Deve ser um diretório, no formato ' directory1/directory2/'.
...
### -Recurse
Indica se o item filho será obtido recursivamente.
O padrão é falso.
