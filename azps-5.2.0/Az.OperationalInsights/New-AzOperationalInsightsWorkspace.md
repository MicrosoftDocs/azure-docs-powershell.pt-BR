...
## Sinopse
Cria um espaço de trabalho ou restaura um espaço de trabalho excluído de uma mídia.
...
## DESCRITIVO
O cmdlet **New-AzOperationalInsightsWorkspace** cria um espaço de trabalho no grupo de recursos e na localização especificados. Ou restaurar um espaço de trabalho excluído de uma mídia.
