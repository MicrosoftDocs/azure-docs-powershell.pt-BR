...
## DESCRITIVO
O cmdlet **set-AzDataShare** atualiza um compartilhamento de dados que existe em uma conta do Azure data share especificada.
...
Este comando atualiza um compartilhamento de dados existente chamado AdsShare
...
### -InputObject
Objeto de compartilhamento de dados do Azure
...
### -TermsOfUse
Termos de uso do compartilhamento de dados
