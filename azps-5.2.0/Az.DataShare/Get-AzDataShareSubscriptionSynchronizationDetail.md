...
Este comando fornece informações sobre a sincronização iniciada para AdsShareSubscription de assinatura de compartilhamento em WikiAds de conta de compartilhamento de dados.
...
### -Synchronizationid
ID de sincronização da sincronização da assinatura do compartilhamento
