...
## DESCRITIVO
O cmdlet **Remove-AzDataShareAccount** remove uma conta de compartilhamento de DataShare.
...
Esse comando Remove a conta de compartilhamento de WikiADS do grupo de recursos chamado anúncios.
...
### -InputObject
O objeto da conta do Azure data share.
