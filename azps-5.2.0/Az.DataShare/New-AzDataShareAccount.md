...
## DESCRITIVO
O cmdlet **New-AzDataShareAccount** cria uma conta de compartilhamento de DataShare no grupo de recursos do Azure especificado.
...
Cria uma conta chamada "WikiADS" no grupo de recursos "anúncios"
...
### -Local
O local no qual criar a conta de compartilhamento de dados.
...
### -ResourceGroupName
O nome do grupo de recursos da conta do Azure data share será criado.
...
### -Marca
As marcas a serem associadas à conta do Azure data share.
