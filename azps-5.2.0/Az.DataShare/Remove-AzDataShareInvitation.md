...
## DESCRITIVO
O cmdlet **Remove-AzDataShareInvitation** remove um convite de compartilhamento de DataShare.
...
Esses comandos removem um convite chamado ADSInvite do share AdsShare. 
...
### -InputObject
Objeto de convite de compartilhamento de dados do Azure
