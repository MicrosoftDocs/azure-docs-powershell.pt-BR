...
## DESCRITIVO
O cmdlet **Remove-AzDataShareTrigger** remove um gatilho de compartilhamento de DataShare
...
Esses comandos removem um gatilho chamado AdsTrigger da assinatura de compartilhamento AdsShareSubscription. 
...
### -InputObject
Objeto de gatilho do compartilhamento de dados do Azure
...
### -ResourceId
A ID do recurso do gatilho do Azure data share
