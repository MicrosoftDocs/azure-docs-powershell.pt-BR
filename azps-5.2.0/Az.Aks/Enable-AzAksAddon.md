...
Habilite os complementos `HttpApplicationRouting` , `Monitoring` , `AzurePolicy` `VirtualNode` e `KubeDashboard` para AKs.
...
### -WorkspaceResourceId
ID do recurso do espaço de trabalho de monitoramento.
