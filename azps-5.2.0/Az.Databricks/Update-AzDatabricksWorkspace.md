...
### Exemplo 1: atualiza as marcas de um espaço de trabalho databricks
```powershell
...
Esse comando atualiza as marcas de um espaço de trabalho databricks.

### Exemplo 2: habilitar a criptografia em um espaço de trabalho databricks
```powershell
...
Habilitar a criptografia em um espaço de trabalho databricks usa três etapas:
1.
Atualize o espaço de trabalho com `-PrepareEncryption` (se ele não tiver sido criado).
1.
Localize `StorageAccountIdentityPrincipalId` na saída da última etapa.
Conceder permissões de chave para o principal.
1.
Atualize o espaço de trabalho novamente para preencher as informações sobre a chave de criptografia:
    - `-EncryptionKeySource`
    - `-EncryptionKeyVaultUri`
    - `-EncryptionKeyName`
    - `-EncryptionKeyVersion`

### Exemplo 3: desabilitar a criptografia em um espaço de trabalho databricks
```powershell
...
Para desabilitar a criptografia, basta definir `-EncryptionKeySource` como `'Default'` .
...
### -EncryptionKeySource
A fonte de criptografia (provedor).
Valores possíveis (não diferencia maiúsculas de minúsculas): padrão, Microsoft. keyvault
...
### -EncryptionKeyVaultUri
O URI (nome DNS) do cofre de chaves.
