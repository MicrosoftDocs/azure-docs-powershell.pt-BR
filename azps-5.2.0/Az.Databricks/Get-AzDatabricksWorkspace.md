...
### Exemplo 1: obter um espaço de trabalho databricks com nome
```powershell
...
Esse comando obtém um espaço de trabalho databricks em um grupo de recursos.

### Exemplo 2: listar todos os espaços de trabalho databricks em uma assinatura
```powershell
...
Esse comando lista todos os espaços de trabalho databricks em uma assinatura.

### Exemplo 3: listar todos os espaços de trabalho datatijolo em um grupo de recursos
```powershell
...
Esse comando lista todos os espaços de trabalho databricks em um grupo de recursos.
