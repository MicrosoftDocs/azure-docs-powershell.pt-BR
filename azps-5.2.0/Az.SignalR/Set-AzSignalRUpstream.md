...
O JSON a seguir representa os modelos reais definidos. 
...
### -Limpar
Desmarque todas as configurações de upstream.
...
### -Modelo
Item (ns) de modelo para configurações de upstream.
Chave necessária: UrlTemplate.
Chaves opcionais: HubPattern, EventPattern, CategoryPattern.
Exemplo usando a sintaxe splatting para transmitir o parâmetro templates: @ {UrlTemplate = ' http://host-connections1.com ', HubPattern = ' chat '; EventPattern = "transmissão"}, @ {UrlTemplate = " http://host-connections2.com "}
