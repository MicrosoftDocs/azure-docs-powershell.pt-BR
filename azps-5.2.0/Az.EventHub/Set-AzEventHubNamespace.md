...
## DESCRITIVO
O cmdlet Set-AzEventHubNamespace atualiza as propriedades do namespace de hubs de eventos especificado.
...
Atualiza as marcas do namespace \` Mynamespacename \` a ser criado.
...
### Exemplo 5: Criando e atualizando o namespace com gerenciar identidade em um cluster 
```powershell
