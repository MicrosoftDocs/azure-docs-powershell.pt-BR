...
### Exemplo 1: remover uma extensão de computador.
```powershell
PS C:\> Remove-AzConnectedMachineExtension -MachineName myMachine -ResourceGroupName myRG -Name custom

```

Exclui a extensão na máquina.

### Exemplo 2: remover extensão pelo pipeline
```powershell
PS C:\> Get-AzConnectedMachineExtension -ResourceGroupName contoso-connected-machines -MachineName myMachine | Remove-AzConnectedMachineExtension

```

Remove todas as extensões no computador especificado.
...
### -MachineName
O nome da máquina na qual a extensão deve ser excluída.
