...
### Exemplo 1: invocar exportação por exportname e escopo
```powershell
PS C:\> Invoke-AzCostManagementExecuteExport -ExportName 'TestExport' -Scope 'subscriptions/**********'

```

Invocar exportação por exportname e escopo

### Exemplo 2: invocar exportação por InputObject
```powershell
...
Invocar exportação por InputObject
