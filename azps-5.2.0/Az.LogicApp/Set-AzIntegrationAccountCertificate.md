...
## DESCRITIVO
O cmdlet **set-AzIntegrationAccountCertificate** modifica um certificado de conta de integração.
Esse cmdlet retorna um objeto que representa o certificado da conta de integração.
Especificando o nome da conta de integração, o nome do grupo de recursos e o nome do certificado.
...
### Exemplo 1: modificar um certificado de conta de integração
```
...
Esse comando modifica o certificado da conta de integração no grupo de recursos especificado.
...
### -KeyName
Especifica o nome de uma chave de certificado no cofre de chaves.
