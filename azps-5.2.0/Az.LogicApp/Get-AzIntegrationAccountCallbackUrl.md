...
## DESCRITIVO
O cmdlet **Get-AzIntegrationAccountCallbackUrl** Obtém uma URL de retorno de chamada de conta de integração de um grupo de recursos.
Esse cmdlet retorna um objeto **CallbackUrl** que representa a URL de retorno de chamada da conta de integração.
...
Esse comando obtém uma URL de retorno de chamada de conta de integração.
...
### -Não depois
Especifica a data de vencimento para a URL de retorno de chamada.
