...
Esse comando obtém um contrato de conta de integração chamado IntegrationAccountAgreement06.

### Exemplo 2: obter contratos da conta de integração por nome do grupo de recursos
```
...
Esse comando obtém os contratos da conta de integração por nome do grupo de recursos.
