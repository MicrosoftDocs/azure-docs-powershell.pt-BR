...
## DESCRITIVO
O cmdlet **Get-AzLogicApp** Obtém um aplicativo lógico.
...
### Exemplo 1: obter um aplicativo lógico de um grupo de recursos
```
...
Esse comando obtém um aplicativo lógico do grupo de recursos chamado ResourceGroup11.
...
### -Nome
Especifica o nome do aplicativo lógico que este cmdlet obtém.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos em que esse cmdlet obtém um aplicativo lógico.
...
### -Versão
Especifica a versão de um aplicativo lógico.
