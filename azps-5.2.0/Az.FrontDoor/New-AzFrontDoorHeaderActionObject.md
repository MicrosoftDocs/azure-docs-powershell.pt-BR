...
## DESCRITIVO
Cria o objeto PSHeaderAction para a criação do objeto PSRulesEngineAction.
...
### -HeaderActionType
O tipo de manipulação a ser aplicado ao cabeçalho.
...
### -HeaderName
O nome do cabeçalho ao qual esta ação será aplicada.
...
### -Valor
O valor com o qual atualizar o nome do cabeçalho fornecido.
Esse valor não será usado se o ActionType for DELETE.
