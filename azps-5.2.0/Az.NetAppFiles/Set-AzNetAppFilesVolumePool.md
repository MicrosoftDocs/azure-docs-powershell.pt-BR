...
## DESCRITIVO
O cmdlet **set-AzNetAppFilesVolumePool** altera o pool de um volume ANF.
...
Isso altera o pool do volume myvolume para um com a ID de 7d6e4069-6c78-6c61-7bf6-c60968e45fbf
...
### -NewPoolResourceId
ResourceId do pool de capacidade para o qual mover.
UUID v4 usado para identificar o pool
...
### -Poolobject
O objeto de pool que contém o volume
