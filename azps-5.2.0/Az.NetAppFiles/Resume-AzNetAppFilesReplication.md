...
## DESCRITIVO
Retomar/ressincronizar a conexão no volume de destino
...
Esse comando retoma a conexão de replicação do ANF no volume "MyDestinationAnfVolume".
...
### -InputObject
O objeto de volume de destino de replicação do ANF para ressincronização
...
### -PassThru
Retornar se a ressincronização do volume de replicação especificado foi realizada
