...
## DESCRITIVO
O cmdlet **Remove-AzNetAppFilesActiveDirectory** exclui uma configuração do Active Directory do ANF.
...
Esse comando exclui a nova configuração do Active Directory do ANF com o nome "MyADName".
...
### -PassThru
Retornar se o Active Directory especificado foi removido com êxito
