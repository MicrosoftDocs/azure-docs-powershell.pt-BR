...
## DESCRITIVO
O cmdlet **Remove-AzNetAppFilesBackup** exclui uma conta ANF.
...
Esse comando exclui o novo ANF backup com um nome "MyBackup" para volume "myvolume".
...
### -PassThru
Retornar se o backup especificado foi removido com êxito
