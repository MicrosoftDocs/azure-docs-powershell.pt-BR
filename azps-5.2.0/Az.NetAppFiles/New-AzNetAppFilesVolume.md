...
## DESCRITIVO
O cmdlet **New-AzNetAppFilesVolume** cria um volume ANF.

## EXEMPLOS

### Exemplo 1: criar um volume do ANF
```
...
Esse comando cria o novo volume ANF "MyAnfVolume" no pool "MyAnfPool".
...
### -BackupId
ID de backup. UUID v4 ou identificador de recurso usado para identificar o backup
...
### -CreationToken
Um caminho de arquivo exclusivo para o volume
...
### -KerberosEnabled
Descrever se um volume está habilitado para Kerberos
...
### -Poolobject
O pool para o novo objeto de volume
...
### -ReplicationObject
Uma matriz de Hashtable que representa o objeto de replicação
...
### -Securitystyle
O estilo de segurança do volume. Os valores possíveis incluem: ' NTFS ', ' UNIX '
...
### -Instantâneo
Uma matriz de Hashtable que representa o objeto de instantâneo
...
Se habilitado (verdadeiro), o volume conterá um diretório somente leitura. diretório de instantâneo que fornece acesso a cada um dos instantâneos do volume (padrão para verdadeiro)
...
### -Captura de imagem
Criar volume a partir de um instantâneo. UUID v4 ou identificador de recurso usado para identificar o instantâneo
...
### -Subnetid
O URI do recurso do Azure para uma sub-rede delegada
