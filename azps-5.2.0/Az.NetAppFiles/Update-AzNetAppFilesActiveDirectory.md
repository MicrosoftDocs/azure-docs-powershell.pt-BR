...
## DESCRITIVO
O cmdlet **Update-AzNetAppFilesAccount** modifica uma configuração do Active Directory do ANF.
...
Esse comando executa uma atualização na configuração do Active Directory fornecida modificando o nome de usuário para o fornecido.
...
### -Accountobject
A conta para o objeto do Active Directory
...
### -ActiveDirectoryid
A ID do Active Directory do ANF
...
### -InputObject
O objeto do Active Directory a ser removido
