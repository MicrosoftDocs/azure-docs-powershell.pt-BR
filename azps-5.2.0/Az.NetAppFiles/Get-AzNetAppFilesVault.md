...
## DESCRITIVO
O cmdlet **Get-AzNetAppFilesVault** Obtém uma lista de cofres de backup de contas do ANF.
...
Esse comando obtém uma lista dos cofres de backup da conta do Azure NetappFiles (ANF) "MyAnfAccount".
...
### -Accountobject
A conta para o novo objeto de backup
