...
O cmdlet **Remove-AzAzureRmApiManagementApiVersionSet** remove um conjunto de versões de API existente.
...
### -ResourceId
Resourcebinding de ApiVersionSet. Esse parâmetro é obrigatório.
