...
## DESCRITIVO
O cmdlet **set-AzApiManagementGroup** configura um grupo de gerenciamento de API.
...
Esse comando configura um grupo de gerenciamento chamado Group0001.
...
### -GroupId
Especifica o identificador do grupo de gerenciamento.
