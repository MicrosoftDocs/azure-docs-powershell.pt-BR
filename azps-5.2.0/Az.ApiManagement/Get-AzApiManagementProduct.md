...
## DESCRITIVO
O cmdlet **Get-AzApiManagementProduct** Obtém uma lista ou um produto específico.
...
### -ApiId
ApiId da API para localizar os produtos correlacionados. Este parâmetro é opcional.
