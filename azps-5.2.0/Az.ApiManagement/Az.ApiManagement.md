...
---
# Módulo AZ. ApiManagement
## Descritivo
Este tópico exibe os tópicos da ajuda para os cmdlets de gerenciamento de API do Azure.

## Cmdlets AZ. ApiManagement
### [Add-AzApiManagementApiToGateway](Add-AzApiManagementApiToGateway.md)
Anexa uma API a um gateway.
...
Obter os detalhes do esquema de API
...
Obtenha detalhes do diagnóstico configurado no nível de serviço ou no nível de API. O diagnóstico é usado para registrar solicitações/respostas do gateway de gerenciamento de API.

### [Get-AzApiManagementGateway](Get-AzApiManagementGateway.md)
Obtém todo ou gateway de gerenciamento de API específico.
...
Obtém as chaves do gateway existente
...
Obtenha o segredo do cliente do provedor de identidade.
...
Obtém um valor secreto do valor nomeado específico.
...
Obtém segredo do cliente do provedor do OpenID Connect.
...
Obtém as chaves de configuração do Access para um locatário.
...
Obtém as chaves de configuração de acesso git para um locatário.

### [Get-AzApiManagementTenantSyncState](Get-AzApiManagementTenantSyncState.md)
Obtém o status da sincronização mais recente entre o banco de dados de configuração e o repositório do git.
...
Cria uma versão de API de uma revisão de API
...
Cria o novo esquema de API no serviço ApiManagement
...
Cria um novo contrato de credencial back-end.
...
Cria uma nova entidade de cache
...
Cria uma operação de gerenciamento de API.
...
Cria um produto de gerenciamento de API.
...
Criar um novo contrato de localização de recursos (usado em gateways).

### [New-AzApiManagementSamplingSetting](New-AzApiManagementSamplingSetting.md)
Criar uma nova configuração de amostragem para o diagnóstico
...
Revisão de API específica removida
...
Remova a entidade de diagnóstico do escopo global ou de nível de API.

### [Remove-AzApiManagementGateway](Remove-AzApiManagementGateway.md)
Desanexa uma API de um gateway.
...
Atualiza uma versão de API definida no contexto de gerenciamento de API.
...
Modifica um certificado de gerenciamento de API que está configurado para autenticação mútua com back-end.

### [Set-AzApiManagementDiagnostic](Set-AzApiManagementDiagnostic.md)
Modifica um diagnóstico de gerenciamento de API no escopo global ou de API.

### [Set-AzApiManagementGroup](Set-AzApiManagementGroup.md)
Configura um grupo de gerenciamento de API.
...
Define detalhes de assinatura existentes.
