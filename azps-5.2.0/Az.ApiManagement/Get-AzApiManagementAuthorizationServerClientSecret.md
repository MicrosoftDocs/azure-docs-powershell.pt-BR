...
## DESCRITIVO
O cmdlet **Get-AzApiManagementAuthorizationServerClientSecret** Obtém o segredo do cliente do servidor de autorização de gerenciamento de API do Azure.

## EXEMPLOS

### Exemplo 1: obter um segredo de cliente de servidor de autorização especificado por ID
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementAuthorizationServerClientSecret -Context $ApiMgmtContext -ServerId "0123456789"
```

Esse comando obtém o servidor de autorização especificado cient segredo.
...
### -ResourceId
Identificador de recursos ARM do servidor de autorização.
Se especificado, você tentará localizar o servidor de autorização pelo identificador.
Esse parâmetro é obrigatório.
...
Se especificado, o servidor de autorização será localizado pelo identificador.
...
### Microsoft. Azure. Commands. ApiManagement. onmanagement. Models. PsApiManagementClientSecret
