...
## DESCRITIVO
O cmdlet **New-AzApiManagementGatewayHostnameConfiguration** cria um nome de host configuratin para o gateway existente.

## EXEMPLOS

### Exemplo 1: criar uma configuração de nome de host para o gateway existente
```powershell
...
Esse comando cria uma configuração do nome do host "H01" para um gateway "G01".

## OS

### -CertificateResourceId
Um identificador de recurso para a ID de certificado existente. Esse parâmetro é obrigatório.
...
Identificador da nova Confiuration do nome do host do gateway.
...
Sinalizador para impor NegotiateClientCertificate.
Este parâmetro é opcional.
