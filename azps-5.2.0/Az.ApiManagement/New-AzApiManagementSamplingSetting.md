...
## DESCRITIVO
O cmdlet **New-AzApiManagementSamplingSetting** cria uma nova configuração de amostragem para o diagnóstico

## EXEMPLOS

### Exemplo 1: criar uma configuração de amostragem básica
```powershell
...
Cria uma configuração de amostragem do `Fixed` tipo com registro em log para 100% das solicitações/respostas

### Exemplo 2

Crie uma nova configuração de amostragem para o diagnóstico. (gerado automaticamente)
...
### -SamplingPercentage
Taxa de amostragem para amostragem de taxa fixa. Este parâmetro é opcional.
