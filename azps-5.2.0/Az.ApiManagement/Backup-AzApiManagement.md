...
## DESCRITIVO
O cmdlet **backup-AzApiManagement** faz a cópia de um serviço de gerenciamento de APIs do Azure.
...
Esse cmdlet gera um valor padrão com base no seguinte padrão: {Name}-{YYYY-MM-DD-HH-mm}. apimbackup
