...
### Exemplo 2: atualizar a AzDigitalTwinsInstance de outro AzDigitalTwinsInstance
```powershell
...
Para construir, consulte a seção notas para propriedades DIGITALTWINSPATCHDESCRIPTION e crie uma tabela de hash.
