...
## Sinopse
Cria uma configuração de NIC ASR que contém os detalhes de configuração relacionados ao failover e teste de failover.
...
Cria um objeto ASRVmNicConfig com as configurações de rede de failover e teste faiover configuradas para a NIC. Qualquer propriedade que não seja passada acima é buscada do item protegido passado.
...
Cria um objeto ASRVmNicConfig com as configurações de rede faiover de teste configuradas para a renomeação da NIC. Qualquer propriedade que não seja passada acima é buscada do item protegido passado.


### Exemplo 3

Cria uma configuração de NIC ASR que contém os detalhes de configuração relacionados ao failover e teste de failover. (gerado automaticamente)
...
Especifica as IDs dos pools de endereços back-end para a NIC de recuperação.
