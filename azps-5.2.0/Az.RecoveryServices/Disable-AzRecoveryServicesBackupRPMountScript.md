...
## DESCRITIVO
O cmdlet Disable-AzRecoveryServicesBackupRPMountScript desmonta os arquivos do ponto de recuperação que foram montados anteriormente usando o cmdlet Get-AzRecoveryServicesBackupRPMountScript.
...
Desmonta todos os arquivos do ponto de recuperação. (gerado automaticamente)
