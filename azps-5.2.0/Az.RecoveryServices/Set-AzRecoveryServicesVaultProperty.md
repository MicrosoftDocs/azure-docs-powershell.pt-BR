...
Esse cmdlet retorna as propriedades do cofre atualizadas após a operação de conjunto atual.
O uso dessas propriedades de cofre, como exclusão suave, pode ser habilitado em qualquer point-in-time.
