...
Depois do cálculo do preço, o cliente poderia purcahse-lo pela RI fornecido por calculatePrice
...
### -InstanceFlexibility
{{Fill InstanceFlexibility descrição}}
...
### -ReservationOrderId
ID da ordem de reserva a comprar, gerar por reserva de reservas do AZ-ordem calculada.
...
### Microsoft. Azure. Management. reservas. Models. ReservationOrderResponse
