...
## DESCRITIVO
O cmdlet Suspend-AzPowerBIEmbeddedCapacity suspende uma instância da capacidade inserida do PowerBI
...
Esse comando suspenderá uma capacidade ativa nomeada testcapacity no modo de teste do mymodo de origem
