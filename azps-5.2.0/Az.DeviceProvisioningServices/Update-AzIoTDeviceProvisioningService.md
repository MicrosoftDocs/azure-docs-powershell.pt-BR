...
Adicionar marcas a um serviço de provisionamento de dispositivo Hub IoT do Azure "myiotdps".
...
Excluir marca e adicionar novas marcas a um serviço de provisionamento de dispositivo Hub IoT do Azure "myiotdps" usando o pipeline.
