...
## Sinopse
Obtém os signatários de política confiáveis de um locatário no Azure atestado.
...
## DESCRITIVO
O cmdlet Get-AzAttestationPolicySigners Obtém os signatários de política confiáveis de um locatário no Azure atestado.
...
Obtém os signatários de política de confiança para o provedor de atestado *pshtest* no *PSH de grupo de recursos-Test-RG*.  Observe que não há signatários confiáveis para este provedor de atestado.
...
Obtém os signatários de política de confiança para o provedor de atestado *pshtest2* no *PSH de grupo de recursos-Test-RG*.  Observe que há um signatário confiável para este provedor de atestado.
...
Obtém os signatários de política de confiança para o provedor padrão de atestado nos locais *centrais dos EUA*.  Observe que não há signatários confiáveis para o provedor padrão de atestado.
