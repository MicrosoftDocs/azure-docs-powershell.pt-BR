...
Esse cmdlet cria uma regra de ação para supressão, com um escopo de assinatura.
...
Esse cmdlet cria uma regra de ação para o grupo de ação, com uma lista de escopo de grupos de recursos.
...
Esse cmdlet cria uma regra de ação para configurações de diagnóstico, com um escopo de recursos.

## OS

### -ActionGroupId
ID do grupo de ação que será notificado.
...
Formato esperado-{ \<operation\> : \<comma separated list of values\> } por exemplo,
Contém: smartgroups
...
Formato esperado-{ \<operation\> : \<comma separated list of values\> } por exemplo,
Equals:/assinaturas/ad825170-845c-47db-8F00-11978947b089/resourceGroups/abvarma/Providers/Microsoft. insights/metricAlerts/Test-mrmc-VM-abvarma
...
Formato esperado-{ \<operation\> : \<comma separated list of values\> } por exemplo,
Igual a: plataforma, análise de logs
...
### -ReccurentValue
Valores de Reccurent, se aplicável. Em caso de semana- \[ 1, 2 \] em caso de mês- \[ 1, 3, 5, 30\]
...
### -SuppressionEndTime
Hora de término da supressão.
O formato 12/09/2018 06:00:00 + deve ser mencionado em caso de Reccurent do programa de supressão de uma vez, diariamente, semanalmente ou mensalmente.
