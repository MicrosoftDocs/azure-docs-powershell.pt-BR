...
## Sinopse
Atualiza ou cria a oferta para armazenamento particular.
...
## DESCRITIVO
Atualiza ou cria a oferta para armazenamento privado que foi criada em escopo do locatário.
...
Cria uma oferta com planos privados + públicos para armazenamento particular que foi criado em escopo do locatário. 
...
Cria uma oferta com planos particulares somente para armazenamento privado criado em escopo de assinatura. 
...
As atualizações oferecem planos privados + públicos para armazenamento particular criado em escopo do locatário. ETag é necessário.
...
Atualizações oferta para armazenamento privado somente com planos particulares que foram criados em escopo de assinatura. ETag é necessário.
...
### -ETag
ETag do Azure Marketplace privateStore da oferta de atualização
...
Limitação de IDs do plano específico do Azure Marketplace privateStore
