...
### Exemplo 1: obter servidor PostgreSql com contexto padrão
```powershell
...
Este cmdlet obtém um servidor PostgreSql com contexto padrão.

### Exemplo 2: obter servidor PostgreSql por grupo de recursos e nome do servidor
```powershell
...
Este cmdlet obtém um servidor PostgreSql por grupo de recursos e nome do servidor.

### Exemplo 3: lista todos os servidores PostgreSql no grupo de recursos especificado
```powershell
...
Esse cmdlet lista todos os servidores PostgreSql no grupo de recursos especificado.

### Exemplo 4: obter servidor PostgreSql por identidade
```powershell
...
Esta lista de cmdlets Obtém servidor PostgreSql por identidade.
