...
### Exemplo 1: reiniciar o servidor PostgreSql por grupo de recursos e nome do servidor
```powershell
PS C:\> Restart-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Este cmdlet reinicia o servidor PostgreSql por grupo de recursos e nome do servidor.

### Exemplo 2: reiniciar o servidor PostgreSql por identidade
```powershell
...
Esses cmdlets reiniciam o servidor PostgreSql por identidade.
