...
### Exemplo 1: obter o serviço de nuvem Spring por nome
```powershell
...
Obter serviço de nuvem Spring por nome

### Exemplo 2: listar todos os serviços de nuvem Spring sob o grupo de recursos.
```powershell
...
Liste todos os serviços de nuvem da mola sob o grupo de recursos.
