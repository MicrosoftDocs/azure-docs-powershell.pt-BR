...
## DESCRITIVO
O cmdlet Remove-AzAnalysisServicesServer exclui uma instância do servidor do Analysis Services
...
Esse comando removerá o servidor chamado TestServer do botão de teste do MySource
