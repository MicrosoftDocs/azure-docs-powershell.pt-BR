...
## DESCRITIVO
O cmdlet Remove-AzDataFactoryV2IntegrationRuntimeNode remove um nó em um tempo de execução de integração.

## EXEMPLOS

### Exemplo 1: remover um nó de um tempo de execução de integração

Remover um nó com o nome fornecido em um tempo de execução de integração. (gerado automaticamente)
