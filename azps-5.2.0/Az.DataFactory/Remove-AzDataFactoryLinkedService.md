...
## DESCRITIVO
O cmdlet **Remove-AzDataFactoryLinkedService** remove um serviço vinculado do Azure data Factory.
...
### -Force
Indica que esse cmdlet Remove um serviço vinculado sem solicitar confirmação.
