...
## DESCRITIVO
O cmdlet **set-AzDataFactoryV2** cria uma fábrica de dados com o nome e o local do grupo de recursos especificados.
...
### Exemplo 2: criar uma fábrica de dados com detalhes de configuração do repositório usando um objeto de fábrica existente.
```
...
Esse comando cria uma fábrica de dados chamada WikiADF no grupo de recursos chamado ADF no local da Eastus com a configuração de controle de origem do DevOps do Azure.

### Exemplo 3: criar uma fábrica de dados com detalhes de configuração do repositório do GitHub usando um novo objeto de fábrica.
```
...
Esse comando cria um data Factory chamado WikiADF no grupo de recursos chamado ADF no local da Eastus com configuração de controle de origem do GitHub..

## OS

### -AccountName
O nome da conta para a configuração do repositório.
...
### -CollaborationBranch
A ramificação de colaboração para a configuração do repositório.
...
O dicionário que contém os parâmetros globais da fábrica de dados.
...
### -HostName
O nome do host para configuração do repositório do GitHub.
...
### -LastCommitId
A última ID de confirmação da configuração do repositório.
...
### -ProjectName
O nome do projeto DevOps para a configuração do repositório.
...
### -Repositoryname
O nome do repositório para a configuração do repositório.
...
### -ResourceId
A ID de recurso do Azure da fábrica de dados v2.
...
### -RootFolder
A pasta raiz da configuração do repositório.
...
### -Tenantid
A ID de locatário da configuração do repositório do Azure DevOps.
