...
## Sinopse
Interrompe um gatilho executado em uma fábrica de dados.
...
## DESCRITIVO
O cmdlet **Stop-AzDataFactoryV2TriggerRun** interrompe um gatilho executado em um fábrica de dados especificado com o nome do gatilho e a ID de execução do gatilho.
Atualmente só tem suporte para TumblingWindowTriggers no estado WaitingOnDependency.
...
Esse comando interrompe o disparo executado com a ID ' 08586002468005888497807248799CU16 ' no WikiADF de fábrica.
...
### -InputObject
As informações sobre o gatilho são executadas.
...
### -PassThru
Se especificado, o cmdlet escrever verdadeiro na operação do caso terá êxito.
