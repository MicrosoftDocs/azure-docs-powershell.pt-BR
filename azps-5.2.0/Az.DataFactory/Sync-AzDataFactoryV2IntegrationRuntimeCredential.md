...
## DESCRITIVO
O cmdlet **Sync-AzDataFactoryV2IntegrationRuntimeCredential** sincroniza as credenciais locais entre nós do tempo de execução de integração, o que obriga as credenciais a serem idênticas em todos os nós.

## EXEMPLOS

### Exemplo 1: sincronizar uma credencial de tempo de execução de integração

Sincroniza as credenciais entre nós do tempo de execução de integração. (gerado automaticamente)
