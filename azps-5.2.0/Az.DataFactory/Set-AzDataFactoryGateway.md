...
## DESCRITIVO
O cmdlet **set-AzDataFactoryGateway** define a descrição do gateway especificado no Azure data Factory.

## EXEMPLOS

### Exemplo 1: definir a descrição de um gateway
```
...
Esse comando define a descrição do gateway chamado ContosoGateway no data Factory chamado WikiADF.
O parâmetro Description especifica a nova descrição.

## OS

### -Datafactory
Especifica um objeto **PSDataFactory** .
Esse cmdlet define a descrição do gateway na fábrica de dados que esse parâmetro especifica.
...
### -Nome
Especifica o nome do gateway para o qual definir uma descrição.
...
Esse cmdlet define a descrição de um gateway que pertence ao grupo que esse parâmetro especifica.
