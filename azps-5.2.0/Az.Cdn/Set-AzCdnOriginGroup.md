...
## Sinopse
Atualiza o grupo de origens CDN
...
## DESCRITIVO
Set-AzCdnOriginGroup atualizará o grupo de origem especificado dentro de um determinado ponto de extremidade. 
...
```
Esse cmdlet atualizará a propriedade ProbeIntervalInSeconds no grupo Origin. 
