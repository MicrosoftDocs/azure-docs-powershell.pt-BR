...
## DESCRITIVO
O cmdlet **Remove-AzSqlInstanceActiveDirectoryAdministrator** remove um administrador do Azure Active Directory (Azure AD) para AzureSQL instância gerenciada na assinatura atual.
...
Esse comando Remove o administrador do Azure AD da instância gerenciada nomeada ManagedInstanceName01 associada à ResourceGroup01 do grupo de recursos.
...
Esse comando Remove o Azure AD Administrator do objeto de instância gerenciado.
...
Esse comando Remove o administrador do Azure AD usando o identificador de recursos de instância gerenciada.
...
### -PassThru
Define se o administrador de AD removido deve ser retornado
