...
### Exemplo 3: habilitar a política de auditoria de armazenamento de blob de um banco de dados SQL do Azure com filtragem avançada usando um predicado T-SQL
```powershell
...
### Exemplo 4: remover a configuração de filtragem avançada da política de auditoria de um banco de dados SQL do Azure
```powershell
...
### Exemplo 5: habilitar a política de auditoria do hub de eventos de um banco de dados SQL do Azure
```powershell
...
### Exemplo 6: desabilitar a política de auditoria do hub de eventos de um banco de dados SQL do Azure
```powershell
...
### Exemplo 7: habilitar a política de auditoria de análise de log de um banco de dados SQL do Azure
```powershell
...
### Exemplo 8: desabilitar a política de auditoria de análise de log de um banco de dados SQL do Azure
```powershell
...
### Exemplo 9: desabilitar, por meio de pipeline, a política de auditoria de análise de logs de um banco de dados SQL do Azure
```powershell
...
### Exemplo 10: desabilitar o envio de registros de auditoria de um banco de dados SQL do Azure para o armazenamento de BLOB e habilitar o envio para a análise de logs.
```powershell
...
### Exemplo 11: habilitar o envio de registros de auditoria de um banco de dados SQL do Azure para o armazenamento de BLOB, o Hub de eventos e a análise de logs.
```powershell
