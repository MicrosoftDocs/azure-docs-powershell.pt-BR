...
Esse comando obtém informações sobre um administrador do Azure AD para uma instância gerenciada chamada ManagedInstance01 que está associada a um grupo de recursos chamado ResourceGroup01.
...
Esse comando obtém informações sobre um administrador do Azure AD a partir de um objeto de instância gerenciado.
...
Esse comando obtém informações sobre um administrador do Azure AD usando o identificador de recursos de instância gerenciada.
