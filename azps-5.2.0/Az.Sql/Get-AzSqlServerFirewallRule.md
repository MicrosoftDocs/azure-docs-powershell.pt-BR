...
## DESCRITIVO
O cmdlet **Get-AzSqlServerFirewallRule** Obtém regras de firewall para um servidor de banco de dados SQL do Azure.
...
### Exemplo 2: obter todas as regras de um servidor usando a filtragem
```
...
Esse comando obtém todas as regras de firewall do servidor chamado Server01 que começam com "regra".
