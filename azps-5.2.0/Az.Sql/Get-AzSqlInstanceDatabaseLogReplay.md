...
## DESCRITIVO
O cmdlet **Get-AzSqlInstanceDatabaseLogReplay** Obtém o status do serviço de repetição de log no banco de dados fornecido.
...
Esse comando receberá o status do serviço de reprodução de log em um determinado banco de dados.
