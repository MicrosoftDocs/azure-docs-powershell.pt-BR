...
## DESCRITIVO
O cmdlet **Update-AzSqlSyncGroup** modifica as propriedades de um grupo de sincronização do banco de dados SQL do Azure.
...
Se você deve usar uma conexão de link particular ao se conectar ao Hub deste grupo de sincronização.
