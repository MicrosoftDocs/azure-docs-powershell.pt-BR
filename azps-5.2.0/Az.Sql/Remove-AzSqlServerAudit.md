...
## DESCRITIVO
O cmdlet **Remove-AzSqlServerAudit** remove as configurações de auditoria de um SQL Server do Azure.
Especifique os parâmetros *ResourceGroupName* e *nomedoservidor* para identificar o servidor.

## EXEMPLOS

### Exemplo 1: remover as configurações de auditoria de um SQL Server do Azure
```
PS C:\>Remove-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
```

### Exemplo 2: remover, por meio de pipeline, as configurações de auditoria de um SQL Server do Azure
```
