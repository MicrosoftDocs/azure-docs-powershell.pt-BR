...
## DESCRITIVO
O cmdlet **Remove-AzSqlServerActiveDirectoryAdministrator** remove um administrador do Azure Active Directory (Azure AD) para AzureSQL Server na assinatura atual.
...
Esse comando Remove o administrador do Azure AD do servidor chamado Server01 associado à ResourceGroup01 do grupo de recursos.
...
### -Nomedoservidor
Especifica o nome do SQL Server para o qual esse cmdlet Remove um administrador.
