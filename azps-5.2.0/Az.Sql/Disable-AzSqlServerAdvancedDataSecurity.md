...
### Exemplo 1
### Exemplo 2: desabilitar a segurança de dados avançados do servidor
```powershell
...
### Exemplo 3: desabilitar a segurança de dados avançados do servidor do recurso do servidor
```powershell
