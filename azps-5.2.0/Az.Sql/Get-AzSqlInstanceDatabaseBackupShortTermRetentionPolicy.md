...
Esse comando obtém a política de retenção de curto prazo para todos os bancos de dados excluídos chamados database01 via tubulação em um objeto de banco de dados excluído.
