...
## DESCRITIVO
O cmdlet **New-AzSqlDatabaseRestorePoint** cria um novo ponto de restauração no qual um SQL data warehouse do Azure pode ser restaurado.
Este cmdlet tem suporte no momento para SQL data warehouse do Azure.
