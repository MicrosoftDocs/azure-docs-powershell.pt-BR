...
### Exemplo 1: remover um repositório de configuração de aplicativo
```powershell
PS C:\> Remove-AzAppConfigurationStore -Name appconfig-test03 -ResourceGroupName lucas-manual-test

```

Esse comando Remove um repositório de configuração de aplicativo.

### Exemplo 2: remover um repositório de configuração de aplicativo
```powershell
