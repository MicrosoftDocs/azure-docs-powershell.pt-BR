...
## Sinopse
Lista a tecla de acesso para o repositório de configuração especificado.
...
### Exemplo 1: listar todas as chaves da loja de um repositório de configuração de aplicativo
```powershell
...
Esse comando lista todas as chaves da loja de um repositório de configuração de aplicativo.
