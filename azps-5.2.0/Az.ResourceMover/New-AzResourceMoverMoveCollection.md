...
### Exemplo 1: criar uma nova coleção mover.
```powershell
...
Criar uma nova coleção de movimento em uma assinatura.
...
### -IdentityType
O tipo de identidade usado para o serviço de mudança de região.
