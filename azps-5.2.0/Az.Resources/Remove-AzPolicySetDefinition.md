...
### -InputObject
O objeto de definição do conjunto de políticas para remover a saída de outro cmdlet.
...
### -ManagementGroupName
O nome do grupo de gerenciamento da definição de conjunto de políticas a ser excluída.
...
### -SubscriptionId
A ID da assinatura da definição do conjunto de políticas a ser excluída.
