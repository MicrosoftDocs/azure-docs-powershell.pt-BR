...
## DESCRITIVO
O cmdlet **Remove-AzManagementGroup** exclui um grupo de gerenciamento.
...
### Exemplo 2: remover um grupo de gerenciamento por objeto de PSManagementGroup de tubulação
```powershell
