...
### Exemplo 1: atualizar a regra de rede virtual do MySql por nome
```powershell
...
Este cmdlet atualiza a regra de rede virtual do MySql por nome.

### Exemplo 2: atualizar a regra de rede virtual do MySql por identidade.
```powershell
...
Esses cmdlets atualizam a regra de rede virtual do MySql por identidade.
