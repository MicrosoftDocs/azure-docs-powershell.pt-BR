...
### Exemplo 1: obter servidor MySql com contexto padrão
```powershell
...
Esse cmdlet obtém servidores MySql com contexto padrão.

### Exemplo 2: obter o MySql Server por grupo de recursos e nome do servidor
```powershell
...
Este cmdlet obtém servidores MySql por grupo de recursos e nome do servidor.
...
Esse cmdlet lista todos os servidores MySql no grupo de recursos especificado.

### Exemplo 4: obter o servidor MySql por identidade
```powershell
...
Essas listas de cmdlets são servidores MySql por identidade.
