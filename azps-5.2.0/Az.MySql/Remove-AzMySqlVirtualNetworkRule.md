...
### Exemplo 1: remover a regra de rede virtual do MySql Server por nome
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

Este cmdlet Remove a regra de rede virtual do MySql Server por nome.

### Exemplo 2: remover a regra de rede virtual do MySql Server por identidade
```powershell
...
Esses cmdlets removem a regra de rede virtual do MySql Server por identidade.
