...
### Exemplo 1: remover a regra de firewall do MySql por nome
```powershell
...
Este cmdlet Remove a regra de firewall do MySql por nome.

### Exemplo 2: remover a regra de firewall do MySql por identidade
```powershell
...
Esses cmdlets removem a regra de firewall do MySql por identidade.
