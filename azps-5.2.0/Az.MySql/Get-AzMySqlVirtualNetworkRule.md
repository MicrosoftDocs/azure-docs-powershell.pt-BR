...
Esse cmdlet lista todas as regras de rede virtual no servidor MySql especificado.

### Exemplo 2: obter uma regra de rede virtual por nome
```powershell
...
Este cmdlet obtém uma regra de rede virtual por nome.
