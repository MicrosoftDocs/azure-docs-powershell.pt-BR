...
Abre uma sessão remota do PowerShell no contêiner do Windows especificado em determinado site ou slot e em um determinado grupo de recursos
...
Obtenha uma regra de roteamento para o nome do slot fornecido.
...
New-AzWebAppContainerPSSession criará uma nova sessão remota do PowerShell no contêiner do Windows especificado em determinado site ou slot e em um determinado grupo de recursos
...
### [Publicar-AzWebApp](Publish-AzWebApp.md)
...
Remove uma regra de restrição de acesso de um aplicativo Web do Azure.
...
Remova uma regra de roteamento do slot.
...
### [Botão de AzWebAppSlot](Switch-AzWebAppSlot.md)
Trocar dois slots por um aplicativo Web

### [Update-AzWebAppAccessRestrictionConfig](Update-AzWebAppAccessRestrictionConfig.md)
Atualiza a herança de configuração do restiction de acesso ao site principal para o site do SCM para um aplicativo Web do Azure.
