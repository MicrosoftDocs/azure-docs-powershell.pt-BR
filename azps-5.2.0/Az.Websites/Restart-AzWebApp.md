...
## DESCRITIVO
O cmdlet **Restart-AzWebApp** interrompe e, em seguida, inicia um aplicativo Web do Azure.
Se o aplicativo Web estiver em um estado parado, use o cmdlet Start-AzWebApp.
