...
## DESCRITIVO
O cmdlet **set-AzAppServicePlan** define um plano do serviço de aplicativo Azure.

## EXEMPLOS

### Exemplo 1: modificar um plano do serviço de aplicativo
```powershell
...
Define um plano do serviço de aplicativo Azure. (gerado automaticamente)
