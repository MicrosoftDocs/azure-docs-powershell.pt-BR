...
## Sinopse
Obter configurações de segurança na central de segurança do Azure
...
## DESCRITIVO
O cmdlet Get-AzSecuritySetting obter configurações de segurança na central de segurança do Azure.
...
Obtém uma configuração de exportação de dados do MCAS   
