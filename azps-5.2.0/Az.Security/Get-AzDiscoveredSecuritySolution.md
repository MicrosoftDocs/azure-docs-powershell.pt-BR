...
## DESCRITIVO
As soluções de segurança são descobertas automaticamente pela central de segurança do Azure, use esse cmdlet para exibir as soluções de segurança descobertas
...
Obter todas as soluções de segurança descobertas na assinatura
...
Obter uma solução específica de segurança descoberta
