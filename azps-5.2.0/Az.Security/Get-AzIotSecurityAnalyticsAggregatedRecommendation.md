...
## DESCRITIVO
O cmdlet Get-AzIotSecurityAnalyticsAggregatedAlert retorna uma ou mais recomendações agregadas em dispositivos de Hub IOT. O nome de uma recomendação agregada é seu tipo
...
Obter a recomendação agregada "IoT_OpenPorts" na solução de segurança "MySolution" e grupo de recursos "MyResource Group"
...
Obter uma lista de recomendações agregadas na solução de segurança "MySolution" e grupo de recursos "MyResource Group"
