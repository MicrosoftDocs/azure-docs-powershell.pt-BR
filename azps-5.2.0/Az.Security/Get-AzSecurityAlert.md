...
ms.locfileid: "98262726"
---
# <span data-ttu-id="574f6-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="574f6-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="574f6-102">Sinopse</span><span class="sxs-lookup"><span data-stu-id="574f6-102">SYNOPSIS</span></span>
<span data-ttu-id="574f6-103">Obtém alertas de segurança detectados pela central de segurança do Azure</span><span class="sxs-lookup"><span data-stu-id="574f6-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="574f6-104">SYNTAX</span><span class="sxs-lookup"><span data-stu-id="574f6-104">SYNTAX</span></span>

### <span data-ttu-id="574f6-105">SubscriptionScope (padrão)</span><span class="sxs-lookup"><span data-stu-id="574f6-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="574f6-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="574f6-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="574f6-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="574f6-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="574f6-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="574f6-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="574f6-109">Identificação</span><span class="sxs-lookup"><span data-stu-id="574f6-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="574f6-110">DESCRITIVO</span><span class="sxs-lookup"><span data-stu-id="574f6-110">DESCRIPTION</span></span>
<span data-ttu-id="574f6-111">Obtém alertas de segurança detectados pela central de segurança do Azure</span><span class="sxs-lookup"><span data-stu-id="574f6-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="574f6-112">EXEMPLOS</span><span class="sxs-lookup"><span data-stu-id="574f6-112">EXAMPLES</span></span>

### <span data-ttu-id="574f6-113">Exemplo 1</span><span class="sxs-lookup"><span data-stu-id="574f6-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="574f6-114">Obtém todos os alertas de segurança detectados nos recursos dentro de uma assinatura</span><span class="sxs-lookup"><span data-stu-id="574f6-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="574f6-115">Exemplo 2</span><span class="sxs-lookup"><span data-stu-id="574f6-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="574f6-116">Obtém todos os alertas de segurança detectados nos recursos dentro do grupo de recursos "myService1"</span><span class="sxs-lookup"><span data-stu-id="574f6-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="574f6-117">Exemplo 3</span><span class="sxs-lookup"><span data-stu-id="574f6-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="574f6-118">Obtém um alerta de segurança específico detectado em recursos dentro do grupo de recursos "myService1"</span><span class="sxs-lookup"><span data-stu-id="574f6-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="574f6-119">OS</span><span class="sxs-lookup"><span data-stu-id="574f6-119">PARAMETERS</span></span>

### <span data-ttu-id="574f6-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="574f6-120">-DefaultProfile</span></span>
<span data-ttu-id="574f6-121">As credenciais, a conta, o locatário e a assinatura usados para comunicação com o Azure.</span><span class="sxs-lookup"><span data-stu-id="574f6-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="574f6-122">-Local</span><span class="sxs-lookup"><span data-stu-id="574f6-122">-Location</span></span>
<span data-ttu-id="574f6-123">Ponto.</span><span class="sxs-lookup"><span data-stu-id="574f6-123">Location.</span></span>
...
### <span data-ttu-id="574f6-124">-Nome</span><span class="sxs-lookup"><span data-stu-id="574f6-124">-Name</span></span>
<span data-ttu-id="574f6-125">Nome do recurso.</span><span class="sxs-lookup"><span data-stu-id="574f6-125">Resource name.</span></span>
...
### <span data-ttu-id="574f6-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="574f6-126">-ResourceGroupName</span></span>
<span data-ttu-id="574f6-127">Nome do grupo de recursos.</span><span class="sxs-lookup"><span data-stu-id="574f6-127">Resource group name.</span></span>
...
### <span data-ttu-id="574f6-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="574f6-128">-ResourceId</span></span>
<span data-ttu-id="574f6-129">ID do recurso.</span><span class="sxs-lookup"><span data-stu-id="574f6-129">Resource ID.</span></span>
...
### <span data-ttu-id="574f6-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="574f6-130">CommonParameters</span></span>
<span data-ttu-id="574f6-131">Esse cmdlet dá suporte a parâmetros comuns:-debug,-ErrorAction,-ErrorVariable,-Informationaction,-InformationVariable,-OutVariable,-OutBuffer,-PipelineVariable,-Verbose-WarningAction e-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="574f6-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="574f6-132">Para obter mais informações, consulte [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="574f6-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="574f6-133">SENSORES</span><span class="sxs-lookup"><span data-stu-id="574f6-133">INPUTS</span></span>

### <span data-ttu-id="574f6-134">System. String</span><span class="sxs-lookup"><span data-stu-id="574f6-134">System.String</span></span>

## <span data-ttu-id="574f6-135">EXIBE</span><span class="sxs-lookup"><span data-stu-id="574f6-135">OUTPUTS</span></span>

### <span data-ttu-id="574f6-136">Microsoft. Azure. Commands. Security. Models. Alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="574f6-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="574f6-137">INFORMA</span><span class="sxs-lookup"><span data-stu-id="574f6-137">NOTES</span></span>

## <span data-ttu-id="574f6-138">LINKS RELACIONADOS</span><span class="sxs-lookup"><span data-stu-id="574f6-138">RELATED LINKS</span></span>
