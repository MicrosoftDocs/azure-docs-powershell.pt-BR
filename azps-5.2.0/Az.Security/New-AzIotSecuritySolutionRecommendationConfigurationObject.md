...
## DESCRITIVO
O AzIotSecuritySolutionRecommendationConfigurationObject cria um novo objeto de configuração de recomendação para a solução de segurança IOT.
Dessa forma, o status de uma recomendação é configurado, seja habilitado ou desabilitado.
...
Criar uma nova configuração de recomendação para o tipo de recomendação "IoT_ACRAuthentication" com o status definido como Disable
