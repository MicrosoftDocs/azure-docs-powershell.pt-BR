...
## DESCRITIVO
O cmdlet Get-AzIotSecurityAnalyticsAggregatedAlert retorna um ou mais alertas agregados em dispositivos de Hub IOT.
O nome dos alertas agregados é uma combinação do tipo de alerta e a data de aggragted do alerta, separados por '/'.
...
Obter o alerta agregado "IoT_Bruteforce_Fail/2019-02-02" (o nome combinado do tipo de alerta e sua data de agregação) em solução "MySolution" e grupo de recursos "MyResource Group"
...
Obter uma lista de todos os alertas agregados na solução "MySolution" e grupo de recursos "MyResource Group"
