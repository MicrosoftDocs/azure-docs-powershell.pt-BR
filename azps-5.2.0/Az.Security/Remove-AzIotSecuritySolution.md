...
## DESCRITIVO
O cmdlet Remove-AzIotSecuritySolution exclui uma solução de segurança IOT específica. A solução de segurança da IoT coleta dados de segurança e eventos de dispositivos IOT e Hub IOT para ajudar a prevenir e a detectar ameaças.
...
Excluir a solução de segurança IoT "MySample" com grupo de recursos "MyResource Group"
