...
## Sinopse
Cria o objeto de consulta Azure de configuração da atualização do software de automação do Azure.
...
## DESCRITIVO
Cria um objeto de consultas de configuração de atualização de software do Azure que será usado para criar uma configuração de atualização de software que será executada em um cronograma para atualizar uma lista de lista resolvida dinamicamente de máquinas virtuais do Azure.
