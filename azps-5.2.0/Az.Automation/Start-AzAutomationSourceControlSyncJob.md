...
## DESCRITIVO
O cmdlet Start-AzAutomationSourceControlSyncJob inicia um trabalho de sincronização do controle do código-fonte do Azure Automation para o nome do controle do código-fonte fornecido.
