...
### -MinimumTlsVersion
Especifique a versão de TLS exigida pelos clientes para se conectar ao cache.
...
Camadas padrão e Premium.
Para obter mais informações, consulte Gerenciar o cache do Azure Redis com o PowerShell do PowerShell http://go.microsoft.com/fwlink/?LinkId=800051 ( http://go.microsoft.com/fwlink/?LinkId=800051) .
...
- 26GB
- 53GB
- 120 GB o valor padrão é 1GB ou C1.
