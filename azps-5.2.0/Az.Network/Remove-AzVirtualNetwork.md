...
## DESCRITIVO
O cmdlet **Remove-AzVirtualNetwork** remove uma rede virtual do Azure.

## EXEMPLOS

### 1: criar e excluir uma rede virtual
```
...
Este exemplo cria uma rede virtual em um grupo de recursos e, em seguida, a exclui imediatamente. Para suprimir o prompt ao excluir a rede virtual, use o sinalizador-Force.
...
### -Nome
Especifica o nome da rede virtual que este cmdlet Remove.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém a rede virtual que este cmdlet Remove.
