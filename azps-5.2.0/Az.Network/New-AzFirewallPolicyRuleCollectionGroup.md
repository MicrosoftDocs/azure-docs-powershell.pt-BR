...
## DESCRITIVO
O cmdlet **New-AzFirewallPolicyRuleCollectionGroup** cria um grupo de coleção de regras em uma política de firewall do Azure.
...
Este exemplo cria um grupo de coleção de regras na política de firewall $fp

### Exemplo 2

Crie um novo grupo de coleção de regras de firewall do Azure. (gerado automaticamente)
