...
## DESCRITIVO
O cmdlet New-AzNetworkWatcherConnectionMonitor cria um recurso de monitor de conexão para a origem e o destino especificados (monitor de conexão SingleSourcedestination) ou conjunto de grupos de teste (MultiEndpointConnectionMonitor).
