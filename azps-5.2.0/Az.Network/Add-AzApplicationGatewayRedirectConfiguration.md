...
## DESCRITIVO
O cmdlet **Add-AzApplicationGatewayRedirectConfiguration** adiciona uma configuração de redirecionamento a um gateway de aplicativo.
...
O segundo comando adiciona a configuração de redirecionamento ao gateway do aplicativo.

### Exemplo 2

Adiciona uma configuração de redirecionamento a um gateway de aplicativo. (gerado automaticamente)
...
### -TargetListener
Escuta HTTP para redirecionar a solicitação para
