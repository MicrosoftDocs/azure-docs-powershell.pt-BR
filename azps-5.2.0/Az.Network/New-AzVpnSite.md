...
A seguir, você criará um grupo de recursos, a WAN virtual no leste dos EUA no grupo de recursos "nonlinkSite" do Azure. 

Em seguida, ele cria um VpnSite para representar uma ramificação do cliente e a vincula à rede de longa distância virtual.

Uma conexão IPSec pode ser configurada com essa ramificação e uma VpnGateway usando o comando New-AzVpnConnection.
...
A seguir, você criará um grupo de recursos, uma rede de longa distância virtual e uma VpnSite com 1 VpnSiteLinks no leste dos EUA no grupo de recursos "conexões múltiplas" do Azure.

### Exemplo 3

Cria um novo recurso do Azure VpnSite. (gerado automaticamente)
...
### -O365Policy
A política de debates de tráfego do Office 365 para este VpnSite.
