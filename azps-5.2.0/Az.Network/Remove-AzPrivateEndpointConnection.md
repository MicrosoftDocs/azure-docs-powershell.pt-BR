...
## DESCRITIVO
O cmdlet **Remove-AzPrivateEndpointConnection** remove uma conexão de ponto de extremidade particular.
...
Este exemplo remove uma conexão de ponto de extremidade particular chamada MyPrivateEndpointConnection1
...
### -Force
Não pedir confirmação se quiser excluir o recurso
