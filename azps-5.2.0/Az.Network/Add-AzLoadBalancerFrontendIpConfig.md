...
## DESCRITIVO
O cmdlet **Add-AzLoadBalancerFrontendIpConfig** adiciona uma configuração de IP de front-end a um balanceador de carga do Azure.
...
### Exemplo 4 adicionar uma configuração de IP de front-end com um prefixo de IP público
```
...
O primeiro comando obtém o prefixo de IP público do Azure chamado MyPubPrefix e armazena o resultado na variável chamada $PublicIpPrefix.
O segundo comando obtém o balanceador de carga chamado MyLB e passa o resultado para o cmdlet **Add-AzLoadBalancerFrontendIpConfig** que adiciona uma configuração de IP front-end ao balanceador de carga com o prefixo de IP público armazenado na variável chamada $PublicIpPrefix.
...
Especifica o objeto de prefixo de endereço IP público a ser associado a uma configuração de IP de front-end.
...
Especifica a ID do objeto de prefixo de endereço IP público a ser associado a uma configuração de IP de front-end.
