...
## DESCRITIVO
O cmdlet **set-AzPrivateDnsZoneGroup** atualiza o grupo zona DNS.
...
Exemplo acima atualiza o grupo de zonas DNS chamado dnsgroup1 com um novo dnsconfig que se vincula a outra zona DNS.
