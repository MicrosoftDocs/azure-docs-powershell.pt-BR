...
### ByVirtualHubNameByVpnServerConfigurationObject (padrão)
```
...
## DESCRITIVO
O cmdlet **New-AzP2sVpnGateway** permite que você crie um novo P2SVpnGateway em VirtualHub para obter a conectividade do ponto para o site do Point para os clientes do site para o Azure VirtualWan.
...
O cmdlet **New-AzP2sVpnGateway** permite que você crie um novo P2SVpnGateway em VirtualHub para obter a conectividade do ponto para o site.
...
### -VirtualHub
O VirtualHub para o qual este P2SVpnGateway precisa estar associado.
...
### -VirtualHubId
A ID do VirtualHub para o qual este P2SVpnGateway precisa estar associado.
