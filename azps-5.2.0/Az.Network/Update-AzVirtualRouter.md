...
## DESCRITIVO
Atualiza o roteador virtual para habilitar ou desabilitar o tráfego de ramificação para ramificação.
...
Atualiza o roteador virtual para permitir o tráfego de ramificação para ramificação
...
Atualiza o roteador virtual para bloquear o tráfego de ramificação para ramificação

## OS

### -AllowBranchToBranchTraffic
Sinalizador para permitir o tráfego de ramificação para ramificação para o roteador virtual.
