...
## DESCRITIVO
O cmdlet New-AzApplicationGatewayBackendHttpSetting cria configurações HTTP back-end para um gateway de aplicativo.
...
Este comando cria configurações HTTP de back-end chamadas Setting01 na porta 80, usando o protocolo HTTP, com afinidade baseada em cookies desabilitada.
As configurações são armazenadas na variável $Setting.

### Exemplo 2

Cria uma configuração HTTP back-end para um gateway de aplicativo. (gerado automaticamente)
...
### -CookieBasedAffinity
Especifica se a afinidade baseada em cookies deve ser habilitada ou desabilitada para o pool de servidores back-end.
...
### -Teste
Especifica um teste a ser associado ao pool do servidor back-end.
...
### -Probeid
Especifica a ID do teste a ser associada ao pool de servidor back-end.
...
### -Protocolo
Especifica o protocolo a ser usado para comunicação entre o Application Gateway e os servidores back-end.
