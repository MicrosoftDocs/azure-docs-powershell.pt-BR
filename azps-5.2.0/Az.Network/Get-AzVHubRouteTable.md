...
## Sinopse
Recupera um recurso de tabela de rota de Hub associado a um VirtualHub.
...
## DESCRITIVO
Obtém a tabela de rota de Hub especificada associada ao Hub virtual especificado.
...
Esse comando obtém a tabela de rota do Hub do Hub virtual.
...
Esse comando lista todas as tabelas de rotas de Hub no VirtualHub especificado.
...
### -ResourceId
A ID do recurso vhubroutetable para obter.
