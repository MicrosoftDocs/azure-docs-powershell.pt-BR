...
## DESCRITIVO
Os cmdlets **set-AzExpressRouteCircuitPeeringConfig** salvam uma configuração de emparelhamento de rota modificada de volta para o Azure.
...
Salva uma configuração de emparelhamento do ExpressRoute modificada. (gerado automaticamente)
