...
## DESCRITIVO
O cmdlet Get-AzDdosProtectionPlan Obtém um plano de proteção contra DDoS.

## EXEMPLOS

### Exemplo 1: obter um plano de proteção contra DDoS específico
```
...
Nesse caso, precisamos especificar ambos os atributos **ResourceGroupName** e **Name** , que correspondem ao grupo de recursos e ao nome do plano de proteção contra DDoS, respectivamente.

### Exemplo 2: obter todos os planos de proteção contra DDoS em um grupo de recursos
```
...
Nesse cenário, especificamos somente o parâmetro **ResourceGroupName** para obter uma lista de planos de proteção contra DDoS.

### Exemplo 3: obter todos os planos de proteção DDoS em uma assinatura
```
...
Aqui, não especificamos parâmetros para obter uma lista de todos os planos de proteção contra DDoS em uma assinatura.

### Exemplo 4: obter todos os planos de proteção DDoS em uma assinatura
```
...
Esse cmdlet retorna todos os DdosProtectionPlans que começam com "Test".
...
### -Nome
Especifica o nome do plano de proteção contra DDoS.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos plano de proteção contra DDoS.
