...
## Sinopse
Obtém a configuração do vínculo particular de um gateway de aplicativo.
...
## DESCRITIVO
O cmdlet **Get-AzApplicationGatewayPrivateLinkConfiguration** Obtém a configuração do link privado de um gateway de aplicativo.

## EXEMPLOS

### Exemplo 1: obter uma configuração de link particular especificado
```powershell
...
O segundo comando obtém a configuração do link particular chamado privateLinkConfig01 do $AppGw e a armazena na variável $PrivateLinkConfiguration.

### Exemplo 2: obter uma lista de configurações de link particular
```powershell
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
O primeiro comando obtém um gateway do aplicativo denominado ApplicationGateway01 do grupo de recursos chamado ResourceGroup01 e o armazena na variável $AppGw.
O segundo comando obtém todas as configurações de vínculo privado $AppGw e as armazena na variável $PrivateLinkConfigurations.
...
### -Nome
O nome da configuração de privateLink do gateway do aplicativo
