...
O exemplo a seguir cria um serviço de link particular.
...
Assinaturas de aprovação automática do serviço de link privado
...
### -EnableProxyProtocol
Habilite o protocolo proxy para o serviço de link privado.
...
As configurações de front-end de IP
