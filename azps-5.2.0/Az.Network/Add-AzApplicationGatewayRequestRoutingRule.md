...
O segundo comando adiciona a regra de roteamento de solicitação ao gateway do aplicativo.

## OS

### -ApplicationGateway
Especifica um gateway de aplicativo para o qual esse cmdlet adiciona uma regra de roteamento de solicitação.
...
### -BackendAddressPool
Especifica um objeto de pool de endereços back-end do Application Gateway.
...
Especifica uma ID do pool de endereços back-end do aplicativo gateway.
...
Especifica uma ID de configurações HTTP de back-end para um gateway de aplicativo.
...
### -HttpListener
Especifica o objeto ouvinte HTTP do Application Gateway.
...
### -Nome
Especifica o nome da regra de roteamento de solicitação que esse cmdlet adiciona.
...
### -UrlPathMapId
Especifica a ID do mapa de caminho da URL para a regra de roteamento.
