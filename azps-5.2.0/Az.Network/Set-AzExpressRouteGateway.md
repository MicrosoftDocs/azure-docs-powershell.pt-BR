...
O cmdlet **set-AzExpressRouteGateway** permite que você atualize as unidades de escala de um ExpressRouteGateway existente ou atualize as marcas do recurso.
...
A seguir, você criará um grupo de recursos, uma WAN virtual, uma rede virtual, um hub virtual no oeste dos EUA no grupo de recursos "testRG" do Azure. Um gateway do ExpressRoute será criado posteriormente no Hub virtual com duas unidades de escala que serão modificadas para 3 unidades de escala
...
### -InputObject
O ExpressRouteGateway que precisa ser atualizado.
...
### -ResourceGroupName
O nome do grupo de recursos do ExpressRouteGateway a ser atualizado.
...
### -ResourceId
A ID do ExpressRouteGateway que precisa ser atualizada.
