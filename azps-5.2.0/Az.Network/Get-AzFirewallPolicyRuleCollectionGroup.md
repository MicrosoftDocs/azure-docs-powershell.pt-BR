...
Este exemplo obtém o grupo de regras de regra na política de firewall $fp

### Exemplo 2

Obtém um grupo de coleções de regras de firewall do Azure. (gerado automaticamente)
