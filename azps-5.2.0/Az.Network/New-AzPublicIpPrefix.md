...
## DESCRITIVO
O cmdlet **New-AzPublicIpPrefix** cria um prefixo de IP público.

## EXEMPLOS

### Exemplo 1: criar um novo prefixo de IP público
```powershell
PS C:\> $publicIpPrefix = New-AzPublicIpPrefix -Name $prefixName -ResourceGroupName $rgName -PrefixLength 30
```

Esse comando cria um novo recurso de prefixo de IP público. 

### Exemplo 2: criar um novo prefixo de IP público global
```powershell
...
Esse comando cria um novo recurso de prefixo de IP público global. 
...
### -CustomIpPrefix
O CustomIpPrefix ao qual este PublicIpPrefix será associado
...
### -Local
O local do prefixo de IP público.
...
### -SKU
O nome SKU do prefixo de IP público.
...
### -Tier
A camada de SKU de prefixo de IP público.
