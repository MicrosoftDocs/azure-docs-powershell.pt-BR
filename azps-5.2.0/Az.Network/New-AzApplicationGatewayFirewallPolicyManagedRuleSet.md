...
## DESCRITIVO
O **New-AzApplicationGatewayFirewallPolicyManagedRuleSet** cria regras gerenciadas para uma política de firewall.
...
Cria um ManagedRuleSet com ruleSettype como $ruleSetType, ruleSetVersion como $ruleSetVersion e RuleGroupOverrides como uma lista de inteiros como $ruleGroupOverride 1, $ruleGroupOverride 2 que o novo ManagedRuleSet está atribuído a $managedRuleSet
...
### -RuleGroupOverride
Substituições de grupo de regra.
...
### -RuleSettype
Especificar o RuleSettype em um managedRuleSet
...
### -RuleSetVersion
Especificar o RuleSetVersion em um managedRuleSet
