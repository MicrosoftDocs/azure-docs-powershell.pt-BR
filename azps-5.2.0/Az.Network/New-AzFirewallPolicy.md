...
Este exemplo cria uma política de firewall do Azure com um modo de ameaça Intel

### Exemplo 3:3. Criar uma política vazia com a lista branca do ThreatIntel
```powershell
...
Este exemplo cria uma política de firewall do Azure com uma lista branca da Intel com ameaças
