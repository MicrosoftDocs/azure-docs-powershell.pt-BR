...
Os dois primeiros comandos usam [New-AzAutoscaleRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscalerule) para criar duas regras de autoescala, $Rule 1 e $Rule 2.
O terceiro e o quarto comandos usam [New-AzAutoscaleProfile](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscaleprofile) para criar perfis de autoescala, $Profile 1 e $Profile 2, usando $Rule 1 e $Rule 2.
