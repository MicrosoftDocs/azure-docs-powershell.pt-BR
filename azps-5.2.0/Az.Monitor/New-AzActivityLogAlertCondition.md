...
**Observação**: quando esse cmdlet é usado com [set-AzActivityLogAlert](https://docs.microsoft.com/en-us/powershell/module/az.monitor/set-azactivitylogalert) pelo menos um desses objetos, passados como parâmetros, deve ter seu campo igual a "category". Caso contrário, o back-end responderá com um 400 (BadRequest.)
