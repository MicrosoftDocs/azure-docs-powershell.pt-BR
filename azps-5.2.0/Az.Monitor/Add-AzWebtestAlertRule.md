...
## DESCRITIVO
O cmdlet **Add-AzWebtestAlertRule** adiciona ou atualiza uma regra de alerta de tipo de métrica, evento ou WebTest.
...
### Exemplo 1: adicionar uma regra de alerta de WebTest
```
...
Esse comando adiciona ou atualiza uma regra de alerta de WebTest.
...
### -FailedLocationCount
Especifica a contagem de locais com falha para as regras WebTest.
Isso é semelhante ao limiar nos outros tipos de regras.
...
### -MetricNamespace
Especifica o namespace de métrica para a regra.
...
### -TargetResourceUri
Especifica a ID do recurso do WebTest.
