...
## DESCRITIVO
Atualiza uma regra de alerta de log, atualizando somente a propriedade "Enabled" é compatível com este comando.
Para atualizar outras propriedades, consulte comando [set-AzScheduledQueryRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/set-azscheduledqueryrule) .

## EXEMPLOS

### Exemplo 1: atualizar por nome de regra
```powershell
...
### Exemplo 2: atualizar por objeto de entrada
```powershell
...
### Exemplo 3: atualizar por ID do recurso
```powershell
...
### Habilitado para o
O estado do alerta do Azure-valores válidos-$true $false
