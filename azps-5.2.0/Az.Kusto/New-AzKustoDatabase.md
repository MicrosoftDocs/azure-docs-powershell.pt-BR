...
### Exemplo 1: criar um novo banco de dados do Kusto por nome
```powershell
...
O comando acima cria um novo banco de dados Kusto chamado "mykustodatabase" no cluster existente "testnewkustocluster" localizado no grupo de recursos "testrg".
