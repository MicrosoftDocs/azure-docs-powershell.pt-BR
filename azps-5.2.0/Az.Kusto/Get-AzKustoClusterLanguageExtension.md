...
### Exemplo 1: listar todas as extensões de idioma definidas para um cluster
```powershell
...
O comando acima retorna uma lista de extensões de idioma que podem ser executadas em consultas KQL.
