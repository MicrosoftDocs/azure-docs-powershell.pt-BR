...
### Exemplo 1: remover uma lista de extensões de idioma do cluster
```powershell
PS C:\> Remove-AzKustoClusterLanguageExtension -ResourceGroupName testrg -ClusterName testnewkustocluster -Value (@{Name="R"})
```

O comando acima remove uma lista de extensões de idioma que podem ser executadas em consultas KQL.
...
VALOR <ILanguageExtension [] >: a lista de extensões de idioma.
