...
Exporta os dados do domínio de segurança de um HSM gerenciado.
...
Crie um objeto que representa as configurações de regra de rede.
...
Remove uma regra de rede de um cofre de chaves.
...
### [Desfazer-AzKeyVaultCertificateRemoval](Undo-AzKeyVaultCertificateRemoval.md)
...
### [Desfazer-AzKeyVaultManagedStorageAccountRemoval](Undo-AzKeyVaultManagedStorageAccountRemoval.md)
Recupera uma conta de armazenamento gerenciado anteriormente excluída do keyvault.

### [Desfazer-AzKeyVaultManagedStorageSasDefinitionRemoval](Undo-AzKeyVaultManagedStorageSasDefinitionRemoval.md)
Recupera uma definição de SAS de armazenamento gerenciado anteriormente excluída do keyvault.

### [Desfazer-AzKeyVaultRemoval](Undo-AzKeyVaultRemoval.md)
...
Atualize o estado de um HSM gerenciado do Azure.
