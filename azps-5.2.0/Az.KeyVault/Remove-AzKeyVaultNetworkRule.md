...
Esse comando Remove uma regra de rede do cofre especificado, contanto que uma regra seja encontrada, correspondendo ao endereço IP especificado e ao identificador de recursos de rede virtual.
