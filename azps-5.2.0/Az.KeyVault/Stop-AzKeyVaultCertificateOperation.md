...
## DESCRITIVO
O cmdlet **Stop-AzKeyVaultCertificateOperation** cancela uma operação de certificado no serviço de compartimento de chave do Azure.

## EXEMPLOS

### Exemplo 1: cancelar uma operação de certificado
```powershell
...
Esse comando cancela a operação de certificado TestCert02.
