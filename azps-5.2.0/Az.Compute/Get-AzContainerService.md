...
## DESCRITIVO
O cmdlet **Get-AzContainerService** recebe um serviço de contêiner.
...
### Exemplo 2: obter todos os serviços de contêiner
```
...
Este comando obtém todos os serviços de contêiner na assinatura.

### Exemplo 3: obter todos os serviços de contêiner no grupo de recursos
```
...
Esse comando obtém todos os serviços de contêiner no ResourceGroup17.

### Exemplo 4: obter todos os serviços de contêiner usando o filtro
```
...
Esse comando obtém todos os serviços de contêiner começando com "CSResourceGroup1".
