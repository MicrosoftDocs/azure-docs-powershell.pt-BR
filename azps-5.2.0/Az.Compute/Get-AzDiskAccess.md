...
## DESCRITIVO
O cmdlet **Get-AzDiskAccess** Obtém as propriedades de acessos de disco
...
Este comando obtém as propriedades de um recurso de acesso a disco chamado "DiskAccess01" no grupo de recursos "ResourceGroup01".
...
Esse comando obtém as propriedades de todos os acessos de disco no grupo de recursos "ResourceGroup01".


### Exemplo 3: obtendo todos os acessos ao disco
```
...
Esse comando obtém as propriedades de todos os acessos de disco na assinatura.

### Exemplo 4: obter todos os acessos de disco usando caracteres curinga
```
...
Esse comando obtém as propriedades de todos os acessos de disco sob o nome da assinatura, começando com "DiskAccessMicrosoft".

### Exemplo 5: obter acesso a disco usando ResourceId.
```
...
Esse comando obtém as propriedades de um acesso a disco com o ResourceId fornecido.
