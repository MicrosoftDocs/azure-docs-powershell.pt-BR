...
## DESCRITIVO
O cmdlet **Add-AzVmssDataDisk** adiciona um disco de dados à instância do VMSS (conjunto de dimensionamento de máquina virtual).
...
### -DiskIOPSReadWrite
Especifica o Read-Write IOPS para o disco gerenciado. Deve ser usado somente quando o StorageAccountType está UltraSSD_LRS. Se não for especificado, um valor padrão será atribuído com base no diskSizeGB.
...
### -DiskMBpsReadWrite
Especifica a largura de banda em MB por segundo para o disco gerenciado. Deve ser usado somente quando o StorageAccountType está UltraSSD_LRS. Se não for especificado, um valor padrão será atribuído com base no diskSizeGB.
