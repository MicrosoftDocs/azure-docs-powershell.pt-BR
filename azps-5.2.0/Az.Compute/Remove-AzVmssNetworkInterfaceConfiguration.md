...
## DESCRITIVO
O cmdlet **Remove-AzVmssNetworkInterfaceConfiguration** remove uma configuração de interface de rede de um conjunto de dimensionamento de máquina virtual (VMSS).
...
O primeiro comando obtém um VMSS usando o cmdlet Get-AzVmss e, em seguida, armazena-o na variável $VMSS.
