...
## DESCRITIVO
O cmdlet **Remove-AzVMSqlServerExtension** remove uma extensão de servidor AzureSQL de uma máquina virtual.
...
### -Nome
Especifica o nome do SQL Server que a extensão que este cmdlet Remove.
...
### -VMName
Especifica o nome da máquina virtual a partir da qual esse cmdlet Remove a extensão do SQL Server.
