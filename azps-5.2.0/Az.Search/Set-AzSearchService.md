...
## DESCRITIVO
O cmdlet **set-AzSearchService** modifica um serviço de pesquisa do Azure.
...
O exemplo altera a contagem de partições e a contagem de réplicas do serviço de pesquisa do Azure para 2.
