...
## DESCRITIVO
O cmdlet **Start-AzPolicyRemediation** cria uma correção de política para uma determinada atribuição de política. Todos os recursos não compatíveis no escopo da correção serão corrigidos ou abaixo. A correção só tem suporte para políticas com o efeito ' deployIfNotExists '.
...
### Exemplo 5: iniciar uma correção que descobrirá recursos não compatíveis antes de remediar
```
PS C:\> $policyAssignmentId = "/subscriptions/f0710c27-9663-4c05-19f8-1b4be01e86a5/providers/Microsoft.Authorization/policyAssignments/2deae24764b447c29af7c309"
PS C:\> Select-AzSubscription -Subscription "My Subscription"
...
Esse comando cria uma nova correção de política na "minha assinatura" da assinatura para a atribuição de política determinada. O estado de conformidade dos recursos na assinatura será reavaliado em relação à atribuição de política e os recursos não compatíveis serão corrigidos.
...
Descreve como a tarefa de correção irá descobrir recursos que precisam ser corrigidos.
Não há suporte para ReEvaluateCompliance ao corrigir escopos do grupo de gerenciamento.
