...
## DESCRITIVO
Reinicie os nós específicos do tipo de nó. Ele desativará os nós da malha de serviços antes de reiniciar as VMs e habilitá-las novamente depois que elas forem retomadas. Se isso for feito nos tipos de nó primário, pode demorar um pouco, pois ele pode não reiniciar todos os nós ao mesmo tempo. Use-ForceRestart force a operação mesmo que o Service Fabric não consiga desabilitar os nós, mas use com cuidado, pois isso pode causar perda de dados se cargas de trabalho com estado estiverem em execução no nó.
...
### -ForceRestart
Usar esse sinalizador forçará o nó a reiniciar mesmo se o Service Fabric não conseguir desabilitar os nós.
