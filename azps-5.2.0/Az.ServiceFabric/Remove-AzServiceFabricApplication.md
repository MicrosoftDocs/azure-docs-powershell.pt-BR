...
## Sinopse
Remover um aplicativo do cluster. Isso removerá todos os serviços do aplicativo. Só oferece suporte a aplicativos de ARM distribuído.
...
## DESCRITIVO
Esse cmdlet Remove um formulário de aplicativo do cluster. Isso removerá todos os serviços, se houver, sob o recurso do aplicativo.
...
Este exemplo remove o aplicativo "testApp" no grupo de recursos "testRG" e cluster "testCluster".
