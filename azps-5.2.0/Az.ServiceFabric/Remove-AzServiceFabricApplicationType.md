...
## Sinopse
Remover a malha de serviços um tipo de aplicativo do cluster. Isso removerá todas as versões de tipo desse recurso. Só oferece suporte a tipos de aplicativo ARM implantados.
...
## DESCRITIVO
Esse cmdlet Remove um tipo de aplicativo do cluster e removerá toda a versão do tipo nesse recurso, mas todos os aplicativos abaixo dele deverão ser removidos antes de executar este comando.
...
Este exemplo removerá o tipo de aplicativo "testAppType" e todas as versões abaixo dele. Se houver aplicativos criados com esse tipo, o comando gerará uma exceção.
...
### -InputObject
O recurso de tipo de aplicativo.
...
### -ResourceId
Resourcebinding do tipo de aplicativo.
...
### Microsoft. Azure. Commands. imfabric. Models. PSApplicationType
