...
## Sinopse
Gera uma tolen SAS para a regra de autorização do ServiceBus do Azure de namespace/fila/tópico. 
...
## DESCRITIVO
O cmdlet New-AzServiceBusAuthorizationRuleSASToken gera um token de assinatura de acesso compartilhado (SAS) para um namesapce do Eventhub do Azure ou um Eventhub do Azure
...
Gerar token SAS para a regra de authorixation fornecida para namespace com tempo de início e de expiração..
...
Gerar token SAS para a regra authorixation fornecida para namespace com tempo de expiração.

## OS

### -AuthorizationRuleId
Resourcebinding da regra Authoraization
