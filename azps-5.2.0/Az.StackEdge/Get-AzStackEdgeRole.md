...
## DESCRITIVO
O cmdlet **Get-AzStackEdgeRole** busca as funções IOT disponíveis para um dispositivo de borda de pilha. Você pode mencionar o parâmetro Name para obter os detalhes de uma função IoT específica.
