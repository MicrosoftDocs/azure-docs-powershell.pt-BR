...
## DESCRITIVO
O cmdlet **Get-AzStackEdgeUser** lista os usuários configurados para um dispositivo de borda de pilha. Você pode mencionar o nome nos parâmetros para obter detalhes sobre um usuário específico.
