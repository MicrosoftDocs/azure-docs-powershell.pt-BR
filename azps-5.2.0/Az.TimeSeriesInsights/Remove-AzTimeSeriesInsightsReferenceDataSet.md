...
### Exemplo 1: remover um conjunto de dados de referência especificado por nome
```powershell
PS C:\> Remove-AzTimeSeriesInsightsReferenceDataSet -EnvironmentName tsitest001 -Name dstest001 -ResourceGroupName testgroup

```

Esse comando Remove um conjunto de dados de referência especificado.

### Exemplo 2: remover um conjunto de dados de referência especificado por objeto
```powershell
