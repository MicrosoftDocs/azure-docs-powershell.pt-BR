...
Esse comando lista todos os conjuntos de dados de referência no ambiente especificado.

### Exemplo 2: obter um conjunto de dados de referência especificado por nome
```powershell
...
Esse comando obtém um conjunto de dados de referência especificado.
...
### -Nome
O nome do conjunto de dados de referência de série temporal associado ao ambiente especificado.
