...
### Exemplo 1: listar todas as fontes de evento sob o ambiente especificado
```powershell
...
Esse comando lista todas as fontes de evento nos ambientes especificados.

### Exemplo 2: obter uma fonte de evento especificada por nome
```powershell
...
Esse comando obtém uma fonte de evento específica.
...
### -Nome
O nome da fonte de evento de insights série temporal associado ao ambiente especificado.
