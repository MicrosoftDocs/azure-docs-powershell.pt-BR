...
Regenere a chave correspondente à chave \' key1 ' \ do domínio da grade de eventos \` domain1 \` na MyResourceGroupName do grupo de recursos \` \` .
...
Regenere a chave correspondente à chave \' Key2 ' \ do domínio da grade de eventos \` domain1 \` no grupo de recursos \` MyResourceGroupName \` usando sua ID de recurso completo.
