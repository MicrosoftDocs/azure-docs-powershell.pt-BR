...
## DESCRITIVO
Atualizar um artefato. Há duas maneiras de atualizar um artefato: por meio de um artefato JSON como um arquivo de entrada ou de fornecer parâmetros embutidos para o artefato. Embora o método JSON não exija o tipo do método de parâmetro embutido que deve ser fornecido, o usuário deve fornecer o tipo do parâmetro artefato por tipo.
...
Atualize um artefato por meio de um arquivo JSON de artefato.
...
Atualize um artefato por meio de parâmetros embutidos.
...
Atualizar um artefato por meio de um arquivo de modelo ARM.

## OS

### -Artefatofile
Localização do arquivo de artefato em formato JSON em disco.
...
### -Depende
Lista dos nomes dos artefatos que devem ser criados antes da criação do artefato atual.
...
### -PolicyDefinitionId
ID da definição da definição da política.
...
Hashtable dos parâmetros a serem passados para o artefato de definição de política.
...
### -ResourceGroupName
Nome do grupo de recursos no qual o artefato vai estar.
...
Lista de IDs de entidade de segurança de definição de função.
...
### -Digite
Tipo do artefato.
Há 3 tipos com suporte: RoleAssignmentArtifact, PolicyAssignmentArtifact, TemplateArtifact.
...
### Microsoft. Azure. Management. Blueprint. Models. artefato
