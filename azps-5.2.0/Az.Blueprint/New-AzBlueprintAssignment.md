...
Crie uma nova atribuição Blueprint da definição Blueprint `$blueprintObject` dentro da assinatura especificada usando o parâmetro definido e o dicionário do grupo de recursos. Usa a identidade atribuída pelo sistema. O local define a região para a criação da identidade gerenciada.
...
Crie uma nova atribuição Blueprint da definição Blueprint `$blueprintObject` dentro da assinatura especificada usando o dicionário definido e o dicionário do grupo de recursos e Configurando o bloqueio de recursos para os próprios **recursos**. O padrão é usar a identidade atribuída pelo sistema.  O local define a região para a criação da identidade gerenciada.
...
Crie uma nova atribuição Blueprint da definição Blueprint `$blueprintObject` dentro da assinatura especificada usando o parâmetro definido e o dicionário do grupo de recursos usando a ID de identidade atribuída pelo usuário especificada.
...
Crie uma nova atribuição Blueprint da definição Blueprint que `$blueprintObject` direciona a assinatura especificada dentro do grupo de gerenciamento especificado usando o parâmetro definido.
...
### -Local
Região para a qual a identidade gerenciada deve ser criada.
...
### -ManagementGroupId
A ID do grupo de gerenciamento em que a (s) atribuição (ções) de gráfico será salva.
...
Hashtable dos parâmetros a serem passados para o artefato do grupo de recursos.
...
Parâmetro de cadeia de caracteres seguro para ID do recurso de keyvault, nome e versão.
...
### -SubscriptionId
ID da assinatura para atribuir a definição Blueprint.
Pode ser uma lista delimitada por vírgula de cadeias de caracteres SubscriptionId.
...
Identidade atribuída ao sistema (MSI) para implantar os artefatos.
...
Identidade atribuída ao usuário (MSI) para implantar os artefatos.
