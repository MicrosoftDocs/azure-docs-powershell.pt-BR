...
## DESCRITIVO
O cmdlet **Get-AzHDInsightClusterAutoscaleConfiguration** Obtém a configuração de autoescala do cluster HDInsight.

## EXEMPLOS

### Exemplo 1: obter a configuração de autoescala do cluster HDInsight.
```powershell
...
Esse comando obtém a configuração de autoescala do cluster HDInsight.
