...
## Sinopse
Atualiza os metadados de um serviço de dispositivo IoT do Windows.
...
Este comando atualiza um serviço Windows IoT por nome.

### Exemplo 2: atualizar um serviço Windows IoT por pipeline
```powershell
...
Esse comando atualiza um serviço IoT do Windows por pipeline.
