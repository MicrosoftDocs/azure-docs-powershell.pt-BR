...
## Sinopse
Excluir um serviço de dispositivo IoT do Windows.
...
### Exemplo 1: remover um serviço Windows IoT por nome
```powershell
PS C:\> Remove-AzWindowsIotServicesDevice -Name wsi-t03 -ResourceGroupName azure-rg-test

```

Esse comando Remove um serviço Windows IoT por nome.

### Exemplo 2: remover um serviço Windows IoT por pipeline
```powershell
...
Esse comando Remove um serviço Windows IoT por pipeline.
