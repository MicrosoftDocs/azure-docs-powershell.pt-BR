...
## Sinopse
Obter os metadados relacionados a não segurança de um serviço de dispositivo IoT do Windows.
...
### Exemplo 1: obter todos os serviços IoT do Windows em uma assinatura
```powershell
...
Este comando obtém todos os serviços da Windows IoT em uma assinatura.

### Exemplo 2: obter todos os serviços IoT do Windows em um grupo de recursos
```powershell
...
Este comando obtém todos os serviços da Windows IoT em um grupo de recursos.

### Exemplo 3: obter um serviço Windows IoT por nome
```powershell
...
Este comando obtém um serviço Windows IoT por nome.
...
Esse comando obtém um serviço Windows IoT por objeto.
...
Esse comando obtém um serviço Windows IoT por pipeline.
...
INPUTobject <IWindowsIotServicesIdentity> : parâmetro de identidade
  - `[DeviceName <String>]`: O nome do serviço de dispositivo IoT do Windows.
  - `[Id <String>]`: Caminho de identidade do recurso
  - `[ResourceGroupName <String>]`: O nome do grupo de recursos que contém o serviço de dispositivo IoT do Windows.
