...
## DESCRITIVO
Crie um trabalho de migração de disco.
...
Iniciar um trabalho de migração de disco gerenciado para os primeiros 20 discos

## OS

### -Discos
Os parâmetros da lista de discos.
...
### -TargetShare
O nome do compartilhamento de destino.
