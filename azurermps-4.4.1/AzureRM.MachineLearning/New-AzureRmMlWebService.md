...
### Crie um novo Azure ML WebService a partir de um arquivo JSON definiton.
```
...
### Serviço
O parâmetro ' NewWebServiceDefinition ' aceita o valor do tipo ' WebService ' do pipeline
