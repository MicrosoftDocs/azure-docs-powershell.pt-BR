...
## DESCRITIVO
O cmdlet **set-AzureRmServiceBusNamespaceAuthorizationRule** atualiza a descrição da regra de autorização especificada no namespace de barramento do serviço específico.
...
### -InputObj
NameSpace do ServiceBus objeto AuthorizationRule.
