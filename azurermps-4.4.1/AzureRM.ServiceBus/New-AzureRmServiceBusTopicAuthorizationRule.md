...
## DESCRITIVO
O cmdlet **New-AzureRmServiceBusTopicAuthorizationRule** cria uma nova regra de autorização para o tópico de barramento de serviço especificado.
...
Cria uma regra de autorização `SBTopicAuthoRule1` com os direitos de **escuta** e **envio** para o tópico `SB-Topic_exampl1` .
