...
## DESCRITIVO
O cmdlet **Remove-AzureRmServiceBusQueueAuthorizationRule** remove a regra de autorização de uma fila do namespace de barramento de serviço especificado.
...
Remove a regra `SBAuthoRule1` de autorização da fila `SB-Queue_exampl1` do namespace `SB-Example1` .
...
### -Nome
Nome da fila AuthorizationRule.
