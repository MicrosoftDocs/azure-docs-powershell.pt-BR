...
## DESCRITIVO
O cmdlet **Get-AzureRmSiteRecoveryNetworkMapping** Obtém informações sobre os mapeamentos de rede do Azure site Recovery para o cofre de recuperação do site atual.
...
### -Azure
Indica que o comando obtém uma lista de mapeamentos de rede para redes no servidor primário mapeado para redes virtuais do Azure.
...
### ASRFabric
O parâmetro ' PrimaryFabric ' aceita o valor do tipo ' ASRFabric ' do pipeline

### ASRServer
O parâmetro ' PrimaryServer ' aceita o valor do tipo ' ASRServer ' do pipeline
