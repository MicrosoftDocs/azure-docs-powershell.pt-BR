...
## DESCRITIVO
O cmdlet **Update-AzureRmSiteRecoveryServer** atualiza um servidor do Azure site Recovery.
...
### -Servidor
Especifica o servidor de recuperação de site em que este cmdlet é atualizado.
