...
## DESCRITIVO
O cmdlet **Remove-AzureRmSiteRecoveryServicesProvider** remove um provedor de serviços de recuperação de site do Azure do cofre.
...
### -Servicesprovider
Especifica o objeto provedor de serviços.
