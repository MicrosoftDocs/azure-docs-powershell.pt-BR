...
## DESCRITIVO
O cmdlet **set-AzureRmSiteRecoveryProtectionEntity** habilita ou desabilita a proteção em uma entidade de proteção do Azure site Recovery.
...
### -Proteção
Especifica se a proteção deve ser habilitada ou desabilitada.
Os valores aceitáveis para esse parâmetro são:
...
Especifica a ID da conta de armazenamento do Azure de destino.
...
### -WaitForCompletion
Indica que o comando aguarda a conclusão antes de retornar.
