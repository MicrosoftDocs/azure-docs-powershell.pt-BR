...
Obtém contêineres de proteção para o cofre de recuperação do site atual.
...
Obtém informações sobre os provedores do Azure site Recovery no cofre.

### [Get-AzureRmSiteRecoverySite](Get-AzureRmSiteRecoverySite.md)
Obtém os sites do Hyper-V do cofre de recuperação do site.
...
Obtém informações de configurações para o cofre de recuperação do site atual.
...
Permite a replicação para um item que pode ser protegido criando um item protegido
...
Cria um mapeamento de classificação de armazenamento na recuperação do site.
...
Remove um item protegido de replicação do Azure site Recovery.
...
Remove um provedor de serviços de recuperação de site do Azure.
...
Define o estado de uma entidade de proteção de site Recovery.
...
Define as opções do lado de recuperação de uma entidade de proteção de site Recovery.
...
{{Insira Update-AzureRmSiteRecoveryPolicy Descrição manualmente aqui}}
...
Atualiza um servidor de recuperação de site.
