...
## DESCRITIVO
O cmdlet **New-AzureRmSiteRecoveryRecoveryPlan** cria um plano de recuperação no Azure site Recovery.
...
### ASRProtectionEntity[]
O parâmetro ' ProtectionEntityList ' aceita o valor do tipo ' ASRProtectionEntity [] ' da pipeline

### ASRReplicationProtectedItem[]
O parâmetro ' ReplicationProtectedItem ' aceita o valor do tipo ' ASRReplicationProtectedItem [] ' da pipeline
