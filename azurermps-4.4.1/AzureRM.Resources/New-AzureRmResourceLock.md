...
### Um bloqueio no escopo especificado. Assume
```
...
### Um bloqueio no escopo do grupo de recursos.
```
New-AzureRmResourceLock -LockName <String> -LockLevel <LockLevel> [-LockNotes <String>] [-Force]
...
### Um bloqueio no escopo de recursos do grupo de recursos.
```
New-AzureRmResourceLock -LockName <String> -LockLevel <LockLevel> [-LockNotes <String>] [-Force]
...
### Um bloqueio no escopo da assinatura.
```
New-AzureRmResourceLock -LockName <String> -LockLevel <LockLevel> [-LockNotes <String>] [-Force]
...
### Um bloqueio no escopo do recurso de assinatura.
```
New-AzureRmResourceLock -LockName <String> -LockLevel <LockLevel> [-LockNotes <String>] [-Force]
...
### Um bloqueio no escopo do recurso locatário.
```
New-AzureRmResourceLock -LockName <String> -LockLevel <LockLevel> [-LockNotes <String>] [-Force]
...
## DESCRITIVO
O cmdlet **New-AzureRmResourceLock** cria um bloqueio de recurso.

## EXEMPLOS

### Exemplo 1: criar um bloqueio de recurso em um site
```
...
Esse comando cria um bloqueio de recurso em um site.
...
### -LockLevel
Especifica o nível para o bloqueio.
Atualmente, o único valor válido é CanNotDelete.
...
### -LockNotes
Especifica as anotações para o bloqueio.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos para o qual o bloqueio se aplica ou que contém o grupo de recursos ao qual o bloqueio se aplica.
...
### -ResourceName
Especifica o nome do recurso para o qual o bloqueio se aplica.
...
### -ResourceType
Especifica o tipo de recurso do recurso para o qual o bloqueio se aplica.
...
`/subscriptions/`ID `/resourceGroups/` do grupo de recursos nome do grupo nome `/providers/Microsoft.Sql/servers/` do `/databases/` banco de dados

Para especificar um grupo de recursos, use o seguinte formato: 

`/subscriptions/`ID da assinatura `/resourceGroups/` nome do grupo de recursos
