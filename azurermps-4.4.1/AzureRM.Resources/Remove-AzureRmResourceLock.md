...
### Um bloqueio no escopo especificado.
```
...
## DESCRITIVO
O cmdlet **Remove-AzureRmResourceLock** remove um bloqueio de recurso do Azure.

## EXEMPLOS

### Exemplo 1: remover um bloqueio
```
...
Esse comando Remove o bloqueio chamado ContosoSiteLock.
...
### -LockId
Especifica a ID do bloqueio que este cmdlet Remove.
...
### -Lockname
Especifica o nome do bloqueio que este cmdlet Remove.
