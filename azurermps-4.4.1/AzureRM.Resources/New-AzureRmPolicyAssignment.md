...
### Atribuição de política sem parâmetros (padrão)
```
...
### Atribuição de política com parâmetros por objeto de parâmetro de política
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
...
### Atribuição de política com parâmetros por cadeia de parâmetro de política
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
 [-Description <String>] -PolicyDefinition <PSObject> [-PolicySetDefinition <PSObject>]
...
### Atribuição de política com parâmetros por meio do objeto de parâmetro de conjunto de políticas
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
 [-Description <String>] [-PolicyDefinition <PSObject>] -PolicySetDefinition <PSObject>
 -PolicyParameterObject <Hashtable> [-Sku <Hashtable>] [-ApiVersion <String>] [-Pre]
...
### Atribuição de política com parâmetros por cadeia de parâmetro de conjunto de políticas
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
 [-Description <String>] [-PolicyDefinition <PSObject>] -PolicySetDefinition <PSObject>
 -PolicyParameter <String> [-Sku <Hashtable>] [-ApiVersion <String>] [-Pre]
...
O segundo comando obtém a definição de política chamada VirtualMachinePolicy usando o cmdlet Get-AzureRmPolicyDefinition.
O comando armazena esse objeto na variável $Policy.

O comando final atribui a política em $Policy no nível de um grupo de recursos.
...
### -PolicyDefinition
Especifica uma política, como um objeto **PSObject** que contém a regra de política.
...
Por exemplo, para atribuir uma política a um grupo de recursos, especifique o seguinte:
...
### -SKU
Uma tabela de hash que representa as propriedades de SKU. Padrões para SKU grátis: nome = a0, nível = grátis
