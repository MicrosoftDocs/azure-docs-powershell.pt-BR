...
## DESCRITIVO
O cmdlet **New-AzureRMSqlDatabaseSecondary** substitui o cmdlet Start-AzureSqlDatabaseCopy quando usado para configurar a replicação geográfica para um banco de dados. Ele retorna o objeto de link de replicação geográfica do banco de dados primário para o secundário.

## EXEMPLOS

### 1: estabelecer Geo-Replication ativas
```
...
### -Marcas
Especifica os pares de valores chave na forma de uma tabela de hash a serem associados ao link de replicação do banco de dados SQL. Por exemplo:
...
Esse cmdlet retorna objetos **ReplicationLink** .
