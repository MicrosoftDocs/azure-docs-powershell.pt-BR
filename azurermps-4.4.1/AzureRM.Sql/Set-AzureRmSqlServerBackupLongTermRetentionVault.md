...
## DESCRITIVO
O cmdlet **set-AzureRmSqlServerBackupLongTermRetentionVault** define o cofre de retenção de longo prazo registrado para este servidor.
O cofre é um recurso de backup do Azure usado para armazenar dados de backup.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém o servidor.
...
### -Nomedoservidor
Especifica o servidor para o qual esse cmdlet define um cofre.
