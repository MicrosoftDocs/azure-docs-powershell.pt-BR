...
## DESCRITIVO
O cmdlet **set-AzureRmSqlElasticPool** modifica as propriedades de um pool de banco de dados elástico em um banco de dados SQL do Azure. Esse cmdlet pode modificar as DTUs (unidades de throughput de banco de dados) mínimas por banco de dados, além do máximo de DTUs por banco de dados, o número de DTUs do pool e o limite de armazenamento do pool.
...
### Exemplo 2: modificar o armazenamento máximo de um pool elástico
```
...
### -Marcas
Especifica um dicionário de pares de chave-valor que esse cmdlet associa ao pool elástico na forma de uma tabela de hash. Por exemplo:
