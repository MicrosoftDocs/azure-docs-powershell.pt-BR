...
## DESCRITIVO
O cmdlet **Get-AzureRmSqlDatabaseThreatDetectionPolicy** Obtém a política de detecção de ameaças de um banco de dados SQL do Azure.
...
Esse cmdlet retorna um objeto **Model. DatabaseThreatDetectionPolicyModel** .
