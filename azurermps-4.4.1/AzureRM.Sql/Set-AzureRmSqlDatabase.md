...
## DESCRITIVO
O cmdlet **set-AzureRmSqlDatabase** define propriedades para um banco de dados SQL do Azure.
Além disso, você pode especificar o parâmetro *ElasticPoolName* para mover um banco de dados para um pool elástico.
Se um banco de dados já estiver em um pool elástico, você pode usar o parâmetro *RequestedServiceObjectiveName* para atribuir um nível de desempenho.
...
Você pode especificar o parâmetro ou o *MaxSizeGB*.
Consulte o parâmetro *MaxSizeGB* para obter valores aceitáveis por edição.
