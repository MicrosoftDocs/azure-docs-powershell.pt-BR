...
## DESCRITIVO
O cmdlet **Get-AzureRmSqlServerServiceObjective** Obtém os objetivos de serviço disponíveis para um servidor de banco de dados SQL do Azure.
...
Esse comando obtém os objetivos de serviço do servidor chamado Server01 e o banco de dados chamado Database01.

## OS

### -DatabaseName
Especifica o nome de um banco de dados SQL do Azure.
