...
## DESCRITIVO
O cmdlet **Get-AzureRmSqlServerAuditing** Obtém a política de auditoria de blob de um SQL Server do Azure.
Especifique os parâmetros *ResourceGroupName* e *nomedoservidor* para identificar o banco de dados.
Esse cmdlet retorna uma política que é usada pelos bancos de dados SQL do Azure definidos no SQL Server do Azure especificado.
