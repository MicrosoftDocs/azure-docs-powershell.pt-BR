...
## DESCRITIVO
O cmdlet **set-AzureRmSqlDatabaseAdvisorAutoExecuteStatus** modifica a propriedade de execução automática para um supervisor de banco de dados SQL do Azure.
...
Esse cmdlet retorna um objeto **AzureSqlDatabaseAdvisorModel** .
