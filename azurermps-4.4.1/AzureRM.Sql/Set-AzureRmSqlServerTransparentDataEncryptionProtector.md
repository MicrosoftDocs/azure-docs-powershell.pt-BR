...
## DESCRITIVO
O cmdlet Set-AzureRmSqlServerTransparentDataEncryptionProtector define o protetor TDE para um SQL Server.
Alterar o tipo de protetor TDE irá rotacionar o protetor.

## EXEMPLOS

### --------------------------Exemplo 1: definir o tipo de protetor de criptografia de dados transparentes (TDE) como não gerenciado--------------------------
```
...
### --------------------------Exemplo 2: definir o tipo de protetor de criptografia de dados transparente para o Azure Key Vault--------------------------
```
