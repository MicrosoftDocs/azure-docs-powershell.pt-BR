...
### -DatabaseName
Especifica o nome do banco de dados SQL para o qual esse cmdlet define uma política.
...
### -Nomedoservidor
Especifica o servidor que hospeda o banco de dados.
