...
## DESCRITIVO
O cmdlet **set-AzureRmSqlServerFirewallRule** modifica uma regra de firewall em um servidor de banco de dados SQL do Azure.
...
O comando modifica os endereços IP de início e término.
