...
## DESCRITIVO
O cmdlet **resume-AzureRmSqlDatabase** retoma um banco de dados de SQL data warehouse do Azure.

## EXEMPLOS

### Exemplo 1: retoma um banco de dados de SQL data warehouse do Azure
```
PS C:\>Resume-AzureRmSqlDatabase -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

Esse comando retoma um banco de dados suspenso do Azure SQL data warehouse.

## OS

### -DatabaseName
Especifica o nome do banco de dados que este cmdlet reinicia.
...
### -Nomedoservidor
Especifica o nome do servidor que hospeda o banco de dados que este cmdlet reinicia.
...
## INFORMA
* O cmdlet **resume-AzureRmSqlDatabase** funciona apenas em bancos de dados de data warehouse do SQL do Azure. Não há suporte para essa operação nas edições Basic, Standard e Premium do banco de dados SQL do Azure.
