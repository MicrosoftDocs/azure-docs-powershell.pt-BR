...
## DESCRITIVO
O cmdlet **Get-AzureRmSqlDatabaseActivity** Obtém o status de bancos de dados elásticos que se movem para dentro ou para fora de um pool de banco de dados elástico no banco de dados SQL do Azure.
...
### -Nomedoservidor
Especifica o nome do Microsoft SQL Server que hospeda o pool de banco de dados elástico.
