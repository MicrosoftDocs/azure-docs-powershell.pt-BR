...
## DESCRITIVO
O cmdlet **Update-AzureRmContainerRegistryCredential** regenera uma credencial de logon para um registro de contêiner.
...
Esse comando regenera uma credencial de logon para o registro de contêiner especificado. O usuário administrador precisa estar habilitado para o registro do contêiner `MyRegistry` gerar novamente as credenciais de logon.
