...
## DESCRITIVO
O cmdlet **New-AzureBatchCertificate** adiciona um certificado à conta em lotes do Azure especificada.
...
### Byte []
O parâmetro ' RawData ' aceita o valor do tipo ' byte [] ' do pipeline
