...
## DESCRITIVO
O cmdlet **Remove-AzureBatchNodeFile** exclui um arquivo de nó de lote do Azure para uma tarefa ou um nó de computação.

## EXEMPLOS

### Exemplo 1: excluir um arquivo assocated com uma tarefa
```
PS C:\>Remove-AzureBatchNodeFile -JobId "Job-000001" -TaskId "Task26" -Name "wd\testFile.txt" -BatchContext $Context
```

Esse comando exclui o arquivo de nó chamado wd\testFile.txt.
Esse arquivo está associado à tarefa que tem a ID Task26 sob o job job-000001.
...
Esse comando exclui o arquivo de nó que é chamado startup\testFile.txt do nó de computação especificado no pool que tem a ID Pool07.
...
Esse comando obtém o arquivo de nó usando **Get-AzureBatchNodeFile**.
Esse arquivo está associado à tarefa que tem a ID Task26 sob o job job-000001.
O comando passa esse arquivo para o cmdlet atual usando o pipeline.
O cmdlet atual remove o arquivo de nó.
...
### -ComputeNodeId
Especifica a ID do nó de computação que contém o arquivo de nó de lote que este cmdlet exclui.
...
### -InputObject
Especifica o objeto **PSNodeFile** que representa o arquivo de nó que este cmdlet exclui.
Para obter um **PSNodeFile** , use o cmdlet Get-AzureBatchNodeFile.
...
### -Nome
Especifica o nome do arquivo de nó que este cmdlet exclui.
...
### -Recursiva
Indica que esse cmdlet exclui a pasta e todas as subpastas e arquivos sob o caminho especificado.
Este cmdlet é relevante apenas se o caminho for uma pasta.
