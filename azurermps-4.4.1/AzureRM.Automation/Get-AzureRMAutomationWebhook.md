...
## DESCRITIVO
O cmdlet **Get-AzureRmAutomationWebhook** Obtém WebHooks.
Para obter WebHooks específicos, especifique um nome de webhook ou especifique o nome de um runbook de automação do Azure para obter os WebHooks conectados a ele.
...
Especifica o nome de uma conta de automação na qual esse cmdlet recebe um webhook.
...
### -Nome
Especifica o nome do webhook que este cmdlet obtém.
