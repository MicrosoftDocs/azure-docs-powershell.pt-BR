...
## DESCRITIVO
O cmdlet **Test-AzureRmDataLakeAnalyticsAccount** verifica a existência de uma conta do data Lake Analytics.
...
### bool
True ou false que indica se a conta existe ou não.
