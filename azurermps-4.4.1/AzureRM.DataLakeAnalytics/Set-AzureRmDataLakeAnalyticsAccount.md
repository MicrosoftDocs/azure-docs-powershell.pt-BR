...
## DESCRITIVO
O cmdlet **set-AzureRmDataLakeAnalyticsAccount** modifica uma conta do Azure data Lake Analytics.
...
O grau máximo de suporte opcional de paralelismo para atualizar a conta com.
