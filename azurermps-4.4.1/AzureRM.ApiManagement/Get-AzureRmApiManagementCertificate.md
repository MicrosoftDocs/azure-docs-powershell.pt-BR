...
### Obter todos os certificados (padrão)
```
...
## DESCRITIVO
O cmdlet **Get-AzureRmApiManagementCertificate** Obtém todos os certificados de gerenciamento de API do Azure ou certificados que você especificar.
