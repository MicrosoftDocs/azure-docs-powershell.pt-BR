...
## DESCRITIVO
O cmdlet **Remove-AzureRmApiManagementApiFromProduct** remove uma API de gerenciamento de API do Azure de um produto.
...
Isso commnd remove a API especificada de um produto.
