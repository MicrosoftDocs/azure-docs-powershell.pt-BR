...
## DESCRITIVO
O cmdlet **set-AzureRmApiManagementOpenIdConnectProvider** modifica um provedor de conexão OpenID no gerenciamento de API do Azure.
...
Esse comando modifica o provedor que tem a ID OICProvicer01.
