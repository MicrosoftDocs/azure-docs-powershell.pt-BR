...
Obtém certificados de gerenciamento de API.
...
{{Insira Get-AzureRmApiManagementProperty Descrição manualmente aqui}}
...
### [Publicar-AzureRmApiManagementTenantGitConfiguration](Publish-AzureRmApiManagementTenantGitConfiguration.md)
...
Modifica um certificado de gerenciamento de API.
