...
O comando especifica várias configurações para a configuração do serviço de contêiner.
O comando passa o objeto de configuração para o cmdlet Add-AzureRmContainerServiceAgentPoolProfile usando o operador pipeline.
Esse cmdlet adiciona um perfil de pool do agente.
...
### -Marca
Especifica as marcas para o serviço de contêiner.
