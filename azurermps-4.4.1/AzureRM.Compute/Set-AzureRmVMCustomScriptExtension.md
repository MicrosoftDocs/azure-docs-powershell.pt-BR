...
## DESCRITIVO
O cmdlet **set-AzureRmVMCustomScriptExtension** adiciona uma extensão de máquina virtual de script personalizado a uma máquina virtual.
...
### -Nome do arquivo
Especifica o nome do arquivo de script.
