...
## Sinopse
Defina as propriedades de um tópico de grade de eventos.
...
## DESCRITIVO
Defina as propriedades de um tópico de grade de eventos. Isso pode ser usado para substituir as marcas de um tópico de grade de eventos.
...
Define as propriedades do tópico da grade de eventos \` tópico1 \` no grupo de MyResourceGroupName de recursos \` \` para substituir as marcas por "departamento" e "ambiente" especificado.
