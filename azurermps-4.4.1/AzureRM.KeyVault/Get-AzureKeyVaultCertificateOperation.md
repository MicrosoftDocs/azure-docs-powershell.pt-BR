...
## DESCRITIVO
O cmdlet **Get-AzureKeyVaultCertificateOperation** Obtém o status de uma operação de certificado.

## EXEMPLOS

### Exemplo 1: obter o status de uma operação de certificado
```
...
Esse comando obtém o status da operação do certificado para TestCert01 no cofre da chave ContosoKV01.
