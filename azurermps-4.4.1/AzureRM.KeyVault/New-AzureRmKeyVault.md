...
### -EnableSoftDelete
Se especificado, a funcionalidade ' exclusão reversível ' está habilitada para este cofre de chaves.
...
### -Local
Especifica a região do Azure na qual criar o cofre de chaves. Use o comando Get-AzureLocation ( https://msdn.microsoft.com/ library/Azure/mt589064. aspx) para ver suas opções. Para obter mais informações, digite `Get-Help Get-AzureLocation` .
