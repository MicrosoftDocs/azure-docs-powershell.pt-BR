...
### -KeyvaultEncryption
Define se deseja definir a fonte de fonte de criptografia da conta de armazenamento como Microsoft. keyvault ou não. Se você especificar KeyName, keyversion e KeyvaultUri, a fonte de criptografia da conta de armazenamento também será definida como Microsoft. Weather Weather esse parâmetro está definido ou não.
```yaml
Type: System.Management.Automation.SwitchParameter
Parameter Sets: KeyvaultEncryption
Aliases: 
...
### -NetworkRuleSet
Conta de armazenamento NetworkRuleSet
