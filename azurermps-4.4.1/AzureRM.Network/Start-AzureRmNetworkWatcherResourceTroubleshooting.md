...
## DESCRITIVO
O cmdlet Start-AzureRmNetworkWatcherResourceTroubleshooting começa a solução de problemas para um recurso de rede no Azure e retorna informações sobre possíveis problemas e atenuações. Atualmente, há suporte para gateways de rede virtual e conexões.
