...
## DESCRITIVO
O cmdlet **New-AzureRmNetworkSecurityGroup** cria um grupo de segurança de rede do Azure.

## EXEMPLOS

### 1: criar um novo grupo de segurança de rede
```
New-AzureRmNetworkSecurityGroup -Name "nsg1" -ResourceGroupName "rg1"  -Location  "westus"
```

Esse comando cria um novo grupo de segurança de rede do Azure chamado "nsg1" no grupo de recursos "Rg1" no local "oesteus".

### 2: criar um grupo de segurança de rede detalhado
```
...
Etapa: 1 Crie uma regra de segurança para permitir o acesso da Internet à porta 3389.
Etapa: 2 crie uma regra de segurança que permita o acesso da Internet à porta 80.
...
Esse cmdlet cria um grupo de segurança de rede no grupo de recursos que esse parâmetro especifica.
