...
## DESCRITIVO
O Set-AzureRmNetworkWatcherConfigFlowLog configura o registro em log de fluxo para um recurso de destino. As propriedades a serem configuradas incluem: se o recurso de log de fluxo está ou não habilitado para o recurso fornecido, a conta de armazenamento configurada para enviar logs e a política de retenção para os logs. Atualmente, os grupos de segurança de rede têm suporte para o registro de fluxo. 

## EXEMPLOS

### ---Exemplo 1: configurar o log de fluxo para um---de NSG especificado
```
...
Neste exemplo, configuramos o status do log de fluxo para um grupo de segurança de rede. Na resposta, vemos que o NSG especificado tem o log de fluxo habilitado e nenhuma política de retenção definida.
