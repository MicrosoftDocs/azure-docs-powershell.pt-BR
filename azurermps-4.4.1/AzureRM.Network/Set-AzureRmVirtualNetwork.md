...
Este exemplo cria uma rede virtual com duas sub-redes. Em seguida, ele remove uma sub-rede da representação na memória da rede virtual. O cmdlet Set-AzureRmVirtualNetwork é usado para gravar o estado da rede virtual modificada no lado do serviço.
