...
### Conjunto de parâmetros para parâmetros de campos
```
...
## DESCRITIVO
O cmdlet **Remove-AzureRmCdnProfile** remove um perfil da CDN (rede de distribuição de conteúdo) do Azure.
...
### -CdnProfile
Especifica o perfil que este cmdlet Remove.
...
### -ProfileName
Especifica o nome do perfil que este cmdlet Remove.
