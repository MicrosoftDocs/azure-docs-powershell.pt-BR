...
## DESCRITIVO
O cmdlet **set-AzureRmOperationalInsightsDataSource** atualiza uma fonte de dados.
...
### -DataSource
Especifica a fonte de dados que este cmdlet atualiza.
...
### PSDataSource
O parâmetro ' DataSource ' aceita o valor do tipo ' PSDataSource ' do pipeline
