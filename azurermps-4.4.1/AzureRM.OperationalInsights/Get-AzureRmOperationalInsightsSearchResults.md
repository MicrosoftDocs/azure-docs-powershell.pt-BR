...
O objeto **PSSearchGetSearchResultsResponse** inclui uma propriedade Value que inclui os registros retornados do formato de pesquisa em JSON e um objeto de metadados que inclui informações sobre os resultados da pesquisa.
