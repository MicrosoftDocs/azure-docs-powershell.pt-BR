...
## DESCRITIVO
O cmdlet **Enable-AzureRmOperationalInsightsLinuxPerformanceCollection** inicia a coleta de contadores de desempenho de computadores Linux conectados em um espaço de trabalho.
