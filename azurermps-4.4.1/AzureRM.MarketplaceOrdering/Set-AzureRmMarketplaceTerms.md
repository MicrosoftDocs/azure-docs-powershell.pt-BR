...
## DESCRITIVO
O cmdlet **set-AzureRmMarketplaceTerms** salva o objeto terms para a determinada ID de fornecedor (fornecedor), a ID de oferta (produto) e a tupla de ID de plano (nome).
...
### -InputObject
Objeto termos retornado no Get-AzureRmMarketplaceTerms cmdlet. Esse é um parâmetro obrigatório se o parâmetro aceito for verdadeiro.
