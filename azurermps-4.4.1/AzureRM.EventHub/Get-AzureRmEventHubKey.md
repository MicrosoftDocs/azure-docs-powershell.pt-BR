...
## DESCRITIVO
O cmdlet Get-AzureRmEventHubKey retorna connectionStrings primárias e secundárias e detalhes de chaves da regra de autorização de hubs de eventos especificados.
