...
## DESCRITIVO
O cmdlet Set-AzureRmEventHub atualiza as propriedades do hub de eventos especificado.

## EXEMPLOS

### Exemplo 1
Para atualizar o Eventhub com as propriedades de descrição de captura, siga as etapas abaixo. 
...
Atualiza o MyEventHubName do hub de eventos \` \` representado \` pelo \` objeto MyCreatedEventHub, definindo o período de retenção da mensagem como 4 dias, o número de partições para 2 e propriedades de CaptureDescription
...
Atualiza o MyEventHubName do hub de eventos \` \` representado \` pelo \` objeto MyCreatedEventHub, definindo o período de retenção da mensagem como 4 dias e o número de partições para 2.

## OS

### -messageRetentionInDays
Período de retenção da mensagem do hub de eventos em dias.
...
### -partitionCount
Número de partições nesse Hub de eventos.
