...
## DESCRITIVO
O cmdlet Set-AzureRmEventHubNamespaceAuthorizationRule atualiza a regra de autorização no namespace de hubs de eventos especificado.
...
Atualiza a regra de autorização \` MyAuthRuleName \` para conceder direitos de gerenciamento.

## OS

### -AuthorizationRuleName
O nome da regra de autorização.
Obrigatório se-AuthruleObj não for especificado.
...
### -AuthRuleObj
O objeto de regra de autorização de namespace de hubs de eventos.
