...
## DESCRITIVO
O cmdlet **New-AzureRmIntegrationAccountSchema** cria um esquema de conta de integração.
...
### Exemplo 1: criar o esquema da conta de integração
```
...
Esse comando cria o esquema da conta de integração chamado IntegrationAccountSchema1 no grupo de recursos especificado.
...
### -SchemaName
Especifica um nome para o esquema da conta de integração.
