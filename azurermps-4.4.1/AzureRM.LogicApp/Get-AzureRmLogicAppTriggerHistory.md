...
## DESCRITIVO
O cmdlet **Get-AzureRmLogicAppTriggerHistory** Obtém o histórico de gatilhos em um aplicativo lógico no recurso de aplicativos lógicos.
Esse cmdlet retorna um objeto **WorkflowTriggerHistory** .
Especifique o aplicativo lógico, o grupo de recursos e o gatilho.
...
### Exemplo 1: obter um histórico de gatilho de um aplicativo lógico
```
...
Esse comando obtém um histórico de gatilho do aplicativo lógico específico para um gatilho no aplicativo lógico chamado LogicApp03.

### Exemplo 2: obter históricos de gatilho de um aplicativo lógico
```
...
Esse comando obtém os históricos de gatilho do fluxo de trabalho para um gatilho no aplicativo lógico chamado LogicApp07.

## OS

### -Historyname
Especifica o nome do histórico que este cmdlet obtém.
...
### -Nome
Especifica o nome do aplicativo lógico para o qual este cmdlet tem o histórico de gatilhos.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos no qual esse cmdlet obtém o histórico.
...
### -Triggername
Especifica o nome do gatilho para o qual esse cmdlet obtém o histórico.
