...
### Parâmetros padrão para alerta de registro de atividades de definição
```
...
### Parâmetros para definir um alerta de log de atividades levando o valor de ResourceId do pipe
```
...
### Parâmetros para definir um valor de alertas do log de atividades a partir do pipe
```
