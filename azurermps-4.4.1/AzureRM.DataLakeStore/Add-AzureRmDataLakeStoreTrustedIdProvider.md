...
## DESCRITIVO
O cmdlet **Add-AzureRmDataLakeStoreTrustedIdProvider** adiciona um provedor de identidade confiável à conta especificada do data Lake Store.
...
### -Conta
O nome da conta do data Lake Store para a qual o provedor de identidade confiável especificado será adicionado.
...
### -ResourceGroupName
Nome do grupo de recursos sob o qual a conta para a qual o provedor de identidade confiável será adicionado.
...
O provedor de identidade confiável adicionado.
