...
## DESCRITIVO
O cmdlet **New-AzureRmDataLakeStoreItem** cria um novo arquivo ou pasta no data Lake Store.

## EXEMPLOS

### Exemplo 1: criar um novo arquivo e uma nova pasta
```
PS C:\>New-AzureRmDataLakeStoreItem -AccountName "ContosoADL" -Path "/NewFile.txt"
PS C:\> New-AzureRmDataLakeStoreItem -AccountName "ContosoADL" -Path "/NewFolder" -Folder
```

O primeiro comando cria o NewFile.txt de arquivo para a conta especificada.

O segundo comando cria a pasta NewFolder na pasta raiz.
...
### -Pasta
Indica que esta operação cria uma pasta.
...
### -Force
Indica que essa operação pode substituir o item de destino, caso ele já exista.
...
### -Caminho
Especifica o caminho do repositório data Lake do item a ser criado, começando com o diretório raiz (/).
...
### -Valor
Especifica o conteúdo a ser adicionado ao item que você criou.
...
### Objeto
O parâmetro ' value ' aceita o valor do tipo ' Object ' da pipeline

## EXIBE

### String
O caminho completo para o arquivo ou a pasta criada.
