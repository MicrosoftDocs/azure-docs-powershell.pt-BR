...
## DESCRITIVO
O cmdlet **move-AzureRmDataLakeStoreItem** move ou renomeia um arquivo ou pasta no repositório data Lake.
...
### -Destino
Especifica o caminho do repositório data Lake para o qual mover o item, começando com o diretório raiz (/).
...
### -Caminho
Especifica o caminho do repositório data Lake do item para mover ou renomear, começando com o diretório raiz (/).
...
### String
O caminho completo para o arquivo ou pasta movida.
