...
## DESCRITIVO
O cmdlet **set-AzureRmDataLakeStoreFirewallRule** modifica a regra de firewall especificada no repositório data Lake especificado.

## EXEMPLOS

### Exemplo 1: atualizar o intervalo de IP de início e término de uma regra de firewall
```
...
Atualiza a regra de firewall "MyFirewallRule" na conta "ContosoADL" para ter um intervalo de 127.0.0.1-127.0.0.2
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém a conta para a qual atualizar a regra de firewall.
...
Os detalhes da regra de firewall atualizada.
