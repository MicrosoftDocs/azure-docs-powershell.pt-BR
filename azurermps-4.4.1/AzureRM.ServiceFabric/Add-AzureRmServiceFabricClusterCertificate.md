...
## DESCRITIVO
Use **Add-AzureRmServiceFabricClusterCertificate** para adicionar um certificado de cluster secundário, seja de um cofre de chaves do Azure existente ou criando um novo cofre de chaves do Azure usando um certificado existente fornecido ou a partir de um novo certificado auto-assinado criado. Ele substituirá o cluster secundário, se houver.
...
### -SecretIdentifier
A URL secreta existente do Azure Key Vault.
