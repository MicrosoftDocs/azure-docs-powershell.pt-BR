...
## DESCRITIVO
O cmdlet **Start-AzureRmDataFactoryV2IntegrationRuntime** inicia um tempo de execução de integração dedicada gerenciado. O recurso é provisionado e após a operação em que o estado é ' iniciado '.

## EXEMPLOS

### Exemplo 1: iniciar um tempo de execução de integração
```
...
Este cmdlet inicia um tempo de execução de integração dedicada gerenciado chamado ' test-Dedicated-IV '.
...
[Parar-AzureRmDataFactoryV2IntegrationRuntime]()
