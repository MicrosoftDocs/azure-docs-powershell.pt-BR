...
## DESCRITIVO
O cmdlet **Remove-AzureRmDataFactoryV2Trigger** remove um gatilho de uma fábrica de dados. Se o parâmetro _Force_ for especificado, o cmdlet não avisa antes de remover o gatilho.
