...
## DESCRITIVO
O cmdlet **resume-AzureRmDataFactoryPipeline** retoma um pipeline suspenso no Azure data Factory.
...
Use o cmdlet **Suspend-AzureRmDataFactoryPipeline** para suspender um pipeline.
