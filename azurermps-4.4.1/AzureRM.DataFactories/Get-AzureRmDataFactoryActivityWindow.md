...
## DESCRITIVO
O cmdlet **Get-AzureRmDataFactoryActivityWindow** Obtém informações sobre as janelas de atividade associadas a uma fábrica de dados.
...
Esse cmdlet obtém as janelas de atividade que estão no estado que esse parâmetro especifica.
...
Esse cmdlet obtém as janelas de atividade que estão no subestado que esse parâmetro especifica.
...
[Cmdlets de fábricas de dados do Azure](./AzureRM.DataFactories.md)
