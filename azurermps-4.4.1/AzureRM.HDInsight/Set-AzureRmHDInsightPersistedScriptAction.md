...
## DESCRITIVO
O cmdlet **set-AzureRmHDInsightPersistedScriptAction** define uma ação de script executada anteriormente para ser uma ação de script persistente.
...
Você pode encontrar a ID de execução da ação de script usando Get-AzureRmHDInsightScriptActionHistory.
