...
## DESCRITIVO
O cmdlet **REVOKE-AzureRmHDInsightHttpServicesAccess** desabilita o acesso http a um cluster do Azure HDInsight para os serviços Web ODBC, Ambari, Oozie e webHCatalog.

## EXEMPLOS

### Exemplo 1: desabilitar o acesso HTTP a um cluster
```
PS C:\>Revoke-AzureRmHDInsightHttpServicesAccess `
       -ClusterName "your-hadoop_001"
```

Esse comando revoga o acesso HTTP ao cluster chamado seu hadoop_001.
