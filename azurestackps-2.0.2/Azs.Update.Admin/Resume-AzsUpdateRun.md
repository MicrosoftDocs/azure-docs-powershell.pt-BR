...
## Sinopse
Retomar uma atualização com falha.

## SYNTAX

### Executar novamente (padrão)
```
...
### Exemplo 1: Resume-AzsUpdateRun por nome e updatename
```powershell
PS C:\> Resume-AzsUpdateRun -UpdateName northwest/Microsoft1.1907.0.10 -Name 45aaeb26-805b-495b-9c8c-d5da5542dbf4

```

O commandlet permite executar novamente uma execução de atualização específica com falha.
Observe que há um requisito de que a versão de atualização seja estritamente maior do que a versão atual.
