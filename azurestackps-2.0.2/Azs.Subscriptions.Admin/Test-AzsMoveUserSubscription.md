...
Teste se as assinaturas do usuário podem ser movidas para uma oferta de provedor delegado.
...
Teste se as assinaturas do usuário podem ser movidas de um provedor delegado para o provedor padrão.
