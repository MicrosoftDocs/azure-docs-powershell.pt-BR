...
Crie um trabalho de migração de disco para migrar os discos para a unidade de escala de destino e o volume.
...
Crie um trabalho de migração de disco para migrar discos para o compartilhamento de destino.
...
### -Discos
Para construir, consulte a seção de notas para propriedades de discos e crie uma tabela de hash.
...
DISKs <IDisk [] >: 
  ...
  - `[SharePath <String>]`: O caminho de compartilhamento de disco.
  - `[Status <DiskState?>]`: O status do disco.
