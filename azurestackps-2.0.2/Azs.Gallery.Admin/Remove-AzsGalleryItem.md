...
### Exemplo 1: Remove-AzsGalleryItem
```powershell
PS C:\> Remove-AzsGalleryItem -Name TestUbuntu.Test.1.0.0

```

Exclui TestUbuntu. Test. 1.0.0 da Galeria de pilhas do Azure.

### Exemplo 2: Remove-AzsGalleryItem por meio do pipeline
```powershell
PS C:\> Get-AzsGalleryItem -Name TestUbuntu.Test.1.0.0 | Remove-AzsGalleryItem

```

Exclui TestUbuntu. Test. 1.0.0 pelo pipeline.
