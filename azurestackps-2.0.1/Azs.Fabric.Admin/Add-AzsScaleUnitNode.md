...
### Exemplo 1: Add-AzsScaleUnitNode
```powershell
...
Para construir, consulte a seção notas para propriedades NODELIST e crie uma tabela de hash.
...
Para construir, consulte a seção notas para propriedades SCALEUNITNODEPARAMETER e crie uma tabela de hash.
...
NODELIST <IScaleOutScaleUnitParameters [] >: lista de nós na unidade de escala.
  - `[BmciPv4Address <String>]`: BMC address da máquina física.
  - `[ComputerName <String>]`: Nome de computador da máquina física.

SCALEUNITNODEPARAMETER <IScaleOutScaleUnitParametersList> : uma lista de dados de entrada que permite adicionar um conjunto de nós de unidade de escala.
  - `[AwaitStorageConvergence <Boolean?>]`: Flag indica se a operação deve aguardar até que o armazenamento convergesse antes de retornar.
  - `[NodeList <IScaleOutScaleUnitParameters[]>]`: Lista de nós na unidade de escala.
    - `[BmciPv4Address <String>]`: BMC address da máquina física.
    - `[ComputerName <String>]`: Nome de computador da máquina física.
