...
## DESCRITIVO
O cmdlet **Get-AzureRmDeploymentManagerStep** Obtém uma etapa e retorna um objeto que representa essa etapa.
...
Você pode modificar esse objeto localmente e, em seguida, aplicar as alterações à fonte de artefatos usando o cmdlet Set-AzureRmDeploymentManagerStep.
...
### Exemplo 3: obter uma etapa usando um objeto retornado por New-AzureRmDeploymentManagerStep
```powershell
