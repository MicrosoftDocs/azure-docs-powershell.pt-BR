...
## DESCRITIVO
O cmdlet **New-AzureRmDeploymentManagerArtifactSource** cria uma fonte de artefato.
Especifique o *nome* , *ResourceGroupName* e propriedades necessárias.

Você pode modificar o objeto retornado localmente e, em seguida, aplicar as alterações à fonte de artefatos usando o cmdlet Set-AzureRmDeploymentManagerArtifactSource.

O cmdlet retorna um objeto artefato que tem um ResourceId que pode ser referenciado no cmdlet New-AzureRmDeloymentManagerServiceTopology para que os artefatos necessários para um recurso de recurso, o modelo e os arquivos de parâmetros, possam ser referenciados neste local.
...
Cria uma fonte de artefatos no ContosoResourceGroup com o nome ContosoArtifactSource com EUA como o local do recurso. A propriedade SasUri fornece um URI de SAS de armazenamento do Azure para o contêiner de armazenamento em que os artefatos são armazenados.

## OS

### -ArtifactRoot
O deslocamento de diretório opcional abaixo do contêiner de armazenamento dos artefatos.
...
### -SasUri
O URI da SAS para o contêiner de armazenamento do Azure em que os artefatos são armazenados.
