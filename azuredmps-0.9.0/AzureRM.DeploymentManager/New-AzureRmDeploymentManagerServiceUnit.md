...
## DESCRITIVO
O cmdlet **New-AzureRmDeploymentManagerServiceUnit** cria um serviço em um serviço em uma topologia de serviço e retorna um objeto que representa essa unidade de serviço.
...
O cmdlet retorna um objeto onunit. Você pode modificar esse objeto localmente e, em seguida, aplicar as alterações ao serviço usando o cmdlet Set-AzureRmDeploymentManagerService.
