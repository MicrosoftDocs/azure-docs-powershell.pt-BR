...
Crie um controlador DevSpaces no devSpaceResourceGroup de grupo de recursos com um nome devSpaceName. Use clusterName cluster como um destino para este controlador.
