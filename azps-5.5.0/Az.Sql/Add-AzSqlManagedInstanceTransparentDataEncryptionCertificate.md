...
## Sinopse
Adiciona um Certificado de Criptografia de Dados Transparente para uma determinada instância gerenciada
...
## Descrição
O Add-AzSqlManagedInstanceTransparentDataEncryptionCertificate adiciona um Certificado de Criptografia de Dados Transparentes para uma determinada instância gerenciada
...
### -Senha
A senha do certificado de criptografia de dados transparentes
...
### -PrivateB ltd
O blob particular para certificado de criptografia de dados transparentes
