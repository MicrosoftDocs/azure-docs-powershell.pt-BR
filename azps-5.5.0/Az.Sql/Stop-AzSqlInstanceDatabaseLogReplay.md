...
## Sinopse
Cancela o serviço de Reprodução de Log soltando o banco de dados.
...
## Descrição
O cmdlet **Stop-AzSqlInstanceDatabaseLogReplay** descarta o banco de dados e, portanto, cancela o serviço de Reprodução de Log.
...
Esse comando cancelará o serviço de reprodução de log no banco de dados determinado.
