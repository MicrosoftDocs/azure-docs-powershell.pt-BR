...
## Sinopse
Obtém as teclas do Cofre de Teclas de uma instância gerenciada pelo SQL.
...
## Descrição
O Get-AzSqlInstanceKeyVaultKey cmdlet obtém informações sobre as teclas do Cofre de Teclas em uma instância gerenciada pelo SQL. Você pode exibir todas as teclas em uma instância gerenciada ou exibir uma chave específica fornecendo o KeyId.
...
Esse comando obtém todas as teclas do Cofre de Teclas em uma instância gerenciada pelo SQL.
...
Esse comando obtém a tecla Key Vault com Id https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ' '.

### Exemplo 3: Usando objeto de instância
```powershell
...
### Exemplo 5: Usando a canalização
```powershell
PS C:\> $managedInstance = Get-AzSqlInstance -Name 'ContosoManagedInstanceName' -ResourceGroupName 'ContosoResourceGroup'
