...
## Sinopse
Obtém os tipos de informações recomendados e rótulos de sensibilidade de colunas no banco de dados de instância gerenciada do Azure SQL.
...
## Descrição
O Get-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet retorna os tipos de informações recomendadas e rótulos de sensibilidade de colunas no banco de dados de instância gerenciada do Azure SQL.

## Exemplos

### Exemplo 1: Obter tipos de informações recomendadas e rótulos de sensibilidade de um banco de dados de instância gerenciado pelo SQL do Azure.
```powershell
...
### Exemplo 2: Obter tipos de informações recomendadas e rótulos de sensibilidade de um banco de dados de instância gerenciado pelo SQL do Azure usando o Piping.
```powershell
