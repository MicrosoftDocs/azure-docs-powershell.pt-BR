...
## Sinopse
Remove um membro de sincronização de banco de dados SQL do Azure.
...
## Descrição
O cmdlet **Remove-AzSqlSyncMember** remove um Membro de Sincronização de Banco de Dados SQL do Azure.
...
Esse comando remove o Membro de Sincronização de Banco de Dados SQL do Azure chamado syncMember01.
...
### -PassThru
Define se o membro de sincronização removido deve retornar
