...
### Exemplo 4: Remover um destino de mapa estilhaço
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Remove um destino (servidor, pool elástica, banco de dados e mapa estilhaço) de um grupo de destino
...
### -AgentServerName
Nome do Servidor do Agente de Banco de Dados SQL.
...
### -ShardMapName
Nome de destino do mapa estilhaço
