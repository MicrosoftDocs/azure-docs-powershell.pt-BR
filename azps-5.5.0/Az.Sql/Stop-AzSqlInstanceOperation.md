...
## Sinopse
Interrompe as operações de uma instância gerenciada pelo SQL.
...
## Descrição
A Stop-AzSqlInstanceOperation de cmdlet interrompe a operação com o nome da operação fornecida em uma instância gerenciada pelo SQL.
...
Este comando interrompe a operação com o nome 'd0f5bef5-e2b1-4ef8-bb42-2e54073874f9' em uma instância gerenciada pelo SQL.

### Exemplo 2: Usando a ID do recurso de operação
```powershell
...
Este comando interrompe a operação com a ID do recurso $managedInstanceOperation.Id.

### Exemplo 3: usando o objeto de operação
```powershell
...
Esse comando interrompe a operação com a $managedInstanceOperation.
...
### -ResourceId
A ID do recurso do objeto de operação a ser parada
