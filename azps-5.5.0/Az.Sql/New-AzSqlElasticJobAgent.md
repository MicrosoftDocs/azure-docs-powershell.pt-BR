...
## Sinopse
Cria um novo agente de trabalho elástica
...
## Descrição
O New-AzSqlElasticJobAgent cmdlet cria um novo agente de Trabalho Elástica
...
### -DatabaseResourceId
A ID do Recurso de Banco de Dados de Controle do Agente
