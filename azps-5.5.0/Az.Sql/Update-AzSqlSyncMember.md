...
## Sinopse
Atualiza um Membro de Sincronização de Banco de Dados SQL do Azure.
...
## Descrição
O cmdlet **Update-AzSqlSyncGroup** modifica as propriedades de um Membro de Sincronização de Banco de Dados SQL do Azure.
...
Esse comando redefine a senha de administrador do banco de dados do membro.
...
Se você deve usar um link particular ao se conectar a este membro de sincronização.
