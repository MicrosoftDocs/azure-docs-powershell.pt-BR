...
## Sinopse
Recebe um ou mais Consultores para um SQL Server do Azure.
...
## Descrição
O cmdlet **Get-AzSqlServerAdvisor** obtém um ou mais Azure SQL Server Advisors para um SQL Server do Azure.
...
Esse comando obtém uma lista de todos os consultores do servidor chamado wi-runner-australia-east que pertence ao grupo de recursos chamado WI WifisProd.
...
Esse comando obtém o consultor chamado CreateIndex para o servidor chamado wi-runner-australia-east.
...
Esse comando obtém todos os consultores do servidor chamados wi-runner-australia-east.
Como o comando usa o parâmetro *ExpandRecom recommendedActions,* o cmdlet obtém as ações recomendadas dos consultores incluídas na resposta.
...
Esse comando recebe o advisor chamado CreateIndex do servidor chamado wi-runner-australia-east com suas ações recomendadas incluídas na resposta.

### Exemplo 5: Listar todos os consultores do servidor usando filtragem
```
...
Este comando obtém uma lista de todos os consultores do servidor chamado wi-runner-australia-east que pertence ao grupo de recursos chamado WI WifisProd que começam com a letra "d".
