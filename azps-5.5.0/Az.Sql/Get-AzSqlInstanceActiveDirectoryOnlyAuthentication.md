...
## Sinopse
Obtém a autenticação somente do Azure AD para uma instância gerenciada pelo SQL específica.
...
Esse comando obtém o requisito de autenticação somente do Azure Active Directory (Azure AD) para uma Instância Gerenciada do AzureSQL chamada ManagedInstance01 associada a um grupo de recursos chamado ResourceGroup01.
