...
## Sinopse
Retorna informações sobre a Instância de Banco de Dados Gerenciado pelo SQL do Azure.
...
## Descrição
O cmdlet **Get-AzSqlInstance** retorna informações sobre uma ou mais Instâncias Gerenciadas do Azure SQL.
Especifique o nome de uma instância para ver informações apenas para essa instância.
...
Esse comando obtém informações sobre todas as instâncias atribuídas ao grupo de recursos ResourceGroup01.
...
Esse comando obtém informações sobre a instância nomeada managedInstance1.

### Exemplo 3: Obter todas as instâncias atribuídas a um grupo de recursos usando filtragem
```powershell
...
### Exemplo 6: Obter todas as instâncias em um pool de instâncias usando o identificador de recurso de pool de instâncias
```powershell
...
### Exemplo 7: Obter uma instância gerenciada usando seu identificador de recurso
```powershell
...
### -ResourceId
O identificador de recurso de instância gerenciada.
