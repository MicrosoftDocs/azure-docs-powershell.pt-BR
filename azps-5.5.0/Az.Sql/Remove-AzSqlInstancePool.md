...
## Sinopse
Remove um pool de instâncias SQL do Azure.
...
## Descrição
O cmdlet **Remove-AzSqlInstancePool** remove um pool de Instância SQL do Azure.
...
### Exemplo 3: Remover um pool de instâncias por um objeto de pool de instância
```powershell
...
### -ResourceId
A ID do recurso de pool de instâncias a ser removido.
