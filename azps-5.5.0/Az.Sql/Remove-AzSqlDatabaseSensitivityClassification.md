...
### Exemplo 1: Remover o tipo de informações e o rótulo de sensibilidade de uma coluna em um banco de dados SQL do Azure.
```powershell
...
### Exemplo 2: Remover tipos de informações atuais e rótulos de sensibilidade de colunas em um banco de dados SQL do Azure usando o Piping.
```powershell
...
### Exemplo 3: Remover o tipo de informações e o rótulo de sensibilidade de uma coluna em um banco de dados SQL do Azure usando o Piping.
```powershell
