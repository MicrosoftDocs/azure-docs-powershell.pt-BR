...
## Descrição
O cmdlet **Get-AzSqlDatabaseDataMaskingPolicy** obtém a política de mascaramento de dados de um banco de dados SQL do Azure.
...
### Exemplo 1: Obter a política de mascaramento de dados para um banco de dados SQL do Azure
```
...
Esse comando obtém a política de mascaramento de dados do banco de dados Database01 no grupo de recursos ResourceGroup01 no servidor Server01.
