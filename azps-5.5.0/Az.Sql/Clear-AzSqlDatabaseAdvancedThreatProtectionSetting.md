...
### Exemplo 1: Remover uma configuração avançada de proteção contra ameaças para um banco de dados
```
...
Esse comando remove as configurações avançadas de proteção contra ameaças de um banco de dados chamado Database01 no servidor chamado Server01.
