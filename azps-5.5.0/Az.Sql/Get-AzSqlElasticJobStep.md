...
## Descrição
O Get-AzSqlElasticJobStep cmdlet obtém uma ou mais etapas de trabalho de um trabalho

## Exemplos

### Exemplo 1: Obtém uma etapa de trabalho de um trabalho
```powershell
...
Obtém uma etapa de trabalho de um trabalho
