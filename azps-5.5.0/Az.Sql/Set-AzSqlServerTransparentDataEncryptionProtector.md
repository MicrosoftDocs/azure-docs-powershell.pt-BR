...
## Sinopse
Define a criptografia de dados transparentes (TDE) para um servidor SQL.
...
## Descrição
O Set-AzSqlServerTransparentDataEncryptionProtector cmdlet define o TDE para um servidor SQL.
Alterar o tipo de ressarção TDE girará a seta.
...
Esse comando atualiza o tipo de TDE de um servidor para a Service Managed.
...
Este comando atualiza um servidor para usar a Chave do Cofre de Chave do Servidor com Id https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ' como o TDE.
ResourceGroupName ServerName Type ServerKeyVaultKeyName
----------------- ----------                   ---- ---------------------
...
### -Tipo
O tipo de banco de dados TDE do Azure Sql.
