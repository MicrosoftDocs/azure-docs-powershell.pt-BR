...
## Sinopse
Obtém a criptografia de dados transparente (TDE) para uma instância gerenciada pelo SQL.
...
## Descrição
O Get-AzSqlInstanceTransparentDataEncryptionProtector cmdlet obtém o TDE para a instância gerenciada pelo SQL especificada.
...
Esse comando obtém o comando TDE para a instância gerenciada chamada ContosoManagedInstanceName no grupo de recursos chamado ContosoResourceGroup.
