...
## Sinopse
Desabilita a autenticação somente do Azure AD para uma Instância Gerenciada do SQL específica.
...
Esse comando desabilita o requisito somente de autenticação do Azure Active Directory (Azure AD) para uma Instância Gerenciada do AzureSQL chamada ManagedInstance01 associada a um grupo de recursos chamado ResourceGroup01.
...
### -NomedaE ocorrência
O nome da Instância Gerenciada do SQL do Azure na qual a autenticação somente do Azure Active Directory está.
