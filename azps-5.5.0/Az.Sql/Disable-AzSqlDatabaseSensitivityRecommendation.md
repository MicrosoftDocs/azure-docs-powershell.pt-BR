...
### Exemplo 1: Desabilitar recomendações de sensibilidade em uma determinada coluna em um banco de dados SQL do Azure.
```powershell
...
### Exemplo 2: Desabilitar recomendações de sensibilidade em colunas que têm recomendações de sensibilidade em um banco de dados SQL do Azure usando o Piping.
```powershell
...
### Exemplo 3: Desabilitar recomendações de sensibilidade em uma determinada coluna em um banco de dados SQL do Azure usando o Piping.
```powershell
...
### -InputObject
Um objeto que representa uma Classificação de Sensibilidade do Banco de Dados SQL.
