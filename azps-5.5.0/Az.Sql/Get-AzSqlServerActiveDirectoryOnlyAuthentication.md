...
## Sinopse
Obtém a autenticação somente do Azure AD para um SQL Server específico.
...
## Descrição
O cmdlet **Get-AzSqlServerActiveDirectoryOnlyAuthentication obtém** o requisito de autenticação somente do Azure Active Directory (Azure AD) para um AzureSQL Server na assinatura atual.
...
Esse comando obtém o requisito de autenticação somente do Azure Active Directory (Azure AD) para um servidor AzureSQL chamado Server01 associado a um grupo de recursos chamado ResourceGroup01.
