...
## Sinopse
Cria uma Regra de Rede Virtual do Azure SQL Server. 
...
## Descrição
Cria uma Regra de Rede Virtual do Azure SQL Server. As Regras de Rede Virtual são usadas para conectar o SQL Server do Azure a uma Rede Virtual específica, a fim de restringir o acesso no SQL Server do Azure para estar disponível apenas na Rede Virtual. 
...
Nome da regra de rede virtual do Azure Sql Server.
...
A ID da Sub-rede de Rede Virtual que especifica os detalhes da Rede.Microsoft
