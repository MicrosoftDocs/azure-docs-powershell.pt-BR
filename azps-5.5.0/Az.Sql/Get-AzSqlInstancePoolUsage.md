...
## Sinopse
Retorna informações sobre o uso de um pool de Instância SQL do Azure.
...
## Descrição
O cmdlet **Get-AzSqlInstancePoolUsage** retorna informações sobre o uso de um pool de instância SQL do Azure.

## Exemplos

### Exemplo 1: obtém o uso de um pool de Instância SQL do Azure
```powershell
...
Obtém o uso das instâncias de pool sql do Azure SQL Instance0.

### Exemplo 2: obtém o uso de um pool de Instância SQL do Azure usando um objeto de pool de instâncias
```powershell
...
Obtém o uso do pool de instâncias sql do Azure usando um objeto de pool de instâncias.

### Exemplo 3: obtém o uso de um pool de Instância SQL do Azure usando uma ID de recurso de pool de instâncias
```powershell
...
Obtém o uso do pool de instâncias SQL do Azure usando um identificador de recurso de pool de instâncias.

### Exemplo 3: Obtém o uso de um pool de Instância SQL do Azure com uma divisão dos usos de instância gerenciada dentro do pool.
```powershell
...
Obtém o uso do pool de instâncias sql do Azure, juntamente com os usos das instâncias gerenciadas em instâncias0.
...
### -ExpandChildren
Sinalizador indicando se você quer expandir o uso desse pool de instâncias com o uso de seus filhos.
...
### -InstancePool
O objeto de pool de instância pai.
...
### -Nome
O nome do pool de instâncias gerenciada.
