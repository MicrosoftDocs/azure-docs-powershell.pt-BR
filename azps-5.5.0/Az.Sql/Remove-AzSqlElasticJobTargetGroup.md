...
## Descrição
O Remove-AzSqlElasticJobTargetGroup cmdlet remove um grupo de destino e seus destinos
...
Remove um grupo de destino e seus destinos
...
### -ResourceId
A ID do recurso de grupo de destino
