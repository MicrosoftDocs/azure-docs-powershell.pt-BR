...
## Sinopse
Atualiza o status de execução automática de um Azure SQL Elastic Pool Advisor.
...
## Descrição
O cmdlet **Set-AzSqlElasticPoolAdvisorAutoExecuteStatus** define a propriedade de execução automática para um Azure SQL Elastic Pool Advisor.
...
Esse comando define o status de execução automática de um consultor chamado CreateIndex para habilitado.

## Parâmetros

### -AdvisorName
Especifica o nome do consultor para o qual este cmdlet atualiza o status de execução automática.
...
### -AutoExecuteStatus
Especifica um novo valor ao qual este cmdlet atualiza o status de execução automática.
...
## Notas
* Palavras-chave: azure, azurerm, arm, resource, management, manager, sql, elastic pool, mssql, advisor
