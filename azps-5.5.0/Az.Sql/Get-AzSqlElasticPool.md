...
## Sinopse
Obtém pools elásticas e seus valores de propriedade em um banco de dados SQL do Azure.
...
Esse comando obtém todos os pools elásticas no servidor chamado Server01.
...
Esse comando obtém o pool elástica chamado ElasticPool0127 no servidor chamado Server01.

### Exemplo 3: Obter métricas para um Pool de Banco de Dados Elástica SQL do Azure
```
...
Esse comando retorna métricas para um pool de banco de dados elástica SQL do Azure chamado ElasticPool01.
...
Esse comando obtém todos os pools elásticas no servidor chamado Server01 que começam com "ElasticPool".
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém o pool elástica que este cmdlet obtém.
...
### -ServerName
Especifica o nome do servidor que contém o pool elástica que este cmdlet obtém.
