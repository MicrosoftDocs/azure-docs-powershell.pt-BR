...
## Descrição
O Set-AzSqlDatabaseSensitivityClassification cmdlet define os tipos de informações e rótulos de sensibilidade das colunas no banco de dados.

## Exemplos

### Exemplo 1: Definir o tipo de informações e o rótulo de sensibilidade de uma coluna em um banco de dados SQL do Azure.
```powershell
...
### Exemplo 3: Definir o tipo de informações e o rótulo de sensibilidade de uma coluna em um banco de dados SQL do Azure, usando piping.
```powershell
