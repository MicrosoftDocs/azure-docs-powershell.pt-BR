...
## Sinopse
Atualiza um Grupo de Sincronização de Banco de Dados SQL do Azure.
...
## Descrição
O cmdlet **Update-AzSqlSyncGroup** modifica as propriedades de um Grupo de Sincronização de Banco de Dados SQL do Azure.
...
Se você quer usar uma conexão de link particular ao se conectar ao hub deste grupo de sincronização.
