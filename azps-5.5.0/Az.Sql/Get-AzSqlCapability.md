...
## Descrição
O cmdlet **Get-AzSqlCapability** obtém os recursos do Banco de Dados SQL do Azure disponíveis na assinatura atual de uma região.
Se você especificar os parâmetros *ServerVersionName,* *EditionName* ou *ServiceObjectiveName,* esse cmdlet retornará os valores especificados e suas predecessoras.
...
### -Padrões
Indica que esse cmdlet recebe apenas padrões.
