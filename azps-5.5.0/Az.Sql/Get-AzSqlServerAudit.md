...
## Sinopse
Obtém as configurações de auditoria de um servidor SQL do Azure.
...
## Descrição
O cmdlet **Get-AzSqlServerAudit obtém** as configurações de auditoria de um servidor SQL do Azure.
*Especifique os parâmetros ResourceGroupName* e *ServerName* para identificar o servidor.

## Exemplos

### Exemplo 1: Obter as configurações de auditoria de um servidor SQL do Azure
```
...
### Exemplo 2: Obter, por meio do pipeline, as configurações de auditoria de um servidor SQL do Azure
```
...
### Exemplo 3: Obter as configurações de auditoria de um servidor SQL do Azure
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
