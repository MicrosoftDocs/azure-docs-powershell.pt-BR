...
### Exemplo 1: Obtém uma ou mais execuções de destino de trabalho a partir de execuções de um trabalho
```powershell
...
### Exemplo 2: Obtém uma ou mais execuções de destino de trabalho a partir de execuções de um trabalho - filtragem por nome da etapa
```powershell
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
...
### -Contagem
Contagem retorna o número superior de execuções.
