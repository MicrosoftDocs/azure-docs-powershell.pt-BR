...
## Sinopse
Atualiza um agente de trabalho elástica
...
## Descrição
O Set-AzSqlElasticJobAgent cmdlet atualiza os agentes de Trabalho Elástica
...
### -Tag
As marcas a associar ao Agente de Banco de Dados SQL do Azure
