...
## Sinopse
Remove um banco de dados de Instância Gerenciada do SQL do Azure.
...
### -InputObject
O objeto Banco de Dados de Instância a ser removido
...
### -ResourceId
A ID do recurso do objeto Banco de Dados de Instância para remover
