...
## Sinopse
Interrompe uma sincronização de grupo de sincronização.
...
## Descrição
O cmdlet **Stop-AzSqlSyncGroupSync** interrompe uma sincronização de grupo de sincronização.
...
Esse comando interrompe a sincronização que está em andamento para o mysg do grupo de sincronização.
...
### -PassThru
Define se o grupo de sincronização deve retornar
