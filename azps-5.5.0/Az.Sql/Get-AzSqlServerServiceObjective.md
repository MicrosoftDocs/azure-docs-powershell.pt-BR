...
Esse comando obtém os objetivos de serviço para o servidor chamado Server01.
...
Esse comando obtém os objetivos de serviço do servidor chamado Server01 que começam com "Sistema".
...
Esse comando obtém os objetivos de serviço de uma região especificada do Azure.
...
### -ServerName
Especifica o nome de um servidor de banco de dados SQL Database.
...
Os valores aceitáveis para este parâmetro são: Básico, S0, S1, S2, P1, P2 e P3.
