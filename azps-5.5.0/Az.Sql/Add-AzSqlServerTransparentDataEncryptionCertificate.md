...
## Sinopse
Adiciona um Certificado de Criptografia de Dados Transparentes para uma determinada instância do SQL Server
...
## Descrição
A Add-AzSqlManagedInstanceTransparentDataEncryptionCertificate adiciona um Certificado de Criptografia de Dados Transparentes para uma determinada instância do SQL Server
