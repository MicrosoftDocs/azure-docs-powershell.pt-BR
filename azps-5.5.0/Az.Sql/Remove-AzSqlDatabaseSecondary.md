...
## Sinopse
Termina a replicação de dados entre um banco de dados SQL e o banco de dados secundário especificado.
...
Não há sincronização de replicação antes da rescisão.
