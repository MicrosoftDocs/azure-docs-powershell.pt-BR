...
## Sinopse
Obtém uma política de backup do banco de dados.
...
## Descrição
O cmdlet **Get-AzSqlDatabaseGeoBackupPolicy obtém** a política de backup geo registrada nesse banco de dados.
...
Obtém uma política de backup do banco de dados. (gerado automaticamente)
