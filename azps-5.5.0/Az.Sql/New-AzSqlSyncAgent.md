...
## Sinopse
Cria um Agente de Sincronização SQL do Azure.
...
## Descrição
O cmdlet **New-AzSqlSyncAgent cria** um Agente de Sincronização SQL do Azure.

## Exemplos

### Exemplo 1: Criar um agente de sincronização para um servidor SQL do Azure.
```
...
Esse comando cria um agente de sincronização para um servidor SQL do Azure.
...
### -SyncDatabaseResourceID
A ID do recurso do banco de dados de sincronização de metadados.
