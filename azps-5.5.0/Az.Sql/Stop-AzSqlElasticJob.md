...
## Sinopse
Interrompe um trabalho com a ID de execução de trabalho
...
## Descrição
O Stop-AzSqlElasticJob cmdlet interrompe um trabalho com uma execução em execução.
...
Interrompe uma execução de trabalho em execução e retorna seu status atual
