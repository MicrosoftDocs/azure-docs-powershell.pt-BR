...
## Descrição
O New-AzSqlElasticJob cmdlet cria um novo trabalho
...
### -Habilitar
O sinalizador para indicar que o cliente quer que esse trabalho seja habilitado.
...
### -EndTime
Hora de término do cronograma de trabalho
...
### -StartTime
A hora de início do cronograma de trabalho
