...
## Sinopse
Cancela a operação assíncrona de atualizações no banco de dados.
...
### Exemplo 1: Cancelar a operação assíncrona de atualizações no banco de dados
```
...
Esse comando cancela a operação assíncrona de atualizações no banco de dados.
