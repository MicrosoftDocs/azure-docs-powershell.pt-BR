...
## Descrição
O Disable-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet desabilita (descarta) recomendações de sensibilidade em colunas no banco de dados de instância gerenciada do Azure SQL.
...
### Exemplo 2: Desabilitar recomendações de sensibilidade em colunas que têm recomendações de sensibilidade em um banco de dados de instância gerenciada do Azure SQL com Piping.
```powershell
