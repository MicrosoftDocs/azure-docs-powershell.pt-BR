...
### -RemoveOutput
O sinalizador para indicar se você deve remover a saída
...
### -RetryAttempts
Os attemps de tentar novamente
...
O multiplicador de backoff do intervalo de tentativa
