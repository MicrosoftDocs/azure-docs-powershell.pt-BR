...
## Sinopse
Remove o alias DNS do Azure SQL Server.
...
## Descrição
Esses comandos removem o Alias DNS do SQL Server do Azure do servidor, deixando o servidor intacto.
...
Remove o Alias DNS do Azure SQL Server com o nome aliasName do servidor com o nome serverName
...
### -Nome
Nome de alias dns do Azure Sql Server
...
### -ResourceId
A ID do recurso do objeto Alias dns do servidor a ser removido
