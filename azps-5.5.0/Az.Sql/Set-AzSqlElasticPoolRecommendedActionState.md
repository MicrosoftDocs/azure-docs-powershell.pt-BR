...
## Sinopse
Atualiza o estado de uma ação recomendada do Pool Elástica SQL do Azure.
...
## Descrição
O cmdlet **Set-AzSqlElasticPoolRecom recommendedActionAState** atualiza o estado de uma ação recomendada do Pool Elástico SQL do Azure.
Esse cmdlet aplica uma ação recomendada, revertida ou descartada com base no novo estado.
...
Este comando atualiza o estado da ação recomendada para pool elástica chamada IR_ \[ test_schema \] _ \[ test_table_0.0361551 \] _6C7AE8CC9C87E7FD5893 pendente.
...
### -Estado
Especifica o valor ao qual este cmdlet atualiza o estado de ação recomendado.
