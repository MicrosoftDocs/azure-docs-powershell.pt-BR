...
## Sinopse
Atualiza o estado de uma ação recomendada do SQL Server do Azure.
...
## Descrição
O cmdlet **Set-AzSqlServerRecom recommendedActionAstate** atualiza o estado de uma ação recomendada do Azure SQL Server.
Este cmdlet aplica, reverte ou descarta a ação recomendada com base no novo estado.

## Exemplos

### Exemplo1: Atualizar o estado da ação recomendada especificada para Pendente
```
...
Atualiza o estado da ação recomendada do servidor chamada "IR_ \[ test_schema \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893" como \] "Pendente"

## Parâmetros

### -AdvisorName
Especifica o nome do consultor que contém a ação recomendada.
...
Especifica o nome da ação recomendada para a qual este cmdlet atualiza o estado.
...
### Microsoft.Azure.Commands.Sql.RecommendedAction.Model.AzureSqlServerRecom recommendedActionModel
