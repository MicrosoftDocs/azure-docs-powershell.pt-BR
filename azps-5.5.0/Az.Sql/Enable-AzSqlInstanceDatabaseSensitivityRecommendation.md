...
## Sinopse
Habilita recomendações de sensibilidade em colunas (as recomendações são habilitadas por padrão em todas as colunas) no banco de dados de instância gerenciada do Azure SQL.
...
## Descrição
O Enable-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet permite recomendações de sensibilidade em colunas no banco de dados de instância gerenciada do Azure SQL.

## Exemplos

### Exemplo 1: Habilitar recomendações de sensibilidade em uma determinada coluna em um banco de dados de instância gerenciada do Azure SQL.
```powershell
...
### Exemplo 2: Habilitar recomendações de sensibilidade em uma determinada coluna em um banco de dados de instância gerenciado pelo SQL do Azure com Piping.
```powershell
...
### -InputObject
Um objeto que representa uma Classificação de Sensibilidade do Banco de Dados de Instância Gerenciada do SQL.
...
### -PassThru
Especifica se o modelo de classificação de sensibilidade será saída no final da execução do cmdlet
