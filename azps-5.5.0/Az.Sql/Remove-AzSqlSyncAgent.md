...
## Sinopse
Remove um Agente de Sincronização SQL do Azure.
...
## Descrição
O cmdlet **Remove-AzSqlSyncAgent** remove um Agente de Sincronização SQL do Azure.

## Exemplos

### Exemplo 1: Remover um agente de sincronização
```
PS C:\>Remove-AzSqlSyncAgent -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -Name "syncAgent01"
```

Esse comando remove o Agente de Sincronização SQL do Azure chamado syncAgent01.
...
### -PassThru
Define se retorna o agente de sincronização removido
...
### -ServerName
O nome do SQL Server do Azure em que o agente de sincronização está.
