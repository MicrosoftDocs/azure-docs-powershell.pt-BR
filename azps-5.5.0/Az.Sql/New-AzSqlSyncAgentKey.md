...
## Sinopse
Cria uma Chave do Agente de Sincronização SQL do Azure.
...
## Descrição
O **cmdlet New-AzSqlSyncAgentKey** cria uma tecla do Azure SQL Sync Agent.

## Exemplos

### Exemplo 1: Criar uma chave de agente de sincronização para um agente de sincronização SQL do Azure.
```
PS C:\> New-AzSqlSyncAgentKey -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -SyncAgentName "SyncAgent01"
SyncAgentKey                  : Key
```

Esse comando cria uma chave do agente de sincronização para um Agente de Sincronização SQL do Azure.
