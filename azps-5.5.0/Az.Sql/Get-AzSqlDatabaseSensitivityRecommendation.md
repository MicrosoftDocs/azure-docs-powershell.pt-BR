...
## Sinopse
Obtém os tipos de informações recomendados e os rótulos de sensibilidade das colunas no banco de dados.
...
## Descrição
O Get-AzSqlDatabaseSensitivityRecommendation cmdlet retorna os tipos de informações recomendados e rótulos de sensibilidade de colunas no banco de dados.
...
### Exemplo 2: Obter tipos de informações recomendadas e rótulos de sensibilidade de um banco de dados SQL do Azure usando o Piping.
```powershell
