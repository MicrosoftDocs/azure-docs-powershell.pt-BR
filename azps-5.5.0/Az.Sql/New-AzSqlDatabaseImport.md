...
A solicitação de status de importação do banco de dados pode ser enviada para recuperar informações de status dessa solicitação.
...
Esse parâmetro será padrão para SQL se nenhum tipo de autenticação for definido.
Os valores aceitáveis para este parâmetro são:
- Sql.
Autenticação SQL.
De definir os *parâmetros AdministratorLogin* *e AdministratorLoginPassword* para o nome de usuário e a senha do administrador sql. 
- ADPassword.
Autenticação do Azure Active Directory.
De *configurar o AdministratorLogin* *e o AdministratorLoginPassword para* o nome de usuário e a senha do administrador do Azure Active Directory.
...
### -Edição
Especifica a edição do novo banco de dados para o que importar.
Os valores aceitáveis para este parâmetro são:
- Premium
- Basic
- Padrão
...
Especifica o nome do objetivo do serviço a ser atribuído ao Banco de Dados SQL do Azure.
...
- SharedAccessKey.
Usa a tecla SAS (Assinatura de Acesso Compartilhado).
