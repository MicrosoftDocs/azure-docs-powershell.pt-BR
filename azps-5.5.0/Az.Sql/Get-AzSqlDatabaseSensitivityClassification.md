...
## Sinopse
Obtém os tipos de informações atuais e os rótulos de sensibilidade das colunas no banco de dados.
...
## Descrição
O Get-AzSqlDatabaseSensitivityClassification cmdlet retorna os tipos de informações atuais e os rótulos de sensibilidade das colunas no banco de dados SQL do Azure.
...
### Exemplo 2: Obter tipos de informações atuais e rótulos de sensibilidade de um banco de dados SQL do Azure com Piping.
```powershell
...
### Exemplo 3: Obter o tipo de informação atual e o rótulo de sensibilidade de uma coluna específica de um banco de dados SQL do Azure.
```powershell
...
### Exemplo 4: Obter o tipo de informação atual e o rótulo de sensibilidade de uma coluna específica de um banco de dados SQL do Azure usando o Piping.
```powershell
