...
## Sinopse
Restaura um banco de dados de Instância Gerenciada do SQL do Azure.
...
## Descrição
O cmdlet **Restore-AzSqlInstanceDatabase** restaura um banco de dados de instância de um backup geo-redundante, um ponto no tempo em um banco de dados ao vivo ou um backup de retenção a longo prazo.
...
O comando restaura o banco de dados de instância Database01 na instância managedInstance1 no grupo de recursos ResourceGroup01 do backup de ponto em tempo especificado para o banco de dados de instância chamado Database01_restored on instance managedInstance2 no grupo de recursos ResourceGroup02.
...
O segundo comando restaura o backup no $GeoBackup para o banco de dados de instância chamado Database01_restored.
...
O segundo comando restaura o banco de dados buscado, do backup de ponto em tempo especificado para o banco de dados de instância chamado Database01_restored.
...
O primeiro comando obtém os bancos de dados de instância excluídos chamados 'DB1' na Instância 'managedInstance1'.
O segundo comando restaura o banco de dados buscado, do backup de ponto em tempo especificado para o banco de dados de instância chamado Database01_restored usando objeto de entrada.

### Exemplo 6: Restaurar um banco de dados a partir do backup do LTR.
```
...
Restaura o backup do LTR com a ID de recurso determinada (que pode ser encontrada executando Get-AzSqlInstanceDatabaseLongTermRetentionBackup).
...
### -FromGeoBackup
Restaurar a partir de um backup geo.
...
Restaurar a partir de um backup de Retenção a Longo Prazo.
...
### -GeoBackupObject
O objeto de banco de dados de instância recuperável para restaurar
...
### -InputObject
O objeto Banco de Dados de Instância para restaurar
...
### -PointInTime
O ponto a tempo para restaurar o banco de dados.
...
### -ResourceId
A ID do recurso do objeto Banco de Dados de Instância para restaurar
...
O nome do banco de dados de instância de destino para o que restaurar.
...
Se não especificado, a instância de destino é a mesma que a instância de origem.
...
O nome do grupo de recursos de destino para o que restaurar.
Se não especificado, o grupo de recursos de destino será o mesmo que o grupo de recursos de origem.
