...
## Sinopse
Recebe uma ou mais execuções de trabalho
...
## Descrição
O Get-AzSqlElasticJobExecution cmdlet recebe uma ou mais execuções de trabalho
...
Recebe uma ou mais execuções de trabalho. (gerado automaticamente)
