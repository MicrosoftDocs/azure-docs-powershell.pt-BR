...
## Sinopse
Adiciona uma chave do Cofre de Teclas a um servidor SQL.
...
## Descrição
O cmdlet Add-AzSqlServerKeyVaultKey adiciona uma chave do Cofre de Teclas ao servidor SQL fornecido.
O servidor deve ter permissões 'get, wrapKey, unwrapKey' para o cofre.

## Exemplos

### Exemplo 1: Adicionar chave do Cofre de Teclas
```
...
Esse comando adiciona a chave do Cofre de Teclas com Id ' ao servidor SQL chamado 'ContosoServer' no grupo de recursos https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 'ContosoResourceGroup'.
