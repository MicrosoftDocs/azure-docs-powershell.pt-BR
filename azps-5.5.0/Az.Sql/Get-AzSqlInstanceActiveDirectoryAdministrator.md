...
## Sinopse
Obtém informações sobre um administrador do Azure AD para instância gerenciada pelo SQL.
...
Esse comando obtém informações sobre um administrador do Azure AD para uma instância gerenciada chamada ManagedInstance01 associada a um grupo de recursos chamado ResourceGroup01.
...
Esse comando obtém informações sobre um administrador do Azure AD de um objeto de instância gerenciado.
...
Esse comando obtém informações sobre um administrador do Azure AD usando o identificador de recurso de instância gerenciada.
