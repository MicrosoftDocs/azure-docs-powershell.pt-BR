...
## Descrição
O cmdlet **Remove-AzSqlDatabaseDataMaskingRule** remove uma regra específica de mascaramento de dados de um banco de dados SQL do Azure.
Você pode remover uma regra de mascaramento de dados usando os parâmetros *ResourceGroupName,* *ServerName,* *DatabaseName* e *RuleId* para identificar a regra que este cmdlet remove.
...
Esse comando remove o nome da regra Rule01 definido para o Banco de Dados de Banco de Dados01.
