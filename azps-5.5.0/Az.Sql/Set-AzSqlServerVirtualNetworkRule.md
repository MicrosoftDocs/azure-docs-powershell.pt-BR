...
## Sinopse
Modifica a configuração de uma Regra de Rede Virtual do SQL Server do Azure.
...
Modifica uma regra de rede virtual existente com a nova ID da sub-rede virtual que contém informações sobre a nova rede virtual
...
A ID da Sub-rede de Rede Virtual para a regra.
