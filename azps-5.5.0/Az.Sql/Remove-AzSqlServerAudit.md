...
## Sinopse
Remove as configurações de auditoria de um servidor SQL do Azure.
...
## Descrição
O cmdlet **Remove-AzSqlServerAudit** remove as configurações de auditoria de um servidor SQL do Azure.
*Especifique os parâmetros ResourceGroupName* e *ServerName* para identificar o servidor.

## Exemplos

### Exemplo 1: Remover as configurações de auditoria de um servidor SQL do Azure
```
PS C:\>Remove-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
```

### Exemplo 2: Remover, por meio de pipeline, as configurações de auditoria de um servidor SQL do Azure
```
