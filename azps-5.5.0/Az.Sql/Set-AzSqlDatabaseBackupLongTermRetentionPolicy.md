...
Isso define a política de retenção de longo prazo do banco de dados01 para salvar todos os backups semanais completos por duas semanas
...
Isso define a política de retenção de longo prazo do banco de dados01 para salvar o primeiro backup completo de cada mês por 5 anos
...
Isso define a política de retenção de longo prazo do banco de dados01 para salvar o backup completo feito na 26ª semana do ano por 10 anos
...
Isso define a política de retenção de longo prazo do banco de dados01 para salvar cada backup completo por 14 dias, o primeiro backup completo de cada mês por 24 semanas e o backup completo feito na 26ª semana do ano por 10 anos
...
Remove a política do banco de dados01 para que ela não salve mais os backups de retenção de longo prazo.
...
Essa é outra maneira de remover a política do banco de dados01 para que ela não salve mais os backups de retenção de longo prazo.
Isso não afetará os backups que já foram feitos
...
### -RemovePolicy
Se fornecido, a política do banco de dados será removida.
