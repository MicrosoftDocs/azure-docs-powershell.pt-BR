...
## Sinopse
Failovers de uma Instância Gerenciada do SQL do Azure.
...
## Descrição
O cmdlet **Invoke-AzSqlInstanceFailover** failovers an Azure SQL Managed Instance.
...
Esse comando fará failover na réplica principal da instância chamada "ManagedInstance01".
...
Esse comando falhará na replica secundária acessível da instância gerenciada "ManagedInstance01".
...
### -Nome
O nome da instância SQL do Azure a ser removido.
...
### -ReadableSecondary
Failover a replica secundária acessível em vez da réplica primária padrão
