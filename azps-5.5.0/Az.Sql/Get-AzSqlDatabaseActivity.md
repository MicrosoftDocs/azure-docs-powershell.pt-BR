...
### Exemplo 1: Obter status para todas as instâncias do banco de dados SQL
```
PS C:\>Get-AzSqlDatabaseActivity -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

Esse comando retorna o status da operação de todas as instâncias do banco de dados SQL em um pool elástica chamado ElasticPool01.

### Exemplo 2: Obter status para todas as operações de banco de dados SQL
```
