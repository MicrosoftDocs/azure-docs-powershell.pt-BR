...
## Descrição
Esse comando remove o Grupo de Failover de Instância com o nome especificado, deixando todos os bancos de dados intactos. O ponto de extremidade do ouvinte será não registro do DNS.
...
### -InputObject
O objeto Grupo de Failover de Instância para remover
...
### -PassThru
Especifica se você deve passar pela saída de execução do cmdlet.
