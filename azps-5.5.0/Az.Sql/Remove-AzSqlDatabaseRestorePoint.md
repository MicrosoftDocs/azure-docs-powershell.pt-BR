...
## Descrição
O cmdlet **Remove-AzSqlDatabaseRestorePoint** remove determinado ponto de restauração do banco de dados SQL do Azure.
Este cmdlet tem suporte no momento pelo serviço SQL Server Datawarehouse no Banco de Dados SQL do Azure.
...
Esse comando remove um ponto de restauração do banco de dados SQL do Azure de acordo com a data de criação.
