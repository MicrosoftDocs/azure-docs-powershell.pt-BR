...
## Descrição
O cmdlet **New-AzSqlDatabaseSecondary** substitui o cmdlet Start-AzSqlDatabaseCopy quando usado para configurar a replicação geográfica de um banco de dados. Ele retorna o objeto de vínculo de replicação geográfica do principal para o banco de dados secundário.

## Exemplos

### Exemplo 1: Estabeleça um Geo-Replication
```powershell
$database = Get-AzSqlDatabase -DatabaseName $databasename -ResourceGroupName $primaryresourcegroupname -ServerName $primaryservername
$database | New-AzSqlDatabaseSecondary -PartnerResourceGroupName $secondaryresourcegroupname -PartnerServerName $secondaryservername -AllowConnections "All"
```

### Exemplo 2: Estabeleça o active Geo-Replication e especifique o nome do banco de dados do parceiro para ser diferente do nome do banco de dados de origem
```powershell
$database = Get-AzSqlDatabase -DatabaseName $databasename -ResourceGroupName $primaryresourcegroupname -ServerName $primaryservername
...
Especifica o nome do banco de dados para atuar como principal.
...
Especifica o nome do pool elástica no qual se coloca o banco de dados secundário.
...
### -ServerName
Especifica o nome do SQL Server do banco de dados SQL principal.
...
### -Marcas
Especifica os pares de valor-chave na forma de uma tabela hash para associar ao link de replicação do banco de dados SQL. Por exemplo: @{key0="value0";key1=$null;key2="value2"}
