...
## Descrição
O cmdlet **Remove-AzSqlServerCommunicationLink** exclui um link de comunicação de servidor para servidor para transações de banco de dados elásticas no Banco de Dados SQL do Azure.
...
Esse comando exclui um link de comunicação de servidor para servidor chamado Link01 no ContosoServer17.
...
Este servidor contém o link de comunicação que este cmdlet exclui.
