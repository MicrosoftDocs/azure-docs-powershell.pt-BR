...
## Sinopse
Cria um pool de Instância SQL do Azure.
...
## Descrição
O cmdlet **New-AzSqlInstancePool cria** um pool de Instância SQL do Azure.
...
Esse comando cria um novo pool de Instância SQL do Azure.
...
### -ComputeGeneration
A geração de cálculo para o pool de instâncias.
...
### -Sub-RedeId
A ID da sub-rede a ser usada para a criação de pool de instâncias.
