...
## Descrição
O cmdlet **Disable-AzSqlInstanceAdvancedDataSecurity** desabilita a Segurança de Dados Avançada em uma instância gerenciada.

## Exemplos

### Exemplo 1 - Desabilitar a segurança de dados avançada da instância gerenciada
```powershell
...
### Exemplo 2 - Desabilitar a Segurança de Dados Avançada do servidor do recurso de instância gerenciada
```powershell
