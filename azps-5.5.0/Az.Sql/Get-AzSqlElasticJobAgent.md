...
## Sinopse
Obtém um agente de Trabalho Elástica SQL do Azure
...
## Descrição
O cmdlet Get-AzSqlElasticJobAgent obtém um ou mais agentes de Trabalho Elástica
...
Obtém um agente de Trabalho Elástica
