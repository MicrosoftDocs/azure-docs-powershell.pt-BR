...
## Sinopse
Retorna informações sobre membros de sincronização de banco de dados SQL do Azure.
...
## Descrição
O cmdlet **Get-AzSqlSyncMember** retorna informações sobre um ou mais Membros de Sincronização de Banco de Dados SQL do Azure.
Especifique o nome de um membro de sincronização para ver informações apenas para esse membro de sincronização.

## Exemplos

### Exemplo 1: Obter todas as instâncias do Membro de Sincronização SQL do Azure atribuídas a um grupo de sincronização
```
...
Esse comando obtém informações sobre todos os Membros de Sincronização de Banco de Dados SQL do Azure atribuídos ao grupo de sincronização SyncGroup01.
...
Este comando obtém informações sobre o Membro de Sincronização de Banco de Dados SQL do Azure com o nome "SyncMember01"

### Exemplo 3: Obter todas as instâncias do Membro de Sincronização SQL do Azure atribuídas a um grupo de sincronização usando filtragem
```
...
Esse comando obtém informações sobre todos os Membros de Sincronização de Banco de Dados SQL do Azure atribuídos ao grupo de sincronização SyncGroup01 que começam com "SyncMember".
