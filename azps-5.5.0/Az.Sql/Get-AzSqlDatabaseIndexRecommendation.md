...
## Descrição
O cmdlet **Get-AzSqlDatabaseIndexRecommendation obtém** as operações de índice recomendadas para um servidor ou banco de dados SQL do Azure.
...
Esse comando retorna recomendações de índice para todos os bancos de dados no servidor01.
...
### Exemplo 3: obter uma recomendação de índice único por nome
```
PS C:\>Get-AzSqlDatabaseIndexRecommendation -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01" -IndexRecommendationName "INDEX_NAME"
```

Esse comando retorna uma recomendação de índice único por nome.

## Parâmetros

### -Nomedo Banco de Dados
Especifica o nome do banco de dados para o qual este cmdlet recebe recomendações de índice.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos para o que o servidor está atribuído.
Este cmdlet obtém recomendações de índice para um banco de dados hospedado por este servidor.
...
### -ServerName
Especifica o servidor que hospeda o banco de dados para o qual este cmdlet recebe recomendações de índice.
