...
## Sinopse
Exclui um pool de banco de dados elástica.
...
## Descrição
O cmdlet **Remove-AzSqlElasticPool** exclui um pool elástica do banco de dados SQL do Azure.

## Exemplos

### Exemplo 1: Excluir um pool elástica
```
PS C:\>Remove-AzSqlElasticPool -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

Esse comando exclui um pool elástica chamado ElasticPool01.
...
### -ElasticPoolName
Especifica o nome do pool elástica que este cmdlet exclui.
