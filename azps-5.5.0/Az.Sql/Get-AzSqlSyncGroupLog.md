...
### Exemplo 1: Obter os logs de um Grupo de Sincronização SQL do Azure
```
...
Esse comando obtém os logs de um Grupo de Sincronização SQL do Azure.
...
### -LogLevel
O tipo de logs para consulta.
Os valores válidos são: 'Erro', 'Aviso', 'Sucesso' e 'Tudo'.
