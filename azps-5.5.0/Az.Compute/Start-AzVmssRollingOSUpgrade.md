...
## Sinopse
Inicia uma atualização em implantação para mover todas as instâncias de conjunto de escala de máquina virtual para a versão mais recente do sistema operacional de imagem da plataforma disponível.
...
## Descrição
Inicia uma atualização em implantação para mover todas as instâncias de conjunto de escala de máquina virtual para a versão mais recente do sistema operacional de imagem da plataforma disponível.
As instâncias que já estão executando a versão mais recente do sistema operacional disponível não são afetadas.
...
Esse comando inicia uma atualização de rolagem de todas as instâncias vm do conjunto de escala de VM "VMSS001" no grupo de recursos "Group001".
