...
Esse comando remove o grupo de posicionamento de proximidade determinado.

### Exemplo 2

Esse comando remove o grupo de posicionamento de proximidade determinado. (gerado automaticamente)
...
### -InputObject
O Objeto de Grupo de Posicionamento de Proximidade do PS
