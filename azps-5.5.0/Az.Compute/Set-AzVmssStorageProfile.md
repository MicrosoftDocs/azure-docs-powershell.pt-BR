...
## Sinopse
Define as propriedades de perfil de armazenamento para o VMSS.
...
## Descrição
O **cmdlet Set-AzVmssStorageProfile** define as propriedades de perfil de armazenamento para o VMSS (Virtual Machine Scale Set).
...
Esse comando define as propriedades de perfil de armazenamento para o VMSS chamado ContosoVMSS.
...
Para obter o objeto, use o New-AzVmssConfig objeto.
