...
### -Descrição
A descrição do recurso Definição de imagem da galeria. 
...
### -EndOfLifeDate
A data de fim da vida útil da Galeria de Definição de Imagens
...
### -Oferta
O nome da oferta definição de imagem da galeria.
...
### -Publisher
O nome do editor definição de imagem da galeria.
