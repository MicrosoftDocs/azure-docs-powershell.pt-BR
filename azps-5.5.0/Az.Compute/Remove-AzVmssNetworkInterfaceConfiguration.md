...
## Descrição
O cmdlet **Remove-AzVmssNetworkInterfaceConfiguration** remove uma configuração de interface de rede de um VMSS (Virtual Machine Scale Set).
...
O primeiro comando obtém um VMSS usando o cmdlet Get-AzVmss e, em seguida, o armazena na variável $VMSS dados.
