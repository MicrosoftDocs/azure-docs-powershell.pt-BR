...
## Descrição
O cmdlet **Grant-AzSnapshotAccess** concede acesso a um instantâneo.
...
Conceda acesso "Leitura" ao instantâneo chamado "Instantâneo01" no grupo de recursos chamado 'ResourceGroup01' por 60 segundos.

## Parâmetros

### -Access
Especifica o nível do Access.
