...
## Sinopse
Define as propriedades da chave de criptografia em um objeto de disco.
...
## Descrição
O **cmdlet Set-AzDiskKeyEncryptionKey** define as propriedades da chave de criptografia em um objeto de disco.
