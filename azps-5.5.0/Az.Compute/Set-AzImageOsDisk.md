...
## Sinopse
Define as propriedades de disco do sistema operacional em um objeto de imagem.
...
## Descrição
O **cmdlet Set-AzImageOsDisk** define as propriedades de disco do sistema operacional em um objeto de imagem.
