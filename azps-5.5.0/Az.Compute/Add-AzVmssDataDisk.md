...
### -DiskIOPSReadWrite
Especifica o Read-Write IOPS do disco gerenciado. Deve ser usado somente quando StorageAccountType estiver UltraSSD_LRS. Se não especificado, um valor padrão seria atribuído com base no diskSizeGB.
...
### -DiskMBpsReadWrite
Especifica a largura de banda em MB por segundo para o disco gerenciado. Deve ser usado somente quando StorageAccountType estiver UltraSSD_LRS. Se não especificado, um valor padrão seria atribuído com base no diskSizeGB.
