...
## Sinopse
Modifica o estado de uma instância do VMSS.
...
## Descrição
O cmdlet **Set-AzVmsSVM** modifica o estado de uma instância do VMSS (Conjunto de Escala de Máquina Virtual).

## Exemplos

### Exemplo 1

Modifica o estado de uma instância do VMSS. (gerado automaticamente)
...
### -Reimage
Indica que esse cmdlet reimata a instância do VMSS.
...
### -ReimageAll
Indica que o cmdlet reimata todos os discos na instância VMSS.
...
Indica que esse cmdlet simula a simulação de uma máquina virtual em um conjunto de escala de VM.
A desapropriação ocorrerá dentro de 30 minutos após a chamada da API.
