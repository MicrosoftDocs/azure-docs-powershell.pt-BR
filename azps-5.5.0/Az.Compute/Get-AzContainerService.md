...
## Descrição
O **cmdlet Get-AzContainerService** obtém um serviço de contêiner.
Você pode exibir as propriedades de um serviço de contêiner, que incluem estado, número de mestres e agentes e nome de domínio totalmente qualificado de mestre e agente.
...
### Exemplo 2: Obter todos os serviços de contêineres
```
...
Este comando obtém todos os serviços de contêiner em assinatura.
...
### Exemplo 4: Obter todos os serviços de contêiner usando filtro
```
...
### -ResourceGroupName
Especifica o grupo de recursos do serviço de contêineres que este cmdlet obtém.
