...
### -DiskEncryptionSetId
Especifica a ID do recurso do conjunto de criptografia de disco que deve ser usado para habilenciar a criptografia em repouso.
...
### -Incremental
Especifica um instantâneo incremental. Instantâneos incrementais no mesmo disco ocupam menos espaço do que instantâneos completos e podem ser diferentes.
