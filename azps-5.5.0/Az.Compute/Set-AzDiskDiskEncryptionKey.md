...
## Descrição
O cmdlet **Set-AzDiskDiskEncryptionKey** define as propriedades da chave de criptografia de disco em um objeto de disco.
...
O primeiro comando cria um objeto de disco vazio local com tamanho de 5 GB Standard_LRS de armazenamento.  Ele também define o tipo do sistema operacional Windows e habilita as configurações de criptografia.
O segundo e o terceiro comandos configuram a chave de criptografia de disco e as configurações da chave de criptografia do objeto de disco.
O último comando assume o objeto de disco e cria um disco com o nome 'Disco01' no grupo de recursos 'ResourceGroup01'.
