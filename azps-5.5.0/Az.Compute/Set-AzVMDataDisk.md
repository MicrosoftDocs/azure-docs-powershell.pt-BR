...
O comando o armazena na variável $VM dados.
...
Modifica as propriedades de um disco de dados de máquina virtual. (gerado automaticamente)
...
### -DiskSizeInGB
Especifica o tamanho, em gigabytes, do disco de dados.
...
### -Ltda
Especifica o número de unidade lógica (Nº 80) do disco de dados que este cmdlet modifica.
...
### -StorageAccountType
O tipo de conta gerenciada pelo computador virtual.
...
### -VM
Especifica a máquina virtual para a qual este cmdlet modifica um disco de dados.
