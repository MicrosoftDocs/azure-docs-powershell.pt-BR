...
## Sinopse
Define as propriedades da chave de criptografia em um objeto de instantâneo.
...
## Descrição
O cmdlet **Set-AzSnapshotKeyEncryptionKey** define as propriedades da chave de criptografia em um objeto de instantâneo.
