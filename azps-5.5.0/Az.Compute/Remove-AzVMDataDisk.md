...
O segundo comando remove o disco de dados chamado Disco3 da máquina virtual armazenada no $VirtualMachine.
...
### -VM
Especifica o objeto de máquina virtual local do qual remover um disco de dados.
