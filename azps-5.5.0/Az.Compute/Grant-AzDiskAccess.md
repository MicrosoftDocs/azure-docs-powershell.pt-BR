...
## Descrição
O cmdlet **Grant-AzDiskAccess** concede acesso a um disco.
...
Conceda acesso de 'Leitura' ao disco chamado 'Disco01' no grupo de recursos chamado 'ResourceGroup01' por 60 segundos.
