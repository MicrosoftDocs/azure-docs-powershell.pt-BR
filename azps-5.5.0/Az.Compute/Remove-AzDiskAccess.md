...
### Exemplo 1: Remover Acesso a Disco usando o Conjunto de Parâmetros Padrão
```
PS C:\> Remove-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01"
```

Esse comando remove o acesso a disco chamado "DiskAccess01" no grupo de recursos "ResourceGroup01"

### Exemplo 2: Remover o Acesso a Disco usando a ID do Recurso
```
...
Esse comando remove o acesso a disco por ID do Recurso

### Exemplo 3: Remover o Acesso a Disco usando o Objeto de Entrada
```
PS C:\> $myDiskAccess = Get-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01"
PS C:\> Remove-AzDiskAccess -InputObject $myDiskAccess
```

Este comando remove o acesso a disco por InputObject

### Exemplo 4: remover o acesso ao disco por meio da canalização de objeto de entrada
```
PS C:\> Get-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01" | Remove-AzDiskAccess 
```

Este comando remove o acesso a disco por meio de uma canalização do InputObject
