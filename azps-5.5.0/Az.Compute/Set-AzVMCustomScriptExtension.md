...
### ByNameWithContainerAndFileNamesParameterSet (Padrão)
```
...
Adiciona uma extensão de script personalizada a uma máquina virtual. (gerado automaticamente)
...
### -Argumento
Especifica argumentos que a extensão de script passa para o script.
...
### -Nomedo Contêiner
Especifica o nome do contêiner de armazenamento do Azure onde este cmdlet armazena o script.
...
### -NomeDoAr arquivo
Especifica o nome do arquivo de script. Se o arquivo estiver armazenado no armazenamento do Blob do Azure, o valor do nome do arquivo será sensível ao caso. Os nomes de arquivos dos arquivos armazenados no armazenamento de arquivos do Azure não são sensíveis a minúsculas.
...
### -Executar
Especifica o comando a ser usado que executa seu script.
...
### -SecureExecution
Indica que esse cmdlet garante que  o valor do parâmetro Executar não está conectado ao servidor ou retornado ao usuário usando a API de extensão OBTER.
O valor de *Executar* pode conter segredos ou senhas a serem passados para o arquivo de script com segurança.
...
### -StorageAccountKey
Especifica a chave do contêiner de armazenamento do Azure.
...
### -StorageAccountName
Especifica o nome da conta de armazenamento do Azure onde esse cmdlet armazena o script.
...
Para obter a versão, execute o cmdlet Get-AzVMExtensionImage com um valor de Microsoft.Compute para o parâmetro *PublisherName* e CustomScriptExtension para o parâmetro *Tipo.*
...
Este cmdlet adiciona a extensão de script personalizada para a máquina virtual especificada por esse parâmetro.
