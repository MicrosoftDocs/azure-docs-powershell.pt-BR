...
### -Reimplantar
Indica que esse cmdlet reimplanta manualmente a máquina virtual para um host diferente do Azure para corrigir quaisquer problemas.
Se você reimplantar uma máquina virtual, ela será reiniciada, o que resulta na perda de dados da unidade efémémera.
...
Indica que esse cmdlet simula a simulação da máquina virtual de local.
