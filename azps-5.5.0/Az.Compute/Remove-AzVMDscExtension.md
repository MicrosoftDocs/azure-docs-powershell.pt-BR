...
Esse comando remove a extensão chamada DSC em uma máquina virtual chamada VM07.
...
O Set-AzVMDscExtension cmdlet define esse nome para Microsoft.Powershell.DSC, que é o valor padrão usado por **Remove-AzVMDscExtension.**
