...
## Descrição
Este cmdlet receberá um grupo de host.
Esse cmdlet também lista todos os grupos de host em um grupo de recursos se um nome de grupo de host não for dado.
Esse cmdlet também lista todos os grupos de host em uma assinatura se nenhum nome de grupo de host nem nome de grupo de recursos for dado.
...
Esse comando retorna um grupo de host.
...
Esse comando retorna todos os grupos de host no grupo de recursos determinado.
...
Esse comando retorna todos os grupos de host na assinatura.
...
### -InstanceView
Expanda o objeto retornado para listar também os exibições de instância do host. 
