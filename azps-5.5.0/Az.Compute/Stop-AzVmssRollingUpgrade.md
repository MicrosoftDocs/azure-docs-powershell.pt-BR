...
## Sinopse
Cancela a atualização atual em escala de máquina virtual.
...
Esse comando cancela a atualização em movimento do conjunto de escala VM "VMSS001" no grupo de recursos "Group001".
