...
O primeiro comando cria um objeto de instantâneo local com tamanho de 10 GB Premium_LRS de armazenamento.  Ele também define o tipo do sistema operacional Windows.
O segundo comando define a ID da imagem e o número da unidade lógica 0 para o objeto de instantâneo.
