...
## Descrição
O **cmdlet Set-AzVmss** define ações específicas no VMSS (Virtual Machine Scale Set).
A única ação compatível com esse cmdlet é o Reimage.

## Exemplos

### Exemplo 1: reimage um VMSS
```powershell
PS C:\> Set-AzVmss -Reimage -ResourceGroupName "ContosoGroup" -VMScaleSetName "ContosoVMSS"
```

Esse comando reimaja o VMSS chamado ContosoVMSS que pertence ao grupo de recursos chamado ContosoGroup.
...
Indica que esse cmdlet executa a manutenção de um ou mais máquinas virtuais no VMSS.
...
### -Reimplantar
Indica que o cmdlet reimplanta uma ou mais máquinas virtuais no VMSS.
...
### -Reimage
Indica que o cmdlet reimaima o VMSS.
...
### -ReimageAll
Indica que o cmdlet reimaja todos os discos no VMSS.
...
### -VMScaleSetName
Especimos o nome do VMSS para o qual este cmdlet define as ações.
