...
## Descrição
O **cmdlet Add-AzImageDataDisk** adiciona um disco de dados a um objeto de imagem.
...
Os três comandos a seguir atribuem caminhos de disco do sistema operacional e dois discos de dados para as variáveis $osDiskVhdUri, $dataDiskVhdUri 1 e $dataDiskVhdUri 2.
...
### -Ltda
Especifica o número da unidade lógica (Nº DEF. Nº).
