...
Esse comando cria um host da SKU determinada no grupo de host determinado e no local determinado.
...
Especifica se o host deve ser substituído automaticamente em caso de falha. O valor é padrão para "verdadeiro" quando não é fornecido.
...
### -HostGroupName
Especifica o nome do grupo de host.
...
### -LicenseType
Especifica o tipo de licença de software que será aplicado aos VMs implantados no host. Os valores possíveis são: Nenhum, Windows_Server_Hybrid e Windows_Server_Perpetual.  O valor padrão é Nenhum.
...
### -PlatformFaultDomain
Especifica o número de domínios de falha da plataforma do host.  Em seguida, o valor mínimo é 0 e o valor máximo é 2.
