...
## Descrição
O cmdlet **Add-AzVmssDiagnosticsExtension** adiciona uma extensão de diagnóstico à instância VMSS (Virtual Machine Scale Set).
...
Esse comando adiciona uma extensão de diagnóstico ao VMSS.
...
### -SettingFilePath
Especifica o caminho do arquivo de configuração público.
...
Para obter a versão, execute o cmdlet [Get-AzVMExtensionImage](./Get-AzVMExtensionImage.md) com um valor de Microsoft.Azure.Diagnostics para o parâmetro *PublisherName* e IaaSDiagnosticstics para o parâmetro *Tipo.*
