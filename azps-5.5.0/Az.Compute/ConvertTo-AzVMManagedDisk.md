...
A máquina virtual deve ser parada antes de revogar esta operação.
...
Esse comando converte os discos baseados em blob da máquina virtual chamada 'VM01' no grupo de recursos 'ResourceGroup01' em discos gerenciados.
