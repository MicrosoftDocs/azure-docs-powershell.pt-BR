...
## Descrição
O cmdlet **Remove-AzVmssExtension** remove uma extensão do VMSS (Virtual Machine Scale Set).
...
Esse comando remove a ID de especificação de extensão do VMSS que pertence ao grupo de recursos chamado Group002.
...
### -ID
Especifica a ID da extensão que este cmdlet remove do VMSS.
