...
Você pode adicionar uma interface ao criar uma máquina virtual ou adicioná-la a uma máquina virtual existente.
...
### -ID
Especifica a ID de uma interface de rede para adicionar a uma máquina virtual.
Você pode usar o cmdlet [Get-AzNetworkInterface para](/powershell/module/az.network/get-aznetworkinterface) obter uma interface de rede.
