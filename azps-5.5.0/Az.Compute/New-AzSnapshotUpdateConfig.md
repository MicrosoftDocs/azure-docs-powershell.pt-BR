...
O primeiro comando cria um objeto de atualização de instantâneo vazio local com tamanho de 10 GB Premium_LRS de armazenamento. Ele também define o tipo do sistema operacional Windows e habilita as configurações de criptografia. O segundo e o terceiro comandos configuram a chave de criptografia de disco e as configurações da chave de criptografia para o objeto de atualização de instantâneo. O último comando leva o objeto de atualização de instantâneo e atualiza um instantâneo existente com o nome 'Instantâneo01' no grupo de recursos 'ResourceGroup01'.
...
Esse comando atualiza um instantâneo existente com o nome "Instantâneo01" no grupo de recursos 'ResourceGroup01' para o tamanho do disco de 10 GB.
...
### -DiskEncryptionKey
Especifica o objeto da chave de criptografia de disco em um instantâneo.
...
### -KeyEncryptionKey
Especifica a chave de criptografia chave em um instantâneo.
