...
## Descrição
O cmdlet **Get-AzVMSqlServerExtension** obtém as configurações da infraestrutura do SQL Server como um agente de serviço (IaaS) em uma máquina virtual.
...
Esse comando obtém a máquina virtual chamada ContosoVM22 no serviço Service08 usando o cmdlet Get-AzVM usuário.
O comando passa os resultados para o cmdlet atual usando o operador de pipeline.
O comando atual obtém as configurações do Sql Server IaaS Agent nessa máquina virtual.
...
Esse comando obtém as configurações da versão 1.0 da extensão do SQL Server em uma máquina virtual chamada ContosoVM07.
