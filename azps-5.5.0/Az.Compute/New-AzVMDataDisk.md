...
## Sinopse
Cria um objeto de disco de dados local para uma máquina virtual ou um VMSS.
...
## Descrição
O **cmdlet New-AzVMDataDisk** cria um objeto de disco de dados local para uma máquina virtual ou um VMSS.
...
O comando final atualiza o VMSS adicionando um novo disco de dados.

### Exemplo 2

Cria um objeto de disco de dados local para uma máquina virtual ou um VMSS. (gerado automaticamente)
...
### -Cache
O cache do disco de dados do computador virtual.
...
### -CreateOption
A opção criar disco de dados do computador virtual.
...
### -DiskEncryptionSetId
A ID do conjunto de criptografia de disco gerenciado por computador virtual.
...
### -DiskSizeInGB
O tamanho do disco de dados do computador virtual em GB.
...
### -Ltda
O disco de dados virtual do computador.
...
### -ManagedDiskId
A ID do disco virtual gerenciado pelo computador.
...
### -Nome
O nome do disco de dados do computador virtual.
...
### -SourceImageUri
O Uri da imagem de origem do disco virtual do computador.
...
### -HighdUri
O Uri de datad Uri do computador virtual.
