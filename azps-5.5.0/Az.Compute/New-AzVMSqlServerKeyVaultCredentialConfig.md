...
## Sinopse
Cria um objeto de configuração para a credencial do cofre de teclas do SQL Server em uma máquina virtual.
...
### -AzureKeyVaultUrl
URL de serviço do Cofre de Chave do Azure
