...
## Sinopse
Atualizações de tíquete de suporte.
...
### Exemplo 4: Atualizar a gravidade do tíquete de suporte por meio de um objeto de tíquete de suporte.
```powershell
...
### Exemplo 6: atualizar o status do tíquete de suporte por meio de um objeto de tíquete de suporte.
```powershell
...
Atualize os detalhes do contato no SupportTicket.
...
Idioma de suporte preferido do cliente.
Esse deve ser um código de controle de idioma válido para um dos idiomas com suporte listados https://azure.microsoft.com/support/faq/ aqui.
