...
Sempre use os GUIDs de classificação de problemas e serviço obtidos programaticamente. Essa prática garante que você tenha os GUIDs de classificação de problemas e de serviço mais recentes para criação de tíquetes de suporte.

## Exemplos

### Exemplo 1: obter classificações de problemas para um serviço usando o parâmetro ID do serviço.
```powershell
...
### Exemplo 2: obter classificações de problemas para um serviço usando o objeto de serviço pai
```powershell
...
### Exemplo 3: Obter detalhes de um único problema classificaiton por id por objeto de serviço de piping
```powershell
...
### -ServiceObject
Objeto de serviço para o qual as classificações de problema são recuperadas.
