...
Liste todos os alertas com a gravidade de Sev2 e a condição do monitor Desv2. Configurando IncludeContext como true, inclua uma carga de alerta personalizada.
...
Obter detalhes do Alerta por ID (GUID) ou ID do Recurso (ID de ARM completa)
...
### -Selecionar
Projetar os campos necessários fora do essencial.
