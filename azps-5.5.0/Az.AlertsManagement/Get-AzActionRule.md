...
Liste todas as regras de ação configuradas no rg de teste do grupo de recursos filtrado na gravidade de Sev2 e no Serviço de Monitor de Plataforma. Use Format-List para obter os detalhes de cada regra de ação na lista.
...
Obter a regra de ação com o nome Test-Action-Rule no grupo de recursos rg de teste.
