...
## Sinopse
Obtém histórico de grupos inteligentes
...
## Descrição
**O cmdlet Get-AzSmartGroupHistory** obtém o histórico de grupos inteligentes.
...
Obtém detalhes do histórico de grupos inteligentes.
...
### -SmartGroupId
Identificador exclusivo de alerta SmartGroup/ResourceId.
