...
### Exemplo 1: Alterar a chave de acesso de uma fonte de dados
```
PS C:\>Set-AzDataLakeAnalyticsDataSource -Account "ContosoAdlAccount" -Blob "contosowasb" -AccessKey "...newaccesskey..."
```

Esse comando altera a chave de acesso armazenada para uma fonte de dados de Armazenamento de Blob do Azure.

## Parâmetros

### -AccessKey
Especifica a nova chave de acesso da fonte de dados Armazenamento de Blob do Azure.
