...
Esse comando altera a fonte de dados padrão e a propriedade Marcas da conta.
...
### -FirewallState
Opcionalmente, habilita/desabilite as regras de firewall existentes.
...
### -MaxAnalyticsUnits
As unidades de análise máximas com suporte opcional para atualizar a conta.
...
### -MaxCount
Os trabalhos opcionais máximos com suporte em execução sob a conta ao mesmo tempo a ser definido.
...
### -QueryStoreRetention
O número opcional de dias que os metadados de trabalho são mantidos para definir na conta.
...
### -Tag
Uma cadeia de caracteres, dicionário de cadeias de caracteres de marcas associadas a esta conta que deve substituir o conjunto atual de marcas
