...
## Sinopse
Modifica uma entrada na ACL de um item de catálogo ou de catálogo no Data Lake Analytics.
...
## Descrição
O cmdlet **Set-AzDataLakeAnalyticsCatalogItemAclEntry** adiciona ou modifica uma entrada (ACE) na lista de controles de acesso (ACL) de um item de catálogo ou de catálogo no Data Lake Analytics.
...
Esse comando modifica o ace de catálogo para que Ela Tenha permissões de leitura.
...
Esse comando modifica o ACE do banco de dados para Que ele tenha permissões de leitura.
...
Esse comando modifica o ACE de catálogo para que outros tenham permissões de leitura.
...
Esse comando define a permissão de proprietário da conta como Lida.

### Exemplo 6: Modificar permissões de proprietário do usuário para um banco de dados
```powershell
...
Esse comando define a permissão de proprietário do banco de dados como Lida.
...
### -Outros
Definir a entrada ACL do catálogo para outros.
