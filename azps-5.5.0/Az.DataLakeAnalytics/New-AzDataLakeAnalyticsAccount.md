...
Esse comando cria uma conta do Data Lake Analytics chamada ContosoAdlAccount que usa o Repositório de Dados da ContosoAdlStore, no grupo de recursos chamado ContosoOrg.
...
### -MaxAnalyticsUnits
As unidades de análise máximas com suporte opcional para esta conta.
...
### -MaxCount
Os trabalhos opcionais máximos com suporte em execução sob a conta ao mesmo tempo. Se nenhum for especificado, o padrão será 3
...
### -QueryStoreRetention
O número opcional de dias em que os metadados de trabalho são mantidos. Se nenhum especificado, o padrão será de 30 dias.
...
Para criar um grupo de recursos, use o cmdlet New-AzResourceGroup dados.
...
### -Tag
Uma cadeia de caracteres, dicionário de cadeias de caracteres de marcas associadas a esta conta
