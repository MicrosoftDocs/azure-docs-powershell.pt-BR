...
## Sinopse
Exclui uma entrada da ACL de um item de catálogo ou de catálogo no Data Lake Analytics.
...
## Descrição
O cmdlet **Remove-AzDataLakeAnalyticsCatalogItemAclEntry** remove uma entrada (ACE) da lista de controles de acesso (ACL) de um item de catálogo ou de catálogo no Data Lake Analytics.

## Exemplos

### Exemplo 1: Remover o ACL do usuário de um catálogo
```powershell
...
Este comando remove o catálogo ACL para o Catalogo Denídeo da conta contosoadla.

### Exemplo 2: Remover o ACL do usuário de um banco de dados
```powershell
...
Esse comando remove o ACL do banco de dados para o Oracle Ltda da conta contosoadla.
...
### -Agrupar
Remover a entrada ACL do catálogo do grupo.
...
### -Usuário
Remover a entrada ACL do catálogo do usuário.
