...
## Descrição
O New-AzDataLakeAnalyticsCatalogCredential cmdlet cria uma nova credencial a ser usada em um catálogo do Azure Data Lake Analytics para se conectar a fontes de dados externas.

## Exemplos

### Exemplo 1: Criar uma credencial para um catálogo que especifica o host e a porta
```
...
Esse comando cria a credencial especificada para a conta, o banco de dados, o host e a porta especificadas usando o protocolo https.

### Exemplo 2: Criar uma credencial para um catálogo que especifica URI completo
```
PS C:\> New-AzDataLakeAnalyticsCatalogCredential -AccountName "ContosoAdlAccount" `
                  -DatabaseName "databaseName" `
                  -CredentialName "exampleDbCred" `
...
Esse comando cria a credencial especificada para o URI de fonte de dados, banco de dados e conta especificada.
...
Especifica o nome do banco de dados na conta do Data Lake Analytics em que a credencial será armazenada.
