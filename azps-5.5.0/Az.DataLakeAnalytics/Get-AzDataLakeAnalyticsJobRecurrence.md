...
## Sinopse
Obtém uma recorrência ou recorrência de um trabalho do Data Lake Analytics.
...
## Descrição
O **Get-AzDataLakeAnalytics JobRecurrence obtém** uma recorrência especificada do Trabalho de Análise do Azure Data Lake ou uma lista de recorrência.
...
Esse comando obtém a recorrência do trabalho especificado com a id '83cb7ad2-3523-4b82-b909-d478b0d8aea3' na conta "contosoadla".
...
### -Conta
Nome do nome da conta do Data Lake Analytics sob o qual deseja recuperar a recorrência do trabalho.
...
### -RecorrênciaId
ID da recorrência de trabalho específica para a que as informações são retornadas.
...
### -SubmittedAfter
Um filtro opcional que retorna as recorrências de trabalho enviadas somente após o horário especificado.
...
### -SubmittedBefore
Um filtro opcional que retorna as recorrências de trabalho enviadas somente antes do horário especificado.
