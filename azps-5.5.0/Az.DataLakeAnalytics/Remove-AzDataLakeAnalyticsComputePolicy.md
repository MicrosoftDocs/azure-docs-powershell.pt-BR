...
## Sinopse
Remove uma política de computação especificada do Azure Data Lake Analytics
...
## Descrição
O **Remove-AzDataLakeAnalyticsComputePolicy** remove uma política de computação especificada do Azure Data Lake Analytics.
...
Esse comando remove a política de computação especificada com o nome 'myPolicy' na conta 'contosoadla'.
