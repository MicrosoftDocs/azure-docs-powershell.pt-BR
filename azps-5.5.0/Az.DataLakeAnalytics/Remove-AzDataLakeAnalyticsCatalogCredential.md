...
## Descrição
O Remove-AzDataLakeAnalyticsCatalogCredential cmdlet exclui uma credencial de catálogo do Azure Data Lake Analytics.
...
Esse comando remove a credencial de catálogo do Data Lake Analytics especificada.
...
### -PassThru
Indica que esse cmdlet não espera a conclusão da operação.
...
Isso será necessário se o chamador não for o proprietário da conta.
...
### -Recorrência
Indica que essa operação de exclusão deve ser realizada e também excluir e soltar todos os recursos que dependem dessa credencial.
