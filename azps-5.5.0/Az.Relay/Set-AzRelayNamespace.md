...
## Descrição
O cmdlet **Set-AzRelayNamespace** atualiza a descrição do namespace de Retransmissão especificado no grupo de recursos.
...
Atualiza o namespace relay com uma nova descrição.
