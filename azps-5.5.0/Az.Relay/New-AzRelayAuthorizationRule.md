...
## Descrição
O cmdlet **New-AzRelayAuthorizationRule** cria uma nova regra de autorização para as entidades de Relay especificadas (Namespace/WcfRelay/HybridConnection).
...
Cria `AuthoRule1` com os **direitos** de Ouvir para o `TestNameSpace-Relay1` namespace.
...
Cria uma regra de `AuthoRule1` autorização **com** direitos de ouvir para o WcfRelay. `TestWCFRelay1`
...
Cria `AuthoRule1` com **direitos** de ouvir para a Conexão Híbrida. `TestHybridConnection`
