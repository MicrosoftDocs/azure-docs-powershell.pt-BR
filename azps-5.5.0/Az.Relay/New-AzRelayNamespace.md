...
## Sinopse
Cria um novo namespace de Retransmissão.
...
## Descrição
O **cmdlet New-AzRelayNamespace** cria um novo namespace relay. Depois de criado, o manifesto de recurso namespace é imutável.
