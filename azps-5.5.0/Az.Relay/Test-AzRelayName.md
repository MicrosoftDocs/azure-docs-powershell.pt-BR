...
## Sinopse
Verifica a Disponibilidade do nome namespace determinado
...
## Descrição
O **Cmdlet Test-AzRelayName** Check Availability of the NameSpace NameSpace
...
retorna o status sobre a disponibilidade do nome do namespace
