...
## Sinopse
Obtém a descrição de uma regra de autorização especificada para determinadas entidades relay (Namespace/WcfRelay/HybridConnection).
...
## Descrição
O cmdlet **Get-AzRelayAuthorizationRule** obtém a descrição da regra de autorização especificada em determinadas entidades relay (Namespace/WcfRelay/HybridConnection).
...
Retorna a descrição da regra de autorização especificada para uma determinada Conexão Híbrida.
