...
## Sinopse
Obtém uma descrição para a Conexão Híbrida especificada no namespace relay.
...
## Descrição
O cmdlet **Get-AzRelayHybridConnection** obtém uma descrição para a Conexão Híbrida especificada no namespace relay.
...
Retorna a descrição da Conexão Híbrida.
