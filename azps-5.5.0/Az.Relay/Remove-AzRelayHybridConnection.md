...
## Sinopse
Remove a Conexão Híbrida do namespace de Conexão Híbrida especificado.
...
## Descrição
O cmdlet **Remove-AzRelayHybridConnection** remove a Conexão Híbrida do namespace de Relay especificado.
...
Remove a Conexão `TestHybridConnection` Híbrida do `TestNameSpace-Relay1` namespace.
