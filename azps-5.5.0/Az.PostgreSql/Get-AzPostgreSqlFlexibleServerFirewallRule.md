...
### Exemplo 3: Lista todas as regras de firewall no servidor PostgreSql especificado
```powershell
...
Este cmdlet lista todas as regras de firewall no servidor PostgreSql especificado.
