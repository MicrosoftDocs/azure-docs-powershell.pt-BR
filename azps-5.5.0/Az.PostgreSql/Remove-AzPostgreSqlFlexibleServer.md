...
### Exemplo 1: Remover servidor PostgreSql por resourceGroup e nome do servidor
```powershell
PS C:\> Remove-AzPostgreSqlFlexibleServer -ResourceGroupName PowershellPostgreSqlTest -Name postgresql-test

```

Este cmdlet remove o servidor PostgreSql por resourceGroup e nome do servidor.

### Exemplo 2: Remover servidor PostgreSql por identidade
```powershell
