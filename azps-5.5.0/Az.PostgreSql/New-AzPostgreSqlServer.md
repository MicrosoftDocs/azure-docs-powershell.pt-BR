...
### -GeoRedundantBackup
Habilitar a redundância geográfica ou não para backup do servidor.
...
### -MinimalTlsVersion
Defina a versão TLS mínima para conexões com o servidor quando a SSL estiver habilitada.
O padrão é valores TLSEnforcementDisabled.accepted: TLS1_0, TLS1_1, TLS1_2, TLSEnforcementDisabled.
