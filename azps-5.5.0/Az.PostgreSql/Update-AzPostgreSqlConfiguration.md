...
### Exemplo 1: Atualizar configuração PostgreSql por nome
```powershell
...
Este cmdlet atualiza a configuração PostgreSql por nome.

### Exemplo 2: Atualizar configuração PostgreSql por identidade.
```powershell
...
Esses cmdlets atualizam a configuração PostgreSql por identidade.
