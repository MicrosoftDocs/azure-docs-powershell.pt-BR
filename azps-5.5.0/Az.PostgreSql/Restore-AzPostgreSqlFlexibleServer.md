...
### Exemplo 1: Restaurar o servidor PostgreSql usando a Restauração do PointInTime
```powershell
...
### -RestorePointInTime
O ponto a ser restaurado (formato ISO8601), por exemplo, 2017-04-26T02:10:00+08:00.
