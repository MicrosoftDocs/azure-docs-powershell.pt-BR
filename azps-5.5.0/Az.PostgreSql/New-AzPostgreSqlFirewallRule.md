...
Esse cmdlets criam uma Regra de Firewall do servidor PostgreSql.

### Exemplo 2: Crie uma nova Regra de Firewall PostgreSql usando -ClientIPAddress.
```powershell
...
Esse cmdlets criam uma Regra de Firewall PostgreSql usando -ClientIPAddress.

### Exemplo 3: Criar uma nova Regra de Firewall PostgreSql para permitir todos os IPs
```powershell
