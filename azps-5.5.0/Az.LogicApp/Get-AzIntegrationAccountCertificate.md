...
## Sinopse
Obtém certificados de conta de integração de um grupo de recursos.
...
Este comando obtém o certificado de conta de integração chamado IntegrationAccountCertificate01.

### Exemplo 2: Obter certificados de conta de integração pelo nome da conta de integração
```
...
Esse comando obtém os certificados de conta de integração da conta de integração chamada IntegrationAccount31.
