...
## Descrição
O **cmdlet New-Az LogicApp** cria um aplicativo lógico usando o recurso Aplicativos Lógicos.
...
Você pode criar um aplicativo lógico especificando um nome, um local, uma definição do Aplicativo Lógico, um grupo de recursos e um plano.
...
O aplicativo lógica inclui a definição e os parâmetros especificados por caminhos de arquivo.
...
Esse comando cria um aplicativo lógico no grupo de recursos de grupo de recursos especificado.
...
Esse comando obtém o grupo de recursos chamado ResourceGroup11 usando Get-AzResourceGroup cmdlet.
...
O comando armazena o aplicativo lógico na variável $Workflow dados.
O segundo comando cria um novo aplicativo lógico que usa a definição e os parâmetros do aplicativo lógico armazenados $Workflow.
...
### -Definição
Especifica a definição do seu aplicativo lógico como um objeto ou uma cadeia de caracteres no formato de Notação de Objeto JavaScript (JSON).
