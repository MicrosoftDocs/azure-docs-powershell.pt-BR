...
## Descrição
O **cmdlet Set-AzIntegrationAccountPartner** modifica um parceiro de conta de integração.
Este cmdlet retorna um objeto que representa o parceiro de conta de integração.
...
### Exemplo 1: Modificar um parceiro de conta de integração
```powershell
...
Esse comando modifica o parceiro de conta de integração chamado IntegrationAccountPartner22 no grupo de recursos especificado.

### Exemplo 2

Modifica um parceiro de conta de integração. (gerado automaticamente)
...
### -Entidades BusinessId
Especifica identidades comerciais para o parceiro de conta de integração.
Especifique uma tabela hash.
...
### -PartnerName
Especifica o nome do parceiro de conta de integração.
...
Esse parâmetro dá suporte ao tipo B2B.
