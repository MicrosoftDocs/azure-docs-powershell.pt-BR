...
Esse comando cria o mapa de conta de integração no grupo de recursos especificado.
...
### -MapFilePath
Especifica o caminho do arquivo de uma definição para o mapa de conta de integração. Especifique esse parâmetro ou o *parâmetro MapDefinition.*
