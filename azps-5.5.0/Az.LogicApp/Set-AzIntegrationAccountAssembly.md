...
## Sinopse
Modifica uma montagem de conta de integração.
...
### Exemplo 1: Modificar uma montagem usando um arquivo local
```powershell
...
Modifica a montagem chamada "sampleAssembly" usando o arquivo local localizado no caminho do arquivo contido em "$localAssemblyFilePath".

### Exemplo 2: Modificar uma montagem usando dados de byte
```powershell
...
Modifica a montagem chamada "sampleAssembly" usando a matriz byte contida em "$assemblyContent".

### Exemplo 3: Modificar uma montagem usando um link de conteúdo
```powershell
...
Modifica a montagem chamada "sampleAssembly" usando os dados de um byte localizados na URL "$assemblyUrl". Este é o método sugerido para criar grandes conjuntos de tamanhos.

## Parâmetros

### -AssemblyData
Os dados de byte de montagem de conta de integração.
...
### -AssemblyFilePath
O caminho do arquivo de montagem de conta de integração.
...
### -ContentLink
Um link publicamente acessível para os dados de montagem da conta de integração.
...
### -InputObject
Uma montagem de conta de integração.
...
### -Metadados
Os metadados de montagem da conta de integração.
...
### -ResourceId
A ID do recurso de montagem de conta de integração.
