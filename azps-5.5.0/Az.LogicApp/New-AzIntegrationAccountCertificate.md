...
Especifique o nome da conta de integração, o nome do grupo de recursos, o nome do certificado, o nome da chave, a versão da chave e a ID do cofre de chave.
...
Esse comando cria o certificado de conta de integração no grupo de recursos especificado.

## Parâmetros

### -Nomedo Certificado
Especifica um nome para o certificado de conta de integração.
...
### -KeyName
Especifica o nome da chave do certificado no cofre de chave.
