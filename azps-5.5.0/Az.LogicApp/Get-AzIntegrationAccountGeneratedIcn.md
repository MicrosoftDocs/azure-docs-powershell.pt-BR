...
## Sinopse
Este cmdlet recupera o valor atual do número de controle de troca gerado por contrato.
...
## Descrição
Esse cmdlet deve ser usado em cenários de recuperação de desastres para recuperar o valor atual do número de controle de intercambiamento gerado, de modo a anotar um valor aumentado com Set-AzIntegrationAccountGeneratedIcn.
O número do controle de troca deve ser aumentado para evitar números de controle de troca duplicados para os números que ainda não puderam ser replicados para a região passiva quando o desastre aconteceu na região ativa.
...
Esse comando obtém a conta de integração gerada X12 número do controle de troca por nome de contrato. Verifique se o contrato especificado é do tipo "X12"
...
Esse comando obtém o número de controle de troca gerado pela conta de integração Edifact por nome de contrato. Certifique-se de que o contrato especificado seja do tipo "Edifact"
...
Esse comando obtém todos os números de controle de troca X12 gerados pelo nome da conta de integração.
