...
## Descrição
O **cmdlet Get-AzApp** obtém um aplicativo lógico.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos no qual este cmdlet obtém um aplicativo lógico.
