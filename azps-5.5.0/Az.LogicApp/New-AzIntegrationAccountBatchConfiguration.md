...
### Exemplo 1: Criar nova configuração em lotes usando o arquivo local
```powershell
...
Cria uma nova configuração em lotes usando o arquivo local localizado no caminho de arquivo contido em "$batchConfigurationFilePath".

### Exemplo 2: Criar nova configuração em lotes usando uma cadeia de caracteres JSON
```powershell
...
Cria uma nova configuração de lote usando a cadeia de caracteres JSON contida em "$batchConfigurationContent".

### Exemplo 3: Criar nova configuração em lotes usando parâmetros
```powershell
