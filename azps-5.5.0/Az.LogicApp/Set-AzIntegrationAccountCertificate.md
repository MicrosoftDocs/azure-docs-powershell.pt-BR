...
Este cmdlet retorna um objeto que representa o certificado de conta de integração.
...
Esse comando modifica o certificado de conta de integração no grupo de recursos especificado.
...
### -KeyName
Especifica o nome de uma chave de certificado no cofre de chave.
...
### -KeyVaultId
Especifica uma ID do cofre de chave.
...
### -KeyVersion
Especifica a versão da chave do certificado no cofre de chave.
