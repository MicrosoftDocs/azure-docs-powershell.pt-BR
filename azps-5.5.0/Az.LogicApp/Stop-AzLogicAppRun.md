...
## Sinopse
Cancela uma executar um aplicativo lógico.
...
## Descrição
O cmdlet **Stop-AzAppRun** cancela uma executar um aplicativo lógico.
...
### Exemplo 1: Cancelar uma executar um aplicativo lógico
```
PS C:\>Stop-AzLogicAppRun -ResourceGroupName "ResourceGroup11" -Name "LogicApp03" -RunName "08587489104702792076" -Force
```

Esse comando cancela uma executar o aplicativo lógico chamado LogicApp03.
...
### -Nome
Especifica o nome de um aplicativo lógico para o qual este cmdlet cancela uma executar.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos no qual este cmdlet cancela uma executar.
...
### -RunName
Especifica o nome de um aplicativo lógico executado que este cmdlet cancela.
