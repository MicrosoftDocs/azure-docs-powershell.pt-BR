...
## Sinopse
Remove uma configuração de lote da conta de integração.
...
### -InputObject
Uma configuração em lotes de conta de integração.
...
### -ResourceId
A ID do recurso de configuração em lote da conta de integração.
