...
O cmdlet **Get-AzAppTrihistory obtém** o histórico de gatilhos em um aplicativo lógico no recurso Aplicativos Lógicos.
Este cmdlet retorna um objeto **WorkflowTrihistory.**
...
Esse comando obtém um histórico de acionador de aplicativo lógico específico para um gatilho no aplicativo lógico chamado LogicApp03.
...
Esse comando obtém as histórias de gatilho de fluxo de trabalho para um gatilho no aplicativo lógico chamado LogicApp07.

### Exemplo 3: Obter todo o histórico de gatilhos de um aplicativo lógico
...
Esse comando obtém todo o histórico de gatilhos do fluxo de trabalho para um gatilho no aplicativo lógico chamado LogicApp08 seguindo o NextPageLink.
...
Esse comando obtém as duas primeiras páginas do histórico de gatilhos do fluxo de trabalho para um gatilho no aplicativo lógico chamado LogicApp09 seguindo o NextPageLink e limitando o tamanho do resultado a duas páginas.
...
Especifica o nome do aplicativo lógico para o qual este cmdlet obtém o histórico de gatilhos.
...
### Microsoft.Azure.Management.Logic.Models.WorkflowTrihistory
...
[Get-Az Ltda.](./Get-AzLogicAppTrigger.md)
