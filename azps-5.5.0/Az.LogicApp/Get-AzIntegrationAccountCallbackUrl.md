...
## Sinopse
Obtém uma URL de retorno de retorno de conta de integração.
...
## Descrição
O cmdlet **Get-AzIntegrationAccountCallbackUrl** obtém uma URL de retorno de retorno de conta de integração de um grupo de recursos.
Este cmdlet retorna um objeto **CallbackUrl** que representa a URL de retorno de chamada da conta de integração.
...
### Exemplo 1: Obter uma URL de retorno de chamada de conta de integração
```
...
Esse comando obtém uma URL de retorno de retorno de conta de integração.
...
### -NotAfter
Especifica a data de vencimento da URL de retorno de chamada.
...
[Get-AzAppTricallbackUrl](./Get-AzLogicAppTriggerCallbackUrl.md)
