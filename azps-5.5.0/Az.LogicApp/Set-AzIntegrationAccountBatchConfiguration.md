...
## Sinopse
Modifica uma configuração de lote de conta de integração.
...
## Descrição
O cmdlet **Set-AzIntegrationAccountBatchConfiguration** modifica uma configuração de lote de conta de integração.
...
Modifique uma configuração em lotes chamada "sampleBatchConfig" usando o arquivo local localizado no caminho de arquivo contido em "$batchConfigurationFilePath".
...
A definição de configuração em lote da conta de integração.
...
O caminho do arquivo de configuração em lote da conta de integração.
...
### -MessageCount
A contagem de mensagens de configuração em lote da conta de integração.
...
### -Metadados
Os metadados de configuração em lote da conta de integração.
...
### -ScheduleFrequency
A frequência de agendamento de configuração em lote da conta de integração.
...
### -ScheduleInterval
O intervalo de agendamento de configuração em lote da conta de integração.
...
### -ScheduleStartTime
A hora de início do cronograma de configuração de lote da conta de integração.
...
### -ScheduleTimeZone
O fuso horário de configuração de lote da conta de integração.
