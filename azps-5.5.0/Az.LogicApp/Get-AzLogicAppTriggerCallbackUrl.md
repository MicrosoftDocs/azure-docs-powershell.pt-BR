...
## Sinopse
Obtém uma URL de retorno de chamada de gatilho do aplicativo Logic.
...
## Descrição
O cmdlet **Get-AzAppTricallbackUrl** obtém uma URL de retorno de retorno de gatilho do Aplicativo Logic de um grupo de recursos.
Esse cmdlet retorna um objeto **WorkflowTricallbackUrl** que representa a URL de retorno de chamada.
Especifique o nome do grupo de recursos, o nome do aplicativo lógico e o nome do gatilho.
...
### Exemplo 1: Obter uma URL de retorno de chamada de gatilho do aplicativo Logic
```
...
Esse comando obtém uma URL de retorno de chamada de gatilho do Aplicativo Lógico.
...
### -TriggerName
Especifica o nome de um gatilho.
...
### Microsoft.Azure.Management.Logic.Models.WorkflowTricallbackUrl
