...
Esse cmdlet retorna um objeto que representa a conta de integração. Especifique um nome, um local, um nome de grupo de recursos e um nome SKU.
...
### -SKU
Especifica um nome SKU para a conta de integração.
