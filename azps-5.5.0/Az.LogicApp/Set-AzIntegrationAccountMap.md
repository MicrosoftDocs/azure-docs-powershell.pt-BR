...
## Sinopse
Modifica um mapa de conta de integração.
...
## Descrição
O **cmdlet Set-AzIntegrationAccountMap** modifica um mapa de conta de integração.
Este cmdlet retorna um objeto que representa o mapa de conta de integração.
...
### Exemplo 1: Modificar um mapa de conta de integração
```powershell
...
Esse comando modifica o mapa da conta de integração no grupo de recursos especificado.
O comando especifica uma definição de mapa armazenada no $MapContent variável por um comando anterior.

### Exemplo 2

Modifica um mapa de conta de integração. (gerado automaticamente)
...
### -ContentType
Especifica um tipo de conteúdo para o mapa de conta de integração.
...
### -MapDefinition
Especifica um objeto de definição para o mapa de conta de integração.
...
### -MapFilePath
Especifica o caminho do arquivo de uma definição para o mapa de conta de integração.
...
### -MapName
Especifica o nome de um mapa de conta de integração.
...
### -MapType
Especifica o tipo do mapa de conta de integração.
Este cmdlet dá suporte ao Xslt como um tipo de mapa.
