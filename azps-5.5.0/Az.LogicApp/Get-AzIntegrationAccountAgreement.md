...
### Exemplo 2: Obter contratos de conta de integração por nome de grupo de recursos
```
...
Esse comando obtém os contratos de conta de integração por nome do grupo de recursos.
