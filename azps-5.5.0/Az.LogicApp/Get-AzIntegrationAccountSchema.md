...
Esse comando obtém o esquema de conta de integração chamado IntegrationAccountSchema43.
...
Esse comando obtém os esquemas de conta de integração do grupo de recursos chamado ResourceGroup11.
