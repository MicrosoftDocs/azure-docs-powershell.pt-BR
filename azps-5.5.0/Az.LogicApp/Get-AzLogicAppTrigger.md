...
## Descrição
O cmdlet **Get-AzAppTrigger** recebe gatilhos de um aplicativo lógico.
Este cmdlet retorna um objeto **WorkflowTri workflow.**
...
### -Nome
Especifica o nome do aplicativo lógico do qual este cmdlet obtém um gatilho.
...
[Get-AzHistoryAppTrihistory](./Get-AzLogicAppTriggerHistory.md)
