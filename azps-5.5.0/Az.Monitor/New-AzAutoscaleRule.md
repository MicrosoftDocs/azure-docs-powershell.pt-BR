...
## Sinopse
Cria uma regra de Escala Automática.
...
## Descrição
O **cmdlet New-AzAutoscaleRule** cria uma regra de escala automática.
...
O primeiro comando cria uma regra para a métrica solicitações e a armazena na variável $Rule 1.
O segundo comando cria uma segunda regra para a métrica solicitações e a armazena na variável $Rule 2.

### Exemplo 3

Cria uma regra de Escala Automática. (gerado automaticamente)
...
### -ScaleActionCooldown
Especifica o tempo de recarga da ação de Escala Automática.
...
Especifica a direção da ação de escala.
Os valores aceitáveis para este parâmetro são:
- Nenhum
- Aumentar
- Diminuir
...
### -Limite
Especifica o limite do valor métrico.
