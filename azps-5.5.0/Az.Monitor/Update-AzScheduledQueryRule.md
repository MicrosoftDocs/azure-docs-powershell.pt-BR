...
## Descrição
Atualiza uma regra de Alerta de Log, atualizando apenas a propriedade "Habilitado" é suportado por esse comando.
Para atualizar outras propriedades, consulte [o comando Set-AzScheduledQueryRule.](https://docs.microsoft.com/en-us/powershell/module/az.monitor/set-azscheduledqueryrule)

## Exemplos

### Exemplo 1: Atualizar por nome da regra
```powershell
...
### Exemplo 3: Atualizar por ID de recurso
```powershell
