...
## Sinopse
criar para o recurso de vinculação privada com escopo
...
## Descrição
criar para um recurso com escopo de link privado, o recurso com escopo pode ser o espaço de trabalho do Log Analytics ou o componente Informações do Aplicativo
...
criar recurso com escopo "scoped_resource_name" vinculado ao componente de informações do aplicativo "ai_name"
...
### -LinkedResourceId
ID de Recurso LA/AI para Vincular
