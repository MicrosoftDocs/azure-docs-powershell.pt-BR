...
### Exemplo 1: Adicionar uma regra de alerta métrico a um site
```
...
Esse comando cria uma regra de alerta métrico para um site.
...
Se a regra não existir, ela será desabilitada.
Se a regra existir, ela simplesmente a desabilitará.
...
Especifique esse parâmetro somente para regras baseadas em métricas.
