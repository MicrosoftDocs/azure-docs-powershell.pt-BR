...
## Sinopse
Cria um objeto de critérios local que pode ser usado para criar um novo alerta métrico
...
## Descrição
O cmdlet **New-AzMetricAlertRuleV2Criteria** cria um objeto de critérios métricos local a ser usado como um cmdlet de entrada [Add-AzMetricAlertRuleV2](https://docs.microsoft.com/en-us/powershell/module/az.monitor/add-azmetricalertrulev2) que cria uma nova regra de alerta métrico.
...
Esse comando cria um critério de alerta métrico simples que pode ser usado em uma regra de alerta métrico

### Exemplo 2: Criar critérios de alerta de métrica dinâmica
...
Esse comando cria um critério de alerta de métrica dinâmica que pode ser usado em uma regra de alerta métrico
...
### Exemplo 4: Criar critérios de disponibilidade de teste na Web
...
Esse comando cria um critério de disponibilidade do teste na Web que pode ser usado em uma regra de alerta métrico

## Parâmetros

### -ApplicationInsightsId
A ID do recurso Informações do Aplicativo.
...
### -DynamicThreshold
Alternar parâmetro para usar o Tipo de Limite Dinâmico
...
A sensibilidade da condição de regra
...
### -TimeAggregation
A operação de agregação usada para rolar vários valores métricos no intervalo de janelas
...
### -ViolationCount
O número mínimo de violações necessárias na janela de tempo de retorno selecionada necessária para levantar um alerta
...
### -Teste Web
Alternar parâmetro para usar o tipo de critérios de disponibilidade
