...
## Sinopse
Adiciona ou atualiza uma regra de alerta de teste da Web.
...
## Descrição
O cmdlet **Add-AzWebtestAlertRule** adiciona ou atualiza uma regra de alerta do tipo métrica, evento ou teste da Web.
...
### Exemplo 1: Adicionar uma regra de alerta de teste na Web
```
...
Esse comando adiciona ou atualiza uma regra de alerta de teste da Web.

## Parâmetros

### -Ação
Especifica uma lista de ações separada por vírgula.
...
### -FailedLocationCount
Especifica a contagem de locais com falha para as regras de teste da Web.
Isso é semelhante ao limite nos outros tipos de regras.
...
### -MetricNamespace
Especifica o namespace métrico da regra.
...
### -TargetResourceUri
Especifica a ID de recurso do teste da Web.
...
### -WindowSize
Especifica o tamanho da janela de tempo para que a regra calcule seus dados.
