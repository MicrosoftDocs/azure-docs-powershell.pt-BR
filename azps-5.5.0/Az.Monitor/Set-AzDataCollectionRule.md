...
## Sinopse
Atualizações (substituição total) uma regra de coleta de dados.
...
### Exemplo 1: Atualizar regra de coleta de dados, JSON da API rest
```powershell
...
### Exemplo 2: Atualizar regra de coleta de dados, JSON da PSDataCollectionRuleResource
```powershell
PS C:\>Set-AzDataCollectionRule -Location 'East US 2 EUAP'
