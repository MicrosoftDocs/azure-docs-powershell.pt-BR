...
## Sinopse
Obter ou listar categoria de configuração de diagnóstico com suporte para o recurso do Azure.
...
Receba categorias de configuração de diagnóstico com suporte para rede virtual.
