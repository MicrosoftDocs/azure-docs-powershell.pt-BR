...
## Descrição
Cria um objeto do tipo Fonte.
Este objeto deve ser passado para o comando que cria a Regra de Alerta de Log
...
Cria um objeto do tipo Fonte. (gerado automaticamente)
...
### -QueryType
Tipo de consulta - valores com suporte no momento: ResultadoContar
