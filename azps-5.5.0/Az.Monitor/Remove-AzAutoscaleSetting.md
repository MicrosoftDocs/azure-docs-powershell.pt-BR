...
## Sinopse
Remove uma configuração de Escala Automática.
...
## Descrição
O cmdlet **Remove-AzAutoscaleSetting** remove uma configuração de Escala Automática.
Você deve especificar o nome da configuração e o nome do grupo de recursos ao qual ele foi atribuído.
...
Remove uma configuração de Escala Automática. (gerado automaticamente)
...
### -Nome
Especifica o nome da configuração de Escala Automática a ser removido.
