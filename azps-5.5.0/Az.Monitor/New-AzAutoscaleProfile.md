...
### Exemplo 1: Criar um único perfil com uma data fixa
```
...
O primeiro comando cria uma regra de Escala Automática chamada Solicitações e a armazena na variável $Rule dados.
O segundo comando cria um perfil chamado Perfil01 com uma data fixa usando a regra em $Rule.
...
O terceiro comando cria um perfil chamado ProfileName usando as regras em Regra1 e Regra2 e, em seguida, o armazena na variável $Profile 1.
...
O primeiro comando cria uma regra de Escala Automática chamada Solicitações e a armazena na variável $Rule dados.
O segundo comando cria um perfil sem um cronograma ou uma data fixa e o armazena na variável $Profile dados.
...
### -Regra
Especifica a lista de regras a ser adicionar ao perfil.
