...
## Sinopse
Obtém associação de regras de coleta de dados.
...
Esse comando lista todas as regras de coleta de dados para a ID de recurso de destino determinada (máquina virtual).
...
Esse comando lista as associações de regras de coleta de dados para determinado grupo de recursos e regra (DCR).
...
Este comando lista as associações de regras de coleta de dados para o objeto de entrada determinado.
...
Esse comando lista uma associação de regras de coleta de dados (uma lista com um único elemento).
