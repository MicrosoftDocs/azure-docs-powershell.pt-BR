...
### Exemplo 1: Obter definições métricas para um recurso
```
...
Esse comando obtém as definições de métrica para o recurso especificado.

### Exemplo 2: Obter definições métricas com saída detalhada
```
...
Esse comando obtém as definições de métrica para o site2.
A saída é detalhada.
...
Esse comando obtém definições para as métricas BytesSent e CpuTime.
A saída é detalhada.
...
### -MetricNamespace
Especifica o namespace métrico para as definições da métrica de consulta.
