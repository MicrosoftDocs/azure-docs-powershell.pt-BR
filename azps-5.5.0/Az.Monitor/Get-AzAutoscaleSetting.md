...
Esse comando obtém as configurações de Escala Automática atribuídas ao grupo de recursos Default-Web-EastUS.

### Exemplo 2: Obter uma configuração de Escala Automática por nome
```
...
Esse comando obtém a configuração de escala automática chamada DefaultServerFarm-Default-Web-EastUS.
