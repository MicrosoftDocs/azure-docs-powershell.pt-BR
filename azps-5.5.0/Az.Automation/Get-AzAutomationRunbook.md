...
Esse comando obtém todos os runbooks na conta automação do Azure chamada Contoso17.

## Parâmetros

### -AutomationAccountName
Especifica o nome de uma conta de Automação na qual este cmdlet obtém runbooks.
...
### -Nome
Especifica o nome de uma runbook que este cmdlet obtém.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos para o qual este cmdlet obtém os runbooks.
