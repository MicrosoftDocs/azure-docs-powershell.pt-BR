...
## Sinopse
Obtém trabalhos de sincronização de controle de origem de automação do Azure.
...
## Descrição
O Get-AzAutomationSourceControlSyncJob cmdlet obtém trabalhos de sincronização de controle de origem de automação do Azure. Para obter um trabalho de sincronização de controle de origem específico, especifique sua id.

## Exemplos

### Exemplo 1
Esse comando obtém todos os trabalhos de sincronização de controle de origem de automação do VSTSNative do controle de origem.
...
### Exemplo 2
Esse comando obtém o trabalho de sincronização de controle de origem com a id 08d6d266-27b6-463c-beea-bc48a67ace15 para o controle de origem VSTSNative. 
...
Obtém trabalhos de sincronização de controle de origem de automação do Azure. (gerado automaticamente)
