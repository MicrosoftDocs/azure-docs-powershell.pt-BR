...
O primeiro comando atribui uma tabela hash de valores de campo à variável $FieldValue dados.
O segundo comando cria uma conexão do Azure chamada Conexão12 na conta automação chamada AutomationAccount01.
...
O comando cria uma conexão do Azure chamada Conexão13 na conta automação chamada AutomationAccount01 usando $RunAsAccountConnectionFieldValues e ConnectionTypeName=AzureServicePrincipal.
Este ConnectionTypeName=AzureServicePrincipal é usado principalmente para o Azure Run As Account.
...
O comando cria uma conexão do Azure chamada Conexão14 na conta automação chamada AutomationAccount01 usando $ClassicRunAsAccountConnectionFieldValues e ConnectionTypeName=AzureClassicCertificate.
Este ConnectionTypeName=AzureClassicCertificate é usado principalmente para o Azure Classic Run As Account.

## Parâmetros

### -AutomationAccountName
Especifica o nome da conta automação para a qual este cmdlet cria uma conexão.
...
Especifica uma tabela hash que contém pares de chave/valor.
As teclas representam os campos de conexão para o tipo de conexão especificado.
