...
## Descrição
O cmdlet **New-AzAutomationRunbook** cria um manual de automação do Azure vazio usando a APS.
Especifique um nome para o livro de executar.

## Exemplos

### Exemplo 1: Criar um livro de executar
```powershell
PS C:\>New-AzAutomationRunbook -AutomationAccountName "Contoso17" -Name "Runbook02" -ResourceGroupName "ResourceGroup01"
```

Esse comando cria um runbook chamado Runbook02 na conta de Automação do Azure chamada Contoso17.

### Exemplo 2

Cria um manual de automação. (gerado automaticamente)
...
Especifica o nome da conta automação na qual este cmdlet cria um livro de executar.
...
### -Nome
Especifica um nome para o livro de executar.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos para o qual este cmdlet cria um livro de executar.
