...
## Sinopse
Obtém anuários de automação e agendas associadas.
...
Especifique o nome de um runbook ou um cronograma ou ambos para ver cronogramas específicos do runbook.
...
Esse comando obtém todos os runbooks agendados na conta automação do Azure chamada Contoso17.

### Exemplo 2: Obter todos os cronogramas associados a um livro de executar
```
PS C:\>Get-AzAutomationScheduledRunbook -AutomationAccountName "Contoso17" -ResourceGroupName "ResourceGroup01" -RunbookName "Runbk01"
```

Esse comando obtém todos os runbooks agendados do runbook Runbk01 na conta de Automação do Azure chamada Contoso17.
...
Esse comando obtém todas as guias de executar agendadas para o cronograma01 na conta de Automação do Azure chamada Contoso17.
...
### -RunbookName
Especifica o nome de um livro de runbook para o qual este cmdlet obtém os runbooks agendados.
...
### -Nomedo Agendamento
Especifica o nome de um cronograma para o qual este cmdlet obtém os runbooks agendados.
