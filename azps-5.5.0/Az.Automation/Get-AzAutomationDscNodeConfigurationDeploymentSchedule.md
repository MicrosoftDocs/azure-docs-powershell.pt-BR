...
## Sinopse
Obtém um cronograma de trabalho de implantação de configuração de nó DSC em Automação.
...
## Descrição
O cmdlet **Get-AzAutomationDscNodeConfigurationDeployment** implanta uma configuração de nó DSC (Configuração de Estado Desejado) APS na Automação do Azure.
...
### -JobScheduleId
Especifica a ID do Cronograma de Trabalho de um trabalho de implantação agendado existente.
