...
## Sinopse
Cria uma configuração agendada de atualização de software de automação do azure.
...
## Descrição
Cria uma configuração de atualização de software que é executado em um cronograma para atualizar uma lista de computadores. Os computadores incluem máquinas virtuais do Azure ou computadores não az.

## Exemplos

### Exemplo 1
Cria uma configuração de atualização de software para instalar atualizações críticas em duas máquinas virtuais do Windows azure uma vez a cada sábado às 21h. A duração da atualização está definida como 2 horas neste exemplo.
...
### -AzureQuery
Consulta dinâmica do azure de grupo.
...
### -ExcludedKbNumber
Números de KB de atualizações excluídas.
...
Máscaras de pacote do Linux excluídas.
...
### -IncludedKbNumber
Números de KB de atualizações incluídas.
...
Classificações de pacote do Linux incluídas.
...
Máscaras de pacote do Linux incluídas.
...
Classificações incluídas do Windows Update.
...
### -Linux
Indica que a configuração de atualização de software que visa máquinas de sistema operacional Linux.
...
### -NonAzureComputer
Nomes de computador que não são do Az.
...
### -NonAzureQuery
Consulta de grupo dinâmico que não é do Azure.
...
### -RebootOnly
Indica que a configuração de atualização de software reiniciará apenas os máquinas.
...
### -Windows
Indica que a configuração de atualização de software destinado a computadores de sistema operacional windows.
