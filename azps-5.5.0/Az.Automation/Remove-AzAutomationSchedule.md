...
Esse comando exclui o cronograma chamado Agenda01 na conta de automação Contoso17 no grupo de recursos ResourceGroup01.

## Parâmetros

### -AutomationAccountName
Especifica o nome de uma conta de Automação para a qual este cmdlet remove um cronograma.
...
### -Nome
Especifica o nome do cronograma que este cmdlet remove.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos para o qual este cmdlet remove um cronograma.
