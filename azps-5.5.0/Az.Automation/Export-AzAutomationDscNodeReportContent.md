...
Esse conjunto de comandos exporta o relatório mais recente do nó DSC chamado Computador14 para a área de trabalho.

## Parâmetros

### -AutomationAccountName
Especifica o nome de uma conta de Automação.
Esse cmdlet exporta o conteúdo do relatório para um nó DSC que pertence à conta automação especificada por esse parâmetro.
...
### -NodeId
Especifica a ID exclusiva do nó DSC para o qual este cmdlet exporta o conteúdo do relatório.
...
### -OutputFolder
Especifica a pasta de saída onde este cmdlet exporta o conteúdo do relatório.
...
### -ReportId
Especifica a ID exclusiva do relatório de nó DSC que esse cmdlet exporta.
