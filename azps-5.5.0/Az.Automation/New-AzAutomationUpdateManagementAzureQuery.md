...
## Sinopse
Cria o objeto de consulta azure de atualização de software de automação do azure.
...
## Descrição
Cria um objeto de consultas azure de configuração de atualização de software que será usado para criar uma configuração de atualização de software que será executado em um cronograma para atualizar uma lista de máquinas virtuais do azure resolvida dinamicamente.
