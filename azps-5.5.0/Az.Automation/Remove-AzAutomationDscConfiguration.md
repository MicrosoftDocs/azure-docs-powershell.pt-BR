...
## Sinopse
Remove as configurações de DSC da Automação.
...
## Descrição
O cmdlet **Remove-AzAutomationDscConfiguration** remove as configurações de DSC (Configuração de Estado Desejado) APS da Automação do Azure.

## Exemplos

### Exemplo 1

Remove as configurações de DSC da Automação. (gerado automaticamente)
...
Especifica o nome da conta automação que contém configurações DSC que este cmdlet remove.
...
### -Nome
Especifica o nome da configuração DSC que este cmdlet remove.
