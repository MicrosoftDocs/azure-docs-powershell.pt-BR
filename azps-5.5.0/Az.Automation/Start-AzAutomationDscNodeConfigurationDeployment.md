...
## Sinopse
Implanta uma configuração de nó DSC em Automação.
...
## Descrição
O cmdlet **Start-AzAutomationDscNodeConfigurationDeployment** implanta uma configuração de nó DSC (Configuração de Estado Desejado) na Automação do Azure.

## Exemplos

### Exemplo 1: Implantar uma configuração de nó DSC do Azure em Automação
```
...
O comando acima implanta a configuração de nó DSC chamada "Config01.Node1" para a determinada matriz bidimensional de Nomes de Nó. A implantação acontece em estágios.

### Exemplo 2: Agendar uma implantação de configuração de nó DSC do Azure em Automação
```
...
O comando acima agenda uma implantação de uma configuração de nó DSC chamada "Config01.Node1" para a determinada matriz bidimensional de Nomes de Nó. A implantação acontece em estágios e será executada com base no cronograma.
...
### -NodeName
Especifica os nomes dos nós para os quais a Configuração do Nó seria implantada.
...
### -Agendar
Objeto Agendamento de Automação para agendar o trabalho de implantação.
