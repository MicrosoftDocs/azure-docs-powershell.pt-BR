...
## Sinopse
Obtém uma lista de atualizações de software de automação do Azure.
...
## Descrição
O Get-AzAutomationSoftwareUpdateRun cmdlet retorna uma lista de atualizações de software. Como uma configuração de atualização de software tem um cronograma associado, ela pode ser disparada várias vezes. Cada vez que um cronograma é disparado, uma atualização é criada. A atualização é uma agregação do resultado de todas as executar máquina. Você pode obter execução para configurações específicas de atualização de software passando o parâmetro SoftwareUpdateConfigurationName. Para obter uma correção específica, você precisa passar o parâmetro de nome. Você também pode listar executados com status específico, executados visando um sistema operacional específico ou executados após um período específico passando o parâmetro apropriado.

## Exemplos

### Exemplo 1
Esta lista de exemplos de todas as atualizações é disparada por uma configuração de atualização de software específica.
...
### -ID
ID da configuração de atualização de software em execução.
...
### -OperatingSystem
O sistema operacional da operação.
...
A configuração de atualização de software desencadeou a execução.
...
O nome da configuração de atualização de software desencadeou a execução.
...
### -StartTime
Tempo mínimo de início da executar.
