...
## Descrição
O cmdlet **Remove-AzAutomationDscNodeConfiguration** remove metadados das configurações de nó DSC (Configuração de Estado Desejado) APS na Automação do Azure.
...
Esse cmdlet remove metadados para configurações de nó DSC no grupo de recursos especificado por esse parâmetro.
