...
Esse comando altera a ID de assinatura da conexão do Azure chamada ContosoConnection na conta automação chamada AutomationAccount01.

## Parâmetros

### -AutomationAccountName
Especifica o nome da conta automação para a qual esse cmdlet modifica um campo em uma conexão.
