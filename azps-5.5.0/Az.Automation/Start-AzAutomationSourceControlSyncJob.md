...
## Sinopse
Inicia um trabalho de sincronização de controle de origem de automação do Azure.
...
## Descrição
O Start-AzAutomationSourceControlSyncJob cmdlet inicia um trabalho de sincronização de controle de origem de automação do Azure para o nome de controle de origem determinado.
