...
## Descrição
O cmdlet **Get-AzAutomationCertificate** recebe um ou mais certificados de Automação do Azure.
...
Esse comando obtém metadados para todos os certificados da conta automação chamada Contoso17.
...
Especifica o nome da conta automação para a qual este cmdlet recupera um certificado.
