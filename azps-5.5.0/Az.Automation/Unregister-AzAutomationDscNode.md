...
## Descrição
O **cmdlet Unregister-AzAutomationDscNode** remove um nó DSC (Configuração de Estado Desejado) APS do gerenciamento por uma conta de Automação do Azure.
...
Especifica o nome da conta automação da qual este cmdlet remove um nó DSC.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos no qual este cmdlet não contata um nó DSC.
