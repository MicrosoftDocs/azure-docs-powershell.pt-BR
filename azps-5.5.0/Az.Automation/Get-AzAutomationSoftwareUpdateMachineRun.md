...
## Sinopse
Obtém uma lista do computador de configuração de atualização de software de automação do Azure executado.
...
## Descrição
Este cmdlet retorna uma lista de executados por máquina. Cada execução de atualização de software disparará uma execução automática para cada computador de destino de configuração de atualização de software. Para executar uma máquina específica, passe o parâmetro ID. Você pode listar todas as máquinas que são executados, todas são executados para um computador específico, tudo isso é executado com status específico passando os parâmetros correspondentes.

## Exemplos

### Exemplo 1
Este exemplo retorna todas as falhas de máquina executados para a máquina virtual do azure especificada.
...
### -ID
ID da máquina de atualização de software.
...
### -SoftwareUpdateRun
A atualização de software é executado.
...
### -SoftwareUpdateRunId
ID da atualização de software em uso.
...
### -TargetComputer
computador de destino para a máquina de executar.
Pode ser um nome de computador não az ou uma ID de recurso VM do Azure.
