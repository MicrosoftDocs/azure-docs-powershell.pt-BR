...
## Sinopse
Remove uma associação entre uma agenda e uma agenda.
...
O cronograma não inicia mais o livro de executar.

## Exemplos

### Exemplo 1: Remover a associação entre uma agenda e uma agenda
```
...
Esse comando remove a associação entre o runbook chamado Runbk01 e o cronograma chamado Runbk01Sched.
...
### -JobScheduleId
Especifica a ID de um livro de executar agendado.
...
### -RunbookName
Especifica o nome do livro de runbook que este cmdlet divide de um cronograma.
...
### -Nomedo Agendamento
Especifica o nome do cronograma a partir do qual este cmdlet desmarca uma runbook.
