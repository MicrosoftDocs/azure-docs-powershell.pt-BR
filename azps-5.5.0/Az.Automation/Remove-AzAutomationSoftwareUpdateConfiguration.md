...
## Sinopse
Remove uma configuração de atualização de software de automação do Azure.
...
## Descrição
Este cmdlet removeu uma configuração de atualização de software de automação do azure.
...
### -Nome
Nome da configuração de atualização de software a ser removido.
...
### -PassThru
PassThru retorna um objeto que representa o item com o qual você está trabalhando. Por padrão, esse cmdlet não gera saída.
...
A configuração de atualização de software a ser removido.
