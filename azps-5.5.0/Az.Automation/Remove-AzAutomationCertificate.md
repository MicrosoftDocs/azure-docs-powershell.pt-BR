...
## Descrição
O cmdlet **Remove-AzAutomationCertificate** remove um certificado da Automação do Azure.
...
Esse comando remove um certificado chamado Cert01 na conta automação chamada Contoso17.

## Parâmetros

### -AutomationAccountName
Especifica o nome da conta automação para a qual este cmdlet remove um certificado.
...
### -Nome
Especifica o nome do certificado que este cmdlet remove.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos para o qual este cmdlet remove um certificado.
