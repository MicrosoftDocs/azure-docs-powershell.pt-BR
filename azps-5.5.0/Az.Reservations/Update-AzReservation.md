...
Atualiza o AppliedScopeType do especificado como Único e `Reservation` InstanceFlexibility para Ligado.
...
Atualiza o AppliedScopeType do especificado como Compartilhado e `Reservation` InstanceFlexibility para Desligado.

## Parâmetros

### -AppliedScope
SubscriptionId para que `Reservation` isso seja aplicado
...
### -InstanceFlexibility
Se estiver presente, atualizará o valor InstanceFlexibility do `Reservation` . Se não especificado, o valor existente permanecerá inalterado.
...
### -Reserva
Parâmetro de objeto de cano para `Reservation`
...
### -ReservationOrderId
ID da `ReservationOrder` atualização
