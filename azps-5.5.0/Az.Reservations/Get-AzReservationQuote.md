...
## Descrição
Calcular o preço para fazer um pedido de reserva.
...
Depois de obter o catálogo, o cliente pode obter o produto diferente com base na localização. Ao usar essas informações, verifique o preço corretamente

## Parâmetros

### -AppliedScope
Assinatura de que o benefício será aplicado. Obrigatório se --tipo de escopo aplicado for Único. Não especifique se --tipo de escopo aplicado é Compartilhado.
...
### -BillingPlan
As opções de plano de cobrança disponíveis para esta SKU. "Mensal" ou "Upfront"
...
### -InstanceFlexibility
Tipo de Flexibilidade de Instância para atualizar a reserva com.
...
### -Local
Local em que a SKU está disponível.
...
### -Renovar
Definir isso como verdadeiro comprará automaticamente uma nova reserva na data de vencimento.
...
Tipo do recurso para o qual as sKIs devem ser fornecidas.
...
### -SKU
Nome da SKU, obter a lista de SKU usando a apresentação de catálogo de reservas de comando
