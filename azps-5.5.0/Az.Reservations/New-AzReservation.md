...
Depois de calcular o preço, o cliente pode calcular que o RI fornece pelo calculatePrice
...
### -ReservationOrderId
ID do pedido de reserva para comprar, gerar pelo cálculo de ordem de reserva de reservas do Az.
