...
## Descrição
Cria uma suprimição para recomendações, o que permite que uma recomendação específica seja adiada por uma duração específica ou infinitamente.
...
Crie uma suprimição para o nome de recomendação determinado com um nome de suprimição padrão e dias padrão como -1.
...
Uma suprimição é criada para a ID de recomendação determinada.
...
Criando uma suprimição, criando uma Get-AzAdvisorRecommendation para Disable-AzAdvisorRecommendation.
...
### -Nomeda Recomendação
Nomedo Recurso da recomendação
