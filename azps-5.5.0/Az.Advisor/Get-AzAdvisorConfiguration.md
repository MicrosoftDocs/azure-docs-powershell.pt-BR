...
## Sinopse
Obter as configurações do Azure Advisor para a determinada assinatura ou grupo de recursos.
...
Configuração de nível de Grupo de Recursos: pode haver apenas uma configuração para cada Grupo de Recursos em uma assinatura. Excluir é a única propriedade desse tipo de configuração.
