...
## Descrição
Obtém a lista de recomendações do Azure Advisor. Pode ser filtrado por Categoria, ID do recurso, nome etc.
...
Type                 : Microsoft.Advisor/recommendations
```
Obtém a lista de todas as recomendações filtradas por desempenho da categoria.
...
### -ResourceGroupName
Nome do Grupo de Recursos da recomendação
