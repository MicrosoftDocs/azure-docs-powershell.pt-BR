...
Esse comando cancela a correção chamada "correção1" no grupo de recursos "meuRG".

### Exemplo 2: Cancelar a correção de um grupo de gerenciamento por meio de uma canalização
```
PS C:\> $remediation = Get-AzPolicyRemediation -ManagementGroupName "mg1" -Name "remediation1"
PS C:\> $remediation | Stop-AzPolicyRemediation
```

Esse comando cancela a correção chamada "correção1" no grupo de gerenciamento "mg1".
