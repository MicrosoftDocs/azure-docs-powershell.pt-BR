...
### Exemplo 1: Remover um espaço de trabalho Datab sérvios
```powershell
PS C:\> Remove-AzDatabricksWorkspace -ResourceGroupName testgroup -Name databricks-test
```

Esse comando remove um espaço de trabalho Databções de um grupo de recursos.

### Exemplo 2: Remover um espaço de trabalho Databéticos por objeto
```powershell
