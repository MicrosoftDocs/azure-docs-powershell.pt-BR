...
## Sinopse
Atualiza uma configuração do Azure NetApp Files (ANF) active directory para os modificadores opcionais fornecidos.
...
Esse comando executa uma atualização na configuração determinada do Active Directory modificando o nome de usuário para o fornecido.
...
### -AccountObject
A conta do objeto do Active Directory
