...
### -ForceBreak
Se a replicação estiver em transferência de status e você quiser forçar a quebra da replicação, definida como verdadeira
...
### -InputObject
O objeto de volume de destino da ANF com a replicação para quebra
