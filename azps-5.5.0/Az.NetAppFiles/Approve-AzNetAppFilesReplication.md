...
Este comando aprova a replicação no MyAnfVolume.

## Parâmetros

### -NomedaEm conta
O nome da conta ANF do volume da fonte de replicação
...
### -InputObject
O objeto de volume de origem ANF para o destino de replicação autorizado
...
### -Nome
O nome do volume de origem de replicação da ANF
...
### -PassThru
Retornar se a autorização de replicação do volume especificado foi executada
...
### -ResourceGroupName
O grupo de recursos do volume de origem de replicação da ANF
...
### -ResourceId
A ID do recurso do volume de origem de replicação da ANF
