...
## Sinopse
Atualiza uma conta do Azure NetApp Files (ANF) com o novo conjunto de dados. Útil para a exclusão de diretórios ativos associados.
...
### Exemplo 1: modificar uma conta ANF
```
...
Esse comando executa uma atualização na conta determinada. A ausência do active directory significa que ele será removido da conta.

## Parâmetros

### -ActiveDirectory
Uma matriz de tabela hash que representa os diretórios ativos
