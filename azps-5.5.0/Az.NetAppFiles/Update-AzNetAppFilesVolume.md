...
## Sinopse
Atualiza o volume de arquivos Azure NetApp (ANF) de acordo com os modificadores opcionais fornecidos.
...
### Exemplo 1: Atualizar um volume de ANF
```
...
Este comando atualiza o volume da ANF "MyAnfVolume" com o novo tamanho UsageThreshold.
