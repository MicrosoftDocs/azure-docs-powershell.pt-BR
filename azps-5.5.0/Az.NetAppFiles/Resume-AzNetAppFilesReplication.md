...
## Sinopse
Resume/Resync a conexão no volume de destino. Se a operação for realizada no volume de origem, ela reverterá a sincronização da conexão e sincronizará da origem para o destino.
...
## Descrição
Retomar/Ressync a conexão no volume de destino
...
Esse comando retoma a conexão de Replicação ANF no volume "MyDestinationAnfVolume".
...
### -InputObject
O objeto de volume de destino de replicação ANF para ressincron
...
### -Nome
O nome do volume de destino de replicação da ANF
...
### -PassThru
Retornar se o ressíncrono do volume de replicação especificado foi executado
...
### -PoolName
O nome do pool de ANF do volume de replicação
...
### -ResourceGroupName
O grupo de recursos do volume de destino de replicação da ANF
...
### -ResourceId
A ID do recurso do volume de destino de replicação da ANF
