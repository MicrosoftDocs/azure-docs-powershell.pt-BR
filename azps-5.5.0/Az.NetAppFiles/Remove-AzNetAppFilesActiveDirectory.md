...
## Sinopse
Exclui uma configuração do Azure NetApp Files (ANF) do Active Directory.
...
## Descrição
O cmdlet **Remove-AzNetAppFilesActiveDirectory** exclui uma configuração do Active Directory ANF.
...
Esse comando exclui a nova configuração do Active Directory ANF com o nome "MyADName".
