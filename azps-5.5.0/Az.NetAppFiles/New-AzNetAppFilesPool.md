...
## Sinopse
Cria um novo pool de Arquivos Azure NetApp (ANF).
...
Esse comando cria o novo pool ANF "MyAnfPool" dentro da conta "MyAnfAccount".
...
### -AccountObject
A conta do novo objeto de pool
...
### -ServiceLevel
O nível de serviço do pool de ANF
