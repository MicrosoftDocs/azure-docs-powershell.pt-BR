...
## Sinopse
Obtém uma lista dos cofres de backup de Contas do Azure NetApp (ANF).
...
## Descrição
O **cmdlet Get-AzNetAppFilesVault obtém** uma lista de cofres de backup de contas ANF.
...
### -AccountObject
A conta do novo objeto de backup
