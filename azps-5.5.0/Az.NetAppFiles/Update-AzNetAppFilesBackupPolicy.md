...
## Sinopse
Atualiza uma política de backup de Arquivos Azure NetApp (ANF) para os modificadores opcionais fornecidos.
...
Esse comando altera a política de backup "MyBackupPolicy" da ANF para que o DailyBackupsToKeep seja determinado.
...
### -AccountObject
O objeto Conta que contém a Política de Backup a ser atualizada
...
### -DailyBackupsToKeep
Os backups diários contam para manter
...
### -ResourceId
A ID do recurso da Política de Backup da ANF
...
### -WeeklyBackupsToKeep
Os backups semanais contam para manter
...
### -YearlyBackupsToKeep
A contagem anual de backups deve ser guardada
