...
## Sinopse
Atualiza um pool de Arquivos Azure NetApp (ANF) de acordo com os modificadores opcionais fornecidos.
...
## Descrição
O **cmdlet Update-AzNetAppFilesPool** modifica um pool ANF.
...
Esse comando altera o pool de ANF "MyAnfPool" para ter o tamanho determinado e o QosType.
...
### -AccountObject
O objeto da conta que contém o pool de atualizações
...
### -QosType
O tipo de qos do pool. Os valores possíveis incluem: 'Automático', 'Manual'
