...
## Sinopse
Remover/excluir a conexão de replicação no volume de destino e enviar a versão para a replicação de origem
...
Esse comando remove a conexão de Replicação ANF no volume "MyDestinationAnfVolume".
...
### -InputObject
O volume de destino da ANF com a replicação a ser removido
...
### -PassThru
Retornar se a replicação ANF especificada foi removida com êxito
