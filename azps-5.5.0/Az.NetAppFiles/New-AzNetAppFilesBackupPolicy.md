...
## Sinopse
Cria uma nova política de backup Azure NetApp Files (ANF) para uma conta ANF.
...
Esse comando cria a nova política de backup ANF para a conta ANF chamada conta "MyAccount".
...
### -AccountObject
O objeto Conta da nova Política de Backup
