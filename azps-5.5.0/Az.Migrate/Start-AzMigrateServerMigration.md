...
### -TargetObjectID
Especifica o servidor de resposta para o qual a migração precisa ser iniciada.
...
### -TurnOffSourceServer
Especifica se o servidor de origem deve ser desligado após a migração.
...
INPUTOBJECT: <IMigrationItem> especifica o servidor de replicação para o qual a migração precisa ser iniciada. O objeto do servidor pode ser recuperado usando o cmdlet Get-AzMigrateServerReplication servidor.
