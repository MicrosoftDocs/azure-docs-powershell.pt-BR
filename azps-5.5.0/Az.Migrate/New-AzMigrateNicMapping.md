...
## Sinopse
Cria um objeto para atualizar as propriedades NIC de um servidor de replicação.
...
### -TargetNicIP
Especifica o IP dentro da sub-rede de destino a ser usado para a NIC.
...
### -TargetNicSubnet
Especifica o nome da Sub-rede da NIC na Rede Virtual de destino para a qual o servidor precisa ser migrado.
