...
### [Get-AzMySqlFlexibleServerLocerBasedCapability](Get-AzMySqlFlexibleServerLocationBasedCapability.md)
...
Cria uma nova regra de firewall para servidor flexível MySQL
...
### [Novo-AzMySqlServer](New-AzMySqlServer.md)
...
Use Update-AzMySqlServer em vez disso, se quiser atualizar o AdministratorLoginPassword, sku etc.
...
Atualiza informações sobre uma configuração de um servidor mySQL flexível.
