...
### Exemplo 1: Lista todas as Regras de Rede Virtual no servidor MySql especificado
```powershell
...
Este cmdlet lista todas as Regras de Rede Virtual no servidor MySql especificado.

### Exemplo 2: Obter Regra de Rede Virtual por nome
```powershell
...
Este cmdlet obtém a Regra de Rede Virtual por nome.

### Exemplo 3: Obter a Regra de Rede Virtual por identidade
```powershell
