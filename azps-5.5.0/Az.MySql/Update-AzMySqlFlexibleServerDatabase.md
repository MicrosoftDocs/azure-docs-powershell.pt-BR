...
### Exemplo 1: Atualizar um banco de dados do servidor MySql por nome
```powershell
...
Atualizar um banco de dados por nome de recurso.

### Exemplo 2: Atualizar o banco de dados MySql por parâmetro.
```powershell
...
Atualizar um banco de dados por parâmetro
