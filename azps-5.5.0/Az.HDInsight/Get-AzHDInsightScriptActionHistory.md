...
## Descrição
O cmdlet **Get-AzHDInsightScriptActionHistory** obtém o histórico de ações de script de um cluster HDInsight do Azure e o lista em ordem cronológica inversa ou obtém detalhes de uma ação de script executada anteriormente.

## Exemplos

### Exemplo 1: Obter o histórico de execução de ações de script para um cluster
```
