...
## Descrição
O cmdlet **Disable-AzHDInsightMonitoring** desabilita o monitoramento em um cluster HDInsight do Azure.
...
O monitoramento será desabilitado no cluster HDInsight e logs relevantes deixarão de fluir para o espaço de trabalho de monitoramento.
