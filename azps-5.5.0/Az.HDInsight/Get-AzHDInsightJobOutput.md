...
## Descrição
O cmdlet **Get-AzHDInsight JobOutput** obtém a saída de log de um trabalho da conta de Armazenamento associada a um cluster HDInsight do Azure.
...
Esse comando obtém a saída de log do cluster chamado seu-hadoop-001.
