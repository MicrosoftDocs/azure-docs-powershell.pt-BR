...
## Descrição
O cmdlet **Get-AzHDInsightPersistedScriptAction** obtém as ações de script persistentes de um cluster HDInsight do Azure e as lista em ordem cronológica ou obtém detalhes de uma ação de script especificada.
...
Esse comando recebe ações de script persistentes no cluster chamado seu-hadoop-001.
