...
## Descrição
O cmdlet **Start-AzHDInsight Job** inicia um trabalho definido do Azure HDInsight em um cluster especificado.
Isso pode ser um trabalho do MapReduce, um trabalho de Streaming mapreduce, um trabalho de Colmeia ou um trabalho de porção.
...
### -JobDefinition
Especifica o trabalho para começar no cluster HDInsight do Azure.
