...
### -HiveMetastore
Especifica a metadaria para armazenar metadados de Colmeia.
...
### -OozieMetastore
Especifica a metadados para armazenar metadados Oozie.
...
Obtém ou define a ID de recurso da conta de armazenamento.
...
Use Get-AzVMSize para tamanhos VM aceitáveis e veja a página de preços da HDInsight.
Este parâmetro é válido somente para clusters HBase ou Storm.
