...
## Descrição
O cmdlet **Wait-AzHDInsight Job** aguarda a conclusão ou falha de um trabalho HDInsight do Azure.

## Exemplos

### Exemplo 1: Aguardar a conclusão ou a falha de um trabalho
```
PS C:\># Cluster info
...
Esse comando aguarda a conclusão ou a falha de um trabalho.
...
### -TimeoutInSeconds
O tempo total para aguardar a conclusão do trabalho em segundos.
...
O tempo de espera entre verificações de status do trabalho, em segundos.
