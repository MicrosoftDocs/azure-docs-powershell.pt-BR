...
## Descrição
O cmdlet **New-AzHDInsightClusterAutoscaleScheduleCondition** cria uma condição de escala automática baseada em Cronograma.
...
Esse comando cria uma condição em que o cluster escala automaticamente para 5 nós de trabalhadores às 09:00 todas as segundas-feiras, quartas-feiras.

### Exemplo 2: Habilitar a escala automática baseada em agenda de um cluster com condição de escala automática.
```powershell
...
### -Dia
Obtém ou define os dias da condição de agendamento em Escala Automática.
...
### -Hora
Obtém ou define o horário da condição de agendamento em Escala Automática.
...
### -WorkerNodeCount
Obtém ou define a contagem de escala de trabalho agendada da condição de agendamento de escala automática.
