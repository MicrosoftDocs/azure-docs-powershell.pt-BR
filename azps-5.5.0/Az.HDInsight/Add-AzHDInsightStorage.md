...
Esse comando adiciona uma entrada de conta de armazenamento de blob à configuração HDInsight chamada hadoop-001.
...
### -StorageAccountKey
Especifica a chave da conta de armazenamento para que a conta de armazenamento seja adicionada ao novo cluster.
