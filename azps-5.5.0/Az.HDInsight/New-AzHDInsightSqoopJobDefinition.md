...
## Descrição
O cmdlet **New-AzHDInsightSqoop JobDefinition** define um objeto de trabalho Sqoop para ser usado com um cluster HDInsight do Azure.
...
Esse comando cria uma definição de trabalho do Sqoop.
...
### -LibDir
Especifica o diretório da biblioteca para o trabalho do Sqoop.
