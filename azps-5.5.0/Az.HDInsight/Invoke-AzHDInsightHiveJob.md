...
## Descrição
O cmdlet **Invoke-AzHDInsightHiveJob** envia uma consulta Desmaio para um cluster HDInsight do Azure e recupera os resultados da consulta em uma única operação.
...
### Exemplo 1: Enviar uma consulta Descarada para um cluster HDInsight do Azure
```
...
Esse comando envia a consulta MOSTRAR TABELAS para o cluster chamado seu-hadoop-001.
...
Especifica a chave da conta para a conta de armazenamento padrão que o cluster HDInsight usa.
...
### -Define
Especifica valores de configuração hadoop para definir quando um trabalho é executado.
...
### -Arquivos
Especifica um conjunto de arquivos necessários para um trabalho de Colmeia.
...
### -JobName
Especifica o nome de um trabalho de Colmeia.
Se você não especificar esse parâmetro, este cmdlet usará o valor padrão: "Colmeia: \<first 100 characters of Query\> ".
