...
## Descrição
O cmdlet **Get-AzHDInsight Job** obtém trabalhos recentes para um cluster HDInsight especificado do Azure em ordem cronológica inversa, com o trabalho mais recente na parte superior da lista.
Receba um trabalho específico fornecendo o parâmetro *JobId.*

## Exemplos

### Exemplo 1: Obter trabalhos recentes para um cluster HDInsight do Azure especificado
```
PS C:\># Cluster info
...
### -NumOfJobs
Especifica o número de trabalhos a recuperar.
