...
## Descrição
O cmdlet **New-AzHDInsightPig JobDefinition** define um objeto de trabalho de porre para ser usado com um cluster HDInsight do Azure.

## Exemplos

### Exemplo 1: Criar uma definição de trabalho de leitões
```
PS C:\># Cluster info
...
Esse comando cria uma definição de trabalho de Porão.
...
### -Consulta
Especifica a consulta Descarros.
