...
Esse comando define a configuração de escala automática baseada em carga de um cluster HDInsight do Azure.
...
Esse comando define a configuração de escala automática baseada em Agenda do cluster HDInsight.
...
Esse comando define a configuração de escala automática do cluster HDInsight com base em outro cluster.
