...
## Descrição
O cmdlet **Add-AzHDInsightMetastore** adiciona uma Metadadosdoca ou Oozie ao objeto de configuração HDInsight criado pelo cmdlet New-AzHDInsightClusterConfig.
Uma metadaria é um banco de dados SQL que pode ser usado para armazenar metadados para Terrulário, Oozie ou ambos.

## Exemplos

### Exemplo 1: Adicionar uma metadaria de banco de dados SQL ao objeto de configuração de cluster
```
...
Esse comando adiciona uma metadaria de banco de dados SQL ao cluster chamado hadoop-001.

### Exemplo 2: Adicionar um banco de dados Ambari personalizado ao objeto de configuração de cluster
```
PS C:\># Primary storage account info
PS C:\> $storageAccountResourceGroupName = "Group"
PS C:\> $storageAccountResourceId = "yourstorageaccountresourceid"
...
Esse comando adiciona um banco de dados Ambari personalizado ao cluster chamado hadoop-002.
...
### -Credencial
Especifica as credenciais a usar para o banco de dados do AzureSQL Server.
...
Especifica o banco de dados na instância do AzureSQL Server a ser usado para essa metadaria.
...
### -MetastoreType
Especifica o tipo de metadados.
Os valores possíveis são OozieMetastore ou OozieMetastore.
...
### -SqlAzureServerName
Especifica a instância do AzureSQL Server a ser usada para essa metadados.
