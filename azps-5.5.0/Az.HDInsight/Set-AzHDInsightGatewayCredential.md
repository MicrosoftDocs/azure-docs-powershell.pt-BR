...
## Descrição
O cmdlet **Set-AzHDInsightGatewayCredential** define a credencial do gateway de um cluster HDInsight do Azure.
...
Esse comando define a credencial do gateway do cluster chamado seu-hadoop-001 por conjunto de parâmetros de nome.
...
Esse comando define a credencial do gateway do cluster chamado seu-hadoop-001 pelo conjunto de parâmetros ResourceId.
...
Esse comando define a credencial do gateway do cluster chamado seu-hadoop-001 pelo conjunto de parâmetros InputObject.
