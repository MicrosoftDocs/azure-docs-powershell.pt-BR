...
Crie um Objeto PSFrontendEndpoint para criação de Porta Frontal.
...
### -CertificateType
o tipo de certificado usado para conexões seguras com um frontendEndpoint
...
### -SecretVersion
A versão do segredo do Cofre de Chaves representando o certificado PFX completo
...
Se você quer permitir affinity de sessão neste host.
...
O TTL a ser usado em segundos para affinidade da sessão, se aplicável. O valor padrão é 0
...
### -Cofre
O Cofre de Teclas que contém o certificado SSL
...
### -WebApplicationFirewallPolicyLink
A ID de recurso da política de Firewall do Aplicativo Web para cada host (se aplicável)
