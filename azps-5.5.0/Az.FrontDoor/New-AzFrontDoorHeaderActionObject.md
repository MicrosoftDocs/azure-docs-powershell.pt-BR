...
## Descrição
Cria um objeto PSHeaderAction para a criação do objeto PSRulesEngineAction.
...
### -HeaderActionType
Que tipo de manipulação aplicar ao header.
...
### -HeaderName
O nome do header ao que esta ação se aplicará.
...
### -Valor
O valor com o que atualizar o nome do determinado header.
