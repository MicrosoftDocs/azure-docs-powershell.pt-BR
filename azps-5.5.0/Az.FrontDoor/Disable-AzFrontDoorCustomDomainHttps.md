...
### Exemplo 1: Desabilitar HTTPS para um domínio personalizado com o FrontDoorName e o ResourceGroupName.
```powershell
...
Desabilite HTTPS para um domínio personalizado "frontendpointname1-custom-xyz" com o FrontDoorName como "frontdoor1" e ResourceGroupName como "resourcegroup1".
...
Desabilitar HTTPS para um domínio personalizado com o objeto PSFrontendEndpoint.
...
Desabilite HTTPS para um domínio personalizado "frontendpointname1-custom-xyz" com ResourceId como $resourceId.
...
### -ResourceId
ID do recurso do ponto de extremidade Porta da Frente para desabilitar https
