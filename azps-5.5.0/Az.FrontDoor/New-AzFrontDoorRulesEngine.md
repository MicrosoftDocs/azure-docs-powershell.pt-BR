...
Use o cmdlet "New-AzFrontDoorRulesEngineRule" para construir regras de mecanismo de regras para passar para o parâmetro "-Regras" deste cmdlet.
...
Crie uma nova configuração de mecanismo de regras para a porta frontal especificada.
...
### -Regra
Uma lista de regras que define uma configuração específica do Mecanismo de Regras.
