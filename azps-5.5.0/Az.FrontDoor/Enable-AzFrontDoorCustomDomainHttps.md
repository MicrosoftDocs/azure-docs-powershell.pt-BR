...
### Exemplo 1: Habilitar HTTPS para um domínio personalizado com o FrontDoorName e o ResourceGroupName usando certificado gerenciado pelo Front Door.
```powershell
...
Habilita o HTTPS para um domínio personalizado "frontendpointname1-custom-xyz" que faz parte da "frontdoor1" do grupo de recursos "resourcegroup1" usando o certificado gerenciado pela Front Door.

### Exemplo 2: Habilitar HTTPS para um domínio personalizado com o FrontDoorName e o ResourceGroupName usando o próprio certificado no Cofre de Teclas.
```powershell
...
Habilita o HTTPS para um domínio personalizado "frontendpointname1-custom-xyz" que faz parte do "frontdoor1" do grupo de recursos "resourcegroup1" usando o certificado gerenciado pela Front Door.

### Exemplo 3: Habilitar HTTPS para um domínio personalizado com objeto PSFrontendEndpoint usando certificado gerenciado pela Front Door.
```powershell
...
Habilita o HTTPS para um domínio personalizado com o objeto PSFrontendEndpoint usando certificado gerenciado pelo Front Door.

### Exemplo 4: Habilitar HTTPS para um domínio personalizado com id de recurso usando certificado gerenciado pelo Front Door.
```powershell
...
Habilita o HTTPS para um domínio personalizado "nomedo frontendpoint1-custom-xyz" com a ID do recurso $resourceId usando certificado gerenciado pelo Front Door.
...
### -InputObject
O objeto do ponto de extremidade Frontend a ser atualizado.
...
### -MinimumTlsVersion
A versão TLS mínima necessária para os clientes estabelecerem um handshake SSL com o Front Door.
...
### -ResourceId
ID do Recurso do ponto de extremidade Porta da Frente para habilitar https
...
### -SecretName
O nome do segredo do Cofre de Chaves representando o certificado PFX completo
...
### -VaultId
A ID do Cofre de Teclas que contém o certificado SSL
