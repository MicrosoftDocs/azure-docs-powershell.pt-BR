...
## Descrição
O cmdlet **New-AzFrontDoorBackendpoolsSettingObject** cria um novo objeto PSBackendPoolsSettings para criação da Porta da Frente.
...
Se você quer impor a verificação de nome de certificado em solicitações HTTPS a todos os pools de back-end.
Não há efeito em solicitações que não são HTTPS.
...
Enviar e receber tempo de tempo de espera sobre a solicitação de encaminhamento para o back-end. Quando o tempo é atingido, a solicitação falha e retorna.
