...
Remova a política WAF chamada $policyName no $resourceGroupName.
...
Remova todas as políticas WAF $resourceGroupName.
...
### -Nome
O nome da política WAF a ser excluído.
...
### -ResourceGroupName
O grupo de recursos ao qual a política WAF pertence.
...
### -ResourceId
ID do Recurso da política WAF a ser excluído
