...
### -Operador
Operador a ser usado ao corresponder ao seletor, Igual aAny significa nenhum seletor (todas as variáveis correspondentes do tipo especificado)
...
### -Seletor
Padrão de seletor para corresponder usando o operador (se o operador não for Igual aAny)
...
### -Variável
Corresponder variável. Os valores possíveis são RequestHeaderNames, RequestCookieNames, QueryStringArgNames, RequestOokiePostArgNames.
Por exemplo, QueryStringArgNames é uma exclusão dos parâmetros GET que coincidem com o seletor com o operador determinado.
