...
Esse comando regenera a chave de acesso principal secreta usada para autenticar conexões com o banco de dados do Cache Corporativo Redis chamado MyCache.
...
Esse comando regenera a chave de acesso secreta secundária usada para autenticar conexões com o banco de dados do Cache Corporativo Redis chamado MyCache.
...
### -KeyType
Qual chave de acesso deve ser regenerada.
