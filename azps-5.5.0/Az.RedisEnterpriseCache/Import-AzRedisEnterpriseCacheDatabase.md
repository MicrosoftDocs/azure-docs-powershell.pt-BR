...
Esse comando importa um arquivo de banco de dados para o banco de dados do Cache Corporativo Redis chamado MyCache.

### Exemplo 2: Importar banco de dados (usando exemplo de nome de arquivo)
```powershell
#[SuppressMessage("Microsoft.Security", "CS002:SecretInNextLine", Justification="Invalid SAS token")]
...
### -SasUri
SAS Uri para o blob de destino a ser importado
