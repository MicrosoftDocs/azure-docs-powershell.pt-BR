...
### Exemplo 1: Exportar banco de dados
```powershell
...
Esse comando exporta o banco de dados do Cache Corporativo Redis chamado MyCache para um arquivo de banco de dados.
...
### -SasUri
Uri do SAS para o diretório de destino a ser exportado para
