...
## Descrição
O cmdlet **Get-AzContainerGroup** obtém um grupo de contêineres especificado ou todos os grupos de contêineres em um grupo de recursos ou na assinatura.
...
O comando obtém os grupos de contêineres no grupo de `demo` recursos.
