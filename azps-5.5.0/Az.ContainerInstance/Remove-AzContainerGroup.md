...
### Exemplo 2: remove um grupo de contêineres por piping
```
PS C:\> Get-AzContainerGroup -ResourceGroupName MyResourceGroup -Name MyContainer | Remove-AzContainerGroup
```

Esse comando remove um grupo de contêineres por piping.
...
Esse comando remove um grupo de contêineres por ID de recurso.
