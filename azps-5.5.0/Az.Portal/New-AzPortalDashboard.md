...
Para construir, confira a seção ANOTAÇÕES para propriedades do PAINEL e crie uma tabela hash.
...
PAINEL: <IDashboard> a definição de recurso de painel compartilhado.
  ...
  - `[Lens <IDashboardPropertiesLenses>]`: as lentes do painel.
    - `[(Any) <IDashboardLens>]`: indica que qualquer propriedade pode ser adicionada a este objeto.
  - `[Metadata <IDashboardPropertiesMetadata>]`: Os metadados do painel.
    - `[(Any) <Object>]`: indica que qualquer propriedade pode ser adicionada a este objeto.
