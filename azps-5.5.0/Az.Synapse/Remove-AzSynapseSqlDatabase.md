...
Esse comando exclui um banco de dados SQL do Azure Synapse Analytics por meio de pipeline.
...
Esse comando exclui um banco de dados SQL do Azure Synapse Analytics com a ID de recurso especificada.
