...
## Descrição
O cmdlet **Update-AzSynapseIntegrationRuntimeNode** atualiza as propriedades do nó de tempo de execução de integração auto-hospedado em um espaço de trabalho. Atualmente, só há suporte para a atualização de 'ConcurrentJobsLimit'.
