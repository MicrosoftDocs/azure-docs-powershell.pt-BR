...
## Sinopse
Aguarda a conclusão de um trabalho do Synapse Analytics Spark.
...
## Descrição
O cmdlet **Wait-AzSynapseSpark Job** aguarda a conclusão de um trabalho do Azure Synapse Analytics.
...
Esse comando aguarda a conclusão do trabalho com a ID especificada.
...
### -TimeoutInSeconds
A quantidade máxima de tempo para aguardar antes do erro. O valor padrão é nunca ter tempo de tempo.
...
O intervalo de votação entre verifica o status do trabalho em segundos.
