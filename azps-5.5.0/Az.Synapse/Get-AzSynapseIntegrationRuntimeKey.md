...
## Descrição
O cmdlet **Get-AzSynapseIntegrationRuntimeKey** obtém chaves para um tempo de execução de integração. As teclas são usadas para registrar um nó de tempo de execução de integração.
