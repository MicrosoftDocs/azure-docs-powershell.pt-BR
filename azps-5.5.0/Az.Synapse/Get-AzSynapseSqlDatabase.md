...
## Sinopse
Obtém um banco de dados SQL do Synapse Analytics.
...
## Descrição
[Este recurso está em uma visualização limitada, inicialmente acessível somente a determinadas assinaturas.] O cmdlet **Get-AzSynapseSqlDatabase** obtém informações sobre um banco de dados SQL do Azure Synapse Analytics.
...
Esse comando obtém todos os bancos de dados SQL sob um espaço de trabalho.
...
Esse comando obtém o banco de dados SQL no espaço de trabalho ContosoWorkspace com o nome ContosoSqlDatabase.
...
Esse comando obtém todos os bancos de dados SQL em um espaço de trabalho por meio do pipeline.
...
Esse comando obtém o banco de dados SQL com a ID de recurso especificada.
...
### -ResourceId
Identificador de recursos do Banco de Dados SQL Synapse.
