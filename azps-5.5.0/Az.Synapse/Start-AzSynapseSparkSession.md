...
## Sinopse
Inicia uma sessão synapse Analytics Spark.
...
## Descrição
O cmdlet **Start-AzSynapseSparkSession** inicia uma sessão synapse Analytics Spark.
...
Esse comando inicia uma sessão do Azure Synapse Analytics Spark.
...
Esse comando inicia uma sessão do Azure Synapse Analytics Spark por meio do pipeline.
