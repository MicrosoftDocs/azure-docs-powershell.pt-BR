...
## Sinopse
Cria uma Regra de Firewall de Análise Synapse.
...
## Descrição
O cmdlet **New-AzSynapseFirewallRule** cria uma Regra de Firewall de Análise Synapse do Azure.
...
Esse comando cria uma regra de firewall chamada ContosoFirewallRule sob o espaço de trabalho ContosoWorkspace com o nome ContosoFirewallRule.
...
Esse comando cria uma regra de firewall chamada ContosoFirewallRule sob um espaço de trabalho por meio de pipeline.
...
Esse comando cria uma regra de firewall que permite todos os ips do azure sob um espaço de trabalho.
