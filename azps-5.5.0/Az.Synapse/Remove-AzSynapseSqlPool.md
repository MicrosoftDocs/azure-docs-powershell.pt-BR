...
Esse comando exclui um pool SQL do Azure Synapse Analytics por meio do pipeline.
...
Esse comando exclui um pool SQL do Azure Synapse Analytics com a ID de recurso especificada.
