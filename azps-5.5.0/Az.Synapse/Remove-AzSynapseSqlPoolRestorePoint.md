...
## Sinopse
Exclui um ponto de restauração de pool SQL do Synapse Analytics.
...
## Descrição
O cmdlet **Remove-AzSynapseSqlPoolRestorePoint** exclui permanentemente um ponto de restauração do pool SQL do Azure Synapse Analytics.
...
Esse comando exclui um ponto de restauração de pool sql do Azure Synapse Analytics.
...
Esse comando exclui um ponto de restauração de pool SQL do Azure Synapse Analytics através do pipeline.
...
Esse comando exclui um ponto de restauração de pool sql do Azure Synapse Analytics com a ID de recurso especificada.
...
### -InputObject
Objeto de entrada de tempo de criação de ponto de restauração do pool SQL, geralmente passado pelo pipeline.
...
Nome da Data de Criação do Ponto de Restauração SQL Synapse.
