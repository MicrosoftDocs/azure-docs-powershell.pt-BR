...
## Sinopse
Remove as configurações de auditoria de um Espaço de Trabalho do Azure Synapse Analytics.
...
Esse comando remove as configurações de auditoria de um Espaço de Trabalho do Azure Synapse Analytics chamado ContosoWorkspace.
...
Esse comando remove as configurações de auditoria de um Espaço de Trabalho do Azure Synapse Analytics chamado ContosoWorkspace por meio de pipeline.
