...
## Sinopse
Cancela um trabalho do Synapse Analytics Spark.
...
## Descrição
O cmdlet **Stop-AzSynapseSparkJob** cancela um trabalho do Synapse Analytics Spark.
...
Este comando cancela um trabalho do Synapse Analytics Spark.
...
Esse comando cancela um trabalho do Synapse Analytics Spark por meio do pipeline.
