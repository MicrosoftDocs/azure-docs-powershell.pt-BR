...
Esse comando exibe informações sobre o tempo de execução de integração chamado "test-selfhost-ir" no espaço de trabalho chamado ContosoWorkspace.
...
Esse comando exibe o status de detalhes sobre o tempo de execução de integração chamado "test-selfhost-ir" no espaço de trabalho chamado ContosoWorkspace.
