...
Habilitar a política de auditoria de armazenamento em blob de um Espaço de Trabalho do Azure Synapse Analytics chamado ContosoWorkspace.
...
Desabilite a política de auditoria de armazenamento em blob de um Espaço de Trabalho do Azure Synapse Analytics chamado ContosoWorkspace.
...
Habilitar a política de auditoria de armazenamento em blob de um Espaço de Trabalho de Análise do Azure Synapse chamado ContosoWorkspace com filtragem avançada usando um predicado T-SQL.
...
Remova a configuração de filtragem avançada da política de auditoria de um Espaço de Trabalho do Azure Synapse Analytics chamado ContosoWorkspace.
...
Desabilite a política de auditoria de armazenamento em blob de um Espaço de Trabalho do Azure Synapse Analytics chamado ContosoWorkspace por meio de pipeline.
...
Esses grupos abrangem todas as instruções SQL e os procedimentos armazenados executados no banco de dados e não devem ser usados em combinação com outros grupos, pois isso resultará em logs de auditoria duplicados.
