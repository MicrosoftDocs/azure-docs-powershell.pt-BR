...
## Sinopse
Obtém um pool SQL do Synapse Analytics.
...
Esse comando obtém o pool SQL no espaço de trabalho ContosoWorkspace com o nome ContosoSqlPool.
...
### -Versão
[Este recurso está em uma visualização limitada, inicialmente acessível somente a determinadas assinaturas.] Versão do pool SQL Synapse. Por exemplo, 2 ou 3.
