...
## Sinopse
Obtém as configurações de auditoria de um Espaço de Trabalho do Azure Synapse Analytics.
...
## Descrição
O cmdlet **Get-AzSynapseSqlAuditSetting obtém** as configurações de auditoria de um Espaço de Trabalho do Azure Synapse Analytics.
...
Obtém as configurações de auditoria de um espaço de trabalho chamado ContosoWorkspace.
...
Obtém as configurações de auditoria de um espaço de trabalho chamado ContosoWorkspace por meio de pipeline.
