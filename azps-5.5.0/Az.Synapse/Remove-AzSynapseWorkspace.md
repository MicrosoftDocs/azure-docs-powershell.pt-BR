...
## Sinopse
Exclui um espaço de trabalho do Synapse Analytics.
...
## Descrição
O cmdlet **Remove-AzSynapseWorkspace** exclui permanentemente um espaço de trabalho do Azure Synapse Analytics.
...
Esse comando exclui um espaço de trabalho do Azure Synapse Analytics.
...
Esse comando exclui um espaço de trabalho do Azure Synapse Analytics por meio de pipeline.
...
Esse comando exclui um espaço de trabalho do Azure Synapse Analytics por meio de pipeline com a ID de recurso especificada.
