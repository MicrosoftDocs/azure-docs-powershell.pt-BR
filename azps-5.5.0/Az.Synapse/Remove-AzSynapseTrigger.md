...
## Descrição
O **cmdlet Remove-AzSynapseTrishot** remove um gatilho de um espaço de trabalho.
...
Remova um gatilho chamado ContosoTrição do espaço de trabalho ContosoWorkspace.
...
Remova um gatilho chamado ContosoTri pipeline do espaço de trabalho ContosoWorkspace.
