...
## Sinopse
Obtém uma atribuição de função Análise Synapse.
...
## Descrição
O cmdlet **Get-AzSynapseRoleAssignment obtém** uma Azure Synapse Analytics Role Assignment.
Se você não especificar uma definição de função ou um nome de entidade de usuário, este cmdlet obtém todas as atribuições de função.
...
Esse comando obtém todas as atribuições de função em um espaço de trabalho.
...
Esse comando obtém todas as atribuições de função no espaço de trabalho ContosoWorkspace com o nome da função ContosoRole.
...
Esse comando obtém uma atribuição de função no espaço de trabalho ContosoWorkspace com o nome da função ContosoRole e o nome de usuário principal ContosoName.
...
### -RoleDefinitionName
Nome da Função atribuída ao diretor.
