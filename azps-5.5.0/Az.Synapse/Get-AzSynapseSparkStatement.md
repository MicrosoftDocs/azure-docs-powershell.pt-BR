...
## Sinopse
Obtém uma instrução Synapse Analytics Spark.
...
## Descrição
O cmdlet **Get-AzSynapseSparkStatement** obtém informações sobre uma instrução Azure Synapse Analytics Spark.
...
Esse comando obtém a instrução Spark com a ID especificada.
