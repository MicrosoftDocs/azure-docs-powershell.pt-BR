...
Esse comando cria um espaço de trabalho do Synapse Analytics chamado ContosoWorkspace que usa o Data Store de Dados contosoAdlGenStorage, no grupo de recursos chamado ContosoResourceGroup.
...
O nome de conta de armazenamento padrão do ADLS Gen2.
...
Nome de uma rede virtual gerenciada por Synapse dedicada para o espaço de trabalho Azure Synapse.
...
Credenciais de administrador sql.
