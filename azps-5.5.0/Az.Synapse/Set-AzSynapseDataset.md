...
## Sinopse
Cria ou atualiza um conjuntos de dados no espaço de trabalho.
...
## Descrição
O cmdlet **Set-AzSynapseDataset** cria um conjunto de dados ou atualiza um conjunto de dados existente no espaço de trabalho.
...
Esse comando cria um grupo de dados chamado ContosoDataset no espaço de trabalho chamado ContosoWorkspace.
O comando baseia o conjuntos de dados em informações no Dataset.jsno arquivo.
