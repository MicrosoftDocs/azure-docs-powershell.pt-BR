...
## Sinopse
Cria um banco de dados SQL do Synapse Analytics.
...
### -Colagem
O colamento define as regras que classificação e comparação de dados e não podem ser alteradas após a criação do pool sql.
O colamento padrão é SQL_Latin1_General_CP1_CI_AS.
