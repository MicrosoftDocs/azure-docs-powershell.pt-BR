...
## Descrição
O cmdlet **Get-AzSynapseIntegrationRuntimeNode** obtém as informações de detalhes de um nó de tempo de execução de integração.
...
O cmdlet obtém informações do nó chamado "Node_1" em tempo de execução de integração hospedada auto-hospedado "test-selfhost-ir" no espaço de trabalho ContosoWorkspace.
...
O cmdlet obtém informações do nó chamado "Node_1" em tempo de execução de integração hospedada auto-hospedado 'test-selfhost-ir' no espaço de trabalho 'test-df-eu2', incluindo o endereço IP.
