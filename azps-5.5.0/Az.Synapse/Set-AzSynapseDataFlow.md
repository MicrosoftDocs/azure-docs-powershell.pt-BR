...
Esse comando cria um fluxo de dados chamado ContosoDataFlow no espaço de trabalho chamado ContosoWorkspace.
O comando baseia o fluxo de dados em informações no DataFlow.jsno arquivo.
