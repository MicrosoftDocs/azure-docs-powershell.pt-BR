...
## Sinopse
Retorna informações sobre o gatilho executado.
...
## Descrição
O **comando Get-AzSynapseTriframeRun** retorna informações detalhadas sobre o gatilho executado para o gatilho especificado no determinado prazo.
...
Este comando mostra informações sobre as executados para ContosoTrigger no espaço de trabalho ContosoWorkspace que começou entre "2018-09-01T21:00" e "2019-09-01T21:00".
...
Este comando mostra informações sobre as executados para ContosoTri pipeline no espaço de trabalho ContosoWorkspace que começou entre "2018-09-01T21:00" e "2019-09-01T21:00" por meio do pipeline.
...
### Microsoft.Azure.Commands.Synapse.Models.PSTri googleRun
