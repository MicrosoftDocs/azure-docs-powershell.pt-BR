...
## Descrição
O cmdlet **Get-AzSynapseSqlPoolTransparentDataEncryption** obtém o estado de Criptografia de Dados Transparentes (TDE) para um pool SQL do Azure Synapse Analytics.
...
Esse comando obtém o status do TDE para o pool SQL chamado ContosoSqlPool no espaço de trabalho chamado ContosoWorkspace.
