...
Se você não especificar um nome de regra, esse cmdlet obtém todas as regras.
...
Esse comando obtém a regra de firewall no espaço de trabalho ContosoWorkspace com o nome ContosoFirewallRule.
