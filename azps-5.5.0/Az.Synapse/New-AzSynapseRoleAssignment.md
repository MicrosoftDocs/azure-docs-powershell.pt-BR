...
## Sinopse
Cria uma atribuição de função Análise Synapse.
...
## Descrição
O **cmdlet New-AzSynapseRoleAssignment cria** uma atribuição de função Azure Synapse Analytics.
...
Esse comando atribui a ContosoRole ao usuário cujo nome principal é ContosoName por meio de pipeline.
