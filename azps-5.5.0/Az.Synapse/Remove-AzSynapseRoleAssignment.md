...
## Sinopse
Exclui uma atribuição de função Análise Synapse.
...
Esse comando exclui uma atribuição de função Análise Synapse do Azure com uma ID de atribuição de função.
...
Esse comando exclui uma atribuição de função do Azure Synapse Analytics com um nome de função e um nome de entidade de usuário.
