...
## Sinopse
Interrompe a executar um pipeline em um espaço de trabalho.
...
## Descrição
O cmdlet **Stop-AzSynapse PipelinelineRun** interrompe uma operação de pipeline em um espaço de trabalho especificado com a ID de executar pipeline.
...
Esse comando interrompe a operação do pipeline com a ID b9730a13-aa12-4926-a8b3-8e3a974ab0bd no espaço de trabalho ContosoWorkspace.
...
Esse comando interrompe a operação do pipeline com a ID b9730a13-aa12-4926-a8b3-8e3a974ab0bd no espaço de trabalho ContosoWorkspace por meio de pipeline.
