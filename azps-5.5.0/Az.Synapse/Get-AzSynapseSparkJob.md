...
## Sinopse
Obtém um trabalho do Synapse Analytics Spark.
...
## Descrição
O cmdlet **Get-AzSynapseSparkJob** obtém um trabalho do Azure Synapse Analytics Spark.
...
Este comando obtém todos os trabalhos em um pool de Spark.
...
Esse comando obtém o trabalho com a ID do aplicativo especificada.
...
Esse comando obtém todos os trabalhos em um pool de Spark por meio do pipeline.
...
### -Ela
Identificador do trabalho do Spark.
