...
## Sinopse
Obtém um pool de miniapse analytics.
...
## Descrição
O cmdlet **Get-AzSynapseSparkPool** obtém informações sobre um pool de sparks de análise do Azure Synapse.
...
Esse comando obtém todos os pools de Spark sob um espaço de trabalho.
...
Esse comando obtém o pool de Spark no espaço de trabalho ContosoWorkspace com o nome ContosoSparkPool.
...
Esse comando obtém todos os pools de Spark sob um espaço de trabalho por meio do pipeline.
...
Esse comando obtém o pool de Spark com a ID de recurso especificada.
