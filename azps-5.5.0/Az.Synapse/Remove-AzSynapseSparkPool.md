...
## Sinopse
Exclui um pool de minilhas de análise do Synapse.
...
## Descrição
O cmdlet **Remove-AzSynapseSparkPool** exclui permanentemente um pool de miniaplets de análise do Azure Synapse.
...
Esse comando exclui um pool de minissérie de análise do Azure Synapse.
...
Esse comando exclui um pool de miniapis de análise do Azure Synapse por meio do pipeline.
...
Esse comando exclui um pool de miniaptenções de análise do Azure Synapse com uma ID de recurso.
