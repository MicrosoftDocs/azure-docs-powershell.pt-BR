...
Habilitar a política de auditoria de armazenamento em blob de um pool SQL do Azure Synapse Analytics chamado ContosoSqlPool.
...
Habilitar a política de auditoria de armazenamento de blob de um pool SQL do Azure Synapse Analytics chamado ContosoSqlPool com filtragem avançada usando um predicado T-SQL.
...
Desabilite a política de auditoria de armazenamento de blob de um pool SQL do Azure Synapse Analytics chamado ContosoSqlPool por meio de pipeline.
...
Para os últimos casos, os formulários BANCO DE DADOS:: dbname e \[ \] ESQUEMA:: nomedo esquema são \[ \] usados, respectivamente.
