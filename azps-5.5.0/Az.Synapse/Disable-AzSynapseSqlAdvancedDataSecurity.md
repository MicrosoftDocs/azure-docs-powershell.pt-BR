...
## Descrição
O cmdlet **Disable-AzSynapseSqlAdvancedDataSecurity** desabilita a Segurança De Dados Avançada em um espaço de trabalho.
...
Esse comando desabilita a Segurança De Dados Avançada no espaço de trabalho chamado ContosoWorkspace.
...
Esse comando desabilita a Segurança De Dados Avançada no espaço de trabalho chamado ContosoWorkspace por meio de pipeline.
