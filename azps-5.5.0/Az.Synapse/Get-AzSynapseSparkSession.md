...
## Sinopse
Obtém uma sessão synapse Analytics Spark.
...
## Descrição
O cmdlet **Get-AzSynapseSparkSession obtém** informações sobre uma sessão do Azure Synapse Analytics Spark.
...
Esse comando obtém todas as sessões do Spark sob o pool de Spark especificado.
...
Esse comando obtém a sessão do Spark com a ID especificada.
...
Esse comando obtém todas as sessões do Spark sob o pool de Spark especificado por meio do pipeline.
