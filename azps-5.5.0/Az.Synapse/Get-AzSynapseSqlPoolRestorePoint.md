...
## Sinopse
Recupera os pontos de restauração distintos dos quais um pool SQL do Synapse Analytics pode ser restaurado.
...
## Descrição
O cmdlet **Get-AzSynapseSqlPoolRestorePoint** recupera os pontos de restauração distintos de onde um pool SQL do Azure Synapse Analytics pode ser restaurado.
