...
## Sinopse
Invoca uma instrução Synapse Analytics Spark.
...
## Descrição
O cmdlet **Invoke-AzSynapseSparkStatement** invoca uma instrução Synapse Analytics Spark.
...
Esses comandos iniciam uma sessão do Spark e invocam uma instrução Spark em linha por meio do pipeline.
...
Esses comandos iniciam uma sessão do Spark e invocam uma instrução Spark em linha.
...
Esses comandos iniciam uma sessão do Spark e, em seguida, invocam as instruções do Spark em um arquivo.
