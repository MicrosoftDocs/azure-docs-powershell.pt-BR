...
## Sinopse
Atualiza um pool de minipáginas de análise synapse.
...
## Descrição
O cmdlet **Update-AzSynapseSparkPool** atualiza um pool de miniaplets de análise do Azure Synapse.
...
Este comando atualiza um pool de miniaptenções de análise do Azure Synapse.
...
Este comando atualiza um pool de miniapis de análise do Azure Synapse por meio do pipeline.
...
Este comando atualiza um pool de miniaptenções de análise do Azure Synapse com a ID do recurso.
...
Esse comando habilita a escala automática para um pool de miniapis de análise do Azure Synapse.
...
Esse comando desabilita a escala automática para um pool de miniapis de análise do Azure Synapse.
...
Esse comando habilita a pausa automática para um Pool de Miniapros de Análise do Azure Synapse.
...
Esse comando desabilita a pausa automática para um Pool de Miniapros de Análise do Azure Synapse.
...
Número de minutos ociosos. Esse parâmetro deve ser especificado quando a Pausa Automática estiver habilitada.
...
Número máximo de nós a serem alocados no pool de Spark especificado.
Esse parâmetro deve ser especificado quando a escala automática está habilitada.
...
Número mínimo de nós a serem alocados no pool de minilhas especificado.
Esse parâmetro deve ser especificado quando a escala automática está habilitada.
...
### -EnableAutoPause
Indica se a pausa automática deve estar habilitada.
...
Arquivo de configuração de ambiente ("SAÍDA PIP congelar").
...
### -NodeCount
Número de nós a serem alocados no pool de Spark especificado.
...
### -NodeSize
Número de núcleo e memória a serem usados para nós alocados no pool de Spark especificado.
Esse parâmetro deve ser especificado quando a escala automática está desabilitada
...
### -ResourceId
Identificador de recurso do pool de Miniapse Spark.
