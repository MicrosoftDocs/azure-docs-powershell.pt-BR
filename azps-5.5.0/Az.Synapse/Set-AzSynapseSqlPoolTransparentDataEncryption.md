...
## Sinopse
Modifica a propriedade TDE para um pool SQL.
...
## Descrição
O cmdlet **Set-AzSynapseSqlPoolTransparentDataEncryption** modifica a propriedade TDE (Criptografia de Dados Transparentes) de um pool SQL do Azure Synapse Analytics.
...
Esse comando habilita o TDE para o pool SQL chamado ContosoSqlPool no espaço de trabalho chamado ContosoWorkspace.
...
### -Estado
O estado de Criptografia de Dados Transparente do Pool de Dados do Azure Synapse Analytics.
