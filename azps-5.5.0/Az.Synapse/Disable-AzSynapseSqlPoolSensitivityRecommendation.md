...
## Sinopse
Desabilita (descarta) recomendações de sensibilidade em colunas no pool sql.
...
### Exemplo 1: Desabilitar recomendações de sensibilidade em uma determinada coluna em um pool SQL do Azure Synapse.
```powershell
...
### Exemplo 2: Desabilitar recomendações de sensibilidade em colunas que têm recomendações de sensibilidade em um pool SQL do Azure Synapse usando o Piping.
```powershell
...
### Exemplo 3: Desabilitar recomendações de sensibilidade em uma determinada coluna em um pool SQL synapse do Azure usando o Piping.
```powershell
