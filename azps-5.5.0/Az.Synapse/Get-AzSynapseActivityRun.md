...
## Sinopse
Obtém informações sobre atividades em uma operação de pipeline.
...
## Descrição
O cmdlet **Get-AzSynapseActivityRun** obtém informações sobre as executados no espaço de trabalho para a operação de pipeline especificada que ocorreu no prazo determinado. Além disso, você pode especificar filtros para o nome da atividade e o status da executar.
...
Este comando obtém detalhes sobre todas as atividades realizadas no pipeline chamado Contoso Pipeline run com ID "f288712d-fb08-4cb8-96ef-82d3b9b30621" que aconteceu entre "2018-09-01T21:00" e "2018-09-30T21:00".
...
Este comando obtém detalhes sobre todas as atividades realizadas no pipeline chamado Contoso Pipeline run com ID "f288712d-fb08-4cb8-96ef-82d3b9b30621" que aconteceu entre "09/09/2018-01T21:00" e "2018-09-30T21:00" por meio do pipeline.
...
### -ExecutarStartedAfter
O horário em que o evento de executar foi atualizado no formato 'ISO 8601'.
...
### -Status
O status da executar o pipeline.
