...
## Descrição
O **cmdlet Stop-AzHpcCache** interrompe um Cache HPC do Azure.
...
### -Forçar
Indica que o cmdlet não solicita confirmação. Por padrão, esse cmdlet solicita que você confirme que deseja interromper o cache.
...
### -ResourceGroupName
Nome do grupo de recursos no qual você deseja interromper o cache.
