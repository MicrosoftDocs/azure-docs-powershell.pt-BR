...
## Descrição
O cmdlet **Set-AzHpcCacheStorageTarget** atualiza um Destino de Armazenamento anexado ao cache HPC do Azure.
...
### -CLFS
Atualizar o tipo de Destino de Armazenamento CLFS.
...
### -NFS
Atualizar o tipo de destino de armazenamento NFS.
...
### -ResourceGroupName
Nome do grupo de recursos no qual você deseja atualizar o destino de armazenamento.
