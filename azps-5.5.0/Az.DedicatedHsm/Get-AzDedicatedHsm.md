...
Este comando obtém todos os HSM Dedicados sob uma assinatura
...
Esse comando obtém todos os HSM Dedicados em um grupo de recursos.

### Exemplo 3: Obter um HSM Dedicado por nome
```powershell
...
Esse comando obtém um HSM Dedicado por nome.
...
Esse comando obtém um HSM Dedicado por objeto.
