...
## Descrição
O cmdlet **New-AzDataLakeStoreAccount cria** uma nova conta da Data Lake Store.
...
Esse comando cria uma conta da Data Lake Store chamada ContosoADL para o local do Leste dos EUA 2.

## Parâmetros

### -DefaultGroup
Especifica a ID de objeto do grupo Diretório AzureActive a ser usado como o proprietário do grupo padrão para novos arquivos e pastas.
