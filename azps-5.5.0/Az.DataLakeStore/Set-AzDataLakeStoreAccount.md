...
Esse comando adiciona a marca especificada à conta da Data Lake Store chamada ContosoADL.
...
### -AllowAzureIpState
Opcionalmente, permita/bloqueie IPs de origem do Azure por meio do firewall.
...
### -DefaultGroup
Especifica a ID de um grupo do AzureActive Directory.
Este grupo é o grupo padrão para arquivos e pastas que você cria.
...
### -FirewallState
Opcionalmente, habilita ou desabilita as regras de firewall existentes.
...
### -KeyVersion
Se o tipo de criptografia for atribuído pelo usuário, o usuário poderá girar sua versão de chave com este parâmetro.
...
### -Nome
Especifica o nome de uma conta do Data Lake Store.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém a conta do Data Lake Store para modificar.
...
### -Tier
O nível de compromisso desejado para que essa conta seja usada.
...
Opcionalmente, habilita ou desabilite os provedores de ID confiáveis existentes.
