...
## Sinopse
Restaure um arquivo ou pasta excluído no Lago de Dados do Azure.
...
## Descrição
O cmdlet **Restore-AzDataLakeStoreDeletedItem** restaura um arquivo ou pasta excluído no Data Lake Store. Requer o caminho do item excluído na lixeira retornado pela Get-AzDataLakeStoreDeletedItem.
...
### -PassThru
Retorne booliana verdadeiro sobre o sucesso.
...
### -RestoreAction
Ação a ser tomada sobre conflitos de nome de destino - "copiar" ou "substituir"
