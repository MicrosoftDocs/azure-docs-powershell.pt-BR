...
Isso cria uma nova regra de rede virtual chamada "myVNET" na conta "dls" com uma id da sub-rede "testId"

## Parâmetros

### -Conta
A conta do Data Lake Store para adicionar a regra de rede virtual
...
### -Sub-RedeId
A sub-redeId da regra de rede virtual
