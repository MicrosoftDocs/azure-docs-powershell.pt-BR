...
## Descrição
O cmdlet **Set-AzDataLakeStoreItemOwner** modifica o proprietário de um arquivo ou pasta no Data Lake Store.
...
Esse comando define o proprietário para o diretório raiz como Sendo Ele.
...
### -ID
Especifica a ID de objeto do usuário, grupo ou entidade de serviço do AzureActive Directory a ser usado como proprietário.
