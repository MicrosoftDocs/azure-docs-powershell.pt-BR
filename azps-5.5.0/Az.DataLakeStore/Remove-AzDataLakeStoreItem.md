...
Esse comando remove os arquivos File01.txt e File.csv da Data Lake Store.
...
### -Caminhos
Especifica uma matriz de caminhos do Data Lake Store dos arquivos a remover, começando pelo diretório raiz (/).
