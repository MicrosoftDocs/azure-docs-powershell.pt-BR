...
## Descrição
O cmdlet **Get-AzDataLakeStoreChildItem** obtém a lista de itens em uma pasta na Data Lake Store.
...
Esse comando obtém os itens filho da pasta MeusArquivos.
...
### -Caminho
Especifica o caminho do Data Lake Store da pasta, começando pelo diretório raiz (/).
