...
## Descrição
O cmdlet **Set-AzDataLakeStoreItemAclEntry** modifica uma entrada (ACE) na lista de controles de acesso (ACL) de um arquivo ou pasta no Data Lake Store.
...
Esse comando modifica o ACE para o Batman Ltda para ter todas as permissões.
...
### Exemplo 3: Modificar permissões para um objeto ACE recursivamente usando o objeto Acl
```
...
Esse comando modifica recursivamente o ACE para Que ele tenha todas as permissões de raiz e todos os seus subdiretivos e arquivos.
...
### -Acl
Especifica o objeto ACL que contém as entradas a modificar.
...
### -Padrão
Indica que essa operação modifica o ACE padrão do ACL especificado.
...
### -Caminho
Especifica o caminho do Data Lake Store do item para o qual modificar um ACE, começando pelo diretório raiz (/).
...
### -Recorrência
Indica que o ACL deve ser modificado recursivamente para os arquivos e subdiretivos filho
...
### -ShowProgress
Se aprovado, o status do progresso será mostrado. Aplicável somente quando a modificação recursiva do Acl é feita.
