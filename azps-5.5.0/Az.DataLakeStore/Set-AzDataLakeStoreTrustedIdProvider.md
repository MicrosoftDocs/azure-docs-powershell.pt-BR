...
## Descrição
O cmdlet **Set-AzDataLakeStoreTrustedIdProvider** modifica o provedor de identidade confiável especificado na Data Lake Store especificada.

## Exemplos

### Exemplo 1: Atualizar um ponto de extremidade de provedor de identidade confiável
```
...
Isso atualiza o ponto de extremidade do provedor para a regra de firewall "MeuProvider" na conta "ContosoADL" para https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150 " "

## Parâmetros

### -Conta
A conta do Data Lake Store para adicionar o provedor de identidade confiável ao
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém a conta para atualizar o provedor de identidade confiável.
