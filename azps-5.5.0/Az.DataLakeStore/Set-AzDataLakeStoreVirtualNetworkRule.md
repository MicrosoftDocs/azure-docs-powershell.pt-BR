...
## Sinopse
Modifica a regra de rede virtual especificada no Data Lake Store especificado.
...
## Descrição
O cmdlet **Set-AzDataLakeStoreVirtualNetworkRule** modifica a regra de rede virtual especificada na Data Lake Store especificada.
...
Atualiza a ID da sub-rede da regra de rede virtual "myVNET" na conta "dls" para "updatedId"
...
### -Sub-RedeId
O início do intervalo ip válido para a regra de rede virtual
