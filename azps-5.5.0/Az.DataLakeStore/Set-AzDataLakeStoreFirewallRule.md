...
## Descrição
O cmdlet **Set-AzDataLakeStoreFirewallRule** modifica a regra de firewall especificada no Repositório de Dados especificado.
...
### -EndIpAddress
O fim do intervalo ip válido para a regra de firewall
