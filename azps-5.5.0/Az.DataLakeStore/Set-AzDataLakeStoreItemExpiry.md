...
Define a expiração no arquivo myfile.txt na conta ContosoADL para daqui a duas horas.
...
### Exemplo 3: Definir o tempo de expiração de um arquivo em relação a agora
```
...
### -Caminho
Especifica o caminho do Data Lake Store do item de arquivo para o qual definir ou remover expirar.
...
Opções de expiração relativas. RelativeToData ou RelativeToCreationDate são opções atuais
