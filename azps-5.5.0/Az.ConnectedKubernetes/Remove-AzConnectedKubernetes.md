...
## Sinopse
Exclua um cluster conectado, removendo o recurso rastreado no Gerenciador de Recursos do Azure (ARM).
...
### Exemplo 1: Remover uma rede de rede conectada
```powershell
PS C:\> Remove-AzConnectedKubernetes -ResourceGroupName azureps-manual-test -ClusterName ps-connaks-t01

```

Este comando remove uma rede de rede conectada

### Exemplo 2: Remover uma rede de rede conectada por objeto
```powershell
...
Este comando remove uma rede de rede conectada por objeto
