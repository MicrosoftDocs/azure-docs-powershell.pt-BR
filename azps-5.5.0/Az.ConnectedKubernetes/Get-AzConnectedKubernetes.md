...
### Exemplo 1: Obter todas as redes conectadas em uma assinatura
```powershell
...
Esse comando obtém todas as redes conectadas em uma assinatura.

### Exemplo 2: Obter todas as rede conectadas sob o grupo de recursos
```powershell
...
Esse comando obtém todas as redes conectadas sob o grupo de recursos.

### Exemplo 3: Obter uma rede conectada
```powershell
...
Esse comando obtém uma rede conectada.

### Exemplo 4: Obter uma rede por objeto conectada
```powershell
...
Esse comando obtém uma rede conectada por objeto.
