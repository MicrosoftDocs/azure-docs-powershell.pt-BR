...
Criar um AzDigitalTwinsEndpoint para Eventhub por conexãoStringPrimaryKey
...
Criar um AzDigitalTwinsEndpoint para ServicBus pela PrimaryConnectionString
...
### -DeadLetterSecsec
Segredo de armazenamento de cartas mortos.
...
Para construir, consulte a seção ANOTAÇÕES para propriedades ENDPOINTDESCRIPTION e crie uma tabela hash.
...
### -EndpointType
O tipo de ponto de extremidade Digital Descarrém
...
ENDPOINTDESCRIPTION : Recurso de ponto de extremidade <IDigitalTwinsEndpointResource> DigitalTwinsInstance.
  - `EndpointType <EndpointType>`: o tipo de ponto de extremidade Digital Descarrém
  - `[DeadLetterSecret <String>]`: segredo de armazenamento de cartas mortos. Serão ofuscados durante a leitura.
