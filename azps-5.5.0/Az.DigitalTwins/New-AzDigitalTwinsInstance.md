...
### Exemplo 2: Criar um Objeto AzDigitalTwinsInstance por AzDigitalTwins Object.
```powershell
...
Criar um objeto AzDigitalTwinsInstance por AzDigitalTwins Object
...
Para construir, confira a seção ANOTAÇÕES para propriedades DIGITALTWINSCREATE e crie uma tabela hash.
