...
### Exemplo 3: Adicionar uma nova extensão com a localização especificada por meio do pipeline
```powershell
...
### Exemplo 4: Adicionar uma nova extensão usando um objeto de extensão como o local e os parâmetros para atualizar
```powershell
