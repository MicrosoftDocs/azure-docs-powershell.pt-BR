...
## Sinopse
Recupera informações sobre o exibição de modelo ou a exibição de instância de uma máquina híbrida.
...
### Exemplo 1: Listar todos os máquinas conectadas em uma assinatura
```powershell
...
Lista todos os máquinas conectadas em uma assinatura.
...
Obter um computador conectado em um grupo de recursos por nome.
