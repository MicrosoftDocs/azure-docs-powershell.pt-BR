...
# Módulo Az.Media
## Descrição
Este tópico exibe tópicos de ajuda para o recurso serviço Web do Serviço de Mídia nos cmdlets do Serviço de Aplicativo do Azure.
...
Os nomes de serviços de mídia são globalmente exclusivos.

### [New-AzMediaService](New-AzMediaService.md)
Cria um serviço de mídia se o serviço de mídia já existir, todas as suas propriedades são atualizadas com a entrada fornecida.
...
Sincroniza as chaves de conta de armazenamento para uma conta de armazenamento associada ao serviço de mídia.
