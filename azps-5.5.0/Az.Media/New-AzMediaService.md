...
### Exemplo1: Criar um serviço de mídia apenas com a conta de armazenamento principal
```
PS C:\># Variables
## Global
...
Este exemplo mostra como criar um serviço de mídia especificando apenas a conta de armazenamento principal.
...
### -NomedaEm conta
Especifica o nome do serviço de mídia que este cmdlet cria.
...
### -Local
Especifica a região em que este cmdlet cria o serviço de mídia.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos ao que o serviço de mídia está atribuído.
...
### -StorageAccounts
Especifica uma matriz de contas de armazenamento para associar ao serviço de mídia.
