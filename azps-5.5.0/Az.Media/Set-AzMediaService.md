...
## Descrição
O **cmdlet Set-AzMediaService** modifica propriedades especificadas de um serviço de mídia existente.
...
Este segundo comando atualiza o serviço de mídia chamado MediaService001 que pertence ao grupo de recursos chamado ResourceGroup123 com as marcas armazenadas $Tags variável.
O comando também usa uma matriz de objetos de configuração de armazenamento armazenados $StorageAccounts variável.

## Parâmetros

### -NomedaEm conta
Especifica o nome do serviço de mídia que este cmdlet modifica.
...
### -Tag
As marcas associadas à conta de mídia.
