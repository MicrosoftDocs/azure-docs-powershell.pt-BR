...
### Exemplo 1: Remover uma associação de provedores personalizados.
```powershell
PS C:\> PS C:\> Remove-AzCustomProviderAssociation -Scope $id -Name Namespace.Type
```

Remover uma associação de provedor personalizado.

### Exemplo 2: Remover uma associação de provedor personalizado com a Piping
```powershell
...
Remova uma associação de provedores personalizados, usando a piping e o recurso PassThru para indicar sucesso ou fracasso.
