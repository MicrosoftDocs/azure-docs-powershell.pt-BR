...
## Descrição
O Resume-AzAnalysisServicesServer cmdlet retoma uma instância do servidor do Analysis Services
...
Esse comando retomará um servidor pausado chamado testserver no grupo de teste de grupo de recursos
