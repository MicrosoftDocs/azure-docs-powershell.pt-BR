...
## Descrição
O Remove-AzAnalysisServicesServer cmdlet exclui uma instância do servidor do Analysis Services
...
Esse comando removerá o servidor nomeado como testserver no grupo de recursos de grupo de teste
