...
O primeiro comando obtém as credenciais de entidade de serviço do aplicativo e as armazena na variável $ApplicationCredential aplicativo.
O segundo comando adiciona a conta principal de serviço de aplicativo especificada pela variável $ApplicationCredential e TenantId ao ambiente westcentralus.asazure.windows.net Analysis Services.
...
### -RolloutEnvironment
Nome do ambiente do Azure Analysis Services para o qual fazer logon. Dado o nome completo do servidor, por exemplo, asazure://westcentralus.asazure.windows.net/testserver, o valor correto dessa variável será westcentralus.asazure.windows.net
