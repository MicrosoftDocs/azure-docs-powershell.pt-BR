...
Cria um servidor chamado testserver na região oeste dos EUA e no grupo de recursos testresourcegroup. O nível de sku do servidor será S1.
...
### -Administrador
Uma cadeia de caracteres que representa uma lista separada por vírgulas de usuários ou grupos a serem definidos como administradores no servidor. Os usuários ou grupos precisam ser especificados no formato UPN, por user@contoso.com exemplo, ou groups@contoso.com
...
Contagem de réplicas somente leitura de um servidor de serviços do Analysis
