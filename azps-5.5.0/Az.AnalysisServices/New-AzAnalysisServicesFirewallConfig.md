...
## Descrição
O New-AzAnalysisServicesFirewallConfig cria um novo objeto de configuração de firewall
...
Cria um objeto de configuração de firewall com duas regras e, ao mesmo tempo, habilita o acesso do serviço do Power BI.
...
Um sinalizador para indicar se o firewall está permitindo o acesso do Power BI
...
### System.Collections.Generic.List'1[[Microsoft.Azure.Commands.AnalysisServices.Models.PsAzureAnalysisServicesFirewallRule, Microsoft.Azure.PowerShell.Cmdlets.AnalysisServices, Version=1.0.0.0,0, Culture=neutral, PublicKeyToken=null]]
