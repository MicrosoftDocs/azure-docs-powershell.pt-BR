...
## Descrição
A New-AzAnalysisServicesFirewallRule cria um novo objeto de regra de firewall.
...
Cria uma regra de firewall chamada regra1 com o intervalo inicial 0.0.0.0 e o intervalo final 255.255.255.255
...
### -RangeEnd
O fim do intervalo de uma regra de firewall
...
### -Início do Intervalo
O início do intervalo de uma regra de firewall
