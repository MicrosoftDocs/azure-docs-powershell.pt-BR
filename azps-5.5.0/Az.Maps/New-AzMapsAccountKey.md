...
## Descrição
O New-AzMapsAccountKey cmdlet regenera uma chave da API de uma conta do Azure Maps.
...
Regenera a Chave da API Primária da conta MyAccount no grupo de recursos MyResourceGroup.
...
Regenera a Chave da API Secundária para a Conta de Mapas do Azure especificada.
