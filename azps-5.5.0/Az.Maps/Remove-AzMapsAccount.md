...
## Descrição
O Remove-AzMapsAccount cmdlet exclui a conta especificada do Azure Maps.
...
Exclui a conta MyAccount do grupo de recursos MyResourceGroup.
...
Exclui a Conta de Mapas do Azure especificada.
...
### -PassThru
Retorne se a conta especificada foi excluída com êxito ou não.
