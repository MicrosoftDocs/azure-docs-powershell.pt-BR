...
## Descrição
O Get-AzMapsAccount cmdlet obtém uma conta provisionada do Azure Maps, seja por grupo de recursos e nome, ou por ID do recurso. Além disso, ele pode retornar uma lista de todas as contas no ResourceGroup ou todas as contas do Azure Maps para a assinatura atual.
...
Obtém a conta Mapas especificada pela ID do Recurso.
