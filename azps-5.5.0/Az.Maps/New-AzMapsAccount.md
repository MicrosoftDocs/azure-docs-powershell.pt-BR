...
## Descrição
O New-AzMapsAccount cmdlet cria uma conta do Azure Maps com a SKU especificada.
...
Cria uma nova conta do Azure Maps chamada MyAccount no grupo de recursos MyResourceGroup com a SKU S0 e uma marca.
