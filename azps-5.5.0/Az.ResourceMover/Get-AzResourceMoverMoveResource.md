...
### Exemplo 1: Obter detalhes de todos os recursos na coleção Mover.
```powershell
...
Obter detalhes de todos os recursos do conjunto de movimentações.

### Exemplo 2: Obter detalhes de recursos específicos em um conjunto mover usando o nome do recurso mover.
```powershell
...
Obter detalhes de recursos específicos em um conjunto de movimentações usando mover o nome do recurso.

### Exemplo 3: Obter detalhes de recursos específicos em um conjunto mover usando filtros como : SourceResourceName, SourceId, MoveState, IsResolveRequired, ProvisioningState
```powershell
...
Obter detalhes de recursos específicos em uma coleção Mover usando filtro como armid, moveStatusMoveState(verificar) etc.
...
Por exemplo, você pode usar $filter=Properties/ProvisioningState eq 'Bem-sucedido'.
