...
### Exemplo 1: Validar as dependeções antes de iniciar a movimentação para os recursos.
```powershell
...
Valide as dependecies antes de Iniciar Movimentação para os recursos.

### Exemplo 2: Iniciar Mover para o conjunto de recursos na coleção Mover usando "Nome MoveResource" como entrada
```powershell
...
Inicie Mover para o conjunto de recursos na coleção Mover usando "Nome MoveResource" como entrada.

### Exemplo 3: Iniciar Movimentação para o conjunto de recursos no Conjunto de Movimentações usando "SourceARMID" como entrada
```powershell
...
Inicie Mover para o conjunto de recursos na coleção Mover usando "SourceARMID" como entrada.
