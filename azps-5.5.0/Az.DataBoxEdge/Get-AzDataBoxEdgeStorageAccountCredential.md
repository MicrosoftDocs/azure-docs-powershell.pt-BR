...
## Descrição
O cmdlet **Get-AzDataBoxEdgeStorageAccountCredential** obtém as credenciais de conta de armazenamento da conta de armazenamento correspondente no dispositivo de Borda da Caixa de Dados. Você pode especificar parâmetros Nome, Nome do Grupo de Recursos e Nome do Dispositivo para obter informações sobre uma credencial de conta de armazenamento específica.
