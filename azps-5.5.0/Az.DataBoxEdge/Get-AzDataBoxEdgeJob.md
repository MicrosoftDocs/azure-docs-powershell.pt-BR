...
## Descrição
O **cmdlet Get-AzDataBoxEdgeJob obtém** os trabalhos ativos em um dispositivo de Borda de Caixa de Dados. Você pode mencionar o parâmetro Nome para obter detalhes de um trabalho específico.
