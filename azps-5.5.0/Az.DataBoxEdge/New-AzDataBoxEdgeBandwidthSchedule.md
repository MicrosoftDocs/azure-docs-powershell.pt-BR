...
## Descrição
O cmdlet **New-AzDataBoxEdgeBandwidthSchedule** cria um novo Cronograma de Largura de Banda para um dispositivo de Borda de Caixa de Dados para ajudar a gerenciar o uso de largura de banda.
...
### -UnlimitedBandwidth
Definirá Largura de Banda Ilimitada, se definida como false definirá o valor padrão como 20 Mbps
