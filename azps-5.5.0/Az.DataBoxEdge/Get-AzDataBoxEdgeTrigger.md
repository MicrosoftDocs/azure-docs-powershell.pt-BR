...
## Descrição
O cmdlet **Get-AzDataBoxEdgeTriger** obtém os gatilhos de um dispositivo. Você pode especificar o nome como um parâmetro no cmdlet para buscar os detalhes de um Gatilho específico
