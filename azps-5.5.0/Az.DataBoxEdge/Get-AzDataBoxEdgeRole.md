...
## Descrição
O cmdlet **Get-AzDataBoxEdgeRole** busca as funções de IoT disponíveis para um dispositivo de borda de caixa de dados. Você pode mencionar o parâmetro Nome para obter os detalhes de uma função IoT específica.
