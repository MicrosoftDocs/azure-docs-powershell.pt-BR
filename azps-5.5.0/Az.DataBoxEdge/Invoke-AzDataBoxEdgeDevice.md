...
## Descrição
O cmdlet **Invoke-AzDataBoxEdgeDevice** invoca ações para verificar, baixar e instalar as atualizações no dispositivo De borda da Caixa de Dados. Uma verificação automática é feita diariamente no dispositivo, você pode acionar a verificação explicitamente executando este cmdlet.
...
### -InstallUpdate
Instala as atualizações na borda da caixa de dados/dispositivo de gateway
