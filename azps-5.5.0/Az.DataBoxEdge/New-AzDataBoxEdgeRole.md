...
## Descrição
O cmdlet **New-AzDataBoxEdgeRole** cria uma nova função para um dispositivo de borda de caixa de dados.
...
### -DeviceProperty
Para fornecer propriedades do dispositivo
...
Forneça a cadeia de conexão do dispositivo IOT
...
Tecla de acesso do dispositivo Iot Edge
...
Forneça a cadeia de conexão do Dispositivo de Borda
...
### -Plataforma
Forneça a Plataforma, por exemplo: Linux
