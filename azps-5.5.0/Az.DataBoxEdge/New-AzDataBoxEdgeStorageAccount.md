...
## Descrição
O **cmdlet New-AzDataBoxEdgeStorageAccount** cria uma nova conta de Armazenamento de Borda em um dispositivo de Borda de Caixa de Dados. Para um dispositivo, uma conta de Armazenamento de Borda pode ser mapeada no máximo para apenas uma conta de Armazenamento em Nuvem.
...
2 EdgeStorageAccounts no dispositivo não pode compartilhar mais de 1 Conta de Armazenamento em Nuvem
...
### -Cloud
Usará uma CloudStorageAccount para a classificação de camadas
...
Fornecer o Nome de Recurso de StorageAccountCredential existente
