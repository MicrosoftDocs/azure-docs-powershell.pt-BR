...
## Descrição
O cmdlet **Set-AzDataBoxEdgeRole** atualiza uma função IoT para um dispositivo de borda de caixa de dados. Os compartilhamentos antigos montados serão substituídos por aqueles recém-fornecidos no parâmetro ShareName.
