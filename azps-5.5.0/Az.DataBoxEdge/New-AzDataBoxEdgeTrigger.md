...
### -StartTime
A hora do dia que resulta em um gatilho válido. O cronograma é calculado com referência à hora especificada em até segundos. Se o timezone não for especificado, o tempo será considerado como no zona de tempo do dispositivo. O valor sempre será retornado como horário UTC.
