...
## Descrição
O cmdlet **Get-AzDataBoxEdgeShare** obtém os compartilhamentos disponíveis para um dispositivo de borda de caixa de dados. Se o Nome for fornecido, isso receberá o compartilhamento por Nome.
