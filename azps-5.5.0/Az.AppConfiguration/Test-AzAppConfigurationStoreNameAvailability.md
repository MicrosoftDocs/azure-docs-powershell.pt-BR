...
### Exemplo 1: Testar a disponibilidade do nome do armazenamento de configuração de aplicativos
...
Esse comando testa a disponibilidade do nome do armazenamento de configuração do aplicativo.
