...
## Sinopse
Atualiza um armazenamento de configurações com os parâmetros especificados.
...
Esse comando habilita a criptografia de dados por uma chave armazenada no Cofre de Teclas do Azure usando uma identidade gerenciada atribuída pelo sistema.
...
Esse comando habilita a criptografia de dados por uma chave armazenada no Cofre de Teclas do Azure usando uma identidade gerenciada atribuída pelo usuário.
...
Este comando atualiza a SKU e a marca de um armazenamento de configuração de aplicativo por pipeline.
...
O URI da chave do cofre de chave usada para criptografar dados.
...
O tipo "Nenhum" removerá as identidades.
...
A ID do cliente da identidade que será usada para acessar o cofre de teclas.
...
A lista de identidades atribuídas pelo usuário associada ao recurso.
As chaves do dicionário de identidade atribuídas pelo usuário serão IDs de recurso ARM no formulário: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
