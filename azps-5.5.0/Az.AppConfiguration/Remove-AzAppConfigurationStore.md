...
## Sinopse
Exclui um armazenamento de configurações.
...
### Exemplo 1: Remover um armazenamento de configuração de aplicativos
```powershell
PS C:\> Remove-AzAppConfigurationStore -Name appconfig-test03 -ResourceGroupName lucas-manual-test

```

Esse comando remove um armazenamento de configuração de aplicativo.

### Exemplo 2: Remover um armazenamento de configuração de aplicativos
```powershell
