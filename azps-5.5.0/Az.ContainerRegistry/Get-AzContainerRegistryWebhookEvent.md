...
### ListWebwebEventsByNameResourceGroupParameterSet (Padrão)
```
...
### ListWebwebwebEventsByWebbjectParameterSet
```
...
## Descrição
O cmdlet Get-AzContainerRegistryWebhookEvent lista todos os eventos de um web browser.

## Exemplos

### Exemplo 1: Obtém todos os eventos de um web browser.
```powershell
...
Obtém todos os eventos de um web browser.
...
### Microsoft.Azure.Commands.ContainerRegistry.PSContainerRegistryWeb container
