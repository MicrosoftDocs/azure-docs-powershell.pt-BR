...
## Descrição
O Get-AzContainerRegistry cmdlet obtém um registro de contêiner especificado ou todos os registros de contêineres em um grupo de recursos ou na assinatura.
...
### Exemplo 2: Obter todos os registros de contêineres em um grupo de recursos
```powershell
...
Esse comando obtém todos os registros de contêineres em um grupo de recursos.

### Exemplo 3: Obter todos os registros de contêineres na assinatura
```powershell
...
### -IncludeDetail
Mostrar mais detalhes sobre o registro de contêineres.
