...
## Descrição
O New-AzContainerRegistryReplication cmdlet cria uma nova replicação do registro de contêiner.

## Exemplos

### Exemplo 1: Criar uma nova replicação de registro de contêiner.
```powershell
...
Criar uma nova replicação do registro de contêiner.
...
### -Tag
Marcas de Registro de Contêineres.
