...
## Descrição
O New-AzContainerRegistryWebhook cmdlet cria um webtare de registro de contêiner.

## Exemplos

### Exemplo 1: Criar um contêiner de registro web browser.
```
...
Criar um contêiner da Web de registro.
...
### -Header
Headers personalizados que serão adicionados às notificações de web notifications.
...
### -Status
Status web browser, valor padrão habilitado
