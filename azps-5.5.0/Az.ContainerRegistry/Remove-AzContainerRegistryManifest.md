...
## Descrição
Excluir manifesto ACR.
Para usar este cmdlet, execute `Update-AzContainerRegistryRepository -RegistryName XXX -Repository XXX -DeleteEnable $true`
Primeiro.
...
Excluir manifesto com a marca mais recente para o teste do repositório/busybox27 em Registro
