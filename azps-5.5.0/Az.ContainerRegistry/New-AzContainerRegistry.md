...
Esse comando cria um registro de contêiner com o usuário de administrador habilitado.
...
### -Local
Local do Registro de Contêineres.
...
### -Tag
Container Registry Tags.Key-value pairs na forma de uma tabela hash.
