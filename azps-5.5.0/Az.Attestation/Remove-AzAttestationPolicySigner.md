...
## Sinopse
Remove um signatário de política confiável para um locatário no Azure Attestation.
...
Remover um signator confiável para o Provedor de Teste chamado *pshtest.*
...
### -Signator
Especifica o RFC7519 JSON Web Token contendo uma reivindicação chamada "maa-policyCertificate" cujo valor é uma Chave Web JSON JSON RFC7517 que contém uma chave de assinatura confiável a ser removido.
