...
## Sinopse
Obtém a política de um locatário no Azure Attestation.
...
## Descrição
O Get-AzAttestationPolicy cmdlet obtém a política de um locatário no Azure Attestation.
...
Obtém a política de teste *pshtest* do Provedor de Teste para Tipo de Tee *SgxEn ltda.*
...
Obtém a política para o Provedor Padrão de Teste da Location *UK South* para o tipo *de tee SgxEnmaxe.*
...
Este cmdlet obtém a política de teste para o locatário especificado por esse parâmetro.
...
Há suporte para quatro tipos de ambiente: SgxEntronice, OpenEn ltda, CyResComponent e VBSEn ltda.
