...
## Sinopse
Obtém os signatários de política confiáveis de um locatário no Azure Attestation.
...
## Descrição
O Get-AzAttestationPolicySigners cmdlet obtém os signatários de política confiáveis de um locatário no Azure Attestation.
...
Obtém os signatários de política confiáveis para o *teste pshtest* do Provedor de Teste de Atestação no Resource Group *psh-test-rg.*  Observe que não há signatários confiáveis para este Provedor de Teste.
...
Obtém os signatários de política confiáveis para o provedor de teste de atestação *pshtest2* no Resource Group *psh-test-rg.*  Observe que há um signator confiável para este Provedor de Teste.
...
Obtém os signatários de política confiáveis para o Provedor Padrão de Teste na *Localização central dos EUA.*  Observe que não há signatários confiáveis para o Provedor Padrão de Teste.
...
### -Nome
Especifica o nome de um provedor de teste.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos de um provedor de teste.
...
### -ResourceId
Especifica a ResourceID de um provedor de teste.
