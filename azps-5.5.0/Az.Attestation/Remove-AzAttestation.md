...
### Estação ByAvailableAtte (Padrão)
```
...
## Descrição
O Remove-AzAttestation cmdlet exclui o teste especificado.
...
Exclua o Provedor de Teste chamado *pshtest3* no grupo de recursos chamado *psh-test-rg* da assinatura atual.
...
### -InputObject
Objeto de teste a ser excluído.
...
### -Nome
Especifica o nome do teste a ser removido.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos a ser removido do Azure.
