...
Regenerar a chave secundária do "exemplo" de Conta de Renderização Remota no Grupo de Recursos "rg1". 
...
Regenerar a chave secundária da Conta de Renderização Remota "exemplo" da assinatura atual e grupo de recursos "rg1" com piping.
