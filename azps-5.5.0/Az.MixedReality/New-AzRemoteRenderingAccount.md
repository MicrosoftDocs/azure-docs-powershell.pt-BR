...
Crie um novo "exemplo" de Conta de Renderização Remota na Assinatura atual, Grupo de Recursos "rg1" e Central dos EUA.
...
### -Local
Localização da conta de renderização remota.
