...
## Descrição
O cmdlet **Remove-AzNotificationHubsNamespaceAuthorizationRule** remove uma regra de autorização de Assinatura de Acesso Compartilhado (SAS) de um namespace do hub de notificação.
