...
## Descrição
O **New-AzSearchSharedPrivateLinkResource** cria um recurso de link privado compartilhado para o serviço pesquisa cognitiva do Azure.
...
Este exemplo cria um recurso de vínculo privado compartilhado para o serviço de blob de uma conta de armazenamento para o serviço pesquisa cognitiva do Azure.
...
### -ResourceRegion
(Opcional) Região de recurso de vínculo privado compartilhado
