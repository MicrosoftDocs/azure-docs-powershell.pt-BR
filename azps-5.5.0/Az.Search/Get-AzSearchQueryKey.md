...
## Descrição
O cmdlet **Get-AzSearchQueryKey** obtém as teclas de consulta do serviço pesquisa cognitiva do Azure.
...
O exemplo obtém todas as teclas de consulta do serviço pesquisa cognitiva do Azure.
