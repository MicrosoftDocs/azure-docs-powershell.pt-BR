...
## Descrição
O **cmdlet New-AzSearchAdminKey** regenera uma chave de administração do serviço de Pesquisa Cognitiva do Azure.
...
O exemplo regenera a chave primária do serviço pesquisa cognitiva do Azure.
...
### -Key Ressend
Tipo de chave de administração do Serviço de Pesquisa Cognitiva do Azure (Principal/Secundário).
