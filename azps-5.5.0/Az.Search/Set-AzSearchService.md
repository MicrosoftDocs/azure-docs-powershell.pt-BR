...
## Descrição
O **cmdlet Set-AzSearchService** modifica um serviço de Pesquisa Cognitiva do Azure.
...
O exemplo altera a contagem de partições e a contagem de réplicas do serviço pesquisa cognitiva do Azure para 2.
...
### -PartitionCount
Pesquisar contagem de partição do serviço.
...
### -ReplicaCount
Contagem de replicas do Serviço de Pesquisa.
...
### -ResourceId
Pesquisar ID de Recurso do Serviço.
