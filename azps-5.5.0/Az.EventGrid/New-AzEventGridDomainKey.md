...
Regenerar a chave correspondente à chave1'\ do domínio domínio da Grade do Evento1 no grupo de recursos \' \` \` \` MyResourceGroupName. \`
...
Regenerar a chave correspondente à chave2'\ do domínio domínio da Grade do Evento1 no grupo de recursos \' \` \` \` MyResourceGroupName usando sua ID de \` recurso completa.
