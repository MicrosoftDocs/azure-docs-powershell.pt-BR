...
## Descrição
Define as propriedades de um tópico de Grade do Evento. Isso pode ser usado para substituir as marcas de um tópico de Grade do Evento.
...
Define as propriedades do tópico da Grade do Evento1 no grupo de recursos MyResourceGroupName para substituir as marcas com as marcas \` \` \` \` especificadas "Departamento" e "Ambiente".
