...
Remove o Tópico de Tópico do Domínio da Grade do Evento1 em Domínio1 no grupo de recursos \` \` \` \` \` MyResourceGroupName. \`
...
### -ResourceId
Identificador de Recursos que representa o Tópico de Domínio da Grade do Evento.
