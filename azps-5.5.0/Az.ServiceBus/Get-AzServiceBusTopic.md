...
## Descrição
O **cmdlet Get-AzServiceBusTopic** retorna uma descrição de tópico para o namespace de Barra de Serviços especificado.
...
Retorna a descrição do tópico especificado para o namespace de Service Bus determinado.
...
Retorna a lista de tópicos para determinado namespace de Barra de Serviços. Por padrão, serão retornados 100 tópicos, se mais de 100 tópicos serem retornados, use o Parâmetro -MaxCount.
...
Retorna a lista dos primeiros 150 tópicos para determinado namespace de Barra de Serviços.
...
### -MaxCount
Determine o número máximo de Tópicos a retornar.
