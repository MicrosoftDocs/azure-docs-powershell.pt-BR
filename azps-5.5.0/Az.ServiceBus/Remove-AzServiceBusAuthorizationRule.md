...
## Descrição
O cmdlet **Remove-AzServiceBusAuthorizationRule** remove a regra de autorização de um namespace de Barra de Serviços ou fila ou tópico para o grupo de recursos especificado.
...
Remove a regra de `SBAuthoRule1` autorização do namespace `SB-Example1` do grupo de recursos especificado.
...
Remove a regra de `SBAuthoRule1` autorização da `SBQueue` fila do grupo de recursos especificado.
...
Remove a regra de `SBAuthoRule1` autorização do tópico `SBTopic` do grupo de recursos especificado.
...
### -InputObject
Objeto ServiceBus AuthorizationRule
