...
## Sinopse
Os cmdlets definiram a Migração de Namespace Padrão para premium como cadeias de caracteres completas e de conexão do namespace padrão agora apontam para o namespace Premium
...
## Descrição
Os cmdlets **Complete-AzServiceBusMigration definiram** a Migração do namespace Padrão para premium como cadeias de caracteres completas e de conexão do namespace padrão agora apontam para o namespace Premium
...
Define a Migração do namespaceStandardMigration como concluída.
...
### -InputObject
Configuração de migração de barramento de serviço - Objeto Namespace Padrão
...
### -ResourceId
Migração de Barramento de Serviço - ID de Recurso namespace padrão
