...
## Descrição
O cmdlet **Set-AzServiceBusAuthorizationRule** atualiza a descrição da regra de autorização especificada no namespace ou fila ou tópico do Service Bus.
...
Remove Gerenciar **dos** direitos de acesso da regra de autorização `AuthoRule1` no `SB-Example1` namespace.
...
Remove Gerenciar **dos** direitos de acesso da regra de autorização `AuthoRule1` na `SBQueue` fila.
...
Remove Gerenciar **dos** direitos de acesso da regra de autorização `AuthoRule1` no `SBTopic` tópico.
