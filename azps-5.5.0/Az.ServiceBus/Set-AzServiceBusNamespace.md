...
## Descrição
O cmdlet **Set-AzServiceBusNamespace** atualiza a descrição do namespace de Barra de Serviços especificado no grupo de recursos.
...
Atualiza o namespace da Barra de Serviços com uma nova descrição.
...
### -Local
O local de namespace do Barramento de Serviço.
...
### -Confirmar
Atualiza o namespace do Service Bus com as informações especificadas.
