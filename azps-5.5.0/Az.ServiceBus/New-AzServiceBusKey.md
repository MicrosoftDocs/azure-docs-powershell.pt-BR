...
## Descrição
O **cmdlet New-AzServiceBusKey** gera novas cadeias de conexão primárias ou secundárias para o namespace ou fila ou regra de autorização ou fila especificada.
...
Regenera as cadeias de conexão primárias ou secundárias do namespace.
...
Regenera as cadeias de conexão primárias ou secundárias do tópico.
