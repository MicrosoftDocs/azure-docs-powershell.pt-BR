...
## Descrição
O cmdlet **Remove-AzServiceBusTopic** remove o tópico do namespace de Barra de Serviços especificado.
...
Remove o tópico `SB-Topic_exampl1` do `SB-Example1` namespace.
...
### Exemplo 5: ResourceId usando o valor de cadeia de caracteres
```powershell
...
### -InputObject
Objeto de tópico da Barra de Serviços
...
### -ResourceId
ID do Recurso de Tópico da Barra de Serviços
