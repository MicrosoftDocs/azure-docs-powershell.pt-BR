...
## Descrição
O cmdlet **Set-AzServiceBusQueue** atualiza a descrição da fila de Barra de Serviços no namespace de Barra de Serviços especificado.
...
Atualiza a fila especificada com uma nova descrição no namespace especificado. Este exemplo atualiza a **propriedade DeadLetteringOnMessageExpiration** como verdadeira **e a SupportOrdering** como **verdadeira.** 
