...
## Descrição
O cmdlet **Get-AzServiceBusRule** obtém a descrição da regra especificada na determinada assinatura do tópico.
...
Retorna uma lista de descrições de regras para uma assinatura especificada.  Por padrão, a regra 100 será retornada, se mais de 100 regra for retornada, use o Parâmetro -MaxCount.
...
Retorna uma lista das primeiras 150 descrições de regras para uma assinatura especificada.
...
### -MaxCount
Determine o número máximo de regras a ser retornada.
