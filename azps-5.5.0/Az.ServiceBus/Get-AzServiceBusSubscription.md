...
## Descrição
O cmdlet **Get-AzServiceBusSubscription** retorna uma descrição de assinatura para o tópico de Barra de Serviços especificado.
...
Retorna uma descrição de assinatura para o tópico especificado do Service Bus.
...
Retorna a lista de assinaturas para o tópico especificado do Service Bus. Por padrão, 100 assinaturas serão retornadas. Para o número de assinaturas, use -MaxCount Parameter
...
Retorna a lista das primeiras 150 assinaturas para o tópico especificado do Service Bus.
