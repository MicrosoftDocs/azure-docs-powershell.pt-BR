...
## Descrição
O cmdlet **Get-AzServiceBusAuthorizationRule** obtém a descrição da regra de autorização especificada no namespace ou fila ou tópico ou alias (configurações geodr).
