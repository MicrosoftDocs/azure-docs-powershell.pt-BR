...
Adiciona a sub-rede e IgnoreMissingVnetServiceEndpoint (VirtualNetworkRule) ao NetworkRuleSet para o namespace determinado
...
Adiciona o $virtualruleset 1 ao NetworkRuleSet para o namespace determinado
