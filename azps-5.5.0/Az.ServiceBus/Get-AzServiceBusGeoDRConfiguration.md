...
## Descrição
O **Get-AzServiceBusGeoDRConfiguration** recupera alias(configuração de Recuperação de Desastres) para namespace primário ou secundário
...
Recupera a configuração de alias "SampleDRConfigName" para o namespace principal "SampleNamespace_Primary"
