...
Exclui o NetworkRuleSet do namespace "ServiceBus-Namespace1-1375" dado 

### Exemplo 2
```powershell
PS C:\> Remove-AzServiceBusNetworkRuleSet -InputObject $result1375
```
Nome : DefaultAction padrão: Allow Id : /subscriptions/subscriptionId/resourceGroups/RSG-TestAzEventhub/providers/Microsoft.EventHub/namespaces/Eventhub-Namespace-1375/networkRuleSets/default Type: Microsoft.EventHub/Namespaces/NetworkRuleSet IpRules : VirtualNetworkRules : 
