...
## Descrição
O cmdlet **Set-AzServiceBusSubscription** atualiza a descrição da assinatura para o tópico De barramento de serviço no namespace de Barra de Serviços especificado.
...
Atualiza a descrição da assinatura especificada para o determinado tópico. Este exemplo atualiza a **propriedade DeadLetteringOnMessageExpiration** como **true** e **MaxDeliveryCount** para 9.
...
### -InputObject
Definição de assinatura do ServiceBus.
