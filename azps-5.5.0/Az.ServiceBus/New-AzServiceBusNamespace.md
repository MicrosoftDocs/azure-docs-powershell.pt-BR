...
## Descrição
O **cmdlet New-AzServiceBusNamespace** cria um novo namespace de Barra de Serviços. Depois de criado, o manifesto de recurso namespace é imutável. Esta operação é idementente.
...
Cria um novo namespace de Barra de Serviços dentro do grupo de recursos especificado.
...
### -SkuCapacity
As unidades de transferência de namespace premium do Service Bus, valores permitidos 1 ou 2 ou 4
...
### -SkuName
O nome da SKU do namespace de barra de serviços.
