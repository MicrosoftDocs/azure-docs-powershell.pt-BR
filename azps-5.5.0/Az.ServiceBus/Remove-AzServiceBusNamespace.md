...
Remove o namespace da Barra de Serviços `SB-Example1` do grupo de recursos `Default-ServiceBus-WestUS` especificado.
...
Remove o namespace de Service Bus fornecido por meio do $inputobject.

### Exemplo 2.2 - InputObject - Usando a piping:
```
PS C:\> Get-AzServiceBusNamespace <params> | Remove-AzServiceBusNamespace
```

Remove o namespace da Barra de Serviços usando a Piping.
...
Remove o namespace de Barra de Serviço fornecido por meio da ID arm $resourceid parâmetro -ResourceId ou por meio de piping.
...
### -InputObject
Objeto Namespace da Barra de Serviços
...
### -ResourceId
ID do Recurso Namespace do Barramento de Serviço
