...
## Descrição
O **cmdlet New-AzServiceBusRule** cria uma nova regra para determinada assinatura.
...
O New-AzServiceBusRule cmdlet cria uma nova regra para a Assinatura especificada.
...
O New-AzServiceBusRule cmdlet cria uma nova regra para a assinatura especificada com o ActionFilter.
...
### - RequerPreprocessamento
Ação requer pré-processamento
