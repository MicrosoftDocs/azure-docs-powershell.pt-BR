...
## Descrição
O cmdlet **Set-AzServiceBusTopic** atualiza um objeto de descrição para um tópico de Barra de Serviço no namespace de Barra de Serviços especificado.
...
Atualiza o tópico especificado com uma nova descrição no namespace especificado. Este exemplo atualiza a **propriedade EnableExpress** como **verdadeira.** 
...
### -InputObject
Definição de Tópico do ServiceBus.
