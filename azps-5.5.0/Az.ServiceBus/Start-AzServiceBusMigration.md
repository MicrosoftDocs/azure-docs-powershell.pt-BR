...
## Descrição
O **cmdlet Start-AzServiceBusMigration** cria uma nova configuração de migração e começa a migrar entidades de namespaces Padrão para Premium
...
Cria uma nova configuração de migração para 'TestingNamespaceStandardMigration' para namespaces 'TestingNamespacePremiumMigration'
...
### -PostMigrationName
Nome pós-migração para Namespace Padrão na Migração
