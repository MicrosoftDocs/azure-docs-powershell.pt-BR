...
## Descrição
O cmdlet **New-AzServiceBusAuthorizationRule** cria uma nova regra de autorização para o namespace ou fila ou tópico do Service Bus especificado.
...
Cria `AuthoRule1` com os **direitos** ouvir **e enviar** para o namespace. `SB-Example1`
...
Cria `AuthoRule1` com os **direitos** ouvir **e** enviar para a `SBQueue` fila.
...
Cria `AuthoRule1` com Os **direitos** de **Ouvir e** Enviar para o `SBTopic` tópico.
