...
Retorna a lista de filas para determinado namespace, por padrão, 100 filas serão retornadas, se mais de 100 filas serem retornadas, use o Parâmetro -MaxCount.
...
Retorna a lista das primeiras 150 filas para determinado namespace
...
### -MaxCount
Determine o número máximo de filas a retornar.
