...
## Sinopse
Obtém a política de um certificado em um cofre de chave.
...
## Descrição
O cmdlet **Get-AzKeyVaultCertificatePolicy** obtém a política de um certificado em um cofre de chave no Cofre de Teclas do Azure.
...
Esse comando obtém a política de certificado do certificado TestCert01 no cofre de teclas ContosoKV01.
