...
## Sinopse
Exporta os dados de domínio de segurança de um HSM gerenciado.
...
## Descrição
Exporta os dados de domínio de segurança de um HSM gerenciado para importação em outro HSM.
...
Esse comando recupera o HSM gerenciado chamado testmhsm e salva um backup desse domínio de segurança HSM gerenciado no arquivo de saída especificado.

## Parâmetros

### -Certificados
Caminhos para os certificados usados para criptografar os dados do domínio de segurança.
...
### -Forçar
Especifique se deve substituir o arquivo existente.
...
### -OutputPath
Especifique o caminho para o qual os dados do domínio de segurança serão baixados.
...
### -PassThru
Quando especificado, um boolano será retornado quando o cmdlet for bem-sucedido.
...
### -Quorum
O número mínimo de compartilhamentos necessário para descriptografar o domínio de segurança para recuperação.
