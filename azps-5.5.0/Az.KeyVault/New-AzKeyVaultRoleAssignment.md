...
A função que está sendo atribuída deve ser especificada usando o parâmetro RoleDefinitionName pr RoleDefinitionId. O escopo no qual o acesso está sendo concedido pode ser especificado. Ele é padrão para a assinatura selecionada.
...
Este exemplo atribui a função "Administrador de Política HSM Gerenciada" ao user1@microsoft.com usuário" no escopo superior.
