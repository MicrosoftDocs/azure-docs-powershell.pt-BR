...
## Sinopse
Cria um objeto de detalhes da organização de certificados na memória.
...
## Descrição
O **cmdlet New-AzKeyVaultCertificateOrganizationDetail** cria um objeto de detalhes da organização de certificados de memória.
...
O primeiro comando cria um objeto de detalhes do administrador de certificados e, em seguida, o armazena na variável $AdminDetails dados.
O segundo comando cria um objeto de detalhes da organização de certificados e o armazena na variável $OrgDetails certificado.

## Parâmetros

### -AdministratorDetails
Especifica os administradores da organização de certificados.
...
### System.Collections.Generic.List'1[Microsoft.Azure.Commands.KeyVault.Models.PSKeyVaultCertificateAdministratorDetails, Microsoft.Azure.PowerShell.Cmdlets.KeyVault, Version=1.0.0.0,0, Culture=neutral, PublicKeyToken=null]]
