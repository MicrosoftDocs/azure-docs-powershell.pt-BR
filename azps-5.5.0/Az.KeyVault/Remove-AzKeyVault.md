...
## Descrição
O **cmdlet Remove-AzKeyVault** exclui o cofre de chave especificado.
...
### Exemplo 1: Remover um cofre de chave
```powershell
...
Esse comando remove o cofre de chave chamado Contoso03Vault da sua assinatura atual.

### Exemplo 2: Remover um cofre de chave de um grupo de recursos especificado
```powershell
...
Esse comando remove o cofre de chave chamado Contoso03Vault do grupo de recursos nomeado.
Se você não especificar o nome do grupo de recursos, o cmdlet procurará o cofre de chave nomeado para excluir na assinatura atual.
...
Por padrão, esse cmdlet solicita que você confirme que deseja excluir o cofre de chave.
...
### -InputObject
Objeto do Cofre de Teclas a ser excluído.
...
### -Nomedo Cofre
Especifica o nome do cofre de chave a ser removido.
