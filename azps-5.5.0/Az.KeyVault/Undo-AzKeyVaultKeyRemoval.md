...
## Sinopse
Recupera uma chave excluída em um cofre de chave em um estado ativo.
...
A chave recuperada estará ativa e poderá ser usada para todas as operações de chave normal.
...
Esse comando recuperará a chave "MyKey" que foi excluída anteriormente em um estado ativo e acessível.
