...
## Sinopse
Crie um objeto que represente as configurações da regra de rede.
...
## Descrição
Crie um objeto que represente as configurações da regra de rede que podem ser usadas ao criar um cofre.
