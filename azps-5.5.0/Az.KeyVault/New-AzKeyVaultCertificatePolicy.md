...
## Descrição
O cmdlet **New-AzKeyVaultCertificatePolicy** cria um objeto de política de certificado na memória do Azure Key Vault.
...
Este exemplo cria um certificado SAN com 3 nomes DNS.

## Parâmetros

### -CertificateTransparency
Indica se a transparência do certificado está habilitada para este certificado/emissor; se não especificado, o padrão é "verdadeiro"
...
### -DnsName
Especifica os nomes DNS no certificado. Os Nomes Alternativos de Assunto (SANs) podem ser especificados como nomes DNS.
...
### -EmailAtPercentageLifetime
Especifica a porcentagem da vida útil após a qual o processo automático para a notificação começa.
...
### -KeyType
Especifica o tipo de chave da chave que res atrás do certificado.
Os valores aceitáveis para este parâmetro são:
- Rsa
- RSA-HSM
- Ce
...
### -RenewAtNumberOfDaysBeforeExpiry
Especifica o número de dias antes do vencimento após o qual o processo automático de renovação do certificado começa.
...
### -RenewAtPercentageLifetime
Especifica a porcentagem da vida útil após a qual o processo automático de renovação do certificado começa.
...
### -SecretContentType
Especifica o tipo de conteúdo do novo segredo do cofre de chave.
Os valores aceitáveis para este parâmetro são:
- aplicativo/x-pkcs12
- arquivo de aplicativo/x-pem
