...
Em seguida, **o comando Import-AzKeyVaultSecurityDomain** restaura dados de domínio de segurança de backup anteriores para um HSM gerenciado usando essas chaves.
