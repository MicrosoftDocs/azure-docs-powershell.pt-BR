...
## Sinopse
Exclui uma operação de certificado de um cofre de chave.
...
## Descrição
O cmdlet **Remove-AzKeyVaultCertificateOperation** exclui uma operação de certificado de um cofre de chave.
...
Esse comando remove a operação de certificado chamada TestCert01 do cofre de teclas ContosoKV01 sem solicitar confirmação.
