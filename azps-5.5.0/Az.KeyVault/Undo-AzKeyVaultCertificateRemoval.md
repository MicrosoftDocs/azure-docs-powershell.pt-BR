...
## Sinopse
Recupera um certificado excluído em um cofre de chave em um estado ativo.
...
## Descrição
O cmdlet **Undo-AzKeyVaultCertificateRemoval** recuperará um certificado excluído anteriormente.
...
Esse comando recuperará o certificado "MyCertificate" que foi excluído anteriormente em um estado ativo e acessível.
...
### -Nome
Nome do certificado.
O Cmdlet constrói o FQDN de um certificado do nome do cofre, do ambiente selecionado no momento e do nome do certificado.
