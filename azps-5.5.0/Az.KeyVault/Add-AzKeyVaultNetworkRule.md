...
## Sinopse
Adiciona uma regra para restringir o acesso a um cofre de chave com base no endereço da Internet do cliente.
...
## Descrição
O cmdlet **Add-AzKeyVaultNetworkRule** concede ou restringe o acesso a um cofre de chave para um conjunto de chamador designado por seus endereços IP ou pela rede virtual à qual ele pertence. A regra tem o potencial de restringir o acesso a outros usuários, aplicativos ou grupos de segurança que tenham sido concedidas permissões por meio da política de acesso.
