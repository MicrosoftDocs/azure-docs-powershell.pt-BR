...
## Sinopse
Atualize o estado de um HSM gerenciado pelo Azure.
...
## Descrição
Este cmdlet atualiza o estado de um HSM gerenciado pelo Azure.
...
Atualiza marcas para o Hsm gerenciado nomeado `$hsmName` no grupo de `$resourceGroupName` recursos.

### Exemplo 2: Atualizar um Hsm gerenciado usando a cana
```powershell
...
Atualiza marcas para o Hsm gerenciado usando a sintaxe de canos.
