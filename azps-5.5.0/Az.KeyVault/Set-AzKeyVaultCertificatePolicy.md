...
## Sinopse
Cria ou atualiza a política de um certificado em um cofre de chave.
...
## Descrição
O cmdlet **Set-AzKeyVaultCertificatePolicy** cria ou atualiza a política de um certificado em um cofre de chave.
...
Esse comando define a política para o certificado TestCert01 no cofre de teclas ContosoKV01.
