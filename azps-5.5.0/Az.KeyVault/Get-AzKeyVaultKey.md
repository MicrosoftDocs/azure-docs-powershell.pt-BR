...
Esse comando obtém todas as versões da chave ITPfx no cofre de chaves chamado Contoso.
...
### Exemplo 5: Obter todas as chaves que foram excluídas, mas não limpas para este cofre de chave
```powershell
