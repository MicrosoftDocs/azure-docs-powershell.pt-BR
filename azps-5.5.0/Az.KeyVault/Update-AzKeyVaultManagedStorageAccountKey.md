...
## Sinopse
Regenera a chave especificada da Conta de Armazenamento gerenciada pelo Azure Vault.
...
## Descrição
Regenera a chave especificada da Conta de Armazenamento gerenciada pelo Azure Vault e define a chave como a chave ativa. O Cofre de Teclas proxifica a chamada para o Gerenciador de Recursos do Azure para regenerar a chave. O chamador deve ter permissões para regenerar chaves em determinada Conta de Armazenamento do Azure.
...
Regenera a "chave1" da conta "mystorageaccount" e define "chave1" como a ativa da Conta de Armazenamento gerenciada do Azure Do Cofre de Chaves.
...
### -KeyName
Nome da chave da conta de armazenamento para regenerar e tornar ativos.
