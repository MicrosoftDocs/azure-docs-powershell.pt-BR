...
## Descrição
O cmdlet **Get-AzKeyVaultManagedHsm obtém** informações sobre os HSMs gerenciados em uma assinatura. Você pode exibir todas as instâncias de HSMs gerenciadas em uma assinatura ou filtrar seus resultados por um grupo de recursos ou um HSM gerenciado específico.
Observe que, embora especificar o grupo de recursos seja opcional para esse cmdlet quando você obter um único HSM gerenciado, deverá fazê-lo para obter um melhor desempenho.
...
Esse comando obtém todas as HSMs gerenciadas no grupo de recursos chamado myrg1.
...
### -Nome
Nome HSM. O Cmdlet construirá o FQDN de um HSM com base no nome e no ambiente selecionado no momento.
