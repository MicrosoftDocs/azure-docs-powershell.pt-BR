...
## Descrição
O cmdlet **Get-AzKeyVaultCertificateOperation** obtém o status de uma operação de certificado.
...
Esse comando obtém o status da operação de certificado para TestCert01 no cofre de teclas ContosoKV01.
