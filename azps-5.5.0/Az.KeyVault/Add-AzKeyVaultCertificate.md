...
## Descrição
O cmdlet **Add-AzKeyVaultCertificate** inicia o processo de inscrição para um certificado em um cofre de chave no Cofre de Teclas do Azure.
...
O primeiro comando usa o cmdlet New-AzKeyVaultCertificatePolicy para criar uma política de certificado e a armazena na variável $Policy dados.
O segundo comando usa **Add-AzKeyVaultCertificate** para iniciar o processo para criar um certificado.
O terceiro comando usa o Get-AzKeyVaultCertificateOperation cmdlet para sondar a operação para verificar se ele está concluído.
O comando final usa o Get-AzKeyVaultCertificate cmdlet para obter o certificado.
...
### -Nome
Especifica o nome do certificado a ser acrescentado.
