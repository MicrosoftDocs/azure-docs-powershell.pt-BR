...
Esse comando remove todas as permissões que um usuário tem PattiFuller@contoso.com no cofre de teclas chamado Contoso03Vault.  Se -PassThru for especificado, o objeto KeyVault será retornado.
