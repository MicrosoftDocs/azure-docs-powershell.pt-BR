...
### Exemplo 1: remover o aplicativo Da Nuvem de Primavera por nome.
```powershell
PS C:\> Remove-AzSpringCloudApp -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway
```

Remover o Aplicativo da Nuvem de Primavera por nome.

### Exemplo 2: Remover o aplicativo Nuvem de Primavera do cano.
```powershell
PS C:\> Get-AzSpringCloudApp -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway | Remove-AzSpringCloudApp
```

Remover o Aplicativo da Nuvem de Primavera do cano.
