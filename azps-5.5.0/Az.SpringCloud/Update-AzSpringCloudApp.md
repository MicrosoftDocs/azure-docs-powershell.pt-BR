...
### Exemplo 1: Atualizar o aplicativo cloud spring por nome.
```powershell
...
Atualize o Aplicativo da Nuvem de Primavera por nome.

### Exemplo 2: Atualizar o Aplicativo na Nuvem da Primavera a partir do cano.
```powershell
...
Atualize o Aplicativo da Nuvem de Primavera a partir do cano.
...
### -Local
A localização GEO do aplicativo, sempre a mesma com seu recurso pai
