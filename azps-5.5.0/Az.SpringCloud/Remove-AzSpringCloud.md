...
### Exemplo 1: Remover o Serviço de Nuvem de Primavera por nome.
```powershell
PS C:\> Remove-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service
```

Remover o Serviço de Nuvem de Primavera por nome.

### Exemplo 2: Remover o Serviço de Nuvem de Primavera do cano.
```powershell
PS C:\> Get-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service | Remove-AzSpringCloud
```

Remover o Serviço de Nuvem de Primavera do cano.
