...
### Exemplo 1: Obter o Serviço de Nuvem da Primavera por nome
```powershell
...
Obter o Serviço de Nuvem de Primavera por nome

### Exemplo 2: Listar todos os serviços de nuvem de primavera sob o grupo de recursos.
```powershell
...
Listar todos os serviços de nuvem de primavera sob o grupo de recursos.
