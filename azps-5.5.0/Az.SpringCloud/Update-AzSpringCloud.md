...
### Exemplo 1: Atualizar o Serviço de Nuvem da Primavera por nome.
```powershell
...
Atualize o Serviço de Nuvem de Primavera por nome.

### Exemplo 2: Atualizar o Serviço de Nuvem de Primavera do cano.
```powershell
...
Atualize o Serviço de Nuvem de Primavera do cano.
...
### -TraceAppInsightInstrumentationKey
Chave de instrumentação de informações do aplicativo de destino
