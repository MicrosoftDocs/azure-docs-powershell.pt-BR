...
### Exemplo 1: Implantar o jar compilado local para o serviço por nome.
```powershell
...
Implante o jar compilado local para o serviço por nome.
...
### -JarPath
O caminho do jarro precisa ser deplorável.
