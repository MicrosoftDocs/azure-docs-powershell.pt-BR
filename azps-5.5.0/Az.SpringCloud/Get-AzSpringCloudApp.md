...
### Exemplo 1: Obter o aplicativo Cloud Spring por nome.
```powershell
...
Obter o aplicativo Nuvem de Primavera por nome.

### Exemplo 2: Listar todos os aplicativos em um determinado serviço de nuvem de primavera.
```powershell
...
Liste todos os aplicativos em um determinado serviço de nuvem de primavera.
