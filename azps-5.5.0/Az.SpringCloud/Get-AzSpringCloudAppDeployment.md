...
### Exemplo 1: Obter a Implantação do aplicativo Cloud Spring por nome.
```powershell
...
Obter o Nome do aplicativo Spring Cloud Deploymeng.

### Exemplo 2: Listar toda a implantação em um determinado aplicativo de nuvem de primavera.
```powershell
