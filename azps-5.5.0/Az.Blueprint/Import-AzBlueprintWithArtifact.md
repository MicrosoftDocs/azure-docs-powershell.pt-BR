...
## Descrição
Importe uma definição de planta com seus artefatos. 
...
Importe uma definição de planta com seus artefatos e salve em uma assinatura.
...
### -PassThru
Quando definido, o cmdlet retornará um objeto que representa a definição de diagrama importada. Por padrão, esse cmdlet não gera saída.
