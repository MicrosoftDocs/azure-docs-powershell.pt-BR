...
## Descrição
Atribua uma definição de plano de trabalho a uma assinatura.
...
Crie uma nova atribuição de diagrama da definição de diagrama dentro da assinatura especificada usando o parâmetro definido e o dicionário de grupo `$blueprintObject` de recursos. Usa a identidade atribuída pelo sistema. O local define a região para a criação da identidade gerenciada.
...
Crie uma nova atribuição de diagrama da definição de diagrama dentro da assinatura especificada usando o parâmetro definido e o dicionário do grupo de recursos e configurando o bloqueio de recursos para `$blueprintObject` **AllResources.** Padrões para usar a identidade atribuída pelo sistema.  O local define a região para a criação da identidade gerenciada.
...
Crie uma nova atribuição de diagrama da definição de diagrama dentro da assinatura especificada usando o parâmetro definido e o dicionário de grupo de recursos usando a ID de identidade atribuída `$blueprintObject` pelo usuário especificada.
...
Crie uma nova atribuição de diagrama da definição de diagrama visando a assinatura especificada dentro do `$blueprintObject` grupo de gerenciamento especificado usando o parâmetro definido.
...
### -Local
Região para a criação da identidade gerenciada.
Saiba mais no aka.ms/blueprintmsi
...
### -Lock
Bloquear recursos.
Saiba mais no aka.ms/blueprintlocks
...
### -ManagementGroupId
A ID do grupo de gerenciamento onde as atribuições de Diagrama serão salvas.
...
Parâmetro de cadeia de caracteres seguro para a ID, o nome e a versão do recurso KeyVault.
...
### -SubscriptionId
ID da assinatura para atribuir a definição de diagrama.
...
Identidade atribuída pelo sistema (MSI) para implantar os artefatos.
...
Identidade atribuída pelo usuário (MSI) para implantar os artefatos.
