...
## Descrição
Obter uma ou mais definições de diagrama. As definições de diagrama existem no grupo de gerenciamento ou no escopo da assinatura.
...
Obter as definições de diagrama dentro da assinatura atual e a hierarquia de grupo de gerenciamento da assinatura.
...
Obter as definições de diagrama dentro do grupo de gerenciamento especificado.
...
Obter as definições de diagrama dentro da assinatura especificada e a hierarquia de grupo de gerenciamento da assinatura.
...
Obter a definição de diagrama com o nome determinado dentro da assinatura especificada.
...
Obter a definição do diagrama com o nome e a versão indicados dentro do grupo de gerenciamento especificado.
...
Obter a definição de diagrama publicada mais recente com o nome determinado dentro do grupo de gerenciamento especificado.
...
### -LatestPublished
O sinalizador de definição de planta publicado mais recente.
Quando definida, a execução retorna a versão publicada mais recente da definição de diagrama.
O padrão é falso.
...
### -ManagementGroupId
ID do Grupo de Gerenciamento onde a definição de diagrama é salva.
...
### -SubscriptionId
ID da assinatura onde a definição de plano de trabalho é salva.
