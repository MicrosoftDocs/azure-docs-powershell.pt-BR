...
## Descrição
Atualizar um artefato. Há duas maneiras de atualizar um artefato: através de um artefato JSON como um arquivo de entrada ou por meio do fornecimento de parâmetros em linha para o artefato. Embora o método JSON não exija que o tipo do artefato seja fornecido, o método de parâmetro em linha requer que o usuário forneça o tipo do artefato por meio do parâmetro Tipo.
...
Atualize um artefato por meio de parâmetros em linha.
...
Atualize um artefato por meio de um arquivo de modelo ARM.
