...
### Exemplo 1: Listar todos os resultados de executar em um modelo
```powershell
...
Esse comando lista todos os resultados de executar em um modelo.

### Exemplo 2: Obter um resultado de executar em um modelo
```powershell
...
Esse comando obtém um resultado de executar em um modelo.

### Exemplo 3: Obter um resultado de executar em um modelo
```powershell
