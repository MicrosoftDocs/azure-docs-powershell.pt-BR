...
## Sinopse
Cancelar a com build de imagem de longa execução com base no modelo de imagem
...
### Exemplo 1: Interromper a criação de modelos de imagem
```powershell
...
Esse comando interrompe a criação do modelo de imagem.

### Exemplo 2: Interromper a criação de modelos de imagem
```powershell
PS C:\> Start-AzImageBuilderTemplate -ImageTemplateName template-name-sn78hg -ResourceGroupName wyunchi-imagebuilder -AsJob 
