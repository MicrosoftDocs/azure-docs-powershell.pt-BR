...
## Descrição
O cmdlet **Remove-AzStreamAnalyticsOutput** exclui assíncronamente uma saída de um trabalho do Stream Analytics no Azure.
...
Esse comando remove a saída Saída no trabalho Streaming Job.
...
### -Nome
Especifica o nome da saída do Azure Stream Analytics para remover.
