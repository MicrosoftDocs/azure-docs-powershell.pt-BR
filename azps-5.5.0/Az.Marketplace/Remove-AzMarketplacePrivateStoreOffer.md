...
## Sinopse
Remover uma oferta do armazenamento particular.
...
## Descrição
Remover uma oferta do armazenamento particular que foi criada no escopo do locatário.
...
### -PrivateStoreId
Azure Marketplace privateStore obrigatório
