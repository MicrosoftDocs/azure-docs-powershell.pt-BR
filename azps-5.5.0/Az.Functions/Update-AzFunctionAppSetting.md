...
## Sinopse
Adiciona ou atualiza as configurações do aplicativo em um aplicativo de função.
...
Esse comando adiciona uma nova configuração de aplicativo em um aplicativo de função.
