...
### Exemplo 1: Obter um aplicativo de função por nome e excluí-lo.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Remove-AzFunctionApp -Force
```

Esse comando obtém um aplicativo de função por nome e o exclui.

### Exemplo 2: Excluir um aplicativo de função por nome.
```powershell
PS C:\> Remove-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName -Force
```

Esse comando exclui um aplicativo de função por nome.
...
### -Forçar
Força o cmdlet a remover o aplicativo de função sem solicitar confirmação.
