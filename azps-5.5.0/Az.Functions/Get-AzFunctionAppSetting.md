...
## Sinopse
Obtém configurações de aplicativo para um aplicativo de função.
...
### Exemplo 1: Obter as configurações de aplicativo de um aplicativo de função.
```powershell
PS C:\> Get-AzFunctionAppSetting -Name MyAppName -ResourceGroupName MyResourceGroupName
```

Esse comando obtém as configurações de aplicativo de um aplicativo de função.
