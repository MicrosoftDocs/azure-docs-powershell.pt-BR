...
### Exemplo 2: Obter aplicativos de função por nome.
```powershell
...
### Exemplo 4: Obter aplicativos de função para determinadas assinaturas.
```powershell
...
### -IncludeSlot
Use para especificar se você deve incluir slots de implantação nos resultados.
