...
### Exemplo 1: Crie um plano de aplicativo premium do Windows na Europa Ocidental com capacidade de saída de até 10 instâncias.
```powershell
...
Esse comando cria um plano de aplicativo premium do Windows na Europa Ocidental com capacidade de saída de até 10 instâncias.
...
### -WorkerType
O tipo de trabalhador do plano.
