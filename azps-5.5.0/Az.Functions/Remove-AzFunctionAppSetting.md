...
### Exemplo 1: Remover configurações do aplicativo em um aplicativo de função.
```powershell
...
Esse comando remove as configurações do aplicativo em um aplicativo de função.

## Parâmetros

### -AppSettingName
Lista de configurações do aplicativo de função a ser removida do aplicativo de função.
