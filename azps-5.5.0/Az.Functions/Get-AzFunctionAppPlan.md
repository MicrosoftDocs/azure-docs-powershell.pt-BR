...
### Exemplo 2: Obter planos do aplicativo de função por nome de grupo de recursos.
```powershell
...
Este comando obtém planos do aplicativo de função por nome do grupo de recursos.

### Exemplo 3: Obter planos do aplicativo de função para determinadas assinaturas.
```powershell
...
Este comando obtém planos do aplicativo de função para as assinaturas determinadas.

### Exemplo 4: Obter planos do aplicativo de função por local.
```powershell
...
Este comando obtém planos do aplicativo de função por local.
