...
### Exemplo 1: Criar um aplicativo de função de consumo do PowerShell na Central dos EUA.
```powershell
...
Esse comando cria um aplicativo de função de consumo do PowerShell na Central dos EUA.
...
Desabilitar a criação de recursos de informações do aplicativo durante a criação do aplicativo de função.
Não haverá logs disponíveis.
...
### -DockerImageName
Somente Linux.
Nome da imagem do contêiner do Registro Docker, por exemplo, publisher/image-name:tag.
