...
### Exemplo 1: Obter um aplicativo de função por nome e in inicie-o.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Start-AzFunctionApp
```

Esse comando obtém um aplicativo de função por nome e o inicia.

### Exemplo 2: Iniciar um aplicativo de função por nome.
```powershell
PS C:\> Start-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName
```

Esse comando inicia um aplicativo de função por nome.
