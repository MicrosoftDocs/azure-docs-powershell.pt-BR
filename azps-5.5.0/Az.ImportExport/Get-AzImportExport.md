...
### Exemplo 1: Obter o trabalho ImportExport com contexto padrão
```powershell
...
### Exemplo 2: Obter o trabalho ImportExport por grupo de recursos e nome do trabalho
```powershell
...
### Exemplo 4: Obter o trabalho ImportExport por identidade
```powershell
...
Essa lista de cmdlets obtém o trabalho ImportExport por identidade.
