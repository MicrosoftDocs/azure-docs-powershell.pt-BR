...
### Exemplo 1: Criar uma nova Lista de Discos para o trabalho ImportExport
```powershell
...
Esses cmdlets criam uma nova Lista de Discos para o trabalho ImportExport.
...
Esse campo não será retornado na resposta até que a unidade seja transferida.
...
### -ManifestHash
O hash MD5 codificado com Base16 do arquivo de manifesto na unidade.
