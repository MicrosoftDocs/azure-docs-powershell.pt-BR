...
### Exemplo 1 Remover uma chave da api de informações do aplicativo para um recurso de insights de aplicativo
```
...
Remova a chave da api de insights de aplicativo específica que id seja "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" para "teste" do recurso no grupo de recursos "grupo de teste".
