...
### Exemplo 1 Componente atualizar informações do aplicativo
```powershell
Update-AzApplicationInsights -ResourceGroupName "rgName" -Name "aiName" -PublicNetworkAccessForIngestion "Disabled" -PublicNetworkAccessForQuery "Disabled"
```

componente atualizar insights do aplicativo "aiName" PublicNetworkAccessForIngestion/PublicNetworkAccessForQuery ambos como "Desabilitados"
...
O tipo de acesso à rede para acessar a ingestão de Informações do Aplicativo.
...
O tipo de acesso à rede para acessar a consulta Informações do Aplicativo.
O valor deve ser "Habilitado" ou "Desabilitado"
