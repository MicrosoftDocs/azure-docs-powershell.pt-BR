...
### Exemplo 1 Criar um novo recurso de ideias de aplicativo
```
...
Adicionar um novo recurso de insights de aplicativo denominado "teste" no grupo de recursos "grupo de teste" com o tipo "java"
...
### -Local
Local do recurso Informações do Aplicativo.
...
O tipo de acesso à rede para acessar a ingestão de Informações do Aplicativo. O valor deve ser "Habilitado" ou "Desabilitado"
...
O tipo de acesso à rede para acessar a consulta Informações do Aplicativo. O valor deve ser "Habilitado" ou "Desabilitado"
