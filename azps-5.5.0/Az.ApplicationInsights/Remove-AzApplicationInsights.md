...
### Exemplo 1 Remover um recurso de ideias de aplicativo
```
PS C:\> Remove-AzApplicationInsights -ResourceGroupName "testgroup" -Name "test" -PassThru
True
```

Remover um recurso de ideias de aplicativo chamado "teste" no grupo de recursos "grupo de teste"
...
### -PassThru
Se especificado, a gravação será verdadeira caso a operação seja bem-sucedida. Este parâmetro é opcional. O valor padrão é falso.
