...
### Exemplo 1 Obter Chaves da Api para um recurso de informações do aplicativo
```
...
Obter chaves da API de insights do aplicativo para o "teste" do recurso no grupo de recursos "grupo de teste".

### Exemplo 2 Obter uma chave de API específica para um recurso de ideias de aplicativo
```
...
Obter uma chave de api de insights de aplicativo específica que id é "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" para o recurso "teste" no grupo de recursos "grupo de teste".

## Parâmetros

### -ApiKeyId
ID da Chave da Api do Insights do Aplicativo.
