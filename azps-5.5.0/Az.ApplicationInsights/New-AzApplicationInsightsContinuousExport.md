...
### Exemplo 1 Criar uma nova configuração de exportação contínua para um recurso de insights de aplicativo
```
...
Crie uma nova configuração de exportação de insights de aplicativos para exportar tipos de documentos "Solicitar" e "Rastrear" para o armazenamento que contenham "testcontainer" na conta de armazenamento "teststorageaccount" no grupo de recursos "grupo de teste". O token SAS deve ser válido e ter permissão de gravação para o contêiner, caso contrário, o recurso de exportação contínua não funcionará. Se o token SAS tiver expirado, o recurso de exportação contínua não funcionará mais.
...
### -DocumentType
Tipos de documentos que precisam ser exportados.
...
### -StorageSASUri
Uri SAS de armazenamento de destino.
