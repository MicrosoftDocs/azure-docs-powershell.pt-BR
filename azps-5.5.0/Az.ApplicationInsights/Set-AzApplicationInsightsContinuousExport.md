...
Atualize a configuração contínua de exportação "jlTFEiBg1rkDXOCIeJQ2mB2TxZg=" de "teste" do recurso no grupo de recursos "grupo de teste" para exportar documentos "Solicitar" e "Rastrear" para o contêiner de armazenamento "testcontainer" em "teststorageaccount". O token SAS deve ser válido e ter permissão de gravação para o contêiner, caso contrário, o recurso de exportação contínua não funcionará. Se o token SAS tiver expirado, o recurso de exportação contínua não funcionará mais.
...
Desabilitar a exportação contínua ou não.
