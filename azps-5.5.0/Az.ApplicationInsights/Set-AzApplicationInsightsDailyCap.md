...
### Exemplo 1 Definir o limite de volume de dados diários para um recurso de informações do aplicativo
```
...
Definir o limite de volume de dados diários como 400 GB por dia e interromper o envio de notificação quando atingir o limite para o recurso "teste" no grupo de recursos "grupo de teste"
