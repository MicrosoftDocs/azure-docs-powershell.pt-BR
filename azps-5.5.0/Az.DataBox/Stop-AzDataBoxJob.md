...
## Sinopse
Cancela um trabalho em andamento da caixa de dados se o trabalho estiver em estado cancelável.
...
## Descrição
O cmdlet **Stop-AzDataBox Job** é usado para cancelar um trabalho de caixa de dados.
...
Cancela o trabalho da caixa de dados especificada
...
Cancela o trabalho especificado da caixa de dados com força sem confirmação
...
### -ResourceId
ID do Recurso da Caixa de Dados
