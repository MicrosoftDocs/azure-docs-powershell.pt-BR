...
## Sinopse
Exclui o trabalho da caixa de dados
...
## Descrição
O cmdlet **Remove-AzDataBox Job é** usado para excluir um trabalho de caixa de dados concluído da lista de trabalhos da caixa de dados.
...
Exclui o trabalho da caixa de dados especificada
...
Exclui o trabalho da caixa de dados especificado com força sem confirmação
