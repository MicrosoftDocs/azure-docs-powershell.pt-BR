...
## Descrição
O **cmdlet Remove-AzCognitiveServicesAccount** exclui a conta especificada dos Serviços Cognitivas.

## Exemplos

### Exemplo 1
Este comando não retorna nada.
...
### -Nome
Especifica o nome da conta a ser excluído.
