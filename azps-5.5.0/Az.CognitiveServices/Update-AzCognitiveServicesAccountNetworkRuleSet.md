...
## Descrição
O cmdlet **Update-AzCognitiveServicesAccountNetworkRuleSet** atualiza a propriedade NetworkRule de uma conta do Cognitive Services
...
### Exemplo 3: Limpar regras de NetworkRule de uma conta dos Serviços Cognitivas
```
...
Este comando limpa as regras de NetworkRule de uma conta dos Serviços Cognitivas (outras propriedades não mudam).

## Parâmetros

### -DefaultAction
NetworkRule DefaultAction da Conta dos Serviços Cognitivas. Valor `Deny` padrão.
