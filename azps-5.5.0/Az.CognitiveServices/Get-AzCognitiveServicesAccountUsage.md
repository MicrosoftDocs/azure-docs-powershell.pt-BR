...
## Descrição
O cmdlet **Get-AzCognitiveServicesAccountUsage obtém** os usos atuais de uma conta do Cognitive Services.
...
### -InputObject
Objeto de Conta do Serviço Cognitiva.
...
### -ResourceId
ID do Recurso de Conta do Serviço Cognitiva.
