...
Não é possível adicionar ou remover registros SOA, mas você pode editá-los.
...
Como um conjunto de registros CNAME pode conter no máximo um registro, ele deve ser inicialmente um conjunto de registros vazio ou os registros existentes devem ser removidos usando Remove-AzDnsRecordConfig.
