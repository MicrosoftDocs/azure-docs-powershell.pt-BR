...
## Descrição
O cmdlet **Set-AzBatchPool** atualiza as propriedades de um pool no serviço Lote do Azure.
...
O primeiro comando obtém um pool usando **Get-AzBatchPool** e o armazena na variável $Pool dados.
Os três comandos a seguir modificam a especificação da tarefa inicial no $Pool objeto.
O comando final atualiza o serviço Lote para corresponder ao objeto local no $Pool.
...
### -Pool
Especifica o **PSCloudPool** ao qual este cmdlet atualiza o serviço Lote.
