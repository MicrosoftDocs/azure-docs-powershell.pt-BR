...
## Sinopse
Obtém as tarefas em lotes de um trabalho.
...
Você pode especificar o *parâmetro Filtro* para obter as tarefas que corresponderem a um filtro OData (Open Data Protocol).
...
Esse comando obtém a tarefa com a ID Task03 no trabalho Job01.
...
Esse comando obtém as tarefas concluídas do trabalho que tem a ID Job02.
...
Especifique um valor para esse parâmetro para obter entidades associadas da entidade principal.
...
Se você não especificar um filtro, esse cmdlet retornará todas as tarefas da conta ou do trabalho em lotes.
