...
## Sinopse
Obtém informações sobre um pacote de aplicativos em uma conta em lote.
...
## Descrição
O cmdlet **Get-AzBatchApplicationPackage** obtém informações sobre um pacote de aplicativos em uma conta do Azure Batch.

## Exemplos

### Exemplo 1: Obter detalhes de um pacote de aplicativos em uma conta em lotes
```
