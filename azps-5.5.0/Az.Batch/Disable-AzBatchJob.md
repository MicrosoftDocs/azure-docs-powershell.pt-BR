...
## Descrição
O **cmdlet Disable-AzBatch Job** desabilita um trabalho do Azure Batch.
Depois de habilitar um trabalho, novas tarefas podem ser executadas.
Os trabalhos desabilitados não executarão novas tarefas.
...
Esse comando desabilita o trabalho que tem a ID Job-000001.
...
### -DisableJobOption
Especifica o que fazer com tarefas ativas associadas ao trabalho desabilitado por esse cmdlet.
...
### -ID
Especifica a ID do trabalho que este cmdlet desabilita.
