...
### -ComputeNode
Especifica o **objeto PSComputeNode** que representa o nó de computação para reimagem.
...
### -ID
Especifica a ID do nó de computação a ser reimagem.
...
### -ReimageOption
Especifica quando reimage o nó e o que fazer com as tarefas em execução no momento.
O padrão é a sequência.
