...
ms.locfileid: "100112232"
---
# Set-AzBatchApplication

## Sinopse
Configurações de atualizações para o aplicativo especificado.
...
## Descrição
O cmdlet **Set-AzBatchApplication** modifica as configurações do aplicativo Azure Batch especificado.

## Exemplos

### Exemplo 1: Atualizar um aplicativo em uma conta em lote
```powershell
...
Esse comando altera se o aplicativo Litware na conta ContosoBatch permite atualizações.
O comando não altera a versão padrão ou o nome de exibição do aplicativo.

### Exemplo 2

Configurações de atualizações para o aplicativo especificado. (gerado automaticamente)
...
### -NomedaEm conta
Especifica o nome da conta Em lotes para a qual este cmdlet modifica um aplicativo.
