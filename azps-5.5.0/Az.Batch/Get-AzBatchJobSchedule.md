...
## Descrição
O cmdlet **Get-AzBatch JobSchedule obtém** cronogramas de trabalho do Azure Batch para a conta em lotes especificada pelo parâmetro *BatchContext.*
Especifique uma ID para obter um único cronograma de trabalho.
*Especifique o parâmetro* Filtro para obter os cronogramas de trabalho que corresponderem a um filtro OData (Open Data Protocol).
...
Esse comando obtém o cronograma de trabalho que tem o JobSchedule23 da ID.
...
Esse comando obtém todos os cronogramas de trabalho com IDs que começam com Trabalho, especificando o *parâmetro Filtro.*
...
Se você não especificar um filtro, esse cmdlet retornará todos os cronogramas de trabalho para o contexto Lote.
...
### -MaxCount
Especifica o número máximo de cronogramas de trabalho a retornar.
