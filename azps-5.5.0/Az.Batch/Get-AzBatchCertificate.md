...
## Sinopse
Obtém os certificados em uma conta em lote.
...
## Descrição
O cmdlet **Get-AzBatchCertificate** obtém os certificados na conta lote do Azure especificada pelo parâmetro *BatchContext.*
Para obter um certificado específico, especifique os parâmetros *ThumbprintAlgorithm* e *Thumbprint.*
*Especifique o* parâmetro Filtro para obter os certificados que corresponderem a um filtro open data protocol (OData).
...
Esse comando obtém um único certificado com a impressão digital especificada.
O algoritmo de impressão de certificado é sha1.
...
Esse comando obtém todos os certificados no estado ativo da conta Lote.
O *parâmetro Filtro* especifica o estado.
...
Se você especificar esse parâmetro, este cmdlet obtém os certificados que corresponderem ao filtro.
...
### -MaxCount
Especifica o número máximo de certificados a retornar.
