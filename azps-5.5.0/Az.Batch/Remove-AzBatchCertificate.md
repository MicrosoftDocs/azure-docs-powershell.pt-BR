...
## Descrição
O cmdlet **Remove-AzBatchCertificate** remove um certificado da conta especificada do Lote do Azure.
...
Esse comando obtém todos os certificados que estão ativos usando o cmdlet Get-AzBatchCertificate dados.
