...
## Descrição
O **cmdlet Enable-AzBatchAutoScale** habilita o dimensionamento automático do pool especificado.
...
O primeiro comando define uma fórmula e a salva na $Formula variável.
O segundo comando habilita o dimensionamento automático no pool chamado MyPool usando a fórmula $Formula.
