...
## Sinopse
Obtém o resultado de uma fórmula de dimensionamento automática em um pool.
...
O primeiro comando armazena uma fórmula na $Formula variável para uso no exemplo.
