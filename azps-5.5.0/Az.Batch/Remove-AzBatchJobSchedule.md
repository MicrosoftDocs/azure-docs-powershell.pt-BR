...
## Descrição
O cmdlet **Remove-AzBatch JobSchedule** remove um cronograma de trabalho do Azure Batch.
...
Esse comando exclui o cronograma de trabalho que tem o ID My JobSchedule.
O comando solicita a confirmação antes de excluir o trabalho.
Use o cmdlet Get-AzBatchAccountKey para atribuir um contexto à variável $Context dados.

### Exemplo 2: Excluir um trabalho em lote sem confirmação usando o pipeline
```
PS C:\>Get-AzBatchJobSchedule -Id "MyJobSchedule" -BatchContext $Context | Remove-AzBatchJobSchedule -Force -BatchContext $Context
```

Esse comando obtém o cronograma de trabalho que tem o ID My JobSchedule usando o cmdlet Get-AzBatchJobSchedule trabalho.
O comando passa esse cronograma de trabalho para o cmdlet atual usando o operador de pipeline.
O comando exclui esse cronograma de trabalho.
Como o comando inclui o parâmetro *Forçar,* ele não solicita confirmação.
...
### -ID
Especifica a ID do cronograma de trabalho a ser removido.
