...
## Descrição
O cmdlet **Disable-AzBatch JobSchedule** desabilita um cronograma de trabalho do Azure Batch.
Se você desabilitar um cronograma, os trabalhos não serão criados de acordo com esse cronograma.
Você pode habilitar uma agenda desabilitada mais tarde.
...
Esse comando desabilita o cronograma de trabalho que tem o JobSchedule17 de ID.
...
### -ID
Especifica a ID do cronograma de trabalho que este cmdlet desabilita.
