...
## Descrição
O cmdlet **Get-AzBatchSupportedImage** recebe imagens de máquina virtuais com suporte que estão disponíveis em uma conta do Azure Batch.
Especifique a conta usando o parâmetro *BatchContext.*

## Exemplos

### Exemplo 1: Obter todas as imagens com suporte disponíveis
...
Se você não especificar um filtro, esse cmdlet retornará todas as imagens compatíveis com a conta Lote.
...
### -MaxCount
Especifica o número máximo de imagens com suporte a retornar.
