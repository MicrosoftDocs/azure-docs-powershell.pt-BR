...
## Sinopse
Obtém trabalhos em lotes para uma conta em lotes ou cronograma de trabalho.
...
## Descrição
O **cmdlet Get-AzBatchJob** obtém os trabalhos do Lote do Azure para a conta em lotes especificada pelo parâmetro *BatchAccountContext.*
Você pode usar o *parâmetro ID* para obter um único trabalho.
Você pode usar o *parâmetro Filtro* para obter os trabalhos que corresponderem a um filtro OData (Open Data Protocol).
Se você fornecer uma ID de cronograma de trabalho ou uma instância do **PSCloud JobSchedule,** esse cmdlet retornará apenas os trabalhos para esse cronograma de trabalho.
...
### Exemplo 2: Obter todos os trabalhos ativos para um cronograma de trabalho
```
...
Esse comando obtém os trabalhos ativos para o cronograma de trabalho que tem o JobSchedule27 da ID.
...
Esse comando obtém o cronograma de trabalho que tem o JobSchedule27 de ID usando o cmdlet Get-AzBatchJobSchedule trabalho.
O comando passa esse cronograma de trabalho para o cmdlet atual usando o operador de pipeline.
O comando obtém todos os trabalhos para esse cronograma de trabalho.
...
Se você não especificar um filtro, esse cmdlet retornará todos os trabalhos da conta em lotes ou cronograma de trabalho.
...
### -JobSchedule
Especifica um objeto **PSCloudJobSchedule** que representa o cronograma de trabalho que contém os trabalhos.
...
### -JobScheduleId
Especifica a ID do cronograma de trabalho que contém os trabalhos.
...
### -MaxCount
Especifica o número máximo de trabalhos a retornar.
