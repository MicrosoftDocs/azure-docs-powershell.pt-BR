...
Esse comando obtém um arquivo RDP do nó de computação que tem o ID ComputeNode01 no pool que tem o Pool de ID06.
...
Esse comando obtém o nó de computação que tem o ID ComputeNode02 no pool que tem o Pool de ID06.
O comando passa esse nó de computação para o cmdlet atual usando o operador de pipeline.
O cmdlet atual obtém um arquivo .primeiro do nó de computação e salva o conteúdo como um arquivo chamado C:\PowerShell\MyComputeNode02.rdp.

### Exemplo 3: Obter um arquivo RDP de um nó de computação especificado e direcionar para um fluxo
```
...
O segundo comando obtém um arquivo .rdp do nó de computação que tem o ID ComputeNode03 no pool que tem o Pool de ID06.
...
### -ComputeNode
Especifica um nó de computação, como um **objeto PSComputeNode,** para o qual o arquivo .rdp aponta.
...
### -DestinationPath
Especifica o caminho do arquivo onde este cmdlet salva o arquivo .rdp.
...
### -DestinationStream
Especifica o fluxo no qual este cmdlet direciona os dados RDP.
...
### -PoolId
Especifica a ID do pool que contém o nó de computação do qual este cmdlet obtém um arquivo .rdp.
