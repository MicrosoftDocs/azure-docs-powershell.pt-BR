...
## Sinopse
Cria um pacote de aplicativos em uma conta em lote.
...
## Descrição
O cmdlet **New-AzBatchApplicationPackage** cria um pacote de aplicativos em uma conta do Azure Batch.

## Exemplos

### Exemplo 1: Instalar um pacote de aplicativos em uma conta em lote
```
...
Esse comando cria e ativa a versão 1.0 do aplicativo Litware e carrega o conteúdo do litware.1.0.zip como conteúdo do pacote de aplicativos.

## Parâmetros

### -NomedaEm conta
Especifica o nome da conta Em lotes à qual este cmdlet adiciona um pacote de aplicativos.
...
### -ActivateOnly
Indica que esse cmdlet ativa um pacote de aplicativos que já foi carregado.
...
### -Formatar
Especifica o formato do arquivo binário do pacote de aplicativos.
