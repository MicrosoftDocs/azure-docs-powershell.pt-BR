...
## Sinopse
Exclui um arquivo de nó para uma tarefa ou nó de computação.
...
## Descrição
O cmdlet **Remove-AzBatchNodeFile** exclui um arquivo de nó do Azure Batch para uma tarefa ou nó de computação.
...
Esse arquivo está associado à tarefa que tem a Tarefa de ID26 sob o trabalho Job-000001.
...
Esse comando exclui o arquivo de nó denominado startup\testFile.txt do nó de computação especificado no pool que tem o Pool de ID.
...
### -ComputeNodeId
Especifica a ID do nó de computação que contém o arquivo de nó Em lotes que este cmdlet exclui.
...
### -InputObject
Especifica o **objeto PSNodeFile** que representa o arquivo de nó que esse cmdlet exclui.
Para obter um **PSNodeFile,** use Get-AzBatchNodeFile cmdlet.
...
### -PoolId
Especifica a ID do pool que contém os nós de computação para os quais este cmdlet remove um arquivo.
...
Esse cmdlet só será relevante se o caminho for uma pasta.
