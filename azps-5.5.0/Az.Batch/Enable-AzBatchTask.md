...
Se uma tarefa tiver desgastado sua contagem de tentativa, esse cmdlet, no entanto, permitirá que ela seja executado.
...
Esse comando reativa a tarefa Tarefa2 no trabalho 7.
...
Esse comando obtém a tarefa Lote que tem a ID Tarefa3 no trabalho que tem a ID Job8 usando o cmdlet Get-AzBatchTask.
...
### -Tarefa
Especifica a tarefa que este cmdlet reativa.
