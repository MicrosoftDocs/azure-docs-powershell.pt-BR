...
## Descrição
O cmdlet **Stop-AzBatch JobSchedule** interrompe um cronograma de trabalho do Azure Batch.
...
Esse comando interrompe o cronograma de trabalho que tem o JobSchedule17 de ID.
