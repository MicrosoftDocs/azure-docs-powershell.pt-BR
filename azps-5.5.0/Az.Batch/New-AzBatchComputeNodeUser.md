...
## Descrição
O cmdlet **New-AzBatchComputeNodeUser** cria uma conta de usuário em um nó de computação em lote do Azure.

## Exemplos

### Exemplo 1: Criar uma conta de usuário com credenciais administrativas
```
PS C:\>New-AzBatchComputeNodeUser -PoolId "MyPool01" -ComputeNodeId "ComputeNode01" -Name "TestUser" -Password "Password" -ExpiryTime ([DateTime]::Now.AddDays(7)) -IsAdmin -BatchContext $Context
```

Esse comando cria uma conta de usuário no nó de computação que tem o ID ComputeNode01.
O nó está no pool que tem o ID MyPool01.
O nome de usuário é TestUser, a senha é Senha, a conta expira em sete dias e a conta tem credenciais administrativas.
...
Esse nó está no pool que tem o ID MyPool01.
O comando passa esse nó de computação para o cmdlet atual usando o operador de pipeline.
O comando cria uma conta de usuário com o nome de usuário TestUser e a senha.
...
### -ComputeNode
Especifica o nó de computação, como um **objeto PSComputeNode,** no qual esse cmdlet cria uma conta de usuário.
...
### -ComputeNodeId
Especifica a ID do nó de computação no qual esse cmdlet cria uma conta de usuário.
...
### -IsAdmin
Indica que o cmdlet cria uma conta de usuário com credenciais administrativas.
