...
### -NomedaEm conta
Especifica o nome da conta em lotes que este cmdlet cria.
...
Especifica a ID de recurso da conta de armazenamento a ser usada para o armazenamento automático.
...
### -IdentityType
A identidade associada à ContagemDe Lotes
...
### -KeyVaultId
A ID do recurso do cofre de chave do Azure associado à conta Lote.
...
### -KeyVaultUrl
A URL do cofre de chave do Azure associado à conta Lote.
...
### -Local
Especifica a região onde este cmdlet cria a conta.
...
### -PoolAllocationMode
O modo de alocação para a criação de pools na conta Em lotes.
