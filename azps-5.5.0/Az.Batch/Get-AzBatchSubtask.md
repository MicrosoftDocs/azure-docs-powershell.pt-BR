...
## Descrição
O cmdlet **Get-AzBatchSubtask** recupera as informações de subtarefa sobre a tarefa especificada.
As subtarefas fornecem processamento paralelo para tarefas individuais e permitem um monitoramento preciso da execução e do andamento das tarefas.
...
### -JobId
Especifica a ID do trabalho que contém a tarefa cujas subtarefas este cmdlet obtém.
...
### -MaxCount
Especifica o número máximo de subtarefas a retornar.
...
### -Tarefa
Especifica uma referência de objeto à tarefa que contém as subtarefas que esse cmdlet retorna.
Essa referência de objeto é criada usando o cmdlet Get-AzBatchTask e o armazenamento do objeto retornado em uma variável.
...
### -TaskId
Especifica a ID da tarefa cujos subtarefas este cmdlet retorna.
