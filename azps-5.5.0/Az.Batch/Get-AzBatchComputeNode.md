...
## Descrição
O cmdlet **Get-AzBatchComputeNode** obtém nós de computação em lote do Azure de um pool.
Especifique o *parâmetro PoolID* ou *Pool.*
Especifique *o parâmetro Id* para obter um único nó de computação.
*Especifique o* parâmetro Filtro para obter os nós de computação que corresponderem a um filtro OData (Open Data Protocol).
...
Esse comando obtém o nó de computação que tem o ID tvm-2316545714_1-20150725t21320z do pool que tem o Pool de ID.
...
Esse comando obtém todos os nós de computação ocioso contidos no pool que tem o Pool de ID06.
O comando especifica o estado ocioso usando o *parâmetro* Filtro.
...
Esse comando obtém o pool que tem o Pool de ID07 usando o cmdlet Get-AzBatchPool usuário.
...
Esse cmdlet retorna nós de computação que corresponderem ao filtro especificado por esse parâmetro.
Se você não especificar um filtro, esse cmdlet retornará todos os nós de computação para o pool.
...
### -ID
Especifica a ID do nó de computação que este cmdlet obtém do pool.
...
### -MaxCount
Especifica o número máximo de nós de computação a retornar.
