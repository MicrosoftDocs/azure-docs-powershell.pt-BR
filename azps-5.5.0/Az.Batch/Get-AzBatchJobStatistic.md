...
## Descrição
O cmdlet **Get-AzBatchStatistic** obtém estatísticas resumo de vida útil para todos os trabalhos em uma conta do Azure Batch.
As estatísticas são agregadas em todos os trabalhos que já existiram na conta, desde a criação de contas até o último horário de atualização das estatísticas.
...
O segundo comando obtém as estatísticas de resumo para todos os trabalhos.
O comando usa o $Context valor do primeiro comando.
