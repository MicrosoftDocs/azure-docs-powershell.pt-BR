...
## Descrição
O cmdlet **Update-AzDataLakeGen2AclRecursive** atualiza o ACL recursivamente no caminho especificado. O ACL de entrada mescla a ACL original: se a entrada ACL com o mesmo AccessControlType/EntityId/DefaultScope existir, a permissão de atualização será atualizada; adicione uma nova entrada ACL.

## Exemplos

### Exemplo 1: Atualizar a ACL recursivamente em uma directiry raiz do sistema de arquivos
```
...
Esse comando primeiro cria um objeto ACL com 3 entradas e atualiza o ACL recursivamente em um diretório raiz de um sistema de arquivos.
...
Esse comando primeiro atualiza o ACL recursivamente para um diretório e falha e, em seguida, retoma com ContinuationToken depois que o usuário corrige o arquivo com falha.

### Exemplo 3: Atualizar a ACL recursivamente em bloco por bloco
```
...
Esse script atualizará a ACL rescursivamente em bloco de diretório por bloco, com tamanho de bloco como BatchSize * MaxBatchCount. O tamanho do bloco é 5.000 neste script.

### Exemplo 4: Atualizar a ACL recursivamente em um diretório e ContinuarOnFailure e retomar das falhas um por um
```
...
Este comando primeiro atualiza o ACL recursivamente para um diretório com o ContinueOnFailure e alguns itens falharam e, em seguida, retome os itens com falha um por um.
