...
Esse comando obtém um compartilhamento de arquivos de armazenamento com o nome da conta de armazenamento e o nome do compartilhamento.
...
Esse comando obtém um compartilhamento de arquivos de Armazenamento com o nome da conta de armazenamento e o nome do compartilhamento e inclui o uso do compartilhamento em bytes.

### Exemplo 5: Listar todos os compartilhamentos de arquivos de armazenamento de uma conta de armazenamento, inclua os compartilhamentos excluídos
```
...
Esse comando lista todos os compartilhamentos de arquivos de armazenamento incluindo os compartilhamentos excluídos de uma conta de armazenamento com o nome da conta de armazenamento.
...
### -GetShareUsage
Especifique este parâmetro para obter o Uso do Compartilhamento em Bytes.
