...
## Sinopse
Cria um objeto de regra ManagementPolicy, que pode ser usado no Set-AzStorageAccountManagementPolicy.
...
## Descrição
O cmdlet **New-AzStorageAccountManagementPolicyRule** cria um objeto de regra ManagementPolicy, que pode ser usado no Set-AzStorageAccountManagementPolicy.

## Exemplos

### Exemplo 1: cria um objeto de regra ManagementPolicy e, em seguida, é definido como uma Conta de Armazenamento
```
...
Esse comando cria um objeto de regra ManagementPolicy, com um objeto de grupo de ação ManagementPolicy contém 4 ações, um objeto de filtro de regra ManagementPolicy e, em seguida, desfocar a regra para uma Conta de Armazenamento.
...
### -Desabilitado
A regra será desabilitada se ela for definida.
...
### -Nome
Um nome de regra pode conter qualquer combinação de caracteres alfanuméricos.
O nome da regra é sensível a minúsculas.
Ela deve ser exclusiva dentro de uma política.
