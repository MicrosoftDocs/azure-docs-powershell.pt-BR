...
## Descrição
O cmdlet **Remove-AzStorageB ltd remove** o blob especificado de uma conta de armazenamento no Azure.
...
Esse comando remove um blob identificado por seu nome.
...
Esse comando usa o caractere curinga asterisco (*) e o pipeline para recuperar o blob ou blobs e depois removê-los.
...
Esse comando remove um único verão de blobs com VersionId.
...
Esse comando remove um único instantâneo de blobs com InstantâneoTime.
...
Você pode usar o cmdlet Get-AzStorageContainer-lo.
...
Você pode usar o cmdlet New-AzStorageContext para criar.
...
Especifica o perfil do Azure para que o cmdlet seja lido.
Se não especificado, o cmdlet será lido do perfil padrão.
