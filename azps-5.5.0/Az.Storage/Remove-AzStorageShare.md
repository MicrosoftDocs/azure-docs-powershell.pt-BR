...
## Sinopse
Exclui um compartilhamento de arquivo.
...
## Descrição
O **cmdlet Remove-AzStorageShare** exclui um compartilhamento de arquivo.

## Exemplos

### Exemplo 1: Remover um compartilhamento de arquivo
```
...
### -Forçar
Forçar a remoção do compartilhamento com todos os seus instantâneos e todo o conteúdo.
...
Esse cmdlet exclui o compartilhamento de arquivo especificado por este parâmetro.
