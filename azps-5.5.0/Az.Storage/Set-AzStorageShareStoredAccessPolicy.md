...
### Exemplo 1: Atualizar uma política de acesso armazenada no compartilhamento de armazenamento
```
...
### -Permissão
Especifica permissões na política de acesso armazenada para acessar o compartilhamento ou arquivos abaixo dela.
