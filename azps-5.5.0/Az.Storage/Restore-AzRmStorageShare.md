...
## Descrição
O cmdlet **Restore-AzRmStorageShare** restaura um compartilhamento de arquivo excluído dentro de um dia de retenção válido se a exclusão suave do compartilhamento estiver habilitada.
...
Primeiro, esse comando exclui um compartilhamento de arquivos e, em seguida, lista compartilhamentos e vê a versão de compartilhamento excluída, finalmente restaure-a novamente para um compartilhamento normal. Precisa habilitar o compartilhamento de exclusão suave com o Update-AzStorageFileServiceProperty, antes de excluir o compartilhamento.
...
### -DeletedShareVersion
Versão de compartilhamento excluída, que será restaurada a partir de.
