...
## Sinopse
Definir ACL recursivamente no caminho especificado. 
...
## Descrição
O cmdlet **Set-AzDataLakeGen2AclRecursive** define a ACL recursivamente no caminho especificado. O ACL de entrada substituirá completamente o ACL original.

## Exemplos

### Exemplo 1: Definir ACL recursivamente em um diretório
```
...
Esse comando primeiro cria um objeto ACL com 3 entradas de acl e, em seguida, define a ACL recursivamente em um diretório.

### Exemplo 2: Definir ACL recursivamente em um diretório raiz de sistema de arquivos
```
...
Esse comando primeiro define a ACL recursivamente como um diretório raiz e falha e, em seguida, retoma com ContinuationToken depois que o usuário corrige o arquivo com falha.

### Exemplo 3: Definir ACL de forma recursiva de forma recursiva por bloco
```
$token = $null
...
Esse script define a ACL rescursivamente em bloco de diretório por bloco, com tamanho de bloco como BatchSize * MaxBatchCount. O tamanho do bloco é 200 neste script.

### Exemplo 4: Definir a ACL recursivamente em um diretório e ContinuarOnFailure e retomar das falhas um por um
```
...
Esse comando primeiro define a ACL recursivamente para um diretório com o ContinueOnFailure e alguns itens falharam e, em seguida, retome os itens com falha um por um.
