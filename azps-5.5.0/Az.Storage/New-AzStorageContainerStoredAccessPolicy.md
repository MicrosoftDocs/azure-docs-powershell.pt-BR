...
## Sinopse
Cria uma política de acesso armazenada para um contêiner de armazenamento do Azure.
...
## Descrição
O cmdlet **New-AzStorageContainerStoredAccessPolicy** cria uma política de acesso armazenada para um contêiner de armazenamento do Azure.

## Exemplos

### Exemplo 1: Criar uma política de acesso armazenada em um contêiner de armazenamento
```
PS C:\>New-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy01"
```

Esse comando cria uma política de acesso chamada Política01 no contêiner de armazenamento chamado MyContainer.
...
### -Permissão
Especifica permissões na política de acesso armazenada para acessar o contêiner.
...
### -Política
Especifica uma política de acesso armazenada, que inclui as permissões para este token SAS.
