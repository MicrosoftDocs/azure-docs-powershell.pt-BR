...
### Exemplo 1: Definir uma política de acesso armazenada em um contêiner de armazenamento com permissão total
```
PS C:\>Set-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy06" -Permission rwdl
```

Esse comando define uma política de acesso chamada Policy06 para contêiner de armazenamento chamado MyContainer.
...
### -NoStartTime
Define a hora de início a ser $Null.
...
### -Permissão
Especifica permissões na política de acesso armazenada para acessar o contêiner de armazenamento.
