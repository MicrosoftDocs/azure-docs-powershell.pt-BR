...
### Exemplo 1: Criar uma política de acesso armazenada em um compartilhamento
```
...
### -Permissão
Especifica permissões na política de acesso armazenada para acessar o compartilhamento de armazenamento ou arquivos sob ela.
