...
### Exemplo 1: Obter o blob de Armazenamento do Azure por nome
```
PS C:\>Get-AzStorageContainer -Name container*
```

Este exemplo usa um caractere curinga para retornar uma lista de todos os contêineres com um nome que começa com contêiner.

### Exemplo 2: Obter contêiner de armazenamento do Azure por prefixo de nome de contêiner
```
PS C:\>Get-AzStorageContainer -Prefix "container"
```

Este exemplo usa o parâmetro *Prefixo* para retornar uma lista de todos os contêineres com um nome que começa com contêiner.
...
As permissões de contêiner não serão recuperadas quando você usar um contexto de armazenamento criado a partir do Token SAS, pois as permissões de contêiner de consulta exigem permissão de chave da conta de armazenamento.
...
Caso contrário, ele lista todos os contêineres que corresponderem ao nome especificado ou ao padrão de nome normal.
...
Você pode usá-lo para encontrar todos os contêineres que começam com a mesma cadeia de caracteres, como "meu" ou "teste".
