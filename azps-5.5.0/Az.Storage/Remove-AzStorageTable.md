...
Este exemplo usa um caractere  curinga com o parâmetro Nome para obter todas as tabelas que corresponderem à tabela padrão e passa o resultado no pipeline para remover as tabelas.
...
### -Nome
Especifica o nome da tabela a ser removido.
