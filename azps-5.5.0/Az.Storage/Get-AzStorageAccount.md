...
Esse comando obtém a conta de Armazenamento especificada.
...
Esse comando obtém todas as contas de Armazenamento em um grupo de recursos.
...
Esse comando obtém todas as contas de Armazenamento na assinatura.
...
Esse comando obtém uma conta de Armazenamento com seu status de restauração de blob e mostra o status de restauração de blob.
...
### -IncludeBstoreStatus
Obter o BlobRestoreStatus da conta de Armazenamento.
...
Obter os GeoReplicationStats da conta de Armazenamento.
...
### -Nome
Especifica o nome da conta de armazenamento a ser obter.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém a conta de armazenamento a ser obter.
