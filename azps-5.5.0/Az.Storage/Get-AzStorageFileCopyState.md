...
### Exemplo 1: Obter o estado da cópia por nome de arquivo
```
PS C:\>Get-AzStorageFileCopyState -ShareName "ContosoShare" -FilePath "ContosoFile"
```

Esse comando obtém o estado da operação de cópia de um arquivo que tem o nome especificado.
...
O primeiro comando inicia a cópia do arquivo "contosofile" para "contosofile_copy" e saída do objeto de arquivo de desgregação. O segundo comando pipeline o objeto de arquivo de desagregação para Get-AzStorageFileCopyState, para obter o estado de cópia do arquivo.
...
### -WaitForComplete
Indica que esse cmdlet aguarda a cópia ser finalada.
