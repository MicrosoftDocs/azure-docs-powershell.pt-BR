...
## Sinopse
Mover um arquivo ou diretório para outro um arquivo ou diretório na mesma conta de Armazenamento.
...
## Descrição
O cmdlet **Mover-AzDataLakeGen2Item** move um arquivo ou diretório para outro um arquivo ou diretório na mesma conta de Armazenamento.
...
### Exemplo 2: Mover um arquivo por pipeline para outro sistema de arquivos na mesma conta de Armazenamento sem aviso
```
...
Este comando move o arquivo 'dir1/file1' em 'filesystem1' para o arquivo 'dir2/file2' em 'filesystem2' na mesma conta de Armazenamento sem aviso.
...
### -Forçar
Forçar a escrever mais do que o destino.
...
### -InputObject
Objeto de Item do Azure Datalake Gen2 para mover-se.
...
### -Caminho
O caminho no sistema de arquivos especificado que deve ser se mover.
