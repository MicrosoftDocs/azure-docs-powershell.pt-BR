...
## Descrição
O cmdlet **Close-AzStorageFileHandle** fecha as alças de arquivo de um compartilhamento de arquivos, de um diretório de arquivos ou de um arquivo.
...
Esse comando lista todos os compartilhamentos de arquivos da Conta de Armazenamento atual e fecha todas as alças de arquivo do arquivo compartilha recursivamente..

### Exemplo 2: Fechar todas as alças de arquivo em um diretório de arquivos recursivamente e mostrar a contagem de alças de arquivo fechada
```
PS C:\>Close-AzStorageFileHandle -ShareName "mysharename" -Path 'dir1/dir2' -Recursive -CloseAll -PassThru
10
```

Esse comando fecha todas as alças de arquivo em um diretório de arquivos e mostra a contagem de alças de arquivo fechada.

### Exemplo 3: Fechar todas as alças de arquivo que foi aberta há um dia em um diretório de arquivos
```
...
Esse comando lista todas as alças de arquivo em um diretório de arquivos recursivamente, filtra as alças que foram abertas há um dia e, em seguida, feche-as.
...
Esse comando fecha todas as alças de arquivo em um arquivo.
...
### -CloseAll
Forçar o fechamento de todas as alças de arquivo.
...
### -Directory
O objeto CloudFileDirectory indicou a pasta base onde os arquivos/diretórios seriam listados.
...
### -Arquivo
O objeto CloudFile indicou a alça de fechamento do arquivo.
...
### -FileHandle
A Alça de Arquivo a ser fechado.
...
### -PassThru
Retorna a contagem de alças de arquivo fechadas.
...
### -Recursivo
A lista lida com recursivamente.
Funciona apenas no Diretório de Arquivos.
...
### -Compartilhar
O objeto CloudFileShare indicou o compartilhamento onde os arquivos/diretórios seriam listados.
