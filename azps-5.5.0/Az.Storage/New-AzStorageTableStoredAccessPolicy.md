...
Esse comando cria uma política de acesso chamada Política02 na tabela de armazenamento chamada MyTable.
...
É importante observar que esta é uma cadeia de caracteres, como `raud` (para Ler, Adicionar, Atualizar e Excluir).
