...
Esse comando obtém propriedades de métricas para armazenamento de blob para o tipo de métricas hora.
...
Este cmdlet obtém as propriedades das métricas do tipo especificado por esse parâmetro.
