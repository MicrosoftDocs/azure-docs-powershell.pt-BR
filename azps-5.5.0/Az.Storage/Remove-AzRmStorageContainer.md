...
## Sinopse
Remove um contêiner de blob armazenamento
...
## Descrição
O cmdlet **Remove-AzRmStorageContainer** remove um contêiner de blob armazenamento

## Exemplos

### Exemplo 1: Remover um contêiner de blob armazenamento com o nome da conta de armazenamento e o nome do contêiner
```
PS C:\>Remove-AzRmStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" -ContainerName "myContainer"
```

Esse comando remove um contêiner de blob armazenamento com o nome da conta de armazenamento e o nome do contêiner.

### Exemplo 2: Remover um contêiner de blob armazenamento com o objeto de conta de armazenamento e o nome do contêiner
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageContainer -StorageAccount $accountObject -ContainerName "myContainer"
```

Esse comando remove um contêiner de blob armazenamento com o objeto de conta de armazenamento e o nome do contêiner.

### Exemplo 3: Remover todos os contêineres de blob armazenamento em uma conta de armazenamento com pipeline
```
PS C:\>Get-AzStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" | Remove-AzRmStorageContainer -Force
```

Esse comando remove todos os contêineres de blob armazenamento em uma conta de armazenamento com pipeline.
...
### -Forçar
Forçar a remoção do contêiner e todo o conteúdo nele
