...
## Sinopse
Aplica uma instrução SQL (Structured Query Language) simples ao conteúdo de um blob e salva apenas o subconjunto consultado dos dados em um arquivo local.
...
## Descrição
O cmdlet **Get-AzStorageBiedQueryResult** aplica uma instrução SQL (Linguagem de Consulta Estruturada) simples no conteúdo de um blob e salva o subconjunto consultado dos dados em um arquivo local.
...
Esse comando consulta um blob de forma supositiva com a configuração de entrada como csv e a configuração de saída como json, e salva a saída no arquivo local "c:\resultfile.js".
...
Esse comando obtém primeiro um objeto de blob para instantâneo de blob, depois consulta o instantâneo de blob e mostra o resultado incluindo o erro de consulta.
...
### -Forçar
Forçar a substituir o arquivo existente.
...
A configuração usada para lidar com o texto de entrada da consulta. Crie o objeto de configuração com o Novo-AzStorageB diamondQueryConfig.
...
A configuração usada para lidar com o texto de saída da consulta. Crie o objeto de configuração com o Novo-AzStorageB diamondQueryConfig.
...
### -PassThru
Retorne se a blob especificada foi consultada com êxito.
...
### -QueryString
Cadeia de caracteres de consulta, veja mais detalhes em: https://docs.microsoft.com/en-us/azure/storage/blobs/query-acceleration-sql-reference
...
### -ResultFile
Caminho de arquivo local para salvar o resultado da consulta.
