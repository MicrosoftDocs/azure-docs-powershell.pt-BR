...
## Sinopse
Lista as alças de arquivo de um compartilhamento de arquivos, um diretório de arquivos ou um arquivo.
...
## Descrição
O **cmdlet Get-AzStorageFileHandle** lista as alças de arquivo de um compartilhamento de arquivos, um diretório de arquivos ou um arquivo.

## Exemplos

### Exemplo 1: Listar todas as alças de arquivo em um compartilhamento recursivo de arquivo e classificar por ClientIp e OpenTime
```
...
Esse comando lista alças de arquivo em um compartilhamento de arquivo e classificar a saída por ClientIp e, em seguida, por OpenTime.

### Exemplo 2: Listar 2 primeiras alças de arquivo em um diretório de arquivos recursivamente
```
...
Esse comando lista as duas primeiras alças de arquivo em um diretório de arquivos recursivamente.
...
Esse comando lista as alças do 3º ao 6º arquivo em um arquivo.
...
### -Arquivo
O objeto CloudFile indicou o arquivo para listar Alças de Arquivo.
...
### -IncludeTotalCount
Relata o número de objetos no conjunto de dados (um inteiro) seguido dos objetos. Se o cmdlet não puder determinar a contagem total, retornará "Contagem total desconhecida".
