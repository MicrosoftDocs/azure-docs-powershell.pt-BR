...
## Descrição
O cmdlet **Remove-AzStorageCORSRule** remove o Compartilhamento de Recursos de Origem Cruzada (CORS) para um serviço de Armazenamento do Azure.
...
### Exemplo 1: Remover regras do CORS para o serviço de blob
```
PS C:\>Remove-AzStorageCORSRule -ServiceType Blob
```

Esse comando remove as regras do CORS para o tipo de serviço Blob.
...
### -ServiceType
Especifica o tipo de serviço armazenamento do Azure para o qual este cmdlet remove regras.
