...
Primeiro, este comando cria 2 objetos de regra ManagementPolicy e, em seguida, cria ou atualiza a política de gerenciamento de uma conta de Armazenamento com os 2 objetos de regra ManagementPolicy.
...
### Exemplo 3: Obter a política de gerenciamento de uma conta de Armazenamento e defini-la para outra conta de Armazenamento.
```
...
Esse comando obtém primeiro a política de gerenciamento de uma conta de Armazenamento e, em seguida, a configura para outra conta de Armazenamento.
...
### -Política
Objeto de Política de Gerenciamento para Definir
