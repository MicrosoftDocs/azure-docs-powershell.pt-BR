...
Esse comando usa o cmdlet **Get-AzStorageShare** para obter o compartilhamento de arquivos chamado ContosoShare06 e passa-o para o cmdlet atual usando o operador de pipeline.
...
Esse cmdlet cria a pasta no local especificado por esse parâmetro.
...
Esse cmdlet cria uma pasta no compartilhamento de arquivos especificado por esse parâmetro.
