...
## Descrição
O cmdlet **Get-AzDataLakeGen2ItemContent** baixou um arquivo em um sistema de arquivos em uma conta de armazenamento do Azure.
...
### Exemplo 1: Baixar um arquivo sem aviso
```
...
Esse comando baixa um arquivo para um arquivo local sem aviso.

### Exemplo 2: Obter um arquivo e, em seguida, pipeline para baixar o arquivo para um arquivo local
```
...
Esse comando obtém primeiro um arquivo e, em seguida, o pipeline para baixar o arquivo para um arquivo local.
...
### -Destino
Caminho de arquivo local de destino.
...
### -InputObject
Objeto de item do Azure Datalake Gen2 para download.
