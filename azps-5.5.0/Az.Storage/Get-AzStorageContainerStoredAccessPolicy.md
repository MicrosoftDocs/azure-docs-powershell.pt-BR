...
## Sinopse
Obtém a política de acesso ou políticas armazenadas para um contêiner de armazenamento do Azure.
...
### Exemplo 1: Obter uma política de acesso armazenada em um contêiner de armazenamento
```
PS C:\>Get-AzStorageContainerStoredAccessPolicy -Container "Container07" -Policy "Policy22"
```

Esse comando obtém a política de acesso chamada Política22 no contêiner de armazenamento chamado Contêiner07.
...
Esse comando obtém todas as políticas de acesso no contêiner de armazenamento chamado Contêiner07.
...
### Microsoft.Azure.Storage.Blob.SharedAccessBpolicy
