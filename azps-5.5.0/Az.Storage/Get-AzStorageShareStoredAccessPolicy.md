...
## Descrição
O cmdlet **Get-AzStorageShareStoredAccessPolicy** obtém políticas de acesso armazenadas para um compartilhamento de Armazenamento do Azure.
Para obter uma política específica, especifique-a por nome.

## Exemplos

### Exemplo 1: Obter uma política de acesso armazenada em um compartilhamento
```
PS C:\>Get-AzStorageShareStoredAccessPolicy -ShareName "ContosoShare" -Policy "GeneralPolicy"
```

Esse comando obtém uma política de acesso armazenada chamada GeneralPolicy em ContosoShare.

### Exemplo 2: Obter todas as políticas de acesso armazenadas em compartilhamento
```
PS C:\>Get-AzStorageShareStoredAccessPolicy -ShareName "ContosoShare"
```

Esse comando obtém todas as políticas de acesso armazenadas na ContosoShare.
...
### -Política
Especifica o nome da política de acesso armazenada que este cmdlet obtém.
