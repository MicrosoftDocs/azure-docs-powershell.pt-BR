...
## Sinopse
Obtém as máquinas virtuais por política de laboratório de um laboratório no DevTest Labs.
...
### -LabName
Especifica o nome do laboratório para o qual este cmdlet obtém as máquinas virtuais.
