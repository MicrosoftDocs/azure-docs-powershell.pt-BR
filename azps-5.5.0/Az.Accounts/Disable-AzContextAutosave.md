...
### Exemplo 1: Desabilitar a autossagem do contexto
```powershell
PS C:\> Disable-AzContextAutosave
```

Desabilitar o salvar automaticamente para o usuário atual.

### Exemplo 2

Desativar a gravação automática de credenciais do Azure nesta sessão do PowerShell. (gerado automaticamente)
