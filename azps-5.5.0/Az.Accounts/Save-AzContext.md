...
### -Caminho
Especifica o caminho do arquivo para o qual as informações de autenticação são salvas.
...
### -Perfil
Especifica o contexto do Azure a partir do qual este cmdlet é lido.
Se você não especificar um contexto, esse cmdlet será lido a partir do contexto padrão local.
