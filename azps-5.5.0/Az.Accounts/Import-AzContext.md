...
Os cmdlets executados na sessão atual usam essas informações para autenticar solicitações ao Gerenciador de Recursos do Azure.
...
Este exemplo seleciona um contexto de um arquivo JSON que é passado para o cmdlet. Este arquivo JSON pode ser criado a partir do Save-AzContext.
...
### -Caminho
Especifica o caminho para informações de contexto salvas usando Salvar-AzContext.
