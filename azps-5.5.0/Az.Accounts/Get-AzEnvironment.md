...
### Exemplo 3: Como obter o ambiente do AzureUS Facultment
```
...
Este exemplo mostra como obter os pontos de extremidade e os metadados do ambiente AzureUSTabment.
