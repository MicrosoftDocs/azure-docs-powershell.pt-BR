...
## Descrição
O Set-AzContext cmdlet define informações de autenticação para cmdlets executados na sessão atual.
...
Esse comando define o contexto para usar a assinatura especificada.
...
### -Forçar
Substituir o contexto existente com o mesmo nome, se for o caso.
...
### -Assinatura
O nome ou iD da assinatura para o qual o contexto deve ser definido. Este parâmetro tem aliases para -SubscriptionName e -SubscriptionId, portanto, para maior clareza, qualquer um deles pode ser usado em vez de -Assinatura ao especificar nome e id, respectivamente.
