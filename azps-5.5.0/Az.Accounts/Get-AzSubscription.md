...
## Descrição
O Get-AzSubscription cmdlet obtém a ID da assinatura, o nome da assinatura e o locatário ínteque das assinaturas que a conta atual pode acessar.
...
Liste todas as assinaturas do locatário que estão autorizadas para a conta atual.
...
Esse comando obtém a assinatura especificada e define o contexto atual para usá-lo. Todos os cmdlets subsequentes nesta sessão usam a nova assinatura (Assinatura Contoso 1) por padrão.
