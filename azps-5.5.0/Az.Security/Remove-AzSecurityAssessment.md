...
## Descrição
Exclui um resultado de avaliação de segurança de uma assinatura, geralmente usado quando uma reormissão é excluída ou quando a avaliação não é mais relevante para um recurso específico
