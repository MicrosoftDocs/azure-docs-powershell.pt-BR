...
ms.locfileid: "100116202"
---
# <span data-ttu-id="8a520-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="8a520-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="8a520-102">Sinopse</span><span class="sxs-lookup"><span data-stu-id="8a520-102">SYNOPSIS</span></span>
<span data-ttu-id="8a520-103">Recebe alertas de segurança que foram detectados pela Central de Segurança do Azure</span><span class="sxs-lookup"><span data-stu-id="8a520-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="8a520-104">Sintaxe</span><span class="sxs-lookup"><span data-stu-id="8a520-104">SYNTAX</span></span>

### <span data-ttu-id="8a520-105">SubscriptionScope (Padrão)</span><span class="sxs-lookup"><span data-stu-id="8a520-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="8a520-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="8a520-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="8a520-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="8a520-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="8a520-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="8a520-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="8a520-109">Resourceid</span><span class="sxs-lookup"><span data-stu-id="8a520-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="8a520-110">Descrição</span><span class="sxs-lookup"><span data-stu-id="8a520-110">DESCRIPTION</span></span>
<span data-ttu-id="8a520-111">Recebe alertas de segurança que foram detectados pela Central de Segurança do Azure</span><span class="sxs-lookup"><span data-stu-id="8a520-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="8a520-112">Exemplos</span><span class="sxs-lookup"><span data-stu-id="8a520-112">EXAMPLES</span></span>

### <span data-ttu-id="8a520-113">Exemplo 1</span><span class="sxs-lookup"><span data-stu-id="8a520-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="8a520-114">Recebe todos os alertas de segurança que foram detectados em recursos dentro de uma assinatura</span><span class="sxs-lookup"><span data-stu-id="8a520-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="8a520-115">Exemplo 2</span><span class="sxs-lookup"><span data-stu-id="8a520-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="8a520-116">Recebe todos os alertas de segurança que foram detectados em recursos dentro do grupo de recursos "meuService1"</span><span class="sxs-lookup"><span data-stu-id="8a520-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="8a520-117">Exemplo 3</span><span class="sxs-lookup"><span data-stu-id="8a520-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="8a520-118">Recebe um alerta de segurança específico que foi detectado em recursos dentro do grupo de recursos "meuService1"</span><span class="sxs-lookup"><span data-stu-id="8a520-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="8a520-119">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="8a520-119">PARAMETERS</span></span>

### <span data-ttu-id="8a520-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="8a520-120">-DefaultProfile</span></span>
<span data-ttu-id="8a520-121">As credenciais, a conta, o locatário e a assinatura usadas para comunicação com o Azure.</span><span class="sxs-lookup"><span data-stu-id="8a520-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="8a520-122">-Local</span><span class="sxs-lookup"><span data-stu-id="8a520-122">-Location</span></span>
<span data-ttu-id="8a520-123">Localização.</span><span class="sxs-lookup"><span data-stu-id="8a520-123">Location.</span></span>
...
### <span data-ttu-id="8a520-124">-Nome</span><span class="sxs-lookup"><span data-stu-id="8a520-124">-Name</span></span>
<span data-ttu-id="8a520-125">Nome do recurso.</span><span class="sxs-lookup"><span data-stu-id="8a520-125">Resource name.</span></span>
...
### <span data-ttu-id="8a520-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="8a520-126">-ResourceGroupName</span></span>
<span data-ttu-id="8a520-127">Nome do grupo de recursos.</span><span class="sxs-lookup"><span data-stu-id="8a520-127">Resource group name.</span></span>
...
### <span data-ttu-id="8a520-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="8a520-128">-ResourceId</span></span>
<span data-ttu-id="8a520-129">ID do Recurso.</span><span class="sxs-lookup"><span data-stu-id="8a520-129">Resource ID.</span></span>
...
### <span data-ttu-id="8a520-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="8a520-130">CommonParameters</span></span>
<span data-ttu-id="8a520-131">Este cmdlet dá suporte aos parâmetros comuns: -Depurar, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction e -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="8a520-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="8a520-132">Para obter mais informações, [consulte about_CommonParameters.](http://go.microsoft.com/fwlink/?LinkID=113216)</span><span class="sxs-lookup"><span data-stu-id="8a520-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="8a520-133">Entradas</span><span class="sxs-lookup"><span data-stu-id="8a520-133">INPUTS</span></span>

### <span data-ttu-id="8a520-134">System.String</span><span class="sxs-lookup"><span data-stu-id="8a520-134">System.String</span></span>

## <span data-ttu-id="8a520-135">Saídas</span><span class="sxs-lookup"><span data-stu-id="8a520-135">OUTPUTS</span></span>

### <span data-ttu-id="8a520-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="8a520-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="8a520-137">Notas</span><span class="sxs-lookup"><span data-stu-id="8a520-137">NOTES</span></span>

## <span data-ttu-id="8a520-138">LINKS RELACIONADOS</span><span class="sxs-lookup"><span data-stu-id="8a520-138">RELATED LINKS</span></span>
