...
só podem ser usados para tipos de avaliação "CustomerManaged" e somente depois que os metadados de avaliação corresponderem são criados.
...
Marca o resultado da assinatura como "Não Saudável" para avaliação do tipo "4FB6C0A0-1137-42C7-A1C7-4BD37C91DE8D" – mais detalhes sobre o tipo de avaliação serão encontrados sob o tipo de avaliaçãoMetadata

## Parâmetros

### -Dados Adicionais
Dados anexados ao resultado da avaliação para melhorar as investigações ou a clareza do status.
...
### -StatusCode
Código de progremática para o resultado da avaliação.
pode ser "Saudável", "Não Saudável" ou "Não Aplicação"
...
### -StatusDescription
Descrição acessível da causa do resultado da avaliação.
