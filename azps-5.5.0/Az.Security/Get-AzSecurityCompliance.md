...
## Descrição
Obtém a conformidade de segurança de uma assinatura com base na proporção atual de recursos saudáveis e não protegidos nesta assinatura.
...
Obtém a conformidade de segurança de uma assinatura dos últimos 14 dias
