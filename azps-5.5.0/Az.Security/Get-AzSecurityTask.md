...
## Descrição
A Central de Segurança do Azure verifica seus recursos para detectar possíveis problemas de segurança.
Esse cmdlet permite que você descubra as tarefas de segurança que a Central de Segurança do Azure recomenda que você faça.
...
Obtém todas as tarefas de segurança que foram descobertas em recursos dentro de uma assinatura.
...
Obtém todas as tarefas de segurança que foram descobertas em recursos dentro de um grupo de recursos.
...
Obtém uma tarefa de segurança específica.
