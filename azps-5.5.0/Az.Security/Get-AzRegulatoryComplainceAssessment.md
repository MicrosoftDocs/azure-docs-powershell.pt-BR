...
## Descrição
Obter detalhes de uma avaliação spcifico ou listar todas as avaliações sob controle específico e padrão de conformidade regulamentar.
...
Obter todas as avaliações sob controle específico e padrão.
...
Obter uma avaliação específica sob controle específico e padrão de acordo com a ID da Avaliação.
