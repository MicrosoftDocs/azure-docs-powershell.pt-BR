...
## Sinopse
Obtém controles regulatórios de conformidade
...
## Descrição
Obter detalhes de controle spcifico ou listar todos os controles sob um padrão de conformidade regulamentar específico.
...
Obter todos os controles de acordo com um padrão regulatório específico.
...
Obter detalhes específicos do controle de acordo com a ID do controle.
...
Obter detalhes específicos do controle de acordo com a ID do recurso.
