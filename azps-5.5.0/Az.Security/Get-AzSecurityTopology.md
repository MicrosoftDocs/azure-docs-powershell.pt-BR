...
## Descrição
Topologias de segurança são descobertas automaticamente pela Central de Segurança do Azure, use este cmdlet para exibir topologias de segurança.
...
Obter topologias de segurança específicas
