...
## Descrição
O Get-AzIotSecuritySolution cmdlet retorna uma ou mais soluções de segurança iot. A solução de segurança de IoT coleta dados e eventos de segurança de dispositivos iot e hub iot para ajudar a evitar e detectar ameaças.
...
Obter a solução "MySample" no grupo de recursos "MyResourceGroup"
...
Obter uma lista de todas as soluções de segurança no grupo de recursos "MyResourceGroup"
