...
## Descrição
Atualiza as configurações de espaço de trabalho da assinatura.
O espaço de trabalho configurado conterá os dados de segurança que foram coletados pelo agente do Azure Log Analytics que está instalado em VMs dentro desta assinatura.
...
Define o espaço de trabalho "securityuserws" para manter todos os dados de segurança coletados pelo agente de Análise de Log do Azure.
