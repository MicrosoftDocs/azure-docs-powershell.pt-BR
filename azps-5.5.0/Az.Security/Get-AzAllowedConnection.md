...
## Sinopse
Usado para exibir o tráfego permitido entre os recursos da assinatura
...
## Descrição
Obtém a lista de todo o tráfego possível entre os recursos da assinatura e do local, com base no tipo de conexão.
