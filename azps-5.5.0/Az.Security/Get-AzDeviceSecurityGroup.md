...
## Descrição
O Get-AzDeviceSecurityGroup cmdlet retorna um grupo de segurança de dispositivo definido na solução de segurança iot
...
Get device security group "MySecurityGroup" in IoT Hub with reasource Id "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub"
...
Obter lista do grupo de segurança do dispositivo no Hub IoT com a ID de recursos "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub"
