...
## Descrição
O New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject cmdlet cria uma nova lista de regras de alerta personalizadas negadas para o grupo de segurança do dispositivo na solução de segurança de IoT.
...
Criar nova regra de alerta personalizado da lista de negação com o tipo "SomeRuleType" e status definido como desvível
