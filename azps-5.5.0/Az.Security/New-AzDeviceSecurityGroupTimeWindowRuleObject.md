...
## Descrição
O New-AzDeviceSecurityGroupTimeWindowRuleObject cmdlet cria uma nova lista de regras de alerta de janela de tempo para o grupo de segurança do dispositivo na solução de segurança de IoT.
