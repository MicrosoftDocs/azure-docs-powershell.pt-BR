...
## Descrição
As políticas de acesso à rede Just In Time (JIT) permitem que você defina uma política para permitir que usuários simples criem uma conexão de rede temporária com um VM.
A política define quais portas, protocolo e endereços IP de origem podem solicitar uma conexão com um VM e a duração máxima antes que a conexão seja fechada automaticamente.
...
Obter todas as equipes de acesso à rede JIT em uma assinatura
...
Obter todas as equipes de acesso à rede JIT no grupo de recursos "meuService1"
