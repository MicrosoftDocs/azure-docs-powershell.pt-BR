...
## Descrição
O Set-AzIotSecuritySolution cmdlet cria ou atualiza uma solução de segurança iot específica. A solução de segurança de IoT coleta dados e eventos de segurança de dispositivos iot e hub iot para ajudar a evitar e detectar ameaças.
...
Criar nova solução de segurança iot "MySample" para hub IoT com id de recurso "/subscriptions/XXXXXXXX-XXXX-XXXXXX-XXXXXXXXXXXX/resourceGroups/XxxlResourceGroup/providers/Microsoft.Devices/IotHubs/MySample" (o nome da solução deve ser idêntico ao nome do hub de IoT)
...
Status de registro em log ip não massked.
