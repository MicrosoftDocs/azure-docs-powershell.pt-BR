...
## Descrição
O Update-AzIotSecuritySolution cmdlet de hoje em dia uma ou mais das seguintes propriedades em uma solução de segurança de IoT específica: marcas, configuração de recomendação, recursos definidos pelo usuário.
Somente as propriedades especificadas serão atualizadas dentro da solução de segurança iot.
A solução de segurança de IoT coleta dados e eventos de segurança de dispositivos iot e hub iot para ajudar a evitar e detectar ameaças.
