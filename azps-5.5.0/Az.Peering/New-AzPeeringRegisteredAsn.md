...
## Descrição
Crie ASNs registradas para objetos de peering.

## Exemplos

### Obter o peering e criar uma ASN registrada
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredAsn -Name $asnName -Asn $asn
```

Obter o par que você deseja adicionar uma ASN registrada. Em seguida, passe-o para o commandlet.

### Usar o peering resourceId para criar uma asn registrada
```powershell
