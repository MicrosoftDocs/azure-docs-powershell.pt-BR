...
A chave de autenticação MD5 para sessão.
...
### -PeeringDBFacilityId
A ID da instalação de paração encontrada em https://peeringdb.com
...
O endereço IPv4 da sessão de pares
...
O endereço IPv6 da sessão de pares
