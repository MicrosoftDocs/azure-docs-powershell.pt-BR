...
## Descrição
Cria o prefixo de serviço de paração associado a um objeto de serviço de paração.
...
Cria um prefixo a partir de um objeto de serviço de paração
...
Cria um prefixo a partir de uma ID de recurso de serviço de paração.
...
Cria um prefixo a partir de um nome e nome de grupo de recursos de serviço de paração
...
### -PeeringServiceName
O nome do serviço de paração.
Use New-AzPeeringService cmdlet para um novo serviço de Get-AzPeeringService para uma lista.
...
### -ServiceKey
Este é um GUID exclusivo fornecido por seu provedor de serviços
