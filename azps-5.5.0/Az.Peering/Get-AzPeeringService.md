...
## Descrição
Obtém serviços de peering para uma assinatura
...
Obtém um serviço de paridade para um grupo de recursos
...
Obtém um serviço de paridade para um grupo de recursos e um nome
...
Obtém um serviço de peering por ID de recurso
