...
Cria um objeto de serviço de paração com o provedor e o local de peering. Usar em conjuração com `Get-AzPeeringServiceProvider` e `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
A Localização Física Diferente da Região do Azure. Use Get-AzPeeringServiceLocation [-País] <country>
...
O nome do provedor de serviços de paração.
Usar Get-AzPeeringServiceProvider cmdlet para uma lista
...
### -Tag
As marcas a associar ao Serviço InputObject da Microsoft.
