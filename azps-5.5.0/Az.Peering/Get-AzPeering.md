...
Obtém todos os recursos da assinatura.
...
Nomeia o peering do Exchange `myExchangePeering1`
...
Recebe o peering do Exchange `myExchangePeering1` nomeado com base na ID do recurso.
