...
## Descrição
Remove um prefixo de serviço de paração de um serviço de peering.
...
Remover um prefixo de uma ID de recurso de serviço de paração.
...
### -PassThru
Retorna verdadeiro para sucesso ou falso para falha.
