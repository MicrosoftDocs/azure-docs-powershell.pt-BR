...
## Descrição
Usado em conjunto com o Update-AzPeering, esta é uma operação de memória e persistirá apenas `Update-AzPeering` com. 

## Exemplos

### Largura de banda de atualização
```powershell
...
Atualiza a largura de banda para a primeira conexão no objeto Peering na memória. 

### Atualizar Endereço de Sessão Bgp
```powershell
...
Atualiza o Endereço de Parimento para a primeira conexão no objeto Peering na memória. 

### Atualizar Uso para o serviço de peering
```powershell
...
Atualiza a conexão para uso com o serviço de peering
