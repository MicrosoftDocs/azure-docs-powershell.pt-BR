...
Criar conexão de paridade direta com o uso para o serviço de peering habilitado e endereços IP fornecidos pela Microsoft
...
Criar conexão de peering direto com o uso para endereços IP habilitados para serviço de par e fornecidos por pares
...
Crie uma conexão de paridade direta sem endereços IP de sessão bgp. O ponto terá que definir os endereços IP antes que a sessão bgp possa ser configurada.
...
Habilita o sinalizador que informa à Microsoft para fornecer os endereços de sessão BGP.
...
Habilitar para uso com o Serviço de Peering (MPS) da Microsoft.
