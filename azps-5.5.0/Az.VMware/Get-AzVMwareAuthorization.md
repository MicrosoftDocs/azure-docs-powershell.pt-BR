...
### Exemplo 2: Autorização de lista
```powershell
...
Este cmdlet lista autorização `azps-test-auth` em nuvem privada `azps-test-cloud`
...
### Microsoft.Azure.PowerShell.Cmdlets.V Ltd.Models.Api20200320.IExpressRouteAuthorization
