...
### Exemplo 1: Obter credencial de administrador da nuvem privada
```powershell
...
Obter credencial de administrador da nuvem privada
...
### Microsoft.Azure.PowerShell.Cmdlets.V Ltd.Models.Api20200320.IAdminCredentials
