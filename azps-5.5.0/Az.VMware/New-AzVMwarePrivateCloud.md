...
### -AcceptEULA
Aceitar a EULA do AVS, o termo legal será disponibilizado sem este parâmetro fornecido
...
### -NetworkBlock
O bloco de endereços deve ser exclusivo na VNet em sua assinatura, bem como no local.
Certifique-se de que o formato CIDR está conforme (A.B.C.D/X) em que A,B,C,D está entre 0 e 255 e X está entre 0 e 22
...
### -NsxtPassword
Opcionalmente, de definir a senha do NSX-T Manager quando a nuvem privada for criada
...
### -VcenterPassword
Opcionalmente, de definir a senha de administrador do vCenter quando a nuvem particular for criada
