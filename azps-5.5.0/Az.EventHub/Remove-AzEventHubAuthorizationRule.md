...
## Descrição
O Remove-AzEventHubAuthorizationRule cmdlet remove e exclui a regra de autorização especificada do Hub de Eventos determinado.
...
Remove a regra de \` autorização MyAuthRuleName do Hub de \` Eventos \` MyEventHubName. \`
