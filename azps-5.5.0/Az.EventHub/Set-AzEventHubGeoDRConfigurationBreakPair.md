...
## Descrição
O cmdlet **Set-AzEventHubGeoDRConfigurationBreakPair** desabilita a Recuperação de Desastres e interrompe a replicação de alterações de namespaces primários para secundários
