...
## Descrição
O Set-AzEventHubConsumerGroup cmdlet atualiza o grupo de consumidores de Hubs de Eventos especificado.
...
Define os metadados do usuário do grupo de consumidor \` MyConsumerGroupName \` como "Teste".
