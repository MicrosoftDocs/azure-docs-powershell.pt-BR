...
## Descrição
O New-AzEventHubAuthorizationRule cmdlet cria uma nova regra de autorização do Hub de Eventos.
...
Cria uma regra de autorização MyAuthRuleName concedendo direitos de Ouvir e Enviar para o namespace MyNamespaceName, com o grupo de recursos \` \` \` \` \` MyResourceGroupName. \`
...
Cria uma regra de autorização MyAuthRuleName concedendo direitos de Ouvir e Enviar para o Hub de Eventos \` \` MyEventHubName no namespace MyNamespaceName, com o grupo de recursos \` \` \` \` \` MyResourceGroupName. \`
