...
## Descrição
O New-AzEventHubKey cmdlet regenera a chave SAS primária ou secundária para a regra de autorização de Hubs de Eventos especificada.
...
Regenera a chave primária da regra de autorização \` MyAuthRuleName. \`

### Exemplo 2: EventHub - AuthorizationRule PrimaryKey
```powershell
...
Regenera a chave secundária da regra de autorização \` MyAuthRuleName. \`
