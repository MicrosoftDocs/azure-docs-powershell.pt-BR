...
Atualiza as Marcas do namespace \` MyNamespaceName \` para Criado.
...
Atualiza o estado do namespace \` MyNamespaceName \` com AutoInflate = habilitado e MaximumThroughputUnits = 10
...
### Exemplo 5: Criar e atualizar o Namespace com Gerenciar Identidade em um cluster 
```powershell
...
### -IdentityUserDefined
Identidade definida pelo usuário ou Nenhum
