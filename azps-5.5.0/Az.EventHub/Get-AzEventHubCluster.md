...
## Sinopse
Obtém os detalhes de um único Cluster do Hub de Eventos ou obtém uma lista de Clusters do Hub de Eventos.
...
## Descrição
O Get-AzEventHubCluster cmdlet retorna os detalhes de um Cluster do Hub de Eventos ou uma lista de todos os Clusters do Hub de Eventos em determinado grupo de recursos.
...
Retorna as decivações de cluster 'Eventhub-Cluster-5557' do grupo de recursos 'RSG-Cluster27651'
