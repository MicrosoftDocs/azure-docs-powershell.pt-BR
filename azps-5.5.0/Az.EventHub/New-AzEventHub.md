...
## Descrição
O New-AzEventHub cmdlet cria um novo Hub de Eventos do Azure.
Para criar o Eventhub com propriedades de descrição de captura, siga as etapas abaixo (Exemplos 2). 
...
Cria um Hub de Eventos chamado MyEventHubName com um período de retenção de mensagem de 3 dias e duas partições, no local do WestUS, com o grupo de recursos \` \` \` \` \` MyResourceGroupName. \`
...
Cria um Hub de Eventos chamado MyEventHubName com um período de retenção de mensagem de 3 dias, 2 partições e propriedades CaptureDescription no local do WestUS, com o grupo de recursos \` \` \` \` \` MyResourceGroupName. \`
