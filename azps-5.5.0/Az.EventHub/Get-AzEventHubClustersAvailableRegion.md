...
## Sinopse
Obtém os detalhes de um único cluster eventhub ou a lista de clusters no determinado Grupo de Recursos
...
## Descrição
A Get-AzEventHubClustersAvailableRegion lista de cmdlets de regiões onde dedicados estão disponíveis para criação.
...
A lista de regiões é retornada para onde
