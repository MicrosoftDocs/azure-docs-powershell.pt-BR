...
Remove o namespace myNamespaceName dos Hubs de Evento no grupo de \` \` recursos \` MyResourceGroupName. \`
...
### Exemplo 5: ResourceId - Usando a piping:
```powershell
...
### -ResourceId
ID do Recurso EventHubs Namespace
