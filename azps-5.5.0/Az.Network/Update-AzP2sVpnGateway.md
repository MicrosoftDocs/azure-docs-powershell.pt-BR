...
## Sinopse
Atualize um P2SVpnGateway existente no VirtualHub para apontar para a conectividade do site.
...
## Descrição
O cmdlet **Update-AzP2sVpnGateway** permite que você atualize um P2SVpnGateway existente no VirtualHub com o novo VpnClientAddressPool ou o novo VpnServerConfiguration ou a alteração do VpnGatewayScaleUnit.
...
O cmdlet **Update-AzP2sVpnGateway** permite que você atualize um P2SVpnGateway existente no VirtualHub com o novo VpnClientAddressPool. Quando o cliente Point to site se conecta a este P2SVpnGateway, um dos endereços ip deste VpnClientAddressPool é alocado para esse cliente.

### Exemplo 2

Atualize um P2SVpnGateway existente no VirtualHub para apontar para a conectividade do site. (gerado automaticamente)
...
Habilitar o sinalizador de segurança da Internet para as conexões P2SVpnGateway
...
Desabilitar o sinalizador de segurança da Internet para esta conexão P2SVpnGateway
...
### -VpnGatewayScaleUnit
A unidade de escala deste P2SVpnGateway.
