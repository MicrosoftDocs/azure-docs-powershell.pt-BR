...
## Sinopse
Recupera um recurso de tabela de rotação de hub associado a um VirtualHub.
...
## Descrição
Obtém a tabela de rota do hub especificada associada ao hub virtual especificado.
...
Esse comando lista todas as tabelas de rota do hub no VirtualHub especificado.
...
### -ResourceId
A ID de recurso do recurso que você pode obter.
