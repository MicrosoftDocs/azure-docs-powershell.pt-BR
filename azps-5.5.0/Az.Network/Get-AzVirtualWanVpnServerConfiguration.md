...
## Sinopse
Obtém a lista de todas as VpnServerConfigurações associadas a este VirtualWan.
...
## Descrição
O cmdlet **Get-AzVirtualWanVpnServerConfiguration** retornará a lista de todas as VpnServerConfigurações associadas a esse VirtualWan. ou seja, todas as VpnServerConfigurações que estão anexadas a qualquer P2SVpnGateways sob VirutalHubs desta VirtualWan.
