...
## Sinopse
Adiciona configurações HTTP de back-end a um gateway de aplicativo.
...
## Descrição
O Add-AzApplicationGatewayBackendHttpSetting cmdlet adiciona configurações HTTP de back-end a um gateway de aplicativo.
As configurações http de back-end são aplicadas a todos os servidores back-end no pool.

## Exemplos

### Exemplo 1: Adicionar configurações HTTP de back-end a um gateway de aplicativo
```powershell
...
O primeiro comando obtém o gateway de aplicativo chamado ApplicationGateway01 que pertence ao grupo de recursos chamado ResourceGroup01 e o armazena na variável $AppGw. O segundo comando adiciona configurações HTTP de back-end ao gateway do aplicativo, configurando a porta como 88 e o protocolo para HTTP e nomeia as configurações Configurações02.

### Exemplo 2

Adiciona configurações HTTP de back-end a um gateway de aplicativo. (gerado automaticamente)
...
### -CookieBasedAffinity
Especifica se affinity baseada em cookies deve ser habilitada ou desabilitada para o pool de servidor de back-end.
...
### -Desmão
Especifica um problema para associar a um servidor back-end.
...
### -ElaId
Especifica a ID do teste para associar ao servidor back-end.
...
### -Protocolo
Especifica o protocolo para comunicação entre o gateway de aplicativos e os servidores back-end.
