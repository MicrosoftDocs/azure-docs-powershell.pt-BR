...
## Descrição
O **cmdlet New-AzRouteServer** cria um Azure RouteServer
...
### -HostedSubnet
A sub-rede onde o servidor de rota está hospedado.
...
### -ResourceGroupName
O nome do grupo de recursos do servidor de rotação.
