...
O acima criará um grupo de recursos "testRG" na região "Oeste dos EUA" e uma WAN Virtual do Azure com ramificação para o tráfego de ramificação permitido nesse grupo de recursos no Azure.

## Parâmetros

### -AllowBranchToBranchTraffic
Permitir a ramificação para o tráfego de VirtualWan.
...
Permitir o tráfego vnet para vnet para VirtualWan.
...
### -Local
A localização do recurso VirtualWAN.
