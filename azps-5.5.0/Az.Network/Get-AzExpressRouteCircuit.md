...
## Descrição
O cmdlet **Get-AzExpressRoute Circuit** é usado para recuperar um objeto de circuito do ExpressRoute da sua assinatura. O objeto de circuito retornado pode ser usado como entrada para outros cmdlets que operam em circuitos do ExpressRoute.
...
Obter um circuito específico do ExpressRoute com o nome "testrg" e o ResourceGroupName "test"

### Exemplo 2: Listar os circuitos do ExpressRoute usando filtragem
```
...
Obter todos os circuitos do ExpressRoute cujo nome começa com "teste".
