...
## Descrição
O cmdlet **Remove-AzApplicationGatewayRequestRoutingRule** remove uma regra de roteamento de solicitação de um gateway de aplicativo do Azure.

## Exemplos

### Exemplo 1: Remover uma regra de roteamento de solicitação de um gateway de aplicativo
```
...
O segundo comando remove a regra de roteamento de solicitação chamada Rule02 do gateway de aplicativo armazenado no $AppGw.

## Parâmetros

### -ApplicationGateway
Especifica o gateway de aplicativo do qual remover uma regra de roteamento de solicitação.
...
### -Nome
Especifica o nome da regra de roteamento de solicitação para a qual este cmdlet é removido.
