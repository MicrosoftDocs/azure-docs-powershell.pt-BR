...
## Sinopse
Cria um Gateway escalonável do ExpressRoute.
...
New-AzExpressRouteGateway cria um Gateway escalonável do ExpressRoute. Essa é a conectividade definida pelo software para o Azure local dentro do VirtualHub. 

Esse gateway pode ser dimensionado com base na unidade de escala especificada nesta ou no cmdlet Set-AzExpressRouteGateway dados. 

Uma conexão é configurada de um circuito local do ExpressRoute para o gateway escalável.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual no Oeste dos EUA no grupo de recursos "testRG" no Azure. Um gateway do ExpressRoute será criado posteriormente no Hub Virtual com 2 unidades de escala.
...
### -VirtualHub
O VirtualHub a que este VpnGateway precisa estar associado.
...
### -VirtualHubId
A ID do VirtualHub a que este VpnGateway precisa estar associada.
