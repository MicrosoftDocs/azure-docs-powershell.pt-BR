...
## Sinopse
Cria um grupo de zona DNS particular no ponto de extremidade particular especificado.
...
## Descrição
O cmdlet **New-AzPrivateDnsZoneGroup** permite que você crie um novo grupo de zona DNS particular.
...
Depois que o ponto de extremidade particular é criado, o exemplo acima cria um `test-pr-endpoint` grupo de zona DNS sob esse ponto de extremidade particular.
...
Um conjunto de configurações privadas de zona dns do grupo de zona dns particular.
...
### -PrivateEndpointName
O nome do ponto de extremidade particular.
