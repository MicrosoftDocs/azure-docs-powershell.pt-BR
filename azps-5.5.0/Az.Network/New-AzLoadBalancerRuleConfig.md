...
Os três primeiros comandos configuram um IP público, um front-end e um teste para a configuração da regra no comando forth. O comando forth cria uma nova regra chamada MyLBrule com determinadas especificações.
...
### -BackendPort
Especifica a porta de back-end do tráfego que é corresponder a essa configuração de regra de balanceamento de carga.
...
### -Protocolo
Especifica o protocolo que é correspondente a uma configuração de regra de balanceador de carga.
...
### Microsoft.Azure.Commands.Network.Models.PSLoad RencingRule
