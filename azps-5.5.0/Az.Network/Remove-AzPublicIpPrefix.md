...
## Descrição
O cmdlet **Remove-AzPublicIpPrefix** remove um prefixo IP público do Azure, desde que não haja endereços IP públicos alocados dele.
...
Remove o prefixo IP público com $prefixName nome do grupo de recursos $rgName
...
### -ResourceId
A ID do recurso a ser removido
