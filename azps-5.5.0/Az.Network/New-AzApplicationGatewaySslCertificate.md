...
Obter o segredo e criar um Certificado SSL `New-AzApplicationGatewaySslCertificate` usando.
...
### Exemplo 3: Criar um certificado SSL usando o KeyVault Secret e adicionar a um Gateway de Aplicativo.
```
PS C:\> $secret = Get-AzKeyVaultSecret -VaultName "keyvault01" -Name "sslCert01"
