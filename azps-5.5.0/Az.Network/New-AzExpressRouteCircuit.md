...
## Descrição
O cmdlet **New-AzExpressRoute Circuit** cria um circuito de rota expressa do Azure.
...
### -BandwidthInGbps
A largura de banda do circuito quando o circuito é provisionado em um recurso do ExpressRoutePort.
...
### -BandwidthInMbps
A largura de banda do circuito. Esse deve ser um valor com suporte do provedor de serviços.
...
### -ExpressRoutePort
A referência ao recurso ExpressRoutePort quando o circuito é provisionado em um recurso do ExpressRoutePort.
...
### -Peering
Configurações de ponto de lista.
...
### -PeeringLocation
O nome do local de peering com suporte do provedor de serviços.
...
### -ServiceProviderName
O nome do provedor de serviços de circuito. Isso deve corresponder a um nome listado pelo cmdlet Get-AzExpressRouteServiceProvider dados.
...
### -SkuTier
O nível de serviço do circuito. Os valores possíveis para esse parâmetro são: `Standard` ou `Premium` `Local` .
