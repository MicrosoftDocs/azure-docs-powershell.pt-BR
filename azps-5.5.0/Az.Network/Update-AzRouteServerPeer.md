...
## Sinopse
Atualizar um Ponto em um Servidor de Rota do Azure
...
## Descrição
O cmdlet **Update-AzRouteServerPeer** atualiza um Ponto de RouteServer para um Servidor de Rota do Azure
...
### -InputObject
O objeto de entrada por ponto do servidor de rotação.
...
### -PeerName
O nome do peer do servidor de rotação.
...
### -ResourceId
A ID do recurso de ponto do servidor de rotação.
