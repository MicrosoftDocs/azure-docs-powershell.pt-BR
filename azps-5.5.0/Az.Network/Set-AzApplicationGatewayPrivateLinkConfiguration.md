...
## Sinopse
Modifica uma Configuração do PrivateLink para um gateway de aplicativo.
...
O segundo comando define a configuração privateLink com nome privateLinkConfig01 para usar a configuração de ip armazenada no $privateLinkIpConfiguration 01
