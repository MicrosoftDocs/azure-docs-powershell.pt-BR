...
## Descrição
O cmdlet **Remove-AzNetworkProfile** removerá um perfil de rede se nenhuma interface de rede de contêiner (contrastada com uma configuração de **interface** de rede de contêiner) tiver sido criada.
...
Isso remove o perfil da rede com o nome np1 do grupo de recursos rg1.
...
### -ResourceId
A ID de recurso do gerenciador de recursos do Azure do perfil de rede.
