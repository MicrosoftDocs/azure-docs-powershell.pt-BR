...
## Descrição
O cmdlet **Set-AzExpressRoutePortIdentity** atualiza um objeto local do Azure ExpressRoutePort. Use **Set-AzExpressRoutePort para** atribuí-lo ao ExpressRoutePort.
