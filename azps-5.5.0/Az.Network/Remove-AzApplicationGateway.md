...
Esse comando remove o gateway de aplicativo chamado ApplicationGateway01 no grupo de recursos chamado ResourceGroup01.
...
### -Forçar
Indica que o cmdlet força a exclusão do gateway de aplicativo independentemente de os recursos a ele estar atribuídos.
...
### -Nome
Especifica o nome do gateway de aplicativo a ser removido.
...
### -ResourceGroupName
Especifica o nome do nome do grupo de recursos ao que o gateway de aplicativo pertence.
