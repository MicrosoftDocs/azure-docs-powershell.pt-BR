...
## Descrição
O cmdlet New-AzApplicationGatewayTrustedClientCertificate cria uma cadeia de certificados ca de cliente confiável para um gateway de aplicativo.
...
```
O comando cria um novo objeto de cadeia de certificados da CA de cliente confiável que caminho para o certificado ca do cliente como entrada.
