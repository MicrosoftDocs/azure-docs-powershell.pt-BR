...
## Sinopse
cria uma nova IpconfigurationBgpPeeringAddressObject
...
```
## Descrição
O **Novo-AzIpConfigurationBgpPeeringAddressObject** cria um objeto IpConfigurationBgpPeeringAddressObject que representa a propriedade BgpPeeringAddresses em seu gateway de rede virtual bgpsettings.
...
O acima criará um IpConfigurationBgpPeeringAddressObject.Este novo objeto será para gw1ipconfBgp1.
...
### -CustomAddress
A lista customAddress do gateway de rede virtual para BgpPeeringAddresses.
