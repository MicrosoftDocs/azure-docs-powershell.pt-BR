...
## Descrição
O New-AzIpsecPolicy cmdlet cria uma proposta de política IPSec a ser usada em uma conexão de gateway de rede virtual.
...
Criar uma política IPSec a ser usada para uma nova conexão de gateway de rede virtual.
...
### -IkeEncryption
O algoritmo de criptografia IKE (IKE Phase 1)
...
### -IkeIntegrity
O algoritmo de integridade IKE (IKE Phase 1)
...
### -IpsecEncryption
O algoritmo de criptografia IPSec (IKE Phase 2)
...
### -IpsecIntegrity
O algoritmo de integridade IPSec (IKE Phase 2)
...
### -PfsGroup
Os Grupos de DH usados na Fase 2 do IKE para a sa nova criança
...
### -SADataSizeKidataytes
A Associação de Segurança IPSec (também chamada de Modo Rápido ou Fase 2 SA) tamanho da carga em KB
...
### -SALifeTimeSeconds
A associação de segurança IPSec (também chamada de Modo Rápido ou Fase 2 SA) dura em segundos
