...
## Descrição
O cmdlet New-AzNetworkWatcherConnectionMonitor cria um recurso de monitor de conexão para origem e destino especificados (monitor de conexão SingleSourcedestination) ou conjunto de grupos de teste (MultiEndpointConnectionMonitor).
...
### -ConfigureOnly
Configure o monitor de conexão, mas não inicie-o
...
Intervalo de monitoramento em segundos. O valor padrão é de 60 segundos.
...
### -SourceResourceId
A ID do recurso usado como fonte pelo monitor de conexão.
