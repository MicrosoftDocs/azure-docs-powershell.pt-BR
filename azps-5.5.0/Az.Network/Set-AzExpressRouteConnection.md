...
## Sinopse
Atualiza uma conexão de rota expressa criada entre um gateway de rota expressa e o peering de circuito de rota expressa local.
...
## Descrição
O cmdlet **Set-AzExpressRouteConnection** atualiza uma conexão de rota expressa criada entre um gateway de rota expressa e o peering de circuito de rota expressa local.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual e um ExpressRouteSite no oeste dos EUA no grupo de recursos "testRG" no Azure. Um gateway do ExpressRoute será criado posteriormente no Hub Virtual com 2 unidades de escala.

Depois que o gateway for criado, ele será conectado ao peering de circuito do ExpressRoute local usando o comando New-AzExpressRouteConnection usuário.

Em seguida, a conexão é atualizada para ter um Roteamento diferente usando o comando Set-AzExpressRouteConnection roteamento.
...
### -AuthorizationKey
A chave de autorização a ser usada para criar a conexão de gateway do ExpressRoute.
...
Habilitar a segurança da Internet para esta conexão do Gateway do ExpressRoute
...
### -RoutingWeight
A peso que precisa ser atribuída a essa conexão para o roteamento de pacotes.
