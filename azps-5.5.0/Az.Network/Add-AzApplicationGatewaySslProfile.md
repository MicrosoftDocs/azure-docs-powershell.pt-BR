...
## Sinopse
Adiciona perfil SSL a um gateway de aplicativo.
...
O segundo comando cria uma nova política SSL e a armazena na variável $sslPolicy dados.
O terceiro e quarto comando cria duas novas cadeias de certificados de certificação de cliente confiáveis e as armazena nas variáveis $ClientCert 01 e $ClientCert 02.
O quinto comando adiciona o perfil SSL com a política SSL e as cadeias de certificados de CA de cliente confiáveis ao gateway de aplicativos $AppGw.
