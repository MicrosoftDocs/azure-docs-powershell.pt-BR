...
## Sinopse
Lista os pares BGP de um gateway de rede virtual do Azure
...
## Descrição
Esse comando enumera os pares BGP em que um gateway de rede virtual do Azure está configurado para o ponto. O status de cada ponto também é dado.
...
Recupera pares BGP para o gateway de rede virtual do Azure chamado gatewayName no grupo de recursos ResourceGroup.
Esta saída de exemplo mostra um ponto BGP conectado, com um IP de 10.0.0.254.
...
### -Ponto
IP do ponto para recuperar o status para
