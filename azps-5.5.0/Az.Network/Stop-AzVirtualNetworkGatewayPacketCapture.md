...
## Descrição
Interrompe a Operação de Captura de Pacotes em um Gateway de Rede Virtual e carregará o resultado em determinado SasUrl de contêiner de armazenamento.
...
### -InputObject
O objeto virtual de gateway de rede onde a captura de pacote deve ser iniciada.
...
### -Nome
O nome do gateway de rede virtual onde a captura de pacote deve ser iniciada.
