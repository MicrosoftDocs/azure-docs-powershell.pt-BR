...
O comando cria uma nova regra personalizada com o nome da regra de exemplo, prioridade 1 e o tipo de regra será MatchRule com condição definida na variável de condição, a ação permitirá. A nova regra personalizada de combinação é salva $customRule.
