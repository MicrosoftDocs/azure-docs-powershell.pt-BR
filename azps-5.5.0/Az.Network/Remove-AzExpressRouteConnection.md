...
## Sinopse
Remove uma Conexão Do ExpressRoute.
...
Depois que o gateway for criado, ele será conectado ao ExpressRouteSite usando o comando New-AzExpressRouteConnection usuário.

Em seguida, ela remove a conexão usando o nome da conexão.
...
O mesmo que o exemplo 1, mas agora remove a conexão usando o objeto encadeado do Get-AzExpressRouteConnection.
