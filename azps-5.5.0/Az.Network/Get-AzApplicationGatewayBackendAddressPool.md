...
### Exemplo 1: Obter um pool de servidor back-end especificado
```
...
O segundo comando obtém o pool de endereços back-end associado $AppGw pool01 e o armazena na variável $BackendPool back-end.

### Exemplo 2: Obter uma lista de pool de servidor back-end
```
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
