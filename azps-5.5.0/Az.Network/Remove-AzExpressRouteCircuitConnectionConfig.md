...
### Exemplo 2: remover uma configuração de conexão de circuito usando a piping de um circuito do ExpressRoute
```
...
[New-AzExpressRoute CircuitConnectionConfig](New-AzExpressRouteCircuitConnectionConfig.md)
