...
## Sinopse
Adiciona um erro personalizado a um gateway de aplicativo.
...
## Descrição
O cmdlet **Add-AzApplicationGatewayCustomError** adiciona um erro personalizado a um gateway de aplicativo.

## Exemplos

### Exemplo 1: adiciona um erro personalizado ao nível do gateway de aplicativo
```powershell
...
Esse comando adiciona um erro personalizado do código de status http 502 ao gateway de aplicativo $appgw e retorna o gateway atualizado.

### Exemplo 2: adiciona um erro personalizado ao nível de ouvinte do gateway de aplicativo
```powershell
...
Esse comando adiciona um erro personalizado do código de status http 502 ao gateway do aplicativo $appgw no nível do ouvinte e retorna o gateway atualizado.
