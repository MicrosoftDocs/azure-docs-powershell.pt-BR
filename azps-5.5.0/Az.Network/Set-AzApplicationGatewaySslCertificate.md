...
### Exemplo 1: Atualizar um certificado SSL existente no Gateway de Aplicativos
```
...
### Exemplo 2: Atualizar um certificado SSL existente usando KeyVault Secret (version-less secretId) no Gateway de Aplicativos
```
...
Obter o segredo e atualizar um Certificado SSL existente `Set-AzApplicationGatewaySslCertificate` usando.

### Exemplo 3: Atualizar um certificado SSL existente usando KeyVault Secret no Gateway de Aplicativos
```
PS C:\> $secret = Get-AzKeyVaultSecret -VaultName "keyvault01" -Name "sslCert01"
