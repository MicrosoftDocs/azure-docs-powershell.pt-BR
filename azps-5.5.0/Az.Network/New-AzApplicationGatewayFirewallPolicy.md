...
## Sinopse
Cria uma política de firewall do gateway de aplicativo.
...
## Descrição
O **cmdlet New-AzApplicationGatewayFirewallPolicy** cria uma política de firewall do gateway de aplicativo.
...
Este comando cria uma nova política de firewall do gateway de aplicativo do Azure chamada "wafResource1" no grupo de recursos "rg1" no local "westus" com regras personalizadas definidas na variável $customRule
...
### -PolicySetting
Configurações de Política para Firewall do Aplicativo Web
