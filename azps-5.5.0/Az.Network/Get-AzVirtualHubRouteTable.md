...
## Sinopse
Obtém uma Tabela de Rota do Hub Virtual em um hub virtual ou lista todas as tabelas de rota em um hub virtual.
...
Esse cmdlet recupera um recurso de tabela de rota usando o nome do grupo de recursos, o nome do hub e o nome da tabela de rota.
