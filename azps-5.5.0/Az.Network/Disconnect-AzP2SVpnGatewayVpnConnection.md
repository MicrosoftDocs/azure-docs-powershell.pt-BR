...
## Sinopse
Desconectar determinadas conexões de cliente vpn conectadas com um determinado gateway vpn p2s
...
## Descrição
O cmdlet **Disconnect-AzP2sVpnGatewayVpnConnection** permite que você desconecte determinado ponto atual para a conexão de site do P2SVpnGateway.
...
### -ResourceId
ID do recurso de gateway de rede virtual P2s
