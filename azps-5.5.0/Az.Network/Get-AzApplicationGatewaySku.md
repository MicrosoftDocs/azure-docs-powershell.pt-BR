...
## Descrição
O cmdlet **Get-AzApplicationGatewaySku** obtém a unidade de manutenção de ações (SKU) de um gateway de aplicativo.

## Exemplos

### Exemplo 1: Obter uma SKU de gateway de aplicativo
```
...
### -ApplicationGateway
Especifica o objeto do gateway de aplicativo.
