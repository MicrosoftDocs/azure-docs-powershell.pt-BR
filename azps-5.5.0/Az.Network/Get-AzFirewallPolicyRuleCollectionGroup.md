...
## Sinopse
Obtém um Grupo de Conjunto de Regras de Política de Firewall do Azure
...
## Descrição
O cmdlet **Get-AzFirewallPolicyRuleCollectionGroup** obtém o RuleCollectionGroup mencionado de uma Política de Firewall
...
Este exemplo obterá o Grupo de conjunto de regras na política de firewall $fp

### Exemplo 2

Obtém um Grupo de Conjunto de Regras de Política de Firewall do Azure. (gerado automaticamente)
