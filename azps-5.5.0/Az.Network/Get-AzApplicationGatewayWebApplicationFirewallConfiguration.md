...
## Descrição
O cmdlet **Get-AzApplicationGatewayWebApplicationFirewallConfiguration** obtém a configuração waf (web application firewall) de um gateway de aplicativo.

## Exemplos

### Exemplo 1: Obter uma configuração de firewall de aplicativo web gateway de aplicativos
```
...
O segundo comando obtém a configuração de firewall do gateway de aplicativo no $AppGW e o armazena em $FirewallConfig.
