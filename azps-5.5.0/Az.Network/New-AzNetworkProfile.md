...
## Descrição
O **cmdlet New-AzNetworkProfile** cria um novo recurso de nível superior de perfil de rede.
...
Isso cria um novo recurso de nível superior de perfil de rede
...
### -ContainerNicConfig
As configurações da interface de rede do contêiner para adicionar a esse perfil de rede.
