...
## Descrição
O cmdlet **Get-AzExpressRouteCrossConnectionRouteTable** recupera uma tabela de rota detalhada de um circuito do ExpressRoute. A tabela de rota mostrará todas as rotas ou poderá ser filtrada para mostrar rotas para um tipo de ponto específico. Você pode usar a tabela de rota para validar a configuração de par e a conectividade.
