...
## Sinopse
Adiciona uma configuração de peering a um circuito do ExpressRoute.
...
## Descrição
O **cmdlet Add-AzExpressRoute CircuitPeeringConfig** adiciona uma configuração de peering a um circuito do ExpressRoute. Os circuitos do ExpressRoute conectam sua rede local à nuvem da Microsoft usando um provedor de conectividade em vez da Internet pública. Observe que, depois de executar **o Add-AzExpressRoute CircuitPeeringConfig,** você deve ligar para o cmdlet Set-AzExpressRouteCircuit para ativar a configuração.

## Exemplos

### Exemplo 1: Adicionar um ponto a um circuito do ExpressRoute existente
```
