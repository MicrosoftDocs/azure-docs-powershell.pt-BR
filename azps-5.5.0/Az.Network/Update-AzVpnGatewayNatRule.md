...
### ByVpnGatewayNatRuleName (Padrão)
```
...
## Descrição
O cmdlet **Update-AzVpnGatewayNatRule** atualiza uma regra NAT associada ao VpnGateway.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual. Em seguida, criaremos o VpnGateway nesse Hub Virtual. Em seguida, crie uma nova regra NAT associada ao VpnGateway criado.
Usando este comando: Update-AzVpnGatewayNatRule, atualize a regra NAT.
...
### -ExternalMapping
A lista de mapeamentos externos da sub-rede de endereço IP particular para NAT
...
### -InternalMapping
A lista de mapeamentos internos da sub-rede de endereços IP particulares para NAT
...
### -IpConfigurationId
A ID de Configuração IP a que esta regra NAT se aplica
...
### -Modo
A direção NAT de origem de uma NAT VPN
