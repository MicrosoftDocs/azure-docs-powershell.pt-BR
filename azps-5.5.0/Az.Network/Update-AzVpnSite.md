...
Depois que o site é criado, ele atualiza o IpAddress do site usando o comando Set-AzVpnSite usuário.

## Parâmetros

### -AddressSpace
Os prefixos de endereço da rede virtual.
Use este ou AddressSpaceObject, mas não ambos.
...
### -ResourceId
A ID de recurso do Azure para o site de vpn.
...
[Novo-AzVpnSite](./New-AzVpnSite.md)
