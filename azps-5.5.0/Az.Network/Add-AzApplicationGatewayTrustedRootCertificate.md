...
## Descrição
O cmdlet **Add-AzApplicationGatewayTrustedRootCertificate** adiciona um certificado raiz confiável a um gateway de aplicativo do Azure.
...
O segundo comando adiciona um novo certificado raiz confiável ao Gateway de Aplicativos, fazendo o caminho do certificado raiz como entrada.
O terceiro comando cria uma nova configuração de back-end http usando um certificado raiz confiável para validar o certificado do servidor back-end.
O quarto comando atualiza o Gateway de Aplicativos.
...
### -CertificateFile
Caminho do arquivo CER de certificado
