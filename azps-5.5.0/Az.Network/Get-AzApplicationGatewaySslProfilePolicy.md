...
## Sinopse
Obtém a política SSL de um perfil SSL de gateway de aplicativo.
...
## Descrição
O cmdlet **Get-AzApplicationGatewaySslProfilePolicy** obtém a política SSL de um perfil SSL de gateway de aplicativo.
