...
## Sinopse
Cria um serviço de vinculação particular
...
## Descrição
O **cmdlet New-AzPrivateLinkService cria** um serviço de link particular

## Exemplos

### Exemplo 1

O exemplo a seguir cria um serviço de vinculação particular.
...
As assinaturas de aprovação automática do serviço de link particular
