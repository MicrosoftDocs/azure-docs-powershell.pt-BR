...
O comando acima criará um objeto VHubRoute com nextHop como o Firewall especificado que pode ser adicionado a um recurso VHubRouteTable.
...
O comando acima criará um objeto VHubRoute com o nextHop como o hubVnetConnection especificado que pode ser adicionado a um recurso VHubRouteTable.
...
```
Os comandos acima obterão a Configuração de Roteamento de um AzVHubRoute já existente e adicionarão uma rota estática na conexão. Como alternativa, se você espera criar uma nova conexão com a rota estática dentro dela, confira o Exemplo 1 [aqui.](New-AzRoutingConfiguration.md)
## Parâmetros
