...
### -Nome
Especifica o nome da configuração da sub-rede que este cmdlet obtém.
...
### -ResourceId
Especifica a ID de recurso da sub-rede que este cmdlet obtém.
...
### -VirtualNetwork
Especifica o **objeto VirtualNetwork** que contém a configuração da sub-rede que este cmdlet obtém.
