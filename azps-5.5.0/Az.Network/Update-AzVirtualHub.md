...
### -AddressPrefix
A cadeia de espaços de endereço para este hub virtual.
...
### -HubVnetConnection
As conexões de rede virtual do hub associadas a este Hub Virtual.
...
### -Tabela de Rota
A tabela de rota associada a este Hub Virtual.
