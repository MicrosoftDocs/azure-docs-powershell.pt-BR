...
### -ConnectionBandwidth
A largura de banda que precisa ser tratada por esta conexão de link em mbps.
...
### -EgressNatRule
A lista de regras NAT de saída associadas a esta Conexão de link.
...
### -EnableBgp
Habilitar BGP para esta conexão de link
...
### -IngressNatRule
A lista de regras NAT de entrada associadas a esta Conexão de link.
...
Use seletores de tráfego baseados em política para esta conexão de link.
...
### -VpnSiteLink
O objeto de link de site vpn para se conectar.
