...
## Sinopse
Obtém um ponto de Rota Virtual em um Azure VirtualRouter
...
## Descrição
O cmdlet **Get-AzVirtualRouterPeer obtém** um Ponto em um Azure VirtualRouter
...
### -PeerName
O nome do ponto de roteador virtual.
