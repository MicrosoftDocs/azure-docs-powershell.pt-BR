...
### -Local
O nome do local do Azure onde reside o circuito do ExpressRoute.
...
### -ResourceGroupName
O nome do grupo de recursos que conterá o circuito do ExpressRoute sendo movido.
