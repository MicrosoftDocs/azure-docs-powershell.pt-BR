...
## Sinopse
Cria uma ação de regra de reescrita definida para um gateway de aplicativo.
...
## Descrição
O cmdlet **New-AzApplicationGatewayRewriteRuleActionSet** cria uma ação de regra de reescrita definida para um gateway de aplicativo do Azure.
...
Esse comando cria um conjunto de ações de regra de reescrita e armazena o resultado na variável chamada $action.
...
Lista de configurações de solicitação de header
