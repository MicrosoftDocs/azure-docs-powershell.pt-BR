...
## Descrição
O cmdlet **New-AzApplicationGatewayRewriteRuleSet** cria uma regra de reescrita definida para um gateway de aplicativo do Azure.
...
Esse comando cria um conjunto de regras de reescrita denominado ruleset1 e armazena o resultado na variável chamada $ruleset.
