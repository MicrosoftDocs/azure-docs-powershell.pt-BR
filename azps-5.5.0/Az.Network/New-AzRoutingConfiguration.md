...
O comando acima criará um objeto RoutingConfiguration que pode ser adicionado a um recurso de conexão. As rotas estáticas só são permitidas com um objeto HubVirtualNetworkConnection. 
...
A tabela de rota do hub associada a essa configuração de roteamento.
...
### -ID
A lista de IDs de recursos de todas as tabelas de rota do hub para anunciar as rotas para a propriedade PropagatedRouteTables.
...
### -Rótulo
A lista de rótulos da propriedade PropagatedRouteTables.
