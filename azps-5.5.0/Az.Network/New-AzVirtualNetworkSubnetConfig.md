...
Este exemplo cria duas novas configurações de sub-rede usando o cmdlet New-AzVirtualSubnetConfig e as usa para criar uma rede virtual. O New-AzVirtualSubnetConfig cria apenas uma representação na memória da sub-rede. Neste exemplo, a frontendSubnet tem CIDR 10.0.1.0/24 e faz referência a um grupo de segurança de rede que permite acesso RDP. A backendSubnet tem CIDR 10.0.2.0/24 e faz referência ao mesmo grupo de segurança de rede.
