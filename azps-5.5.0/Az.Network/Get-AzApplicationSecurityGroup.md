...
## Sinopse
Obtém um grupo de segurança de aplicativos.
...
## Descrição
O **cmdlet Get-AzApplicationSecurityGroup** obtém um grupo de segurança de aplicativos.

## Exemplos

### Exemplo 1: Recuperar todos os grupos de segurança de aplicativos.
```
...
O comando acima retorna todos os grupos de segurança de aplicativos na assinatura.

### Exemplo 2: Recuperar grupos de segurança de aplicativos em um grupo de recursos.
```
...
O comando acima retorna todos os grupos de segurança de aplicativos que pertencem ao grupo de recursos MyResourceGroup.
...
O comando acima retorna o grupo de segurança do aplicativo MyApplicationSecurityGroup no grupo de recursos MyResourceGroup.

### Exemplo 4: Recuperar grupos de segurança de aplicativos usando filtragem.
```
