...
## Sinopse
Modifica uma porta front-end para um gateway de aplicativo.
...
## Descrição
O cmdlet **Set-AzApplicationGatewayFrontendPort** modifica uma porta front-end para um gateway de aplicativo.

## Exemplos

### Exemplo 1: Definir uma porta front-end de gateway de aplicativo para 80
```
...
O segundo comando modifica o gateway no $AppGw para usar a porta 80 para a porta front-end chamada FrontEndPort01.

## Parâmetros

### -ApplicationGateway
Especifica o objeto do gateway de aplicativo com o qual esse cmdlet associa a porta front-end.
...
### -Nome
Especifica o nome da porta front-end a ser modificado.
...
### -Porta
Especifica o número da porta a ser usada para a porta front-end.
