...
## Descrição
Atualiza a tabela de rota especificada associada ao hub virtual especificado com as rotas ou rótulos fornecidos.
...
### -InputObject
O recurso que pode ser atualizado.
...
### -ResourceId
A ID de recurso do recurso que pode ser atualizado.
