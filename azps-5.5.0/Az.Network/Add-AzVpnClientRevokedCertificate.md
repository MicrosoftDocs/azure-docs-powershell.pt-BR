...
Por exemplo: -Thumbprint "E3A38EBA60CAA1C1C162785A2E1C44A15AD450199C3" Você pode obter informações de impressão digital para seus certificados usando um comando do Windows PowerShell semelhante a este: `Get-ChildItem -Path Cert:\LocalMachine\Root` .
...
Especifica o nome do certificado do cliente VPN a ser adicionado.
