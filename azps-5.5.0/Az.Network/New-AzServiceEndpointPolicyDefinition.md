...
## Sinopse
Cria uma definição de política de ponto de extremidade de serviço.
...
## Descrição
O **cmdlet New-AzServiceEndpointPolicyDefinition** cria uma definição de política de ponto de extremidade de serviço.
...
Cria uma definição de política de ponto de extremidade de serviço. (gerado automaticamente)
...
### -Nome
O nome da política de ponto de extremidade de serviço
