...
## Sinopse
Atualizar um Ponto em uma Rota Virtual do Azure
...
## Descrição
O cmdlet **Update-AzVirtualRouterPeer** atualiza um Ponto de Rota Virtual para um Azure VirtualRouter
...
### -ResourceGroupName
O nome do grupo de recursos do roteador/ponto virtual.
...
### -ResourceId
A ID de recurso de ponto do roteador virtual.
...
### -VirtualRouterName
O roteador virtual onde o ponto existe.
