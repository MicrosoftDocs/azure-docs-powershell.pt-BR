...
### Exemplo 1: Atualizar a SKU do gateway de aplicativos
```
...
### -ApplicationGateway
Especifica o objeto do gateway de aplicativo com o qual este cmdlet associa a SKU.
...
### -Tier
Especifica o nível do gateway do aplicativo.
Os valores aceitáveis para este parâmetro são:
- Padrão
- Waf
