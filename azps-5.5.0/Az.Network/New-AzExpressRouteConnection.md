...
## Sinopse
Cria uma conexão do ExpressRoute que conecta um gateway do ExpressRoute a um circuito local do ExpressRoute
...
## Descrição
Cria uma conexão do ExpressRoute entre um circuito BGP do circuito do ExpressRoute local para o gateway do ExpressRoute dentro de um hub Virtual.
...
O exemplo acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual, Gateway de Rota Expressa e um circuito do ExpressRoute com o peering particular no grupo de recursos "testRG" do Azure. Depois que o gateway for criado, ele será conectado ao Peering de Circuito do ExpressRoute usando o comando New-AzExpressRouteConnection.
...
### -ExpressRoute CircuitPeeringId
A ID do recurso do Peering do Circuito de Rota Expressa para o qual esta conexão de gateway de Rota Expressa deve ser criada.
...
O ExpressRouteGateway pai para esta conexão.
...
### -ParentResourceId
A ID do recurso do ExpressRouteGateway pai para esta conexão.
...
### -RoutingWeight
A peso do roteamento de pacotes que precisa ser atribuído a essa conexão.
