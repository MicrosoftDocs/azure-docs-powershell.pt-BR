...
### -BackendAddressPool
Especifica o pool de endereços back-end para associar a uma configuração de regra de balanceador de carga.
...
### -BackendPort
Especifica a porta de back-end do tráfego que é corresponder a uma configuração de regra de balanceamento de carga.
...
Especifica o tempo, em minutos, de que o estado das conversas é mantido no balanceador de carga.
...
### -Nome
Especifica o nome da configuração da regra de balanceador de carga.
