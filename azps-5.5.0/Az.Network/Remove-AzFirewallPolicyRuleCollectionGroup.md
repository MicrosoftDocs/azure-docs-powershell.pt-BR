...
Este exemplo remove o grupo de coleções de regras de política de firewall chamado "testRcGroup" no firewall chamado "fpName" frpm os nomes de grupo de recursos "testRg"
...
### -InputObject
Objeto de grupo Conjunto de Regras de Política de Firewall
