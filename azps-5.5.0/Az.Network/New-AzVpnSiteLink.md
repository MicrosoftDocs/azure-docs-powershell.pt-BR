...
## Sinopse
Cria um objeto Azure VpnSiteLink.
...
O exemplo acima criará um grupo de recursos, Wan Virtual e um Site Vpn com 1 VpnSiteLinks no oeste dos EUA no grupo de recursos "testRG" no Azure.

### Exemplo 2

Cria um objeto Azure VpnSiteLink. (gerado automaticamente)
...
### -BGPAsn
O ASN BGP para este VpnSiteLink.
...
### -BGPPeeringAddress
O endereço de paridade BGP deste VpnSiteLink.
...
### -IPAddress
O Endereço IpAddress do Próximo Salto.
