...
## Sinopse
Crie um novo P2SVpnGateway no VirtualHub para apontar para a conectividade do site.
...
## Descrição
O cmdlet New-AzP2sVpnGateway permite que você crie um novo P2SVpnGateway no VirtualHub para apontar para a conectividade do site de clientes ponto a site para o Azure VirtualWan.
...
O New-AzP2sVpnGateway cmdlet permite que você crie um novo P2SVpnGateway no VirtualHub para conectividade ponto a site.
...
### -VirtualHub
O VirtualHub com o P2SVpnGateway precisa estar associado.
...
### -VirtualHubId
A ID do VirtualHub a que este P2SVpnGateway precisa estar associado.
...
Sinalizar para habilitar a Internet de Preferências de Roteamento neste P2SVpnGateway.
