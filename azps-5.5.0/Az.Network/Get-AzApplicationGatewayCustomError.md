...
### Exemplo 1: recebe um erro personalizado em um gateway de aplicativo
```powershell
PS C:\> $ce = Get-AzApplicationGatewayCustomError -ApplicationGateway $appgw -StatusCode HttpStatus502
```

Esse comando obtém e retorna o erro personalizado do código de status http 502 do gateway de aplicativo $appgw.
...
Esse comando obtém e retorna a lista de todos os erros personalizados do gateway de aplicativos $appgw.
