...
A conexão VPN cria uma conexão IPsec que conecta um gateway VPN a uma ramificação de cliente remota representada no Azure como um site VPN.
...
A conexão é atualizada para ter um novo IpSecPolicy usando o comando Set-AzVpnConnection usuário.
...
A lista de VpnSiteLinkConnections que esta VpnConnection precisa ter.
