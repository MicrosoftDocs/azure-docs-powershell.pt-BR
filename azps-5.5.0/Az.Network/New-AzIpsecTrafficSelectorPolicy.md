...
## Descrição
O New-AzTrafficSelectorPolicy cmdlet cria uma proposta de política de seletor de tráfego a ser usada em uma conexão virtual de gateway de rede.
...
### -LocalAddressRange
Um conjunto de intervalos de endereços CIDR
