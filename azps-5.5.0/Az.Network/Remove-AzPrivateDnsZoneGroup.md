...
## Descrição
O cmdlet **Remove-AzPrivateDnsZoneGroup** remove um grupo de zona DNS. 
...
Exemplo acima remove uma zona DNS chamada dnsgroup1 do ponto de extremidade test-pr-endpoint.
