...
## Sinopse
Obtém uma Conexão de Rede Virtual em um hub virtual ou lista todas as conexões de rede virtuais em um hub virtual.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual na Central dos EUA nesse grupo de recursos no Azure. Uma Conexão de Rede Virtual será criada a partir daí, que irá fazer o mesmo com a Rede Virtual com o Hub Virtual.
...
Este cmdlet lista todas as conexões de rede virtual do hub começando com "teste" usando o nome do grupo de recursos e o nome do hub.
