...
## Sinopse
O Remove-AzVirtualHubVnetConnection cmdlet remove uma Conexão de Rede Virtual do Azure que compara uma VNET remota ao VNET do hub.
...
Depois que a conexão de rede virtual do hub é criada, ela remove a conexão de rede virtual do hub usando a alimentação do PowerShell na saída do Get-AzHubVirtualNetworkConnection.
