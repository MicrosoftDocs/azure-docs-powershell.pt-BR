...
## Descrição
O cmdlet **Remove-AzExpressRoute Circuit** remove um circuito do ExpressRoute.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos ao que este circuito do ExpressRoute pertence.
