...
### Exemplo 2: Configuração de novo endereço do loadbalancer com referência de configuração ip frontend do loadbalancer
```powershell
...
### -IpAddress
O IPAddress para adicionar ao pool de back-end
...
A configuração de ip frontend do balanceador de carga associada à configuração de Endereço Backend
...
### -Nome
O nome da configuração Endereço de Backend
...
### -VirtualNetworkId
A rede virtual associada à configuração endereço backend
