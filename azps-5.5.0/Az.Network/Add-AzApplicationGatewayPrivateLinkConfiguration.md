...
## Descrição
O **cmdlet Add-AzApplicationGatewayPrivateLinkConfiguration** adiciona uma configuração de link particular a um gateway de aplicativo.
...
O primeiro comando cria uma propriedadeLinkIpConfiguration e a armazena na variável $PrivateLinkIpConfiguration privada.
...
O terceiro comando adiciona a configuração de link particular chamada privateLinkConfig01 para o gateway no $AppGw
