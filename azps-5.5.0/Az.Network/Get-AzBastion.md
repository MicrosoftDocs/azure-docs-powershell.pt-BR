...
## Sinopse
Obtém um recurso de Balões ou recursos de Bastião.
...
## Descrição
O **cmdlet Get-Bastion** obtém um ou mais balões em um grupo de recursos ou subscritption.
...
### -ResourceId
A ID de recurso do Azure de balões
