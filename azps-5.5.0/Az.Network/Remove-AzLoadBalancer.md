...
Esse comando exclui um balanceador de carga chamado MyLoadBalancer no grupo de recursos chamado MyResourceGroup.
...
### -Forçar
Indica que esse cmdlet remove o balanceador de carga, independentemente de se os recursos estão atribuídos a ele.
