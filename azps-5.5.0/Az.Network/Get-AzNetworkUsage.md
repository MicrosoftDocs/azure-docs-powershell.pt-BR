...
## Sinopse
Lista os usos de rede para uma assinatura
...
## Descrição
O Get-AzNetworkUsage cmdlet obtém limites e o uso atual dos recursos de rede.
...
Obtém dados de uso de recursos na região oeste
...
### -Local
O local onde o uso do recurso é consultado.
