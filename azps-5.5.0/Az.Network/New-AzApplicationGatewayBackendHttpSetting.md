...
## Sinopse
Cria a configuração HTTP de back-end para um gateway de aplicativo.
...
## Descrição
O New-AzApplicationGatewayBackendHttpSetting cmdlet cria configurações HTTP de back-end para um gateway de aplicativo.
As configurações http de back-end são aplicadas a todos os servidores back-end em um pool.
...
Esse comando cria configurações HTTP de back-end chamadas Configurações01 na porta 80, usando o protocolo HTTP, com affinity baseada em cookies desabilitada.
As configurações são armazenadas na variável $Setting dados.

### Exemplo 2

Cria a configuração HTTP de back-end para um gateway de aplicativo. (gerado automaticamente)
...
### -AffinityCookieName
Nome de cookie a ser usado para o cookie de affinity
...
### -ConnectionDraining
O esgotamento de conexão do recurso de configurações http back-end.
...
### -CookieBasedAffinity
Especifica se affinity baseada em cookies deve ser habilitada ou desabilitada para o pool de servidor back-end.
...
### -Nome
Especifica o nome das configurações HTTP de back-end que este cmdlet cria.
...
### -Porta
Especifica a porta do pool de servidor back-end.
...
### -Desmão
Especifica um problema para associar ao pool de servidor back-end.
...
### -ElaId
Especifica a ID do teste para associar ao pool de servidores back-end.
...
### -Protocolo
Especifica o protocolo a ser usado para comunicação entre o gateway de aplicativo e os servidores back-end.
...
### -RequestTimeout
Especifica um valor de tempo de tempo de solicitação.
...
Certificados Raiz Confiáveis do Gateway de Aplicativos
