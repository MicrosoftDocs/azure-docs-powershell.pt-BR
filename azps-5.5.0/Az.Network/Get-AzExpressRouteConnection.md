...
Depois que o gateway for criado, ele será conectado ao circuito do ExpressRoute local usando o comando New-AzExpressRouteConnection usuário.
...
Esse comando obterá todas as Conexões no ExpressRoute "testExpressRoutegw" que começam com "teste"
