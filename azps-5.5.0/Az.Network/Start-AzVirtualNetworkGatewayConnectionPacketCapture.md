...
## Sinopse
Inicia a Operação de Captura de Pacotes em uma Conexão virtual de Gateway de Rede.
...
### -FilterData
Opções de filtro para iniciar a captura de pacotes na conexão virtual do gateway de rede.
