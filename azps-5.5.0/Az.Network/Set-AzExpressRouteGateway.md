...
## Sinopse
Atualiza um Gateway escalonável do ExpressRoute.
...
O cmdlet **Set-AzExpressRouteGateway** permite que você atualize as unidades de escala de um ExpressRouteGateway existente ou atualize as marcas de recurso.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual no Oeste dos EUA no grupo de recursos "testRG" no Azure. Um gateway do ExpressRoute será criado posteriormente no Hub Virtual com 2 unidades de escala que serão modificadas para 3 unidades de escala
