...
## Sinopse
Obtém um ponto de RouteServer em um Servidor de Rota do Azure
...
## Descrição
O cmdlet **Get-AzRouteServerPeer** obtém um Ponto em um Servidor de Rota do Azure
...
### -ResourceId
ResourceId do ponto de servidor de rota.
