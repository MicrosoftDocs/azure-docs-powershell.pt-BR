...
## Descrição
New-AzVpnGateway cria um Gateway VPN escalável.
Essa é a conectividade definida pelo software para conexões de site com sites dentro do VirtualHub.

Esse gateway resize e dimensiona com base na unidade de escala especificada nesta ou no cmdlet Set-AzVpnGateway dados.

Uma conexão é configurada de uma ramificação/site conhecida como VPNSite para o gateway escalável.
...
Sinalizar para habilitar a Internet de Preferências de Roteamento neste VpnGateway.
