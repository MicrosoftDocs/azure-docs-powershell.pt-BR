...
## Sinopse
Crie uma nova VpnServerConfiguration para apontar para a conectividade do site.
...
Crie uma nova VpnServerConfiguration para apontar para a conectividade do site. (gerado automaticamente)
...
### -AadIssuer
Emissor do AAD para autenticação P2S AAD.
...
Uma lista dos caminhos dos arquivos de RadiusClientRootCertificate
...
Uma lista de VpnClientCertificates a serem revogados caminhos de arquivos
...
Uma lista de VpnClientRootCertificates para adicionar os caminhos dos arquivos
