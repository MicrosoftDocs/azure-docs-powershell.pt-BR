...
## Sinopse
Remove uma porta front-end de um gateway de aplicativo.
...
## Descrição
O cmdlet **Remove-AzApplicationGatewayFrontendPort** remove uma porta front-end de um gateway de aplicativo do Azure.

## Exemplos

### Exemplo: Remover uma porta front-end de um gateway de aplicativo
```
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
PS C:\> Remove-AzApplicationGatewayFrontendPort -ApplicationGateway $AppGw -Name "FrontEndPort02"
```

O primeiro comando obtém um gateway de aplicativo chamado ApplicationGateway01 que pertence ao grupo de recursos chamado ResourceGroup01 e armazena o gateway na $AppGw variável.
O segundo comando remove a porta chamada FrontEndPort02 do gateway de aplicativo.

## Parâmetros

### -ApplicationGateway
Especifica o gateway de aplicativo do qual remover uma porta front-end.
...
### -Nome
Especifica o nome da porta frontend a ser removido.
