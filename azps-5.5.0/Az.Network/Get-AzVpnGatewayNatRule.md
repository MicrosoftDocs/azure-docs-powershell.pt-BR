...
## Sinopse
Obtém uma regra NAT associada ao VpnGateway.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual e VpnGateway & uma regra NAT associada ao Vpngateway.
Em seguida, ela obtém a regra NAT usando o nome da regra NAT.
...
### -ParentObject
O VpnGateway pai desta VpnGatewayNatRule.
...
### -ParentResourceId
A ID do recurso do VpnGateway pai para esta VpnGatewayNatRule.
