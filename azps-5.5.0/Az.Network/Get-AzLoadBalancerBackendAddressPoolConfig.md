...
## Sinopse
Obtém uma configuração de pool de endereços de back-end para um balanceador de carga.
...
### Exemplo 1: Obter o pool de endereços de back-end
```
...
O segundo comando obtém a configuração de pool de endereços back-end associado chamada BackendAddressPool02 para o balanceador de carga no $loadbalancer.
...
### -LoadBalancer
Especifica o balanceador de carga associado ao pool de endereços back-end para obter.
...
### -Nome
Especifica o nome do balanceador de carga que contém o pool de endereços de back-end para obter.
