...
## Descrição
O cmdlet **Set-AzApplicationGatewayAuthenticationCertificate** atualiza um certificado de autenticação para um gateway de aplicativo do Azure.
...
### -ApplicationGateway
Especifica o nome do gateway de aplicativo para o qual este cmdlet atualiza um certificado de autenticação.
...
### -CertificateFile
Especifica o caminho do arquivo de certificado de autenticação com o qual este cmdlet atualiza o certificado.
