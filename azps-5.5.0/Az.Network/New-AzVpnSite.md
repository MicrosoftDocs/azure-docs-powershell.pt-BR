...
## Sinopse
Cria um novo recurso do Azure VpnSite. Esta é uma representação rm das ramificações do cliente que são carregadas para a conectividade do Azure para S2S com um hub virtual Cortex.
...
O acima criará um grupo de recursos, Wan Virtual no Leste dos EUA, no grupo de recursos "nonlinkSite" no Azure. 

Em seguida, ele cria um VpnSite para representar uma ramificação de cliente e a vincula à WAN Virtual.

Uma conexão IPSec pode ser configurada com essa ramificação e uma VpnGateway usando o comando New-AzVpnConnection usuário.
...
O exemplo acima criará um grupo de recursos, WAN Virtual e um Site Vpn com 1 VpnSiteLinks no Leste dos EUA em um grupo de recursos "multilink" no Azure.
...
### -BgpPeeringAddress
O endereço de paridade BGP deste VpnSite.
...
### -BgpPeeringWeight
A peso do peering BGP para este VpnSite.
...
### -DeviceVendor
O fornecedor de dispositivo do dispositivo vpn remoto.
...
### -VirtualWan
O VirtualWan ao que este VpnSite precisa estar conectado.
...
### -VirtualWanId
O ResourceId VirtualWan a que este VpnSite precisa estar conectado.
...
### -VirtualWanName
O nome do VirtualWan ao que este VpnSite precisa estar conectado.
...
O nome do grupo de recursos do VirtualWan ao que este VpnSite precisa estar conectado.
...
### -VpnSiteLink
A lista de VpnSiteLinks que este Site Vpn tem.
