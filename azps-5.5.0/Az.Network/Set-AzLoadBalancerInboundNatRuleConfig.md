...
O segundo comando usa o operador de pipeline para passar o balanceador de carga no $slb para Add-AzLoadBalancerInboundNatRuleConfig, que adiciona uma configuração de regra NAT de entrada a ele.
...
Especifica o tempo, em minutos, de que o estado das conversas é mantido em um balanceador de carga.
...
### -Protocolo
Especifica o protocolo que é correspondente a uma configuração de regra NAT de entrada.
