...
## Descrição
O cmdlet **Get-AzExpressRoute CircuitStat** recupera estatísticas de tráfego para um circuito do ExpressRoute. As estatísticas incluem o número de bytes enviados e recebidos nas rotas primária e secundária.

## Exemplos

### Exemplo 1: Exibir as estatísticas de tráfego para um ponto do ExpressRoute
```
...
### Microsoft.Azure.Commands.Network.Models.PSExpressRoute CircuitStats
