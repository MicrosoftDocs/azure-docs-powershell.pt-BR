...
## Sinopse
Obtém uma configuração de paridade de circuito do ExpressRoute.
...
## Descrição
O cmdlet **Get-AzExpressRoute CircuitPeeringConfig** recupera a configuração de uma relação de pares para um circuito do ExpressRoute.

## Exemplos

### Exemplo 1: Exibir a configuração de peering de um circuito do ExpressRoute
```
...
O objeto de circuito do ExpressRoute que contém a configuração de peering.
