...
### -ApplicationGateway
Especifica um gateway de aplicativo ao qual este cmdlet adiciona uma regra de roteamento de solicitação.
...
### -BackendAddressPool
Especifica um objeto de pool de endereços back-end do gateway de aplicativo.
...
Especifica uma ID do pool de endereços back-end do gateway de aplicativo.
...
### -BackendHttpSettings
Especifica um objeto de configurações HTTP de back-end para um gateway de aplicativo.
...
### -Nome
Especifica o nome da regra de roteamento de solicitação que este cmdlet adiciona.
