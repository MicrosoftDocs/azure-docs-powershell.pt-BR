...
## Sinopse
O **Test-AzPrivateLinkServiceVisibility** verifica se um serviço de link particular está visível para uso atual.
...
## Descrição
Verifique se um serviço de link particular está visível para uso atual.

## Exemplos

### Exemplo 1: verifique se contoso.cloudapp.azure.com está disponível para uso.
```
