...
## Sinopse
Adiciona uma porta front-end a um gateway de aplicativo.
...
## Descrição
O cmdlet **Add-AzApplicationGatewayFrontendPort** adiciona uma porta front-end a um gateway de aplicativo.

## Exemplos

### Exemplo 1: Adicionar uma porta front-end a um gateway de aplicativo
```
...
O segundo comando adiciona a porta 80 como uma porta front-end para o gateway de aplicativo armazenado no $AppGw e nomeia a porta FrontEndPort01.

## Parâmetros

### -ApplicationGateway
Especifica o gateway do aplicativo ao qual este cmdlet adiciona uma porta front-end.
...
### -Nome
Especifica o nome da porta front-end.
