...
## Descrição
O cmdlet **Set-AzApplicationGatewayRequestRoutingRule** modifica uma configuração de redirecionamento.
...
O segundo comando modifica a configuração de redirecionamento do gateway de aplicativo para redirecionar o tipo Permanente e usar uma URL de destino.

### Exemplo 2

Define a configuração de redirecionamento em um Gateway de Aplicativo existente. (gerado automaticamente)
...
### -IncludeQueryString
Incluir cadeia de caracteres de consulta na URL redirecionada.
O padrão é verdadeiro.
...
### -TargetUrl
Redirecionamento da URL de destino
