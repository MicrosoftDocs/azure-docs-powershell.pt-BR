...
### Exemplo 2: Adicionar/Atualizar marcas a uma VirtualNetworkGatewayConnection existente
```
$conn = Get-AzVirtualNetworkGatewayConnection -Name 1 -ResourceGroupName myRG
...
### -EnableBgp
Se você quer usar uma sessão BGP em um túnel S2S VPN
...
### -DpdTimeoutInSeconds
Tempo de Tempo De detecção de ponto morto da conexão em segundos
...
### -ConnectionMode
Modo de Conexão do Gateway de Rede Virtual
...
Se você quer usar o PrivateIP para uma conexão S2S
...
Se você quer usar seletores de tráfego baseados em política para uma conexão S2S
...
Especifica o objeto PSVirtualNetworkGatewayConnection que esse cmdlet usa para modificar a conexão de gateway de rede virtual.
