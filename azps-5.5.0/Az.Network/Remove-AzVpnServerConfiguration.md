...
## Sinopse
Remove uma configuração VpnServerConfiguration existente.
...
O comando acima removerá uma Configuração VpnServer existente.
...
### -ResourceId
A ID de recurso do Azure para que o vpnServerConfiguration seja excluído.
