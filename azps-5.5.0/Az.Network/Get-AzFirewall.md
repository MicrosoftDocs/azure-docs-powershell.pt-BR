...
Este exemplo recupera um firewall e adiciona uma coleção de regras de aplicativo ao firewall por meio do método de chamada AddApplicationRuleCollection.
...
Este exemplo recupera um firewall e adiciona uma coleção de regras de rede ao firewall por meio do método de chamada AddNetworkRuleCollection.
...
Este exemplo recupera um firewall e obtém uma coleção de regras por nome, método de chamada GetApplicationRuleCollectionByName no objeto de firewall. O nome da coleção de regras para o método GetApplicationRuleCollectionByName não tem maiúsculas de minúsculas.
...
Este exemplo recupera um firewall e obtém uma coleção de regras por nome, método de chamada GetNetworkRuleCollectionByName no objeto de firewall. O nome da coleção de regras para o método GetNetworkRuleCollectionByName não tem maiúsculas de minúsculas.
...
Este exemplo recupera um firewall e remove um conjunto de regras por nome, método de chamada RemoveApplicationRuleCollectionByName no objeto de firewall. O nome da coleção de regras para o método RemoveApplicationRuleCollectionByName não tem maiúsculas de minúsculas.
...
Este exemplo recupera um firewall e remove uma coleção de regras por nome, método de chamada RemoveNetworkRuleCollectionByName no objeto de firewall. O nome da coleção de regras para o método RemoveNetworkRuleCollectionByName não tem maiúsculas de minúsculas.

### 10: Recuperar um firewall e, em seguida, atribuir o firewall
```
...
Este exemplo recupera um firewall e chamadas Alocar no firewall para iniciar o serviço de firewall usando a configuração (coleções de regras de rede e aplicativo) associadas ao firewall.
