...
## Sinopse
Cria um recurso de tabela de rotação de hub associado a um VirtualHub.
...
## Descrição
Cria a tabela de rota especificada associada ao hub virtual especificado com as rotas fornecidas e as etiquetas.
