...
## Sinopse
Remove uma política de firewall do gateway de aplicativo.
...
## Descrição
O cmdlet **Remove-AzApplicationGatewayFirewallPolicy** remove uma política de firewall do gateway de aplicativo.
...
Esse comando remove a política de firewall do gateway de aplicativo chamada ApplicationGatewayFirewallPolicy01 no grupo de recursos chamado ResourceGroup01.
