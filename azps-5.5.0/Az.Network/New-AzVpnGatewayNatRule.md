...
## Sinopse
Cria uma regra NAT em uma VpnGateway que pode ser associada ao VpnSiteLinkConnection.
...
## Descrição
Cria uma regra NAT em uma VpnGateway que pode ser associada ao VpnGateway.
...
O acima criará um grupo de recursos, WAN Virtual, Rede Virtual, Hub Virtual. Em seguida, criaremos o VpnGateway nesse Hub Virtual. Em seguida, usando este comando: New-AzVpnGatewayNatRule, a regra NAT pode ser criada e associada ao VpnGateway criado.
...
### -ParentObject
O VpnGateway pai para esta Regra NAT.
...
### -ParentResourceId
A ID do recurso da VpnGateway pai para esta Regra NAT.
