...
## Descrição
O cmdlet **Remove-AzApplicationGatewayRedirectConfiguration** remove uma configuração de redirecionamento de um Gateway de Aplicativo existente.
...
O segundo comando remove a configuração de redirecionamento chamada Redirecionamento01 do gateway de aplicativo armazenado no $AppGw.
