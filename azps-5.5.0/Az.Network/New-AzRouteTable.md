...
O primeiro comando cria uma rota chamada Roteada07 usando o cmdlet New-AzRouteConfig e, em seguida, o armazena na variável $Route dados. Essa rota encaminha pacotes para a rede virtual local.
O segundo comando cria uma tabela de rota chamada Roteável01 e adiciona a rota armazenada $Route à nova tabela. O comando especifica o grupo de recursos ao qual a tabela pertence e o local da tabela.
...
### -Forçar
Indica que esse cmdlet cria uma tabela de rota mesmo que já exista uma tabela de rota com o mesmo nome.
...
### -Rota
Especifica uma matriz de objetos **de** Rota para associar à tabela de rota.
