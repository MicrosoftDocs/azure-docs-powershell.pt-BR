...
Este exemplo cria uma rede virtual com uma sub-rede. Em seguida, Set-AzVirtualNetworkSubnetConfig para modificar o AddressPrefix da sub-rede. Isso só afeta a representação na memória da rede virtual. Set-AzVirtualNetwork é chamado para modificar a rede virtual no Azure.
...
### -Nome
Especifica o nome de uma configuração de sub-rede que esse cmdlet configura.
...
### -Tabela de Rota
Especifica o objeto da tabela de roteia associado ao grupo de segurança de rede.
