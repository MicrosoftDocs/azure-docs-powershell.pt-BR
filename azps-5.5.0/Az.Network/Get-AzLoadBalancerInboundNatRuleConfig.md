...
## Descrição
O cmdlet **Get-AzLoadBalancerInboundNatRuleConfig** recebe uma ou mais regras de conversão de endereço de rede de entrada (NAT) em um balanceador de carga do Azure.
...
### -LoadBalancer
Especifica o balanceador de carga associado à configuração de regra NAT de entrada para obter.
...
### -Nome
Especifica o nome da configuração da regra NAT de entrada para obter.
