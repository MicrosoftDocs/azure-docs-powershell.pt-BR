...
## Sinopse
Remove a configuração de autenticação do cliente de um objeto de perfil SSL.
...
## Descrição
O cmdlet **Remove-AzApplicationGatewayClientAuthConfiguration** remove a configuração de autenticação do cliente de um objeto de perfil SSL.
