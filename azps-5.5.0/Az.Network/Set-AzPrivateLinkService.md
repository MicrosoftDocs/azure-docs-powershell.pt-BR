...
### 1: Cria um serviço de link particular e atualiza seu
```
...
Este exemplo cria um serviço de link particular chamado mypls. Em seguida, ele substitui suas ipConfigurações do objeto ipConfiguratiuon na memória. O Set-AzPrivateLinkService cmdlet é usado para gravar o estado de serviço de link particular modificado no lado do serviço. 
...
### -PrivateLinkService
Especifica um objeto de serviço de link privado que representa o estado ao qual o serviço de vinculação particular deve ser definido.
