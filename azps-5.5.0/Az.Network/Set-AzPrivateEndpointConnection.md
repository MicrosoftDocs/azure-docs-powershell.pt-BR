...
## Sinopse
Atualiza um estado de conexão de ponto de extremidade particular no serviço de link particular.
...
## Descrição
O cmdlet **Set-AzPrivateEndpointConnection** atualiza um estado de conexão de ponto de extremidade particular em um serviço de link particular
...
Aprovado ou rejeitado o recurso.
