...
O segundo comando usa o operador de pipeline para passar o balanceador de carga no $slb para Add-AzLoadBalancerOutboundRuleConfig, que adiciona uma configuração de regra de saída a ele.
