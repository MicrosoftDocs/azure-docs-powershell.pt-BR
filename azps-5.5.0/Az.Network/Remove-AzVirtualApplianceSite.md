...
## Descrição
O comando Remove-AzVirtualApplianceSite remover um site de Dispositivo Virtual de um recurso de Dispositivo Virtual de Rede.
...
Excluir um recurso de site de Dispositivo Virtual. 
...
A ID de recurso do Dispositivo Virtual de Rede associado a este site.
...
O objeto do site de dispositivo virtual.
