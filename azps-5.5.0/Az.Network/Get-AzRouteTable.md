...
Você pode obter uma única tabela de rota ou obter todas as tabelas de rota em um grupo de recursos ou em sua assinatura.
...
Esse comando obtém a tabela de rota chamada Roteamento01 no grupo de recursos chamado ResourceGroup11.

### Exemplo 2: Listar tabelas de roteamento usando filtragem
```
...
Esse comando obtém todas as tabelas de rota cujo nome começa com "Tabela de Rota"
