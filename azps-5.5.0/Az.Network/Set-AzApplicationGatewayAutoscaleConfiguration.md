...
## Sinopse
Atualiza a Configuração de Escala Automática de um gateway de aplicativo.
...
## Descrição
O cmdlet **Set-AzApplicationGatewayAutoscaleConfiguration** modifica a configuração de escala automática existente de um Gateway de Aplicativo.
...
O segundo comando atualiza a configuração de escala automática do gateway de aplicativo.
...
### -MaxCapacity
Capacidade máxima para gateway de aplicativos.
...
### -MinCapacity
Capacidade mínima para gateway de aplicativos.
