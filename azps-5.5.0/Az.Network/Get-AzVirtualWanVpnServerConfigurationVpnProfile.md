...
## Sinopse
Gera e baixa o perfil vpn no nível VirtualWan-VpnServerConfiguration para a configuração do cliente ponto a site.
...
## Descrição
O cmdlet **Get-AzVirtualWanVpnServerConfigurationVpnProfile** permite que você gere e baixe o perfil vpn no nível VirtualWan-VpnServerConfiguration para a configuração do cliente Ponto para site. Isso é necessário para a conectividade De Ponto para Site, do cliente Ponto ao site para o Azure P2SVpnGateway.
...
O comando acima gerará e retornará a Url do SAS para que o cliente baixe o perfil vpn no nível VirtualWan-VpnServerConfiguration para a configuração do cliente Ponto para site.
...
A VpnServerConfiguration à qual este VirtualWan está associado.
...
A id do objeto de configuração do servidor Vpn com o que essa wan virtual será associada.
