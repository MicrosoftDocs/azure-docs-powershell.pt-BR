...
## Descrição
O cmdlet **Get-AzApplicationGatewayTrustedRootCertificate** obtém um Certificado Raiz Confiável com um nome específico do Gateway de Aplicativo.
...
O primeiro comando obtém o Gateway de Aplicativos e o armazena $gw variável.
