...
## Sinopse
Obter de delegações de serviços disponíveis na região.
...
## Descrição
O cmdlet **Get-AzAvailableServiceDelegation** permite recuperar todas as de delegações de serviço disponíveis para uma sub-rede no local fornecido. Este cmdlet *não descreve* quais delegações podem existir em uma única sub-rede.

## Exemplos

### 1: Como obter todas as de delegações de serviços disponíveis
```powershell
