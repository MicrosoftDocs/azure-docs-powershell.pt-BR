...
## Sinopse
Obtém as informações de saúde das conexões de site atuais do P2SVpnGateway.
...
## Descrição
O cmdlet **Get-AzP2sVpnGatewayConnectionHealth** permite obter a saúde agregada atual das conexões ponto a site do P2SVpnGateway. A saúde agregada mostra o número de pontos para clientes de site conectados ao P2SVpnGateway, a entrada total e os bytes de saída transferidos por meio do P2SVpnGateway e endereços IP alocados para o ponto conectado aos clientes do site.
...
O cmdlet **Get-AzP2sVpnGatewayConnectionHealth** permite obter a saúde agregada atual das conexões ponto a site do P2SVpnGateway. O comando Acima permite que a saúde da saída mostre que o número de pontos para clientes de site conectados ao P2SVpnGateway são 2. Os bytes de entrada e saída totais transferidos por meio do P2SVpnGateway são 100 e 200, respectivamente. Os endereços IP alocados para clientes de sites conectados são "192.168.2.1", "192.168.2.2".
