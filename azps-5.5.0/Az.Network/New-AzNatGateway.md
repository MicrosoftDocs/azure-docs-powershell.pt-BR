...
## Sinopse
Crie um novo recurso Nat Gateway com propriedades Endereço Ip Público/Prefixo Ip Público, IdleTimeoutInMinutes e SKU.
...
O primeiro comando cria o Endereço IP público padrão.
