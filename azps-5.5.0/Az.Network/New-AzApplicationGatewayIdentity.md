...
## Sinopse
Cria um objeto de identidade para um gateway de aplicativo. Isso fará referência à identidade atribuída pelo usuário.
...
## Descrição
**O cmdlet New-AzApplicationGatewayIdentity cria** um objeto de identidade do gateway de aplicativo.
...
Neste exemplo, criamos uma identidade atribuída ao usuário e a referenciamos no objeto de identidade usado com o Gateway de Aplicativo.
