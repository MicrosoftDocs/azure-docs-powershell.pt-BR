...
## Descrição
O Set-AzApplicationGatewayBackendHttpSetting cmdlet atualiza as configurações http de protocolo HTTP de back-end para um gateway de aplicativo do Azure.
...
O segundo comando atualiza as configurações HTTP do gateway de aplicativo na variável $AppGw para usar a porta 88, o protocolo HTTP e habilita affinity baseada em cookies.
...
### -ApplicationGateway
Especifica um objeto de gateway de aplicativo com o qual este cmdlet associa as configurações http de back-end.
...
Os valores aceitáveis para este parâmetro são: Desabilitados ou Habilitados.
...
### -Desmão
Especifica um problema para associar às configurações HTTP de back-end.
...
### -ElaId
Especifica a ID do teste para associar às configurações HTTP de back-end.
...
### -Protocolo
Especifica o protocolo a ser usado para comunicação entre o gateway do aplicativo e os servidores back-end.
Os valores aceitáveis para este parâmetro são: Http e Https.
Este parâmetro é sensível a minúsculas.
