...
Esse comando obtém a tabela de rota chamada Roteável01 usando o cmdlet Get-AzRouteTable rota.
O comando passa essa tabela para o cmdlet atual usando o operador de pipeline.
O cmdlet atual modifica a rota chamada Rota02 e passa o resultado para o cmdlet **Set-AzRouteTable,** que atualiza a tabela para refletir suas alterações.
...
Um gateway de rede virtual privada do Azureserver-to-server. 
- VnetLocal.
