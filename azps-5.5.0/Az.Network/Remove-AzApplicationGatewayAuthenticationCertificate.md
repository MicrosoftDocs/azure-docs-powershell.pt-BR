...
## Descrição
O cmdlet **Remove-AzApplicationGatewayAuthenticationCertificate** remove um certificado de autenticação de um gateway de aplicativo do Azure.

## Exemplos

### Exemplo 1: Remover um certificado de autenticação de um gateway de aplicativo
```
...
### -ApplicationGateway
Especifica o nome do gateway de aplicativo do qual este cmdlet remove um certificado de autenticação.
