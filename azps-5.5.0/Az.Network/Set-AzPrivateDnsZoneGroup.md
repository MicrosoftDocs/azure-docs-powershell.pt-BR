...
## Descrição
O cmdlet **Set-AzPrivateDnsZoneGroup** atualiza o grupo de zona DNS.
...
Acima do exemplo, atualiza o grupo de zona DNS chamado dnsgroup1 com uma nova dnsconfig que vincula a outra zona DNS.
