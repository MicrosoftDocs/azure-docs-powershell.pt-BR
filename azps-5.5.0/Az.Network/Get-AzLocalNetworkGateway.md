...
O cmdlet **Get-AzLocalNetworkGateway** retorna o objeto que representa seu gateway local com base no Nome e Nome do Grupo de Recursos.
...
### Exemplo 2: Obter Gateways de Rede Local usando filtragem
```powershell
...
Retorna o objeto do Gateway de Rede Local com o nome começando com "myLocalGW" no grupo de recursos "myRG"
