...
O primeiro comando obtém o balanceador de carga associado à configuração de regra de saída que você deseja remover e o armazena na variável $slb.
O segundo comando remove a configuração da regra de saída associada do balanceador de carga.
