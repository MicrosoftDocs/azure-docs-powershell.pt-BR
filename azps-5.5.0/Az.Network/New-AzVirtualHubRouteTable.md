...
## Sinopse
Cria um objeto Tabela de Rota do Hub Virtual do Azure.
...
A tabela de rota acima criará uma tabela composta por várias rotas e anexada a um novo hub virtual.

Esse é um objeto na memória que pode ser usado para adicionar uma tabela De roteamento a um Novo ou a um VirtualHub existente.
