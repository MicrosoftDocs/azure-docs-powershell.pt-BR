...
## Sinopse
Obtém um P2SVpnGateway existente no VirtualHub.
...
## Descrição
O cmdlet **Get-AzP2sVpnGateway** permite que você receba um P2SVpnGateway existente no VirtualHub.
...
O cmdlet **Get-AzP2sVpnGateway** permite que você receba um P2SVpnGateway existente no VirtualHub que é usado para a conectividade do ponto para o site.
