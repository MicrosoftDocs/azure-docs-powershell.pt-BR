...
## Sinopse
salva um grupo modificado de conjunto de regras de política de política de firewall do Azure
...
## Descrição
O cmdlet **Set-AzFirewallPolicyRuleCollectionGroup** atualiza um grupo de conjunto de regras em uma Política de Firewall do Azure.
...
Este exemplo atualiza um grupo de conjunto de regras na política de firewall $fp

### Exemplo 2

salva um grupo modificado de conjunto de regras de política de firewall do Azure. (gerado automaticamente)
...
### -ResourceId
A ID do recurso do grupo Conjunto de regras
