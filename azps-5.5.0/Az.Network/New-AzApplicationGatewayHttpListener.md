...
Esse comando cria um ouvinte HTTP chamado Ouvinte01 e armazena o resultado na variável chamada $Listener.
...
Esse comando cria um ouvinte HTTP que usa a recarga SSL e fornece o certificado SSL na variável $SSLCert 01.
O comando armazena o resultado na variável chamada $Listener.

### Exemplo 3: Criar um ouvinte HTTP com política de firewall
```
PS C:\>$Listener = New-AzApplicationGatewayHttpListener -Name "Listener01" -Protocol "Http" -FrontendIpConfiguration $FIp01 -FrontendPort $FP01 -FirewallPolicy $firewallPolicy
```

Esse comando cria um ouvinte HTTP chamado Ouvinte01, FirewallPolicy como $firewallPolicy e armazena o resultado na variável chamada $Listener.
...
Esse comando cria um ouvinte HTTP que usa a recarga SSL e fornece o certificado SSL na variável $SSLCert 01 juntamente com dois Nomes de Host.
O comando armazena o resultado na variável chamada $Listener.
...
Especifica a ID da configuração IP de front-end para o ouvinte HTTP.
