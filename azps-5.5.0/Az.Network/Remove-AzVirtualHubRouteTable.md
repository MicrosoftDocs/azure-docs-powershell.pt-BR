...
## Sinopse
Exclua um recurso de tabela de rotação de hub virtual associado a um hub virtual.
...
## Descrição
Exclui a tabela de rota especificada associada ao hub virtual especificado.
...
Esse comando exclui a RoteadaTable1 do hub virtual westushub.
...
### -InputObject
O recurso virtualhuutetable a ser removido.
...
### -ResourceId
A id de recurso do recurso virtualmenteeável a ser removido.
