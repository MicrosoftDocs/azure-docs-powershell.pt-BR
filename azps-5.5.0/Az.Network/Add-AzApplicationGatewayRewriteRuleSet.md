...
## Sinopse
Adiciona uma regra de reescrita definida a um gateway de aplicativo.
...
## Descrição
O **cmdlet Add-AzApplicationGatewayRewriteRuleSet** adiciona uma regra de reescrita definida a um gateway de aplicativo.
...
O primeiro comando obtém o gateway do aplicativo e o armazena na variável $AppGw aplicativo.
O segundo comando adiciona a regra de reescrita definida ao gateway do aplicativo.
