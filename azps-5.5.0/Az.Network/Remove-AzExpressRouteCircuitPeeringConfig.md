...
## Sinopse
Remove uma configuração de peering de circuito do ExpressRoute.
...
## Descrição
O cmdlet **Remove-AzExpressRoute CircuitPeeringConfig** remove uma configuração de peering de circuito do ExpressRoute.

## Exemplos

### Exemplo 1: Remover uma configuração de peering de um circuito do ExpressRoute
```
