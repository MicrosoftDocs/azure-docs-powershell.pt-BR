...
## Sinopse
Interrompe a Operação de Captura de Pacotes em uma conexão do Gateway de Rede Virtual
...
## Descrição
Interrompe a Operação de Captura de Pacotes em uma conexão do Gateway de Rede Virtual e carregará o resultado em determinado SasUrl do contêiner de armazenamento.
...
### -InputObject
O objeto de conexão do gateway de rede virtual onde a captura de pacote deve ser iniciada.
...
### -Nome
O nome da conexão do gateway de rede virtual onde a captura de pacote deve ser iniciada.
...
### -ResourceId
A ID de recurso do Azure da VirtualNetworkGatewayConnection onde a captura de pacote deve ser iniciada.
