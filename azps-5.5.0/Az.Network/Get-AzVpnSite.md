...
## Sinopse
Obtém um recurso do Azure VpnSite por nome OU lista todos os VpnSites em um ResourceGroup ou SubscriptionId. 

Esta é uma representação rm das ramificações do cliente que são carregadas para a conectividade do Azure para S2S com um hub virtual Cortex.
...
Depois que o site é criado, ele obtém o site usando o comando Get-AzVpnSite usuário.
...
Este cmdlet obtém todos os Sites que começam com "teste".
