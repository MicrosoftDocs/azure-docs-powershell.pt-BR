...
## Descrição
O cmdlet **Remove-AzVirtualNetworkTap** remove um toque de rede virtual do Azure.

## Exemplos

### Exemplo 1: Remover um toque de rede virtual
```
PS C:\>Remove-AzNetworkInterface -Name "VirtualNetworkTap1" -ResourceGroup "ResourceGroup1"
```

Esse comando remove o VirtualNetworkTap1 no grupo de recursos ResourceGroup1.
...
### -InputObject
Referência ao recurso VirtualNetworkTap
