...
## Descrição
O cmdlet remove-AzNetworkWatcherConnectionMonitor remove o monitor de conexão especificado.
...
Neste exemplo, excluímos o monitor de conexão especificado por local e nome.

### Exemplo 2

Remover o monitor de conexão. (gerado automaticamente)
