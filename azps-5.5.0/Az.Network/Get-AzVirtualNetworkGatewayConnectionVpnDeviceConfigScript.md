...
O exemplo acima usa Get-AzVirtualNetworkGatewaySupportedVpnDevice para obter as marcas, modelos e versões de firmware de dispositivo VPN com suporte.
Em seguida, usa uma das informações de modelos retornados para gerar um script de configuração de dispositivo VPN para o virtualNetworkGatewayConnection "TestConnection". O dispositivo usado neste exemplo tem DeviceFamily "Teste IOS", DeviceVendor "Cisco-Test" e FirmwareVersion 20.
