...
## Sinopse
Criar uma nova Coleção de Regras nat da Política de Firewall do Azure
...
## Descrição
O cmdlet **New-AzFirewallPolicyNatRuleCollection** cria um conjunto de regras Nat para uma Política de Firewall do Azure.
