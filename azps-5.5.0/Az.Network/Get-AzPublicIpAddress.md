...
Esse comando obtém um recurso de endereço IP público com o nome meuPublicIp no grupo de recursos myRg.
...
Esse comando obtém todos os recursos de endereço IP públicos cujo nome começa com meuPublicIp.
...
### -IpConfigurationName
Nome de configuração IP da interface de rede.
...
Nome da interface de rede de máquina virtual.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos que contém o endereço IP público que este cmdlet obtém.
...
Nome de conjunto de escala de máquina virtual.
