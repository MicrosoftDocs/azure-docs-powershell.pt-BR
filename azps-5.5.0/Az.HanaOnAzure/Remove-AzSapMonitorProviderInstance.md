...
## Sinopse
Exclui uma instância de provedor para a assinatura especificada, o grupo de recursos, o nome do SapMonitor e o nome do recurso.
...
Esse comando remove a instância do monitor SAP por objeto.
