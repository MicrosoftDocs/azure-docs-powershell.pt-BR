...
## Sinopse
Obtém propriedades de uma instância de provedor para a assinatura especificada, o grupo de recursos, o nome do SapMonitor e o nome do recurso.
...
Esse comando obtém todas as instâncias sob um monitor SAP.

### Exemplo 2: Obter uma instâncias do monitor SAP por nome
```powershell
