...
### Exemplo 2: Criar uma instância do monitor SAP por cofre de chave para HANA
```powershell
...
Esse comando cria uma instância do monitor SAP por cofre de chave para HANA.

### Exemplo 3: Criar uma instância do monitor SAP por dicionário para QueeusHaCluster
```powershell
...
Esse comando cria uma instância do monitor SAP por dicionário para QuedaseusHaCluster.

### Exemplo 4: Criar uma instância do monitor SAP por dicionário para o MereusOS
```powershell
...
Esse comando cria uma instância do monitor SAP por dicionário para QuedaseusOS.
...
ID do recurso do Cofre de Teclas que contém as credenciais HANA.
...
### -HanaDatabaseSqlPort
A porta SQL do banco de dados da instância SAP HANA.
...
### -HanaHostname
O nome do host da instância SAP HANA.
