...
Cria uma atribuição de registro no escopo padrão usando o identificador de definição de registro.
...
Cria uma atribuição de registro com um objeto de definição de registro como entrada.
...
Atualiza uma atribuição de registro com um nome e um identificador de definição de registro.
...
A ID de recurso totalmente qualificada da definição de registro.
