...
Obtém uma tarefa de registro por nome sem detalhes de definição de registro.
...
Obtém uma tarefa de registro por nome com detalhes de definição de registro.
...
Se você deve incluir detalhes de definição de registro.
