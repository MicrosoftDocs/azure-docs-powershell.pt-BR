...
## Sinopse
Atualiza um serviço de saúdeApis fhir existente.
...
### Exemplo 1: atualiza o serviço de serviços de saúde existente chamado MyService no grupo de recursos MyResourceGroup com odb offerThroughput = 500.
...
### Exemplo 2: atualiza o serviço de serviços de saúde existente chamado MyService no grupo de recursos MyResourceGroup com odb OfferThroughput = 500 e key vault key uri "https:// \<my-keyvault> .vault.azure.net/keys/ \<my-key> "
...
### -InputObject
Serviço HealthcareApis fhir da Get-AzHealthcareApisFhirService.
