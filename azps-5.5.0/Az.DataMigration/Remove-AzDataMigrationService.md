...
## Descrição
O Remove-AzDataMigrationService cmdlet remove uma instância do Serviço de Migração de Banco de Dados do Azure do Azure. O fornecimento do parâmetro DeleteRunningTask remove todas as tarefas do Serviço de Migração de Banco de Dados do Azure associadas ao serviço que está sendo removido. 
...
O exemplo acima remove uma instância do Serviço de Migração de Banco de Dados do Azure chamada TestService que está contida em um Grupo de Recursos do Azure chamado MyResourceGroup.
