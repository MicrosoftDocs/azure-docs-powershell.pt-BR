...
## Descrição
O New-AzDataMigrationSelectedDB cmdlet cria um objeto de informações de banco de dados que contém informações sobre bancos de dados de origem e destino, bem como os mapeamentos de tabela, para migração. Esse cmdlet pode ser usado como um parâmetro com New-AzDataMigrationTask cmdlet.
...
Definir o tipo de migração para o SQL Server como SQL DB Migration.
...
### -MigrateSqlServerSqlDbMi
Definir o tipo de migração para o SQL Server como SQL DB MI Migration.
