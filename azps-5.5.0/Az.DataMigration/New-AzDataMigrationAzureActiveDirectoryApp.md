...
## Sinopse
Crie uma nova instância detalhes do aplicativo DataMigration Azure ActiveDirectory.
...
```
ApplicationId : "Sua ID do AppId/Service Principal aqui" AppKey: System.Security.SecureString TenantId: "ID do locatário"
