...
## Descrição
O Start-AzDataMigrationService cmdlet inicia uma instância do Serviço de Migração de Banco de Dados do Azure em um estado interrompido. 
...
O exemplo acima inicia uma instância do Serviço de Migração de Banco de Dados do Azure chamada Serviço de Teste em um estado interrompido com base no nome do serviço passado como entrada
