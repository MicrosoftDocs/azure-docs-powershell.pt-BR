...
## Descrição
O cmdlet New-AzDataMigrationTask cria uma tarefa de migração de dados. Este cmdlet assume parâmetros para enumerador de Tipo de Tarefa, Grupo de Recursos do Azure, nome do Serviço de Migração de Banco de Dados do Azure associado e Project como entrada. 
...
### -Aguarde
Se você quer esperar a tarefa terminar. Se o sinalizador estiver definido, verificará a cada um segundos até que a tarefa termine e retorne ao usuário as propriedades da tarefa onde o resultado ou o erro pode ser inspecionado. 
```yaml
