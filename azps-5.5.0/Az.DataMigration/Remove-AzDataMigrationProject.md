...
## Descrição
O Remove-AzDataMigrationProject cmdlet remove um projeto do Azure Database Migration Service do Azure. O fornecimento do parâmetro DeleteRunningTask remove todas as tarefas do Serviço de Migração de Banco de Dados do Azure associadas ao projeto que está sendo removido. 
