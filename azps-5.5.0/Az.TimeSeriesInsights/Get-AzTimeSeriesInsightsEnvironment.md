...
### Exemplo 1: Obter um ambiente de insights de série de tempo
```powershell
...
Esse comando obtém um ambiente de informações de séries temportivas.

### Exemplo 2: Listar todos os ambientes de insights de séries de tempo
```powershell
...
Esse comando lista todos os ambientes de insights de séries de tempo em um grupo de recursos.

### Exemplo 3: Obter um ambiente de insights de série de tempo por objeto
```powershell
...
Esse comando obtém ambientes de informações de séries temportivas.
...
### -Expandir
A $expand=status incluirá o status dos serviços internos do ambiente no serviço Insights de Série de Tempo.
