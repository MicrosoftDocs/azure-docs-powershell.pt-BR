...
### Exemplo 1: Criar uma fonte de eventos do eventhub sob o ambiente especificado
```powershell
...
Esse comando cria uma fonte de eventos eventhub sob o ambiente especificado.

### Exemplo 2: Criar uma fonte de eventos do iothub no ambiente especificado
```powershell
...
Esse comando cria uma fonte de eventos do iothub sob o ambiente especificado.

## Parâmetros

### -ConsumerGroupName
O nome do grupo de consumidor do hub de eventos/iot que retém as partições das quais os eventos serão lidos.
...
A ID do recurso da fonte de eventos no Gerenciador de Recursos do Azure.
...
A propriedade do evento que será usada como data/hora da fonte do evento.
