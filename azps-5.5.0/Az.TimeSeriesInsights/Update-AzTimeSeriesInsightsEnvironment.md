...
### Exemplo 1: Atualizar um ambiente de insights de séries temporizais gen1
```powershell
...
Este comando atualiza um ambiente de insights de séries temporizais gen1.

### Exemplo 2: Atualizar um ambiente de insights de séries temporizais gen1
```powershell
