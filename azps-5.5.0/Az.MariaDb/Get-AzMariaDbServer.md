...
### Exemplo 1: Listar todos os MariaDB em uma assinatura
```powershell
...
Este comando lista todas as MariaDB em uma assinatura.

### Exemplo 2: Listar todos os MariaDB em um grupo de recursos
```powershell
...
Esse comando lista todos os MariaDB em um grupo de recursos.
