...
Use Update-AzMariaDbServer em vez disso, se quiser atualizar o AdministratorLoginPassword, sku etc.
...
### Exemplo 1: Atualizar configuração de MariaDB
```powershell
...
Este comando atualiza uma configuração mariadb.
