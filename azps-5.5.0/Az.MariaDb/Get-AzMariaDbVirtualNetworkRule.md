...
### Exemplo 1: Listar todas as regras de rede virtual sob um MariaDB
```powershell
...
Esse comando lista todas as regras de rede virtual sob um MariaDB.

### Exemplo 2: Obter regra de rede virtual sob um MariaDB
```powershell
...
Esse comando obtém uma regra de rede virtual sob um MariaDB.
