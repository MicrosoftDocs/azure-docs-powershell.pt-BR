...
ms.locfileid: "100113573"
---
# <span data-ttu-id="1c389-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="1c389-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="1c389-102">Sinopse</span><span class="sxs-lookup"><span data-stu-id="1c389-102">SYNOPSIS</span></span>
<span data-ttu-id="1c389-103">Obtém informações sobre uma configuração do servidor.</span><span class="sxs-lookup"><span data-stu-id="1c389-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="1c389-104">Sintaxe</span><span class="sxs-lookup"><span data-stu-id="1c389-104">SYNTAX</span></span>

### <span data-ttu-id="1c389-105">Lista (Padrão)</span><span class="sxs-lookup"><span data-stu-id="1c389-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="1c389-106">Obter</span><span class="sxs-lookup"><span data-stu-id="1c389-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="1c389-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="1c389-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="1c389-108">Descrição</span><span class="sxs-lookup"><span data-stu-id="1c389-108">DESCRIPTION</span></span>
<span data-ttu-id="1c389-109">Obtém informações sobre uma configuração do servidor.</span><span class="sxs-lookup"><span data-stu-id="1c389-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="1c389-110">Exemplos</span><span class="sxs-lookup"><span data-stu-id="1c389-110">EXAMPLES</span></span>

### <span data-ttu-id="1c389-111">Exemplo 1: Listar todas as configurações em um MariaDB</span><span class="sxs-lookup"><span data-stu-id="1c389-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="1c389-112">Esse comando lista todas as configurações sob um MariaDB.</span><span class="sxs-lookup"><span data-stu-id="1c389-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="1c389-113">Exemplo 2: Obter uma configuração de MariaDB</span><span class="sxs-lookup"><span data-stu-id="1c389-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="1c389-114">Esse comando obtém uma configuração do MariaDB.</span><span class="sxs-lookup"><span data-stu-id="1c389-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="1c389-115">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="1c389-115">PARAMETERS</span></span>

### <span data-ttu-id="1c389-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="1c389-116">-DefaultProfile</span></span>
<span data-ttu-id="1c389-117">As credenciais, a conta, o locatário e a assinatura usadas para comunicação com o Azure.</span><span class="sxs-lookup"><span data-stu-id="1c389-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="1c389-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="1c389-118">-InputObject</span></span>
<span data-ttu-id="1c389-119">Parâmetro de Identidade para construir, consulte a seção ANOTAÇÕES para propriedades INPUTOBJECT e crie uma tabela hash.</span><span class="sxs-lookup"><span data-stu-id="1c389-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="1c389-120">-Nome</span><span class="sxs-lookup"><span data-stu-id="1c389-120">-Name</span></span>
<span data-ttu-id="1c389-121">O nome da configuração do servidor.</span><span class="sxs-lookup"><span data-stu-id="1c389-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="1c389-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="1c389-122">-ResourceGroupName</span></span>
<span data-ttu-id="1c389-123">O nome do grupo de recursos que contém o recurso.</span><span class="sxs-lookup"><span data-stu-id="1c389-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="1c389-124">Você pode obter esse valor da API do Gerenciador de Recursos do Azure ou do portal.</span><span class="sxs-lookup"><span data-stu-id="1c389-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="1c389-125">-ServerName</span><span class="sxs-lookup"><span data-stu-id="1c389-125">-ServerName</span></span>
<span data-ttu-id="1c389-126">O nome do servidor.</span><span class="sxs-lookup"><span data-stu-id="1c389-126">The name of the server.</span></span>
...
### <span data-ttu-id="1c389-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="1c389-127">-SubscriptionId</span></span>
<span data-ttu-id="1c389-128">A ID da assinatura que identifica uma assinatura do Azure.</span><span class="sxs-lookup"><span data-stu-id="1c389-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="1c389-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="1c389-129">CommonParameters</span></span>
<span data-ttu-id="1c389-130">Este cmdlet dá suporte aos parâmetros comuns: -Depurar, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction e -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="1c389-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="1c389-131">Para obter mais informações, [consulte about_CommonParameters.](http://go.microsoft.com/fwlink/?LinkID=113216)</span><span class="sxs-lookup"><span data-stu-id="1c389-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="1c389-132">Entradas</span><span class="sxs-lookup"><span data-stu-id="1c389-132">INPUTS</span></span>

### <span data-ttu-id="1c389-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="1c389-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="1c389-134">Saídas</span><span class="sxs-lookup"><span data-stu-id="1c389-134">OUTPUTS</span></span>

### <span data-ttu-id="1c389-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span><span class="sxs-lookup"><span data-stu-id="1c389-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="1c389-136">Notas</span><span class="sxs-lookup"><span data-stu-id="1c389-136">NOTES</span></span>

<span data-ttu-id="1c389-137">Aliases</span><span class="sxs-lookup"><span data-stu-id="1c389-137">ALIASES</span></span>

<span data-ttu-id="1c389-138">PROPRIEDADES DE PARÂMETRO COMPLEXOS</span><span class="sxs-lookup"><span data-stu-id="1c389-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="1c389-139">Para criar os parâmetros descritos abaixo, construa uma tabela hash contendo as propriedades apropriadas.</span><span class="sxs-lookup"><span data-stu-id="1c389-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="1c389-140">Para obter informações sobre tabelas hash, execute Get-Help about_Hash_Tables.</span><span class="sxs-lookup"><span data-stu-id="1c389-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="1c389-141">INPUTOBJECT: <IMariaDbIdentity> Parâmetro de Identidade</span><span class="sxs-lookup"><span data-stu-id="1c389-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="1c389-142">`[ConfigurationName <String>]`: o nome da configuração do servidor.</span><span class="sxs-lookup"><span data-stu-id="1c389-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="1c389-143">`[DatabaseName <String>]`: o nome do banco de dados.</span><span class="sxs-lookup"><span data-stu-id="1c389-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="1c389-144">`[FirewallRuleName <String>]`: o nome da regra de firewall do servidor.</span><span class="sxs-lookup"><span data-stu-id="1c389-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="1c389-145">`[Id <String>]`: Caminho de identidade de recursos</span><span class="sxs-lookup"><span data-stu-id="1c389-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="1c389-146">`[LocationName <String>]`: o nome do local.</span><span class="sxs-lookup"><span data-stu-id="1c389-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="1c389-147">`[ResourceGroupName <String>]`: o nome do grupo de recursos que contém o recurso.</span><span class="sxs-lookup"><span data-stu-id="1c389-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="1c389-148">Você pode obter esse valor da API do Gerenciador de Recursos do Azure ou do portal.</span><span class="sxs-lookup"><span data-stu-id="1c389-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="1c389-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: o nome da política de alerta de segurança.</span><span class="sxs-lookup"><span data-stu-id="1c389-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="1c389-150">`[ServerName <String>]`: o nome do servidor.</span><span class="sxs-lookup"><span data-stu-id="1c389-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="1c389-151">`[SubscriptionId <String>]`: A ID da assinatura que identifica uma assinatura do Azure.</span><span class="sxs-lookup"><span data-stu-id="1c389-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="1c389-152">`[VirtualNetworkRuleName <String>]`: o nome da regra de rede virtual.</span><span class="sxs-lookup"><span data-stu-id="1c389-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="1c389-153">LINKS RELACIONADOS</span><span class="sxs-lookup"><span data-stu-id="1c389-153">RELATED LINKS</span></span>
