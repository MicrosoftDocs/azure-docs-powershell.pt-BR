...
### Obter todos os serviços de Sinalização na assinatura
```
PS C:\> Get-AzSignalR
...
### Obter todos os serviços de Sinalização em um grupo de recursos
```
...
### Obter um serviço de Sinalização específico
```
...
### Obter um serviço de Sinalização específico do grupo de recursos padrão
```
