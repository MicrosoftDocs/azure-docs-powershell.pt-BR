...
## Descrição
O cmdlet **Remove-AzTrafficManagerCusagerCustomHeaderFromProfile** remove informações personalizadas do header de um objeto de perfil local do Azure Traffic Manager.
...
### Exemplo 1: Remover informações personalizadas do header de um perfil
```
...
O segundo comando remove informações personalizadas do header do perfil armazenado no $TrafficManagerProfile.
