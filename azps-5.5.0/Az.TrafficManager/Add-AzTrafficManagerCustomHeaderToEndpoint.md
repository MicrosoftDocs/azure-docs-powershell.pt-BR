...
## Descrição
O cmdlet **Add-AzTrafficManagerCusagerCustomHeaderToEndpoint** adiciona informações de header personalizadas a um objeto de ponto de extremidade local do Azure Traffic Manager.
...
### Exemplo 1: Adicionar informações personalizadas de um header a um ponto de extremidade
```
...
O segundo comando adiciona informações personalizadas ao ponto de extremidade armazenado $TrafficManagerEndpoint.
