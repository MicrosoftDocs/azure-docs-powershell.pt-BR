...
### Exemplo 1: Excluir o AzADDomain por ResourceGroupName e Name
```powershell
PS C:\> Remove-AzADDomainService -ResourceGroupName $env.ResourceGroupName -Name $env.ADdomainName

```

Excluir o AzADDomain por ResourceGroupName e Name

### Exemplo 2: Excluir o AzADDomain por InputObject
```powershell
...
Excluir o AzADDomain por InputObject
