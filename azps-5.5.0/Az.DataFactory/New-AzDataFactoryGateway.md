...
Esse comando cria um gateway chamado ContosoGateway na fábrica de dados chamada WikiADF no grupo de recursos chamado ADF.

## Parâmetros

### -DataFactory
Especifica um **objeto PSDataFactory.**
Esse cmdlet cria um gateway para o fábrica de dados especificado por esse parâmetro.
...
Esse cmdlet cria um gateway que pertence ao grupo especificado por esse parâmetro.
