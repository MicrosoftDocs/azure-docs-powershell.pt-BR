...
## Sinopse
Interrompe a adoção de um pipeline em uma fábrica de dados.
...
## Descrição
O cmdlet **Stop-AzDataFactoryV2 PipelinelineRun** interrompe um pipeline executado em um fábrica de dados especificado com a ID de pipeline de executar.
...
Este comando interrompe a executar o pipeline com a ID b9730a13-aa12-4926-a8b3-8e3a974ab0bd no WikiADF de fábrica.
