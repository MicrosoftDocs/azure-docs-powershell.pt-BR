...
## Sinopse
Remover um nó com o nome determinado em um tempo de execução de integração.
...
## Descrição
O Remove-AzDataFactoryV2IntegrationRuntimeNode cmdlet remove um nó em um tempo de execução de integração.

## Exemplos

### Exemplo 1: Remover um nó de um tempo de execução de integração

Remover um nó com o nome determinado em um tempo de execução de integração. (gerado automaticamente)
...
### -NodeName
O nome do nó de tempo de execução de integração.
