...
## Sinopse
Obtém informações sobre o pipeline executado.
...
### ByFactoryObjectByBjectByBjline
```
...
## Descrição
O **comando Get-AzDataFactoryV2 PipelineRun** retorna informações sobre as executados para o pipeline especificado. Se PipelineRunId for especificado, ele mostrará detalhes para a executar com essa ID. Se o PipelineRunId não for especificado, ele mostrará informações sobre todas as executados para os pipelines que aconteceram entre os valores lastUpdatedAfter e LastUpdatedBefore.

## Exemplos

### Exemplo 1: Obter informações para uma adoção de pipeline
```
...
### -LastUpdatedAfter
O horário em que o pipeline foi executado ou depois foi atualizado no formato ISO8601.
...
### Microsoft.Azure.Commands.DataFactoryV2.Models.PS Ltd.
