...
## Sinopse
Obtém informações sobre conjuntos de dados no Data Factory.
...
## Descrição
O Get-AzDataFactoryV2Dataset cmdlet obtém informações sobre conjuntos de dados no Azure Data Factory.
...
### -Nome
Especifica o nome do conjuntos de dados sobre o qual obter informações.
