...
## Sinopse
Remove um pipeline do Data Factory.
...
Este cmdlet remove um pipeline da fábrica de dados especificado por esse parâmetro.
...
Este cmdlet remove o pipeline especificado por este parâmetro.
