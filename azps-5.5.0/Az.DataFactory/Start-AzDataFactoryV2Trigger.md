...
## Descrição
O cmdlet **Start-AzDataFactoryV2Triory** inicia um gatilho em uma fábrica de dados. Se o gatilho estiver no estado "Parado", o cmdlet iniciará o gatilho e eventualmente invocará pipelines com base em sua definição. Se o gatilho já estiver no estado "Iniciado", esse cmdlet não terá efeito. Se o parâmetro Forçar for especificado, o cmdlet não solicitará antes de iniciar o gatilho.
...
Inicia um gatilho chamado "ScheduledTri wiki" no fábrica de dados "WikiADF".
