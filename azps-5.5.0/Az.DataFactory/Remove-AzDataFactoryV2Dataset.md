...
## Sinopse
Remove um conjuntos de dados do Data Factory.
...
## Descrição
O Remove-AzDataFactoryV2Dataset cmdlet remove um conjuntos de dados do Azure Data Factory.

## Exemplos

### Exemplo 1: Remover um conjuntos de dados
```
...
Esse comando remove o conjuntos de dados chamado DAWikiAggregatedData da fábrica de dados chamada WikiADF.
...
Este cmdlet remove um conjuntos de dados do fábrica de dados especificado por esse parâmetro.
...
### -InputObject
Especifica um objeto de conjuntos de dados a ser removido.
...
### -Nome
Especifica o nome do conjuntos de dados a ser removido.
...
Esse cmdlet remove um conjunto de dados do grupo especificado por esse parâmetro.
