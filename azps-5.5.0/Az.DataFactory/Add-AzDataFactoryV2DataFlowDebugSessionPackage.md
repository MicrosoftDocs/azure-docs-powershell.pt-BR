...
Adicione o pacote de fluxo de dados à sessão de depuração "550effe4-93a3-485c-8525-eaf25259efbd" da fábrica de dados "WikiADF".
O arquivo Pakcage contém o recurso de depuração de fluxo de dados, lista de resouce de depuração de conjuntos de dados, lista de recurso de depuração de serviço vinculado, configuração de depuração e ID de sessão. Por exemplo:
