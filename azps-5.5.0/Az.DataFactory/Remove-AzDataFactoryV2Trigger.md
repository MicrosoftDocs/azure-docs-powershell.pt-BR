...
## Descrição
O cmdlet **Remove-AzDataFactoryV2Triory** remove um gatilho de uma fábrica de dados. Se o _parâmetro Forçar_ for especificado, o cmdlet não solicitará antes de remover o gatilho.
...
Remova um gatilho chamado "ScheduledTrigger" do fábrica de dados "WikiADF".
