...
Execute essas operações na seguinte ordem: - Criar uma fábrica de dados.
...
### Exemplo 2: Criar uma fábrica de dados com detalhes de configuração de repo usando um objeto de fábrica existente.
```
...
Esse comando cria uma fábrica de dados chamada WikiADF no grupo de recursos chamado ADF no local do EastUS com a configuração de controle de origem Azure DevOps.

### Exemplo 3: Crie uma fábrica de dados com detalhes de configuração do GitHub repo usando um novo objeto de fábrica.
```
...
Esse comando cria uma fábrica de dados chamada WikiADF no grupo de recursos chamado ADF no local do EastUS com configuração de controle de origem gitHub..

## Parâmetros

### -NomedaEm conta
O nome da conta para configuração de repo.
...
### -CollaborationBranch
A ramificação de colaboração para a configuração de repo.
...
### -Nomedo Host
O nome do host para a configuração de repo do GitHub.
