...
## Descrição
O **comando Get-AzDataFactoryV2TriframeRun** retorna informações detalhadas sobre o gatilho executado para o gatilho especificado no determinado prazo.

## Exemplos

### Exemplo 1: Obter informações sobre a acionamento
```
...
Este comando mostra informações sobre as executados para "WikiTri wikiTri wiki" na fábrica "WikiADF" que começou entre "2017-09-01" e "2019-09-30".
...
O momento em que a execução do gatilho começou a ser executada no formato ISO8601.
