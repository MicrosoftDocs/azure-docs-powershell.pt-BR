...
## Sinopse
Vincula um armazenamento de dados ou um serviço de nuvem ao Data Factory.
...
## Descrição
O Set-AzDataFactoryV2LinkedService cmdlet vincula um armazenamento de dados ou um serviço de nuvem ao Azure Data Factory.
