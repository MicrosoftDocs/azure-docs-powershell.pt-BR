...
## Descrição
O cmdlet **New-AzDataFactoryV2IntegrationRuntimeKey** regenera a tecla de tempo de execução de integração com o nome da chave especificado pelo parâmetro 'KeyName'. A chave anterior será inválida.
