...
O tempo em hora do dia para a atualização automática de tempo de execução de integração hospedada.
...
### Microsoft.Azure.Commands.DataFactoryV2.Models.PSHostedIntegrationRuntimeStatus
