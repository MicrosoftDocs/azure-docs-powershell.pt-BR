...
## Sinopse
Obtém informações sobre o Data Factory.
...
## Descrição
O Get-AzDataFactoryV2 cmdlet obtém informações sobre a coleta de dados em um grupo de recursos do Azure.
...
Exibe informações sobre toda a coleta de dados na assinatura do Azure.
