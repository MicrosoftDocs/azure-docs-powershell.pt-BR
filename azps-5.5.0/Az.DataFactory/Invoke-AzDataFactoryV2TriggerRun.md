...
## Sinopse
 Invoca outra instância de uma operação de gatilho.
...
## Descrição
O **comando Invoke-AzDataFactoryV2TrivocRun** inicia outra instância de uma executar gatilho com uma nova id de executar gatilho.
...
```
Inicia outra instância de uma execução de gatilho com uma nova ID de execução de gatilho, mantendo a mesma janelaStartTime e windowEndTime que o gatilho original é executado.
...
### -InputObject
As informações sobre o gatilho são executados.
...
### -PassThru
Se especificado o cmdlet write true caso a operação seja bem-sucedida.
...
### Microsoft.Azure.Commands.DataFactoryV2.Models.PSTrioryRun
...
### Microsoft.Azure.Commands.DataFactoryV2.Models.PS Bem-feira
