...
## Sinopse
Interrompe a operação de um gatilho em uma fábrica de dados.
...
## Descrição
O cmdlet **Stop-AzDataFactoryV2TrioryRun** interrompe uma operação de gatilho em um fábrica de dados especificado com o nome do gatilho e a ID de executar gatilho.
Atualmente, só há suporte para WindWindowTriwinds no estado WaitingOnDependency.
...
Esse comando interrompe a executar o gatilho com a id '08586002468005888497807248799CU16' no WikiADF de fábrica.
