...
## Descrição
Esse comando assina o gatilho do evento para os eventos de serviço externo especificados a partir da definição do gatilho.
...
Esse comando assinará o gatilho BlobEnetTrigregação1 para os eventos especificados a partir da definição do gatilho.
