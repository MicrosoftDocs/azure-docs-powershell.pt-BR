...
## Descrição
O cmdlet **Update-AzDataFactoryV2** atualiza marcas ou propriedades de identidade de uma fábrica de dados.
...
Este comando atualiza as marcas do WikiADF de fábrica para um dicionário que contém uma marca chamada myNewTagName com valor myTagValue.
