...
Esse comando cria uma fábrica de dados chamada WikiADF no grupo de recursos chamado ADF no local do WestUS.
...
### -Local
Especifica o local da fábrica de dados, como WestUS ou EastUS.
No momento, somente a WestUS tem suporte.
...
### -Nome
Especifica o nome da fábrica de dados a ser criado.
