...
Se você quiser adicionar um Microsoft SQL Server local como um serviço vinculado a uma fábrica de dados, deverá instalar um gateway em seu computador local.
...
Esse comando obtém informações sobre todos os gateways lógicos para o fábrica de dados chamado WikiADF no grupo de recursos chamado ADF.
...
Esse comando obtém informações sobre o gateway lógico chamado Gateway01 na fábrica de dados chamada WikiADF no grupo de recursos chamado ADF.
