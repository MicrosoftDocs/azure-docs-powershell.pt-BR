...
Esse comando remove o tempo de execução de integração chamado 'test-reserved-ir' da fábrica de dados chamada 'test-df'.
...
O nome da fábrica de dados vinculada.
