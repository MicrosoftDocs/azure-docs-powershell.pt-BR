...
## Descrição
O New-AzDataFactoryV2LinkedServiceEncryptedCredential cmdlet criptografa credenciais no serviço vinculado com tempo de execução de integração especificado.
...
Esse comando criptografa a credencial no arquivo C:\samples\WikiSample\TaxiDemo1.jscom o tempo de execução de integração chamado test-selfhost-ir.
