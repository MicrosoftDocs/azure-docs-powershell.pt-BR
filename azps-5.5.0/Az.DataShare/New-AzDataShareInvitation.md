...
## Descrição
O cmdlet **New-AzDataShareInvitation** envia um convite para o consumidor de destino com informações sobre o compartilhamento do provedor. 
...
Esse comando cria um convite AdsInvitation para compartilhar AdsShare e o envia para o email de adstest@microsoft.com destino.
