...
Esse comando exibe informações sobre o conjunto de dados AdsDataSet no share AdsShare na conta de compartilhamento de dados wikiAdsAccount do Azure e ADS do grupo de recursos.
