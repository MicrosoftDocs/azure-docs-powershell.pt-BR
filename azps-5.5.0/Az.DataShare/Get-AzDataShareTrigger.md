...
## Descrição
O **cmdlet Get-AzDataShareTri adobe obtém** informações sobre o gatilho para compartilhar assinatura na conta de compartilhamento de dados.
...
Este comando obtém informações sobre acionar AdsTriscription para compartilhar assinatura AdsShareSubscription sob a conta wikiAds do compartilhamento de dados.
