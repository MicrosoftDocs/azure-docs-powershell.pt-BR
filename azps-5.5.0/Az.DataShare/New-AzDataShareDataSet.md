...
## Descrição
O **cmdlet New-AzDataShareDataSet** adiciona conjuntos de dados no compartilhamento de dados da conta de compartilhamento de dados do Azure. Você pode adicionar conjuntos de dados dos tipos Blob, ADLS Gen2 e ADLS Gen1.
...
Esse comando adiciona um conjuntos de dados chamado AdsDataSet do contêiner de blob de tipo ao compartilhamento de dados do Azure AdsShare.
...
### -AdlsGen1FolderPath
Caminho da pasta de armazenamento do ADLS gen1 do Azure
