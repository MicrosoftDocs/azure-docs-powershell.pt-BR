...
## Descrição
O cmdlet **Get-AzDataShareSubscriptionSynchronization** fornece informações sobre toda a sincronização é executado em uma assinatura de compartilhamento em uma conta de compartilhamento de dados no consumidor.
...
Esse comando fornece informações sobre todas as sincronizações em uma assinatura de compartilhamento adsShareSubscription sob wikiAds da conta de compartilhamento de dados.
