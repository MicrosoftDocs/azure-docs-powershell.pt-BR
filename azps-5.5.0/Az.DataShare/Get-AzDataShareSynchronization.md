...
Esses comandos fornece informações sobre todas as configurações de sincronização presentes no compartilhamento AdsShare na conta wikiAds do compartilhamento de dados.
