...
## Descrição
O **cmdlet Set-AzDataShare** atualiza um compartilhamento de dados que existe dentro de uma conta de compartilhamento de dados do azure especificada.
...
### -TermsOfUse
Termos de Uso para Compartilhamento de Dados
