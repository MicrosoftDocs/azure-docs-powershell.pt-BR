...
## Descrição
O **cmdlet Remove-AzDataShareAccount** remove uma conta de da ltda.
...
Esse comando remove a conta da wikiadre chamada WikiADS do grupo de recursos chamado ADS.
...
### -InputObject
O objeto de conta de compartilhamento de dados do azure.
