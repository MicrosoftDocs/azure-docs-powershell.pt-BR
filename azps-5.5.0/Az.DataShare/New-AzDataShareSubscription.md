...
Esses comandos criam uma nova assinatura de compartilhamento adsShareSubscription para inçõesionId sob a conta wikiAds do compartilhamento de dados.
...
### -InvitationId
InvitationId de compartilhamento de dados do Azure
...
### -SourceShareLocation
Local de compartilhamento de dados do Azure
