...
## Descrição
O cmdlet **New-AzDataShareTrigate** cria um gatilho para compartilhar assinatura para o intervalo de recorrência especificado e o tempo de sincronização na conta de compartilhamento de dados do azure.
...
Esse comando cria um novo gatilho AdsTriscription para compartilhar assinatura AdsShareSubscription com um intervalo de recorrência diário de 9h.
