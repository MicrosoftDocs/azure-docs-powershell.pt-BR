...
## Descrição
O cmdlet **Remove-AzDataShareSynchronizationSetting** remove uma configuração de sincronização de dagatere
...
### -InputObject
A configuração sincronização de compartilhamento de dados do Azure.
