...
```
 ...
 Esse comando exibe informações sobre todos os mapeamentos de conjuntos de dados na assinatura de compartilhamento.
...
### -ResourceId
A ID do recurso do mapeamento de conjunto de dados do Azure.
