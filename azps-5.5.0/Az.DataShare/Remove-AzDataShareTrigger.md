...
## Descrição
O cmdlet **Remove-AzDataShareTrigger** remove um gatilho de dação
...
Esses comandos removem um gatilho chamado AdsTriscription do compartilhamento de assinatura AdsShareSubscription. 
...
### -InputObject
Objeto disparador de compartilhamento de dados do Azure
...
### -ResourceId
A ID do recurso do gatilho de compartilhamento de dados do Azure
