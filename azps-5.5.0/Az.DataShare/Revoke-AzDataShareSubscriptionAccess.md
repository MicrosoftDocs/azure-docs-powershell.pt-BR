...
## Descrição
O **cmdlet Revoke-AzDataShareSubscriptionAccess concede** a uma assinatura de compartilhamento acesso ao compartilhamento de origem
...
### -ShareSubscriptionId
A ID de compartilhamento da assinatura de compartilhamento do provedor
