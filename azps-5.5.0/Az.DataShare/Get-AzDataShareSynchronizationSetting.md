...
Este comando fornece informações sobre a sincronização do ShareSynchronization habilitada no compartilhamento AdsShare em wikiAds da conta de compartilhamento de dados.
...
### -Nome
Nome para Configuração de Sincronização
...
### -ResourceId
A ID do recurso da configuração de sincronização de compartilhamento de dados do Azure
