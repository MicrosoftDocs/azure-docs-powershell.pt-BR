...
## Descrição
O cmdlet **Get-AzDataShareProviderSubscription** obtém informações sobre assinaturas de compartilhamento de consumidor no lado do provedor. Se você especificar a ID de compartilhamento de subscrption, este cmdlet obterá informações sobre a assinatura de compartilhamento. Se você não especificar a ID da assinatura de compartilhamento, este cmdlet obterá informações sobre todas as assinaturas de compartilhamento do consumidor associadas ao compartilhamento.
...
Esses comandos fornece informações sobre a assinatura de compartilhamento de consumidor associada ao compartilhamento AdsShare em wikiAds da conta de compartilhamento de dados.
...
### -ShareSubscriptionId
A ID da assinatura de compartilhamento de consumidor
