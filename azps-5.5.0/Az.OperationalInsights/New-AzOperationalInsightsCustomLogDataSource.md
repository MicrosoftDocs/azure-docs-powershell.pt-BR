...
## Sinopse
Define uma política de conjunto de log personalizada.
...
## Descrição
O **cmdlet New-AzOperationalInsightsCustomLogDataSource** define uma política de conjunto de log personalizada.
...
### -CustomLogRawJson
Especifica a política de coleção personalizada como uma cadeia de caracteres JSON (Notação de Objeto JavaScript) bruto.
