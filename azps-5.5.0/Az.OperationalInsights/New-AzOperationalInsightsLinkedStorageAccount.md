...
## Sinopse
Criar conta de armazenamento vinculada para espaço de trabalho
...
Adicionar armazenamento vinculado para espaço de trabalho

## Parâmetros

### -DataSourceType
O Tipo de Fonte de Dados deve ser um dos 'CustomLogs', 'Azure Widget'.
...
### -StorageAccountIds
lista de ID da conta de armazenamento.
