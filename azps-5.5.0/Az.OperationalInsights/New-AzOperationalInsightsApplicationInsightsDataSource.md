...
## Descrição
O cmdlet **New-AzOperationalInsightsApplicationInsightsDataSource** habilita o conjunto de logs de um determinado Application-Insights aplicativo.
...
Esse comando cria uma fonte de dados de insights de aplicativo de um determinado aplicativo em um determinado espaço de trabalho de análise de log. Isso habilita o conjunto de logs de determinado aplicativo para o espaço de trabalho de análise de log.

### Exemplo 2: Obter objeto de espaço de trabalho e criar fonte de dados de insights de aplicativo pela ID do recurso de aplicativo
```
...
Esse comando demonstra como obter um objeto de espaço de trabalho de análise de log e, em seguida, passar a saída para criar uma fonte de dados de informações de aplicativo associada pela ID do recurso de aplicativo. 
