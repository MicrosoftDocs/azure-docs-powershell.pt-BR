...
## Descrição
O cmdlet **New-AzOperationalInsightsComputerGroup** cria um grupo de computador em um grupo de recursos e local.

## Exemplos

### Exemplo 1

Cria um grupo de computador. (gerado automaticamente)
...
### -DisplayName
Especifica o nome de exibição do grupo de computador.
...
### -Consulta
Especifica a consulta do grupo de computador.
...
O cmdlet cria um grupo de computador neste grupo de recursos.
...
### -SavedSearchId
Especifica a ID do grupo de computador.
