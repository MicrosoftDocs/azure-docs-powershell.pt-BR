...
Isso expõe o quanto os dados foram analisados pelo espaço de trabalho em um determinado período.

## Exemplos

### Exemplo 1: Obter dados de uso por nome de espaço de trabalho
```
