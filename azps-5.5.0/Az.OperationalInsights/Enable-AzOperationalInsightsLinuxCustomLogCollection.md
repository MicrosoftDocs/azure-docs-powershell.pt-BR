...
## Sinopse
Inicia uma coleção de logs personalizados de computadores Linux.
...
## Descrição
O cmdlet **Enable-AzOperationalInsightsLinuxCustomLogCollection** inicia uma coleção de logs personalizados de computadores Linux conectados em um espaço de trabalho.
