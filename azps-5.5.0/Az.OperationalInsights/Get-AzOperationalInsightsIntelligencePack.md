...
## Descrição
O cmdlet **Get-AzOperationalInsightsIntelligencePack** obtém os Pacotes de Inteligência disponíveis.
...
Esse comando obtém os Pacotes de Inteligência disponíveis.
