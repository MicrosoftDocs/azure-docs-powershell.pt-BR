...
atualizar cluster com propriedades do cofre de chave e sku
...
### -KeyVaultUri
O Uri do Cofre de Teclas, "Proteção contra Limpeza" e "Exclusão Suave" devem ser habilitados para este keyvault
