...
## Sinopse
Atualiza um Insights de Armazenamento.
...
## Descrição
O cmdlet **Set-AzOperationalInsightsStorageInsight** altera a configuração de um Insight de Armazenamento.

## Exemplos

### Exemplo 1: Modificar uma Visão de Armazenamento por nome
```
...
Esse comando modifica as tabelas das quais o Insights de Armazenamento chamado MyStorageInsight lê.

### Exemplo 2: Modificar uma Visão de Armazenamento usando um objeto de espaço de trabalho
```
...
O segundo comando modifica os contêineres dos quais o Insights de Armazenamento chamado MyStorageInsight lê.
...
### -Nome
Especifica o nome de uma Visão de Armazenamento.
