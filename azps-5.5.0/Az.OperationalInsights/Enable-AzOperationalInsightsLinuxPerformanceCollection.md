...
## Sinopse
Inicia a coleção de contadores de desempenho de computadores Linux.
...
## Descrição
O cmdlet **Enable-AzOperationalInsightsLinuxPerformanceCollection** inicia uma coleção de contadores de desempenho de computadores Linux conectados em um espaço de trabalho.
