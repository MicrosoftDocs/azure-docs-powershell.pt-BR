...
## Sinopse
Inicia a coleta de dados de syslog de computadores Linux.
...
## Descrição
O cmdlet **Enable-AzOperationalInsightsLinuxSyslogCollection** inicia o conjunto de dados de syslog de computadores Linux conectados em um espaço de trabalho.
