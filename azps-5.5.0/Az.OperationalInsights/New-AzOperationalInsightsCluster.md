...
### -IdentityType
o tipo de identidade, o valor pode ser "SystemAssigned", "None".
...
### -Local
A região geográfica em que o cluster será implantado.
...
### -SkuCapacity
Capacidade da SKU, o valor precisa ser múltiplo de 100 e no intervalo de 1000 a 2000.
...
### -SkuName
Nome SKU, agora pode ser somente 'CapacityReservation'
