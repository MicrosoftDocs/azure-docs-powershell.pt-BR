...
## Sinopse
Interrompe a coleção de logs personalizados de computadores Linux.
...
## Descrição
O cmdlet **Disable-AzOperationalInsightsLinuxCustomLogCollection** interrompe a coleção de logs personalizados de computadores Linux conectados em um espaço de trabalho.
