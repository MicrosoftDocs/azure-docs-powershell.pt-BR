...
Esse comando usa o cmdlet Get-AzOperationalInsightsWorkspace para obter o espaço de trabalho chamado MyWorkSpace e passa-o para o cmdlet **Set-AzOperationalInsightsWorkspace** usando o operador de pipeline para definir a SKU como Premium.
...
### -SKU
Especifica o nível de serviço do espaço de trabalho.
