...
## Descrição
A New-AzOperationalInsightsAzureActivityLogDataSource habilitar o Log Analytics para coletar o log de atividades do Azure de determinada assinatura.
...
### -BackfillStartTime
Você pode optar por fazer o backfill logs de uma semana atrás.
