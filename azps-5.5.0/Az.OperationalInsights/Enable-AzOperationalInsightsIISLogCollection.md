...
## Sinopse
Inicia o conjunto de logs IIS de computadores em um espaço de trabalho.
...
## Descrição
O cmdlet **Enable-AzOperationalInsightsILogCollection** inicia uma coleção de logs do IIS (Serviços de Informações da Internet) de computadores conectados em um espaço de trabalho.
