...
Esse comando adiciona a API especificada ao produto especificado.

## Parâmetros

### -ApiId
Especifica a ID de uma API para adicionar a um produto.
...
### -ProductId
Especifica a ID do produto ao qual adicionar a API.
