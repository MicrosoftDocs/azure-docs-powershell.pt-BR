...
### -ApiRevision
Identificador de Revisão da API. Este parâmetro é opcional. Se não especificado, a operação será anexada à revisão da api ativa no momento.
...
### -Respostas
Especifica uma matriz de possíveis respostas à operação de gerenciamento de API.
