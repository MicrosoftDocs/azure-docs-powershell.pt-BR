...
## Sinopse
Publica alterações de uma ramificação git no banco de dados de configuração.
...
Você pode validar as alterações em uma ramificação git sem publicar.
...
Esse comando publica as alterações da ramificação especificada no banco de dados de configuração.
...
### -Branch
Especifica o nome da ramificação Git a partir da qual este cmdlet implanta a configuração para o banco de dados de configuração.
...
### -ValidateOnly
Indica que esse cmdlet valida as alterações na ramificação do Git especificada.
Ele não é publicado no banco de dados de configuração.
