...
## Sinopse
Remova a entidade diagnóstico do escopo de nível Global ou API.
...
## Descrição
O cmdlet **Remove-AzApiManagementDiagnostic** remove a entidade de diagnóstico especificada pelo escopo global ou `DiagnosticId` por um `ApiId` escopo

## Exemplos

### Exemplo 1: Remover a entidade diagnóstico
```powershell
...
### -DiagnosticId
Identificador de produto existente.
...
### -InputObject
Instância de PsApiManagementDiagnostic. Esse parâmetro é necessário.
...
### -ResourceId
Arm ResourceId of Diagnostic. Esse parâmetro é necessário.
