...
## Sinopse
Obtém as teclas de configuração de acesso para um locatário.
...
### Exemplo 1: Obter teclas de configuração de acesso do locatário
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementTenantAccessSecret -Context $apimContext
```

Esse comando obtém as teclas de configuração de acesso do locatário para o contexto especificado.
