...
Em outras palavras, este cmdlet remove a atribuição de grupo de um produto.
...
### -PassThru
Indica que esse cmdlet retorna um valor de $True, se for bem-sucedido ou $False, caso contrário.
