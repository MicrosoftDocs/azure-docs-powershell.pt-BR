...
O script removerá o Esquema `2` da Api se ele não for `echo-api` referenciado.

### Exemplo 2

O script removerá o Esquema 2 da api de eco da Api se ele não for referenciado. (gerado automaticamente)
...
### -ResourceId
Arm ResourceId da ApiSchema. Esse parâmetro é necessário.
...
### -SchemaId
Identificador do Esquema da API.
Esse parâmetro é necessário.
