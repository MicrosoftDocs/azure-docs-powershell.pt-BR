...
## Sinopse
Habilita ou desabilita o acesso de locatário.
...
## Descrição
O cmdlet **Set-AzApiManagementTenantAccess** habilita ou desabilita o acesso de locatário.

## Exemplos

### Exemplo 1: Habilitar o acesso do locatário
```
...
### -Habilitado
Especifica se esse cmdlet habilita ou desabilita o acesso do locatário.
Especifique um valor de $True para habilitar ou $False desabilitar.
...
### -PassThru
Indica que esse cmdlet retorna a **PsApiManagementAccessInformation** que este cmdlet modifica.
