...
Esse comando remove um produto existente e todas as assinaturas.
...
Se você não definir esse parâmetro e as assinaturas existirem, uma exceção será descartada.
...
### -PassThru
Indica que esse cmdlet retorna um valor de $True, se for bem-sucedido, ou um valor de $False, se falhar.
