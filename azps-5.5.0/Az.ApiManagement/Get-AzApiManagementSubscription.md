...
As teclas não serão incluídas nos detalhes do resultado. Para obter chaves, use **Get-AzApiManagementSubscriptionKey.**
...
Esse comando obtém as assinaturas de um usuário.
...
Esse comando obtém todas as assinaturas que estão configuradas para o escopo da api global

### Exemplo 6: Obter todas as assinaturas de um escopo de produto e usuário
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
...
Se especificado, esse cmdlet localiza todas as assinaturas pelo identificador do produto.
...
### -Escopo
Identificador de escopo. O Escopo da Assinatura, seja o Escopo da Api /apis/{apiId} ou o Escopo do Produto /products/{productId} ou Escopo da API Global /apis ou escopo global /.
