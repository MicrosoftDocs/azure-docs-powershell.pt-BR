...
### -DeleteSubscriptions
Indica se você deve excluir assinaturas do produto.
...
### -PassThru
Indica que esse cmdlet retorna um valor de $Ture, se for bem-sucedido, ou um valor de $False, caso contrário.
