...
## Descrição
O cmdlet **Get-AzApiManagementApiRelease** recebe uma ou mais versões da API de Gerenciamento da API do Azure.
...
Esse comando obtém as informações de versões de uma API específica com a ID de lançamento especificada.
