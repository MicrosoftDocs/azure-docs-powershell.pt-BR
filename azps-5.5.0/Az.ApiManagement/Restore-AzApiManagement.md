...
## Sinopse
Restaura um Serviço de Gerenciamento de API a partir do blob de armazenamento especificado do Azure.
...
## Descrição
O cmdlet **Restore-AzApiManagement** restaura um Serviço de Gerenciamento de API do backup especificado que reside em um blob do Azurestorage.
...
Esse comando restaura um serviço de Gerenciamento de API a partir do blob de armazenamento do Azure.
...
### -SourceBname
Especifica o nome do blob de origem de backup de armazenamento do Azure.
...
### -SourceContainerName
Especifica o nome do contêiner de origem de backup de armazenamento do Azure.
