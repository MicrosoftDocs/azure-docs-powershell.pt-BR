...
## Sinopse
Obter os detalhes de configuração do provedor de identidade.
...
## Descrição
Obter os detalhes de configuração do provedor de identidade.
ClientSec ltd não será incluído nos detalhes do resultado. Para obter o segredo do cliente, use **Get-AzApiManagementIdentityProviderClientSecsec.**
...
Obter todas as configurações do provedor de identidade no serviço.

### Exemplo 2: Obter o Provedor de Identidade de Tipo AAD
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### Exemplo 3: Obter o Provedor de Identidade de Tipo B2C do AAD
```powershell
