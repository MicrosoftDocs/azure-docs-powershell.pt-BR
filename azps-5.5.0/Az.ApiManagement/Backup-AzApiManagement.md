...
## Sinopse
Fazer o back up de um serviço de Gerenciamento de API.
...
## Descrição
O **cmdlet Backup-AzApiManagement** backup de uma instância de um serviço de Gerenciamento de API do Azure.
...
Esse comando fazer o back up de um serviço de Gerenciamento de API em um blob de Armazenamento.
...
### -Nome
Especifica o nome da implantação de Gerenciamento de API que este cmdlet fazer o back-up.
...
Este cmdlet gera um valor padrão com base no seguinte padrão: {Name}-{yyyyy-MM-dd-HH-mm}.apimbackup
