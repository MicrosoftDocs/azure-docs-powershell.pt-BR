...
Este comando inscreve um usuário existente a um produto.
...
### -AllowTracing
Sinalizador que determina se o Rastreamento pode ser habilitado no Nível de Assinatura. Esse parâmetro é opcional e o padrão é $null.
...
### -ProductId
Especifica a ID do produto ao qual se inscrever.
...
### -Escopo
O Escopo da Assinatura, seja o Escopo da Api /apis/{apiId} ou o Escopo do Produto /products/{productId} ou Escopo da API Global /apis ou escopo global /. Esse parâmetro é necessário.
...
Esse parâmetro é gerado se não especificado.
