...
### Exemplo 1: Criar uma configuração básica de Amostragem
```powershell
...
Cria uma configuração de amostragem do tipo com registro em log `Fixed` para 100% das solicitações/respostas
