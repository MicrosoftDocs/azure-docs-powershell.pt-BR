...
## Descrição
O cmdlet **New-AzApiManagement DimensionalLineDiagnosticSetting** cria as configurações de Diagnóstico para mensagens HTTP de entrada/saída para o Gateway.
...
Crie um diagnóstico de pipeline a ser usado em FrontEnd ou Backend na Entidade de Diagnóstico.
