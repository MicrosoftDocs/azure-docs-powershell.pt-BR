...
### Exemplo 1: Criar um produto que não requer uma assinatura
```
...
### Exemplo 2: Criar um produto que exija uma assinatura e aprovação
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
É necessária uma assinatura e uma aprovação.
Esse comando define o período de notificação para 10 dias.
...
psdx_paramvalues
- Não Publicado
- Publicado O valor padrão não é Publicado.
