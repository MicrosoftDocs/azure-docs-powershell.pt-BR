...
## Sinopse
Obtém a configuração de acesso git para um locatário.
...
## Descrição
O cmdlet **Get-AzApiManagementTenantGitAccess** obtém a configuração de acesso do Git para um locatário.
As teclas não serão incluídas nos detalhes do resultado. Para obter o segredo do cliente, use **Get-AzApiManagementTenantGitAccessSec limited.**

## Exemplos

### Exemplo 1: Obter configuração de acesso de locatário
```powershell
...
Esse comando obtém a configuração de acesso do Git para o contexto especificado.
