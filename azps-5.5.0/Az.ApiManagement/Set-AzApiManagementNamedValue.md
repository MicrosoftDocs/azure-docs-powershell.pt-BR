...
O primeiro comando atribui dois valores à variável $Tags dados.
...
### -NamedValueId
Identificador de valor nomeado para atualização.
...
### -PassThru
Se especificado, a instância do Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementProperty que representa a propriedade modificada será escrita em saída.
...
O comprimento máximo é de 1.000 caracteres.
