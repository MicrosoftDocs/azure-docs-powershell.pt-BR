...
psdx_paramvalues OBTER e POSTAR.
...
### -TokenEndpointUrl
Especifica o ponto de extremidade do token para que os clientes obtenham tokens de acesso em troca de apresentação de concessões de autorização ou tokens de atualização.
