...
## Sinopse
Obtém detalhes de todas as Revisões da API de uma API
...
### Exemplo 1: Obter todas as revisões da API de uma API
```powershell
...
Esse comando obtém toda a revisão da API da API especificada para contexto de ApiManagement específico.
...
### -ApiRevision
Identificador de Revisão da revisão de Api específica. Este parâmetro é opcional.
