...
Esse comando remove a política de escopo da API do Gerenciamento de API.
...
Se você especificar esse parâmetro, o cmdlet removerá a política de escopo da API.
