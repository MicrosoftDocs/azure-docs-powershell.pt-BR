...
## Sinopse
Obtém as teclas de configuração de acesso git para um locatário.
...
Esse comando obtém as teclas de configuração de acesso do Git para o contexto especificado.
