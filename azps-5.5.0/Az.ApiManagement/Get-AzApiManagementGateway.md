...
## Sinopse
Obtém um Gateway de gerenciamento de API completo ou específico.
...
## Descrição
O cmdlet **Get-AzApiManagementGateway** obtém o Gateway de gerenciamento de API todo ou específico.
...
Se especificado, tentará encontrar o gateway pelo identificador.
