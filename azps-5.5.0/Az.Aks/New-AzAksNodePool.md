...
### Criar pool de nó com parâmetros padrão
```powershell
...
### -ClusterObject
Especifique o objeto de cluster no qual criar pool de nó.
...
### -Forçar
Criar pool de nó mesmo que ele já exista
...
### -OsType
OsType a ser usado para especificar o tipo do sistema operacional.
Escolha no Linux e no Windows.
Padrão para o Linux.
...
ScaleSetEvictionPolicy a ser usado para especificar a política de desagregação para conjunto de escala de máquina virtual de baixa prioridade.
Padrão para Excluir.
...
### -ScaleSetPriority
ScaleSetPriority a ser usado para especificar a prioridade de conjunto de escala de máquina virtual.
Padrão para regular.
...
### -VmSetType
Representa os tipos de um pool de nó.
