...
### Baixar e instalar a versão mais recente doectl
```powershell
...
### -Destino
Caminho no qual instalar oectl.
Padrão para instalar em ~/.azure-ectl/
...
### -DownloadFromMirror
Baixar do site espelhado: https://mirror.azure.cn/kubernetes/kubectl/
...
### -Forçar
Substituir aectl existente sem aviso
...
### -Versão
Versão deectl para instalação, por exemplo, 'v1.17.2'.
