...
## Sinopse
Importar e mesclar a configuração Desaectl para um Cluster Desarmado gerenciado.
...
### Importar e mesclar a configuração Desarmônica
```
...
### -Administrador
Obter a configuração de 'clusterAdmin'ectl ' em vez do 'clusterUser' padrão.
...
### -ConfigPath
Um arquivo de configuração daectl para criar ou atualizar.
Use '-' para imprimir YAML para stdout.
Padrão: %Home%/.ltd/config.
...
### -Forçar
Importar a configuração de RedeNetes, mesmo que seja o padrão
