...
## Sinopse
Obtém mapeamentos de Contêiner de Proteção de Recuperação de Site do Azure.
...
## Descrição
O cmdlet **Get-AzRecoveryServicesAsrProtectionContainerMapping** obtém informações sobre o contêiner de proteção para mapeamentos de política de replicação(associação) no cofre do contêiner de proteção ASR especificado.
...
Lista de mapeamentos de contêineres de proteção para contêineres.
...
### -Nome
Especifica o nome do mapeamento de contêiner de proteção para obter.
