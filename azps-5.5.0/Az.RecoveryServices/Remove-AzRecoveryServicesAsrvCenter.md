...
## Sinopse
Remove o servidor vCenter da malha ASR e interrompe a descoberta de máquinas virtuais do servidor vCenter.
...
## Descrição
O cmdlet **Remove-AzRecoveryServicesAsrvCenter** remove o servidor vCenter da tela asR e interrompe a descoberta de máquinas virtuais do servidor vCenter.
...
Remove o servidor vCenter da malha ASR.

### Exemplo 2

Remove o servidor vCenter da malha ASR e interrompe a descoberta de máquinas virtuais do servidor vCenter. (gerado automaticamente)
...
### -InputObject
Objeto ASR vCenter que representa o servidor vCenter a ser removido.
...
### -ResourceId
Especifica a resourceId do vCenter a ser removido.
