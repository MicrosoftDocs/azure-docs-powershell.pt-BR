...
## Sinopse
Obtém detalhes dos eventos de Recuperação de Site do Azure no cofre.
...
## Descrição
O **Get-AzRecoveryServicesAsrEvent obtém** a lista de eventos no cofre com base nos filtros de seleção especificados.
...
Lista de eventos do Objeto afetado.
...
Lista de eventos entre a hora de início e a hora de término, gravidade crítica e tipo de saúde VmHealth.

## Parâmetros

### -AffectedObjectFriendlyName
Especifica AffectedObject FriendlyName para a pesquisa.
...
### -EndTime
Especifica a hora de término da janela de pesquisa. Use este parâmetro para obter somente os eventos que ocorreram antes do horário especificado.
...
### -EventType
Filtre eventos pelo tipo de evento.
...
### -Malha
Filtre eventos pela malha especificada.
...
### -FabricId
Especifica a ID de fábrica a ser filtrada.
...
### -ResourceId
Especifica o evento ResourceId do evento.
...
### -Gravidade
Gravidade do evento para filtrar.
...
### -StartTime
Especifica a hora de início da janela de pesquisa. Use este parâmetro para obter somente os eventos que ocorreram após o tempo especificado.
