...
ms.locfileid: "100114943"
---
# Initialize-AzRecoveryServicesBackupProtectableItem

## Sinopse
Esse comando desencadeia a descoberta de qualquer item desprotegido do tipo de carga de trabalho determinado no contêiner determinado. Se o aplicativo DB não estiver protegido automaticamente, use esse comando para descobrir novos DBs sempre que eles são adicionados e prossiga para protegê-los.
...
## Descrição
o cmdlet solicita cargas de trabalho específicas dentro de um contêiner. Isso desencadeia uma operação que cria itens protegidos.
...
Esse comando desencadeia a descoberta de qualquer item desprotegido do tipo de carga de trabalho determinado no contêiner determinado. (gerado automaticamente)
