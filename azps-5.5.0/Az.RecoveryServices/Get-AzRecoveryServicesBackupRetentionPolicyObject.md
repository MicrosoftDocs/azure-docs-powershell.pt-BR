...
## Descrição
O cmdlet **Get-AzRecoveryServicesBackupRetentionPolicyObject** obtém uma base **AzureRMRecoveryServicesRetentionPolicyObject.**
...
O segundo comando define a duração do objeto de política de retenção para 365 dias.
O terceiro comando obtém o objeto de política de agendamento e o armazena na variável $SchPol calendário.
