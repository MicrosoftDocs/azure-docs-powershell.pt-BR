...
## Descrição
O cmdlet **Update-AzRecoveryServicesAsrPolicy** atualiza a política de replicação de Recuperação de Site do Azure especificada.
...
Inicia a operação de política de replicação de atualização usando os parâmetros especificados e retorna o trabalho ASR usado para controlar a operação.
...
Inicia a atualização do azure para a operação de política de replicação do Azure usando os parâmetros especificados e retorna o trabalho ASR usado para controlar a operação.
...
Inicia a atualização do azure para a política de replicação do Azure usando os parâmetros especificados e retorna o trabalho ASR usado para controlar a operação.

## Parâmetros

### -ApplicationConsistentSnapshotFrequencyInHours
Especifica a frequência(em horas) na qual se cria pontos de recuperação consistentes do aplicativo.
...
### -AzureToV Ltd
Especifica a recuperação de desastres do Azure para vMWare.
...
### -Compactação
Especifica se a compactação deve estar habilitada.
...
### -HyperVToAzure
Alternar parâmetro indicando que a política especificada é usada para replicar máquinas virtuais Hyper-V para o Azure.
...
### -MultiVmSyncStatus
Especifica o status de sincronização multiVm para a política.
...
Especifica os pontos de recuperação de número a manter.
...
Especifica a ID de conta de armazenamento do Azure do destino de replicação. Usado como a conta de armazenamento de destino para replicação se uma alternativa não for fornecida durante a habilitação da replicação usando New-AzRecoveryServicesASRReplicationProtectedItem cmdlet.
...
### -ReplicaDeletion
Especifica se a máquina virtual de réplica deve ser excluída na desabilitação da replicação de um site gerenciado de VMM para outro.
...
Não deve ser mais do que 24 horas a partir do início do trabalho.
...
### -VmmToVmm
Alternar parâmetro indicando que a política especificada é usada para replicar máquinas virtuais VMM gerenciadas hyper-V entre dois sites HiperV.
...
### -V FazerAzure
Alternar parâmetro indicando que a política especificada é usada para replicar máquinas virtuais VLique para o Azure.
