...
## Sinopse
Desabilita o backup automático para um item protegido.
...
## Descrição
O cmdlet **Disable-AzRecoveryServicesBackupAutoProtection** desabilita a proteção em um item protegido.
...
O primeiro cmdlet obtém o contêiner backup do tipo AzureVMAppContainer.  O segundo cmdlet obtém o BackupItem protegido e desabilita a proteção automática.

### Exemplo 2

Desabilita o backup automático para um item protegido. (gerado automaticamente)
...
### -WorkloadType
Tipo de carga de trabalho do recurso. O valor com suporte atual é "MSSQL"
