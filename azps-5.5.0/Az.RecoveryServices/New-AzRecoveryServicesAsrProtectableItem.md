...
## Descrição
O **New-AzRecoveryServicesAsrProtectableItem** adiciona um novo item protegido à lista de itens protegidos descobertos em um contêiner de proteção dentro de uma malha ASR (aplicável somente para o tipo de malha V Ltd.
