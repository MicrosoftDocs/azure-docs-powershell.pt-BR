...
## Descrição
O cmdlet **Remove-AzRecoveryServicesAsrStorageClassificationMapping** exclui o mapeamento de classificação de armazenamento de Recuperação de Site do Azure especificado.
...
Inicia a exclusão do mapeamento de classificação de armazenamento especificado e retorna o trabalho ASR usado para controlar a operação.
