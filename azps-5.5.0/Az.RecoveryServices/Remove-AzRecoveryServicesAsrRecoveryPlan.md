...
## Sinopse
Exclui o plano de recuperação ASR especificado do cofre dos Serviços de Recuperação.
...
## Descrição
O cmdlet **Remove-AzRecoveryServicesAsrRecoveryPlan** exclui o plano de recuperação especificado do cofre dos Serviços de Recuperação.
...
Inicia a exclusão do plano de recuperação especificado e retorna o trabalho ASR usado para controlar a operação.
...
### -InputObject
O objeto de entrada para o cmdlet: o objeto do plano de recuperação ASR correspondente ao plano de recuperação a ser excluído.
...
### -Nome
Especifica o nome do plano de recuperação a ser excluído.
