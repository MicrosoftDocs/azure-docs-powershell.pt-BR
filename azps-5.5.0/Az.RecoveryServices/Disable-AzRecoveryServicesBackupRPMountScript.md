...
## Sinopse
Desaperda todos os arquivos do ponto de recuperação.
...
## Descrição
O Disable-AzRecoveryServicesBackupRPMountScript cmdlet de recuperação desaconfia os arquivos do ponto de recuperação que foram montados anteriormente usando o cmdlet Get-AzRecoveryServicesBackupRPMountScript de recuperação.
...
Desaperda todos os arquivos do ponto de recuperação. (gerado automaticamente)
...
### -PassThru
Retornar o ponto de recuperação.
