...
## Descrição
O cmdlet **Add-AzRecoveryServicesAsrReplicationProtectedItemDisk** adiciona o disco para proteção para uma máquina virtual do azure já protegida.
...
Inicie a operação para adicionar configuração de disco especificada para proteção.
...
Inicie a operação para adicionar configuração de disco especificada para proteção. Item protegido de replicação de entrada de piping.

## Parâmetros

### -AzureToAzureDiskReplicationConfiguration
Especifica a configuração de disco a ser usada para proteção em disco do Azure para cenário de recuperação de desastres do Azure.
...
### -InputObject
O objeto de entrada para o cmdlet: o objeto de item protegido de replicação ASR correspondente ao qual o novo disco deve ser protegido.
