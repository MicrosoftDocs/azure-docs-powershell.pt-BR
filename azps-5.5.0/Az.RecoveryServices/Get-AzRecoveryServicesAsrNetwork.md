...
## Descrição
O cmdlet **Get-AzRecoveryServicesAsrNetwork obtém** informações sobre redes de Recuperação de Sites do Azure para o cofre atual de Recuperação de Site do Azure.
