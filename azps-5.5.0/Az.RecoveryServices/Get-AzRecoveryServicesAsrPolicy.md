...
## Descrição
O cmdlet **Get-AzRecoveryServicesAsrPolicy obtém** a lista de políticas de replicação configuradas de Recuperação de Site do Azure ou uma política de replicação específica por nome.
...
Retorna a política de replicação com nome.
