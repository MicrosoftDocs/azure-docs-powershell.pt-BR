...
## Sinopse
Atualizar detalhes da descoberta de um vCenter registrado.
...
## Descrição
O cmdlet **Update-AzRecoveryServicesAsrvCenter** atualiza os detalhes de descoberta de um vCenter registrado.
