...
## Sinopse
Cria um objeto de mapeamento de disco para que discos de máquina virtuais vMWare sejam replicados.
...
## Descrição
Cria um objeto de mapeamento de disco que mapeia um disco de máquina virtual vMWare para a conta de armazenamento em cache e o tipo de disco gerenciado de destino (região de recuperação) a ser usado para replicar o disco.
...
Crie um objeto de mapeamento de disco para que discos de máquina virtuais vMWare sejam replicados. Usado durante a proteção de habilitar para o computador vMWare.
...
### -DiskId
Especifique a DiskId do disco ao qual esse mapeamento corresponde.
...
### -DiskType
Especifica o tipo de disco Recuperação.
