...
## Descrição
O Get-AzRecoveryServicesBackupRPMountScript cmdlet baixa um script que monta os volumes do ponto de recuperação no computador onde ele é executado.

## Exemplos

### Exemplo 1: Monte um ponto de recuperação
```powershell
...
### -Caminho
Local onde o arquivo deve ser baixado no caso de recuperação de arquivos. Se -Caminho não for fornecido, o arquivo de script será baixado no diretório atual.
...
### Microsoft.Azure.Commands.RecoveryServices.Backup.Cmdlets.Models.MOUNTScriptDetails
