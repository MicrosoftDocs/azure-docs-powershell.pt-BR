...
## Sinopse
Cria um objeto de mapeamento de disco para que discos de máquina virtuais do Azure sejam replicados.
...
## Descrição
Cria um objeto de mapeamento de disco que mapeia um disco de máquina virtual do Azure para a conta de armazenamento em cache e a conta de armazenamento de destino (região de recuperação) a ser usada para replicar o disco.
...
Crie um objeto de mapeamento de disco para que discos de máquina virtual do Azure sejam replicados. Usado durante o Azure para HabilitarDr do Azure e proteger a operação.
...
Crie um objeto de mapeamento de disco gerenciado para que discos de máquina virtuais do Azure sejam replicados. Usado durante o Azure para HabilitarDr do Azure e proteger a operação.
...
Crie um objeto de mapeamento de disco gerenciado com configurações de criptografia de uma passagem para discos de máquina virtuais do Azure serem replicados. Usado durante o Azure para HabilitarDr do Azure e proteger a operação.
...
Crie um objeto de mapeamento de disco gerenciado com a ID de conjunto de criptografia de disco de destino para que os discos de máquina virtuais do Azure sejam replicados. Usado durante o Azure para HabilitarDr do Azure e proteger a operação.
...
Especifica a URL secreta da criptografia de disco.
...
Especifica a ID arm do cofre de criptografia de disco.
...
### -KeyEncryptionKeyUrl
Especifica a URL de criptografia da chave.
...
Especifica a ID arm do cofre de criptografia de chave de criptografia.
...
Especifica a ID da conta de armazenamento do Azure para a ser replicada.
...
### -HighdUri
Especifique o URI DE ACORDO do disco ao qual esse mapeamento corresponde.
