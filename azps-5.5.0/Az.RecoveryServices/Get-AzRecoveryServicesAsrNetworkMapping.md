...
## Descrição
O cmdlet **Get-AzRecoveryServicesAsrNetWorkMapping** obtém informações sobre mapeamentos de rede de Recuperação de Site do Azure para o cofre dos Serviços de Recuperação.
...
Obtém o mapeamento de redes com o nome fornecido na malha de recuperação de site do azure especificada.
