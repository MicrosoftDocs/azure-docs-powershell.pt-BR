...
## Descrição
Use **Remove-AzServiceFabricClusterCertificate** para remover um certificado de cluster do cluster, desde que haja outro certificado válido que já está em uso no cluster.
...
Esse comando remove o certificado com a impressão de miniatura 5F3660C715EBBDA31DB1FFDCF508302348DE8E7A de ser usado para segurança de cluster.
...
### -Impressão digital
Especifique a impressão digital de cluster que deve ser removida.
