...
## Descrição
Remova o tipo de nó ou nós específicos dentro do tipo de nó. Se o nome do grupo -NodeName for usado, somente os nós especificados serão removidos.
...
Remover o tipo de nó, com canos.
...
Remover 2 nós do tipo de nó, com canos.
...
Use com cuidado, pois isso pode causar perda de dados se cargas de trabalho estado em execução nos nós ou pode trazer o cluster para baixo se não houver nós de seed suficientes após a opearion.
