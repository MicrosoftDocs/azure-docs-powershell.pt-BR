...
## Descrição
Use **Remove-AzServiceFabricClientCertificate** para remover um(s) certificado(s) cliente(s) ou (s) nome(s) de certificado (s) de ser usado para autenticação de cliente para o cluster.
...
Esse comando removerá o certificado do cliente com a impressão miniatura '5F3660C715EBBDA31DB1FFDCF508302348DE8E7A' do cluster.
