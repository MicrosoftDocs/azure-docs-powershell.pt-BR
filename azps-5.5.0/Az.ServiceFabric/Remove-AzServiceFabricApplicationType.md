...
## Sinopse
Remover malha de serviço de um tipo de aplicativo do cluster. Isso removerá todas as versões do tipo sob esse recurso. Só é compatível com tipos de aplicativo implantados pelo ARM.
...
## Descrição
Esse cmdlet remove um formulário de tipo de aplicativo do cluster e remove toda a versão do tipo sob esse recurso, mas todos os aplicativos abaixo dele devem ser removidos antes de executar esse comando.
...
Este exemplo removerá o tipo de aplicativo "testAppType" e toda a versão abaixo dele. Se houver aplicativos criados com esse tipo, o comando lançará uma exceção.
...
### -ResourceId
Arm ResourceId do tipo de aplicativo.
