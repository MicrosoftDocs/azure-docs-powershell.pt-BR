...
Atualize o nome dns e a porta de conexão do cliente para o cluster.
...
Atualize o nome dns e a porta de conexão do cliente para o cluster, com canos.
...
Porta usada para conexões de cliente com o cluster. Padrão: 19000.
...
### -CodeVersion
Versão de código de cluster. Use somente se o modo de atualização for Manual.
...
Porta usada para conexões http com o cluster. Padrão: 19080.
...
### -ResourceId
ID do recurso Cluster Gerenciado
...
### -UpgradeMode
Modo de atualização de versão de código de cluster. Automático ou Manual.
