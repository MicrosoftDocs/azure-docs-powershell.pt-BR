...
## Descrição
Use **Set-AzServiceFabricUpgradeType** para definir o tipo de atualização como automático ou manual com uma versão de código de Malha de Serviço específica.
...
Esse comando definirá o modo de atualização de cluster como automático.
