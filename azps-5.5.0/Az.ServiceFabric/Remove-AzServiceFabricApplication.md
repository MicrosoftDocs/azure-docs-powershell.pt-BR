...
## Sinopse
Remover um aplicativo do cluster. Isso removerá todos os serviços sob o aplicativo. Só é compatível com aplicativos implantados pelo ARM.
...
## Descrição
Este cmdlet remove um formulário de aplicativo do cluster. Isso removerá todos os serviços, se for o caso, sob o recurso de aplicativo.
