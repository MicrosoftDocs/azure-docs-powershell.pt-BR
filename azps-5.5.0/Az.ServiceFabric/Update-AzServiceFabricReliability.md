...
## Descrição
Use **Update-AzServiceFabricReliability** para atualizar a confiabilidade do tipo de nó principal em um cluster.
...
Esse comando altera o nível de confiabilidade do tipo de nó principal para prata.

### Exemplo 2

Atualize o nível de confiabilidade do tipo de nó principal em um cluster. (gerado automaticamente)
...
### -AutoAddNode
Adicionar contagem de nó automaticamente ao alterar a confiabilidade
