...
## Descrição
Adicione um segredo de certificado ao tipo de nó. O segredo deve ser armazenado em um Cofre de Teclas do Azure. Para saber mais sobre o Cofre de Teclas, confira o que é o Cofre de Teclas do Azure? (https://azure.microsoft.com/en-us/documentation/articles/key-vault-whatis/). Para obter mais informações sobre os cmdlets, consulte Cmdlets do Cofre de Chave do Azure ( na biblioteca do Microsoft Developer Network ou no https://msdn.microsoft.com/library/azure/dn868052.aspx) cmdlet Set-AzKeyVaultSecret usuário.
...
Essa vírgula adiciona um segredo de certificado do keyvault e do identificador secreto especificado.
...
Essa vírgula adiciona um segredo de certificado do keyvault e do identificador secreto especificado, com piping.
...
### -CertificateUrl
Esta é a URL de um certificado que foi carregado para o Cofre de Chaves como um segredo.
Para adicionar um segredo ao Cofre de Teclas, confira Adicionar uma chave ou \[ um segredo ao cofre de chaves ( \] https://docs.microsoft.com/azure/key-vault/key-vault-get-started/#add) .
Nesse caso, seu certificado precisa ser a codificação Base64 do seguinte Objeto JSON, codificado em UTF-8: \<br\> \<br\> { \<br\> "dados":" \<Base64-encoded-certificate\> ", \<br\> "dataType":"pfx", \<br\> "password":" \<pfx-file-password\> " \<br\> }/
