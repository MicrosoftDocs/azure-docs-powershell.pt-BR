...
## Sinopse
Obter detalhes do serviço de Malha de Serviço sob o aplicativo e o cluster especificados. Só é compatível com serviços implantados pelo ARM.
...
## Descrição
Este cmdlet receberá os detalhes do serviço no aplicativo e no cluster especificados.
