...
## Descrição
Use **Remove-AzServiceFabricNode** para remover nós de um tipo de nó específico de um cluster. A remoção só será possível se atender às métricas de saúde do cluster.
...
Esse comando removerá dois nós do NodeType 'nt1'.
