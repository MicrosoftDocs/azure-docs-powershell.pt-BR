...
## Sinopse
Exclua um certificado do Serviço de Provisionamento de Dispositivo do Hub do Azure IoT.
...
Exclua "meucertificar" em um serviço de provisionamento de dispositivo do Hub do Azure IoT.
