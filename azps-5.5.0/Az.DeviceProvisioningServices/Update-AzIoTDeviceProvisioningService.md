...
## Sinopse
Atualize um serviço de provisionamento de dispositivo do Hub IoT do Azure.
...
Atualize a Política de Alocação para "GeoLatency" de um serviço de provisionamento de dispositivos do Azure IoT Hub "myiotdps".
...
Adicione marcas a um serviço de provisionamento de dispositivos do Azure IoT Hub "myiotdps".
...
Exclua a marca e adicione novas marcas a um serviço de provisionamento de dispositivos do Azure IoT Hub "myiotdps" usando pipeline.

## Parâmetros

### -AllocationPolicy
Política de Alocação de Serviço de Provisionamento de Dispositivo IoT
...
### -Redefinir
Redefinir marcas de serviço de provisionamento de dispositivo IoT
...
### -Tag
Conjunto de marca de serviço de provisionamento de dispositivo IoT
