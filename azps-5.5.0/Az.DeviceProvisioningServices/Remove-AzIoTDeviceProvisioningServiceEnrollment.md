...
## Descrição
Exclua um registro de dispositivo em um Serviço de Provisionamento de Dispositivo do Hub do Azure IoT.
...
Exclua um registro de registro especificado.
...
Exclua todos os registros de registro.
