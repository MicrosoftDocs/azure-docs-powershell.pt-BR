...
## Sinopse
Criar/atualizar um certificado do Serviço de Provisionamento de Dispositivo do Hub IoT do Azure.
...
## Descrição
Carrega um novo certificado ou para substituir o certificado existente pelo mesmo nome.
Para uma explicação detalhada dos certificados de AC no Serviço de Provisionamento de Dispositivo do Hub do Azure IoT, consulte https://docs.microsoft.com/en-us/azure/iot-dps/how-to-verify-certificates .
...
Carregue um arquivo CER de certificado ca para um serviço de provisionamento de dispositivo do Hub do Azure IoT.
...
Atualiza um certificado ca em um serviço de provisionamento de dispositivo do hub IoT carregando um novo arquivo CER. 

## Parâmetros

### -Nomedo Certificado
Nome do certificado de serviço de provisionamento de dispositivo Iot
...
### -InputObject
Objeto de certificado de serviço de provisionamento de dispositivo IoT
...
### -Caminho
representação de base 64 do arquivo .cer de certificado X509 ou caminho de arquivo .pem
