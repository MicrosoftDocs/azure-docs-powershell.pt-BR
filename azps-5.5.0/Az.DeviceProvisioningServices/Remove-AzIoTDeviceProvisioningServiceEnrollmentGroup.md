...
## Sinopse
Excluir um grupo de registro de dispositivo.
...
## Descrição
Exclua um grupo de inscrição em um Serviço de Provisionamento de Dispositivo do Hub do Azure IoT.
...
Exclua um grupo de inscrição especificado.
