...
## Sinopse
Liste todos ou mostre detalhes dos hubs de IoT vinculados em um serviço de provisionamento de dispositivos do Hub do Azure IoT.
...
Liste todos os hubs de IoT vinculados em "myiotdps".
...
Mostrar detalhes do hub IoT vinculado "myiothub1" em um serviço de provisionamento de dispositivos do Hub do Azure IoT.
