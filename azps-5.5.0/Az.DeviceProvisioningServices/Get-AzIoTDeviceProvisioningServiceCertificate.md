...
## Sinopse
Lista todos os certificados ou um certificado específico contido em um Serviço de Provisionamento de Dispositivo do Hub do Azure IoT.
...
Mostrar detalhes sobre "mycertificate" em um serviço de provisionamento de dispositivos do Hub do Azure IoT.
