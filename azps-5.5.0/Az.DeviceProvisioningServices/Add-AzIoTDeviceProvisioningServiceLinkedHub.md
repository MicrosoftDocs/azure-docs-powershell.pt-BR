...
## Sinopse
Hub de IoT vinculado a um serviço de provisionamento de dispositivos do Azure IoT Hub.
...
Hub de IoT vinculado a um serviço de provisionamento de dispositivos do Hub IoT do Azure com AllocationWeight e ApplyAllocationPolicy.
...
### -ApplyAllocationPolicy
Um boolano indicando se você deve aplicar a política de alocação ao Hub de IoT
