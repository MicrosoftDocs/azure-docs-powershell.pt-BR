...
## Sinopse
Gere um código de verificação para um certificado do Serviço de Provisionamento de Dispositivo do Hub do Azure IoT.
...
## Descrição
Esse código de verificação é usado para concluir a prova de etapa de confirmação de um certificado. Use este código de verificação como o CN de um novo certificado assinado com a chave privada de certificados raiz.
...
Gere um código de verificação para "mycertificate" usando o pipeline.
