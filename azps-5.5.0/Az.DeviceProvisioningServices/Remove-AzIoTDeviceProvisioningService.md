...
## Sinopse
Exclua um serviço de provisionamento de dispositivo do Hub IoT do Azure.
...
Exclua um serviço de provisionamento de dispositivos do Hub IoT do Azure 'myiotdps'.
...
Exclua um serviço de provisionamento de dispositivos do Hub do Azure IoT "myiotdps" usando pipeline.
