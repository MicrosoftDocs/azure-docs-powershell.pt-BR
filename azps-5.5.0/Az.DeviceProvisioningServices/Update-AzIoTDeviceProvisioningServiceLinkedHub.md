...
## Sinopse
Atualize um hub de IoT vinculado em um serviço de provisionamento de dispositivos do Hub do Azure IoT.
...
Atualize o hub de IoT vinculado "myiothub.azure-devices.net" em um serviço de provisionamento de dispositivos do Hub do Azure IoT.

## Parâmetros

### -AllocationWeight
Peso da alocação do Hub de IoT
...
Aplicar política de alocação ao Hub de IoT
