...
## Sinopse
Criar um registro de registro de dispositivo.
...
## Descrição
Crie um registro de dispositivo em um Serviço de Provisionamento de Dispositivo do Hub do Azure IoT.
...
Crie um registro com o teste de TPM.
...
### -EndorsementKey
Chave de endosso de TPM para um dispositivo TPM.
