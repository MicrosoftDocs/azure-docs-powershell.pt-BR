...
## Sinopse
Atualizar um grupo de registro de dispositivo.
...
## Descrição
Atualizar um grupo de inscrição em um Serviço de Provisionamento de Dispositivo do Hub do Azure IoT.
...
Atualize a política de alocação e os hubs de um grupo de inscrição.
...
Atualize o estado inicial do grupo de registro.
