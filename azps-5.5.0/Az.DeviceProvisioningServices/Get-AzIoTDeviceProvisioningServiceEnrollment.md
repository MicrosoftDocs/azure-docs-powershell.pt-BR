...
## Descrição
Obter detalhes de registro do dispositivo ou listar o registro de dispositivos em um Serviço de Provisionamento de Dispositivo do Hub do Azure IoT.
...
Obter detalhes de registro do dispositivo em um Serviço de Provisionamento de Dispositivo do Hub do Azure IoT.
...
Liste os registro de dispositivos em um Serviço de Provisionamento de Dispositivo do Hub do Azure IoT.
