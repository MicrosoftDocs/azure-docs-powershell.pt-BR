...
## Descrição
Atualizar um registro de dispositivo em um Serviço de Provisionamento de Dispositivo do Hub do Azure IoT.
...
Atualize a política de alocação e os hubs para um registro de registro.
...
Atualize o estado inicial do registro.
