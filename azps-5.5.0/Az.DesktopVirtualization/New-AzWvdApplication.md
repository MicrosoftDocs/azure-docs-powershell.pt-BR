...
### Exemplo 1: Criar um aplicativo virtual da área de trabalho do Windows
```powershell
...
Esse comando cria um Aplicativo virtual da área de trabalho do Windows em um grupo de aplicativos.

## Parâmetros

### -AppAlias
Alias do Aplicativo no item do menu Iniciar
