...
### Exemplo 1: Criar um HostPool da Área de Trabalho Virtual do Windows por nome
```powershell
...
Esse comando cria um HostPool da Área de Trabalho Virtual do Windows em um Grupo de Recursos.
...
### -DesktopAppGroupName
Nome do grupo aplicativo da área de trabalho
...
O tipo de grupo de aplicativos preferido, padrão para o Grupo de Aplicativos da Área de Trabalho
...
### -SsoadfsAuthority
URL para o servidor ADFS do cliente para assinar certificados WVD SSO.
...
### -SsoClientId
ClientId para a Parte Subjacente registrada usada para emitir certificados SSO WVD.
...
### -SsoClientSecáticaKeyVaultPath
Caminho para o Azure KeyVault armazenar o segredo usado para comunicação com o ADFS.
...
### -SsoContext
Caminho para o keyvault contendo segredo de ssoContext.
...
### -VMTemplate
Modelo VM para configuração de sessionhosts dentro do hostpool.
