...
### Exemplo 1: Atualizar um pacote MSIX 
```powershell
...
Este comando atualiza um Pacote MSIX em um HostPool.
...
### -DisplayName
Nome de exibição do pacote MSIX.
...
### -FullName
O nome completo do pacote de versão específico do pacote MSIX dentro do hostpool especificado
...
### -IsActive
Definir uma versão do pacote para ser ativa em hostpool.
