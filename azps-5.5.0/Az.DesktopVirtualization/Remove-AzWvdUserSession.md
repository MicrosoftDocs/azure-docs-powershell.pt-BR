...
### Exemplo 1: Excluir uma UserSession da Área de Trabalho Virtual do Windows por nome
```powershell
...
Esse comando exclui uma UserSessão da Área de Trabalho Virtual do Windows em um Host de Sessão.
...
### -Forçar
Forçar o sinalizador a fazer logon do usuário.
...
### -ID
O nome da sessão do usuário dentro do host de sessão especificado
