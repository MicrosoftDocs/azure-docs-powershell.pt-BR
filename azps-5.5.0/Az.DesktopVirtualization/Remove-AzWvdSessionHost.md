...
### Exemplo 1: Excluir um Windows Virtual Desktop SessionHost por nome
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Esse comando exclui um Windows Virtual Desktop SessionHost em um Pool de Host.
...
### -Forçar
Forçar o sinalizador para forçar a exclusão de sessionHost mesmo quando a exclusão de usuário existir.
