...
### Exemplo 1: Registrar um Grupo de Aplicativos da Área de Trabalho Virtual do Windows
```powershell
...
Esse comando registra um Grupo de Aplicativos da Área de Trabalho Virtual do Windows em um Espaço de Trabalho.
