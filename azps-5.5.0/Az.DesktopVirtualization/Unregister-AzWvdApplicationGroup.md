...
### Exemplo 1: Não registro em um Grupo de Aplicativos da Área de Trabalho Virtual do Windows
```powershell
...
Este comando desasterra um Grupo de Aplicativos da Área de Trabalho Virtual do Windows para um Espaço de Trabalho.
