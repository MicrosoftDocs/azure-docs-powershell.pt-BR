...
### Exemplo 1: Obter um Grupo de Aplicativos da Área de Trabalho Virtual do Windows por nome
```powershell
...
Esse comando obtém um Grupo de Aplicativos da Área de Trabalho Virtual do Windows em um Grupo de Recursos.

### Exemplo 2: Listar Grupos de Aplicativos da Área de Trabalho Virtual do Windows
```powershell
...
Esse comando lista um Grupo de Aplicativos da Área de Trabalho Virtual do Windows em um Grupo de Recursos.
