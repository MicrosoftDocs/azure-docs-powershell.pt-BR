...
### Exemplo 1: Obter uma UserSession da Área de Trabalho Virtual do Windows por nome
```powershell
...
Esse comando obtém uma UserSession da Área de Trabalho Virtual do Windows em um Host de Sessão.
...
Este comando lista as UserSessionsão da Área de Trabalho Virtual do Windows em um Host de Sessão.

### Exemplo 3: Listar UserSessions da Área de Trabalho Virtual do Windows no pool de host
```powershell
...
Esse comando lista as UserSessionsão da Área de Trabalho Virtual do Windows em um Host de Sessão em um pool de host.
