...
### Exemplo 1: Criar um Grupo de Aplicativos da Área de Trabalho Virtual do Windows por nome
```powershell
...
Esse comando cria um Grupo de Aplicativos da Área de Trabalho Virtual do Windows em um Grupo de Recursos.

### Exemplo 2: Criar um Grupo de Aplicativos da Área de Trabalho Virtual do Windows por nome
```powershell
PS C:\> New-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName `
                            -Name ApplicationGroupName `
                            -Location 'eastus' `
...
Tipo de Recurso do ApplicationGroup.
...
### -Nome Amigável
Nome amigável do ApplicationGroup.
...
### -HostPoolArmPath
Caminho de armPool do ApplicationGroup.
