...
### Exemplo 1: Atualizar um Espaço de Trabalho Virtual da Área de Trabalho do Windows por nome
```powershell
...
Este comando atualiza um Espaço de Trabalho virtual da área de trabalho do Windows em um Grupo de Recursos.

## Parâmetros

### -ApplicationGroupReference
Lista de links de grupo de aplicativos.
