...
### Exemplo 1: Excluir um Espaço de Trabalho Virtual da Área de Trabalho do Windows por nome
```powershell
PS C:\> Remove-AzWvdWorkspace -ResourceGroupName ResourceGroupName -Name WorkspaceName
```

Esse comando exclui um Espaço de Trabalho Virtual da Área de Trabalho do Windows em um Grupo de Recursos.
