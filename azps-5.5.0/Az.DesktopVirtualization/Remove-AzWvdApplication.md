...
### Exemplo 1: excluir um aplicativo virtual da área de trabalho do Windows por nome
```powershell
PS C:\> Remove-AzWvdApplication -ResourceGroupName ResourceGroupName -ApplicationGroupName ApplicationGroupName -Name ApplicationName
```

Esse comando exclui um Aplicativo virtual da área de trabalho do Windows em um grupo de aplicativos.
