...
## Descrição
O cmdlet **New-AzDeploymentManagerService** cria um serviço sob uma topologia de serviço e retorna um objeto que representa esse serviço.
Especifique o serviço pelo nome, topologia do serviço em que ele está e o nome do grupo de recursos. 

O cmdlet retorna um objeto Service. Você pode modificar esse objeto localmente e aplicar alterações ao serviço usando o cmdlet Set-AzDeploymentManagerService usuário.
...
Cria um novo serviço com o nome ContosoService1 sob topologia de serviço ContosoServiceTopology no Grupo de Recursos ContosoResourceGroup, no local Central dos EUA. A propriedade TargetLocation indica que o serviço ContosoService1 deve ser implantado na região leste dos EUA na assinatura especificada.
...
### -Local
A localização do recurso de serviço.
...
### -ServiceTopologyName
O nome da topologia de serviço a que este serviço pertence.
...
### -TargetLocation
Determina o local para onde os recursos sob o serviço seriam implantados.
...
Determina a assinatura para a qual os recursos sob o serviço seriam implantados.
