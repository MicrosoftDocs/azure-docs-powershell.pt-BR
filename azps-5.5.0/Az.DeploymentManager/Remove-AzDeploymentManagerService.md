...
Esse comando exclui um serviço chamado ContosoService1 em uma topologia de serviço chamada ContosoServiceTopology no Grupo ContosoResource.
...
Esse comando exclui um serviço cujo nome, nome de topologia de serviço e Grupo de Recursos corresponderem às propriedades Nome, ServiceTopologyName e ResourceGroupName do $serviceObject, respectivamente.
