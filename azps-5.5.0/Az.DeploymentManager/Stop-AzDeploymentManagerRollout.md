...
## Descrição
O cmdlet **Stop-AzDeploymentManagerRollout** interrompe uma versão em andamento e retorna um objeto que representa o estado atual da versão.
...
Esse comando interrompe uma adoção chamada ContosoRollout no Grupo ContosoResource. 

### Exemplo 2: Parar uma distribuição usando o identificador de recurso
```powershell
...
### Exemplo 3: Interromper uma adoção usando o objeto de adoção.
```powershell
PS C:\> Get-AzDeploymentManagerRollout -InputObject $rolloutObject
```

Esse comando interrompe uma distribuição cujo nome e Grupo de Recursos corresponderem às propriedades Nome e NomeDoGrupo de Recursos do $rolloutObject, respectivamente.
