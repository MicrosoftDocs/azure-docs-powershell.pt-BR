...
Esse comando exclui uma unidade de serviço chamada ContosoService1Storage sob um serviço ContosoService1 em uma topologia de serviço chamada ContosoServiceTopology no Grupo ContosoResource.

### Exemplo 2: Excluir uma unidade de serviço usando o identificador de recurso.
```powershell
...
### Exemplo 3: Excluir uma unidade de serviço usando o objeto da unidade de serviço.
```powershell
PS C:\> Remove-AzDeploymentManagerServiceUnit -InputObject $serviceUnitObject
```

Esse comando exclui uma unidade de serviço cujo nome, nome do serviço, nome da topologia do serviço e Grupo de Recursos corresponderem às propriedades Nome, ServiceName, ServiceTopologyName e ResourceGroupName do $serviceUnitObject, respectivamente.
