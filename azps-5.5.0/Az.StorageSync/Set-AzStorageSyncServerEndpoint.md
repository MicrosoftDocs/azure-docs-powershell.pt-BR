...
## Descrição
Esse comando permite alterações nos parâmetros ajustáveis de um ponto de extremidade do servidor. Por exemplo, as políticas de camada de nuvem e de camadas de nuvem podem ser alteradas a qualquer momento. Vários aspectos de um ponto de extremidade do servidor, como o caminho local, não podem ser alterados depois que o ponto de extremidade do servidor foi criado.
