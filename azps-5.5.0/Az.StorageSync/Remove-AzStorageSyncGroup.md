...
## Descrição
Esse comando excluirá o grupo de sincronização especificado. Um grupo de sincronização só pode ser removido quando todos os pontos de extremidade contidos são excluídos primeiro.
...
Esse comando removerá o grupo de sincronização.
