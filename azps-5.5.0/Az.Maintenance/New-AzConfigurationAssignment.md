...
## Sinopse
Configuração de registro do recurso.
...
## Descrição
Registrar a configuração de manutenção do recurso.
...
Registrar configuração de manutenção para host dedicado.
...
O nome da atribuição de configuração deve corresponder ao NomedaConfiguração manutenção.
...
A Configuração de Manutenção totalmente qualificada.
