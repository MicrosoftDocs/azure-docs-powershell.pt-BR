...
## Descrição
O cmdlet **Set-AzMarketplaceTerms** salva o objeto de termos para determinada id do publisher(Publisher), id da oferta(Produto) e id do plano(Nome) da tupla.

## Exemplos

### Exemplo 1
Obter o contrato do editor do marketplace
...
### Exemplo 2
De definir o contrato do editor como "Aceitar". Obter o valor do parâmetro 'Termos' do cmdlet 'Get-AzMarketplaceTerms'
...
### -Aceitar
Passe isso para aceitar os termos legais.
...
### -Nome
Cadeia de caracteres identificador de plano da imagem que está sendo implantada.
...
### -Produto
Oferecer cadeia de caracteres identificador da imagem que está sendo implantada.
...
### -Publisher
Cadeia de caracteres identificador do Publisher da imagem que está sendo implantada.
...
### -Rejeitar
Passe isso para rejeitar os termos legais.
