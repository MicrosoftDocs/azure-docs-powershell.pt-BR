...
## Descrição
O Remove-AzSqlVMGroup cmdlet exclui um grupo de máquinas virtuais sql.
...
Exclui o grupo de máquina virtual SQL do Azure "grupo de teste" no grupo de recursos ResourceGroup01.
...
### -PassThru
Especifica se o recurso excluído será saída no final da execução do cmdlet.
