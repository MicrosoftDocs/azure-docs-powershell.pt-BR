...
## Descrição
O New-AzSqlVMGroup cmdlet cria um grupo de máquinas virtuais SQL do Azure.
...
Cria um novo grupo de máquina virtual SQL do Azure com vm de grupo de teste no grupo de recursos ResourceGroup01.
...
### -FileSharePath
Caminho opcional para a prova de compartilhamento de arquivos
...
### -Local
Local do grupo de máquinas virtuais SQL.
...
### -Oferta
Oferta de grupo de máquinas virtuais SQL.
...
### -SKU
Tipo de edição de grupo de máquina virtual SQL.
...
### -SqlServiceAccount
Nome sob o qual o serviço SQL será executado em todas as máquinas virtuais SQL participantes no cluster
...
Chave primária da conta de armazenamento de informações
...
### -Tag
As marcas a associar ao grupo de máquinas virtuais SQL.
