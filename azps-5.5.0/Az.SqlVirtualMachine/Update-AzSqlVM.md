...
## Descrição
O Update-AzSqlVM cmdlet atualiza uma máquina virtual sql.
...
### -LicenseType
Tipo de licença de computador virtual SQL.
...
### -Oferta
Oferta de computador virtual SQL.
...
### -SKU
Tipo de edição de computador virtual SQL.
...
### -SqlManagementType
Tipo de gerenciamento de máquina virtual SQL.
...
### -Tag
As marcas a associar à máquina virtual SQL
