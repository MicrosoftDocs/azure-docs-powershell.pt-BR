...
## Descrição
O New-AzSqlVM cmdlet cria uma máquina virtual SQL do Azure.
...
Cria uma nova máquina virtual SQL do Azure com vm de nome no grupo de recursos ResourceGroup01 
...
### -Local
Local do computador virtual SQL.
