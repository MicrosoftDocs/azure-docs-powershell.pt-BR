...
## Descrição
O Set-AzSqlVMConfigGroup cmdlet definiu as informações necessárias para ingressar em um grupo de máquinas virtuais sql para uma configuração de computador virtual sql.
...
Atualize as informações de grupo de uma configuração de computador virtual sql.

## Parâmetros

### -ClusterBootstrapAccountPassword
Senha da conta bootstrap de cluster
...
### -SqlVM
A configuração da máquina virtual SQL à qual a associação a um grupo será adicionada
...
### -SqlVMGroup
O grupo do sql virtual machine fará parte
