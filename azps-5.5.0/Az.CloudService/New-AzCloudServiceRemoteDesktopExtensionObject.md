...
Esse comando cria um objeto de extensão de área de trabalho remota que é usado para criar ou atualizar um serviço de nuvem.
...
### -Expiração
Expiração da Extensão de Área de Trabalho Remota.
...
### -TypeHandlerVersion
Versão da Extensão de Área de Trabalho Remota.
