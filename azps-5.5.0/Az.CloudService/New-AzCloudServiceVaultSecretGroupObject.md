...
## Sinopse
Criar um objeto na memória para o Grupo Secreto do Cofre
...
### Exemplo 1: Criar objeto de grupo de cofre secreto
```powershell
...
Esse comando cria um objeto de grupo secreto do cofre que é usado para criar ou atualizar um serviço de nuvem.
...
### Microsoft.Azure.PowerShell.Cmdlets.CloudService.Models.Api20201001Preview.CloudServiceVaultSecgroup
