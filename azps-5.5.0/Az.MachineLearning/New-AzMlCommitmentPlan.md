...
Se houver um plano de compromisso com o mesmo nome no grupo de recursos, a chamada atuará como uma operação de atualização e o plano de compromisso existente será substituído.
...
Cria um novo plano de compromisso do Azure Machine Learning chamado "MyCommitmentPlanName" no grupo "MyResourceGroup" e região do Centro Sul dos EUA. Neste exemplo, o Teste/Padrão de Desenvolvimento da SKU é usado, o que significa que os recursos fornecidos pelo plano de compromisso serão definidos pelos limites de Teste de Desenvolvimento/Padrão. A SkuCapacity neste exemplo é 1, o que significa que o custo do plano será 1x o custo do DevTest, e os recursos que o plano contém serão 1x o que o DevTest fornece.
...
### -Local
A localização do plano de compromisso ML do Azure.
...
### -SkuCapacity
A capacidade da SKU de usar ao provisionar o plano de compromisso ML do Azure.
...
### -SkuName
O nome da SKU a ser usada ao provisionar o plano de compromisso ML do Azure.
...
### -SkuTier
O nível da SKU a ser usado ao provisionar o plano de compromisso ML do Azure.
