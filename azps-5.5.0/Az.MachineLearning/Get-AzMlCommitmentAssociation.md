...
Dependendo dos parâmetros passados, o cmdlet retorna uma associação de compromisso específica ou um conjunto de associações de compromisso para o plano de compromisso especificado.
...
### -CommitmentPlanName
O nome do plano de compromisso ML do Azure, que tem uma ou mais associações de compromisso.
...
### -Nome
O nome da associação de compromisso ML do Azure.
...
### -ResourceGroupName
O nome do grupo de recursos da associação de compromisso ML do Azure.
