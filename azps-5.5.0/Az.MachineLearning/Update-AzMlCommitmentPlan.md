...
## Descrição
Atualiza um recurso de plano de compromisso existente. Observe que a maioria das propriedades do plano de compromisso é imutável e não pode ser modificada. As propriedades que podem ser modificadas incluem SKU (permitindo que você migre o plano de compromisso de uma SKU para outra) e Marcas.

## Exemplos

### Exemplo 1: Atualizar um plano de compromisso
```
...
### -Nome
O nome do plano de compromisso ML do Azure.
...
### -SkuCapacity
A capacidade da SKU de usar ao atualizar o plano de compromisso ML do Azure.
...
### -SkuName
O nome da SKU a ser usada ao atualizar o plano de compromisso ML do Azure.
...
### -SkuTier
O nível da SKU a ser usada ao atualizar o plano de compromisso ML do Azure.
...
### -Tag
Marcas para o recurso de plano de compromisso.
