...
## Descrição
Recupera informações do histórico de uso para um plano de compromisso especificado, incluindo os recursos usados e os recursos restantes dentro do plano.
