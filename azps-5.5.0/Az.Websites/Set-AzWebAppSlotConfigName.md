...
## Sinopse
Definir nomes de Configuração de Slot do Web App
...
Esse comando remove todas as configurações do aplicativo e cadeias de conexão para o Web App ContosoWebApp associado ao grupo de recursos Default-Web-WestUS

### Exemplo 2

Definir nomes de Configuração de Slot do Web App. (gerado automaticamente)
...
### -AppSettingNames
Matriz de Cadeia de Caracteres de Nomes de Configurações do Aplicativo
...
Matriz de Cadeia de Caracteres de Nomes de Cadeia de Conexão
...
Opção Remover Todos os Nomes de Configuração de Aplicativo
