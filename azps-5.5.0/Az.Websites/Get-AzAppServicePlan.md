...
## Sinopse
Obtém um plano de Serviço de Aplicativo do Azure no grupo de recursos especificado.
...
Esse comando obtém o plano serviço de aplicativo chamado ContosoASP que pertence ao grupo de recursos chamado Default-Web-WestUS.
...
Esse comando obtém todos os planos do Serviço de Aplicativo localizados na região "Oeste dos EUA".
