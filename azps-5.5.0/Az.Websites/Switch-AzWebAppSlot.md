...
## Sinopse
Trocar dois slots com um Web App
...
## Descrição
O **Switch-AzWebAppSlot** alterna dois slots associados a um Azure Web App.
...
Este comando alterna o slot "sourceslot" com "destinationslot" o Web App ContosoWebApp associado ao grupo de recursos Default-Web-WestUS
...
Trocar com a ação de visualização
