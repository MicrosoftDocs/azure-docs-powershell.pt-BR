...
Esse comando obtém o perfil de publicação no formato Ftp para Web App ContosoWebApp associado ao grupo de recursos Default-Web-WestUS e o armazena no arquivo de saída especificado.
...
Incluir os pontos de extremidade de recuperação de desastres, se verdadeiro
