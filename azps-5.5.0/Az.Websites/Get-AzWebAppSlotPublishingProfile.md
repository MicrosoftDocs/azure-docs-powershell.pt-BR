...
Esse comando obtém o perfil de publicação no formato Ftp para slot Slot001 pertencente ao Web App ContosoWebApp associado ao grupo de recursos Default-Web-WestUS e o armazena no arquivo de saída especificado.
