...
## Sinopse
New-AzWebAppContainerPSSession criará uma nova Sessão remota do PowerShell no contêiner do Windows especificado em um determinado site ou slot e determinado grupo de recursos
...
Isso criará uma nova Sessão remota do PowerShell no aplicativo contêiner do Windows ContosoASP e mostrará os processos que estão em execução no contêiner ContosoASP
