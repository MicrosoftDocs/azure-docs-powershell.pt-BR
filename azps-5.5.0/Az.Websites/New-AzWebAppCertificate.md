...
## Sinopse
Cria um certificado gerenciado pelo serviço de aplicativos para um Azure Web App. 
...
## Descrição
O **cmdlet New-AzWebAppCertificate** cria um Certificado Gerenciado pelo Serviço do Azure App
## Exemplos
...
Este comando cria um Certificado Gerenciado pelo Serviço de Aplicativo para determinado WebApp
...
Esse comando cria um Certificado Gerenciado pelo Serviço de Aplicativo e se vincula ao Slot webapp determinado.
...
Esse comando cria um Certificado Gerenciado pelo Serviço de Aplicativo e se vincula ao WebApp determinado.
...
### -Nomedo Host
Nomes de host personalizados associados ao aplicativo Web/slot.
...
### -SslState
Opção de estado SSL.
Use 'SniEnabled' ou 'IpBasedEnabled'.
A opção padrão é 'SniEnabled'.
