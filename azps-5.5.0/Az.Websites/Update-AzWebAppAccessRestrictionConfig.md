...
## Sinopse
Atualiza a herança da configuração Restiction do Access do site principal para o Site de SCM de um Azure Web App.
...
## Descrição
O cmdlet **Update-AzWebAppAccessRestrictionConfig** atualiza o configuração de Restrição do Access para um Azure Web App.

## Exemplos

### Exemplo 1: Atualizar um site de SCM do Aplicativo Web para usar as Restrições de Acesso do Site Principal

O exemplo a seguir atualiza um Web App chamado IpRule que pertence ao grupo de recursos MyResourceGroup para usar o config de restrição de acesso do site principal no site de scm.
...
### -InputObject
O objeto de configuração de restrição de acesso
