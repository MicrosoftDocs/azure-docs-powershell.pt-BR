...
## Descrição
O cmdlet **Get-AzWebAppBackupConfiguration** obtém a configuração de backup de um Azure Web App.
...
Esse comando obtém a configuração de backup do Web App chamada WebAppStandard que pertence ao grupo de recursos Default-Web-WestUS.
