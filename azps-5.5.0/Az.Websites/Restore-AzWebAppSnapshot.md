...
## Descrição
Restaura um instantâneo de aplicativo Web para o aplicativo Web. Restaurar um instantâneo substitui todos os arquivos em um aplicativo Web com os arquivos contidos no instantâneo. Para restaurar as configurações também, use o parâmetro de opção RecuperarConfiguração. Um instantâneo de um aplicativo Web pode ser restaurado para qualquer outro aplicativo Web na mesma assinatura.
...
Obtém o instantâneo mais recente de um aplicativo Web chamado "ContosoApp" com um slot chamado "Preparação" no grupo de recursos "Default-Web-WestUS". Restaura o instantâneo no slot "Restaurar" do aplicativo Web.
...
### -InputObject
O instantâneo do Azure Web App.
...
Recupere a configuração do aplicativo Web além de arquivos.
