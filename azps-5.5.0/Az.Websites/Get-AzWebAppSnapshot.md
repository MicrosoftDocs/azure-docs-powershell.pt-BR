...
## Sinopse
Disponibiliza os instantâneos para um aplicativo Web.
...
Obter os instantâneos de um aplicativo Web chamado "ContosoApp" com um slot chamado "Preparação" no grupo de recursos "Default-Web-WestUS"
...
### -UseDisasterRecovery
Leia os instantâneos de uma unidade de escala secundária.
