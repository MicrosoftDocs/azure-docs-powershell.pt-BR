...
## Descrição
O cmdlet **Reset-AzRedisCache** reinicia nós de uma instância do Cache do Azure Redis.

## Exemplos

### Exemplo 1: Reiniciar ambos os nós
```
...
### -RebootType
Especifica quais nós ou nó reiniciar.
...
### -ShardId
Especifica a ID do fragmento que este cmdlet reinicia para um cache premium com cluster habilitado.
