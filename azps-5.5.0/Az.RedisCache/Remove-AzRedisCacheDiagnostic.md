...
## Descrição
O cmdlet **Remove-AzRedisCacheDiagnostic** desabilita o diagnóstico em um Cache de Redis do Azure.
...
Esse comando desabilita o diagnóstico no Cache de Redis do Azure especificado.
Isso desabilita o diagnóstico de todos os Caches do Azure Redis na mesma região da assinatura.
