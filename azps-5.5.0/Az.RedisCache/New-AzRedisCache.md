...
## Descrição
O **cmdlet New-AzRedisCache** cria um Cache de Redis do Azure.

## Exemplos

### Exemplo 1: Criar um Cache de Redis
```
...
Esse comando cria um Cache de Redis.
...
### -Local
Especifica o local no qual criar um Cache de Redis.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos no qual criar o Cache de Redis.
...
- 13 GB
- 26 GB
- 53 GB O valor padrão é 1GB ou C1.
...
### -StaticIP
Especifica um endereço IP exclusivo na sub-rede do Cache de Redis.
Se você não especificar um valor para esse parâmetro, esse cmdlet escolherá um endereço IP na sub-rede.
