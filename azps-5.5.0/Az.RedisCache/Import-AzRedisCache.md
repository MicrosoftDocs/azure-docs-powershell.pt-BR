...
## Descrição
O cmdlet **Import-AzRedisCache** importa dados de blobs para o Cache Azure Redis.
...
Esse comando importa dados do blob especificado pela URL do SAS para o Cache do Azure Redis.
