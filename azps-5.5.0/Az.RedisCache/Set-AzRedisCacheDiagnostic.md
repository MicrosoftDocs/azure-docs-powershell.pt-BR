...
## Descrição
O cmdlet **Set-AzRedisCacheDiagnostic** habilita o diagnóstico para um Cache de Redis do Azure.

## Exemplos

### Exemplo 1: Habilitar diagnóstico
```
...
Esse comando habilita o diagnóstico para um cache do Azure Redis.
Esse comando habilita o diagnóstico ou atualiza a conta de armazenamento de todos os Caches do Azure Redis na mesma região da assinatura.
...
### -StorageAccountId
Especifica a ID de recurso da conta de armazenamento usada para armazenar os dados de diagnóstico.
