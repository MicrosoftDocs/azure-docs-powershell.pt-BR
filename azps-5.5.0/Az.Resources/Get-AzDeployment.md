...
Por padrão, **o Get-AzDeployment** obtém todas as implantações no escopo da assinatura atual.
...
Esse comando obtém a implantação DeployRoles01 no escopo da assinatura atual.
Você pode atribuir um nome a uma implantação ao criar essa implantação usando os cmdlets **New-AzDeployment.**
