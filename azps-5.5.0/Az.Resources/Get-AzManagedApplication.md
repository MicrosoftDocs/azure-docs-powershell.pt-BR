...
## Descrição
O **cmdlet Get-AzManagedApplication** obtém aplicativos gerenciados

## Exemplos

### Exemplo 1: Obter todos os aplicativos gerenciados em um grupo de recursos
```
PS C:\>Get-AzManagedApplication -ResourceGroupName "MyRG"
```

Esse comando obtém aplicativos gerenciados no grupo de recursos "MyRG"

### Exemplo 2: Obter todos os aplicativos gerenciados
```
PS C:\>Get-AzManagedApplication
```

Este comando obterá todos os aplicativos gerenciados sob a assinatura atual
