...
## Descrição
O cmdlet **Update-AzManagementGroup** atualiza o **ParentId** ou **DisplayName** de um Grupo de Gerenciamento.

## Exemplos

### Exemplo 1: Atualizar o Nome de Exibição de um Grupo de Gerenciamento
```
...
### Exemplo 2: Atualizar o pai de um grupo de gerenciamento
```
...
### Exemplo 3: Atualizar um Grupo de Gerenciamento por meio de um objeto PSManagementGroup
```
...
### Exemplo 4: Atualizar o pai de um Grupo de Gerenciamento usando o ParentObject
```
...
### -DisplayName
Nome de Exibição do grupo de gerenciamento
...
### -InputObject
Objeto de Entrada da chamada Obter
...
### -ParentId
ID do responsável do grupo de gerenciamento
