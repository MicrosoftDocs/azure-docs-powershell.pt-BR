...
Criação de um novo grupo com `DisplayName` e `ParentId` definido como `null` . O mesmo será o pai do grupo e o `DisplayName` `GroupName` locatário.  
...
Nesse caso, o pai do grupo será o locatário e o valor será `DisplayName` definido como determinado.

### Exemplo 3: Criar um Grupo de Gerenciamento com um pai e um nome para exibição
```
