...
## Descrição
O **cmdlet Export-AzResourceGroup** captura o grupo de recursos especificado como um modelo e o salva em um arquivo JSON. Isso pode ser útil em cenários em que você já criou alguns recursos em seu grupo de recursos e, em seguida, deseja aproveitar os benefícios de usar implantações com suporte de modelo.
...
Esse comando captura o grupo de recursos chamado Grupo de Teste como um modelo e o salva em um arquivo JSON no diretório atual.
...
Esse comando captura o recurso Virtual Machine chamado "TestVirtualMachine" do grupo de recursos "TestGroup" como um modelo e o salva em um arquivo JSON no diretório atual.
...
Esse comando captura dois recursos do grupo de recursos "Grupo de Teste" como um modelo e o salva em um arquivo JSON no diretório atual. O modelo gerado não conterá parâmetros gerados.

## Parâmetros

### -ApiVersion
Especifica a versão da API do provedor de recursos a ser usada.
Se não especificado, a versão mais recente da API será usada.
...
Ignorar parâmetros de nome de recurso.
