...
### -ID
A ID de aplicativo gerenciado totalmente qualificada, incluindo a assinatura. por exemplo, /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName
...
### -Plano
Uma tabela hash que representa propriedades de plano de aplicativo gerenciado.
