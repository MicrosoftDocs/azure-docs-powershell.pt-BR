...
## Descrição
O cmdlet **Invoke-AzResourceAction** invocará uma ação em um recurso especificado do Azure.
Para obter uma lista de ações com suporte, use a ferramenta Do Explorador de Recursos do Azure.

## Exemplos

### Exemplo 1: Invoke iniciando um VM com ResourceId
...
### Exemplo 2: Invocar o poweroffing de um VM com ResourceName
...
Esse comando interrompe a Máquina Virtual com {ResourceId}.
O comando especifica o parâmetro *Forçar,* portanto, ele não solicita confirmação.

### Exemplo 3: Invoke registrando um provedor de recursos com ResourceId
...
Especifica o nome de um recurso de extensão para o recurso no qual este cmdlet invoca uma ação.
...
### -Parâmetros
Especifica parâmetros, como uma tabela hash, para a ação que este cmdlet invoca.
...
### -ResourceGroupName
Especifica o nome de um grupo de recursos no qual este cmdlet invoca uma ação.
...
### -ResourceId
Especifica a ID de recurso totalmente qualificada do recurso no qual este cmdlet invoca uma ação.
...
### -ResourceName
Especifica o nome do recurso do recurso no qual este cmdlet invoca uma ação.
