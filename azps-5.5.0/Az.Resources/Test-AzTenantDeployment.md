...
## Descrição
O cmdlet **Test-AzTenantDeployment** determina se um modelo de implantação e seus valores de parâmetro são válidos no escopo atual do locatário.
...
Esse comando testa uma implantação no escopo do locatário atual usando o arquivo de modelo determinado e o arquivo de parâmetros.

### Exemplo 2: Testar a implantação com um objeto de modelo personalizado e um arquivo de parâmetro
```
...
Esse comando testa uma implantação no escopo do locatário atual usando uma tabela hashtable na memória criada a partir do arquivo de modelo determinado e um arquivo de parâmetro.
