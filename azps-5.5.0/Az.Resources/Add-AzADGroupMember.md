...
### Exemplo 2: Adicionar um usuário a um grupo por piping

```powershell
PS C:\> Get-AzADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE | Add-AzADGroupMember -MemberObjectId D9076BBC-D62C-4105-9C78-A7F5BC4A3405
```

Obtém o grupo com a ID do objeto '85F89C90-780E-4AA6-9F4F-6F268D322EEE' e o canal no cmdlet Add-AzADGroupMember para adicionar o usuário a esse grupo.
...
O nome de exibição do grupo ao que adicionar os membros.
...
### -TargetGroupObject
A representação de objeto do grupo para adicionar os membros.
...
### -TargetGroupObjectId
A ID do objeto do grupo para adicionar os membros.
