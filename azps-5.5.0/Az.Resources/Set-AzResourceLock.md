...
## Descrição
O **cmdlet Set-AzResourceLock** modifica um bloqueio de recurso.

## Exemplos

### Exemplo 1: Atualizar anotações para um bloqueio
```
PS C:\>Set-AzResourceLock -LockLevel CanNotDelete -LockNotes "Updated note" -LockName "ContosoSiteLock" -ResourceName "ContosoSite" -ResourceType "microsoft.web/sites" -ResourceGroupName "ResourceGroup11"
```

Este comando atualiza a anotação de um bloqueio chamado ContosoSiteLock.
...
### -LockId
Especifica a ID do bloqueio que este cmdlet modifica.
...
### -LockName
Especifica o nome do bloqueio que este cmdlet modifica.
...
Por exemplo, para especificar um banco de dados, use o seguinte formato: Banco de Dados do `/` Servidor
...
### -ResourceType
Especifica o tipo de recurso para o qual o bloqueio se aplica.
