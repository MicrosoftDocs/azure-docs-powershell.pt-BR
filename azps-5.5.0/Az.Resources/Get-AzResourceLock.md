...
Esse comando obtém o bloqueio de recursos chamado ContosoSiteLock.

### Exemplo 2: Obter bloqueios no nível do grupo de recursos ou superior
```
PS C:\> Get-AzResourceLock -ResourceGroupName "ResourceGroup11" -AtScope
```

Esse comando obtém os bloqueios de recursos no grupo de recursos ou na assinatura.
...
### -AtScope
Indica que esse cmdlet retorna todos os bloqueios em ou acima do escopo especificado.
Se você não especificar esse parâmetro, o cmdlet retornará todos os bloqueios, acima ou abaixo do escopo.
...
Este cmdlet obtém bloqueios para esse grupo de recursos.
...
### -ResourceName
Especifica o nome do recurso para o qual esse bloqueio se aplica.
Este cmdlet obtém bloqueios para esse recurso.
...
O cmdlet obtém bloqueios para esse escopo.
