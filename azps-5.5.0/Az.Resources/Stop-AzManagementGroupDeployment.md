...
## Descrição
O cmdlet **Stop-AzManagementGroupDeployment** cancela uma implantação iniciada, mas não concluída em um grupo de gerenciamento.
...
Para criar uma implantação em um grupo de gerenciamento, use New-AzManagementGroupDeployment cmdlet.
...
Esse comando cancela uma "implantação01" de implantação em execução no grupo de gerenciamento "myMG".
...
Esse comando obtém a "implantação01" de implantação no grupo de gerenciamento "myMG" e o cancela. 
