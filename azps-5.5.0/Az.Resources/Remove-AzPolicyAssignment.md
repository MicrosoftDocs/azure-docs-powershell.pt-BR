...
O primeiro comando obtém um grupo de recursos chamado ResourceGroup11 e armazena esse objeto na variável $ResourceGroup dados.
O segundo comando obtém a atribuição de política em um nível de grupo de recursos e a armazena na variável $PolicyAssignment dados.
A **propriedade ResourceId** da $ResourceGroup identifica o grupo de recursos.
O comando final remove a atribuição de política que a propriedade **ResourceId** da $PolicyAssignment identifica.
...
### -InputObject
O objeto de atribuição de política para remover que foi saída de outro cmdlet.
