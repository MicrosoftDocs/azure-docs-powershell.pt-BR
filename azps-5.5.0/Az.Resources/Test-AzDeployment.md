...
Esse comando testa uma implantação no escopo da assinatura atual usando o arquivo de modelo determinado e o arquivo de parâmetros.
...
Esse comando testa uma implantação no escopo da assinatura atual usando uma tabela de hash na memória criada a partir do arquivo de modelo determinado e um arquivo de parâmetro.
