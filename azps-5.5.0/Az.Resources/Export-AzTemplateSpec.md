...
Exporta a versão 'v1.0' da Especificação de Modelo chamada "MyTemplateSpec" no grupo de recursos "myRG" da subId de assinatura para a pasta de saída \{ \} local "v1".
