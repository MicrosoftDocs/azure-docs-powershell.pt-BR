...
Lista os membros de um grupo de AD no locatário atual.
...
Listas em que o Azure RBAC nega atribuições no escopo especificado.
Por padrão, lista todas as atribuições de negação na assinatura selecionada do Azure.
Use parâmetros respectivos para listar negar atribuições a um usuário específico ou para listar negar atribuições em um grupo de recursos ou recurso específico.
...
Obtém um modelo ARM What-If resultado para uma implantação no escopo da assinatura. 
...
Obtém um modelo ARM What-If resultado para uma implantação no escopo do grupo de gerenciamento. 

### [Get-AzPolicyAlias](Get-AzPolicyAlias.md)
Get-AzPolicyAlias recupera e saídas tipos de recursos de provedores do Azure que têm aliases definidos e corresponderem aos valores de parâmetros determinados. Se nenhum parâmetro for fornecido, todos os tipos de recursos do provedor que contêm um alias serão saída.
...
Obtém as operações de um provedor de recursos do Azure que sãocuráveis usando o Azure RBAC.
...
Obtém a operação de implantação de grupo de recursos

### [Get-AzResourceGroupDeploymentWhatIfResult](Get-AzResourceGroupDeploymentWhatIfResult.md)
Obtém um modelo ARM What-If resultado para uma implantação no escopo do grupo de recursos. 

### [Get-AzResourceLock](Get-AzResourceLock.md)
Obtém um bloqueio de recursos.
...
Obtém um modelo ARM What-If resultado para uma implantação no escopo do locatário. 
...
Cria um novo aplicativo do azure Active Directory.
...
### [Novo-AzDeployment](New-AzDeployment.md)
Criar uma implantação

### [New-AzManagedApplication](New-AzManagedApplication.md)
Cria um aplicativo gerenciado pelo Azure.
...
Cria um Grupo de Gerenciamento
...
Cria um bloqueio de recursos.

### [Novo-AzRoleAssignment](New-AzRoleAssignment.md)
Atribui a função RBAC especificada ao principal especificado, no escopo especificado.
...
### [Novo-AzTenantDeployment](New-AzTenantDeployment.md)
...
Exclui um grupo do Active Directory.

### [Remove-AzADGroupMember](Remove-AzADGroupMember.md)
Remove um usuário de um grupo de AD.
...
Remove uma implantação e quaisquer operações associadas

### [Remove-AzDeploymentScript](Remove-AzDeploymentScript.md)
Remove um script de implantação e seus recursos associados.
...
Remove uma definição de aplicativo gerenciado
...
Remove um bloqueio de recursos.

### [Remove-AzRoleAssignment](Remove-AzRoleAssignment.md)
Remove uma atribuição de função para o diretor especificado que está atribuído a uma função específica em um escopo específico.

### [Remove-AzRoleDefinition](Remove-AzRoleDefinition.md)
Exclui uma função personalizada no Azure RBAC.
A função a ser excluída é especificada usando a propriedade Id da função.
A exclusão falhará se houver atribuições de função existentes feitas na função personalizada.
...
Remove uma implantação no escopo do locatário e em quaisquer operações associadas

### [Salvar-AzDeploymentScriptLog](Save-AzDeploymentScriptLog.md)
...
Atualiza a definição de aplicativo gerenciado
...
Modifica um bloqueio de recurso.
...
Cancelar uma implantação em execução

### [Stop-AzManagementGroupDeployment](Stop-AzManagementGroupDeployment.md)
Cancelar uma implantação em execução em um grupo de gerenciamento

### [Stop-AzResourceGroupDeployment](Stop-AzResourceGroupDeployment.md)
Cancela uma implantação de grupo de recursos.

### [Stop-AzTenantDeployment](Stop-AzTenantDeployment.md)
Cancelar uma implantação em execução no escopo do locatário

### [Teste-AzDeployment](Test-AzDeployment.md)
Valida uma implantação.

### [Teste-AzManagementGroupDeployment](Test-AzManagementGroupDeployment.md)
Valida uma implantação em um grupo de gerenciamento.

### [Teste-AzResourceGroupDeployment](Test-AzResourceGroupDeployment.md)
Valida uma implantação de grupo de recursos.

### [Teste-AzTenantDeployment](Test-AzTenantDeployment.md)
Valida uma implantação no escopo do locatário.
...
Não conta com um provedor de recursos.
...
Atualiza um Grupo de Gerenciamento
