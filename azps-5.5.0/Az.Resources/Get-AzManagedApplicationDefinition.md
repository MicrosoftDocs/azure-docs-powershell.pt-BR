...
Esse comando obtém as definições de aplicativo gerenciado no grupo de recursos "MyRG"
...
Esse comando obtém a definição de aplicativo gerenciado "myManagedAppDef" no grupo de recursos "MyRG"
