...
## Descrição
O **cmdlet Unregister-AzResourceProvider** não registrou um provedor de recursos do Azure.

## Exemplos

### Exemplo 1: Provedor de recursos não-registro com ProviderNamespace

```powershell
PS C:\>Unregister-AzResourceProvider -ProviderNamespace "Microsoft.support"
```

Este comando desosterna o provedor de recursos "Microsoft.support".
