...
Esse comando remove uma implantação de grupo de recursos com a ID de recurso totalmente qualificada da implantação.
A remoção bem-sucedida retorna verdadeiro.
...
Esse comando remove uma implantação de grupo de recursos com o ResourceGroupName e o ResourceName fornecidos.
A remoção bem-sucedida retorna verdadeiro.
