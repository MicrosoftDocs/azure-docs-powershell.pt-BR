...
### Exemplo 1: Remover a definição da política por nome
```
PS C:\> Remove-AzPolicyDefinition -Name 'VMPolicyDefinition'
```

Esse comando remove a definição de política especificada.

### Exemplo 2: Remover definição de política por ID do recurso
```
...
O comando o armazena na variável $PolicyDefinition dados.
O segundo comando remove a definição de política identificada pela propriedade **ResourceId** da $PolicyDefinition.
