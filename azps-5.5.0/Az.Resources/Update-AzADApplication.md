...
## Descrição
Atualiza um aplicativo existente do Azure Active Directory.
Para atualizar as credenciais associadas a este aplicativo, use o cmdlet New-AzADAppCredential dados.
...
Atualiza o nome de exibição do aplicativo com a ID do objeto 'fb7b3405-ca44-4b5b-8584-12392f5d96d7' como 'MeuNewDisplayName'.
...
### Exemplo 3 - Atualizar o nome de exibição de um aplicativo usando a cana

```
PS C:\> Get-AzADApplication -ObjectId fb7b3405-ca44-4b5b-8584-12392f5d96d7 | Update-AzADApplication -DisplayName MyNewDisplayName
```

Obtém o aplicativo com a ID do objeto 'fb7b3405-ca44-4b5b-8584-12392f5d96d7' e canos que para o cmdlet Update-AzADApplication para atualizar o nome de exibição do aplicativo para "MyNewDisplayName".
...
Verdadeiro se o aplicativo for compartilhado com outros locatários; caso contrário, falso.
...
### -ReplyUrl
Especifica as URLs para as que os tokens de usuário são enviados para entrar ou as URIs de redirecionamento para as que os códigos de autorização e tokens de acesso do OAuth 2.0 são enviados.
