...
## Descrição
O cmdlet **Get-AzPolicyDefinition obtém** um conjunto de definições de política ou uma definição de política específica identificada por nome ou ID.
...
Esse comando obtém todas as definições de política na categoria "Máquina Virtual".
...
### -Builtin
Limita a lista de resultados a apenas definições de política internas.
...
### -Personalizado
Limita a lista de resultados a apenas definições de política personalizadas.
