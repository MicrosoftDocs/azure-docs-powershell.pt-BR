...
## Descrição
O cmdlet **Test-AzResourceGroupDeployment** determina se um modelo de implantação de grupo de recursos do Azure e seus valores de parâmetro são válidos.

## Exemplos

### Exemplo 1: Testar a implantação com um objeto de modelo personalizado e um arquivo de parâmetro
...
Esse comando testa uma implantação no determinado grupo de recursos usando uma tabela de hash na memória criada a partir do arquivo de modelo determinado e um arquivo de parâmetro.

### Exemplo 2: Testar a implantação via arquivo de modelo e arquivo de parâmetro
...
Esse comando testa uma implantação no determinado grupo de recursos e recurso usando o arquivo de modelo fornecido e um arquivo de parâmetro.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos a ser testado.
