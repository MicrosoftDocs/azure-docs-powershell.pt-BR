...
## Descrição
O cmdlet **Remove-AzTenantDeployment** remove uma implantação do Azure no escopo atual do locatário e em quaisquer operações associadas.
...
Esse comando remove a implantação "RolesDeployment" no escopo atual do locatário.
...
Esse comando obtém a implantação "RolesDeployment" no escopo atual do locatário e o remove.
