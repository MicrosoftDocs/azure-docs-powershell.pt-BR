...
VALUE <IDatabasePrincipal[]>: a lista de entidades de banco de dados do Kusto.
  ...
  - `[AppId <String>]`: ID do aplicativo – relevante somente para o tipo de entidade do aplicativo.
  - `[Email <String>]`: Email principal do banco de dados se existir.
  - `[Fqn <String>]`: Nome totalmente qualificado do capital do banco de dados.
