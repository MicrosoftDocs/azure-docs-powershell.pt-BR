...
### Exemplo 1: Excluir uma Asignment de Cluster Kusto existente por nome
```powershell
...
O comando acima exclui o principalAssignment chamado "kustoprincipal1" no cluster de Kusto "testnewkustocluster".
