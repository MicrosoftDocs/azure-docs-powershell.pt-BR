...
### Exemplo 1: Lista de entidades de banco de dados do cluster e banco de dados Kusto determinados
```powershell
...
O comando acima retorna uma lista de entidades de banco de dados do cluster e banco de dados Kusto determinados
