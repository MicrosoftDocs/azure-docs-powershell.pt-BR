...
### Exemplo 1: Listar todas as AnexadasDatabaseConfigurações em um cluster
```powershell
...
O comando acima lista todas as AttachedDatabaseConfigurações no cluster "testnewkustoclusterf".

### Exemplo 2: Obter uma Configuração AnexadaDatabase específica em um cluster
```powershell
...
O comando acima retorna as AnexadasDatabaseConfigurações chamadas "myfollowerconfiguration" no cluster "testnewkustoclusterf".
