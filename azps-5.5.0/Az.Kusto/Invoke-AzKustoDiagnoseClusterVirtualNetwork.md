...
### Exemplo 1: Mostrar diagnóstico de conectividade de rede para recursos externos 
```powershell
PS C:\> Invoke-AzKustoDiagnoseClusterVirtualNetwork -ResourceGroupName "testrg" -ClusterName "testnewkustocluster"

```

O comando acima diagnostica o status de conectividade de rede para recursos externos dos quais o cluster "testnewkustocluster" depende
