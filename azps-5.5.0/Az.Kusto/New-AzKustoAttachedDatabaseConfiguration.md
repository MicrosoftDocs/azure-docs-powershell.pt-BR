...
### Exemplo 1: Criar uma nova AttachedDatabaseConfiguration
```powershell
...
O comando acima cria um banco de dados do ReadOnly "mykustodatabase" em cluster "testnewkustoclusterf".
Ele segue o banco de dados "mykustodatabase" de cluster "testnewkustocluster"
...
### -ClusterResourceId
A ID do recurso do cluster onde os bancos de dados que você gostaria de anexar residem.
...
O nome do banco de dados que você deseja anexar, use * se quiser seguir todos os bancos de dados atuais e futuros.
...
### -DefaultPrincipalsModificationMode
O tipo de modificação de entidades de entidades padrão
