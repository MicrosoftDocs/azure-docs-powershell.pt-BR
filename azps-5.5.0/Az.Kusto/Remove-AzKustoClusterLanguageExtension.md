...
O comando acima remove uma lista de extensões de idioma que podem ser executados em consultas KQL.
...
Para construir, confira a seção ANOTAÇÕES das propriedades VALOR e crie uma tabela hash.
