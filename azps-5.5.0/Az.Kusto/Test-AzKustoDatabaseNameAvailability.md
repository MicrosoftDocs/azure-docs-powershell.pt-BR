...
### Exemplo 1: Verificar a disponibilidade de um nome de banco de dados kusto que está em uso
```powershell
...
O comando acima retorna se existe ou não um banco de dados do Kusto chamado "mykustodatabase" no cluster "testnewkustocluster".

### Exemplo 2: Verificar a disponibilidade de um nome de banco de dados kusto que não está em uso
```powershell
...
O comando acima retorna se existe ou não um banco de dados do Kusto chamado "mykustodatabase2" no cluster "testnewkustocluster".
...
### -Tipo
O tipo de recurso, por exemplo, Microsoft.Kusto/Clusters/databases.
