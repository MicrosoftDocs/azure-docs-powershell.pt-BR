...
### Exemplo 1: Listar todas as entidades de cluster Kusto
```powershell
...
### Exemplo 2: obtém um cluster principal KustoAssignment por nome
```powershell
...
O comando acima retorna o cluster principal KustoAssignment chamado "kustoprincipal1" no cluster "testnewkustocluster".
