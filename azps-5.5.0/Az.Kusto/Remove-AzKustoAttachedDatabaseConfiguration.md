...
### Exemplo 1: Excluir um nome de AttachedDatabaseConfiguration existente
```powershell
...
O comando acima exclui o banco de dados de seguidores definido na attachedDatabaseConfiguration "myfollowerconfiguration" do cluster "testnewkustoclusterf".
