...
O comando acima atualiza o período de exclusão suave e o período de hot cache do banco de dados de Kusto "mykustodatabase" no cluster "testnewkustocluster" encontrado no grupo de recursos "testrg".

### Exemplo 2: Atualizar um banco de dados existente por meio de identidade
```powershell
...
### Exemplo 4: Atualizar um banco de dados do ReadOnly existente por meio de identidade
```powershell
