...
### Exemplo 1: Verificar a disponibilidade de um nome de aferimento de entidade de cluster que está em uso
```powershell
...
### Exemplo 2: Verificar a disponibilidade de um nome de nome de entidade de cluster que não está em uso
```powershell
