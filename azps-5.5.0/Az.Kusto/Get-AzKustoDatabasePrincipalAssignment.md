...
### Exemplo 1: Listar todas as PrincipaisAssignação em um banco de dados por nome
```powershell
...
O comando acima retorna todas as PrincipaisAssignment no banco de dados "mykustodatabase" encontrado no cluster "testnewkustocluster".

### Exemplo 2: Obter um nome específico do PrincipalAssignment em um banco de dados
```powershell
...
O comando acima retorna todos os PrincipaisAssignment chamados "kustoprincipal1" no banco de dados "mykustodatabase" encontrado no cluster "testnewkustocluster".
