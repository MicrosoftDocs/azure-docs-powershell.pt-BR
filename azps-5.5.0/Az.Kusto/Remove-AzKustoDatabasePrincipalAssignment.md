...
### Exemplo 1: Excluir um nome de banco de dados do Kusto existente
```powershell
...
O comando acima exclui o principalAssignment chamado "kustoprincipal1" no banco de dados de Kusto "mykustodatabase".
