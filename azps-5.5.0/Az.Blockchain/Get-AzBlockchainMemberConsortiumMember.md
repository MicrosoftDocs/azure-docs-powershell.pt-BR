...
### Exemplo 1: Lista os membros do consorciado de um membro da família.
```powershell
...
Este comando lista os membros do consorciado para um membro da empresa.
...
### Microsoft.Azure.PowerShell.Cmdlets.Itor.Models.Api20180601Preview.IConsortiumMember
