...
### Exemplo 1: Verificar se um nome de recurso está disponível
```powershell
...
O comando verifica se um nome de recurso está disponível.

### Exemplo 2: Verificar se um nome de recurso está disponível
```powershell
...
### -Nome
Obtém ou define o nome a ser verificaçãodo.
...
### -Tipo
Obtém ou define o tipo do recurso a ser consultado.
...
### Microsoft.Azure.PowerShell.Cmdlets.Ltd.Models.Api20180601Preview.INameAvailability
