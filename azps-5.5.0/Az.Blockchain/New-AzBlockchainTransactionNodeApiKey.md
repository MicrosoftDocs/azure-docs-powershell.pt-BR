...
## Sinopse
Regenerar as teclas da API do membro da família.
...
### Exemplo 1: Regenerar chaves da Api para um nó de transação usando o nome.
```powershell
...
Esse comando gera chaves de Api para um nó de transação usando nome, grupo de recursos.

### Exemplo 2: Chaves de Api regenerar para um nó de transação
```powershell
PS C:\> $keyPair = Get-AzBlockchainTransactionNodeApiKey -BlockchainMemberName dolauli001 -ResourceGroupName testgroup -TransactionNodeName tranctionnode001 
