...
### Exemplo 1: Chaves da Api regenerar para um membro da família Ao usar o nome
```powershell
...
Este comando regenera as teclas da Api para um membro da casa usando nome, grupo de recursos.

### Exemplo 2: Chaves da Api regenerar para um membro da família Ao usar idenity
```powershell
PS C:\> $keyPair = Get-AzBlockchainMemberApiKey -BlockchainMemberName myblockchainhlqc92 -ResourceGroupName bc-rg
...
Esse comando regenera as teclas da Api para um membro da empresa usando a identidade.
...
### Microsoft.Azure.PowerShell.Cmdlets.Bluetooth.Models.Api20180601Preview.IApiKey
...
INPUTOBJECT: <IBlockchainIdentity> Parâmetro de Identidade
  - `[BlockchainMemberName <String>]`: Nome do membro Dal.
