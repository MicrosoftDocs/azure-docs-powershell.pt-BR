...
### Exemplo 1: SKU de lista para uma assinatura
```powershell
PS C:\> Get-AzBlockchainSku -SubscriptionId c9cbd920-c00c-427c-852b-8aaf38badaeb

```

Este comando lista a SKU de uma assinatura.
...
### Microsoft.Azure.PowerShell.Cmdlets.Ltd.Model.Api20180601Preview.IResourceTypeSku
