...
### Exemplo 1: Criar um nó de transação de 'nó de transação'
```powershell
...
Esse comando cria um nó de transação de nó de transação.
...
### -Local
Obtém ou define o local do nó de transação.
...
### Microsoft.Azure.PowerShell.Cmdlets.Ltd.Model.Api20180601Preview.ITransactionNode
