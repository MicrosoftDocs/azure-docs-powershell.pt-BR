...
## Descrição
Cadeia de conexão de lista de todos os módulos ou um módulo especificado de um dispositivo IoT de destino contido em um Hub do Azure IoT.
...
Mostrar todas as cadeias de conexão de módulos de um dispositivo IoT de destino em um Hub Iot.
...
Obter a cadeia de conexão de módulo secundário de um dispositivo IoT de destino em um Hub Iot.
