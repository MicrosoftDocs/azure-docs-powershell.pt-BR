...
## Sinopse
Cria um novo trabalho de importação de dispositivos.
...
## Descrição
Cria um novo trabalho de importação de dispositivos para o IotHub.
Isso importa todos os dispositivos para o IotHub do contêiner especificado. Confira o seguinte artigo sobre como gerar o URI SAS.
...
### -OutputBltContainerUri
O Uri para gravar a saída. 
