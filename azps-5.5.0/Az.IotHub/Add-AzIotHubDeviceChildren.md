...
## Sinopse
Adicione dispositivos que não são de borda como filhos ao dispositivo de borda.
...
## Descrição
Adicione uma lista especificada separada por vírgulas de IDs de dispositivo não de borda como filhos de dispositivo de borda especificado.
...
Adicione dispositivos que não são de borda como filhos ao dispositivo de borda independentemente de que o dispositivo sem borda já seja filho de outro dispositivo de borda.

## Parâmetros

### -Crianças
A lista de dispositivos filho (vírgulas separadas) inclui apenas dispositivos que não são de borda.
