...
## Sinopse
Remova dispositivos que não são de borda como filhos do dispositivo de borda especificado.
...
## Descrição
Remova todos os dispositivos sem borda mencionados como dispositivos de borda especificados para crianças.
...
Remover dispositivos mencionados como filhos de dispositivo especificado.
...
Remova todos os dispositivos que não são de borda como dispositivo de borda especificado para crianças.
