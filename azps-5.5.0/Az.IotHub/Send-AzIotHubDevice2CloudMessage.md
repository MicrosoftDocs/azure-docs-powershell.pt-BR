...
## Sinopse
Enviar mensagem de dispositivo para nuvem.
...
## Descrição
O comando dá suporte ao envio de mensagens com propriedades do aplicativo e do sistema.
...
Enviando um dispositivo para a mensagem na nuvem usando o tipo de transporte padrão.
...
Enviando um dispositivo mqtt para a mensagem na nuvem.
...
### -Mensagem
Corpo da mensagem para enviar para o Hub de IoT.
