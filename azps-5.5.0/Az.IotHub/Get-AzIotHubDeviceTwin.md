...
## Descrição
Obtém um dispositivo duplo. Confira https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-device-twins mais informações.
...
Retorna o objeto de brilho do dispositivo.
