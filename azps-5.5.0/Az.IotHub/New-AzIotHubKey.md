...
## Sinopse
Gere uma tecla hub do Azure IoT.
...
Chave primária regenerada para a política de autorização "testKey" de um hub do azure iot.
...
Trocar chaves para a política de autorização "testKey" de um hub do azure iot.
