...
## Sinopse
Consultar um Hub de IoT usando um idioma poderoso do tipo SQL.
...
## Descrição
Consulte um Hub de IoT usando um idioma poderoso do tipo SQL para recuperar informações sobre o módulo e os módulos, trabalhos e roteamento de mensagens.
...
Consultar todos os dados de dispositivo em um Hub IoT do Azure.
...
Consultar os dois principais dados do módulo em um dispositivo de destino.
