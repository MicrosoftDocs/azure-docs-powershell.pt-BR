...
## Sinopse
Obter informações sobre todos os pontos de extremidade do Hub de IoT
...
Obter todos os pontos de extremidade do Hub de IoT do "myiothub".
...
Obter todos os pontos de extremidade do tipo EventHub no Hub de IoT do "myiothub". 
...
Obter informações de ponto de extremidade do Hub de IoT do "myiothub".
...
### System.Collections.Generic.List'1[[Microsoft.Azure.Commands.Management.IotHub.Models.PSRoutingEventHubProperties, Microsoft.Azure.PowerShell.Cmdlets.IotHub, Version=1.0.0.0,0, Culture=neutral, PublicKeyToken=null]]
