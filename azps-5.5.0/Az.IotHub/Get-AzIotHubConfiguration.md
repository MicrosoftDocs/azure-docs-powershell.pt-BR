...
## Sinopse
Lista toda ou uma configuração de gerenciamento de dispositivo automática de IoT específica.
...
## Descrição
Obter os detalhes de uma configuração automática de gerenciamento de dispositivo de IoT ou de configurações de gerenciamento automático de dispositivo IoT em um Hub de IoT.
...
Obter os detalhes de uma configuração automática de gerenciamento de dispositivo de IoT.
...
List IoT automatic device management configurations in a IoT Hub.
