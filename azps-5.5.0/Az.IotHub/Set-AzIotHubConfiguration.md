...
## Sinopse
Atualize os campos de mutável do registro de configuração.
...
## Descrição
Atualize as propriedades especificadas de uma configuração de gerenciamento de dispositivo automática de IoT.
...
### -Forçar
Permite que o objeto de configuração seja substituído mesmo se ele tiver sido atualizado desde que foi recuperado da última vez.
