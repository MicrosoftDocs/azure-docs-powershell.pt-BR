...
## Sinopse
Excluir uma rota no Hub de IoT
...
## Descrição
Excluir rotas para um ponto de extremidade
...
Exclua a rota "R1" do Hub de IoT do "myiothub".
...
### -PassThru
Permite retornar o objeto boolano. Por padrão, esse cmdlet não gera saída.
