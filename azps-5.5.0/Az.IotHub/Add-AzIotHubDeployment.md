...
## Sinopse
Adicione uma implantação de borda IoT em um Hub de IoT de destino.
...
## Descrição
As implantações de borda podem ser criadas com métricas definidas pelo usuário para avaliação sob demanda.
...
Crie uma implantação de Borda com metadados padrão.
...
Crie uma implantação de Borda com uma prioridade 3 que se aplica na condição quando um dispositivo está marcado no edifício 9 e o ambiente é "teste".
...
Crie uma implantação de Borda com rótulos.
...
Crie uma implantação de Borda com conteúdo.
