...
Isso exportará todos os dispositivos para o contêiner especificado. Confira o seguinte artigo sobre como gerar o URI SAS.
...
### -ExcludeKeys
Permite exportar dispositivos sem teclas.
...
### -ExportBltContainerUri
O Uri para exportar o blob. 
