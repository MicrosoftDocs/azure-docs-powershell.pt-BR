...
### Exemplo 1 Criar um novo IotHub com propriedades padrão
```
PS C:\> $tags = @{}
...
Cria um novo IotHub chamado "myiothub" da sku "S1", capacidade 1 e local "northeurope" incluído nas Marcas.

### Exemplo 2 Criar um novo IotHub com a MaxDeliveryCount da Fila CloudToDevice definida como 20
```
PS C:\> New-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -SkuName "S1" -Units 1 -Location "northeurope" -Properties $properties
```

Cria um novo IotHub chamado "myiothub" da sku "S1", capacidade 1 e local "northeurope" com propriedades de entrada avançadas representadas por $properties.
...
### -Local
Local onde o hub de IoT precisa ser criado. 
...
### -Tag
Marcas de instância do hub IoT. Bolsa de propriedades em pares de valor-chave na forma de uma tabela hash.
