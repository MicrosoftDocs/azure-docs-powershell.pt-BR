...
Os Nomes de Teclas não são exclusivos e precisam ser gerenciados com cuidado.
...
Cria uma chave chamada "mykey" para o iothub "myiothub" com permissões do RegistryRead.
