...
## Descrição
O cmdlet **Set-AzSt stackEdgeBandwidthSchedule** atualiza um cronograma de largura de banda para um dispositivo Stack Edge.
...
### -UnlimitedBandwidth
Definirá largura de banda ilimitada
...
### Microsoft.Azure.PowerShell.Cmdlets.StackEdge.Models.PSSt stackEdgeBandWidthSchedule
