...
## Descrição
O cmdlet **Remove-AzSt stackEdgeStorageContainer** remove um contêiner de armazenamento associado para a conta de Armazenamento de Borda em um dispositivo stack edge. Você pode especificar o nome do contêiner de armazenamento a ser removido como parâmetro.
