...
## Descrição
O **cmdlet New-AzSt stackEdgeOrder** cria uma nova ordem para um dispositivo de Borda de Pilha. Um recurso de dispositivo Stack Edge precisa ser criado primeiro antes de criar uma ordem. Você pode especificar detalhes como contato, nome da empresa, email, endereço etc. como parâmetros para criar o pedido.
...
### Microsoft.Azure.PowerShell.Cmdlets.StackEdge.Models.PSSt stackEdgeOrder
