...
## Descrição
O cmdlet **Get-AzSt stackEdgeRole** busca as funções de IoT disponíveis para um dispositivo de Borda de Pilha. Você pode mencionar o parâmetro Nome para obter os detalhes de uma função IoT específica.
