...
## Descrição
O cmdlet **Remove-AzSt stackEdgeStorageAccount** remove uma Conta de Armazenamento de Borda associada para um dispositivo stack edge. Você pode especificar o nome da Conta de Armazenamento de Borda a ser removida como um parâmetro no cmdlet.
