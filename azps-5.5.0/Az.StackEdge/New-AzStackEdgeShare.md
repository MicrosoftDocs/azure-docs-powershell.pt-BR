...
## Descrição
O cmdlet **New-AzSt stackEdgeShare** cria um novo compartilhamento no dispositivo Stack Edge.
...
### -Nomedo Contêiner
Nome do contêiner (com base no formato de dados especificado, isso representa o nome dos Arquivos do Azure/Pageb ltd/Blob)
...
### -DataFormat
Definir Formato de Dados, por ex: PageB ltd, BlobBlab
...
### -NFS
AccessProtocol no caso de criar o Compartilhamento
