...
## Descrição
O cmdlet **Set-AzSt stackEdgeStorageAccountCredential** atualiza a credencial da conta de armazenamento correspondente a uma conta de armazenamento no dispositivo Stack Edge.
...
Ajuda a girar as teclas de acesso para uma conta de armazenamento
