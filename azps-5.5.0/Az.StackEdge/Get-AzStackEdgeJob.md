...
## Descrição
O **cmdlet Get-AzSt stackEdgeJob** obtém os trabalhos ativos em um dispositivo Stack Edge. Você pode mencionar o parâmetro Nome para obter detalhes de um trabalho específico.
...
### Microsoft.Azure.PowerShell.Cmdlets.StackEdge.Models.PSSt stackEdgeJob
