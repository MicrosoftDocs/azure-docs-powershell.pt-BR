...
## Descrição
O **cmdlet Get-AzSt stackEdgeUser** lista os usuários configurados para um dispositivo de Borda de Pilha. Você pode mencionar o Nome nos parâmetros para obter detalhes sobre um usuário específico.
