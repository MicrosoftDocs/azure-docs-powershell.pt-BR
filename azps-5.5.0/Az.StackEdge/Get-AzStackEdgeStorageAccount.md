...
## Descrição
O cmdlet **Get-AzSt stackEdgeStorageAccount** obtém as contas de Armazenamento de Borda disponíveis em um dispositivo Stack Edge. Você pode especificar o Nome como um parâmetro no cmdlet para obter as informações de uma conta de Armazenamento de Borda específica.
