...
## Descrição
O cmdlet **Invoke-AzSt stackEdgeDevice** invoca ações para verificar, baixar e instalar as atualizações no dispositivo Stack Edge. Uma verificação automática é feita diariamente no dispositivo, você pode acionar a verificação explicitamente executando este cmdlet.
...
### -FetchUpdate
Baixa as atualizações em um dispositivo stack edge/gateway
...
### -InstallUpdate
Instala as atualizações no dispositivo stack edge/gateway
...
### -ScanForUpdate
Verifica se há atualizações em um dispositivo stack edge/gateway.
