...
## Descrição
O cmdlet **Get-AzSt stackEdgeDevice** obtém as informações sobre os Dispositivos de Borda de Pilha disponíveis. Você pode especificar o Nome do dispositivo juntamente com o Nome do Grupo de Recursos para obter as informações em um dispositivo específico. 
...
### -Alerta
Buscar os alertas no dispositivo stack edge/gateway
...
### -NetworkSetting
Obtém as configurações de rede do dispositivo de Stack Edge/Stack Gateway especificado
