...
## Descrição
O cmdlet **Get-AzSt stackEdgeStorageAccountCredential** obtém as credenciais de conta de armazenamento da conta de armazenamento correspondente no dispositivo Stack Edge. Você pode especificar parâmetros Nome, Nome do Grupo de Recursos e Nome do Dispositivo para obter informações sobre uma credencial de conta de armazenamento específica.
