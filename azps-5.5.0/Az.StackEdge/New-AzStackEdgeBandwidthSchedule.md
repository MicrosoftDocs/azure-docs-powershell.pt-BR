...
## Descrição
O cmdlet **New-AzSt stackEdgeBandwidthSchedule** cria um novo Cronograma de Largura de Banda para um dispositivo de Borda de Pilha para ajudar a gerenciar o uso de largura de banda.
...
### -UnlimitedBandwidth
Definirá largura de banda como ilimitada
