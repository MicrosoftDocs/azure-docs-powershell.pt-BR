...
## Descrição
O cmdlet **Invoke-AzSt stackEdgeShare** invoca a ação para atualizar dados em um compartilhamento em um dispositivo stack edge.
...
### -RefreshData
Atualizar o Compartilhamento de Metadados com os dados da nuvem
