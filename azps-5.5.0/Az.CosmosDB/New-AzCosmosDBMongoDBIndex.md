...
## Descrição
O **New-AzCosmosDBMongoDBIndex cria** um novo Índice MongoDB.
...
### -Tecla
Matriz de valores principais como cadeias de caracteres.
...
### -TtlInSeconds
Número de segundos após os quais o índice expira.
