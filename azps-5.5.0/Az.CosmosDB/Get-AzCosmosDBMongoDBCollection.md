...
## Descrição
O cmdlet **Get-AzCosmosDBMongoDBCollection** obtém a Coleção MongoDB de MongoDB.
...
O Objeto de Recurso contém mongoIndexes, _rid, _ts, _etag propriedades.
...
Este exemplo obtém a SkeyKey da coleção recuperada
