...
## Sinopse
Cria um novo objeto do tipo PSIncpath. Ele pode ser passado como um valor de parâmetro para Set-AzCosmosDBSqlContainer.
...
## Descrição
Objeto correspondente ao IncludedPath da API do Sql.
