...
## Sinopse
Obtém o Contêiner Sql do Sql Do Sql Do Sql.
...
## Descrição
O cmdlet **Get-AzCosmosDBSqlContainer** obtém a lista de todos os Contêineres Sql do Sql Do Sql existentes para um determinado ResourceGroupName, AccountName e DatabaseName e obtém um único Contêiner Sql Do Sql Do Sql DoLMDB para um determinado ResourceGroupName, AccountName, DatabaseName e ContainerName.
