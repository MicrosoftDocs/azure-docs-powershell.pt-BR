...
## Sinopse
Cria um novo Esquema Defamado DalMdb.
...
## Descrição
O **New-AzCosmosDBCasschema** cria um novo Esquema de Schema do CosmosDB.
...
### -PartitionKey
Matriz de cadeias de caracteres que contêm as Teclas de Partição.
