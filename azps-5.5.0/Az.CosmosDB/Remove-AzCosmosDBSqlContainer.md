...
## Sinopse
Exclui o Contêiner Sql do Sql Do Sql Do Sql.
...
## Descrição
O cmdlet **Remove-AzCosmosDBSqlContainer** exclui o Contêiner Sql Do Sql DaLMdb correspondente ao ResourceGroupName, AccountName, DatabaseName e ContainerName.
