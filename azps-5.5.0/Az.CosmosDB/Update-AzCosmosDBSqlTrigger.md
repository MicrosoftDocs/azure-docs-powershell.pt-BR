...
## Sinopse
Atualiza o Gatilho Sql Do Sql Do Sql Do Sql. Executa uma operação de patch do lado do cliente lendo o Gatilho existente.
...
### -TriggerOperation
A operação à que o gatilho está associado.
Os valores possíveis incluem: 'Tudo', 'Criar', 'Atualizar', 'Excluir', 'Substituir'
...
### -TriggerType
Tipo do Gatilho.
Os valores possíveis incluem: 'Pre', 'Post'
...
### Microsoft.Azure.Commands.CosmosDB.Models.PSSqlTrigetResults
