...
## Sinopse
Atualiza o Graph de Gremlin do CosmosDB. Executa uma operação de patch do lado do cliente lendo o Gráfico existente.
...
ConflictResolutionPolicy Object do tipo PSConflictResolutionPolicy, quando fornecido, ele é definido como ConflictResolutionPolicy do contêiner.
...
### -Produtividade
A produtividade do Gremlin Graph (RU/s).
...
### -UniqueKeyPolicy
Objeto UniqueKeyPolicy do tipo Microsoft.Azure.Commands.CosmosDB.PSUniqueKeyPolicy.
