...
## Sinopse
Obtém o Banco de Dados de Gremlin do CosmosDB.
...
## Descrição
O cmdlet **Get-AzCosmosDBGremlinDatabase** obtém o Banco de Dados de Gremlin do CosmosDB.
...
O Objeto de Recurso contém _rid, _ts, _etag.
