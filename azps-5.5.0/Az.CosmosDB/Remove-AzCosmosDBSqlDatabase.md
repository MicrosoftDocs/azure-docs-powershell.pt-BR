...
## Sinopse
Exclui o Banco de Dados Sql do Sql Do Sql Do Sql.
...
## Descrição
O cmdlet **Remove-AzCosmosDBSqlDatabase** exclui o Banco de Dados Sql Do Sql Do Sql correspondente ao ResourceGroupName, AccountName e DatabaseName determinados.
