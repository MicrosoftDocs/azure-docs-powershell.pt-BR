...
## Sinopse
Cria um novo objeto do tipo PSIncpath. Ele pode ser passado como um valor de parâmetro para Set-AzCosmosDBGremlinGraph.
...
## Descrição
Objeto correspondente ao IncludedPath da API de Gremlin.
...
### Microsoft.Azure.Commands.CosmosDB.Models.PSIncpath
