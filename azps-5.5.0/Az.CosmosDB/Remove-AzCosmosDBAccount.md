...
## Descrição
Remover uma Conta do CosmosDB com um determinado Nome no Determinado Grupo de Recursos.
...
A Conta com nome de conta dbname no ResourceGroup rg é excluída. 
...
### -InputObject
O objeto Conta de Banco de Dados
