...
## Sinopse
Obtém as propriedades de produtividade do CosmosDB da Coleção MongoDB.
...
## Descrição
O cmdlet **Get-AzCosmosDBMongoDBCollectionThroughput** obtém as propriedades de produtividade da Coleção MongoDB.
