...
## Sinopse
Exclui o Sql UserDefinedFunction do Sql.
...
## Descrição
O cmdlet **Remove-AzCosmosDBSqlUserDefinedFunction** exclui o Sql UserDefinedFunction do Sql Sql correspondente ao resourceGroupName, AccountName e DatabaseName determinados.
