...
### -ExcludedPath
Matriz de cadeias de caracteres que contêm excludedPath(Especifica um caminho em um documento JSON a ser excluído no serviço Azure Db.)  Elementos.
...
### -IncludedPath
Matriz de cadeias de caracteres que contêm includedPath (especifica um caminho em um documento JSON a ser incluído nos elementos do serviço Azure Db.)
...
Os valores possíveis incluem: 'Consistente', 'Lento', 'Nenhum'
...
### -EspécieSpec
Matriz de objetos do tipo Microsoft.Azure.Commands.CosmosDB.PSSárialSpec
