...
## Sinopse
Obtém o valor de produtividade da Tabela Desarmável.
...
## Descrição
O cmdlet **Get-AzCosmosDBCasstableThroughput** obtém o objeto de produtividade correspondente a um determinado Espaço de Teclas.
