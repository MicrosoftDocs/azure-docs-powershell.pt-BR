...
## Sinopse
Regenerar uma determinada Chave de Conta do CosmosDB.
...
Novas chaves são geradas para Conta com nome de conta dbname no resourcegroup rg.

### Exemplo 2

Regenerar uma determinada Chave de Conta do CosmosDB. (gerado automaticamente)
...
Valores aceitos: primário, primárioReadonly, secundário, secundárioReadonly
