...
## Sinopse
Obtém as propriedades de produtividade do Banco de Dados MongoDB.
...
## Descrição
O cmdlet **Get-AzCosmosDBMongoDBDatabaseThroughput** obtém as propriedades de produtividade do banco de dados MongoDB.
