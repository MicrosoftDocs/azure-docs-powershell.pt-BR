...
## Sinopse
Obtém uma Tabela Desarmão Dalmdb.
...
## Descrição
O cmdlet **Get-AzCosmosDBCasstable** cria um novo ou atualiza um Espaço de Keyspace existente do CosmosDB.
...
{{ Get-AzCosmosDBCassandraTable obtém as propriedades de umKeyspace existente. Você pode expandir o Recurso para obter as propriedades DefaultTtl, Esquema, _etag, _ts, _rid.}}
