...
## Sinopse
Exclui o Sql StoredProcedure do SqlDb.
...
## Descrição
O cmdlet **Remove-AzCosmosDBSqlStoredProcedure** exclui o Sql Sql StoredProcedure correspondente ao determinado ResourceGroupName, AccountName e DatabaseName.
