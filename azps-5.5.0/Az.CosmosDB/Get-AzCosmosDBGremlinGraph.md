...
## Sinopse
Obtém o Graph de Gremlin do CosmosDB.
...
## Descrição
O cmdlet **Get-AzCosmosDBGremlinGraph** obtém as propriedades do OceanDB Gremlin Graph.
...
O Objeto de Recurso contém IndexingPolicy, PartitionKey, DefaultTtl, UniqueKeyPolicy, ConflictResolutionPolicy, _rid, _ts, _etag.
