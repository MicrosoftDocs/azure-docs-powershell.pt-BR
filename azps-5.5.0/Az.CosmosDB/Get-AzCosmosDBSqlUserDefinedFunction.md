...
## Sinopse
Obtém a Função Definida pelo Usuário sql do Sql.
...
## Descrição
O cmdlet **Get-AzCosmosDBSqlUserDefinedFunction** obtém a lista de todos os existentes Do Sql UserDefinedFunctions do Sql Para um determinado ResourceGroupName, AccountName, DatabaseName e ContainerName e obtém um único UserDefinedFunction sql do Sql Sql Para um determinado ResourceGroupName, AccountName, DatabaseName, ContainerName e UserDefinedFunctionName.
