...
## Sinopse
Obtém as configurações de produtividade correspondentes a um Banco de Dados Sql do Sql Do Sql Do Sql.
...
## Descrição
O cmdlet **Get-AzCosmosDBSqlDatabaseThroughput** obtém as configurações de produtividade correspondentes a um Banco de Dados Sql Do Sql Do Sql.
