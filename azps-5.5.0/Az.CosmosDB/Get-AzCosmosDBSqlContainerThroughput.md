...
## Sinopse
Obtém as configurações de produtividade correspondentes a um Contêiner Sql do Sql Do Sql Do Sql.
...
## Descrição
O cmdlet **Get-AzCosmosDBSqlContainerThroughput** obtém as configurações de produtividade correspondentes a um Contêiner Sql Do Sql Do Sql. 
