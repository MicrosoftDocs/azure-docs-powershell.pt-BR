...
## Sinopse
Crie um novo Objeto Do Portal VirtualNetworkRule(PSVirtualNetworkRule).
...
Booliano para indicar se você deve criar uma regra de firewall antes que a rede virtual tenha o ponto de extremidade do serviço VNET habilitado.
