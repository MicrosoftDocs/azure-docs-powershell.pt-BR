...
## Descrição
O cmdlet **Set-AzCdnOrigin** atualiza um servidor de origem de REDE de Distribuição de Conteúdo (CDN) do Azure.
...
### -CdnOrigin
Especifica o servidor de origem que este cmdlet atualiza.
