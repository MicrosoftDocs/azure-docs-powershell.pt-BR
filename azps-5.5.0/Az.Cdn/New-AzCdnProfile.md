...
## Descrição
O **cmdlet New-AzCdnProfile** cria um perfil de REDE de Distribuição de Conteúdo (CDN) do Azure.

## Exemplos

### Exemplo 1

Cria um perfil de CDN. (gerado automaticamente)
...
### -Tag
As marcas a associar ao perfil de CDN do Azure.
