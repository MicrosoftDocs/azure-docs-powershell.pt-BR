...
## Descrição
A New-AzCdnOrigin criará uma nova origem de CDN dentro do ponto de extremidade especificado.
...
Esse cmdlet criará uma nova origem de CDN para o ponto de extremidade especificado. Ele usará o nome do host fornecido como a origem. 
...
### -Nomedo Host
Nome do host de origem da CDN do Azure.
...
### -OriginName
Nome de origem do CDN do Azure.
