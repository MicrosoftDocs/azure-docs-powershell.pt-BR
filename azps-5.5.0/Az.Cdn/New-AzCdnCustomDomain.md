...
## Descrição
O cmdlet **New-AzCdnCustomDomain** cria um domínio personalizado para o ponto de extremidade de Rede de Distribuição de Conteúdo (CDN) do Azure.
...
### -CdnEndpoint
Especifica o objeto do ponto de extremidade CDN ao qual o domínio personalizado é adicionado.
