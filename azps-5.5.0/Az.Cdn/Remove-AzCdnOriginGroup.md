...
## Descrição
Remove-AzCdnOriginGroup removerá um grupo de origem de CDN do ponto de extremidade especificado. 
...
Esse cmdlet removerá o grupo de origem especificado do ponto de extremidade determinado. 
...
### -ResourceId
A ID do recurso do grupo de origem da CDN do Azure.
