...
### -MatchValue
Lista de possíveis valores de combinação.
...
### -MatchVariable
Corresponder variável da condição.
...
### -NegateCondition
Descreve se o resultado dessa condição deve ser negativo.
...
### -Seletor
Nome do Seletor a ser corresponder
...
### -Transformar
Transforme para aplicar antes da correspondência.
