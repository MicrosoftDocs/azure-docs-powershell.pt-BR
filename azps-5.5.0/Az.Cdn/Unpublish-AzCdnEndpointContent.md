...
## Descrição
O **cmdlet Unpublish-AzCdnEndpointContent** limpa o conteúdo de um ponto de extremidade de REDE de Distribuição de Conteúdo (CDN) do Azure.
...
### -PurgeContent
Especifica uma matriz de caminhos relativos para o conteúdo no servidor de origem que este cmdlet limpa.
