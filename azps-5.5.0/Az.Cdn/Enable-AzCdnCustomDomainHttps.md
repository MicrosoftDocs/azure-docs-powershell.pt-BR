...
## Descrição
O cmdlet **Enable-AzCdnCustomDomainHttps** habilita a entrega HTTPS protegida de um domínio personalizado de CDN.
...
Habilitar a entrega segura do domínio personalizado.
