...
## Descrição
O cmdlet **Get-AzCdnProfileSupportedOptimizationType obtém** os tipos de otimização com suporte para o perfil atual. Um usuário pode criar um ponto de extremidade com um tipo de otimização a partir dos valores listados.
...
Obter os tipos de otimização com suporte para um perfil de CDN.
