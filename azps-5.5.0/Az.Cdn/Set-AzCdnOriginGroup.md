...
## Sinopse
Atualiza o grupo de origem da CDN
...
## Descrição
Set-AzCdnOriginGroup atualizará o grupo de origem especificado dentro de determinado ponto de extremidade. 
...
```
Este cmdlet atualizará a propriedade ElevalInSeconds no grupo de origem. 
...
### -OriginId
IDs do grupo de origem cdn do Azure.
...
### -ElevaIntervalInSeconds
O número de segundos entre problemas de saúde.
...
### -Path
O caminho em relação à origem usado para determinar a saúde da origem.
...
### -Elaprotocol
Protocolo a ser usado para a saúde.
...
### -Ela é um tipo de autoconsuidade
O tipo de solicitação de saúde que é feita.
