...
? e & serão adicionados automaticamente, portanto, não os inclua.
...
### -HeaderActionType
Se você quer modificar o header de solicitação ou o header de resposta
...
### -PreservePath
Se você deve preservar o caminho não imparável.
...
### -QueryParameter
Parâmetros de consulta a incluir ou excluir (separados por vírgula).
...
### -SourcePattern
Defina um padrão de URI de solicitação que identifique o tipo de solicitações que podem ser reescritas. Se o valor estiver em branco, todas as cadeias de caracteres serão corresponderes.
