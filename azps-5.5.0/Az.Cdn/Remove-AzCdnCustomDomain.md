...
## Descrição
O cmdlet **Remove-AzCdnCustomDomain** remove o domínio personalizado de um ponto de extremidade de Rede de Distribuição de Conteúdo (CDN) do Azure.
...
Especifica o nome do ponto de extremidade do qual este cmdlet remove um domínio personalizado.
...
### -ProfileName
Especifica o nome do perfil do qual este cmdlet remove um domínio personalizado.
...
### -ResourceGroupName
Especifica o nome do grupo de recursos do qual este cmdlet remove um domínio personalizado.
