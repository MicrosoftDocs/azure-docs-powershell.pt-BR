...
## Descrição
O cmdlet **Enable-AzCdnCustomDomain** habilita a entrega HTTPS protegida de um domínio personalizado de CDN.
...
Habilitar a entrega https do domínio personalizado.
