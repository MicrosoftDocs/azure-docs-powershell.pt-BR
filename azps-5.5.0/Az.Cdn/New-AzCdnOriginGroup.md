...
## Sinopse
Cria um novo grupo de origem de CDN
...
## Descrição
A New-AzCdnOriginGroup criará um novo grupo de origem dentro do ponto de extremidade especificado. Se esse for o primeiro grupo de origem do ponto de extremidade, a propriedade DefaultOriginGroup também deverá ser definida.
...
```
Esse cmdlet criará um novo grupo de origem dentro do ponto de extremidade especificado. Ela utilizará as IDs de origem determinadas como o conjunto de origens.
