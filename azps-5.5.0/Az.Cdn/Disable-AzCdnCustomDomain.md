...
## Descrição
O cmdlet **Disable-AzCdnCustomDomain** desabilita a entrega HTTPS protegida de um domínio personalizado cdn.
...
Desabilitar a entrega de https do domínio personalizado.

## Parâmetros

### -CustomDomainName
Nome de exibição de domínio personalizado cdn do Azure.
