...
## Descrição
Remove-AzCdnOrigin excluirá uma origem de CDN do ponto de extremidade determinado. Se a origem for a única origem dentro do ponto de extremidade especificado, a exclusão falhará uma vez que pelo menos uma origem é necessária. 
...
```
Esse cmdlet removerá a origem especificada do ponto de extremidade determinado. 
