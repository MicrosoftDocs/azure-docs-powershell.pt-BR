...
## Descrição
O Update-AzPowerBIEmbeddedCapacity cmdlet modifica uma instância da Capacidade Inserida do PowerBI
...
### -PassThru
Retornará os detalhes da capacidade excluída se a operação for concluída com êxito
...
### -ResourceId
ID do Recurso de Capacidade Inserida do PowerBI.
