...
## Descrição
O New-AzPowerBIEmbeddedCapacity cmdlet cria uma nova Capacidade Inserida do PowerBI
...
Cria uma capacidade chamada testcapacity na região do Azure oeste dos EUA e no testRG do grupo de recursos. O nível de sku para a capacidade será A1.

## Parâmetros

### -Administrador
Nomes separados por vírgulas para definir como administrador na capacidade
...
### -Local
A região do Azure onde a Capacidade Inserida do PowerBI está hospedada
...
### -Tag
Pares de valor-chave na forma de uma tabela hash definida como marcas na capacidade.
