...
## Descrição
O Remove-AzPowerBIEmbeddedCapacity cmdlet exclui uma instância da Capacidade Inserida do PowerBI
...
Esse comando removerá a capacidade nomeada de testcapacity no testeRG do grupo de recursos
