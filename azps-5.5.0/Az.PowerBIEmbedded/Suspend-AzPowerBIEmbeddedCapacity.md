...
## Descrição
O Suspend-AzPowerBIEmbeddedCapacity cmdlet suspende uma instância da Capacidade Inserida do PowerBI
...
Esse comando suspenderá uma capacidade ativa chamada testcapacity no grupo de teste de grupo de recursos
