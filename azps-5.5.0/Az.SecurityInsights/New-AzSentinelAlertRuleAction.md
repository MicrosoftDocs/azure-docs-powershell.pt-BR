...
## Descrição
O cmdlet **New-AzSentinelAlertRuleAction** cria uma Resposta Automatizada para uma Regra de Alerta no espaço de trabalho especificado.
Você deve fornecer a ID do Aplicativo Logic Resorce e o Uri do Gatilho, que podem ser encontrados usando o módulo do Aplicativo Lógico.
...
Este exemplo cria uma **AlertRuleAction** para a Regra de Alerta especificada usando propriedades do aplicativo Logic e a armazena na variável $AlertRuleAction dados.
...
### -TriggerUri
Uri de acionador do aplicativo Action Logic.
