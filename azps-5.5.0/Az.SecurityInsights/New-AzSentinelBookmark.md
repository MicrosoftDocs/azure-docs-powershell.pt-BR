...
## Descrição
O **cmdlet New-AzSentinelBookmark** cria um Indicador a partir do espaço de trabalho especificado.
...
Este exemplo cria **um Indicador** no espaço de trabalho especificado e o armazena na variável $Bookmark dados.
