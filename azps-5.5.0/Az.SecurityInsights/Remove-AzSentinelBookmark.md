...
Você pode passar um **objeto indicador** usando o operador de pipeline ou, alternativamente, pode especificar os parâmetros necessários.
...
Esse comando remove o Indicador do espaço de trabalho.
