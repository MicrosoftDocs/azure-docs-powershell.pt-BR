...
## Descrição
O cmdlet **Remove-AzSentinelAlertRule** exclui permanentemente uma Regra de Alerta de um espaço de trabalho especificado.
Você pode passar um objeto **AlertRule** usando o operador de pipeline ou, alternativamente, pode especificar os parâmetros necessários.
