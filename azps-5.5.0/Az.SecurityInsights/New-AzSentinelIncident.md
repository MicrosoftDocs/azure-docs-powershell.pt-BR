...
## Descrição
O cmdlet **New-AzSentinelIncident** cria um Incidente a partir do espaço de trabalho especificado.
...
Este exemplo cria **um Incidente** no espaço de trabalho especificado e o armazena na variável $Incident dados.
