...
Este exemplo atualiza uma **Ação AlertRuleAction** substituindo uma *Ação existente* por novas propriedades.
...
Este exemplo atualiza uma **AlertRuleAction** usando um InputObject substituindo uma *Ação existente* por novas propriedades.
