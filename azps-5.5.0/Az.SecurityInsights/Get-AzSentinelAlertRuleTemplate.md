...
Se você não especificar o parâmetro *AlertRuleTemplateId,* uma matriz que contém todos os Modelos de Regra de Alerta no espaço de trabalho especificado será retornada.
...
Este exemplo obtém todos os **AlertRuleTemplates** no espaço de trabalho especificado e, em seguida, o armazena na variável $AlertRuleTemplates dados.
...
Este exemplo obtém **um AlertRuleTemplate** no espaço de trabalho especificado e, em seguida, o armazena na variável $AlertRuleTemplate dados.

## Parâmetros

### -AlertRuleTemplateId
ID da Regra de Alerta do Modelo.
