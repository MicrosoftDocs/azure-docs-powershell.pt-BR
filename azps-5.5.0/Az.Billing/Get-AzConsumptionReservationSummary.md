...
## Descrição
O cmdlet **Get-AzConsumptionReservationSummary obtém** resumos de reserva para o trigo diário ou mensal.

## Exemplos

### Exemplo 1: Obter resumos de reserva com ID do pedido de reserva para o trigo mensal
```powershell
...
### Exemplo 2: Obter resumos de reserva com ID do pedido de reserva e ID de reserva para o trigo mensal
```powershell
...
### Exemplo 3: Obter resumos de reserva com ID do pedido de reserva para intervalo de datas fornecidos diariamente
```powershell
...
### Exemplo 4: Obter resumos de reserva com ID do pedido de reserva e ID de reserva para intervalo de datas fornecidos diariamente
```powershell
...
### -EndDate
Os dados de término (AAAA-MM-DD em UTC) do resumo da reserva, necessários somente para os trigos diários.
...
### -Grain
O tempo do resumo da reserva pode ser diário ou mensal.
...
### -ReservationId
O identificador de uma reserva dentro de um pedido de reserva.
...
### -Data Inicial
Os dados de início (YYYYY-MM-DD em UTC) do resumo da reserva, necessários somente para os trigos diários.
