...
## Descrição
O **cmdlet Get-AzBillingProfile** obtém perfis de cobrança sob a conta de cobrança especificada. 
...
Obter todos os perfis de cobrança sob a conta de cobrança especificada.
...
Obter todos os perfis de cobrança em uma conta de cobrança especificada e incluir as seções da fatura no resultado.
...
Obter o perfil de cobrança com o nome especificado e incluir as seções da fatura no resultado.
...
Inclua as seções de faturas no perfil de cobrança.
