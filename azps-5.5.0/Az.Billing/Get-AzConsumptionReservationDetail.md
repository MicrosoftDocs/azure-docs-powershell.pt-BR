...
### Exemplo 2: Obter detalhes da reserva com ID do pedido de reserva e ID de reserva para o intervalo de datas fornecido
```powershell
...
### -EndDate
Os dados de término (AAAA-MM-DD em UTC) dos detalhes da reserva.
...
### -Data Inicial
Os dados de início (AAAA-MM-DD em UTC) dos detalhes da reserva.
